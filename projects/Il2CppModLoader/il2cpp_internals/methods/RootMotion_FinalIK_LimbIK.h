...
namespace app::methods::RootMotion_FinalIK::LimbIK {
...
IL2CPP_REGISTER_METHOD(0x002FBB60, IKSolver *, GetIKSolver, (app::LimbIK * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A17B70, void, __ctor, (app::LimbIK * this_ptr));
}
