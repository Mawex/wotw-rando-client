...
namespace app::methods::ZenFulcrum_VR_OpenVRBinding::CVRDriverManager {
IL2CPP_REGISTER_METHOD(0x016785A0, void, __ctor, (app::CVRDriverManager * this_ptr, app::void * p_interface));
