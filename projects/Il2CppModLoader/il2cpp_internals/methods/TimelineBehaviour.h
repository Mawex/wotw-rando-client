...
IL2CPP_REGISTER_METHOD(0x002FBBA0, LegacyTimelineSequence *, get_TimelineSequence, (app::TimelineBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00615280, void, __ctor, (app::TimelineBehaviour * this_ptr));
}
