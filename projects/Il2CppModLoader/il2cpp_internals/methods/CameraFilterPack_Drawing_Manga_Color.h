...
IL2CPP_REGISTER_METHOD(0x024F5CC0, Material *, get_material, (app::CameraFilterPack_Drawing_Manga_Color * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024F6450, void, __ctor, (app::CameraFilterPack_Drawing_Manga_Color * this_ptr));
}
