...
namespace app::methods::System_Net_Http_Headers::AuthenticationHeaderValue {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::AuthenticationHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_Parameter, (app::AuthenticationHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_Parameter, (app::AuthenticationHeaderValue * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Scheme, (app::AuthenticationHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_Scheme, (app::AuthenticationHeaderValue * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x0173F610, Object *, ICloneable_Clone, (app::AuthenticationHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D02B90, String *, ToString, (app::AuthenticationHeaderValue * this_ptr));
}
