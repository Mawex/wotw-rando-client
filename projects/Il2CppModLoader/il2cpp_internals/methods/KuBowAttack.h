...
namespace app::methods::KuBowAttack {
    IL2CPP_REGISTER_METHOD(0x0122C980, SeinCharacter*, get_Sein, (app::KuBowAttack * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0122CA10, SeinBowAttack*, get_SeinBow, (app::KuBowAttack * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0044C850, void, __ctor, (app::KuBowAttack * this_ptr));
} // namespace app::methods::KuBowAttack
