...
namespace app::methods::Microsoft_Applications_Events::CompactBinaryProtocolWriter {
IL2CPP_REGISTER_METHOD(0x002FA280, List_1_System_Byte_ *, get_Data, (app::CompactBinaryProtocolWriter * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA290, void, __ctor_1, (app::CompactBinaryProtocolWriter * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor_2, (app::CompactBinaryProtocolWriter * this_ptr, app::List_1_System_Byte_ * output));
