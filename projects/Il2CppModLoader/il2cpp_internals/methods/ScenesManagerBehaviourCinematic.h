...
IL2CPP_REGISTER_METHOD(0x01052D80, Vector2, get_PredictedTargetPosition, (app::ScenesManagerBehaviourCinematic * this_ptr));
IL2CPP_REGISTER_METHOD(0x00597B10, ScenesManagerUpdateType__Enum, get_CurrentUpdateType, (app::ScenesManagerBehaviourCinematic * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010553C0, void, __ctor, (app::ScenesManagerBehaviourCinematic * this_ptr));
}
