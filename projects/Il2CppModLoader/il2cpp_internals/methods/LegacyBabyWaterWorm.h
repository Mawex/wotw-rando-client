...
IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::LegacyBabyWaterWorm * this_ptr));
IL2CPP_REGISTER_METHOD(0x015D80D0, Vector2, get_UpDirection, (app::LegacyBabyWaterWorm * this_ptr));
IL2CPP_REGISTER_METHOD(0x015D81F0, void, set_UpDirection, (app::LegacyBabyWaterWorm * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x015D8330, Vector2, get_WorldSpeed, (app::LegacyBabyWaterWorm * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x015D8500, Vector2, get_TargetPosition, (app::LegacyBabyWaterWorm * this_ptr));
IL2CPP_REGISTER_METHOD(0x0091D5A0, SuspendableMask__Enum, get_Mask, (app::LegacyBabyWaterWorm * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x015DA990, Vector2, GetAvoidanceForces, (app::LegacyBabyWaterWorm * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x015DB0E0, WaterZone *, GetWaterZoneIntersectingPoint, (app::LegacyBabyWaterWorm * this_ptr, app::Vector3 center));
...
IL2CPP_REGISTER_METHOD(0x00720150, IDamageReciever__Array *, get_AffectedReceivers, (app::LegacyBabyWaterWorm * this_ptr));
IL2CPP_REGISTER_METHOD(0x015DCF90, void, __ctor, (app::LegacyBabyWaterWorm * this_ptr));
}
