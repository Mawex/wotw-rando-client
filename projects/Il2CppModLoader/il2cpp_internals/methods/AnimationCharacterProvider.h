...
IL2CPP_REGISTER_METHOD(0x004FBE50, MoonAnimator *, GetAnimator, (app::CharacterFactory_Characters__Enum character_type));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::AnimationCharacterProvider * this_ptr));
