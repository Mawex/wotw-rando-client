...
namespace app::methods::System_Diagnostics_Tracing::EnumHelper_1_System_UInt16_ {
...
IL2CPP_REGISTER_METHOD(0x02FF6E70, uint16_t, Cast_14, (app::void * value));
...
IL2CPP_REGISTER_METHOD(0x02FF6E70, uint16_t, Cast_22, (app::void * value));
