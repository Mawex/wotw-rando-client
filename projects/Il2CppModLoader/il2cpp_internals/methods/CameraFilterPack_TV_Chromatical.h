...
IL2CPP_REGISTER_METHOD(0x020E7110, Material *, get_material, (app::CameraFilterPack_TV_Chromatical * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0136E200, void, __ctor, (app::CameraFilterPack_TV_Chromatical * this_ptr));
}
