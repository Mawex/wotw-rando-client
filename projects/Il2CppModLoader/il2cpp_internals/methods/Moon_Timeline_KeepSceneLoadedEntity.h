...
namespace app::methods::Moon_Timeline::KeepSceneLoadedEntity {
IL2CPP_REGISTER_METHOD(0x00417920, UpdateCategory__Enum, get_UpdateCategory, (app::KeepSceneLoadedEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007729F0, void, __ctor, (app::KeepSceneLoadedEntity * this_ptr));
}
