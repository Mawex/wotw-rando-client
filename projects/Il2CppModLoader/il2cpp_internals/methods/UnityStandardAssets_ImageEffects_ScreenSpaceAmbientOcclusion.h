...
namespace app::methods::UnityStandardAssets_ImageEffects::ScreenSpaceAmbientOcclusion {
IL2CPP_REGISTER_METHOD(0x02D61AB0, Material *, CreateMaterial, (app::Shader * shader));
...
IL2CPP_REGISTER_METHOD(0x02D62D60, void, __ctor, (app::ScreenSpaceAmbientOcclusion * this_ptr));
}
