...
IL2CPP_REGISTER_METHOD(0x0241ADD0, bool, GetAllocatorDebugInfo, (int32_t index, app::String * * name, app::uint32_t * allocated_mem, app::uint32_t * reserved_mem, app::uint32_t * alloc_count, app::uint32_t * peak_size));
...
IL2CPP_REGISTER_METHOD(0x0241AF40, bool, MemoryProfileGetBucketSize, (int32_t bucket_index, app::uint32_t * bucket_size));
IL2CPP_REGISTER_METHOD(0x0241AFA0, bool, MemoryProfileGetBucketForLabelIndex, (int32_t label_index, int32_t bucket_index, app::uint32_t * alloc_count));
IL2CPP_REGISTER_METHOD(0x0241B010, bool, MemoryProfileGetInfoForLabelIndex, (int32_t index, app::uint32_t * allocated, app::uint32_t * alloc_count));
...
IL2CPP_REGISTER_METHOD(0x0241B3D0, void, GetNvnPoolStats, (app::Application_NvnBufferUsage__Enum usage_type, app::int32_t * num_pools, app::int32_t * total_size, app::int32_t * used_size));
...
IL2CPP_REGISTER_METHOD(0x0241CD70, AsyncOperation_1 *, LoadLevelAsync_1, (int32_t index));
IL2CPP_REGISTER_METHOD(0x0241CD80, AsyncOperation_1 *, LoadLevelAsync_2, (app::String * level_name));
IL2CPP_REGISTER_METHOD(0x0241CD90, AsyncOperation_1 *, LoadLevelAdditiveAsync, (app::String * level_name));
}
