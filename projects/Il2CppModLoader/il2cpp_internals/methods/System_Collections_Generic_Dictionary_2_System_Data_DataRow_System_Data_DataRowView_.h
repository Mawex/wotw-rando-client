...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_Data_DataRow_System_Data_DataRowView_ {
IL2CPP_REGISTER_METHOD(0x0283AC50, void, __ctor_1, (app::Dictionary_2_System_Data_DataRow_System_Data_DataRowView_ * this_ptr, app::IEqualityComparer_1_System_Data_DataRow_ * comparer));
...
IL2CPP_REGISTER_METHOD(0x02BD24D0, DataRowView *, get_Item, (app::Dictionary_2_System_Data_DataRow_System_Data_DataRowView_ * this_ptr, app::DataRow * key));
...
IL2CPP_REGISTER_METHOD(0x02BD1F00, void, __ctor_2, (app::Dictionary_2_System_Data_DataRow_System_Data_DataRowView_ * this_ptr, int32_t capacity, app::IEqualityComparer_1_System_Data_DataRow_ * comparer));
