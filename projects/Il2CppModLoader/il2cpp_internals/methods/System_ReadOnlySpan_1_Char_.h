...
IL2CPP_REGISTER_METHOD(0x0021A160, void, __ctor_1, (app::ReadOnlySpan_1_Char___Boxed * this_ptr, app::Void * pointer, int32_t length));
IL2CPP_REGISTER_METHODINFO(0x04710458, ReadOnlySpan_1_Char___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00219D80, void, __ctor_2, (app::ReadOnlySpan_1_Char___Boxed * this_ptr, app::Char__Array * array));
IL2CPP_REGISTER_METHOD(0x0021A170, String *, get_DebuggerDisplay, (app::ReadOnlySpan_1_Char___Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00107C00, Pinnable_1_Char_ *, get_Pinnable, (app::ReadOnlySpan_1_Char___Boxed * this_ptr));
