...
namespace app::methods::Newtonsoft_Json_Serialization::JsonDynamicContract {
IL2CPP_REGISTER_METHOD(0x002FBD00, JsonPropertyCollection *, get_Properties, (app::JsonDynamicContract * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD20, Func_2_String_String_ *, get_PropertyNameResolver, (app::JsonDynamicContract * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01870D40, CallSite_1_System_Func_3_ *, CreateCallSiteGetter, (app::String * name));
IL2CPP_REGISTER_METHODINFO(0x04766300, JsonDynamicContract_CreateCallSiteGetter__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01870FC0, CallSite_1_System_Func_4_ *, CreateCallSiteSetter, (app::String * name));
IL2CPP_REGISTER_METHODINFO(0x04745E78, JsonDynamicContract_CreateCallSiteSetter__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01871240, void, __ctor, (app::JsonDynamicContract * this_ptr, app::Type * underlying_type));
