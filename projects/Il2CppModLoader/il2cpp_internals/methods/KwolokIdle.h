...
namespace app::methods::KwolokIdle {
    IL2CPP_REGISTER_METHOD(0x00420EE0, BehaviourStatus__Enum, OnExecuteTask, (app::KwolokIdle * this_ptr, app::IContext* context));
    ...
    IL2CPP_REGISTER_METHOD(0x005B3EC0, void, __ctor, (app::KwolokIdle * this_ptr));
} // namespace app::methods::KwolokIdle
