...
IL2CPP_REGISTER_METHOD(0x0247CFC0, Material *, get_material, (app::CameraFilterPack_Gradients_Stripe * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0247D5E0, void, __ctor, (app::CameraFilterPack_Gradients_Stripe * this_ptr));
}
