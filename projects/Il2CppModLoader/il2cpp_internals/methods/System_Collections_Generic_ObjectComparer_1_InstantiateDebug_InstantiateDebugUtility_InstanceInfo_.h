...
namespace app::methods::System_Collections_Generic::ObjectComparer_1_InstantiateDebug_InstantiateDebugUtility_InstanceInfo_ {
    ...
    IL2CPP_REGISTER_METHOD(0x019F8810, void, __ctor, (app::ObjectComparer_1_InstantiateDebug_InstantiateDebugUtility_InstanceInfo_ * this_ptr));
}
