...
namespace app::methods::System_Collections_Generic::List_1_CageStructureTool_Face_ {
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_CageStructureTool_Face_, GetEnumerator, (app::List_1_CageStructureTool_Face_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04795558, List_1_CageStructureTool_Face__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EFC50, CageStructureTool_Face *, get_Item, (app::List_1_CageStructureTool_Face_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_CageStructureTool_Face_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04709A38, List_1_CageStructureTool_Face___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F05A0, CageStructureTool_Face *, Find, (app::List_1_CageStructureTool_Face_ * this_ptr, app::Predicate_1_CageStructureTool_Face_ * match));
IL2CPP_REGISTER_METHODINFO(0x0475EFD8, List_1_CageStructureTool_Face__Find__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EAEF0, CageStructureTool_Face__Array *, ToArray, (app::List_1_CageStructureTool_Face_ * this_ptr));
