...
IL2CPP_REGISTER_METHOD(0x00720150, MoonAnimator *, get_LeftWeaponAnimator, (app::MeleeWeaponChainsword * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009C8C50, Transform__Array *, GetAnimatorTransforms, (app::MeleeWeaponChainsword * this_ptr));
IL2CPP_REGISTER_METHOD(0x009C8DB0, void, Update, (app::MeleeWeaponChainsword * this_ptr));
IL2CPP_REGISTER_METHOD(0x009C8E70, void, __ctor, (app::MeleeWeaponChainsword * this_ptr));
}
