...
namespace app::methods::Game::Zones {
    IL2CPP_REGISTER_METHOD(0x00687630, EnemyNoGoZone*, GetNoGoZoneAtPoint, (app::Vector3 position));
    ...
    IL2CPP_REGISTER_METHOD(0x00687B40, WaterZone*, GetWaterZoneAtPoint, (app::Vector3 position));
    ...
    IL2CPP_REGISTER_METHOD(0x00687ED0, DigZone*, GetDigZoneAtPoint, (app::Vector3 position));
    IL2CPP_REGISTER_METHOD(0x00688060, bool, IsInDigZone, (app::Vector3 position));
    IL2CPP_REGISTER_METHOD(0x006881F0, DigZone*, GetDigZoneWithinCircle, (app::Vector3 center, float radius));
    ...
    IL2CPP_REGISTER_METHOD(0x00688CD0, NavigationType__Enum, GetZoneTypeAtPoint, (app::Vector3 point));
