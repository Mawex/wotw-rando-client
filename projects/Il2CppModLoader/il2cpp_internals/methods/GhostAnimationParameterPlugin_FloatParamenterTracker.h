...
IL2CPP_REGISTER_METHOD(0x002FA280, FloatAnimationParameter *, get_Parameter, (app::GhostAnimationParameterPlugin_FloatParamenterTracker * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E14010, String *, get_GUID, (app::GhostAnimationParameterPlugin_FloatParamenterTracker * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::GhostAnimationParameterPlugin_FloatParamenterTracker * this_ptr, app::FloatAnimationParameter * parameter));
