...
IL2CPP_REGISTER_METHOD(0x02566EA0, Vector3, RandomPointInsideTriangle, (app::Vector3 a, app::Vector3 b, app::Vector3 c, app::IRng * rng));
IL2CPP_REGISTER_METHOD(0x025672F0, Vector2, UniformSampleTriangle, (app::Vector2 u));
}
