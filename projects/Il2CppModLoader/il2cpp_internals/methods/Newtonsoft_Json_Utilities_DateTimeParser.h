...
namespace app::methods::Newtonsoft_Json_Utilities::DateTimeParser {
...
IL2CPP_REGISTER_METHOD(0x001C24C0, bool, ParseTime, (app::DateTimeParser__Boxed * this_ptr, app::int32_t * start));
IL2CPP_REGISTER_METHOD(0x001C24D0, bool, ParseZone, (app::DateTimeParser__Boxed * this_ptr, int32_t start));
IL2CPP_REGISTER_METHOD(0x001C24E0, bool, Parse4Digit, (app::DateTimeParser__Boxed * this_ptr, int32_t start, app::int32_t * num));
IL2CPP_REGISTER_METHOD(0x001C24F0, bool, Parse2Digit, (app::DateTimeParser__Boxed * this_ptr, int32_t start, app::int32_t * num));
