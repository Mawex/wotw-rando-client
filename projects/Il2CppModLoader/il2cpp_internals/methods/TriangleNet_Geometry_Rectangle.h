...
namespace app::methods::TriangleNet_Geometry::Rectangle {
IL2CPP_REGISTER_METHOD(0x0261DD00, void, __ctor_1, (app::Rectangle * this_ptr));
IL2CPP_REGISTER_METHOD(0x0261DD30, void, __ctor_2, (app::Rectangle * this_ptr, app::Rectangle * other));
IL2CPP_REGISTER_METHOD(0x0261DD80, void, __ctor_3, (app::Rectangle * this_ptr, double x, double y, double width, double height));
