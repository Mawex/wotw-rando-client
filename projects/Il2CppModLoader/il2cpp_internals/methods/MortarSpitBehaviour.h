...
IL2CPP_REGISTER_METHOD(0x0147EF30, BehaviourStatus__Enum, OnExecute, (app::MortarSpitBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0147F750, void, __ctor, (app::MortarSpitBehaviour * this_ptr));
}
