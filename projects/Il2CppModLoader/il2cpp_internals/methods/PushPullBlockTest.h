...
IL2CPP_REGISTER_METHOD(0x00653A60, Vector3, get_Position, (app::PushPullBlockTest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00653A60, Vector3, GetPosition, (app::PushPullBlockTest * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E85520, void, SetPosition, (app::PushPullBlockTest * this_ptr, app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x002FBBA0, Rigidbody *, GetRigidbody, (app::PushPullBlockTest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00736620, SuspendableMask__Enum, get_Mask, (app::PushPullBlockTest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E86AE0, void, __ctor, (app::PushPullBlockTest * this_ptr));
}
