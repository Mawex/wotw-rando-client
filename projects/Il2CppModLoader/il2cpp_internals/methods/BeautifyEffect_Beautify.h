...
IL2CPP_REGISTER_METHOD(0x00654950, BEAUTIFY_PRESET__Enum, get_preset, (app::Beautify * this_ptr));
IL2CPP_REGISTER_METHOD(0x031778D0, void, set_preset, (app::Beautify * this_ptr, app::BEAUTIFY_PRESET__Enum value));
IL2CPP_REGISTER_METHOD(0x00998570, BEAUTIFY_QUALITY__Enum, get_quality, (app::Beautify * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03177980, Color, get_tintColor, (app::Beautify * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03177B30, Color, get_vignettingColor, (app::Beautify * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03177BC0, Color, get_frameColor, (app::Beautify * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03177CB0, Color, get_nightVisionColor, (app::Beautify * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012C4320, Color, get_outlineColor, (app::Beautify * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00660430, Texture2D *, get_lensDirtTexture, (app::Beautify * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011354B0, Camera *, get_cameraEffect, (app::Beautify * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0317AEE0, void, __ctor, (app::Beautify * this_ptr));
}
