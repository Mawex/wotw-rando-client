...
IL2CPP_REGISTER_METHOD(0x006C33A0, SceneManagerScene *, get_PrologueMaster, (app::SkipCutsceneController * this_ptr));
IL2CPP_REGISTER_METHOD(0x006C3570, SceneManagerScene *, get_KuFlyAway, (app::SkipCutsceneController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006C4F50, void, __ctor, (app::SkipCutsceneController * this_ptr));
}
