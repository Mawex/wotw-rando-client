...
IL2CPP_REGISTER_METHOD(0x01319C80, GameObject *, get_Reflectable, (app::ChargeShotCollider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0131A2A0, void, __ctor, (app::ChargeShotCollider * this_ptr));
}
