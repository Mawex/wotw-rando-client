...
namespace app::methods::BuilderEntity {
    IL2CPP_REGISTER_METHOD(0x00816030, ITimelineEntity*, get_CurrentProject, (app::BuilderEntity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00816170, MessageProvider*, get_FinishedProjectMessage, (app::BuilderEntity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00816400, String*, get_DialogActorName, (app::BuilderEntity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00816480, String*, get_InteractionActorName, (app::BuilderEntity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x004173E0, void, __ctor, (app::BuilderEntity * this_ptr));
} // namespace app::methods::BuilderEntity
