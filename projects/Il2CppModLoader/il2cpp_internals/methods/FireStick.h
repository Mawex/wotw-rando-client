...
namespace app::methods::FireStick {
    ...
    IL2CPP_REGISTER_METHOD(0x01259290, IEnumerator*, DropAndDestroy, (app::FireStick * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01259F00, IEnumerator*, DeactivateWithDelay, (app::FireStick * this_ptr, float delay));
    IL2CPP_REGISTER_METHOD(0x0125A060, IEnumerator*, DestroyAfter, (app::FireStick * this_ptr, float time));
    ...
    IL2CPP_REGISTER_METHOD(0x0071F5B0, ThrowAnimationType__Enum, GetAnimationType, (app::FireStick * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0125AE70, GameObject*, GetCurrentSparkPrefab, (app::FireStick * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x04764330, FireStick_GetCurrentSparkPrefab__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x0125AEB0, Vector2, get_PreviusPositionForWaterfallInteraction, (app::FireStick * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0125AF00, Vector2, get_PositionForWaterfallInteraction, (app::FireStick * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00420EE0, WaterfallIntersectionMode__Enum, get_WaterfallIntersectionMode, (app::FireStick * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBC60, Rigidbody*, get_RigidbodyForWaterfallInteraction, (app::FireStick * this_ptr));
    IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, get_IsFlamable, (app::FireStick * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0125B060, Vector2, get_SpeedForWaterfallInteraction, (app::FireStick * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0125B1F0, void, set_SpeedForWaterfallInteraction, (app::FireStick * this_ptr, app::Vector2 value));
    IL2CPP_REGISTER_METHOD(0x0125B350, Rect, get_BoundsForWaterfallInteraction, (app::FireStick * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0125B510, void, OnDrawGizmosSelected, (app::FireStick * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0125B5F0, void, __ctor, (app::FireStick * this_ptr));
} // namespace app::methods::FireStick
