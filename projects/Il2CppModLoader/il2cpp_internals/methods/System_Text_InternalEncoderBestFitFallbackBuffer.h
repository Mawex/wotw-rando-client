...
namespace app::methods::System_Text::InternalEncoderBestFitFallbackBuffer {
IL2CPP_REGISTER_METHOD(0x02458BC0, Object *, get_InternalSyncObject, ());
IL2CPP_REGISTER_METHOD(0x02458D30, void, __ctor, (app::InternalEncoderBestFitFallbackBuffer * this_ptr, app::InternalEncoderBestFitFallback * fallback));
