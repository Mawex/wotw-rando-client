...
namespace app::methods::RootMotion_FinalIK::FBIKChain {
IL2CPP_REGISTER_METHOD(0x0205C2B0, void, __ctor_1, (app::FBIKChain * this_ptr));
IL2CPP_REGISTER_METHOD(0x0205C450, void, __ctor_2, (app::FBIKChain * this_ptr, float pin, float pull, app::Transform__Array * node_transforms));
...
IL2CPP_REGISTER_METHOD(0x0205E910, Vector3, Push, (app::FBIKChain * this_ptr, app::IKSolverFullBody * solver));
...
IL2CPP_REGISTER_METHOD(0x02060060, Vector3, SolveFABRIKJoint, (app::FBIKChain * this_ptr, app::Vector3 pos1, app::Vector3 pos2, float length));
IL2CPP_REGISTER_METHOD(0x02060270, Vector3, GetDirToBendPoint, (app::FBIKChain * this_ptr, app::Vector3 direction, app::Vector3 bend_direction, float direction_magnitude));
