...
namespace app::methods::System_Collections_Generic::List_1_Moon_Race_LeaderBoardEntry_ {
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_1, (app::List_1_Moon_Race_LeaderBoardEntry_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHODINFO(0x04740E90, List_1_Moon_Race_LeaderBoardEntry___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EFC50, LeaderBoardEntry *, get_Item, (app::List_1_Moon_Race_LeaderBoardEntry_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_2, (app::List_1_Moon_Race_LeaderBoardEntry_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047604B0, List_1_Moon_Race_LeaderBoardEntry___ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_Moon_Race_LeaderBoardEntry_ *, GetRange, (app::List_1_Moon_Race_LeaderBoardEntry_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_Moon_Race_LeaderBoardEntry_, GetEnumerator, (app::List_1_Moon_Race_LeaderBoardEntry_ * this_ptr));
