...
IL2CPP_REGISTER_METHOD(0x020A2AE0, String *, get_Message, (app::SocketException * this_ptr));
IL2CPP_REGISTER_METHOD(0x00989BF0, SocketError__Enum, get_SocketErrorCode, (app::SocketException * this_ptr));
}
