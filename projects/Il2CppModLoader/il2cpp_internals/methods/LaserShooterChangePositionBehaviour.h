...
IL2CPP_REGISTER_METHOD(0x00417920, BehaviourStatus__Enum, OnExecute, (app::LaserShooterChangePositionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00F12E70, void, __ctor, (app::LaserShooterChangePositionBehaviour * this_ptr));
}
