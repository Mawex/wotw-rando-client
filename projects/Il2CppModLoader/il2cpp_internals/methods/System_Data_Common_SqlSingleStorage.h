...
namespace app::methods::System_Data_Common::SqlSingleStorage {
IL2CPP_REGISTER_METHOD(0x0285E1B0, void, __ctor, (app::SqlSingleStorage * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x0285E330, Object *, Aggregate, (app::SqlSingleStorage * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x0285F1B0, Object *, ConvertValue, (app::SqlSingleStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02842A10, void, Copy, (app::SqlSingleStorage * this_ptr, int32_t record_no1, int32_t record_no2));
IL2CPP_REGISTER_METHOD(0x0285F270, Object *, Get, (app::SqlSingleStorage * this_ptr, int32_t record));
...
IL2CPP_REGISTER_METHOD(0x0285F480, Object *, ConvertXmlToObject, (app::SqlSingleStorage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x0285F7D0, String *, ConvertObjectToXml, (app::SqlSingleStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x0285FB30, Object *, GetEmptyStorage, (app::SqlSingleStorage * this_ptr, int32_t record_count));
