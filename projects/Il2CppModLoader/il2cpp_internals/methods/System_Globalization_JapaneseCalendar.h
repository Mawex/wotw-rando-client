...
IL2CPP_REGISTER_METHOD(0x02618490, EraInfo__Array *, GetEraInfo, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x00420EE0, EraInfo__Array *, GetErasFromRegistry, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x02618C00, Calendar *, GetDefaultInstance, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x02619280, String__Array *, EraNames, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x026193F0, String__Array *, AbbrevEraNames, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x02619560, String__Array *, EnglishEraNames, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x026197D0, void, __cctor, (MethodInfo * method));
}
