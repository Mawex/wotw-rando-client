...
IL2CPP_REGISTER_METHOD(0x02751EA0, Material *, get_material, (app::CameraFilterPack_Blend2Camera_LighterColor * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02753070, void, __ctor, (app::CameraFilterPack_Blend2Camera_LighterColor * this_ptr));
}
