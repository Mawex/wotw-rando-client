...
IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkAcousticSurface * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x026C3FA0, void *, getCPtr, (app::AkAcousticSurface * obj));
IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkAcousticSurface * this_ptr, app::void * c_ptr));
...
IL2CPP_REGISTER_METHOD(0x026C42C0, void, __ctor_2, (app::AkAcousticSurface * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x026C4A80, String *, get_strName, (app::AkAcousticSurface * this_ptr));
