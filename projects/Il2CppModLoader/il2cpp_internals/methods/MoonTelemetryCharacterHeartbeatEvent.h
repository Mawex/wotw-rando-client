...
IL2CPP_REGISTER_METHOD(0x00756A30, String *, get_Name, (app::MoonTelemetryCharacterHeartbeatEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0146BF10, void, __ctor, (app::MoonTelemetryCharacterHeartbeatEvent * this_ptr));
IL2CPP_REGISTER_METHOD(0x0146C100, void, __cctor, ());
}
