...
namespace app::methods::Steamworks::SNetListenSocket_t {
    IL2CPP_REGISTER_METHOD(0x0010DB80, void, __ctor, (app::SNetListenSocket_t__Boxed * this_ptr, uint32_t value));
    ...
    IL2CPP_REGISTER_METHOD(0x015F7650, bool, operator____1, (app::SNetListenSocket_t x, app::SNetListenSocket_t y));
    IL2CPP_REGISTER_METHOD(0x015F7660, bool, operator____2, (app::SNetListenSocket_t x, app::SNetListenSocket_t y));
    IL2CPP_REGISTER_METHOD(0x006CE970, app::SNetListenSocket_t, operator__1, (uint32_t value));
    IL2CPP_REGISTER_METHOD(0x006CE970, uint32_t, operator__2, (app::SNetListenSocket_t that));
