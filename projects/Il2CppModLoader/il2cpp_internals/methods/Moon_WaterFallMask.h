...
IL2CPP_REGISTER_METHOD(0x011A7930, Vector3, get_RootPosition, (app::WaterFallMask * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011A8110, SuspendableMask__Enum, get_Mask, (app::WaterFallMask * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011AA040, bool, AgentIntersectRect, (app::WaterFallMask * this_ptr, app::IWaterfallInteractionAgent * current_agent, app::WaterFallMask_WaterLineGroup * water_line, app::Vector2 * intersection_point, app::bool * tunnel_through));
IL2CPP_REGISTER_METHOD(0x011AA2F0, void, SetShaderProperties, (app::WaterFallMask * this_ptr));
IL2CPP_REGISTER_METHOD(0x011AA5D0, Vector3, GetStartPositionForLine, (app::WaterFallMask * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x011AA750, void, ComputeMaskTransform, (app::WaterFallMask * this_ptr, int32_t idx));
IL2CPP_REGISTER_METHOD(0x011AABD0, ParticleSystem *, CreateStaticCollisionEffect, (app::WaterFallMask * this_ptr, app::Vector2 position, app::Vector2 normal));
...
IL2CPP_REGISTER_METHOD(0x011AB230, Bounds, get_Bounds, (app::WaterFallMask * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011AB580, void, __ctor, (app::WaterFallMask * this_ptr));
}
