...
IL2CPP_REGISTER_METHOD(0x00AD8BA0, RecorderFrame_FrameDataTypes__Enum, FrameType, (app::CheckpointData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::CheckpointData * this_ptr));
}
