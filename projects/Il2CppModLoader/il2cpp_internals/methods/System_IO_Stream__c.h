...
namespace app::methods::System_IO::Stream___c {
IL2CPP_REGISTER_METHOD(0x0237DF10, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::Stream_c * this_ptr));
IL2CPP_REGISTER_METHOD(0x0237E050, SemaphoreSlim *, _EnsureAsyncActiveSemaphoreInitialized_b__4_0, (app::Stream_c * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0237E3C0, IAsyncResult *, _BeginEndReadAsync_b__43_0, (app::Stream_c * this_ptr, app::Stream * stream, app::Stream_ReadWriteParameters args, app::AsyncCallback * callback, app::Object * state));
...
IL2CPP_REGISTER_METHOD(0x0237E650, IAsyncResult *, _BeginEndWriteAsync_b__53_0, (app::Stream_c * this_ptr, app::Stream * stream, app::Stream_ReadWriteParameters args, app::AsyncCallback * callback, app::Object * state));
IL2CPP_REGISTER_METHODINFO(0x0471EB18, Stream_c__BeginEndWriteAsync_b__53_0__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0237E6C0, VoidTaskResult, _BeginEndWriteAsync_b__53_1, (app::Stream_c * this_ptr, app::Stream * stream, app::IAsyncResult * async_result));
