...
namespace app::methods::Moon_Animation::NativeVerletAnimationPostprocess {
...
IL2CPP_REGISTER_METHOD(0x00ABE2D0, AnimationVerletPlayable, get_Playable, (app::NativeVerletAnimationPostprocess * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B02810, Playable, ConstructPlayable, (app::NativeVerletAnimationPostprocess * this_ptr, app::PlayableGraph playable_graph));
...
IL2CPP_REGISTER_METHOD(0x01B03160, void, __ctor, (app::NativeVerletAnimationPostprocess * this_ptr));
