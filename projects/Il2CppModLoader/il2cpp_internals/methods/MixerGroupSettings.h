...
IL2CPP_REGISTER_METHOD(0x001263D0, void, SetFloatConditional, (app::MixerGroupSettings__Boxed * this_ptr, app::AudioMixer * mixer, app::String * str, float val, app::float * cache));
