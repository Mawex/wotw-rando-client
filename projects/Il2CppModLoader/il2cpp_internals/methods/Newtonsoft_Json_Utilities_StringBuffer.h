...
namespace app::methods::Newtonsoft_Json_Utilities::StringBuffer {
...
IL2CPP_REGISTER_METHOD(0x002409C0, void, __ctor_1, (app::StringBuffer__Boxed * this_ptr, app::IArrayPool_1_System_Char_ * buffer_pool, int32_t inital_size));
IL2CPP_REGISTER_METHOD(0x002409F0, void, __ctor_2, (app::StringBuffer__Boxed * this_ptr, app::Char__Array * buffer));
...
IL2CPP_REGISTER_METHOD(0x00240AD0, String *, ToString_1, (app::StringBuffer__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00240B00, String *, ToString_2, (app::StringBuffer__Boxed * this_ptr, int32_t start, int32_t length));
IL2CPP_REGISTER_METHOD(0x00107C00, Char__Array *, get_InternalBuffer, (app::StringBuffer__Boxed * this_ptr));
}
