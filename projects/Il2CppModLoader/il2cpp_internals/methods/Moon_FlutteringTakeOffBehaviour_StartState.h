...
IL2CPP_REGISTER_METHOD(0x01488500, void, __ctor, (app::FlutteringTakeOffBehaviour_StartState * this_ptr, app::FlutteringTakeOffBehaviour * behaviour));
...
IL2CPP_REGISTER_METHOD(0x00B68B50, Vector3, ProcessRootMotion, (app::FlutteringTakeOffBehaviour_StartState * this_ptr, app::Vector3 motion));
