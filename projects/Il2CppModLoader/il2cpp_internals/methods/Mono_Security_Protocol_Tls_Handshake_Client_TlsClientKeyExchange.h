...
namespace app::methods::Mono_Security_Protocol_Tls_Handshake_Client::TlsClientKeyExchange {
    IL2CPP_REGISTER_METHOD(0x01F6C890, void, __ctor, (app::TlsClientKeyExchange_1 * this_ptr, app::Context_1 * context));
