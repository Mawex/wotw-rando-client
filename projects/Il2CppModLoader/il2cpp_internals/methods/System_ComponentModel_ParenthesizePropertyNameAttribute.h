...
namespace app::methods::System_ComponentModel::ParenthesizePropertyNameAttribute {
IL2CPP_REGISTER_METHOD(0x00531660, void, __ctor_1, (app::ParenthesizePropertyNameAttribute * this_ptr));
IL2CPP_REGISTER_METHOD(0x0052C650, void, __ctor_2, (app::ParenthesizePropertyNameAttribute * this_ptr, bool need_parenthesis));
...
IL2CPP_REGISTER_METHOD(0x02991EB0, void, __cctor, ());
}
