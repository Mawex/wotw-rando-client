...
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_SchemeName, (app::UriParser * this_ptr));
IL2CPP_REGISTER_METHOD(0x0052A010, int32_t, get_DefaultPort, (app::UriParser * this_ptr));
IL2CPP_REGISTER_METHOD(0x004C50A0, UriParser *, OnNewUri, (app::UriParser * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0319DF20, String *, Resolve, (app::UriParser * this_ptr, app::Uri * base_uri, app::Uri * relative_uri, app::UriFormatException * * parsing_error));
IL2CPP_REGISTER_METHODINFO(0x04703B48, UriParser_Resolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0319E150, String *, GetComponents, (app::UriParser * this_ptr, app::Uri * uri, app::UriComponents__Enum components, app::UriFormat__Enum format));
...
IL2CPP_REGISTER_METHOD(0x002FC6D0, UriSyntaxFlags__Enum, get_Flags, (app::UriParser * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0319FDB0, void, __ctor, (app::UriParser * this_ptr, app::UriSyntaxFlags__Enum flags));
IL2CPP_REGISTER_METHOD(0x0319FE50, UriParser *, FindOrFetchAsUnknownV1Syntax, (app::String * lwr_case_scheme));
IL2CPP_REGISTER_METHOD(0x031A03F0, UriParser *, GetSyntax, (app::String * lwr_case_scheme));
IL2CPP_REGISTER_METHOD(0x031A05C0, bool, get_IsSimple, (app::UriParser * this_ptr));
IL2CPP_REGISTER_METHOD(0x031A05D0, UriParser *, InternalOnNewUri, (app::UriParser * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x029449B0, String *, InternalResolve, (app::UriParser * this_ptr, app::Uri * this_base_uri, app::Uri * uri_link, app::UriFormatException * * parsing_error));
IL2CPP_REGISTER_METHOD(0x031A0640, String *, InternalGetComponents, (app::UriParser * this_ptr, app::Uri * this_uri, app::UriComponents__Enum uri_components, app::UriFormat__Enum uri_format));
