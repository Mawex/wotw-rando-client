...
namespace app::methods::Game::Targets {
    IL2CPP_REGISTER_METHOD(0x00682C30, IEnumerable_1_IAttackable_*, get_Attackables, ());
    ...
    IL2CPP_REGISTER_METHOD(0x00683C40, List_1_IAttackable_*, GetAttackableConsumerList, (app::IAttackableConsumer * consumer));
    ...
    IL2CPP_REGISTER_METHOD(0x00684370, void, __cctor, ());
} // namespace app::methods::Game::Targets
