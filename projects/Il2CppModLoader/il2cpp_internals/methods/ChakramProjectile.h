...
IL2CPP_REGISTER_METHOD(0x01040060, IBowAttackable *, GetClosestTarget, (app::ChakramProjectile * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01040DA0, void, __ctor, (app::ChakramProjectile * this_ptr));
}
