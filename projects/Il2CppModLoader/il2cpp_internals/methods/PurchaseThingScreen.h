...
IL2CPP_REGISTER_METHOD(0x00420EE0, CleverMenuItemSelectionManager *, get_NavigationManager, (app::PurchaseThingScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C81B90, void, __ctor, (app::PurchaseThingScreen * this_ptr));
}
