...
namespace app::methods::frameworks_loading_Prewarmers::GameplaySystemsScenePreloadPrewarmOperation {
IL2CPP_REGISTER_METHOD(0x00F5F9B0, void, __ctor, (app::GameplaySystemsScenePreloadPrewarmOperation * this_ptr));
IL2CPP_REGISTER_METHOD(0x00F5FA80, bool, Begin, (app::GameplaySystemsScenePreloadPrewarmOperation * this_ptr));
IL2CPP_REGISTER_METHOD(0x00F5FB50, AsyncOperation_1 *, LoadScene, (app::GameplaySystemsScenePreloadPrewarmOperation * this_ptr, app::String * scene_name));
