...
IL2CPP_REGISTER_METHOD(0x020EEDE0, Material *, get_material, (app::CameraFilterPack_TV_VHS_Rewind * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020EF730, void, __ctor, (app::CameraFilterPack_TV_VHS_Rewind * this_ptr));
}
