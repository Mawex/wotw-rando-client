...
namespace app::methods::System_Data::DataView_DataRowReferenceComparer {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::DataView_DataRowReferenceComparer * this_ptr));
