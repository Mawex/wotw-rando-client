...
IL2CPP_REGISTER_METHOD(0x024DA880, Material *, get_material, (app::CameraFilterPack_Color_Noise * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024DB0F0, void, __ctor, (app::CameraFilterPack_Color_Noise * this_ptr));
}
