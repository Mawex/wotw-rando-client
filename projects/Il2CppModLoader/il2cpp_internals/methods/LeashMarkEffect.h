...
IL2CPP_REGISTER_METHOD(0x015C6F40, IEnumerator *, DelayedDestroyInactive, (app::LeashMarkEffect * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00444DD0, void, __ctor, (app::LeashMarkEffect * this_ptr));
