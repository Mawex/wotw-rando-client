...
IL2CPP_REGISTER_METHOD(0x002FA280, MoonGuid *, get_Guid, (app::GhostStateMachineData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007E9400, void, __ctor_1, (app::GhostStateMachineData * this_ptr));
IL2CPP_REGISTER_METHOD(0x007E94D0, void, __ctor_2, (app::GhostStateMachineData * this_ptr, app::StateMachine_2 * state_machine));
IL2CPP_REGISTER_METHOD(0x007E95D0, void, __ctor_3, (app::GhostStateMachineData * this_ptr, app::StateMachine_2 * state_machine, int32_t event_id));
...
IL2CPP_REGISTER_METHOD(0x007E9990, GhostFrame_FrameDataTypes__Enum, get_FrameType, (app::GhostStateMachineData * this_ptr));
