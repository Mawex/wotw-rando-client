...
namespace app::methods::LandOnLogic {
    IL2CPP_REGISTER_METHOD(0x002FB9D0, IMoonSetupAnimator*, get_MoonSetupAnimator, (app::LandOnLogic * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00F02980, void, __ctor, (app::LandOnLogic * this_ptr));
} // namespace app::methods::LandOnLogic
