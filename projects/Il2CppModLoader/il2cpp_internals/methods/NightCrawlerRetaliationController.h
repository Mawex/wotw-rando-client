...
IL2CPP_REGISTER_METHOD(0x00608180, Enum__Array *, GetEntries, (app::NightCrawlerRetaliationController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00608590, Enum, Evaluate, (app::NightCrawlerRetaliationController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006086C0, void, __ctor, (app::NightCrawlerRetaliationController * this_ptr));
}
