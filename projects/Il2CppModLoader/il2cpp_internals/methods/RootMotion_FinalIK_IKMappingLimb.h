...
namespace app::methods::RootMotion_FinalIK::IKMappingLimb {
IL2CPP_REGISTER_METHOD(0x02BDEE00, bool, IsValid, (app::IKMappingLimb * this_ptr, app::IKSolver * solver, app::String * * message));
IL2CPP_REGISTER_METHOD(0x02BDEEA0, IKMapping_BoneMap *, GetBoneMap, (app::IKMappingLimb * this_ptr, app::IKMappingLimb_BoneMapType__Enum bone_map));
IL2CPP_REGISTER_METHOD(0x02BDEFB0, void, SetLimbOrientation, (app::IKMappingLimb * this_ptr, app::Vector3 upper, app::Vector3 lower));
IL2CPP_REGISTER_METHOD(0x02BDFA20, void, __ctor_1, (app::IKMappingLimb * this_ptr));
IL2CPP_REGISTER_METHOD(0x02BDFE40, void, __ctor_2, (app::IKMappingLimb * this_ptr, app::Transform * bone1, app::Transform * bone2, app::Transform * bone3, app::Transform * parent_bone));
