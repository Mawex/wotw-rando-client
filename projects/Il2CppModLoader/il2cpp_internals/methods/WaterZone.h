...
namespace app::methods::WaterZone {
    ...
    IL2CPP_REGISTER_METHOD(0x008E62C0, Vector2, GetPositionClosestToWaterZone, (app::Vector2 position));
    IL2CPP_REGISTER_METHOD(0x008E6540, bool, TryGetWaterZone, (app::Vector3 position, app::WaterZone** found_water_zone));
    IL2CPP_REGISTER_METHOD(0x008E6700, WaterZone*, GetWaterZone, (app::Vector3 position));
    ...
    IL2CPP_REGISTER_METHOD(0x008E6B00, Vector2, GetVelocityAtPoint, (app::WaterZone * this_ptr, app::Vector2 point));
    ...
    IL2CPP_REGISTER_METHOD(0x008E77B0, NavigationType__Enum, AreaType, (app::WaterZone * this_ptr));
    IL2CPP_REGISTER_METHOD(0x008E77C0, bool, ContainsPoint, (app::WaterZone * this_ptr, app::Vector2 point));
    IL2CPP_REGISTER_METHOD(0x008E78A0, Vector2, ClosestPoint, (app::WaterZone * this_ptr, app::Vector2 point));
    IL2CPP_REGISTER_METHOD(0x0043D9A0, SelectableCategory__Enum, get_Category, (app::WaterZone * this_ptr));
    IL2CPP_REGISTER_METHOD(0x008E79B0, void, __ctor, (app::WaterZone * this_ptr));
} // namespace app::methods::WaterZone
