...
namespace app::methods::RootMotion_Demos::PlatformRotator {
...
IL2CPP_REGISTER_METHOD(0x0222DE60, IEnumerator *, SwitchRotation, (app::PlatformRotator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0222E290, void, __ctor, (app::PlatformRotator * this_ptr));
}
