...
namespace app::methods::Moon_Telemetry_Performance_Settings::LowResolutionProfilingSetting {
IL2CPP_REGISTER_METHOD(0x006FD6F0, ProfilingSettings_SettingType__Enum, get_SettingType, (app::LowResolutionProfilingSetting * this_ptr));
