...
IL2CPP_REGISTER_METHOD(0x002FB950, SeinBlazeSpell_BalancingData_BlazeSettings *, GetCurrentBlazeSettings, (app::SeinBlazeSpell_BalancingData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004140E0, void, __ctor, (app::SeinBlazeSpell_BalancingData * this_ptr));
}
