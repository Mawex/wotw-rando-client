...
IL2CPP_REGISTER_METHOD(0x01542BC0, Task_1_System_Boolean_ *, CreateCacheableTask, (bool result));
IL2CPP_REGISTER_METHODINFO(0x04787980, AsyncTaskCache_CreateCacheableTask_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01542E00, Task_1_System_Nullable_1_ *, CreateCacheableTask, (Nullable_1_Int32_ result));
IL2CPP_REGISTER_METHOD(0x01543040, Task_1_VoidTaskResult_ *, CreateCacheableTask, (VoidTaskResult result));
}
