...
IL2CPP_REGISTER_METHOD(0x024F03F0, Material *, get_material, (app::CameraFilterPack_Drawing_Crosshatch * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0248A900, void, __ctor, (app::CameraFilterPack_Drawing_Crosshatch * this_ptr));
}
