...
IL2CPP_REGISTER_METHOD(0x00601A30, Vector3, get_KnockbackForceDirection, (app::NightCrawlerChaseController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::NightCrawlerChaseController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, IMoonTypeResolver *, GetResolverForType_1, (app::NightCrawlerChaseController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, IMoonTypeResolver *, GetResolverForType_2, (app::NightCrawlerChaseController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, IMoonTypeResolver *, GetResolverForType_3, (app::NightCrawlerChaseController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, IMoonTypeResolver *, GetResolverForType_4, (app::NightCrawlerChaseController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, IMoonTypeResolver *, GetResolverForType_5, (app::NightCrawlerChaseController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, IMoonTypeResolver *, GetResolverForType_6, (app::NightCrawlerChaseController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, IMoonTypeResolver *, GetResolverForType_7, (app::NightCrawlerChaseController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, IMoonTypeResolver *, GetResolverForType_8, (app::NightCrawlerChaseController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, IMoonTypeResolver *, GetResolverForType_9, (app::NightCrawlerChaseController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, IMoonTypeResolver *, GetResolverForType_10, (app::NightCrawlerChaseController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, IMoonTypeResolver *, GetResolverForType_11, (app::NightCrawlerChaseController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, IMoonTypeResolver *, GetResolverForType_12, (app::NightCrawlerChaseController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, IMoonTypeResolver *, GetResolverForType_13, (app::NightCrawlerChaseController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, IMoonTypeResolver *, GetResolverForType_14, (app::NightCrawlerChaseController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, IMoonTypeResolver *, GetResolverForType_15, (app::NightCrawlerChaseController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, IMoonTypeResolver *, GetResolverForType_16, (app::NightCrawlerChaseController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, IMoonTypeResolver *, GetResolverForType_17, (app::NightCrawlerChaseController * this_ptr));
}
