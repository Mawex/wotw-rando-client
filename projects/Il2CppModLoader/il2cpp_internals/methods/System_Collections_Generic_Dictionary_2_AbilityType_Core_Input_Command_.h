...
namespace app::methods::System_Collections_Generic::Dictionary_2_AbilityType_Core_Input_Command_ {
...
IL2CPP_REGISTER_METHOD(0x02EA3DB0, Input_Command__Enum, get_Item, (app::Dictionary_2_AbilityType_Core_Input_Command_ * this_ptr, app::AbilityType__Enum key));
...
IL2CPP_REGISTER_METHOD(0x0283AC50, void, __ctor, (app::Dictionary_2_AbilityType_Core_Input_Command_ * this_ptr, app::IEqualityComparer_1_AbilityType_ * comparer));
