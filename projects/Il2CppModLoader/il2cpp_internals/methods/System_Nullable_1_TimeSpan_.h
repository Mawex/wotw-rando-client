...
IL2CPP_REGISTER_METHOD(0x00107C00, TimeSpan, GetValueOrDefault_1, (app::Nullable_1_TimeSpan___Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00210020, TimeSpan, get_Value, (app::Nullable_1_TimeSpan___Boxed * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047958B8, Nullable_1_TimeSpan__get_Value__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor, (app::Nullable_1_TimeSpan___Boxed * this_ptr, app::TimeSpan value));
...
IL2CPP_REGISTER_METHOD(0x001F8BF0, TimeSpan, GetValueOrDefault_2, (app::Nullable_1_TimeSpan___Boxed * this_ptr, app::TimeSpan default_value));
IL2CPP_REGISTER_METHOD(0x00210240, String *, ToString, (app::Nullable_1_TimeSpan___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x02551710, Object *, Box, (app::Nullable_1_TimeSpan_ o));
IL2CPP_REGISTER_METHOD(0x02551790, Nullable_1_TimeSpan_, Unbox, (app::Object * o));
}
