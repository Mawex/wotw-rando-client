...
IL2CPP_REGISTER_METHOD(0x00E207C0, Vector3, get_TargetPositon, (app::GhostIndicator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00723FF0, void, __ctor, (app::GhostIndicator * this_ptr));
}
