...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::BrowserNative_Calltype_zfb_sendCommandToFocusedFrame * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x01DCAAA0, IAsyncResult *, BeginInvoke, (app::BrowserNative_Calltype_zfb_sendCommandToFocusedFrame * this_ptr, int32_t id, app::BrowserNative_FrameCommand__Enum command, app::AsyncCallback * callback, app::Object * object));
