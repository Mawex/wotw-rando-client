...
IL2CPP_REGISTER_METHOD(0x00C39EB0, BaseAnimator *, GetRandomStepAnimator, (app::PetrifiedOwlSideStepBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C3A1C0, void, __ctor, (app::PetrifiedOwlSideStepBehaviour * this_ptr));
}
