...
namespace app::methods::System_Data_SqlTypes::SqlBinary {
IL2CPP_REGISTER_METHOD(0x00120B90, void, __ctor_1, (app::SqlBinary__Boxed * this_ptr, bool f_null));
IL2CPP_REGISTER_METHOD(0x001D5C30, void, __ctor_2, (app::SqlBinary__Boxed * this_ptr, app::Byte__Array * value));
IL2CPP_REGISTER_METHOD(0x001D5C40, bool, get_IsNull, (app::SqlBinary__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001D5C50, Byte__Array *, get_Value, (app::SqlBinary__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E4E990, SqlBinary, operator_, (app::Byte__Array * x));
IL2CPP_REGISTER_METHOD(0x001D5D10, String *, ToString, (app::SqlBinary__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E4EAA0, EComparison__Enum, PerformCompareByte, (app::Byte__Array * x, app::Byte__Array * y));
IL2CPP_REGISTER_METHOD(0x01E4EBD0, SqlBoolean, operator___, (app::SqlBinary x, app::SqlBinary y));
IL2CPP_REGISTER_METHOD(0x01E4ECF0, SqlBoolean, operator___1, (app::SqlBinary x, app::SqlBinary y));
IL2CPP_REGISTER_METHOD(0x01E4EE10, SqlBoolean, operator___2, (app::SqlBinary x, app::SqlBinary y));
IL2CPP_REGISTER_METHOD(0x001D5D20, SqlGuid, ToSqlGuid, (app::SqlBinary__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0013BB70, XmlSchema *, IXmlSerializable_GetSchema, (app::SqlBinary__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E4F870, XmlQualifiedName *, GetXsdType, (app::XmlSchemaSet * schema_set));
