...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::PointerUIBase {
...
IL2CPP_REGISTER_METHOD(0x01661300, Vector2, get_MousePosition, (app::PointerUIBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x01661320, void, set_MousePosition, (app::PointerUIBase * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x0062C500, MouseButton__Enum, get_MouseButtons, (app::PointerUIBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x0062C510, void, set_MouseButtons, (app::PointerUIBase * this_ptr, app::MouseButton__Enum value));
IL2CPP_REGISTER_METHOD(0x01661350, Vector2, get_MouseScroll, (app::PointerUIBase * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005E07A0, List_1_UnityEngine_Event_ *, get_KeyEvents, (app::PointerUIBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD20, BrowserCursor *, get_BrowserCursor, (app::PointerUIBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD30, void, set_BrowserCursor, (app::PointerUIBase * this_ptr, app::BrowserCursor * value));
IL2CPP_REGISTER_METHOD(0x002FBD40, BrowserInputSettings *, get_InputSettings, (app::PointerUIBase * this_ptr));
