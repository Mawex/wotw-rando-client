...
IL2CPP_REGISTER_METHOD(0x00785FB0, SoundHost *, get_EffectiveSoundHost, (app::ShowFixedTimeTextEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x007860F0, float, get_Duration, (app::ShowFixedTimeTextEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x007862F0, MessageProvider *, get_Message, (app::ShowFixedTimeTextEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x007863B0, MessageControllerB_NpcMessageStyle__Enum, get_Style, (app::ShowFixedTimeTextEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00787BD0, MoonTimeline *, get_ParentTimeline, (app::ShowFixedTimeTextEntity * this_ptr));
