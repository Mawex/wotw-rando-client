...
namespace app::methods::System_Collections_Generic::List_1_Condition_ {
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_Condition_, GetEnumerator, (app::List_1_Condition_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04776380, List_1_Condition__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_Condition_ * this_ptr));
