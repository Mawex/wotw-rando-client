...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::Transform * this_ptr));
IL2CPP_REGISTER_METHOD(0x02C6AD30, Vector3, get_position, (app::Transform * this_ptr));
IL2CPP_REGISTER_METHOD(0x02C6ADB0, void, set_position, (app::Transform * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x02C6AE10, Vector3, get_localPosition, (app::Transform * this_ptr));
IL2CPP_REGISTER_METHOD(0x02C6AE90, void, set_localPosition, (app::Transform * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x02C6AEF0, Vector3, GetLocalEulerAngles, (app::Transform * this_ptr, app::RotationOrder__Enum order));
...
IL2CPP_REGISTER_METHOD(0x02C6C150, RotationOrder__Enum, get_rotationOrder, (app::Transform * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C6C200, Vector3, get_localScale, (app::Transform * this_ptr));
IL2CPP_REGISTER_METHOD(0x02C6C280, void, set_localScale, (app::Transform * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x02C6C2E0, Transform *, get_parent, (app::Transform * this_ptr));
IL2CPP_REGISTER_METHOD(0x02C6C330, void, set_parent, (app::Transform * this_ptr, app::Transform * value));
IL2CPP_REGISTER_METHOD(0x02C6C2E0, Transform *, get_parentInternal, (app::Transform * this_ptr));
IL2CPP_REGISTER_METHOD(0x02C6C450, void, set_parentInternal, (app::Transform * this_ptr, app::Transform * value));
IL2CPP_REGISTER_METHOD(0x02C6C2E0, Transform *, GetParent, (app::Transform * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C6C540, Matrix4x4, get_worldToLocalMatrix, (app::Transform * this_ptr));
IL2CPP_REGISTER_METHOD(0x02C6C5F0, Matrix4x4, get_localToWorldMatrix, (app::Transform * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C6E150, Vector3, TransformDirection_1, (app::Transform * this_ptr, app::Vector3 direction));
IL2CPP_REGISTER_METHOD(0x02C6E1E0, Vector3, TransformDirection_2, (app::Transform * this_ptr, float x, float y, float z));
IL2CPP_REGISTER_METHOD(0x02C6E290, Vector3, InverseTransformDirection_1, (app::Transform * this_ptr, app::Vector3 direction));
IL2CPP_REGISTER_METHOD(0x02C6E320, Vector3, InverseTransformDirection_2, (app::Transform * this_ptr, float x, float y, float z));
IL2CPP_REGISTER_METHOD(0x02C6E3D0, Vector3, TransformVector_1, (app::Transform * this_ptr, app::Vector3 vector));
IL2CPP_REGISTER_METHOD(0x02C6E460, Vector3, TransformVector_2, (app::Transform * this_ptr, float x, float y, float z));
IL2CPP_REGISTER_METHOD(0x02C6E510, Vector3, InverseTransformVector_1, (app::Transform * this_ptr, app::Vector3 vector));
IL2CPP_REGISTER_METHOD(0x02C6E5A0, Vector3, InverseTransformVector_2, (app::Transform * this_ptr, float x, float y, float z));
IL2CPP_REGISTER_METHOD(0x02C6E650, Vector3, TransformPoint_1, (app::Transform * this_ptr, app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x02C6E6E0, Vector3, TransformPoint_2, (app::Transform * this_ptr, float x, float y, float z));
IL2CPP_REGISTER_METHOD(0x02C6E790, Vector3, InverseTransformPoint_1, (app::Transform * this_ptr, app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x02C6E820, Vector3, InverseTransformPoint_2, (app::Transform * this_ptr, float x, float y, float z));
IL2CPP_REGISTER_METHOD(0x02C6E8D0, Transform *, get_root, (app::Transform * this_ptr));
IL2CPP_REGISTER_METHOD(0x02C6E8D0, Transform *, GetRoot, (app::Transform * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C6EB10, Transform *, FindRelativeTransformWithPath, (app::Transform * transform, app::String * path, bool is_active_only));
IL2CPP_REGISTER_METHOD(0x02C6EB90, Transform *, Find, (app::Transform * this_ptr, app::String * n));
...
IL2CPP_REGISTER_METHOD(0x02C6ECE0, Vector3, get_lossyScale, (app::Transform * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C6EE70, Transform *, FindChild, (app::Transform * this_ptr, app::String * n));
IL2CPP_REGISTER_METHOD(0x02C6EE80, IEnumerator *, GetEnumerator, (app::Transform * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C6F0B0, Transform *, GetChild, (app::Transform * this_ptr, int32_t index));
