...
namespace app::methods::ZenFulcrum_VR_OpenVRBinding::CVRCompositor {
IL2CPP_REGISTER_METHOD(0x01677C10, void, __ctor, (app::CVRCompositor * this_ptr, app::void * p_interface));
...
IL2CPP_REGISTER_METHOD(0x01677DE0, ETrackingUniverseOrigin__Enum, GetTrackingSpace, (app::CVRCompositor * this_ptr));
IL2CPP_REGISTER_METHOD(0x01677E00, EVRCompositorError__Enum, WaitGetPoses, (app::CVRCompositor * this_ptr, app::TrackedDevicePose_t__Array * p_render_pose_array, app::TrackedDevicePose_t__Array * p_game_pose_array));
IL2CPP_REGISTER_METHOD(0x01677E50, EVRCompositorError__Enum, GetLastPoses, (app::CVRCompositor * this_ptr, app::TrackedDevicePose_t__Array * p_render_pose_array, app::TrackedDevicePose_t__Array * p_game_pose_array));
IL2CPP_REGISTER_METHOD(0x01677EA0, EVRCompositorError__Enum, GetLastPoseForTrackedDeviceIndex, (app::CVRCompositor * this_ptr, uint32_t un_device_index, app::TrackedDevicePose_t * p_output_pose, app::TrackedDevicePose_t * p_output_game_pose));
IL2CPP_REGISTER_METHOD(0x01677ED0, EVRCompositorError__Enum, Submit, (app::CVRCompositor * this_ptr, app::EVREye__Enum e_eye, app::Texture_t * p_texture, app::VRTextureBounds_t * p_bounds, app::EVRSubmitFlags__Enum n_submit_flags));
...
IL2CPP_REGISTER_METHOD(0x01677FE0, HmdColor_t, GetCurrentFadeColor, (app::CVRCompositor * this_ptr, bool b_background));
...
IL2CPP_REGISTER_METHOD(0x01678080, EVRCompositorError__Enum, SetSkyboxOverride, (app::CVRCompositor * this_ptr, app::Texture_t__Array * p_textures));
...
IL2CPP_REGISTER_METHOD(0x016783C0, EVRCompositorError__Enum, GetMirrorTextureD3D11, (app::CVRCompositor * this_ptr, app::EVREye__Enum e_eye, app::void * p_d3_d11_device_or_resource, app::void * * pp_d3_d11_shader_resource_view));
IL2CPP_REGISTER_METHOD(0x016783F0, void, ReleaseMirrorTextureD3D11, (app::CVRCompositor * this_ptr, app::void * p_d3_d11_shader_resource_view));
IL2CPP_REGISTER_METHOD(0x01678420, EVRCompositorError__Enum, GetMirrorTextureGL, (app::CVRCompositor * this_ptr, app::EVREye__Enum e_eye, app::uint32_t * pgl_texture_id, app::void * pgl_shared_texture_handle));
IL2CPP_REGISTER_METHOD(0x01678450, bool, ReleaseSharedGLTexture, (app::CVRCompositor * this_ptr, uint32_t gl_texture_id, app::void * gl_shared_texture_handle));
IL2CPP_REGISTER_METHOD(0x01678480, void, LockGLSharedTextureForAccess, (app::CVRCompositor * this_ptr, app::void * gl_shared_texture_handle));
IL2CPP_REGISTER_METHOD(0x016784B0, void, UnlockGLSharedTextureForAccess, (app::CVRCompositor * this_ptr, app::void * gl_shared_texture_handle));
...
IL2CPP_REGISTER_METHOD(0x01678510, uint32_t, GetVulkanDeviceExtensionsRequired, (app::CVRCompositor * this_ptr, app::void * p_physical_device, app::StringBuilder * pch_value, uint32_t un_buffer_size));
IL2CPP_REGISTER_METHOD(0x01678540, void, SetExplicitTimingMode, (app::CVRCompositor * this_ptr, bool b_explicit_timing_mode));
IL2CPP_REGISTER_METHOD(0x01678570, EVRCompositorError__Enum, SubmitExplicitTimingData, (app::CVRCompositor * this_ptr));
}
