...
namespace app::methods::Moon_Timeline::TransformAnimatorEntity {
IL2CPP_REGISTER_METHOD(0x00C03C70, UpdateCategory__Enum, get_UpdateCategory, (app::TransformAnimatorEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E8FF70, void, __ctor, (app::TransformAnimatorEntity * this_ptr));
}
