...
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_SceneName, (app::EditorSceneSaveEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02E91490, DatadogEvent *, GetCompatibleEvent, (app::EditorSceneSaveEvent * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::EditorSceneSaveEvent * this_ptr));
}
