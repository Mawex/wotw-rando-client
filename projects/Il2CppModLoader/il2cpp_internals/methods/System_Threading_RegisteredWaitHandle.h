...
namespace app::methods::System_Threading::RegisteredWaitHandle {
    IL2CPP_REGISTER_METHOD(0x0232A0F0, void, __ctor, (app::RegisteredWaitHandle * this_ptr, app::WaitHandle * wait_object, app::WaitOrTimerCallback * callback, app::Object * state, app::TimeSpan timeout, bool execute_only_once));
