...
namespace app::methods::System_Xml_Schema::XmlSchemaObjectTable_XSOEnumerator {
    IL2CPP_REGISTER_METHOD(0x01CB8800, void, __ctor, (app::XmlSchemaObjectTable_XSOEnumerator * this_ptr, app::List_1_System_Xml_Schema_XmlSchemaObjectTable_XmlSchemaObjectEntry_ * entries, int32_t size, app::XmlSchemaObjectTable_EnumeratorType__Enum enum_type));
