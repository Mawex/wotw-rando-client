...
namespace app::methods::System_Net::ServerCertValidationCallback {
IL2CPP_REGISTER_METHOD(0x01BD34E0, void, __ctor, (app::ServerCertValidationCallback * this_ptr, app::RemoteCertificateValidationCallback * validation_callback));
IL2CPP_REGISTER_METHOD(0x002FA280, RemoteCertificateValidationCallback *, get_ValidationCallback, (app::ServerCertValidationCallback * this_ptr));
