...
IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor, (app::AkAuxSendValue * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x026CAFE0, void *, getCPtr, (app::AkAuxSendValue * obj));
IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkAuxSendValue * this_ptr, app::void * c_ptr));
