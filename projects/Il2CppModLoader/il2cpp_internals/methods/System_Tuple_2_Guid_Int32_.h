...
IL2CPP_REGISTER_METHOD(0x01349560, Guid, get_Item1, (app::Tuple_2_Guid_Int32_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A62D90, void, __ctor, (app::Tuple_2_Guid_Int32_ * this_ptr, app::Guid item1, int32_t item2));
...
IL2CPP_REGISTER_METHOD(0x02A63610, String *, ToString, (app::Tuple_2_Guid_Int32_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A63790, String *, ITupleInternal_ToString, (app::Tuple_2_Guid_Int32_ * this_ptr, app::StringBuilder * sb));
}
