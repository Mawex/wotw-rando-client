...
IL2CPP_REGISTER_METHOD(0x024EA9C0, Material *, get_material, (app::CameraFilterPack_Distortion_Noise * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E70F0, void, __ctor, (app::CameraFilterPack_Distortion_Noise * this_ptr));
}
