...
namespace app::methods::System_Globalization::CharUnicodeInfo {
...
IL2CPP_REGISTER_METHOD(0x01A21DB0, UnicodeCategory__Enum, GetUnicodeCategory_1, (uint16_t ch));
IL2CPP_REGISTER_METHOD(0x01A21E50, UnicodeCategory__Enum, GetUnicodeCategory_2, (app::String * s, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x0471FA10, CharUnicodeInfo_GetUnicodeCategory_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A21F70, UnicodeCategory__Enum, InternalGetUnicodeCategory_1, (int32_t ch));
IL2CPP_REGISTER_METHOD(0x01A22010, uint8_t, InternalGetCategoryValue, (int32_t ch, int32_t offset));
IL2CPP_REGISTER_METHOD(0x01A22190, UnicodeCategory__Enum, InternalGetUnicodeCategory_2, (app::String * value, int32_t index));
