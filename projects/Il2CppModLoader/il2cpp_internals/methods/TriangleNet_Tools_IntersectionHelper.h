...
namespace app::methods::TriangleNet_Tools::IntersectionHelper {
...
IL2CPP_REGISTER_METHOD(0x02A971B0, Point *, BoxRayIntersection_2, (app::Rectangle * rect, app::Point * p, double dx, double dy));
