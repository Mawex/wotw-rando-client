...
namespace app::methods::Moon_BehaviourSystem::TimeLimitDecorator {
...
IL2CPP_REGISTER_METHOD(0x03011E70, BehaviourStatus__Enum, OnExecute, (app::TimeLimitDecorator * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x03011F40, void, __ctor, (app::TimeLimitDecorator * this_ptr));
}
