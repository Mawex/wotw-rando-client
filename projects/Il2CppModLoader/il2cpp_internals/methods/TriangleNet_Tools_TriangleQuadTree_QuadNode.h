...
namespace app::methods::TriangleNet_Tools::TriangleQuadTree_QuadNode {
IL2CPP_REGISTER_METHOD(0x02A9CB50, void, __ctor_1, (app::TriangleQuadTree_QuadNode * this_ptr, app::Rectangle * box, app::TriangleQuadTree * tree));
IL2CPP_REGISTER_METHOD(0x02A9CB70, void, __ctor_2, (app::TriangleQuadTree_QuadNode * this_ptr, app::Rectangle * box, app::TriangleQuadTree * tree, bool init));
IL2CPP_REGISTER_METHOD(0x02A9D1F0, List_1_System_Int32_ *, FindTriangles, (app::TriangleQuadTree_QuadNode * this_ptr, app::Point * search_point));
...
IL2CPP_REGISTER_METHOD(0x02A9EFE0, void, __cctor, ());
}
