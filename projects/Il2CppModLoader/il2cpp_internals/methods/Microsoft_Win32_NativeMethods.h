...
namespace app::methods::Microsoft_Win32::NativeMethods {
...
IL2CPP_REGISTER_METHOD(0x02172060, bool, GetExitCodeProcess_1, (app::void * process_handle, app::int32_t * exit_code));
IL2CPP_REGISTER_METHOD(0x02172080, bool, GetExitCodeProcess_2, (app::SafeProcessHandle * process_handle, app::int32_t * exit_code));
IL2CPP_REGISTER_METHOD(0x0173D7D0, bool, TerminateProcess_1, (app::void * process_handle, int32_t exit_code));
...
IL2CPP_REGISTER_METHOD(0x02172260, bool, CloseProcess, (app::void * handle));
}
