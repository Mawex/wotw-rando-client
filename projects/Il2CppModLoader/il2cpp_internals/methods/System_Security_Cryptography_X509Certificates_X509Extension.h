...
namespace app::methods::System_Security_Cryptography_X509Certificates::X509Extension {
...
IL2CPP_REGISTER_METHOD(0x021D5860, String *, FormatUnkownData, (app::X509Extension_1 * this_ptr, app::Byte__Array * data));
}
