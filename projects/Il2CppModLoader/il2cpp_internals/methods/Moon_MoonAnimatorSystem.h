...
IL2CPP_REGISTER_METHOD(0x00597B10, UpdateType__Enum, get_UpdateType, (app::MoonAnimatorSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x005C3FE0, PlayableGraph, get_PlayableGraph, (app::MoonAnimatorSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0211EF70, void, __ctor, (app::MoonAnimatorSystem * this_ptr));
