...
namespace app::methods::UnityEngine_EventSystems::PointerEventData {
IL2CPP_REGISTER_METHOD(0x01F22D40, void, __ctor, (app::PointerEventData * this_ptr, app::EventSystem * event_system));
IL2CPP_REGISTER_METHOD(0x01704A60, GameObject *, get_pointerEnter, (app::PointerEventData * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB960, void, set_pointerEnter, (app::PointerEventData * this_ptr, app::GameObject * value));
IL2CPP_REGISTER_METHOD(0x01F22F90, GameObject *, get_lastPress, (app::PointerEventData * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9A0, void, set_lastPress, (app::PointerEventData * this_ptr, app::GameObject * value));
IL2CPP_REGISTER_METHOD(0x01F1C1D0, GameObject *, get_rawPointerPress, (app::PointerEventData * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9C0, void, set_rawPointerPress, (app::PointerEventData * this_ptr, app::GameObject * value));
IL2CPP_REGISTER_METHOD(0x01F1A590, GameObject *, get_pointerDrag, (app::PointerEventData * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9E0, void, set_pointerDrag, (app::PointerEventData * this_ptr, app::GameObject * value));
IL2CPP_REGISTER_METHOD(0x01F22FA0, RaycastResult, get_pointerCurrentRaycast, (app::PointerEventData * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F22FE0, void, set_pointerCurrentRaycast, (app::PointerEventData * this_ptr, app::RaycastResult value));
IL2CPP_REGISTER_METHOD(0x01F23010, RaycastResult, get_pointerPressRaycast, (app::PointerEventData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F230B0, Vector2, get_position, (app::PointerEventData * this_ptr));
IL2CPP_REGISTER_METHOD(0x01466B40, void, set_position, (app::PointerEventData * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x01F230D0, Vector2, get_delta, (app::PointerEventData * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F230F0, void, set_delta, (app::PointerEventData * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x01F23120, Vector2, get_pressPosition, (app::PointerEventData * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F23140, void, set_pressPosition, (app::PointerEventData * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x01F23170, Vector3, get_worldPosition, (app::PointerEventData * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F23190, void, set_worldPosition, (app::PointerEventData * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x01F231B0, Vector3, get_worldNormal, (app::PointerEventData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F231F0, Vector2, get_scrollDelta, (app::PointerEventData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F23270, PointerEventData_InputButton__Enum, get_button, (app::PointerEventData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F232E0, Camera *, get_enterEventCamera, (app::PointerEventData * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F233D0, Camera *, get_pressEventCamera, (app::PointerEventData * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F234C0, GameObject *, get_pointerPress, (app::PointerEventData * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F234D0, void, set_pointerPress, (app::PointerEventData * this_ptr, app::GameObject * value));
IL2CPP_REGISTER_METHOD(0x01F235A0, String *, ToString, (app::PointerEventData * this_ptr));
}
