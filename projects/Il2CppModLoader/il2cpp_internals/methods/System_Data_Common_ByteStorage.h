...
namespace app::methods::System_Data_Common::ByteStorage {
IL2CPP_REGISTER_METHOD(0x021576E0, void, __ctor, (app::ByteStorage * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x02157800, Object *, Aggregate, (app::ByteStorage * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x02158150, Object *, ConvertValue, (app::ByteStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02158280, void, Copy, (app::ByteStorage * this_ptr, int32_t record_no1, int32_t record_no2));
IL2CPP_REGISTER_METHOD(0x02158340, Object *, Get, (app::ByteStorage * this_ptr, int32_t record));
...
IL2CPP_REGISTER_METHOD(0x02158710, Object *, ConvertXmlToObject, (app::ByteStorage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x021587F0, String *, ConvertObjectToXml, (app::ByteStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x021588D0, Object *, GetEmptyStorage, (app::ByteStorage * this_ptr, int32_t record_count));
