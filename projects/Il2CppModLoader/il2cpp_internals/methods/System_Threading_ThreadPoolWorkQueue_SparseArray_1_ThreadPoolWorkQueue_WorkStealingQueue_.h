...
namespace app::methods::System_Threading::ThreadPoolWorkQueue_SparseArray_1_ThreadPoolWorkQueue_WorkStealingQueue_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02A61DB0, void, __ctor, (app::ThreadPoolWorkQueue_SparseArray_1_ThreadPoolWorkQueue_WorkStealingQueue_ * this_ptr, int32_t initial_size));
