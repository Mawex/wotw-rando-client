...
IL2CPP_REGISTER_METHOD(0x00867B60, String *, GetNiceName, (app::MoveCameraAction * this_ptr));
IL2CPP_REGISTER_METHOD(0x0044C850, void, __ctor, (app::MoveCameraAction * this_ptr));
}
