...
namespace app::methods::System_Collections_Generic::List_1_Mono_Security_Protocol_Tls_CipherSuite_ {
IL2CPP_REGISTER_METHOD(0x025EFC50, CipherSuite *, get_Item, (app::List_1_Mono_Security_Protocol_Tls_CipherSuite_ * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x04778B28, List_1_Mono_Security_Protocol_Tls_CipherSuite__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_Mono_Security_Protocol_Tls_CipherSuite_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047107C8, List_1_Mono_Security_Protocol_Tls_CipherSuite___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_Mono_Security_Protocol_Tls_CipherSuite_, GetEnumerator, (app::List_1_Mono_Security_Protocol_Tls_CipherSuite_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025F0B50, IEnumerator_1_Mono_Security_Protocol_Tls_CipherSuite_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_Mono_Security_Protocol_Tls_CipherSuite_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025F0B50, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_Mono_Security_Protocol_Tls_CipherSuite_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02FE89B0, Object *, IList_get_Item, (app::List_1_Mono_Security_Protocol_Tls_CipherSuite_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02FE87E0, Object *, ICollection_get_SyncRoot, (app::List_1_Mono_Security_Protocol_Tls_CipherSuite_ * this_ptr));
