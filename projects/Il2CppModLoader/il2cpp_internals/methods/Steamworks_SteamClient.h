...
IL2CPP_REGISTER_METHOD(0x027E3990, HSteamUser, ConnectToGlobalUser, (app::HSteamPipe h_steam_pipe));
IL2CPP_REGISTER_METHOD(0x027E39C0, HSteamUser, CreateLocalUser, (app::HSteamPipe * ph_steam_pipe, app::EAccountType__Enum e_account_type));
