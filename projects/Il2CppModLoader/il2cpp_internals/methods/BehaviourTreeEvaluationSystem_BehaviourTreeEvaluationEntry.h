...
IL2CPP_REGISTER_METHOD(0x002FB930, Entity *, get_Entity, (app::BehaviourTreeEvaluationSystem_BehaviourTreeEvaluationEntry * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::BehaviourTreeEvaluationSystem_BehaviourTreeEvaluationEntry * this_ptr));
}
