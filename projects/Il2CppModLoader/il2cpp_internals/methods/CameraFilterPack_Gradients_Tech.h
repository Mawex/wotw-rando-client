...
IL2CPP_REGISTER_METHOD(0x0247D680, Material *, get_material, (app::CameraFilterPack_Gradients_Tech * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0247DCA0, void, __ctor, (app::CameraFilterPack_Gradients_Tech * this_ptr));
}
