...
IL2CPP_REGISTER_METHOD(0x00420EE0, RecordableParsingGroup__Enum, get_ParsingGroup, (app::RecordingUnmanagedParticlesTracker * this_ptr));
IL2CPP_REGISTER_METHOD(0x008FB250, TrackingExclusions, get_TrackingExclusions, (app::RecordingUnmanagedParticlesTracker * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::RecordingUnmanagedParticlesTracker * this_ptr));
}
