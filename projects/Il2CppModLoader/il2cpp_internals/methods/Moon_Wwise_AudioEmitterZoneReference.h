...
namespace app::methods::Moon_Wwise::AudioEmitterZoneReference {
IL2CPP_REGISTER_METHOD(0x001FE500, void, __ctor, (app::AudioEmitterZoneReference__Boxed * this_ptr, app::AudioEmitterZone * zone));
IL2CPP_REGISTER_METHOD(0x001FE540, bool, get_IsValid, (app::AudioEmitterZoneReference__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00107C00, AudioEmitterZone *, get_Zone, (app::AudioEmitterZoneReference__Boxed * this_ptr));
