...
namespace app::methods::PrefabSpawner {
    ...
    IL2CPP_REGISTER_METHOD(0x00C6ECA0, GameObject*, Spawn, (app::PrefabSpawner * this_ptr, app::IContext* context));
    IL2CPP_REGISTER_METHOD(0x00C6F300, void, DestroyInstance, (app::PrefabSpawner * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00C6F3E0, void, __ctor, (app::PrefabSpawner * this_ptr));
} // namespace app::methods::PrefabSpawner
