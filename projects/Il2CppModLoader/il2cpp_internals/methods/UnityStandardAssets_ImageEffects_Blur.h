...
namespace app::methods::UnityStandardAssets_ImageEffects::Blur {
IL2CPP_REGISTER_METHOD(0x02515B20, Material *, get_material, (app::Blur * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025168F0, void, __ctor, (app::Blur * this_ptr));
