...
namespace app::methods::System_Security_Claims::ClaimsPrincipal {
IL2CPP_REGISTER_METHOD(0x020C58A0, ClaimsIdentity *, SelectPrimaryIdentity, (app::IEnumerable_1_System_Security_Claims_ClaimsIdentity_ * identities));
...
IL2CPP_REGISTER_METHOD(0x020C5BC0, void, __ctor_1, (app::ClaimsPrincipal * this_ptr));
IL2CPP_REGISTER_METHOD(0x020C5D20, void, __ctor_2, (app::ClaimsPrincipal * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
...
IL2CPP_REGISTER_METHOD(0x020C6A70, String *, SerializeIdentities, (app::ClaimsPrincipal * this_ptr));
