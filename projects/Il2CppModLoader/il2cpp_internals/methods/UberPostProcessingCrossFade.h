...
IL2CPP_REGISTER_METHOD(0x018F6430, Material *, get_Material, (app::UberPostProcessingCrossFade * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::UberPostProcessingCrossFade * this_ptr));
}
