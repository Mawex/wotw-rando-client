...
namespace app::methods::Mono_Security_Protocol_Tls::TlsServerSettings {
...
IL2CPP_REGISTER_METHOD(0x002FA280, X509CertificateCollection_2 *, get_Certificates, (app::TlsServerSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB930, RSA *, get_CertificateRSA, (app::TlsServerSettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x0291C4C0, RSAParameters, get_RsaParameters, (app::TlsServerSettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x0291C4F0, void, set_RsaParameters, (app::TlsServerSettings * this_ptr, app::RSAParameters value));
IL2CPP_REGISTER_METHOD(0x002FBB80, Byte__Array *, get_SignedParams, (app::TlsServerSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBE0, ClientCertificateType__Enum__Array *, get_CertificateTypes, (app::TlsServerSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBA0, String__Array *, get_DistinguisedNames, (app::TlsServerSettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBB0, void, set_DistinguisedNames, (app::TlsServerSettings * this_ptr, app::String__Array * value));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::TlsServerSettings * this_ptr));
