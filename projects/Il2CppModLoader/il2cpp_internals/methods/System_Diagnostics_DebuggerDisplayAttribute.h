...
namespace app::methods::System_Diagnostics::DebuggerDisplayAttribute {
    IL2CPP_REGISTER_METHOD(0x01741130, void, __ctor, (app::DebuggerDisplayAttribute * this_ptr, app::String * value));
