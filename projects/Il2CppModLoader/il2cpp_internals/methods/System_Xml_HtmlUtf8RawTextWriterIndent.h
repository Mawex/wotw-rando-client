...
namespace app::methods::System_Xml::HtmlUtf8RawTextWriterIndent {
IL2CPP_REGISTER_METHOD(0x0199D3E0, void, __ctor, (app::HtmlUtf8RawTextWriterIndent * this_ptr, app::Stream * stream, app::XmlWriterSettings * settings));
