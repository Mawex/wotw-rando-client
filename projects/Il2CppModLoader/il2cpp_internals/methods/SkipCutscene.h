...
namespace app::methods::SkipCutscene {
    IL2CPP_REGISTER_METHOD(0x006C0B30, List_1_ICondition_*, get_ResolvedConditions, (app::SkipCutscene * this_ptr));
    IL2CPP_REGISTER_METHOD(0x006C0D60, List_1_ISkipCutsceneAction_*, get_ResolvedReactions, (app::SkipCutscene * this_ptr));
    IL2CPP_REGISTER_METHOD(0x006C0F90, Vector3, get_DesiredPositionAfterSkip, (app::SkipCutscene * this_ptr));
    IL2CPP_REGISTER_METHOD(0x006C1260, bool, get_ShouldHandleSceneLoadingUnloading, (app::SkipCutscene * this_ptr));
    IL2CPP_REGISTER_METHOD(0x006C13C0, MoonTimeline*, get_ResolvedTimeline, (app::SkipCutscene * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::SkipCutscene * this_ptr));
} // namespace app::methods::SkipCutscene
