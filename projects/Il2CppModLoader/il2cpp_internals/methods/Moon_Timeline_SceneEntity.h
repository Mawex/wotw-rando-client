...
namespace app::methods::Moon_Timeline::SceneEntity {
...
IL2CPP_REGISTER_METHOD(0x00783940, bool, ApproximateEvent, (app::SceneEntity * this_ptr, int32_t evt, app::float * time));
...
IL2CPP_REGISTER_METHOD(0x00783C50, void, __ctor, (app::SceneEntity * this_ptr));
}
