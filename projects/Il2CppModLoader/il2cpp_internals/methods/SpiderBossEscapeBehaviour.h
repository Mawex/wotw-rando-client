...
IL2CPP_REGISTER_METHOD(0x011AD1D0, BehaviourStatus__Enum, OnExecuteTask, (app::SpiderBossEscapeBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x011ADF10, void, __ctor, (app::SpiderBossEscapeBehaviour * this_ptr));
}
