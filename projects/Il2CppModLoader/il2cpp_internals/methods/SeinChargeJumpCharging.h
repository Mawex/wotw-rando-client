...
IL2CPP_REGISTER_METHOD(0x00A50B70, PlayerAbilities *, get_PlayerAbilities, (app::SeinChargeJumpCharging * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement *, get_PlatformMovement, (app::SeinChargeJumpCharging * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A50B90, SeinChargeJump *, get_ChargeJump, (app::SeinChargeJumpCharging * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A52450, void, __ctor, (app::SeinChargeJumpCharging * this_ptr));
