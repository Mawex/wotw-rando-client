...
IL2CPP_REGISTER_METHOD(0x0073E1F0, ParticleSystem *, get_ParticleSystem, (app::ShurikenParticleAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0073EB80, void, __ctor, (app::ShurikenParticleAnimator * this_ptr));
}
