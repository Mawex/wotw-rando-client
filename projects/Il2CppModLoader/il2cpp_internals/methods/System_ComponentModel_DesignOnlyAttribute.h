...
namespace app::methods::System_ComponentModel::DesignOnlyAttribute {
IL2CPP_REGISTER_METHOD(0x0052C650, void, __ctor, (app::DesignOnlyAttribute * this_ptr, bool is_design_only));
