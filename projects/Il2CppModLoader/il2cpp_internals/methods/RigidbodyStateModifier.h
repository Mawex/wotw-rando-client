...
IL2CPP_REGISTER_METHOD(0x01B789A0, Vector3, get_Position, (app::RigidbodyStateModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B78A60, void, set_Position, (app::RigidbodyStateModifier * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x01B78B40, Vector3, get_RotationEuler, (app::RigidbodyStateModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B78C00, void, set_RotationEuler, (app::RigidbodyStateModifier * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x01B78CE0, Quaternion, get_RotationQuaternion, (app::RigidbodyStateModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01B794E0, void, __ctor, (app::RigidbodyStateModifier * this_ptr));
