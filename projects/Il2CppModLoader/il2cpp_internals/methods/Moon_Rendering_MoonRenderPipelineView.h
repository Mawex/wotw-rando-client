...
namespace app::methods::Moon_Rendering::MoonRenderPipelineView {
...
IL2CPP_REGISTER_METHOD(0x007A31C0, void, __ctor_1, (app::MoonRenderPipelineView * this_ptr, app::MoonRenderPipelineViewType__Enum view_type, app::MoonRenderPipelineAsset * owner, app::MoonRenderPipelineSettings * settings));
...
IL2CPP_REGISTER_METHOD(0x007A49D0, CommandBuffer *, GetEmissivityCB, (app::MoonRenderPipelineView * this_ptr, int32_t frame));
IL2CPP_REGISTER_METHOD(0x007A4A30, Camera *, get_camera, (app::MoonRenderPipelineView * this_ptr));
IL2CPP_REGISTER_METHOD(0x007A4A40, FilterResults, get_visibleRenderers, (app::MoonRenderPipelineView * this_ptr));
IL2CPP_REGISTER_METHOD(0x007A4A50, Int2, get_SceneResolution, (app::MoonRenderPipelineView * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007AB890, DrawRendererSettings, getDrawRendererSettings, (app::Camera * sort_camera, app::ShaderPassName shader_pass_name));
...
IL2CPP_REGISTER_METHOD(0x007AC2C0, CommandBuffer *, getCommandBuffer, (app::String * name));
...
IL2CPP_REGISTER_METHOD(0x007ACF50, Matrix4x4, GetJitteredPerspectiveProjectionMatrix, (app::Camera * camera, app::Int2 size, app::Vector2 offset));
IL2CPP_REGISTER_METHOD(0x007AD190, Matrix4x4, GetNonJitteredPerspectiveProjectionMatrix, (app::Camera * camera));
...
IL2CPP_REGISTER_METHOD(0x007AD780, void, __ctor_2, (app::MoonRenderPipelineView * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007B1310, Texture *, getGodraysRT, (app::MoonRenderPipelineView * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007B5B30, float, _calculateResolutionBasedAdditionalDownsamplingRatio, (app::MoonRenderPipelineView * this_ptr, float scene_r_t_height, app::bool * use_alt_downsampling));
IL2CPP_REGISTER_METHOD(0x007B5CF0, void, _calculateAltDownsamplingRatio, (app::MoonRenderPipelineView * this_ptr, float scene_r_t_height, float slice_scale, app::bool * use_alt_downsampling, app::float * alt_downsampling_scale));
...
IL2CPP_REGISTER_METHOD(0x007D5E60, MoonRenderPipelineView_FilterBounds, getCullBounds, (app::MoonRenderPipelineView * this_ptr, float z_world_near, float z_world_far));
