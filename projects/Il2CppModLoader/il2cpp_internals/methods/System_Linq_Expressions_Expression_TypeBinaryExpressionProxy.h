...
namespace app::methods::System_Linq_Expressions::Expression_TypeBinaryExpressionProxy {
    IL2CPP_REGISTER_METHOD(0x022C7720, void, __ctor, (app::Expression_TypeBinaryExpressionProxy * this_ptr, app::TypeBinaryExpression * node));
