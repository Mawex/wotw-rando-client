...
namespace app::methods::NPCMessageBox {
    ...
    IL2CPP_REGISTER_METHOD(0x00881B70, SuspendableMask__Enum, get_Mask, (app::NPCMessageBox * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00881B80, void, set_Mask, (app::NPCMessageBox * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x00881C40, void, __ctor, (app::NPCMessageBox * this_ptr));
} // namespace app::methods::NPCMessageBox
