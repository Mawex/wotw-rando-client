...
IL2CPP_REGISTER_METHOD(0x004BBF40, IUberState__Array *, get_AffectingUberStates, (app::AchievementsStateValidator * this_ptr));
IL2CPP_REGISTER_METHOD(0x004BC560, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::AchievementsStateValidator * this_ptr));
