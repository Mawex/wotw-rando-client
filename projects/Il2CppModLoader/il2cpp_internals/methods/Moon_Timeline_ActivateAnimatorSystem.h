...
namespace app::methods::Moon_Timeline::ActivateAnimatorSystem {
IL2CPP_REGISTER_METHOD(0x0311AC10, ActivateAnimatorSystem *, get_Instance, ());
IL2CPP_REGISTER_METHOD(0x00597B10, UpdateType__Enum, get_UpdateType, (app::ActivateAnimatorSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0311C1F0, void, __ctor, (app::ActivateAnimatorSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x0311C4F0, void, __cctor, ());
}
