...
namespace app::methods::Moon_Timeline::BlockDamageInterruption {
IL2CPP_REGISTER_METHOD(0x002FBBE0, Action_1_DamageWeightMask_ *, get_EventStart, (app::BlockDamageInterruption * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC00, Action_1_DamageWeightMask_ *, get_EventStay, (app::BlockDamageInterruption * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC20, Action_1_DamageWeightMask_ *, get_EventEnd, (app::BlockDamageInterruption * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010C7EC0, void, __ctor, (app::BlockDamageInterruption * this_ptr));
}
