...
namespace app::methods::Moon_ArtOptimization::ArtOptimizerDataContainer {
    ...
    IL2CPP_REGISTER_METHOD(0x01346FC0, void, __ctor, (app::ArtOptimizerDataContainer * this_ptr));
}
