...
namespace app::methods::UnityEngine_Events::ArgumentCache {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::ArgumentCache * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F2AB40, Object_1 *, get_unityObjectArgument, (app::ArgumentCache * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F25880, String *, get_unityObjectArgumentAssemblyTypeName, (app::ArgumentCache * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F234C0, String *, get_stringArgument, (app::ArgumentCache * this_ptr));
