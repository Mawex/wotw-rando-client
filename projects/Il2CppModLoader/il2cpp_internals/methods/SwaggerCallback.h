...
IL2CPP_REGISTER_METHOD(0x02EA25C0, void, __ctor, (app::SwaggerCallback * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02EA2AE0, SwaggerJSONParser *, get_Parser, (app::SwaggerCallback * this_ptr));
}
