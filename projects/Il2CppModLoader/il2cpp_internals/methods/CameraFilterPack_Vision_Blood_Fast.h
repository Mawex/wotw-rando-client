...
IL2CPP_REGISTER_METHOD(0x020F5F10, Material *, get_material, (app::CameraFilterPack_Vision_Blood_Fast * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020F5EE0, void, __ctor, (app::CameraFilterPack_Vision_Blood_Fast * this_ptr));
}
