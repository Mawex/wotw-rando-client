...
namespace app::methods::Motvin_Collections::FastHashSet_1_System_UInt32_ {
IL2CPP_REGISTER_METHOD(0x02AF8B00, void, __ctor_1, (app::FastHashSet_1_System_UInt32_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x02AF89C0, void, __ctor_2, (app::FastHashSet_1_System_UInt32_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02AF8A20, void, __ctor_3, (app::FastHashSet_1_System_UInt32_ * this_ptr, app::IEnumerable_1_System_UInt32_ * collection));
IL2CPP_REGISTER_METHOD(0x02AF8A90, void, __ctor_4, (app::FastHashSet_1_System_UInt32_ * this_ptr, app::IEqualityComparer_1_System_UInt32_ * comparer));
IL2CPP_REGISTER_METHOD(0x02AF8B70, void, __ctor_5, (app::FastHashSet_1_System_UInt32_ * this_ptr, app::IEnumerable_1_System_UInt32_ * collection, app::IEqualityComparer_1_System_UInt32_ * comparer));
IL2CPP_REGISTER_METHOD(0x02AF8BE0, void, __ctor_6, (app::FastHashSet_1_System_UInt32_ * this_ptr, int32_t capacity, app::IEqualityComparer_1_System_UInt32_ * comparer));
...
IL2CPP_REGISTER_METHOD(0x002FBB00, IEqualityComparer_1_System_UInt32_ *, get_Comparer, (app::FastHashSet_1_System_UInt32_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AFB2E0, int32_t, GetNewSlotsArraySizeIncrease, (app::FastHashSet_1_System_UInt32_ * this_ptr, app::int32_t * old_array_size));
...
IL2CPP_REGISTER_METHOD(0x02B06210, FastHashSet_1_T_TNode_System_UInt32___Array *, IncreaseCapacityNoCopy, (app::FastHashSet_1_System_UInt32_ * this_ptr, int32_t capacity_increase));
...
IL2CPP_REGISTER_METHOD(0x02B069D0, bool, Add_2, (app::FastHashSet_1_System_UInt32_ * this_ptr, app::uint32_t * item));
IL2CPP_REGISTER_METHOD(0x02B07430, int32_t, AddToHashSetIfNotFound, (app::FastHashSet_1_System_UInt32_ * this_ptr, app::uint32_t * item, int32_t hash, app::bool * is_found));
IL2CPP_REGISTER_METHOD(0x02B076D0, int32_t, AddToHashSetIfNotFoundAndMark, (app::FastHashSet_1_System_UInt32_ * this_ptr, app::uint32_t * item, int32_t hash));
IL2CPP_REGISTER_METHOD(0x02B07950, bool, Contains_1, (app::FastHashSet_1_System_UInt32_ * this_ptr, app::uint32_t * item));
IL2CPP_REGISTER_METHOD(0x02B07BB0, bool, Contains_2, (app::FastHashSet_1_System_UInt32_ * this_ptr, uint32_t item));
IL2CPP_REGISTER_METHOD(0x02B081E0, bool, RemoveIf, (app::FastHashSet_1_System_UInt32_ * this_ptr, app::uint32_t * item, app::Predicate_1_UInt32_ * remove_if_pred_is_true));
IL2CPP_REGISTER_METHODINFO(0x04729DA0, FastHashSet_1_System_UInt32__RemoveIf__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02B086C0, uint32_t *, FindOrAdd, (app::FastHashSet_1_System_UInt32_ * this_ptr, app::uint32_t * item, app::bool * is_found));
IL2CPP_REGISTER_METHOD(0x02B089C0, uint32_t *, Find, (app::FastHashSet_1_System_UInt32_ * this_ptr, app::uint32_t * item, app::bool * is_found));
IL2CPP_REGISTER_METHOD(0x02B08BF0, uint32_t *, FindAndRemoveIf, (app::FastHashSet_1_System_UInt32_ * this_ptr, app::uint32_t * item, app::Predicate_1_UInt32_ * remove_if_pred_is_true, app::bool * is_found, app::bool * is_removed));
IL2CPP_REGISTER_METHODINFO(0x04774958, FastHashSet_1_System_UInt32__FindAndRemoveIf__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02B09100, void, FindInSlotsArray_1, (app::FastHashSet_1_System_UInt32_ * this_ptr, app::uint32_t * item, app::int32_t * found_node_index, app::int32_t * prior_node_index, app::int32_t * buckets_index));
IL2CPP_REGISTER_METHOD(0x02B092E0, bool, FindInSlotsArray_2, (app::FastHashSet_1_System_UInt32_ * this_ptr, app::uint32_t * item, int32_t hash));
IL2CPP_REGISTER_METHOD(0x02B09420, bool, FindInNoHashArray, (app::FastHashSet_1_System_UInt32_ * this_ptr, app::uint32_t * item));
...
IL2CPP_REGISTER_METHOD(0x02B09720, FastHashSet_1_T_FoundType_System_UInt32_ *, FindInSlotsArrayAndMark, (app::FastHashSet_1_System_UInt32_ * this_ptr, app::uint32_t * item, app::int32_t * found_node_index));
IL2CPP_REGISTER_METHOD(0x02B09970, List_1_Motvin_Collections_ChainLevelAndCount_ *, GetChainLevelsCounts, (app::FastHashSet_1_System_UInt32_ * this_ptr, app::double * avg_node_visits_per_chain));
IL2CPP_REGISTER_METHOD(0x02B0A0E0, void, ReorderChainedNodesToBeAdjacent, (app::FastHashSet_1_System_UInt32_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02B0A260, bool, TryGetValue, (app::FastHashSet_1_System_UInt32_ * this_ptr, uint32_t equal_value, app::uint32_t * actual_value));
...
IL2CPP_REGISTER_METHOD(0x02B0E000, void, RemoveIfNotMarked, (app::FastHashSet_1_System_UInt32_ * this_ptr, app::uint32_t * item));
...
IL2CPP_REGISTER_METHOD(0x02B03D00, IEqualityComparer_1_Motvin_Collections_FastHashSet_1__1 *, CreateSetComparer, ());
IL2CPP_REGISTER_METHOD(0x02B03E60, IEnumerator_1_System_UInt32_ *, GetEnumerator, (app::FastHashSet_1_System_UInt32_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02B03E60, IEnumerator *, IEnumerable_GetEnumerator, (app::FastHashSet_1_System_UInt32_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02B0E660, void, __cctor, ());
}
