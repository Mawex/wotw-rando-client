...
namespace app::methods::P3D_Tree {
    ...
    IL2CPP_REGISTER_METHOD(0x03099B30, P3D_Result*, FindNearest, (app::P3D_Tree * this_ptr, app::Vector3 point, float max_distance));
    IL2CPP_REGISTER_METHOD(0x03099DC0, P3D_Result*, FindBetweenNearest, (app::P3D_Tree * this_ptr, app::Vector3 start_point, app::Vector3 end_point));
    IL2CPP_REGISTER_METHOD(0x0309A050, List_1_P3D_Result_*, FindBetweenAll, (app::P3D_Tree * this_ptr, app::Vector3 start_point, app::Vector3 end_point));
    IL2CPP_REGISTER_METHOD(0x0309A2C0, P3D_Result*, FindPerpendicularNearest, (app::P3D_Tree * this_ptr, app::Vector3 point, float max_distance));
    IL2CPP_REGISTER_METHOD(0x0309A560, List_1_P3D_Result_*, FindPerpendicularAll, (app::P3D_Tree * this_ptr, app::Vector3 point, float max_distance));
    ...
    IL2CPP_REGISTER_METHOD(0x0309B170, P3D_Result*, GetResult, (app::P3D_Tree * this_ptr, app::P3D_Triangle* triangle, app::Vector3 weights, float distance01));
    ...
    IL2CPP_REGISTER_METHOD(0x0309C410, void, SortTriangle, (app::P3D_Tree * this_ptr, app::P3D_Triangle* triangle, app::int32_t* min_index, app::int32_t* max_index, bool above_pivot));
    IL2CPP_REGISTER_METHOD(0x0309C560, void, __ctor, (app::P3D_Tree * this_ptr));
