...
IL2CPP_REGISTER_METHOD(0x0064D930, Vector3, get_TargetPosition, (app::FaceTargetBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00615280, void, __ctor, (app::FaceTargetBehaviour * this_ptr));
}
