...
namespace app::methods::System_Globalization::CompareInfo {
IL2CPP_REGISTER_METHOD(0x01A229B0, void, __ctor_1, (app::CompareInfo * this_ptr, app::CultureInfo * culture));
IL2CPP_REGISTER_METHOD(0x01A229E0, CompareInfo *, GetCompareInfo, (app::String * name));
...
IL2CPP_REGISTER_METHOD(0x01A22CC0, String *, get_Name, (app::CompareInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01A241D0, SortKey *, GetSortKey, (app::CompareInfo * this_ptr, app::String * source, app::CompareOptions__Enum options));
IL2CPP_REGISTER_METHOD(0x01A241D0, SortKey *, CreateSortKey, (app::CompareInfo * this_ptr, app::String * source, app::CompareOptions__Enum options));
...
IL2CPP_REGISTER_METHOD(0x01A24750, String *, ToString, (app::CompareInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x01A247F0, bool, get_UseManagedCollation, ());
IL2CPP_REGISTER_METHOD(0x01A24920, SimpleCollator *, GetCollator, (app::CompareInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x01A24D60, SortKey *, CreateSortKeyCore, (app::CompareInfo * this_ptr, app::String * source, app::CompareOptions__Enum options));
...
IL2CPP_REGISTER_METHOD(0x01A25580, void, __ctor_2, (app::CompareInfo * this_ptr));
