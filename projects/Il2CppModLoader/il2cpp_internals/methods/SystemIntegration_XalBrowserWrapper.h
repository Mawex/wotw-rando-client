...
IL2CPP_REGISTER_METHOD(0x00CDB300, void, __ctor, (app::XalBrowserWrapper * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CDBAE0, void, __ctor_b__8_0, (app::XalBrowserWrapper * this_ptr, app::void * operation_id, app::String * start_url, app::String * final_url, bool suppress_ui));
