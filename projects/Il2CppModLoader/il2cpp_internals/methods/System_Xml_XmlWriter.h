...
namespace app::methods::System_Xml::XmlWriter {
...
IL2CPP_REGISTER_METHOD(0x01FD6060, XmlWriter *, Create_1, (app::Stream * output, app::XmlWriterSettings * settings));
IL2CPP_REGISTER_METHOD(0x01FD61D0, XmlWriter *, Create_2, (app::TextWriter * output, app::XmlWriterSettings * settings));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::XmlWriter * this_ptr));
}
