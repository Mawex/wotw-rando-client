...
namespace app::methods::System_Collections_Generic::List_1_Moon_BehaviourSystem_BlackboardVariable_ {
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, BlackboardVariable__Array *, ToArray, (app::List_1_Moon_BehaviourSystem_BlackboardVariable_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_Moon_BehaviourSystem_BlackboardVariable_ * this_ptr));
