...
IL2CPP_REGISTER_METHOD(0x00115520, void, __ctor, (app::Vector2Int__Boxed * this_ptr, int32_t x, int32_t y));
...
IL2CPP_REGISTER_METHOD(0x00229560, String *, ToString, (app::Vector2Int__Boxed * this_ptr));
