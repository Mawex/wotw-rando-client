...
IL2CPP_REGISTER_METHOD(0x006E4180, SeinDamageReceiverPuppet *, get_Puppet, (app::SeinDamageReciever * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D06F0, CharacterLeftRightMovement *, get_CharacterLeftRightMovement, (app::SeinDamageReciever * this_ptr));
IL2CPP_REGISTER_METHOD(0x006E4240, CharacterGravity *, get_CharacterGravity, (app::SeinDamageReciever * this_ptr));
IL2CPP_REGISTER_METHOD(0x006E4270, CharacterInstantStop *, get_CharacterInstantStop, (app::SeinDamageReciever * this_ptr));
IL2CPP_REGISTER_METHOD(0x006E42A0, SeinHealthController *, get_HealthController, (app::SeinDamageReciever * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement *, get_PlatformMovement, (app::SeinDamageReciever * this_ptr));
IL2CPP_REGISTER_METHOD(0x006E42D0, Renderer *, get_Sprite, (app::SeinDamageReciever * this_ptr));
IL2CPP_REGISTER_METHOD(0x006E4310, Ku *, get_Ku, (app::SeinDamageReciever * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006E6E60, void, HandleGroundAnimationAndKickback, (app::SeinDamageReciever * this_ptr, app::Damage * damage, bool kickback_enabled, app::float * hurt_timeremaining, app::ActiveAnimationHandle * active_animation, app::SeinDamageReceiverPuppet * puppet));
IL2CPP_REGISTER_METHOD(0x006E7960, Vector2, ComputeSpeedTransfer, (app::SeinDamageReciever * this_ptr, app::Damage * damage));
...
IL2CPP_REGISTER_METHOD(0x006EA4C0, IEnumerator *, FlashSprite, (app::SeinDamageReciever * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006EC8A0, IEnumerator *, OnKillRoutine, (app::SeinDamageReciever * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006ECB70, Vector3, get_LastLeachPosition, (app::SeinDamageReciever * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006ECCA0, Vector3, get_LastPinPosition, (app::SeinDamageReciever * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006ECDF0, void, __ctor, (app::SeinDamageReciever * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::SeinDamageReciever * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::SeinDamageReciever * this_ptr));
}
