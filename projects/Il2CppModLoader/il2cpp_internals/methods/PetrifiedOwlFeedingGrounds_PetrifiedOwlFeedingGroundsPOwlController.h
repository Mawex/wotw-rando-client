...
IL2CPP_REGISTER_METHOD(0x014E3950, String *, GetStateToString, (app::PetrifiedOwlFeedingGroundsPOwlController * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::PetrifiedOwlFeedingGroundsPOwlController * this_ptr));
}
