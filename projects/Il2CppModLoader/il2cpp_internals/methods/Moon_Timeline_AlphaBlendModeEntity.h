...
namespace app::methods::Moon_Timeline::AlphaBlendModeEntity {
IL2CPP_REGISTER_METHOD(0x010C7360, IAlphaBlendModeController *, get_EffectiveTarget, (app::AlphaBlendModeEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010C76E0, void, __ctor, (app::AlphaBlendModeEntity * this_ptr));
}
