...
namespace app::methods::System_Xml::BinHexEncoder {
...
IL2CPP_REGISTER_METHOD(0x021E20A0, String *, Encode_2, (app::Byte__Array * in_array, int32_t offset_in, int32_t count));
