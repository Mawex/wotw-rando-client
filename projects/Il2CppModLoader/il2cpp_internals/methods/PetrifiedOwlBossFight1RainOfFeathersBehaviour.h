...
IL2CPP_REGISTER_METHOD(0x01769850, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossFight1RainOfFeathersBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01769C50, Vector3, RandomOffScreenPosition, (app::PetrifiedOwlBossFight1RainOfFeathersBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x0176A2F0, Vector3, RandomOffsetPosition, (app::PetrifiedOwlBossFight1RainOfFeathersBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0176A8D0, Projectile *, SpawnProjectile, (app::PetrifiedOwlBossFight1RainOfFeathersBehaviour * this_ptr, app::Vector2 shoot_point, app::Vector3 shoot_velocity, app::ProjectileSpawner * spawner));
IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, ShoulStopAttack, (app::PetrifiedOwlBossFight1RainOfFeathersBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x0176AC50, void, __ctor, (app::PetrifiedOwlBossFight1RainOfFeathersBehaviour * this_ptr));
}
