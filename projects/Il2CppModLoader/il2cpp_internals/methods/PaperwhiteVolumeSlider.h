...
IL2CPP_REGISTER_METHOD(0x00443F50, String *, GetValueToDisplay, (app::PaperwhiteVolumeSlider * this_ptr));
IL2CPP_REGISTER_METHOD(0x00444040, void, __ctor, (app::PaperwhiteVolumeSlider * this_ptr));
}
