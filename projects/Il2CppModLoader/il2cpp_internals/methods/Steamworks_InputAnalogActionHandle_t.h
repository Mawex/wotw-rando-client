...
namespace app::methods::Steamworks::InputAnalogActionHandle_t {
    IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor, (app::InputAnalogActionHandle_t__Boxed * this_ptr, uint64_t value));
    ...
    IL2CPP_REGISTER_METHOD(0x015F8190, bool, operator____1, (app::InputAnalogActionHandle_t x, app::InputAnalogActionHandle_t y));
    IL2CPP_REGISTER_METHOD(0x015F81A0, bool, operator____2, (app::InputAnalogActionHandle_t x, app::InputAnalogActionHandle_t y));
    IL2CPP_REGISTER_METHOD(0x004C50A0, app::InputAnalogActionHandle_t, operator__1, (uint64_t value));
    IL2CPP_REGISTER_METHOD(0x004C50A0, uint64_t, operator__2, (app::InputAnalogActionHandle_t that));
