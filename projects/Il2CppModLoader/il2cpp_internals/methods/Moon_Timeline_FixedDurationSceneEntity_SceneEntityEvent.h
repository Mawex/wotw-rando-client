...
namespace app::methods::Moon_Timeline::FixedDurationSceneEntity_SceneEntityEvent {
IL2CPP_REGISTER_METHOD(0x0076CEF0, void, __ctor, (app::FixedDurationSceneEntity_SceneEntityEvent * this_ptr, app::FixedDurationSceneEntity_Markers__Enum event));
IL2CPP_REGISTER_METHOD(0x00529FF0, FixedDurationSceneEntity_Markers__Enum, get_Event, (app::FixedDurationSceneEntity_SceneEntityEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_Name, (app::FixedDurationSceneEntity_SceneEntityEvent * this_ptr));
