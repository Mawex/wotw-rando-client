...
namespace app::methods::System_Collections_Generic::List_1_UnityEngine_Vector3_ {
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_UnityEngine_Vector3_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04723348, List_1_UnityEngine_Vector3___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02D49B80, Vector3, get_Item, (app::List_1_UnityEngine_Vector3_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, Vector3__Array *, ToArray, (app::List_1_UnityEngine_Vector3_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04731FD0, List_1_UnityEngine_Vector3__ToArray__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02D4AC20, List_1_T_Enumerator_UnityEngine_Vector3_, GetEnumerator, (app::List_1_UnityEngine_Vector3_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02EEC150, void, __ctor_2, (app::List_1_UnityEngine_Vector3_ * this_ptr, app::IEnumerable_1_UnityEngine_Vector3_ * collection));
IL2CPP_REGISTER_METHODINFO(0x04748D50, List_1_UnityEngine_Vector3___ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_3, (app::List_1_UnityEngine_Vector3_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x02EEC5E0, Object *, ICollection_get_SyncRoot, (app::List_1_UnityEngine_Vector3_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D49C20, bool, IsCompatibleObject, (app::Object * value));
IL2CPP_REGISTER_METHOD(0x02D49D10, Object *, IList_get_Item, (app::List_1_UnityEngine_Vector3_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_UnityEngine_Vector3_ *, AsReadOnly, (app::List_1_UnityEngine_Vector3_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D4A5E0, Vector3, Find, (app::List_1_UnityEngine_Vector3_ * this_ptr, app::Predicate_1_UnityEngine_Vector3_ * match));
IL2CPP_REGISTER_METHOD(0x02D4A710, List_1_UnityEngine_Vector3_ *, FindAll, (app::List_1_UnityEngine_Vector3_ * this_ptr, app::Predicate_1_UnityEngine_Vector3_ * match));
...
IL2CPP_REGISTER_METHOD(0x02D4AC60, IEnumerator_1_UnityEngine_Vector3_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_UnityEngine_Vector3_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D4AC60, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_UnityEngine_Vector3_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_UnityEngine_Vector3_ *, GetRange, (app::List_1_UnityEngine_Vector3_ * this_ptr, int32_t index, int32_t count));
