...
IL2CPP_REGISTER_METHOD(0x029E8300, void, __ctor, (app::GUILayoutGroup * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x029E8980, GUILayoutEntry *, GetNext, (app::GUILayoutGroup * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0472EFB8, GUILayoutGroup_GetNext__MethodInfo);
IL2CPP_REGISTER_METHOD(0x029E8C90, Rect, GetLast, (app::GUILayoutGroup * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x029EB5A0, String *, ToString, (app::GUILayoutGroup * this_ptr));
}
