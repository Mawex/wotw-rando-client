...
IL2CPP_REGISTER_METHOD(0x006D6510, SuspendableMask__Enum, get_Mask, (app::PetrifiedOwlFeedingGroundsGameplayController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014DFBA0, IUberState__Array *, get_AffectingUberStates, (app::PetrifiedOwlFeedingGroundsGameplayController * this_ptr));
IL2CPP_REGISTER_METHOD(0x014DFC30, List_1_UnityEngine_GameObject_ *, IUberStateApplier_get_AllTargets, (app::PetrifiedOwlFeedingGroundsGameplayController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014E2BD0, void, __ctor, (app::PetrifiedOwlFeedingGroundsGameplayController * this_ptr));
}
