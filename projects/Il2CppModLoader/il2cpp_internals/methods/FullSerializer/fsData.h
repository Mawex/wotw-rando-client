...
namespace app::methods::FullSerializer::fsData {
    IL2CPP_REGISTER_METHOD(0x0063D180, void, __ctor_1, (app::fsData * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0150A1A0, void, __ctor_2, (app::fsData * this_ptr, bool boolean));
    IL2CPP_REGISTER_METHOD(0x0150A240, void, __ctor_3, (app::fsData * this_ptr, double f));
    IL2CPP_REGISTER_METHOD(0x0150A2E0, void, __ctor_4, (app::fsData * this_ptr, int64_t i));
    IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor_5, (app::fsData * this_ptr, app::String * str));
    IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor_6, (app::fsData * this_ptr, app::Dictionary_2_System_String_FullSerializer_fsData_ * dict));
    IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor_7, (app::fsData * this_ptr, app::List_1_FullSerializer_fsData_ * list));
