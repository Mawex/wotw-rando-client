...
IL2CPP_REGISTER_METHOD(0x0150A630, fsData *, CreateList_1, ());
IL2CPP_REGISTER_METHOD(0x0150A840, fsData *, CreateList_2, (int32_t capacity));
IL2CPP_REGISTER_METHOD(0x0150AA50, void, BecomeDictionary, (app::fsData * this_ptr));
IL2CPP_REGISTER_METHOD(0x0150ABC0, fsData *, Clone, (app::fsData * this_ptr));
IL2CPP_REGISTER_METHOD(0x0150AD10, fsDataType__Enum, get_Type, (app::fsData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0150B440, String *, get_AsString, (app::fsData * this_ptr));
IL2CPP_REGISTER_METHOD(0x0150B4C0, Dictionary_2_System_String_FullSerializer_fsData_ *, get_AsDictionary, (app::fsData * this_ptr));
IL2CPP_REGISTER_METHOD(0x0150B540, List_1_FullSerializer_fsData_ *, get_AsList, (app::fsData * this_ptr));
IL2CPP_REGISTER_METHOD(0x0150B5C0, String *, ToString, (app::fsData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0150BBF0, bool, operator____1, (app::fsData * a, app::fsData * b));
IL2CPP_REGISTER_METHOD(0x0150BD30, bool, operator____2, (app::fsData * a, app::fsData * b));
IL2CPP_REGISTER_METHOD(0x0150BDE0, int32_t, GetHashCode, (app::fsData * this_ptr));
IL2CPP_REGISTER_METHOD(0x0150BE10, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x015E9100, Object *, Cast_1, (app::fsData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x015E9100, String *, Cast_5, (app::fsData * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04738C40, fsData_Cast_4__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015E9100, Dictionary_2_System_String_FullSerializer_fsData_ *, Cast_6, (app::fsData * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04761268, fsData_Cast_5__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015E9100, List_1_FullSerializer_fsData_ *, Cast_7, (app::fsData * this_ptr));
