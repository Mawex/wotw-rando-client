...
namespace app::methods::System_IO::TextWriter_SyncTextWriter {
IL2CPP_REGISTER_METHOD(0x023882C0, void, __ctor, (app::TextWriter_SyncTextWriter * this_ptr, app::TextWriter * t));
IL2CPP_REGISTER_METHOD(0x01706DD0, Encoding *, get_Encoding, (app::TextWriter_SyncTextWriter * this_ptr));
IL2CPP_REGISTER_METHOD(0x01706D40, IFormatProvider *, get_FormatProvider, (app::TextWriter_SyncTextWriter * this_ptr));
IL2CPP_REGISTER_METHOD(0x01706E00, String *, get_NewLine, (app::TextWriter_SyncTextWriter * this_ptr));
