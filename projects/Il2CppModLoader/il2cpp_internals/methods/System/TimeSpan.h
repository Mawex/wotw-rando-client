...
namespace app::methods::System::TimeSpan {
    IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor_1, (app::TimeSpan__Boxed * this_ptr, int64_t ticks));
    IL2CPP_REGISTER_METHOD(0x002034B0, void, __ctor_2, (app::TimeSpan__Boxed * this_ptr, int32_t hours, int32_t minutes, int32_t seconds));
    IL2CPP_REGISTER_METHOD(0x002034C0, void, __ctor_3, (app::TimeSpan__Boxed * this_ptr, int32_t days, int32_t hours, int32_t minutes, int32_t seconds));
    IL2CPP_REGISTER_METHOD(0x002034F0, void, __ctor_4, (app::TimeSpan__Boxed * this_ptr, int32_t days, int32_t hours, int32_t minutes, int32_t seconds, int32_t milliseconds));
