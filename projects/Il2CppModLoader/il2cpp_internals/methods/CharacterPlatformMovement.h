...
IL2CPP_REGISTER_METHOD(0x01303730, Collider *, get_GroundCollider, (app::CharacterPlatformMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x01303740, void, set_GroundCollider, (app::CharacterPlatformMovement * this_ptr, app::Collider * value));
IL2CPP_REGISTER_METHOD(0x01303770, Collider *, get_CeilingCollider, (app::CharacterPlatformMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x01303780, void, set_CeilingCollider, (app::CharacterPlatformMovement * this_ptr, app::Collider * value));
IL2CPP_REGISTER_METHOD(0x013037B0, Collider *, get_WallLeftCollider, (app::CharacterPlatformMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x013037C0, void, set_WallLeftCollider, (app::CharacterPlatformMovement * this_ptr, app::Collider * value));
IL2CPP_REGISTER_METHOD(0x013037F0, Collider *, get_WallRightCollider, (app::CharacterPlatformMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x01303800, void, set_WallRightCollider, (app::CharacterPlatformMovement * this_ptr, app::Collider * value));
IL2CPP_REGISTER_METHOD(0x00696600, DamageDealer *, get_GroundDamageDealer, (app::CharacterPlatformMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x01303830, DamageDealer *, get_CeilingDamageDealer, (app::CharacterPlatformMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x006A67A0, DamageDealer *, get_WallLeftDamageDealer, (app::CharacterPlatformMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x01303840, DamageDealer *, get_WallRightDamageDealer, (app::CharacterPlatformMovement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01303EC0, Vector2, get_KickbackDirection, (app::CharacterPlatformMovement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x013044E0, Vector3, get_RigidbodyVelocity, (app::CharacterPlatformMovement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x013045B0, RaycastHit, get_AntecipationRayHit, (app::CharacterPlatformMovement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01305120, CharacterPlatformMovement_ScheduledSpeedCurve *, ScheduleSpeedCurve, (app::CharacterPlatformMovement * this_ptr, app::CharacterPlatformMovement_ScheduledSpeedCurve * curve_entry));
...
IL2CPP_REGISTER_METHOD(0x01305520, Vector2, GetExternalForceFromSource, (app::CharacterPlatformMovement * this_ptr, app::Object_1 * source));
IL2CPP_REGISTER_METHOD(0x01305720, void, ClearExternalForces, (app::CharacterPlatformMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x013057D0, String *, GetExternalForceSummary, (app::CharacterPlatformMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x01305B10, Vector2, GetExternalForce, (app::CharacterPlatformMovement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01306BE0, Vector2, get_LastSpeed, (app::CharacterPlatformMovement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::CharacterPlatformMovement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0130D3B0, Vector2, CalculatePositionDelta, (app::CharacterPlatformMovement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0130F780, Vector3, get_FeetRayPosition, (app::CharacterPlatformMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x0130F7B0, Vector3, get_HeadRayPosition, (app::CharacterPlatformMovement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01310D50, IEnumerator *, MoveSeinToPositionSmoothly, (app::CharacterPlatformMovement * this_ptr, float position, int32_t frames));
IL2CPP_REGISTER_METHOD(0x01310EC0, void, __ctor, (app::CharacterPlatformMovement * this_ptr));
