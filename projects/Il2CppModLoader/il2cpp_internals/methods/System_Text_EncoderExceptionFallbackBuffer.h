...
namespace app::methods::System_Text::EncoderExceptionFallbackBuffer {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::EncoderExceptionFallbackBuffer * this_ptr));
