...
namespace app::methods::System_Diagnostics_Tracing::StringTypeInfo {
...
IL2CPP_REGISTER_METHOD(0x01A09060, Object *, GetData, (app::StringTypeInfo * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x01A090E0, void, __ctor, (app::StringTypeInfo * this_ptr));
}
