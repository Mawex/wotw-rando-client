...
namespace app::methods::System_Data::XmlTreeGen {
IL2CPP_REGISTER_METHOD(0x030563D0, void, __ctor, (app::XmlTreeGen * this_ptr, app::SchemaFormat__Enum format));
...
IL2CPP_REGISTER_METHOD(0x030578D0, String *, XmlDataTypeName, (app::Type * type));
...
IL2CPP_REGISTER_METHOD(0x0305A440, DataTable__Array *, CreateToplevelTables, (app::XmlTreeGen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0305CAE0, XmlElement *, SchemaTree_2, (app::XmlTreeGen * this_ptr, app::XmlDocument * xd, app::DataTable * dt));
IL2CPP_REGISTER_METHOD(0x0305D2A0, XmlElement *, FillDataSetElement, (app::XmlTreeGen * this_ptr, app::XmlDocument * xd, app::DataSet * ds, app::DataTable * dt));
...
IL2CPP_REGISTER_METHOD(0x0305E120, XmlElement *, HandleRelation, (app::XmlTreeGen * this_ptr, app::DataRelation * rel, app::XmlDocument * dc));
IL2CPP_REGISTER_METHOD(0x0305EC50, XmlElement *, FindSimpleType, (app::XmlElement * schema, app::String * name));
IL2CPP_REGISTER_METHOD(0x0305EE10, XmlElement *, GetSchema, (app::XmlTreeGen * this_ptr, app::String * namespace_u_r_i));
...
IL2CPP_REGISTER_METHOD(0x0305FCB0, String *, FindTargetNamespace, (app::XmlTreeGen * this_ptr, app::DataTable * table));
IL2CPP_REGISTER_METHOD(0x0305FE20, XmlElement *, HandleColumn, (app::XmlTreeGen * this_ptr, app::DataColumn * col, app::XmlDocument * dc, app::XmlElement * schema, bool f_write_ordinal));
IL2CPP_REGISTER_METHOD(0x030608C0, String *, TranslateAcceptRejectRule, (app::AcceptRejectRule__Enum rule));
IL2CPP_REGISTER_METHOD(0x03060960, String *, TranslateRule, (app::Rule__Enum rule));
...
IL2CPP_REGISTER_METHOD(0x03060B20, XmlElement *, FindTypeNode, (app::XmlTreeGen * this_ptr, app::XmlElement * node, app::String * str_type));
IL2CPP_REGISTER_METHOD(0x03060D40, XmlElement *, HandleTable_1, (app::XmlTreeGen * this_ptr, app::DataTable * table, app::XmlDocument * dc, app::XmlElement * schema));
...
IL2CPP_REGISTER_METHOD(0x03061AD0, XmlElement *, HandleTable_2, (app::XmlTreeGen * this_ptr, app::DataTable * table, app::XmlDocument * dc, app::XmlElement * schema, bool gen_nested));
