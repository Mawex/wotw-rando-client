...
IL2CPP_REGISTER_METHOD(0x0062C500, SuspendableMask__Enum, get_Mask, (app::SpiritFlameProjectile * this_ptr));
IL2CPP_REGISTER_METHOD(0x0062C510, void, set_Mask, (app::SpiritFlameProjectile * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x002FBCE0, Transform *, get_StartTarget, (app::SpiritFlameProjectile * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCF0, void, set_StartTarget, (app::SpiritFlameProjectile * this_ptr, app::Transform * value));
IL2CPP_REGISTER_METHOD(0x002FBD00, SeinCharacter *, get_Sein, (app::SpiritFlameProjectile * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD10, void, set_Sein, (app::SpiritFlameProjectile * this_ptr, app::SeinCharacter * value));
IL2CPP_REGISTER_METHOD(0x002FBD20, Transform *, get_AttackableTargetTransform, (app::SpiritFlameProjectile * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBD40, IAttackable *, get_AttackableTarget, (app::SpiritFlameProjectile * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD50, void, set_AttackableTarget, (app::SpiritFlameProjectile * this_ptr, app::IAttackable * value));
IL2CPP_REGISTER_METHOD(0x011D4770, Vector3, get_StartPosition, (app::SpiritFlameProjectile * this_ptr));
IL2CPP_REGISTER_METHOD(0x011D4790, void, set_StartPosition, (app::SpiritFlameProjectile * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x005B0220, SpiritFlame *, get_SpiritFlame, (app::SpiritFlameProjectile * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010B5C80, DamageWeight__Enum, get_DamageWeight, (app::SpiritFlameProjectile * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011D5D80, Vector3, GetPointOnArc_1, (app::SpiritFlameProjectile * this_ptr, float frac, float curve));
IL2CPP_REGISTER_METHOD(0x011D5FA0, Vector3, GetPointOnArc_2, (app::SpiritFlameProjectile * this_ptr, app::SpiritFlameProjectile_PointOnArc poa));
IL2CPP_REGISTER_METHOD(0x011D5FF0, Vector2, GetPointOnArcDelta, (app::SpiritFlameProjectile * this_ptr, app::SpiritFlameProjectile_PointOnArc start_p_o_a, app::SpiritFlameProjectile_PointOnArc end_p_o_a));
IL2CPP_REGISTER_METHOD(0x011D61E0, SpiritFlameProjectile_PointOnArc, CachePointOnArc_1, (app::SpiritFlameProjectile * this_ptr, int32_t point_index, int32_t number_of_points));
IL2CPP_REGISTER_METHOD(0x011D6270, SpiritFlameProjectile_PointOnArc, CachePointOnArc_2, (app::SpiritFlameProjectile * this_ptr, float r));
IL2CPP_REGISTER_METHOD(0x011D62F0, void, CachePointsOnArc, (app::SpiritFlameProjectile * this_ptr));
IL2CPP_REGISTER_METHOD(0x011D6400, Vector2, GetHitVector, (app::SpiritFlameProjectile * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011D81A0, ISpiritFlameAttackable *, IsShootableTarget, (app::SpiritFlameProjectile * this_ptr, app::Collider * target));
IL2CPP_REGISTER_METHOD(0x011D8580, void, FixedUpdate, (app::SpiritFlameProjectile * this_ptr));
IL2CPP_REGISTER_METHOD(0x011D88D0, void, __ctor, (app::SpiritFlameProjectile * this_ptr));
