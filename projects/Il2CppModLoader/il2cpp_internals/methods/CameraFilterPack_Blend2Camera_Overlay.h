...
IL2CPP_REGISTER_METHOD(0x02758D40, Material *, get_material, (app::CameraFilterPack_Blend2Camera_Overlay * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02759F10, void, __ctor, (app::CameraFilterPack_Blend2Camera_Overlay * this_ptr));
}
