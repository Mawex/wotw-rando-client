...
IL2CPP_REGISTER_METHOD(0x015A4070, Vector2, get_Position, (app::MetaballRenderer_TransformMetaball * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E71230, Vector2, get_Speed, (app::MetaballRenderer_TransformMetaball * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00858E20, void, __ctor, (app::MetaballRenderer_TransformMetaball * this_ptr));
}
