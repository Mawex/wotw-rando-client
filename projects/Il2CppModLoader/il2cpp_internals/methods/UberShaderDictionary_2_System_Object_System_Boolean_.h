...
IL2CPP_REGISTER_METHOD(0x0225D7A0, Dictionary_2_TKey_TValue_ValueCollection_System_Object_System_Boolean_ *, get_Values, (app::UberShaderDictionary_2_System_Object_System_Boolean_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0225D7D0, Dictionary_2_TKey_TValue_KeyCollection_System_Object_System_Boolean_ *, get_Keys, (app::UberShaderDictionary_2_System_Object_System_Boolean_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0225D800, IEnumerator_1_KeyValuePair_2_System_Object_System_Boolean_ *, System_Collections_Generic_IEnumerable_System_Collections_Generic_KeyValuePair_TK_TV___GetEnumerator, (app::UberShaderDictionary_2_System_Object_System_Boolean_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0225D800, IEnumerator *, IEnumerable_GetEnumerator, (app::UberShaderDictionary_2_System_Object_System_Boolean_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0225D970, bool, TryGetValue, (app::UberShaderDictionary_2_System_Object_System_Boolean_ * this_ptr, app::Object * key, app::bool * value));
...
IL2CPP_REGISTER_METHOD(0x0225DBC0, void, __ctor, (app::UberShaderDictionary_2_System_Object_System_Boolean_ * this_ptr));
}
