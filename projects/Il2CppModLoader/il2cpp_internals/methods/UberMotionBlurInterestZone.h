...
IL2CPP_REGISTER_METHOD(0x00FCF380, Vector4, GetParams, (app::UberMotionBlurInterestZone * this_ptr, app::Camera * cam));
...
IL2CPP_REGISTER_METHOD(0x008A2C20, void, __ctor, (app::UberMotionBlurInterestZone * this_ptr));
