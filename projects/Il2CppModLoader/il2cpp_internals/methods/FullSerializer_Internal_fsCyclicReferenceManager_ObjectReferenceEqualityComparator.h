...
namespace app::methods::FullSerializer_Internal::fsCyclicReferenceManager_ObjectReferenceEqualityComparator {
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::fsCyclicReferenceManager_ObjectReferenceEqualityComparator * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01652230, void, __cctor, ());
}
