...
IL2CPP_REGISTER_METHOD(0x003FF7D0, SuspendableMask__Enum, get_Mask, (app::LegacyAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x0111BFC0, void, set_Mask, (app::LegacyAnimator * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x00597B10, UpdateType__Enum, get_UpdateType, (app::LegacyAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x005790B0, void, __ctor, (app::LegacyAnimator * this_ptr));
}
