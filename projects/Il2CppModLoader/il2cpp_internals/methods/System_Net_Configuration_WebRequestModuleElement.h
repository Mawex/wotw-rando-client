...
namespace app::methods::System_Net_Configuration::WebRequestModuleElement {
IL2CPP_REGISTER_METHOD(0x01E995C0, void, __ctor_1, (app::WebRequestModuleElement * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047121C8, WebRequestModuleElement__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E995F0, void, __ctor_2, (app::WebRequestModuleElement * this_ptr, app::String * prefix, app::String * type));
IL2CPP_REGISTER_METHODINFO(0x04705588, WebRequestModuleElement__ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E99620, void, __ctor_3, (app::WebRequestModuleElement * this_ptr, app::String * prefix, app::Type * type));
IL2CPP_REGISTER_METHODINFO(0x04763B20, WebRequestModuleElement__ctor_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E99650, String *, get_Prefix, (app::WebRequestModuleElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E996B0, ConfigurationPropertyCollection *, get_Properties, (app::WebRequestModuleElement * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04708D38, WebRequestModuleElement_get_Properties__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E996E0, Type *, get_Type, (app::WebRequestModuleElement * this_ptr));
