...
namespace app::methods::Moon_Telemetry_Performance_Settings::WwiseSoundBankRefCountProfilingSetting {
IL2CPP_REGISTER_METHOD(0x00E41140, ProfilingSettings_SettingType__Enum, get_SettingType, (app::WwiseSoundBankRefCountProfilingSetting * this_ptr));
