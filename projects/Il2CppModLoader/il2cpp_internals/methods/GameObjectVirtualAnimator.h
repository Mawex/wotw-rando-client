...
IL2CPP_REGISTER_METHOD(0x01BA47E0, String *, get_Name, (app::GameObjectVirtualAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA280, GameObject *, get_Target, (app::GameObjectVirtualAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA280, GameObject *, get_ExternalTarget, (app::GameObjectVirtualAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FD1D0, VirtualTimelineRepresentationGroup__Enum, get_Group, (app::GameObjectVirtualAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BA4820, void, __ctor_1, (app::GameObjectVirtualAnimator * this_ptr, app::GameObject * target, app::String * custom_name));
IL2CPP_REGISTER_METHOD(0x01BA4980, void, __ctor_2, (app::GameObjectVirtualAnimator * this_ptr, app::GameObject * target));
...
IL2CPP_REGISTER_METHOD(0x00529E80, AnimatorPlayState__Enum, get_PlayState, (app::GameObjectVirtualAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB00, PlaybackStatus *, get_PlaybackStatus, (app::GameObjectVirtualAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BA4C10, IEventReciever *, get_EventReciever, (app::GameObjectVirtualAnimator * this_ptr));
