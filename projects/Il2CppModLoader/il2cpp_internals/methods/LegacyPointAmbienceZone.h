...
IL2CPP_REGISTER_METHOD(0x0043D9E0, SelectableCategory__Enum, get_Category, (app::LegacyPointAmbienceZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A319E0, void, __ctor, (app::LegacyPointAmbienceZone * this_ptr));
}
