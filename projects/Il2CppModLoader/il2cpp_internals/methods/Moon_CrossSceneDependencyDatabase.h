...
IL2CPP_REGISTER_METHOD(0x00CCF710, CrossSceneDependency *, GetByID, (int32_t object_i_d));
...
IL2CPP_REGISTER_METHOD(0x00CCFD00, List_1_Moon_CrossSceneDependencyInjector_ *, GetInjectors, (int32_t object_i_d));
IL2CPP_REGISTER_METHOD(0x00CCFE20, void, OnEnable, (app::CrossSceneDependencyDatabase * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CCFF40, void, __ctor, (app::CrossSceneDependencyDatabase * this_ptr));
