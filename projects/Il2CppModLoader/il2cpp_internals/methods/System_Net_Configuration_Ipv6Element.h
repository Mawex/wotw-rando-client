...
IL2CPP_REGISTER_METHOD(0x02019BC0, bool, get_Enabled, (Ipv6Element * __this));
IL2CPP_REGISTER_METHODINFO(0x0470F278, Ipv6Element_get_Enabled__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02019BF0, void, set_Enabled, (Ipv6Element * __this, bool value));
IL2CPP_REGISTER_METHODINFO(0x04743F30, Ipv6Element_set_Enabled__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02019C20, ConfigurationPropertyCollection *, get_Properties, (Ipv6Element * __this));
