...
namespace app::methods::ZenFulcrum_VR_OpenVRBinding::CVRSettings {
IL2CPP_REGISTER_METHOD(0x0167B6E0, void, __ctor, (app::CVRSettings * this_ptr, app::void * p_interface));
IL2CPP_REGISTER_METHOD(0x0167B820, String *, GetSettingsErrorNameFromEnum, (app::CVRSettings * this_ptr, app::EVRSettingsError__Enum e_error));
