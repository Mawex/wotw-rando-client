...
namespace app::methods::System_Collections_Generic::List_1_DistortionAnimator_RendererData_Property_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_DistortionAnimator_RendererData_Property_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C21490, DistortionAnimator_RendererData_Property, get_Item, (app::List_1_DistortionAnimator_RendererData_Property_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_DistortionAnimator_RendererData_Property_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02E5B950, void, __ctor_3, (app::List_1_DistortionAnimator_RendererData_Property_ * this_ptr, app::IEnumerable_1_DistortionAnimator_RendererData_Property_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02E5BDE0, Object *, ICollection_get_SyncRoot, (app::List_1_DistortionAnimator_RendererData_Property_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C21620, Object *, IList_get_Item, (app::List_1_DistortionAnimator_RendererData_Property_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_DistortionAnimator_RendererData_Property_ *, AsReadOnly, (app::List_1_DistortionAnimator_RendererData_Property_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C21EE0, DistortionAnimator_RendererData_Property, Find, (app::List_1_DistortionAnimator_RendererData_Property_ * this_ptr, app::Predicate_1_DistortionAnimator_RendererData_Property_ * match));
IL2CPP_REGISTER_METHOD(0x02C22010, List_1_DistortionAnimator_RendererData_Property_ *, FindAll, (app::List_1_DistortionAnimator_RendererData_Property_ * this_ptr, app::Predicate_1_DistortionAnimator_RendererData_Property_ * match));
...
IL2CPP_REGISTER_METHOD(0x02C22520, List_1_T_Enumerator_DistortionAnimator_RendererData_Property_, GetEnumerator, (app::List_1_DistortionAnimator_RendererData_Property_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02C22570, IEnumerator_1_DistortionAnimator_RendererData_Property_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_DistortionAnimator_RendererData_Property_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02C22570, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_DistortionAnimator_RendererData_Property_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_DistortionAnimator_RendererData_Property_ *, GetRange, (app::List_1_DistortionAnimator_RendererData_Property_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, DistortionAnimator_RendererData_Property__Array *, ToArray, (app::List_1_DistortionAnimator_RendererData_Property_ * this_ptr));
