...
namespace app::methods::System::Enum {
    IL2CPP_REGISTER_METHOD(0x01A10D70, Enum_ValuesAndNames*, GetCachedValuesAndNames, (app::RuntimeType * enum_type, bool get_names));
    IL2CPP_REGISTER_METHOD(0x01A11140, String*, InternalFormattedHexString, (app::Object * value));
    IL2CPP_REGISTER_METHODINFO(0x0470CA98, Enum_InternalFormattedHexString__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x01A11560, String*, InternalFormat, (app::RuntimeType * e_t, app::Object* value));
    IL2CPP_REGISTER_METHOD(0x01A116D0, String*, InternalFlagsFormat, (app::RuntimeType * e_t, app::Object* value));
    ...
    IL2CPP_REGISTER_METHOD(0x01A11D70, RuntimeType*, InternalGetUnderlyingType, (app::RuntimeType * enum_type));
    ...
    IL2CPP_REGISTER_METHOD(0x01A11E00, Object*, InternalBoxEnum, (app::RuntimeType * enum_type, int64_t value));
    IL2CPP_REGISTER_METHOD(0x01A11E30, Object*, Parse_1, (app::Type * enum_type, app::String* value));
    IL2CPP_REGISTER_METHOD(0x01A11EE0, Object*, Parse_2, (app::Type * enum_type, app::String* value, bool ignore_case));
    ...
    IL2CPP_REGISTER_METHOD(0x01A12800, Type*, GetUnderlyingType, (app::Type * enum_type));
    IL2CPP_REGISTER_METHODINFO(0x04738E78, Enum_GetUnderlyingType__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x01A128E0, Array*, GetValues, (app::Type * enum_type));
    IL2CPP_REGISTER_METHODINFO(0x0471BF50, Enum_GetValues__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x01A129C0, UInt64__Array*, InternalGetValues, (app::RuntimeType * enum_type));
    IL2CPP_REGISTER_METHOD(0x01A12A70, String*, GetName, (app::Type * enum_type, app::Object* value));
    IL2CPP_REGISTER_METHODINFO(0x0475CD18, Enum_GetName__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x01A12B60, String__Array*, GetNames, (app::Type * enum_type));
    IL2CPP_REGISTER_METHODINFO(0x0471A0A0, Enum_GetNames__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x01A12C40, String__Array*, InternalGetNames, (app::RuntimeType * enum_type));
    IL2CPP_REGISTER_METHOD(0x01A12CF0, Object*, ToObject_1, (app::Type * enum_type, app::Object* value));
    ...
    IL2CPP_REGISTER_METHOD(0x01A13370, String*, Format, (app::Type * enum_type, app::Object* value, app::String* format));
    IL2CPP_REGISTER_METHODINFO(0x04723A50, Enum_Format__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x01A13AD0, Object*, get_value, (app::Enum__Boxed * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01A13AD0, Object*, GetValue, (app::Enum__Boxed * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01A13D50, String*, ToString_1, (app::Enum__Boxed * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01A13F60, String*, ToString_2, (app::Enum__Boxed * this_ptr, app::String* format, app::IFormatProvider* provider));
    ...
    IL2CPP_REGISTER_METHOD(0x01A14270, String*, ToString_3, (app::Enum__Boxed * this_ptr, app::String* format));
    IL2CPP_REGISTER_METHODINFO(0x04758908, Enum_ToString_2__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x01742A00, String*, ToString_4, (app::Enum__Boxed * this_ptr, app::IFormatProvider* provider));
    ...
    IL2CPP_REGISTER_METHOD(0x01A14D00, TypeCode__Enum, GetTypeCode, (app::Enum__Boxed * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01A16800, Decimal, IConvertible_ToDecimal, (app::Enum__Boxed * this_ptr, app::IFormatProvider* provider));
    IL2CPP_REGISTER_METHOD(0x01A16A10, DateTime, IConvertible_ToDateTime, (app::Enum__Boxed * this_ptr, app::IFormatProvider* provider));
    IL2CPP_REGISTER_METHODINFO(0x04709070, Enum_System_IConvertible_ToDateTime__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x01A16AE0, Object*, IConvertible_ToType, (app::Enum__Boxed * this_ptr, app::Type* type, app::IFormatProvider* provider));
    IL2CPP_REGISTER_METHOD(0x01A16BA0, Object*, ToObject_2, (app::Type * enum_type, int8_t value));
    IL2CPP_REGISTER_METHODINFO(0x047032F8, Enum_ToObject_1__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x01A16DC0, Object*, ToObject_3, (app::Type * enum_type, int16_t value));
    IL2CPP_REGISTER_METHODINFO(0x04749628, Enum_ToObject_2__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x01A16FE0, Object*, ToObject_4, (app::Type * enum_type, int32_t value));
    IL2CPP_REGISTER_METHODINFO(0x047156A0, Enum_ToObject_3__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x01A17200, Object*, ToObject_5, (app::Type * enum_type, uint8_t value));
    IL2CPP_REGISTER_METHODINFO(0x047754D8, Enum_ToObject_4__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x01A17420, Object*, ToObject_6, (app::Type * enum_type, uint16_t value));
    IL2CPP_REGISTER_METHODINFO(0x04798CD0, Enum_ToObject_5__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x01A17640, Object*, ToObject_7, (app::Type * enum_type, uint32_t value));
    IL2CPP_REGISTER_METHODINFO(0x04703300, Enum_ToObject_6__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x01A17860, Object*, ToObject_8, (app::Type * enum_type, int64_t value));
    IL2CPP_REGISTER_METHODINFO(0x04717220, Enum_ToObject_7__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x01A17A80, Object*, ToObject_9, (app::Type * enum_type, uint64_t value));
    IL2CPP_REGISTER_METHODINFO(0x04780BE0, Enum_ToObject_8__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x01A17CA0, Object*, ToObject_10, (app::Type * enum_type, uint16_t value));
    IL2CPP_REGISTER_METHODINFO(0x0475AA28, Enum_ToObject_9__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x01A17EC0, Object*, ToObject_11, (app::Type * enum_type, bool value));
    IL2CPP_REGISTER_METHODINFO(0x04737950, Enum_ToObject_10__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::Enum__Boxed * this_ptr));
