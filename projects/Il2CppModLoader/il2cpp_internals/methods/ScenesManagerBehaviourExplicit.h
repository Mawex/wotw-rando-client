...
IL2CPP_REGISTER_METHOD(0x01052D80, Vector2, get_PredictedTargetPosition, (app::ScenesManagerBehaviourExplicit * this_ptr));
IL2CPP_REGISTER_METHOD(0x00597B10, ScenesManagerUpdateType__Enum, get_CurrentUpdateType, (app::ScenesManagerBehaviourExplicit * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01056BB0, void, __ctor, (app::ScenesManagerBehaviourExplicit * this_ptr));
}
