...
namespace app::methods::Moon_UI::UberShaderDrivenComponent {
...
IL2CPP_REGISTER_METHOD(0x0118BA10, Transform *, get_Sprite, (app::UberShaderDrivenComponent * this_ptr));
IL2CPP_REGISTER_METHOD(0x0118BB80, UberShaderComponent *, get_UberShader, (app::UberShaderDrivenComponent * this_ptr));
IL2CPP_REGISTER_METHOD(0x00597BB0, void, __ctor, (app::UberShaderDrivenComponent * this_ptr));
}
