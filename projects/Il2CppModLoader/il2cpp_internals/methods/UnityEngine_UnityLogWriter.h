...
IL2CPP_REGISTER_METHOD(0x02C70CE0, void, __ctor, (app::UnityLogWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C711D0, Encoding *, get_Encoding, (app::UnityLogWriter * this_ptr));
