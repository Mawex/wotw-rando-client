...
IL2CPP_REGISTER_METHOD(0x024DB110, Material *, get_material, (app::CameraFilterPack_Color_RGB * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024DB9D0, void, __ctor, (app::CameraFilterPack_Color_RGB * this_ptr));
}
