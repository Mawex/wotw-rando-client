...
namespace app::methods::AkExternalSourceInfo {
    IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkExternalSourceInfo * this_ptr, void * c_ptr, bool c_memory_own));
    ...
    IL2CPP_REGISTER_METHOD(0x026E4B30, void, __ctor_3, (app::AkExternalSourceInfo * this_ptr, void * in_p_in_memory, uint32_t in_ui_memory_size, uint32_t in_i_external_src_cookie, uint32_t in_id_codec));
