...
namespace app::methods::Moon_Setups::ChangeMultipleStatesOnCondition {
...
IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::ChangeMultipleStatesOnCondition * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00ED2230, IDesiredUberState *, GetRequirementsForTimeline, (app::ChangeMultipleStatesOnCondition * this_ptr, app::MoonTimeline * timeline));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::ChangeMultipleStatesOnCondition * this_ptr));
}
