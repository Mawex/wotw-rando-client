...
IL2CPP_REGISTER_METHOD(0x005D06C0, CharacterPlatformMovement *, get_PlatformMovement, (app::SeinChakramSpell * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00DAAAF0, bool, TestScatterShotShard, (app::SeinChakramSpell * this_ptr, app::int32_t * count, app::float * interval, app::bool * split_damage));
...
IL2CPP_REGISTER_METHOD(0x00DAB750, IBowAttackable *, GetClosestTarget, (app::SeinChakramSpell * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, ComboMoveType__Enum, get_ComboMoveType, (app::SeinChakramSpell * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, ButtonInputType__Enum, get_ButtonInputType, (app::SeinChakramSpell * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00DAC6C0, IComboMove *, GetComboMove, (app::SeinChakramSpell * this_ptr, app::ComboInput * input));
IL2CPP_REGISTER_METHOD(0x006FB810, List_1_Moon_ComboSystem_IComboMove_ *, get_ComboMoves, (app::SeinChakramSpell * this_ptr));
IL2CPP_REGISTER_METHOD(0x00DAC730, AbilityType__Enum, get_ComboAbilityType, (app::SeinChakramSpell * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00DAC740, void, __ctor, (app::SeinChakramSpell * this_ptr));
}
