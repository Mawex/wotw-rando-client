...
IL2CPP_REGISTER_METHOD(0x00C69CE0, Int32__Array *, GetAllStateGUIDs, (app::PostStateDefinition * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C69E10, String *, GetStateName, (app::PostStateDefinition * this_ptr, int32_t state_g_u_i_d));
IL2CPP_REGISTER_METHOD(0x00C69EC0, bool, HasStateGUID, (app::PostStateDefinition * this_ptr, int32_t state_g_u_i_d));
IL2CPP_REGISTER_METHOD(0x00C69EE0, PostStateDefinition_PostState *, GetStateByGuid, (app::PostStateDefinition * this_ptr, int32_t guid));
...
IL2CPP_REGISTER_METHOD(0x00C6A500, void, __ctor, (app::PostStateDefinition * this_ptr));
}
