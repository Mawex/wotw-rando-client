...
namespace app::methods::DeathsPlugin {
    ...
    IL2CPP_REGISTER_METHOD(0x00DE1320, List_1_UnityEngine_Vector3_*, ExtractDataFromRecorder, (app::RecorderData * recorder_data));
    IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::DeathsPlugin * this_ptr));
} // namespace app::methods::DeathsPlugin
