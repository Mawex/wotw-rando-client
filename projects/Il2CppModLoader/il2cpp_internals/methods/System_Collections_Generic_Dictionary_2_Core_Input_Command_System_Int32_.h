...
namespace app::methods::System_Collections_Generic::Dictionary_2_Core_Input_Command_System_Int32_ {
...
IL2CPP_REGISTER_METHOD(0x02BB43A0, bool, TryGetValue, (app::Dictionary_2_Core_Input_Command_System_Int32_ * this_ptr, app::Input_Command__Enum key, app::int32_t * value));
...
IL2CPP_REGISTER_METHOD(0x0283AC50, void, __ctor, (app::Dictionary_2_Core_Input_Command_System_Int32_ * this_ptr, app::IEqualityComparer_1_Core_Input_Command_ * comparer));
