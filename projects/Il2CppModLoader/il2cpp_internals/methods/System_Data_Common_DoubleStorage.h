...
namespace app::methods::System_Data_Common::DoubleStorage {
IL2CPP_REGISTER_METHOD(0x02165450, void, __ctor, (app::DoubleStorage * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x02165570, Object *, Aggregate, (app::DoubleStorage * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x02165E80, Object *, ConvertValue, (app::DoubleStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02165FB0, void, Copy, (app::DoubleStorage * this_ptr, int32_t record_no1, int32_t record_no2));
IL2CPP_REGISTER_METHOD(0x02166070, Object *, Get, (app::DoubleStorage * this_ptr, int32_t record));
...
IL2CPP_REGISTER_METHOD(0x02166450, Object *, ConvertXmlToObject, (app::DoubleStorage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x02166510, String *, ConvertObjectToXml, (app::DoubleStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x021665E0, Object *, GetEmptyStorage, (app::DoubleStorage * this_ptr, int32_t record_count));
