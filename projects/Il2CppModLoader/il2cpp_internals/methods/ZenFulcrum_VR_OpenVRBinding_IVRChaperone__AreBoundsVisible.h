...
namespace app::methods::ZenFulcrum_VR_OpenVRBinding::IVRChaperone__AreBoundsVisible {
    IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::IVRChaperone_AreBoundsVisible * this_ptr, app::Object * object, void * method_1));
