...
IL2CPP_REGISTER_METHOD(0x00583910, RuntimeGameWorldArea *, FindAreaFromPosition, (app::WorldMapLogic * this_ptr, app::Vector3 camera_position));
...
IL2CPP_REGISTER_METHOD(0x003FD3F0, SuspendableMask__Enum, get_Mask, (app::WorldMapLogic * this_ptr));
IL2CPP_REGISTER_METHOD(0x00583BA0, void, set_Mask, (app::WorldMapLogic * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x00583C50, void, __ctor, (app::WorldMapLogic * this_ptr));
IL2CPP_REGISTER_METHOD(0x00583D20, void, __cctor, ());
}
