...
namespace app::methods::System_Dynamic::ExpandoObject__GetExpandoEnumerator_d__51 {
IL2CPP_REGISTER_METHOD(0x002FC6E0, void, __ctor, (app::ExpandoObject_GetExpandoEnumerator_d_51 * this_ptr, int32_t __1__state));
...
IL2CPP_REGISTER_METHOD(0x00C3DD30, KeyValuePair_2_System_String_System_Object_, IEnumerator_KeyValuePair_string__object___get_Current, (app::ExpandoObject_GetExpandoEnumerator_d_51 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F8F640, Object *, IEnumerator_get_Current, (app::ExpandoObject_GetExpandoEnumerator_d_51 * this_ptr));
}
