...
IL2CPP_REGISTER_METHOD(0x012D3960, Color, get_Color, (app::ColorStateModifierDataWisps * this_ptr));
IL2CPP_REGISTER_METHOD(0x012D3A10, void, set_Color, (app::ColorStateModifierDataWisps * this_ptr, app::Color value));
IL2CPP_REGISTER_METHOD(0x012D3AE0, ColorAnimator_ColorType__Enum, get_ColorType, (app::ColorStateModifierDataWisps * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012D3E80, void, __ctor, (app::ColorStateModifierDataWisps * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012D4310, Dictionary_2_System_Int32_System_Type_ *, GetIdToTypeMap, (app::ColorStateModifierDataWisps * this_ptr));
}
