...
IL2CPP_REGISTER_METHOD(0x01C0C750, DynamicReflectionDelegateFactory *, get_Instance, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x01C0E2E0, void, __cctor, (MethodInfo * method));
