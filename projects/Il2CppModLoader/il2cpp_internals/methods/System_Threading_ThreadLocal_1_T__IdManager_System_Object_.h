...
namespace app::methods::System_Threading::ThreadLocal_1_T__IdManager_System_Object_ {
...
IL2CPP_REGISTER_METHOD(0x02A5FBD0, void, __ctor, (app::ThreadLocal_1_T_IdManager_System_Object_ * this_ptr));
}
