...
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::MoonTelemetry_SendRequestData * this_ptr, app::String * body));
...
IL2CPP_REGISTER_METHOD(0x02E9FF80, MoonTelemetrySendRequest *, GetRequest, (app::MoonTelemetry_SendRequestData * this_ptr));
}
