...
IL2CPP_REGISTER_METHOD(0x009E6BB0, MenuScreen *, get_Top, (app::MenuScreenStack * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009E7410, void, __ctor, (app::MenuScreenStack * this_ptr));
}
