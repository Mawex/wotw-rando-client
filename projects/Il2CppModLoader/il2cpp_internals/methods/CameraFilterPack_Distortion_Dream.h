...
IL2CPP_REGISTER_METHOD(0x024E6190, Material *, get_material, (app::CameraFilterPack_Distortion_Dream * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E8940, void, __ctor, (app::CameraFilterPack_Distortion_Dream * this_ptr));
}
