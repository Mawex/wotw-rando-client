...
namespace app::methods::System_Collections_Generic::Queue_1_List_1_ServerObject__ {
IL2CPP_REGISTER_METHOD(0x0243CB70, void, __ctor, (app::Queue_1_List_1_ServerObject_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CA77B0, List_1_ServerObject_ *, Dequeue, (app::Queue_1_List_1_ServerObject_ * this_ptr));
