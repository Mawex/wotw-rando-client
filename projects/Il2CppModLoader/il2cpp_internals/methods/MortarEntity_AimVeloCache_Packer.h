...
IL2CPP_REGISTER_METHOD(0x0147CC30, void, __ctor, (app::MortarEntity_AimVeloCache_Packer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0147CFD0, Vector2, UnpackVelocity, (app::MortarEntity_AimVeloCache_Packer * this_ptr, uint16_t vi));
