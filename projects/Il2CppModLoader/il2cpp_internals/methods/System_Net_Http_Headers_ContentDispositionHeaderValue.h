...
namespace app::methods::System_Net_Http_Headers::ContentDispositionHeaderValue {
...
IL2CPP_REGISTER_METHOD(0x02D05E20, ICollection_1_System_Net_Http_Headers_NameValueHeaderValue_ *, get_Parameters, (app::ContentDispositionHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D05F80, Object *, ICloneable_Clone, (app::ContentDispositionHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D063E0, String *, ToString, (app::ContentDispositionHeaderValue * this_ptr));
