...
namespace app::methods::System_Runtime_Serialization_Formatters_Binary::MemberPrimitiveUnTyped {
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MemberPrimitiveUnTyped * this_ptr));
