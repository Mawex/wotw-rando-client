...
namespace app::methods::System_Collections_Generic::List_1_Game_IFrustumEnabled_ {
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_Game_IFrustumEnabled_, GetEnumerator, (app::List_1_Game_IFrustumEnabled_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EFC50, IFrustumEnabled *, get_Item, (app::List_1_Game_IFrustumEnabled_ * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x04770640, List_1_Game_IFrustumEnabled__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_Game_IFrustumEnabled_ * this_ptr));
