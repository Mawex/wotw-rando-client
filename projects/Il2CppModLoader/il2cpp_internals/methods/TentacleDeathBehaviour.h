...
IL2CPP_REGISTER_METHOD(0x00CEEF40, BehaviourStatus__Enum, OnExecuteTask, (app::TentacleDeathBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00CEEFA0, void, OnExitTask, (app::TentacleDeathBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00CEF000, void, __ctor, (app::TentacleDeathBehaviour * this_ptr));
}
