...
IL2CPP_REGISTER_METHOD(0x010F6290, Transform *, get_Transform, (app::TimelineCharacterPreviewManager_CharacterPreviewInstance * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::TimelineCharacterPreviewManager_CharacterPreviewInstance * this_ptr));
}
