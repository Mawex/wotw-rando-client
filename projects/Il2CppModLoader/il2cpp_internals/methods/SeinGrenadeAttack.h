...
IL2CPP_REGISTER_METHOD(0x014D0B10, AbilityType__Enum, get_AbilityType, (app::SeinGrenadeAttack * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005D06F0, CharacterLeftRightMovement *, get_CharacterLeftRightMovement, (app::SeinGrenadeAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x006E4240, CharacterGravity *, get_CharacterGravity, (app::SeinGrenadeAttack * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014D2AA0, Vector3, get_GrenadeSpawnPosition, (app::SeinGrenadeAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x014D2BD0, Vector3, get_RightHandPosition, (app::SeinGrenadeAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x014D2D80, Vector3, get_SeinCenterPosition, (app::SeinGrenadeAttack * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014D7CC0, IAttackable *, get_FindAutoAttackable, (app::SeinGrenadeAttack * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014D8440, Vector3, GetSafeGrenadeSpawnPosition, (app::SeinGrenadeAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x014D8960, Vector2, VelocityToAimAtTarget, (app::SeinGrenadeAttack * this_ptr, app::IAttackable * attackable));
...
IL2CPP_REGISTER_METHOD(0x00696560, StressTestStatus__Enum, get_StressTestStatus, (app::SeinGrenadeAttack * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014D8D90, String *, get_StressTestName, (app::SeinGrenadeAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x014D8E10, void, __ctor, (app::SeinGrenadeAttack * this_ptr));
}
