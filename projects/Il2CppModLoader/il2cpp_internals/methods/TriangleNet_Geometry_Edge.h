...
namespace app::methods::TriangleNet_Geometry::Edge {
    ...
    IL2CPP_REGISTER_METHOD(0x0261B9A0, void, __ctor_1, (app::Edge * this_ptr, int32_t p0, int32_t p1));
    IL2CPP_REGISTER_METHOD(0x0133CEF0, void, __ctor_2, (app::Edge * this_ptr, int32_t p0, int32_t p1, int32_t label));
}
