...
IL2CPP_REGISTER_METHOD(0x011B8AB0, MoonTimeline *, GetTimeline, (app::SpiderBossSpitBehaviour * this_ptr, app::MirroredTimelineSet * set));
...
IL2CPP_REGISTER_METHOD(0x011B9D90, BehaviourStatus__Enum, OnExecute, (app::SpiderBossSpitBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x011BA6B0, void, __ctor, (app::SpiderBossSpitBehaviour * this_ptr));
}
