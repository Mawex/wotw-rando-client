...
IL2CPP_REGISTER_METHOD(0x01781C60, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossWallCrushBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01782390, Enum__Array *, GetEntries, (app::PetrifiedOwlBossWallCrushBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x01782430, Enum, Evaluate, (app::PetrifiedOwlBossWallCrushBehaviour * this_ptr));
