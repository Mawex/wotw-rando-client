...
IL2CPP_REGISTER_METHOD(0x007FE740, ScenesManager *, get_ScenesManager, (app::GoToSceneController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007FFE80, void, __ctor, (app::GoToSceneController * this_ptr));
}
