...
namespace app::methods::ZenFulcrum_VR_OpenVRBinding::IVRRenderModels__FreeRenderModel {
    IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::IVRRenderModels_FreeRenderModel * this_ptr, app::Object * object, void * method_1));
