...
namespace app::methods::System_Collections_Generic::List_1_DeathInformation_ {
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_DeathInformation_, GetEnumerator, (app::List_1_DeathInformation_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EFC50, DeathInformation *, get_Item, (app::List_1_DeathInformation_ * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x0473C438, List_1_DeathInformation__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_DeathInformation_ * this_ptr));
