...
namespace app::methods::UnityStandardAssets_CinematicEffects::SMAA {
IL2CPP_REGISTER_METHOD(0x02508F20, Shader *, get_shader, (app::SMAA * this_ptr));
IL2CPP_REGISTER_METHOD(0x02509030, Texture2D *, get_areaTexture, (app::SMAA * this_ptr));
IL2CPP_REGISTER_METHOD(0x02509110, Texture2D *, get_searchTexture, (app::SMAA * this_ptr));
IL2CPP_REGISTER_METHOD(0x025091F0, Material *, get_material, (app::SMAA * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0250AF90, RenderTexture *, TempRT, (app::SMAA * this_ptr, int32_t width, int32_t height, app::RenderTextureFormat__Enum format));
IL2CPP_REGISTER_METHOD(0x0250B0C0, void, __ctor, (app::SMAA * this_ptr));
}
