...
namespace app::methods::Moon_VisualDebug::LineEntity {
    IL2CPP_REGISTER_METHOD(0x00417920, int32_t, get_Mode, (app::LineEntity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x011929E0, void, __ctor, (app::LineEntity * this_ptr, app::Vector3 start, app::Vector3 end, app::Color color));
