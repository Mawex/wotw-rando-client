...
namespace app::methods::System_Collections_Generic::List_1_System_Threading_Timer_ {
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor, (app::List_1_System_Threading_Timer_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x025EFC50, Timer *, get_Item, (app::List_1_System_Threading_Timer_ * this_ptr, int32_t index));
