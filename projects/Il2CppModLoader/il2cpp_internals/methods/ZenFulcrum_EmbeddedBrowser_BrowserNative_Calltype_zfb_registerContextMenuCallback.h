...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::BrowserNative_Calltype_zfb_registerContextMenuCallback * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x01DC9FF0, IAsyncResult *, BeginInvoke, (app::BrowserNative_Calltype_zfb_registerContextMenuCallback * this_ptr, int32_t id, app::BrowserNative_ShowContextMenuFunc * cb, app::AsyncCallback * callback, app::Object * object));
