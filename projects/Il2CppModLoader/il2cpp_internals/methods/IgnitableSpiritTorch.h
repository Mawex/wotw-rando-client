...
IL2CPP_REGISTER_METHOD(0x00625D40, IgnitableSpiritTorch *, IgniteAnyTorchesNearPosition, (app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x00625FB0, void, Light, (app::IgnitableSpiritTorch * this_ptr, bool by_grenade));
IL2CPP_REGISTER_METHOD(0x006260E0, Vector3, get_Position, (app::IgnitableSpiritTorch * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006263E0, void, __ctor, (app::IgnitableSpiritTorch * this_ptr));
