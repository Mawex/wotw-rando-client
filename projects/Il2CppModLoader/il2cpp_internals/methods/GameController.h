...
IL2CPP_REGISTER_METHOD(0x00689A60, GameController_GameDifficultyModes__Enum, get_GameDifficultyMode, (app::GameController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00689F30, String *, get_GameParametersFilePath, (app::GameController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0068A510, SuspendableMask__Enum, get_Mask, (app::GameController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0068C050, IEnumerator *, RestartingCleanupNextFrame, (app::GameController * this_ptr));
IL2CPP_REGISTER_METHOD(0x0068C1A0, void, StartNewGame, (app::GameController * this_ptr));
IL2CPP_REGISTER_METHOD(0x0068C1E0, PlayerLoopSystem, FilterLoopSubsytems, (app::GameController * this_ptr, app::PlayerLoopSystem root, app::Type__Array * types));
IL2CPP_REGISTER_METHOD(0x0068C450, void, Initialize, (app::GameController * this_ptr));
IL2CPP_REGISTER_METHOD(0x0068D630, PlatformServiceProvider *, get_PlatformServiceProvider, (app::GameController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0068D650, IRaceServiceProvider *, get_RaceServiceServiceProvider, (app::GameController * this_ptr));
IL2CPP_REGISTER_METHOD(0x0068D680, RestartReason__Enum, get_RestartReason, (app::GameController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0068E390, IEnumerator *, Start, (app::GameController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0068FE50, IEnumerator *, StartBuildInScene, (app::GameController * this_ptr, app::String * scene_name));
IL2CPP_REGISTER_METHOD(0x0068FFA0, String *, ParseArgument, (app::GameController * this_ptr, app::String * flag));
IL2CPP_REGISTER_METHOD(0x006903A0, void, OnApplicationFocus, (app::GameController * this_ptr, bool focus_status));
IL2CPP_REGISTER_METHOD(0x00690680, IEnumerator *, SetRunInBackgroundToTrue, (app::GameController * this_ptr));
IL2CPP_REGISTER_METHOD(0x006907D0, IEnumerator *, LoadAssets, (app::GameController * this_ptr, app::List_1_System_String_ * assets_to_load));
...
IL2CPP_REGISTER_METHOD(0x00691730, IEnumerator *, WarmUpResourcesRoutine, (app::GameController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00695500, Objective *, GetObjectiveFromIndex, (app::GameController * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x00696600, List_1_TelemetryFpsSample_ *, get_FPSSamples, (app::GameController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00697D30, GameController_GameModeBalanceSettings *, get_CurrentGameModeBalanceSettings, (app::GameController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00697ED0, void, __ctor, (app::GameController * this_ptr));
