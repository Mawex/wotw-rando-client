...
namespace app::methods::GasballEntity {
    IL2CPP_REGISTER_METHOD(0x0041EBA0, GasballEntity_InflateState__Enum, GetNextInflateState, (app::GasballEntity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0041F890, void, __ctor, (app::GasballEntity * this_ptr));
} // namespace app::methods::GasballEntity
