...
namespace app::methods::System_Xml::XmlEntity {
IL2CPP_REGISTER_METHOD(0x01DB52D0, void, __ctor, (app::XmlEntity * this_ptr, app::String * name, app::String * strdata, app::String * public_id, app::String * system_id, app::String * notation_name, app::XmlDocument * doc));
IL2CPP_REGISTER_METHOD(0x01DB5380, XmlNode *, CloneNode, (app::XmlEntity * this_ptr, bool deep));
...
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_Name, (app::XmlEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_LocalName, (app::XmlEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01DAF6D0, String *, get_InnerText, (app::XmlEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01DB5460, XmlLinkedNode *, get_LastNode, (app::XmlEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005D89A0, XmlNodeType__Enum, get_NodeType, (app::XmlEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_SystemId, (app::XmlEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9D0, String *, get_BaseURI, (app::XmlEntity * this_ptr));
