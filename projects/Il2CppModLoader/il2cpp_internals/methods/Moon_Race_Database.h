...
namespace app::methods::Moon_Race::Database {
IL2CPP_REGISTER_METHOD(0x00C3F180, String *, get_RacesFolder, ());
IL2CPP_REGISTER_METHOD(0x00C3F270, String *, get_PresetsFolder, ());
IL2CPP_REGISTER_METHOD(0x00C3F380, List_1_Moon_Race_LeaderBoardEntry_ *, GetLeaderBoard, (app::Database * this_ptr, app::String * race_name));
IL2CPP_REGISTER_METHOD(0x00C3F560, List_1_Moon_Race_LeaderBoardEntry_ *, GetLeaderBoardWithLocalPlayerTime, (app::Database * this_ptr, app::String * race_name));
...
IL2CPP_REGISTER_METHOD(0x00C40B50, void, __ctor, (app::Database * this_ptr));
}
