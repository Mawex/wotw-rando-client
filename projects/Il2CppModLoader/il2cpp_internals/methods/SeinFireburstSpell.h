...
IL2CPP_REGISTER_METHOD(0x006E4240, CharacterGravity *, get_CharacterGravity, (app::SeinFireburstSpell * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D06F0, CharacterLeftRightMovement *, get_CharacterLeftRightMovement, (app::SeinFireburstSpell * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement *, get_PlatformMovement, (app::SeinFireburstSpell * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00ADF2A0, void, __ctor, (app::SeinFireburstSpell * this_ptr));
}
