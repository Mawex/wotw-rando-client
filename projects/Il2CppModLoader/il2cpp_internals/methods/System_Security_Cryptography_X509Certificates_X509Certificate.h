...
IL2CPP_REGISTER_METHOD(0x01E16110, X509CertificateImpl *, get_Impl, (app::X509Certificate_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E16290, Byte__Array *, GetCertHash, (app::X509Certificate_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E162F0, String *, GetCertHashString, (app::X509Certificate_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E16320, int32_t, GetHashCode, (app::X509Certificate_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E16380, String *, GetIssuerName, (app::X509Certificate_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E163C0, String *, GetName, (app::X509Certificate_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E16400, Byte__Array *, GetPublicKey, (app::X509Certificate_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E16440, Byte__Array *, GetRawCertData, (app::X509Certificate_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E16480, Byte__Array *, GetSerialNumber, (app::X509Certificate_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E164C0, String *, GetSerialNumberString, (app::X509Certificate_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E16610, String *, ToString_1, (app::X509Certificate_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E16650, String *, ToString_2, (app::X509Certificate_1 * this_ptr, bool f_verbose));
...
IL2CPP_REGISTER_METHOD(0x01E16810, String *, get_Issuer, (app::X509Certificate_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E16860, String *, get_Subject, (app::X509Certificate_1 * this_ptr));
