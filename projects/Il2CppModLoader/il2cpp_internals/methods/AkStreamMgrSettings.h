...
namespace app::methods::AkStreamMgrSettings {
    IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkStreamMgrSettings * this_ptr, void * c_ptr, bool c_memory_own));
    ...
    IL2CPP_REGISTER_METHOD(0x026FC800, void, __ctor_2, (app::AkStreamMgrSettings * this_ptr));
}
