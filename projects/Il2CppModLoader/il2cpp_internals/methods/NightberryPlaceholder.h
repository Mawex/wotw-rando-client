...
IL2CPP_REGISTER_METHOD(0x00609A90, IEnumerator *, HackForFixingNightberry, (app::NightberryPlaceholder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::NightberryPlaceholder * this_ptr));
}
