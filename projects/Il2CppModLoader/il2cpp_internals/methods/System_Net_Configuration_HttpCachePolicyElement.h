...
namespace app::methods::System_Net_Configuration::HttpCachePolicyElement {
IL2CPP_REGISTER_METHOD(0x02019500, void, __ctor, (app::HttpCachePolicyElement * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0470E678, HttpCachePolicyElement__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02019530, TimeSpan, get_MaximumAge, (app::HttpCachePolicyElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02019590, TimeSpan, get_MaximumStale, (app::HttpCachePolicyElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020195F0, TimeSpan, get_MinimumFresh, (app::HttpCachePolicyElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02019650, HttpRequestCacheLevel__Enum, get_PolicyLevel, (app::HttpCachePolicyElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020196B0, ConfigurationPropertyCollection *, get_Properties, (app::HttpCachePolicyElement * this_ptr));
