...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::IVRCompositor_ClearLastSubmittedFrame * this_ptr, app::Object * object, app::void * method_1));
IL2CPP_REGISTER_METHOD(0x00611820, void, Invoke, (app::IVRCompositor_ClearLastSubmittedFrame * this_ptr));
IL2CPP_REGISTER_METHOD(0x00611B10, IAsyncResult *, BeginInvoke, (app::IVRCompositor_ClearLastSubmittedFrame * this_ptr, app::AsyncCallback * callback, app::Object * object));
