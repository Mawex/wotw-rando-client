...
namespace app::methods::UnityEngine_EventSystems::PointerInputModule_MouseState {
IL2CPP_REGISTER_METHOD(0x01F258E0, void, __ctor, (app::PointerInputModule_MouseState * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F25C10, PointerInputModule_ButtonState *, GetButtonState, (app::PointerInputModule_MouseState * this_ptr, app::PointerEventData_InputButton__Enum button));
