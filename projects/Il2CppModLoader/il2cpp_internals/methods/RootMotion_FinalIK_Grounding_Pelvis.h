...
namespace app::methods::RootMotion_FinalIK::Grounding_Pelvis {
IL2CPP_REGISTER_METHOD(0x007EC230, Vector3, get_IKOffset, (app::Grounding_Pelvis * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::Grounding_Pelvis * this_ptr));
}
