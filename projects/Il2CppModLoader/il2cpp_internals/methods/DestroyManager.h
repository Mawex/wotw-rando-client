...
IL2CPP_REGISTER_METHOD(0x00B8A5C0, void, __ctor, (app::DestroyManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B8B040, DestroyManager_CountAndCallback *, GetAvailableCountAndCallback, (app::DestroyManager * this_ptr));
