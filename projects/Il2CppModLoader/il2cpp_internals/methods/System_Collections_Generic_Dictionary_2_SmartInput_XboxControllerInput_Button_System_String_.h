...
namespace app::methods::System_Collections_Generic::Dictionary_2_SmartInput_XboxControllerInput_Button_System_String_ {
...
IL2CPP_REGISTER_METHOD(0x02C35530, String *, get_Item, (app::Dictionary_2_SmartInput_XboxControllerInput_Button_System_String_ * this_ptr, app::XboxControllerInput_Button__Enum key));
...
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_SmartInput_XboxControllerInput_Button_System_String_ * this_ptr));
