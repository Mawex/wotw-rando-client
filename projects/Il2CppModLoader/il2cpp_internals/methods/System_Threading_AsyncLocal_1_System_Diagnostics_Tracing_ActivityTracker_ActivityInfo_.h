...
namespace app::methods::System_Threading::AsyncLocal_1_System_Diagnostics_Tracing_ActivityTracker_ActivityInfo_ {
    ...
    IL2CPP_REGISTER_METHOD(0x019D6B90, void, __ctor, (app::AsyncLocal_1_System_Diagnostics_Tracing_ActivityTracker_ActivityInfo_ * this_ptr, app::Action_1_System_Threading_AsyncLocalValueChangedArgs_1__1 * value_changed_handler));
