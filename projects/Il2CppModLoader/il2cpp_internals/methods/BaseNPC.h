...
namespace app::methods::BaseNPC {
    ...
    IL2CPP_REGISTER_METHOD(0x003FDCE0, SuspendableMask__Enum, get_Mask, (app::BaseNPC * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00F87AC0, void, set_Mask, (app::BaseNPC * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x008C5E20, void, __ctor, (app::BaseNPC * this_ptr));
} // namespace app::methods::BaseNPC
