...
namespace app::methods::System_Net_Sockets::TcpClient {
IL2CPP_REGISTER_METHOD(0x020A2BC0, void, __ctor_1, (app::TcpClient * this_ptr));
IL2CPP_REGISTER_METHOD(0x020A2C70, void, __ctor_2, (app::TcpClient * this_ptr, app::AddressFamily__Enum family));
IL2CPP_REGISTER_METHODINFO(0x0478A140, TcpClient__ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020A2F10, void, __ctor_3, (app::TcpClient * this_ptr, app::String * hostname, int32_t port));
IL2CPP_REGISTER_METHODINFO(0x047380E0, TcpClient__ctor_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020A3130, void, __ctor_4, (app::TcpClient * this_ptr, app::Socket * accepted_socket));
IL2CPP_REGISTER_METHOD(0x002FA280, Socket *, get_Client, (app::TcpClient * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020A3BD0, IAsyncResult *, BeginConnect, (app::TcpClient * this_ptr, app::String * host, int32_t port, app::AsyncCallback * request_callback, app::Object * state));
IL2CPP_REGISTER_METHOD(0x020A3CC0, void, EndConnect, (app::TcpClient * this_ptr, app::IAsyncResult * async_result));
IL2CPP_REGISTER_METHOD(0x020A3D80, NetworkStream *, GetStream, (app::TcpClient * this_ptr));
