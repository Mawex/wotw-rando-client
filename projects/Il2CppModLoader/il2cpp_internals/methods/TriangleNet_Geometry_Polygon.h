...
namespace app::methods::TriangleNet_Geometry::Polygon {
IL2CPP_REGISTER_METHOD(0x002FA280, List_1_TriangleNet_Geometry_Vertex_ *, get_Points, (app::Polygon * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, List_1_TriangleNet_Geometry_Point_ *, get_Holes, (app::Polygon * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB950, List_1_TriangleNet_Geometry_RegionPointer_ *, get_Regions, (app::Polygon * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB00, List_1_TriangleNet_Geometry_ISegment_ *, get_Segments, (app::Polygon * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0261CE50, void, __ctor_1, (app::Polygon * this_ptr));
IL2CPP_REGISTER_METHOD(0x0261CE50, void, __ctor_2, (app::Polygon * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x0261CE60, void, __ctor_3, (app::Polygon * this_ptr, int32_t capacity, bool markers));
...
IL2CPP_REGISTER_METHOD(0x0261D630, Rectangle *, Bounds, (app::Polygon * this_ptr));
