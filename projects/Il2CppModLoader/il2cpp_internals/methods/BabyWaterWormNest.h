...
IL2CPP_REGISTER_METHOD(0x00860670, Vector3, GetSpawnPoint, (app::BabyWaterWormNest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0072D940, void, __ctor, (app::BabyWaterWormNest * this_ptr));
