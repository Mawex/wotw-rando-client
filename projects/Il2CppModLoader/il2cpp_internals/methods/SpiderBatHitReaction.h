...
IL2CPP_REGISTER_METHOD(0x006A63A0, EntityDamageEvent *, get_DamageEvent, (app::SpiderBatHitReaction * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420230, BehaviourStatus__Enum, OnExecuteTask, (app::SpiderBatHitReaction * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0095C660, void, __ctor, (app::SpiderBatHitReaction * this_ptr));
}
