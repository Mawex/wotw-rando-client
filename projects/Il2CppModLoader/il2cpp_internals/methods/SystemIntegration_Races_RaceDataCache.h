...
namespace app::methods::SystemIntegration_Races::RaceDataCache {
IL2CPP_REGISTER_METHOD(0x002FB950, Dictionary_2_System_String_SystemIntegration_Races_RaceEntry_ *, get_Entries, (app::RaceDataCache * this_ptr));
IL2CPP_REGISTER_METHOD(0x00528570, void, __ctor, (app::RaceDataCache * this_ptr, app::String * race_id, app::String * owner_id));
IL2CPP_REGISTER_METHOD(0x002FB990, List_1_PlayFab_ClientModels_PlayerLeaderboardEntry_ *, get_LastMasterLeaderBoardSync, (app::RaceDataCache * this_ptr));
