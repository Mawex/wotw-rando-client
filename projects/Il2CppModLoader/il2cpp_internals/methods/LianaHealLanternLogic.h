...
IL2CPP_REGISTER_METHOD(0x002FB9D0, IMoonSetupAnimator *, get_MoonSetupAnimator, (app::LianaHealLanternLogic * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0113F2A0, void, __ctor, (app::LianaHealLanternLogic * this_ptr));
}
