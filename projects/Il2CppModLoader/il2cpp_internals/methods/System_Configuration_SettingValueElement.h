...
namespace app::methods::System_Configuration::SettingValueElement {
IL2CPP_REGISTER_METHOD(0x02962710, void, __ctor, (app::SettingValueElement * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0478C550, SettingValueElement__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02962740, ConfigurationPropertyCollection *, get_Properties, (app::SettingValueElement * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0471E760, SettingValueElement_get_Properties__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02962770, XmlNode *, get_ValueXml, (app::SettingValueElement * this_ptr));
