...
IL2CPP_REGISTER_METHOD(0x007F1530, GhostWorldObjectsLifetimePlugin_WorldRecordableEventsData_WorldObjectData *, GetObjectData, (app::GhostWorldObjectsLifetimePlugin_WorldRecordableEventsData * this_ptr, app::RecordableIdData id_data));
...
IL2CPP_REGISTER_METHOD(0x007F17E0, GhostFrame_FrameDataTypes__Enum, get_FrameType, (app::GhostWorldObjectsLifetimePlugin_WorldRecordableEventsData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007F2B40, void, __ctor, (app::GhostWorldObjectsLifetimePlugin_WorldRecordableEventsData * this_ptr));
}
