...
IL2CPP_REGISTER_METHOD(0x0255AB60, Bounds, get_Bounds, (app::MoonTrail * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0255AC30, MoonTrail_SimulationFrameData, get_CurrentSimulationFrame, (app::MoonTrail * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0255AE60, TrailPathProvider *, get_FirstTargetPathProvider, (app::MoonTrail * this_ptr));
IL2CPP_REGISTER_METHOD(0x0255AF40, TrailPathProvider *, get_SecondTargetPathProvider, (app::MoonTrail * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0255B1A0, Vector3, get_TargetPosition, (app::MoonTrail * this_ptr));
IL2CPP_REGISTER_METHOD(0x0255B1F0, Vector3, get_TargetNormal, (app::MoonTrail * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0255B3A0, Renderer *, get_Renderer, (app::MoonTrail * this_ptr));
IL2CPP_REGISTER_METHOD(0x0255B470, MeshFilter *, get_MeshFilter, (app::MoonTrail * this_ptr));
IL2CPP_REGISTER_METHOD(0x0255B540, bool, get_ShouldCalculateDynamicParticles, (app::MoonTrail * this_ptr));
IL2CPP_REGISTER_METHOD(0x0255B550, Camera *, get_Camera, (app::MoonTrail * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0255B820, Vector3, GetTargetPosition, (app::MoonTrail * this_ptr, bool using_two_targets));
IL2CPP_REGISTER_METHOD(0x0255BF20, Vector3, GetTargetNormal, (app::MoonTrail * this_ptr, bool using_two_targets, app::Vector3 target_position));
...
IL2CPP_REGISTER_METHOD(0x02562B90, void, __ctor, (app::MoonTrail * this_ptr));
