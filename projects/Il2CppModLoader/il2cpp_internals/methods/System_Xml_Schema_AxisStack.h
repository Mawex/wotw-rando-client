...
namespace app::methods::System_Xml_Schema::AxisStack {
IL2CPP_REGISTER_METHOD(0x002FB930, ForwardAxis *, get_Subtree, (app::AxisStack * this_ptr));
IL2CPP_REGISTER_METHOD(0x016D95F0, int32_t, get_Length, (app::AxisStack * this_ptr));
IL2CPP_REGISTER_METHOD(0x019A3240, void, __ctor, (app::AxisStack * this_ptr, app::ForwardAxis * faxis, app::ActiveAxis * parent));
