...
IL2CPP_REGISTER_METHOD(0x030463E0, String *, GetShaderName, (app::GradientRampDynamic * this_ptr));
IL2CPP_REGISTER_METHOD(0x0136E930, void, __ctor, (app::GradientRampDynamic * this_ptr));
}
