...
IL2CPP_REGISTER_METHOD(0x0040B220, Recorder_1 *, get_Recorder, (app::RecorderPlaybackUI * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008F7080, IEnumerator *, Start, (app::RecorderPlaybackUI * this_ptr));
