...
IL2CPP_REGISTER_METHOD(0x00F28E00, WaterFallMasksSystem *, get_Instance, ());
IL2CPP_REGISTER_METHOD(0x00F28FF0, void, __ctor, (app::WaterFallMasksSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, UpdateType__Enum, get_UpdateType, (app::WaterFallMasksSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F2A2E0, IEnumerator *, TimeslicedInit, (app::WaterFallMasksSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9D0, String *, GetTimesliceContextualDebugData, (app::WaterFallMasksSystem * this_ptr));
