...
namespace app::methods::System_Diagnostics_Tracing::ActivityTracker {
...
IL2CPP_REGISTER_METHOD(0x01746380, ActivityTracker *, get_Instance, ());
IL2CPP_REGISTER_METHOD(0x01746420, ActivityTracker_ActivityInfo *, FindActiveActivity, (app::ActivityTracker * this_ptr, app::String * name, app::ActivityTracker_ActivityInfo * start_location));
IL2CPP_REGISTER_METHOD(0x017464A0, String *, NormalizeActivityName, (app::ActivityTracker * this_ptr, app::String * provider_name, app::String * activity_name, int32_t task));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::ActivityTracker * this_ptr));
IL2CPP_REGISTER_METHOD(0x017467D0, void, __cctor, ());
}
