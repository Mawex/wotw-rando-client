...
IL2CPP_REGISTER_METHOD(0x002FBBC0, OnDelegate *, get_OnPlaybackFinished, (app::XboxOneVideoPlayer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01C5C380, void, __ctor, (app::XboxOneVideoPlayer * this_ptr));
}
