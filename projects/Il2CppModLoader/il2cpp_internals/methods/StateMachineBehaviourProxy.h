...
IL2CPP_REGISTER_METHOD(0x009B5780, StateMachineBehaviourProxy_IReceiver *, get_Receiver, (app::StateMachineBehaviourProxy * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009B5AA0, void, __ctor, (app::StateMachineBehaviourProxy * this_ptr));
}
