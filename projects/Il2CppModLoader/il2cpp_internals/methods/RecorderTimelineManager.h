...
IL2CPP_REGISTER_METHOD(0x008FAA30, AsyncRenderCapture *, StartOutputTestScreenShot, (int32_t max_frame_count, app::Action_1_Int32_ * on_complete, bool hide_u_i, bool show_frame_count, int32_t start_frame));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::RecorderTimelineManager * this_ptr));
