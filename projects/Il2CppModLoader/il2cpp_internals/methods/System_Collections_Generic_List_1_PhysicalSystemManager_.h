...
namespace app::methods::System_Collections_Generic::List_1_PhysicalSystemManager_ {
...
IL2CPP_REGISTER_METHOD(0x025EFC50, PhysicalSystemManager *, get_Item, (app::List_1_PhysicalSystemManager_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_PhysicalSystemManager_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04743610, List_1_PhysicalSystemManager___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_PhysicalSystemManager_, GetEnumerator, (app::List_1_PhysicalSystemManager_ * this_ptr));
