...
namespace app::methods::System_Linq_Expressions_Interpreter::AssignLocalBoxedInstruction {
IL2CPP_REGISTER_METHOD(0x002FC6E0, void, __ctor, (app::AssignLocalBoxedInstruction * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x022D5A10, String *, get_InstructionName, (app::AssignLocalBoxedInstruction * this_ptr));
