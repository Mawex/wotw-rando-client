...
namespace app::methods::UnityStandardAssets_ImageEffects::CameraMotionBlur {
...
IL2CPP_REGISTER_METHOD(0x02519DC0, Camera *, GetTmpCam, (app::CameraMotionBlur * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0251AA60, void, __ctor, (app::CameraMotionBlur * this_ptr));
