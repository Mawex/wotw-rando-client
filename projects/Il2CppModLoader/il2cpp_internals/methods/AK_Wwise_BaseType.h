...
namespace app::methods::AK_Wwise::BaseType {
IL2CPP_REGISTER_METHOD(0x026C1570, String *, get_Name, (app::BaseType * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x026C1C60, String *, ToString, (app::BaseType * this_ptr));
IL2CPP_REGISTER_METHOD(0x026C1D40, bool, Equals, (app::BaseType * this_ptr, app::BaseType * other));
IL2CPP_REGISTER_METHOD(0x026C1D90, void, __ctor, (app::BaseType * this_ptr));
}
