...
IL2CPP_REGISTER_METHOD(0x02C35530, ParticleSystem *, get_Item, (app::Dictionary_2_SurfaceMaterialType_UnityEngine_ParticleSystem_ * this_ptr, app::SurfaceMaterialType__Enum key));
IL2CPP_REGISTER_METHODINFO(0x0473C590, Dictionary_2_SurfaceMaterialType_UnityEngine_ParticleSystem__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02BA5400, Dictionary_2_TKey_TValue_Enumerator_SurfaceMaterialType_UnityEngine_ParticleSystem_, GetEnumerator, (app::Dictionary_2_SurfaceMaterialType_UnityEngine_ParticleSystem_ * this_ptr));
