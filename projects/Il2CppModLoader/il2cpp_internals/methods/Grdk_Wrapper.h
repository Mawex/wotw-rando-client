...
namespace app::methods::Grdk::Wrapper {
    ...
    IL2CPP_REGISTER_METHOD(0x01086770, String*, GetGRDKSaveGameName, (int32_t slot_index, int32_t backup_index));
    IL2CPP_REGISTER_METHOD(0x010869E0, Byte__Array*, Load_1, (int32_t slot, int32_t backup_slot));
    IL2CPP_REGISTER_METHOD(0x01086A90, Byte__Array*, Load_2, (app::String * name));
    ...
    IL2CPP_REGISTER_METHOD(0x01089070, Byte__Array*, CopySave_2, (int32_t from, app::String* to_name));
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::Wrapper * this_ptr));
