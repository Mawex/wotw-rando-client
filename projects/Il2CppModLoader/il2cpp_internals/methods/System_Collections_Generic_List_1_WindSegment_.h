...
namespace app::methods::System_Collections_Generic::List_1_WindSegment_ {
...
IL2CPP_REGISTER_METHOD(0x025EFC50, WindSegment *, get_Item, (app::List_1_WindSegment_ * this_ptr, int32_t index));
