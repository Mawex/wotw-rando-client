...
namespace app::methods::System_Xml_Linq::XHashtable_1_System_WeakReference_ {
IL2CPP_REGISTER_METHOD(0x0225AE80, void, __ctor, (app::XHashtable_1_System_WeakReference_ * this_ptr, app::XHashtable_1_TValue_ExtractKeyDelegate_System_WeakReference_ * extract_key, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x0225B000, WeakReference *, Add, (app::XHashtable_1_System_WeakReference_ * this_ptr, app::WeakReference * value));
