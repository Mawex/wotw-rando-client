...
IL2CPP_REGISTER_METHOD(0x002FB990, Color__Array *, get_Colors, (app::CCMoonTextColorer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::CCMoonTextColorer * this_ptr));
}
