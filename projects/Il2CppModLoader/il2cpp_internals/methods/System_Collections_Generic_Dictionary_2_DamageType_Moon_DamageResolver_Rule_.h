...
namespace app::methods::System_Collections_Generic::Dictionary_2_DamageType_Moon_DamageResolver_Rule_ {
...
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_DamageType_Moon_DamageResolver_Rule_ * this_ptr));
