...
IL2CPP_REGISTER_METHOD(0x024EDFF0, Material *, get_material, (app::CameraFilterPack_Drawing_BluePrint * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024EE910, void, __ctor, (app::CameraFilterPack_Drawing_BluePrint * this_ptr));
}
