...
IL2CPP_REGISTER_METHOD(0x004C7770, ILever *, get_ResolvedLever, (app::ActivateAndHold * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::ActivateAndHold * this_ptr));
}
