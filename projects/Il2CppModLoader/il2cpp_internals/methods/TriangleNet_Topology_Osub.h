...
namespace app::methods::TriangleNet_Topology::Osub {
IL2CPP_REGISTER_METHOD(0x00107C00, SubSegment *, get_Segment, (app::Osub__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0021F190, String *, ToString, (app::Osub__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0021F440, Vertex *, Org, (app::Osub__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0021F490, Vertex *, Dest, (app::Osub__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0021F500, Vertex *, SegOrg, (app::Osub__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0021F550, Vertex *, SegDest, (app::Osub__Boxed * this_ptr));
