...
IL2CPP_REGISTER_METHOD(0x011080A0, EffectSpawn, ProvideDamageEffect, (app::LizardMeleeAttackBehaviour * this_ptr, app::DamageResult result));
...
IL2CPP_REGISTER_METHOD(0x011087A0, BehaviourStatus__Enum, OnExecute, (app::LizardMeleeAttackBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01109B20, void, __ctor, (app::LizardMeleeAttackBehaviour * this_ptr));
}
