...
namespace app::methods::System_Globalization::FormatProvider_Number {
IL2CPP_REGISTER_METHOD(0x02270570, bool, IsWhite, (uint16_t ch));
IL2CPP_REGISTER_METHOD(0x030F5360, uint16_t *, MatchChars_1, (app::uint16_t * p, app::String * str));
IL2CPP_REGISTER_METHOD(0x030F5470, uint16_t *, MatchChars_2, (app::uint16_t * p, app::uint16_t * str));
...
IL2CPP_REGISTER_METHOD(0x030F6050, void, Int32ToDecChars, (app::uint16_t * buffer, app::int32_t * index, uint32_t value, int32_t digits));
IL2CPP_REGISTER_METHOD(0x030F60B0, uint16_t, ParseFormatSpecifier, (app::String * format, app::int32_t * digits));
IL2CPP_REGISTER_METHOD(0x030F6170, String *, NumberToString, (app::FormatProvider_Number_NumberBuffer number, uint16_t format, int32_t n_max_digits, app::NumberFormatInfo * info, bool is_decimal));
...
IL2CPP_REGISTER_METHOD(0x030F6BA0, int32_t, wcslen, (app::uint16_t * s));
...
IL2CPP_REGISTER_METHOD(0x030F81E0, String *, NumberToStringFormat, (app::FormatProvider_Number_NumberBuffer number, app::String * format, app::NumberFormatInfo * info));
