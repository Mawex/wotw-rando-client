...
IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkSourceSettings * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x026F9CD0, void *, getCPtr, (app::AkSourceSettings * obj));
IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkSourceSettings * this_ptr, app::void * c_ptr));
...
IL2CPP_REGISTER_METHOD(0x026FA240, void, set_pMediaMemory, (app::AkSourceSettings * this_ptr, app::void * value));
...
IL2CPP_REGISTER_METHOD(0x026FA930, void, __ctor_2, (app::AkSourceSettings * this_ptr));
}
