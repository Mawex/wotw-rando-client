...
IL2CPP_REGISTER_METHOD(0x024772A0, Material *, get_material, (app::CameraFilterPack_Fly_Vision * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02477AF0, void, __ctor, (app::CameraFilterPack_Fly_Vision * this_ptr));
}
