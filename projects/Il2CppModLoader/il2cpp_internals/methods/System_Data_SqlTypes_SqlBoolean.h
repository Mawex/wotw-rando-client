...
namespace app::methods::System_Data_SqlTypes::SqlBoolean {
    ...
    IL2CPP_REGISTER_METHOD(0x01E4FB10, app::SqlBoolean, operator_, (bool x));
    IL2CPP_REGISTER_METHOD(0x01E4FB20, bool, op_True, (app::SqlBoolean x));
    IL2CPP_REGISTER_METHOD(0x01E4FB30, app::SqlBoolean, operator___1, (app::SqlBoolean x, app::SqlBoolean y));
    IL2CPP_REGISTER_METHOD(0x01E4FC80, app::SqlBoolean, operator___2, (app::SqlBoolean x, app::SqlBoolean y));
    ...
    IL2CPP_REGISTER_METHOD(0x01E4FE80, app::SqlBoolean, operator___, (app::SqlBoolean x, app::SqlBoolean y));
