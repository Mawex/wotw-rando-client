...
namespace app::methods::System_Collections_Generic::Dictionary_2_Core_Input_Command_AbilityType_ {
...
IL2CPP_REGISTER_METHOD(0x02DBC900, AbilityType__Enum, get_Item, (app::Dictionary_2_Core_Input_Command_AbilityType_ * this_ptr, app::Input_Command__Enum key));
...
IL2CPP_REGISTER_METHOD(0x0283AC50, void, __ctor, (app::Dictionary_2_Core_Input_Command_AbilityType_ * this_ptr, app::IEqualityComparer_1_Core_Input_Command_ * comparer));
