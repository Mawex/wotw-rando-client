...
IL2CPP_REGISTER_METHOD(0x01371720, Vector3, get_OriginalRotation, (app::RotationAnimatorB * this_ptr));
IL2CPP_REGISTER_METHOD(0x00982B40, bool, get_IsLooping, (app::RotationAnimatorB * this_ptr));
IL2CPP_REGISTER_METHOD(0x005A4BA0, void, __ctor, (app::RotationAnimatorB * this_ptr));
}
