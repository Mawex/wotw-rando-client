...
IL2CPP_REGISTER_METHOD(0x00BBDFF0, SceneSettings *, get_GetSettings, (app::SceneSettingsComponent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00BBE6D0, CameraSettings *, GetCameraSettings, (app::SceneSettingsComponent * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC20, FogGradientController *, get_SceneFogSettings, (app::SceneSettingsComponent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00BBF300, void, __ctor, (app::SceneSettingsComponent * this_ptr));
