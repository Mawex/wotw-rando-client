...
IL2CPP_REGISTER_METHOD(0x020E56A0, Material *, get_material, (app::CameraFilterPack_TV_Artefact * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E5E50, void, __ctor, (app::CameraFilterPack_TV_Artefact * this_ptr));
}
