...
IL2CPP_REGISTER_METHOD(0x0070D380, CleverMenuItemSelectionManager *, get_Navigation, (app::RaceMenuScreenMemoriesPage * this_ptr));
IL2CPP_REGISTER_METHOD(0x0070D450, MemoryUISlot *, get_SelectedItem, (app::RaceMenuScreenMemoriesPage * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0070DEC0, SuspendableMask__Enum, get_Mask, (app::RaceMenuScreenMemoriesPage * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0070E700, void, __ctor, (app::RaceMenuScreenMemoriesPage * this_ptr));
}
