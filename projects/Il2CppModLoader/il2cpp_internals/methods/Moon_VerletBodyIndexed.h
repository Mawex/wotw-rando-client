...
IL2CPP_REGISTER_METHOD(0x02128FA0, Vector3, GetPointPosition, (app::VerletBodyIndexed * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02129110, void, __ctor, (app::VerletBodyIndexed * this_ptr));
}
