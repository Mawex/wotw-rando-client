...
IL2CPP_REGISTER_METHOD(0x011AEBC0, BehaviourStatus__Enum, OnExecuteTask, (app::SpiderBossHitReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x011AEFC0, void, __ctor, (app::SpiderBossHitReactionBehaviour * this_ptr));
}
