...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::Action_1_UnityEngine_XR_XRNodeState_ * this_ptr, app::Object * object, app::void * method_1));
IL2CPP_REGISTER_METHOD(0x02C0D9D0, IAsyncResult *, BeginInvoke, (app::Action_1_UnityEngine_XR_XRNodeState_ * this_ptr, app::XRNodeState obj, app::AsyncCallback * callback, app::Object * object));
