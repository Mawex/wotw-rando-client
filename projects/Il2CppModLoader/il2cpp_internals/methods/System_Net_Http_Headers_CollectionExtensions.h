...
namespace app::methods::System_Net_Http_Headers::CollectionExtensions {
IL2CPP_REGISTER_METHOD(0x01567DA0, bool, SequenceEqual_1, (app::List_1_System_Object_ * first, app::List_1_System_Object_ * second));
IL2CPP_REGISTER_METHOD(0x01541BA0, String *, ToString_1, (app::List_1_System_Object_ * list));
...
IL2CPP_REGISTER_METHOD(0x01541BA0, String *, ToString_2, (app::List_1_System_Net_Http_Headers_NameValueHeaderValue_ * list));
