...
namespace app::methods::System_Collections_Generic::List_1_Moon_InteractionGraph_IState_ {
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_Moon_InteractionGraph_IState_, GetEnumerator, (app::List_1_Moon_InteractionGraph_IState_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EFC50, IState_1 *, get_Item, (app::List_1_Moon_InteractionGraph_IState_ * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x04782E80, List_1_Moon_InteractionGraph_IState__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor, (app::List_1_Moon_InteractionGraph_IState_ * this_ptr, int32_t capacity));
