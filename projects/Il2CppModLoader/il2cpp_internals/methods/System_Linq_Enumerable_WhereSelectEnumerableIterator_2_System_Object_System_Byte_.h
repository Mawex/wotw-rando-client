...
namespace app::methods::System_Linq::Enumerable_WhereSelectEnumerableIterator_2_System_Object_System_Byte_ {
...
IL2CPP_REGISTER_METHOD(0x028951E0, Enumerable_Iterator_1_System_Byte_ *, Clone, (app::Enumerable_WhereSelectEnumerableIterator_2_System_Object_System_Byte_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02896570, IEnumerable_1_System_Byte_ *, Where, (app::Enumerable_WhereSelectEnumerableIterator_2_System_Object_System_Byte_ * this_ptr, app::Func_2_Byte_Boolean_ * predicate));
}
