...
IL2CPP_REGISTER_METHOD(0x012F9E00, BehaviourStatus__Enum, OnExecute, (app::KwolokBossWormSpitBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x012FAEC0, Vector3, GetWormSpitDirection, (app::KwolokBossWormSpitBehaviour * this_ptr, app::KwolokBossWormSpitBehaviour_Direction__Enum dir));
IL2CPP_REGISTER_METHOD(0x01251800, void, ModifyDesiredLookAngle, (app::KwolokBossWormSpitBehaviour * this_ptr, app::float * angle));
...
IL2CPP_REGISTER_METHOD(0x012FB0E0, void, __ctor, (app::KwolokBossWormSpitBehaviour * this_ptr));
}
