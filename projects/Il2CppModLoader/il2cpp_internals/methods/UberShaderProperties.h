...
IL2CPP_REGISTER_METHOD(0x019177E0, void, __cctor, ());
...
IL2CPP_REGISTER_METHOD(0x0191A260, UberShaderProperty_Texture__Enum, GetTextureProperty, (int32_t property_id, app::bool * property_found));
}
