...
IL2CPP_REGISTER_METHOD(0x0069FFA0, void, __ctor, (app::GameMapSavePedestal * this_ptr, app::SceneMetaData_SceneSavePedestal * save_pedestal, app::SceneMetaData * scene_meta_data));
...
IL2CPP_REGISTER_METHOD(0x006A00F0, IUberState__Array *, get_AffectingUberStates, (app::GameMapSavePedestal * this_ptr));
IL2CPP_REGISTER_METHOD(0x006A0170, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::GameMapSavePedestal * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006A0A70, Vector2, get_AreaMapIconPosition, (app::GameMapSavePedestal * this_ptr));
IL2CPP_REGISTER_METHOD(0x006A0B80, void, set_AreaMapIconPosition, (app::GameMapSavePedestal * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x006A0CA0, Vector2, get_WorldProjectedPositon, (app::GameMapSavePedestal * this_ptr));
IL2CPP_REGISTER_METHOD(0x006A0DB0, RuntimeGameWorldArea *, get_Area, (app::GameMapSavePedestal * this_ptr));
