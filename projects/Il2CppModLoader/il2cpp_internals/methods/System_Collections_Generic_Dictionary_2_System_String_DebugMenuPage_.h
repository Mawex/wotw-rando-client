...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_String_DebugMenuPage_ {
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_System_String_DebugMenuPage_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BA5400, Dictionary_2_TKey_TValue_Enumerator_System_String_DebugMenuPage_, GetEnumerator, (app::Dictionary_2_System_String_DebugMenuPage_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BD24D0, DebugMenuPage *, get_Item, (app::Dictionary_2_System_String_DebugMenuPage_ * this_ptr, app::String * key));
