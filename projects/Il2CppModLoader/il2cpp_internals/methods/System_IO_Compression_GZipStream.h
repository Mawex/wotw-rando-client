...
namespace app::methods::System_IO_Compression::GZipStream {
IL2CPP_REGISTER_METHOD(0x02009FA0, void, __ctor_1, (app::GZipStream * this_ptr, app::Stream * stream, app::CompressionMode__Enum mode));
IL2CPP_REGISTER_METHOD(0x02009FC0, void, __ctor_2, (app::GZipStream * this_ptr, app::Stream * stream, app::CompressionMode__Enum mode, bool leave_open));
...
IL2CPP_REGISTER_METHOD(0x0200A400, IAsyncResult *, BeginRead, (app::GZipStream * this_ptr, app::Byte__Array * array, int32_t offset, int32_t count, app::AsyncCallback * async_callback, app::Object * async_state));
...
IL2CPP_REGISTER_METHOD(0x0200A5B0, IAsyncResult *, BeginWrite, (app::GZipStream * this_ptr, app::Byte__Array * array, int32_t offset, int32_t count, app::AsyncCallback * async_callback, app::Object * async_state));
...
IL2CPP_REGISTER_METHOD(0x0200A790, Task_1_System_Int32_ *, ReadAsync, (app::GZipStream * this_ptr, app::Byte__Array * array, int32_t offset, int32_t count, app::CancellationToken cancellation_token));
IL2CPP_REGISTER_METHOD(0x0200A7C0, Task *, WriteAsync, (app::GZipStream * this_ptr, app::Byte__Array * array, int32_t offset, int32_t count, app::CancellationToken cancellation_token));
IL2CPP_REGISTER_METHOD(0x0200A7F0, Task *, FlushAsync, (app::GZipStream * this_ptr, app::CancellationToken cancellation_token));
