...
IL2CPP_REGISTER_METHOD(0x0201F510, ArrayList *, get_InnerList, (app::CollectionBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x004C50A0, IList *, get_List, (app::CollectionBase * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0201F970, Object *, ICollection_get_SyncRoot, (app::CollectionBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x0201F9A0, void, ICollection_CopyTo, (app::CollectionBase * this_ptr, app::Array * array, int32_t index));
IL2CPP_REGISTER_METHOD(0x0201F9F0, Object *, IList_get_Item, (app::CollectionBase * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x020202A0, IEnumerator *, GetEnumerator, (app::CollectionBase * this_ptr));
