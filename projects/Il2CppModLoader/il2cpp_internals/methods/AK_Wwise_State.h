...
namespace app::methods::AK_Wwise::State {
IL2CPP_REGISTER_METHOD(0x0043D9A0, WwiseObjectType__Enum, get_WwiseObjectType, (app::State * this_ptr));
IL2CPP_REGISTER_METHOD(0x00AB4D20, WwiseObjectType__Enum, get_WwiseObjectGroupType, (app::State * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x026C39A0, void, __ctor, (app::State * this_ptr));
}
