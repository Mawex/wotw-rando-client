...
IL2CPP_REGISTER_METHOD(0x005065F0, SuspendableMask__Enum, get_Mask, (app::ApplyForceToPhysicsSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00507220, void, __ctor, (app::ApplyForceToPhysicsSystem * this_ptr));
}
