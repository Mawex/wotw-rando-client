...
namespace app::methods::RootMotion_FinalIK::HitReaction_HitPointEffector_EffectorLink {
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::HitReaction_HitPointEffector_EffectorLink * this_ptr));
}
