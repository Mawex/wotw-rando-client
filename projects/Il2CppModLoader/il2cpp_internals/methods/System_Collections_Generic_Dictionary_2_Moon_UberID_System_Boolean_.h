...
namespace app::methods::System_Collections_Generic::Dictionary_2_Moon_UberID_System_Boolean_ {
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_Moon_UberID_System_Boolean_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04791598, Dictionary_2_Moon_UberID_System_Boolean___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02BC0F90, bool, TryGetValue, (app::Dictionary_2_Moon_UberID_System_Boolean_ * this_ptr, app::UberID * key, app::bool * value));
...
IL2CPP_REGISTER_METHOD(0x0283B2B0, Dictionary_2_TKey_TValue_KeyCollection_Moon_UberID_System_Boolean_ *, get_Keys, (app::Dictionary_2_Moon_UberID_System_Boolean_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0472F0B8, Dictionary_2_Moon_UberID_System_Boolean__get_Keys__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02BA5400, Dictionary_2_TKey_TValue_Enumerator_Moon_UberID_System_Boolean_, GetEnumerator, (app::Dictionary_2_Moon_UberID_System_Boolean_ * this_ptr));
