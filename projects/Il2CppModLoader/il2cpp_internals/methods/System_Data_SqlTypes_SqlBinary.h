...
namespace app::methods::System_Data_SqlTypes::SqlBinary {
    ...
    IL2CPP_REGISTER_METHOD(0x01E4E990, app::SqlBinary, operator_, (app::Byte__Array * x));
    ...
    IL2CPP_REGISTER_METHOD(0x01E4EBD0, app::SqlBoolean, operator___, (app::SqlBinary x, app::SqlBinary y));
    IL2CPP_REGISTER_METHOD(0x01E4ECF0, app::SqlBoolean, operator___1, (app::SqlBinary x, app::SqlBinary y));
    IL2CPP_REGISTER_METHOD(0x01E4EE10, app::SqlBoolean, operator___2, (app::SqlBinary x, app::SqlBinary y));
