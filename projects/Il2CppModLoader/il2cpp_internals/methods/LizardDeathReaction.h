...
IL2CPP_REGISTER_METHOD(0x00FAA9E0, BehaviourStatus__Enum, OnExecuteTask, (app::LizardDeathReaction * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00FABDB0, Vector3, ProcessRootMotion, (app::LizardDeathReaction * this_ptr, app::Vector3 motion));
IL2CPP_REGISTER_METHOD(0x00FABDC0, void, EndReaction, (app::LizardDeathReaction * this_ptr));
IL2CPP_REGISTER_METHOD(0x00FABE80, void, __ctor, (app::LizardDeathReaction * this_ptr));
