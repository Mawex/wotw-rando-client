...
namespace app::methods::WindupSwitch {
    ...
    IL2CPP_REGISTER_METHOD(0x0057CB50, void, __ctor, (app::WindupSwitch * this_ptr));
    IL2CPP_REGISTER_METHOD(0x004F4750, GameObject*, IDamageReciever_get_gameObject, (app::WindupSwitch * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00506170, Transform*, IDamageReciever_get_transform, (app::WindupSwitch * this_ptr));
} // namespace app::methods::WindupSwitch
