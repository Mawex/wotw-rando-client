...
namespace app::methods::Newtonsoft_Json_Utilities::ReflectionDelegateFactory {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::ReflectionDelegateFactory * this_ptr));
IL2CPP_REGISTER_METHOD(0x02653CC0, Func_2_Object_Object_ *, CreateGet_1, (app::ReflectionDelegateFactory * this_ptr, app::MemberInfo_1 * member_info));
IL2CPP_REGISTER_METHODINFO(0x0470C8E0, ReflectionDelegateFactory_CreateGet__MethodInfo);
IL2CPP_REGISTER_METHOD(0x018F1C90, Action_2_Object_Object_ *, CreateSet_1, (app::ReflectionDelegateFactory * this_ptr, app::MemberInfo_1 * member_info));
