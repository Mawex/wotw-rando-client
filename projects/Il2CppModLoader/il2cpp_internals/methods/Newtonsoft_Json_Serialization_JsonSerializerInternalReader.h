...
namespace app::methods::Newtonsoft_Json_Serialization::JsonSerializerInternalReader {
IL2CPP_REGISTER_METHOD(0x018748F0, void, __ctor, (app::JsonSerializerInternalReader * this_ptr, app::JsonSerializer * serializer));
IL2CPP_REGISTER_METHOD(0x01874900, JsonContract *, GetContractSafe, (app::JsonSerializerInternalReader * this_ptr, app::Type * type));
IL2CPP_REGISTER_METHOD(0x018749E0, Object *, Deserialize, (app::JsonSerializerInternalReader * this_ptr, app::JsonReader * reader, app::Type * object_type, bool check_additional_content));
IL2CPP_REGISTER_METHODINFO(0x0470CEC8, JsonSerializerInternalReader_Deserialize__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01874D40, JsonSerializerProxy *, GetInternalSerializer, (app::JsonSerializerInternalReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x01874F20, JToken *, CreateJToken, (app::JsonSerializerInternalReader * this_ptr, app::JsonReader * reader, app::JsonContract * contract));
IL2CPP_REGISTER_METHOD(0x01875250, JToken *, CreateJObject, (app::JsonSerializerInternalReader * this_ptr, app::JsonReader * reader));
IL2CPP_REGISTER_METHODINFO(0x0478CAE8, JsonSerializerInternalReader_CreateJObject__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01875640, Object *, CreateValueInternal, (app::JsonSerializerInternalReader * this_ptr, app::JsonReader * reader, app::Type * object_type, app::JsonContract * contract, app::JsonProperty * member, app::JsonContainerContract * container_contract, app::JsonProperty * container_member, app::Object * existing_value));
...
IL2CPP_REGISTER_METHOD(0x01875D00, String *, GetExpectedDescription, (app::JsonSerializerInternalReader * this_ptr, app::JsonContract * contract));
IL2CPP_REGISTER_METHODINFO(0x0472D018, JsonSerializerInternalReader_GetExpectedDescription__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01875E10, JsonConverter *, GetConverter, (app::JsonSerializerInternalReader * this_ptr, app::JsonContract * contract, app::JsonConverter * member_converter, app::JsonContainerContract * container_contract, app::JsonProperty * container_property));
IL2CPP_REGISTER_METHOD(0x01875EB0, Object *, CreateObject, (app::JsonSerializerInternalReader * this_ptr, app::JsonReader * reader, app::Type * object_type, app::JsonContract * contract, app::JsonProperty * member, app::JsonContainerContract * container_contract, app::JsonProperty * container_member, app::Object * existing_value));
...
IL2CPP_REGISTER_METHOD(0x01877E80, JsonArrayContract *, EnsureArrayContract, (app::JsonSerializerInternalReader * this_ptr, app::JsonReader * reader, app::Type * object_type, app::JsonContract * contract));
IL2CPP_REGISTER_METHODINFO(0x04756030, JsonSerializerInternalReader_EnsureArrayContract__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01878060, Object *, CreateList, (app::JsonSerializerInternalReader * this_ptr, app::JsonReader * reader, app::Type * object_type, app::JsonContract * contract, app::JsonProperty * member, app::Object * existing_value, app::String * id));
...
IL2CPP_REGISTER_METHOD(0x01878870, Object *, EnsureType, (app::JsonSerializerInternalReader * this_ptr, app::JsonReader * reader, app::Object * value, app::CultureInfo * culture, app::JsonContract * contract, app::Type * target_type));
...
IL2CPP_REGISTER_METHOD(0x01879A10, IList *, CreateNewList, (app::JsonSerializerInternalReader * this_ptr, app::JsonReader * reader, app::JsonArrayContract * contract, app::bool * created_from_non_default_creator));
IL2CPP_REGISTER_METHODINFO(0x0475EC40, JsonSerializerInternalReader_CreateNewList__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01879D70, IDictionary *, CreateNewDictionary, (app::JsonSerializerInternalReader * this_ptr, app::JsonReader * reader, app::JsonDictionaryContract * contract, app::bool * created_from_non_default_creator));
...
IL2CPP_REGISTER_METHOD(0x0187A3D0, Object *, PopulateDictionary, (app::JsonSerializerInternalReader * this_ptr, app::IDictionary * dictionary, app::JsonReader * reader, app::JsonDictionaryContract * contract, app::JsonProperty * container_property, app::String * id));
IL2CPP_REGISTER_METHODINFO(0x04769C40, JsonSerializerInternalReader_PopulateDictionary__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0187ACC0, Object *, PopulateMultidimensionalArray, (app::JsonSerializerInternalReader * this_ptr, app::IList * list, app::JsonReader * reader, app::JsonArrayContract * contract, app::JsonProperty * container_property, app::String * id));
...
IL2CPP_REGISTER_METHOD(0x0187B700, Object *, PopulateList, (app::JsonSerializerInternalReader * this_ptr, app::IList * list, app::JsonReader * reader, app::JsonArrayContract * contract, app::JsonProperty * container_property, app::String * id));
IL2CPP_REGISTER_METHODINFO(0x0473A9A8, JsonSerializerInternalReader_PopulateList__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0187BC60, Object *, CreateISerializable, (app::JsonSerializerInternalReader * this_ptr, app::JsonReader * reader, app::JsonISerializableContract * contract, app::JsonProperty * member, app::String * id));
IL2CPP_REGISTER_METHODINFO(0x04701DB0, JsonSerializerInternalReader_CreateISerializable__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0187C4B0, Object *, CreateISerializableItem, (app::JsonSerializerInternalReader * this_ptr, app::JToken * token, app::Type * type, app::JsonISerializableContract * contract, app::JsonProperty * member));
IL2CPP_REGISTER_METHOD(0x0187C610, Object *, CreateDynamic, (app::JsonSerializerInternalReader * this_ptr, app::JsonReader * reader, app::JsonDynamicContract * contract, app::JsonProperty * member, app::String * id));
IL2CPP_REGISTER_METHODINFO(0x04753750, JsonSerializerInternalReader_CreateDynamic__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0187CE60, Object *, CreateObjectUsingCreatorWithParameters, (app::JsonSerializerInternalReader * this_ptr, app::JsonReader * reader, app::JsonObjectContract * contract, app::JsonProperty * container_property, app::ObjectConstructor_1_System_Object_ * creator, app::String * id));
IL2CPP_REGISTER_METHOD(0x0187E220, Object *, DeserializeConvertable, (app::JsonSerializerInternalReader * this_ptr, app::JsonConverter * converter, app::JsonReader * reader, app::Type * object_type, app::Object * existing_value));
IL2CPP_REGISTER_METHOD(0x0187E530, List_1_Newtonsoft_Json_Serialization_JsonSerializerInternalReader_CreatorPropertyContext_ *, ResolvePropertyAndCreatorValues, (app::JsonSerializerInternalReader * this_ptr, app::JsonObjectContract * contract, app::JsonProperty * container_property, app::JsonReader * reader, app::Type * object_type));
IL2CPP_REGISTER_METHODINFO(0x04783760, JsonSerializerInternalReader_ResolvePropertyAndCreatorValues__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0187ED80, Object *, CreateNewObject, (app::JsonSerializerInternalReader * this_ptr, app::JsonReader * reader, app::JsonObjectContract * object_contract, app::JsonProperty * container_member, app::JsonProperty * container_property, app::String * id, app::bool * created_from_non_default_creator));
IL2CPP_REGISTER_METHODINFO(0x04757CF8, JsonSerializerInternalReader_CreateNewObject__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0187F080, Object *, PopulateObject, (app::JsonSerializerInternalReader * this_ptr, app::Object * new_object, app::JsonReader * reader, app::JsonObjectContract * contract, app::JsonProperty * member, app::String * id));
...
IL2CPP_REGISTER_METHOD(0x01880100, Object *, ReadExtensionDataValue, (app::JsonSerializerInternalReader * this_ptr, app::JsonObjectContract * contract, app::JsonProperty * member, app::JsonReader * reader));
