...
namespace app::methods::System_Data_Common::ObjectStorage_TempAssemblyComparer {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::ObjectStorage_TempAssemblyComparer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0216F080, void, __cctor, ());
}
