...
IL2CPP_REGISTER_METHOD(0x0049F2B0, EntityDamageEvent *, get_DamageEvent, (app::MinerHitReactionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420230, BehaviourStatus__Enum, OnExecuteTask, (app::MinerHitReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0144B870, void, __ctor, (app::MinerHitReactionBehaviour * this_ptr));
}
