...
IL2CPP_REGISTER_METHOD(0x002FBC60, PlayerUberStateShards_Shard *, get_SpiritShard, (app::SpiritShardUIShardSocket * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D70630, void, __ctor, (app::SpiritShardUIShardSocket * this_ptr));
}
