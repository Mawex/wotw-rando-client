...
IL2CPP_REGISTER_METHOD(0x00F157A0, BehaviourStatus__Enum, OnExecute, (app::LaserShooterInflateToAttackBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, BehaviourStatus__Enum, OnAnticUpdate, (app::LaserShooterInflateToAttackBehaviour * this_ptr, float d_time));
IL2CPP_REGISTER_METHOD(0x00F15B30, BehaviourStatus__Enum, OnShootingUpdate, (app::LaserShooterInflateToAttackBehaviour * this_ptr, float d_time));
IL2CPP_REGISTER_METHOD(0x00F161C0, BehaviourStatus__Enum, OnResolveUpdate, (app::LaserShooterInflateToAttackBehaviour * this_ptr, float d_time));
...
IL2CPP_REGISTER_METHOD(0x00F16E00, void, __ctor, (app::LaserShooterInflateToAttackBehaviour * this_ptr));
