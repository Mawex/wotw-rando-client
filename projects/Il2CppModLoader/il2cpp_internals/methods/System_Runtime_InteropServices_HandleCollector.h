...
namespace app::methods::System_Runtime_InteropServices::HandleCollector {
IL2CPP_REGISTER_METHOD(0x021BBD50, void, __ctor_1, (app::HandleCollector * this_ptr, app::String * name, int32_t initial_threshold));
IL2CPP_REGISTER_METHOD(0x021BBE70, void, __ctor_2, (app::HandleCollector * this_ptr, app::String * name, int32_t initial_threshold, int32_t maximum_threshold));
...
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_Name, (app::HandleCollector * this_ptr));
