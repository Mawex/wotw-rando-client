...
namespace app::methods::System_Runtime_CompilerServices::TaskAwaiter_1_System_Byte___ {
...
IL2CPP_REGISTER_METHOD(0x001FF750, Byte__Array *, GetResult, (app::TaskAwaiter_1_System_Byte___Boxed * this_ptr));
