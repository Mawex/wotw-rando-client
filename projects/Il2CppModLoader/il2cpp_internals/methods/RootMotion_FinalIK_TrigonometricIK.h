...
namespace app::methods::RootMotion_FinalIK::TrigonometricIK {
...
IL2CPP_REGISTER_METHOD(0x002FBB60, IKSolver *, GetIKSolver, (app::TrigonometricIK * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A28140, void, __ctor, (app::TrigonometricIK * this_ptr));
}
