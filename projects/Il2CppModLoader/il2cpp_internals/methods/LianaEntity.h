...
namespace app::methods::LianaEntity {
    ...
    IL2CPP_REGISTER_METHOD(0x01139920, Bounds, CalculateBounds, (app::LianaEntity * this_ptr, float height));
    ...
    IL2CPP_REGISTER_METHOD(0x0113C9C0, IEnumerator*, WaitReleaseTongue, (app::LianaEntity * this_ptr, float wait_time));
    ...
    IL2CPP_REGISTER_METHOD(0x0113D660, Bounds, get_Bounds, (app::LianaEntity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0113D6A0, void, __ctor, (app::LianaEntity * this_ptr));
