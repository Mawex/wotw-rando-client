...
IL2CPP_REGISTER_METHOD(0x0096C1B0, SpiderBossEntity_SpiderFightState__Enum, get_CurrentUberState, (app::SpiderBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005ACE90, List_1_SpiderBossBaseBehaviour_ *, get_ExecutingBehaviours, (app::SpiderBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00956A60, SpiderBossBaseBehaviour *, get_LastBehaviour, (app::SpiderBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0096C490, Vector3, get_ClawAttackDirection, (app::SpiderBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0096C850, Vector3, get_EntityPosition, (app::SpiderBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0096CB80, GameObject *, get_TalonImpactEffectPrefab, (app::SpiderBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x0096CB90, Transform *, get_FrontLeftLegGround2D, (app::SpiderBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x0096CBA0, Transform *, get_FrontRightLegGround2D, (app::SpiderBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x0096CBB0, Transform *, get_SmushPosition2D, (app::SpiderBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x0096CBC0, SpiderBossLocomotion *, get_SpiderLocomotion, (app::SpiderBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x0096CC80, Vector3, get_TargetPosition, (app::SpiderBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0096F880, SpiderBossLocationZone__Enum, GetCurrentZone, (app::SpiderBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x0096F8E0, SpiderBossLocationZone__Enum, GetCurrentZoneNoOverride, (app::SpiderBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x0096F980, SpiderBossLocationZone__Enum, GetLocationZoneForPosition, (app::SpiderBossEntity * this_ptr, app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x0096FCC0, SpiderBossBehaviourZone__Enum, GetBehaviourZoneForTarget, (app::SpiderBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x0096FE60, SpiderBossBehaviourZone__Enum, GetBehaviourZoneForPosition, (app::SpiderBossEntity * this_ptr, app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x0096FF30, List_1_SpiderBossBehaviourZone_ *, GetBehaviourZonesForPosition, (app::SpiderBossEntity * this_ptr, app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x00970140, CageStructureMetaDataGroup *, GetMetaGroup, (app::SpiderBossEntity * this_ptr, app::SpiderBossLocationZone__Enum current_zone, float look_direction));
IL2CPP_REGISTER_METHOD(0x009701F0, List_1_SpiderBossLocationZone_ *, GetAllowedZones, (app::SpiderBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009713E0, IUberState__Array *, get_AffectingUberStates, (app::SpiderBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00971470, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::SpiderBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00971630, void, __ctor, (app::SpiderBossEntity * this_ptr));
}
