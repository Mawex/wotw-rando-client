...
namespace app::methods::System_Data::DataRelationCollection {
...
IL2CPP_REGISTER_METHOD(0x023A5E50, String *, AssignName, (app::DataRelationCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x023A62E0, String *, MakeName, (app::DataRelationCollection * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x023A6F50, void, __ctor, (app::DataRelationCollection * this_ptr));
}
