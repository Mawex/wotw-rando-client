...
namespace app::methods::System_Text_RegularExpressions::RegexCharClass {
...
IL2CPP_REGISTER_METHOD(0x0258F820, bool, CharInCategoryGroup, (uint16_t ch, app::UnicodeCategory__Enum chcategory, app::String * category, app::int32_t * i));
IL2CPP_REGISTER_METHOD(0x0258F8F0, String *, NegateCategory, (app::String * category));
IL2CPP_REGISTER_METHOD(0x0258FBD0, RegexCharClass *, Parse, (app::String * char_class));
IL2CPP_REGISTER_METHOD(0x0258FC70, RegexCharClass *, ParseRecursive, (app::String * char_class, int32_t start));
IL2CPP_REGISTER_METHOD(0x02590230, int32_t, RangeCount, (app::RegexCharClass * this_ptr));
IL2CPP_REGISTER_METHOD(0x025902C0, String *, ToStringClass, (app::RegexCharClass * this_ptr));
IL2CPP_REGISTER_METHOD(0x02590710, RegexCharClass_SingleRange *, GetRangeAt, (app::RegexCharClass * this_ptr, int32_t i));
IL2CPP_REGISTER_METHOD(0x025907C0, void, Canonicalize, (app::RegexCharClass * this_ptr));
IL2CPP_REGISTER_METHOD(0x02590BB0, String *, SetFromProperty, (app::String * capname, bool invert, app::String * pattern));
