...
namespace app::methods::Steamworks::ISteamMatchmakingPlayersResponse_InternalPlayersRefreshComplete {
    IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::ISteamMatchmakingPlayersResponse_InternalPlayersRefreshComplete * this_ptr, app::Object * object, void * method_1));
