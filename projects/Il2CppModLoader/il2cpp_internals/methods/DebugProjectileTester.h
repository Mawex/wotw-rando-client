...
IL2CPP_REGISTER_METHOD(0x003FF2B0, SuspendableMask__Enum, get_Mask, (app::DebugProjectileTester * this_ptr));
IL2CPP_REGISTER_METHOD(0x00DFE820, void, set_Mask, (app::DebugProjectileTester * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x00DFE8D0, void, __ctor, (app::DebugProjectileTester * this_ptr));
}
