...
IL2CPP_REGISTER_METHOD(0x002FBC20, RuntimeQuest *, get_ActiveRuntimeQuest, (app::QuestsController * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC30, void, set_ActiveRuntimeQuest, (app::QuestsController * this_ptr, app::RuntimeQuest * value));
IL2CPP_REGISTER_METHOD(0x00E8D9E0, Quest *, get_ActiveQuest, (app::QuestsController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E8F9A0, Quest *, GetQuestByName, (app::QuestsController * this_ptr, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x00E8FC20, bool, TryRemapStateToQuestIndex, (app::QuestsController * this_ptr, app::SerializedIntUberState * uber_state, int32_t state_value, app::int32_t * quest_index));
...
IL2CPP_REGISTER_METHOD(0x00E8D9E0, Quest *, GetActiveQuest, (app::QuestsController * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC20, RuntimeQuest *, GetActiveRuntimeQuest, (app::QuestsController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E91F80, RuntimeQuest *, GetRuntimeQuest, (app::QuestsController * this_ptr, app::Quest * quest));
IL2CPP_REGISTER_METHOD(0x00E92070, List_1_RuntimeQuest_ *, GetQuests, (app::QuestsController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E92110, Quest *, GetQuestFromRuntimeQuest, (app::QuestsController * this_ptr, app::RuntimeQuest * runtime_quest));
...
IL2CPP_REGISTER_METHOD(0x002FBD00, IUberState__Array *, get_AffectingUberStates, (app::QuestsController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E924C0, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::QuestsController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E93150, void, __ctor, (app::QuestsController * this_ptr));
}
