...
IL2CPP_REGISTER_METHOD(0x00723F10, Vector3, get_TargetPositon, (app::RaceTargetIndicator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00723FF0, void, __ctor, (app::RaceTargetIndicator * this_ptr));
}
