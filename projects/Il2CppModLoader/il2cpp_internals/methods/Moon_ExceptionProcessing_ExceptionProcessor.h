...
namespace app::methods::Moon_ExceptionProcessing::ExceptionProcessor {
IL2CPP_REGISTER_METHOD(0x01987530, Dictionary_2_System_Int32_Moon_ExceptionProcessing_ExceptionEntry_ *, Process, (app::ExceptionProcessor * this_ptr, app::String * log_path));
...
IL2CPP_REGISTER_METHOD(0x01987D20, String *, ParseException, (app::ExceptionProcessor * this_ptr, app::String * exception));
IL2CPP_REGISTER_METHOD(0x01987DE0, String *, ParseStackTrace, (app::ExceptionProcessor * this_ptr, app::String * exception));
IL2CPP_REGISTER_METHOD(0x01988130, void, __ctor, (app::ExceptionProcessor * this_ptr));
