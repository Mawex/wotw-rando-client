...
IL2CPP_REGISTER_METHOD(0x011B2BE0, String *, get_Info, (app::SpiderBossLocationTurnTimelineBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x010B5C80, SpiderBossLocationZone__Enum, get_StartZone, (app::SpiderBossLocationTurnTimelineBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x010B5C80, SpiderBossLocationZone__Enum, GetForcedAnimationZone, (app::SpiderBossLocationTurnTimelineBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011B37E0, BehaviourStatus__Enum, OnExecute, (app::SpiderBossLocationTurnTimelineBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x011B3940, void, OnExit, (app::SpiderBossLocationTurnTimelineBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x011B3CF0, void, __ctor, (app::SpiderBossLocationTurnTimelineBehaviour * this_ptr));
}
