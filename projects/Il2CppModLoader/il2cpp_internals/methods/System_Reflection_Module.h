...
namespace app::methods::System_Reflection::Module {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::Module * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, ToString, (app::Module * this_ptr));
IL2CPP_REGISTER_METHOD(0x0268DFD0, Guid, GetModuleVersionId, (app::Module * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0268E4E0, String *, GetGuidInternal, (app::Module * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02283820, bool, operator____1, (app::Module * left, app::Module * right));
IL2CPP_REGISTER_METHOD(0x02283870, bool, operator____2, (app::Module * left, app::Module * right));
IL2CPP_REGISTER_METHOD(0x0268E500, Assembly *, get_Assembly, (app::Module * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0471F9B8, Module_get_Assembly__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0268E5A0, String *, get_ScopeName, (app::Module * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04717170, Module_get_ScopeName__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0268E640, Guid, get_ModuleVersionId, (app::Module * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04778968, Module_get_ModuleVersionId__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0268E6E0, String *, get_FullyQualifiedName, (app::Module * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0268E970, Object__Array *, GetCustomAttributes_1, (app::Module * this_ptr, bool inherit));
IL2CPP_REGISTER_METHODINFO(0x04768508, Module_GetCustomAttributes__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0268EA10, Object__Array *, GetCustomAttributes_2, (app::Module * this_ptr, app::Type * attribute_type, bool inherit));
