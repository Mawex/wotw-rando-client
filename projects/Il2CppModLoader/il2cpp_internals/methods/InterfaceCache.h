...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::InterfaceCache * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01586130, Object__Array *, GetComponentsAs_1, (app::InterfaceCache * this_ptr));
IL2CPP_REGISTER_METHOD(0x015EB730, Object *, GetComponentAs_1, (app::InterfaceCache * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01586130, IDamageReciever__Array *, GetComponentsAs_2, (app::InterfaceCache * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01586130, IDamageInterruptionBlockingTask__Array *, GetComponentsAs_3, (app::InterfaceCache * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x015EB730, IDamageResolver *, GetComponentAs_2, (app::InterfaceCache * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01586130, ITask__Array *, GetComponentsAs_4, (app::InterfaceCache * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x015EB730, INavigationAgent *, GetComponentAs_3, (app::InterfaceCache * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04732A60, InterfaceCache_GetComponentAs_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01586130, IEntityEventListener__Array *, GetComponentsAs_5, (app::InterfaceCache * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04723D28, InterfaceCache_GetComponentsAs_4__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01586130, IEntityOwned__Array *, GetComponentsAs_6, (app::InterfaceCache * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0471D4D8, InterfaceCache_GetComponentsAs_5__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015EB730, IEntityLocomotion *, GetComponentAs_4, (app::InterfaceCache * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01586130, IVitalsDeathListener__Array *, GetComponentsAs_7, (app::InterfaceCache * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04707A10, InterfaceCache_GetComponentsAs_6__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01586130, ICameraFrustumSuspendable__Array *, GetComponentsAs_8, (app::InterfaceCache * this_ptr));
