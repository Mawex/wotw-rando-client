...
namespace app::methods::System_Xml_Schema::XsdBuilder_XsdEndChildFunction {
    IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::XsdBuilder_XsdEndChildFunction * this_ptr, app::Object * object, void * method_1));
