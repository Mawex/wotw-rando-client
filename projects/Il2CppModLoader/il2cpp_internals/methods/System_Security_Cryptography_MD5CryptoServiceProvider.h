...
namespace app::methods::System_Security_Cryptography::MD5CryptoServiceProvider {
IL2CPP_REGISTER_METHOD(0x020DD610, void, __ctor, (app::MD5CryptoServiceProvider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020DD910, Byte__Array *, HashFinal, (app::MD5CryptoServiceProvider * this_ptr));
