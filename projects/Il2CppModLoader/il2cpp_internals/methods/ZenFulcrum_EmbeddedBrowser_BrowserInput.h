...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::BrowserInput {
    IL2CPP_REGISTER_METHOD(0x01C72D70, void, __ctor, (app::BrowserInput * this_ptr, app::Browser * browser));
