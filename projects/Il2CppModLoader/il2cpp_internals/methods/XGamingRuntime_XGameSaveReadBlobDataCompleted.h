...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::XGameSaveReadBlobDataCompleted * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x030BB1C0, IAsyncResult *, BeginInvoke, (app::XGameSaveReadBlobDataCompleted * this_ptr, int32_t hresult, app::XGameSaveBlob__Array * blobs, app::AsyncCallback * callback, app::Object * object));
