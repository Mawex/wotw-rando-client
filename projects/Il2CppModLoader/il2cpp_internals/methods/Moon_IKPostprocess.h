...
IL2CPP_REGISTER_METHOD(0x01101010, Transform *, get_StartBone, (app::IKPostprocess * this_ptr));
IL2CPP_REGISTER_METHOD(0x01101250, Transform *, get_EndBone, (app::IKPostprocess * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008A2C20, void, __ctor, (app::IKPostprocess * this_ptr));
}
