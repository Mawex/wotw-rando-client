...
IL2CPP_REGISTER_METHOD(0x006CA3B0, void, __ctor_1, (app::CompoundAxisInput * this_ptr, app::IAxisInput__Array * inputs));
IL2CPP_REGISTER_METHOD(0x00597BC0, void, __ctor_2, (app::CompoundAxisInput * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006CA670, IAxisInput *, GetLastPressed, (app::CompoundAxisInput * this_ptr));
