...
namespace app::methods::System_Threading_Tasks::TaskToApm {
IL2CPP_REGISTER_METHOD(0x023401B0, IAsyncResult *, Begin, (app::Task * task, app::AsyncCallback * callback, app::Object * state));
...
IL2CPP_REGISTER_METHOD(0x01580480, Object *, End_2, (app::IAsyncResult * async_result));
