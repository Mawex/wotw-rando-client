...
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::SteamSignInProvider * this_ptr, app::INetworkConnectivityChecker * net_connectivity_checker));
...
IL2CPP_REGISTER_METHOD(0x002FB950, IPlatformUser *, get_User, (app::SteamSignInProvider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_LinkToken, (app::SteamSignInProvider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0052AA80, Texture2D *, GetSteamImageAsTexture2D, (int32_t i_image));
