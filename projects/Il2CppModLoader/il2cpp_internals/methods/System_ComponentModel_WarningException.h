...
IL2CPP_REGISTER_METHOD(0x002FBC20, String *, get_HelpUrl, (app::WarningException * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC40, String *, get_HelpTopic, (app::WarningException * this_ptr));
