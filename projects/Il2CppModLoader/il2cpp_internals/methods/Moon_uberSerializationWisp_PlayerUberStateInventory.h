...
namespace app::methods::Moon_uberSerializationWisp::PlayerUberStateInventory {
IL2CPP_REGISTER_METHOD(0x002FA280, List_1_Moon_uberSerializationWisp_PlayerUberStateInventory_InventoryItem_ *, get_Inventory, (app::PlayerUberStateInventory * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, List_1_Moon_uberSerializationWisp_PlayerUberStateInventory_InventoryItem_ *, get_Bindings, (app::PlayerUberStateInventory * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB950, List_1_Moon_uberSerializationWisp_PlayerUberStateInventory_QuestItem_ *, get_QuestItems, (app::PlayerUberStateInventory * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F3B0E0, void, __ctor, (app::PlayerUberStateInventory * this_ptr, app::Action * set_dirty_callback));
IL2CPP_REGISTER_METHOD(0x00F3BC70, PlayerUberStateInventory_InventoryItem *, GrantItem, (app::PlayerUberStateInventory * this_ptr, app::EquipmentType__Enum type));
