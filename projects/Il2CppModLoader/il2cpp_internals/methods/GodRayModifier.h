...
IL2CPP_REGISTER_METHOD(0x00800860, Renderer *, GetRenderer, (app::GodRayModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00800B80, void, __ctor, (app::GodRayModifier * this_ptr));
