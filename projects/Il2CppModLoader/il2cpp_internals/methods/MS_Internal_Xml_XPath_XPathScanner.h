...
namespace app::methods::MS_Internal_Xml_XPath::XPathScanner {
IL2CPP_REGISTER_METHOD(0x021DFD20, void, __ctor, (app::XPathScanner * this_ptr, app::String * xpath_expr));
IL2CPP_REGISTER_METHODINFO(0x047665A8, XPathScanner__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_SourceText, (app::XPathScanner * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0052A010, XPathScanner_LexKind__Enum, get_Kind, (app::XPathScanner * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, get_Name, (app::XPathScanner * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_Prefix, (app::XPathScanner * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9B0, String *, get_StringValue, (app::XPathScanner * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x021E08A0, String *, ScanString, (app::XPathScanner * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047218F0, XPathScanner_ScanString__MethodInfo);
IL2CPP_REGISTER_METHOD(0x021E0A50, String *, ScanName, (app::XPathScanner * this_ptr));
}
