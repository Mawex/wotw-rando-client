...
namespace app::methods::TriangleNet_Meshing::QualityOptions {
...
IL2CPP_REGISTER_METHOD(0x002FBB00, Func_3_TriangleNet_Geometry_ITriangle_Double_Boolean_ *, get_UserTest, (app::QualityOptions * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::QualityOptions * this_ptr));
}
