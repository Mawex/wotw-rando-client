...
namespace app::methods::Moon_Wwise::AudioEmitterZone {
...
IL2CPP_REGISTER_METHOD(0x02709650, String *, get_GizmoText, (app::AudioEmitterZone * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::AudioEmitterZone * this_ptr));
}
