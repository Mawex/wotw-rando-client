...
namespace app::methods::UnityEngine_Experimental_Rendering::ScriptableRuntimeReflectionSystemWrapper {
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::ScriptableRuntimeReflectionSystemWrapper * this_ptr));
