...
IL2CPP_REGISTER_METHOD(0x002FBB40, IPassiveStateDescriptor *, get_Controller, (app::PassiveStateModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01B77B10, String *, get_StateName, (app::PassiveStateModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01B77D50, void, __ctor, (app::PassiveStateModifier * this_ptr));
