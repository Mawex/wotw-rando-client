...
namespace app::methods::frameworks_loading_Prewarmers::ShaderPrewarmOperation {
    IL2CPP_REGISTER_METHOD(0x00F62000, void, __ctor, (app::ShaderPrewarmOperation * this_ptr));
