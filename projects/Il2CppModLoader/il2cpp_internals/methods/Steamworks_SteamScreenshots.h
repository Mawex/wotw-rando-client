...
IL2CPP_REGISTER_METHOD(0x02797530, ScreenshotHandle, WriteScreenshot, (app::Byte__Array * pub_r_g_b, uint32_t cub_r_g_b, int32_t n_width, int32_t n_height));
IL2CPP_REGISTER_METHOD(0x027976A0, ScreenshotHandle, AddScreenshotToLibrary, (app::String * pch_filename, app::String * pch_thumbnail_filename, int32_t n_width, int32_t n_height));
...
IL2CPP_REGISTER_METHOD(0x027981D0, ScreenshotHandle, AddVRScreenshotToLibrary, (app::EVRScreenshotType__Enum_1 e_type, app::String * pch_filename, app::String * pch_v_r_filename));
}
