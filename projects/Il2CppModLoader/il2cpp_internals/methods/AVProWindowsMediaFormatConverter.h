...
IL2CPP_REGISTER_METHOD(0x002FB990, Texture *, get_OutputTexture, (app::AVProWindowsMediaFormatConverter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03129B30, Material *, GetConversionMaterial, (app::AVProWindowsMediaFormatConverter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0312BEF0, void, __ctor, (app::AVProWindowsMediaFormatConverter * this_ptr));
}
