...
namespace app::methods::SeinWallSlide {
    ...
    IL2CPP_REGISTER_METHOD(0x005D0720, CharacterSpriteMirror*, get_SpriteMirror, (app::SeinWallSlide * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005D06F0, CharacterLeftRightMovement*, get_LeftRightMovement, (app::SeinWallSlide * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A7EB40, SeinDoubleJump*, get_DoubleJump, (app::SeinWallSlide * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00AB1790, SeinJump*, get_Jump, (app::SeinWallSlide * this_ptr));
    IL2CPP_REGISTER_METHOD(0x006E4240, CharacterGravity*, get_Gravity, (app::SeinWallSlide * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005D06C0, CharacterPlatformMovement*, get_PlatformMovement, (app::SeinWallSlide * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00AB1E00, SeinWallSlidePuppet*, get_Puppet, (app::SeinWallSlide * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00AB3010, SurfaceMaterialType__Enum, get_WallSurfaceMaterialType, (app::SeinWallSlide * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00AB4CF0, void, __ctor, (app::SeinWallSlide * this_ptr));
} // namespace app::methods::SeinWallSlide
