...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::Action_1_Steamworks_UserAchievementStored_t_ * this_ptr, app::Object * object, app::void * method_1));
IL2CPP_REGISTER_METHODINFO(0x04792C50, Action_1_Steamworks_UserAchievementStored_t___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02A04200, IAsyncResult *, BeginInvoke, (app::Action_1_Steamworks_UserAchievementStored_t_ * this_ptr, app::UserAchievementStored_t obj, app::AsyncCallback * callback, app::Object * object));
