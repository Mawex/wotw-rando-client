...
namespace app::methods::System_Collections_Generic::Queue_1_Moon_Timeline_Reaction_ {
...
IL2CPP_REGISTER_METHOD(0x02CA4590, Queue_1_T_Enumerator_Moon_Timeline_Reaction_, GetEnumerator, (app::Queue_1_Moon_Timeline_Reaction_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CA4690, Reaction, Dequeue, (app::Queue_1_Moon_Timeline_Reaction_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CA4050, Object *, ICollection_get_SyncRoot, (app::Queue_1_Moon_Timeline_Reaction_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CA45E0, IEnumerator_1_Moon_Timeline_Reaction_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::Queue_1_Moon_Timeline_Reaction_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA45E0, IEnumerator *, IEnumerable_GetEnumerator, (app::Queue_1_Moon_Timeline_Reaction_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA4790, Reaction, Peek, (app::Queue_1_Moon_Timeline_Reaction_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA4810, bool, Contains, (app::Queue_1_Moon_Timeline_Reaction_ * this_ptr, app::Reaction item));
IL2CPP_REGISTER_METHOD(0x0243D5D0, Reaction__Array *, ToArray, (app::Queue_1_Moon_Timeline_Reaction_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0243D6C0, void, SetCapacity, (app::Queue_1_Moon_Timeline_Reaction_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x0243D7A0, void, MoveNext, (app::Queue_1_Moon_Timeline_Reaction_ * this_ptr, app::int32_t * index));
