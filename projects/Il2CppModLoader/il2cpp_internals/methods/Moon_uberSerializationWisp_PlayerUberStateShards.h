...
namespace app::methods::Moon_uberSerializationWisp::PlayerUberStateShards {
IL2CPP_REGISTER_METHOD(0x00F406E0, void, __ctor, (app::PlayerUberStateShards * this_ptr, app::Action * set_dirty_callback));
IL2CPP_REGISTER_METHOD(0x00F40DC0, PlayerUberStateShards_Shard *, SetAbility, (app::PlayerUberStateShards * this_ptr, app::SpiritShardType__Enum ability, bool value));
IL2CPP_REGISTER_METHOD(0x00F40EF0, bool, HasAbility, (app::PlayerUberStateShards * this_ptr, app::SpiritShardType__Enum ability));
IL2CPP_REGISTER_METHOD(0x00F40FA0, PlayerUberStateShards_Shard *, GetShard, (app::PlayerUberStateShards * this_ptr, app::SpiritShardType__Enum shard));
...
IL2CPP_REGISTER_METHOD(0x00F411D0, PlayerUberStateShards_Shard *, GetShardAtSlot, (app::PlayerUberStateShards * this_ptr, int32_t index));
