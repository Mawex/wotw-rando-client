...
namespace app::methods::Moon_InteractionGraph::State {
...
IL2CPP_REGISTER_METHOD(0x01991590, void, __ctor_1, (app::State_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x01991A00, void, __ctor_2, (app::State_1 * this_ptr, int32_t id));
