...
namespace app::methods::Moon_Driver::UpdateManager {
IL2CPP_REGISTER_METHOD(0x031371A0, void, __ctor, (app::UpdateManager * this_ptr, app::UpdateType__Enum update_type, app::UpdateManager__Array * managers));
...
IL2CPP_REGISTER_METHOD(0x03138C60, UpdateManager_Entry *, GetEntryFromPool, (app::IUpdateHandlerBase * handler, app::UpdateType__Enum update_type));
