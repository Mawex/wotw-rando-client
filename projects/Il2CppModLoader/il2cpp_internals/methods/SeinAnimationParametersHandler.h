...
IL2CPP_REGISTER_METHOD(0x00D841B0, CharacterPlatformMovement *, get_PlatformMovement, (app::SeinAnimationParametersHandler * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::SeinAnimationParametersHandler * this_ptr));
}
