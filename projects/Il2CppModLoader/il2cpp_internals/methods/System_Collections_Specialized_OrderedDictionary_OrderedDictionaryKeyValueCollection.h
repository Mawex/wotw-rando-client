...
namespace app::methods::System_Collections_Specialized::OrderedDictionary_OrderedDictionaryKeyValueCollection {
IL2CPP_REGISTER_METHOD(0x01669060, void, __ctor, (app::OrderedDictionary_OrderedDictionaryKeyValueCollection * this_ptr, app::ArrayList * array, bool is_keys));
...
IL2CPP_REGISTER_METHOD(0x01BCB830, Object *, ICollection_get_SyncRoot, (app::OrderedDictionary_OrderedDictionaryKeyValueCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x0249DCB0, IEnumerator *, IEnumerable_GetEnumerator, (app::OrderedDictionary_OrderedDictionaryKeyValueCollection * this_ptr));
}
