...
IL2CPP_REGISTER_METHOD(0x00ABE390, Object *, CreateData, (app::ServerConfigureConfigurableJointAction * this_ptr, app::Object * data));
IL2CPP_REGISTER_METHOD(0x00ABE6B0, Component_1 *, ApplyData, (app::ServerConfigureConfigurableJointAction * this_ptr, app::GameObject * * gameobj));
