...
namespace app::methods::System_Security_Cryptography::SHA384Managed {
IL2CPP_REGISTER_METHOD(0x028F9440, void, __ctor, (app::SHA384Managed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x028F9560, Byte__Array *, HashFinal, (app::SHA384Managed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x028F99A0, Byte__Array *, _EndHash, (app::SHA384Managed * this_ptr));
IL2CPP_REGISTER_METHOD(0x028F9C40, void, SHATransform, (app::uint64_t * expanded_buffer, app::uint64_t * state, app::uint8_t * block));
...
IL2CPP_REGISTER_METHOD(0x028FA800, void, SHA384Expand, (app::uint64_t * x));
