...
namespace app::methods::System_Net_Http_Headers::CacheControlHeaderValue {
IL2CPP_REGISTER_METHOD(0x02D02C30, ICollection_1_System_Net_Http_Headers_NameValueHeaderValue_ *, get_Extensions, (app::CacheControlHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CB5CB0, Nullable_1_TimeSpan_, get_MaxAge, (app::CacheControlHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01999450, Nullable_1_TimeSpan_, get_MaxStaleLimit, (app::CacheControlHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01CB97B0, Nullable_1_TimeSpan_, get_MinFresh, (app::CacheControlHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D02DB0, ICollection_1_System_String_ *, get_NoCacheHeaders, (app::CacheControlHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D02F20, ICollection_1_System_String_ *, get_PrivateHeaders, (app::CacheControlHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D030A0, Nullable_1_TimeSpan_, get_SharedMaxAge, (app::CacheControlHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D030C0, Object *, ICloneable_Clone, (app::CacheControlHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D04DD0, String *, ToString, (app::CacheControlHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::CacheControlHeaderValue * this_ptr));
}
