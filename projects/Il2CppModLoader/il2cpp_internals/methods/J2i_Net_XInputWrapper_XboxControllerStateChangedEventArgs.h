...
namespace app::methods::J2i_Net_XInputWrapper::XboxControllerStateChangedEventArgs {
    ...
    IL2CPP_REGISTER_METHOD(0x031BA170, void, __ctor, (app::XboxControllerStateChangedEventArgs * this_ptr));
}
