...
namespace app::methods::System_Xml::XmlEntityReference {
IL2CPP_REGISTER_METHOD(0x01DB5690, void, __ctor, (app::XmlEntityReference * this_ptr, app::String * name, app::XmlDocument * doc));
IL2CPP_REGISTER_METHODINFO(0x0476F9D0, XmlEntityReference__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_Name, (app::XmlEntityReference * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_LocalName, (app::XmlEntityReference * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, String *, get_Value, (app::XmlEntityReference * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008E77B0, XmlNodeType__Enum, get_NodeType, (app::XmlEntityReference * this_ptr));
IL2CPP_REGISTER_METHOD(0x01DB5860, XmlNode *, CloneNode, (app::XmlEntityReference * this_ptr, bool deep));
...
IL2CPP_REGISTER_METHOD(0x002FBB00, XmlLinkedNode *, get_LastNode, (app::XmlEntityReference * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01DB5D40, String *, get_BaseURI, (app::XmlEntityReference * this_ptr));
IL2CPP_REGISTER_METHOD(0x01DB5D80, String *, ConstructBaseURI, (app::XmlEntityReference * this_ptr, app::String * base_u_r_i, app::String * system_id));
IL2CPP_REGISTER_METHOD(0x01DB5EA0, String *, get_ChildBaseURI, (app::XmlEntityReference * this_ptr));
}
