...
namespace app::methods::RecorderData {
    ...
    IL2CPP_REGISTER_METHOD(0x008EE620, RecorderFrame*, GetFrame, (app::RecorderData * this_ptr, int32_t index));
    IL2CPP_REGISTER_METHOD(0x008EE6F0, RecorderFrame*, get_LastFrame, (app::RecorderData * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x008EFA40, void, __ctor, (app::RecorderData * this_ptr));
} // namespace app::methods::RecorderData
