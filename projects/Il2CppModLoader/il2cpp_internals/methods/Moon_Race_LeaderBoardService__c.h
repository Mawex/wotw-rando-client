...
IL2CPP_REGISTER_METHOD(0x00C44310, bool, _HasScore_b__2_0, (LeaderBoardService_c * __this, LeaderBoardEntry * o));
IL2CPP_REGISTER_METHODINFO(0x04711D60, LeaderBoardService_c__HasScore_b__2_0__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00C40EF0, int32_t, _InTop_b__4_0, (LeaderBoardService_c * __this, LeaderBoardEntry * a, LeaderBoardEntry * b));
IL2CPP_REGISTER_METHODINFO(0x0476C468, LeaderBoardService_c__InTop_b__4_0__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00C44420, bool, _InTop_b__4_1, (LeaderBoardService_c * __this, LeaderBoardEntry * o));
