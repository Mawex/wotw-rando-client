...
namespace app::methods::J2i_Net_XInputWrapper::XboxController {
...
IL2CPP_REGISTER_METHOD(0x031B8EF0, void, __ctor, (app::XboxController * this_ptr, int32_t player_index));
...
IL2CPP_REGISTER_METHOD(0x031BA140, String *, ToString, (app::XboxController * this_ptr));
}
