...
IL2CPP_REGISTER_METHOD(0x027A7A60, void, OnRunCallback, (app::void * thisptr, app::void * pv_param));
IL2CPP_REGISTER_METHODINFO(0x04776178, UserAchievementStoredCallback_OnRunCallback__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027A7C00, void, OnRunCallResult, (app::void * thisptr, app::void * pv_param, bool b_failed, uint64_t h_steam_a_p_i_call));
IL2CPP_REGISTER_METHODINFO(0x04797308, UserAchievementStoredCallback_OnRunCallResult__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027A7E70, int32_t, OnGetCallbackSizeBytes, (app::void * thisptr));
IL2CPP_REGISTER_METHODINFO(0x04742330, UserAchievementStoredCallback_OnGetCallbackSizeBytes__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027A7F10, void, __cctor, ());
}
