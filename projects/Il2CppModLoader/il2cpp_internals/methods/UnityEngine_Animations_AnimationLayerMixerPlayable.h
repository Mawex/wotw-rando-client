...
namespace app::methods::UnityEngine_Animations::AnimationLayerMixerPlayable {
IL2CPP_REGISTER_METHOD(0x002417B0, void, __ctor, (app::AnimationLayerMixerPlayable__Boxed * this_ptr, app::PlayableHandle handle));
IL2CPP_REGISTER_METHODINFO(0x0476DE30, AnimationLayerMixerPlayable__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0307C9A0, AnimationLayerMixerPlayable, Create, (app::PlayableGraph graph, int32_t input_count));
IL2CPP_REGISTER_METHOD(0x0307CA90, PlayableHandle, CreateHandle, (app::PlayableGraph graph, int32_t input_count));
IL2CPP_REGISTER_METHOD(0x001D9980, PlayableHandle, GetHandle, (app::AnimationLayerMixerPlayable__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0307C600, Playable, operator_, (app::AnimationLayerMixerPlayable playable));
