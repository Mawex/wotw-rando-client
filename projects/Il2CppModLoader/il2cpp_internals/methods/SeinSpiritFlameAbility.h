...
IL2CPP_REGISTER_METHOD(0x005E2D20, List_1_ISpiritFlameAttackable_ *, get_ClosestAttackables, (app::SeinSpiritFlameAbility * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005E39A0, void, __ctor, (app::SeinSpiritFlameAbility * this_ptr));
}
