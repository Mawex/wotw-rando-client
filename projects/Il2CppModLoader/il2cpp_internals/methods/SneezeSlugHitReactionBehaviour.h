...
IL2CPP_REGISTER_METHOD(0x00756A30, EntityDamageEvent *, get_DamageEvent, (app::SneezeSlugHitReactionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00EDE3C0, BehaviourStatus__Enum, OnExecuteTask, (app::SneezeSlugHitReactionBehaviour * this_ptr, app::IContext * context));
