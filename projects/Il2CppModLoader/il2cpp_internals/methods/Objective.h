...
namespace app::methods::Objective {
    ...
    IL2CPP_REGISTER_METHOD(0x002FBB00, Transform*, get_AreaMapTransform, (app::Objective * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB10, void, set_AreaMapTransform, (app::Objective * this_ptr, app::Transform* value));
    IL2CPP_REGISTER_METHOD(0x002FB990, Transform*, get_WorldMapTransform, (app::Objective * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB9A0, void, set_WorldMapTransform, (app::Objective * this_ptr, app::Transform* value));
    IL2CPP_REGISTER_METHOD(0x0060FCF0, RuntimeGameWorldArea*, get_Area, (app::Objective * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x004140E0, void, __ctor, (app::Objective * this_ptr));
} // namespace app::methods::Objective
