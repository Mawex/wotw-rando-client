...
namespace app::methods::Moon_UberStateVisualization::ListView {
...
IL2CPP_REGISTER_METHOD(0x019978B0, void, __ctor, (app::ListView * this_ptr, int32_t control_id));
...
IL2CPP_REGISTER_METHOD(0x002FBCC0, ListViewItem *, get_SelectedItem, (app::ListView * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCE0, ListViewItem *, get_HoveredItem, (app::ListView * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCF0, void, set_HoveredItem, (app::ListView * this_ptr, app::ListViewItem * value));
IL2CPP_REGISTER_METHOD(0x002FBD00, List_1_Moon_UberStateVisualization_ListViewItem_ *, get_Items, (app::ListView * this_ptr));
IL2CPP_REGISTER_METHOD(0x01999450, Rect, get_ContentRect, (app::ListView * this_ptr));
}
