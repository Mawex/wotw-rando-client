...
IL2CPP_REGISTER_METHOD(0x00B89840, Vector3, GetSegmentPosition, (app::DesertEscapeWormPathFollower * this_ptr, float distance_from_head, app::Transform * previous_segment));
...
IL2CPP_REGISTER_METHOD(0x006DC050, SuspendableMask__Enum, get_Mask, (app::DesertEscapeWormPathFollower * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC20, IUberState__Array *, get_AffectingUberStates, (app::DesertEscapeWormPathFollower * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC40, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::DesertEscapeWormPathFollower * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B8A280, void, __ctor, (app::DesertEscapeWormPathFollower * this_ptr));
}
