...
namespace app::methods::System_Data_Common::DateTimeStorage {
IL2CPP_REGISTER_METHOD(0x02161C30, void, __ctor, (app::DateTimeStorage * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x02161D80, Object *, Aggregate, (app::DateTimeStorage * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x021626B0, Object *, ConvertValue, (app::DateTimeStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x021627E0, void, Copy, (app::DateTimeStorage * this_ptr, int32_t record_no1, int32_t record_no2));
IL2CPP_REGISTER_METHOD(0x02162890, Object *, Get, (app::DateTimeStorage * this_ptr, int32_t record));
...
IL2CPP_REGISTER_METHOD(0x02162E90, Object *, ConvertXmlToObject, (app::DateTimeStorage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x02163040, String *, ConvertObjectToXml, (app::DateTimeStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02163210, Object *, GetEmptyStorage, (app::DateTimeStorage * this_ptr, int32_t record_count));
