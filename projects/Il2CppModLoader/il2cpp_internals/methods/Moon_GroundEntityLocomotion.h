...
IL2CPP_REGISTER_METHOD(0x0049F2B0, GroundEntityMovementProcessor *, get_GroundMovement, (app::GroundEntityLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x0065FBE0, LocomotionGroundMoveBehaviour *, get_MovementBehaviour, (app::GroundEntityLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x0148DA00, Transform *, get_FeetTransform, (app::GroundEntityLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A640A0, bool, IsLookDirectionLocked, (app::GroundEntityLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x0148DA20, Vector3, get_FeetPosition, (app::GroundEntityLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C1F040, EntityWeightData_EntityWeight__Enum, get_Weight, (app::GroundEntityLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0065FBA0, EntityLocomotionTask *, get_DefaultFSMState, (app::GroundEntityLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0148F6A0, EntityLocomotionTask *, GetNextBehaviour, (app::GroundEntityLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01490A80, Vector3, GetGroundProjectedTargetPosition, (app::GroundEntityLocomotion * this_ptr, app::Vector3 target_position, float offset_y, float ray_length));
...
IL2CPP_REGISTER_METHOD(0x01490E80, Vector2, get_LookDirection, (app::GroundEntityLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x01490F90, Vector2, get_LookDirectionXYNormalized, (app::GroundEntityLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0049F2B0, MovementProcessor *, get_MovementProcessor, (app::GroundEntityLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x014910E0, void, OnDrawGizmosSelected, (app::GroundEntityLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x01491570, void, __ctor, (app::GroundEntityLocomotion * this_ptr));
