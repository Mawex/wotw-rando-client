...
namespace app::methods::UnityEngine_UI_Collections::IndexedSet_1_UnityEngine_UI_ICanvasElement_ {
IL2CPP_REGISTER_METHOD(0x02ACD120, void, __ctor, (app::IndexedSet_1_UnityEngine_UI_ICanvasElement_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02ACD8A0, ICanvasElement *, get_Item, (app::IndexedSet_1_UnityEngine_UI_ICanvasElement_ * this_ptr, int32_t index));
