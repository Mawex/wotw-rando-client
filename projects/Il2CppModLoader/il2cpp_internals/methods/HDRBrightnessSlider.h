...
IL2CPP_REGISTER_METHOD(0x0109B180, String *, GetValueToDisplay, (app::HDRBrightnessSlider * this_ptr));
IL2CPP_REGISTER_METHOD(0x00444040, void, __ctor, (app::HDRBrightnessSlider * this_ptr));
}
