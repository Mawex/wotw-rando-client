...
namespace app::methods::System_Diagnostics::Process {
IL2CPP_REGISTER_METHOD(0x01FFE840, void, __ctor_1, (app::Process * this_ptr));
IL2CPP_REGISTER_METHOD(0x01FFE900, void, __ctor_2, (app::Process * this_ptr, app::String * machine_name, bool is_remote_machine, int32_t process_id, app::ProcessInfo * process_info));
...
IL2CPP_REGISTER_METHOD(0x01FFEF50, ProcessStartInfo *, get_StartInfo, (app::Process * this_ptr));
IL2CPP_REGISTER_METHOD(0x01FFF1D0, ISynchronizeInvoke *, get_SynchronizingObject, (app::Process * this_ptr));
IL2CPP_REGISTER_METHOD(0x01FFF330, StreamWriter *, get_StandardInput, (app::Process * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0478CDF8, Process_get_StandardInput__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01FFF400, StreamReader *, get_StandardOutput, (app::Process * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02000160, SafeProcessHandle *, GetProcessHandle_1, (app::Process * this_ptr, int32_t access, bool throw_if_exited));
IL2CPP_REGISTER_METHODINFO(0x0475EEE0, Process_GetProcessHandle__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02000670, SafeProcessHandle *, GetProcessHandle_2, (app::Process * this_ptr, int32_t access));
IL2CPP_REGISTER_METHOD(0x02000680, SafeProcessHandle *, OpenProcessHandle, (app::Process * this_ptr, int32_t access));
...
IL2CPP_REGISTER_METHOD(0x02000B80, String *, ToString, (app::Process * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02001080, String *, ProcessName_internal_1, (app::void * handle));
IL2CPP_REGISTER_METHOD(0x02001180, String *, ProcessName_internal_2, (app::SafeProcessHandle * handle));
IL2CPP_REGISTER_METHOD(0x020013D0, String *, get_ProcessName, (app::Process * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00417870, bool, CreateProcess_internal, (app::ProcessStartInfo * start_info, app::void * stdin_1, app::void * stdout_1, app::void * stderr_1, app::Process_ProcInfo * proc_info));
