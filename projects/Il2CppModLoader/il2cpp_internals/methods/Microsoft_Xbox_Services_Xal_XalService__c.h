...
namespace app::methods::Microsoft_Xbox_Services_Xal::XalService___c {
IL2CPP_REGISTER_METHOD(0x0143BC30, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::XalService_c * this_ptr));
