...
namespace app::methods::Moon_Timeline::CustomTimelineConstraint {
...
IL2CPP_REGISTER_METHOD(0x0052A010, EntityId, get_ConstrainedTo, (app::CustomTimelineConstraint * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00529E80, ConstraintFlag__Enum, get_Flags, (app::CustomTimelineConstraint * this_ptr));
IL2CPP_REGISTER_METHOD(0x00529E90, void, set_Flags, (app::CustomTimelineConstraint * this_ptr, app::ConstraintFlag__Enum value));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::CustomTimelineConstraint * this_ptr));
}
