...
namespace app::methods::System_Net::HttpWebRequest_AuthorizationState {
IL2CPP_REGISTER_METHOD(0x00114130, bool, get_IsCompleted, (app::HttpWebRequest_AuthorizationState__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001155B0, HttpWebRequest_NtlmAuthState__Enum, get_NtlmAuthState, (app::HttpWebRequest_AuthorizationState__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001D70A0, bool, get_IsNtlmAuthenticated, (app::HttpWebRequest_AuthorizationState__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001D70C0, void, __ctor, (app::HttpWebRequest_AuthorizationState__Boxed * this_ptr, app::HttpWebRequest * request, bool is_proxy));
...
IL2CPP_REGISTER_METHOD(0x001D7100, String *, ToString, (app::HttpWebRequest_AuthorizationState__Boxed * this_ptr));
}
