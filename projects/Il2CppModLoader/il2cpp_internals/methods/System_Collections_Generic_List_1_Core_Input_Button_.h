...
namespace app::methods::System_Collections_Generic::List_1_Core_Input_Button_ {
IL2CPP_REGISTER_METHOD(0x02D201B0, List_1_T_Enumerator_Core_Input_Button_, GetEnumerator, (app::List_1_Core_Input_Button_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0474C148, List_1_Core_Input_Button__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_Core_Input_Button_ * this_ptr));
