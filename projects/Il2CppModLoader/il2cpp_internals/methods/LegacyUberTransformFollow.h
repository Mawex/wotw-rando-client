...
IL2CPP_REGISTER_METHOD(0x0112E070, Vector3, MidPoint, (app::LegacyUberTransformFollow * this_ptr, app::List_1_UnityEngine_Transform_ * * targets));
...
IL2CPP_REGISTER_METHOD(0x0112F800, Vector3, ComputeAvgRotation3D, (app::LegacyUberTransformFollow * this_ptr, app::List_1_UnityEngine_Transform_ * * targets));
...
IL2CPP_REGISTER_METHOD(0x0112FBE0, Vector3, ComputeLookRotation3D, (app::LegacyUberTransformFollow * this_ptr, app::Vector3 from, app::Vector3 to));
...
IL2CPP_REGISTER_METHOD(0x01130370, void, __ctor, (app::LegacyUberTransformFollow * this_ptr));
}
