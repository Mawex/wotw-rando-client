...
IL2CPP_REGISTER_METHOD(0x00982550, Transform *, get_m_target, (app::EulerRotationAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00868870, Vector3, get_OriginalEulerAngles, (app::EulerRotationAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00982B40, bool, get_IsLooping, (app::EulerRotationAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00982DC0, void, __ctor, (app::EulerRotationAnimator * this_ptr));
}
