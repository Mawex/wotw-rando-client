...
namespace app::methods::LoreNodeWisps {
    ...
    IL2CPP_REGISTER_METHOD(0x009ED530, LoreNodeWisps_LoreStep*, get_CurrentStep, (app::LoreNodeWisps * this_ptr));
    IL2CPP_REGISTER_METHOD(0x009ED700, MessageProvider*, get_CurrentLine, (app::LoreNodeWisps * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0056FAC0, void, __ctor, (app::LoreNodeWisps * this_ptr));
} // namespace app::methods::LoreNodeWisps
