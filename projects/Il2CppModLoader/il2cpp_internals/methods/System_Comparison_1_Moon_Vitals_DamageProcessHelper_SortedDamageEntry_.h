...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::Comparison_1_Moon_Vitals_DamageProcessHelper_SortedDamageEntry_ * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02C7AD30, IAsyncResult *, BeginInvoke, (app::Comparison_1_Moon_Vitals_DamageProcessHelper_SortedDamageEntry_ * this_ptr, app::Vitals_DamageProcessHelper_SortedDamageEntry x, app::Vitals_DamageProcessHelper_SortedDamageEntry y, app::AsyncCallback * callback, app::Object * object));
