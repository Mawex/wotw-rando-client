...
IL2CPP_REGISTER_METHOD(0x02487F60, Material *, get_material, (app::CameraFilterPack_OldFilm_Cutting2 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024886E0, void, __ctor, (app::CameraFilterPack_OldFilm_Cutting2 * this_ptr));
}
