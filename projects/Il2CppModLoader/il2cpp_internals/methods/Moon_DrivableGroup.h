...
IL2CPP_REGISTER_METHOD(0x031367E0, String *, get_GroupName, (app::DrivableGroup * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03136F40, void, __ctor, (app::DrivableGroup * this_ptr));
}
