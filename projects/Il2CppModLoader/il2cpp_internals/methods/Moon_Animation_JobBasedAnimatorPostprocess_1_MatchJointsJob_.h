...
namespace app::methods::Moon_Animation::JobBasedAnimatorPostprocess_1_MatchJointsJob_ {
IL2CPP_REGISTER_METHOD(0x019FC330, void, __ctor, (app::JobBasedAnimatorPostprocess_1_MatchJointsJob_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x019FBF70, Playable, ConstructPlayable, (app::JobBasedAnimatorPostprocess_1_MatchJointsJob_ * this_ptr, app::PlayableGraph playable_graph));
