...
IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor, (app::ParticleSystem_EmissionModule__Boxed * this_ptr, app::ParticleSystem * particle_system));
...
IL2CPP_REGISTER_METHOD(0x00247380, ParticleSystem_MinMaxCurve, get_rateOverTime, (app::ParticleSystem_EmissionModule__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002474F0, ParticleSystem_MinMaxCurve, get_rateOverDistance, (app::ParticleSystem_EmissionModule__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00247650, ParticleSystem_Burst, GetBurst_1, (app::ParticleSystem_EmissionModule__Boxed * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x03134340, ParticleSystem_Burst, GetBurst_2, (app::ParticleSystem * system, int32_t index));
