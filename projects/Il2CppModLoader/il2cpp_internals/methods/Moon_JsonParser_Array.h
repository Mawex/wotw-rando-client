...
IL2CPP_REGISTER_METHOD(0x002458B0, void, __ctor, (app::JsonParser_Array__Boxed * this_ptr, app::JsonParser * parser));
IL2CPP_REGISTER_METHOD(0x00245900, Nullable_1_Moon_JsonParser_Slot_, TryGetSlot, (app::JsonParser_Array__Boxed * this_ptr));
