...
IL2CPP_REGISTER_METHOD(0x00ACB210, SeinClamberPuppet *, get_Puppet, (app::SeinEdgeClamber * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D06C0, CharacterPlatformMovement *, get_PlatformMovement, (app::SeinEdgeClamber * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D06F0, CharacterLeftRightMovement *, get_LeftRightMovement, (app::SeinEdgeClamber * this_ptr));
IL2CPP_REGISTER_METHOD(0x00ACB2D0, void, OnSetReferenceToSein, (app::SeinEdgeClamber * this_ptr));
IL2CPP_REGISTER_METHOD(0x006E4240, CharacterGravity *, get_CharacterGravity, (app::SeinEdgeClamber * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D06F0, CharacterLeftRightMovement *, get_CharacterLeftRightMovement, (app::SeinEdgeClamber * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00ACD190, void, __ctor, (app::SeinEdgeClamber * this_ptr));
}
