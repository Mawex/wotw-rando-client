...
namespace app::methods::System_Data_Common::BooleanStorage {
IL2CPP_REGISTER_METHOD(0x02156620, void, __ctor, (app::BooleanStorage * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x02156740, Object *, Aggregate, (app::BooleanStorage * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x02156CD0, Object *, ConvertValue, (app::BooleanStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02156E00, void, Copy, (app::BooleanStorage * this_ptr, int32_t record_no1, int32_t record_no2));
IL2CPP_REGISTER_METHOD(0x02156EC0, Object *, Get, (app::BooleanStorage * this_ptr, int32_t record));
...
IL2CPP_REGISTER_METHOD(0x021572A0, Object *, ConvertXmlToObject, (app::BooleanStorage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x02157350, String *, ConvertObjectToXml, (app::BooleanStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02157410, Object *, GetEmptyStorage, (app::BooleanStorage * this_ptr, int32_t record_count));
