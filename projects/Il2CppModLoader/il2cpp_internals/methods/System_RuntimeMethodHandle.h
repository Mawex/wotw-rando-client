...
IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor_1, (app::RuntimeMethodHandle__Boxed * this_ptr, app::void * v));
IL2CPP_REGISTER_METHOD(0x001D8110, void, __ctor_2, (app::RuntimeMethodHandle__Boxed * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
...
IL2CPP_REGISTER_METHOD(0x01EE2730, String *, ConstructInstantiation, (app::RuntimeMethodInfo * method_1, app::TypeNameFormatFlags__Enum format));
