...
IL2CPP_REGISTER_METHOD(0x0121F770, void, CalculateMultipliers, (app::EntityHitReaction * this_ptr, app::EntityDamageEvent * damage_event, bool instant, app::float * kickback_multiplier, app::float * vertical_multiplier, app::bool * should_skip_kickback));
...
IL2CPP_REGISTER_METHOD(0x012203E0, void, __ctor, (app::EntityHitReaction * this_ptr));
}
