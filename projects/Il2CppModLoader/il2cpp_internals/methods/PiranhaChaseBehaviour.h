...
IL2CPP_REGISTER_METHOD(0x0115D870, BehaviourStatus__Enum, OnExecute, (app::PiranhaChaseBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x0115DB00, void, __ctor, (app::PiranhaChaseBehaviour * this_ptr));
}
