...
namespace app::methods::WorldEvents {
    IL2CPP_REGISTER_METHOD(0x00581340, String*, GetNameFromID, (app::WorldEvents * this_ptr, int32_t id));
    ...
    IL2CPP_REGISTER_METHOD(0x00581850, void, __ctor, (app::WorldEvents * this_ptr));
} // namespace app::methods::WorldEvents
