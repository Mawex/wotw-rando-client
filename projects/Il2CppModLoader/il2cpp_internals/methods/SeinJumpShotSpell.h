...
IL2CPP_REGISTER_METHOD(0x010200F0, Vector3, reflect, (app::SeinJumpShotSpell * this_ptr, app::Vector3 v, app::Vector3 axis));
...
IL2CPP_REGISTER_METHOD(0x005D06C0, CharacterPlatformMovement *, get_PlatformMovement, (app::SeinJumpShotSpell * this_ptr));
IL2CPP_REGISTER_METHOD(0x01020A10, void, __ctor, (app::SeinJumpShotSpell * this_ptr));
}
