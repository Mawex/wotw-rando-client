...
namespace app::methods::System_Net::ListenerPrefix {
IL2CPP_REGISTER_METHOD(0x01E6D7F0, void, __ctor, (app::ListenerPrefix * this_ptr, app::String * prefix));
IL2CPP_REGISTER_METHOD(0x002FA280, String *, ToString, (app::ListenerPrefix * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9B0, IPAddress__Array *, get_Addresses, (app::ListenerPrefix * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Host, (app::ListenerPrefix * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E6D800, int32_t, get_Port, (app::ListenerPrefix * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, get_Path, (app::ListenerPrefix * this_ptr));
