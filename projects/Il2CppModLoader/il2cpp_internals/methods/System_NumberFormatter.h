...
IL2CPP_REGISTER_METHOD(0x02274500, void, __ctor, (app::NumberFormatter * this_ptr, app::Thread * current));
...
IL2CPP_REGISTER_METHOD(0x02275550, NumberFormatInfo *, GetNumberFormatInstance, (app::NumberFormatter * this_ptr, app::IFormatProvider * fp));
...
IL2CPP_REGISTER_METHOD(0x02275E60, NumberFormatter *, GetInstance, (app::IFormatProvider * fp));
IL2CPP_REGISTER_METHOD(0x022762B0, void, Release, (app::NumberFormatter * this_ptr));
IL2CPP_REGISTER_METHOD(0x022763F0, String *, NumberToString_1, (app::String * format, uint32_t value, app::IFormatProvider * fp));
IL2CPP_REGISTER_METHOD(0x02276550, String *, NumberToString_2, (app::String * format, int32_t value, app::IFormatProvider * fp));
IL2CPP_REGISTER_METHOD(0x022766C0, String *, NumberToString_3, (app::String * format, uint64_t value, app::IFormatProvider * fp));
IL2CPP_REGISTER_METHOD(0x02276820, String *, NumberToString_4, (app::String * format, int64_t value, app::IFormatProvider * fp));
IL2CPP_REGISTER_METHOD(0x02276990, String *, NumberToString_5, (app::String * format, float value, app::IFormatProvider * fp));
IL2CPP_REGISTER_METHOD(0x02276B80, String *, NumberToString_6, (app::String * format, double value, app::IFormatProvider * fp));
IL2CPP_REGISTER_METHOD(0x02276E00, String *, NumberToString_7, (app::String * format, app::Decimal value, app::IFormatProvider * fp));
IL2CPP_REGISTER_METHOD(0x02276F20, String *, IntegerToString, (app::NumberFormatter * this_ptr, app::String * format, app::IFormatProvider * fp));
IL2CPP_REGISTER_METHODINFO(0x04710EB0, NumberFormatter_IntegerToString__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02277170, String *, NumberToString_8, (app::NumberFormatter * this_ptr, app::String * format, app::NumberFormatInfo * nfi));
IL2CPP_REGISTER_METHODINFO(0x04774700, NumberFormatter_NumberToString_7__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02277360, String *, FormatCurrency, (app::NumberFormatter * this_ptr, int32_t precision, app::NumberFormatInfo * nfi));
IL2CPP_REGISTER_METHOD(0x022776F0, String *, FormatDecimal, (app::NumberFormatter * this_ptr, int32_t precision, app::NumberFormatInfo * nfi));
IL2CPP_REGISTER_METHOD(0x022777F0, String *, FormatHexadecimal, (app::NumberFormatter * this_ptr, int32_t precision));
IL2CPP_REGISTER_METHOD(0x02277990, String *, FormatFixedPoint, (app::NumberFormatter * this_ptr, int32_t precision, app::NumberFormatInfo * nfi));
IL2CPP_REGISTER_METHOD(0x02277B40, String *, FormatRoundtrip_1, (app::NumberFormatter * this_ptr, double origval, app::NumberFormatInfo * nfi));
IL2CPP_REGISTER_METHOD(0x02277C70, String *, FormatRoundtrip_2, (app::NumberFormatter * this_ptr, float origval, app::NumberFormatInfo * nfi));
IL2CPP_REGISTER_METHOD(0x02277D20, String *, FormatGeneral, (app::NumberFormatter * this_ptr, int32_t precision, app::NumberFormatInfo * nfi));
IL2CPP_REGISTER_METHOD(0x02277E90, String *, FormatNumber, (app::NumberFormatter * this_ptr, int32_t precision, app::NumberFormatInfo * nfi));
IL2CPP_REGISTER_METHOD(0x02278030, String *, FormatPercent, (app::NumberFormatter * this_ptr, int32_t precision, app::NumberFormatInfo * nfi));
IL2CPP_REGISTER_METHOD(0x022781C0, String *, FormatExponential_1, (app::NumberFormatter * this_ptr, int32_t precision, app::NumberFormatInfo * nfi));
IL2CPP_REGISTER_METHOD(0x02278220, String *, FormatExponential_2, (app::NumberFormatter * this_ptr, int32_t precision, app::NumberFormatInfo * nfi, int32_t exp_digits));
IL2CPP_REGISTER_METHOD(0x022783C0, String *, FormatCustom, (app::NumberFormatter * this_ptr, app::String * format, app::NumberFormatInfo * nfi));
...
IL2CPP_REGISTER_METHOD(0x02279E90, NumberFormatter *, GetClone, (app::NumberFormatter * this_ptr));
}
