...
IL2CPP_REGISTER_METHOD(0x024EFC40, Material *, get_material, (app::CameraFilterPack_Drawing_Comics * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024F03D0, void, __ctor, (app::CameraFilterPack_Drawing_Comics * this_ptr));
}
