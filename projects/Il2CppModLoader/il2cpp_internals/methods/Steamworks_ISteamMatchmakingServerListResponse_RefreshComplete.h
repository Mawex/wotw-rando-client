...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::ISteamMatchmakingServerListResponse_RefreshComplete * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x015FF6D0, IAsyncResult *, BeginInvoke, (app::ISteamMatchmakingServerListResponse_RefreshComplete * this_ptr, app::HServerListRequest h_request, app::EMatchMakingServerResponse__Enum response, app::AsyncCallback * callback, app::Object * object));
