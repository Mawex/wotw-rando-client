...
IL2CPP_REGISTER_METHOD(0x020F9650, Material *, get_material, (app::CameraFilterPack_Vision_Rainbow * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020F9FE0, void, __ctor, (app::CameraFilterPack_Vision_Rainbow * this_ptr));
}
