...
IL2CPP_REGISTER_METHOD(0x013D6540, IEnumerable_1_System_String_ *, GetBaseVertexTextureNames, (app::TurbulenceTranslationModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x013D66C0, IEnumerable_1_System_String_ *, GetKeywordsForShader, (app::TurbulenceTranslationModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x013D6B40, void, __ctor, (app::TurbulenceTranslationModifier * this_ptr));
}
