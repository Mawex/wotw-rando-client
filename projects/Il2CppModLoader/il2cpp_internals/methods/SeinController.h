...
IL2CPP_REGISTER_METHOD(0x002FBB80, Transform *, get_Transform, (app::SeinController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006DC050, SuspendableMask__Enum, get_Mask, (app::SeinController * this_ptr));
IL2CPP_REGISTER_METHOD(0x006DC060, void, set_Mask, (app::SeinController * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x002FBBC0, Component_1__Array *, get_Suspendables, (app::SeinController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006DE7E0, RaycastCommand, GetRayTestCommand, (app::SeinController * this_ptr, app::GameObject * target, app::Vector2 start_offset, app::Vector2 end_offset));
...
IL2CPP_REGISTER_METHOD(0x006DF420, void, __ctor, (app::SeinController * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::SeinController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::SeinController * this_ptr));
}
