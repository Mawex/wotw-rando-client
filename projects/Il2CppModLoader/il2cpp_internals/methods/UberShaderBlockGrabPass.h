...
IL2CPP_REGISTER_METHOD(0x007882F0, void, OnPoolSpawned, (UberShaderBlockGrabPass * __this));
IL2CPP_REGISTER_METHOD(0x0190BDC0, void, Update, (UberShaderBlockGrabPass * __this));
