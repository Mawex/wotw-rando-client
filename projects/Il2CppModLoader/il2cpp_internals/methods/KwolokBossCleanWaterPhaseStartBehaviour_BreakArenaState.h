...
IL2CPP_REGISTER_METHOD(0x01251B60, void, __ctor, (app::KwolokBossCleanWaterPhaseStartBehaviour_BreakArenaState * this_ptr, app::KwolokBossCleanWaterPhaseStartBehaviour * behaviour));
