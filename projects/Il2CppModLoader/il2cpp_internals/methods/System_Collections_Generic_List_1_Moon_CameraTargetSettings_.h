...
namespace app::methods::System_Collections_Generic::List_1_Moon_CameraTargetSettings_ {
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_Moon_CameraTargetSettings_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0473C158, List_1_Moon_CameraTargetSettings___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_Moon_CameraTargetSettings_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHODINFO(0x04706010, List_1_Moon_CameraTargetSettings___ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02C1DFB0, CameraTargetSettings, get_Item, (app::List_1_Moon_CameraTargetSettings_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02C1F070, List_1_T_Enumerator_Moon_CameraTargetSettings_, GetEnumerator, (app::List_1_Moon_CameraTargetSettings_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0476BF28, List_1_Moon_CameraTargetSettings__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02D4EC20, void, __ctor_3, (app::List_1_Moon_CameraTargetSettings_ * this_ptr, app::IEnumerable_1_Moon_CameraTargetSettings_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02D4F0B0, Object *, ICollection_get_SyncRoot, (app::List_1_Moon_CameraTargetSettings_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C1E150, Object *, IList_get_Item, (app::List_1_Moon_CameraTargetSettings_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_Moon_CameraTargetSettings_ *, AsReadOnly, (app::List_1_Moon_CameraTargetSettings_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C1EA20, CameraTargetSettings, Find, (app::List_1_Moon_CameraTargetSettings_ * this_ptr, app::Predicate_1_Moon_CameraTargetSettings_ * match));
IL2CPP_REGISTER_METHOD(0x02C1EB60, List_1_Moon_CameraTargetSettings_ *, FindAll, (app::List_1_Moon_CameraTargetSettings_ * this_ptr, app::Predicate_1_Moon_CameraTargetSettings_ * match));
...
IL2CPP_REGISTER_METHOD(0x02C1F0C0, IEnumerator_1_Moon_CameraTargetSettings_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_Moon_CameraTargetSettings_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02C1F0C0, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_Moon_CameraTargetSettings_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_Moon_CameraTargetSettings_ *, GetRange, (app::List_1_Moon_CameraTargetSettings_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, CameraTargetSettings__Array *, ToArray, (app::List_1_Moon_CameraTargetSettings_ * this_ptr));
