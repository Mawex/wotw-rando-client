...
IL2CPP_REGISTER_METHOD(0x013006A0, CharacterGravity *, get_CharacterGravity, (app::CharacterGravityToGround * this_ptr));
IL2CPP_REGISTER_METHOD(0x013006C0, PlatformMovement *, get_PlatformMovement, (app::CharacterGravityToGround * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x013013A0, void, __ctor, (app::CharacterGravityToGround * this_ptr));
}
