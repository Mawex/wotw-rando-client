...
IL2CPP_REGISTER_METHOD(0x02BD24D0, Queue_1_Moon_Timeline_IPoolableTimelineEntity_ *, get_Item, (app::Dictionary_2_System_Type_Queue_1_Moon_Timeline_IPoolableTimelineEntity_ * this_ptr, app::Type * key));
