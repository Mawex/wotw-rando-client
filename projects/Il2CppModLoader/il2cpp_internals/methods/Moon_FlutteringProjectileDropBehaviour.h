...
IL2CPP_REGISTER_METHOD(0x012260C0, BehaviourStatus__Enum, OnExecute, (app::FlutteringProjectileDropBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x012283F0, void, __ctor, (app::FlutteringProjectileDropBehaviour * this_ptr));
}
