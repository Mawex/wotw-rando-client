...
IL2CPP_REGISTER_METHOD(0x020FB320, Material *, get_material, (app::CameraFilterPack_Vision_Warp2 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020FBC70, void, __ctor, (app::CameraFilterPack_Vision_Warp2 * this_ptr));
}
