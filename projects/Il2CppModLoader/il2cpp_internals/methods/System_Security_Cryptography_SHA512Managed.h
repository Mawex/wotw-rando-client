...
namespace app::methods::System_Security_Cryptography::SHA512Managed {
IL2CPP_REGISTER_METHOD(0x01E0E5F0, void, __ctor, (app::SHA512Managed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E0E710, Byte__Array *, HashFinal, (app::SHA512Managed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E0EB50, Byte__Array *, _EndHash, (app::SHA512Managed * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E0EDF0, void, SHATransform, (app::uint64_t * expanded_buffer, app::uint64_t * state, app::uint8_t * block));
...
IL2CPP_REGISTER_METHOD(0x01E0F9F0, void, SHA512Expand, (app::uint64_t * x));
