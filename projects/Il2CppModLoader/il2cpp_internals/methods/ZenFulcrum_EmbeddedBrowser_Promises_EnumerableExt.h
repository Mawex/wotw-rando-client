...
namespace app::methods::ZenFulcrum_EmbeddedBrowser_Promises::EnumerableExt {
IL2CPP_REGISTER_METHOD(0x0156C730, IEnumerable_1_System_Object_ *, Empty, ());
IL2CPP_REGISTER_METHOD(0x00E7D170, IEnumerable_1_System_Object_ *, LazyEach, (app::IEnumerable_1_System_Object_ * source, app::Action_1_Object_ * fn));
