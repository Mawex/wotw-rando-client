...
namespace app::methods::System_Runtime_CompilerServices::TaskAwaiter_1_System_Boolean_ {
...
IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor, (app::TaskAwaiter_1_System_Boolean___Boxed * this_ptr, app::Task_1_System_Boolean_ * task));
