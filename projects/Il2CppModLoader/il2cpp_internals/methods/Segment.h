...
namespace app::methods::Segment {
    ...
    IL2CPP_REGISTER_METHOD(0x0106EDB0, Segment_1*, FindClosestSegment, (app::Vector3 position, float min_distance));
    IL2CPP_REGISTER_METHOD(0x0106EFB0, Segment_1*, FindClosestSegmentDown, (app::Vector3 position));
    ...
    IL2CPP_REGISTER_METHOD(0x0106F5A0, void, __ctor, (app::Segment_1 * this_ptr));
