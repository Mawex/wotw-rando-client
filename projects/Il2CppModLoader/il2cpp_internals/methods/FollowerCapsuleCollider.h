...
IL2CPP_REGISTER_METHOD(0x0127CF70, Vector3, get_CapsuleBase, (app::FollowerCapsuleCollider * this_ptr));
IL2CPP_REGISTER_METHOD(0x0127D0F0, Vector3, get_CapsuleTop, (app::FollowerCapsuleCollider * this_ptr));
IL2CPP_REGISTER_METHOD(0x0127D270, Vector3, GetCapsuleAxisFromDirection, (app::CapsuleCollider * capsule));
...
IL2CPP_REGISTER_METHOD(0x0127E940, Vector3, GetProjectedPointOnZ, (app::FollowerCapsuleCollider * this_ptr, app::Vector3 point_position));
IL2CPP_REGISTER_METHOD(0x0127EA30, void, OnDrawGizmosSelected, (app::FollowerCapsuleCollider * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::FollowerCapsuleCollider * this_ptr));
IL2CPP_REGISTER_METHOD(0x0127EF90, void, __cctor, ());
}
