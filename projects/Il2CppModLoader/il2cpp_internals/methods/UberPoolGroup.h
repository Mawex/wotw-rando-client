...
IL2CPP_REGISTER_METHOD(0x002FB990, UberPoolSettings *, get_Settings, (app::UberPoolGroup * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FD30C0, UberPoolItem *, PrewarmInstanceFromScene, (app::UberPoolGroup * this_ptr, app::GameObject * instance, app::Dictionary_2_System_Int32_UberPoolItem_ * entries));
IL2CPP_REGISTER_METHOD(0x00FD3150, UberPoolItem *, PrewarmExistingInstance, (app::UberPoolGroup * this_ptr, app::GameObject * instance, app::Dictionary_2_System_Int32_UberPoolItem_ * entries));
IL2CPP_REGISTER_METHOD(0x00FD3290, UberPoolItem *, RequestObject, (app::UberPoolGroup * this_ptr, app::GameObject * prototype, app::Vector3 position, app::Quaternion rotation, app::Nullable_1_Single_ * new_object_elapsed_millis));
IL2CPP_REGISTER_METHOD(0x00FD3C60, UberPoolItem *, CreatePoolItemForGO, (app::UberPoolGroup * this_ptr, app::GameObject * new_obj));
IL2CPP_REGISTER_METHOD(0x00FD3F60, void, BroadcastCallbacks, (app::UberPoolItem * pool_object));
IL2CPP_REGISTER_METHOD(0x00FD4290, GameObject *, GetNewObject, (app::UberPoolGroup * this_ptr, app::GameObject * prototype, app::Vector3 position, app::Quaternion rotation));
...
IL2CPP_REGISTER_METHOD(0x00FD4DE0, void, __ctor, (app::UberPoolGroup * this_ptr));
