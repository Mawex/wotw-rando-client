...
namespace app::methods::System_Xml_Schema::FacetsChecker_FacetsCompiler {
IL2CPP_REGISTER_METHOD(0x001E6F60, void, __ctor, (app::FacetsChecker_FacetsCompiler__Boxed * this_ptr, app::DatatypeImplementation * base_datatype, app::RestrictionFacets * restriction));
...
IL2CPP_REGISTER_METHOD(0x001E7070, Object *, ParseFacetValue, (app::FacetsChecker_FacetsCompiler__Boxed * this_ptr, app::XmlSchemaDatatype * datatype, app::XmlSchemaFacet * facet, app::String * code, app::IXmlNamespaceResolver * nsmgr, app::XmlNameTable * name_table));
IL2CPP_REGISTER_METHODINFO(0x04710428, FacetsChecker_FacetsCompiler_ParseFacetValue__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0236E690, String *, Preprocess, (app::String * pattern));
