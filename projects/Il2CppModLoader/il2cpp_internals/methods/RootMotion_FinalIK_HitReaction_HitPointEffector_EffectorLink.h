...
IL2CPP_REGISTER_METHOD(0x02077BE0, void, CrossFadeStart, (HitReaction_HitPointEffector_EffectorLink * __this));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (HitReaction_HitPointEffector_EffectorLink * __this));
}
