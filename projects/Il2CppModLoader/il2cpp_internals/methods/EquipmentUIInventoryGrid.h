...
IL2CPP_REGISTER_METHOD(0x009781A0, CleverMenuItemSelectionManager *, get_NavigationManager, (app::EquipmentUIInventoryGrid * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00979FF0, void, GetRowAndCol, (app::EquipmentUIInventoryGrid * this_ptr, int32_t index, app::int32_t * col, app::int32_t * row));
...
IL2CPP_REGISTER_METHOD(0x0097A270, void, __ctor, (app::EquipmentUIInventoryGrid * this_ptr));
}
