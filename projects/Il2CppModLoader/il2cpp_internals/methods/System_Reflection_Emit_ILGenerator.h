...
namespace app::methods::System_Reflection_Emit::ILGenerator {
IL2CPP_REGISTER_METHOD(0x02680C20, LocalBuilder *, DeclareLocal, (app::ILGenerator * this_ptr, app::Type * local_type));
IL2CPP_REGISTER_METHODINFO(0x0471C278, ILGenerator_DeclareLocal__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02680C70, Label, DefineLabel, (app::ILGenerator * this_ptr));
