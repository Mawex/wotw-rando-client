...
IL2CPP_REGISTER_METHOD(0x00E26FD0, BehaviourStatus__Enum, OnExecute, (app::ShardTraderIdleBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00E27000, void, OnExit, (app::ShardTraderIdleBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x0060C1C0, void, __ctor, (app::ShardTraderIdleBehaviour * this_ptr));
}
