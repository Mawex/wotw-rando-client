...
namespace app::methods::System_Xml::XmlTextReaderImpl_DtdParserProxy {
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::XmlTextReaderImpl_DtdParserProxy * this_ptr, app::XmlTextReaderImpl * reader));
IL2CPP_REGISTER_METHOD(0x01FBB230, XmlNameTable *, IDtdParserAdapter_get_NameTable, (app::XmlTextReaderImpl_DtdParserProxy * this_ptr));
IL2CPP_REGISTER_METHOD(0x01FBB250, IXmlNamespaceResolver *, IDtdParserAdapter_get_NamespaceResolver, (app::XmlTextReaderImpl_DtdParserProxy * this_ptr));
IL2CPP_REGISTER_METHOD(0x01FBB270, Uri *, IDtdParserAdapter_get_BaseUri, (app::XmlTextReaderImpl_DtdParserProxy * this_ptr));
IL2CPP_REGISTER_METHOD(0x01FBB370, bool, IDtdParserAdapter_get_IsEof, (app::XmlTextReaderImpl_DtdParserProxy * this_ptr));
IL2CPP_REGISTER_METHOD(0x01A88520, Char__Array *, IDtdParserAdapter_get_ParsingBuffer, (app::XmlTextReaderImpl_DtdParserProxy * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01FBB5A0, bool, IDtdParserAdapter_PushEntity, (app::XmlTextReaderImpl_DtdParserProxy * this_ptr, app::IDtdEntityInfo * entity, app::int32_t * entity_id));
IL2CPP_REGISTER_METHOD(0x01FBB6D0, bool, IDtdParserAdapter_PopEntity, (app::XmlTextReaderImpl_DtdParserProxy * this_ptr, app::IDtdEntityInfo * * old_entity, app::int32_t * new_entity_id));
...
IL2CPP_REGISTER_METHOD(0x01FBBB80, IValidationEventHandling *, IDtdParserAdapterWithValidation_get_ValidationEventHandling, (app::XmlTextReaderImpl_DtdParserProxy * this_ptr));
