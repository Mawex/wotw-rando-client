...
IL2CPP_REGISTER_METHOD(0x020E1BF0, Material *, get_material, (app::CameraFilterPack_Sharpen_Sharpen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E24A0, void, __ctor, (app::CameraFilterPack_Sharpen_Sharpen * this_ptr));
}
