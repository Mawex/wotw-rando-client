...
IL2CPP_REGISTER_METHOD(0x004B3DF0, UpgradableAbility *, GetUpgradableAbility, (app::AbilityUpgradeSettings * this_ptr, app::AbilityType__Enum ability));
IL2CPP_REGISTER_METHOD(0x004B3E90, void, __ctor, (app::AbilityUpgradeSettings * this_ptr));
}
