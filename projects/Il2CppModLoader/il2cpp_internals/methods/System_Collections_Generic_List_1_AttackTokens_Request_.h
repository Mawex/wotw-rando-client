...
namespace app::methods::System_Collections_Generic::List_1_AttackTokens_Request_ {
...
IL2CPP_REGISTER_METHOD(0x025EC760, AttackTokens_Request, get_Item, (app::List_1_AttackTokens_Request_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_AttackTokens_Request_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0473F288, List_1_AttackTokens_Request___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_AttackTokens_Request_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x025EC170, void, __ctor_3, (app::List_1_AttackTokens_Request_ * this_ptr, app::IEnumerable_1_AttackTokens_Request_ * collection));
...
IL2CPP_REGISTER_METHOD(0x025EC600, Object *, ICollection_get_SyncRoot, (app::List_1_AttackTokens_Request_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EC910, Object *, IList_get_Item, (app::List_1_AttackTokens_Request_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_AttackTokens_Request_ *, AsReadOnly, (app::List_1_AttackTokens_Request_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025ED1F0, AttackTokens_Request, Find, (app::List_1_AttackTokens_Request_ * this_ptr, app::Predicate_1_AttackTokens_Request_ * match));
IL2CPP_REGISTER_METHOD(0x025ED330, List_1_AttackTokens_Request_ *, FindAll, (app::List_1_AttackTokens_Request_ * this_ptr, app::Predicate_1_AttackTokens_Request_ * match));
...
IL2CPP_REGISTER_METHOD(0x025ED850, List_1_T_Enumerator_AttackTokens_Request_, GetEnumerator, (app::List_1_AttackTokens_Request_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025ED8A0, IEnumerator_1_AttackTokens_Request_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_AttackTokens_Request_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025ED8A0, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_AttackTokens_Request_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_AttackTokens_Request_ *, GetRange, (app::List_1_AttackTokens_Request_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, AttackTokens_Request__Array *, ToArray, (app::List_1_AttackTokens_Request_ * this_ptr));
