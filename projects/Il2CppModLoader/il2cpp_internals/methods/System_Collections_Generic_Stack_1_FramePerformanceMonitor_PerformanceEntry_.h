...
namespace app::methods::System_Collections_Generic::Stack_1_FramePerformanceMonitor_PerformanceEntry_ {
...
IL2CPP_REGISTER_METHOD(0x02CF7F30, FramePerformanceMonitor_PerformanceEntry *, Peek, (app::Stack_1_FramePerformanceMonitor_PerformanceEntry_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CF7F90, FramePerformanceMonitor_PerformanceEntry *, Pop, (app::Stack_1_FramePerformanceMonitor_PerformanceEntry_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04757F48, Stack_1_FramePerformanceMonitor_PerformanceEntry__Pop__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0243CB70, void, __ctor, (app::Stack_1_FramePerformanceMonitor_PerformanceEntry_ * this_ptr));
