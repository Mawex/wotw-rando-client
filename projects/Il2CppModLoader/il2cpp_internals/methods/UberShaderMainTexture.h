...
IL2CPP_REGISTER_METHOD(0x01912A80, IUberAtlasExternal *, GetExternalAtlasProvider, (app::UberShaderMainTexture * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCE0, UberShaderAtlasTexture *, get_AtlasTexture, (app::UberShaderMainTexture * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01912F70, void, __ctor, (app::UberShaderMainTexture * this_ptr));
}
