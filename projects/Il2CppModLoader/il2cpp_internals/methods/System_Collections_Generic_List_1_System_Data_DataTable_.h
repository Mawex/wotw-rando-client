...
namespace app::methods::System_Collections_Generic::List_1_System_Data_DataTable_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_System_Data_DataTable_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EFC50, DataTable *, get_Item, (app::List_1_System_Data_DataTable_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, DataTable__Array *, ToArray, (app::List_1_System_Data_DataTable_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04702078, List_1_System_Data_DataTable__ToArray__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_System_Data_DataTable_, GetEnumerator, (app::List_1_System_Data_DataTable_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04715CE0, List_1_System_Data_DataTable__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_System_Data_DataTable_ * this_ptr, int32_t capacity));
