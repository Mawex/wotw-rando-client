...
IL2CPP_REGISTER_METHOD(0x0119E2D0, Vector2, ProcessFreeMovementSpeed, (app::VolumeEntityMovementProcessor * this_ptr, app::Vector2 speed));
...
IL2CPP_REGISTER_METHOD(0x011A0C40, Vector2, ProcessGroundedMovementSpeed, (app::VolumeEntityMovementProcessor * this_ptr, app::Vector2 speed));
...
IL2CPP_REGISTER_METHOD(0x011A1960, Vector2, ProcessSpeedWithCollisionAvoidance, (app::VolumeEntityMovementProcessor * this_ptr, app::Vector2 initial_world_velocity));
...
IL2CPP_REGISTER_METHOD(0x011A2060, void, __ctor, (app::VolumeEntityMovementProcessor * this_ptr));
}
