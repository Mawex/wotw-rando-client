...
IL2CPP_REGISTER_METHOD(0x002FB930, BaseAnimator *, get_Animator, (app::AnimationMontage_Entry * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_Animator, (app::AnimationMontage_Entry * this_ptr, app::BaseAnimator * value));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::AnimationMontage_Entry * this_ptr));
}
