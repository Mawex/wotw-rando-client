...
namespace app::methods::CameraShake {
    ...
    IL2CPP_REGISTER_METHOD(0x00B1C4D0, Vector3, get_CurrentOffset, (app::CameraShake * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00B1C6A0, Vector3, get_CurrentRotation, (app::CameraShake * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00B1D170, TimelineEntity*, Convert, (app::CameraShake * this_ptr, app::Transform* target));
    IL2CPP_REGISTER_METHOD(0x00B1D310, void, __ctor, (app::CameraShake * this_ptr));
