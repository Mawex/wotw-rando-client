...
IL2CPP_REGISTER_METHOD(0x0041FB20, BehaviourStatus__Enum, OnExecuteTask, (app::GasballExplosionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0041FDB0, void, __ctor, (app::GasballExplosionBehaviour * this_ptr));
}
