...
namespace app::methods::Moon_Timeline::MoonTimeline {
...
IL2CPP_REGISTER_METHOD(0x00660430, List_1_Moon_Timeline_ConstraintsMetaData_ *, get_ConstraintMetaDatas, (app::MoonTimeline * this_ptr));
IL2CPP_REGISTER_METHOD(0x005B0220, List_1_Moon_Timeline_TimelineEntityRecord_ *, get_EntityRecords, (app::MoonTimeline * this_ptr));
IL2CPP_REGISTER_METHOD(0x00418200, List_1_Moon_Timeline_TimelineMarkerRecord_ *, get_MarkerRecords, (app::MoonTimeline * this_ptr));
IL2CPP_REGISTER_METHOD(0x0049F2B0, List_1_Moon_Timeline_ExternalTimelineRecord_ *, get_ExternalRecords, (app::MoonTimeline * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BC5170, String *, get_ProfilingMarkerName, (app::MoonTimeline * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00597B10, UpdateType__Enum, get_UpdateType, (app::MoonTimeline * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BC64F0, EntityId, AddChild, (app::MoonTimeline * this_ptr, app::ITimelineEntity * entity));
...
IL2CPP_REGISTER_METHOD(0x01BC6DC0, EntityId, GetEntityConstrainedTo, (app::MoonTimeline * this_ptr, app::EntityId entity_id, app::Constraint__Enum constraint));
...
IL2CPP_REGISTER_METHOD(0x01BC6E40, IConstraint *, get_StartConstraint, (app::MoonTimeline * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04780B30, MoonTimeline_get_StartConstraint__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01BC6E90, IConstraint *, get_EndConstraint, (app::MoonTimeline * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04787348, MoonTimeline_get_EndConstraint__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00420EE0, EntityId, get_EntityId, (app::MoonTimeline * this_ptr));
IL2CPP_REGISTER_METHOD(0x004C50A0, ITimelineEntity *, get_Entity, (app::MoonTimeline * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BC6EE0, int32_t, get_ConstrainedEntitiesCount, (app::MoonTimeline * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BC6F70, IConstrainedEntity *, GetConstrainedEntityFrom, (app::MoonTimeline * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x01BC7030, IConstrainedEntity *, GetConstrainedEntity, (app::MoonTimeline * this_ptr, app::EntityId entity_id));
IL2CPP_REGISTER_METHOD(0x004C50A0, ITimelineEntityParent *, get_GetITimelineEntityParent, (app::MoonTimeline * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BC7100, Nullable_1_Single_, get_ForcedDuration, (app::MoonTimeline * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BC7110, void, set_ForcedDuration, (app::MoonTimeline * this_ptr, app::Nullable_1_Single_ value));
IL2CPP_REGISTER_METHOD(0x005FDE00, ITrimController *, get_TrimController, (app::MoonTimeline * this_ptr));
IL2CPP_REGISTER_METHOD(0x005FDE10, void, set_TrimController, (app::MoonTimeline * this_ptr, app::ITrimController * value));
IL2CPP_REGISTER_METHOD(0x01BC7120, String *, get_FullAddress, (app::MoonTimeline * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BC7260, void, Remove, (app::MoonTimeline * this_ptr, app::EntityId id));
IL2CPP_REGISTER_METHOD(0x01BC74F0, EntityId, AddMarkerRecord_1, (app::MoonTimeline * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BC75D0, EntityId, AddMarkerRecord_2, (app::MoonTimeline * this_ptr, app::EntityId constrained_to));
...
IL2CPP_REGISTER_METHOD(0x01BC8620, bool, ApproximateEvent, (app::MoonTimeline * this_ptr, int32_t evt, app::float * time));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, RecordableParsingGroup__Enum, get_ParsingGroup, (app::MoonTimeline * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BC89B0, void, __ctor, (app::MoonTimeline * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BC9480, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x01EB9450, List_1_System_Object_ *, GetAnimators_1, (app::MoonTimeline * this_ptr));
IL2CPP_REGISTER_METHOD(0x01EB9450, List_1_Moon_Timeline_EventTriggerGameplayAnimator_ *, GetAnimators_2, (app::MoonTimeline * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04760158, MoonTimeline_GetAnimators_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EB9450, List_1_Moon_ScalableAnimationPlayer_ *, GetAnimators_3, (app::MoonTimeline * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04729ED0, MoonTimeline_GetAnimators_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EB9450, List_1_Moon_AnimationPlayer_ *, GetAnimators_4, (app::MoonTimeline * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0471F158, MoonTimeline_GetAnimators_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EB9450, List_1_Moon_Timeline_ReadyToFinishAnimator_ *, GetAnimators_5, (app::MoonTimeline * this_ptr));
