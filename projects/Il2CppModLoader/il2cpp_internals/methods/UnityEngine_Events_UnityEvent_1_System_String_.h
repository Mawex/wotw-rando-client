...
namespace app::methods::UnityEngine_Events::UnityEvent_1_System_String_ {
...
IL2CPP_REGISTER_METHOD(0x01F2C230, void, __ctor, (app::UnityEvent_1_System_String_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AC95D0, MethodInfo_1 *, FindMethod_Impl, (app::UnityEvent_1_System_String_ * this_ptr, app::String * name, app::Object * target_obj));
IL2CPP_REGISTER_METHOD(0x02AC8CD0, BaseInvokableCall *, GetDelegate, (app::UnityEvent_1_System_String_ * this_ptr, app::Object * target, app::MethodInfo_1 * the_function));
}
