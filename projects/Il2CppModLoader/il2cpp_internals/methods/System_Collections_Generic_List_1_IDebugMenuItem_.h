...
namespace app::methods::System_Collections_Generic::List_1_IDebugMenuItem_ {
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor, (app::List_1_IDebugMenuItem_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x025EFC50, IDebugMenuItem *, get_Item, (app::List_1_IDebugMenuItem_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_IDebugMenuItem_, GetEnumerator, (app::List_1_IDebugMenuItem_ * this_ptr));
