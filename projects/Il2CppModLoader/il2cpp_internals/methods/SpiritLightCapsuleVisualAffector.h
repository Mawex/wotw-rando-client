...
IL2CPP_REGISTER_METHOD(0x00D61010, Vector3, get_StartPointPosition, (app::SpiritLightCapsuleVisualAffector * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D61180, Vector3, get_EndPointPosition, (app::SpiritLightCapsuleVisualAffector * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D61840, void, __ctor, (app::SpiritLightCapsuleVisualAffector * this_ptr));
