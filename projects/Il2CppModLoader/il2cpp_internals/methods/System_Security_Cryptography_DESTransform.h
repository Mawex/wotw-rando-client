...
namespace app::methods::System_Security_Cryptography::DESTransform {
IL2CPP_REGISTER_METHOD(0x020D1FF0, void, __ctor, (app::DESTransform * this_ptr, app::SymmetricAlgorithm * symm_algo, bool encryption, app::Byte__Array * key, app::Byte__Array * iv));
...
IL2CPP_REGISTER_METHOD(0x020D3B10, Byte__Array *, GetStrongKey, ());
IL2CPP_REGISTER_METHOD(0x020D3C60, void, __cctor, ());
}
