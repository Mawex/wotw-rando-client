...
IL2CPP_REGISTER_METHOD(0x02B79C90, void, __cctor, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x02B7A110, HuffmanTree *, get_StaticLiteralLengthTree, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x02B7A1B0, HuffmanTree *, get_StaticDistanceTree, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x02B7A250, void, __ctor, (HuffmanTree * __this, Byte__Array * codeLengths));
IL2CPP_REGISTER_METHOD(0x02B7A2A0, Byte__Array *, GetStaticLiteralTreeLength, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x02B7A3F0, Byte__Array *, GetStaticDistanceTreeLength, (MethodInfo * method));
