...
namespace app::methods::Moon_InteractionGraph::StateMachine {
...
IL2CPP_REGISTER_METHOD(0x002FB930, IState_1 *, get_CurrentState, (app::StateMachine_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_CurrentState, (app::StateMachine_1 * this_ptr, app::IState_1 * value));
IL2CPP_REGISTER_METHOD(0x002FB950, IState_1 *, get_PreviousState, (app::StateMachine_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB960, void, set_PreviousState, (app::StateMachine_1 * this_ptr, app::IState_1 * value));
IL2CPP_REGISTER_METHOD(0x002FB9F0, List_1_Moon_InteractionGraph_IState_ *, get_States, (app::StateMachine_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x019925B0, StateConfigurator *, Configure, (app::StateMachine_1 * this_ptr, app::IState_1 * state));
IL2CPP_REGISTER_METHOD(0x01992700, TransitionManager *, FindTransitionManager, (app::StateMachine_1 * this_ptr, app::Type * trigger));
...
IL2CPP_REGISTER_METHOD(0x019932A0, IState_1 *, IndexToState, (app::StateMachine_1 * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x01993350, void, __ctor, (app::StateMachine_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x015F1C80, Object *, GetCurrentState, (app::StateMachine_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x01550340, void, Trigger_2, (app::StateMachine_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x018EFF10, TransitionManager *, GetTransistionManager_1, (app::StateMachine_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x018EFF10, TransitionManager *, GetTransistionManager_2, (app::StateMachine_1 * this_ptr));
