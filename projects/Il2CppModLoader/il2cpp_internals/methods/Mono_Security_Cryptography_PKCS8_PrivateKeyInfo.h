...
namespace app::methods::Mono_Security_Cryptography::PKCS8_PrivateKeyInfo {
...
IL2CPP_REGISTER_METHOD(0x025D3900, Byte__Array *, get_PrivateKey_1, (app::PKCS8_PrivateKeyInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025D3E10, Byte__Array *, RemoveLeadingZero_1, (app::Byte__Array * big_int));
IL2CPP_REGISTER_METHOD(0x025D3F10, Byte__Array *, Normalize_1, (app::Byte__Array * big_int, int32_t length));
IL2CPP_REGISTER_METHOD(0x025D4000, RSA *, DecodeRSA_1, (app::Byte__Array * keypair));
IL2CPP_REGISTER_METHODINFO(0x047473C8, PKCS8_PrivateKeyInfo_DecodeRSA__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025D46B0, DSA *, DecodeDSA_1, (app::Byte__Array * private_key, app::DSAParameters dsa_parameters));
...
IL2CPP_REGISTER_METHOD(0x02A40D30, Byte__Array *, get_PrivateKey_2, (app::PKCS8_PrivateKeyInfo_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A413C0, Byte__Array *, GetBytes, (app::PKCS8_PrivateKeyInfo_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A41BD0, Byte__Array *, RemoveLeadingZero_2, (app::Byte__Array * big_int));
IL2CPP_REGISTER_METHOD(0x02A41CD0, Byte__Array *, Normalize_2, (app::Byte__Array * big_int, int32_t length));
IL2CPP_REGISTER_METHOD(0x02A41DC0, RSA *, DecodeRSA_2, (app::Byte__Array * keypair));
IL2CPP_REGISTER_METHODINFO(0x047807D8, PKCS8_PrivateKeyInfo_1_DecodeRSA__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02A42470, Byte__Array *, Encode_1, (app::RSA * rsa));
IL2CPP_REGISTER_METHOD(0x02A427E0, DSA *, DecodeDSA_2, (app::Byte__Array * private_key, app::DSAParameters dsa_parameters));
IL2CPP_REGISTER_METHODINFO(0x04769708, PKCS8_PrivateKeyInfo_1_DecodeDSA__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02A42A00, Byte__Array *, Encode_2, (app::DSA * dsa));
IL2CPP_REGISTER_METHOD(0x02A42A70, Byte__Array *, Encode_3, (app::AsymmetricAlgorithm * aa));
