...
IL2CPP_REGISTER_METHOD(0x00FCF380, Vector4, GetParams, (UberMotionBlurInterestZone * __this, Camera * cam));
IL2CPP_REGISTER_METHOD(0x00FCF7E0, void, OnEnable, (UberMotionBlurInterestZone * __this));
