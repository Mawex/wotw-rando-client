...
IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::OneShotEmitter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00614BC0, void, __ctor, (app::OneShotEmitter * this_ptr));
}
