...
IL2CPP_REGISTER_METHOD(0x017644B0, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossFight1ClawSwipeBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x01765790, void, OnExit, (app::PetrifiedOwlBossFight1ClawSwipeBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x017659D0, Enum__Array *, GetEntries, (app::PetrifiedOwlBossFight1ClawSwipeBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x01765A70, Enum, Evaluate, (app::PetrifiedOwlBossFight1ClawSwipeBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_ShouldSkip, (app::PetrifiedOwlBossFight1ClawSwipeBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x017657C0, void, __ctor, (app::PetrifiedOwlBossFight1ClawSwipeBehaviour * this_ptr));
}
