...
IL2CPP_REGISTER_METHOD(0x004C65D0, String *, get_EventProviderName, (app::TimelineEventTrigger * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC60, Action_1_TimelineEventTrigger_ *, get_EventStartWithTriggerInfo, (app::TimelineEventTrigger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC80, Action *, get_EventStart, (app::TimelineEventTrigger * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC90, void, set_EventStart, (app::TimelineEventTrigger * this_ptr, app::Action * value));
IL2CPP_REGISTER_METHOD(0x002FBCA0, Action *, get_EventStay, (app::TimelineEventTrigger * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCB0, void, set_EventStay, (app::TimelineEventTrigger * this_ptr, app::Action * value));
IL2CPP_REGISTER_METHOD(0x002FBCC0, Action *, get_EventEnd, (app::TimelineEventTrigger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010F7000, void, __ctor, (app::TimelineEventTrigger * this_ptr));
}
