...
namespace app::methods::BugReporter {
    ...
    IL2CPP_REGISTER_METHOD(0x0080A600, String*, GetBuildId, (app::BugReporter * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00810540, String*, GetLastRecording, (app::BugReporter * this_ptr, bool recording_available));
    ...
    IL2CPP_REGISTER_METHOD(0x008113F0, IEnumerator*, RecordScreenshot, (app::BugReporter * this_ptr, app::String* path));
    IL2CPP_REGISTER_METHOD(0x00811540, List_1_System_String_*, GetIncludedScreenshots, (app::BugReporter * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00811FF0, List_1_BugReporter_Attachment_*, GetRecordings, (app::BugReporter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00812330, List_1_System_String_*, GetIncludedRecordings, (app::BugReporter * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00720040, String*, GetRecordingDirectory, (app::BugReporter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00813F90, String*, GetFFmpegDirectory, (app::BugReporter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00813FA0, String*, GetOBSCommandDirectory, (app::BugReporter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00813FB0, void, __ctor, (app::BugReporter * this_ptr));
