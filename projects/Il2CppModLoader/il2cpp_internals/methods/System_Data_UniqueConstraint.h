...
IL2CPP_REGISTER_METHOD(0x022C0090, String__Array *, get_ColumnNames, (app::UniqueConstraint * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9D0, Index *, get_ConstraintIndex, (app::UniqueConstraint * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F616E0, Constraint_1 *, Clone_1, (app::UniqueConstraint * this_ptr, app::DataSet * destination));
IL2CPP_REGISTER_METHOD(0x022C0A30, Constraint_1 *, Clone_2, (app::UniqueConstraint * this_ptr, app::DataSet * destination, bool ignor_n_sfor_table_lookup));
IL2CPP_REGISTER_METHOD(0x022C1080, UniqueConstraint *, Clone_3, (app::UniqueConstraint * this_ptr, app::DataTable * table));
IL2CPP_REGISTER_METHOD(0x022C1550, DataColumn__Array *, get_Columns, (app::UniqueConstraint * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9B0, DataColumn__Array *, get_ColumnsReference, (app::UniqueConstraint * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, DataKey, get_Key, (app::UniqueConstraint * this_ptr));
IL2CPP_REGISTER_METHOD(0x022C1900, DataTable *, get_Table, (app::UniqueConstraint * this_ptr));
}
