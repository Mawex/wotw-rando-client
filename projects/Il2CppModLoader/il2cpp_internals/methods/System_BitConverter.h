...
IL2CPP_REGISTER_METHOD(0x0229C4B0, Byte__Array *, GetBytes_1, (bool value));
IL2CPP_REGISTER_METHOD(0x0229C560, Byte__Array *, GetBytes_2, (uint16_t value));
IL2CPP_REGISTER_METHOD(0x0229C600, Byte__Array *, GetBytes_3, (int16_t value));
IL2CPP_REGISTER_METHOD(0x0229C6A0, Byte__Array *, GetBytes_4, (int32_t value));
IL2CPP_REGISTER_METHOD(0x0229C740, Byte__Array *, GetBytes_5, (int64_t value));
IL2CPP_REGISTER_METHOD(0x0229C7E0, Byte__Array *, GetBytes_6, (uint16_t value));
IL2CPP_REGISTER_METHOD(0x0229C880, Byte__Array *, GetBytes_7, (uint32_t value));
IL2CPP_REGISTER_METHOD(0x0229C920, Byte__Array *, GetBytes_8, (uint64_t value));
IL2CPP_REGISTER_METHOD(0x0229C9C0, Byte__Array *, GetBytes_9, (float value));
IL2CPP_REGISTER_METHOD(0x0229CA60, Byte__Array *, GetBytes_10, (double value));
...
IL2CPP_REGISTER_METHOD(0x0229D3B0, String *, ToString_1, (app::Byte__Array * value, int32_t start_index, int32_t length));
IL2CPP_REGISTER_METHODINFO(0x04789CF0, BitConverter_ToString__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0229D790, String *, ToString_2, (app::Byte__Array * value));
