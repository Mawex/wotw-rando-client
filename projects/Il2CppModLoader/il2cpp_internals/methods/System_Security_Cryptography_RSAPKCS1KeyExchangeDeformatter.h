...
namespace app::methods::System_Security_Cryptography::RSAPKCS1KeyExchangeDeformatter {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_1, (app::RSAPKCS1KeyExchangeDeformatter * this_ptr));
IL2CPP_REGISTER_METHOD(0x028EC0A0, void, __ctor_2, (app::RSAPKCS1KeyExchangeDeformatter * this_ptr, app::AsymmetricAlgorithm * key));
IL2CPP_REGISTER_METHODINFO(0x0472FF10, RSAPKCS1KeyExchangeDeformatter__ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FB950, RandomNumberGenerator *, get_RNG, (app::RSAPKCS1KeyExchangeDeformatter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, String *, get_Parameters, (app::RSAPKCS1KeyExchangeDeformatter * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, set_Parameters, (app::RSAPKCS1KeyExchangeDeformatter * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x028EC1B0, Byte__Array *, DecryptKeyExchange, (app::RSAPKCS1KeyExchangeDeformatter * this_ptr, app::Byte__Array * rgb_in));
