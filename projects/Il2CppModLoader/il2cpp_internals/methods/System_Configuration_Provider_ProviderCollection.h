...
namespace app::methods::System_Configuration_Provider::ProviderCollection {
...
IL2CPP_REGISTER_METHOD(0x031BC080, Object *, get_SyncRoot, (app::ProviderCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031BC0E0, IEnumerator *, GetEnumerator, (app::ProviderCollection * this_ptr));
