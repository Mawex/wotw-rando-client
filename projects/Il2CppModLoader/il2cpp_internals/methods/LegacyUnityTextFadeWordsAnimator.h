...
IL2CPP_REGISTER_METHOD(0x01130B00, String *, ColorToHex, (app::LegacyUnityTextFadeWordsAnimator * this_ptr, app::Color32 color));
...
IL2CPP_REGISTER_METHOD(0x011315A0, void, __ctor, (app::LegacyUnityTextFadeWordsAnimator * this_ptr));
}
