...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::Comparison_1_System_Diagnostics_Tracing_EventProvider_SessionInfo_ * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02C7DF30, IAsyncResult *, BeginInvoke, (app::Comparison_1_System_Diagnostics_Tracing_EventProvider_SessionInfo_ * this_ptr, app::EventProvider_SessionInfo x, app::EventProvider_SessionInfo y, app::AsyncCallback * callback, app::Object * object));
