...
IL2CPP_REGISTER_METHOD(0x00C82460, Vector2, get_WorldSpeed, (app::EnemyPlatformMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C82570, void, set_WorldSpeed, (app::EnemyPlatformMovement * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x00C826A0, Vector2, get_LocalSpeed, (app::EnemyPlatformMovement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0095E530, void, __ctor, (app::EnemyPlatformMovement * this_ptr));
}
