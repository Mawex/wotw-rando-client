...
namespace app::methods::System_Collections_Generic::Queue_1_Moon_IDrivable_ {
IL2CPP_REGISTER_METHOD(0x02CA77B0, IDrivable *, Dequeue, (app::Queue_1_Moon_IDrivable_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0243CB70, void, __ctor, (app::Queue_1_Moon_IDrivable_ * this_ptr));
