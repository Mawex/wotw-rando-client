...
IL2CPP_REGISTER_METHOD(0x00420EE0, IUberState__Array *, get_AffectingUberStates, (app::FallingRockSetup * this_ptr));
IL2CPP_REGISTER_METHOD(0x009973A0, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::FallingRockSetup * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00997620, Bounds, get_Bounds, (app::FallingRockSetup * this_ptr));
IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, get_AllowCacheBounds, (app::FallingRockSetup * this_ptr));
IL2CPP_REGISTER_METHOD(0x00997640, Bounds, EncapsulateChildren, (app::FallingRockSetup * this_ptr, app::Transform * trans, app::Bounds * current, app::bool * has_bounds));
IL2CPP_REGISTER_METHOD(0x009977D0, Bounds, WorldSpaceHierarchyBoundingBox, (app::FallingRockSetup * this_ptr, app::GameObject * game_object));
IL2CPP_REGISTER_METHOD(0x00997A70, void, __ctor, (app::FallingRockSetup * this_ptr));
}
