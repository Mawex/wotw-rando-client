...
namespace app::methods::System_Collections_Generic::Dictionary_2_MoonGuid_NearbySceneData_ {
IL2CPP_REGISTER_METHOD(0x02259DF0, void, __ctor, (app::Dictionary_2_MoonGuid_NearbySceneData_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x0283F7F0, Dictionary_2_TKey_TValue_Enumerator_MoonGuid_NearbySceneData_, GetEnumerator, (app::Dictionary_2_MoonGuid_NearbySceneData_ * this_ptr));
