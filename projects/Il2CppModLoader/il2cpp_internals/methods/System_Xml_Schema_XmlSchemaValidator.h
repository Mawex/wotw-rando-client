...
namespace app::methods::System_Xml_Schema::XmlSchemaValidator {
IL2CPP_REGISTER_METHOD(0x0191EF60, void, __ctor, (app::XmlSchemaValidator * this_ptr, app::XmlNameTable * name_table, app::XmlSchemaSet * schemas, app::IXmlNamespaceResolver * namespace_resolver, app::XmlSchemaValidationFlags__Enum validation_flags));
...
IL2CPP_REGISTER_METHOD(0x01920C20, Object *, ValidateAttribute_1, (app::XmlSchemaValidator * this_ptr, app::String * local_name, app::String * namespace_uri, app::XmlValueGetter * attribute_value, app::XmlSchemaInfo * schema_info));
IL2CPP_REGISTER_METHODINFO(0x0470F5B8, XmlSchemaValidator_ValidateAttribute__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01920D20, Object *, ValidateAttribute_2, (app::XmlSchemaValidator * this_ptr, app::String * l_name, app::String * ns, app::XmlValueGetter * attribute_value_getter, app::String * attribute_string_value, app::XmlSchemaInfo * schema_info));
...
IL2CPP_REGISTER_METHOD(0x019221D0, Object *, ValidateEndElement, (app::XmlSchemaValidator * this_ptr, app::XmlSchemaInfo * schema_info));
...
IL2CPP_REGISTER_METHOD(0x002FA280, XmlSchemaSet *, get_SchemaSet, (app::XmlSchemaValidator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00529FF0, XmlSchemaValidationFlags__Enum, get_ValidationFlags, (app::XmlSchemaValidator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01922D70, XmlSchemaContentType__Enum, get_CurrentContentType, (app::XmlSchemaValidator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01922E70, String *, GetConcatenatedValue, (app::XmlSchemaValidator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01922EA0, Object *, InternalValidateEndElement, (app::XmlSchemaValidator * this_ptr, app::XmlSchemaInfo * schema_info, app::Object * typed_value));
...
IL2CPP_REGISTER_METHOD(0x01923A20, Object *, ValidateElementContext, (app::XmlSchemaValidator * this_ptr, app::XmlQualifiedName * element_name, app::bool * invalid_element_in_context));
IL2CPP_REGISTER_METHOD(0x01923F40, XmlSchemaElement *, GetSubstitutionGroupHead, (app::XmlSchemaValidator * this_ptr, app::XmlQualifiedName * member));
IL2CPP_REGISTER_METHOD(0x01924250, Object *, ValidateAtomicValue_1, (app::XmlSchemaValidator * this_ptr, app::String * string_value, app::XmlSchemaSimpleType * * member_type));
IL2CPP_REGISTER_METHOD(0x019245B0, Object *, ValidateAtomicValue_2, (app::XmlSchemaValidator * this_ptr, app::Object * parsed_value, app::XmlSchemaSimpleType * * member_type));
IL2CPP_REGISTER_METHOD(0x01924A30, String *, GetTypeName, (app::XmlSchemaValidator * this_ptr, app::SchemaDeclBase * decl));
...
IL2CPP_REGISTER_METHOD(0x01925000, SchemaElementDecl *, FastGetElementDecl, (app::XmlSchemaValidator * this_ptr, app::XmlQualifiedName * element_name, app::Object * particle));
IL2CPP_REGISTER_METHOD(0x01925290, SchemaElementDecl *, CheckXsiTypeAndNil, (app::XmlSchemaValidator * this_ptr, app::SchemaElementDecl * element_decl, app::String * xsi_type, app::String * xsi_nil, app::bool * decl_found));
...
IL2CPP_REGISTER_METHOD(0x01925F00, SchemaAttDef *, CheckIsXmlAttribute, (app::XmlSchemaValidator * this_ptr, app::XmlQualifiedName * att_q_name));
IL2CPP_REGISTER_METHOD(0x01926060, void, AddXmlNamespaceSchema, (app::XmlSchemaValidator * this_ptr));
IL2CPP_REGISTER_METHOD(0x019261F0, Object *, CheckMixedValueConstraint, (app::XmlSchemaValidator * this_ptr, app::String * element_value));
...
IL2CPP_REGISTER_METHOD(0x01926D30, Object *, CheckAttributeValue, (app::XmlSchemaValidator * this_ptr, app::Object * value, app::SchemaAttDef * attdef));
IL2CPP_REGISTER_METHOD(0x01927110, Object *, CheckElementValue, (app::XmlSchemaValidator * this_ptr, app::String * string_value));
...
IL2CPP_REGISTER_METHOD(0x01927690, Object *, FindId, (app::XmlSchemaValidator * this_ptr, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x01927E80, XmlSchemaElement *, GetSchemaElement, (app::XmlSchemaValidator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01927FE0, String *, GetDefaultAttributePrefix, (app::XmlSchemaValidator * this_ptr, app::String * attribute_n_s));
...
IL2CPP_REGISTER_METHOD(0x0192BCB0, String *, PrintExpectedElements, (app::ArrayList * expected, bool get_particles));
IL2CPP_REGISTER_METHOD(0x0192C280, String *, PrintNames, (app::ArrayList * expected));
...
IL2CPP_REGISTER_METHOD(0x0192CFC0, String *, QNameString, (app::String * local_name, app::String * ns));
IL2CPP_REGISTER_METHOD(0x0192D080, String *, BuildElementName_1, (app::XmlQualifiedName * qname));
IL2CPP_REGISTER_METHOD(0x0192D140, String *, BuildElementName_2, (app::String * local_name, app::String * ns));
