...
namespace app::methods::HitFlash3D {
    IL2CPP_REGISTER_METHOD(0x002FB9F0, List_1_HitFlash3D_Flash_*, get_Entries, (app::HitFlash3D * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00B56AD0, void, __ctor, (app::HitFlash3D * this_ptr));
} // namespace app::methods::HitFlash3D
