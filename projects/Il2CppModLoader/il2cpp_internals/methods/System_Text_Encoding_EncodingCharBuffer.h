...
namespace app::methods::System_Text::Encoding_EncodingCharBuffer {
IL2CPP_REGISTER_METHOD(0x02454ED0, void, __ctor, (app::Encoding_EncodingCharBuffer * this_ptr, app::Encoding * enc, app::DecoderNLS * decoder, app::uint16_t * char_start, int32_t char_count, app::uint8_t * byte_start, int32_t byte_count));
