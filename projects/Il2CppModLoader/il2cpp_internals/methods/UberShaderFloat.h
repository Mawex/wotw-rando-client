...
namespace app::methods::UberShaderFloat {
    ...
    IL2CPP_REGISTER_METHOD(0x01912620, void, __ctor_1, (app::UberShaderFloat * this_ptr, float val, app::String * default_value));
    IL2CPP_REGISTER_METHOD(0x019126C0, void, __ctor_2, (app::UberShaderFloat * this_ptr));
