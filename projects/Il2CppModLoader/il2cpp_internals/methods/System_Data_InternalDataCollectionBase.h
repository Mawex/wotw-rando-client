...
namespace app::methods::System_Data::InternalDataCollectionBase {
...
IL2CPP_REGISTER_METHOD(0x01E3FB10, IEnumerator *, GetEnumerator, (app::InternalDataCollectionBase * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, Object *, get_SyncRoot, (app::InternalDataCollectionBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, ArrayList *, get_List, (app::InternalDataCollectionBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::InternalDataCollectionBase * this_ptr));
