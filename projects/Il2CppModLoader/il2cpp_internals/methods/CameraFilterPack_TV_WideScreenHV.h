...
IL2CPP_REGISTER_METHOD(0x020F1E00, Material *, get_material, (app::CameraFilterPack_TV_WideScreenHV * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020F1DD0, void, __ctor, (app::CameraFilterPack_TV_WideScreenHV * this_ptr));
}
