...
namespace app::methods::System_Collections_Generic::Dictionary_2_AbilityType_UpgradableAbility_ {
...
IL2CPP_REGISTER_METHOD(0x02EAA0E0, UpgradableAbility *, get_Item, (app::Dictionary_2_AbilityType_UpgradableAbility_ * this_ptr, app::AbilityType__Enum key));
IL2CPP_REGISTER_METHODINFO(0x04715418, Dictionary_2_AbilityType_UpgradableAbility__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_AbilityType_UpgradableAbility_ * this_ptr));
