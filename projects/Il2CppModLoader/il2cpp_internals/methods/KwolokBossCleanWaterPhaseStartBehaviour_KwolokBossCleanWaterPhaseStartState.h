...
IL2CPP_REGISTER_METHOD(0x01251F50, void, __ctor, (app::KwolokBossCleanWaterPhaseStartBehaviour_KwolokBossCleanWaterPhaseStartState * this_ptr, app::KwolokBossCleanWaterPhaseStartBehaviour * behaviour));
