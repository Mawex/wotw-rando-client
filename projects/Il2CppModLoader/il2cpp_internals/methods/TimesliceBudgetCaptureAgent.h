...
IL2CPP_REGISTER_METHOD(0x010F93D0, String__Array *, GetDataHeaderNames, (app::TimesliceBudgetCaptureAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010F9D00, String__Array *, GetFrameData, (app::TimesliceBudgetCaptureAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010FA140, void, __ctor, (app::TimesliceBudgetCaptureAgent * this_ptr));
}
