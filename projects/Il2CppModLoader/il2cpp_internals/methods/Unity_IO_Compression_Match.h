...
namespace app::methods::Unity_IO_Compression::Match {
IL2CPP_REGISTER_METHOD(0x002FC6D0, MatchState__Enum, get_State, (app::Match_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::Match_1 * this_ptr));
}
