...
IL2CPP_REGISTER_METHOD(0x002FB950, IState_2 *, get_CurrentState, (app::StateMachine_2 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB960, void, set_CurrentState, (app::StateMachine_2 * this_ptr, app::IState_2 * value));
IL2CPP_REGISTER_METHOD(0x002FBB00, IState_2 *, get_PreviousState, (app::StateMachine_2 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB10, void, set_PreviousState, (app::StateMachine_2 * this_ptr, app::IState_2 * value));
IL2CPP_REGISTER_METHOD(0x002FBB40, List_1_fsm_IState_ *, get_States, (app::StateMachine_2 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F6FA40, StateConfigurator_1 *, Configure, (app::StateMachine_2 * this_ptr, app::IState_2 * state));
IL2CPP_REGISTER_METHOD(0x00F6FB90, TransitionManager_1 *, FindTransitionManager, (app::StateMachine_2 * this_ptr, app::Type * trigger));
...
IL2CPP_REGISTER_METHOD(0x00F708C0, IState_2 *, IndexToState, (app::StateMachine_2 * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x0157E090, Object *, GetCurrentState_1, (app::StateMachine_2 * this_ptr));
IL2CPP_REGISTER_METHOD(0x015E7910, void, Trigger_2, (app::StateMachine_2 * this_ptr));
IL2CPP_REGISTER_METHOD(0x02FF92E0, TransitionManager_1 *, GetTransistionManager_1, (app::StateMachine_2 * this_ptr));
IL2CPP_REGISTER_METHOD(0x02FF92E0, TransitionManager_1 *, GetTransistionManager_2, (app::StateMachine_2 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0157E090, EntityLocomotionTask *, GetCurrentState_2, (app::StateMachine_2 * this_ptr));
