...
namespace app::methods::Unity_IO_Compression::DeflateStream {
IL2CPP_REGISTER_METHOD(0x02B72150, void, __ctor_1, (app::DeflateStream_1 * this_ptr, app::Stream * stream, app::CompressionMode__Enum_2 mode));
IL2CPP_REGISTER_METHOD(0x02B72170, void, __ctor_2, (app::DeflateStream_1 * this_ptr, app::Stream * stream, app::CompressionMode__Enum_2 mode, bool leave_open));
...
IL2CPP_REGISTER_METHOD(0x002FBB00, Stream *, get_BaseStream, (app::DeflateStream_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B73170, IAsyncResult *, BeginRead, (app::DeflateStream_1 * this_ptr, app::Byte__Array * array, int32_t offset, int32_t count, app::AsyncCallback * async_callback, app::Object * async_state));
...
IL2CPP_REGISTER_METHOD(0x02B74310, IAsyncResult *, BeginWrite, (app::DeflateStream_1 * this_ptr, app::Byte__Array * array, int32_t offset, int32_t count, app::AsyncCallback * async_callback, app::Object * async_state));
