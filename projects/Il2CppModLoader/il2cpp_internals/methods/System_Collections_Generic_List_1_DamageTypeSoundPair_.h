...
namespace app::methods::System_Collections_Generic::List_1_DamageTypeSoundPair_ {
IL2CPP_REGISTER_METHOD(0x025EFC50, DamageTypeSoundPair *, get_Item, (app::List_1_DamageTypeSoundPair_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_DamageTypeSoundPair_, GetEnumerator, (app::List_1_DamageTypeSoundPair_ * this_ptr));
