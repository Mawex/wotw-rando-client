...
IL2CPP_REGISTER_METHOD(0x024E6920, Material *, get_material, (app::CameraFilterPack_Distortion_Dream2 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024E71D0, void, __ctor, (app::CameraFilterPack_Distortion_Dream2 * this_ptr));
}
