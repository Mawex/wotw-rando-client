...
IL2CPP_REGISTER_METHOD(0x009567D0, BehaviourStatus__Enum, OnExecuteTask, (app::SpiderBatDeathReaction * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00956900, void, __ctor, (app::SpiderBatDeathReaction * this_ptr));
}
