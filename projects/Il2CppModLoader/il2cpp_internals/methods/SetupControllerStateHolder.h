...
IL2CPP_REGISTER_METHOD(0x01B7AF50, Dictionary_2_System_Int32_SetupStateModifier_ *, get_GuidToUberStateModifier, (app::SetupControllerStateHolder * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B7AFF0, void, BuildModifierDictionary, (app::SetupControllerStateHolder * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B7B240, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::SetupControllerStateHolder * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B7B4A0, int32_t, get_ModifiersCount, (app::SetupControllerStateHolder * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B7B530, SetupStateModifier *, GetModifierAt, (app::SetupControllerStateHolder * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x01B7B5E0, int32_t, GetModifierIndex, (app::SetupControllerStateHolder * this_ptr, int32_t modifier_guid));
IL2CPP_REGISTER_METHOD(0x01B7B6E0, SetupState *, GetStateAt, (app::SetupControllerStateHolder * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x01B7B790, List_1_SetupStateModifierData_ *, GetModifierData, (app::SetupControllerStateHolder * this_ptr, int32_t state_guid));
IL2CPP_REGISTER_METHOD(0x01B7B970, SetupState *, GetStateByGuid, (app::SetupControllerStateHolder * this_ptr, int32_t guid));
...
IL2CPP_REGISTER_METHOD(0x01B7C550, SetupStateModifier *, AddModifier, (app::SetupControllerStateHolder * this_ptr, app::Type * type));
IL2CPP_REGISTER_METHOD(0x01B7C790, int32_t, ProduceNewGuid, (app::SetupControllerStateHolder * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B7C8B0, SetupStateModifier *, GetUberStateModifier, (app::SetupControllerStateHolder * this_ptr, int32_t uber_state_modifier_g_u_i_d));
...
IL2CPP_REGISTER_METHOD(0x01B7CF00, void, __ctor, (app::SetupControllerStateHolder * this_ptr));
}
