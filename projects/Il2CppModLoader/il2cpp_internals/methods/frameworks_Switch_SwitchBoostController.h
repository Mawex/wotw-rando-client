...
IL2CPP_REGISTER_METHOD(0x00F5A010, bool, get_GPUBoostAutoMode, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x00F5A0B0, void, set_GPUBoostAutoMode, (bool value));
IL2CPP_REGISTER_METHOD(0x00F5A160, float, get_GPUAutoBoostDRSThreshold, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x00F5A200, void, set_GPUAutoBoostDRSThreshold, (float value));
IL2CPP_REGISTER_METHOD(0x00F5A2B0, int32_t, get_GPUAutoBoostBadSamplesBeforeEngaging, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x00F5A350, void, set_GPUAutoBoostBadSamplesBeforeEngaging, (int32_t value));
IL2CPP_REGISTER_METHOD(0x00F5A400, int32_t, get_GPUAutoBoostGoodSamplesBeforeDisabling, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x00F5A4A0, void, set_GPUAutoBoostGoodSamplesBeforeDisabling, (int32_t value));
IL2CPP_REGISTER_METHOD(0x00F5A550, int32_t, get_GPUAutoBoostSampleLengthFrames, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x00F5A5F0, void, set_GPUAutoBoostSampleLengthFrames, (int32_t value));
IL2CPP_REGISTER_METHOD(0x00F5A710, bool, get_CPUBoostMode, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x00F5A7B0, void, set_CPUBoostMode, (bool value));
IL2CPP_REGISTER_METHOD(0x00F5A860, SwitchBoostController_HandheldGPUBoostMode__Enum, get_HandheldPerformanceConfiguration, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x00F5AEA0, void, __cctor, (MethodInfo * method));
}
