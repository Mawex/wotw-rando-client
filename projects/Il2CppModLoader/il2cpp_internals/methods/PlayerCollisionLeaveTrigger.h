...
IL2CPP_REGISTER_METHOD(0x0043D9A0, SelectableCategory__Enum, get_Category, (app::PlayerCollisionLeaveTrigger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00611C70, void, __ctor, (app::PlayerCollisionLeaveTrigger * this_ptr));
}
