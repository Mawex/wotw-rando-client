...
IL2CPP_REGISTER_METHOD(0x0064D930, Vector3, get_TargetPosition, (app::AlertBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00615280, void, __ctor, (app::AlertBehaviour * this_ptr));
}
