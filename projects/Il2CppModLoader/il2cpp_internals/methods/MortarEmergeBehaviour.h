...
IL2CPP_REGISTER_METHOD(0x014760E0, BehaviourStatus__Enum, OnExecute, (app::MortarEmergeBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00F15500, void, OnExit, (app::MortarEmergeBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x0060C1C0, void, __ctor, (app::MortarEmergeBehaviour * this_ptr));
