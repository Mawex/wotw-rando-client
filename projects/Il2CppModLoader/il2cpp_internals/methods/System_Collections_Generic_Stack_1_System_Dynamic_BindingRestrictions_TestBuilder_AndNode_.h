...
namespace app::methods::System_Collections_Generic::Stack_1_System_Dynamic_BindingRestrictions_TestBuilder_AndNode_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0243CB70, void, __ctor_1, (app::Stack_1_System_Dynamic_BindingRestrictions_TestBuilder_AndNode_ * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x04754C38, Stack_1_System_Dynamic_BindingRestrictions_TestBuilder_AndNode___ctor__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x02CF6050, void, __ctor_2, (app::Stack_1_System_Dynamic_BindingRestrictions_TestBuilder_AndNode_ * this_ptr, int32_t capacity));
