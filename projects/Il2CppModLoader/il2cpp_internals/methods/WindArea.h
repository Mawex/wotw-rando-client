...
namespace app::methods::WindArea {
    IL2CPP_REGISTER_METHOD(0x002FB9B0, Transform*, get_Transform, (app::WindArea * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00575070, Vector3, get_WindSpeed, (app::WindArea * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x003FF3C0, SuspendableMask__Enum, get_Mask, (app::WindArea * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00575490, void, set_Mask, (app::WindArea * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x00575540, void, __ctor, (app::WindArea * this_ptr));
} // namespace app::methods::WindArea
