...
namespace app::methods::System_Reflection::MemberInfoSerializationHolder {
...
IL2CPP_REGISTER_METHOD(0x0268B900, void, __ctor, (app::MemberInfoSerializationHolder * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
...
IL2CPP_REGISTER_METHOD(0x0268BBE0, Object *, GetRealObject, (app::MemberInfoSerializationHolder * this_ptr, app::StreamingContext context));
