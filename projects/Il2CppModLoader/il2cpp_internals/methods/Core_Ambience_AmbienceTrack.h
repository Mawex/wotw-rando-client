...
IL2CPP_REGISTER_METHOD(0x00CB5CD0, ArtificialSoundHostReference, get_SoundHost, (app::Ambience_AmbienceTrack * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9F0, Event_1 *, get_CurrentEvent, (app::Ambience_AmbienceTrack * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::Ambience_AmbienceTrack * this_ptr));
}
