...
IL2CPP_REGISTER_METHOD(0x002FA280, IComboMove *, get_ComboMove, (app::ComboMoveStressTest * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::ComboMoveStressTest * this_ptr, app::IComboMove * move));
...
IL2CPP_REGISTER_METHOD(0x0052A010, StressTestStatus__Enum, get_StressTestStatus, (app::ComboMoveStressTest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011DE7C0, String *, get_StressTestName, (app::ComboMoveStressTest * this_ptr));
}
