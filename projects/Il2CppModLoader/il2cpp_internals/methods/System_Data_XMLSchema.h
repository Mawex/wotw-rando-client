...
namespace app::methods::System_Data::XMLSchema {
IL2CPP_REGISTER_METHOD(0x023D3700, TypeConverter *, GetConverter, (app::Type * type));
...
IL2CPP_REGISTER_METHOD(0x023D3F30, String *, GenUniqueColumnName, (app::String * proposed_name, app::DataTable * table));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::XMLSchema * this_ptr));
}
