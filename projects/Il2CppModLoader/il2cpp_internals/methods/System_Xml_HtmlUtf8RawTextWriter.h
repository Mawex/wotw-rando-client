...
IL2CPP_REGISTER_METHOD(0x0199CB70, void, WriteHtmlElementTextBlock, (app::HtmlUtf8RawTextWriter * this_ptr, app::uint16_t * p_src, app::uint16_t * p_src_end));
IL2CPP_REGISTER_METHOD(0x0199CB90, void, WriteHtmlAttributeTextBlock, (app::HtmlUtf8RawTextWriter * this_ptr, app::uint16_t * p_src, app::uint16_t * p_src_end));
IL2CPP_REGISTER_METHOD(0x0199CBD0, void, WriteHtmlAttributeText, (app::HtmlUtf8RawTextWriter * this_ptr, app::uint16_t * p_src, app::uint16_t * p_src_end));
IL2CPP_REGISTER_METHOD(0x0199CED0, void, WriteUriAttributeText, (app::HtmlUtf8RawTextWriter * this_ptr, app::uint16_t * p_src, app::uint16_t * p_src_end));
