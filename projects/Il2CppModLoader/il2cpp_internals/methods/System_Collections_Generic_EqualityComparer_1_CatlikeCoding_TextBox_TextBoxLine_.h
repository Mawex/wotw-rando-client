...
namespace app::methods::System_Collections_Generic::EqualityComparer_1_CatlikeCoding_TextBox_TextBoxLine_ {
...
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::EqualityComparer_1_CatlikeCoding_TextBox_TextBoxLine_ * this_ptr));
}
