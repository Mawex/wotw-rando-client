...
IL2CPP_REGISTER_METHOD(0x031400C0, void, Update, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x03140630, void, GetReadyToPlay, (AudioSourceExtension * extension));
IL2CPP_REGISTER_METHOD(0x03140820, void, RegisterBuiltinDefinitions, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x031409D0, Object_1 *, GetAudioListener, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x03140A20, void, __cctor, (MethodInfo * method));
}
