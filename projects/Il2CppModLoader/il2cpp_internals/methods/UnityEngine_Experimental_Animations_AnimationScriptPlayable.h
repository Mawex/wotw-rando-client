...
namespace app::methods::UnityEngine_Experimental_Animations::AnimationScriptPlayable {
    ...
    IL2CPP_REGISTER_METHOD(0x0307C600, app::Playable, operator__1, (app::AnimationScriptPlayable playable));
    IL2CPP_REGISTER_METHOD(0x03086610, app::AnimationScriptPlayable, operator__2, (app::Playable playable));
