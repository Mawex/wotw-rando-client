...
namespace app::methods::Moon_ComboSystem::DashNewComboMove {
IL2CPP_REGISTER_METHOD(0x003FC7F0, ComboMoveState__Enum, get_m_comboMoveState, (app::DashNewComboMove * this_ptr));
IL2CPP_REGISTER_METHOD(0x00617D40, void, set_m_comboMoveState, (app::DashNewComboMove * this_ptr, app::ComboMoveState__Enum value));
IL2CPP_REGISTER_METHOD(0x006FB830, AbilityType__Enum, get_ComboAbilityType, (app::DashNewComboMove * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CC69F0, CharacterState *, get_CharacterState, (app::DashNewComboMove * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CC5850, void, __ctor, (app::DashNewComboMove * this_ptr));
}
