...
namespace app::methods::Moon_BehaviourSystem::EntityTask {
IL2CPP_REGISTER_METHOD(0x002FB9B0, Entity *, get_Entity, (app::EntityTask * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB60, List_1_Moon_BehaviourSystem_EntityTask_ *, get_Children, (app::EntityTask * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, EntityBehaviourDebugData *, get_DebugData, (app::EntityTask * this_ptr));
IL2CPP_REGISTER_METHOD(0x004E57A0, BehaviourStatus__Enum, get_TaskStatus, (app::EntityTask * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CB6570, void, set_TaskStatus, (app::EntityTask * this_ptr, app::BehaviourStatus__Enum value));
IL2CPP_REGISTER_METHOD(0x00CB65C0, Nullable_1_Moon_BehaviourSystem_BehaviourStatus_, get_ForceReturnTaskStatus, (app::EntityTask * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00417920, EntityOwnedInitOrder__Enum, get_InitOrder, (app::EntityTask * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CB6DA0, void, __ctor, (app::EntityTask * this_ptr));
}
