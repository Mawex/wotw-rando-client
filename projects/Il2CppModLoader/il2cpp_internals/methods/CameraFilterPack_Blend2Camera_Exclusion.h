...
IL2CPP_REGISTER_METHOD(0x0274B5D0, Material *, get_material, (app::CameraFilterPack_Blend2Camera_Exclusion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0274C7A0, void, __ctor, (app::CameraFilterPack_Blend2Camera_Exclusion * this_ptr));
}
