...
IL2CPP_REGISTER_METHOD(0x027AA500, void, OnRunCallback, (app::void * thisptr, app::void * pv_param));
IL2CPP_REGISTER_METHODINFO(0x04732808, UserStatsStoredCallback_OnRunCallback__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027AA690, void, OnRunCallResult, (app::void * thisptr, app::void * pv_param, bool b_failed, uint64_t h_steam_a_p_i_call));
IL2CPP_REGISTER_METHODINFO(0x04734FE8, UserStatsStoredCallback_OnRunCallResult__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027AA8F0, int32_t, OnGetCallbackSizeBytes, (app::void * thisptr));
IL2CPP_REGISTER_METHODINFO(0x047134B8, UserStatsStoredCallback_OnGetCallbackSizeBytes__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027AA990, void, __cctor, ());
}
