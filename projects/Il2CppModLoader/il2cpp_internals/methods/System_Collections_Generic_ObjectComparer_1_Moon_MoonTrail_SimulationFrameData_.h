...
namespace app::methods::System_Collections_Generic::ObjectComparer_1_Moon_MoonTrail_SimulationFrameData_ {
...
IL2CPP_REGISTER_METHOD(0x019F8810, void, __ctor, (app::ObjectComparer_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr));
}
