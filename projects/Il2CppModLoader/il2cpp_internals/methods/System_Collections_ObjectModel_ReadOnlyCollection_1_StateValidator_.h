...
namespace app::methods::System_Collections_ObjectModel::ReadOnlyCollection_1_StateValidator_ {
IL2CPP_REGISTER_METHOD(0x02B7DCF0, void, __ctor, (app::ReadOnlyCollection_1_StateValidator_ * this_ptr, app::IList_1_StateValidator_ * list));
IL2CPP_REGISTER_METHOD(0x02B7DD20, int32_t, get_Count, (app::ReadOnlyCollection_1_StateValidator_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02B7EA90, StateValidator, get_Item, (app::ReadOnlyCollection_1_StateValidator_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02B7DF30, IEnumerator_1_StateValidator_ *, GetEnumerator, (app::ReadOnlyCollection_1_StateValidator_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B7EA90, StateValidator, System_Collections_Generic_IList_T__get_Item, (app::ReadOnlyCollection_1_StateValidator_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02EC1F30, IEnumerator *, IEnumerable_GetEnumerator, (app::ReadOnlyCollection_1_StateValidator_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, ICollection_get_IsSynchronized, (app::ReadOnlyCollection_1_StateValidator_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02EC1FC0, Object *, ICollection_get_SyncRoot, (app::ReadOnlyCollection_1_StateValidator_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B7F310, Object *, IList_get_Item, (app::ReadOnlyCollection_1_StateValidator_ * this_ptr, int32_t index));
