...
namespace app::methods::LightCanvas {
    ...
    IL2CPP_REGISTER_METHOD(0x002FB9B0, LightCanvas_BindData*, get_DefaultBindData, (app::LightCanvas * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0043D9A0, SelectableCategory__Enum, get_Category, (app::LightCanvas * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0113FD30, LightCanvas_SubLayerSettings*, get_CanvasSubLayerSettings, (app::LightCanvas * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0113FDB0, Texture2D*, get_LightTexture, (app::LightCanvas * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0113FDB0, Texture2D*, get_LightTextureAsset, (app::LightCanvas * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0113FDF0, LightCanvas_LightCanvasStateData*, get_CurrentStateData, (app::LightCanvas * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0113FE00, LightCanvas_BindData*, get_CurrentBindData, (app::LightCanvas * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0113FF20, Texture2D*, GetLightTextureForState, (app::LightCanvas * this_ptr, int32_t state_guid));
    IL2CPP_REGISTER_METHOD(0x0113FF20, Texture2D*, GetLightTextureAssetForState, (app::LightCanvas * this_ptr, int32_t state_guid));
    ...
    IL2CPP_REGISTER_METHOD(0x01141CE0, Bounds, GetCustomBounds, (app::LightCanvas * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01142220, LightCanvas_LightCanvasStateData*, GetCanvasStateData, (app::LightCanvas * this_ptr, int32_t state_guid));
    ...
    IL2CPP_REGISTER_METHOD(0x011428E0, Vector4, MakeBakedLightingLightColorMask, (app::LightCanvas_SubLayerSettings * sub_layer_settings, app::Vector3 light_canvas_comp, float ubershader_comp_z));
    ...
    IL2CPP_REGISTER_METHOD(0x01143260, void, __ctor, (app::LightCanvas * this_ptr));
