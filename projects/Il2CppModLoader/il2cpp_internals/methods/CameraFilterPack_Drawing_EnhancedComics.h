...
IL2CPP_REGISTER_METHOD(0x024F14D0, Material *, get_material, (app::CameraFilterPack_Drawing_EnhancedComics * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024F1E40, void, __ctor, (app::CameraFilterPack_Drawing_EnhancedComics * this_ptr));
}
