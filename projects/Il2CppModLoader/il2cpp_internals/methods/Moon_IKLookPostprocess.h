...
IL2CPP_REGISTER_METHOD(0x01100CF0, Vector3, HandleLimit, (app::IKLookPostprocess * this_ptr, app::Vector3 pos));
IL2CPP_REGISTER_METHOD(0x01100F30, void, __ctor, (app::IKLookPostprocess * this_ptr));
}
