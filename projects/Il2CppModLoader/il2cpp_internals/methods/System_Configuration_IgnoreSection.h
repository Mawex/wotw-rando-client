...
namespace app::methods::System_Configuration::IgnoreSection {
IL2CPP_REGISTER_METHOD(0x031BBEA0, void, __ctor, (app::IgnoreSection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04783E10, IgnoreSection__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x031BBED0, ConfigurationPropertyCollection *, get_Properties, (app::IgnoreSection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031BBFC0, String *, SerializeSection, (app::IgnoreSection * this_ptr, app::ConfigurationElement * parent_section, app::String * name, app::ConfigurationSaveMode__Enum save_mode));
