...
namespace app::methods::System_Security_Cryptography_X509Certificates::X509ChainElementCollection {
IL2CPP_REGISTER_METHOD(0x021CDC90, void, __ctor, (app::X509ChainElementCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x021CDE10, X509ChainElement *, get_Item, (app::X509ChainElementCollection * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x01BCB830, Object *, get_SyncRoot, (app::X509ChainElementCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x021CDF10, X509ChainElementEnumerator *, GetEnumerator, (app::X509ChainElementCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x021CE060, IEnumerator *, IEnumerable_GetEnumerator, (app::X509ChainElementCollection * this_ptr));
