...
IL2CPP_REGISTER_METHOD(0x01396CD0, StateMachine_2 *, get_StateMachine, (app::PetrifiedOwlBossFinalComboBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x0176CE70, PetrifiedOwlBossBaseBehaviour_PetrifiedOwlBossBaseStatesSet *, get_States, (app::PetrifiedOwlBossFinalComboBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0176DCB0, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossFinalComboBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0176E000, Vector3, RandomOffsetPosition, (app::PetrifiedOwlBossFinalComboBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0176E890, Projectile *, SpawnProjectile, (app::PetrifiedOwlBossFinalComboBehaviour * this_ptr, app::Vector2 shoot_point, app::Vector3 shoot_velocity, float gravity, float damage, app::ProjectileSpawner * spawner));
IL2CPP_REGISTER_METHOD(0x0176EAC0, Enum__Array *, GetEntries, (app::PetrifiedOwlBossFinalComboBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x0176EB60, Enum, Evaluate, (app::PetrifiedOwlBossFinalComboBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_ShouldSkip, (app::PetrifiedOwlBossFinalComboBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x0176EC00, void, __ctor, (app::PetrifiedOwlBossFinalComboBehaviour * this_ptr));
}
