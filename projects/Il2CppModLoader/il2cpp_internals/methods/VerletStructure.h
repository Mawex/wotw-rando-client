...
IL2CPP_REGISTER_METHOD(0x013C9410, Bounds, get_WorldBounds, (app::VerletStructure * this_ptr));
IL2CPP_REGISTER_METHOD(0x013C9600, Bounds, get_Bounds, (app::VerletStructure * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009D2A80, SuspendableMask__Enum, ISuspendable_get_Mask, (app::VerletStructure * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, IUpdateHandler_get_UpdateType, (app::VerletStructure * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x013CE130, VerletStructure_VerletStructureState *, GetSystemState, (app::VerletStructure * this_ptr, int32_t state_g_u_i_d));
...
IL2CPP_REGISTER_METHOD(0x013CE820, void, __ctor, (app::VerletStructure * this_ptr));
