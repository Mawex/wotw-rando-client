...
namespace app::methods::System_Linq_Expressions_Interpreter::LoadLocalFromClosureInstruction {
...
IL2CPP_REGISTER_METHOD(0x023F9D30, String *, get_InstructionName, (app::LoadLocalFromClosureInstruction * this_ptr));
