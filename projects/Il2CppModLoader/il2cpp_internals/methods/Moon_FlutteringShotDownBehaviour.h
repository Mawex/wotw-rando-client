...
IL2CPP_REGISTER_METHOD(0x01482D50, BehaviourStatus__Enum, OnExecute, (app::FlutteringShotDownBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x014833C0, void, __ctor, (app::FlutteringShotDownBehaviour * this_ptr));
}
