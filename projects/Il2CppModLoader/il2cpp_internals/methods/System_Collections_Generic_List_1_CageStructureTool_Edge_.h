...
namespace app::methods::System_Collections_Generic::List_1_CageStructureTool_Edge_ {
IL2CPP_REGISTER_METHOD(0x025EFC50, CageStructureTool_Edge *, get_Item, (app::List_1_CageStructureTool_Edge_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_CageStructureTool_Edge_, GetEnumerator, (app::List_1_CageStructureTool_Edge_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04738320, List_1_CageStructureTool_Edge__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F05A0, CageStructureTool_Edge *, Find, (app::List_1_CageStructureTool_Edge_ * this_ptr, app::Predicate_1_CageStructureTool_Edge_ * match));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_CageStructureTool_Edge_ * this_ptr));
