...
IL2CPP_REGISTER_METHOD(0x02579E50, Vector2, ApplyCircleDeadzone, (app::Vector2 axis, float deadzone_radius));
IL2CPP_REGISTER_METHOD(0x02579FB0, Vector2, ApplyRectangleDeadzone, (app::Vector2 axis, float deadzone_x, float deadzone_y));
IL2CPP_REGISTER_METHOD(0x0257A0F0, Vector3, Abs, (app::Vector3 v));
IL2CPP_REGISTER_METHOD(0x01831B60, Vector3, Divide, (app::Vector3 a, app::Vector3 b));
IL2CPP_REGISTER_METHOD(0x0257A1F0, Vector2, RotateTowards, (app::Vector2 angle_vector, app::Vector2 target_vector, float delta));
...
IL2CPP_REGISTER_METHOD(0x01B14200, Vector3, Perpendicular3, (app::Vector3 v));
IL2CPP_REGISTER_METHOD(0x018307C0, Vector2, Perpendicular, (app::Vector2 v));
IL2CPP_REGISTER_METHOD(0x0257A5C0, Vector3, Lerp2d, (app::Vector3 a, app::Vector3 b, float k));
