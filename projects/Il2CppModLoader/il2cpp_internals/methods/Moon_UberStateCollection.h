...
IL2CPP_REGISTER_METHOD(0x01B68170, IUberState *, GetState, (app::UberID * group_i_d, app::UberID * state_i_d));
...
IL2CPP_REGISTER_METHOD(0x01B68D70, void, __ctor, (app::UberStateCollection * this_ptr));
