...
namespace app::methods::System_Xml::CharEntityEncoderFallback {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::CharEntityEncoderFallback * this_ptr));
IL2CPP_REGISTER_METHOD(0x021E80E0, EncoderFallbackBuffer *, CreateFallbackBuffer, (app::CharEntityEncoderFallback * this_ptr));
