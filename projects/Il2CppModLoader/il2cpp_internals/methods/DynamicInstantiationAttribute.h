...
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_DynamicCount, (app::DynamicInstantiationAttribute * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01834240, void, __ctor, (app::DynamicInstantiationAttribute * this_ptr));
}
