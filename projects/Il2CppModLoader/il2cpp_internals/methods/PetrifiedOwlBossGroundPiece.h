...
IL2CPP_REGISTER_METHOD(0x01772E80, Vector3, GetGroundCenterPosition, (app::PetrifiedOwlBossGroundPiece * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E21060, void, PlayOffLimitsAnticipationFeedback, (app::PetrifiedOwlBossGroundPiece * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::PetrifiedOwlBossGroundPiece * this_ptr));
}
