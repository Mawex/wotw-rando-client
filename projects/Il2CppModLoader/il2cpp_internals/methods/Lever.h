...
namespace app::methods::Lever {
    ...
    IL2CPP_REGISTER_METHOD(0x002FBD00, Transform*, get_Transform, (app::Lever * this_ptr));
    IL2CPP_REGISTER_METHOD(0x003FF8B0, LeverDirections__Enum, get_Direction, (app::Lever * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005065F0, LeverDirections__Enum, get_OriginalDirection, (app::Lever * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00855600, LeverMode__Enum, get_LeverType, (app::Lever * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x011340F0, IUberState__Array*, get_AffectingUberStates, (app::Lever * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01134230, List_1_UnityEngine_GameObject_*, get_AllTargets, (app::Lever * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::Lever * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0074F800, SuspendableMask__Enum, get_Mask, (app::Lever * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01135A30, Bounds, get_Bounds, (app::Lever * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01135B10, IDesiredUberState*, GetRequirementsForTimeline, (app::Lever * this_ptr, app::MoonTimeline* timeline));
    IL2CPP_REGISTER_METHOD(0x01135BB0, void, OnSceneRootPostEnable, (app::Lever * this_ptr, app::SceneRoot* scene_root));
    IL2CPP_REGISTER_METHOD(0x01135BC0, void, __ctor, (app::Lever * this_ptr));
