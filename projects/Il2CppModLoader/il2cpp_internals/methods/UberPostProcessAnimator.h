...
IL2CPP_REGISTER_METHOD(0x002FBC60, CameraSettings *, get_Settings, (app::UberPostProcessAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC70, void, set_Settings, (app::UberPostProcessAnimator * this_ptr, app::CameraSettings * value));
IL2CPP_REGISTER_METHOD(0x00417920, PostProcessInfluencerOrder__Enum, get_PostInfluenceApplyOrder, (app::UberPostProcessAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBE0, CameraSettingsAsset *, get_SettingsAssetForDebug, (app::UberPostProcessAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x018F3DE0, void, __ctor, (app::UberPostProcessAnimator * this_ptr));
}
