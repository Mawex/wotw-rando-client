...
namespace app::methods::System_Collections_Generic::List_1_OverridableFloatProperty_ {
    IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_OverridableFloatProperty_ * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x04726AA0, List_1_OverridableFloatProperty___ctor__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x02FE8360, void, __ctor_2, (app::List_1_OverridableFloatProperty_ * this_ptr, app::IEnumerable_1_OverridableFloatProperty_ * collection));
