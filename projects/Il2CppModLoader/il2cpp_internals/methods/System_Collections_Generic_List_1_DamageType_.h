...
namespace app::methods::System_Collections_Generic::List_1_DamageType_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_DamageType_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04709020, List_1_DamageType___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02D1F360, DamageType__Enum, get_Item, (app::List_1_DamageType_ * this_ptr, int32_t index));
