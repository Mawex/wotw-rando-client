...
IL2CPP_REGISTER_METHOD(0x01107290, BehaviourStatus__Enum, OnExecute, (app::LizardKamikazeAttackBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01107F00, void, __ctor, (app::LizardKamikazeAttackBehaviour * this_ptr));
