...
namespace app::methods::System_Threading_Tasks::Task_1_System_Nullable_1_ {
IL2CPP_REGISTER_METHOD(0x0277FBD0, ConfiguredTaskAwaitable_1_System_Nullable_1_, ConfigureAwait, (app::Task_1_System_Nullable_1_ * this_ptr, bool continue_on_captured_context));
...
IL2CPP_REGISTER_METHOD(0x02A59E60, Task_1_System_Nullable_1_ *, StartNew_1, (app::Task * parent, app::Func_1_Nullable_1_Int32_ * function, app::CancellationToken cancellation_token, app::TaskCreationOptions__Enum creation_options, app::InternalTaskOptions__Enum internal_options, app::TaskScheduler * scheduler, app::StackCrawlMark__Enum * stack_mark));
IL2CPP_REGISTER_METHODINFO(0x04740DE0, Task_1_System_Nullable_1__StartNew__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02A5A170, Task_1_System_Nullable_1_ *, StartNew_2, (app::Task * parent, app::Func_2_Object_Nullable_1_Int32_ * function, app::Object * state, app::CancellationToken cancellation_token, app::TaskCreationOptions__Enum creation_options, app::InternalTaskOptions__Enum internal_options, app::TaskScheduler * scheduler, app::StackCrawlMark__Enum * stack_mark));
IL2CPP_REGISTER_METHODINFO(0x04724BF8, Task_1_System_Nullable_1__StartNew_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02A5A480, String *, get_DebuggerDisplayResultDescription, (app::Task_1_System_Nullable_1_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A5A570, String *, get_DebuggerDisplayMethodDescription, (app::Task_1_System_Nullable_1_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A5A760, Nullable_1_Int32_, get_Result, (app::Task_1_System_Nullable_1_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB40, Nullable_1_Int32_, get_ResultOnSuccess, (app::Task_1_System_Nullable_1_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A5A7B0, Nullable_1_Int32_, GetResultCore, (app::Task_1_System_Nullable_1_ * this_ptr, bool wait_completion_notification));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, TaskAwaiter_1_System_Nullable_1_, GetAwaiter, (app::Task_1_System_Nullable_1_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A5A930, Task *, ContinueWith_1, (app::Task_1_System_Nullable_1_ * this_ptr, app::Action_1_System_Threading_Tasks_Task_1__8 * continuation_action));
IL2CPP_REGISTER_METHOD(0x02A5AA30, Task *, ContinueWith_2, (app::Task_1_System_Nullable_1_ * this_ptr, app::Action_1_System_Threading_Tasks_Task_1__8 * continuation_action, app::TaskScheduler * scheduler, app::CancellationToken cancellation_token, app::TaskContinuationOptions__Enum continuation_options, app::StackCrawlMark__Enum * stack_mark));
