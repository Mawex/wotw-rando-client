...
namespace app::methods::System_Collections_Generic::Dictionary_2_DofAnimator_System_Single_ {
...
IL2CPP_REGISTER_METHOD(0x02BA5400, Dictionary_2_TKey_TValue_Enumerator_DofAnimator_System_Single_, GetEnumerator, (app::Dictionary_2_DofAnimator_System_Single_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0476BA28, Dictionary_2_DofAnimator_System_Single__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_DofAnimator_System_Single_ * this_ptr));
