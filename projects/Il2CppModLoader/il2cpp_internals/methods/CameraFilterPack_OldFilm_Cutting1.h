...
IL2CPP_REGISTER_METHOD(0x024877C0, Material *, get_material, (app::CameraFilterPack_OldFilm_Cutting1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02487F30, void, __ctor, (app::CameraFilterPack_OldFilm_Cutting1 * this_ptr));
}
