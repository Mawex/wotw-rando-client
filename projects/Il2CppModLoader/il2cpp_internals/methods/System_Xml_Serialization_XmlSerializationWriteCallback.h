...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::XmlSerializationWriteCallback * this_ptr, app::Object * object, app::void * method_1));
IL2CPP_REGISTER_METHOD(0x00673B90, void, Invoke, (app::XmlSerializationWriteCallback * this_ptr, app::Object * o));
IL2CPP_REGISTER_METHOD(0x00674080, IAsyncResult *, BeginInvoke, (app::XmlSerializationWriteCallback * this_ptr, app::Object * o, app::AsyncCallback * callback, app::Object * object));
