...
IL2CPP_REGISTER_METHOD(0x0065FBC0, SandWormLocomotion *, get_Locomotion, (app::SandWormSandDigLocomotionBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x0065FBE0, SandWormEntity *, get_WormEntity, (app::SandWormSandDigLocomotionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C25150, BehaviourStatus__Enum, OnExecuteTask, (app::SandWormSandDigLocomotionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00C25E10, Vector3, get_TargetPosition, (app::SandWormSandDigLocomotionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C25E70, SandWormSandDigLocomotionBehaviour_SpeedEntry, GetCurrentSpeedEntry, (app::SandWormSandDigLocomotionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C26170, void, __ctor, (app::SandWormSandDigLocomotionBehaviour * this_ptr));
