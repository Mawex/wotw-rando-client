...
IL2CPP_REGISTER_METHOD(0x02AD8330, Object *, ICollection_get_SyncRoot, (app::BlockingCollection_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AD9B50, Object__Array *, ToArray, (app::BlockingCollection_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AD9E90, IEnumerable_1_System_Object_ *, GetConsumingEnumerable_1, (app::BlockingCollection_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02AD9F60, IEnumerable_1_System_Object_ *, GetConsumingEnumerable_2, (app::BlockingCollection_1_System_Object_ * this_ptr, app::CancellationToken cancellation_token));
IL2CPP_REGISTER_METHOD(0x02ADA0A0, IEnumerator_1_System_Object_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::BlockingCollection_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02ADA130, IEnumerator *, IEnumerable_GetEnumerator, (app::BlockingCollection_1_System_Object_ * this_ptr));
