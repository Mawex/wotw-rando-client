...
IL2CPP_REGISTER_METHOD(0x011BD6A0, Quest *, get_SpiderlingQuest, (app::SpiderInteractionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011BDE80, BehaviourStatus__Enum, OnExecute, (app::SpiderInteractionBehaviour * this_ptr, app::IContext * context));
