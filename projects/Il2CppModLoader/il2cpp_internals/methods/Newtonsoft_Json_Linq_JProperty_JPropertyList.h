...
namespace app::methods::Newtonsoft_Json_Linq::JProperty_JPropertyList {
IL2CPP_REGISTER_METHOD(0x01F0E2D0, IEnumerator_1_Newtonsoft_Json_Linq_JToken_ *, GetEnumerator, (app::JProperty_JPropertyList * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F0E2D0, IEnumerator *, IEnumerable_GetEnumerator, (app::JProperty_JPropertyList * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F0E510, JToken *, get_Item, (app::JProperty_JPropertyList * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x01F0E4F0, void, set_Item, (app::JProperty_JPropertyList * this_ptr, int32_t index, app::JToken * value));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::JProperty_JPropertyList * this_ptr));
}
