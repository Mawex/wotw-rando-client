...
IL2CPP_REGISTER_METHOD(0x002FBBA0, LegacyEntity *, get_CurrentEntity, (app::RespawningPlaceholder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003FF7D0, SuspendableMask__Enum, get_Mask, (app::RespawningPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x0090A480, void, set_Mask, (app::RespawningPlaceholder * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::RespawningPlaceholder * this_ptr));
