...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::HUDManager {
...
IL2CPP_REGISTER_METHOD(0x002FB9D0, Browser *, get_HUDBrowser, (app::HUDManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01DE0BC0, IEnumerator *, Rehide, (app::HUDManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01DE15F0, IEnumerator *, LoadLevel, (app::HUDManager * this_ptr, bool force));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::HUDManager * this_ptr));
