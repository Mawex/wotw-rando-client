...
namespace app::methods::System_Xml_Serialization::XmlArrayItemAttributes {
IL2CPP_REGISTER_METHOD(0x01C9AC80, XmlArrayItemAttribute *, get_Item, (app::XmlArrayItemAttributes * this_ptr, int32_t index));
