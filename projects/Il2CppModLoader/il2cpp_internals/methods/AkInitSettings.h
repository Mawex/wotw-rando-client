...
IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkInitSettings * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x026E84A0, void *, getCPtr, (app::AkInitSettings * obj));
IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkInitSettings * this_ptr, app::void * c_ptr));
...
IL2CPP_REGISTER_METHOD(0x026EA030, AkOutputSettings *, get_settingsMainOutput, (app::AkInitSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x026EAA90, String *, get_szPluginDLLPath, (app::AkInitSettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x026EABE0, void, set_eFloorPlane, (app::AkInitSettings * this_ptr, app::AkFloorPlane__Enum value));
IL2CPP_REGISTER_METHOD(0x026EAD10, AkFloorPlane__Enum, get_eFloorPlane, (app::AkInitSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x026EB2E0, void, __ctor_2, (app::AkInitSettings * this_ptr));
}
