...
IL2CPP_REGISTER_METHOD(0x01486E20, BehaviourStatus__Enum, OnExecute, (app::FlutteringTakeOffBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x014877F0, void, __ctor, (app::FlutteringTakeOffBehaviour * this_ptr));
}
