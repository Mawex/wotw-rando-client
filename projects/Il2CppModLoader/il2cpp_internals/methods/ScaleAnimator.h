...
namespace app::methods::ScaleAnimator {
    ...
    IL2CPP_REGISTER_METHOD(0x00933260, Vector3, get_OriginalScale, (app::ScaleAnimator * this_ptr));
    IL2CPP_REGISTER_METHOD(0x004167A0, bool, get_IsLooping, (app::ScaleAnimator * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00933280, void, __ctor, (app::ScaleAnimator * this_ptr));
} // namespace app::methods::ScaleAnimator
