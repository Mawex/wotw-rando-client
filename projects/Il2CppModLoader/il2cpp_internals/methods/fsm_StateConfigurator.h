...
IL2CPP_REGISTER_METHOD(0x0058DA40, void, __ctor, (StateConfigurator_1 * __this, StateMachine_2 * stateMachine, IState_2 * state));
IL2CPP_REGISTER_METHOD(0x00F6EA20, StateConfigurator_1 *, AddEvent, (StateConfigurator_1 * __this, int32_t eventId, Action * action));
IL2CPP_REGISTER_METHOD(0x02FF9060, StateConfigurator_1 *, AddTransition, (StateConfigurator_1 * __this, IState_2 * to, ICondition * condition, IAction * action, IContext * context));
IL2CPP_REGISTER_METHOD(0x02FF91A0, StateConfigurator_1 *, AddTransition, (StateConfigurator_1 * __this, IState_2 * to, Func_1_Boolean_ * condition, Action * action, IContext * context));
IL2CPP_REGISTER_METHOD(0x02FF91A0, StateConfigurator_1 *, AddTransition, (StateConfigurator_1 * __this, IState_2 * to, Func_1_Boolean_ * condition, Action * action, IContext * context));
