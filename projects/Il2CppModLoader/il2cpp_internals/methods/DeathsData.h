...
namespace app::methods::DeathsData {
    IL2CPP_REGISTER_METHOD(0x00AB4D20, RecorderFrame_FrameDataTypes__Enum, FrameType, (app::DeathsData * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::DeathsData * this_ptr));
} // namespace app::methods::DeathsData
