...
IL2CPP_REGISTER_METHOD(0x01104710, Vector3, get_TargetPostion, (app::LizardGroundChaseBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01105280, BehaviourStatus__Enum, OnExecute, (app::LizardGroundChaseBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01105900, void, __ctor, (app::LizardGroundChaseBehaviour * this_ptr));
}
