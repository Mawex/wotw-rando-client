...
IL2CPP_REGISTER_METHOD(0x011717F0, Vector3, get_Position, (app::PlatformMovementPortalVisitor * this_ptr));
IL2CPP_REGISTER_METHOD(0x011718F0, void, set_Speed, (app::PlatformMovementPortalVisitor * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x011719E0, Vector3, get_Speed, (app::PlatformMovementPortalVisitor * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01171D70, void, __ctor, (app::PlatformMovementPortalVisitor * this_ptr));
}
