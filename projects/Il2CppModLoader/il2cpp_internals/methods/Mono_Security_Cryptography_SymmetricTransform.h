...
namespace app::methods::Mono_Security_Cryptography::SymmetricTransform {
IL2CPP_REGISTER_METHOD(0x025D7EF0, void, __ctor, (app::SymmetricTransform * this_ptr, app::SymmetricAlgorithm * symm_algo, bool encryption, app::Byte__Array * rgb_i_v));
...
IL2CPP_REGISTER_METHOD(0x025D9450, Byte__Array *, FinalEncrypt, (app::SymmetricTransform * this_ptr, app::Byte__Array * input_buffer, int32_t input_offset, int32_t input_count));
IL2CPP_REGISTER_METHODINFO(0x04761BB0, SymmetricTransform_FinalEncrypt__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025D9850, Byte__Array *, FinalDecrypt, (app::SymmetricTransform * this_ptr, app::Byte__Array * input_buffer, int32_t input_offset, int32_t input_count));
IL2CPP_REGISTER_METHOD(0x025D9BE0, Byte__Array *, TransformFinalBlock, (app::SymmetricTransform * this_ptr, app::Byte__Array * input_buffer, int32_t input_offset, int32_t input_count));
