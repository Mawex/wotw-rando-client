...
namespace app::methods::Moon_Wwise::WwiseEventSystem {
...
IL2CPP_REGISTER_METHOD(0x02712FF0, WwiseEventSystem_SoundHandle, AllocateHandle, (app::WwiseEventSystem * this_ptr, app::Event_1 * wise_event, app::ISoundHost * host));
IL2CPP_REGISTER_METHOD(0x027130D0, WwiseEventSystem_SoundHandleProtected *, GetFreeSoundHandle, (app::WwiseEventSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02713300, void, __ctor, (app::WwiseEventSystem * this_ptr));
}
