...
IL2CPP_REGISTER_METHOD(0x005D06C0, CharacterPlatformMovement *, get_PlatformMovement, (app::SeinStandingOnEdge * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D06F0, CharacterLeftRightMovement *, get_LeftRightMovement, (app::SeinStandingOnEdge * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D0720, CharacterSpriteMirror *, get_SpriteMirror, (app::SeinStandingOnEdge * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A7DBC0, bool, StandingOnEdgeRayHit, (app::SeinStandingOnEdge * this_ptr, float offset, app::int32_t * req_id));
IL2CPP_REGISTER_METHOD(0x00A7DF70, void, __ctor, (app::SeinStandingOnEdge * this_ptr));
