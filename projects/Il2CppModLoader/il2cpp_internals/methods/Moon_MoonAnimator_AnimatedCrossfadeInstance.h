...
IL2CPP_REGISTER_METHOD(0x002FB9F0, MoonAnimator_AnimationInstance *, get_MainAnimationInstance, (app::MoonAnimator_AnimatedCrossfadeInstance * this_ptr));
IL2CPP_REGISTER_METHOD(0x005C3FE0, Playable, get_Playable, (app::MoonAnimator_AnimatedCrossfadeInstance * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9D0, MoonAnimator_AnimationInstance *, get_SourceAnimationInstance, (app::MoonAnimator_AnimatedCrossfadeInstance * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, MoonAnimator_AnimationInstance *, get_TargetAnimationInstance, (app::MoonAnimator_AnimatedCrossfadeInstance * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB40, MoonAnimator_AnimationInstance *, get_TransitionAnimationInstance, (app::MoonAnimator_AnimatedCrossfadeInstance * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008E77B0, MoonAnimator_AnimationInstanceType__Enum, get_Type, (app::MoonAnimator_AnimatedCrossfadeInstance * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MoonAnimator_AnimatedCrossfadeInstance * this_ptr));
}
