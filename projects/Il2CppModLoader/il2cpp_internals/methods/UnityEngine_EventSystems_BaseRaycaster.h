...
namespace app::methods::UnityEngine_EventSystems::BaseRaycaster {
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::BaseRaycaster * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F1B680, String *, ToString, (app::BaseRaycaster * this_ptr));
