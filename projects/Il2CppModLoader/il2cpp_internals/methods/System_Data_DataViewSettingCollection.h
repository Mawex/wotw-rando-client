...
namespace app::methods::System_Data::DataViewSettingCollection {
IL2CPP_REGISTER_METHOD(0x01F4BE20, void, __ctor, (app::DataViewSettingCollection * this_ptr, app::DataViewManager * data_view_manager));
IL2CPP_REGISTER_METHODINFO(0x0476E828, DataViewSettingCollection__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01F4BFA0, DataViewSetting *, get_Item, (app::DataViewSettingCollection * this_ptr, app::DataTable * table));
...
IL2CPP_REGISTER_METHOD(0x01F4C540, IEnumerator *, GetEnumerator, (app::DataViewSettingCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_IsSynchronized, (app::DataViewSettingCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x004C50A0, Object *, get_SyncRoot, (app::DataViewSettingCollection * this_ptr));
