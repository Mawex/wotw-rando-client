...
namespace app::methods::UnityEngine_UI::CanvasScaler {
IL2CPP_REGISTER_METHOD(0x01F2C240, void, __ctor, (app::CanvasScaler * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F2AB70, CanvasScaler_ScaleMode__Enum, get_uiScaleMode, (app::CanvasScaler * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F2C360, Vector2, get_referenceResolution, (app::CanvasScaler * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F2C380, void, set_referenceResolution, (app::CanvasScaler * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x01F2C4F0, CanvasScaler_ScreenMatchMode__Enum, get_screenMatchMode, (app::CanvasScaler * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F1C1C0, CanvasScaler_Unit__Enum, get_physicalUnit, (app::CanvasScaler * this_ptr));
