...
IL2CPP_REGISTER_METHOD(0x0273BBA0, Material *, get_material, (app::CameraFilterPack_AAA_Blood_Plus * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0273BB80, void, __ctor, (app::CameraFilterPack_AAA_Blood_Plus * this_ptr));
}
