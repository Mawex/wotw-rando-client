...
namespace app::methods::System_Data::AutoIncrementBigInteger {
IL2CPP_REGISTER_METHOD(0x021492F0, Object *, get_Current, (app::AutoIncrementBigInteger * this_ptr));
IL2CPP_REGISTER_METHOD(0x02149380, void, set_Current, (app::AutoIncrementBigInteger * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02149430, Type *, get_DataType, (app::AutoIncrementBigInteger * this_ptr));
