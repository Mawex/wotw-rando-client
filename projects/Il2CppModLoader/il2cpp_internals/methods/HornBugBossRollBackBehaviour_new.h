...
IL2CPP_REGISTER_METHOD(0x00B68320, Damage *, TweakDamage, (app::HornBugBossRollBackBehaviour_new * this_ptr, app::Damage * dmg, app::DamageDealer * dealer, app::IDamageReciever * reciever));
...
IL2CPP_REGISTER_METHOD(0x00B65470, void, __ctor, (app::HornBugBossRollBackBehaviour_new * this_ptr));
}
