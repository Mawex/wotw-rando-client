...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::IVRCompositor_GetFrameTimeRemaining * this_ptr, app::Object * object, app::void * method_1));
IL2CPP_REGISTER_METHOD(0x028815A0, float, Invoke, (app::IVRCompositor_GetFrameTimeRemaining * this_ptr));
IL2CPP_REGISTER_METHOD(0x00611B10, IAsyncResult *, BeginInvoke, (app::IVRCompositor_GetFrameTimeRemaining * this_ptr, app::AsyncCallback * callback, app::Object * object));
