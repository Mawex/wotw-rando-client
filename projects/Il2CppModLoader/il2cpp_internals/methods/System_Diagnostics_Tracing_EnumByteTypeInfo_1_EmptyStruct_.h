...
namespace app::methods::System_Diagnostics_Tracing::EnumByteTypeInfo_1_EmptyStruct_ {
...
IL2CPP_REGISTER_METHOD(0x00502220, Object *, GetData, (app::EnumByteTypeInfo_1_EmptyStruct_ * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x0298B8E0, void, __ctor, (app::EnumByteTypeInfo_1_EmptyStruct_ * this_ptr));
}
