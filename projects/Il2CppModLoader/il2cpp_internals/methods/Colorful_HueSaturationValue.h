...
IL2CPP_REGISTER_METHOD(0x03047C90, String *, GetShaderName, (HueSaturationValue * __this));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (HueSaturationValue * __this));
}
