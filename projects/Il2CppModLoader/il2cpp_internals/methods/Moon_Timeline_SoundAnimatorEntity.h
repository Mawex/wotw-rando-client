...
namespace app::methods::Moon_Timeline::SoundAnimatorEntity {
IL2CPP_REGISTER_METHOD(0x00D05230, GameObject *, get_ExternalTarget, (app::SoundAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, OnEntityCreated, (app::SoundAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D05250, Transform *, get_EffectiveTransform, (app::SoundAnimatorEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D05750, SoundDescriptor *, GetSoundDescriptor, (app::SoundAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D05830, bool, HasFinished, (app::SoundAnimatorEntity * this_ptr, int32_t event_id));
IL2CPP_REGISTER_METHOD(0x00D058F0, void, __ctor, (app::SoundAnimatorEntity * this_ptr));
