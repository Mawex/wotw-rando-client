...
namespace app::methods::UnityEngine_UI::Mask {
IL2CPP_REGISTER_METHOD(0x008223A0, void, __ctor, (app::Mask_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x0265F370, RectTransform *, get_rectTransform, (app::Mask_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0265F500, Graphic *, get_graphic, (app::Mask_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0265FB80, Material *, GetModifiedMaterial, (app::Mask_1 * this_ptr, app::Material * base_material));
}
