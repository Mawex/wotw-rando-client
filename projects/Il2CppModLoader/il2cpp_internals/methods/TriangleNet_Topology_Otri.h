...
namespace app::methods::TriangleNet_Topology::Otri {
IL2CPP_REGISTER_METHOD(0x00107C00, Triangle *, get_Triangle, (app::Otri__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0010FD20, void, set_Triangle, (app::Otri__Boxed * this_ptr, app::Triangle * value));
IL2CPP_REGISTER_METHOD(0x0021F6B0, String *, ToString, (app::Otri__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0021F8D0, Vertex *, Org, (app::Otri__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0021F8E0, Vertex *, Dest, (app::Otri__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0021F440, Vertex *, Apex, (app::Otri__Boxed * this_ptr));
