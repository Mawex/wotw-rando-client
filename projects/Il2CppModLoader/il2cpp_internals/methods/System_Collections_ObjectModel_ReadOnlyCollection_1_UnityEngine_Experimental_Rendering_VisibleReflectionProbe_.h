...
namespace app::methods::System_Collections_ObjectModel::ReadOnlyCollection_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ {
IL2CPP_REGISTER_METHOD(0x02B7DCF0, void, __ctor, (app::ReadOnlyCollection_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr, app::IList_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * list));
...
IL2CPP_REGISTER_METHOD(0x02ECE8C0, VisibleReflectionProbe, get_Item, (app::ReadOnlyCollection_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02B7DF30, IEnumerator_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ *, GetEnumerator, (app::ReadOnlyCollection_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02ECE8C0, VisibleReflectionProbe, System_Collections_Generic_IList_T__get_Item, (app::ReadOnlyCollection_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02ECEBA0, IEnumerator *, IEnumerable_GetEnumerator, (app::ReadOnlyCollection_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02ECEC30, Object *, ICollection_get_SyncRoot, (app::ReadOnlyCollection_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02ECF220, Object *, IList_get_Item, (app::ReadOnlyCollection_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr, int32_t index));
