...
namespace app::methods::System_Collections_Generic::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02D2AB50, void, __ctor_3, (app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr, app::IEnumerable_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02D2B030, Object *, ICollection_get_SyncRoot, (app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D2B190, VisibleReflectionProbe, get_Item, (app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02D2B450, Object *, IList_get_Item, (app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ *, AsReadOnly, (app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D2C080, VisibleReflectionProbe, Find, (app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr, app::Predicate_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * match));
IL2CPP_REGISTER_METHOD(0x02D2C240, List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ *, FindAll, (app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr, app::Predicate_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * match));
...
IL2CPP_REGISTER_METHOD(0x02D2C8B0, List_1_T_Enumerator_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_, GetEnumerator, (app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D2C910, IEnumerator_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D2C910, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ *, GetRange, (app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, VisibleReflectionProbe__Array *, ToArray, (app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ * this_ptr));
