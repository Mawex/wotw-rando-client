...
namespace app::methods::TriangleNet_Tools::Statistic {
...
IL2CPP_REGISTER_METHOD(0x002FBB40, Int32__Array *, get_AngleHistogram, (app::Statistic * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB60, Int32__Array *, get_MinAngleHistogram, (app::Statistic * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB80, Int32__Array *, get_MaxAngleHistogram, (app::Statistic * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::Statistic * this_ptr));
