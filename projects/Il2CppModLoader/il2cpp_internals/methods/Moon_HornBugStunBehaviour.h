...
IL2CPP_REGISTER_METHOD(0x010FAC40, BehaviourStatus__Enum, OnExecute, (app::HornBugStunBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x010FB2F0, void, __ctor, (app::HornBugStunBehaviour * this_ptr));
