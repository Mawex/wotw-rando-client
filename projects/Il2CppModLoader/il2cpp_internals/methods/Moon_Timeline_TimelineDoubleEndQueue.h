...
namespace app::methods::Moon_Timeline::TimelineDoubleEndQueue {
IL2CPP_REGISTER_METHOD(0x01E84340, int32_t, get_Count, (app::TimelineDoubleEndQueue * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E843E0, Reaction, Dequeue, (app::TimelineDoubleEndQueue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E84EF0, void, __ctor, (app::TimelineDoubleEndQueue * this_ptr));
}
