...
IL2CPP_REGISTER_METHOD(0x002FBC20, Type *, get_ComponentType, (app::TypeConverter_SimplePropertyDescriptor * this_ptr));
IL2CPP_REGISTER_METHOD(0x02945B10, bool, get_IsReadOnly, (app::TypeConverter_SimplePropertyDescriptor * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC40, Type *, get_PropertyType, (app::TypeConverter_SimplePropertyDescriptor * this_ptr));
