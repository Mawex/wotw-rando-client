...
IL2CPP_REGISTER_METHOD(0x019EBC30, bool, PerformCastInternal, (app::CapsulecastCommand cmd, app::RaycastHit * hit, app::int32_t * request_i_d, bool guarantee_immediate_result));
...
IL2CPP_REGISTER_METHOD(0x019EE1D0, void, __ctor, (app::GenericCastManager_1_UnityEngine_CapsulecastCommand_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x019ECD80, bool, PerformMultipleCastsInternal, (app::CapsulecastCommand__Array * cmds, app::RaycastHit__Array * hits, app::Boolean__Array * hit_results, int32_t cmd_count, app::int32_t * request_i_d, bool guarantee_immediate_result));
