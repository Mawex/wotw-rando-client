...
IL2CPP_REGISTER_METHOD(0x007EC140, GhostFrame_FrameDataTypes__Enum, get_FrameType, (app::GhostTimelineEventsPlugin_TimelineEventData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::GhostTimelineEventsPlugin_TimelineEventData * this_ptr));
}
