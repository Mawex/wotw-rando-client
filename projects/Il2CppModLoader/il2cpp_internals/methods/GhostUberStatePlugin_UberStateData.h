...
IL2CPP_REGISTER_METHOD(0x007EC6B0, GhostFrame_FrameDataTypes__Enum, get_FrameType, (app::GhostUberStatePlugin_UberStateData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::GhostUberStatePlugin_UberStateData * this_ptr));
}
