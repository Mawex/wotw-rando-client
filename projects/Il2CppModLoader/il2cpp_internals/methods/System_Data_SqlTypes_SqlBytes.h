...
namespace app::methods::System_Data_SqlTypes::SqlBytes {
IL2CPP_REGISTER_METHOD(0x01E518F0, void, __ctor_1, (app::SqlBytes * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E51910, void, __ctor_2, (app::SqlBytes * this_ptr, app::Byte__Array * buffer));
IL2CPP_REGISTER_METHOD(0x01E51950, void, __ctor_3, (app::SqlBytes * this_ptr, app::SqlBinary value));
IL2CPP_REGISTER_METHOD(0x01E519D0, bool, get_IsNull, (app::SqlBytes * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E519E0, Byte__Array *, get_Buffer, (app::SqlBytes * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E51AE0, Byte__Array *, get_Value, (app::SqlBytes * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, XmlSchema *, IXmlSerializable_GetSchema, (app::SqlBytes * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E52390, XmlQualifiedName *, GetXsdType, (app::XmlSchemaSet * schema_set));
