...
namespace app::methods::Newtonsoft_Json_Utilities::TypeExtensions {
IL2CPP_REGISTER_METHOD(0x019E35B0, MemberTypes__Enum, MemberType, (app::MemberInfo_1 * member_info));
...
IL2CPP_REGISTER_METHOD(0x023AE510, Assembly *, Assembly, (app::Type * type));
