...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::IVROverlay_ShowDashboard * this_ptr, app::Object * object, app::void * method_1));
IL2CPP_REGISTER_METHOD(0x00673B90, void, Invoke, (app::IVROverlay_ShowDashboard * this_ptr, app::String * pch_overlay_to_show));
IL2CPP_REGISTER_METHOD(0x00674080, IAsyncResult *, BeginInvoke, (app::IVROverlay_ShowDashboard * this_ptr, app::String * pch_overlay_to_show, app::AsyncCallback * callback, app::Object * object));
