...
IL2CPP_REGISTER_METHOD(0x00D20AB0, BehaviourStatus__Enum, OnExecute, (app::TurtleShellAttackBehaviorNew * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00D201C0, void, __ctor, (app::TurtleShellAttackBehaviorNew * this_ptr));
}
