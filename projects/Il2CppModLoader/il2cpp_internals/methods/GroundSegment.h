...
namespace app::methods::GroundSegment {
    IL2CPP_REGISTER_METHOD(0x010983C0, Vector3, ClampPosition, (app::GroundSegment * this_ptr, app::Vector3 position));
    ...
    IL2CPP_REGISTER_METHOD(0x01099050, void, __ctor, (app::GroundSegment * this_ptr));
} // namespace app::methods::GroundSegment
