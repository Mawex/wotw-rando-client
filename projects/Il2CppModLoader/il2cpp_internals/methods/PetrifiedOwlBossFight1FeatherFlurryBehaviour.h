...
IL2CPP_REGISTER_METHOD(0x0065FBA0, StateMachine_2 *, get_StateMachine, (app::PetrifiedOwlBossFight1FeatherFlurryBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x0065FBC0, PetrifiedOwlBossBaseBehaviour_PetrifiedOwlBossBaseStatesSet *, get_States, (app::PetrifiedOwlBossFight1FeatherFlurryBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01767920, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossFight1FeatherFlurryBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01768080, void, __ctor, (app::PetrifiedOwlBossFight1FeatherFlurryBehaviour * this_ptr));
}
