...
namespace app::methods::Moon_UberStateVisualization::SerializedBoolUberStateWrapper {
IL2CPP_REGISTER_METHOD(0x01999FC0, void, __ctor, (app::SerializedBoolUberStateWrapper * this_ptr, app::ISerializedUberState * state));
