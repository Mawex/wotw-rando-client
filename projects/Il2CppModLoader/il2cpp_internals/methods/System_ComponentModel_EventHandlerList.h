...
namespace app::methods::System_ComponentModel::EventHandlerList {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_1, (app::EventHandlerList * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, __ctor_2, (app::EventHandlerList * this_ptr, app::Component * parent));
IL2CPP_REGISTER_METHOD(0x01FEC3F0, Delegate *, get_Item, (app::EventHandlerList * this_ptr, app::Object * key));
...
IL2CPP_REGISTER_METHOD(0x01FEC9D0, EventHandlerList_ListEntry *, Find, (app::EventHandlerList * this_ptr, app::Object * key));
