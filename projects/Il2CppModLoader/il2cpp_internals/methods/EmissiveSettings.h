...
IL2CPP_REGISTER_METHOD(0x00BFBB50, EmissiveSettings *, Clone, (app::EmissiveSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00BFBD20, void, __ctor, (app::EmissiveSettings * this_ptr));
}
