...
namespace app::methods::MoonMath_Line {
    IL2CPP_REGISTER_METHOD(0x02575B10, Vector3, ClosestPointOnLineSegmentToPoint2D, (app::Vector3 p1, app::Vector3 p2, app::Vector3 p));
    IL2CPP_REGISTER_METHOD(0x02575ED0, Vector3, ClosestPointOnLineSegmentToPoint3D, (app::Vector3 point1, app::Vector3 point2, app::Vector3 point));
