...
IL2CPP_REGISTER_METHOD(0x00578DE0, WindSegment *, FindPrevious, (app::WindShaftController * this_ptr, app::WindSegment * wind_segment));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::WindShaftController * this_ptr));
}
