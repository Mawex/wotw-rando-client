...
namespace app::methods::UberShader_optimizations_gc::MemoryManagerDebugger {
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MemoryManagerDebugger * this_ptr));
