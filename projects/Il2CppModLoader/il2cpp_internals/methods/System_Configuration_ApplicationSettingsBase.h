...
namespace app::methods::System_Configuration::ApplicationSettingsBase {
IL2CPP_REGISTER_METHOD(0x02961000, void, __ctor_1, (app::ApplicationSettingsBase * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047656A0, ApplicationSettingsBase__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02961030, void, __ctor_2, (app::ApplicationSettingsBase * this_ptr, app::IComponent * owner));
IL2CPP_REGISTER_METHODINFO(0x0476D330, ApplicationSettingsBase__ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02961060, void, __ctor_3, (app::ApplicationSettingsBase * this_ptr, app::IComponent * owner, app::String * settings_key));
IL2CPP_REGISTER_METHODINFO(0x047234A0, ApplicationSettingsBase__ctor_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02961090, void, __ctor_4, (app::ApplicationSettingsBase * this_ptr, app::String * settings_key));
IL2CPP_REGISTER_METHODINFO(0x04702548, ApplicationSettingsBase__ctor_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x029610C0, SettingsContext *, get_Context, (app::ApplicationSettingsBase * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0478BE70, ApplicationSettingsBase_get_Context__MethodInfo);
IL2CPP_REGISTER_METHOD(0x029610F0, Object *, get_Item, (app::ApplicationSettingsBase * this_ptr, app::String * property_name));
...
IL2CPP_REGISTER_METHOD(0x02961150, SettingsPropertyCollection *, get_Properties, (app::ApplicationSettingsBase * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04741D40, ApplicationSettingsBase_get_Properties__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02961180, SettingsPropertyValueCollection *, get_PropertyValues, (app::ApplicationSettingsBase * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04719F90, ApplicationSettingsBase_get_PropertyValues__MethodInfo);
IL2CPP_REGISTER_METHOD(0x029611B0, SettingsProviderCollection *, get_Providers, (app::ApplicationSettingsBase * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04743318, ApplicationSettingsBase_get_Providers__MethodInfo);
IL2CPP_REGISTER_METHOD(0x029611E0, String *, get_SettingsKey, (app::ApplicationSettingsBase * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x029613C0, Object *, GetPreviousVersion, (app::ApplicationSettingsBase * this_ptr, app::String * property_name));
