...
IL2CPP_REGISTER_METHOD(0x0104FBE0, GameObject *, SpawnCharacter, (app::CharacterFactory * this_ptr, app::CharacterFactory_Characters__Enum character, app::GameObject * prefab, app::Vector3 position, app::Action * after_load, bool asign_to_current));
...
IL2CPP_REGISTER_METHOD(0x01050810, GameObject *, GetCharacterPrefab, (app::CharacterFactory * this_ptr, app::CharacterFactory_Characters__Enum character));
