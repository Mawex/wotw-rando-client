...
IL2CPP_REGISTER_METHOD(0x02757AD0, Material *, get_material, (app::CameraFilterPack_Blend2Camera_Multiply * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02758CA0, void, __ctor, (app::CameraFilterPack_Blend2Camera_Multiply * this_ptr));
}
