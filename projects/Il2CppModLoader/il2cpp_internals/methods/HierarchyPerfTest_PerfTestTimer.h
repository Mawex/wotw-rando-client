...
IL2CPP_REGISTER_METHOD(0x002FA280, PerfTestTimer_TestData *, GetTestTimingData, (app::PerfTestTimer * this_ptr));
IL2CPP_REGISTER_METHOD(0x01974380, void, __ctor, (app::PerfTestTimer * this_ptr, app::String * name, int32_t num_iterations_to_do, bool take_g_c_unload_timings));
