...
IL2CPP_REGISTER_METHOD(0x00420EE0, BehaviourStatus__Enum, OnExecuteTask, (app::SkeetoSpawnTask * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x006B38D0, void, __ctor, (app::SkeetoSpawnTask * this_ptr));
}
