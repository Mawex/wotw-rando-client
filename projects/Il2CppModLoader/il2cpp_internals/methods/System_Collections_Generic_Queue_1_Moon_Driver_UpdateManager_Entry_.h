...
namespace app::methods::System_Collections_Generic::Queue_1_Moon_Driver_UpdateManager_Entry_ {
IL2CPP_REGISTER_METHOD(0x02CA7080, void, __ctor, (app::Queue_1_Moon_Driver_UpdateManager_Entry_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x02CA77B0, UpdateManager_Entry *, Dequeue, (app::Queue_1_Moon_Driver_UpdateManager_Entry_ * this_ptr));
