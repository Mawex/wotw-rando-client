...
namespace app::methods::System_Runtime_Serialization::FormatterConverter {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::FormatterConverter * this_ptr));
IL2CPP_REGISTER_METHOD(0x01D88010, Object *, Convert, (app::FormatterConverter * this_ptr, app::Object * value, app::Type * type));
...
IL2CPP_REGISTER_METHOD(0x01D88560, String *, ToString, (app::FormatterConverter * this_ptr, app::Object * value));
