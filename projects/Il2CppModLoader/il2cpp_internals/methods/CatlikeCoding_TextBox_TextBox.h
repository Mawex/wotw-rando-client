...
namespace app::methods::CatlikeCoding_TextBox::TextBox {
IL2CPP_REGISTER_METHOD(0x01032580, int32_t, get_LineCount, (app::TextBox * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9D0, String *, get_DefaultText, (app::TextBox * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01032AC0, CharMetaData, GetCharacterMetaData, (app::TextBox * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x01032B30, void, ResetTextRenderers, (app::TextBox * this_ptr));
IL2CPP_REGISTER_METHOD(0x01032B40, TextBoxLine, GetLineInfo, (app::TextBox * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x010330B0, TextRenderer *, GetTextRenderer, (app::TextBox * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x01033C60, Vector2, ComputeAnchorAndBounds, (app::TextBox * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01035290, LineDescent, FindLineDataForLastWord, (app::TextBox * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010362A0, Rect, GetRealTextBoxLocalRect, (app::TextBox * this_ptr));
IL2CPP_REGISTER_METHOD(0x01036490, void, __ctor, (app::TextBox * this_ptr));
