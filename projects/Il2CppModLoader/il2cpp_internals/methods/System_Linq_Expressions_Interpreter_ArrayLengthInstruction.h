...
namespace app::methods::System_Linq_Expressions_Interpreter::ArrayLengthInstruction {
...
IL2CPP_REGISTER_METHOD(0x022D56E0, String *, get_InstructionName, (app::ArrayLengthInstruction * this_ptr));
