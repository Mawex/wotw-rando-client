...
IL2CPP_REGISTER_METHOD(0x00B1EA60, Vector3, get_EndPosition, (app::CameraStraightLineMotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::CameraStraightLineMotion * this_ptr));
}
