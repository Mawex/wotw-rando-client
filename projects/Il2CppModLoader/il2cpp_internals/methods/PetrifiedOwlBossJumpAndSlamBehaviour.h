...
IL2CPP_REGISTER_METHOD(0x00660430, StateMachine_2 *, get_StateMachine, (app::PetrifiedOwlBossJumpAndSlamBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x005B0220, PetrifiedOwlBossBaseBehaviour_PetrifiedOwlBossBaseStatesSet *, get_States, (app::PetrifiedOwlBossJumpAndSlamBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01766290, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossJumpAndSlamBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x01766390, void, OnExit, (app::PetrifiedOwlBossJumpAndSlamBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x01774A20, void, __ctor, (app::PetrifiedOwlBossJumpAndSlamBehaviour * this_ptr));
}
