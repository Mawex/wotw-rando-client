...
IL2CPP_REGISTER_METHOD(0x01C58F30, String *, GetLeaderboardEventName, (app::LeaderboardB__Enum leaderboard));
IL2CPP_REGISTER_METHODINFO(0x0476BD48, XboxOneLeaderboards_GetLeaderboardEventName__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::XboxOneLeaderboards * this_ptr));
}
