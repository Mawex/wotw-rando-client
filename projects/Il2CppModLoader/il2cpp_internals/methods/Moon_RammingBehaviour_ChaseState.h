...
IL2CPP_REGISTER_METHOD(0x00C503D0, String *, get_StateName, (app::RammingBehaviour_ChaseState * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C50450, void, __ctor, (app::RammingBehaviour_ChaseState * this_ptr, app::RammingBehaviour * behaviour));
