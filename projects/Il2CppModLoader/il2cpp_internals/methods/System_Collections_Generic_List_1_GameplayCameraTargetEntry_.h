...
namespace app::methods::System_Collections_Generic::List_1_GameplayCameraTargetEntry_ {
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_GameplayCameraTargetEntry_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04724F38, List_1_GameplayCameraTargetEntry___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_GameplayCameraTargetEntry_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02DFE0B0, void, __ctor_3, (app::List_1_GameplayCameraTargetEntry_ * this_ptr, app::IEnumerable_1_GameplayCameraTargetEntry_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02DFE540, Object *, ICollection_get_SyncRoot, (app::List_1_GameplayCameraTargetEntry_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025EC760, GameplayCameraTargetEntry, get_Item, (app::List_1_GameplayCameraTargetEntry_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025EC910, Object *, IList_get_Item, (app::List_1_GameplayCameraTargetEntry_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_GameplayCameraTargetEntry_ *, AsReadOnly, (app::List_1_GameplayCameraTargetEntry_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025ED1F0, GameplayCameraTargetEntry, Find, (app::List_1_GameplayCameraTargetEntry_ * this_ptr, app::Predicate_1_GameplayCameraTargetEntry_ * match));
IL2CPP_REGISTER_METHOD(0x025ED330, List_1_GameplayCameraTargetEntry_ *, FindAll, (app::List_1_GameplayCameraTargetEntry_ * this_ptr, app::Predicate_1_GameplayCameraTargetEntry_ * match));
...
IL2CPP_REGISTER_METHOD(0x025ED850, List_1_T_Enumerator_GameplayCameraTargetEntry_, GetEnumerator, (app::List_1_GameplayCameraTargetEntry_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025ED8A0, IEnumerator_1_GameplayCameraTargetEntry_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_GameplayCameraTargetEntry_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025ED8A0, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_GameplayCameraTargetEntry_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_GameplayCameraTargetEntry_ *, GetRange, (app::List_1_GameplayCameraTargetEntry_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, GameplayCameraTargetEntry__Array *, ToArray, (app::List_1_GameplayCameraTargetEntry_ * this_ptr));
