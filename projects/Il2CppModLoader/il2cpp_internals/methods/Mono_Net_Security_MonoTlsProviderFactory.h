...
namespace app::methods::Mono_Net_Security::MonoTlsProviderFactory {
...
IL2CPP_REGISTER_METHOD(0x02183B20, MonoTlsProvider *, LookupProvider, (app::String * name, bool throw_on_error));
