...
namespace app::methods::System_Net::CookieCollection {
IL2CPP_REGISTER_METHOD(0x01EA0EE0, void, __ctor_1, (app::CookieCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x01EA1070, void, __ctor_2, (app::CookieCollection * this_ptr, bool is_read_only));
IL2CPP_REGISTER_METHOD(0x00F5DF30, bool, get_IsReadOnly, (app::CookieCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x01EA1200, Cookie *, get_Item_1, (app::CookieCollection * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x04727698, CookieCollection_get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EA1320, Cookie *, get_Item_2, (app::CookieCollection * this_ptr, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, Object *, get_SyncRoot, (app::CookieCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01EA1980, DateTime, TimeStamp, (app::CookieCollection * this_ptr, app::CookieCollection_Stamp__Enum how));
...
IL2CPP_REGISTER_METHOD(0x01EA2090, IEnumerator *, GetEnumerator, (app::CookieCollection * this_ptr));
}
