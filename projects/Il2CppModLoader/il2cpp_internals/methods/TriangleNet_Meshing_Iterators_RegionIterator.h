...
namespace app::methods::TriangleNet_Meshing_Iterators::RegionIterator {
    IL2CPP_REGISTER_METHOD(0x02B11180, void, __ctor, (app::RegionIterator * this_ptr, app::Mesh_1 * mesh));
