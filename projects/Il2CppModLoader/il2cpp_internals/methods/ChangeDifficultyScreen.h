...
IL2CPP_REGISTER_METHOD(0x010459A0, String *, DifficultyToText, (app::ChangeDifficultyScreen * this_ptr, app::DifficultyMode__Enum mode));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::ChangeDifficultyScreen * this_ptr));
}
