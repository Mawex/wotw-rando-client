...
IL2CPP_REGISTER_METHOD(0x00AF5B90, GUIStyle *, get_LabelStyle, (app::TimesliceSpikeReporter * this_ptr));
IL2CPP_REGISTER_METHOD(0x00AF5F00, TimesliceSpikeReporter *, get_Instance, ());
...
IL2CPP_REGISTER_METHOD(0x00AF6FA0, void, __ctor, (app::TimesliceSpikeReporter * this_ptr));
IL2CPP_REGISTER_METHOD(0x00AF7100, void, __cctor, ());
}
