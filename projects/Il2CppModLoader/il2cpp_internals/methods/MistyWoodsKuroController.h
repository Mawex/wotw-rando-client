...
IL2CPP_REGISTER_METHOD(0x003FF610, SuspendableMask__Enum, get_Mask, (app::MistyWoodsKuroController * this_ptr));
IL2CPP_REGISTER_METHOD(0x01328E40, void, set_Mask, (app::MistyWoodsKuroController * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x0049C0F0, void, __ctor, (app::MistyWoodsKuroController * this_ptr));
}
