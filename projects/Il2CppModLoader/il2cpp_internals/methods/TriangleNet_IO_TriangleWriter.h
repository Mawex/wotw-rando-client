...
namespace app::methods::TriangleNet_IO::TriangleWriter {
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::TriangleWriter * this_ptr));
IL2CPP_REGISTER_METHOD(0x02629420, void, __cctor, ());
}
