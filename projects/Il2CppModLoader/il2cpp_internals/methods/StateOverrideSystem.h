...
IL2CPP_REGISTER_METHOD(0x00597B10, UpdateType__Enum, get_UpdateType, (app::StateOverrideSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03148470, void, __ctor, (app::StateOverrideSystem * this_ptr));
}
