...
namespace app::methods::UnityEngine_UI::Shadow {
IL2CPP_REGISTER_METHOD(0x02662FD0, void, __ctor, (app::Shadow * this_ptr));
IL2CPP_REGISTER_METHOD(0x024AE370, Color, get_effectColor, (app::Shadow * this_ptr));
IL2CPP_REGISTER_METHOD(0x02674F80, void, set_effectColor, (app::Shadow * this_ptr, app::Color value));
IL2CPP_REGISTER_METHOD(0x02675070, Vector2, get_effectDistance, (app::Shadow * this_ptr));
