...
namespace app::methods::System_Collections_Generic::List_1_T__Enumerator_Quest_ {
IL2CPP_REGISTER_METHOD(0x00107C20, Quest *, get_Current, (app::List_1_T_Enumerator_Quest___Boxed * this_ptr));
