...
IL2CPP_REGISTER_METHOD(0x0199E410, void, __ctor, (app::LocalDataStoreSlot * this_ptr, app::LocalDataStoreMgr * mgr, int32_t slot, int64_t cookie));
IL2CPP_REGISTER_METHOD(0x002FA280, LocalDataStoreMgr *, get_Manager, (app::LocalDataStoreSlot * this_ptr));
