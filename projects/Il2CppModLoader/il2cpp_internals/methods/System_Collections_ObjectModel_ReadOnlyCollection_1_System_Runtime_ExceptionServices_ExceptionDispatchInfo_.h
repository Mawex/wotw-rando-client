...
namespace app::methods::System_Collections_ObjectModel::ReadOnlyCollection_1_System_Runtime_ExceptionServices_ExceptionDispatchInfo_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02B7DCF0, void, __ctor, (app::ReadOnlyCollection_1_System_Runtime_ExceptionServices_ExceptionDispatchInfo_ * this_ptr, app::IList_1_System_Runtime_ExceptionServices_ExceptionDispatchInfo_ * list));
