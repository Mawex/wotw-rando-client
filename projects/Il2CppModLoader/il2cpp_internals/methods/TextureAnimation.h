...
IL2CPP_REGISTER_METHOD(0x010E9160, AtlasSpriteTexture *, GetTextureAtTime, (app::TextureAnimation * this_ptr, float time, app::Atlas * * atlas));
IL2CPP_REGISTER_METHOD(0x010E9170, AtlasSpriteTexture *, GetTextureAtIndex, (app::TextureAnimation * this_ptr, float index, app::Atlas * * found_atlas));
IL2CPP_REGISTER_METHOD(0x010E9390, AtlasSpriteTexture *, GetFrameForId, (app::TextureAnimation * this_ptr, app::MoonGuid * guid, app::Atlas * * found_atlas));
...
IL2CPP_REGISTER_METHOD(0x010E9960, void, __ctor, (app::TextureAnimation * this_ptr));
}
