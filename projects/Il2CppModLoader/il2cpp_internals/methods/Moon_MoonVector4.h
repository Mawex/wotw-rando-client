...
IL2CPP_REGISTER_METHOD(0x02F9B4C0, CrossSceneReferenceId, get_CrossSceneReferenceId, (app::MoonVector4 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F92180, void, __ctor, (app::MoonVector4 * this_ptr, app::Vector4 static_value));
IL2CPP_REGISTER_METHOD(0x02F9B6A0, Vector4, Resolve, (app::MoonVector4 * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x047744B0, MoonVector4_Resolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02F9B8A0, Vector4, SafeResolve, (app::MoonVector4 * this_ptr, app::IMoonResolverContext * context));
...
IL2CPP_REGISTER_METHOD(0x01746A40, MoonTypeData, GetTypeData, (app::MoonVector4 * this_ptr));
}
