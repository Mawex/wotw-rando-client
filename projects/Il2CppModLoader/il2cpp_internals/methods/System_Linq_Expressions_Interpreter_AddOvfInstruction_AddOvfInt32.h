...
namespace app::methods::System_Linq_Expressions_Interpreter::AddOvfInstruction_AddOvfInt32 {
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::AddOvfInstruction_AddOvfInt32 * this_ptr));
}
