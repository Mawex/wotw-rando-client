...
IL2CPP_REGISTER_METHOD(0x00B19610, IEnumerable_1_System_String_ *, GetBaseVertexTextureNames, (app::TurbulenceScaleModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B19790, IEnumerable_1_System_String_ *, GetKeywordsForShader, (app::TurbulenceScaleModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B19BF0, void, __ctor, (app::TurbulenceScaleModifier * this_ptr));
}
