...
IL2CPP_REGISTER_METHOD(0x002FBBC0, CleverMenuItem *, get_CleverMenu, (app::WorldMapOverworldArea * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00583FD0, Vector3, get_ScrollPosition, (app::WorldMapOverworldArea * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::WorldMapOverworldArea * this_ptr));
}
