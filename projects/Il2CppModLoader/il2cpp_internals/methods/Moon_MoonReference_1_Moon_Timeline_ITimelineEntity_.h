...
IL2CPP_REGISTER_METHOD(0x02720AC0, ITimelineEntity *, Resolve, (app::MoonReference_1_Moon_Timeline_ITimelineEntity_ * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x047529F8, MoonReference_1_Moon_Timeline_ITimelineEntity__Resolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027205B0, void, __ctor, (app::MoonReference_1_Moon_Timeline_ITimelineEntity_ * this_ptr, app::ITimelineEntity * reference));
IL2CPP_REGISTER_METHODINFO(0x0474B678, MoonReference_1_Moon_Timeline_ITimelineEntity___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02720E10, ITimelineEntity *, SaveResolverStatic, (app::MoonReference_1_Moon_Timeline_ITimelineEntity_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047462F0, MoonReference_1_Moon_Timeline_ITimelineEntity__SaveResolverStatic__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02720EB0, ITimelineEntity *, SafeResolve, (app::MoonReference_1_Moon_Timeline_ITimelineEntity_ * this_ptr, app::IMoonResolverContext * context));
...
IL2CPP_REGISTER_METHOD(0x02721E50, MoonReference_1_Moon_Timeline_ITimelineEntity_ *, Copy, (app::MoonReference_1_Moon_Timeline_ITimelineEntity_ * this_ptr));
