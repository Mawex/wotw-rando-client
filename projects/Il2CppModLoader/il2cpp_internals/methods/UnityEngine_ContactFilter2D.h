...
IL2CPP_REGISTER_METHOD(0x0024A790, ContactFilter2D, NoFilter, (app::ContactFilter2D__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0316F1C0, ContactFilter2D, CreateLegacyFilter, (int32_t layer_mask, float min_depth, float max_depth));
}
