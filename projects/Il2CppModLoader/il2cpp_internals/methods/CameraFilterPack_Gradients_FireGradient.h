...
IL2CPP_REGISTER_METHOD(0x0247B4C0, Material *, get_material, (app::CameraFilterPack_Gradients_FireGradient * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0247BAE0, void, __ctor, (app::CameraFilterPack_Gradients_FireGradient * this_ptr));
}
