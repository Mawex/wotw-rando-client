...
namespace app::methods::System_Text::InternalEncoderBestFitFallback {
IL2CPP_REGISTER_METHOD(0x02458940, void, __ctor, (app::InternalEncoderBestFitFallback * this_ptr, app::Encoding * encoding));
IL2CPP_REGISTER_METHOD(0x02458950, EncoderFallbackBuffer *, CreateFallbackBuffer, (app::InternalEncoderBestFitFallback * this_ptr));
