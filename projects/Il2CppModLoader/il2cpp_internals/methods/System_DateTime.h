...
IL2CPP_REGISTER_METHOD(0x00213EA0, DateTime, Add_1, (app::DateTime__Boxed * this_ptr, app::TimeSpan value));
IL2CPP_REGISTER_METHOD(0x00213EB0, DateTime, Add_2, (app::DateTime__Boxed * this_ptr, double value, int32_t scale));
IL2CPP_REGISTER_METHODINFO(0x0475C2F8, DateTime_Add_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00213EC0, DateTime, AddDays, (app::DateTime__Boxed * this_ptr, double value));
IL2CPP_REGISTER_METHOD(0x00213ED0, DateTime, AddHours, (app::DateTime__Boxed * this_ptr, double value));
IL2CPP_REGISTER_METHOD(0x00213EE0, DateTime, AddMilliseconds, (app::DateTime__Boxed * this_ptr, double value));
IL2CPP_REGISTER_METHOD(0x00213EF0, DateTime, AddMonths, (app::DateTime__Boxed * this_ptr, int32_t months));
IL2CPP_REGISTER_METHODINFO(0x04711A40, DateTime_AddMonths__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00213F00, DateTime, AddSeconds, (app::DateTime__Boxed * this_ptr, double value));
IL2CPP_REGISTER_METHOD(0x00213EA0, DateTime, AddTicks, (app::DateTime__Boxed * this_ptr, int64_t value));
IL2CPP_REGISTER_METHODINFO(0x04731C80, DateTime_AddTicks__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00213F10, DateTime, AddYears, (app::DateTime__Boxed * this_ptr, int32_t value));
...
IL2CPP_REGISTER_METHOD(0x028A37F0, DateTime, FromBinary, (int64_t date_data));
IL2CPP_REGISTER_METHODINFO(0x04791108, DateTime_FromBinary__MethodInfo);
IL2CPP_REGISTER_METHOD(0x028A3AB0, DateTime, FromBinaryRaw, (int64_t date_data));
IL2CPP_REGISTER_METHODINFO(0x04795CC0, DateTime_FromBinaryRaw__MethodInfo);
IL2CPP_REGISTER_METHOD(0x028A3BA0, DateTime, FromFileTime, (int64_t file_time));
IL2CPP_REGISTER_METHOD(0x028A3C50, DateTime, FromFileTimeUtc, (int64_t file_time));
...
IL2CPP_REGISTER_METHOD(0x028A3D50, DateTime, SpecifyKind, (app::DateTime value, app::DateTimeKind__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x002143A0, DateTime, get_Date, (app::DateTime__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002143F0, DayOfWeek__Enum, get_DayOfWeek, (app::DateTime__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00214490, DateTimeKind__Enum, get_Kind, (app::DateTime__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00214510, TimeSpan, get_TimeOfDay, (app::DateTime__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x028A4360, DateTime, Parse_1, (app::String * s, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHOD(0x028A4440, DateTime, Parse_2, (app::String * s, app::IFormatProvider * provider, app::DateTimeStyles__Enum styles));
IL2CPP_REGISTER_METHOD(0x028A4540, DateTime, ParseExact_1, (app::String * s, app::String * format, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHOD(0x028A4630, DateTime, ParseExact_2, (app::String * s, app::String * format, app::IFormatProvider * provider, app::DateTimeStyles__Enum style));
IL2CPP_REGISTER_METHOD(0x028A4750, DateTime, ParseExact_3, (app::String * s, app::String__Array * formats, app::IFormatProvider * provider, app::DateTimeStyles__Enum style));
IL2CPP_REGISTER_METHOD(0x00214540, TimeSpan, Subtract, (app::DateTime__Boxed * this_ptr, app::DateTime value));
...
IL2CPP_REGISTER_METHOD(0x002145C0, DateTime, ToLocalTime_1, (app::DateTime__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x002145D0, DateTime, ToLocalTime_2, (app::DateTime__Boxed * this_ptr, bool throw_on_overflow));
IL2CPP_REGISTER_METHODINFO(0x0478B350, DateTime_ToLocalTime_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002145E0, String *, ToLongDateString, (app::DateTime__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x002146C0, String *, ToLongTimeString, (app::DateTime__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x002146D0, String *, ToShortDateString, (app::DateTime__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x002147B0, String *, ToShortTimeString, (app::DateTime__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00214890, String *, ToString_1, (app::DateTime__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x002148A0, String *, ToString_2, (app::DateTime__Boxed * this_ptr, app::String * format));
IL2CPP_REGISTER_METHOD(0x002148B0, String *, ToString_3, (app::DateTime__Boxed * this_ptr, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHOD(0x002148C0, String *, ToString_4, (app::DateTime__Boxed * this_ptr, app::String * format, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHOD(0x002148D0, DateTime, ToUniversalTime, (app::DateTime__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x028A5AD0, DateTime, operator___1, (app::DateTime d, app::TimeSpan t));
IL2CPP_REGISTER_METHODINFO(0x047231E0, DateTime_op_Addition__MethodInfo);
IL2CPP_REGISTER_METHOD(0x028A5BE0, DateTime, operator___2, (app::DateTime d, app::TimeSpan t));
IL2CPP_REGISTER_METHODINFO(0x04738470, DateTime_op_Subtraction__MethodInfo);
IL2CPP_REGISTER_METHOD(0x028A5CE0, TimeSpan, operator___3, (app::DateTime d1, app::DateTime d2));
IL2CPP_REGISTER_METHOD(0x028A5D00, bool, operator____1, (app::DateTime d1, app::DateTime d2));
IL2CPP_REGISTER_METHOD(0x028A5D20, bool, operator____2, (app::DateTime d1, app::DateTime d2));
IL2CPP_REGISTER_METHOD(0x028A5D40, bool, operator___4, (app::DateTime t1, app::DateTime t2));
IL2CPP_REGISTER_METHOD(0x028A5D60, bool, operator____3, (app::DateTime t1, app::DateTime t2));
IL2CPP_REGISTER_METHOD(0x028A5D80, bool, operator___5, (app::DateTime t1, app::DateTime t2));
IL2CPP_REGISTER_METHOD(0x028A5DA0, bool, operator____4, (app::DateTime t1, app::DateTime t2));
IL2CPP_REGISTER_METHOD(0x00214900, String__Array *, GetDateTimeFormats_1, (app::DateTime__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x002149C0, String__Array *, GetDateTimeFormats_2, (app::DateTime__Boxed * this_ptr, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHOD(0x002149D0, TypeCode__Enum, GetTypeCode, (app::DateTime__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00214AA0, Decimal, IConvertible_ToDecimal, (app::DateTime__Boxed * this_ptr, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHODINFO(0x04798868, DateTime_System_IConvertible_ToDecimal__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00107C00, DateTime, IConvertible_ToDateTime, (app::DateTime__Boxed * this_ptr, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHOD(0x00214AB0, Object *, IConvertible_ToType, (app::DateTime__Boxed * this_ptr, app::Type * type, app::IFormatProvider * provider));
