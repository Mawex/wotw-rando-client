...
namespace app::methods::System_Collections_Generic::EqualityComparer_1_UnityEngine_Color32_ {
IL2CPP_REGISTER_METHOD(0x02807CD0, EqualityComparer_1_UnityEngine_Color32_ *, get_Default, ());
IL2CPP_REGISTER_METHOD(0x02B49FC0, EqualityComparer_1_UnityEngine_Color32_ *, CreateComparer, ());
...
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::EqualityComparer_1_UnityEngine_Color32_ * this_ptr));
}
