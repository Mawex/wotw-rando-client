...
namespace app::methods::System_Collections_Generic::Dictionary_2_GameMapPins_PinColour_GameMapPins_Pin_ {
IL2CPP_REGISTER_METHOD(0x02C35530, GameMapPins_Pin *, get_Item, (app::Dictionary_2_GameMapPins_PinColour_GameMapPins_Pin_ * this_ptr, app::GameMapPins_PinColour__Enum key));
IL2CPP_REGISTER_METHODINFO(0x047719A8, Dictionary_2_GameMapPins_PinColour_GameMapPins_Pin__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_GameMapPins_PinColour_GameMapPins_Pin_ * this_ptr));
