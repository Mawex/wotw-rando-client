...
namespace app::methods::System_Reflection_Emit::PropertyBuilder {
IL2CPP_REGISTER_METHOD(0x02689220, PropertyAttributes__Enum, get_Attributes, (app::PropertyBuilder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02689310, Type *, get_DeclaringType, (app::PropertyBuilder * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0473E798, PropertyBuilder_get_DeclaringType__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02689360, String *, get_Name, (app::PropertyBuilder * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04712940, PropertyBuilder_get_Name__MethodInfo);
IL2CPP_REGISTER_METHOD(0x026893B0, Type *, get_PropertyType, (app::PropertyBuilder * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0475A340, PropertyBuilder_get_PropertyType__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02689400, ParameterInfo_1__Array *, GetIndexParameters, (app::PropertyBuilder * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047890B8, PropertyBuilder_GetIndexParameters__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02689450, Type *, get_ReflectedType, (app::PropertyBuilder * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04784E70, PropertyBuilder_get_ReflectedType__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02689480, MethodInfo_1__Array *, GetAccessors, (app::PropertyBuilder * this_ptr, bool non_public));
IL2CPP_REGISTER_METHODINFO(0x0477C0A0, PropertyBuilder_GetAccessors__MethodInfo);
IL2CPP_REGISTER_METHOD(0x026894B0, Object__Array *, GetCustomAttributes_1, (app::PropertyBuilder * this_ptr, bool inherit));
IL2CPP_REGISTER_METHODINFO(0x04705F88, PropertyBuilder_GetCustomAttributes__MethodInfo);
IL2CPP_REGISTER_METHOD(0x026894E0, Object__Array *, GetCustomAttributes_2, (app::PropertyBuilder * this_ptr, app::Type * attribute_type, bool inherit));
IL2CPP_REGISTER_METHODINFO(0x0473A9B8, PropertyBuilder_GetCustomAttributes_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02689510, MethodInfo_1 *, GetGetMethod, (app::PropertyBuilder * this_ptr, bool non_public));
IL2CPP_REGISTER_METHODINFO(0x04736D68, PropertyBuilder_GetGetMethod__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02689540, MethodInfo_1 *, GetSetMethod, (app::PropertyBuilder * this_ptr, bool non_public));
IL2CPP_REGISTER_METHODINFO(0x0470C370, PropertyBuilder_GetSetMethod__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02689570, Object *, GetValue, (app::PropertyBuilder * this_ptr, app::Object * obj, app::BindingFlags__Enum invoke_attr, app::Binder * binder, app::Object__Array * index, app::CultureInfo * culture));
