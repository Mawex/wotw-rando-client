...
IL2CPP_REGISTER_METHOD(0x00971A60, Vector3, get_Position, (app::EquipmentRadialSelection_RadialItemVisual * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00972610, Vector2, get_Direction, (app::EquipmentRadialSelection_RadialItemVisual * this_ptr));
IL2CPP_REGISTER_METHOD(0x00972630, bool, get_IsDisabled, (app::EquipmentRadialSelection_RadialItemVisual * this_ptr));
IL2CPP_REGISTER_METHOD(0x00972650, void, __ctor, (app::EquipmentRadialSelection_RadialItemVisual * this_ptr, app::CleverMenuItem * item, float angle, bool hide_renderers));
