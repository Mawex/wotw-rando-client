...
IL2CPP_REGISTER_METHOD(0x02EC2580, ExceptionDispatchInfo *, get_Item, (app::ReadOnlyCollection_1_System_Runtime_ExceptionServices_ExceptionDispatchInfo_ * this_ptr, int32_t index));
