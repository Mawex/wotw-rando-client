...
namespace app::methods::RootMotion_Demos::CharacterThirdPerson {
...
IL2CPP_REGISTER_METHOD(0x022158C0, Vector3, GetMoveDirection, (app::CharacterThirdPerson * this_ptr));
IL2CPP_REGISTER_METHOD(0x02215D70, void, Rotate, (app::CharacterThirdPerson * this_ptr));
IL2CPP_REGISTER_METHOD(0x02216940, Vector3, GetForwardDirection, (app::CharacterThirdPerson * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02217940, void, __ctor, (app::CharacterThirdPerson * this_ptr));
}
