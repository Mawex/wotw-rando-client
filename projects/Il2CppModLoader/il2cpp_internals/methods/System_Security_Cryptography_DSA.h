...
namespace app::methods::System_Security_Cryptography::DSA {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::DSA * this_ptr));
IL2CPP_REGISTER_METHOD(0x020D3E80, DSA *, Create_1, ());
IL2CPP_REGISTER_METHOD(0x020D3FD0, DSA *, Create_2, (app::String * alg_name));
IL2CPP_REGISTER_METHOD(0x020D40B0, Byte__Array *, HashData_1, (app::DSA * this_ptr, app::Byte__Array * data, int32_t offset, int32_t count, app::HashAlgorithmName hash_algorithm));
IL2CPP_REGISTER_METHODINFO(0x04764948, DSA_HashData__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020D40F0, Byte__Array *, HashData_2, (app::DSA * this_ptr, app::Stream * data, app::HashAlgorithmName hash_algorithm));
IL2CPP_REGISTER_METHODINFO(0x04793AF0, DSA_HashData_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020D4130, Byte__Array *, SignData_1, (app::DSA * this_ptr, app::Byte__Array * data, app::HashAlgorithmName hash_algorithm));
IL2CPP_REGISTER_METHODINFO(0x04748E60, DSA_SignData__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020D4220, Byte__Array *, SignData_2, (app::DSA * this_ptr, app::Byte__Array * data, int32_t offset, int32_t count, app::HashAlgorithmName hash_algorithm));
IL2CPP_REGISTER_METHODINFO(0x0478FA80, DSA_SignData_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020D43E0, Byte__Array *, SignData_3, (app::DSA * this_ptr, app::Stream * data, app::HashAlgorithmName hash_algorithm));
...
IL2CPP_REGISTER_METHOD(0x020D5350, String *, ToXmlString, (app::DSA * this_ptr, bool include_private_parameters));
