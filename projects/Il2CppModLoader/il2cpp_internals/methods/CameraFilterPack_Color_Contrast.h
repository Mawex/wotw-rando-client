...
IL2CPP_REGISTER_METHOD(0x024D91F0, Material *, get_material, (app::CameraFilterPack_Color_Contrast * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024D9A60, void, __ctor, (app::CameraFilterPack_Color_Contrast * this_ptr));
}
