...
IL2CPP_REGISTER_METHOD(0x002FBCA0, MoonAnimator *, get_MoonAnimator, (app::SkeletonAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006B3F50, void, __ctor, (app::SkeletonAnimator * this_ptr));
}
