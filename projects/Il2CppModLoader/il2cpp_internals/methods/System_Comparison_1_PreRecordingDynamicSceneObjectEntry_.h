...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::Comparison_1_PreRecordingDynamicSceneObjectEntry_ * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02C7B580, IAsyncResult *, BeginInvoke, (app::Comparison_1_PreRecordingDynamicSceneObjectEntry_ * this_ptr, app::PreRecordingDynamicSceneObjectEntry x, app::PreRecordingDynamicSceneObjectEntry y, app::AsyncCallback * callback, app::Object * object));
