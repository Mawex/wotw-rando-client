...
IL2CPP_REGISTER_METHOD(0x02382DD0, Stream *, CreateFile, (app::String * path, bool append, bool check_host));
...
IL2CPP_REGISTER_METHOD(0x002FBB00, Stream *, get_BaseStream, (app::StreamWriter * this_ptr));
IL2CPP_REGISTER_METHOD(0x02383430, bool, get_LeaveOpen, (app::StreamWriter * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB990, Encoding *, get_Encoding, (app::StreamWriter * this_ptr));
