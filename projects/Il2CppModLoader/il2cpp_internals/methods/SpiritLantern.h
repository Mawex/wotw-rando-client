...
IL2CPP_REGISTER_METHOD(0x00D59910, Color, get_OuterGlowColor, (app::SpiritLantern * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D59A80, void, set_OuterGlowColor, (app::SpiritLantern * this_ptr, app::Color value));
IL2CPP_REGISTER_METHOD(0x00D59BC0, Color, get_SparkParticlesColor, (app::SpiritLantern * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D59D20, void, set_SparkParticlesColor, (app::SpiritLantern * this_ptr, app::Color value));
IL2CPP_REGISTER_METHOD(0x00C7C010, Vector3, get_Position, (app::SpiritLantern * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, SpiritLeashMode__Enum, get_LeashInteractionMode, (app::SpiritLantern * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBCE0, Transform *, get_HookTargetTransform, (app::SpiritLantern * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D5AF20, Vector3, get_CameraTargetPosition, (app::SpiritLantern * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D5B0C0, Vector2, get_CameraTargetPadding, (app::SpiritLantern * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D5B170, Vector3, get_CameraInfluencePosition, (app::SpiritLantern * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A372E0, Vector2, get_CameraZoomFactor, (app::SpiritLantern * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417920, CameraTargetType__Enum, get_TargetType, (app::SpiritLantern * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D5B240, void, GetTargetData, (app::SpiritLantern * this_ptr, app::CameraTargetData * * data));
IL2CPP_REGISTER_METHOD(0x00D5B4A0, void, AdjustCameraTargetWeight, (app::SpiritLantern * this_ptr, app::float * weight, app::CameraTargetData * data, app::Vector3 primary_target_position));
...
IL2CPP_REGISTER_METHOD(0x006A63A0, IDamageReciever__Array *, get_AffectedReceivers, (app::SpiritLantern * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D5B880, void, __ctor, (app::SpiritLantern * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::SpiritLantern * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::SpiritLantern * this_ptr));
}
