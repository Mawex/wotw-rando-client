...
namespace app::methods::MusicZone {
    ...
    IL2CPP_REGISTER_METHOD(0x0043D9E0, SelectableCategory__Enum, get_Category, (app::MusicZone * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0087F490, void, __ctor, (app::MusicZone * this_ptr));
