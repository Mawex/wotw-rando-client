...
namespace app::methods::System_Net_Configuration::ServicePointManagerElement {
...
IL2CPP_REGISTER_METHOD(0x01E98780, EncryptionPolicy__Enum, get_EncryptionPolicy, (app::ServicePointManagerElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E98840, ConfigurationPropertyCollection *, get_Properties, (app::ServicePointManagerElement * this_ptr));
