...
namespace app::methods::System_Collections_Generic::LinkedList_1_T__Enumerator_System_Object_ {
IL2CPP_REGISTER_METHOD(0x00107C30, Object *, get_Current, (app::LinkedList_1_T_Enumerator_System_Object___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001525E0, Object *, IEnumerator_get_Current, (app::LinkedList_1_T_Enumerator_System_Object___Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00152590, void, __ctor_1, (app::LinkedList_1_T_Enumerator_System_Object___Boxed * this_ptr, app::LinkedList_1_System_Object_ * list));
IL2CPP_REGISTER_METHOD(0x001525C0, void, __ctor_2, (app::LinkedList_1_T_Enumerator_System_Object___Boxed * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
