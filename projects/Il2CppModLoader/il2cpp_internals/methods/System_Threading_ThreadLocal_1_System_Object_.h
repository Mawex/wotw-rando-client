...
namespace app::methods::System_Threading::ThreadLocal_1_System_Object_ {
IL2CPP_REGISTER_METHOD(0x02A60590, Object *, get_Value, (app::ThreadLocal_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A617A0, Object *, get_ValueForDebugDisplay, (app::ThreadLocal_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A618F0, List_1_System_Object_ *, get_ValuesForDebugDisplay, (app::ThreadLocal_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A5FDF0, void, __ctor, (app::ThreadLocal_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A60540, String *, ToString, (app::ThreadLocal_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A60860, Object *, GetValueSlow, (app::ThreadLocal_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A613F0, List_1_System_Object_ *, GetValuesAsList, (app::ThreadLocal_1_System_Object_ * this_ptr));
