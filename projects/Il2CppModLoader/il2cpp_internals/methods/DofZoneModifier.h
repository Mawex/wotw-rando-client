...
IL2CPP_REGISTER_METHOD(0x00B9C600, SliceRenderSettingsInfluencerOrder__Enum, get_SliceRenderInfluenceOrder, (app::DofZoneModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::DofZoneModifier * this_ptr));
}
