...
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::FlutteringSlamBehaviour_EndState * this_ptr, app::FlutteringSlamBehaviour * behaviour));
...
IL2CPP_REGISTER_METHOD(0x00B68B50, Vector3, ProcessRootMotion, (app::FlutteringSlamBehaviour_EndState * this_ptr, app::Vector3 motion));
