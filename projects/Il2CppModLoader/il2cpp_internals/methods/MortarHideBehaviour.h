...
IL2CPP_REGISTER_METHOD(0x0147D320, BehaviourStatus__Enum, OnExecute, (app::MortarHideBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x0147D3E0, void, OnExit, (app::MortarHideBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x0147D440, void, __ctor, (app::MortarHideBehaviour * this_ptr));
