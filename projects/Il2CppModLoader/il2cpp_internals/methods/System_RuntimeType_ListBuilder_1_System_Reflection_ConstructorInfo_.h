...
IL2CPP_REGISTER_METHOD(0x001FF7C0, void, __ctor, (app::RuntimeType_ListBuilder_1_System_Reflection_ConstructorInfo___Boxed * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x001FF820, ConstructorInfo__Array *, ToArray, (app::RuntimeType_ListBuilder_1_System_Reflection_ConstructorInfo___Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x001FF7E0, ConstructorInfo *, get_Item, (app::RuntimeType_ListBuilder_1_System_Reflection_ConstructorInfo___Boxed * this_ptr, int32_t index));
