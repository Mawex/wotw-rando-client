...
namespace app::methods::System_Xml_Linq::NameSerializer {
IL2CPP_REGISTER_METHOD(0x0302C390, void, __ctor, (app::NameSerializer * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
IL2CPP_REGISTER_METHODINFO(0x0470FAA0, NameSerializer__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0302C460, Object *, IObjectReference_GetRealObject, (app::NameSerializer * this_ptr, app::StreamingContext context));
