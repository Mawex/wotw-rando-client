...
namespace app::methods::Moon_ArtOptimization::ResolutionPreset {
...
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Title, (app::ResolutionPreset * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_Title, (app::ResolutionPreset * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x0134FD60, void, __ctor, (app::ResolutionPreset * this_ptr, int32_t width, int32_t height, app::String * title));
}
