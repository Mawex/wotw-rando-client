...
IL2CPP_REGISTER_METHOD(0x006CCDB0, void, __ctor, (app::InputCacheManager_SetupTempData * this_ptr));
IL2CPP_REGISTER_METHOD(0x006CCFF0, InputCacheManager_SetupTempData_Node *, GetOrCreateNode, (app::InputCacheManager_SetupTempData * this_ptr, app::ICachableInput * input));
