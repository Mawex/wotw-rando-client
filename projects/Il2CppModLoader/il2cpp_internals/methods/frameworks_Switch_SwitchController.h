...
namespace app::methods::frameworks_Switch::SwitchController {
    ...
    IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::SwitchController * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00F5B8E0, void, __cctor, ());
}
