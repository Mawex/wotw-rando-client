...
IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor, (app::ParticleSystem_ColorOverLifetimeModule__Boxed * this_ptr, app::ParticleSystem * particle_system));
...
IL2CPP_REGISTER_METHOD(0x00247240, ParticleSystem_MinMaxGradient, get_color, (app::ParticleSystem_ColorOverLifetimeModule__Boxed * this_ptr));
