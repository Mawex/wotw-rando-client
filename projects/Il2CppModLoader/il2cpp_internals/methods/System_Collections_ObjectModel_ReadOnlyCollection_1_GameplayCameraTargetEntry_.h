...
namespace app::methods::System_Collections_ObjectModel::ReadOnlyCollection_1_GameplayCameraTargetEntry_ {
IL2CPP_REGISTER_METHOD(0x02B7DCF0, void, __ctor, (app::ReadOnlyCollection_1_GameplayCameraTargetEntry_ * this_ptr, app::IList_1_GameplayCameraTargetEntry_ * list));
IL2CPP_REGISTER_METHOD(0x02B7DD20, int32_t, get_Count, (app::ReadOnlyCollection_1_GameplayCameraTargetEntry_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02B7EA90, GameplayCameraTargetEntry, get_Item, (app::ReadOnlyCollection_1_GameplayCameraTargetEntry_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02B7DF30, IEnumerator_1_GameplayCameraTargetEntry_ *, GetEnumerator, (app::ReadOnlyCollection_1_GameplayCameraTargetEntry_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B7EA90, GameplayCameraTargetEntry, System_Collections_Generic_IList_T__get_Item, (app::ReadOnlyCollection_1_GameplayCameraTargetEntry_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02F11E30, IEnumerator *, IEnumerable_GetEnumerator, (app::ReadOnlyCollection_1_GameplayCameraTargetEntry_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F11EC0, Object *, ICollection_get_SyncRoot, (app::ReadOnlyCollection_1_GameplayCameraTargetEntry_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B7F310, Object *, IList_get_Item, (app::ReadOnlyCollection_1_GameplayCameraTargetEntry_ * this_ptr, int32_t index));
