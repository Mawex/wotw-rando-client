...
namespace app::methods::ShadowEmitter {
    IL2CPP_REGISTER_METHOD(0x005A93B0, Transform*, get_GroundAnchorSafe, (app::ShadowEmitter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005A9500, Transform*, get_PerspectiveAnchorSafe, (app::ShadowEmitter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005A9650, Ray, get_CastRay, (app::ShadowEmitter * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x005AAC50, void, __ctor, (app::ShadowEmitter * this_ptr));
} // namespace app::methods::ShadowEmitter
