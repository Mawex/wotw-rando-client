...
IL2CPP_REGISTER_METHOD(0x014DF390, PetrifiedOwlFeedingGroundHideZone *, GetZoneIfPositionInside, (app::PetrifiedOwlFeedingGroundHideZoneGroup * this_ptr, app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x014DF530, void, Start, (app::PetrifiedOwlFeedingGroundHideZoneGroup * this_ptr));
IL2CPP_REGISTER_METHOD(0x014DF830, void, __ctor, (app::PetrifiedOwlFeedingGroundHideZoneGroup * this_ptr));
}
