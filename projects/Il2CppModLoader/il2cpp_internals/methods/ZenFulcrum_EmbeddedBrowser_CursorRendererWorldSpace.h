...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::CursorRendererWorldSpace {
    ...
    IL2CPP_REGISTER_METHOD(0x01DD35B0, void, __ctor, (app::CursorRendererWorldSpace * this_ptr));
}
