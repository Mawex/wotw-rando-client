...
namespace app::methods::Mono_Security_Protocol_Tls::TlsStream {
...
IL2CPP_REGISTER_METHOD(0x0291C810, void, __ctor_1, (app::TlsStream * this_ptr));
IL2CPP_REGISTER_METHOD(0x0291C980, void, __ctor_2, (app::TlsStream * this_ptr, app::Byte__Array * data));
IL2CPP_REGISTER_METHOD(0x0291CBB0, Byte__Array *, ReadSmallValue, (app::TlsStream * this_ptr, int32_t length));
...
IL2CPP_REGISTER_METHOD(0x0291CEC0, Byte__Array *, ReadBytes, (app::TlsStream * this_ptr, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x0291D4E0, Byte__Array *, ToArray, (app::TlsStream * this_ptr));
