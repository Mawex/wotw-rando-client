...
namespace app::methods::UnityEngine_UI::HorizontalOrVerticalLayoutGroup {
IL2CPP_REGISTER_METHOD(0x024B6530, void, __ctor, (app::HorizontalOrVerticalLayoutGroup * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024B74C0, void, GetChildSizes, (app::HorizontalOrVerticalLayoutGroup * this_ptr, app::RectTransform * child, int32_t axis, bool control_size, bool child_force_expand, app::float * min, app::float * preferred, app::float * flexible));
}
