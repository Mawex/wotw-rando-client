...
namespace app::methods::System_Collections_Generic::List_1_SeinSpiritSpearSpell_FlyingSpear_ {
...
IL2CPP_REGISTER_METHOD(0x02D842B0, SeinSpiritSpearSpell_FlyingSpear, get_Item, (app::List_1_SeinSpiritSpearSpell_FlyingSpear_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_SeinSpiritSpearSpell_FlyingSpear_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047732B0, List_1_SeinSpiritSpearSpell_FlyingSpear___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_SeinSpiritSpearSpell_FlyingSpear_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02D83CB0, void, __ctor_3, (app::List_1_SeinSpiritSpearSpell_FlyingSpear_ * this_ptr, app::IEnumerable_1_SeinSpiritSpearSpell_FlyingSpear_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02D84150, Object *, ICollection_get_SyncRoot, (app::List_1_SeinSpiritSpearSpell_FlyingSpear_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D84380, bool, IsCompatibleObject, (app::Object * value));
IL2CPP_REGISTER_METHOD(0x02D844A0, Object *, IList_get_Item, (app::List_1_SeinSpiritSpearSpell_FlyingSpear_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_SeinSpiritSpearSpell_FlyingSpear_ *, AsReadOnly, (app::List_1_SeinSpiritSpearSpell_FlyingSpear_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D84E60, SeinSpiritSpearSpell_FlyingSpear, Find, (app::List_1_SeinSpiritSpearSpell_FlyingSpear_ * this_ptr, app::Predicate_1_SeinSpiritSpearSpell_FlyingSpear_ * match));
IL2CPP_REGISTER_METHOD(0x02D84FF0, List_1_SeinSpiritSpearSpell_FlyingSpear_ *, FindAll, (app::List_1_SeinSpiritSpearSpell_FlyingSpear_ * this_ptr, app::Predicate_1_SeinSpiritSpearSpell_FlyingSpear_ * match));
...
IL2CPP_REGISTER_METHOD(0x02D85580, List_1_T_Enumerator_SeinSpiritSpearSpell_FlyingSpear_, GetEnumerator, (app::List_1_SeinSpiritSpearSpell_FlyingSpear_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D855F0, IEnumerator_1_SeinSpiritSpearSpell_FlyingSpear_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_SeinSpiritSpearSpell_FlyingSpear_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D855F0, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_SeinSpiritSpearSpell_FlyingSpear_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_SeinSpiritSpearSpell_FlyingSpear_ *, GetRange, (app::List_1_SeinSpiritSpearSpell_FlyingSpear_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, SeinSpiritSpearSpell_FlyingSpear__Array *, ToArray, (app::List_1_SeinSpiritSpearSpell_FlyingSpear_ * this_ptr));
