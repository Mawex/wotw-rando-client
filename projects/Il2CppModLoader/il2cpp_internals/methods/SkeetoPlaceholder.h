...
IL2CPP_REGISTER_METHOD(0x0075F7D0, SkeetoEntity *, get_CurrentEntity, (app::SkeetoPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x006253D0, GameObject *, get_Prefab, (app::SkeetoPlaceholder * this_ptr));
