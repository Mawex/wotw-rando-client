...
IL2CPP_REGISTER_METHOD(0x002FB9D0, List_1_StatSetting_ *, get_StatSettings, (app::StatisticsManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009BCD50, void, __ctor, (app::StatisticsManager * this_ptr));
}
