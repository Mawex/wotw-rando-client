...
namespace app::methods::System_Collections_Generic::Queue_1_System_Single_ {
...
IL2CPP_REGISTER_METHOD(0x0243CB70, void, __ctor_1, (app::Queue_1_System_Single_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04730860, Queue_1_System_Single___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02CA7A20, void, __ctor_2, (app::Queue_1_System_Single_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x02CA7B50, Object *, ICollection_get_SyncRoot, (app::Queue_1_System_Single_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CA6D60, Queue_1_T_Enumerator_System_Single_, GetEnumerator, (app::Queue_1_System_Single_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA6DA0, IEnumerator_1_System_Single_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::Queue_1_System_Single_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA6DA0, IEnumerator *, IEnumerable_GetEnumerator, (app::Queue_1_System_Single_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0243D5D0, Single__Array *, ToArray, (app::Queue_1_System_Single_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0243D6C0, void, SetCapacity, (app::Queue_1_System_Single_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x0243D7A0, void, MoveNext, (app::Queue_1_System_Single_ * this_ptr, app::int32_t * index));
