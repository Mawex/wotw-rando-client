...
namespace app::methods::UnityEngine_UI::Graphic {
IL2CPP_REGISTER_METHOD(0x024AE070, void, __ctor, (app::Graphic * this_ptr));
IL2CPP_REGISTER_METHOD(0x024AE200, Material *, get_defaultGraphicMaterial, ());
IL2CPP_REGISTER_METHOD(0x024AE370, Color, get_color, (app::Graphic * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024AEAD0, RectTransform *, get_rectTransform, (app::Graphic * this_ptr));
IL2CPP_REGISTER_METHOD(0x024AEB60, Canvas *, get_canvas, (app::Graphic * this_ptr));
IL2CPP_REGISTER_METHOD(0x024AEC20, void, CacheCanvas, (app::Graphic * this_ptr));
IL2CPP_REGISTER_METHOD(0x024AEE50, CanvasRenderer *, get_canvasRenderer, (app::Graphic * this_ptr));
IL2CPP_REGISTER_METHOD(0x024AEEE0, Material *, get_defaultMaterial, (app::Graphic * this_ptr));
IL2CPP_REGISTER_METHOD(0x024AEF70, Material *, get_material, (app::Graphic * this_ptr));
IL2CPP_REGISTER_METHOD(0x024AF040, void, set_material, (app::Graphic * this_ptr, app::Material * value));
IL2CPP_REGISTER_METHOD(0x024AF110, Material *, get_materialForRendering, (app::Graphic * this_ptr));
IL2CPP_REGISTER_METHOD(0x024AF350, Texture *, get_mainTexture, (app::Graphic * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024B0D90, Vector2, PixelAdjustPoint, (app::Graphic * this_ptr, app::Vector2 point));
IL2CPP_REGISTER_METHOD(0x024B1090, Rect, GetPixelAdjustedRect, (app::Graphic * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, ICanvasElement_get_transform, (app::Graphic * this_ptr));
}
