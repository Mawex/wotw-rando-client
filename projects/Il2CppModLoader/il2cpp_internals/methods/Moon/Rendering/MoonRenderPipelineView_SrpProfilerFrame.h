...
namespace app::methods::Moon::Rendering::MoonRenderPipelineView_SrpProfilerFrame {
    ...
    operator + (app::MoonRenderPipelineView_SrpProfilerFrame a, app::MoonRenderPipelineView_SrpProfilerFrame b) {
        return op_Addition(a, b);
    }
    operator / (app::MoonRenderPipelineView_SrpProfilerFrame a, int32_t b) {
