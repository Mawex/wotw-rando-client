...
namespace app::methods::CCText {
    ...
    IL2CPP_REGISTER_METHOD(0x00654950, CCText_AlignmentMode__Enum, get_Alignment, (app::CCText * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0315D560, void, set_Alignment, (app::CCText * this_ptr, app::CCText_AlignmentMode__Enum value));
    IL2CPP_REGISTER_METHOD(0x00998570, CCText_BoundingMode__Enum, get_Bounding, (app::CCText * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0315D570, void, set_Bounding, (app::CCText * this_ptr, app::CCText_BoundingMode__Enum value));
    IL2CPP_REGISTER_METHOD(0x003FC7F0, CCText_HorizontalAnchorMode__Enum, get_HorizontalAnchor, (app::CCText * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x003FC830, CCText_VerticalAnchorMode__Enum, get_VerticalAnchor, (app::CCText * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0315D590, void, set_VerticalAnchor, (app::CCText * this_ptr, app::CCText_VerticalAnchorMode__Enum value));
    IL2CPP_REGISTER_METHOD(0x0315D5A0, Vector3, get_CaretMinBounds, (app::CCText * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0315D6C0, Vector3, get_CaretMaxBounds, (app::CCText * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00643F40, Color, get_Color, (app::CCText * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0315D810, void, set_Color, (app::CCText * this_ptr, app::Color value));
    IL2CPP_REGISTER_METHOD(0x002FBB60, CCFont*, get_Font, (app::CCText * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FBBC0, CCTextModifier*, get_Modifier, (app::CCText * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0315D9D0, void, set_Modifier, (app::CCText * this_ptr, app::CCTextModifier* value));
    IL2CPP_REGISTER_METHOD(0x010790F0, Vector3, get_Offset, (app::CCText * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FBC40, String*, get_Text, (app::CCText * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x03160BE0, void, __ctor, (app::CCText * this_ptr));
