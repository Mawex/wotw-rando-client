...
namespace app::methods::System_Data::DataColumnPropertyDescriptor {
IL2CPP_REGISTER_METHOD(0x0239E050, void, __ctor, (app::DataColumnPropertyDescriptor * this_ptr, app::DataColumn * data_column));
IL2CPP_REGISTER_METHOD(0x0239E090, AttributeCollection *, get_Attributes, (app::DataColumnPropertyDescriptor * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC20, DataColumn *, get_Column, (app::DataColumnPropertyDescriptor * this_ptr));
IL2CPP_REGISTER_METHOD(0x0239E400, Type *, get_ComponentType, (app::DataColumnPropertyDescriptor * this_ptr));
IL2CPP_REGISTER_METHOD(0x0239E4A0, bool, get_IsReadOnly, (app::DataColumnPropertyDescriptor * this_ptr));
IL2CPP_REGISTER_METHOD(0x0239E4C0, Type *, get_PropertyType, (app::DataColumnPropertyDescriptor * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0239E760, Object *, GetValue, (app::DataColumnPropertyDescriptor * this_ptr, app::Object * component));
