...
namespace app::methods::System_Configuration::ConfigXmlDocument {
IL2CPP_REGISTER_METHOD(0x02961630, void, __ctor, (app::ConfigXmlDocument * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0475EF08, ConfigXmlDocument__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02961660, String *, get_Filename, (app::ConfigXmlDocument * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x029616C0, String *, IConfigErrorInfo_get_Filename, (app::ConfigXmlDocument * this_ptr));
