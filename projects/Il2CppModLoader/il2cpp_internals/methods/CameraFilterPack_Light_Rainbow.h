...
IL2CPP_REGISTER_METHOD(0x0247E400, Material *, get_material, (app::CameraFilterPack_Light_Rainbow * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0247EC70, void, __ctor, (app::CameraFilterPack_Light_Rainbow * this_ptr));
}
