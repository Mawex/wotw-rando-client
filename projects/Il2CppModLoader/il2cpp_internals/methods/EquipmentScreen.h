...
IL2CPP_REGISTER_METHOD(0x00420EE0, MenuTabBackground__Enum, get_BackgroundMode, (app::EquipmentScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009748F0, SpellUIItem *, get_SelectedSpellUIItem, (app::EquipmentScreen * this_ptr));
IL2CPP_REGISTER_METHOD(0x009749F0, PlayerUberStateInventory_InventoryItem *, get_SelectedSpell, (app::EquipmentScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00974AE0, SuspendableMask__Enum, get_Mask, (app::EquipmentScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00976770, void, __ctor, (app::EquipmentScreen * this_ptr));
}
