...
namespace app::methods::AkLogger {
    IL2CPP_REGISTER_METHOD(0x026EE590, void, __ctor, (app::AkLogger * this_ptr));
    IL2CPP_REGISTER_METHOD(0x026EE870, AkLogger*, get_Instance, ());
    ...
    IL2CPP_REGISTER_METHOD(0x026EECB0, void, __cctor, ());
} // namespace app::methods::AkLogger
