...
namespace app::methods::UnityEngine::Quaternion {
    ...
    IL2CPP_REGISTER_METHOD(0x0296B560, app::Quaternion, operator___1, (app::Quaternion lhs, app::Quaternion rhs));
    IL2CPP_REGISTER_METHOD(0x0296B6C0, app::Vector3, operator___2, (app::Quaternion rotation, app::Vector3 point));
