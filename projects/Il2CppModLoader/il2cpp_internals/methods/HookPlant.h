...
namespace app::methods::HookPlant {
    IL2CPP_REGISTER_METHOD(0x00B5E490, SeinSpiritLeashAbility*, get_Leash, (app::HookPlant * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A64220, Transform*, get_HookTargetTransform, (app::HookPlant * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00B5F800, Vector3, GetLeashPos, (app::HookPlant * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00B5F830, void, __ctor, (app::HookPlant * this_ptr));
} // namespace app::methods::HookPlant
