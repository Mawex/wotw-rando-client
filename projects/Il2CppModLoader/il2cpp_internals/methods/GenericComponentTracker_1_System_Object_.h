...
IL2CPP_REGISTER_METHOD(0x002FA280, List_1_System_Object_ *, get_All, (app::GenericComponentTracker_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x019F84C0, void, __ctor, (app::GenericComponentTracker_1_System_Object_ * this_ptr));
}
