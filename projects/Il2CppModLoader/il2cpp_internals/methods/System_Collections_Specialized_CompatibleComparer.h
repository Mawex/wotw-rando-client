...
IL2CPP_REGISTER_METHOD(0x02492EF0, IComparer *, get_DefaultComparer, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x024930B0, IHashCodeProvider *, get_DefaultHashCodeProvider, (MethodInfo * method));
}
