...
namespace app::methods::MS_Internal_Xml_Cache::XPathNode {
IL2CPP_REGISTER_METHOD(0x001DE330, XPathNodeType__Enum, get_NodeType, (app::XPathNode__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001DE340, String *, get_Prefix, (app::XPathNode__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001DE360, String *, get_LocalName, (app::XPathNode__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001DE380, String *, get_Name, (app::XPathNode__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001DE390, String *, get_NamespaceUri, (app::XPathNode__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001DE3B0, XPathDocument *, get_Document, (app::XPathNode__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x001DE450, XPathNodePageInfo *, get_PageInfo, (app::XPathNode__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00107C30, String *, get_Value, (app::XPathNode__Boxed * this_ptr));
}
