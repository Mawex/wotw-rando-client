...
namespace app::methods::System_ComponentModel::DataObjectAttribute {
    IL2CPP_REGISTER_METHOD(0x00B80D80, void, __ctor_1, (app::DataObjectAttribute * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0052C650, void, __ctor_2, (app::DataObjectAttribute * this_ptr, bool is_data_object));
    ...
    IL2CPP_REGISTER_METHOD(0x01FDE4A0, void, __cctor, ());
}
