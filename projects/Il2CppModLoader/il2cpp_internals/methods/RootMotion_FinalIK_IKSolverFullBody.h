...
namespace app::methods::RootMotion_FinalIK::IKSolverFullBody {
IL2CPP_REGISTER_METHOD(0x02BF2590, IKEffector *, GetEffector, (app::IKSolverFullBody * this_ptr, app::Transform * t));
IL2CPP_REGISTER_METHOD(0x02BF2700, FBIKChain *, GetChain, (app::IKSolverFullBody * this_ptr, app::Transform * transform));
IL2CPP_REGISTER_METHOD(0x02BF2760, int32_t, GetChainIndex, (app::IKSolverFullBody * this_ptr, app::Transform * transform));
IL2CPP_REGISTER_METHOD(0x02BF2940, IKSolver_Node *, GetNode, (app::IKSolverFullBody * this_ptr, int32_t chain_index, int32_t node_index));
IL2CPP_REGISTER_METHOD(0x02BF29B0, void, GetChainAndNodeIndexes, (app::IKSolverFullBody * this_ptr, app::Transform * transform, app::int32_t * chain_index, app::int32_t * node_index));
IL2CPP_REGISTER_METHOD(0x02BF2B60, IKSolver_Point__Array *, GetPoints, (app::IKSolverFullBody * this_ptr));
IL2CPP_REGISTER_METHOD(0x02BF2DA0, IKSolver_Point *, GetPoint, (app::IKSolverFullBody * this_ptr, app::Transform * transform));
...
IL2CPP_REGISTER_METHOD(0x02BF4C40, void, __ctor, (app::IKSolverFullBody * this_ptr));
}
