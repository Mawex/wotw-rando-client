...
IL2CPP_REGISTER_METHOD(0x03144650, void, __ctor, (app::AudioSourceExtension * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F25880, AudioSource *, get_audioSource, (app::AudioSourceExtension * this_ptr));
