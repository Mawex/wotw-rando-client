...
namespace app::methods::TriangleNet_Meshing::QualityMesher {
    IL2CPP_REGISTER_METHOD(0x02B13200, void, __ctor, (app::QualityMesher * this_ptr, app::Mesh_1 * mesh, app::Configuration_1 * config));
