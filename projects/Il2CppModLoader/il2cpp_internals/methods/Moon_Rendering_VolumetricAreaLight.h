...
namespace app::methods::Moon_Rendering::VolumetricAreaLight {
IL2CPP_REGISTER_METHOD(0x00EBFC50, Vector3, get_WorldPos, (app::VolumetricAreaLight * this_ptr));
IL2CPP_REGISTER_METHOD(0x00EBFFC0, Vector3, get_Size, (app::VolumetricAreaLight * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00EC04C0, void, __ctor, (app::VolumetricAreaLight * this_ptr));
}
