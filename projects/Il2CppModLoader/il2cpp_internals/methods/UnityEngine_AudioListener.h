...
IL2CPP_REGISTER_METHOD(0x03140EB0, PropertyName, ReadExtensionName, (app::AudioListener * this_ptr, int32_t listener_index));
...
IL2CPP_REGISTER_METHOD(0x03140F90, PropertyName, ReadExtensionPropertyName, (app::AudioListener * this_ptr, int32_t listener_index));
...
IL2CPP_REGISTER_METHOD(0x03141190, AudioListenerExtension *, AddExtension, (app::AudioListener * this_ptr, app::Type * extension_type));
}
