...
namespace app::methods::System_Threading_Tasks::UnwrapPromise_1_System_Object_ {
    IL2CPP_REGISTER_METHOD(0x02A5DA30, void, __ctor, (app::UnwrapPromise_1_System_Object_ * this_ptr, app::Task * outer_task, bool look_for_oce));
