...
IL2CPP_REGISTER_METHOD(0x004C1F10, void, __ctor, (app::AcidSlugCrawlingState * this_ptr, app::AcidSlugEnemy * slug, app::SoundSource * sound, app::SoundSource * move_sound));
