...
namespace app::methods::MothEnemy {
    IL2CPP_REGISTER_METHOD(0x00864990, MothSwarm*, get_Swarm, (app::MothEnemy * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00864A60, MothSwarmer*, get_Swarmer, (app::MothEnemy * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00864AA0, Vector3, get_PathTarget, (app::MothEnemy * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00866300, void, __ctor, (app::MothEnemy * this_ptr));
} // namespace app::methods::MothEnemy
