...
namespace app::methods::System_Text::DecoderReplacementFallbackBuffer {
IL2CPP_REGISTER_METHOD(0x0244B730, void, __ctor, (app::DecoderReplacementFallbackBuffer * this_ptr, app::DecoderReplacementFallback * fallback));
...
IL2CPP_REGISTER_METHOD(0x01939E80, int32_t, InternalFallback, (app::DecoderReplacementFallbackBuffer * this_ptr, app::Byte__Array * bytes, app::uint8_t * p_bytes));
}
