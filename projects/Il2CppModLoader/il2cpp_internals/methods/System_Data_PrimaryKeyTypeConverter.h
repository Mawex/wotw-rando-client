...
namespace app::methods::System_Data::PrimaryKeyTypeConverter {
...
IL2CPP_REGISTER_METHOD(0x01E491E0, Object *, ConvertTo, (app::PrimaryKeyTypeConverter * this_ptr, app::ITypeDescriptorContext * context, app::CultureInfo * culture, app::Object * value, app::Type * destination_type));
