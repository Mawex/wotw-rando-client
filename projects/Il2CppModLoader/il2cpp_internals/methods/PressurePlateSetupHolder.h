...
IL2CPP_REGISTER_METHOD(0x00C73190, PressurePlateSetupData *, get_NotPressed, (app::PressurePlateSetupHolder * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C73230, PressurePlateSetupData *, get_Pressed, (app::PressurePlateSetupHolder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C73750, void, __ctor, (app::PressurePlateSetupHolder * this_ptr));
}
