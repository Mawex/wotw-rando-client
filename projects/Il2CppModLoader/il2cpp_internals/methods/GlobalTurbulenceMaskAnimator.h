...
IL2CPP_REGISTER_METHOD(0x007FA2D0, SceneSettingsComponent *, get_SceneSettings, (app::GlobalTurbulenceMaskAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007FA950, void, __ctor, (app::GlobalTurbulenceMaskAnimator * this_ptr));
}
