...
namespace app::methods::System_Xml_Schema::DtdValidator {
IL2CPP_REGISTER_METHOD(0x023657A0, void, __ctor, (app::DtdValidator * this_ptr, app::XmlValidatingReaderImpl * reader, app::IValidationEventHandling * event_handling, bool process_identity_constraints));
...
IL2CPP_REGISTER_METHOD(0x02367E80, Object *, FindId, (app::DtdValidator * this_ptr, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x02368090, SchemaEntity *, GetEntity, (app::DtdValidator * this_ptr, app::XmlQualifiedName * qname, bool f_parameter_entity));
