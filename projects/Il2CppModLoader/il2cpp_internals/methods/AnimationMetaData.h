...
IL2CPP_REGISTER_METHOD(0x004FCEE0, AnimationMetaData_AnimationData *, FindData, (app::AnimationMetaData * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x004FD130, void, Process, (app::AnimationMetaData * this_ptr, app::GameObject * model));
IL2CPP_REGISTER_METHOD(0x004FD740, void, __ctor, (app::AnimationMetaData * this_ptr));
}
