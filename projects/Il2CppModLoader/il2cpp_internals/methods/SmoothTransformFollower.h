...
IL2CPP_REGISTER_METHOD(0x006D39F0, Vector3, get_CurrentFollowedPosition, (app::SmoothTransformFollower * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006D4140, void, __ctor, (app::SmoothTransformFollower * this_ptr));
}
