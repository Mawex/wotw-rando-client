...
IL2CPP_REGISTER_METHOD(0x010AD3F0, Vector2, get_EffectiveRandomTargetCenter, (app::TentacleIdleBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010AD930, BehaviourStatus__Enum, OnExecuteTask, (app::TentacleIdleBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x010ADCC0, void, __ctor, (app::TentacleIdleBehaviour * this_ptr));
}
