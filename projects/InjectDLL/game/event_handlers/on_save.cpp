...
namespace {
    IL2CPP_INTERCEPTGameController, void, CreateCheckpoint, (app::GameController * this_ptr, bool doPerformSave, bool respectRestrictCheckpointZone)) {
    ...
    IL2CPP_INTERCEPTNewGameAction, void, Perform, (app::NewGameAction * this_ptr, app::IContext* context)) {
    ...
    IL2CPP_INTERCEPTSaveGameController, void, SaveToFile, (app::SaveGameController * this_ptr, int32_t slotIndex, int32_t backupIndex, app::Byte__Array* bytes)) {
    ...
    IL2CPP_INTERCEPTSaveSlotBackupsManager, void, PerformBackup, (app::SaveSlotBackupsManager * this_ptr, app::SaveSlotBackup* saveSlot, int32_t backupIndex, app::String* backupName)) {
    ...
    IL2CPP_INTERCEPTSaveGameController, void, OnFinishedLoading, (app::SaveGameController * this_ptr)) {
    ...
    IL2CPP_INTERCEPTSaveGameController, void, RestoreCheckpoint, (app::SaveGameController * this_ptr)) {
    ...
    IL2CPP_INTERCEPTSeinHealthController, void, OnRespawn, (app::SeinHealthController * this_ptr)) {
