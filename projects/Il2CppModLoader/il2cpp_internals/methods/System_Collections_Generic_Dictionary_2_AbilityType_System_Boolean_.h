...
namespace app::methods::System_Collections_Generic::Dictionary_2_AbilityType_System_Boolean_ {
IL2CPP_REGISTER_METHOD(0x02E38260, bool, TryGetValue, (app::Dictionary_2_AbilityType_System_Boolean_ * this_ptr, app::AbilityType__Enum key, app::bool * value));
...
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_AbilityType_System_Boolean_ * this_ptr));
