...
namespace app::methods::System_Net::WebAsyncResult {
IL2CPP_REGISTER_METHOD(0x020AD7F0, void, __ctor_1, (app::WebAsyncResult * this_ptr, app::AsyncCallback * cb, app::Object * state));
IL2CPP_REGISTER_METHOD(0x020AD800, void, __ctor_2, (app::WebAsyncResult * this_ptr, app::HttpWebRequest * request, app::AsyncCallback * cb, app::Object * state));
IL2CPP_REGISTER_METHOD(0x020AD840, void, __ctor_3, (app::WebAsyncResult * this_ptr, app::AsyncCallback * cb, app::Object * state, app::Byte__Array * buffer, int32_t offset, int32_t size));
...
IL2CPP_REGISTER_METHOD(0x002FBB60, IAsyncResult *, get_InnerAsyncResult, (app::WebAsyncResult * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB70, void, set_InnerAsyncResult, (app::WebAsyncResult * this_ptr, app::IAsyncResult * value));
IL2CPP_REGISTER_METHOD(0x002FBBA0, Stream *, get_WriteStream, (app::WebAsyncResult * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB80, HttpWebResponse *, get_Response, (app::WebAsyncResult * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBC0, Byte__Array *, get_Buffer, (app::WebAsyncResult * this_ptr));
