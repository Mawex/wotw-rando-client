...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::Comparison_1_ShardTraderPlaceholder_ConditionalStockList_ * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02C7BDD0, IAsyncResult *, BeginInvoke, (app::Comparison_1_ShardTraderPlaceholder_ConditionalStockList_ * this_ptr, app::ShardTraderPlaceholder_ConditionalStockList x, app::ShardTraderPlaceholder_ConditionalStockList y, app::AsyncCallback * callback, app::Object * object));
