...
namespace app::methods::System_Data::DataExpression {
IL2CPP_REGISTER_METHOD(0x0239FA60, void, __ctor_1, (app::DataExpression * this_ptr, app::DataTable * table, app::String * expression));
IL2CPP_REGISTER_METHOD(0x0239FA80, void, __ctor_2, (app::DataExpression * this_ptr, app::DataTable * table, app::String * expression, app::Type * type));
IL2CPP_REGISTER_METHODINFO(0x04720068, DataExpression__ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0239FDF0, String *, get_Expression, (app::DataExpression * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x023A0070, Object *, Evaluate_1, (app::DataExpression * this_ptr));
IL2CPP_REGISTER_METHOD(0x023A0080, Object *, Evaluate_2, (app::DataExpression * this_ptr, app::DataRow * row, app::DataRowVersion__Enum version));
...
IL2CPP_REGISTER_METHOD(0x002FB9D0, DataColumn__Array *, GetDependency, (app::DataExpression * this_ptr));
