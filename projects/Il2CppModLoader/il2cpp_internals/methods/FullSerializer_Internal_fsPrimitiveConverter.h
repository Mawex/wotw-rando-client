...
namespace app::methods::FullSerializer_Internal::fsPrimitiveConverter {
...
IL2CPP_REGISTER_METHOD(0x0165B880, fsResult, TrySerialize, (app::fsPrimitiveConverter * this_ptr, app::Object * instance, app::fsData * * serialized, app::Type * storage_type));
IL2CPP_REGISTER_METHOD(0x0165C2F0, fsResult, TryDeserialize, (app::fsPrimitiveConverter * this_ptr, app::fsData * storage, app::Object * * instance, app::Type * storage_type));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::fsPrimitiveConverter * this_ptr));
}
