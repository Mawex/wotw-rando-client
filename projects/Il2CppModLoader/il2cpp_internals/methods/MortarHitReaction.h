...
IL2CPP_REGISTER_METHOD(0x0147D7C0, BehaviourStatus__Enum, OnExecuteTask, (app::MortarHitReaction * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0147DD80, void, __ctor, (app::MortarHitReaction * this_ptr));
