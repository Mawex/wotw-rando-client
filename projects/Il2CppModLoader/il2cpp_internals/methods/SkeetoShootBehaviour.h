...
IL2CPP_REGISTER_METHOD(0x006B0760, SkeetoLocomotion *, get_Locomotion, (app::SkeetoShootBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x006B0840, Entity *, get_Owner, (app::SkeetoShootBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x006B08C0, Vector3, get_AimPosition, (app::SkeetoShootBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x006B0A20, void, OnEnter, (app::SkeetoShootBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x006B0E70, BehaviourStatus__Enum, OnExecute, (app::SkeetoShootBehaviour * this_ptr, app::IContext * context));
