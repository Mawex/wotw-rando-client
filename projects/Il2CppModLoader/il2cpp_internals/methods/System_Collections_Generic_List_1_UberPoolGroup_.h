...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (List_1_UberPoolGroup_ * __this));
IL2CPP_REGISTER_METHODINFO(0x0477C838, List_1_UberPoolGroup___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (List_1_UberPoolGroup_ * __this));
IL2CPP_REGISTER_METHODINFO(0x04721448, List_1_UberPoolGroup__get_Count__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EFC50, UberPoolGroup *, get_Item, (List_1_UberPoolGroup_ * __this, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x047018A8, List_1_UberPoolGroup__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (List_1_UberPoolGroup_ * __this, UberPoolGroup * item));
IL2CPP_REGISTER_METHODINFO(0x04754F30, List_1_UberPoolGroup__Add__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_UberPoolGroup_, GetEnumerator, (List_1_UberPoolGroup_ * __this));
