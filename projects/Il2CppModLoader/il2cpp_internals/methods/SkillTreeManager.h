...
IL2CPP_REGISTER_METHOD(0x006B72F0, MessageDescriptor, get_AbilityMastered, (app::SkillTreeManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x006B73A0, MessageProvider *, AbilityName, (app::SkillTreeManager * this_ptr, app::AbilityType__Enum ability));
IL2CPP_REGISTER_METHOD(0x006B7540, String *, RequiredAbilitiesText, (app::SkillTreeManager * this_ptr, app::SkillItem * skill_item));
IL2CPP_REGISTER_METHOD(0x006B79E0, void, UpdateRequirementsText, (app::SkillTreeManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x006B7CF0, String *, NameText, (app::SkillTreeManager * this_ptr, app::SkillItem * skill_item));
IL2CPP_REGISTER_METHOD(0x006B7DE0, String *, RequiredSoulsText, (app::SkillTreeManager * this_ptr, app::SkillItem * skill_item));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::SkillTreeManager * this_ptr));
}
