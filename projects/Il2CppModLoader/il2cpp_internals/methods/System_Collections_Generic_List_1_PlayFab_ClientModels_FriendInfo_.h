...
namespace app::methods::System_Collections_Generic::List_1_PlayFab_ClientModels_FriendInfo_ {
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_PlayFab_ClientModels_FriendInfo_, GetEnumerator, (app::List_1_PlayFab_ClientModels_FriendInfo_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0476E2C0, List_1_PlayFab_ClientModels_FriendInfo__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_PlayFab_ClientModels_FriendInfo_ * this_ptr));
