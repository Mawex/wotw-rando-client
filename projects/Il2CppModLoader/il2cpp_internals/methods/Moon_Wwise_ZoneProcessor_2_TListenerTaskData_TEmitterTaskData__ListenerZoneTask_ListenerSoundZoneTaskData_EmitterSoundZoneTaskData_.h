...
namespace app::methods::Moon_Wwise::ZoneProcessor_2_TListenerTaskData_TEmitterTaskData__ListenerZoneTask_ListenerSoundZoneTaskData_EmitterSoundZoneTaskData_ {
...
IL2CPP_REGISTER_METHOD(0x02AF4930, ListenerSoundZoneTaskData, get_Data, (app::ZoneProcessor_2_TListenerTaskData_TEmitterTaskData_ListenerZoneTask_ListenerSoundZoneTaskData_EmitterSoundZoneTaskData_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AF49B0, void, __ctor, (app::ZoneProcessor_2_TListenerTaskData_TEmitterTaskData_ListenerZoneTask_ListenerSoundZoneTaskData_EmitterSoundZoneTaskData_ * this_ptr, int32_t i));
