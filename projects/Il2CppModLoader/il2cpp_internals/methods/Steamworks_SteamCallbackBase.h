...
IL2CPP_REGISTER_METHOD(0x027E37C0, void, BuildCCallbackBase, (app::void * vtable_ptr, int32_t callback_identity, app::CCallbackBase * * callback_base, app::GCHandle * callback_base_ptr));
}
