...
namespace app::methods::System_Threading_Tasks::AwaitTaskContinuation {
IL2CPP_REGISTER_METHOD(0x0232E5F0, void, __ctor_1, (app::AwaitTaskContinuation * this_ptr, app::Action * action, bool flow_execution_context, app::StackCrawlMark__Enum * stack_mark));
IL2CPP_REGISTER_METHOD(0x0232E6C0, void, __ctor_2, (app::AwaitTaskContinuation * this_ptr, app::Action * action, bool flow_execution_context));
IL2CPP_REGISTER_METHOD(0x0232E780, Task *, CreateTask, (app::AwaitTaskContinuation * this_ptr, app::Action_1_Object_ * action, app::Object * state, app::TaskScheduler * scheduler));
