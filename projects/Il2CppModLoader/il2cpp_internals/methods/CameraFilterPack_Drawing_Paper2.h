...
IL2CPP_REGISTER_METHOD(0x024F9360, Material *, get_material, (app::CameraFilterPack_Drawing_Paper2 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024F9C80, void, __ctor, (app::CameraFilterPack_Drawing_Paper2 * this_ptr));
}
