...
IL2CPP_REGISTER_METHOD(0x0098F260, String *, GetNiceName, (app::FadeFromBlackAction * this_ptr));
IL2CPP_REGISTER_METHOD(0x0043BB90, void, __ctor, (app::FadeFromBlackAction * this_ptr));
}
