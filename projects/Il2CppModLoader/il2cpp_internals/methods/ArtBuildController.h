...
IL2CPP_REGISTER_METHOD(0x0083FF80, IEnumerator *, LoadScreenshots, (app::ArtBuildController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00840A50, void, __ctor, (app::ArtBuildController * this_ptr));
}
