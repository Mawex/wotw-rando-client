...
IL2CPP_REGISTER_METHOD(0x002FB9F0, MoonAnimator_AnimationInstance__Array *, get_InputInstances, (app::MoonAnimator_Blend2DInstance * this_ptr));
IL2CPP_REGISTER_METHOD(0x02110C30, Playable, get_Playable, (app::MoonAnimator_Blend2DInstance * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420230, MoonAnimator_AnimationInstanceType__Enum, get_Type, (app::MoonAnimator_Blend2DInstance * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02112660, void, __ctor, (app::MoonAnimator_Blend2DInstance * this_ptr));
}
