...
IL2CPP_REGISTER_METHOD(0x012FD6B0, IByteUberState *, get_ResolvedUberState, (app::KwolokTongueStatue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::KwolokTongueStatue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012FD950, KwolokTongueStatue_TongueState *, GetTongueState, (app::KwolokTongueStatue * this_ptr, app::KwolokTongueStatue_KwolowTongueStatueState__Enum state));
IL2CPP_REGISTER_METHOD(0x012FD970, KwolokTongueStatue_TongueState *, get_OpenedState, (app::KwolokTongueStatue * this_ptr));
IL2CPP_REGISTER_METHOD(0x012FDAE0, KwolokTongueStatue_TongueState *, get_ClosedState, (app::KwolokTongueStatue * this_ptr));
IL2CPP_REGISTER_METHOD(0x012FDC50, KwolokTongueStatue_TongueState *, get_PartiallyOpenedState, (app::KwolokTongueStatue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00413180, SuspendableMask__Enum, get_Mask, (app::KwolokTongueStatue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012FF6B0, Vector3, get_BowAutoTargetPosition, (app::KwolokTongueStatue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012FF8B0, IDesiredUberState__Array *, GetRequirementsForTimeline, (app::KwolokTongueStatue * this_ptr, app::MoonTimeline * timeline));
...
IL2CPP_REGISTER_METHOD(0x01300140, IUberState__Array *, get_AffectingUberStates, (app::KwolokTongueStatue * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::KwolokTongueStatue * this_ptr));
IL2CPP_REGISTER_METHOD(0x013001D0, GameObject *, GetDynamicGraphicTarget, (app::KwolokTongueStatue * this_ptr));
IL2CPP_REGISTER_METHOD(0x005B0220, IDamageReciever__Array *, get_AffectedReceivers, (app::KwolokTongueStatue * this_ptr));
IL2CPP_REGISTER_METHOD(0x013001F0, void, __ctor, (app::KwolokTongueStatue * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::KwolokTongueStatue * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::KwolokTongueStatue * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD40, IMoonTypeResolver *, GetResolverForType, (app::KwolokTongueStatue * this_ptr));
}
