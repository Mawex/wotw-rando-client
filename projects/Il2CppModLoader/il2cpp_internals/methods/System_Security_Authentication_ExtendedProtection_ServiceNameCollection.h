...
namespace app::methods::System_Security_Authentication_ExtendedProtection::ServiceNameCollection {
IL2CPP_REGISTER_METHOD(0x021BC8D0, void, __ctor, (app::ServiceNameCollection * this_ptr, app::ICollection * items));
...
IL2CPP_REGISTER_METHOD(0x021BCF00, String *, NormalizeServiceName, (app::String * input_service_name));
