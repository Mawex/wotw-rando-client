...
namespace app::methods::System_Collections_Generic::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02C26A20, void, __ctor_3, (app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * this_ptr, app::IEnumerable_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02C26EA0, Object *, ICollection_get_SyncRoot, (app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E8A60, Promise_ResolveHandler, get_Item, (app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8BE0, Object *, IList_get_Item, (app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ *, AsReadOnly, (app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025E96E0, Promise_ResolveHandler, Find, (app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * this_ptr, app::Predicate_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * match));
IL2CPP_REGISTER_METHOD(0x025E9800, List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ *, FindAll, (app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * this_ptr, app::Predicate_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * match));
...
IL2CPP_REGISTER_METHOD(0x025E9D20, List_1_T_Enumerator_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_, GetEnumerator, (app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9D60, IEnumerator_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9D60, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ *, GetRange, (app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, Promise_ResolveHandler__Array *, ToArray, (app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * this_ptr));
