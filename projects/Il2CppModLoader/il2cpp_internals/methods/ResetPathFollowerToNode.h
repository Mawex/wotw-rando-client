...
IL2CPP_REGISTER_METHOD(0x00904F00, String *, get_TargetName, (app::ResetPathFollowerToNode * this_ptr));
IL2CPP_REGISTER_METHOD(0x00904FE0, String *, GetNiceName, (app::ResetPathFollowerToNode * this_ptr));
