...
namespace app::methods::System_Runtime_Serialization_Formatters_Binary::__BinaryWriter {
    IL2CPP_REGISTER_METHOD(0x01ED1880, void, __ctor, (app::_BinaryWriter * this_ptr, app::Stream * sout, app::ObjectWriter * object_writer, app::FormatterTypeStyle__Enum formatter_type_style));
