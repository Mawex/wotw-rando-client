...
namespace app::methods::Moon_uberSerializationWisp::PlayerUberStateStats {
    ...
    IL2CPP_REGISTER_METHOD(0x00F43780, void, __ctor, (app::PlayerUberStateStats * this_ptr, app::Action * set_dirty_callback));
