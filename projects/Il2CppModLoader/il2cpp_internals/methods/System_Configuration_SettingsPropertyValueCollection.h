...
namespace app::methods::System_Configuration::SettingsPropertyValueCollection {
IL2CPP_REGISTER_METHOD(0x01FFDDB0, void, __ctor, (app::SettingsPropertyValueCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01FFDE40, SettingsPropertyValue *, get_Item, (app::SettingsPropertyValueCollection * this_ptr, app::String * name));
IL2CPP_REGISTER_METHODINFO(0x04715F38, SettingsPropertyValueCollection_get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01FFDE70, Object *, get_SyncRoot, (app::SettingsPropertyValueCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01FFDF00, Object *, Clone, (app::SettingsPropertyValueCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01FFDF60, IEnumerator *, GetEnumerator, (app::SettingsPropertyValueCollection * this_ptr));
