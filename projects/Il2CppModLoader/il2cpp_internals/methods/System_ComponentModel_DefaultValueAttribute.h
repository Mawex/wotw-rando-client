...
namespace app::methods::System_ComponentModel::DefaultValueAttribute {
...
IL2CPP_REGISTER_METHOD(0x002FA280, Object *, get_Value, (app::DefaultValueAttribute * this_ptr));
