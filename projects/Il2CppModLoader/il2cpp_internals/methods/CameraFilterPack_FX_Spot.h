...
IL2CPP_REGISTER_METHOD(0x024747A0, Material *, get_material, (app::CameraFilterPack_FX_Spot * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024750F0, void, __ctor, (app::CameraFilterPack_FX_Spot * this_ptr));
}
