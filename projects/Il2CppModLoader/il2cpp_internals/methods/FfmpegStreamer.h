...
IL2CPP_REGISTER_METHOD(0x01254320, FfmpegStreamer *, get_Instance, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x012543A0, void, set_Instance, (FfmpegStreamer * value));
IL2CPP_REGISTER_METHOD(0x01254430, int32_t, get_LastPipedFrame, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x01254530, void, Close, (MethodInfo * method));
