...
namespace app::methods::Boid {
    ...
    IL2CPP_REGISTER_METHOD(0x00D350D0, Vector2, SeekPosition, (app::Boid * this_ptr, app::Vector2 target));
    IL2CPP_REGISTER_METHOD(0x00D351F0, Vector2, SeekSpeed, (app::Boid * this_ptr, app::Vector2 speed));
    ...
    IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::Boid * this_ptr));
