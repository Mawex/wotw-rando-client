...
IL2CPP_REGISTER_METHOD(0x002FB9D0, Object *, get_AsyncState, (app::HttpStreamAsyncResult * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E59430, WaitHandle *, get_AsyncWaitHandle, (app::HttpStreamAsyncResult * this_ptr));
