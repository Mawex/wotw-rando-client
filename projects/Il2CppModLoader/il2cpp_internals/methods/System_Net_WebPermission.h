...
namespace app::methods::System_Net::WebPermission {
IL2CPP_REGISTER_METHOD(0x01D77B80, Regex *, get_MatchAllRegex, ());
IL2CPP_REGISTER_METHOD(0x01D77D10, IEnumerator *, get_ConnectList, (app::WebPermission * this_ptr));
IL2CPP_REGISTER_METHOD(0x01D78130, IEnumerator *, get_AcceptList, (app::WebPermission * this_ptr));
IL2CPP_REGISTER_METHOD(0x01D78550, void, __ctor_1, (app::WebPermission * this_ptr, app::PermissionState__Enum state));
IL2CPP_REGISTER_METHOD(0x01D78770, void, __ctor_2, (app::WebPermission * this_ptr, bool unrestricted));
IL2CPP_REGISTER_METHOD(0x01D78990, void, __ctor_3, (app::WebPermission * this_ptr));
IL2CPP_REGISTER_METHOD(0x01D78BA0, void, __ctor_4, (app::WebPermission * this_ptr, app::NetworkAccess__Enum access));
IL2CPP_REGISTER_METHOD(0x01D78DD0, void, __ctor_5, (app::WebPermission * this_ptr, app::NetworkAccess__Enum access, app::Regex * uri_regex));
IL2CPP_REGISTER_METHOD(0x01D79010, void, __ctor_6, (app::WebPermission * this_ptr, app::NetworkAccess__Enum access, app::String * uri_string));
IL2CPP_REGISTER_METHOD(0x01D79250, void, __ctor_7, (app::WebPermission * this_ptr, app::NetworkAccess__Enum access, app::Uri * uri));
...
IL2CPP_REGISTER_METHOD(0x01D7A7F0, IPermission *, Copy, (app::WebPermission * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D7B730, IPermission *, Union, (app::WebPermission * this_ptr, app::IPermission * target));
IL2CPP_REGISTER_METHODINFO(0x04790D28, WebPermission_Union__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01D7BE00, IPermission *, Intersect, (app::WebPermission * this_ptr, app::IPermission * target));
...
IL2CPP_REGISTER_METHOD(0x01D7CE60, SecurityElement *, ToXml, (app::WebPermission * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D7EEA0, Object *, intersectPair, (app::Object * L, app::Object * R, app::bool * is_uri));
}
