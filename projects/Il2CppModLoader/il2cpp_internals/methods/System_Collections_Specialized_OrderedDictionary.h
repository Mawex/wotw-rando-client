...
IL2CPP_REGISTER_METHOD(0x0249BAD0, ICollection *, get_Keys, (app::OrderedDictionary * this_ptr));
IL2CPP_REGISTER_METHOD(0x0249BC20, ArrayList *, get_objectsArray, (app::OrderedDictionary * this_ptr));
IL2CPP_REGISTER_METHOD(0x0249BD80, Hashtable *, get_objectsTable, (app::OrderedDictionary * this_ptr));
IL2CPP_REGISTER_METHOD(0x0249BF00, Object *, ICollection_get_SyncRoot, (app::OrderedDictionary * this_ptr));
IL2CPP_REGISTER_METHOD(0x0249C060, Object *, get_Item, (app::OrderedDictionary * this_ptr, app::Object * key));
...
IL2CPP_REGISTER_METHOD(0x0249C380, ICollection *, get_Values, (app::OrderedDictionary * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0249CE40, IDictionaryEnumerator *, GetEnumerator, (app::OrderedDictionary * this_ptr));
IL2CPP_REGISTER_METHOD(0x0249CFC0, IEnumerator *, IEnumerable_GetEnumerator, (app::OrderedDictionary * this_ptr));
