...
namespace app::methods::System_ComponentModel::ListSortDescriptionCollection {
IL2CPP_REGISTER_METHOD(0x01FF4BC0, void, __ctor_1, (app::ListSortDescriptionCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x01FF4D10, void, __ctor_2, (app::ListSortDescriptionCollection * this_ptr, app::ListSortDescription__Array * sorts));
IL2CPP_REGISTER_METHOD(0x01FF4EB0, ListSortDescription *, get_Item, (app::ListSortDescriptionCollection * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x01FF4EB0, Object *, IList_get_Item, (app::ListSortDescriptionCollection * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, Object *, ICollection_get_SyncRoot, (app::ListSortDescriptionCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x01FF5420, void, CopyTo, (app::ListSortDescriptionCollection * this_ptr, app::Array * array, int32_t index));
IL2CPP_REGISTER_METHOD(0x01BDD500, IEnumerator *, IEnumerable_GetEnumerator, (app::ListSortDescriptionCollection * this_ptr));
}
