...
IL2CPP_REGISTER_METHOD(0x00FD7B70, void, __ctor, (app::UberPoolManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBA0, List_1_UberPoolGroup_ *, get_Groups, (app::UberPoolManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FDA020, GameObject *, Spawn_1, (app::UberPoolManager * this_ptr, app::GameObject * o, app::bool * new_object));
IL2CPP_REGISTER_METHOD(0x00FDA180, GameObject *, Spawn_2, (app::UberPoolManager * this_ptr, app::GameObject * o, app::Vector3 position, app::Quaternion rotation, app::bool * new_object));
IL2CPP_REGISTER_METHOD(0x00FDA220, void, Update, (app::UberPoolManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x00FDA3E0, UberPoolItem *, TryGetInstanceFromPrewarmQueue_1, (app::UberPoolManager * this_ptr, app::String * prefab_name));
IL2CPP_REGISTER_METHOD(0x00FDA520, UberPoolItem *, TryGetInstanceFromPrewarmQueue_2, (app::UberPoolManager * this_ptr, app::String * prefab_name, app::Queue_1_System_ValueTuple_2_ * queue));
IL2CPP_REGISTER_METHOD(0x00FDAAE0, UberPoolItem *, PrewarmInstanceFromPrewarmQueue, (app::UberPoolManager * this_ptr, int32_t group_index, app::GameObject * instance, bool even_if_at_capacity));
...
IL2CPP_REGISTER_METHOD(0x002FBBE0, Dictionary_2_System_Int32_UberPoolItem_ *, GetPrewarmEntries, (app::UberPoolManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x00FDC660, UberPoolGroup *, GetGroup, (app::UberPoolManager * this_ptr, app::GameObject * prefab));
IL2CPP_REGISTER_METHOD(0x00FDC7D0, GameObject *, SpawnWithName, (app::UberPoolManager * this_ptr, app::String * get_name, app::Vector3 position, app::Quaternion rotation, app::GameObject * original, app::bool * new_object));
IL2CPP_REGISTER_METHOD(0x00FDCFD0, bool, IsPooled, (app::UberPoolManager * this_ptr, app::String * name, app::bool * is_using_scene_pooling));
IL2CPP_REGISTER_METHOD(0x00FDD2B0, WeakPrefab *, GetPrefabSettings, (app::UberPoolManager * this_ptr, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x00FDEF90, IEnumerator *, RunDelayed, (app::UberPoolManager * this_ptr, float time, app::Action * run));
