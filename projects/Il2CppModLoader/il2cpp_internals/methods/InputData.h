...
namespace app::methods::InputData {
    ...
    IL2CPP_REGISTER_METHOD(0x00628720, void, CheckButtonChanged, (app::InputData * this_ptr, app::bool* changed, app::bool* member, app::Input_InputButtonProcessor** button));
    ...
    IL2CPP_REGISTER_METHOD(0x00417920, RecorderFrame_FrameDataTypes__Enum, FrameType, (app::InputData * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::InputData * this_ptr));
} // namespace app::methods::InputData
