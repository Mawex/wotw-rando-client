...
namespace app::methods::SystemIntegration_Synchronizer_Statistics::PlayFabStatistics___c {
IL2CPP_REGISTER_METHOD(0x00538C90, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::PlayFabStatistics_c * this_ptr));
