...
IL2CPP_REGISTER_METHOD(0x006BD6A0, SkinnedMeshRenderer *, GetRendererByName, (app::SkinnedMeshLod * this_ptr, app::SkinnedMeshRenderer__Array * renderers, app::String * name));
