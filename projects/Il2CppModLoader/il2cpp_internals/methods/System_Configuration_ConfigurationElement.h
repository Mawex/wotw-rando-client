...
namespace app::methods::System_Configuration::ConfigurationElement {
IL2CPP_REGISTER_METHOD(0x031BB900, ConfigurationPropertyCollection *, get_Properties, (app::ConfigurationElement * this_ptr));
