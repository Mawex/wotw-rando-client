...
namespace app::methods::System_Xml_Schema::SchemaElementDecl {
...
IL2CPP_REGISTER_METHOD(0x01AAF240, IDtdAttributeInfo *, IDtdAttributeListInfo_LookupAttribute, (app::SchemaElementDecl * this_ptr, app::String * prefix, app::String * local_name));
IL2CPP_REGISTER_METHOD(0x002FBBA0, IEnumerable_1_System_Xml_IDtdDefaultAttributeInfo_ *, IDtdAttributeListInfo_LookupDefaultAttributes, (app::SchemaElementDecl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01AAF410, SchemaElementDecl *, Clone, (app::SchemaElementDecl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003FC380, XmlSchemaDerivationMethod__Enum, get_Block, (app::SchemaElementDecl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC00, ContentValidator *, get_ContentValidator, (app::SchemaElementDecl * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC10, void, set_ContentValidator, (app::SchemaElementDecl * this_ptr, app::ContentValidator * value));
IL2CPP_REGISTER_METHOD(0x002FBC20, XmlSchemaAnyAttribute *, get_AnyAttribute, (app::SchemaElementDecl * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC30, void, set_AnyAttribute, (app::SchemaElementDecl * this_ptr, app::XmlSchemaAnyAttribute * value));
IL2CPP_REGISTER_METHOD(0x002FBC60, CompiledIdentityConstraint__Array *, get_Constraints, (app::SchemaElementDecl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC80, XmlSchemaElement *, get_SchemaElement, (app::SchemaElementDecl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01AAF760, SchemaAttDef *, GetAttDef, (app::SchemaElementDecl * this_ptr, app::XmlQualifiedName * qname));
IL2CPP_REGISTER_METHOD(0x002FBBA0, IList_1_System_Xml_IDtdDefaultAttributeInfo_ *, get_DefaultAttDefs, (app::SchemaElementDecl * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB80, Dictionary_2_System_Xml_XmlQualifiedName_System_Xml_Schema_SchemaAttDef_ *, get_AttDefs, (app::SchemaElementDecl * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBE0, Dictionary_2_System_Xml_XmlQualifiedName_System_Xml_XmlQualifiedName_ *, get_ProhibitedAttributes, (app::SchemaElementDecl * this_ptr));
