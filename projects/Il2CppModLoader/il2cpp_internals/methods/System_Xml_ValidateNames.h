...
namespace app::methods::System_Xml::ValidateNames {
...
IL2CPP_REGISTER_METHOD(0x01953DC0, int32_t, ParseQName, (app::String * s, int32_t offset, app::int32_t * colon_offset));
...
IL2CPP_REGISTER_METHOD(0x01954260, Exception *, GetInvalidNameException, (app::String * s, int32_t offset_start_char, int32_t offset_bad_char));
