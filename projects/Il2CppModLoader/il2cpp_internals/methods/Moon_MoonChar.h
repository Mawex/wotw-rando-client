...
namespace app::methods::Moon::MoonChar {
    ...
    IL2CPP_REGISTER_METHOD(0x02F913C0, CrossSceneReferenceId, get_CrossSceneReferenceId, (app::MoonChar * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x02F915A0, void, __ctor, (app::MoonChar * this_ptr, uint16_t static_value));
    ...
    IL2CPP_REGISTER_METHOD(0x02F91C40, bool, TryResolve, (app::MoonChar * this_ptr, app::uint16_t* value, app::IMoonResolverContext* context));
    ...
    IL2CPP_REGISTER_METHOD(0x00C3DD30, MoonTypeData, GetTypeData, (app::MoonChar * this_ptr));
} // namespace app::methods::Moon::MoonChar
