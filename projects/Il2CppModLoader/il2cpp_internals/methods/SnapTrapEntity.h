...
IL2CPP_REGISTER_METHOD(0x006D64E0, SoundHost *, get_SoundHost, (app::SnapTrapEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x006D64F0, SuspendableMask__Enum, get_Mask, (app::SnapTrapEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x006D6500, void, set_Mask, (app::SnapTrapEntity * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x006D6510, SnapTrapEntity_State__Enum, GetState, (app::SnapTrapEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00417920, RecordableParsingGroup__Enum, get_ParsingGroup, (app::SnapTrapEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, get_TrackTranformChangesForRecording, (app::SnapTrapEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x006DADA0, TrackingExclusions, get_TrackingExclusions, (app::SnapTrapEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x006DADB0, void, set_TrackingExclusions, (app::SnapTrapEntity * this_ptr, app::TrackingExclusions value));
IL2CPP_REGISTER_METHOD(0x006DADC0, void, __ctor, (app::SnapTrapEntity * this_ptr));
}
