...
namespace app::methods::System_Data_Common::SingleStorage {
IL2CPP_REGISTER_METHOD(0x021705C0, void, __ctor, (app::SingleStorage * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x021706E0, Object *, Aggregate, (app::SingleStorage * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x02171110, Object *, ConvertValue, (app::SingleStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02171240, void, Copy, (app::SingleStorage * this_ptr, int32_t record_no1, int32_t record_no2));
IL2CPP_REGISTER_METHOD(0x02171300, Object *, Get, (app::SingleStorage * this_ptr, int32_t record));
...
IL2CPP_REGISTER_METHOD(0x021716E0, Object *, ConvertXmlToObject, (app::SingleStorage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x021717A0, String *, ConvertObjectToXml, (app::SingleStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02171870, Object *, GetEmptyStorage, (app::SingleStorage * this_ptr, int32_t record_count));
