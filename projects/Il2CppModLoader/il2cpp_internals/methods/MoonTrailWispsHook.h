...
IL2CPP_REGISTER_METHOD(0x00998570, SuspendableMask__Enum, get_Mask, (app::MoonTrailWispsHook * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014744B0, Bounds, get_Bounds, (app::MoonTrailWispsHook * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00417920, UpdateType__Enum, get_UpdateType, (app::MoonTrailWispsHook * this_ptr));
IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::MoonTrailWispsHook * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, set_Position, (app::MoonTrailWispsHook * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x014750B0, Vector3, get_Speed, (app::MoonTrailWispsHook * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014751E0, void, __ctor, (app::MoonTrailWispsHook * this_ptr));
}
