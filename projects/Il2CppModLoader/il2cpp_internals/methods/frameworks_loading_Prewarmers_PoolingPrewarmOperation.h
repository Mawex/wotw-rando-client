...
namespace app::methods::frameworks_loading_Prewarmers::PoolingPrewarmOperation {
    IL2CPP_REGISTER_METHOD(0x00F61760, void, __ctor, (app::PoolingPrewarmOperation * this_ptr));
