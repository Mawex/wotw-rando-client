...
namespace app::methods::System_Data_Common::SqlBytesStorage {
IL2CPP_REGISTER_METHOD(0x02846750, void, __ctor, (app::SqlBytesStorage * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x02846880, Object *, Aggregate, (app::SqlBytesStorage * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x02846A70, Object *, Get, (app::SqlBytesStorage * this_ptr, int32_t record));
...
IL2CPP_REGISTER_METHOD(0x02846DC0, Object *, ConvertXmlToObject, (app::SqlBytesStorage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x02847210, String *, ConvertObjectToXml, (app::SqlBytesStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02847570, Object *, GetEmptyStorage, (app::SqlBytesStorage * this_ptr, int32_t record_count));
