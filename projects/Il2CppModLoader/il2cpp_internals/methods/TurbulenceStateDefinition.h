...
IL2CPP_REGISTER_METHOD(0x00B1B910, Int32__Array *, GetAllStateGUIDs, (app::TurbulenceStateDefinition * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B1BA40, String *, GetStateName, (app::TurbulenceStateDefinition * this_ptr, int32_t state_g_u_i_d));
IL2CPP_REGISTER_METHOD(0x00B1BAF0, bool, HasStateGUID, (app::TurbulenceStateDefinition * this_ptr, int32_t state_g_u_i_d));
IL2CPP_REGISTER_METHOD(0x00B1BB10, TurbulenceStateDefinition_TurbulenceState *, GetStateByGuid, (app::TurbulenceStateDefinition * this_ptr, int32_t guid));
...
IL2CPP_REGISTER_METHOD(0x00B1C150, void, __ctor, (app::TurbulenceStateDefinition * this_ptr));
}
