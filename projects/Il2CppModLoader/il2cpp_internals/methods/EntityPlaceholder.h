...
IL2CPP_REGISTER_METHOD(0x002FBB40, GameObject *, get_Prefab, (app::EntityPlaceholder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0071EAB0, String *, get_SpawnManagerDebug, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A43000, void, set_SpawnManagerDebug, (app::EntityPlaceholder * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x00C93CD0, GameObject *, get_PooledEntity, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C0CBA0, bool, get_IsEnemyEntityPlaceholder, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x00813F90, Entity *, get_CurrentEntity, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C93DA0, void, set_CurrentEntity, (app::EntityPlaceholder * this_ptr, app::Entity * value));
IL2CPP_REGISTER_METHOD(0x00C94130, GameObject *, get_CurrentEntityGameObject, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C94210, Transform *, get_CurrentEntityTransform, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C942F0, MoonAnimator *, get_CurrentEntityAnimator, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C943E0, Vitals *, get_CurrentEntityVitals, (app::EntityPlaceholder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C98CB0, List_1_Moon_Entity_ *, GetAllEntities, (app::Type * entity_type));
...
IL2CPP_REGISTER_METHOD(0x00C9C650, Rect, ForceBoxAreaToWorldCoords, (app::EntityPlaceholder * this_ptr, app::AxisAlignedBox * box, app::Transform * root));
...
IL2CPP_REGISTER_METHOD(0x00C9CDB0, SuspendableMask__Enum, get_Mask, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C9CDC0, void, set_Mask, (app::EntityPlaceholder * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, IsUsingVariations, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C9CE80, SpiritShardType__Enum, GetEquippedAggressorOrSuppresorShard, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, CanUseAutosetupPositionInOnSand, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C9CFA0, void, __ctor, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C9D5A0, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDisableOnRecordablePreview_get_gameObject, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, IMoonTypeResolver *, GetResolverForType_1, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, IMoonTypeResolver *, GetResolverForType_2, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, IMoonTypeResolver *, GetResolverForType_3, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, IMoonTypeResolver *, GetResolverForType_4, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, IMoonTypeResolver *, GetResolverForType_5, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, IMoonTypeResolver *, GetResolverForType_6, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, IMoonTypeResolver *, GetResolverForType_7, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, IMoonTypeResolver *, GetResolverForType_8, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, IMoonTypeResolver *, GetResolverForType_9, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, IMoonTypeResolver *, GetResolverForType_10, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, IMoonTypeResolver *, GetResolverForType_11, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, IMoonTypeResolver *, GetResolverForType_12, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, IMoonTypeResolver *, GetResolverForType_13, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, IMoonTypeResolver *, GetResolverForType_14, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, IMoonTypeResolver *, GetResolverForType_15, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, IMoonTypeResolver *, GetResolverForType_16, (app::EntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, IMoonTypeResolver *, GetResolverForType_17, (app::EntityPlaceholder * this_ptr));
}
