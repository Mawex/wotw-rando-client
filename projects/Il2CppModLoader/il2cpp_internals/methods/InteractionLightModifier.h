...
IL2CPP_REGISTER_METHOD(0x00637F40, String *, get_InteractionName, (app::InteractionLightModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x00637FE0, IEnumerable_1_System_String_ *, GetKeywordsForShader, (app::InteractionLightModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006382A0, UberInteractionManager_PropertyIDCache *, get_PropertyCache, (app::InteractionLightModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x00638380, void, SetProperties, (app::InteractionLightModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x00638510, void, __ctor, (app::InteractionLightModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x00638950, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x006389E0, IEnumerable_1_System_String_ *, __n__0, (app::InteractionLightModifier * this_ptr));
}
