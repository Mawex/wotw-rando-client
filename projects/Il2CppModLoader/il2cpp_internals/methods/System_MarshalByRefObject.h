...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MarshalByRefObject * this_ptr));
IL2CPP_REGISTER_METHOD(0x02267EF0, ServerIdentity *, get_ObjectIdentity, (app::MarshalByRefObject * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02267F90, ObjRef *, CreateObjRef, (app::MarshalByRefObject * this_ptr, app::Type * requested_type));
IL2CPP_REGISTER_METHODINFO(0x04734438, MarshalByRefObject_CreateObjRef__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02267FE0, Object *, InitializeLifetimeService, (app::MarshalByRefObject * this_ptr));
