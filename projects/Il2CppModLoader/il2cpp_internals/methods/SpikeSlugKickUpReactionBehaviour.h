...
IL2CPP_REGISTER_METHOD(0x011D10B0, BehaviourStatus__Enum, OnExecuteTask, (app::SpikeSlugKickUpReactionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x005B3EC0, void, __ctor, (app::SpikeSlugKickUpReactionBehaviour * this_ptr));
}
