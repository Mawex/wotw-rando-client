...
namespace app::methods::System_Diagnostics::SwitchLevelAttribute {
    IL2CPP_REGISTER_METHOD(0x02005510, void, __ctor, (app::SwitchLevelAttribute * this_ptr, app::Type * switch_level_type));
