...
namespace app::methods::RootMotion_FinalIK::IKSolverLimb {
...
IL2CPP_REGISTER_METHOD(0x02BFD3E0, void, __ctor_1, (app::IKSolverLimb * this_ptr));
IL2CPP_REGISTER_METHOD(0x02BFD4A0, void, __ctor_2, (app::IKSolverLimb * this_ptr, app::AvatarIKGoal__Enum goal));
IL2CPP_REGISTER_METHOD(0x02BFD570, IKSolverLimb_AxisDirection__Array *, get_axisDirections, (app::IKSolverLimb * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BFDD10, Vector3, GetModifiedBendNormal, (app::IKSolverLimb * this_ptr));
}
