...
IL2CPP_REGISTER_METHOD(0x0235B720, FacetsChecker *, get_FacetsChecker, (Datatype_decimal * __this));
IL2CPP_REGISTER_METHOD(0x00C8F220, XmlTypeCode__Enum, get_TypeCode, (Datatype_decimal * __this));
IL2CPP_REGISTER_METHOD(0x0235B7C0, Type *, get_ValueType, (Datatype_decimal * __this));
IL2CPP_REGISTER_METHOD(0x0235B860, Type *, get_ListValueType, (Datatype_decimal * __this));
IL2CPP_REGISTER_METHOD(0x0043D9E0, XmlSchemaWhiteSpace__Enum, get_BuiltInWhitespaceFacet, (Datatype_decimal * __this));
IL2CPP_REGISTER_METHOD(0x0235B900, RestrictionFlags__Enum, get_ValidRestrictionFlags, (Datatype_decimal * __this));
