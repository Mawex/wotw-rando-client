...
IL2CPP_REGISTER_METHOD(0x011291F0, GameObject *, get_EffectiveRoot, (app::LegacyTransparencyAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x011292C0, void, PrintOutRendererData, (app::LegacyTransparencyAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x011294A0, UberShaderProperty_Color__Enum, get_PropertyToUse, (app::LegacyTransparencyAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0112B260, void, __ctor, (app::LegacyTransparencyAnimator * this_ptr));
