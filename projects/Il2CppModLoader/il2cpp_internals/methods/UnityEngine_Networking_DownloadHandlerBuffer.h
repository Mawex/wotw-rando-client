...
IL2CPP_REGISTER_METHOD(0x0317E320, Byte__Array *, GetData, (app::DownloadHandlerBuffer * this_ptr));
IL2CPP_REGISTER_METHOD(0x0317E320, Byte__Array *, InternalGetData, (app::DownloadHandlerBuffer * this_ptr));
}
