...
IL2CPP_REGISTER_METHOD(0x0085EA80, String *, get_GizmoText, (app::AuxiliarySendZone * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0043D9E0, SelectableCategory__Enum, get_Category, (app::AuxiliarySendZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x0085F280, void, __ctor, (app::AuxiliarySendZone * this_ptr));
}
