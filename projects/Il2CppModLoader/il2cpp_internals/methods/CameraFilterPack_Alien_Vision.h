...
IL2CPP_REGISTER_METHOD(0x0273E9E0, Material *, get_material, (app::CameraFilterPack_Alien_Vision * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0273F330, void, __ctor, (app::CameraFilterPack_Alien_Vision * this_ptr));
}
