...
IL2CPP_REGISTER_METHOD(0x00115520, void, __ctor, (app::ValueTuple_2_Int32_Int32___Boxed * this_ptr, int32_t item1, int32_t item2));
...
IL2CPP_REGISTER_METHOD(0x0021CCE0, String *, ToString, (app::ValueTuple_2_Int32_Int32___Boxed * this_ptr));
}
