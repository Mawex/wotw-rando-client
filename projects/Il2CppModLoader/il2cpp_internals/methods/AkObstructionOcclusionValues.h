...
IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkObstructionOcclusionValues * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x018854F0, void *, getCPtr, (app::AkObstructionOcclusionValues * obj));
IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkObstructionOcclusionValues * this_ptr, app::void * c_ptr));
...
IL2CPP_REGISTER_METHOD(0x01885F00, void, __ctor_2, (app::AkObstructionOcclusionValues * this_ptr));
}
