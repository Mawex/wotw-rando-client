...
namespace app::methods::System_Xml_Schema::XsdDateTime {
    ...
    IL2CPP_REGISTER_METHOD(0x01C7D680, app::DateTime, operator__1, (app::XsdDateTime xdt));
    IL2CPP_REGISTER_METHOD(0x01C7DB30, app::DateTimeOffset, operator__2, (app::XsdDateTime xdt));
