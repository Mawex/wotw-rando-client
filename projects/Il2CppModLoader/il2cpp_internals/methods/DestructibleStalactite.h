...
IL2CPP_REGISTER_METHOD(0x00B8DCD0, Vector3, get_Position, (app::DestructibleStalactite * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9D0, IDamageReciever__Array *, get_AffectedReceivers, (app::DestructibleStalactite * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::DestructibleStalactite * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::DestructibleStalactite * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::DestructibleStalactite * this_ptr));
}
