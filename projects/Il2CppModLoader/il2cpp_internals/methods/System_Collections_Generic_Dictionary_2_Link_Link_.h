...
namespace app::methods::System_Collections_Generic::Dictionary_2_Link_Link_ {
...
IL2CPP_REGISTER_METHOD(0x02BD24D0, Link *, get_Item, (app::Dictionary_2_Link_Link_ * this_ptr, app::Link * key));
...
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_Link_Link_ * this_ptr));
