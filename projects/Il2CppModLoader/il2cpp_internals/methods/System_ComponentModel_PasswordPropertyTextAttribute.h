...
namespace app::methods::System_ComponentModel::PasswordPropertyTextAttribute {
    IL2CPP_REGISTER_METHOD(0x00531660, void, __ctor_1, (app::PasswordPropertyTextAttribute * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0052C650, void, __ctor_2, (app::PasswordPropertyTextAttribute * this_ptr, bool password));
    ...
    IL2CPP_REGISTER_METHOD(0x029921A0, void, __cctor, ());
}
