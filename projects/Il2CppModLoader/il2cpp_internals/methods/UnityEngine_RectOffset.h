...
IL2CPP_REGISTER_METHOD(0x0296DE00, void, __ctor_1, (app::RectOffset * this_ptr));
IL2CPP_REGISTER_METHOD(0x0231B8E0, void, __ctor_2, (app::RectOffset * this_ptr, app::Object * source_style, app::void * source));
IL2CPP_REGISTER_METHOD(0x0296DE60, void *, InternalCreate, ());
IL2CPP_REGISTER_METHOD(0x0296DEB0, void, InternalDestroy, (app::void * ptr));
...
IL2CPP_REGISTER_METHOD(0x0296E260, Rect, Remove, (app::RectOffset * this_ptr, app::Rect rect));
IL2CPP_REGISTER_METHOD(0x0296E2F0, void, Finalize, (app::RectOffset * this_ptr));
IL2CPP_REGISTER_METHOD(0x0296E410, String *, ToString, (app::RectOffset * this_ptr));
