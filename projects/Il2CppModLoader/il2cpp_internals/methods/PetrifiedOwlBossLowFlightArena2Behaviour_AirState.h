...
IL2CPP_REGISTER_METHOD(0x01778F80, void, __ctor, (app::PetrifiedOwlBossLowFlightArena2Behaviour_AirState * this_ptr, app::PetrifiedOwlBossLowFlightArena2Behaviour * behaviour));
