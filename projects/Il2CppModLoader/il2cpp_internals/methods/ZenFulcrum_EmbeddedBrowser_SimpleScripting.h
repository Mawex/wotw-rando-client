...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::SimpleScripting {
...
IL2CPP_REGISTER_METHOD(0x0166C590, IEnumerator *, _GetUsername2, (app::SimpleScripting * this_ptr));
IL2CPP_REGISTER_METHOD(0x0166C6E0, void, __ctor, (app::SimpleScripting * this_ptr));
}
