...
IL2CPP_REGISTER_METHOD(0x029E6F30, void, __ctor_1, (app::GUILayoutEntry * this_ptr, float _min_width, float _max_width, float _min_height, float _max_height, app::GUIStyle * _style));
IL2CPP_REGISTER_METHOD(0x029E7070, void, __ctor_2, (app::GUILayoutEntry * this_ptr, float _min_width, float _max_width, float _min_height, float _max_height, app::GUIStyle * _style, app::GUILayoutOption__Array * options));
IL2CPP_REGISTER_METHOD(0x01F1A590, GUIStyle *, get_style, (app::GUILayoutEntry * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x029E79E0, String *, ToString, (app::GUILayoutEntry * this_ptr));
