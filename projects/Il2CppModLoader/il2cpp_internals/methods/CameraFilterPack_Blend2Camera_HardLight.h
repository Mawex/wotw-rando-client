...
IL2CPP_REGISTER_METHOD(0x0274D4E0, Material *, get_material, (app::CameraFilterPack_Blend2Camera_HardLight * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0274E6B0, void, __ctor, (app::CameraFilterPack_Blend2Camera_HardLight * this_ptr));
}
