...
namespace app::methods::System_ComponentModel::NotifyParentPropertyAttribute {
IL2CPP_REGISTER_METHOD(0x0052C650, void, __ctor, (app::NotifyParentPropertyAttribute * this_ptr, bool notify_parent));
...
IL2CPP_REGISTER_METHOD(0x02990DE0, void, __cctor, ());
}
