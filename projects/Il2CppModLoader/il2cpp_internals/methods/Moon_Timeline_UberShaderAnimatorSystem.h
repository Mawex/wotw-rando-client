...
namespace app::methods::Moon_Timeline::UberShaderAnimatorSystem {
...
IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::UberShaderAnimatorSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D1A8F0, Vector4, GetStaticVector, (app::UberShaderAnimatorSystem * this_ptr, app::Renderer * target_renderer, app::UberShaderProperty_Vector__Enum property));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::UberShaderAnimatorSystem * this_ptr));
}
