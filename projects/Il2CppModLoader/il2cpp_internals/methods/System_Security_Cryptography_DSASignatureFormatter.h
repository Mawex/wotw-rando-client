...
namespace app::methods::System_Security_Cryptography::DSASignatureFormatter {
IL2CPP_REGISTER_METHOD(0x020D7890, void, __ctor_1, (app::DSASignatureFormatter * this_ptr));
IL2CPP_REGISTER_METHOD(0x020D7930, void, __ctor_2, (app::DSASignatureFormatter * this_ptr, app::AsymmetricAlgorithm * key));
...
IL2CPP_REGISTER_METHOD(0x020D7C60, Byte__Array *, CreateSignature, (app::DSASignatureFormatter * this_ptr, app::Byte__Array * rgb_hash));
