...
namespace app::methods::System_Collections_Generic::List_1_CharacterState_ {
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_CharacterState_, GetEnumerator, (app::List_1_CharacterState_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_CharacterState_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0477C6F0, List_1_CharacterState___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EFC50, CharacterState *, get_Item, (app::List_1_CharacterState_ * this_ptr, int32_t index));
