...
namespace app::methods::DebugMenuPage {
    IL2CPP_REGISTER_METHOD(0x002FA280, String*, get_Text, (app::DebugMenuPage * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FA490, void, set_Text, (app::DebugMenuPage * this_ptr, app::String* value));
    IL2CPP_REGISTER_METHOD(0x002FB930, String*, get_HelpText, (app::DebugMenuPage * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FBB00, String*, get_Path, (app::DebugMenuPage * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB10, void, set_Path, (app::DebugMenuPage * this_ptr, app::String* value));
    IL2CPP_REGISTER_METHOD(0x002FB990, List_1_List_1_IDebugMenuItem_*, get_Items, (app::DebugMenuPage * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB9A0, void, set_Items, (app::DebugMenuPage * this_ptr, app::List_1_List_1_IDebugMenuItem_* value));
    IL2CPP_REGISTER_METHOD(0x00DF3E10, void, __ctor_1, (app::DebugMenuPage * this_ptr, app::String* path, app::String* name));
    IL2CPP_REGISTER_METHOD(0x00DF3E40, void, __ctor_2, (app::DebugMenuPage * this_ptr, app::String* name));
    ...
    IL2CPP_REGISTER_METHOD(0x002FBC20, Func_1_String_*, get_DynamicText, (app::DebugMenuPage * this_ptr));
