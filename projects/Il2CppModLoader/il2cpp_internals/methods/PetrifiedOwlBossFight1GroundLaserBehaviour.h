...
IL2CPP_REGISTER_METHOD(0x017644B0, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossFight1GroundLaserBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x017693B0, Enum__Array *, GetEntries, (app::PetrifiedOwlBossFight1GroundLaserBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x01769450, Enum, Evaluate, (app::PetrifiedOwlBossFight1GroundLaserBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_ShouldSkip, (app::PetrifiedOwlBossFight1GroundLaserBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x017657C0, void, __ctor, (app::PetrifiedOwlBossFight1GroundLaserBehaviour * this_ptr));
}
