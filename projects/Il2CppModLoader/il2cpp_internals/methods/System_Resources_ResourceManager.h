...
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_BaseName, (app::ResourceManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x00585310, bool, get_IgnoreCase, (app::ResourceManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x003FF2B0, UltimateResourceFallbackLocation__Enum, get_FallbackLocation, (app::ResourceManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x01A85D60, String *, GetResourceFileName, (app::ResourceManager * this_ptr, app::CultureInfo * culture));
IL2CPP_REGISTER_METHOD(0x01A85F80, ResourceSet *, GetFirstResourceSet, (app::ResourceManager * this_ptr, app::CultureInfo * culture));
IL2CPP_REGISTER_METHOD(0x01A864C0, ResourceSet *, GetResourceSet, (app::ResourceManager * this_ptr, app::CultureInfo * culture, bool create_if_not_exists, bool try_parents));
IL2CPP_REGISTER_METHODINFO(0x04706520, ResourceManager_GetResourceSet__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A86890, ResourceSet *, InternalGetResourceSet_1, (app::ResourceManager * this_ptr, app::CultureInfo * culture, bool create_if_not_exists, bool try_parents));
IL2CPP_REGISTER_METHOD(0x01A868C0, ResourceSet *, InternalGetResourceSet_2, (app::ResourceManager * this_ptr, app::CultureInfo * requested_culture, bool create_if_not_exists, bool try_parents, app::StackCrawlMark__Enum * stack_mark));
...
IL2CPP_REGISTER_METHOD(0x01A87210, Version *, GetSatelliteContractVersion, (app::Assembly * a));
IL2CPP_REGISTER_METHODINFO(0x04763538, ResourceManager_GetSatelliteContractVersion__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A87850, CultureInfo *, GetNeutralResourcesLanguage, (app::Assembly * a));
...
IL2CPP_REGISTER_METHOD(0x01A87DA0, String *, GetString, (app::ResourceManager * this_ptr, app::String * name, app::CultureInfo * culture));
