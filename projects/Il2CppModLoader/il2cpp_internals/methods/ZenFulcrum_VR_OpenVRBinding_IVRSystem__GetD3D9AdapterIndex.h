...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::IVRSystem_GetD3D9AdapterIndex * this_ptr, app::Object * object, app::void * method_1));
IL2CPP_REGISTER_METHOD(0x0167F180, int32_t, Invoke, (app::IVRSystem_GetD3D9AdapterIndex * this_ptr));
IL2CPP_REGISTER_METHOD(0x00611B10, IAsyncResult *, BeginInvoke, (app::IVRSystem_GetD3D9AdapterIndex * this_ptr, app::AsyncCallback * callback, app::Object * object));
