...
IL2CPP_REGISTER_METHOD(0x0043D9E0, SelectableCategory__Enum, get_Category, (app::AudioStateZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x0085A740, void, __ctor, (app::AudioStateZone * this_ptr));
