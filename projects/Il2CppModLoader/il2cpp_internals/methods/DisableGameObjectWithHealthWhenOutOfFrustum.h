...
IL2CPP_REGISTER_METHOD(0x00B98120, Bounds, get_Bounds, (app::DisableGameObjectWithHealthWhenOutOfFrustum * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008223A0, void, __ctor, (app::DisableGameObjectWithHealthWhenOutOfFrustum * this_ptr));
}
