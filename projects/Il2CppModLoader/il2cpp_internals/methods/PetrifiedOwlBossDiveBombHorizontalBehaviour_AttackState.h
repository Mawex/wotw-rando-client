...
namespace app::methods::PetrifiedOwlBossDiveBombHorizontalBehaviour_AttackState {
    IL2CPP_REGISTER_METHOD(0x0049FF20, void, __ctor, (app::PetrifiedOwlBossDiveBombHorizontalBehaviour_AttackState * this_ptr, app::PetrifiedOwlBossDiveBombHorizontalBehaviour * behaviour));
