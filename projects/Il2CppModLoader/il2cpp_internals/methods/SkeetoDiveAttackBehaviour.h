...
IL2CPP_REGISTER_METHOD(0x0074F800, SkeetoDiveAttackBehaviour_DiveAttackState__Enum, get_State, (app::SkeetoDiveAttackBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x0074F810, Entity *, get_Owner, (app::SkeetoDiveAttackBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x0074F890, bool, get_IsAttacking, (app::SkeetoDiveAttackBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x0074F8B0, Vector3, get_OffsetToTarget, (app::SkeetoDiveAttackBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x0074F9F0, Vector3, get_InitialTargetPosition, (app::SkeetoDiveAttackBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0074FA30, Vector3, get_CurrentTargetPosition, (app::SkeetoDiveAttackBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007504F0, BehaviourStatus__Enum, UpdateJobScheduledState, (app::SkeetoDiveAttackBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00751050, BehaviourStatus__Enum, OnExecute, (app::SkeetoDiveAttackBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00751430, SkeetoLocomotion *, get_Locomotion, (app::SkeetoDiveAttackBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, BehaviourStatus__Enum, UpdateFlipTowardsTarget, (app::SkeetoDiveAttackBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00751AE0, BehaviourStatus__Enum, UpdateAttackAnticipation, (app::SkeetoDiveAttackBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007521D0, BehaviourStatus__Enum, UpdateAttackLoop, (app::SkeetoDiveAttackBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007529C0, BehaviourStatus__Enum, UpdateAttackResolve, (app::SkeetoDiveAttackBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007531E0, BehaviourStatus__Enum, UpdateHitWallStunnedLoop, (app::SkeetoDiveAttackBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420230, BehaviourStatus__Enum, UpdateHitWallHit, (app::SkeetoDiveAttackBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420230, BehaviourStatus__Enum, UpdateHitWallResolve, (app::SkeetoDiveAttackBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420230, BehaviourStatus__Enum, UpdateHitWallBackward, (app::SkeetoDiveAttackBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00754770, Vector3, OnRootMotion, (app::SkeetoDiveAttackBehaviour * this_ptr, app::Vector3 motion));
...
IL2CPP_REGISTER_METHOD(0x00754A10, void, __ctor, (app::SkeetoDiveAttackBehaviour * this_ptr));
