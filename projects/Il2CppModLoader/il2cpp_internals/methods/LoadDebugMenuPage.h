...
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_Name, (app::LoadDebugMenuPage * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FB3C10, void, __ctor, (app::LoadDebugMenuPage * this_ptr));
