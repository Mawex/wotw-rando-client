...
namespace app::methods::DamageDealer {
    ...
    IL2CPP_REGISTER_METHOD(0x0065FBE0, Collider*, get_Collider, (app::DamageDealer * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A64220, Polygon_1*, get_Polygon, (app::DamageDealer * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00DC31E0, DamageLayerMask__Enum, get_EffectiveDamageLayerMask, (app::DamageDealer * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x004F4750, GameObject*, get_VirtualTimelineTarget, (app::DamageDealer * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00420230, VirtualTimelineRepresentationGroup__Enum, get_VirtualTimelineGroup, (app::DamageDealer * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00DC7010, String*, get_NameDisplayedOnClip, (app::DamageDealer * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00DC70E0, void, __ctor, (app::DamageDealer * this_ptr));
