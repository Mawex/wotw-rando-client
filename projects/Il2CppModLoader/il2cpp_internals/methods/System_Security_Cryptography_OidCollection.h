...
namespace app::methods::System_Security_Cryptography::OidCollection {
IL2CPP_REGISTER_METHOD(0x021C0A10, void, __ctor, (app::OidCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x021C0B60, int32_t, Add, (app::OidCollection * this_ptr, app::Oid * oid));
IL2CPP_REGISTER_METHOD(0x021C0B90, Oid *, get_Item, (app::OidCollection * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x016D95F0, int32_t, get_Count, (app::OidCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x021C0C50, IEnumerator *, IEnumerable_GetEnumerator, (app::OidCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, Object *, get_SyncRoot, (app::OidCollection * this_ptr));
}
