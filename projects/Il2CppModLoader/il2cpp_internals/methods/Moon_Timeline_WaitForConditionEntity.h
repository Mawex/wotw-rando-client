...
namespace app::methods::Moon_Timeline::WaitForConditionEntity {
...
IL2CPP_REGISTER_METHOD(0x00420EE0, RecordableParsingGroup__Enum, get_ParsingGroup, (app::WaitForConditionEntity * this_ptr));
