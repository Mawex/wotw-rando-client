...
IL2CPP_REGISTER_METHOD(0x00FC1E90, Vector3, get_Position, (app::RisingStompPost * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00989BF0, SuspendableMask__Enum, get_Mask, (app::RisingStompPost * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC40, IDamageReciever__Array *, get_AffectedReceivers, (app::RisingStompPost * this_ptr));
IL2CPP_REGISTER_METHOD(0x013578F0, void, __ctor, (app::RisingStompPost * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::RisingStompPost * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::RisingStompPost * this_ptr));
}
