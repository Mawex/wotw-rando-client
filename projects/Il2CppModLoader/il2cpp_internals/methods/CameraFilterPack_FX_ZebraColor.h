...
IL2CPP_REGISTER_METHOD(0x02475120, Material *, get_material, (app::CameraFilterPack_FX_ZebraColor * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024666C0, void, __ctor, (app::CameraFilterPack_FX_ZebraColor * this_ptr));
}
