...
IL2CPP_REGISTER_METHOD(0x00956AC0, MantisSpawnType__Enum, get_SpawnType, (app::MantisGrayboxEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009FC780, Vector3, get_CameraTargetPosition, (app::MantisGrayboxEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x009FCBA0, void, __ctor, (app::MantisGrayboxEntity * this_ptr));
}
