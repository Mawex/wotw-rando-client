...
IL2CPP_REGISTER_METHOD(0x020FA020, Material *, get_material, (app::CameraFilterPack_Vision_Tunnel * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020FA970, void, __ctor, (app::CameraFilterPack_Vision_Tunnel * this_ptr));
}
