...
namespace app::methods::System_Threading_Tasks::ThreadPoolTaskScheduler {
IL2CPP_REGISTER_METHOD(0x02340880, void, __ctor, (app::ThreadPoolTaskScheduler * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02340DB0, IEnumerable_1_System_Threading_Tasks_Task_ *, GetScheduledTasks, (app::ThreadPoolTaskScheduler * this_ptr));
IL2CPP_REGISTER_METHOD(0x02340ED0, IEnumerable_1_System_Threading_Tasks_Task_ *, FilterTasksFromWorkItems, (app::ThreadPoolTaskScheduler * this_ptr, app::IEnumerable_1_System_Threading_IThreadPoolWorkItem_ * tpw_items));
