...
IL2CPP_REGISTER_METHOD(0x024EE970, Material *, get_material, (app::CameraFilterPack_Drawing_CellShading * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024EF290, void, __ctor, (app::CameraFilterPack_Drawing_CellShading * this_ptr));
}
