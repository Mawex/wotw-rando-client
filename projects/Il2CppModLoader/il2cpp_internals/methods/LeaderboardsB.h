...
namespace app::methods::LeaderboardsB {
    IL2CPP_REGISTER_METHOD(0x015BA0C0, LeaderboardFilter__Enum, get_m_currentFilter, (app::LeaderboardsB * this_ptr));
    IL2CPP_REGISTER_METHOD(0x015BA160, void, set_m_currentFilter, (app::LeaderboardsB * this_ptr, app::LeaderboardFilter__Enum value));
    IL2CPP_REGISTER_METHOD(0x015BA200, LeaderboardRowUI*, get_CurrentRowUI, (app::LeaderboardsB * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x015BAFF0, LeaderboardData*, GetLeaderboard, (app::LeaderboardB__Enum leaderboard));
    ...
    IL2CPP_REGISTER_METHOD(0x015BF470, void, __ctor, (app::LeaderboardsB * this_ptr));
} // namespace app::methods::LeaderboardsB
