...
IL2CPP_REGISTER_METHOD(0x00EA5A70, LeaderBoardService *, get_m_leaderBoardService, (app::RaceLeaderboardsTitlescreenController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00EA5B10, LeaderboardFilter__Enum, get_m_currentFilter, (app::RaceLeaderboardsTitlescreenController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00EA7000, void, __ctor, (app::RaceLeaderboardsTitlescreenController * this_ptr));
}
