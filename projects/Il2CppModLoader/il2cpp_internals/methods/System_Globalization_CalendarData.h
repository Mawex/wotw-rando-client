...
namespace app::methods::System_Globalization::CalendarData {
IL2CPP_REGISTER_METHOD(0x01A1EEA0, void, __ctor_1, (app::CalendarData * this_ptr));
IL2CPP_REGISTER_METHOD(0x01A1EEB0, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x01A20530, void, __ctor_2, (app::CalendarData * this_ptr, app::String * locale_name, int32_t calendar_id, bool b_use_user_overrides));
...
IL2CPP_REGISTER_METHOD(0x01A21730, CalendarData *, GetCalendarData, (int32_t calendar_id));
IL2CPP_REGISTER_METHOD(0x01A21940, String *, CalendarIdToCultureName, (int32_t calendar_id));
