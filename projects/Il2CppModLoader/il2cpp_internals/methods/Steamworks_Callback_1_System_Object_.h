...
IL2CPP_REGISTER_METHOD(0x01D1BAA0, Callback_1_System_Object_ *, Create, (app::Callback_1_T_DispatchDelegate_System_Object_ * func));
IL2CPP_REGISTER_METHOD(0x01D1BC00, Callback_1_System_Object_ *, CreateGameServer, (app::Callback_1_T_DispatchDelegate_System_Object_ * func));
IL2CPP_REGISTER_METHOD(0x01D1BD60, void, __ctor, (app::Callback_1_System_Object_ * this_ptr, app::Callback_1_T_DispatchDelegate_System_Object_ * func, bool b_game_server));
...
IL2CPP_REGISTER_METHOD(0x01D1C2C0, void, OnRunCallback, (app::Callback_1_System_Object_ * this_ptr, app::void * thisptr, app::void * pv_param));
IL2CPP_REGISTER_METHOD(0x01D1C450, void, OnRunCallResult, (app::Callback_1_System_Object_ * this_ptr, app::void * thisptr, app::void * pv_param, bool b_failed, uint64_t h_steam_a_p_i_call));
IL2CPP_REGISTER_METHOD(0x003FC830, int32_t, OnGetCallbackSizeBytes, (app::Callback_1_System_Object_ * this_ptr, app::void * thisptr));
