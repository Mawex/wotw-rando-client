...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::VolumeEffectFlags_c * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C53630, String *, _GetComponentNames_b__7_1, (app::VolumeEffectFlags_c * this_ptr, app::VolumeEffectComponentFlags * r));
