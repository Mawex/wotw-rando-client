...
namespace app::methods::PetrifiedOwlBossEscape1Behaviour_FlyEndState {
    IL2CPP_REGISTER_METHOD(0x017627E0, void, __ctor, (app::PetrifiedOwlBossEscape1Behaviour_FlyEndState * this_ptr, app::PetrifiedOwlBossEscape1Behaviour * behaviour));
