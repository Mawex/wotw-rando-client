...
IL2CPP_REGISTER_METHOD(0x005C3FE0, Rect, get_BoundingRect, (app::NoSoulFlameZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x0060A8A0, void, set_BoundingRect, (app::NoSoulFlameZone * this_ptr, app::Rect value));
IL2CPP_REGISTER_METHOD(0x0043D9A0, SelectableCategory__Enum, get_Category, (app::NoSoulFlameZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::NoSoulFlameZone * this_ptr));
