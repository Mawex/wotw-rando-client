...
namespace app::methods::System_Collections_Specialized::StringCollection {
IL2CPP_REGISTER_METHOD(0x0249DE30, String *, get_Item, (app::StringCollection * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x01BCB830, Object *, get_SyncRoot, (app::StringCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x0249DE30, Object *, IList_get_Item, (app::StringCollection * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x01BDD500, IEnumerator *, IEnumerable_GetEnumerator, (app::StringCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x0249E4C0, void, __ctor, (app::StringCollection * this_ptr));
}
