...
IL2CPP_REGISTER_METHOD(0x00969F70, BehaviourStatus__Enum, OnExecuteTask, (app::SpiderBossBreakArena1WallBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0096A2C0, void, __ctor, (app::SpiderBossBreakArena1WallBehaviour * this_ptr));
}
