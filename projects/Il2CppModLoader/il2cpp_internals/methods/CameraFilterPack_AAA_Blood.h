...
IL2CPP_REGISTER_METHOD(0x0273A040, Material *, get_material, (app::CameraFilterPack_AAA_Blood * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E6620, void, __ctor, (app::CameraFilterPack_AAA_Blood * this_ptr));
}
