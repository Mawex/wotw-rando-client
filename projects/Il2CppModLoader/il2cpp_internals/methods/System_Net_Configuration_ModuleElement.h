...
IL2CPP_REGISTER_METHOD(0x02019CB0, void, __ctor, (ModuleElement * __this));
IL2CPP_REGISTER_METHODINFO(0x0470C0D0, ModuleElement__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02019CE0, ConfigurationPropertyCollection *, get_Properties, (ModuleElement * __this));
IL2CPP_REGISTER_METHODINFO(0x0470F330, ModuleElement_get_Properties__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02019D10, String *, get_Type, (ModuleElement * __this));
IL2CPP_REGISTER_METHODINFO(0x047179E8, ModuleElement_get_Type__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02019D40, void, set_Type, (ModuleElement * __this, String * value));
