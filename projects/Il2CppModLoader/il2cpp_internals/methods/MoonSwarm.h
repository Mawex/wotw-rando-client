...
namespace app::methods::MoonSwarm {
    ...
    IL2CPP_REGISTER_METHOD(0x00989BF0, SuspendableMask__Enum, get_Mask, (app::MoonSwarm * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01461CD0, void, set_Mask, (app::MoonSwarm * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x01461D90, Rect, get_LimitRect, (app::MoonSwarm * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01462AC0, Vector2, SwarmCenter, (app::MoonSwarm * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01463D10, void, __ctor, (app::MoonSwarm * this_ptr));
} // namespace app::methods::MoonSwarm
