...
IL2CPP_REGISTER_METHOD(0x0229BDE0, String *, get_Message, (app::BadImageFormatException * this_ptr));
IL2CPP_REGISTER_METHOD(0x0229BEA0, void, SetMessageField, (app::BadImageFormatException * this_ptr));
IL2CPP_REGISTER_METHOD(0x0229BF50, String *, ToString, (app::BadImageFormatException * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC40, String *, get_FusionLog, (app::BadImageFormatException * this_ptr));
