...
namespace app::methods::System_Data::Listeners_1_System_Object_ {
    IL2CPP_REGISTER_METHOD(0x02FAEDD0, bool, get_HasListeners, (app::Listeners_1_System_Object_ * this_ptr));
    IL2CPP_REGISTER_METHOD(0x02FAEC80, void, __ctor, (app::Listeners_1_System_Object_ * this_ptr, int32_t object_i_d, app::Listeners_1_TElem_Func_2_System_Object_System_Object_System_Boolean_ * notify_filter));
