...
IL2CPP_REGISTER_METHOD(0x009C0FF0, String *, get_AnimationSpeedMultiplierParameterName, (app::MeleeComboMoveTorch * this_ptr));
IL2CPP_REGISTER_METHOD(0x009C1070, CharacterPlatformMovement *, get_PlatformMovement, (app::MeleeComboMoveTorch * this_ptr));
IL2CPP_REGISTER_METHOD(0x009C10B0, float, get_EffectiveDamage, (app::MeleeComboMoveTorch * this_ptr));
IL2CPP_REGISTER_METHOD(0x009C10E0, DamageType__Enum, get_EffectiveDamageType, (app::MeleeComboMoveTorch * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009C15E0, AbilityType__Enum, get_ComboAbilityType, (app::MeleeComboMoveTorch * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009C3820, Vector2, ComputeEffectiveKickback, (app::MeleeComboMoveTorch * this_ptr, app::Vector3 enemy_position));
...
IL2CPP_REGISTER_METHOD(0x009C4520, EffectSpawn, DamageEffectProvider, (app::MeleeComboMoveTorch * this_ptr, app::DamageResult damage_result));
...
IL2CPP_REGISTER_METHOD(0x009C4A10, void, __ctor, (app::MeleeComboMoveTorch * this_ptr));
