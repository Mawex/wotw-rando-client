...
namespace app::methods::System_Collections_Concurrent::ConcurrentQueue_1_System_Object_ {
IL2CPP_REGISTER_METHOD(0x00417870, bool, ICollection_get_IsSynchronized, (app::ConcurrentQueue_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02F27690, Object *, ICollection_get_SyncRoot, (app::ConcurrentQueue_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F272B0, void, __ctor, (app::ConcurrentQueue_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F276F0, IEnumerator *, IEnumerable_GetEnumerator, (app::ConcurrentQueue_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F27770, Object__Array *, ToArray, (app::ConcurrentQueue_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F28420, IEnumerator_1_System_Object_ *, GetEnumerator, (app::ConcurrentQueue_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02F284C0, void, SnapForObservation, (app::ConcurrentQueue_1_System_Object_ * this_ptr, app::ConcurrentQueue_1_T_Segment_System_Object_ * * head, app::int32_t * head_head, app::ConcurrentQueue_1_T_Segment_System_Object_ * * tail, app::int32_t * tail_tail));
IL2CPP_REGISTER_METHOD(0x02F28660, Object *, GetItemWhenAvailable, (app::ConcurrentQueue_1_System_Object_ * this_ptr, app::ConcurrentQueue_1_T_Segment_System_Object_ * segment, int32_t i));
IL2CPP_REGISTER_METHOD(0x02F28800, IEnumerator_1_System_Object_ *, Enumerate, (app::ConcurrentQueue_1_System_Object_ * this_ptr, app::ConcurrentQueue_1_T_Segment_System_Object_ * head, int32_t head_head, app::ConcurrentQueue_1_T_Segment_System_Object_ * tail, int32_t tail_tail));
