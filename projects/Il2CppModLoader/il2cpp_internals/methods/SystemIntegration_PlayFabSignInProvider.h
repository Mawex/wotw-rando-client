...
IL2CPP_REGISTER_METHOD(0x002FBB80, IPlatformUser *, get_User, (app::PlayFabSignInProvider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0051DBF0, String *, get_LinkToken, (app::PlayFabSignInProvider * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBC0, String *, get_EntityId, (app::PlayFabSignInProvider * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBD0, void, set_EntityId, (app::PlayFabSignInProvider * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBBE0, String *, get_EntityType, (app::PlayFabSignInProvider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0051DD10, void, __ctor, (app::PlayFabSignInProvider * this_ptr, app::INetworkConnectivityChecker * net_connectivity_checker, app::ISignInProvider * live_sign_in_provider, app::ISignInProvider * non_live_sign_in_provider));
