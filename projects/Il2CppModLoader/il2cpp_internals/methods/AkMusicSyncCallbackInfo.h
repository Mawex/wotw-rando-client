...
IL2CPP_REGISTER_METHOD(0x01882FF0, void, __ctor_1, (app::AkMusicSyncCallbackInfo * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x018830B0, void *, getCPtr, (app::AkMusicSyncCallbackInfo * obj));
IL2CPP_REGISTER_METHOD(0x01883140, void, setCPtr, (app::AkMusicSyncCallbackInfo * this_ptr, app::void * c_ptr));
...
IL2CPP_REGISTER_METHOD(0x01884010, AkCallbackType__Enum, get_musicSyncType, (app::AkMusicSyncCallbackInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x01884130, String *, get_userCueName, (app::AkMusicSyncCallbackInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x01884280, void, __ctor_2, (app::AkMusicSyncCallbackInfo * this_ptr));
}
