...
namespace app::methods::Mono_Unity::UnityTls_unitytls_interface_struct_unitytls_tlsctx_create_client_t {
    IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::UnityTls_unitytls_interface_struct_unitytls_tlsctx_create_client_t * this_ptr, app::Object * object, void * method_1));
