...
namespace app::methods::frameworks_loading_Prewarmers::LoadPoolingPrewarmInstancesOperation {
    IL2CPP_REGISTER_METHOD(0x00F60BE0, void, __ctor, (app::LoadPoolingPrewarmInstancesOperation * this_ptr));
