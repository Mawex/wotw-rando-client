...
IL2CPP_REGISTER_METHOD(0x00C52540, String *, get_StateName, (app::RammingBehaviour_ExhaustState * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C525C0, void, __ctor, (app::RammingBehaviour_ExhaustState * this_ptr, app::RammingBehaviour * behaviour));
