...
namespace app::methods::FrogEntity {
    ...
    IL2CPP_REGISTER_METHOD(0x01647250, FrogGroup*, get_Group, (app::FrogEntity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00B68B50, Vector3, ModifyKickbackForce, (app::FrogEntity * this_ptr, app::Vector3 force, app::Damage* damage, bool apply_death_modification));
    IL2CPP_REGISTER_METHOD(0x01647BD0, void, __ctor, (app::FrogEntity * this_ptr));
