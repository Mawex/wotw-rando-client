...
IL2CPP_REGISTER_METHOD(0x00EF3770, String *, get_GizmoText, (app::SoundZoneTrigger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00EF39C0, SoundHost *, get_EffectiveSoundHost, (app::SoundZoneTrigger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0043D9E0, SelectableCategory__Enum, get_Category, (app::SoundZoneTrigger * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::SoundZoneTrigger * this_ptr));
}
