...
IL2CPP_REGISTER_METHOD(0x002FBD60, TextureAnimator *, get_TextureAnimator, (app::SpriteAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009AB2B0, Atlas *, get_SettingsAtlas, (app::SpriteAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x009AB470, UberScreenMode__Enum, GetExternalUberScreenMode, (app::SpriteAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009ABD10, TextureAnimation *, get_CurrentAnimation, (app::SpriteAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x009ABD30, void, SetDirty, (app::SpriteAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x009ABD40, void, __ctor, (app::SpriteAnimator * this_ptr));
}
