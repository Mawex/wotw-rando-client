...
IL2CPP_REGISTER_METHOD(0x02575B00, bool, IsValidIndex, (int32_t index, int32_t arrayLength));
IL2CPP_REGISTER_METHOD(0x020AD5E0, bool, IsInRange, (int32_t value, int32_t inclusiveMin, int32_t inclusiveMax));
}
