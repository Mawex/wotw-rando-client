...
IL2CPP_REGISTER_METHOD(0x01F5AC30, ExpressionNode *, Parse, (app::ExpressionParser * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0473ACF0, ExpressionParser_Parse__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01F5C890, ExpressionNode *, ParseAggregateArgument, (app::ExpressionParser * this_ptr, app::FunctionId__Enum aggregate));
IL2CPP_REGISTER_METHODINFO(0x0473AF08, ExpressionParser_ParseAggregateArgument__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01F5CCB0, ExpressionNode *, NodePop, (app::ExpressionParser * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F5CD00, ExpressionNode *, NodePeek, (app::ExpressionParser * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F5D520, Tokens__Enum, Scan, (app::ExpressionParser * this_ptr));
