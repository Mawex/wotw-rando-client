...
IL2CPP_REGISTER_METHOD(0x024E18E0, Material *, get_material, (app::CameraFilterPack_Colors_HUE_Rotate * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024E21D0, void, __ctor, (app::CameraFilterPack_Colors_HUE_Rotate * this_ptr));
}
