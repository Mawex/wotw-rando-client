...
IL2CPP_REGISTER_METHOD(0x008C8790, BehaviourStatus__Enum, OnExecute, (app::WandererInteractionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x008C6EF0, void, OnExit, (app::WandererInteractionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x008C8AA0, void, __ctor, (app::WandererInteractionBehaviour * this_ptr));
}
