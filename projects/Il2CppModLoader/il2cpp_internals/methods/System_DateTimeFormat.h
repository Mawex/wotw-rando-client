...
IL2CPP_REGISTER_METHOD(0x028A7030, String *, FormatDayOfWeek, (int32_t day_of_week, int32_t repeat, app::DateTimeFormatInfo * dtfi));
IL2CPP_REGISTER_METHOD(0x028A7080, String *, FormatMonth, (int32_t month, int32_t repeat_count, app::DateTimeFormatInfo * dtfi));
IL2CPP_REGISTER_METHOD(0x028A70D0, String *, FormatHebrewMonthName, (app::DateTime time, int32_t month, int32_t repeat_count, app::DateTimeFormatInfo * dtfi));
...
IL2CPP_REGISTER_METHOD(0x028A7510, String *, FormatCustomized, (app::DateTime date_time, app::String * format, app::DateTimeFormatInfo * dtfi, app::TimeSpan offset));
...
IL2CPP_REGISTER_METHOD(0x028A9060, String *, GetRealFormat, (app::String * format, app::DateTimeFormatInfo * dtfi));
IL2CPP_REGISTER_METHODINFO(0x0470DDB8, DateTimeFormat_GetRealFormat__MethodInfo);
IL2CPP_REGISTER_METHOD(0x028A9700, String *, ExpandPredefinedFormat, (app::String * format, app::DateTime * date_time, app::DateTimeFormatInfo * * dtfi, app::TimeSpan * offset));
IL2CPP_REGISTER_METHODINFO(0x0471B630, DateTimeFormat_ExpandPredefinedFormat__MethodInfo);
IL2CPP_REGISTER_METHOD(0x028A9B30, String *, Format_1, (app::DateTime date_time, app::String * format, app::DateTimeFormatInfo * dtfi));
IL2CPP_REGISTER_METHOD(0x028A9C10, String *, Format_2, (app::DateTime date_time, app::String * format, app::DateTimeFormatInfo * dtfi, app::TimeSpan offset));
IL2CPP_REGISTER_METHOD(0x028A9EE0, String__Array *, GetAllDateTimes_1, (app::DateTime date_time, uint16_t format, app::DateTimeFormatInfo * dtfi));
IL2CPP_REGISTER_METHODINFO(0x047114E8, DateTimeFormat_GetAllDateTimes__MethodInfo);
IL2CPP_REGISTER_METHOD(0x028AA370, String__Array *, GetAllDateTimes_2, (app::DateTime date_time, app::DateTimeFormatInfo * dtfi));
