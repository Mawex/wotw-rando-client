...
namespace app::methods::UberShader_SpriteSharp::MathUtilities {
...
IL2CPP_REGISTER_METHOD(0x018FC890, Vector2, CenterOfMass_1, (app::List_1_UnityEngine_Vector2_ * points));
IL2CPP_REGISTER_METHOD(0x018FCA20, Vector2, CenterOfMass_2, (app::Vector2__Array * points));
IL2CPP_REGISTER_METHOD(0x018FCBA0, Vector2, PointCloudSize, (app::List_1_UnityEngine_Vector2_ * points));
