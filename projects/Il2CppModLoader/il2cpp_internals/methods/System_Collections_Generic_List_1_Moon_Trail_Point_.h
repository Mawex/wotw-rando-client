...
namespace app::methods::System_Collections_Generic::List_1_Moon_Trail_Point_ {
IL2CPP_REGISTER_METHOD(0x02DC9F90, Trail_Point, get_Item, (app::List_1_Moon_Trail_Point_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_Moon_Trail_Point_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04770170, List_1_Moon_Trail_Point___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_Moon_Trail_Point_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02DC9980, void, __ctor_3, (app::List_1_Moon_Trail_Point_ * this_ptr, app::IEnumerable_1_Moon_Trail_Point_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02DC9E30, Object *, ICollection_get_SyncRoot, (app::List_1_Moon_Trail_Point_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02DCA070, bool, IsCompatibleObject, (app::Object * value));
IL2CPP_REGISTER_METHOD(0x02DCA1A0, Object *, IList_get_Item, (app::List_1_Moon_Trail_Point_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_Moon_Trail_Point_ *, AsReadOnly, (app::List_1_Moon_Trail_Point_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02DCABD0, Trail_Point, Find, (app::List_1_Moon_Trail_Point_ * this_ptr, app::Predicate_1_Moon_Trail_Point_ * match));
IL2CPP_REGISTER_METHOD(0x02DCAD70, List_1_Moon_Trail_Point_ *, FindAll, (app::List_1_Moon_Trail_Point_ * this_ptr, app::Predicate_1_Moon_Trail_Point_ * match));
...
IL2CPP_REGISTER_METHOD(0x02DCB330, List_1_T_Enumerator_Moon_Trail_Point_, GetEnumerator, (app::List_1_Moon_Trail_Point_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02DCB3B0, IEnumerator_1_Moon_Trail_Point_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_Moon_Trail_Point_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02DCB3B0, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_Moon_Trail_Point_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_Moon_Trail_Point_ *, GetRange, (app::List_1_Moon_Trail_Point_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, Trail_Point__Array *, ToArray, (app::List_1_Moon_Trail_Point_ * this_ptr));
