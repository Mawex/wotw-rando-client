...
namespace app::methods::System_Collections_ObjectModel::ReadOnlyCollection_1_UnityEngine_UnitySynchronizationContext_WorkRequest_ {
IL2CPP_REGISTER_METHOD(0x02B7DCF0, void, __ctor, (app::ReadOnlyCollection_1_UnityEngine_UnitySynchronizationContext_WorkRequest_ * this_ptr, app::IList_1_UnityEngine_UnitySynchronizationContext_WorkRequest_ * list));
...
IL2CPP_REGISTER_METHOD(0x02B7EA90, UnitySynchronizationContext_WorkRequest, get_Item, (app::ReadOnlyCollection_1_UnityEngine_UnitySynchronizationContext_WorkRequest_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02B7DF30, IEnumerator_1_UnityEngine_UnitySynchronizationContext_WorkRequest_ *, GetEnumerator, (app::ReadOnlyCollection_1_UnityEngine_UnitySynchronizationContext_WorkRequest_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B7EA90, UnitySynchronizationContext_WorkRequest, System_Collections_Generic_IList_T__get_Item, (app::ReadOnlyCollection_1_UnityEngine_UnitySynchronizationContext_WorkRequest_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02ED3630, IEnumerator *, IEnumerable_GetEnumerator, (app::ReadOnlyCollection_1_UnityEngine_UnitySynchronizationContext_WorkRequest_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02ED36C0, Object *, ICollection_get_SyncRoot, (app::ReadOnlyCollection_1_UnityEngine_UnitySynchronizationContext_WorkRequest_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B7F310, Object *, IList_get_Item, (app::ReadOnlyCollection_1_UnityEngine_UnitySynchronizationContext_WorkRequest_ * this_ptr, int32_t index));
