...
IL2CPP_REGISTER_METHOD(0x025634F0, Mesh *, GetUniversalRenderMesh, (int32_t particle_count));
...
IL2CPP_REGISTER_METHOD(0x02565660, void, __ctor, (app::MoonTrailSystem * this_ptr));
