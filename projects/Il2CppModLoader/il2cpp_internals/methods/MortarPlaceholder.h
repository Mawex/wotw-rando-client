...
IL2CPP_REGISTER_METHOD(0x010D6940, GameObject *, get_Prefab, (app::MortarPlaceholder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0147E080, MortarEntity *, get_CurrentEntity, (app::MortarPlaceholder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0147E6C0, void, __ctor, (app::MortarPlaceholder * this_ptr));
