...
IL2CPP_REGISTER_METHOD(0x02F9A880, CrossSceneReferenceId, get_CrossSceneReferenceId, (app::MoonVector3 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F9AA60, void, __ctor, (app::MoonVector3 * this_ptr, app::Vector3 static_value));
IL2CPP_REGISTER_METHOD(0x02F9AA90, Vector3, Resolve, (app::MoonVector3 * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x0473A368, MoonVector3_Resolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02F9ACA0, Vector3, SafeResolve, (app::MoonVector3 * this_ptr, app::IMoonResolverContext * context));
...
IL2CPP_REGISTER_METHOD(0x01746A40, MoonTypeData, GetTypeData, (app::MoonVector3 * this_ptr));
}
