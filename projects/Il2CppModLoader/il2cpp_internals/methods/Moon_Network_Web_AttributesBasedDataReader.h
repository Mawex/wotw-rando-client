...
namespace app::methods::Moon_Network_Web::AttributesBasedDataReader {
...
IL2CPP_REGISTER_METHOD(0x02E92500, Dictionary_2_System_String_System_Object_ *, get_Body, (app::AttributesBasedDataReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::AttributesBasedDataReader * this_ptr));
}
