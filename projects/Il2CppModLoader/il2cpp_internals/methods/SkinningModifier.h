...
IL2CPP_REGISTER_METHOD(0x006C0860, SuspendableMask__Enum, get_Mask, (app::SkinningModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006C0890, void, __ctor, (app::SkinningModifier * this_ptr));
}
