...
namespace app::methods::System_Xml_Schema::XmlAnyConverter {
...
IL2CPP_REGISTER_METHOD(0x02237060, DateTime, ToDateTime, (app::XmlAnyConverter * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHODINFO(0x04735920, XmlAnyConverter_ToDateTime__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02237250, DateTimeOffset, ToDateTimeOffset, (app::XmlAnyConverter * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHODINFO(0x0470EEE8, XmlAnyConverter_ToDateTimeOffset__MethodInfo);
IL2CPP_REGISTER_METHOD(0x022374B0, Decimal, ToDecimal, (app::XmlAnyConverter * this_ptr, app::Object * value));
...
IL2CPP_REGISTER_METHOD(0x02237F20, Object *, ChangeType_1, (app::XmlAnyConverter * this_ptr, bool value, app::Type * destination_type));
IL2CPP_REGISTER_METHODINFO(0x047900C0, XmlAnyConverter_ChangeType__MethodInfo);
IL2CPP_REGISTER_METHOD(0x022381E0, Object *, ChangeType_2, (app::XmlAnyConverter * this_ptr, app::DateTime value, app::Type * destination_type));
IL2CPP_REGISTER_METHODINFO(0x0470F0E0, XmlAnyConverter_ChangeType_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x022384A0, Object *, ChangeType_3, (app::XmlAnyConverter * this_ptr, app::Decimal value, app::Type * destination_type));
IL2CPP_REGISTER_METHODINFO(0x047096F0, XmlAnyConverter_ChangeType_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02238780, Object *, ChangeType_4, (app::XmlAnyConverter * this_ptr, double value, app::Type * destination_type));
IL2CPP_REGISTER_METHODINFO(0x0476BA48, XmlAnyConverter_ChangeType_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02238A50, Object *, ChangeType_5, (app::XmlAnyConverter * this_ptr, int32_t value, app::Type * destination_type));
IL2CPP_REGISTER_METHODINFO(0x0475E308, XmlAnyConverter_ChangeType_4__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02238D10, Object *, ChangeType_6, (app::XmlAnyConverter * this_ptr, int64_t value, app::Type * destination_type));
IL2CPP_REGISTER_METHODINFO(0x047784A0, XmlAnyConverter_ChangeType_5__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02238FD0, Object *, ChangeType_7, (app::XmlAnyConverter * this_ptr, app::String * value, app::Type * destination_type, app::IXmlNamespaceResolver * ns_resolver));
IL2CPP_REGISTER_METHODINFO(0x0471B298, XmlAnyConverter_ChangeType_6__MethodInfo);
IL2CPP_REGISTER_METHOD(0x022392C0, Object *, ChangeType_8, (app::XmlAnyConverter * this_ptr, app::Object * value, app::Type * destination_type, app::IXmlNamespaceResolver * ns_resolver));
IL2CPP_REGISTER_METHODINFO(0x04741440, XmlAnyConverter_ChangeType_7__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0223ADE0, Object *, ChangeTypeWildcardDestination, (app::XmlAnyConverter * this_ptr, app::Object * value, app::Type * destination_type, app::IXmlNamespaceResolver * ns_resolver));
IL2CPP_REGISTER_METHOD(0x0223AF50, Object *, ChangeTypeWildcardSource, (app::XmlAnyConverter * this_ptr, app::Object * value, app::Type * destination_type, app::IXmlNamespaceResolver * ns_resolver));
IL2CPP_REGISTER_METHOD(0x0223B110, XPathNavigator *, ToNavigator, (app::XmlAnyConverter * this_ptr, app::XPathNavigator * nav));
