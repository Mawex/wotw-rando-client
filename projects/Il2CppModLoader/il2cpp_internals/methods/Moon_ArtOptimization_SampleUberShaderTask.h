...
namespace app::methods::Moon_ArtOptimization::SampleUberShaderTask {
    IL2CPP_REGISTER_METHOD(0x00CAECA0, app::RenderTexture *, get_RenderTex, ());
    IL2CPP_REGISTER_METHOD(0x00CAEF90, void, __ctor, (app::SampleUberShaderTask * this_ptr, int32_t sample_index, float progress, app::ArtOptimizationDataModel * data_model, app::UberShaderComponent * uber_shader, app::Bounds bounds));
