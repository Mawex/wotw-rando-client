...
namespace app::methods::System_Net::AutoWebProxyScriptEngine {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::AutoWebProxyScriptEngine * this_ptr, app::WebProxy * proxy, bool use_registry));
IL2CPP_REGISTER_METHOD(0x002FA280, Uri *, get_AutomaticConfigurationScript, (app::AutoWebProxyScriptEngine * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02010EF0, bool, GetProxies_2, (app::AutoWebProxyScriptEngine * this_ptr, app::Uri * destination, app::IList_1_System_String_ * * proxy_list, app::int32_t * sync_status));
IL2CPP_REGISTER_METHOD(0x002FA000, void, Close, (app::AutoWebProxyScriptEngine * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, Abort, (app::AutoWebProxyScriptEngine * this_ptr, app::int32_t * sync_status));
