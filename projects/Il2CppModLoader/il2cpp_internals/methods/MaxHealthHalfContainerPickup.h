...
IL2CPP_REGISTER_METHOD(0x01385FF0, GameObject *, get_EffectiveCollectedEffect, (app::MaxHealthHalfContainerPickup * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005AC260, void, __ctor, (app::MaxHealthHalfContainerPickup * this_ptr));
}
