...
namespace app::methods::System_Xml_Schema::XdrBuilder {
IL2CPP_REGISTER_METHOD(0x01ABDE40, void, __ctor, (app::XdrBuilder * this_ptr, app::XmlReader * reader, app::XmlNamespaceManager * curmgr, app::SchemaInfo * sinfo, app::String * target_namspace, app::XmlNameTable * name_table, app::SchemaNames * schema_names, app::ValidationEventHandler * eventhandler));
...
IL2CPP_REGISTER_METHOD(0x01AC5890, void, ParseDtMaxLength, (app::uint32_t * c_val, app::Object * obj, app::XdrBuilder * builder));
IL2CPP_REGISTER_METHOD(0x01AC5A20, void, ParseDtMinLength, (app::uint32_t * c_val, app::Object * obj, app::XdrBuilder * builder));
IL2CPP_REGISTER_METHOD(0x01AC5BB0, void, CompareMinMaxLength, (uint32_t c_min, uint32_t c_max, app::XdrBuilder * builder));
IL2CPP_REGISTER_METHOD(0x01AC5C60, bool, ParseInteger, (app::String * str, app::uint32_t * n));
...
IL2CPP_REGISTER_METHOD(0x01AC6310, XmlSchemaDatatype *, CheckDatatype, (app::XdrBuilder * this_ptr, app::String * str));
