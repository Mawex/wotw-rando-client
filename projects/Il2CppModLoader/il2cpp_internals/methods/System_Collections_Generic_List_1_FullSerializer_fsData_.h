...
namespace app::methods::System_Collections_Generic::List_1_FullSerializer_fsData_ {
...
IL2CPP_REGISTER_METHOD(0x025EFC50, fsData *, get_Item, (app::List_1_FullSerializer_fsData_ * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x047227B8, List_1_FullSerializer_fsData__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_1, (app::List_1_FullSerializer_fsData_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_2, (app::List_1_FullSerializer_fsData_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04751AB8, List_1_FullSerializer_fsData___ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_FullSerializer_fsData_, GetEnumerator, (app::List_1_FullSerializer_fsData_ * this_ptr));
