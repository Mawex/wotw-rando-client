...
IL2CPP_REGISTER_METHOD(0x00758280, BehaviourStatus__Enum, OnExecute, (app::SkeetoKeepPositionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x002FA000, void, OnExit, (app::SkeetoKeepPositionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00758470, void, __ctor, (app::SkeetoKeepPositionBehaviour * this_ptr));
}
