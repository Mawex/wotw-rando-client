...
IL2CPP_REGISTER_METHOD(0x002FB9D0, Brain *, get_Brain, (app::BrainBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00597BB0, void, __ctor, (app::BrainBehaviour * this_ptr));
}
