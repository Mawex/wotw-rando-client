...
IL2CPP_REGISTER_METHOD(0x00F485D0, PCQualityModeManager_QualityMode__Enum, get_CurrentMode, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x00F48B70, void, __cctor, (MethodInfo * method));
}
