...
IL2CPP_REGISTER_METHOD(0x002FB940, void, __ctor, (app::LocalDataStoreElement * this_ptr, int64_t cookie));
IL2CPP_REGISTER_METHOD(0x002FA280, Object *, get_Value, (app::LocalDataStoreElement * this_ptr));
