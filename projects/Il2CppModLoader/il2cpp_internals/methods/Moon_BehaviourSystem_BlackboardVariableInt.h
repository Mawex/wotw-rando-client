...
namespace app::methods::Moon_BehaviourSystem::BlackboardVariableInt {
IL2CPP_REGISTER_METHOD(0x002FB9B0, IMoonType_1_System_Int32_ *, GetMoonType, (app::BlackboardVariableInt * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0300A1F0, void, __ctor, (app::BlackboardVariableInt * this_ptr));
}
