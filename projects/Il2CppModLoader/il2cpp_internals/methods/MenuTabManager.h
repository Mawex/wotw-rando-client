...
IL2CPP_REGISTER_METHOD(0x009E7570, MenuTabEntry *, get_CurrentTab, (app::MenuTabManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009EAE10, void, __ctor, (app::MenuTabManager * this_ptr));
}
