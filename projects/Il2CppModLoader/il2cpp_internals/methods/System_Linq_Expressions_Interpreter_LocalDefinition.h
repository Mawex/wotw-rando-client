...
namespace app::methods::System_Linq_Expressions_Interpreter::LocalDefinition {
...
IL2CPP_REGISTER_METHOD(0x00107C10, ParameterExpression *, get_Parameter, (app::LocalDefinition__Boxed * this_ptr));
