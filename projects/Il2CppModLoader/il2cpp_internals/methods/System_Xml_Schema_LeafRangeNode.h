...
IL2CPP_REGISTER_METHOD(0x00CB5CB0, Decimal, get_Max, (app::LeafRangeNode * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C3DD30, Decimal, get_Min, (app::LeafRangeNode * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9B0, BitSet *, get_NextIteration, (app::LeafRangeNode * this_ptr));
