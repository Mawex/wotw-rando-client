...
namespace app::methods::SeinHold {
    ...
    IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement*, get_PlatformMovement, (app::SeinHold * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FBC80, IHoldable*, get_CurrentHoldable, (app::SeinHold * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01006BA0, IHoldable*, FindHoldableToPickup, (app::SeinHold * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01008A60, Vector2, GetVelocityFromDirection, (app::SeinHold * this_ptr, app::Vector3 direction));
