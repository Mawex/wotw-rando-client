...
IL2CPP_REGISTER_METHOD(0x0177ED90, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossSpitBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0177F430, Projectile *, SpawnProjectile, (app::PetrifiedOwlBossSpitBehaviour * this_ptr, app::Vector2 shoot_point, app::Vector3 shoot_velocity));
IL2CPP_REGISTER_METHOD(0x0177F890, void, __ctor, (app::PetrifiedOwlBossSpitBehaviour * this_ptr));
}
