...
namespace app::methods::Moon_InteractionGraph::PlayTimelineInteractionNodeDecorator {
IL2CPP_REGISTER_METHOD(0x01990DE0, MoonTimeline *, get_ResolvedTimeline, (app::PlayTimelineInteractionNodeDecorator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01990EE0, MoonTimeline *, get_ResolvedChainedTimeline, (app::PlayTimelineInteractionNodeDecorator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::PlayTimelineInteractionNodeDecorator * this_ptr));
}
