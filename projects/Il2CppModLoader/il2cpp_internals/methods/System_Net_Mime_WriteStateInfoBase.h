...
namespace app::methods::System_Net_Mime::WriteStateInfoBase {
IL2CPP_REGISTER_METHOD(0x01E6ECF0, void, __ctor, (app::WriteStateInfoBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x01A92400, int32_t, get_FooterLength, (app::WriteStateInfoBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, Byte__Array *, get_Footer, (app::WriteStateInfoBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA280, Byte__Array *, get_Header, (app::WriteStateInfoBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB00, Byte__Array *, get_Buffer, (app::WriteStateInfoBase * this_ptr));
