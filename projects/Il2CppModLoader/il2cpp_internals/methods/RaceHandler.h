...
namespace app::methods::RaceHandler {
    IL2CPP_REGISTER_METHOD(0x00E99590, RaceStateMachineContext*, get_Context, (app::RaceHandler * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00E9A210, IEnumerator*, CreateGhostFolder, (app::RaceHandler * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00E9DCC0, IEnumerator*, StartMenuRaceNextFrame, (app::RaceHandler * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00E9EA90, void, __ctor, (app::RaceHandler * this_ptr));
} // namespace app::methods::RaceHandler
