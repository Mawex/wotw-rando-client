...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_String_OverridableColorProperty_ {
IL2CPP_REGISTER_METHOD(0x0283B3E0, Dictionary_2_TKey_TValue_ValueCollection_System_String_OverridableColorProperty_ *, get_Values, (app::Dictionary_2_System_String_OverridableColorProperty_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04773658, Dictionary_2_System_String_OverridableColorProperty__get_Values__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_System_String_OverridableColorProperty_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047422B0, Dictionary_2_System_String_OverridableColorProperty___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02BA5400, Dictionary_2_TKey_TValue_Enumerator_System_String_OverridableColorProperty_, GetEnumerator, (app::Dictionary_2_System_String_OverridableColorProperty_ * this_ptr));
