...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::Animation * this_ptr));
IL2CPP_REGISTER_METHOD(0x03079E00, AnimationClip *, get_clip, (app::Animation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03079F60, WrapMode__Enum, get_wrapMode, (app::Animation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0307A270, AnimationState *, get_Item, (app::Animation * this_ptr, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x0307A5B0, AnimationState *, CrossFadeQueued_1, (app::Animation * this_ptr, app::String * animation, float fade_length, app::QueueMode__Enum queue, app::PlayMode__Enum mode));
IL2CPP_REGISTER_METHOD(0x0307A640, AnimationState *, CrossFadeQueued_2, (app::Animation * this_ptr, app::String * animation, float fade_length, app::QueueMode__Enum queue));
IL2CPP_REGISTER_METHOD(0x0307A660, AnimationState *, CrossFadeQueued_3, (app::Animation * this_ptr, app::String * animation, float fade_length));
IL2CPP_REGISTER_METHOD(0x0307A680, AnimationState *, CrossFadeQueued_4, (app::Animation * this_ptr, app::String * animation));
IL2CPP_REGISTER_METHOD(0x0307A6B0, AnimationState *, PlayQueued_1, (app::Animation * this_ptr, app::String * animation, app::QueueMode__Enum queue, app::PlayMode__Enum mode));
IL2CPP_REGISTER_METHOD(0x0307A730, AnimationState *, PlayQueued_2, (app::Animation * this_ptr, app::String * animation, app::QueueMode__Enum queue));
IL2CPP_REGISTER_METHOD(0x0307A750, AnimationState *, PlayQueued_3, (app::Animation * this_ptr, app::String * animation));
...
IL2CPP_REGISTER_METHOD(0x0307AAA0, IEnumerator *, GetEnumerator, (app::Animation * this_ptr));
IL2CPP_REGISTER_METHOD(0x0307A270, AnimationState *, GetState, (app::Animation * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x0307ABF0, AnimationState *, GetStateAtIndex, (app::Animation * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x0307AC50, int32_t, GetStateCount, (app::Animation * this_ptr));
IL2CPP_REGISTER_METHOD(0x0307ACA0, AnimationClip *, GetClip, (app::Animation * this_ptr, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x0307AED0, AnimationCullingType__Enum, get_cullingType, (app::Animation * this_ptr));
IL2CPP_REGISTER_METHOD(0x0307AF20, void, set_cullingType, (app::Animation * this_ptr, app::AnimationCullingType__Enum value));
IL2CPP_REGISTER_METHOD(0x0307AF80, Bounds, get_localBounds, (app::Animation * this_ptr));
