...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::DialogHandler {
IL2CPP_REGISTER_METHOD(0x01DD4430, DialogHandler *, Create, (app::Browser * parent, app::DialogHandler_DialogCallback * dialog_callback, app::DialogHandler_MenuCallback * context_callback));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::DialogHandler * this_ptr));
}
