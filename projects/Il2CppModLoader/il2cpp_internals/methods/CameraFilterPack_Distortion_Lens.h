...
IL2CPP_REGISTER_METHOD(0x024EA040, Material *, get_material, (app::CameraFilterPack_Distortion_Lens * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024EA9A0, void, __ctor, (app::CameraFilterPack_Distortion_Lens * this_ptr));
}
