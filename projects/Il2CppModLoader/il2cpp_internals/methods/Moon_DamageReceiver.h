...
IL2CPP_REGISTER_METHOD(0x003FC830, SuspendableMask__Enum, get_Mask, (app::DamageReceiver * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CD0D40, void, set_Mask, (app::DamageReceiver * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x002FBC00, List_1_Moon_DamageReceiver_DamageEntry_ *, get_DamageEntriesQueue, (app::DamageReceiver * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBD40, DealDamageOverTime *, get_DealDamageOverTime, (app::DamageReceiver * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, LimitedLifetime *, get_LimitedLifetime, (app::DamageReceiver * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0049F2B0, Collider *, get_Collider, (app::DamageReceiver * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD20, EntityTargetting *, get_Targetting, (app::DamageReceiver * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006A63A0, Action_1_Damage_ *, get_DamageReceived, (app::DamageReceiver * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CD31F0, DamageReceiver_DamageEntry *, AddDamage, (app::DamageReceiver * this_ptr, app::Damage * damage));
...
IL2CPP_REGISTER_METHOD(0x00CD35D0, DamageResult, ResolveDamage, (app::DamageReceiver * this_ptr, app::Damage * damage));
...
IL2CPP_REGISTER_METHOD(0x00CD4910, Transform *, SpawnEffect_1, (app::EffectSpawn prefab, app::Damage * damage, app::IDamageReciever * receiver, float rand, app::EffectTransformType__Enum override_transform_type));
IL2CPP_REGISTER_METHOD(0x00CD4B50, Transform *, SpawnEffect_2, (app::GameObject * prefab, app::Damage * damage, app::IDamageReciever * receiver, float rand, app::EffectTransformType__Enum transform_type, float offset_to_center, bool optional));
...
IL2CPP_REGISTER_METHOD(0x00CD59C0, String *, get_StressTestName, (app::DamageReceiver * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006B90B0, StressTestStatus__Enum, get_StressTestStatus, (app::DamageReceiver * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, get_VirtualTimelineTarget, (app::DamageReceiver * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420230, VirtualTimelineRepresentationGroup__Enum, get_VirtualTimelineGroup, (app::DamageReceiver * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CD5FD0, String *, get_NameDisplayedOnClip, (app::DamageReceiver * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CD60A0, void, __ctor, (app::DamageReceiver * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CD6770, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::DamageReceiver * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::DamageReceiver * this_ptr));
}
