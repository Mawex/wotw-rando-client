...
namespace app::methods::Moon_Timeline::EventTriggerGameplayAnimator {
    ...
    IL2CPP_REGISTER_METHOD(0x01BBDEC0, void, __ctor, (app::EventTriggerGameplayAnimator * this_ptr));
}
