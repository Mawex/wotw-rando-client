...
IL2CPP_REGISTER_METHOD(0x00660430, IBashAttackable *, get_PotentialFutureTarget, (app::SeinBashAttack * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005D06F0, CharacterLeftRightMovement *, get_LeftRightMovement, (app::SeinBashAttack * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D859C0, Component_1 *, get_TargetAsComponent, (app::SeinBashAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x005F0FF0, CharacterAirNoDeceleration *, get_AirNoDeceleration, (app::SeinBashAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A7EB40, SeinDoubleJump *, get_DoubleJump, (app::SeinBashAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x005F0FB0, CharacterApplyFrictionToSpeed *, get_ApplyFrictionToSpeed, (app::SeinBashAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x006E4240, CharacterGravity *, get_Gravity, (app::SeinBashAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D06F0, CharacterLeftRightMovement *, get_CharacterLeftRightMovement, (app::SeinBashAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A50B70, PlayerAbilities *, get_PlayerAbilities, (app::SeinBashAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement *, get_PlatformMovement, (app::SeinBashAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D85A80, SeinController *, get_SeinController, (app::SeinBashAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D85AA0, SeinBashAttackPuppet_SetElement__Enum, get_BashChargeAnimation, (app::SeinBashAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D85EC0, SeinBashAttackPuppet_SetElement__Enum, get_BashJumpAnimation, (app::SeinBashAttack * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D8E0B0, Guid, get_AttackableConsumerID, (app::SeinBashAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D8E0C0, void, set_AttackableConsumerID, (app::SeinBashAttack * this_ptr, app::Guid value));
IL2CPP_REGISTER_METHOD(0x00D8E0D0, IBashAttackable *, FindClosestAttackHandler, (app::SeinBashAttack * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D8E9C0, SeinBashAttackPuppet *, get_Puppet, (app::SeinBashAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D8EA80, void, __ctor, (app::SeinBashAttack * this_ptr));
