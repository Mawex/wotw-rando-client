...
namespace app::methods::UnityEngine_Events::UnityAction_1_System_Boolean_ {
    IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::UnityAction_1_System_Boolean_ * this_ptr, app::Object * object, void * method_1));
