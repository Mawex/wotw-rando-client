...
namespace app::methods::System_Configuration::ConfigurationCollectionAttribute {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::ConfigurationCollectionAttribute * this_ptr, app::Type * item_type));
