...
IL2CPP_REGISTER_METHOD(0x005D06C0, CharacterPlatformMovement *, get_PlatformMovement, (app::SeinSpriteRotationController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A79BE0, SeinCrouch *, get_Crouch, (app::SeinSpriteRotationController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A79C20, SeinStomp *, get_Stomp, (app::SeinSpriteRotationController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A79C60, SeinBashAttack *, get_BashAttack, (app::SeinSpriteRotationController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005C9550, void, __ctor, (app::SeinSpriteRotationController * this_ptr));
}
