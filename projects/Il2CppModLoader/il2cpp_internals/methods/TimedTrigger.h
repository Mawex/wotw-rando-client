...
namespace app::methods::TimedTrigger {
    ...
    IL2CPP_REGISTER_METHOD(0x006410F0, SuspendableMask__Enum, get_Mask, (app::TimedTrigger * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x010F48E0, void, __ctor, (app::TimedTrigger * this_ptr));
} // namespace app::methods::TimedTrigger
