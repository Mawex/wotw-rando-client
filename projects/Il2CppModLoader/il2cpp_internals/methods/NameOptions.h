...
IL2CPP_REGISTER_METHOD(0x00882390, void, ResetStatics, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x00882410, void, OnEnable, (NameOptions * __this));
IL2CPP_REGISTER_METHOD(0x00882C40, NameOptions_NameDatabase *, get_Database, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x00882DA0, NameOptions_NameDatabase *, LoadDatabase, (MethodInfo * method));
