...
namespace app::methods::System_Threading::ReaderWriterLockSlim {
IL2CPP_REGISTER_METHOD(0x02FD2290, void, InitializeThreadCounts, (app::ReaderWriterLockSlim * this_ptr));
IL2CPP_REGISTER_METHOD(0x02FD22A0, void, __ctor_1, (app::ReaderWriterLockSlim * this_ptr));
IL2CPP_REGISTER_METHOD(0x02FD2340, void, __ctor_2, (app::ReaderWriterLockSlim * this_ptr, app::LockRecursionPolicy__Enum recursion_policy));
...
IL2CPP_REGISTER_METHOD(0x02FD2460, ReaderWriterCount *, GetThreadRWCount, (app::ReaderWriterLockSlim * this_ptr, bool dont_allocate));
...
IL2CPP_REGISTER_METHOD(0x02FD38B0, bool, WaitOnEvent, (app::ReaderWriterLockSlim * this_ptr, app::EventWaitHandle * wait_event, app::uint32_t * num_waiters, app::ReaderWriterLockSlim_TimeoutTracker timeout, bool is_write_waiter));
