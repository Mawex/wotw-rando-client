...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::Animator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030800E0, Vector3, get_deltaPosition, (app::Animator * this_ptr));
IL2CPP_REGISTER_METHOD(0x03080160, Quaternion, get_deltaRotation, (app::Animator * this_ptr));
IL2CPP_REGISTER_METHOD(0x030801E0, Vector3, get_velocity, (app::Animator * this_ptr));
IL2CPP_REGISTER_METHOD(0x03080260, Vector3, get_angularVelocity, (app::Animator * this_ptr));
IL2CPP_REGISTER_METHOD(0x030802E0, Vector3, get_rootPosition, (app::Animator * this_ptr));
IL2CPP_REGISTER_METHOD(0x03080360, void, set_rootPosition, (app::Animator * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x030803C0, Quaternion, get_rootRotation, (app::Animator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030806D0, AnimatorUpdateMode__Enum, get_updateMode, (app::Animator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030808D0, Vector3, get_bodyPosition, (app::Animator * this_ptr));
IL2CPP_REGISTER_METHOD(0x03080960, void, set_bodyPosition, (app::Animator * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x030809E0, Vector3, get_bodyPositionInternal, (app::Animator * this_ptr));
IL2CPP_REGISTER_METHOD(0x03080A60, void, set_bodyPositionInternal, (app::Animator * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x03080AC0, Quaternion, get_bodyRotation, (app::Animator * this_ptr));
IL2CPP_REGISTER_METHOD(0x03080B50, void, set_bodyRotation, (app::Animator * this_ptr, app::Quaternion value));
IL2CPP_REGISTER_METHOD(0x03080BC0, Quaternion, get_bodyRotationInternal, (app::Animator * this_ptr));
IL2CPP_REGISTER_METHOD(0x03080C40, void, set_bodyRotationInternal, (app::Animator * this_ptr, app::Quaternion value));
IL2CPP_REGISTER_METHOD(0x03080CA0, Vector3, GetIKPosition, (app::Animator * this_ptr, app::AvatarIKGoal__Enum goal));
IL2CPP_REGISTER_METHOD(0x03080D40, Vector3, GetGoalPosition, (app::Animator * this_ptr, app::AvatarIKGoal__Enum goal));
...
IL2CPP_REGISTER_METHOD(0x03080ED0, Quaternion, GetIKRotation, (app::Animator * this_ptr, app::AvatarIKGoal__Enum goal));
IL2CPP_REGISTER_METHOD(0x03080F70, Quaternion, GetGoalRotation, (app::Animator * this_ptr, app::AvatarIKGoal__Enum goal));
...
IL2CPP_REGISTER_METHOD(0x03081470, Vector3, GetIKHintPosition, (app::Animator * this_ptr, app::AvatarIKHint__Enum hint));
IL2CPP_REGISTER_METHOD(0x03081510, Vector3, GetHintPosition, (app::Animator * this_ptr, app::AvatarIKHint__Enum hint));
...
IL2CPP_REGISTER_METHOD(0x03081DE0, ScriptableObject *, GetBehaviour_1, (app::Animator * this_ptr, app::Type * type));
IL2CPP_REGISTER_METHOD(0x03081E40, ScriptableObject__Array *, InternalGetBehaviours, (app::Animator * this_ptr, app::Type * type));
IL2CPP_REGISTER_METHOD(0x03081EA0, StateMachineBehaviour__Array *, GetBehaviours_1, (app::Animator * this_ptr, int32_t full_path_hash, int32_t layer_index));
IL2CPP_REGISTER_METHOD(0x03081FC0, ScriptableObject__Array *, InternalGetBehavioursByKey, (app::Animator * this_ptr, int32_t full_path_hash, int32_t layer_index, app::Type * type));
...
IL2CPP_REGISTER_METHOD(0x03082140, String *, GetLayerName, (app::Animator * this_ptr, int32_t layer_index));
...
IL2CPP_REGISTER_METHOD(0x03082350, AnimatorStateInfo, GetCurrentAnimatorStateInfo, (app::Animator * this_ptr, int32_t layer_index));
IL2CPP_REGISTER_METHOD(0x03082400, AnimatorStateInfo, GetNextAnimatorStateInfo, (app::Animator * this_ptr, int32_t layer_index));
...
IL2CPP_REGISTER_METHOD(0x03082520, AnimatorTransitionInfo, GetAnimatorTransitionInfo_2, (app::Animator * this_ptr, int32_t layer_index));
...
IL2CPP_REGISTER_METHOD(0x030826F0, AnimatorClipInfo__Array *, GetCurrentAnimatorClipInfo_1, (app::Animator * this_ptr, int32_t layer_index));
IL2CPP_REGISTER_METHOD(0x03082750, AnimatorClipInfo__Array *, GetNextAnimatorClipInfo_1, (app::Animator * this_ptr, int32_t layer_index));
...
IL2CPP_REGISTER_METHOD(0x03082910, AnimatorClipInfo__Array *, GetAnimatorClipInfoInternalWinRT, (app::Animator * this_ptr, int32_t layer_index, bool is_current));
...
IL2CPP_REGISTER_METHOD(0x03082AC0, AnimatorControllerParameter__Array *, get_parameters, (app::Animator * this_ptr));
IL2CPP_REGISTER_METHOD(0x03082B10, int32_t, get_parameterCount, (app::Animator * this_ptr));
IL2CPP_REGISTER_METHOD(0x03082B60, AnimatorControllerParameter *, GetParameter, (app::Animator * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x03082E30, Vector3, get_pivotPosition, (app::Animator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03084050, Vector3, get_targetPosition, (app::Animator * this_ptr));
IL2CPP_REGISTER_METHOD(0x030840D0, Quaternion, get_targetRotation, (app::Animator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030841B0, Transform *, get_avatarRoot, (app::Animator * this_ptr));
IL2CPP_REGISTER_METHOD(0x03084200, Transform *, GetBoneTransform, (app::Animator * this_ptr, app::HumanBodyBones__Enum human_bone_id));
IL2CPP_REGISTER_METHODINFO(0x04772100, Animator_GetBoneTransform__MethodInfo);
IL2CPP_REGISTER_METHOD(0x03084370, Transform *, GetBoneTransformInternal, (app::Animator * this_ptr, int32_t human_bone_id));
IL2CPP_REGISTER_METHOD(0x030843D0, AnimatorCullingMode__Enum, get_cullingMode, (app::Animator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03084720, AnimatorRecorderMode__Enum, get_recorderMode, (app::Animator * this_ptr));
IL2CPP_REGISTER_METHOD(0x03084770, RuntimeAnimatorController *, get_runtimeAnimatorController, (app::Animator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03084980, Avatar *, get_avatar, (app::Animator * this_ptr));
IL2CPP_REGISTER_METHOD(0x030849D0, void, set_avatar, (app::Animator * this_ptr, app::Avatar * value));
IL2CPP_REGISTER_METHOD(0x03084A30, String *, GetStats, (app::Animator * this_ptr));
IL2CPP_REGISTER_METHOD(0x03084A80, PlayableGraph, get_playableGraph, (app::Animator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030851A0, String *, GetCurrentStateName, (app::Animator * this_ptr, int32_t layer_index));
IL2CPP_REGISTER_METHOD(0x03085200, String *, GetNextStateName, (app::Animator * this_ptr, int32_t layer_index));
IL2CPP_REGISTER_METHOD(0x03085260, String *, GetAnimatorStateName, (app::Animator * this_ptr, int32_t layer_index, bool current));
IL2CPP_REGISTER_METHOD(0x030852D0, String *, ResolveHash, (app::Animator * this_ptr, int32_t hash));
...
IL2CPP_REGISTER_METHOD(0x03085540, Vector3, GetVector_1, (app::Animator * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x030855F0, Vector3, GetVector_2, (app::Animator * this_ptr, int32_t id));
...
IL2CPP_REGISTER_METHOD(0x030856A0, Quaternion, GetQuaternion_1, (app::Animator * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x03085750, Quaternion, GetQuaternion_2, (app::Animator * this_ptr, int32_t id));
...
IL2CPP_REGISTER_METHOD(0x0157BF50, Object *, GetBehaviour_2, (app::Animator * this_ptr));
IL2CPP_REGISTER_METHOD(0x02FF5AD0, Object__Array *, ConvertStateMachineBehaviour, (app::ScriptableObject__Array * raw_objects));
IL2CPP_REGISTER_METHOD(0x02FF5BF0, Object__Array *, GetBehaviours_2, (app::Animator * this_ptr));
}
