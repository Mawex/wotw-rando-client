...
namespace app::methods::System_Security_Cryptography::AsymmetricSignatureFormatter {
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::AsymmetricSignatureFormatter * this_ptr));
