...
namespace app::methods::SeinLever {
    ...
    IL2CPP_REGISTER_METHOD(0x01023F30, SeinLeverPuppet*, get_Puppet, (app::SeinLever * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FBCA0, ILever*, get_CurrentLever, (app::SeinLever * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00660200, StressTestStatus__Enum, get_StressTestStatus, (app::SeinLever * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01027FD0, ILever*, GetValidStressTestLever, (app::SeinLever * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00417870, bool, get_StopMovingPlayerWhilePerforming, (app::SeinLever * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01028340, String*, get_StressTestName, (app::SeinLever * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005C9550, void, __ctor, (app::SeinLever * this_ptr));
} // namespace app::methods::SeinLever
