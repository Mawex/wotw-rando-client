...
namespace app::methods::Moon_Rendering::RuntimeSliceRenderSettings {
IL2CPP_REGISTER_METHOD(0x002FA280, SceneDefaultSettingsHelper *, get_DefaultSettingsHelper, (app::RuntimeSliceRenderSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00EB3E80, SliceRenderSettings *, GetSliceRenderSettings, (app::RuntimeSliceRenderSettings * this_ptr, app::SceneSettings * setting));
...
IL2CPP_REGISTER_METHOD(0x00EB5990, void, __ctor, (app::RuntimeSliceRenderSettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x00EB5AE0, void, __cctor, ());
}
