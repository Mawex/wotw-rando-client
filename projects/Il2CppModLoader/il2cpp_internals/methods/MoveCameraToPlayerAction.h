...
IL2CPP_REGISTER_METHOD(0x008685B0, String *, GetNiceName, (app::MoveCameraToPlayerAction * this_ptr));
IL2CPP_REGISTER_METHOD(0x0043BB90, void, __ctor, (app::MoveCameraToPlayerAction * this_ptr));
}
