...
IL2CPP_REGISTER_METHOD(0x00CC97F0, Vector3, get_m_targetPos, (app::CrabBackpedalChaseBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CC9DC0, BehaviourStatus__Enum, OnExecute, (app::CrabBackpedalChaseBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00CCA630, void, __ctor, (app::CrabBackpedalChaseBehaviour * this_ptr));
}
