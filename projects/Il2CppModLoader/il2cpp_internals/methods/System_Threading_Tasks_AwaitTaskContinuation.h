...
IL2CPP_REGISTER_METHOD(0x0232EAA0, bool, get_IsValidLocationForInlining, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x0232EE40, ContextCallback *, GetInvokeActionCallback, (MethodInfo * method));
