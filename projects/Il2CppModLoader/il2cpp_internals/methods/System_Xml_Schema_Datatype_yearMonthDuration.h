...
IL2CPP_REGISTER_METHOD(0x00E406F0, XmlTypeCode__Enum, get_TypeCode, (Datatype_yearMonthDuration * __this));
IL2CPP_REGISTER_METHOD(0x023641D0, void, __ctor, (Datatype_yearMonthDuration * __this));
}
