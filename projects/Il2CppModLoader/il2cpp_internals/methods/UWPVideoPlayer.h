...
IL2CPP_REGISTER_METHOD(0x002FA280, OnDelegate *, get_OnPlaybackFinished, (app::UWPVideoPlayer * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_OnPlaybackFinished, (app::UWPVideoPlayer * this_ptr, app::OnDelegate * value));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Filename, (app::UWPVideoPlayer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::UWPVideoPlayer * this_ptr));
}
