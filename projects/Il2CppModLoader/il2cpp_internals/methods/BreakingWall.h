...
namespace app::methods::BreakingWall {
    ...
    IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::BreakingWall * this_ptr));
    IL2CPP_REGISTER_METHOD(0x004F4750, GameObject*, IDamageReciever_get_gameObject, (app::BreakingWall * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00506170, Transform*, IDamageReciever_get_transform, (app::BreakingWall * this_ptr));
} // namespace app::methods::BreakingWall
