...
namespace app::methods::Ionic_Zlib::InflateManager {
IL2CPP_REGISTER_METHOD(0x0052A050, bool, get_HandleRfc1950HeaderBytes, (app::InflateManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x0052A060, void, __ctor, (app::InflateManager * this_ptr, bool expect_rfc1950_header_bytes));
...
IL2CPP_REGISTER_METHOD(0x03075000, void, __cctor, ());
}
