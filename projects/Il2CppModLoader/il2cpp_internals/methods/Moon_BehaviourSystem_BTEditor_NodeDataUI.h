...
namespace app::methods::Moon_BehaviourSystem_BTEditor::NodeDataUI {
IL2CPP_REGISTER_METHOD(0x002FA280, BehaviourNode *, get_Node, (app::NodeDataUI * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E71230, Vector2, get_Position, (app::NodeDataUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E71250, void, set_Position, (app::NodeDataUI * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x010655D0, Vector2, get_Size, (app::NodeDataUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x010655F0, void, set_Size, (app::NodeDataUI * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x031C07D0, Rect, get_Rect, (app::NodeDataUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x02071D00, void, set_Rect, (app::NodeDataUI * this_ptr, app::Rect value));
IL2CPP_REGISTER_METHOD(0x005C3FE0, Color, get_NodeColor, (app::NodeDataUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x0060A8A0, void, set_NodeColor, (app::NodeDataUI * this_ptr, app::Color value));
IL2CPP_REGISTER_METHOD(0x002FB9D0, String *, get_Name, (app::NodeDataUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9E0, void, set_Name, (app::NodeDataUI * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB9F0, String *, get_Comments, (app::NodeDataUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBA00, void, set_Comments, (app::NodeDataUI * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x031C0820, void, __ctor_1, (app::NodeDataUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x031C0840, void, __ctor_2, (app::NodeDataUI * this_ptr, int32_t id));
IL2CPP_REGISTER_METHOD(0x031C0860, void, __ctor_3, (app::NodeDataUI * this_ptr, int32_t id, app::BehaviourNode * node));
