...
namespace app::methods::System_Collections::Hashtable_KeyCollection {
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::Hashtable_KeyCollection * this_ptr, app::Hashtable * hashtable));
...
IL2CPP_REGISTER_METHOD(0x02027930, IEnumerator *, GetEnumerator, (app::Hashtable_KeyCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x017174B0, bool, get_IsSynchronized, (app::Hashtable_KeyCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x016FBED0, Object *, get_SyncRoot, (app::Hashtable_KeyCollection * this_ptr));
