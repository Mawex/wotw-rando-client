...
namespace app::methods::PlayFab_Public::PlayFabLoggerBase {
IL2CPP_REGISTER_METHOD(0x002FB9B0, IPAddress *, get_ip, (app::PlayFabLoggerBase * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9F0, String *, get_url, (app::PlayFabLoggerBase * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01AD1940, IEnumerator *, RegisterLogger, (app::PlayFabLoggerBase * this_ptr));
