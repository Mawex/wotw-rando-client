...
namespace app::methods::System_Xml::XmlEncodedRawTextWriterIndent {
IL2CPP_REGISTER_METHOD(0x01DB4830, void, __ctor_1, (app::XmlEncodedRawTextWriterIndent * this_ptr, app::TextWriter * writer, app::XmlWriterSettings * settings));
IL2CPP_REGISTER_METHOD(0x01DB4860, void, __ctor_2, (app::XmlEncodedRawTextWriterIndent * this_ptr, app::Stream * stream, app::XmlWriterSettings * settings));
