...
namespace app::methods::System_Net::BaseLoggingObject {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::BaseLoggingObject * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, Dump_4, (app::BaseLoggingObject * this_ptr, app::void * p_buffer, int32_t offset, int32_t length));
}
