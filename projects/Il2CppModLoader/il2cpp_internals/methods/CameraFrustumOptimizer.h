...
IL2CPP_REGISTER_METHOD(0x0168A790, Bounds, GetExtendedBounds, (app::IFrustumOptimizable * o, float expansion_amount));
...
IL2CPP_REGISTER_METHOD(0x0168C6F0, Vector3, get_LastCameraTestPosition, (app::CameraFrustumOptimizer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0168FAD0, CameraFrustumOptimizer_IntersectionResult__Enum, ProcessFrustumOptimizable_1, (app::CameraFrustumOptimizer * this_ptr, app::IFrustumOptimizable * o, uint8_t inside, bool is_first_time, bool instant));
IL2CPP_REGISTER_METHOD(0x0168FAF0, CameraFrustumOptimizer_IntersectionResult__Enum, ProcessFrustumOptimizable_2, (app::CameraFrustumOptimizer * this_ptr, app::IFrustumOptimizable * o, app::Bounds bounds, app::CameraController_1 * camera_controller, bool is_first_time, bool instant));
IL2CPP_REGISTER_METHOD(0x0168FBD0, CameraFrustumOptimizer_IntersectionResult__Enum, ProcessFrustumOptimizableMultiCam, (app::CameraFrustumOptimizer * this_ptr, app::IFrustumOptimizable * o, app::Bounds bounds, bool is_first_time, bool instant));
IL2CPP_REGISTER_METHOD(0x0168FC50, CameraFrustumOptimizer_IntersectionResult__Enum, HandleIntersectionResults, (app::CameraFrustumOptimizer * this_ptr, app::IFrustumOptimizable * o, bool inside, bool is_first_time, bool instant));
...
IL2CPP_REGISTER_METHOD(0x00AB5740, void, __ctor, (app::CameraFrustumOptimizer * this_ptr));
