...
namespace app::methods::Moon_Timeline::EulerXYZRotationTweenAnimator {
IL2CPP_REGISTER_METHOD(0x01BBA1A0, Transform *, get_TransformTarget, (app::EulerXYZRotationTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BBA230, GameObject *, get_ExternalTarget, (app::EulerXYZRotationTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, OnEntityCreated, (app::EulerXYZRotationTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BBA2E0, Transform *, get_EffectiveTransform, (app::EulerXYZRotationTweenAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BBAA50, Quaternion, GetCurrentRotation, (app::EulerXYZRotationTweenAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC20, MoonReference_1_UnityEngine_Transform_ *, GetTransformTarget, (app::EulerXYZRotationTweenAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BBB640, bool, ApproximateEvent, (app::EulerXYZRotationTweenAnimator * this_ptr, int32_t evt, app::float * time));
IL2CPP_REGISTER_METHOD(0x01BBB890, void, __ctor, (app::EulerXYZRotationTweenAnimator * this_ptr));
}
