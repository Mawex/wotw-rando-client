...
IL2CPP_REGISTER_METHOD(0x0070DEC0, SuspendableMask__Enum, get_Mask, (app::JumpFlipPlatform * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E4BDE0, void, set_Mask, (app::JumpFlipPlatform * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x00E4BEA0, void, __ctor, (app::JumpFlipPlatform * this_ptr));
