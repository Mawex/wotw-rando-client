...
namespace app::methods::UnityEngine_UI::Text {
IL2CPP_REGISTER_METHOD(0x026793B0, void, __ctor, (app::Text * this_ptr));
IL2CPP_REGISTER_METHOD(0x02679480, TextGenerator *, get_cachedTextGenerator, (app::Text * this_ptr));
IL2CPP_REGISTER_METHOD(0x026796E0, TextGenerator *, get_cachedTextGeneratorForLayout, (app::Text * this_ptr));
IL2CPP_REGISTER_METHOD(0x02679850, Texture *, get_mainTexture, (app::Text * this_ptr));
IL2CPP_REGISTER_METHOD(0x02679BC0, void, FontTextureChanged, (app::Text * this_ptr));
IL2CPP_REGISTER_METHOD(0x02679DC0, Font *, get_font, (app::Text * this_ptr));
IL2CPP_REGISTER_METHOD(0x02679DE0, void, set_font, (app::Text * this_ptr, app::Font * value));
IL2CPP_REGISTER_METHOD(0x02679F10, String *, get_text, (app::Text * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0267A240, TextAnchor__Enum, get_alignment, (app::Text * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0267A3B0, HorizontalWrapMode__Enum, get_horizontalOverflow, (app::Text * this_ptr));
IL2CPP_REGISTER_METHOD(0x0267A3D0, void, set_horizontalOverflow, (app::Text * this_ptr, app::HorizontalWrapMode__Enum value));
IL2CPP_REGISTER_METHOD(0x0267A430, VerticalWrapMode__Enum, get_verticalOverflow, (app::Text * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0267A540, FontStyle__Enum, get_fontStyle, (app::Text * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0267AD90, TextGenerationSettings, GetGenerationSettings, (app::Text * this_ptr, app::Vector2 extents));
IL2CPP_REGISTER_METHOD(0x0267B090, Vector2, GetTextAnchorPivot, (app::TextAnchor__Enum anchor));
