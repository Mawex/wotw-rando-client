...
namespace app::methods::System_Diagnostics_Tracing::EnumUInt64TypeInfo_1_System_UInt16_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0298B8E0, void, __ctor, (app::EnumUInt64TypeInfo_1_System_UInt16_ * this_ptr));
}
