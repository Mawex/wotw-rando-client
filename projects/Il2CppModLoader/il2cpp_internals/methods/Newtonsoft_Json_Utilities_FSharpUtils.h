...
namespace app::methods::Newtonsoft_Json_Utilities::FSharpUtils {
...
IL2CPP_REGISTER_METHOD(0x01C12F10, MethodInfo_1 *, GetMethodWithNonPublicFallback, (app::Type * type, app::String * method_name, app::BindingFlags__Enum binding_flags));
IL2CPP_REGISTER_METHOD(0x01C12FF0, MethodCall_2_System_Object_System_Object_ *, CreateFSharpFuncCall, (app::Type * type, app::String * method_name));
IL2CPP_REGISTER_METHOD(0x01C13340, ObjectConstructor_1_System_Object_ *, CreateSeq, (app::Type * t));
IL2CPP_REGISTER_METHOD(0x01C134D0, ObjectConstructor_1_System_Object_ *, CreateMap, (app::Type * key_type, app::Type * value_type));
