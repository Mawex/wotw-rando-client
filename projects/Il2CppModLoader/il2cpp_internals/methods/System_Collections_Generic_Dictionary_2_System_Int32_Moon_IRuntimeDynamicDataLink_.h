...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_Int32_Moon_IRuntimeDynamicDataLink_ {
IL2CPP_REGISTER_METHOD(0x02BA5400, Dictionary_2_TKey_TValue_Enumerator_System_Int32_Moon_IRuntimeDynamicDataLink_, GetEnumerator, (app::Dictionary_2_System_Int32_Moon_IRuntimeDynamicDataLink_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047451A0, Dictionary_2_System_Int32_Moon_IRuntimeDynamicDataLink__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor_1, (app::Dictionary_2_System_Int32_Moon_IRuntimeDynamicDataLink_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0283AC50, void, __ctor_2, (app::Dictionary_2_System_Int32_Moon_IRuntimeDynamicDataLink_ * this_ptr, app::IEqualityComparer_1_System_Int32_ * comparer));
...
IL2CPP_REGISTER_METHOD(0x02BB8880, IRuntimeDynamicDataLink *, get_Item, (app::Dictionary_2_System_Int32_Moon_IRuntimeDynamicDataLink_ * this_ptr, int32_t key));
