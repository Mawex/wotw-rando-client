...
namespace app::methods::System_IO::Stream_SynchronousAsyncResult {
...
IL2CPP_REGISTER_METHOD(0x0237F330, WaitHandle *, get_AsyncWaitHandle, (app::Stream_SynchronousAsyncResult * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA280, Object *, get_AsyncState, (app::Stream_SynchronousAsyncResult * this_ptr));
