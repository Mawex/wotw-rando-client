...
namespace app::methods::Moon_ExposedPropertiesInspector::ExposedPropertyGroup {
    ...
    IL2CPP_REGISTER_METHOD(0x031C2A30, void, __ctor, (app::ExposedPropertyGroup * this_ptr));
}
