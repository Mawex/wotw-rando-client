...
IL2CPP_REGISTER_METHOD(0x006331F0, InstantiationHistory *, get_Instance, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x00633290, bool, get_Enabled, (MethodInfo * method));
