...
namespace app::methods::System_Collections_Concurrent::ConcurrentBag_1_System_Object_ {
...
IL2CPP_REGISTER_METHOD(0x02ADC210, Object *, ICollection_get_SyncRoot, (app::ConcurrentBag_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA280, Object *, get_GlobalQueuesLock, (app::ConcurrentBag_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02776BF0, void, __ctor, (app::ConcurrentBag_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02ADB190, ConcurrentBag_1_T_WorkStealingQueue_System_Object_ *, GetCurrentThreadWorkStealingQueue, (app::ConcurrentBag_1_System_Object_ * this_ptr, bool force_create));
IL2CPP_REGISTER_METHOD(0x02ADB210, ConcurrentBag_1_T_WorkStealingQueue_System_Object_ *, CreateWorkStealingQueueForCurrentThread, (app::ConcurrentBag_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02ADB4A0, ConcurrentBag_1_T_WorkStealingQueue_System_Object_ *, GetUnownedWorkStealingQueue, (app::ConcurrentBag_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02ADBC90, Object__Array *, ToArray, (app::ConcurrentBag_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02ADBE50, IEnumerator_1_System_Object_ *, GetEnumerator, (app::ConcurrentBag_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02ADBFA0, IEnumerator *, IEnumerable_GetEnumerator, (app::ConcurrentBag_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02ADC270, void, FreezeBag, (app::ConcurrentBag_1_System_Object_ * this_ptr, app::bool * lock_taken));
