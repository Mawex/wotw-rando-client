...
namespace app::methods::System_Configuration::IriParsingElement {
IL2CPP_REGISTER_METHOD(0x02961C60, void, __ctor, (app::IriParsingElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02961CF0, ConfigurationPropertyCollection *, get_Properties, (app::IriParsingElement * this_ptr));
