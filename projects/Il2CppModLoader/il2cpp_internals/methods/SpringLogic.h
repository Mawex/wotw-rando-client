...
namespace app::methods::SpringLogic {
    IL2CPP_REGISTER_METHOD(0x002FB9B0, IMoonSetupAnimator*, get_MoonSetupAnimator, (app::SpringLogic * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x009A8220, void, __ctor, (app::SpringLogic * this_ptr));
} // namespace app::methods::SpringLogic
