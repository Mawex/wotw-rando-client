...
namespace app::methods::Mono_Security_Cryptography::MD4Managed {
IL2CPP_REGISTER_METHOD(0x025CF410, void, __ctor_1, (app::MD4Managed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025CF870, Byte__Array *, HashFinal_1, (app::MD4Managed * this_ptr));
IL2CPP_REGISTER_METHOD(0x025CFA80, Byte__Array *, Padding_1, (app::MD4Managed * this_ptr, int32_t n_length));
...
IL2CPP_REGISTER_METHOD(0x025CFB80, void, FF_1, (app::MD4Managed * this_ptr, app::uint32_t * a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint8_t s));
IL2CPP_REGISTER_METHOD(0x025CFBC0, void, GG_1, (app::MD4Managed * this_ptr, app::uint32_t * a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint8_t s));
IL2CPP_REGISTER_METHOD(0x025CFC10, void, HH_1, (app::MD4Managed * this_ptr, app::uint32_t * a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint8_t s));
...
IL2CPP_REGISTER_METHOD(0x02A3DBE0, void, __ctor_2, (app::MD4Managed_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A3DCE0, Byte__Array *, HashFinal_2, (app::MD4Managed_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A3DEF0, Byte__Array *, Padding_2, (app::MD4Managed_1 * this_ptr, int32_t n_length));
...
IL2CPP_REGISTER_METHOD(0x025CFB80, void, FF_2, (app::MD4Managed_1 * this_ptr, app::uint32_t * a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint8_t s));
IL2CPP_REGISTER_METHOD(0x025CFBC0, void, GG_2, (app::MD4Managed_1 * this_ptr, app::uint32_t * a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint8_t s));
IL2CPP_REGISTER_METHOD(0x025CFC10, void, HH_2, (app::MD4Managed_1 * this_ptr, app::uint32_t * a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint8_t s));
