...
IL2CPP_REGISTER_METHOD(0x0064EB90, Vector3, get_TargetValue, (app::VectorAnimationParameter_Instance * this_ptr));
IL2CPP_REGISTER_METHOD(0x02125970, void, set_TargetValue, (app::VectorAnimationParameter_Instance * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x00446940, Vector3, get_CurrentValue, (app::VectorAnimationParameter_Instance * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x021259C0, void, __ctor, (app::VectorAnimationParameter_Instance * this_ptr, app::VectorAnimationParameter * parameter));
