...
namespace app::methods::System_Xml::XmlQualifiedName {
IL2CPP_REGISTER_METHOD(0x016FF860, void, __ctor_1, (app::XmlQualifiedName * this_ptr));
IL2CPP_REGISTER_METHOD(0x016FF8F0, void, __ctor_2, (app::XmlQualifiedName * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x016FF990, void, __ctor_3, (app::XmlQualifiedName * this_ptr, app::String * name, app::String * ns));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Namespace, (app::XmlQualifiedName * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_Name, (app::XmlQualifiedName * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x016FFBF0, String *, ToString_1, (app::XmlQualifiedName * this_ptr));
IL2CPP_REGISTER_METHOD(0x016FFCA0, bool, Equals, (app::XmlQualifiedName * this_ptr, app::Object * other));
IL2CPP_REGISTER_METHOD(0x016FFE20, bool, operator____1, (app::XmlQualifiedName * a, app::XmlQualifiedName * b));
IL2CPP_REGISTER_METHOD(0x016FFEC0, bool, operator____2, (app::XmlQualifiedName * a, app::XmlQualifiedName * b));
IL2CPP_REGISTER_METHOD(0x016FFF70, String *, ToString_2, (app::String * name, app::String * ns));
...
IL2CPP_REGISTER_METHOD(0x01700410, XmlQualifiedName *, Parse, (app::String * s, app::IXmlNamespaceResolver * nsmgr, app::String * * prefix));
IL2CPP_REGISTER_METHODINFO(0x04707650, XmlQualifiedName_Parse__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01700630, XmlQualifiedName *, Clone, (app::XmlQualifiedName * this_ptr));
