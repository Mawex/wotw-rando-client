...
IL2CPP_REGISTER_METHOD(0x00D7FEE0, SeinAbilityRestrictZoneMask__Enum, get_Mask, (app::SeinAbilityRestrictZone * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D80A60, CharacterGravity *, get_Gravity, (app::SeinAbilityRestrictZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D80B90, CharacterLeftRightMovement *, get_LeftRightMovement, (app::SeinAbilityRestrictZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D80CC0, PlatformMovement *, get_PlatformMovement, (app::SeinAbilityRestrictZone * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D82070, AnimationSwapSet *, get_CurrentSet, (app::SeinAbilityRestrictZone * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D82A30, HorizontalPlatformMovementSettings *, AdjustForNormalizedValues, (app::SeinAbilityRestrictZone * this_ptr, app::HorizontalPlatformMovementSettings * setting));
...
IL2CPP_REGISTER_METHOD(0x00CB5CD0, Rect, get_Bounds, (app::SeinAbilityRestrictZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D83230, Vector2, GetSize, (app::SeinAbilityRestrictZone * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, get_VirtualTimelineTarget, (app::SeinAbilityRestrictZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417920, VirtualTimelineRepresentationGroup__Enum, get_VirtualTimelineGroup, (app::SeinAbilityRestrictZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D83770, String *, get_NameDisplayedOnClip, (app::SeinAbilityRestrictZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D837F0, SeinAbilityRestrictZoneMask__Enum, ButtonToRestrictZoneMask, (app::Input_Command__Enum button));
...
IL2CPP_REGISTER_METHOD(0x00D83F30, void, __ctor, (app::SeinAbilityRestrictZone * this_ptr));
