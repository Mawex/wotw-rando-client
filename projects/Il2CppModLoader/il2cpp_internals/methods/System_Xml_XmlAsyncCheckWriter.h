...
namespace app::methods::System_Xml::XmlAsyncCheckWriter {
IL2CPP_REGISTER_METHOD(0x0195A260, void, __ctor, (app::XmlAsyncCheckWriter * this_ptr, app::XmlWriter * writer));
...
IL2CPP_REGISTER_METHOD(0x0195AB90, WriteState__Enum, get_WriteState, (app::XmlAsyncCheckWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0195AC50, String *, LookupPrefix, (app::XmlAsyncCheckWriter * this_ptr, app::String * ns));
