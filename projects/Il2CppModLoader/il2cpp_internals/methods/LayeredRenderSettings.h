...
IL2CPP_REGISTER_METHOD(0x00F26840, LayeredRenderSettings_LayerParams__Array *, get_Layers, (app::LayeredRenderSettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x00F26BB0, float, get_FarPlane, (app::LayeredRenderSettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x00F26BE0, LayeredRenderSettings_LayerParams__Array *, GetLayersForOverride, (app::LayeredRenderSettings * this_ptr, app::LayeredRenderSettings_LayeredRenderSettingsPlatformOverride__Enum override_platform));
IL2CPP_REGISTER_METHOD(0x00F26CC0, void, CopyFrom, (app::LayeredRenderSettings * this_ptr, app::LayeredRenderSettings * copy));
IL2CPP_REGISTER_METHOD(0x00F27010, void, __ctor, (app::LayeredRenderSettings * this_ptr, app::LayeredRenderSettings * copy));
...
IL2CPP_REGISTER_METHOD(0x00F28100, LayeredRenderSettings_LayeredRenderSettingsOverride, EvaluateOverride, (app::LayeredRenderSettings * this_ptr));
