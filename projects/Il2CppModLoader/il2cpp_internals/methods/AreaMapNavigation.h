...
IL2CPP_REGISTER_METHOD(0x0050F340, Vector2, get_ScrollPosition, (app::AreaMapNavigation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005100D0, Vector3, GetTargetPosition, (app::AreaMapNavigation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00510800, Bounds, get_Bounds, (app::AreaMapNavigation * this_ptr));
IL2CPP_REGISTER_METHOD(0x00510820, void, set_Bounds, (app::AreaMapNavigation * this_ptr, app::Bounds value));
IL2CPP_REGISTER_METHOD(0x00510840, Vector2, get_MapPlanePosition, (app::AreaMapNavigation * this_ptr));
IL2CPP_REGISTER_METHOD(0x00510950, void, set_MapPlanePosition, (app::AreaMapNavigation * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x00510A70, Vector2, get_MapPlaneSize, (app::AreaMapNavigation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00510F40, Nullable_1_UnityEngine_Vector2_, get_RetainedPosition, (app::AreaMapNavigation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00511BA0, Vector3, WorldToMapPosition, (app::AreaMapNavigation * this_ptr, app::Vector2 position));
IL2CPP_REGISTER_METHOD(0x00511CF0, Vector3, MapToWorldPosition, (app::AreaMapNavigation * this_ptr, app::Vector2 position));
IL2CPP_REGISTER_METHOD(0x00511EF0, void, HandleMapScrolling, (app::AreaMapNavigation * this_ptr));
IL2CPP_REGISTER_METHOD(0x005128E0, Vector3, ConstrainWorldPositionByBounds, (app::AreaMapNavigation * this_ptr, app::Vector3 world_position));
...
IL2CPP_REGISTER_METHOD(0x005135A0, void, __ctor, (app::AreaMapNavigation * this_ptr));
}
