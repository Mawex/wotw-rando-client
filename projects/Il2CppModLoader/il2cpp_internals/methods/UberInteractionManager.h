...
IL2CPP_REGISTER_METHOD(0x013F7820, UberInteractionManager_PropertyIDCache *, GetCachedPropertyID, (app::UberInteractionManager_PropertyIDCache * * static_cache, app::String * property_interaction_name));
...
IL2CPP_REGISTER_METHOD(0x013FB020, void, ResolveActorVsInteraction, (app::UberInteractionManager * this_ptr, int32_t interaction_index, app::UberInteractionActor * actor, app::Vector3 * actor_position, app::Vector3 * prev_actor_position, app::Vector4 * strength, app::Vector3 * velocity, float radius, float z_radius, float z_scale, app::bool * had_overlap));
...
IL2CPP_REGISTER_METHOD(0x013FDB70, void, __ctor, (app::UberInteractionManager * this_ptr));
