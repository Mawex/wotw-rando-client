...
IL2CPP_REGISTER_METHOD(0x002FBC20, LayeredRenderSettings *, get_LayeredRenderSettings, (app::DepthOfFieldAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC00, SliceRenderSettings *, get_SliceRenderInfluenceSettings, (app::DepthOfFieldAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008556D0, SliceRenderSettingsInfluencerOrder__Enum, get_SliceRenderInfluenceOrder, (app::DepthOfFieldAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B83BE0, void, __ctor, (app::DepthOfFieldAnimator * this_ptr));
}
