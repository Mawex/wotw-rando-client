...
IL2CPP_REGISTER_METHOD(0x002FD750, SuspendableMask__Enum, get_Mask, (app::RiseSinkPlatform * this_ptr));
IL2CPP_REGISTER_METHOD(0x013559D0, void, set_Mask, (app::RiseSinkPlatform * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x01355A80, void, __ctor, (app::RiseSinkPlatform * this_ptr));
}
