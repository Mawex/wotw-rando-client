...
IL2CPP_REGISTER_METHOD(0x002FBC60, LegacyTimelineSequence *, get_EffectiveLandSequence, (app::ReactionFallingBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00730AB0, MoonTimeline *, get_EffectiveLandSequenceNew, (app::ReactionFallingBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007312B0, BehaviourStatus__Enum, OnExecuteTask, (app::ReactionFallingBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00733FD0, void, __ctor, (app::ReactionFallingBehaviour * this_ptr));
