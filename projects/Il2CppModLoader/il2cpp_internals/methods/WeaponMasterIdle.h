...
IL2CPP_REGISTER_METHOD(0x008E86A0, WeaponMasterEntity *, get_m_weaponMaster, (app::WeaponMasterIdle * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, BehaviourStatus__Enum, OnExecuteTask, (app::WeaponMasterIdle * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x008E9130, MoonTimeline *, GetIdleTimeline, (app::WeaponMasterIdle * this_ptr));
IL2CPP_REGISTER_METHOD(0x005B3EC0, void, __ctor, (app::WeaponMasterIdle * this_ptr));
}
