...
namespace app::methods::Recorder {
    ...
    IL2CPP_REGISTER_METHOD(0x008E9D60, RecorderFrame*, get_CurrentFrame, (app::Recorder_1 * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x008EC160, IEnumerator*, ResetRecorderAndComponents, (app::Recorder_1 * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x008EDA80, void, __ctor, (app::Recorder_1 * this_ptr));
    IL2CPP_REGISTER_METHOD(0x008EDBF0, void, __cctor, ());
    IL2CPP_REGISTER_METHOD(0x016AA670, Object*, GetPlugin, ());
    IL2CPP_REGISTER_METHOD(0x016AA2E0, Object*, GetFrameData_1, (int32_t frame));
    IL2CPP_REGISTER_METHOD(0x016AA2E0, CharacterData*, GetFrameData_2, (int32_t frame));
    IL2CPP_REGISTER_METHODINFO(0x04793A00, Recorder_1_GetFrameData_1__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x016AA2E0, BuildData*, GetFrameData_3, (int32_t frame));
