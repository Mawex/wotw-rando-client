...
namespace app::methods::System_ComponentModel::BooleanConverter {
...
IL2CPP_REGISTER_METHOD(0x024A5230, Object *, ConvertFrom, (app::BooleanConverter * this_ptr, app::ITypeDescriptorContext * context, app::CultureInfo * culture, app::Object * value));
IL2CPP_REGISTER_METHODINFO(0x04768060, BooleanConverter_ConvertFrom__MethodInfo);
IL2CPP_REGISTER_METHOD(0x024A5440, TypeConverter_StandardValuesCollection *, GetStandardValues, (app::BooleanConverter * this_ptr, app::ITypeDescriptorContext * context));
...
IL2CPP_REGISTER_METHOD(0x024A56D0, void, __ctor, (app::BooleanConverter * this_ptr));
}
