...
namespace app::methods::System_Collections_Concurrent::ConcurrentDictionary_2_System_Guid_System_Int32_ {
...
IL2CPP_REGISTER_METHOD(0x02AE42E0, bool, TryRemove, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr, app::Guid key, app::int32_t * value));
...
IL2CPP_REGISTER_METHOD(0x02ADDC30, void, __ctor_1, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04779B50, ConcurrentDictionary_2_System_Guid_System_Int32___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02AE5130, KeyValuePair_2_System_Guid_System_Int32___Array *, ToArray, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AE3C30, void, __ctor_2, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr, int32_t concurrency_level, int32_t capacity, bool grow_lock_array, app::IEqualityComparer_1_System_Guid_ * comparer));
...
IL2CPP_REGISTER_METHOD(0x02AE4330, bool, TryRemoveInternal, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr, app::Guid key, app::int32_t * value, bool match_value, int32_t old_value));
IL2CPP_REGISTER_METHOD(0x02ADEA70, bool, TryGetValue, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr, app::Guid key, app::int32_t * value));
IL2CPP_REGISTER_METHOD(0x02AE4900, bool, TryGetValueInternal, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr, app::Guid key, int32_t hashcode, app::int32_t * value));
...
IL2CPP_REGISTER_METHOD(0x02AE57F0, IEnumerator_1_KeyValuePair_2_System_Guid_System_Int32_ *, GetEnumerator, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02AE5920, bool, TryAddInternal, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr, app::Guid key, int32_t hashcode, int32_t value, bool update_if_exists, bool acquire_lock, app::int32_t * resulting_value));
...
IL2CPP_REGISTER_METHOD(0x02AE0FC0, ICollection_1_System_Guid_ *, get_Keys, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02AE0FC0, IEnumerable_1_System_Guid_ *, System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Keys, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02AE0FF0, ICollection_1_System_Int32_ *, get_Values, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02AE0FF0, IEnumerable_1_System_Int32_ *, System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Values, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AE1230, IEnumerator *, IEnumerable_GetEnumerator, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AE16A0, IDictionaryEnumerator *, IDictionary_GetEnumerator, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AE0FC0, ICollection *, IDictionary_get_Keys, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AE0FF0, ICollection *, IDictionary_get_Values, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02AE7210, Object *, IDictionary_get_Item, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr, app::Object * key));
...
IL2CPP_REGISTER_METHOD(0x02AE7AE0, Object *, ICollection_get_SyncRoot, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AE8620, void, AcquireAllLocks, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr, app::int32_t * locks_acquired));
IL2CPP_REGISTER_METHOD(0x02AE87F0, void, AcquireLocks, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr, int32_t from_inclusive, int32_t to_exclusive, app::int32_t * locks_acquired));
...
IL2CPP_REGISTER_METHOD(0x02AE8940, ReadOnlyCollection_1_System_Guid_ *, GetKeys, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0477B370, ConcurrentDictionary_2_System_Guid_System_Int32__GetKeys__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02AE8DD0, ReadOnlyCollection_1_System_Int32_ *, GetValues, (app::ConcurrentDictionary_2_System_Guid_System_Int32_ * this_ptr));
