...
namespace app::methods::Moon_Wwise::ZoneProcessor_2_LZData_EZData_ {
IL2CPP_REGISTER_METHOD(0x02AF6B80, void, __ctor, (app::ZoneProcessor_2_LZData_EZData_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00417870, EZData, InitializeEmitterZoneTask, (app::ZoneProcessor_2_LZData_EZData_ * this_ptr, app::EZData zone, app::AudioEmitterZone * audio_emitter_zone));
IL2CPP_REGISTER_METHOD(0x00417870, LZData, InitializeListenerZoneTask, (app::ZoneProcessor_2_LZData_EZData_ * this_ptr, app::LZData data, app::AudioListenerZone * audio_listener_zone));
