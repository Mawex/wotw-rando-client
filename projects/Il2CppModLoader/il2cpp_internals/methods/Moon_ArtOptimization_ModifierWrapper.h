...
namespace app::methods::Moon_ArtOptimization::ModifierWrapper {
IL2CPP_REGISTER_METHOD(0x0134CF00, void, __ctor, (app::ModifierWrapper * this_ptr, int32_t id, app::UberShaderModifier * modifier, app::SerializableUberSaderModifierWrapper * serializable_modifier_wrapper));
...
IL2CPP_REGISTER_METHOD(0x0134D4D0, Sample *, GetSample, (app::ModifierWrapper * this_ptr, int32_t index));
