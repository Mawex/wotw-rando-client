...
namespace app::methods::Moon_Rendering::MoonRenderPipelineDebugUI {
IL2CPP_REGISTER_METHOD(0x007940D0, QualityProfile *, getProfile, (app::MoonRenderPipelineDebugUI * this_ptr, app::MoonRenderPipelineDebugUI_Quality__Enum quality));
...
IL2CPP_REGISTER_METHOD(0x007A1D40, RenderScope__Enum, ui_ToggleField, (app::MoonRenderPipelineDebugUI * this_ptr, app::String * label, app::RenderScope__Enum value));
IL2CPP_REGISTER_METHOD(0x007A1E40, FloatRange, floatRange, (app::String * label, app::FloatRange value, float min, float max));
IL2CPP_REGISTER_METHOD(0x007A1FC0, bool, beginSection_1, (app::bool * foldout, app::String * label));
...
IL2CPP_REGISTER_METHOD(0x007A2400, void, __ctor, (app::MoonRenderPipelineDebugUI * this_ptr));
