...
IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkDeviceSettings * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x026DD420, void *, getCPtr, (app::AkDeviceSettings * obj));
IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkDeviceSettings * this_ptr, app::void * c_ptr));
...
IL2CPP_REGISTER_METHOD(0x026DD740, void, set_pIOMemory, (app::AkDeviceSettings * this_ptr, app::void * value));
...
IL2CPP_REGISTER_METHOD(0x026DE660, AkThreadProperties *, get_threadProperties, (app::AkDeviceSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x026DF1C0, void, __ctor_2, (app::AkDeviceSettings * this_ptr));
}
