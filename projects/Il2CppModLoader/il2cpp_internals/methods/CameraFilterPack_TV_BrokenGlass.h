...
IL2CPP_REGISTER_METHOD(0x020E5E80, Material *, get_material, (app::CameraFilterPack_TV_BrokenGlass * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E6620, void, __ctor, (app::CameraFilterPack_TV_BrokenGlass * this_ptr));
}
