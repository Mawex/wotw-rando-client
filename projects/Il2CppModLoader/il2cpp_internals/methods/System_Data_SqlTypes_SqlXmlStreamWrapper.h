...
namespace app::methods::System_Data_SqlTypes::SqlXmlStreamWrapper {
IL2CPP_REGISTER_METHOD(0x022BD630, void, __ctor, (app::SqlXmlStreamWrapper * this_ptr, app::Stream * stream));
