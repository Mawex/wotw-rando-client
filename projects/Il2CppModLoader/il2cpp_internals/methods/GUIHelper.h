...
IL2CPP_REGISTER_METHOD(0x0151D9B0, GUIStyle *, get_BigTextStyle, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0151DCC0, GUIStyle *, get_MediumSizeTextSyle, (MethodInfo * method));
