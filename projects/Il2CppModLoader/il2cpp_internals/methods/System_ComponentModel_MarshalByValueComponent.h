...
namespace app::methods::System_ComponentModel::MarshalByValueComponent {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MarshalByValueComponent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01FF5D80, EventHandlerList *, get_Events, (app::MarshalByValueComponent * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA280, ISite *, get_Site, (app::MarshalByValueComponent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01FF61E0, IContainer *, get_Container, (app::MarshalByValueComponent * this_ptr));
IL2CPP_REGISTER_METHOD(0x01FF6280, Object *, GetService, (app::MarshalByValueComponent * this_ptr, app::Type * service));
IL2CPP_REGISTER_METHOD(0x01FF6330, bool, get_DesignMode, (app::MarshalByValueComponent * this_ptr));
IL2CPP_REGISTER_METHOD(0x01FF63D0, String *, ToString, (app::MarshalByValueComponent * this_ptr));
