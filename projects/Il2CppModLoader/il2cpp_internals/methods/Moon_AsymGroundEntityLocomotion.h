...
IL2CPP_REGISTER_METHOD(0x00CB47C0, Vector2, get_LookDirection, (app::AsymGroundEntityLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CB48B0, void, __ctor, (app::AsymGroundEntityLocomotion * this_ptr));
}
