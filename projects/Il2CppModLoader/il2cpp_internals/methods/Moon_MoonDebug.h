...
IL2CPP_REGISTER_METHOD(0x031A11B0, void, __ctor, (app::MoonDebug * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031A24E0, Vector3, RotatePointAroundPivot, (app::Vector3 point, app::Vector3 pivot, app::Quaternion angles));
...
IL2CPP_REGISTER_METHOD(0x031A4740, String *, GetFullHierarchy, (app::Transform * transform));
IL2CPP_REGISTER_METHOD(0x031A4900, String *, GetObjectPath, (app::Object_1 * obj));
