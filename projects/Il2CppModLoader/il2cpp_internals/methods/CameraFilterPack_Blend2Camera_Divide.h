...
IL2CPP_REGISTER_METHOD(0x0274A360, Material *, get_material, (app::CameraFilterPack_Blend2Camera_Divide * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0274B530, void, __ctor, (app::CameraFilterPack_Blend2Camera_Divide * this_ptr));
}
