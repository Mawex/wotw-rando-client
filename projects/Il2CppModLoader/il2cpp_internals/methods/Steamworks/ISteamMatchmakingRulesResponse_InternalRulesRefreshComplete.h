...
namespace app::methods::Steamworks::ISteamMatchmakingRulesResponse_InternalRulesRefreshComplete {
    IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::ISteamMatchmakingRulesResponse_InternalRulesRefreshComplete * this_ptr, app::Object * object, void * method_1));
