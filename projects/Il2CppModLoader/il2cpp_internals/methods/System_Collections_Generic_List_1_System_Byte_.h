...
namespace app::methods::System_Collections_Generic::List_1_System_Byte_ {
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_1, (app::List_1_System_Byte_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x02F51B80, List_1_T_Enumerator_System_Byte_, GetEnumerator, (app::List_1_System_Byte_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_2, (app::List_1_System_Byte_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04739DD0, List_1_System_Byte___ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EAEF0, Byte__Array *, ToArray, (app::List_1_System_Byte_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F526E0, void, __ctor_3, (app::List_1_System_Byte_ * this_ptr, app::IEnumerable_1_System_Byte_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02F52B60, Object *, ICollection_get_SyncRoot, (app::List_1_System_Byte_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02F50DC0, bool, IsCompatibleObject, (app::Object * value));
IL2CPP_REGISTER_METHOD(0x02F50EA0, Object *, IList_get_Item, (app::List_1_System_Byte_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_System_Byte_ *, AsReadOnly, (app::List_1_System_Byte_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F51700, List_1_System_Byte_ *, FindAll, (app::List_1_System_Byte_ * this_ptr, app::Predicate_1_Byte_ * match));
...
IL2CPP_REGISTER_METHOD(0x02F51BC0, IEnumerator_1_System_Byte_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_System_Byte_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02F51BC0, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_System_Byte_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_System_Byte_ *, GetRange, (app::List_1_System_Byte_ * this_ptr, int32_t index, int32_t count));
