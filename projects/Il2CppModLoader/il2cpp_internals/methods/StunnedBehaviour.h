...
IL2CPP_REGISTER_METHOD(0x00672130, BehaviourStatus__Enum, OnExecuteTask, (app::StunnedBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x005B3EC0, void, __ctor, (app::StunnedBehaviour * this_ptr));
}
