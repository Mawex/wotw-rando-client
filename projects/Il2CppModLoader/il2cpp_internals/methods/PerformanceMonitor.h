...
IL2CPP_REGISTER_METHOD(0x00497200, FPSTestResult *, GetFPSTestResult, (app::PerformanceMonitor * this_ptr, app::SceneManagerScene * scene));
...
IL2CPP_REGISTER_METHOD(0x00497B40, void, __ctor, (app::PerformanceMonitor * this_ptr));
IL2CPP_REGISTER_METHOD(0x00497CC0, void, __cctor, ());
}
