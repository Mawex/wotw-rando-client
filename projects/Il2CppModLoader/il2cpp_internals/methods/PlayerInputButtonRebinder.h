...
IL2CPP_REGISTER_METHOD(0x0141DA70, Input_Command__Enum, GetCommand, (app::PlayerInputButtonRebinder * this_ptr, app::AbilityType__Enum ability, app::PlayerInputButtonRebinder_Request__Enum request));
IL2CPP_REGISTER_METHOD(0x0141DDB0, AbilityType__Enum, GetAbility, (app::PlayerInputButtonRebinder * this_ptr, app::Input_Command__Enum button, app::PlayerInputButtonRebinder_Request__Enum request));
...
IL2CPP_REGISTER_METHOD(0x0141E6B0, void, __ctor, (app::PlayerInputButtonRebinder * this_ptr));
}
