...
namespace app::methods::Moon_UI::UIComponent {
...
IL2CPP_REGISTER_METHOD(0x0118B4C0, RectTransform *, get_RectTransform, (app::UIComponent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00597BB0, void, __ctor, (app::UIComponent * this_ptr));
}
