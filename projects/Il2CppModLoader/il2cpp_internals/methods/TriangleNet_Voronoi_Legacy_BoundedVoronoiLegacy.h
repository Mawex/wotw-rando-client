...
namespace app::methods::TriangleNet_Voronoi_Legacy::BoundedVoronoiLegacy {
...
IL2CPP_REGISTER_METHOD(0x002FB950, Point__Array *, get_Points, (app::BoundedVoronoiLegacy * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB00, ICollection_1_TriangleNet_Voronoi_Legacy_VoronoiRegion_ *, get_Regions, (app::BoundedVoronoiLegacy * this_ptr));
IL2CPP_REGISTER_METHOD(0x02AA8920, IEnumerable_1_TriangleNet_Geometry_IEdge_ *, get_Edges, (app::BoundedVoronoiLegacy * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AABCF0, IEnumerable_1_TriangleNet_Geometry_IEdge_ *, EnumerateEdges, (app::BoundedVoronoiLegacy * this_ptr));
}
