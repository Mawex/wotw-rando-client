...
IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::ActionSequence * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004C6480, String *, FormatName, (int32_t number, app::String * name));
IL2CPP_REGISTER_METHOD(0x004C6580, String *, UnformatName, (app::String * name));
IL2CPP_REGISTER_METHOD(0x004C65B0, void, RefreshNames, (app::ActionSequence * this_ptr));
IL2CPP_REGISTER_METHOD(0x004C65D0, String *, GetNiceName, (app::ActionSequence * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004C6660, SuspendableMask__Enum, get_Mask, (app::ActionSequence * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004C6820, void, __ctor, (app::ActionSequence * this_ptr));
}
