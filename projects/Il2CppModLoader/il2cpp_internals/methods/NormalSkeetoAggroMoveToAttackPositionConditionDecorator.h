...
IL2CPP_REGISTER_METHOD(0x0060C060, BehaviourStatus__Enum, OnExecute, (app::NormalSkeetoAggroMoveToAttackPositionConditionDecorator * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0060C1C0, void, __ctor, (app::NormalSkeetoAggroMoveToAttackPositionConditionDecorator * this_ptr));
}
