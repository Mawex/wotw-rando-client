...
IL2CPP_REGISTER_METHOD(0x00894F40, SeinLogicCycle_StateFlags__Enum, GetFlags, (app::SeinLogicCycle * this_ptr, app::SeinLogicCycle_StateFlags__Enum test_flags));
...
IL2CPP_REGISTER_METHOD(0x00896C50, SeinCharacter *, get_Sein, (app::SeinLogicCycle * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB60, List_1_CharacterState_ *, GetStates, (app::SeinLogicCycle * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::SeinLogicCycle * this_ptr));
IL2CPP_REGISTER_METHOD(0x008A0CA0, int32_t, get_ExecutionOrder, (app::SeinLogicCycle * this_ptr));
IL2CPP_REGISTER_METHOD(0x008A0CB0, void, __ctor, (app::SeinLogicCycle * this_ptr));
