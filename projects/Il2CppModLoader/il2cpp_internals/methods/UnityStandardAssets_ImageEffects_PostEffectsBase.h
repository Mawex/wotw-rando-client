...
namespace app::methods::UnityStandardAssets_ImageEffects::PostEffectsBase {
IL2CPP_REGISTER_METHOD(0x02D5D890, Material *, CheckShaderAndCreateMaterial, (app::PostEffectsBase * this_ptr, app::Shader * s, app::Material * m2_create));
IL2CPP_REGISTER_METHOD(0x02D5DE70, Material *, CreateMaterial, (app::PostEffectsBase * this_ptr, app::Shader * s, app::Material * m2_create));
...
IL2CPP_REGISTER_METHOD(0x013270D0, void, __ctor, (app::PostEffectsBase * this_ptr));
}
