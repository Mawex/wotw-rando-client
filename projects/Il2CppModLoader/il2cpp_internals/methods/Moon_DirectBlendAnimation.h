...
IL2CPP_REGISTER_METHOD(0x0043D9E0, AnimationType__Enum, get_Type, (app::DirectBlendAnimation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01B0E050, MoonAnimation_RootMotionSample, EvaluateRootMotion, (app::DirectBlendAnimation * this_ptr, float time, app::AnimationParameterSet * parameter_set));
IL2CPP_REGISTER_METHOD(0x01B0E1C0, void, __ctor, (app::DirectBlendAnimation * this_ptr));
}
