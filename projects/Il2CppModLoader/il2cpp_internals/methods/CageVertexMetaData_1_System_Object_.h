...
IL2CPP_REGISTER_METHOD(0x019DEF90, Object *, GetMetaData, (app::CageVertexMetaData_1_System_Object_ * this_ptr, app::CageStructureTool_Vertex * vertex));
IL2CPP_REGISTER_METHOD(0x019DF0B0, void, CompleteMetadata, (app::CageVertexMetaData_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x019DF3A0, void, __ctor, (app::CageVertexMetaData_1_System_Object_ * this_ptr));
}
