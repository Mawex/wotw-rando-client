...
namespace app::methods::System_Security_Cryptography_X509Certificates::X509CertificateImpl {
...
IL2CPP_REGISTER_METHOD(0x01E16C70, Byte__Array *, GetCertHash, (app::X509CertificateImpl * this_ptr));
