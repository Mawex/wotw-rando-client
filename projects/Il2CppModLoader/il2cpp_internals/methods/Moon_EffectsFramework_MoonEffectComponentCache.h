...
namespace app::methods::Moon_EffectsFramework::MoonEffectComponentCache {
    IL2CPP_REGISTER_METHOD(0x002FA280, app::GameObject *, get_Target, (app::MoonEffectComponentCache * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01980470, void, __ctor, (app::MoonEffectComponentCache * this_ptr, app::GameObject * target, app::Type__Array * component_types));
