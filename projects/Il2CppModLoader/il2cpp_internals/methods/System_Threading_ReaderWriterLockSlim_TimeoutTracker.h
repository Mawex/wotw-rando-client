...
namespace app::methods::System_Threading::ReaderWriterLockSlim_TimeoutTracker {
    IL2CPP_REGISTER_METHOD(0x00240600, void, __ctor, (app::ReaderWriterLockSlim_TimeoutTracker__Boxed * this_ptr, int32_t milliseconds_timeout));
