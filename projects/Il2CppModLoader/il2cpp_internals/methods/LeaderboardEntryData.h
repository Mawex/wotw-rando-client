...
IL2CPP_REGISTER_METHOD(0x015B78F0, void, __ctor_1, (app::LeaderboardEntryData * this_ptr, int32_t time, int32_t deaths, int32_t completion));
IL2CPP_REGISTER_METHOD(0x015B7D20, void, __ctor_2, (app::LeaderboardEntryData * this_ptr));
