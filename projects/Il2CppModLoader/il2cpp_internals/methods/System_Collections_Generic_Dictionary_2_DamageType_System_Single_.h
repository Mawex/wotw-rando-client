...
namespace app::methods::System_Collections_Generic::Dictionary_2_DamageType_System_Single_ {
IL2CPP_REGISTER_METHOD(0x02BB43A0, bool, TryGetValue, (app::Dictionary_2_DamageType_System_Single_ * this_ptr, app::DamageType__Enum key, app::float * value));
...
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_DamageType_System_Single_ * this_ptr));
