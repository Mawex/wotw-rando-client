...
namespace app::methods::System_Security_Cryptography::MACTripleDES {
IL2CPP_REGISTER_METHOD(0x020DC4C0, void, __ctor_1, (app::MACTripleDES * this_ptr));
IL2CPP_REGISTER_METHOD(0x020DC680, void, __ctor_2, (app::MACTripleDES * this_ptr, app::Byte__Array * rgb_key));
IL2CPP_REGISTER_METHOD(0x020DC720, void, __ctor_3, (app::MACTripleDES * this_ptr, app::String * str_triple_d_e_s, app::Byte__Array * rgb_key));
...
IL2CPP_REGISTER_METHOD(0x020DCA60, PaddingMode__Enum, get_Padding, (app::MACTripleDES * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020DCEA0, Byte__Array *, HashFinal, (app::MACTripleDES * this_ptr));
