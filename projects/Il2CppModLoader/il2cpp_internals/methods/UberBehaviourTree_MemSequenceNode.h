...
IL2CPP_REGISTER_METHOD(0x013E26E0, void, __ctor, (app::MemSequenceNode * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x013E2840, BehaviourTreeStatus__Enum, Tick, (app::MemSequenceNode * this_ptr, app::TickData tick));
