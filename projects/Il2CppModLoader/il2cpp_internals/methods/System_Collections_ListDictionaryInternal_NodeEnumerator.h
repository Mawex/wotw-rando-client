...
namespace app::methods::System_Collections::ListDictionaryInternal_NodeEnumerator {
IL2CPP_REGISTER_METHOD(0x0202A190, void, __ctor, (app::ListDictionaryInternal_NodeEnumerator * this_ptr, app::ListDictionaryInternal * list));
IL2CPP_REGISTER_METHOD(0x0202A1C0, Object *, get_Current, (app::ListDictionaryInternal_NodeEnumerator * this_ptr));
IL2CPP_REGISTER_METHOD(0x0202A310, DictionaryEntry, get_Entry, (app::ListDictionaryInternal_NodeEnumerator * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0472B848, ListDictionaryInternal_NodeEnumerator_get_Entry__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0202A3F0, Object *, get_Key, (app::ListDictionaryInternal_NodeEnumerator * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04722A88, ListDictionaryInternal_NodeEnumerator_get_Key__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0202A4C0, Object *, get_Value, (app::ListDictionaryInternal_NodeEnumerator * this_ptr));
