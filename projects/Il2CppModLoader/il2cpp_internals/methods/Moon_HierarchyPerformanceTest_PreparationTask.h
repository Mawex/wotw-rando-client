...
namespace app::methods::Moon_HierarchyPerformanceTest::PreparationTask {
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::PreparationTask * this_ptr));
    IL2CPP_REGISTER_METHOD(0x014AA700, void, __cctor, ());
}
