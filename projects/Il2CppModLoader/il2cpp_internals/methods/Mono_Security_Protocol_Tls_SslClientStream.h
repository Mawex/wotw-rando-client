...
namespace app::methods::Mono_Security_Protocol_Tls::SslClientStream {
...
IL2CPP_REGISTER_METHOD(0x002FB990, Stream *, get_InputBuffer, (app::SslClientStream * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F7EA50, X509CertificateCollection_1 *, get_ClientCertificates, (app::SslClientStream * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F7EA80, X509Certificate_1 *, get_SelectedClientCertificate, (app::SslClientStream * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC00, CertificateValidationCallback *, get_ServerCertValidationDelegate, (app::SslClientStream * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC20, CertificateSelectionCallback *, get_ClientCertSelectionDelegate, (app::SslClientStream * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC40, PrivateKeySelectionCallback *, get_PrivateKeyCertSelectionDelegate, (app::SslClientStream * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F7F6A0, IAsyncResult *, BeginNegotiateHandshake, (app::SslClientStream * this_ptr, app::AsyncCallback * callback, app::Object * state));
...
IL2CPP_REGISTER_METHOD(0x01F810F0, X509Certificate_1 *, OnLocalCertificateSelection, (app::SslClientStream * this_ptr, app::X509CertificateCollection_1 * client_certificates, app::X509Certificate_1 * server_certificate, app::String * target_host, app::X509CertificateCollection_1 * server_requested_certificates));
IL2CPP_REGISTER_METHOD(0x01F81110, bool, get_HaveRemoteValidation2Callback, (app::SslClientStream * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F81120, ValidationResult *, OnRemoteCertificateValidation2, (app::SslClientStream * this_ptr, app::X509CertificateCollection_2 * collection));
...
IL2CPP_REGISTER_METHOD(0x01F81190, ValidationResult *, RaiseServerCertificateValidation2, (app::SslClientStream * this_ptr, app::X509CertificateCollection_2 * collection));
IL2CPP_REGISTER_METHOD(0x01F811B0, X509Certificate_1 *, RaiseClientCertificateSelection, (app::SslClientStream * this_ptr, app::X509CertificateCollection_1 * client_certificates, app::X509Certificate_1 * server_certificate, app::String * target_host, app::X509CertificateCollection_1 * server_requested_certificates));
IL2CPP_REGISTER_METHOD(0x01F811D0, AsymmetricAlgorithm *, OnLocalPrivateKeySelection, (app::SslClientStream * this_ptr, app::X509Certificate_1 * certificate, app::String * target_host));
IL2CPP_REGISTER_METHOD(0x01F811F0, AsymmetricAlgorithm *, RaisePrivateKeySelection, (app::SslClientStream * this_ptr, app::X509Certificate_1 * certificate, app::String * target_host));
}
