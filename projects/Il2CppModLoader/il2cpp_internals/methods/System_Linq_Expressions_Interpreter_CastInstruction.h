...
namespace app::methods::System_Linq_Expressions_Interpreter::CastInstruction {
...
IL2CPP_REGISTER_METHOD(0x022D82A0, String *, get_InstructionName, (app::CastInstruction * this_ptr));
IL2CPP_REGISTER_METHOD(0x022D8320, Instruction *, Create, (app::Type * t));
