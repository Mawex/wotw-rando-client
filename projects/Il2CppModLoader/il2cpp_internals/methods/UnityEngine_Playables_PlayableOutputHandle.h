...
namespace app::methods::UnityEngine_Playables::PlayableOutputHandle {
...
IL2CPP_REGISTER_METHOD(0x02966BE0, bool, operator___, (app::PlayableOutputHandle lhs, app::PlayableOutputHandle rhs));
...
IL2CPP_REGISTER_METHOD(0x00217060, Type *, GetPlayableOutputType, (app::PlayableOutputHandle__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x029671F0, Type *, GetPlayableOutputType_Injected, (app::PlayableOutputHandle * _unity_self));
