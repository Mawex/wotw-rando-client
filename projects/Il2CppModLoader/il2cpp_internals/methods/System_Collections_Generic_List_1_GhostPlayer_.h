...
namespace app::methods::System_Collections_Generic::List_1_GhostPlayer_ {
...
IL2CPP_REGISTER_METHOD(0x025EFC50, GhostPlayer *, get_Item, (app::List_1_GhostPlayer_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_GhostPlayer_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0473A318, List_1_GhostPlayer___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EAEF0, GhostPlayer__Array *, ToArray, (app::List_1_GhostPlayer_ * this_ptr));
