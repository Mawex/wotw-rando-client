...
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (DescriptionAttribute * __this, String * description));
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_Description, (DescriptionAttribute * __this));
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_DescriptionValue, (DescriptionAttribute * __this));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_DescriptionValue, (DescriptionAttribute * __this, String * value));
