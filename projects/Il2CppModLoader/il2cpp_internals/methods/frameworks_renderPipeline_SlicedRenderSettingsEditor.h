...
namespace app::methods::frameworks_renderPipeline::SlicedRenderSettingsEditor {
IL2CPP_REGISTER_METHOD(0x00F62DD0, bool, get_IsEnabled, ());
IL2CPP_REGISTER_METHOD(0x00F62F30, bool, get_IsShowingOverride, ());
IL2CPP_REGISTER_METHOD(0x00F63050, DepthOfFieldController *, get_DofController, (app::SlicedRenderSettingsEditor * this_ptr));
IL2CPP_REGISTER_METHOD(0x00F63740, LayeredRenderSettings_LayerParams__Array *, GetLayersFromSettings, (app::SlicedRenderSettingsEditor * this_ptr, app::LayeredRenderSettings * settings));
IL2CPP_REGISTER_METHOD(0x00F63890, LayeredRenderSettings *, get_SceneSettings, (app::SlicedRenderSettingsEditor * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F695F0, void, __ctor, (app::SlicedRenderSettingsEditor * this_ptr));
