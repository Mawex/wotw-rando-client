...
IL2CPP_REGISTER_METHOD(0x027621D0, Material *, get_material, (app::CameraFilterPack_Blend2Camera_VividLight * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x027633A0, void, __ctor, (app::CameraFilterPack_Blend2Camera_VividLight * this_ptr));
}
