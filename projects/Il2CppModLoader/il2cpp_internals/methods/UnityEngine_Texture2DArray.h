...
namespace app::methods::UnityEngine::Texture2DArray {
    IL2CPP_REGISTER_METHOD(0x02C699C0, void, __ctor_1, (app::Texture2DArray * this_ptr, int32_t width, int32_t height, int32_t depth, app::GraphicsFormat__Enum format, app::TextureCreationFlags__Enum flags));
    IL2CPP_REGISTER_METHOD(0x02C69A50, void, __ctor_2, (app::Texture2DArray * this_ptr, int32_t width, int32_t height, int32_t depth, app::TextureFormat__Enum texture_format, bool mip_chain, bool linear));
    IL2CPP_REGISTER_METHOD(0x02C69B60, void, __ctor_3, (app::Texture2DArray * this_ptr, int32_t width, int32_t height, int32_t depth, app::TextureFormat__Enum texture_format, bool mip_chain));
