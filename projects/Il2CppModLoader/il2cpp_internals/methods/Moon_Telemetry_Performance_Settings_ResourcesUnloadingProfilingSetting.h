...
namespace app::methods::Moon_Telemetry_Performance_Settings::ResourcesUnloadingProfilingSetting {
IL2CPP_REGISTER_METHOD(0x00E3F140, ProfilingSettings_SettingType__Enum, get_SettingType, (app::ResourcesUnloadingProfilingSetting * this_ptr));
