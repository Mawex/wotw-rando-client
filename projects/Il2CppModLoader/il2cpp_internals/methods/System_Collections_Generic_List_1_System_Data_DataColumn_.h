...
namespace app::methods::System_Collections_Generic::List_1_System_Data_DataColumn_ {
IL2CPP_REGISTER_METHOD(0x025EFC50, DataColumn *, get_Item, (app::List_1_System_Data_DataColumn_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_System_Data_DataColumn_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, DataColumn__Array *, ToArray, (app::List_1_System_Data_DataColumn_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04732318, List_1_System_Data_DataColumn__ToArray__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_System_Data_DataColumn_, GetEnumerator, (app::List_1_System_Data_DataColumn_ * this_ptr));
