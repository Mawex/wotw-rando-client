...
IL2CPP_REGISTER_METHOD(0x024F4DA0, Material *, get_material, (app::CameraFilterPack_Drawing_Manga4 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024F3E60, void, __ctor, (app::CameraFilterPack_Drawing_Manga4 * this_ptr));
}
