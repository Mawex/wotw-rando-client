...
namespace app::methods::Moon_UberStateVisualization::UberStateVisualizationView {
IL2CPP_REGISTER_METHOD(0x030C4940, void, __ctor, (app::UberStateVisualizationView * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030C7600, ControllerInput *, UpdateInput, (app::UberStateVisualizationView * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030C8090, UberStateData, CreateStateData, (app::UberStateVisualizationView * this_ptr, app::UberID * id, app::UberID * group_id, int64_t size, app::Color color, app::String * string_value));
...
IL2CPP_REGISTER_METHOD(0x030C82F0, UberStateGroupData, badCreateGroupData, (app::UberStateVisualizationView * this_ptr, app::UberID * id, app::UberStateValueGroup * state_value_group, app::Color color));
