...
namespace app::methods::Moon_Timeline::KeepScenesLoaded {
...
IL2CPP_REGISTER_METHOD(0x007731B0, IUberState__Array *, get_AffectingUberStates, (app::KeepScenesLoaded * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB60, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::KeepScenesLoaded * this_ptr));
IL2CPP_REGISTER_METHOD(0x007732B0, void, __ctor, (app::KeepScenesLoaded * this_ptr));
}
