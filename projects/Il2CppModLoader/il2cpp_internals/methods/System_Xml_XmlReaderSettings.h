...
namespace app::methods::System_Xml::XmlReaderSettings {
IL2CPP_REGISTER_METHOD(0x01704870, void, __ctor, (app::XmlReaderSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB930, XmlNameTable *, get_NameTable, (app::XmlReaderSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB950, XmlResolver *, GetXmlResolver, (app::XmlReaderSettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x01704A60, XmlResolver *, GetXmlResolver_CheckConfig, (app::XmlReaderSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00654950, ConformanceLevel__Enum, get_ConformanceLevel, (app::XmlReaderSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003FD3F0, DtdProcessing__Enum, get_DtdProcessing, (app::XmlReaderSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FD490, ValidationType__Enum, get_ValidationType, (app::XmlReaderSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003FDCE0, XmlSchemaValidationFlags__Enum, get_ValidationFlags, (app::XmlReaderSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x017053B0, XmlSchemaSet *, get_Schemas, (app::XmlReaderSettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x01705510, void, set_Schemas, (app::XmlReaderSettings * this_ptr, app::XmlSchemaSet * value));
IL2CPP_REGISTER_METHOD(0x017055B0, XmlReaderSettings *, Clone, (app::XmlReaderSettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB80, ValidationEventHandler *, GetEventHandler, (app::XmlReaderSettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x017056E0, XmlReader *, CreateReader_1, (app::XmlReaderSettings * this_ptr, app::Stream * input, app::Uri * base_uri, app::String * base_uri_string, app::XmlParserContext * input_context));
IL2CPP_REGISTER_METHODINFO(0x0471F9D8, XmlReaderSettings_CreateReader__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01705940, XmlReader *, CreateReader_2, (app::XmlReaderSettings * this_ptr, app::TextReader * input, app::String * base_uri_string, app::XmlParserContext * input_context));
...
IL2CPP_REGISTER_METHOD(0x01705F70, XmlReader *, AddValidation, (app::XmlReaderSettings * this_ptr, app::XmlReader * reader));
IL2CPP_REGISTER_METHOD(0x01706340, XmlValidatingReaderImpl *, CreateDtdValidatingReader, (app::XmlReaderSettings * this_ptr, app::XmlReader * base_reader));
