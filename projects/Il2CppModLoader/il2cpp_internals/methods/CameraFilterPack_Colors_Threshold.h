...
IL2CPP_REGISTER_METHOD(0x024E3440, Material *, get_material, (app::CameraFilterPack_Colors_Threshold * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024E3BD0, void, __ctor, (app::CameraFilterPack_Colors_Threshold * this_ptr));
}
