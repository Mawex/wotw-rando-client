...
namespace app::methods::PetrifiedOwlBossFight1FeatherFlurryBehaviour_EndState {
    IL2CPP_REGISTER_METHOD(0x017682E0, void, __ctor, (app::PetrifiedOwlBossFight1FeatherFlurryBehaviour_EndState * this_ptr, app::PetrifiedOwlBossFight1FeatherFlurryBehaviour * behaviour));
