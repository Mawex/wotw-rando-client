...
IL2CPP_REGISTER_METHOD(0x01484780, BehaviourStatus__Enum, OnExecute, (app::FlutteringSlamBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01484F00, void, __ctor, (app::FlutteringSlamBehaviour * this_ptr));
}
