...
IL2CPP_REGISTER_METHOD(0x002FB930, MemberInfo_1 *, GetMember, (app::FieldExpression * this_ptr));
IL2CPP_REGISTER_METHOD(0x022CFDC0, Type *, get_Type, (app::FieldExpression * this_ptr));
}
