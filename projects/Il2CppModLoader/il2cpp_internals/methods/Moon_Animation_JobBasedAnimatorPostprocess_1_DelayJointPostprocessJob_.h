...
namespace app::methods::Moon_Animation::JobBasedAnimatorPostprocess_1_DelayJointPostprocessJob_ {
...
IL2CPP_REGISTER_METHOD(0x019FBE40, void, __ctor, (app::JobBasedAnimatorPostprocess_1_DelayJointPostprocessJob_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x019FB940, Playable, ConstructPlayable, (app::JobBasedAnimatorPostprocess_1_DelayJointPostprocessJob_ * this_ptr, app::PlayableGraph playable_graph));
