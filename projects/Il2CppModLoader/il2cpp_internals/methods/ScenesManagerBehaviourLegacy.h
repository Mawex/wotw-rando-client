...
IL2CPP_REGISTER_METHOD(0x01056D40, Vector2, get_CurrentCameraTargetPositionExtrapolated, (app::ScenesManagerBehaviourLegacy * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01056D80, Vector2, get_CurrentCameraTargetPositionExtrapolatedShort, (app::ScenesManagerBehaviourLegacy * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01056D40, Vector2, get_PredictedTargetPosition, (app::ScenesManagerBehaviourLegacy * this_ptr));
IL2CPP_REGISTER_METHOD(0x00597B10, ScenesManagerUpdateType__Enum, get_CurrentUpdateType, (app::ScenesManagerBehaviourLegacy * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0105CBB0, void, __ctor, (app::ScenesManagerBehaviourLegacy * this_ptr));
}
