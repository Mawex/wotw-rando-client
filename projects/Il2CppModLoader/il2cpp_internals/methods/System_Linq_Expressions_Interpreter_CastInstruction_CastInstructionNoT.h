...
namespace app::methods::System_Linq_Expressions_Interpreter::CastInstruction_CastInstructionNoT {
    IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::CastInstruction_CastInstructionNoT * this_ptr, app::Type * t));
