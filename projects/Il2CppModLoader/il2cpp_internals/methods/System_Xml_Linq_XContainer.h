...
namespace app::methods::System_Xml_Linq::XContainer {
...
IL2CPP_REGISTER_METHOD(0x0302FAD0, XNode *, get_LastNode, (app::XContainer * this_ptr));
IL2CPP_REGISTER_METHOD(0x0302FCD0, void, Add, (app::XContainer * this_ptr, app::Object * content));
IL2CPP_REGISTER_METHOD(0x030300A0, IEnumerable_1_System_Xml_Linq_XElement_ *, Descendants_1, (app::XContainer * this_ptr));
IL2CPP_REGISTER_METHOD(0x030300B0, IEnumerable_1_System_Xml_Linq_XElement_ *, Descendants_2, (app::XContainer * this_ptr, app::XName * name));
IL2CPP_REGISTER_METHOD(0x030300D0, XElement *, Element, (app::XContainer * this_ptr, app::XName * name));
IL2CPP_REGISTER_METHOD(0x03030220, IEnumerable_1_System_Xml_Linq_XElement_ *, Elements_1, (app::XContainer * this_ptr));
IL2CPP_REGISTER_METHOD(0x03030230, IEnumerable_1_System_Xml_Linq_XElement_ *, Elements_2, (app::XContainer * this_ptr, app::XName * name));
IL2CPP_REGISTER_METHOD(0x03030250, IEnumerable_1_System_Xml_Linq_XNode_ *, Nodes, (app::XContainer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03031900, String *, GetDateTimeString, (app::DateTime value));
IL2CPP_REGISTER_METHOD(0x03031A20, IEnumerable_1_System_Xml_Linq_XElement_ *, GetDescendants, (app::XContainer * this_ptr, app::XName * name, bool self));
IL2CPP_REGISTER_METHOD(0x03031BD0, IEnumerable_1_System_Xml_Linq_XElement_ *, GetElements, (app::XContainer * this_ptr, app::XName * name));
IL2CPP_REGISTER_METHOD(0x03031D70, String *, GetStringValue, (app::Object * value));
