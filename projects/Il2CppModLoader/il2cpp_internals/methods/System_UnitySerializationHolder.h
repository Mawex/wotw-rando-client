...
IL2CPP_REGISTER_METHOD(0x027C5D60, RuntimeType *, AddElementTypes, (app::SerializationInfo * info, app::RuntimeType * type));
IL2CPP_REGISTER_METHOD(0x027C6380, Type *, MakeElementTypes, (app::UnitySerializationHolder * this_ptr, app::Type * type));
...
IL2CPP_REGISTER_METHOD(0x027C6A30, void, __ctor, (app::UnitySerializationHolder * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
...
IL2CPP_REGISTER_METHOD(0x027C6DD0, Object *, GetRealObject, (app::UnitySerializationHolder * this_ptr, app::StreamingContext context));
