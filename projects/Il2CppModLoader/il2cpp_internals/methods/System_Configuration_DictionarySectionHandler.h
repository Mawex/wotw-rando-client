...
IL2CPP_REGISTER_METHOD(0x02961A80, void, __ctor, (DictionarySectionHandler * __this));
IL2CPP_REGISTER_METHODINFO(0x04747C00, DictionarySectionHandler__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02961AB0, String *, get_KeyAttributeName, (DictionarySectionHandler * __this));
IL2CPP_REGISTER_METHODINFO(0x04700A10, DictionarySectionHandler_get_KeyAttributeName__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02961AE0, String *, get_ValueAttributeName, (DictionarySectionHandler * __this));
IL2CPP_REGISTER_METHODINFO(0x04732F10, DictionarySectionHandler_get_ValueAttributeName__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02961B10, Object *, Create, (DictionarySectionHandler * __this, Object * parent, Object * context, XmlNode * section));
