...
IL2CPP_REGISTER_METHOD(0x01785A30, PetrifiedOwlUberState__Enum, get_CurrentUberState, (app::FeedingGroundsGameplayController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01785B50, SuspendableMask__Enum, get_Mask, (app::FeedingGroundsGameplayController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0178A3A0, IUberState__Array *, get_AffectingUberStates, (app::FeedingGroundsGameplayController * this_ptr));
IL2CPP_REGISTER_METHOD(0x0178A430, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::FeedingGroundsGameplayController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0178A8D0, IDesiredUberState__Array *, GetRequirementsForTimeline, (app::FeedingGroundsGameplayController * this_ptr, app::MoonTimeline * timeline));
IL2CPP_REGISTER_METHOD(0x0178AC90, void, __ctor, (app::FeedingGroundsGameplayController * this_ptr));
}
