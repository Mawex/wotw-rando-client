...
IL2CPP_REGISTER_METHOD(0x00F0E6F0, Vector3, get_PieceLocalPositionOffset, (app::LaserShieldRotationController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F0E730, Vector3, get_PieceWorldOffset, (app::LaserShieldRotationController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBD20, LaserShooterMinibossEntity *, get_Entity, (app::LaserShieldRotationController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003FF7B0, LaserShieldRotationController_RotationType__Enum, get_CurrentRotationType, (app::LaserShieldRotationController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F0FCD0, bool, FullRotationTime, (app::LaserShieldRotationController * this_ptr, app::float * full_rotation_time));
IL2CPP_REGISTER_METHOD(0x00F0FDC0, void, OnUpdate, (app::LaserShieldRotationController * this_ptr, float d_time));
IL2CPP_REGISTER_METHOD(0x00F109D0, List_1_LaserShieldDamageReceiver_ *, GetAllAlivePieces, (app::LaserShieldRotationController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F10F20, LaserShieldDamageReceiver *, GetPiece, (app::LaserShieldRotationController * this_ptr, int32_t piece_index));
...
IL2CPP_REGISTER_METHOD(0x00F11360, void, __ctor, (app::LaserShieldRotationController * this_ptr));
}
