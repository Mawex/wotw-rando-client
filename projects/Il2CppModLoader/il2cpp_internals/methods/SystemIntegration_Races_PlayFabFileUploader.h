...
namespace app::methods::SystemIntegration_Races::PlayFabFileUploader {
IL2CPP_REGISTER_METHOD(0x00522850, void, __ctor, (app::PlayFabFileUploader * this_ptr, app::String * file_name, app::Byte__Array * data, app::String * owner_id));
IL2CPP_REGISTER_METHOD(0x00522860, Task_1_System_Boolean_ *, Perform, (app::PlayFabFileUploader * this_ptr));
