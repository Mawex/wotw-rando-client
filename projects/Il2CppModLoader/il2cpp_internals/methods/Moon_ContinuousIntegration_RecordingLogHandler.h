...
namespace app::methods::Moon_ContinuousIntegration::RecordingLogHandler {
    IL2CPP_REGISTER_METHOD(0x0318BC50, void, __ctor, (app::RecordingLogHandler * this_ptr, bool quick_exit));
