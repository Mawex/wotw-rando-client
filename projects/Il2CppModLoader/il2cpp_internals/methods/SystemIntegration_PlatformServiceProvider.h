...
IL2CPP_REGISTER_METHOD(0x00518D60, CacheData__Array *, get_AchievementData, (app::PlatformServiceProvider * this_ptr));
IL2CPP_REGISTER_METHOD(0x00518DF0, CacheData__Array *, get_LeaderBoardData, (app::PlatformServiceProvider * this_ptr));
IL2CPP_REGISTER_METHOD(0x00518E80, bool, get_ShowSignInUi, (app::PlatformServiceProvider * this_ptr));
IL2CPP_REGISTER_METHOD(0x00518F50, IPlatformUser *, get_PrimaryUser, (app::PlatformServiceProvider * this_ptr));
IL2CPP_REGISTER_METHOD(0x00519000, IPlatformUser *, get_SecondaryUser, (app::PlatformServiceProvider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005193D0, String *, get_UserDisplayName, (app::PlatformServiceProvider * this_ptr));
IL2CPP_REGISTER_METHOD(0x005194C0, String *, get_UserId, (app::PlatformServiceProvider * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC40, PlayFabRaceServiceProvider *, get_RaceServiceProvider, (app::PlatformServiceProvider * this_ptr));
IL2CPP_REGISTER_METHOD(0x005195B0, String *, get_EntityId, (app::PlatformServiceProvider * this_ptr));
IL2CPP_REGISTER_METHOD(0x005195D0, bool, get_SignInOnPressAnyButton, (app::PlatformServiceProvider * this_ptr));
IL2CPP_REGISTER_METHOD(0x00519670, void, __ctor, (app::PlatformServiceProvider * this_ptr, app::ISignInProvider * primary_sign_in_provider, app::IDataProvider * primary_achievement_provider, app::ISignInProvider * secondary_sign_in_provider, app::IDataProvider * secondary_achievement_provider));
