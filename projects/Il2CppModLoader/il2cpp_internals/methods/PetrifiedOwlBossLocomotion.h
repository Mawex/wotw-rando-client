...
IL2CPP_REGISTER_METHOD(0x005B0220, Transform *, get_FeetTransform, (app::PetrifiedOwlBossLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x012E28E0, Vector3, get_FeetPosition, (app::PetrifiedOwlBossLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00974AE0, EntityWeightData_EntityWeight__Enum, get_Weight, (app::PetrifiedOwlBossLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0065FBA0, EntityLocomotionTask *, get_DefaultFSMState, (app::PetrifiedOwlBossLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, EntityLocomotionTask *, GetNextBehaviour, (app::PetrifiedOwlBossLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x00968AA0, void, Stop, (app::PetrifiedOwlBossLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x0083E8C0, PetrifiedOwlBossLocomotion_Stance__Enum, get_CurrentStance, (app::PetrifiedOwlBossLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01778320, Vector3, OnProcessRootMotion, (app::PetrifiedOwlBossLocomotion * this_ptr, app::Vector3 velocity));
...
IL2CPP_REGISTER_METHOD(0x004F1990, void, __ctor, (app::PetrifiedOwlBossLocomotion * this_ptr));
}
