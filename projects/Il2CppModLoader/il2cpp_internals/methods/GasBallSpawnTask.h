...
IL2CPP_REGISTER_METHOD(0x00419920, BehaviourStatus__Enum, OnExecuteTask, (app::GasBallSpawnTask * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00419FA0, void, __ctor, (app::GasBallSpawnTask * this_ptr));
}
