...
namespace app::methods::SystemIntegration_Races::PlayFabRaceServiceProvider {
IL2CPP_REGISTER_METHOD(0x005245D0, void, __ctor, (app::PlayFabRaceServiceProvider * this_ptr, app::IDataProvider * statistics_provider_provider, app::PlayFabSignInProvider * play_fab_sign_in_provider));
...
IL2CPP_REGISTER_METHOD(0x00525120, Task_1_SystemIntegration_Races_RaceRequestResult_ *, GetRaceData, (app::PlayFabRaceServiceProvider * this_ptr, app::String * race_id, app::RaceDataLeaderBoardType__Enum type, app::LeaderboardFilter__Enum filter));
IL2CPP_REGISTER_METHOD(0x00525270, String *, ToRaceString, (app::String * race_id, app::RaceDataLeaderBoardType__Enum type, app::LeaderboardFilter__Enum filter));
IL2CPP_REGISTER_METHOD(0x00525390, RaceRequestResult *, ProcessCachedLeaderBoardList, (app::PlayFabRaceServiceProvider * this_ptr, app::RaceDataCache * data_cache));
