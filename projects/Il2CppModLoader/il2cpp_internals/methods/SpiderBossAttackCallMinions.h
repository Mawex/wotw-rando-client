...
IL2CPP_REGISTER_METHOD(0x00966940, EntityPlaceholder__Array *, get_Spawners, (app::SpiderBossAttackCallMinions * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009673B0, EntityPlaceholder *, FindPlaceholderForSpawning, (app::SpiderBossAttackCallMinions * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00967B30, BehaviourStatus__Enum, OnExecute, (app::SpiderBossAttackCallMinions * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x009685F0, void, __ctor, (app::SpiderBossAttackCallMinions * this_ptr));
}
