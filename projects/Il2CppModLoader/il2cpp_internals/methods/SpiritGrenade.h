...
IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::SpiritGrenade * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006515B0, SuspendableMask__Enum, get_Mask, (app::SpiritGrenade * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBD40, IDamageReciever__Array *, get_AffectedReceivers, (app::SpiritGrenade * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D58D20, void, __ctor, (app::SpiritGrenade * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::SpiritGrenade * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::SpiritGrenade * this_ptr));
}
