...
namespace app::methods::System_Collections_Generic::List_1_SmartInput_IButtonInput_ {
...
IL2CPP_REGISTER_METHOD(0x025EFC50, IButtonInput *, get_Item, (app::List_1_SmartInput_IButtonInput_ * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x0471DF80, List_1_SmartInput_IButtonInput__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_SmartInput_IButtonInput_, GetEnumerator, (app::List_1_SmartInput_IButtonInput_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0476D740, List_1_SmartInput_IButtonInput__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_SmartInput_IButtonInput_ * this_ptr));
