...
IL2CPP_REGISTER_METHOD(0x025EFC50, Damage *, get_Item, (List_1_Damage_ * __this, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x04714F78, List_1_Damage__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (List_1_Damage_ * __this));
IL2CPP_REGISTER_METHODINFO(0x04727970, List_1_Damage__get_Count__MethodInfo);
IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (List_1_Damage_ * __this));
IL2CPP_REGISTER_METHODINFO(0x04734850, List_1_Damage__Clear__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (List_1_Damage_ * __this, Damage * item));
IL2CPP_REGISTER_METHODINFO(0x04773B10, List_1_Damage__Add__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor, (List_1_Damage_ * __this, int32_t capacity));
