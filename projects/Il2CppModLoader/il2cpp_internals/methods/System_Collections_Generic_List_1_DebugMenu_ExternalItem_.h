...
namespace app::methods::System_Collections_Generic::List_1_DebugMenu_ExternalItem_ {
...
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_1, (app::List_1_DebugMenu_ExternalItem_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHODINFO(0x047768C0, List_1_DebugMenu_ExternalItem___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_2, (app::List_1_DebugMenu_ExternalItem_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02E5A850, void, __ctor_3, (app::List_1_DebugMenu_ExternalItem_ * this_ptr, app::IEnumerable_1_DebugMenu_ExternalItem_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02E5ACD0, Object *, ICollection_get_SyncRoot, (app::List_1_DebugMenu_ExternalItem_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E8A60, DebugMenu_ExternalItem, get_Item, (app::List_1_DebugMenu_ExternalItem_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8BE0, Object *, IList_get_Item, (app::List_1_DebugMenu_ExternalItem_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_DebugMenu_ExternalItem_ *, AsReadOnly, (app::List_1_DebugMenu_ExternalItem_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025E96E0, DebugMenu_ExternalItem, Find, (app::List_1_DebugMenu_ExternalItem_ * this_ptr, app::Predicate_1_DebugMenu_ExternalItem_ * match));
IL2CPP_REGISTER_METHOD(0x025E9800, List_1_DebugMenu_ExternalItem_ *, FindAll, (app::List_1_DebugMenu_ExternalItem_ * this_ptr, app::Predicate_1_DebugMenu_ExternalItem_ * match));
...
IL2CPP_REGISTER_METHOD(0x025E9D20, List_1_T_Enumerator_DebugMenu_ExternalItem_, GetEnumerator, (app::List_1_DebugMenu_ExternalItem_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9D60, IEnumerator_1_DebugMenu_ExternalItem_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_DebugMenu_ExternalItem_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9D60, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_DebugMenu_ExternalItem_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_DebugMenu_ExternalItem_ *, GetRange, (app::List_1_DebugMenu_ExternalItem_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, DebugMenu_ExternalItem__Array *, ToArray, (app::List_1_DebugMenu_ExternalItem_ * this_ptr));
