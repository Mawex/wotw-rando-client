...
namespace app::methods::Respawner {
    ...
    IL2CPP_REGISTER_METHOD(0x003FF610, SuspendableMask__Enum, get_Mask, (app::Respawner * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FBBC0, IUberState__Array*, get_AffectingUberStates, (app::Respawner * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBBD0, void, set_AffectingUberStates, (app::Respawner * this_ptr, app::IUberState__Array* value));
    IL2CPP_REGISTER_METHOD(0x002FBBE0, List_1_UnityEngine_GameObject_*, get_AllTargets, (app::Respawner * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00908C80, void, __ctor, (app::Respawner * this_ptr));
} // namespace app::methods::Respawner
