...
namespace app::methods::Mono_Security_Cryptography::MD2Managed {
IL2CPP_REGISTER_METHOD(0x025CE830, Byte__Array *, Padding_1, (app::MD2Managed * this_ptr, int32_t n_length));
IL2CPP_REGISTER_METHOD(0x025CE910, void, __ctor_1, (app::MD2Managed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025CEB50, Byte__Array *, HashFinal_1, (app::MD2Managed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025CF150, void, __cctor_1, ());
IL2CPP_REGISTER_METHOD(0x02A3D060, Byte__Array *, Padding_2, (app::MD2Managed_1 * this_ptr, int32_t n_length));
IL2CPP_REGISTER_METHOD(0x02A3D140, void, __ctor_2, (app::MD2Managed_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A3D320, Byte__Array *, HashFinal_2, (app::MD2Managed_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A3D920, void, __cctor_2, ());
}
