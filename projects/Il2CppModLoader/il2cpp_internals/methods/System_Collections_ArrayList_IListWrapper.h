...
IL2CPP_REGISTER_METHOD(0x0201AE40, Object *, get_Item, (app::ArrayList_IListWrapper * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x0201AEE0, void, set_Item, (app::ArrayList_IListWrapper * this_ptr, int32_t index, app::Object * value));
IL2CPP_REGISTER_METHOD(0x0201AFA0, Object *, get_SyncRoot, (app::ArrayList_IListWrapper * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0201B230, Object *, Clone, (app::ArrayList_IListWrapper * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0201B7C0, IEnumerator *, GetEnumerator, (app::ArrayList_IListWrapper * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0201C280, Object__Array *, ToArray_1, (app::ArrayList_IListWrapper * this_ptr));
IL2CPP_REGISTER_METHOD(0x0201C350, Array *, ToArray_2, (app::ArrayList_IListWrapper * this_ptr, app::Type * type));
