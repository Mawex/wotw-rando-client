...
IL2CPP_REGISTER_METHOD(0x01B6D030, ValueTuple_2_Moon_UberID_Moon_UberStateHeader_UberStateType_, Read, (app::UberStateArchive * archive, int32_t store_version));
