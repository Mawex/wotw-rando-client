...
namespace app::methods::FullSerializer_Internal::fsEnumConverter {
...
IL2CPP_REGISTER_METHOD(0x01654D50, Object *, CreateInstance, (app::fsEnumConverter * this_ptr, app::fsData * data, app::Type * storage_type));
IL2CPP_REGISTER_METHOD(0x01654E10, fsResult, TrySerialize, (app::fsEnumConverter * this_ptr, app::Object * instance, app::fsData * * serialized, app::Type * storage_type));
IL2CPP_REGISTER_METHOD(0x016554F0, fsResult, TryDeserialize, (app::fsEnumConverter * this_ptr, app::fsData * data, app::Object * * instance, app::Type * storage_type));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::fsEnumConverter * this_ptr));
