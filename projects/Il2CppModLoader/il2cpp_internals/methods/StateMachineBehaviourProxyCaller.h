...
IL2CPP_REGISTER_METHOD(0x009B5F10, StateMachineBehaviourProxy_IReceiver *, GetReceiver, (app::StateMachineBehaviourProxyCaller * this_ptr, app::Animator * animator));
...
IL2CPP_REGISTER_METHOD(0x004140E0, void, __ctor, (app::StateMachineBehaviourProxyCaller * this_ptr));
}
