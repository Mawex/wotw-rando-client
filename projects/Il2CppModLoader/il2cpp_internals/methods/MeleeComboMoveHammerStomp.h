...
IL2CPP_REGISTER_METHOD(0x00813FA0, HammerComboMoveBase_BalancingData *, get_BalancingBase, (app::MeleeComboMoveHammerStomp * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0139F2C0, void, HandleCollapsingPlatform, (app::MeleeComboMoveHammerStomp * this_ptr, app::Collider * hit_collider, bool perform_collapse, app::bool * hit_collapsing_platform));
...
IL2CPP_REGISTER_METHOD(0x013A1080, void, __ctor, (app::MeleeComboMoveHammerStomp * this_ptr));
}
