...
IL2CPP_REGISTER_METHOD(0x003FFBD0, MenuTabBackground__Enum, get_BackgroundMode, (app::SpiritShardsScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D72E90, SpellUIItem *, get_SelectedSpellUIItem, (app::SpiritShardsScreen * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D72F90, PlayerUberStateInventory_InventoryItem *, get_SelectedSpell, (app::SpiritShardsScreen * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D73130, SpiritShardUIItem *, get_SelectedSpiritShardUIItem, (app::SpiritShardsScreen * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D73230, SpiritShardUIShardSocket *, get_SelectedSpiritShardSocket, (app::SpiritShardsScreen * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D73330, PlayerUberStateShards_Shard *, get_SelectedSpiritShard, (app::SpiritShardsScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C75A10, SuspendableMask__Enum, get_Mask, (app::SpiritShardsScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D757D0, PlayerUberStateShards_Shard *, GetActualInventoryItem, (app::SpiritShardsScreen * this_ptr, app::SpiritShardType__Enum typ));
...
IL2CPP_REGISTER_METHOD(0x00D763B0, void, __ctor, (app::SpiritShardsScreen * this_ptr));
}
