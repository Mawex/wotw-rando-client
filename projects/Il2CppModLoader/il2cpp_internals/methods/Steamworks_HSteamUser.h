...
IL2CPP_REGISTER_METHOD(0x001311C0, String *, ToString, (app::HSteamUser__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006CE970, HSteamUser, operator__1, (int32_t value));
