...
namespace app::methods::System_Threading::SemaphoreSlim {
IL2CPP_REGISTER_METHOD(0x0232AD00, int32_t, get_CurrentCount, (app::SemaphoreSlim * this_ptr));
IL2CPP_REGISTER_METHOD(0x0232AD10, void, __ctor_1, (app::SemaphoreSlim * this_ptr, int32_t initial_count));
IL2CPP_REGISTER_METHOD(0x0232AD20, void, __ctor_2, (app::SemaphoreSlim * this_ptr, int32_t initial_count, int32_t max_count));
...
IL2CPP_REGISTER_METHOD(0x0232B670, Task *, WaitAsync_1, (app::SemaphoreSlim * this_ptr));
IL2CPP_REGISTER_METHOD(0x0232B680, Task_1_System_Boolean_ *, WaitAsync_2, (app::SemaphoreSlim * this_ptr, int32_t milliseconds_timeout, app::CancellationToken cancellation_token));
IL2CPP_REGISTER_METHODINFO(0x04781368, SemaphoreSlim_WaitAsync_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0232BAB0, SemaphoreSlim_TaskNode *, CreateAndAddAsyncWaiter, (app::SemaphoreSlim * this_ptr));
IL2CPP_REGISTER_METHOD(0x0232BD20, bool, RemoveAsyncWaiter, (app::SemaphoreSlim * this_ptr, app::SemaphoreSlim_TaskNode * task));
IL2CPP_REGISTER_METHOD(0x0232BDB0, Task_1_System_Boolean_ *, WaitUntilCountOrTimeoutAsync, (app::SemaphoreSlim * this_ptr, app::SemaphoreSlim_TaskNode * async_waiter, int32_t milliseconds_timeout, app::CancellationToken cancellation_token));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, String *, GetResourceString, (app::String * str));
