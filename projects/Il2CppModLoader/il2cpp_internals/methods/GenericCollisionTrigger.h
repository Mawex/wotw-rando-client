...
IL2CPP_REGISTER_METHOD(0x002FBCA0, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::GenericCollisionTrigger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E068C0, IUberState__Array *, get_AffectingUberStates, (app::GenericCollisionTrigger * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E06A00, void, StopTransitions, (app::GenericCollisionTrigger * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E06B20, void, __ctor, (app::GenericCollisionTrigger * this_ptr));
}
