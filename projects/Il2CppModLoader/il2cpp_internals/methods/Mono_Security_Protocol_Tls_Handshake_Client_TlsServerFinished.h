...
namespace app::methods::Mono_Security_Protocol_Tls_Handshake_Client::TlsServerFinished {
IL2CPP_REGISTER_METHOD(0x01F6F4B0, void, __ctor, (app::TlsServerFinished_1 * this_ptr, app::Context_1 * context, app::Byte__Array * buffer));
