...
IL2CPP_REGISTER_METHOD(0x02266420, void, __ctor, (app::LocalDataStore * this_ptr, app::LocalDataStoreMgr * mgr, int32_t initial_capacity));
IL2CPP_REGISTER_METHOD(0x022664C0, void, Dispose, (app::LocalDataStore * this_ptr));
IL2CPP_REGISTER_METHOD(0x022664F0, Object *, GetData, (app::LocalDataStore * this_ptr, app::LocalDataStoreSlot * slot));
...
IL2CPP_REGISTER_METHOD(0x02266820, LocalDataStoreElement *, PopulateElement, (app::LocalDataStore * this_ptr, app::LocalDataStoreSlot * slot));
