...
IL2CPP_REGISTER_METHOD(0x011E8100, String *, GetValueToDisplay, (app::ContrastVolumeSlider * this_ptr));
IL2CPP_REGISTER_METHOD(0x00444040, void, __ctor, (app::ContrastVolumeSlider * this_ptr));
}
