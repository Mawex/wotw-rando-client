...
namespace app::methods::UnityEngine_Networking::UnityWebRequest {
IL2CPP_REGISTER_METHOD(0x0317E420, void, __ctor_1, (app::UnityWebRequest * this_ptr, app::String * url));
IL2CPP_REGISTER_METHOD(0x0317E4A0, void, __ctor_2, (app::UnityWebRequest * this_ptr, app::String * url, app::String * method_1));
IL2CPP_REGISTER_METHOD(0x0317E530, void, __ctor_3, (app::UnityWebRequest * this_ptr, app::String * url, app::String * method_1, app::DownloadHandler * download_handler, app::UploadHandler * upload_handler));
IL2CPP_REGISTER_METHOD(0x0317E5F0, void, __ctor_4, (app::UnityWebRequest * this_ptr, app::Uri * uri, app::String * method_1, app::DownloadHandler * download_handler, app::UploadHandler * upload_handler));
IL2CPP_REGISTER_METHOD(0x0317E7B0, String *, GetWebErrorString, (app::UnityWebRequest_UnityWebRequestError__Enum err));
IL2CPP_REGISTER_METHOD(0x0317E800, String *, GetHTTPStatusString, (int64_t response_code));
...
IL2CPP_REGISTER_METHOD(0x0317EC40, UnityWebRequestAsyncOperation *, BeginWebRequest, (app::UnityWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x0317EC90, AsyncOperation_1 *, Send, (app::UnityWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x0317EC90, UnityWebRequestAsyncOperation *, SendWebRequest, (app::UnityWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x0317ECF0, void, Abort, (app::UnityWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x0317ED40, UnityWebRequest_UnityWebRequestError__Enum, SetMethod, (app::UnityWebRequest * this_ptr, app::UnityWebRequest_UnityWebRequestMethod__Enum method_type));
...
IL2CPP_REGISTER_METHOD(0x0317EF20, UnityWebRequest_UnityWebRequestError__Enum, SetCustomMethod, (app::UnityWebRequest * this_ptr, app::String * custom_method_name));
...
IL2CPP_REGISTER_METHOD(0x0317F430, UnityWebRequest_UnityWebRequestError__Enum, GetError, (app::UnityWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x0317F480, String *, get_error, (app::UnityWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x0317F7C0, String *, get_url, (app::UnityWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0317F7C0, String *, GetUrl, (app::UnityWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x0317FA00, UnityWebRequest_UnityWebRequestError__Enum, SetUrl, (app::UnityWebRequest * this_ptr, app::String * url));
...
IL2CPP_REGISTER_METHOD(0x0317FD70, UnityWebRequest_UnityWebRequestError__Enum, SetChunked, (app::UnityWebRequest * this_ptr, bool chunked));
...
IL2CPP_REGISTER_METHOD(0x0317FF50, UnityWebRequest_UnityWebRequestError__Enum, InternalSetRequestHeader, (app::UnityWebRequest * this_ptr, app::String * name, app::String * value));
...
IL2CPP_REGISTER_METHOD(0x031801D0, UnityWebRequest_UnityWebRequestError__Enum, SetUploadHandler, (app::UnityWebRequest * this_ptr, app::UploadHandler * uh));
IL2CPP_REGISTER_METHOD(0x01704A60, UploadHandler *, get_uploadHandler, (app::UnityWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031803C0, UnityWebRequest_UnityWebRequestError__Enum, SetDownloadHandler, (app::UnityWebRequest * this_ptr, app::DownloadHandler * dh));
IL2CPP_REGISTER_METHOD(0x01F25880, DownloadHandler *, get_downloadHandler, (app::UnityWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F234C0, CertificateHandler *, get_certificateHandler, (app::UnityWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x031805B0, UnityWebRequest *, Get_1, (app::String * uri));
IL2CPP_REGISTER_METHOD(0x03180820, UnityWebRequest *, Get_2, (app::Uri * uri));
IL2CPP_REGISTER_METHOD(0x03180A90, UnityWebRequest *, Put, (app::String * uri, app::Byte__Array * body_data));
IL2CPP_REGISTER_METHOD(0x03180DD0, String *, UnEscapeURL_1, (app::String * s));
IL2CPP_REGISTER_METHOD(0x03180F30, String *, UnEscapeURL_2, (app::String * s, app::Encoding * e));
}
