...
namespace app::methods::System_Diagnostics_Tracing::ClassPropertyWriter_2_System_Int32_System_Int32_ {
    IL2CPP_REGISTER_METHOD(0x02B3A500, void, __ctor, (app::ClassPropertyWriter_2_System_Int32_System_Int32_ * this_ptr, app::PropertyAnalysis * property));
