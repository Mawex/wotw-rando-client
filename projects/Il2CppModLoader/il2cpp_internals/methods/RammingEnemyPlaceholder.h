...
IL2CPP_REGISTER_METHOD(0x0072D020, LegacyEntity *, Instantiate, (app::RammingEnemyPlaceholder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0072D690, void, __ctor, (app::RammingEnemyPlaceholder * this_ptr));
}
