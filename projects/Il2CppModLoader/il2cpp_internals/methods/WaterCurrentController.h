...
IL2CPP_REGISTER_METHOD(0x008D3C30, Vector2, get_CurrentDirection, (app::WaterCurrentController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008D4B50, Vector2, VelocityAtPoint, (app::WaterCurrentController * this_ptr, app::Vector3 point));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::WaterCurrentController * this_ptr));
}
