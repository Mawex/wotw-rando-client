...
namespace app::methods::System_Net_Http_Headers::EntityTagHeaderValue {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::EntityTagHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Tag, (app::EntityTagHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_Tag, (app::EntityTagHeaderValue * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x0173F610, Object *, ICloneable_Clone, (app::EntityTagHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D080C0, String *, ToString, (app::EntityTagHeaderValue * this_ptr));
