...
namespace app::methods::System_Collections_ObjectModel::ReadOnlyCollection_1_DynamicInstantiationDescriptor_ReflectionInfo_ {
IL2CPP_REGISTER_METHOD(0x02B7DCF0, void, __ctor, (app::ReadOnlyCollection_1_DynamicInstantiationDescriptor_ReflectionInfo_ * this_ptr, app::IList_1_DynamicInstantiationDescriptor_ReflectionInfo_ * list));
...
IL2CPP_REGISTER_METHOD(0x02B7DD70, DynamicInstantiationDescriptor_ReflectionInfo, get_Item, (app::ReadOnlyCollection_1_DynamicInstantiationDescriptor_ReflectionInfo_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02B7DF30, IEnumerator_1_DynamicInstantiationDescriptor_ReflectionInfo_ *, GetEnumerator, (app::ReadOnlyCollection_1_DynamicInstantiationDescriptor_ReflectionInfo_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B7DD70, DynamicInstantiationDescriptor_ReflectionInfo, System_Collections_Generic_IList_T__get_Item, (app::ReadOnlyCollection_1_DynamicInstantiationDescriptor_ReflectionInfo_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02F0F240, IEnumerator *, IEnumerable_GetEnumerator, (app::ReadOnlyCollection_1_DynamicInstantiationDescriptor_ReflectionInfo_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F0F2D0, Object *, ICollection_get_SyncRoot, (app::ReadOnlyCollection_1_DynamicInstantiationDescriptor_ReflectionInfo_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B7E6C0, Object *, IList_get_Item, (app::ReadOnlyCollection_1_DynamicInstantiationDescriptor_ReflectionInfo_ * this_ptr, int32_t index));
