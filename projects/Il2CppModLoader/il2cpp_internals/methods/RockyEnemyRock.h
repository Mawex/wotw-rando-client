...
IL2CPP_REGISTER_METHOD(0x01363360, Vector3, get_PlayerPosition, (app::RockyEnemyRock * this_ptr));
IL2CPP_REGISTER_METHOD(0x01363450, void, __ctor, (app::RockyEnemyRock * this_ptr));
}
