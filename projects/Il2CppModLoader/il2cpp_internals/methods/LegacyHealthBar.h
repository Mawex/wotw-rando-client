...
IL2CPP_REGISTER_METHOD(0x00A283B0, void, __ctor, (app::LegacyHealthBar * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDisableOnRecordablePreview_get_gameObject, (app::LegacyHealthBar * this_ptr));
}
