...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::Terrain_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x0319A290, TerrainData_1 *, get_terrainData, (app::Terrain_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0319A410, Terrain_1__Array *, get_activeTerrains, ());
}
