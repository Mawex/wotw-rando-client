...
IL2CPP_REGISTER_METHOD(0x002FBD60, StateMachine_2 *, get_StateMachine, (app::PetrifiedOwlBossLandBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, PetrifiedOwlBossBaseBehaviour_PetrifiedOwlBossBaseStatesSet *, get_States, (app::PetrifiedOwlBossLandBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01775C50, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossLandBehaviour * this_ptr, app::IContext * context));
