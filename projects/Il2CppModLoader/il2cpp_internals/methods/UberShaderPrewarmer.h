...
IL2CPP_REGISTER_METHOD(0x019149B0, bool, get_IsLoaded, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x01914AD0, float, get_LoadProgress, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x01914BF0, float, get_WarmProgress, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x01914D80, float, get_TotalProgress, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x01914E40, void, Load, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x01916FD0, void, __cctor, (MethodInfo * method));
}
