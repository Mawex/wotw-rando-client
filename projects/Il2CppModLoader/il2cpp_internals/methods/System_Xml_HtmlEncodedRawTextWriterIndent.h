...
namespace app::methods::System_Xml::HtmlEncodedRawTextWriterIndent {
IL2CPP_REGISTER_METHOD(0x021FAA40, void, __ctor_1, (app::HtmlEncodedRawTextWriterIndent * this_ptr, app::TextWriter * writer, app::XmlWriterSettings * settings));
IL2CPP_REGISTER_METHOD(0x021FAAA0, void, __ctor_2, (app::HtmlEncodedRawTextWriterIndent * this_ptr, app::Stream * stream, app::XmlWriterSettings * settings));
