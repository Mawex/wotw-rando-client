...
IL2CPP_REGISTER_METHOD(0x0247C900, Material *, get_material, (app::CameraFilterPack_Gradients_Rainbow * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0247CF20, void, __ctor, (app::CameraFilterPack_Gradients_Rainbow * this_ptr));
}
