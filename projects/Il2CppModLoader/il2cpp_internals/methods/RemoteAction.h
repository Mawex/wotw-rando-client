...
IL2CPP_REGISTER_METHOD(0x02EA11B0, void, Init, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x02EA1970, void, StartCheckingThread, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x02EA1C50, void, __cctor, (MethodInfo * method));
}
