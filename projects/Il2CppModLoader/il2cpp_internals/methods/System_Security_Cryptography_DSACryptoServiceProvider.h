...
IL2CPP_REGISTER_METHOD(0x00420EE0, String *, get_KeyExchangeAlgorithm, (app::DSACryptoServiceProvider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020D63F0, String *, get_SignatureAlgorithm, (app::DSACryptoServiceProvider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020D6580, DSAParameters, ExportParameters, (app::DSACryptoServiceProvider * this_ptr, bool include_private_parameters));
...
IL2CPP_REGISTER_METHOD(0x01D61480, Byte__Array *, CreateSignature, (app::DSACryptoServiceProvider * this_ptr, app::Byte__Array * rgb_hash));
IL2CPP_REGISTER_METHOD(0x020D6700, Byte__Array *, SignData_1, (app::DSACryptoServiceProvider * this_ptr, app::Byte__Array * buffer));
IL2CPP_REGISTER_METHOD(0x020D6760, Byte__Array *, SignData_2, (app::DSACryptoServiceProvider * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count));
IL2CPP_REGISTER_METHOD(0x020D67F0, Byte__Array *, SignData_3, (app::DSACryptoServiceProvider * this_ptr, app::Stream * input_stream));
IL2CPP_REGISTER_METHOD(0x020D6850, Byte__Array *, SignHash, (app::DSACryptoServiceProvider * this_ptr, app::Byte__Array * rgb_hash, app::String * str));
...
IL2CPP_REGISTER_METHOD(0x020D6B80, Byte__Array *, HashData_1, (app::DSACryptoServiceProvider * this_ptr, app::Byte__Array * data, int32_t offset, int32_t count, app::HashAlgorithmName hash_algorithm));
IL2CPP_REGISTER_METHODINFO(0x0475DCB0, DSACryptoServiceProvider_HashData__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020D6D10, Byte__Array *, HashData_2, (app::DSACryptoServiceProvider * this_ptr, app::Stream * data, app::HashAlgorithmName hash_algorithm));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, CspKeyContainerInfo *, get_CspKeyContainerInfo, (app::DSACryptoServiceProvider * this_ptr));
IL2CPP_REGISTER_METHOD(0x020D6F60, Byte__Array *, ExportCspBlob, (app::DSACryptoServiceProvider * this_ptr, bool include_private_parameters));
