...
namespace app::methods::System_Text::UTF8Encoding {
IL2CPP_REGISTER_METHOD(0x027CE2E0, void, __ctor_1, (app::UTF8Encoding * this_ptr));
IL2CPP_REGISTER_METHOD(0x027CE2F0, void, __ctor_2, (app::UTF8Encoding * this_ptr, bool encoder_should_emit_u_t_f8_identifier));
IL2CPP_REGISTER_METHOD(0x027CE300, void, __ctor_3, (app::UTF8Encoding * this_ptr, bool encoder_should_emit_u_t_f8_identifier, bool throw_on_invalid_bytes));
...
IL2CPP_REGISTER_METHOD(0x027CE8D0, int32_t, GetByteCount_3, (app::UTF8Encoding * this_ptr, app::uint16_t * chars, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x027CEF40, int32_t, GetBytes_3, (app::UTF8Encoding * this_ptr, app::uint16_t * chars, int32_t char_count, app::uint8_t * bytes, int32_t byte_count));
...
IL2CPP_REGISTER_METHOD(0x027CF290, int32_t, GetCharCount_2, (app::UTF8Encoding * this_ptr, app::uint8_t * bytes, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x027CF670, int32_t, GetChars_2, (app::UTF8Encoding * this_ptr, app::uint8_t * bytes, int32_t byte_count, app::uint16_t * chars, int32_t char_count));
IL2CPP_REGISTER_METHODINFO(0x047459D8, UTF8Encoding_GetChars_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027CF7F0, String *, GetString, (app::UTF8Encoding * this_ptr, app::Byte__Array * bytes, int32_t index, int32_t count));
IL2CPP_REGISTER_METHODINFO(0x04727268, UTF8Encoding_GetString__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027CF9C0, int32_t, GetByteCount_4, (app::UTF8Encoding * this_ptr, app::uint16_t * chars, int32_t count, app::EncoderNLS * base_encoder));
IL2CPP_REGISTER_METHODINFO(0x0470C380, UTF8Encoding_GetByteCount_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027D00E0, int32_t, PtrDiff_1, (app::uint16_t * a, app::uint16_t * b));
IL2CPP_REGISTER_METHOD(0x027D00F0, int32_t, PtrDiff_2, (app::uint8_t * a, app::uint8_t * b));
IL2CPP_REGISTER_METHOD(0x0195FD00, bool, InRange, (int32_t ch, int32_t start, int32_t end));
IL2CPP_REGISTER_METHOD(0x027D0100, int32_t, GetBytes_4, (app::UTF8Encoding * this_ptr, app::uint16_t * chars, int32_t char_count, app::uint8_t * bytes, int32_t byte_count, app::EncoderNLS * base_encoder));
IL2CPP_REGISTER_METHODINFO(0x04732988, UTF8Encoding_GetBytes_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027D0A20, int32_t, GetCharCount_3, (app::UTF8Encoding * this_ptr, app::uint8_t * bytes, int32_t count, app::DecoderNLS * base_decoder));
IL2CPP_REGISTER_METHOD(0x027D0FA0, int32_t, GetChars_3, (app::UTF8Encoding * this_ptr, app::uint8_t * bytes, int32_t byte_count, app::uint16_t * chars, int32_t char_count, app::DecoderNLS * base_decoder));
...
IL2CPP_REGISTER_METHOD(0x027D1A90, int32_t, FallbackInvalidByteSequence_2, (app::UTF8Encoding * this_ptr, app::uint8_t * p_src, int32_t ch, app::DecoderFallbackBuffer * fallback));
IL2CPP_REGISTER_METHOD(0x027D1AE0, Byte__Array *, GetBytesUnknown, (app::UTF8Encoding * this_ptr, app::uint8_t * * p_src, int32_t ch));
IL2CPP_REGISTER_METHOD(0x027D1E60, Decoder *, GetDecoder, (app::UTF8Encoding * this_ptr));
IL2CPP_REGISTER_METHOD(0x027D1FD0, Encoder *, GetEncoder, (app::UTF8Encoding * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x027D2420, Byte__Array *, GetPreamble, (app::UTF8Encoding * this_ptr));
