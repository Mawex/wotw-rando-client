...
namespace app::methods::System_Collections::Stack_StackEnumerator {
IL2CPP_REGISTER_METHOD(0x02032A90, void, __ctor, (app::Stack_StackEnumerator * this_ptr, app::Stack * stack));
IL2CPP_REGISTER_METHOD(0x0173F610, Object *, Clone, (app::Stack_StackEnumerator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02032C90, Object *, get_Current, (app::Stack_StackEnumerator * this_ptr));
