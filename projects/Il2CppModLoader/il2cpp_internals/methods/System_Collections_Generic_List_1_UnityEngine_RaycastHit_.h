...
namespace app::methods::System_Collections_Generic::List_1_UnityEngine_RaycastHit_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_UnityEngine_RaycastHit_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02EE10D0, RaycastHit, get_Item, (app::List_1_UnityEngine_RaycastHit_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02EE2350, List_1_T_Enumerator_UnityEngine_RaycastHit_, GetEnumerator, (app::List_1_UnityEngine_RaycastHit_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047798D0, List_1_UnityEngine_RaycastHit__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_UnityEngine_RaycastHit_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02EE0AD0, void, __ctor_3, (app::List_1_UnityEngine_RaycastHit_ * this_ptr, app::IEnumerable_1_UnityEngine_RaycastHit_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02EE0F70, Object *, ICollection_get_SyncRoot, (app::List_1_UnityEngine_RaycastHit_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02EE12B0, Object *, IList_get_Item, (app::List_1_UnityEngine_RaycastHit_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_UnityEngine_RaycastHit_ *, AsReadOnly, (app::List_1_UnityEngine_RaycastHit_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02EE1C50, RaycastHit, Find, (app::List_1_UnityEngine_RaycastHit_ * this_ptr, app::Predicate_1_UnityEngine_RaycastHit_ * match));
IL2CPP_REGISTER_METHOD(0x02EE1DD0, List_1_UnityEngine_RaycastHit_ *, FindAll, (app::List_1_UnityEngine_RaycastHit_ * this_ptr, app::Predicate_1_UnityEngine_RaycastHit_ * match));
...
IL2CPP_REGISTER_METHOD(0x02EE23B0, IEnumerator_1_UnityEngine_RaycastHit_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_UnityEngine_RaycastHit_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02EE23B0, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_UnityEngine_RaycastHit_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_UnityEngine_RaycastHit_ *, GetRange, (app::List_1_UnityEngine_RaycastHit_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, RaycastHit__Array *, ToArray, (app::List_1_UnityEngine_RaycastHit_ * this_ptr));
