...
namespace app::methods::System_Globalization::CultureInfo {
...
IL2CPP_REGISTER_METHOD(0x002FBBE0, String *, get_Territory, (app::CultureInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CC59E0, int32_t, get_LCID, (app::CultureInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, String *, get_Name, (app::CultureInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x025F54E0, Calendar *, get_Calendar, (app::CultureInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x025F55B0, CultureInfo *, get_Parent, (app::CultureInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x025F5B00, TextInfo *, get_TextInfo, (app::CultureInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x025F5D70, Object *, Clone, (app::CultureInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x025F6020, bool, Equals, (app::CultureInfo * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x025F6140, CultureInfo__Array *, GetCultures, (app::CultureTypes__Enum types));
IL2CPP_REGISTER_METHOD(0x025F6680, CultureInfo_Data, GetTextInfoData, (app::CultureInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CC59E0, int32_t, GetHashCode, (app::CultureInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x025F66A0, CultureInfo *, ReadOnly, (app::CultureInfo * ci));
IL2CPP_REGISTER_METHODINFO(0x0477F4F8, CultureInfo_ReadOnly__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FB9F0, String *, ToString, (app::CultureInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x025F6990, CompareInfo *, get_CompareInfo, (app::CultureInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025F6C20, NumberFormatInfo *, get_NumberFormat, (app::CultureInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025F6F00, DateTimeFormatInfo *, get_DateTimeFormat, (app::CultureInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025F7230, String *, get_EnglishName, (app::CultureInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x0052B590, bool, get_IsReadOnly, (app::CultureInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x025F72A0, Object *, GetFormat, (app::CultureInfo * this_ptr, app::Type * format_type));
...
IL2CPP_REGISTER_METHOD(0x025F78C0, TextInfo *, CreateTextInfo, (app::CultureInfo * this_ptr, bool read_only));
IL2CPP_REGISTER_METHOD(0x025F7A30, void, __ctor_1, (app::CultureInfo * this_ptr, int32_t culture));
IL2CPP_REGISTER_METHOD(0x025F7A50, void, __ctor_2, (app::CultureInfo * this_ptr, int32_t culture, bool use_user_override));
IL2CPP_REGISTER_METHOD(0x025F7A70, void, __ctor_3, (app::CultureInfo * this_ptr, int32_t culture, bool use_user_override, bool read_only));
IL2CPP_REGISTER_METHODINFO(0x0472CAB8, CultureInfo__ctor_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F7D70, void, __ctor_4, (app::CultureInfo * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x025F7D90, void, __ctor_5, (app::CultureInfo * this_ptr, app::String * name, bool use_user_override));
IL2CPP_REGISTER_METHOD(0x025F7DB0, void, __ctor_6, (app::CultureInfo * this_ptr, app::String * name, bool use_user_override, bool read_only));
IL2CPP_REGISTER_METHODINFO(0x04779488, CultureInfo__ctor_5__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F8150, void, __ctor_7, (app::CultureInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x025F8160, void, insert_into_shared_tables, (app::CultureInfo * c));
IL2CPP_REGISTER_METHOD(0x025F84F0, CultureInfo *, GetCultureInfo_1, (int32_t culture));
IL2CPP_REGISTER_METHODINFO(0x0470FA30, CultureInfo_GetCultureInfo__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F88B0, CultureInfo *, GetCultureInfo_2, (app::String * name));
IL2CPP_REGISTER_METHODINFO(0x04784448, CultureInfo_GetCultureInfo_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F8C60, CultureInfo *, CreateCulture, (app::String * name, bool reference));
IL2CPP_REGISTER_METHOD(0x025F8DE0, CultureInfo *, CreateSpecificCulture, (app::String * name));
IL2CPP_REGISTER_METHODINFO(0x047034D8, CultureInfo_CreateSpecificCulture__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F9340, CultureInfo *, CreateSpecificCultureFromNeutral, (app::String * name));
...
IL2CPP_REGISTER_METHOD(0x025FAF30, Calendar *, CreateCalendar, (int32_t calendar_type));
IL2CPP_REGISTER_METHODINFO(0x04756720, CultureInfo_CreateCalendar__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025FB250, Exception *, CreateNotFoundException, (app::String * name));
...
IL2CPP_REGISTER_METHOD(0x002FB9F0, String *, get_SortName, (app::CultureInfo * this_ptr));
