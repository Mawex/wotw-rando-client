...
IL2CPP_REGISTER_METHOD(0x00ABA180, Object *, CreateData, (app::ServerBreakablePhysicalSetup * this_ptr, app::Object * data));
IL2CPP_REGISTER_METHOD(0x00ABA5D0, Component_1 *, ApplyData, (app::ServerBreakablePhysicalSetup * this_ptr, app::GameObject * * gameobj));
