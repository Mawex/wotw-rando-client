...
IL2CPP_REGISTER_METHOD(0x00D597F0, void, __ctor, (app::SpiritGrenadeDamageDealer * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::SpiritGrenadeDamageDealer * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::SpiritGrenadeDamageDealer * this_ptr));
}
