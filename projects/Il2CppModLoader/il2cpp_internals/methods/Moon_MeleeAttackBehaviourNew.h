...
IL2CPP_REGISTER_METHOD(0x00813FA0, DamageOwner *, get_DamageOwner, (app::MeleeAttackBehaviourNew * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011108F0, BehaviourStatus__Enum, OnExecute, (app::MeleeAttackBehaviourNew * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01112B30, EffectSpawn, ProvideDamageEffect, (app::MeleeAttackBehaviourNew * this_ptr, app::DamageResult result));
IL2CPP_REGISTER_METHOD(0x01112BC0, Vector3, RootMotionModifier, (app::MeleeAttackBehaviourNew * this_ptr, app::Vector3 motion));
