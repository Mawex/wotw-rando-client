...
IL2CPP_REGISTER_METHOD(0x00CAAB00, String *, GetBaseShaderProperties, (app::EnvironmentTintModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CAABA0, void, SetProperties, (app::EnvironmentTintModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CAAC60, void, __ctor, (app::EnvironmentTintModifier * this_ptr));
}
