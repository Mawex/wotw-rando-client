...
namespace app::methods::Moon_Telemetry_Performance::ReportMetadata {
IL2CPP_REGISTER_METHOD(0x00E39DE0, void, __ctor_1, (app::ReportMetadata * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E39FB0, void, __ctor_2, (app::ReportMetadata * this_ptr, app::ReportMetadata * meta));
...
IL2CPP_REGISTER_METHOD(0x00E3A4C0, DateTime, get_RevisionDate, (app::ReportMetadata * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBE0, DataBundle *, get_DataBundle, (app::ReportMetadata * this_ptr));
}
