...
IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::LegacyBabySandWormNew * this_ptr));
IL2CPP_REGISTER_METHOD(0x015D2480, Vector2, get_UpDirection, (app::LegacyBabySandWormNew * this_ptr));
IL2CPP_REGISTER_METHOD(0x015D25A0, void, set_UpDirection, (app::LegacyBabySandWormNew * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x015D26E0, Vector2, get_WorldSpeed, (app::LegacyBabySandWormNew * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x015D28B0, Vector2, get_TargetPosition, (app::LegacyBabySandWormNew * this_ptr));
IL2CPP_REGISTER_METHOD(0x0074F800, SuspendableMask__Enum, get_Mask, (app::LegacyBabySandWormNew * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x015D5010, Vector2, GetAvoidanceForces, (app::LegacyBabySandWormNew * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x015D5C40, DigZone *, GetDigZoneIntersectingPoint, (app::LegacyBabySandWormNew * this_ptr, app::Vector3 center));
...
IL2CPP_REGISTER_METHOD(0x00720040, IDamageReciever__Array *, get_AffectedReceivers, (app::LegacyBabySandWormNew * this_ptr));
IL2CPP_REGISTER_METHOD(0x015D7B70, void, __ctor, (app::LegacyBabySandWormNew * this_ptr));
}
