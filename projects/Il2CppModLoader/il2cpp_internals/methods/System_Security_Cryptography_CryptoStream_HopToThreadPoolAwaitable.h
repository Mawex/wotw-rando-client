...
namespace app::methods::System_Security_Cryptography::CryptoStream_HopToThreadPoolAwaitable {
IL2CPP_REGISTER_METHOD(0x0010E100, CryptoStream_HopToThreadPoolAwaitable, GetAwaiter, (app::CryptoStream_HopToThreadPoolAwaitable__Boxed * this_ptr));
