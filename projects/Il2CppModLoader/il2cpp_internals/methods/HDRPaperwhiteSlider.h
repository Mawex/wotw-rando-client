...
IL2CPP_REGISTER_METHOD(0x0109B630, String *, GetValueToDisplay, (app::HDRPaperwhiteSlider * this_ptr));
IL2CPP_REGISTER_METHOD(0x00444040, void, __ctor, (app::HDRPaperwhiteSlider * this_ptr));
}
