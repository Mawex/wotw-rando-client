...
IL2CPP_REGISTER_METHOD(0x031A7280, Ray, ScreenPointToRay, (app::Camera * cam, app::Vector2 screen_pos));
IL2CPP_REGISTER_METHOD(0x031A7500, Vector2, WorldToScreenPoint, (app::Camera * cam, app::Vector3 world_point));
...
IL2CPP_REGISTER_METHOD(0x031A7CD0, Vector2, GetTransposed, (app::Vector2 input));
IL2CPP_REGISTER_METHOD(0x031A7CF0, Vector2, PixelAdjustPoint, (app::Vector2 point, app::Transform * element_transform, app::Canvas * canvas));
IL2CPP_REGISTER_METHOD(0x031A7DF0, Rect, PixelAdjustRect, (app::RectTransform * rect_transform, app::Canvas * canvas));
