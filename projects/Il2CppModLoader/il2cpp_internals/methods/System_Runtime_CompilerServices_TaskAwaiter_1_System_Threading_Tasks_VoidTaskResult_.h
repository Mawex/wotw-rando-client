...
namespace app::methods::System_Runtime_CompilerServices::TaskAwaiter_1_System_Threading_Tasks_VoidTaskResult_ {
IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor, (app::TaskAwaiter_1_System_Threading_Tasks_VoidTaskResult___Boxed * this_ptr, app::Task_1_VoidTaskResult_ * task));
...
IL2CPP_REGISTER_METHOD(0x001FF6C0, VoidTaskResult, GetResult, (app::TaskAwaiter_1_System_Threading_Tasks_VoidTaskResult___Boxed * this_ptr));
}
