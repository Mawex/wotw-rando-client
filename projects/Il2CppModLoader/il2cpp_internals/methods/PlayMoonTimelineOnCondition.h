...
IL2CPP_REGISTER_METHOD(0x0117A020, MoonTimeline *, get_CachedTimeline, (app::PlayMoonTimelineOnCondition * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::PlayMoonTimelineOnCondition * this_ptr));
}
