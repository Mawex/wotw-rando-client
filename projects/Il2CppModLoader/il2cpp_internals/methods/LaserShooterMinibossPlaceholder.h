...
IL2CPP_REGISTER_METHOD(0x006253D0, GameObject *, get_Prefab, (app::LaserShooterMinibossPlaceholder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F1CCD0, void, __ctor, (app::LaserShooterMinibossPlaceholder * this_ptr));
}
