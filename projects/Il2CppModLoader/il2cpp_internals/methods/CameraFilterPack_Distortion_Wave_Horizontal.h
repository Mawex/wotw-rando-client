...
IL2CPP_REGISTER_METHOD(0x024ED700, Material *, get_material, (app::CameraFilterPack_Distortion_Wave_Horizontal * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02477280, void, __ctor, (app::CameraFilterPack_Distortion_Wave_Horizontal * this_ptr));
}
