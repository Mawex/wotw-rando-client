...
namespace app::methods::System_Collections_Generic::Dictionary_2_CheckpointRestrictZone_System_String_ {
...
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_CheckpointRestrictZone_System_String_ * this_ptr));
