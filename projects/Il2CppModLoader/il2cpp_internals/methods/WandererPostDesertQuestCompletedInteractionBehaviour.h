...
IL2CPP_REGISTER_METHOD(0x008D1A30, BehaviourStatus__Enum, OnExecute, (app::WandererPostDesertQuestCompletedInteractionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0060C1C0, void, __ctor, (app::WandererPostDesertQuestCompletedInteractionBehaviour * this_ptr));
}
