...
namespace app::methods::Newtonsoft_Json_Serialization::JsonArrayContract {
IL2CPP_REGISTER_METHOD(0x002FBD00, Type *, get_CollectionItemType, (app::JsonArrayContract * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0186C360, ObjectConstructor_1_System_Object_ *, get_ParameterizedCreator, (app::JsonArrayContract * this_ptr));
IL2CPP_REGISTER_METHOD(0x0065FBA0, ObjectConstructor_1_System_Object_ *, get_OverrideCreator, (app::JsonArrayContract * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0186C500, void, __ctor, (app::JsonArrayContract * this_ptr, app::Type * underlying_type));
IL2CPP_REGISTER_METHOD(0x0186D460, IWrappedCollection *, CreateWrapper, (app::JsonArrayContract * this_ptr, app::Object * list));
IL2CPP_REGISTER_METHOD(0x0186D920, IList *, CreateTemporaryCollection, (app::JsonArrayContract * this_ptr));
