...
namespace app::methods::System_Net::TrackingValidationObjectDictionary {
IL2CPP_REGISTER_METHOD(0x020AA220, void, __ctor, (app::TrackingValidationObjectDictionary * this_ptr, app::IDictionary_2_System_String_System_Net_TrackingValidationObjectDictionary_ValidateAndParseValue_ * validators));
...
IL2CPP_REGISTER_METHOD(0x020AA5C0, Object *, InternalGet, (app::TrackingValidationObjectDictionary * this_ptr, app::String * key));
...
IL2CPP_REGISTER_METHOD(0x020AA130, String *, get_Item, (app::TrackingValidationObjectDictionary * this_ptr, app::String * key));
