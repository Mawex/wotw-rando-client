...
namespace app::methods::Moon_Timeline::TimelineMarkerRecord {
IL2CPP_REGISTER_METHOD(0x01E8CB90, void, __ctor, (app::TimelineMarkerRecord * this_ptr, app::EntityId id));
IL2CPP_REGISTER_METHOD(0x002FC6D0, EntityId, get_Id, (app::TimelineMarkerRecord * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E8CBB0, String *, get_Name, (app::TimelineMarkerRecord * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CC59E0, EntityId, get_ConstrainedTo, (app::TimelineMarkerRecord * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FD1D0, EntityId, get_EntityToDrawOn, (app::TimelineMarkerRecord * this_ptr));
