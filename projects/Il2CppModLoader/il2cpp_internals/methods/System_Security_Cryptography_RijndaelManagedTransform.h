...
namespace app::methods::System_Security_Cryptography::RijndaelManagedTransform {
IL2CPP_REGISTER_METHOD(0x028F0620, void, __ctor_1, (app::RijndaelManagedTransform * this_ptr, app::Byte__Array * rgb_key, app::CipherMode__Enum mode, app::Byte__Array * rgb_i_v, int32_t block_size, int32_t feedback_size, app::PaddingMode__Enum padding_value, app::RijndaelManagedTransformMode__Enum transform_mode));
...
IL2CPP_REGISTER_METHOD(0x028F1190, Byte__Array *, TransformFinalBlock, (app::RijndaelManagedTransform * this_ptr, app::Byte__Array * input_buffer, int32_t input_offset, int32_t input_count));
...
IL2CPP_REGISTER_METHOD(0x028F3490, void, Enc, (app::RijndaelManagedTransform * this_ptr, app::int32_t * encryptindex, app::int32_t * encrypt_key_expansion, app::int32_t * T, app::int32_t * t_f, app::int32_t * work, app::int32_t * temp));
IL2CPP_REGISTER_METHOD(0x028F3690, void, Dec, (app::RijndaelManagedTransform * this_ptr, app::int32_t * decryptindex, app::int32_t * decrypt_key_expansion, app::int32_t * i_t, app::int32_t * i_t_f, app::int32_t * work, app::int32_t * temp));
...
IL2CPP_REGISTER_METHOD(0x028F4440, void, __ctor_2, (app::RijndaelManagedTransform * this_ptr));
