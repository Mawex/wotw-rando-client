...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::VRBrowserPanel {
...
IL2CPP_REGISTER_METHOD(0x016712D0, Browser *, CreateBrowser, (app::VRBrowserPanel * this_ptr, app::Browser * parent));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::VRBrowserPanel * this_ptr));
