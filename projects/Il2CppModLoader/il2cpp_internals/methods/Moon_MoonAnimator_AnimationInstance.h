...
IL2CPP_REGISTER_METHOD(0x02110310, PlayableGraph, get_PlayableGraph, (app::MoonAnimator_AnimationInstance * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB950, IAnimation *, get_Animation, (app::MoonAnimator_AnimationInstance * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, MoonAnimator_AnimationInstance *, get_MainAnimationInstance, (app::MoonAnimator_AnimationInstance * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, MoonAnimator *, get_Animator, (app::MoonAnimator_AnimationInstance * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MoonAnimator_AnimationInstance * this_ptr));
}
