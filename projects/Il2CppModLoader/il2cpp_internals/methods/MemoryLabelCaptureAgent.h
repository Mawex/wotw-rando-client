...
IL2CPP_REGISTER_METHOD(0x009D7EE0, String__Array *, GetDataHeaderNames, (app::MemoryLabelCaptureAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009D8600, String__Array *, GetFrameData_1, (app::MemoryLabelCaptureAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009D89D0, void, __ctor, (app::MemoryLabelCaptureAgent * this_ptr));
}
