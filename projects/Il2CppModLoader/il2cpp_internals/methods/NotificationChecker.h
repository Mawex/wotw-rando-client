...
namespace app::methods::NotificationChecker {
    IL2CPP_REGISTER_METHOD(0x0060C330, void, __ctor, (app::NotificationChecker * this_ptr, app::RaceSettings * settings, app::String * race_i_d, int32_t original_rank, app::LeaderBoardService * leader_board_service, int32_t slot_index));
