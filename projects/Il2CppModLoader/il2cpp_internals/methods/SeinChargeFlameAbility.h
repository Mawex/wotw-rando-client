...
IL2CPP_REGISTER_METHOD(0x00A44800, Input_InputButtonProcessor *, get_ChargeFlameButton, (app::SeinChargeFlameAbility * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A47530, SoundSource *, CurrentChargingSound, (app::SeinChargeFlameAbility * this_ptr));
