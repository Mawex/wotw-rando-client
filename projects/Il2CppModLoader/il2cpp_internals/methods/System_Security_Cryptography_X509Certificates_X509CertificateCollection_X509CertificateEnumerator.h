...
namespace app::methods::System_Security_Cryptography_X509Certificates::X509CertificateCollection_X509CertificateEnumerator {
    IL2CPP_REGISTER_METHOD(0x021CBB00, void, __ctor, (app::X509CertificateCollection_X509CertificateEnumerator_1 * this_ptr, app::X509CertificateCollection_1 * mappings));
