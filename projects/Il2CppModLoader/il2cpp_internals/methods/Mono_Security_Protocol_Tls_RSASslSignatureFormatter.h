...
namespace app::methods::Mono_Security_Protocol_Tls::RSASslSignatureFormatter {
...
IL2CPP_REGISTER_METHOD(0x01F76E00, Byte__Array *, CreateSignature, (app::RSASslSignatureFormatter * this_ptr, app::Byte__Array * rgb_hash));
