...
namespace app::methods::System_Xml_Schema::SchemaEntity {
IL2CPP_REGISTER_METHOD(0x01AAFC40, void, __ctor, (app::SchemaEntity * this_ptr, app::XmlQualifiedName * qname, bool is_parameter));
IL2CPP_REGISTER_METHOD(0x01052DF0, String *, IDtdEntityInfo_get_Name, (app::SchemaEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01AAFD60, String *, IDtdEntityInfo_get_BaseUriString, (app::SchemaEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01AAFDF0, String *, IDtdEntityInfo_get_DeclaredUriString, (app::SchemaEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, IDtdEntityInfo_get_SystemId, (app::SchemaEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB950, String *, IDtdEntityInfo_get_PublicId, (app::SchemaEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, IDtdEntityInfo_get_Text, (app::SchemaEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA280, XmlQualifiedName *, get_Name, (app::SchemaEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Url, (app::SchemaEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01AAFF80, void, set_Url, (app::SchemaEntity * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_Pubid, (app::SchemaEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB990, XmlQualifiedName *, get_NData, (app::SchemaEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9A0, void, set_NData, (app::SchemaEntity * this_ptr, app::XmlQualifiedName * value));
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, get_Text, (app::SchemaEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01AAFFA0, String *, get_BaseURI, (app::SchemaEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01AB0040, String *, get_DeclaredURI, (app::SchemaEntity * this_ptr));
