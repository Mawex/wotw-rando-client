...
namespace app::methods::System_Data::DataRelationCollection_DataTableRelationCollection {
IL2CPP_REGISTER_METHOD(0x023A8560, void, __ctor, (app::DataRelationCollection_DataTableRelationCollection * this_ptr, app::DataTable * table, bool f_parent_collection));
IL2CPP_REGISTER_METHODINFO(0x0474B298, DataRelationCollection_DataTableRelationCollection__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FB9D0, ArrayList *, get_List, (app::DataRelationCollection_DataTableRelationCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x023A8790, DataSet *, GetDataSet, (app::DataRelationCollection_DataTableRelationCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x023A8840, DataRelation *, get_Item_1, (app::DataRelationCollection_DataTableRelationCollection * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x04759398, DataRelationCollection_DataTableRelationCollection_get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x023A8950, DataRelation *, get_Item_2, (app::DataRelationCollection_DataTableRelationCollection * this_ptr, app::String * name));
