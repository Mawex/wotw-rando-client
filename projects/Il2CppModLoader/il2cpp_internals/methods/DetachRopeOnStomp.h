...
IL2CPP_REGISTER_METHOD(0x00B8E4A0, Vector3, get_Position, (app::DetachRopeOnStomp * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB40, IDamageReciever__Array *, get_AffectedReceivers, (app::DetachRopeOnStomp * this_ptr));
IL2CPP_REGISTER_METHOD(0x00444DD0, void, __ctor, (app::DetachRopeOnStomp * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::DetachRopeOnStomp * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::DetachRopeOnStomp * this_ptr));
}
