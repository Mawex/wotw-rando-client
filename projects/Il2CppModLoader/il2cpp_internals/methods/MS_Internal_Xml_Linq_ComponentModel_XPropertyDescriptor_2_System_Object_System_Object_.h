...
namespace app::methods::MS_Internal_Xml_Linq_ComponentModel::XPropertyDescriptor_2_System_Object_System_Object_ {
IL2CPP_REGISTER_METHOD(0x019F8980, Type *, get_ComponentType, (app::XPropertyDescriptor_2_System_Object_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, get_IsReadOnly, (app::XPropertyDescriptor_2_System_Object_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x019F8A30, Type *, get_PropertyType, (app::XPropertyDescriptor_2_System_Object_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x019F8960, void, __ctor, (app::XPropertyDescriptor_2_System_Object_System_Object_ * this_ptr, app::String * name));
