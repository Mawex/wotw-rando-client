...
namespace app::methods::RootMotion_Demos::AnimatorController3rdPersonIK {
    ...
    IL2CPP_REGISTER_METHOD(0x0220B7B0, void, __ctor, (app::AnimatorController3rdPersonIK * this_ptr));
}
