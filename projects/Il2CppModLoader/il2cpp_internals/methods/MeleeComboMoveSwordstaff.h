...
IL2CPP_REGISTER_METHOD(0x013A5D30, String *, get_AnimationSpeedMultiplierParameterName, (app::MeleeComboMoveSwordstaff * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x013A6430, AbilityType__Enum, get_ComboAbilityType, (app::MeleeComboMoveSwordstaff * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x013A8670, Vector2, ComputeEffectiveKickback, (app::MeleeComboMoveSwordstaff * this_ptr, app::Vector3 enemy_position));
...
IL2CPP_REGISTER_METHOD(0x013A9530, EffectSpawn, DamageEffectProvider, (app::MeleeComboMoveSwordstaff * this_ptr, app::DamageResult damage_result));
IL2CPP_REGISTER_METHODINFO(0x0474D2C8, MeleeComboMoveSwordstaff_DamageEffectProvider__MethodInfo);
IL2CPP_REGISTER_METHOD(0x013A95A0, IEnumerator *, DummyHitStop, (app::MeleeComboMoveSwordstaff * this_ptr, app::GameObject * to_suspend, float suspend_time));
