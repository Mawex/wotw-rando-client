...
IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::SpringVinedController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009A9D40, void, __ctor, (app::SpringVinedController * this_ptr));
}
