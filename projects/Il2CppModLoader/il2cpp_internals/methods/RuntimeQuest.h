...
namespace app::methods::RuntimeQuest {
    ...
    IL2CPP_REGISTER_METHOD(0x0137AB70, Quest_QuestState__Enum, get_State, (app::RuntimeQuest * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0137B030, void, __ctor, (app::RuntimeQuest * this_ptr, app::Quest* quest));
} // namespace app::methods::RuntimeQuest
