...
IL2CPP_REGISTER_METHOD(0x024F5530, Material *, get_material, (app::CameraFilterPack_Drawing_Manga5 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024F3E60, void, __ctor, (app::CameraFilterPack_Drawing_Manga5 * this_ptr));
}
