...
IL2CPP_REGISTER_METHOD(0x0050D8B0, MessageProvider *, GetCurrentFilterMessageProvider, (app::AreaMapIconManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0050DF70, GameObject *, GetIcon, (app::AreaMapIconManager * this_ptr, app::WorldMapIconType__Enum icon_type));
IL2CPP_REGISTER_METHOD(0x0050E8C0, void, HideNonTeleportIcons, (app::AreaMapIconManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::AreaMapIconManager * this_ptr));
}
