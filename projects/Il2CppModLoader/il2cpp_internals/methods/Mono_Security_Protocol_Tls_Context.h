...
namespace app::methods::Mono_Security_Protocol_Tls::Context {
...
IL2CPP_REGISTER_METHOD(0x01F69090, SecurityProtocolType__Enum_1, get_SecurityProtocol, (app::Context_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FC6D0, SecurityProtocolType__Enum_1, get_SecurityProtocolFlags, (app::Context_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB930, Byte__Array *, get_SessionId, (app::Context_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_SessionId, (app::Context_1 * this_ptr, app::Byte__Array * value));
IL2CPP_REGISTER_METHOD(0x002FD1D0, SecurityCompressionType__Enum, get_CompressionMethod, (app::Context_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB00, TlsServerSettings *, get_ServerSettings, (app::Context_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB990, TlsClientSettings *, get_ClientSettings, (app::Context_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FCE30, HandshakeType__Enum, get_LastHandshakeMsg, (app::Context_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FCE40, void, set_LastHandshakeMsg, (app::Context_1 * this_ptr, app::HandshakeType__Enum value));
IL2CPP_REGISTER_METHOD(0x003FF3C0, HandshakeState__Enum, get_HandshakeState, (app::Context_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB60, CipherSuiteCollection *, get_SupportedCiphers, (app::Context_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB70, void, set_SupportedCiphers, (app::Context_1 * this_ptr, app::CipherSuiteCollection * value));
IL2CPP_REGISTER_METHOD(0x002FBD20, TlsStream *, get_HandshakeMessages, (app::Context_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC00, Byte__Array *, get_ClientRandom, (app::Context_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC10, void, set_ClientRandom, (app::Context_1 * this_ptr, app::Byte__Array * value));
IL2CPP_REGISTER_METHOD(0x002FBC20, Byte__Array *, get_ServerRandom, (app::Context_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC30, void, set_ServerRandom, (app::Context_1 * this_ptr, app::Byte__Array * value));
IL2CPP_REGISTER_METHOD(0x002FBC40, Byte__Array *, get_RandomCS, (app::Context_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC50, void, set_RandomCS, (app::Context_1 * this_ptr, app::Byte__Array * value));
IL2CPP_REGISTER_METHOD(0x002FBC60, Byte__Array *, get_RandomSC, (app::Context_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC70, void, set_RandomSC, (app::Context_1 * this_ptr, app::Byte__Array * value));
IL2CPP_REGISTER_METHOD(0x002FBC80, Byte__Array *, get_MasterSecret, (app::Context_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC90, void, set_MasterSecret, (app::Context_1 * this_ptr, app::Byte__Array * value));
IL2CPP_REGISTER_METHOD(0x002FBCA0, Byte__Array *, get_ClientWriteKey, (app::Context_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCB0, void, set_ClientWriteKey, (app::Context_1 * this_ptr, app::Byte__Array * value));
IL2CPP_REGISTER_METHOD(0x002FBCC0, Byte__Array *, get_ServerWriteKey, (app::Context_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCD0, void, set_ServerWriteKey, (app::Context_1 * this_ptr, app::Byte__Array * value));
IL2CPP_REGISTER_METHOD(0x002FBCE0, Byte__Array *, get_ClientWriteIV, (app::Context_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCF0, void, set_ClientWriteIV, (app::Context_1 * this_ptr, app::Byte__Array * value));
IL2CPP_REGISTER_METHOD(0x002FBD00, Byte__Array *, get_ServerWriteIV, (app::Context_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD10, void, set_ServerWriteIV, (app::Context_1 * this_ptr, app::Byte__Array * value));
IL2CPP_REGISTER_METHOD(0x002FBD60, RecordProtocol *, get_RecordProtocol, (app::Context_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD70, void, set_RecordProtocol, (app::Context_1 * this_ptr, app::RecordProtocol * value));
IL2CPP_REGISTER_METHOD(0x01F69260, void, __ctor, (app::Context_1 * this_ptr, app::SecurityProtocolType__Enum_1 security_protocol_type));
IL2CPP_REGISTER_METHOD(0x01F69560, int32_t, GetUnixTime, (app::Context_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F69630, Byte__Array *, GetSecureRandomBytes, (app::Context_1 * this_ptr, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x01F69B80, SecurityProtocolType__Enum_1, DecodeProtocolCode, (app::Context_1 * this_ptr, int16_t code, bool allow_fallback));
...
IL2CPP_REGISTER_METHOD(0x01F69DB0, SecurityParameters *, get_Current, (app::Context_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F69F20, SecurityParameters *, get_Negotiating, (app::Context_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, SecurityParameters *, get_Read, (app::Context_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB40, SecurityParameters *, get_Write, (app::Context_1 * this_ptr));
