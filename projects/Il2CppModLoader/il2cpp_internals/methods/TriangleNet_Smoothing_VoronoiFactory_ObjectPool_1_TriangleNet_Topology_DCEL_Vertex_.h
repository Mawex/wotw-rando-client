...
namespace app::methods::TriangleNet_Smoothing::VoronoiFactory_ObjectPool_1_TriangleNet_Topology_DCEL_Vertex_ {
IL2CPP_REGISTER_METHOD(0x0225C010, void, __ctor, (app::VoronoiFactory_ObjectPool_1_TriangleNet_Topology_DCEL_Vertex_ * this_ptr, int32_t capacity));
