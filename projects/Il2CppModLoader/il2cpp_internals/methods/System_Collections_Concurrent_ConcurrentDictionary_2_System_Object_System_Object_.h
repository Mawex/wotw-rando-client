...
namespace app::methods::System_Collections_Concurrent::ConcurrentDictionary_2_System_Object_System_Object_ {
IL2CPP_REGISTER_METHOD(0x02AF0340, Object *, get_Item, (app::ConcurrentDictionary_2_System_Object_System_Object_ * this_ptr, app::Object * key));
...
IL2CPP_REGISTER_METHOD(0x02AE0FC0, ICollection_1_System_Object_ *, get_Keys, (app::ConcurrentDictionary_2_System_Object_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02AE0FC0, IEnumerable_1_System_Object_ *, System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Keys, (app::ConcurrentDictionary_2_System_Object_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02AE0FF0, ICollection_1_System_Object_ *, get_Values, (app::ConcurrentDictionary_2_System_Object_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02AE0FF0, IEnumerable_1_System_Object_ *, System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Values, (app::ConcurrentDictionary_2_System_Object_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AE0FC0, ICollection *, IDictionary_get_Keys, (app::ConcurrentDictionary_2_System_Object_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02AE0FF0, ICollection *, IDictionary_get_Values, (app::ConcurrentDictionary_2_System_Object_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02AF14A0, Object *, IDictionary_get_Item, (app::ConcurrentDictionary_2_System_Object_System_Object_ * this_ptr, app::Object * key));
...
IL2CPP_REGISTER_METHOD(0x02AF1D20, Object *, ICollection_get_SyncRoot, (app::ConcurrentDictionary_2_System_Object_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02ADDC30, void, __ctor_1, (app::ConcurrentDictionary_2_System_Object_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02AEDD60, void, __ctor_2, (app::ConcurrentDictionary_2_System_Object_System_Object_ * this_ptr, int32_t concurrency_level, int32_t capacity, bool grow_lock_array, app::IEqualityComparer_1_System_Object_ * comparer));
...
IL2CPP_REGISTER_METHOD(0x02AEF4D0, KeyValuePair_2_System_Object_System_Object___Array *, ToArray, (app::ConcurrentDictionary_2_System_Object_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AE57F0, IEnumerator_1_KeyValuePair_2_System_Object_System_Object_ *, GetEnumerator, (app::ConcurrentDictionary_2_System_Object_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AF0770, Object *, GetOrAdd, (app::ConcurrentDictionary_2_System_Object_System_Object_ * this_ptr, app::Object * key, app::Func_2_Object_Object_ * value_factory));
...
IL2CPP_REGISTER_METHOD(0x02AE1230, IEnumerator *, IEnumerable_GetEnumerator, (app::ConcurrentDictionary_2_System_Object_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AE16A0, IDictionaryEnumerator *, IDictionary_GetEnumerator, (app::ConcurrentDictionary_2_System_Object_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AE2D20, void, GetBucketAndLockNo, (int32_t hashcode, app::int32_t * bucket_no, app::int32_t * lock_no, int32_t bucket_count, int32_t lock_count));
IL2CPP_REGISTER_METHOD(0x02AF2840, void, AcquireAllLocks, (app::ConcurrentDictionary_2_System_Object_System_Object_ * this_ptr, app::int32_t * locks_acquired));
IL2CPP_REGISTER_METHOD(0x02AF2A10, void, AcquireLocks, (app::ConcurrentDictionary_2_System_Object_System_Object_ * this_ptr, int32_t from_inclusive, int32_t to_exclusive, app::int32_t * locks_acquired));
...
IL2CPP_REGISTER_METHOD(0x02AF2B60, ReadOnlyCollection_1_System_Object_ *, GetKeys, (app::ConcurrentDictionary_2_System_Object_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0474DD90, ConcurrentDictionary_2_System_Object_System_Object__GetKeys__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02AF2FE0, ReadOnlyCollection_1_System_Object_ *, GetValues, (app::ConcurrentDictionary_2_System_Object_System_Object_ * this_ptr));
