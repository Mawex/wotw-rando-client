...
IL2CPP_REGISTER_METHOD(0x02535E50, float, SmoothDamp_1, (float current, float target, app::float * current_velocity, float smooth_time, float max_speed));
IL2CPP_REGISTER_METHOD(0x02535F90, float, SmoothDamp_2, (float current, float target, app::float * current_velocity, float smooth_time));
IL2CPP_REGISTER_METHOD(0x025360D0, float, SmoothDamp_3, (float current, float target, app::float * current_velocity, float smooth_time, float max_speed, float delta_time));
IL2CPP_REGISTER_METHOD(0x025362B0, float, SmoothDampAngle_1, (float current, float target, app::float * current_velocity, float smooth_time));
IL2CPP_REGISTER_METHOD(0x025363F0, float, SmoothDampAngle_2, (float current, float target, app::float * current_velocity, float smooth_time, float max_speed, float delta_time));
