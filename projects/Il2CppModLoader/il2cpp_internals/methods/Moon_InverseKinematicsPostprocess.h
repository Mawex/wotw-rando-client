...
IL2CPP_REGISTER_METHOD(0x01B14380, IK *, get_IK, (app::InverseKinematicsPostprocess * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01B14E40, Transform *, FindChildRecursive, (app::GameObject * go, app::String * name, bool allow_inactive));
IL2CPP_REGISTER_METHOD(0x01B15170, void, __ctor, (app::InverseKinematicsPostprocess * this_ptr));
}
