...
IL2CPP_REGISTER_METHOD(0x01766A10, void, __ctor, (app::PetrifiedOwlBossFight1DiveLaserBehaviour_BackgroundFlightState * this_ptr, app::PetrifiedOwlBossFight1DiveLaserBehaviour * behaviour));
