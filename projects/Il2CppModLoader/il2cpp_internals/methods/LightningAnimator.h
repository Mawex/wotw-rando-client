...
IL2CPP_REGISTER_METHOD(0x00FA32F0, LightningAnimator_LightningEvent, GetNextLightningEvent, (app::LightningAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00FA3580, void, __ctor, (app::LightningAnimator * this_ptr));
}
