...
IL2CPP_REGISTER_METHOD(0x02488E80, Material *, get_material, (app::CameraFilterPack_Pixelisation_Dot * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024897D0, void, __ctor, (app::CameraFilterPack_Pixelisation_Dot * this_ptr));
}
