...
IL2CPP_REGISTER_METHOD(0x005065F0, SuspendableMask__Enum, get_Mask, (app::SpellUIShardListOverlay * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00950D80, void, __ctor, (app::SpellUIShardListOverlay * this_ptr));
}
