...
namespace app::methods::Projectile {
    ...
    IL2CPP_REGISTER_METHOD(0x0065FBA0, Projectile_ExplodeCollisionInfo*, get_ExplodeCollision, (app::Projectile * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0065FBC0, Projectile_ExplodeCollisionInfo*, get_RicochetCollision, (app::Projectile * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00C74F10, Vector3, get_Displacement, (app::Projectile * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00C74F30, void, set_Displacement, (app::Projectile * this_ptr, app::Vector3 value));
    IL2CPP_REGISTER_METHOD(0x00C74F50, Vector3, get_SpeedVector, (app::Projectile * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00C75270, Vector3, get_Position, (app::Projectile * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00C75BE0, Vector3, IPortalVisitor_get_Speed, (app::Projectile * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00C75DE0, Vector3, get_Direction, (app::Projectile * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0071F210, GameObject*, get_LastReflector, (app::Projectile * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x004B67E0, SuspendableMask__Enum, get_Mask, (app::Projectile * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00C7ACC0, Vector2, ITeleportBeaconAttackable_get_Position, (app::Projectile * this_ptr));
    IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, get_TrackTranformChangesForRecording, (app::Projectile * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0043D9E0, RecordableParsingGroup__Enum, get_ParsingGroup, (app::Projectile * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00C7ADD0, TrackingExclusions, get_TrackingExclusions, (app::Projectile * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A5BA50, IDamageReciever__Array*, get_AffectedReceivers, (app::Projectile * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00C7ADE0, void, __ctor, (app::Projectile * this_ptr));
    IL2CPP_REGISTER_METHOD(0x004F4750, GameObject*, IDamageReciever_get_gameObject, (app::Projectile * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00506170, Transform*, IDamageReciever_get_transform, (app::Projectile * this_ptr));
} // namespace app::methods::Projectile
