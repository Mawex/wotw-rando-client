...
namespace app::methods::System_Collections_Generic::List_1_VerletStructure_VerletLink_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_VerletStructure_VerletLink_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, VerletStructure_VerletLink__Array *, ToArray, (app::List_1_VerletStructure_VerletLink_ * this_ptr));
