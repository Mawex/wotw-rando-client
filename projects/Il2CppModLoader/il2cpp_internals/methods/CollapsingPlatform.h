...
IL2CPP_REGISTER_METHOD(0x012C77A0, CageStructureTool *, get_CageStructure, (app::CollapsingPlatform * this_ptr));
IL2CPP_REGISTER_METHOD(0x012C7870, GameObject *, get_Platform, (app::CollapsingPlatform * this_ptr));
IL2CPP_REGISTER_METHOD(0x012C78A0, GameObject *, get_AnimatedObject, (app::CollapsingPlatform * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012C9C10, String *, get_StressTestName, (app::CollapsingPlatform * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006DC050, StressTestStatus__Enum, get_StressTestStatus, (app::CollapsingPlatform * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012CA040, IUberState__Array *, get_AffectingUberStates, (app::CollapsingPlatform * this_ptr));
IL2CPP_REGISTER_METHOD(0x012CA0B0, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::CollapsingPlatform * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, NamedValue_1_System_Boolean___Array *, get_Options, (app::CollapsingPlatform * this_ptr));
IL2CPP_REGISTER_METHOD(0x012CA330, IDesiredUberState *, GetRequirementsForTimeline, (app::CollapsingPlatform * this_ptr, app::MoonTimeline * timeline));
...
IL2CPP_REGISTER_METHOD(0x00FC5390, Nullable_1_Single_, get_VolitileGenericOverrideValue, (app::CollapsingPlatform * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012CAB10, CollapsingPlatform *, GetCollapsingPlatformFromDigZone, (app::DigZone * dig_zone));
...
IL2CPP_REGISTER_METHOD(0x012CAC50, void, __ctor, (app::CollapsingPlatform * this_ptr));
