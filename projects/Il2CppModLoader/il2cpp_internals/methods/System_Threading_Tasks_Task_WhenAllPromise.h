...
namespace app::methods::System_Threading_Tasks::Task_WhenAllPromise {
IL2CPP_REGISTER_METHOD(0x0233B690, void, __ctor, (app::Task_WhenAllPromise * this_ptr, app::Task__Array * tasks));
