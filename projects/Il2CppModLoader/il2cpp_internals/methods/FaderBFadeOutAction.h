...
IL2CPP_REGISTER_METHOD(0x009941B0, String *, GetNiceName, (app::FaderBFadeOutAction * this_ptr));
IL2CPP_REGISTER_METHOD(0x00993F70, void, __ctor, (app::FaderBFadeOutAction * this_ptr));
}
