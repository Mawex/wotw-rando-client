...
IL2CPP_REGISTER_METHOD(0x006A63A0, EntityDamageEvent *, get_DamageEvent, (app::GiantSlugHitReactionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420230, BehaviourStatus__Enum, OnExecuteTask, (app::GiantSlugHitReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x007F3E60, void, __ctor, (app::GiantSlugHitReactionBehaviour * this_ptr));
}
