...
namespace app::methods::BabySein {
    ...
    IL2CPP_REGISTER_METHOD(0x00860F40, CharacterCapsuleController*, get_CapsuleController, (app::BabySein * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB40, DamageOwner*, get_DamageOwner, (app::BabySein * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB50, void, set_DamageOwner, (app::BabySein * this_ptr, app::DamageOwner* value));
    IL2CPP_REGISTER_METHOD(0x00860F60, Vector3, get_Position, (app::BabySein * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00860FC0, void, set_Position, (app::BabySein * this_ptr, app::Vector3 value));
    IL2CPP_REGISTER_METHOD(0x00861010, Vector3, get_MapDisplayPosition, (app::BabySein * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00861130, Vector3, get_DeltaPosition, (app::BabySein * this_ptr));
    IL2CPP_REGISTER_METHOD(0x008612A0, void, Activate, (app::BabySein * this_ptr, bool active));
    IL2CPP_REGISTER_METHOD(0x004F4750, GameObject*, get_GameObject, (app::BabySein * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x008613E0, Vector3, get_Speed, (app::BabySein * this_ptr));
    IL2CPP_REGISTER_METHOD(0x008614E0, void, set_Speed, (app::BabySein * this_ptr, app::Vector3 value));
    IL2CPP_REGISTER_METHOD(0x008615E0, Vector2, get_PhysicsSpeed, (app::BabySein * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00506170, Transform*, get_Transform, (app::BabySein * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00506170, Transform*, get_CameraTarget, (app::BabySein * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::BabySein * this_ptr));
} // namespace app::methods::BabySein
