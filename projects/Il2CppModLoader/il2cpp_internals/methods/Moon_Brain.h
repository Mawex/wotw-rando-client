...
namespace app::methods::Moon::Brain {
    ...
    IL2CPP_REGISTER_METHOD(0x00CBFB30, BrainBehaviour*, SelectNextBehaviour, (app::Brain * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00CBFE90, void, __ctor, (app::Brain * this_ptr));
} // namespace app::methods::Moon::Brain
