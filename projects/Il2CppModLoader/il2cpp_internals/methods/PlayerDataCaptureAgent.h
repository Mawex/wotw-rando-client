...
IL2CPP_REGISTER_METHOD(0x0140DCE0, String__Array *, GetDataHeaderNames, (app::PlayerDataCaptureAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x0140DDD0, String__Array *, GetFrameData_1, (app::PlayerDataCaptureAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::PlayerDataCaptureAgent * this_ptr));
}
