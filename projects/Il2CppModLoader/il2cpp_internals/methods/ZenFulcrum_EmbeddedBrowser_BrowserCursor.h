...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::BrowserCursor {
...
IL2CPP_REGISTER_METHOD(0x002FB930, Texture2D *, get_Texture, (app::BrowserCursor * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_Texture, (app::BrowserCursor * this_ptr, app::Texture2D * value));
IL2CPP_REGISTER_METHOD(0x00E71230, Vector2, get_Hotspot, (app::BrowserCursor * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01C72150, void, __ctor, (app::BrowserCursor * this_ptr));
