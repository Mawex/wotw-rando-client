...
namespace app::methods::System_Threading::EventWaitHandle {
IL2CPP_REGISTER_METHOD(0x027DB590, void, __ctor_1, (app::EventWaitHandle * this_ptr, bool initial_state, app::EventResetMode__Enum mode));
IL2CPP_REGISTER_METHOD(0x027DB5B0, void, __ctor_2, (app::EventWaitHandle * this_ptr, bool initial_state, app::EventResetMode__Enum mode, app::String * name));
