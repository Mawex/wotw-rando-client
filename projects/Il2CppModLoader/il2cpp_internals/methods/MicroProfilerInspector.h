...
IL2CPP_REGISTER_METHOD(0x015AEE30, String *, _getStringForMSValue, (app::MicroProfilerInspector * this_ptr, double ms));
IL2CPP_REGISTER_METHOD(0x015AEFD0, String *, _getStatName, (app::MicroProfilerInspector * this_ptr, app::Metric__Enum metric));
...
IL2CPP_REGISTER_METHOD(0x015B57D0, void, __ctor, (app::MicroProfilerInspector * this_ptr));
IL2CPP_REGISTER_METHOD(0x015B5ED0, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x015B6840, String *, _OnGUI_b__64_5, (app::MicroProfilerInspector * this_ptr, app::MicroProfilerInspector_MetricData x));
