...
IL2CPP_REGISTER_METHOD(0x0063D090, SuspendableMask__Enum, get_Mask, (app::CatAndMouseRoomDController * this_ptr));
IL2CPP_REGISTER_METHOD(0x0102CAD0, void, set_Mask, (app::CatAndMouseRoomDController * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x0102CB90, void, __ctor, (app::CatAndMouseRoomDController * this_ptr));
}
