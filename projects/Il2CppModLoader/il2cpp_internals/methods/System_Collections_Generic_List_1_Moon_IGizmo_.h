...
namespace app::methods::System_Collections_Generic::List_1_Moon_IGizmo_ {
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_Moon_IGizmo_, GetEnumerator, (app::List_1_Moon_IGizmo_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04784E58, List_1_Moon_IGizmo__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_Moon_IGizmo_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EFC50, IGizmo *, get_Item, (app::List_1_Moon_IGizmo_ * this_ptr, int32_t index));
