...
IL2CPP_REGISTER_METHOD(0x012AD8C0, Transform *, get_Transform, (app::CleverMenuItem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012AF240, Vector3, get_Position, (app::CleverMenuItem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012AF440, Rect, get_Bounds, (app::CleverMenuItem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012B0170, void, __ctor, (app::CleverMenuItem * this_ptr));
}
