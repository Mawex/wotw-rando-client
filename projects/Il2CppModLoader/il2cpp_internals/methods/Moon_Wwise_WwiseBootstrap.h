...
namespace app::methods::Moon_Wwise::WwiseBootstrap {
...
IL2CPP_REGISTER_METHOD(0x02711B80, String *, ParseArgument, (app::String * flag));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::WwiseBootstrap * this_ptr));
