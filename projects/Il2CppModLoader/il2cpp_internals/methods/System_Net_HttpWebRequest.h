...
namespace app::methods::System_Net::HttpWebRequest {
IL2CPP_REGISTER_METHOD(0x01E59BB0, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x01E59C30, void, __ctor_1, (app::HttpWebRequest * this_ptr, app::Uri * uri));
IL2CPP_REGISTER_METHOD(0x01E59F70, void, __ctor_2, (app::HttpWebRequest * this_ptr, app::Uri * uri, app::MonoTlsProvider * tls_provider, app::MonoTlsSettings * settings));
IL2CPP_REGISTER_METHOD(0x01E59FB0, void, __ctor_3, (app::HttpWebRequest * this_ptr, app::SerializationInfo * serialization_info, app::StreamingContext streaming_context));
...
IL2CPP_REGISTER_METHOD(0x01E5A7B0, String *, get_Accept, (app::HttpWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E5A850, void, set_Accept, (app::HttpWebRequest * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB9D0, Uri *, get_Address, (app::HttpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0040EF70, DecompressionMethods__Enum, get_AutomaticDecompression, (app::HttpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007008C0, MonoTlsProvider *, get_TlsProvider, (app::HttpWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x00FAE9A0, MonoTlsSettings *, get_TlsSettings, (app::HttpWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E5AC70, X509CertificateCollection_1 *, get_ClientCertificates, (app::HttpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E5AE90, String *, get_Connection, (app::HttpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB60, String *, get_ConnectionGroupName, (app::HttpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E5B200, String *, get_ContentType, (app::HttpWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E5B2A0, void, set_ContentType, (app::HttpWebRequest * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBBC0, HttpContinueDelegate *, get_ContinueDelegate, (app::HttpWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBD0, void, set_ContinueDelegate, (app::HttpWebRequest * this_ptr, app::HttpContinueDelegate * value));
IL2CPP_REGISTER_METHOD(0x002FBBE0, CookieContainer *, get_CookieContainer, (app::HttpWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBF0, void, set_CookieContainer, (app::HttpWebRequest * this_ptr, app::CookieContainer * value));
IL2CPP_REGISTER_METHOD(0x002FBC00, ICredentials *, get_Credentials, (app::HttpWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC10, void, set_Credentials, (app::HttpWebRequest * this_ptr, app::ICredentials * value));
IL2CPP_REGISTER_METHOD(0x01E5B340, DateTime, get_Date, (app::HttpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E5B820, String *, get_Expect, (app::HttpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC40, WebHeaderCollection *, get_Headers, (app::HttpWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E5BA70, void, set_Headers, (app::HttpWebRequest * this_ptr, app::WebHeaderCollection * value));
IL2CPP_REGISTER_METHOD(0x01E5BC70, String *, get_Host, (app::HttpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E5C090, DateTime, get_IfModifiedSince, (app::HttpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC80, String *, get_MediaType, (app::HttpWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC90, void, set_MediaType, (app::HttpWebRequest * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBCA0, String *, get_Method, (app::HttpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBD00, Version *, get_ProtocolVersion, (app::HttpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBD60, IWebProxy *, get_Proxy, (app::HttpWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E5CA10, void, set_Proxy, (app::HttpWebRequest * this_ptr, app::IWebProxy * value));
IL2CPP_REGISTER_METHOD(0x01E5CA50, String *, get_Referer, (app::HttpWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E5CAF0, void, set_Referer, (app::HttpWebRequest * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB9B0, Uri *, get_RequestUri, (app::HttpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E5CC60, ServicePoint *, get_ServicePoint, (app::HttpWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x005B0220, ServicePoint *, get_ServicePointNoLock, (app::HttpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E5CD30, String *, get_TransferEncoding, (app::HttpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E5D040, String *, get_UserAgent, (app::HttpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9D0, Uri *, get_AuthUri, (app::HttpWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E5D1C0, bool, get_ProxyQuery, (app::HttpWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B1A9A0, ServerCertValidationCallback *, get_ServerCertValidationCallback, (app::HttpWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E5D200, RemoteCertificateValidationCallback *, get_ServerCertificateValidationCallback, (app::HttpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E5D390, ServicePoint *, GetServicePoint, (app::HttpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E5DDE0, IAsyncResult *, BeginGetRequestStream, (app::HttpWebRequest * this_ptr, app::AsyncCallback * callback, app::Object * state));
IL2CPP_REGISTER_METHODINFO(0x0471D1B8, HttpWebRequest_BeginGetRequestStream__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E5E3D0, Stream *, EndGetRequestStream_1, (app::HttpWebRequest * this_ptr, app::IAsyncResult * async_result));
IL2CPP_REGISTER_METHODINFO(0x0474F100, HttpWebRequest_EndGetRequestStream__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E5E560, Stream *, GetRequestStream_1, (app::HttpWebRequest * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04728058, HttpWebRequest_GetRequestStream__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E5E710, Stream *, GetRequestStream_2, (app::HttpWebRequest * this_ptr, app::TransportContext * * context));
...
IL2CPP_REGISTER_METHOD(0x01E5E940, IAsyncResult *, BeginGetResponse, (app::HttpWebRequest * this_ptr, app::AsyncCallback * callback, app::Object * state));
IL2CPP_REGISTER_METHODINFO(0x0475AD18, HttpWebRequest_BeginGetResponse__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E5EEE0, WebResponse *, EndGetResponse, (app::HttpWebRequest * this_ptr, app::IAsyncResult * async_result));
IL2CPP_REGISTER_METHODINFO(0x0470DED0, HttpWebRequest_EndGetResponse__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E5F0A0, Stream *, EndGetRequestStream_2, (app::HttpWebRequest * this_ptr, app::IAsyncResult * async_result, app::TransportContext * * context));
IL2CPP_REGISTER_METHOD(0x01E5F0C0, WebResponse *, GetResponse, (app::HttpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E60420, String *, GetHeaders, (app::HttpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E612F0, Byte__Array *, GetRequestHeaders, (app::HttpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E63BC0, StringBuilder *, GenerateConnectionGroup, (app::String * connection_group_name, bool unsafe_connection_group, bool is_internal_group));
...
IL2CPP_REGISTER_METHOD(0x01E64200, void, __ctor_4, (app::HttpWebRequest * this_ptr));
