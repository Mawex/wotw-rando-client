...
IL2CPP_REGISTER_METHOD(0x019D75F0, Object *, get_Item, (app::AkBaseArray_1_System_Object_ * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x019D7640, void, set_Item, (app::AkBaseArray_1_System_Object_ * this_ptr, int32_t index, app::Object * value));
IL2CPP_REGISTER_METHOD(0x019D7280, void, __ctor, (app::AkBaseArray_1_System_Object_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, DefaultConstructAtIntPtr, (app::AkBaseArray_1_System_Object_ * this_ptr, app::void * address));
IL2CPP_REGISTER_METHOD(0x002FA000, void, ReleaseAllocatedMemoryFromReferenceAtIntPtr, (app::AkBaseArray_1_System_Object_ * this_ptr, app::void * address));
