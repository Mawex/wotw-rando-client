...
namespace app::methods::System_Data_Common::SqlUdtStorage {
IL2CPP_REGISTER_METHOD(0x02861550, void, __ctor_1, (app::SqlUdtStorage * this_ptr, app::DataColumn * column, app::Type * type));
IL2CPP_REGISTER_METHOD(0x02861620, void, __ctor_2, (app::SqlUdtStorage * this_ptr, app::DataColumn * column, app::Type * type, app::Object * null_value));
IL2CPP_REGISTER_METHOD(0x028617D0, Object *, GetStaticNullForUdtType, (app::Type * type));
...
IL2CPP_REGISTER_METHOD(0x02861C70, Object *, Aggregate, (app::SqlUdtStorage * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x02846A70, Object *, Get, (app::SqlUdtStorage * this_ptr, int32_t record_no));
...
IL2CPP_REGISTER_METHOD(0x02862400, Object *, ConvertXmlToObject_1, (app::SqlUdtStorage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x02862870, Object *, ConvertXmlToObject_2, (app::SqlUdtStorage * this_ptr, app::XmlReader * xml_reader, app::XmlRootAttribute * xml_attrib));
IL2CPP_REGISTER_METHOD(0x02862AD0, String *, ConvertObjectToXml_1, (app::SqlUdtStorage * this_ptr, app::Object * value));
...
IL2CPP_REGISTER_METHOD(0x02863000, Object *, GetEmptyStorage, (app::SqlUdtStorage * this_ptr, int32_t record_count));
