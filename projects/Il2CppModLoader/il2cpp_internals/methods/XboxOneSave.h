...
namespace app::methods::XboxOneSave {
    IL2CPP_REGISTER_METHOD(0x01C598B0, XboxOneSave*, get_Instance, ());
    ...
    IL2CPP_REGISTER_METHOD(0x01C59A90, Task*, Delete, (app::String * file));
    IL2CPP_REGISTER_METHOD(0x00417870, bool, get_SaveGameAvailable, ());
    IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, get_SaveGameQueried, ());
    IL2CPP_REGISTER_METHOD(0x00420EE0, Byte__Array*, SaveGameData_1, (int32_t slot, int32_t backup));
    IL2CPP_REGISTER_METHOD(0x00420EE0, Byte__Array*, SaveGameData_2, (app::String * buffer_name));
    ...
    IL2CPP_REGISTER_METHOD(0x00420EE0, String*, SaveGameName, (int32_t slot_index, int32_t backup_index));
    ...
    IL2CPP_REGISTER_METHOD(0x002FA280, Queue_1_System_Action_*, get_QueuedStorageOperations, (app::XboxOneSave * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB930, Queue_1_System_String_*, get_QueuedStorageOperationNames, (app::XboxOneSave * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01C5A0D0, Task_1_System_Collections_Generic_IEnumerable_1_*, LoadAndCacheDataFor, (app::String__Array * buffers));
    IL2CPP_REGISTER_METHOD(0x01C5A350, Task_1_System_Byte_*, GetAsync, (app::String * buffer_name));
    IL2CPP_REGISTER_METHOD(0x01C5A4C0, Task_1_System_Boolean_*, Write, (app::Tuple_2_String_Byte___Array * data_pairs));
    IL2CPP_REGISTER_METHOD(0x01C5A810, void, __ctor, (app::XboxOneSave * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01C5AA60, void, __cctor, ());
} // namespace app::methods::XboxOneSave
