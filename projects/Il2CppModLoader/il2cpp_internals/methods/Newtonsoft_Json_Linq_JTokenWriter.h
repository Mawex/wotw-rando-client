...
namespace app::methods::Newtonsoft_Json_Linq::JTokenWriter {
IL2CPP_REGISTER_METHOD(0x01858240, JToken *, get_Token, (app::JTokenWriter * this_ptr));
IL2CPP_REGISTER_METHOD(0x01858250, void, __ctor, (app::JTokenWriter * this_ptr));
