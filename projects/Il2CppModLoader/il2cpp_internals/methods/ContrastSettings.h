...
IL2CPP_REGISTER_METHOD(0x011E7E20, ContrastSettings *, Clone, (app::ContrastSettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x011DA5B0, void, CopyFrom, (app::ContrastSettings * this_ptr, app::ContrastSettings * settings_contrast));
IL2CPP_REGISTER_METHOD(0x00858E20, void, __ctor, (app::ContrastSettings * this_ptr));
}
