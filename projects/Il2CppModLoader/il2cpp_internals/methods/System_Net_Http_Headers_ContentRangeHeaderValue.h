...
namespace app::methods::System_Net_Http_Headers::ContentRangeHeaderValue {
IL2CPP_REGISTER_METHOD(0x02D067B0, void, __ctor, (app::ContentRangeHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C3DD30, Nullable_1_Int64_, get_From, (app::ContentRangeHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C3DD40, void, set_From, (app::ContentRangeHeaderValue * this_ptr, app::Nullable_1_Int64_ value));
IL2CPP_REGISTER_METHOD(0x00CB5CB0, Nullable_1_Int64_, get_Length, (app::ContentRangeHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CB5CC0, void, set_Length, (app::ContentRangeHeaderValue * this_ptr, app::Nullable_1_Int64_ value));
IL2CPP_REGISTER_METHOD(0x00CB5CD0, Nullable_1_Int64_, get_To, (app::ContentRangeHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CB5CE0, void, set_To, (app::ContentRangeHeaderValue * this_ptr, app::Nullable_1_Int64_ value));
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_Unit, (app::ContentRangeHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x0173F610, Object *, ICloneable_Clone, (app::ContentRangeHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D07380, String *, ToString, (app::ContentRangeHeaderValue * this_ptr));
}
