...
IL2CPP_REGISTER_METHOD(0x00417920, UpdateType__Enum, get_UpdateType, (app::MoonShadingZoneController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01460C90, int32_t, GetNextInsideTargetIndex, (app::MoonShadingZoneController * this_ptr, app::bool * found));
...
IL2CPP_REGISTER_METHOD(0x01461820, void, __ctor, (app::MoonShadingZoneController * this_ptr));
