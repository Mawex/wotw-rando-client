...
namespace app::methods::System_Configuration::SettingsPropertyValue {
IL2CPP_REGISTER_METHOD(0x01FFDB70, void, __ctor, (app::SettingsPropertyValue * this_ptr, app::SettingsProperty * property));
...
IL2CPP_REGISTER_METHOD(0x01FFDC60, String *, get_Name, (app::SettingsPropertyValue * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047533D0, SettingsPropertyValue_get_Name__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01FFDC90, SettingsProperty *, get_Property, (app::SettingsPropertyValue * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04740738, SettingsPropertyValue_get_Property__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01FFDCC0, Object *, get_PropertyValue, (app::SettingsPropertyValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01FFDD20, Object *, get_SerializedValue, (app::SettingsPropertyValue * this_ptr));
