...
IL2CPP_REGISTER_METHOD(0x0043D9E0, SneezeSlugDeathReactionBehaviour_DeathState__Enum, GetNextOnHitGroundState, (app::SneezeSlugDeathReactionBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00ED8B90, void, OnEnterTask, (app::SneezeSlugDeathReactionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00ED8FE0, BehaviourStatus__Enum, OnExecuteTask, (app::SneezeSlugDeathReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00EDAA10, Vector3, ProcessRootMotion, (app::SneezeSlugDeathReactionBehaviour * this_ptr, app::Vector3 motion));
...
IL2CPP_REGISTER_METHOD(0x00EDAD50, void, __ctor, (app::SneezeSlugDeathReactionBehaviour * this_ptr));
