...
namespace app::methods::System_Xml_Schema::XdrValidator {
IL2CPP_REGISTER_METHOD(0x022325B0, void, __ctor_1, (app::XdrValidator * this_ptr, app::BaseValidator * validator));
IL2CPP_REGISTER_METHOD(0x022326D0, void, __ctor_2, (app::XdrValidator * this_ptr, app::XmlValidatingReaderImpl * reader, app::XmlSchemaCollection * schema_collection, app::IValidationEventHandling * event_handling));
...
IL2CPP_REGISTER_METHOD(0x02233A30, SchemaElementDecl *, ThoroughGetElementDecl, (app::XdrValidator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01C87A40, Object *, FindId, (app::XdrValidator * this_ptr, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x02236B40, XmlQualifiedName *, QualifiedName, (app::XdrValidator * this_ptr, app::String * name, app::String * ns));
}
