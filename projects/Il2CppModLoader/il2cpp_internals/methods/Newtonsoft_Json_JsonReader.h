...
namespace app::methods::Newtonsoft_Json::JsonReader {
IL2CPP_REGISTER_METHOD(0x00529E80, JsonReader_State__Enum, get_CurrentState, (app::JsonReader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006410F0, DateTimeZoneHandling__Enum, get_DateTimeZoneHandling, (app::JsonReader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004C6660, DateParseHandling__Enum, get_DateParseHandling, (app::JsonReader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003FF2B0, FloatParseHandling__Enum, get_FloatParseHandling, (app::JsonReader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB80, String *, get_DateFormatString, (app::JsonReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB90, void, set_DateFormatString, (app::JsonReader * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x01A66990, Nullable_1_Int32_, get_MaxDepth, (app::JsonReader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FC6D0, JsonToken__Enum_1, get_TokenType, (app::JsonReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, Object *, get_Value, (app::JsonReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x01A66A70, Type *, get_ValueType, (app::JsonReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x01A66A90, int32_t, get_Depth, (app::JsonReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x01A66B40, String *, get_Path, (app::JsonReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x01A66CA0, CultureInfo *, get_Culture, (app::JsonReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9E0, void, set_Culture, (app::JsonReader * this_ptr, app::CultureInfo * value));
IL2CPP_REGISTER_METHOD(0x01A66D50, JsonPosition, GetPosition, (app::JsonReader * this_ptr, int32_t depth));
IL2CPP_REGISTER_METHOD(0x01A66E20, void, __ctor, (app::JsonReader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01A671B0, JsonContainerType__Enum, Pop, (app::JsonReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB970, JsonContainerType__Enum, Peek, (app::JsonReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x01A67350, Nullable_1_Int32_, ReadAsInt32, (app::JsonReader * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0474ECB8, JsonReader_ReadAsInt32__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A67790, Nullable_1_Int32_, ReadInt32String, (app::JsonReader * this_ptr, app::String * s));
IL2CPP_REGISTER_METHODINFO(0x047171E8, JsonReader_ReadInt32String__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A67A80, String *, ReadAsString, (app::JsonReader * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0474B1D0, JsonReader_ReadAsString__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A67D10, Byte__Array *, ReadAsBytes, (app::JsonReader * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04757988, JsonReader_ReadAsBytes__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A68230, Byte__Array *, ReadArrayIntoByteArray, (app::JsonReader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01A687C0, Nullable_1_Double_, ReadAsDouble, (app::JsonReader * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04796188, JsonReader_ReadAsDouble__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A68B60, Nullable_1_Double_, ReadDoubleString, (app::JsonReader * this_ptr, app::String * s));
IL2CPP_REGISTER_METHODINFO(0x04704848, JsonReader_ReadDoubleString__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A68E80, Nullable_1_Boolean_, ReadAsBoolean, (app::JsonReader * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0471E280, JsonReader_ReadAsBoolean__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A69260, Nullable_1_Boolean_, ReadBooleanString, (app::JsonReader * this_ptr, app::String * s));
IL2CPP_REGISTER_METHODINFO(0x0470C368, JsonReader_ReadBooleanString__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A69560, Nullable_1_Decimal_, ReadAsDecimal, (app::JsonReader * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0473BCE0, JsonReader_ReadAsDecimal__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A69980, Nullable_1_Decimal_, ReadDecimalString, (app::JsonReader * this_ptr, app::String * s));
IL2CPP_REGISTER_METHODINFO(0x04727E08, JsonReader_ReadDecimalString__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A69D80, Nullable_1_DateTime_, ReadAsDateTime, (app::JsonReader * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04737130, JsonReader_ReadAsDateTime__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A6A090, Nullable_1_DateTime_, ReadDateTimeString, (app::JsonReader * this_ptr, app::String * s));
IL2CPP_REGISTER_METHODINFO(0x04747128, JsonReader_ReadDateTimeString__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A6A470, Nullable_1_DateTimeOffset_, ReadAsDateTimeOffset, (app::JsonReader * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0473E080, JsonReader_ReadAsDateTimeOffset__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A6A790, Nullable_1_DateTimeOffset_, ReadDateTimeOffsetString, (app::JsonReader * this_ptr, app::String * s));
...
IL2CPP_REGISTER_METHOD(0x01A6AC40, JsonReaderException *, CreateUnexpectedEndException, (app::JsonReader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01A6B710, JsonContainerType__Enum, GetTypeForCloseToken, (app::JsonReader * this_ptr, app::JsonToken__Enum_1 token));
...
IL2CPP_REGISTER_METHOD(0x01A6BE70, JsonToken__Enum_1, GetContentToken, (app::JsonReader * this_ptr));
}
