...
namespace app::methods::System_Xml_Linq::ElementWriter {
IL2CPP_REGISTER_METHOD(0x002411A0, void, __ctor, (app::ElementWriter__Boxed * this_ptr, app::XmlWriter * writer));
IL2CPP_REGISTER_METHOD(0x002411C0, void, WriteElement, (app::ElementWriter__Boxed * this_ptr, app::XElement * e));
IL2CPP_REGISTER_METHOD(0x002411D0, String *, GetPrefixOfNamespace, (app::ElementWriter__Boxed * this_ptr, app::XNamespace * ns, bool allow_default_namespace));
