...
IL2CPP_REGISTER_METHOD(0x00420230, EntityOwnedInitOrder__Enum, get_InitOrder, (app::EntityReactions * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CA1210, EntityReactionBehaviour *, GetExecutingReactionBehaviour, (app::EntityReactions * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CA18C0, void, __ctor, (app::EntityReactions * this_ptr));
}
