...
IL2CPP_REGISTER_METHOD(0x01BCEA80, IAsyncResult *, BeginRead, (app::RequestStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::AsyncCallback * cback, app::Object * state));
...
IL2CPP_REGISTER_METHOD(0x01BCF0B0, IAsyncResult *, BeginWrite, (app::RequestStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::AsyncCallback * cback, app::Object * state));
