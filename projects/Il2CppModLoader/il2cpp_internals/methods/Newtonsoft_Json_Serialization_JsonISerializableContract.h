...
namespace app::methods::Newtonsoft_Json_Serialization::JsonISerializableContract {
    ...
    IL2CPP_REGISTER_METHOD(0x01871FE0, void, __ctor, (app::JsonISerializableContract * this_ptr, app::Type * underlying_type));
}
