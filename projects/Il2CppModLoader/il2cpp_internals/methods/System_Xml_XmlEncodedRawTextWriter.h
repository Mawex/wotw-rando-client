...
namespace app::methods::System_Xml::XmlEncodedRawTextWriter {
IL2CPP_REGISTER_METHOD(0x01DAF800, void, __ctor_1, (app::XmlEncodedRawTextWriter * this_ptr, app::XmlWriterSettings * settings));
IL2CPP_REGISTER_METHOD(0x01DAF930, void, __ctor_2, (app::XmlEncodedRawTextWriter * this_ptr, app::TextWriter * writer, app::XmlWriterSettings * settings));
IL2CPP_REGISTER_METHOD(0x01DAFA50, void, __ctor_3, (app::XmlEncodedRawTextWriter * this_ptr, app::Stream * stream, app::XmlWriterSettings * settings));
...
IL2CPP_REGISTER_METHOD(0x01DB26E0, void, WriteAttributeTextBlock, (app::XmlEncodedRawTextWriter * this_ptr, app::uint16_t * p_src, app::uint16_t * p_src_end));
IL2CPP_REGISTER_METHOD(0x01DB29E0, void, WriteElementTextBlock, (app::XmlEncodedRawTextWriter * this_ptr, app::uint16_t * p_src, app::uint16_t * p_src_end));
IL2CPP_REGISTER_METHOD(0x01DB2D50, void, RawText_1, (app::XmlEncodedRawTextWriter * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x01DB2D80, void, RawText_2, (app::XmlEncodedRawTextWriter * this_ptr, app::uint16_t * p_src_begin, app::uint16_t * p_src_end));
IL2CPP_REGISTER_METHOD(0x01DB2F80, void, WriteRawWithCharChecking, (app::XmlEncodedRawTextWriter * this_ptr, app::uint16_t * p_src_begin, app::uint16_t * p_src_end));
...
IL2CPP_REGISTER_METHOD(0x01DB3BA0, uint16_t *, EncodeSurrogate, (app::uint16_t * p_src, app::uint16_t * p_src_end, app::uint16_t * p_dst));
IL2CPP_REGISTER_METHODINFO(0x04767A38, XmlEncodedRawTextWriter_EncodeSurrogate__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01DB3D60, uint16_t *, InvalidXmlChar, (app::XmlEncodedRawTextWriter * this_ptr, int32_t ch, app::uint16_t * p_dst, bool entitize));
IL2CPP_REGISTER_METHODINFO(0x04763520, XmlEncodedRawTextWriter_InvalidXmlChar__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01DB3F20, void, EncodeChar, (app::XmlEncodedRawTextWriter * this_ptr, app::uint16_t * * p_src, app::uint16_t * p_src_end, app::uint16_t * * p_dst));
...
IL2CPP_REGISTER_METHOD(0x01DB41C0, uint16_t *, WriteNewLine, (app::XmlEncodedRawTextWriter * this_ptr, app::uint16_t * p_dst));
IL2CPP_REGISTER_METHOD(0x01DB4240, uint16_t *, LtEntity, (app::uint16_t * p_dst));
IL2CPP_REGISTER_METHOD(0x01DB4260, uint16_t *, GtEntity, (app::uint16_t * p_dst));
IL2CPP_REGISTER_METHOD(0x01DB4280, uint16_t *, AmpEntity, (app::uint16_t * p_dst));
IL2CPP_REGISTER_METHOD(0x01DB42A0, uint16_t *, QuoteEntity, (app::uint16_t * p_dst));
IL2CPP_REGISTER_METHOD(0x01DB42C0, uint16_t *, TabEntity, (app::uint16_t * p_dst));
IL2CPP_REGISTER_METHOD(0x01DB42E0, uint16_t *, LineFeedEntity, (app::uint16_t * p_dst));
IL2CPP_REGISTER_METHOD(0x01DB4300, uint16_t *, CarriageReturnEntity, (app::uint16_t * p_dst));
IL2CPP_REGISTER_METHOD(0x01DB4320, uint16_t *, CharEntity, (app::uint16_t * p_dst, uint16_t ch));
IL2CPP_REGISTER_METHOD(0x01DB4420, uint16_t *, RawStartCData, (app::uint16_t * p_dst));
IL2CPP_REGISTER_METHOD(0x01DB4450, uint16_t *, RawEndCData, (app::uint16_t * p_dst));
