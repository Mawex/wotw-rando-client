...
namespace app::methods::System_Linq_Expressions_Interpreter::NullCheckInstruction {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::NullCheckInstruction * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02407510, String *, get_InstructionName, (app::NullCheckInstruction * this_ptr));
