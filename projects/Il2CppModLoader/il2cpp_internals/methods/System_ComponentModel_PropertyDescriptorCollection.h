...
namespace app::methods::System_ComponentModel::PropertyDescriptorCollection {
...
IL2CPP_REGISTER_METHOD(0x02994310, PropertyDescriptor *, get_Item_1, (app::PropertyDescriptorCollection * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x0476C958, PropertyDescriptorCollection_get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02994400, PropertyDescriptor *, get_Item_2, (app::PropertyDescriptorCollection * this_ptr, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x029948A0, PropertyDescriptor *, Find, (app::PropertyDescriptorCollection * this_ptr, app::String * name, bool ignore_case));
...
IL2CPP_REGISTER_METHOD(0x02995250, PropertyDescriptorCollection *, Sort_1, (app::PropertyDescriptorCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x029953D0, PropertyDescriptorCollection *, Sort_2, (app::PropertyDescriptorCollection * this_ptr, app::String__Array * names));
IL2CPP_REGISTER_METHOD(0x02995550, PropertyDescriptorCollection *, Sort_3, (app::PropertyDescriptorCollection * this_ptr, app::String__Array * names, app::IComparer * comparer));
IL2CPP_REGISTER_METHOD(0x029956D0, PropertyDescriptorCollection *, Sort_4, (app::PropertyDescriptorCollection * this_ptr, app::IComparer * comparer));
...
IL2CPP_REGISTER_METHOD(0x02995D70, IEnumerator *, GetEnumerator, (app::PropertyDescriptorCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, Object *, ICollection_get_SyncRoot, (app::PropertyDescriptorCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02996070, IDictionaryEnumerator *, IDictionary_GetEnumerator, (app::PropertyDescriptorCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x029961C0, Object *, IDictionary_get_Item, (app::PropertyDescriptorCollection * this_ptr, app::Object * key));
...
IL2CPP_REGISTER_METHOD(0x02996640, ICollection *, IDictionary_get_Keys, (app::PropertyDescriptorCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x029967A0, ICollection *, IDictionary_get_Values, (app::PropertyDescriptorCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x02996940, void, IDictionary_Remove, (app::PropertyDescriptorCollection * this_ptr, app::Object * key));
IL2CPP_REGISTER_METHOD(0x0195B1F0, IEnumerator *, IEnumerable_GetEnumerator, (app::PropertyDescriptorCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02997080, Object *, IList_get_Item, (app::PropertyDescriptorCollection * this_ptr, int32_t index));
