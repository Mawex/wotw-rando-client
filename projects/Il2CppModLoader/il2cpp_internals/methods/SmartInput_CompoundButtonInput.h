...
IL2CPP_REGISTER_METHOD(0x006CA840, void, __ctor_1, (app::CompoundButtonInput * this_ptr, app::IButtonInput__Array * inputs));
IL2CPP_REGISTER_METHOD(0x00597BD0, void, __ctor_2, (app::CompoundButtonInput * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006CAB40, IButtonInput *, GetLastPressed, (app::CompoundButtonInput * this_ptr));
