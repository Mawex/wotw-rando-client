...
IL2CPP_REGISTER_METHOD(0x002FA280, BaseAnimator *, get_Animator, (app::LegacyTimelineSequence_SequenceEntry * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01127C70, void, __ctor, (app::LegacyTimelineSequence_SequenceEntry * this_ptr));
}
