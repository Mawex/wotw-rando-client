...
IL2CPP_REGISTER_METHOD(0x014E7B90, void, __ctor, (app::PetrifiedOwlSilentWoodsController_StalkBLoopState * this_ptr, app::PetrifiedOwlSilentWoodsController * controller));
