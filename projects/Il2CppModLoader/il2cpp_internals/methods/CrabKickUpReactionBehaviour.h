...
IL2CPP_REGISTER_METHOD(0x00DB67A0, BehaviourStatus__Enum, OnExecuteTask, (app::CrabKickUpReactionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x005B3EC0, void, __ctor, (app::CrabKickUpReactionBehaviour * this_ptr));
}
