...
IL2CPP_REGISTER_METHOD(0x0128B020, IUberState__Array *, get_AffectingUberStates, (app::UberStateBoolCondition * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::UberStateBoolCondition * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0128B370, void, __ctor, (app::UberStateBoolCondition * this_ptr));
}
