...
namespace app::methods::SeinGrabBlock {
    ...
    IL2CPP_REGISTER_METHOD(0x005D0720, CharacterSpriteMirror*, get_Mirror, (app::SeinGrabBlock * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005D06F0, CharacterLeftRightMovement*, get_CharacterLeftRightMovement, (app::SeinGrabBlock * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement*, get_PlatformMovement, (app::SeinGrabBlock * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x014AF8F0, IPushable*, FindPushableNearby, (app::SeinGrabBlock * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x014B0220, IPushable*, DetectPushPullBlock, (app::SeinGrabBlock * this_ptr));
    IL2CPP_REGISTER_METHOD(0x014B0A20, IPushable*, DetectIPushable, (app::SeinGrabBlock * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x014B2590, void, __ctor, (app::SeinGrabBlock * this_ptr));
