...
namespace app::methods::Moon_Telemetry_Performance_visualization::GLHelper {
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::GLHelper * this_ptr));
IL2CPP_REGISTER_METHOD(0x010A5AC0, void, __cctor, ());
}
