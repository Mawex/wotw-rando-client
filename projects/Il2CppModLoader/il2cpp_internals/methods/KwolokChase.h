...
namespace app::methods::KwolokChase {
    ...
    IL2CPP_REGISTER_METHOD(0x00420EE0, IUberState__Array*, get_AffectingUberStates, (app::KwolokChase * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00420EE0, List_1_UnityEngine_GameObject_*, get_AllTargets, (app::KwolokChase * this_ptr));
