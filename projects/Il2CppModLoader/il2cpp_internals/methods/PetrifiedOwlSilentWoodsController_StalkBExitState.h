...
namespace app::methods::PetrifiedOwlSilentWoodsController_StalkBExitState {
    IL2CPP_REGISTER_METHOD(0x014E7B90, void, __ctor, (app::PetrifiedOwlSilentWoodsController_StalkBExitState * this_ptr, app::PetrifiedOwlSilentWoodsController * controller));
