...
namespace app::methods::System_Resources::FastResourceComparer {
...
IL2CPP_REGISTER_METHOD(0x02699980, int32_t, CompareOrdinal_3, (app::uint8_t * a, int32_t byte_len, app::String * b));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::FastResourceComparer * this_ptr));
