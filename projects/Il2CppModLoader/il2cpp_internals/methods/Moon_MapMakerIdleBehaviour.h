...
IL2CPP_REGISTER_METHOD(0x0110E8F0, BehaviourStatus__Enum, OnExecute, (app::MapMakerIdleBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00E27000, void, OnExit, (app::MapMakerIdleBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x0060C1C0, void, __ctor, (app::MapMakerIdleBehaviour * this_ptr));
}
