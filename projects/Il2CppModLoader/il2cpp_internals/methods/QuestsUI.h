...
namespace app::methods::QuestsUI {
    ...
    IL2CPP_REGISTER_METHOD(0x00420EE0, MenuTabBackground__Enum, get_BackgroundMode, (app::QuestsUI * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00E94D80, Quest*, GetCurrentSelectedQuest, (app::QuestsUI * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00E94E30, CleverMenuItem*, GetQuestItem, (app::QuestsUI * this_ptr, app::Quest* quest));
    IL2CPP_REGISTER_METHOD(0x00E94FF0, CleverMenuItem*, GetActiveQuestItem, (app::QuestsUI * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00E950F0, void, BuildUI, (app::QuestsUI * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00E95380, Vector3, AddItems, (app::QuestsUI * this_ptr, app::Vector3 base_position, app::Quest_QuestType__Enum type));
    IL2CPP_REGISTER_METHOD(0x00E95670, bool, ShouldAddItem, (app::QuestsUI * this_ptr, app::RuntimeQuest* quest));
    IL2CPP_REGISTER_METHOD(0x00E956A0, QuestItemUI*, CreateQuestItem, (app::QuestsUI * this_ptr, app::Quest_QuestType__Enum quest_type, app::RuntimeQuest* runtime_quest, app::Vector2 row_position));
    ...
    IL2CPP_REGISTER_METHOD(0x00E96650, Quest*, get_ActiveQuest, (app::QuestsUI * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00E96AF0, void, __ctor, (app::QuestsUI * this_ptr));
} // namespace app::methods::QuestsUI
