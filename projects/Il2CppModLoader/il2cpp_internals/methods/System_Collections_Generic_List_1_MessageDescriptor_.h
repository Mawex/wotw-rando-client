...
namespace app::methods::System_Collections_Generic::List_1_MessageDescriptor_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_MessageDescriptor_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, MessageDescriptor__Array *, ToArray, (app::List_1_MessageDescriptor_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04733408, List_1_MessageDescriptor__ToArray__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02C1DFB0, MessageDescriptor, get_Item, (app::List_1_MessageDescriptor_ * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x0478C978, List_1_MessageDescriptor__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_MessageDescriptor_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02D484C0, void, __ctor_3, (app::List_1_MessageDescriptor_ * this_ptr, app::IEnumerable_1_MessageDescriptor_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02D48950, Object *, ICollection_get_SyncRoot, (app::List_1_MessageDescriptor_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C1E150, Object *, IList_get_Item, (app::List_1_MessageDescriptor_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_MessageDescriptor_ *, AsReadOnly, (app::List_1_MessageDescriptor_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C1EA20, MessageDescriptor, Find, (app::List_1_MessageDescriptor_ * this_ptr, app::Predicate_1_MessageDescriptor_ * match));
IL2CPP_REGISTER_METHOD(0x02C1EB60, List_1_MessageDescriptor_ *, FindAll, (app::List_1_MessageDescriptor_ * this_ptr, app::Predicate_1_MessageDescriptor_ * match));
...
IL2CPP_REGISTER_METHOD(0x02C1F070, List_1_T_Enumerator_MessageDescriptor_, GetEnumerator, (app::List_1_MessageDescriptor_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02C1F0C0, IEnumerator_1_MessageDescriptor_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_MessageDescriptor_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02C1F0C0, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_MessageDescriptor_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_MessageDescriptor_ *, GetRange, (app::List_1_MessageDescriptor_ * this_ptr, int32_t index, int32_t count));
