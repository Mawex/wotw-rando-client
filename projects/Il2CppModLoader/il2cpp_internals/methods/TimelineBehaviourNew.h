...
IL2CPP_REGISTER_METHOD(0x010F4B70, BehaviourStatus__Enum, get_StatusWhenPlaying, (app::TimelineBehaviourNew * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010F50B0, BehaviourStatus__Enum, OnExecute, (app::TimelineBehaviourNew * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x010F51D0, void, OnExit, (app::TimelineBehaviourNew * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00420FE0, void, __ctor, (app::TimelineBehaviourNew * this_ptr));
}
