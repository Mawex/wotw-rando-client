...
namespace app::methods::System_Collections_Generic::Dictionary_2_RailType_UnityEngine_Color_ {
IL2CPP_REGISTER_METHOD(0x02C3B360, Color, get_Item, (app::Dictionary_2_RailType_UnityEngine_Color_ * this_ptr, app::RailType__Enum key));
IL2CPP_REGISTER_METHODINFO(0x0478F588, Dictionary_2_RailType_UnityEngine_Color__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_RailType_UnityEngine_Color_ * this_ptr));
