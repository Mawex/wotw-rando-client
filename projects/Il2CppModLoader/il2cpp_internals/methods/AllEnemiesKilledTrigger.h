...
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, get_VirtualTimelineTarget, (app::AllEnemiesKilledTrigger * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417920, VirtualTimelineRepresentationGroup__Enum, get_VirtualTimelineGroup, (app::AllEnemiesKilledTrigger * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F47C0, String *, get_NameDisplayedOnClip, (app::AllEnemiesKilledTrigger * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4840, void, __ctor, (app::AllEnemiesKilledTrigger * this_ptr));
}
