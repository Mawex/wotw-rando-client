...
IL2CPP_REGISTER_METHOD(0x008677A0, String *, GetValueToDisplay, (app::MotionBlurSlider * this_ptr));
IL2CPP_REGISTER_METHOD(0x00867970, void, __ctor, (app::MotionBlurSlider * this_ptr));
}
