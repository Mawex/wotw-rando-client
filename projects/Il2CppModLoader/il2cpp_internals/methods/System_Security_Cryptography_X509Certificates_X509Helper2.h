...
IL2CPP_REGISTER_METHOD(0x0257BD90, void, Initialize, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x0257C4A0, Exception *, GetInvalidChainContextException, (MethodInfo * method));
}
