...
namespace app::methods::Moon_Timeline::SpriteTransparencyTweenAnimator {
IL2CPP_REGISTER_METHOD(0x00D07AA0, GameObject *, get_ExternalTarget, (app::SpriteTransparencyTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, OnEntityCreated, (app::SpriteTransparencyTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCA0, SpriteRenderer *, get_SpriteRenderer, (app::SpriteTransparencyTweenAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D086B0, bool, ApproximateEvent, (app::SpriteTransparencyTweenAnimator * this_ptr, int32_t evt, app::float * time));
IL2CPP_REGISTER_METHOD(0x00D088B0, void, __ctor, (app::SpriteTransparencyTweenAnimator * this_ptr));
}
