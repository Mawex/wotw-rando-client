...
IL2CPP_REGISTER_METHOD(0x012ACB60, bool, CheckValueChanged, (app::int32_t * cache, int32_t value));
IL2CPP_REGISTER_METHOD(0x012AC3D0, void, InvalidateCaches, (app::UnityRaceTimerDisplay * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::UnityRaceTimerDisplay * this_ptr));
}
