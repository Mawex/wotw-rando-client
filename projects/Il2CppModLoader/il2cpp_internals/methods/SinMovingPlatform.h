...
IL2CPP_REGISTER_METHOD(0x003FF8B0, SuspendableMask__Enum, get_Mask, (app::SinMovingPlatform * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0074B500, void, __ctor, (app::SinMovingPlatform * this_ptr));
}
