...
namespace app::methods::SystemIntegration_Races::RaceRequestResultEntry {
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_DisplayName, (app::RaceRequestResultEntry * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB00, Byte__Array *, get_Data, (app::RaceRequestResultEntry * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, String *, get_UserID, (app::RaceRequestResultEntry * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9C0, void, set_UserID, (app::RaceRequestResultEntry * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::RaceRequestResultEntry * this_ptr));
}
