...
IL2CPP_REGISTER_METHOD(0x010F7EC0, MoonTimeline *, get_Target, (app::TimelineStateCondition * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::TimelineStateCondition * this_ptr));
}
