...
namespace app::methods::CartStopper {
    ...
    IL2CPP_REGISTER_METHOD(0x00B3F8E0, bool, InsideCartStopper_1, (app::Vector3 position, app::Vector3 direction, app::bool* does_contain));
    ...
    IL2CPP_REGISTER_METHOD(0x0043D9A0, SelectableCategory__Enum, get_Category, (app::CartStopper * this_ptr));
