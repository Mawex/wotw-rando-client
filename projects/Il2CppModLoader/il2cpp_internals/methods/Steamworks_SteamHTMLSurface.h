...
IL2CPP_REGISTER_METHOD(0x02804E40, SteamAPICall_t, CreateBrowser, (app::String * pch_user_agent, app::String * pch_user_c_s_s));
...
IL2CPP_REGISTER_METHOD(0x02807C10, void, FileLoadDialogResponse, (app::HHTMLBrowser un_browser_handle, app::void * pch_selected_files));
}
