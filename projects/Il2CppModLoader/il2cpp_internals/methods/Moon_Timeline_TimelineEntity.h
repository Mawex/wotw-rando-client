...
namespace app::methods::Moon_Timeline::TimelineEntity {
IL2CPP_REGISTER_METHOD(0x01E85270, bool, get_IsReadOnly, (app::TimelineEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E853D0, PlaybackStatus *, get_PlaybackStatus, (app::TimelineEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00BAB250, String *, get_Name, (app::TimelineEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x006410F0, AnimatorPlayState__Enum, get_PlayState, (app::TimelineEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x008F7CD0, void, set_PlayState, (app::TimelineEntity * this_ptr, app::AnimatorPlayState__Enum value));
IL2CPP_REGISTER_METHOD(0x01E85560, UpdateType__Enum, get_UpdateType, (app::TimelineEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, UpdateCategory__Enum, get_UpdateCategory, (app::TimelineEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004C6660, SuspendableMask__Enum, get_Mask, (app::TimelineEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBA0, IEventReciever *, get_EventReciever, (app::TimelineEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E85EC0, void, __ctor, (app::TimelineEntity * this_ptr));
