...
namespace app::methods::UnityEngine_Events::InvokableCall_1_System_Single_ {
IL2CPP_REGISTER_METHOD(0x02AC5CF0, void, __ctor_1, (app::InvokableCall_1_System_Single_ * this_ptr, app::Object * target, app::MethodInfo_1 * the_function));
IL2CPP_REGISTER_METHOD(0x02722840, void, __ctor_2, (app::InvokableCall_1_System_Single_ * this_ptr, app::UnityAction_1_System_Single_ * action));
