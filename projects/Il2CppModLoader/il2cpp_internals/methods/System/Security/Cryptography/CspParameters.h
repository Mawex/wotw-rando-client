...
namespace app::methods::System::Security::Cryptography::CspParameters {
    ...
    IL2CPP_REGISTER_METHOD(0x020D0710, void, __ctor_6, (app::CspParameters * this_ptr, int32_t provider_type, app::String * provider_name, app::String * key_container_name, app::CryptoKeySecurity * crypto_key_security, void * parent_window_handle));
