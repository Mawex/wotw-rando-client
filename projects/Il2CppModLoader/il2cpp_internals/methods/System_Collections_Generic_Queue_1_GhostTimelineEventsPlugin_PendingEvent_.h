...
namespace app::methods::System_Collections_Generic::Queue_1_GhostTimelineEventsPlugin_PendingEvent_ {
IL2CPP_REGISTER_METHOD(0x02CA2440, GhostTimelineEventsPlugin_PendingEvent, Dequeue, (app::Queue_1_GhostTimelineEventsPlugin_PendingEvent_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CA2880, Object *, ICollection_get_SyncRoot, (app::Queue_1_GhostTimelineEventsPlugin_PendingEvent_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CA2340, Queue_1_T_Enumerator_GhostTimelineEventsPlugin_PendingEvent_, GetEnumerator, (app::Queue_1_GhostTimelineEventsPlugin_PendingEvent_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA2390, IEnumerator_1_GhostTimelineEventsPlugin_PendingEvent_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::Queue_1_GhostTimelineEventsPlugin_PendingEvent_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA2390, IEnumerator *, IEnumerable_GetEnumerator, (app::Queue_1_GhostTimelineEventsPlugin_PendingEvent_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA2530, GhostTimelineEventsPlugin_PendingEvent, Peek, (app::Queue_1_GhostTimelineEventsPlugin_PendingEvent_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0243D5D0, GhostTimelineEventsPlugin_PendingEvent__Array *, ToArray, (app::Queue_1_GhostTimelineEventsPlugin_PendingEvent_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0243D7A0, void, MoveNext, (app::Queue_1_GhostTimelineEventsPlugin_PendingEvent_ * this_ptr, app::int32_t * index));
