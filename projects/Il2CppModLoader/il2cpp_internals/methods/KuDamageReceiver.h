...
IL2CPP_REGISTER_METHOD(0x002FBBA0, Ku *, get_Ku, (app::KuDamageReceiver * this_ptr));
IL2CPP_REGISTER_METHOD(0x0122F570, SeinCharacter *, get_Sein, (app::KuDamageReceiver * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012304A0, void, __ctor, (app::KuDamageReceiver * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::KuDamageReceiver * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::KuDamageReceiver * this_ptr));
}
