...
namespace app::methods::System_Linq::Lookup_2_TKey_TElement__Grouping_System_Object_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::Lookup_2_TKey_TElement_Grouping_System_Object_System_Object_ * this_ptr));
}
