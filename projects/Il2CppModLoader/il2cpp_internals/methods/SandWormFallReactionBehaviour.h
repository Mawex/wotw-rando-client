...
IL2CPP_REGISTER_METHOD(0x00C1B500, BehaviourStatus__Enum, OnExecuteTask, (app::SandWormFallReactionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00C1B5E0, void, OnExitTask, (app::SandWormFallReactionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00C1B7C0, void, __ctor, (app::SandWormFallReactionBehaviour * this_ptr));
}
