...
IL2CPP_REGISTER_METHOD(0x02635A00, IMesh *, Triangulate, (app::Incremental * this_ptr, app::IList_1_TriangleNet_Geometry_Vertex_ * points, app::Configuration_1 * config));
