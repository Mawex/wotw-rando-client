...
namespace app::methods::SystemIntegration_Synchronizer_Achievements::PlayFabAchievements___c {
IL2CPP_REGISTER_METHOD(0x0052DD90, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::PlayFabAchievements_c * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0052DFA0, String *, _UpdateFromServer_b__18_0, (app::PlayFabAchievements_c * this_ptr, app::AchievementAsset * o));
