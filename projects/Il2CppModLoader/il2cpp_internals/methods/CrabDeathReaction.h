...
IL2CPP_REGISTER_METHOD(0x00DB2250, CrabDeathReaction_DeathState__Enum, GetNextOnHitGroundState, (app::CrabDeathReaction * this_ptr));
IL2CPP_REGISTER_METHOD(0x00DB2280, void, OnEnterTask, (app::CrabDeathReaction * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00DB2720, BehaviourStatus__Enum, OnExecuteTask, (app::CrabDeathReaction * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00DB3C70, Vector3, ProcessRootMotion, (app::CrabDeathReaction * this_ptr, app::Vector3 motion));
IL2CPP_REGISTER_METHODINFO(0x04786578, CrabDeathReaction_ProcessRootMotion__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00DB3CC0, void, __ctor, (app::CrabDeathReaction * this_ptr));
}
