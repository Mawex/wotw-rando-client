...
IL2CPP_REGISTER_METHOD(0x0043D9A0, SelectableCategory__Enum, get_Category, (app::StomperTrigger * this_ptr));
IL2CPP_REGISTER_METHOD(0x004C8610, void, __ctor, (app::StomperTrigger * this_ptr));
}
