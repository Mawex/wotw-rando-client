...
namespace app::methods::System_Collections::SortedList_SortedListEnumerator {
IL2CPP_REGISTER_METHOD(0x0202F720, void, __ctor, (app::SortedList_SortedListEnumerator * this_ptr, app::SortedList * sorted_list, int32_t index, int32_t count, int32_t get_obj_ret_type));
IL2CPP_REGISTER_METHOD(0x0173F610, Object *, Clone, (app::SortedList_SortedListEnumerator * this_ptr));
IL2CPP_REGISTER_METHOD(0x0202F760, Object *, get_Key, (app::SortedList_SortedListEnumerator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0202FA10, DictionaryEntry, get_Entry, (app::SortedList_SortedListEnumerator * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04724210, SortedList_SortedListEnumerator_get_Entry__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0202FB40, Object *, get_Current, (app::SortedList_SortedListEnumerator * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047536D8, SortedList_SortedListEnumerator_get_Current__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0202FC60, Object *, get_Value, (app::SortedList_SortedListEnumerator * this_ptr));
