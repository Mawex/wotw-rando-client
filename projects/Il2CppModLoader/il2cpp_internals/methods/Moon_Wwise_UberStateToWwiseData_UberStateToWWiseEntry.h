...
namespace app::methods::Moon_Wwise::UberStateToWwiseData_UberStateToWWiseEntry {
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::UberStateToWwiseData_UberStateToWWiseEntry * this_ptr));
}
