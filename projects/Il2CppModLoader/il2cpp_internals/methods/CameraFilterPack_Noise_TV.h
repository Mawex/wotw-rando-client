...
IL2CPP_REGISTER_METHOD(0x024824E0, Material *, get_material, (app::CameraFilterPack_Noise_TV * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020F7040, void, __ctor, (app::CameraFilterPack_Noise_TV * this_ptr));
}
