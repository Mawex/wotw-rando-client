...
IL2CPP_REGISTER_METHOD(0x0209EAF0, int32_t, Calculate, (ICollection_1_System_Net_Http_Headers_NameValueHeaderValue_ * list));
IL2CPP_REGISTER_METHODINFO(0x04785B88, HashCodeCalculator_Calculate_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0209EAF0, int32_t, Calculate, (ICollection_1_System_String_ * list));
IL2CPP_REGISTER_METHODINFO(0x0478B938, HashCodeCalculator_Calculate_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0209EAF0, int32_t, Calculate, (ICollection_1_System_Net_Http_Headers_RangeItemHeaderValue_ * list));
