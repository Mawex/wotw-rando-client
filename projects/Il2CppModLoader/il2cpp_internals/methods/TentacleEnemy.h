...
IL2CPP_REGISTER_METHOD(0x00CEF030, TentacleEnemy_Joint *, get_HeadJoint, (app::TentacleEnemy * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CEF0D0, GameObject *, get_HeadGameObject, (app::TentacleEnemy * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CEF160, TentacleEnemy_Joint *, get_NeckJoint, (app::TentacleEnemy * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CEF200, GameObject *, get_NeckGameObject, (app::TentacleEnemy * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CEF310, float, get_CurrentLength, (app::TentacleEnemy * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CEF510, Vector3, get_HeadOrientation, (app::TentacleEnemy * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CF3C00, BehaviourTreeStatus__Enum, OnReset, (app::TentacleEnemy * this_ptr, app::TickData t));
...
IL2CPP_REGISTER_METHOD(0x00CF41A0, Vector3__Array *, MakeSmoothCurve, (app::Vector3__Array * array_to_curve, float smoothness));
...
IL2CPP_REGISTER_METHOD(0x00CF64B0, void, __ctor, (app::TentacleEnemy * this_ptr));
