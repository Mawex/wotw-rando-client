...
namespace app::methods::System_Runtime_Serialization_Formatters_Binary::BinaryObjectWithMapTyped {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_1, (app::BinaryObjectWithMapTyped * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FC6E0, void, __ctor_2, (app::BinaryObjectWithMapTyped * this_ptr, app::BinaryHeaderEnum__Enum binary_header_enum));
