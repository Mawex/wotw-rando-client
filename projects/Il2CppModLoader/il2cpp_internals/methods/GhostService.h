...
namespace app::methods::GhostService {
    ...
    IL2CPP_REGISTER_METHOD(0x007E88D0, GhostPlayer*, get_TopScoreGhost, (app::GhostService * this_ptr));
    IL2CPP_REGISTER_METHOD(0x007E8AC0, Vector3, GetGhostPosition, (app::GhostService * this_ptr, int32_t index));
    IL2CPP_REGISTER_METHOD(0x007E8CB0, GhostPlayer*, GetGhost, (app::GhostService * this_ptr, int32_t index));
    IL2CPP_REGISTER_METHOD(0x002FA280, List_1_GhostPlayer_*, GetGhosts, (app::GhostService * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x007E92B0, void, __ctor, (app::GhostService * this_ptr));
} // namespace app::methods::GhostService
