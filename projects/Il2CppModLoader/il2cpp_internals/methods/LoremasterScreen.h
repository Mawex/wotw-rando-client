...
IL2CPP_REGISTER_METHOD(0x00420EE0, MenuTabBackground__Enum, get_BackgroundMode, (app::LoremasterScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009F19A0, CleverMenuItemSelectionManager *, get_Navigation, (app::LoremasterScreen * this_ptr));
IL2CPP_REGISTER_METHOD(0x009F19C0, LoremasterUISlot *, get_SelectedItem, (app::LoremasterScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00653FB0, SuspendableMask__Enum, get_Mask, (app::LoremasterScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009F3070, void, __ctor, (app::LoremasterScreen * this_ptr));
}
