...
IL2CPP_REGISTER_METHOD(0x003FC7F0, InteractionBidingButton__Enum, get_Button, (app::ButtonDialogTransition * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, InteractionBinding *, get_InteractionBinding, (app::ButtonDialogTransition * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB80, Action_1_IContext_ *, get_OnActivated, (app::ButtonDialogTransition * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB90, void, set_OnActivated, (app::ButtonDialogTransition * this_ptr, app::Action_1_IContext_ * value));
IL2CPP_REGISTER_METHOD(0x002FBBA0, Action_1_IContext_ *, get_OnFinished, (app::ButtonDialogTransition * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0081E5A0, IDialogNode *, get_TransitionDestination, (app::ButtonDialogTransition * this_ptr));
IL2CPP_REGISTER_METHOD(0x00585310, bool, Validate, (app::ButtonDialogTransition * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::ButtonDialogTransition * this_ptr));
}
