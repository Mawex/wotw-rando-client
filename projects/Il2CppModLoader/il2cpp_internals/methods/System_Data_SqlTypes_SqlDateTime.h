...
namespace app::methods::System_Data_SqlTypes::SqlDateTime {
    ...
    IL2CPP_REGISTER_METHOD(0x01E53D40, app::SqlDateTime, operator_, (app::DateTime value));
    IL2CPP_REGISTER_METHOD(0x001D6CB0, app::String *, ToString, (app::SqlDateTime__Boxed * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01E53D60, app::SqlBoolean, operator___, (app::SqlDateTime x, app::SqlDateTime y));
    IL2CPP_REGISTER_METHOD(0x01E53E70, app::SqlBoolean, operator___1, (app::SqlDateTime x, app::SqlDateTime y));
    IL2CPP_REGISTER_METHOD(0x01E53FC0, app::SqlBoolean, operator___2, (app::SqlDateTime x, app::SqlDateTime y));
