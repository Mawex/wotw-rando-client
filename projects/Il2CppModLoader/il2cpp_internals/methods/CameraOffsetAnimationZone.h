...
IL2CPP_REGISTER_METHOD(0x01694DE0, Rect, get_Rect, (app::CameraOffsetAnimationZone * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01696090, Bounds, IFrustumOptimizable_get_Bounds, (app::CameraOffsetAnimationZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CBCC50, bool, get_AllowCacheBounds, (app::CameraOffsetAnimationZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x016960B0, Rect, get_Bounds, (app::CameraOffsetAnimationZone * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00417920, SelectableCategory__Enum, get_Category, (app::CameraOffsetAnimationZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, get_VirtualTimelineTarget, (app::CameraOffsetAnimationZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x0043D9E0, VirtualTimelineRepresentationGroup__Enum, get_VirtualTimelineGroup, (app::CameraOffsetAnimationZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x016966D0, String *, get_NameDisplayedOnClip, (app::CameraOffsetAnimationZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x01696750, void, Build, (app::CameraOffsetAnimationZone * this_ptr, app::VirtualClipsBuilder * builder));
IL2CPP_REGISTER_METHOD(0x016969A0, void, __ctor, (app::CameraOffsetAnimationZone * this_ptr));
