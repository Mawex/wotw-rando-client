...
namespace app::methods::Moon_BehaviourSystem::IsTargetInAreaOfTypeCondition {
    ...
    IL2CPP_REGISTER_METHOD(0x00CB75E0, void, __ctor, (app::IsTargetInAreaOfTypeCondition * this_ptr));
}
