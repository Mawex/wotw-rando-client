...
namespace app::methods::System_Collections_Generic::List_1_Moon_VectorAnimationParameter_ {
IL2CPP_REGISTER_METHOD(0x025EFC50, VectorAnimationParameter *, get_Item, (app::List_1_Moon_VectorAnimationParameter_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_Moon_VectorAnimationParameter_, GetEnumerator, (app::List_1_Moon_VectorAnimationParameter_ * this_ptr));
