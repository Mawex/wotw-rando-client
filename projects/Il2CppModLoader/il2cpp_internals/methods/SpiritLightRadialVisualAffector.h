...
IL2CPP_REGISTER_METHOD(0x00D626B0, Vector3, get_Position, (app::SpiritLightRadialVisualAffector * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D62C80, Bounds, get_Bounds, (app::SpiritLightRadialVisualAffector * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_AllowCacheBounds, (app::SpiritLightRadialVisualAffector * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D62D10, void, __ctor, (app::SpiritLightRadialVisualAffector * this_ptr));
