...
IL2CPP_REGISTER_METHOD(0x002FC6D0, SortingOrder__Enum, get_SortingOrder, (app::CacheData * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FC6E0, void, set_SortingOrder, (app::CacheData * this_ptr, app::SortingOrder__Enum value));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Name, (app::CacheData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::CacheData * this_ptr));
}
