...
IL2CPP_REGISTER_METHOD(0x002FA280, Object *, get_Item1, (app::Tuple_2_Object_Single_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x00863E90, float, get_Item2, (app::Tuple_2_Object_Single_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A68070, void, __ctor, (app::Tuple_2_Object_Single_ * this_ptr, app::Object * item1, float item2));
...
IL2CPP_REGISTER_METHOD(0x02A687E0, String *, ToString, (app::Tuple_2_Object_Single_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A68960, String *, ITupleInternal_ToString, (app::Tuple_2_Object_Single_ * this_ptr, app::StringBuilder * sb));
}
