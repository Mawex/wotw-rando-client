...
namespace app::methods::Moon_Animation::DirectionalHitReactionPostprocess {
...
IL2CPP_REGISTER_METHOD(0x01B02080, void, __ctor, (app::DirectionalHitReactionPostprocess * this_ptr));
}
