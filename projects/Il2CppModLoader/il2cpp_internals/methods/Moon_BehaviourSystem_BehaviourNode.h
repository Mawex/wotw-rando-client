...
namespace app::methods::Moon_BehaviourSystem::BehaviourNode {
IL2CPP_REGISTER_METHOD(0x004E57A0, BehaviourStatus__Enum, get_Status, (app::BehaviourNode * this_ptr));
IL2CPP_REGISTER_METHOD(0x004E57B0, void, set_Status, (app::BehaviourNode * this_ptr, app::BehaviourStatus__Enum value));
IL2CPP_REGISTER_METHOD(0x002FBBE0, Nullable_1_Moon_BehaviourSystem_BehaviourStatus_, get_ForceReturnTaskStatus, (app::BehaviourNode * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBA0, List_1_Moon_BehaviourSystem_DecoratorNode_ *, get_Decorators, (app::BehaviourNode * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030053D0, BehaviourStatus__Enum, Execute, (app::BehaviourNode * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x03005920, String *, get_ProfExecute, (app::BehaviourNode * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004E57A0, BehaviourStatus__Enum, get_TaskStatus, (app::BehaviourNode * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02997080, BehaviourStatus__Enum, OnExecuteTask, (app::BehaviourNode * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x03005DB0, void, __ctor, (app::BehaviourNode * this_ptr));
IL2CPP_REGISTER_METHOD(0x015EBC30, Object *, GetDecorator, (app::BehaviourNode * this_ptr));
