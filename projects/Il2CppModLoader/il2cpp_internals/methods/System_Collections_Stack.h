...
namespace app::methods::System_Collections::Stack {
IL2CPP_REGISTER_METHOD(0x02031C10, void, __ctor_1, (app::Stack * this_ptr));
IL2CPP_REGISTER_METHOD(0x02031CB0, void, __ctor_2, (app::Stack * this_ptr, int32_t initial_capacity));
...
IL2CPP_REGISTER_METHOD(0x02031DA0, Object *, get_SyncRoot, (app::Stack * this_ptr));
IL2CPP_REGISTER_METHOD(0x02031F00, void, Clear, (app::Stack * this_ptr));
IL2CPP_REGISTER_METHOD(0x02031F30, Object *, Clone, (app::Stack * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020323B0, IEnumerator *, GetEnumerator, (app::Stack * this_ptr));
IL2CPP_REGISTER_METHOD(0x02032510, Object *, Peek, (app::Stack * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0475A358, Stack_Peek__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02032600, Object *, Pop, (app::Stack * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02032890, Object__Array *, ToArray, (app::Stack * this_ptr));
}
