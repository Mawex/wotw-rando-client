...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (List_1_DamageType_ * __this));
IL2CPP_REGISTER_METHODINFO(0x04709020, List_1_DamageType___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02D1F360, DamageType__Enum, get_Item, (List_1_DamageType_ * __this, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x04706F30, List_1_DamageType__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (List_1_DamageType_ * __this));
IL2CPP_REGISTER_METHODINFO(0x0476A148, List_1_DamageType__get_Count__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02F1CC20, bool, Contains, (List_1_DamageType_ * __this, DamageType__Enum item));
IL2CPP_REGISTER_METHODINFO(0x04742158, List_1_DamageType__Contains__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02F1C970, void, Add, (List_1_DamageType_ * __this, DamageType__Enum item));
IL2CPP_REGISTER_METHODINFO(0x0470C5A0, List_1_DamageType__Add__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02D20C90, void, RemoveAt, (List_1_DamageType_ * __this, int32_t index));
