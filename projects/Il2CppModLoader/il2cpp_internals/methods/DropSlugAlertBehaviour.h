...
IL2CPP_REGISTER_METHOD(0x00420EE0, BehaviourStatus__Enum, OnExecute, (app::DropSlugAlertBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00BE0E50, void, PlayTimeline, (app::DropSlugAlertBehaviour * this_ptr, app::MoonTimeline * timeline));
IL2CPP_REGISTER_METHOD(0x00BE0E80, void, __ctor, (app::DropSlugAlertBehaviour * this_ptr));
}
