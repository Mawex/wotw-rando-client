...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_Int32_System_TimeType_ {
...
IL2CPP_REGISTER_METHOD(0x02BB8880, TimeType *, get_Item, (app::Dictionary_2_System_Int32_System_TimeType_ * this_ptr, int32_t key));
IL2CPP_REGISTER_METHODINFO(0x04727D10, Dictionary_2_System_Int32_System_TimeType__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02259DF0, void, __ctor, (app::Dictionary_2_System_Int32_System_TimeType_ * this_ptr, int32_t capacity));
