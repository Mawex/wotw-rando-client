...
IL2CPP_REGISTER_METHOD(0x031AC220, void, ResetStatics, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x031AC430, Dictionary_2_Moon_ISuspendable_System_Int32_ *, get_Suspensables, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x031ACCB0, void, OnSuspensionTicketsModified, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x031ACD90, void, UpdateAllSuspendableStates, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x031AD150, void, UpdateCurrentSuspensionMask, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x031AD2F0, bool, FindOrAddToSuspended, (ISuspendable * suspendable, int32_t * count));
IL2CPP_REGISTER_METHOD(0x031AD4C0, void, SuspendAll, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x031AE5F0, void, CleanupSuspendables, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x031AE930, void, ResumeAll, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x031AF0D0, void, __cctor, (MethodInfo * method));
}
