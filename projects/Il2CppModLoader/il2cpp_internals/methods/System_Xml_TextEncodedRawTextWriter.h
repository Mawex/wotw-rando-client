...
namespace app::methods::System_Xml::TextEncodedRawTextWriter {
    IL2CPP_REGISTER_METHOD(0x019507C0, void, __ctor_1, (app::TextEncodedRawTextWriter * this_ptr, app::TextWriter * writer, app::XmlWriterSettings * settings));
    IL2CPP_REGISTER_METHOD(0x019507D0, void, __ctor_2, (app::TextEncodedRawTextWriter * this_ptr, app::Stream * stream, app::XmlWriterSettings * settings));
