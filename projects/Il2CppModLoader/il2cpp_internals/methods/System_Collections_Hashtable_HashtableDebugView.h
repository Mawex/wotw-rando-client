...
namespace app::methods::System_Collections::Hashtable_HashtableDebugView {
    IL2CPP_REGISTER_METHOD(0x02026FE0, void, __ctor, (app::Hashtable_HashtableDebugView * this_ptr, app::Hashtable * hashtable));
