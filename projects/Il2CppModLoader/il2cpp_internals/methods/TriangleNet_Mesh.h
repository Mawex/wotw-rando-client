...
IL2CPP_REGISTER_METHOD(0x002FBBA0, Rectangle *, get_Bounds, (app::Mesh_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x0262A230, ICollection_1_TriangleNet_Geometry_Vertex_ *, get_Vertices, (app::Mesh_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB60, IList_1_TriangleNet_Geometry_Point_ *, get_Holes, (app::Mesh_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB990, ICollection_1_TriangleNet_Topology_Triangle_ *, get_Triangles, (app::Mesh_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x0262A2C0, ICollection_1_TriangleNet_Topology_SubSegment_ *, get_Segments, (app::Mesh_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x0262A350, IEnumerable_1_TriangleNet_Geometry_Edge_ *, get_Edges, (app::Mesh_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0073EDA0, NodeNumbering__Enum, get_CurrentNumbering, (app::Mesh_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x0262A530, void, Initialize, (app::Mesh_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x0262A9D0, void, __ctor, (app::Mesh_1 * this_ptr, app::Configuration_1 * config));
...
IL2CPP_REGISTER_METHOD(0x0262C6A0, InsertVertexResult__Enum, InsertVertex, (app::Mesh_1 * this_ptr, app::Vertex * newvertex, app::Otri * searchtri, app::Osub * splitseg, bool segmentflaws, bool triflaws));
