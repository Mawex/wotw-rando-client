...
namespace app::methods::Moon_Timeline::ParticleSystemAnimator {
IL2CPP_REGISTER_METHOD(0x002FA000, void, OnEntityCreated, (app::ParticleSystemAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E78090, ParticleSystem *, get_ResolvedParticleSystem, (app::ParticleSystemAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E78D90, void, __ctor, (app::ParticleSystemAnimator * this_ptr));
}
