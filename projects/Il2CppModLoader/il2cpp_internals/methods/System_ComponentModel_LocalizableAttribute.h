...
namespace app::methods::System_ComponentModel::LocalizableAttribute {
    IL2CPP_REGISTER_METHOD(0x0052C650, void, __ctor, (app::LocalizableAttribute * this_ptr, bool is_localizable));
