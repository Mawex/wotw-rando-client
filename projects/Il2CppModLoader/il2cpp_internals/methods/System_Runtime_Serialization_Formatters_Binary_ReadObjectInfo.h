...
namespace app::methods::System_Runtime_Serialization_Formatters_Binary::ReadObjectInfo {
...
IL2CPP_REGISTER_METHOD(0x01D9EBD0, ReadObjectInfo *, Create_1, (app::Type * object_type, app::ISurrogateSelector * surrogate_selector, app::StreamingContext context, app::ObjectManager * object_manager, app::SerObjectInfoInit * ser_object_info_init, app::IFormatterConverter * converter, bool b_simple_assembly));
...
IL2CPP_REGISTER_METHOD(0x01D9F820, MemberInfo_1 *, GetMemberInfo, (app::ReadObjectInfo * this_ptr, app::String * name));
IL2CPP_REGISTER_METHODINFO(0x04745218, ReadObjectInfo_GetMemberInfo__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01D9FA70, Type *, GetType, (app::ReadObjectInfo * this_ptr, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x01DA02C0, Type__Array *, GetMemberTypes, (app::ReadObjectInfo * this_ptr, app::String__Array * in_member_names, app::Type * object_type));
IL2CPP_REGISTER_METHODINFO(0x04700D50, ReadObjectInfo_GetMemberTypes__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01DA0A60, Type *, GetMemberType, (app::ReadObjectInfo * this_ptr, app::MemberInfo_1 * obj_member));
IL2CPP_REGISTER_METHODINFO(0x04753258, ReadObjectInfo_GetMemberType__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01DA0CE0, ReadObjectInfo *, GetObjectInfo, (app::SerObjectInfoInit * ser_object_info_init));
}
