...
namespace app::methods::RootMotion_FinalIK::Finger {
...
IL2CPP_REGISTER_METHOD(0x020615B0, Vector3, get_IKPosition, (app::Finger * this_ptr));
IL2CPP_REGISTER_METHOD(0x020615E0, void, set_IKPosition, (app::Finger * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x02061610, Quaternion, get_IKRotation, (app::Finger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004FBE40, void, __ctor, (app::Finger * this_ptr));
}
