...
namespace app::methods::System_Runtime_Serialization::LongList {
IL2CPP_REGISTER_METHOD(0x01ED5410, void, __ctor_1, (app::LongList * this_ptr));
IL2CPP_REGISTER_METHOD(0x01ED54B0, void, __ctor_2, (app::LongList * this_ptr, int32_t starting_size));
