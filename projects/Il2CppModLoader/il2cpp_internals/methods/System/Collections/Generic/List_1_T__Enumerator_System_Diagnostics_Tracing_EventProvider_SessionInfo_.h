...
namespace app::methods::System::Collections::Generic::List_1_T__Enumerator_System_Diagnostics_Tracing_EventProvider_SessionInfo_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0014CC40, void, __ctor, (app::List_1_T_Enumerator_System_Diagnostics_Tracing_EventProvider_SessionInfo___Boxed * this_ptr, app::List_1_System_Diagnostics_Tracing_EventProvider_SessionInfo_ * list));
