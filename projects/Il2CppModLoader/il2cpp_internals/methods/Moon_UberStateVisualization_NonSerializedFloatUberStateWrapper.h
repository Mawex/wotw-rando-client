...
namespace app::methods::Moon_UberStateVisualization::NonSerializedFloatUberStateWrapper {
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::NonSerializedFloatUberStateWrapper * this_ptr, app::FloatUberState * state));
