...
namespace app::methods::Mono_Security_Cryptography::DSAManaged {
IL2CPP_REGISTER_METHOD(0x025C92E0, void, __ctor, (app::DSAManaged * this_ptr, int32_t dw_key_size));
...
IL2CPP_REGISTER_METHOD(0x025CA2C0, RandomNumberGenerator *, get_Random, (app::DSAManaged * this_ptr));
IL2CPP_REGISTER_METHOD(0x025CA2F0, int32_t, get_KeySize, (app::DSAManaged * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, String *, get_KeyExchangeAlgorithm, (app::DSAManaged * this_ptr));
IL2CPP_REGISTER_METHOD(0x025CA320, bool, get_PublicOnly, (app::DSAManaged * this_ptr));
IL2CPP_REGISTER_METHOD(0x025CA3D0, String *, get_SignatureAlgorithm, (app::DSAManaged * this_ptr));
IL2CPP_REGISTER_METHOD(0x025CA450, Byte__Array *, NormalizeArray, (app::DSAManaged * this_ptr, app::Byte__Array * array));
IL2CPP_REGISTER_METHOD(0x025CA540, DSAParameters, ExportParameters, (app::DSAManaged * this_ptr, bool include_private_parameters));
...
IL2CPP_REGISTER_METHOD(0x025CB1E0, Byte__Array *, CreateSignature, (app::DSAManaged * this_ptr, app::Byte__Array * rgb_hash));
