...
IL2CPP_REGISTER_METHOD(0x017644B0, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossShriekArena2Behaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0177DB10, Enum__Array *, GetEntries, (app::PetrifiedOwlBossShriekArena2Behaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x0177DBB0, Enum, Evaluate, (app::PetrifiedOwlBossShriekArena2Behaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_ShouldSkip, (app::PetrifiedOwlBossShriekArena2Behaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x017657C0, void, __ctor, (app::PetrifiedOwlBossShriekArena2Behaviour * this_ptr));
}
