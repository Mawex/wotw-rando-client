...
IL2CPP_REGISTER_METHOD(0x006DFDA0, Renderer *, get_Renderer, (app::SeinController3D * this_ptr));
IL2CPP_REGISTER_METHOD(0x006DFF40, Renderer *, get_AlphaBlendedRenderer, (app::SeinController3D * this_ptr));
IL2CPP_REGISTER_METHOD(0x006E00E0, float, get_CurrentRootAngle, (app::SeinController3D * this_ptr));
IL2CPP_REGISTER_METHOD(0x006E00F0, PerspectiveRotationAdjustment *, get_PerspectiveAdjustment, (app::SeinController3D * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006D64E0, OriHeadIk *, get_OriHeadIk, (app::SeinController3D * this_ptr));
IL2CPP_REGISTER_METHOD(0x006E03A0, void, set_OriHeadIk, (app::SeinController3D * this_ptr, app::OriHeadIk * value));
IL2CPP_REGISTER_METHOD(0x002FBB40, GameObject *, get_OpaqueObject, (app::SeinController3D * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB60, GameObject *, get_AlphaBlendObject, (app::SeinController3D * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006E1F50, void, __ctor, (app::SeinController3D * this_ptr));
