...
IL2CPP_REGISTER_METHOD(0x00244140, void, __ctor, (app::CapsulecastCommand__Boxed * this_ptr, app::Vector3 p1, app::Vector3 p2, float radius, app::Vector3 direction, float distance, int32_t layer_mask));
IL2CPP_REGISTER_METHOD(0x001EB5F0, Vector3, get_point1, (app::CapsulecastCommand__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001EB610, void, set_point1, (app::CapsulecastCommand__Boxed * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x001EB680, Vector3, get_point2, (app::CapsulecastCommand__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002441A0, Vector3, get_direction, (app::CapsulecastCommand__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0309E4C0, JobHandle, ScheduleBatch, (app::NativeArray_1_UnityEngine_CapsulecastCommand_ commands, int32_t cmd_count, app::NativeArray_1_UnityEngine_RaycastHit_ results, int32_t result_count, int32_t min_commands_per_job, app::JobHandle depends_on));
IL2CPP_REGISTER_METHOD(0x0309E670, JobHandle, ScheduleCapsulecastBatch, (app::JobsUtility_JobScheduleParameters * parameters, app::Void * commands, int32_t command_len, app::Void * result, int32_t result_len, int32_t min_commands_per_job));
