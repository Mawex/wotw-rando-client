...
namespace app::methods::KwolokBossTendrilStrikeBehaviour_KwolokBossTendrilStrikeState {
    IL2CPP_REGISTER_METHOD(0x012F0660, void, __ctor, (app::KwolokBossTendrilStrikeBehaviour_KwolokBossTendrilStrikeState * this_ptr, app::KwolokBossTendrilStrikeBehaviour * behaviour));
