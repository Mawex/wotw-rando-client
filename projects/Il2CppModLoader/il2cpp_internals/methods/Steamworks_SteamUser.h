...
IL2CPP_REGISTER_METHOD(0x0279D8F0, HSteamUser, GetHSteamUser, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0279D9A0, bool, BLoggedOn, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0279DA50, CSteamID, GetSteamID, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x0279E200, void, StartVoiceRecording, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0279E2B0, void, StopVoiceRecording, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x0279E720, uint32_t, GetVoiceOptimalSampleRate, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x0279EC60, bool, BIsBehindNAT, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x0279F100, int32_t, GetPlayerSteamLevel, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0279F1B0, SteamAPICall_t, RequestStoreAuthURL, (String * pchRedirectURL));
IL2CPP_REGISTER_METHOD(0x0279F4B0, bool, BIsPhoneVerified, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0279F560, bool, BIsTwoFactorEnabled, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0279F610, bool, BIsPhoneIdentifying, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0279F6C0, bool, BIsPhoneRequiringVerification, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0279F770, SteamAPICall_t, GetMarketEligibility, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0279F8A0, SteamAPICall_t, GetDurationControl, (MethodInfo * method));
}
