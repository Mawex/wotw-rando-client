...
IL2CPP_REGISTER_METHOD(0x002FBCC0, EntityDamageEvent *, get_DamageEvent, (app::GasballHitReactionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420230, BehaviourStatus__Enum, OnExecuteTask, (app::GasballHitReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00420740, Vector3, ProcessKickback, (app::GasballHitReactionBehaviour * this_ptr, app::Damage * damage, float multiplier));
...
IL2CPP_REGISTER_METHOD(0x004209B0, void, __ctor, (app::GasballHitReactionBehaviour * this_ptr));
}
