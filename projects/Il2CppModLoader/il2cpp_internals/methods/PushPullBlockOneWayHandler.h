...
IL2CPP_REGISTER_METHOD(0x00E844A0, Rigidbody *, get_Body, (app::PushPullBlockOneWayHandler * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E848F0, void, __ctor, (app::PushPullBlockOneWayHandler * this_ptr));
}
