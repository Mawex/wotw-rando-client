...
namespace app::methods::RootMotion_Demos::VRInteractionController {
IL2CPP_REGISTER_METHOD(0x002FB9B0, InteractionSystem *, get_interactionSystem, (app::VRInteractionController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9D0, InteractionTrigger *, get_currentTrigger, (app::VRInteractionController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008A2C20, void, __ctor, (app::VRInteractionController * this_ptr));
}
