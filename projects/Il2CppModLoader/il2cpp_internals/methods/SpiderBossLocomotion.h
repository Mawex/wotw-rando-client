...
IL2CPP_REGISTER_METHOD(0x0049F2B0, Transform *, get_FeetTransform, (app::SpiderBossLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x011B46D0, Vector3, get_FeetPosition, (app::SpiderBossLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E5BF60, EntityWeightData_EntityWeight__Enum, get_Weight, (app::SpiderBossLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011B4800, Vector2, get_GravityDirection, (app::SpiderBossLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x011B4890, Vector3, get_AdditiveLocalVelocity, (app::SpiderBossLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005B0220, EntityLocomotionTask *, get_DefaultFSMState, (app::SpiderBossLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011B4E00, EntityLocomotionTask *, GetNextBehaviour, (app::SpiderBossLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011B55F0, Vector2, get_LookDirection, (app::SpiderBossLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011B5660, void, __ctor, (app::SpiderBossLocomotion * this_ptr));
}
