...
namespace app::methods::PlayerInput {
    ...
    IL2CPP_REGISTER_METHOD(0x014168F0, void, ApplyDeadzone, (app::PlayerInput * this_ptr, app::float* x, app::float* y, float dead_zone));
    ...
    IL2CPP_REGISTER_METHOD(0x01419290, void, __ctor, (app::PlayerInput * this_ptr));
