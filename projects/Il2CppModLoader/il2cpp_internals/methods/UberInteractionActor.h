...
IL2CPP_REGISTER_METHOD(0x002FBBA0, UberWaterControl *, get_Water, (app::UberInteractionActor * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x013F73D0, void, __ctor, (app::UberInteractionActor * this_ptr));
}
