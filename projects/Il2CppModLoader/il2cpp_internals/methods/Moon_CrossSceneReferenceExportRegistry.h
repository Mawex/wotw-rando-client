...
IL2CPP_REGISTER_METHOD(0x002FB990, List_1_Moon_CrossSceneReferenceExportData_ *, get_ExportedObjects, (app::CrossSceneReferenceExportRegistry * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::CrossSceneReferenceExportRegistry * this_ptr));
}
