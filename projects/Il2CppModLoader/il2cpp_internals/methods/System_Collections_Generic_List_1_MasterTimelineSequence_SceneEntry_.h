...
namespace app::methods::System_Collections_Generic::List_1_MasterTimelineSequence_SceneEntry_ {
...
IL2CPP_REGISTER_METHOD(0x025EFC50, MasterTimelineSequence_SceneEntry *, get_Item, (app::List_1_MasterTimelineSequence_SceneEntry_ * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x04785500, List_1_MasterTimelineSequence_SceneEntry__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_MasterTimelineSequence_SceneEntry_, GetEnumerator, (app::List_1_MasterTimelineSequence_SceneEntry_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_MasterTimelineSequence_SceneEntry_ * this_ptr));
