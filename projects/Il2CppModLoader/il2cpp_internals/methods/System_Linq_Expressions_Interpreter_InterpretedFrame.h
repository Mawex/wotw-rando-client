...
namespace app::methods::System_Linq_Expressions_Interpreter::InterpretedFrame {
IL2CPP_REGISTER_METHOD(0x01CE1270, void, __ctor, (app::InterpretedFrame * this_ptr, app::Interpreter * interpreter, app::IStrongBox__Array * closure));
IL2CPP_REGISTER_METHOD(0x01CE1390, DebugInfo *, GetDebugInfo, (app::InterpretedFrame * this_ptr, int32_t instruction_index));
IL2CPP_REGISTER_METHOD(0x01CE1450, String *, get_Name, (app::InterpretedFrame * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01CE1B10, Object *, Pop, (app::InterpretedFrame * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CE1B60, void, SetStackDepth, (app::InterpretedFrame * this_ptr, int32_t depth));
IL2CPP_REGISTER_METHOD(0x01CE1B80, Object *, Peek, (app::InterpretedFrame * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CE1BC0, void, Dup, (app::InterpretedFrame * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, InterpretedFrame *, get_Parent, (app::InterpretedFrame * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CE1C80, IEnumerable_1_System_Linq_Expressions_Interpreter_InterpretedFrameInfo_ *, GetStackTraceDebugInfo, (app::InterpretedFrame * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CE1E10, void, SaveTraceToException, (app::InterpretedFrame * this_ptr, app::Exception * exception));
IL2CPP_REGISTER_METHOD(0x01CE20E0, InterpretedFrame *, Enter, (app::InterpretedFrame * this_ptr));
