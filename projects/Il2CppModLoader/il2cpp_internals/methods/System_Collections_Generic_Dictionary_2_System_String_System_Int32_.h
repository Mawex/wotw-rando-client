...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_String_System_Int32_ {
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor_1, (app::Dictionary_2_System_String_System_Int32_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BCDF80, bool, TryGetValue, (app::Dictionary_2_System_String_System_Int32_ * this_ptr, app::String * key, app::int32_t * value));
...
IL2CPP_REGISTER_METHOD(0x02259DF0, void, __ctor_2, (app::Dictionary_2_System_String_System_Int32_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHODINFO(0x04736DD8, Dictionary_2_System_String_System_Int32___ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0283AC50, void, __ctor_3, (app::Dictionary_2_System_String_System_Int32_ * this_ptr, app::IEqualityComparer_1_System_String_ * comparer));
...
IL2CPP_REGISTER_METHOD(0x0283B2B0, Dictionary_2_TKey_TValue_KeyCollection_System_String_System_Int32_ *, get_Keys, (app::Dictionary_2_System_String_System_Int32_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0470A0F8, Dictionary_2_System_String_System_Int32__get_Keys__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02BA5400, Dictionary_2_TKey_TValue_Enumerator_System_String_System_Int32_, GetEnumerator, (app::Dictionary_2_System_String_System_Int32_ * this_ptr));
