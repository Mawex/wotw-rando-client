...
namespace app::methods::System_ComponentModel::EventDescriptorCollection {
IL2CPP_REGISTER_METHOD(0x01FE9E20, void, __ctor_1, (app::EventDescriptorCollection * this_ptr, app::EventDescriptor_1__Array * events));
IL2CPP_REGISTER_METHOD(0x01FE9EE0, void, __ctor_2, (app::EventDescriptorCollection * this_ptr, app::EventDescriptor_1__Array * events, bool read_only));
IL2CPP_REGISTER_METHOD(0x01FE9F10, void, __ctor_3, (app::EventDescriptorCollection * this_ptr, app::EventDescriptor_1__Array * events, int32_t event_count, app::String__Array * named_sort, app::IComparer * comparer));
IL2CPP_REGISTER_METHOD(0x005C3FF0, int32_t, get_Count, (app::EventDescriptorCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x01FEA090, EventDescriptor_1 *, get_Item_1, (app::EventDescriptorCollection * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x0478CDA8, EventDescriptorCollection_get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01FEA180, EventDescriptor_1 *, get_Item_2, (app::EventDescriptorCollection * this_ptr, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x01FEA620, EventDescriptor_1 *, Find, (app::EventDescriptorCollection * this_ptr, app::String * name, bool ignore_case));
...
IL2CPP_REGISTER_METHOD(0x01FEAD10, IEnumerator *, GetEnumerator, (app::EventDescriptorCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x01FEAEA0, EventDescriptorCollection *, Sort_1, (app::EventDescriptorCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x01FEB020, EventDescriptorCollection *, Sort_2, (app::EventDescriptorCollection * this_ptr, app::String__Array * names));
IL2CPP_REGISTER_METHOD(0x01FEB1A0, EventDescriptorCollection *, Sort_3, (app::EventDescriptorCollection * this_ptr, app::String__Array * names, app::IComparer * comparer));
IL2CPP_REGISTER_METHOD(0x01FEB320, EventDescriptorCollection *, Sort_4, (app::EventDescriptorCollection * this_ptr, app::IComparer * comparer));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, Object *, ICollection_get_SyncRoot, (app::EventDescriptorCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x01FEB9C0, IEnumerator *, IEnumerable_GetEnumerator, (app::EventDescriptorCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x01701410, Object *, IList_get_Item, (app::EventDescriptorCollection * this_ptr, int32_t index));
