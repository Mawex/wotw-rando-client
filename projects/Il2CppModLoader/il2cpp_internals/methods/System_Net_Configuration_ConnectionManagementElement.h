...
namespace app::methods::System_Net_Configuration::ConnectionManagementElement {
IL2CPP_REGISTER_METHOD(0x02018890, void, __ctor_1, (app::ConnectionManagementElement * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04798160, ConnectionManagementElement__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020188C0, void, __ctor_2, (app::ConnectionManagementElement * this_ptr, app::String * address, int32_t max_connection));
IL2CPP_REGISTER_METHODINFO(0x0475F528, ConnectionManagementElement__ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020188F0, String *, get_Address, (app::ConnectionManagementElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020189B0, ConfigurationPropertyCollection *, get_Properties, (app::ConnectionManagementElement * this_ptr));
