...
namespace app::methods::PlayFab_Pipeline::OneDSEventPipelineSettings {
...
IL2CPP_REGISTER_METHOD(0x002FB930, TimeSpan, get_BatchFillTimeout, (app::OneDSEventPipelineSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x017B3C40, void, __ctor, (app::OneDSEventPipelineSettings * this_ptr));
