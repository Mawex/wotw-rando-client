...
IL2CPP_REGISTER_METHOD(0x00CCB760, BehaviourStatus__Enum, OnExecute, (app::CrabClawAttackBehaviourNew * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00CCC570, void, __ctor, (app::CrabClawAttackBehaviourNew * this_ptr));
