...
namespace app::methods::System_Collections_Generic::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D525D0, List_1_T_Enumerator_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_, GetEnumerator, (app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02D50E10, void, __ctor_3, (app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ * this_ptr, app::IEnumerable_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02D512A0, Object *, ICollection_get_SyncRoot, (app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D51400, DynamicDataResolver_SerializedDynamicDataLinkItem, get_Item, (app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02D515D0, Object *, IList_get_Item, (app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ *, AsReadOnly, (app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D51F20, DynamicDataResolver_SerializedDynamicDataLinkItem, Find, (app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ * this_ptr, app::Predicate_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ * match));
IL2CPP_REGISTER_METHOD(0x02D52080, List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ *, FindAll, (app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ * this_ptr, app::Predicate_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ * match));
...
IL2CPP_REGISTER_METHOD(0x02D52630, IEnumerator_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D52630, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ *, GetRange, (app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, DynamicDataResolver_SerializedDynamicDataLinkItem__Array *, ToArray, (app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ * this_ptr));
