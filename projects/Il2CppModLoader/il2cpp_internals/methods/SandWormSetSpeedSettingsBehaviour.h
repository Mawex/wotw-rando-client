...
IL2CPP_REGISTER_METHOD(0x00417920, BehaviourStatus__Enum, OnExecute, (app::SandWormSetSpeedSettingsBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00C26B00, void, __ctor, (app::SandWormSetSpeedSettingsBehaviour * this_ptr));
}
