...
namespace app::methods::System_Xml::SecureStringHasher {
IL2CPP_REGISTER_METHOD(0x01C8A800, void, __ctor, (app::SecureStringHasher * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01C8AB30, SecureStringHasher_HashCodeOfStringDelegate *, GetHashCodeDelegate, ());
}
