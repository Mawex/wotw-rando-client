...
namespace app::methods::UnityEngine_UI_Collections::IndexedSet_1_UnityEngine_UI_IClipper_ {
IL2CPP_REGISTER_METHOD(0x02ACD120, void, __ctor, (app::IndexedSet_1_UnityEngine_UI_IClipper_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0478C458, IndexedSet_1_UnityEngine_UI_IClipper___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02ACD8A0, IClipper *, get_Item, (app::IndexedSet_1_UnityEngine_UI_IClipper_ * this_ptr, int32_t index));
