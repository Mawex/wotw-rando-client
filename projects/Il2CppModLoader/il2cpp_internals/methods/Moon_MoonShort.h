...
IL2CPP_REGISTER_METHOD(0x02F98530, CrossSceneReferenceId, get_CrossSceneReferenceId, (app::MoonShort * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F915A0, void, __ctor, (app::MoonShort * this_ptr, int16_t static_value));
...
IL2CPP_REGISTER_METHOD(0x02F98D90, bool, TryResolve, (app::MoonShort * this_ptr, app::int16_t * value, app::IMoonResolverContext * context));
...
IL2CPP_REGISTER_METHOD(0x00C3DD30, MoonTypeData, GetTypeData, (app::MoonShort * this_ptr));
}
