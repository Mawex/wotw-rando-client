...
namespace app::methods::CartJump {
    ...
    IL2CPP_REGISTER_METHOD(0x00B39300, CharacterPlatformMovement*, get_PlatformMovement, (app::CartJump * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00B393D0, CharacterSpriteMirror*, get_CharacterSpriteMirror, (app::CartJump * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00B3A3C0, void, __ctor, (app::CartJump * this_ptr));
} // namespace app::methods::CartJump
