...
namespace app::methods::System_Linq_Expressions_Interpreter::PopInstruction {
...
IL2CPP_REGISTER_METHOD(0x0240CF20, String *, get_InstructionName, (app::PopInstruction * this_ptr));
