...
IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::LegacyAttackableSwitch * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0057A5A0, SuspendableMask__Enum, get_Mask, (app::LegacyAttackableSwitch * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_BowAutoTargetPosition, (app::LegacyAttackableSwitch * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBCA0, IDamageReciever__Array *, get_AffectedReceivers, (app::LegacyAttackableSwitch * this_ptr));
IL2CPP_REGISTER_METHOD(0x015CE600, void, __ctor, (app::LegacyAttackableSwitch * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::LegacyAttackableSwitch * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::LegacyAttackableSwitch * this_ptr));
}
