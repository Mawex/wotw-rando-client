...
IL2CPP_REGISTER_METHOD(0x00C0C5C0, BehaviourStatus__Enum, OnExecuteTask, (app::SandWormDeathBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00C0C910, void, OnExitTask, (app::SandWormDeathBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00C0C940, void, __ctor, (app::SandWormDeathBehaviour * this_ptr));
}
