...
IL2CPP_REGISTER_METHOD(0x00EE3AD0, Vector3, get_CameraPosition, (app::CameraController_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006260E0, Vector3, get_Position, (app::CameraController_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x016853F0, Quaternion, get_Rotation, (app::CameraController_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01685620, Plane__Array *, get_FrustrumPlanes, (app::CameraController_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01686F30, void, __ctor, (app::CameraController_1 * this_ptr));
}
