...
namespace app::methods::SeinGlide {
    ...
    IL2CPP_REGISTER_METHOD(0x006E4240, CharacterGravity*, get_CharacterGravity, (app::SeinGlide * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005D06F0, CharacterLeftRightMovement*, get_CharacterLeftRightMovement, (app::SeinGlide * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement*, get_PlatformMovement, (app::SeinGlide * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00AE3580, MoonAnimator*, get_Leaf, (app::SeinGlide * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00AE5CF0, SeinGlidePuppet*, get_Puppet, (app::SeinGlide * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00AE6150, void, __ctor, (app::SeinGlide * this_ptr));
} // namespace app::methods::SeinGlide
