...
IL2CPP_REGISTER_METHOD(0x02720AC0, Transform *, Resolve, (app::MoonReference_1_UnityEngine_Transform_ * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x04715010, MoonReference_1_UnityEngine_Transform__Resolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02720EB0, Transform *, SafeResolve, (app::MoonReference_1_UnityEngine_Transform_ * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x04794D68, MoonReference_1_UnityEngine_Transform__SafeResolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027205B0, void, __ctor, (app::MoonReference_1_UnityEngine_Transform_ * this_ptr, app::Transform * reference));
