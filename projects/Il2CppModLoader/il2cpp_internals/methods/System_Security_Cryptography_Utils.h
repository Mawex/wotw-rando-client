...
namespace app::methods::System_Security_Cryptography::Utils {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x01E14140, RNGCryptoServiceProvider *, get_StaticRandomNumberGenerator, ());
IL2CPP_REGISTER_METHOD(0x01E14330, Byte__Array *, GenerateRandom, (int32_t key_size));
IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, HasAlgorithm, (int32_t dw_calg, int32_t dw_key_size));
IL2CPP_REGISTER_METHOD(0x01E14400, String *, DiscardWhiteSpaces_1, (app::String * input_buffer));
IL2CPP_REGISTER_METHOD(0x01E144C0, String *, DiscardWhiteSpaces_2, (app::String * input_buffer, int32_t input_offset, int32_t input_count));
IL2CPP_REGISTER_METHOD(0x01E14690, int32_t, ConvertByteArrayToInt, (app::Byte__Array * input));
IL2CPP_REGISTER_METHOD(0x01E146F0, Byte__Array *, ConvertIntToByteArray_1, (int32_t dw_input));
IL2CPP_REGISTER_METHOD(0x01E14890, void, ConvertIntToByteArray_2, (uint32_t dw_input, app::Byte__Array * * counter));
IL2CPP_REGISTER_METHOD(0x01E14910, Byte__Array *, FixupKeyParity, (app::Byte__Array * key));
IL2CPP_REGISTER_METHOD(0x01E14A60, void, DWORDFromLittleEndian, (app::uint32_t * x, int32_t digits, app::uint8_t * block));
IL2CPP_REGISTER_METHOD(0x01E14AC0, void, DWORDToLittleEndian, (app::Byte__Array * block, app::UInt32__Array * x, int32_t digits));
IL2CPP_REGISTER_METHOD(0x01E14C30, void, DWORDFromBigEndian, (app::uint32_t * x, int32_t digits, app::uint8_t * block));
IL2CPP_REGISTER_METHOD(0x01E14C90, void, DWORDToBigEndian, (app::Byte__Array * block, app::UInt32__Array * x, int32_t digits));
IL2CPP_REGISTER_METHOD(0x01E14E00, void, QuadWordFromBigEndian, (app::uint64_t * x, int32_t digits, app::uint8_t * block));
...
IL2CPP_REGISTER_METHOD(0x01E15230, Byte__Array *, RsaOaepEncrypt, (app::RSA * rsa, app::HashAlgorithm * hash, app::PKCS1MaskGenerationMethod * mgf, app::RandomNumberGenerator * rng, app::Byte__Array * data));
IL2CPP_REGISTER_METHOD(0x01E15300, Byte__Array *, RsaOaepDecrypt, (app::RSA * rsa, app::HashAlgorithm * hash, app::PKCS1MaskGenerationMethod * mgf, app::Byte__Array * encrypted_data));
IL2CPP_REGISTER_METHODINFO(0x04768AD8, Utils_RsaOaepDecrypt__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E15400, Byte__Array *, RsaPkcs1Padding, (app::RSA * rsa, app::Byte__Array * oid, app::Byte__Array * hash));
...
IL2CPP_REGISTER_METHOD(0x01E158F0, HashAlgorithmName, OidToHashAlgorithmName, (app::String * oid));
