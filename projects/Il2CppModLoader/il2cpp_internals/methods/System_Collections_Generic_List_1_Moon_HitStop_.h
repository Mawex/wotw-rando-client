...
namespace app::methods::System_Collections_Generic::List_1_Moon_HitStop_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_Moon_HitStop_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04794698, List_1_Moon_HitStop___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EFC50, HitStop *, get_Item, (app::List_1_Moon_HitStop_ * this_ptr, int32_t index));
