...
IL2CPP_REGISTER_METHOD(0x011202C0, Transform *, get_NpcTarget, (app::NPCCameraTransition * this_ptr));
IL2CPP_REGISTER_METHOD(0x011205C0, Transform *, get_OpenStoreTarget, (app::NPCCameraTransition * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003FDCE0, NPCCameraBlendState__Enum, get_State, (app::NPCCameraTransition * this_ptr));
IL2CPP_REGISTER_METHOD(0x011209D0, Vector3, Position, (app::NPCCameraTransition * this_ptr, app::NPCCameraTargetPositionType__Enum target));
IL2CPP_REGISTER_METHOD(0x01120D40, Vector3, get_TargetPosition, (app::NPCCameraTransition * this_ptr));
IL2CPP_REGISTER_METHOD(0x01120D80, Vector3, get_CurrentPosition, (app::NPCCameraTransition * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01121100, CameraPuppetController *, get_Puppet, (app::NPCCameraTransition * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00597B10, UpdateType__Enum, get_UpdateType, (app::NPCCameraTransition * this_ptr));
IL2CPP_REGISTER_METHOD(0x011218C0, void, OnUpdate, (app::NPCCameraTransition * this_ptr, float delta_time));
IL2CPP_REGISTER_METHOD(0x01121D90, void, __ctor, (app::NPCCameraTransition * this_ptr));
}
