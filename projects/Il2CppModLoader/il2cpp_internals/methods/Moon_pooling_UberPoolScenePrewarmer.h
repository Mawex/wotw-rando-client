...
namespace app::methods::Moon_pooling::UberPoolScenePrewarmer {
...
IL2CPP_REGISTER_METHOD(0x00597B10, UpdateType__Enum, get_UpdateType, (app::UberPoolScenePrewarmer * this_ptr));
IL2CPP_REGISTER_METHOD(0x00F31510, void, OnUpdate, (app::UberPoolScenePrewarmer * this_ptr, float delta));
IL2CPP_REGISTER_METHOD(0x00F31620, void, __ctor, (app::UberPoolScenePrewarmer * this_ptr));
}
