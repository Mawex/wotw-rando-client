...
namespace app::methods::Mono_Globalization_Unicode::MSCompatUnicodeTable {
...
IL2CPP_REGISTER_METHOD(0x023BBD20, uint32_t, UInt32FromBytePtr, (app::uint8_t * raw, uint32_t idx));
