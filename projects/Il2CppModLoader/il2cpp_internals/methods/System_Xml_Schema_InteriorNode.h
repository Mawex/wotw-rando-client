...
namespace app::methods::System_Xml_Schema::InteriorNode {
IL2CPP_REGISTER_METHOD(0x002FA280, SyntaxTreeNode *, get_LeftChild, (app::InteriorNode * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_LeftChild, (app::InteriorNode * this_ptr, app::SyntaxTreeNode * value));
IL2CPP_REGISTER_METHOD(0x002FB930, SyntaxTreeNode *, get_RightChild, (app::InteriorNode * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::InteriorNode * this_ptr));
}
