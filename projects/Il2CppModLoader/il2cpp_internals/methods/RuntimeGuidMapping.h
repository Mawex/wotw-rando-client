...
IL2CPP_REGISTER_METHOD(0x0271A460, Byte__Array *, ReadFileWithWWW, (app::RuntimeGuidMapping * this_ptr, app::String * file_path));
...
IL2CPP_REGISTER_METHOD(0x0271AA30, bool, TryGet, (app::RuntimeGuidMapping * this_ptr, uint32_t hash, app::Byte__Array * guid_bytes, app::uint32_t * result));
...
IL2CPP_REGISTER_METHOD(0x0271AF20, void, __ctor, (app::RuntimeGuidMapping * this_ptr));
}
