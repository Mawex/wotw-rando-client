...
IL2CPP_REGISTER_METHOD(0x00D4B520, String *, GetNiceName, (app::BreakPhysicsSystemAction * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9B0, GameObject *, GetDynamicGraphicTarget, (app::BreakPhysicsSystemAction * this_ptr));
IL2CPP_REGISTER_METHOD(0x0087A2D0, void, __ctor, (app::BreakPhysicsSystemAction * this_ptr));
}
