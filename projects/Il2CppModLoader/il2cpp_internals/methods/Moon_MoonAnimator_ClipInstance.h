...
IL2CPP_REGISTER_METHOD(0x021142B0, Playable, get_Playable, (app::MoonAnimator_ClipInstance * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x021147D0, AnimationClip *, get_Clip, (app::MoonAnimator_ClipInstance * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, MoonAnimator_AnimationInstanceType__Enum, get_Type, (app::MoonAnimator_ClipInstance * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MoonAnimator_ClipInstance * this_ptr));
}
