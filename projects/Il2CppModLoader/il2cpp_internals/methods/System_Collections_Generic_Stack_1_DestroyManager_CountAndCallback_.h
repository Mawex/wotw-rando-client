...
namespace app::methods::System_Collections_Generic::Stack_1_DestroyManager_CountAndCallback_ {
IL2CPP_REGISTER_METHOD(0x02CF78E0, void, __ctor, (app::Stack_1_DestroyManager_CountAndCallback_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x02CF7F90, DestroyManager_CountAndCallback *, Pop, (app::Stack_1_DestroyManager_CountAndCallback_ * this_ptr));
