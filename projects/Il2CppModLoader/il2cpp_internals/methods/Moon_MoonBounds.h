...
IL2CPP_REGISTER_METHOD(0x02F8FB80, CrossSceneReferenceId, get_CrossSceneReferenceId, (app::MoonBounds * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F8FD60, void, __ctor, (app::MoonBounds * this_ptr, app::Bounds static_value));
IL2CPP_REGISTER_METHOD(0x02F8FD90, Bounds, Resolve, (app::MoonBounds * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x04755098, MoonBounds_Resolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02F8FFA0, Bounds, SafeResolve, (app::MoonBounds * this_ptr, app::IMoonResolverContext * context));
...
IL2CPP_REGISTER_METHOD(0x00CB5CB0, MoonTypeData, GetTypeData, (app::MoonBounds * this_ptr));
}
