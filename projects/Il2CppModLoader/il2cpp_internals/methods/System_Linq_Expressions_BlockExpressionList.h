...
namespace app::methods::System_Linq_Expressions::BlockExpressionList {
IL2CPP_REGISTER_METHOD(0x0058DA40, void, __ctor, (app::BlockExpressionList * this_ptr, app::BlockExpression * provider, app::Expression * arg0));
...
IL2CPP_REGISTER_METHOD(0x01F9F770, Expression *, get_Item, (app::BlockExpressionList * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x01F9FBE0, IEnumerator_1_System_Linq_Expressions_Expression_ *, GetEnumerator, (app::BlockExpressionList * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F9FBE0, IEnumerator *, IEnumerable_GetEnumerator, (app::BlockExpressionList * this_ptr));
}
