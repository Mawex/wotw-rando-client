...
IL2CPP_REGISTER_METHOD(0x00A3DB30, LegacyTimelineSequence_SequenceEntry *, AddEntry, (app::LegacyTimelineSequence * this_ptr, app::BaseAnimator * animator, float start_time));
...
IL2CPP_REGISTER_METHOD(0x00A3E640, LegacyTimelineSequence_SequenceEntry *, DuplicateEntry, (app::LegacyTimelineSequence * this_ptr, app::LegacyTimelineSequence_SequenceEntry * entry));
...
IL2CPP_REGISTER_METHOD(0x00A3EC70, void, __ctor, (app::LegacyTimelineSequence * this_ptr));
IL2CPP_REGISTER_METHOD(0x018EC8B0, LegacyTimelineSequence_SequenceEntry *, FindEntry, (app::LegacyTimelineSequence * this_ptr));
}
