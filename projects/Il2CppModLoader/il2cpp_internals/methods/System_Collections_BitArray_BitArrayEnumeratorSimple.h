...
namespace app::methods::System_Collections::BitArray_BitArrayEnumeratorSimple {
IL2CPP_REGISTER_METHOD(0x0201E7A0, void, __ctor, (app::BitArray_BitArrayEnumeratorSimple * this_ptr, app::BitArray * bitarray));
IL2CPP_REGISTER_METHOD(0x0173F610, Object *, Clone, (app::BitArray_BitArrayEnumeratorSimple * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0201E900, Object *, get_Current, (app::BitArray_BitArrayEnumeratorSimple * this_ptr));
