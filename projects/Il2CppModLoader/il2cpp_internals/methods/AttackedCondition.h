...
IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::AttackedCondition * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003FC830, SuspendableMask__Enum, get_Mask, (app::AttackedCondition * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_BowAutoTargetPosition, (app::AttackedCondition * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9F0, IDamageReciever__Array *, get_AffectedReceivers, (app::AttackedCondition * this_ptr));
IL2CPP_REGISTER_METHOD(0x00856B30, void, __ctor, (app::AttackedCondition * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::AttackedCondition * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::AttackedCondition * this_ptr));
}
