...
IL2CPP_REGISTER_METHOD(0x024E1170, Material *, get_material, (app::CameraFilterPack_Colors_HSV * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024E18C0, void, __ctor, (app::CameraFilterPack_Colors_HSV * this_ptr));
}
