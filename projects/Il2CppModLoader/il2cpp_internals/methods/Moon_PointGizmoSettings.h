...
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_Label, (app::PointGizmoSettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C3DD30, Color, get_Color, (app::PointGizmoSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005C3FF0, GizmoHandleType__Enum, get_Handle, (app::PointGizmoSettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x005C4000, void, set_Handle, (app::PointGizmoSettings * this_ptr, app::GizmoHandleType__Enum value));
IL2CPP_REGISTER_METHOD(0x00C3DD70, void, __ctor, (app::PointGizmoSettings * this_ptr, app::String * label));
}
