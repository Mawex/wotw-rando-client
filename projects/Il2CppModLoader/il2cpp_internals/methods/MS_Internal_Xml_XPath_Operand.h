...
IL2CPP_REGISTER_METHOD(0x00420230, AstNode_AstType__Enum, get_Type, (app::Operand * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FC6D0, XPathResultType__Enum, get_ReturnType, (app::Operand * this_ptr));
}
