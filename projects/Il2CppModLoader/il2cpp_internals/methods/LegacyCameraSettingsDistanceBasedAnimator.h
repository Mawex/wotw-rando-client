...
IL2CPP_REGISTER_METHOD(0x015DD330, Bounds, GetOuterBounds, (app::LegacyCameraSettingsDistanceBasedAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x015DD640, Bounds, GetInnerBounds, (app::LegacyCameraSettingsDistanceBasedAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::LegacyCameraSettingsDistanceBasedAnimator * this_ptr));
}
