...
IL2CPP_REGISTER_METHOD(0x00FB4020, String *, GetNiceName, (app::LoadFirstBuildSceneAction * this_ptr));
IL2CPP_REGISTER_METHOD(0x00FB4110, void, __ctor, (app::LoadFirstBuildSceneAction * this_ptr));
}
