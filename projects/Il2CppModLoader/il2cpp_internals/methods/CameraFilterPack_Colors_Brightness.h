...
IL2CPP_REGISTER_METHOD(0x024E0100, Material *, get_material, (app::CameraFilterPack_Colors_Brightness * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024E07E0, void, __ctor, (app::CameraFilterPack_Colors_Brightness * this_ptr));
}
