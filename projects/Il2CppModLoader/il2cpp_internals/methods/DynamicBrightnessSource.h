...
IL2CPP_REGISTER_METHOD(0x00BE8F10, Vector2, get_CameraPosition, (app::DynamicBrightnessSource * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00BE9150, Bounds, get_Bounds, (app::DynamicBrightnessSource * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_AllowCacheBounds, (app::DynamicBrightnessSource * this_ptr));
IL2CPP_REGISTER_METHOD(0x008556D0, GlobalBrightnessController_BrigthnessContributionOrder__Enum, get_BrightnessInfluceOrder, (app::DynamicBrightnessSource * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00BE9B50, void, __ctor, (app::DynamicBrightnessSource * this_ptr));
}
