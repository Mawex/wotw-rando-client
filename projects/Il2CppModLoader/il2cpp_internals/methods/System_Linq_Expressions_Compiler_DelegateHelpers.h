...
IL2CPP_REGISTER_METHOD(0x01FA1470, DelegateHelpers_TypeInfo *, NextTypeInfo, (Type * initialArg, DelegateHelpers_TypeInfo * curTypeInfo));
IL2CPP_REGISTER_METHOD(0x01FA1780, Type *, TryMakeVBStyledCallSite, (Type__Array * types));
IL2CPP_REGISTER_METHOD(0x01FA1FC0, Type *, MakeNewDelegate, (Type__Array * types));
IL2CPP_REGISTER_METHOD(0x01FA21F0, Type *, GetFuncType, (Type__Array * types));
