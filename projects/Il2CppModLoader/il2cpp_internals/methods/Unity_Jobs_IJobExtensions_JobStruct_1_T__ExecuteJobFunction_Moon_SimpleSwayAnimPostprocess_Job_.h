...
namespace app::methods::Unity_Jobs::IJobExtensions_JobStruct_1_T__ExecuteJobFunction_Moon_SimpleSwayAnimPostprocess_Job_ {
    IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::IJobExtensions_JobStruct_1_T_ExecuteJobFunction_Moon_SimpleSwayAnimPostprocess_Job_ * this_ptr, app::Object * object, void * method_1));
