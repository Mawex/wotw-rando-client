...
IL2CPP_REGISTER_METHOD(0x02F92BF0, CrossSceneReferenceId, get_CrossSceneReferenceId, (app::MoonColor32 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F92DD0, void, __ctor, (app::MoonColor32 * this_ptr, app::Color32 static_value));
IL2CPP_REGISTER_METHOD(0x02F92DF0, Color32, Resolve, (app::MoonColor32 * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x04765400, MoonColor32_Resolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02F92FD0, Color32, SafeResolve, (app::MoonColor32 * this_ptr, app::IMoonResolverContext * context));
...
IL2CPP_REGISTER_METHOD(0x00C3DD30, MoonTypeData, GetTypeData, (app::MoonColor32 * this_ptr));
}
