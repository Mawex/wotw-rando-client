...
IL2CPP_REGISTER_METHOD(0x00AFF400, IUberState__Array *, get_AffectingUberStates, (app::TorchFirePedestal * this_ptr));
IL2CPP_REGISTER_METHOD(0x00AFF480, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::TorchFirePedestal * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00AFFB00, void, __ctor, (app::TorchFirePedestal * this_ptr));
}
