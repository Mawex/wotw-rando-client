...
namespace app::methods::SeinDashNew {
    IL2CPP_REGISTER_METHOD(0x00417920, ComboMoveType__Enum, get_ComboMoveType, (app::SeinDashNew * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00420EE0, ButtonInputType__Enum, get_ButtonInputType, (app::SeinDashNew * this_ptr));
    IL2CPP_REGISTER_METHOD(0x006F40B0, void, ResetDash, (app::SeinDashNew * this_ptr, bool reset_cooldown));
    IL2CPP_REGISTER_METHOD(0x006F40D0, CharacterPlatformMovement*, get_PlatformMovement, (app::SeinDashNew * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x006F45E0, List_1_DigZone_*, get_NearbyDigZones, (app::SeinDashNew * this_ptr));
    IL2CPP_REGISTER_METHOD(0x006F4860, List_1_WaterZone_*, get_NearbyWaterZones, (app::SeinDashNew * this_ptr));
    IL2CPP_REGISTER_METHOD(0x006F4B10, DigZone*, FindClosestDiggableBody, (app::SeinDashNew * this_ptr, float prediction_time));
    IL2CPP_REGISTER_METHOD(0x006F4D70, MonoBehaviour*, FindClosestBody, (app::SeinDashNew * this_ptr, app::List_1_UnityEngine_MonoBehaviour_* zones));
    ...
    IL2CPP_REGISTER_METHOD(0x006F5350, SeinDashNewPuppet*, get_Puppet, (app::SeinDashNew * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x006FA780, void, ComputeDashDirectionAndType, (app::SeinDashNew * this_ptr, app::int32_t* dash_direction, app::bool* is_forward_dash));
    ...
    IL2CPP_REGISTER_METHOD(0x006FB7D0, IComboMove*, GetComboMove, (app::SeinDashNew * this_ptr, app::ComboInput* input));
    IL2CPP_REGISTER_METHOD(0x006FB810, List_1_Moon_ComboSystem_IComboMove_*, get_ComboMoves, (app::SeinDashNew * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x006FB830, AbilityType__Enum, get_ComboAbilityType, (app::SeinDashNew * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x006FC700, void, __ctor, (app::SeinDashNew * this_ptr));
