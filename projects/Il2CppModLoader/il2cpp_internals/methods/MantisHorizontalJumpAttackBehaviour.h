...
IL2CPP_REGISTER_METHOD(0x00A021E0, BehaviourStatus__Enum, OnExecute, (app::MantisHorizontalJumpAttackBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00A03240, Vector3, GetPositionOnSpline, (app::MantisHorizontalJumpAttackBehaviour * this_ptr, app::Vector3 p0, app::Vector3 p1, app::Vector3 p2, app::Vector3 p3, float t));
IL2CPP_REGISTER_METHOD(0x00A03470, Vector3, GetNextPositionOnPath, (app::MantisHorizontalJumpAttackBehaviour * this_ptr, app::Vector3 current_position, float x_velocity, float delta_time, app::bool * finnished_path));
...
IL2CPP_REGISTER_METHOD(0x00A03BD0, Vector3, ProcessRootMotion, (app::MantisHorizontalJumpAttackBehaviour * this_ptr, app::Vector3 motion));
...
IL2CPP_REGISTER_METHOD(0x00A04950, void, __ctor, (app::MantisHorizontalJumpAttackBehaviour * this_ptr));
}
