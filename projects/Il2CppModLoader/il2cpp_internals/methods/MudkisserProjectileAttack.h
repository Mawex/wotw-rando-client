...
IL2CPP_REGISTER_METHOD(0x00877E20, BehaviourStatus__Enum, OnExecute, (app::MudkisserProjectileAttack * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00878EB0, void, __ctor, (app::MudkisserProjectileAttack * this_ptr));
}
