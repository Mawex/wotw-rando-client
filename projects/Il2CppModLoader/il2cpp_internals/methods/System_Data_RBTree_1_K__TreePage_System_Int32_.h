...
namespace app::methods::System_Data::RBTree_1_K__TreePage_System_Int32_ {
    IL2CPP_REGISTER_METHOD(0x02FAF2F0, void, __ctor, (app::RBTree_1_K_TreePage_System_Int32_ * this_ptr, int32_t size));
