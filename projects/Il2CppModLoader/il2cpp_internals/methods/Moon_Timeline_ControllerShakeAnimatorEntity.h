...
namespace app::methods::Moon_Timeline::ControllerShakeAnimatorEntity {
...
IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::ControllerShakeAnimatorEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007639D0, bool, ApproximateEvent, (app::ControllerShakeAnimatorEntity * this_ptr, int32_t evt, app::float * time));
IL2CPP_REGISTER_METHOD(0x00763AE0, void, __ctor, (app::ControllerShakeAnimatorEntity * this_ptr));
}
