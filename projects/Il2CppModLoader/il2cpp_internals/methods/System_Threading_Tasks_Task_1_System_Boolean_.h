...
namespace app::methods::System_Threading_Tasks::Task_1_System_Boolean_ {
IL2CPP_REGISTER_METHOD(0x004C50A0, TaskAwaiter_1_System_Boolean_, GetAwaiter, (app::Task_1_System_Boolean_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0470A320, Task_1_System_Boolean__GetAwaiter__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0277E780, void, __ctor_1, (app::Task_1_System_Boolean_ * this_ptr, bool canceled, bool result, app::TaskCreationOptions__Enum creation_options, app::CancellationToken ct));
IL2CPP_REGISTER_METHODINFO(0x0472C720, Task_1_System_Boolean___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0277FBD0, ConfiguredTaskAwaitable_1_System_Boolean_, ConfigureAwait, (app::Task_1_System_Boolean_ * this_ptr, bool continue_on_captured_context));
IL2CPP_REGISTER_METHODINFO(0x0476C710, Task_1_System_Boolean__ConfigureAwait__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0277E4E0, void, __ctor_2, (app::Task_1_System_Boolean_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0277E590, void, __ctor_3, (app::Task_1_System_Boolean_ * this_ptr, app::Object * state, app::TaskCreationOptions__Enum options));
IL2CPP_REGISTER_METHOD(0x0277E660, void, __ctor_4, (app::Task_1_System_Boolean_ * this_ptr, bool result));
IL2CPP_REGISTER_METHOD(0x0277E870, void, __ctor_5, (app::Task_1_System_Boolean_ * this_ptr, app::Func_2_Object_Boolean_ * function, app::Object * state, app::CancellationToken cancellation_token, app::TaskCreationOptions__Enum creation_options));
IL2CPP_REGISTER_METHOD(0x0277E9B0, void, __ctor_6, (app::Task_1_System_Boolean_ * this_ptr, app::Func_1_Boolean_ * value_selector, app::Task * parent, app::CancellationToken cancellation_token, app::TaskCreationOptions__Enum creation_options, app::InternalTaskOptions__Enum internal_options, app::TaskScheduler * scheduler, app::StackCrawlMark__Enum * stack_mark));
IL2CPP_REGISTER_METHOD(0x0277EAE0, void, __ctor_7, (app::Task_1_System_Boolean_ * this_ptr, app::Func_1_Boolean_ * value_selector, app::Task * parent, app::CancellationToken cancellation_token, app::TaskCreationOptions__Enum creation_options, app::InternalTaskOptions__Enum internal_options, app::TaskScheduler * scheduler));
IL2CPP_REGISTER_METHODINFO(0x04790048, Task_1_System_Boolean___ctor_6__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0277EC30, void, __ctor_8, (app::Task_1_System_Boolean_ * this_ptr, app::Func_2_Object_Boolean_ * value_selector, app::Object * state, app::Task * parent, app::CancellationToken cancellation_token, app::TaskCreationOptions__Enum creation_options, app::InternalTaskOptions__Enum internal_options, app::TaskScheduler * scheduler, app::StackCrawlMark__Enum * stack_mark));
IL2CPP_REGISTER_METHOD(0x0277ED60, void, __ctor_9, (app::Task_1_System_Boolean_ * this_ptr, app::Delegate * value_selector, app::Object * state, app::Task * parent, app::CancellationToken cancellation_token, app::TaskCreationOptions__Enum creation_options, app::InternalTaskOptions__Enum internal_options, app::TaskScheduler * scheduler));
IL2CPP_REGISTER_METHODINFO(0x04769D88, Task_1_System_Boolean___ctor_8__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0277EEC0, Task_1_System_Boolean_ *, StartNew_1, (app::Task * parent, app::Func_1_Boolean_ * function, app::CancellationToken cancellation_token, app::TaskCreationOptions__Enum creation_options, app::InternalTaskOptions__Enum internal_options, app::TaskScheduler * scheduler, app::StackCrawlMark__Enum * stack_mark));
IL2CPP_REGISTER_METHODINFO(0x047560B8, Task_1_System_Boolean__StartNew__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0277F1D0, Task_1_System_Boolean_ *, StartNew_2, (app::Task * parent, app::Func_2_Object_Boolean_ * function, app::Object * state, app::CancellationToken cancellation_token, app::TaskCreationOptions__Enum creation_options, app::InternalTaskOptions__Enum internal_options, app::TaskScheduler * scheduler, app::StackCrawlMark__Enum * stack_mark));
IL2CPP_REGISTER_METHODINFO(0x047399A8, Task_1_System_Boolean__StartNew_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0277F4E0, String *, get_DebuggerDisplayResultDescription, (app::Task_1_System_Boolean_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0277F5D0, String *, get_DebuggerDisplayMethodDescription, (app::Task_1_System_Boolean_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0277FC50, Task *, ContinueWith_1, (app::Task_1_System_Boolean_ * this_ptr, app::Action_1_System_Threading_Tasks_Task_1__6 * continuation_action));
IL2CPP_REGISTER_METHOD(0x0277FD50, Task *, ContinueWith_2, (app::Task_1_System_Boolean_ * this_ptr, app::Action_1_System_Threading_Tasks_Task_1__6 * continuation_action, app::TaskScheduler * scheduler, app::CancellationToken cancellation_token, app::TaskContinuationOptions__Enum continuation_options, app::StackCrawlMark__Enum * stack_mark));
