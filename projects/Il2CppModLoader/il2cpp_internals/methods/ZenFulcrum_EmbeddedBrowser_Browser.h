...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::Browser {
...
IL2CPP_REGISTER_METHOD(0x002FBB80, INewWindowHandler *, get_NewWindowHandler, (app::Browser * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBE0, IBrowserUI *, get_UIHandler, (app::Browser * this_ptr));
IL2CPP_REGISTER_METHOD(0x01C616C0, void, set_UIHandler, (app::Browser * this_ptr, app::IBrowserUI * value));
IL2CPP_REGISTER_METHOD(0x002FBC20, CookieManager *, get_CookieManager, (app::Browser * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC30, void, set_CookieManager, (app::Browser * this_ptr, app::CookieManager * value));
IL2CPP_REGISTER_METHOD(0x002FBC80, Texture2D *, get_Texture, (app::Browser * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010744F0, String *, get_Url, (app::Browser * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01C66EB0, Vector2, get_Size, (app::Browser * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01C67A80, IPromise_1_JSONNode_ *, EvalJS, (app::Browser * this_ptr, app::String * script, app::String * script_u_r_l));
IL2CPP_REGISTER_METHOD(0x01C68270, IPromise_1_JSONNode_ *, EvalJSCSP, (app::Browser * this_ptr, app::String * script, app::String * script_u_r_l));
IL2CPP_REGISTER_METHOD(0x01C68990, void, _EvalJS, (app::Browser * this_ptr, app::String * script, app::String * script_u_r_l));
IL2CPP_REGISTER_METHOD(0x01C68A80, IPromise_1_JSONNode_ *, CallFunction, (app::Browser * this_ptr, app::String * name, app::JSONNode__Array * arguments));
...
IL2CPP_REGISTER_METHOD(0x01C6AEE0, Browser *, GetBrowser, (int32_t browser_id));
...
IL2CPP_REGISTER_METHOD(0x01C6BF00, void, CB_DisplayDialogFunc, (int32_t browser_id, app::BrowserNative_DialogType__Enum dialog_type, app::void * text_ptr, app::void * prompt_text_ptr, app::void * source_u_r_l));
...
IL2CPP_REGISTER_METHOD(0x01C6CE50, void, CB_NavStateFunc, (int32_t browser_id, bool can_go_back, bool can_go_forward, bool lodaing, app::void * url_raw));
IL2CPP_REGISTER_METHODINFO(0x04758168, Browser_CB_NavStateFunc__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01C6D210, void, CB_NewWindowFunc, (int32_t creator_browser_id, int32_t new_browser_id, app::void * url_ptr));
IL2CPP_REGISTER_METHODINFO(0x04780CB0, Browser_CB_NewWindowFunc__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01C6D5C0, void, __ctor, (app::Browser * this_ptr));
