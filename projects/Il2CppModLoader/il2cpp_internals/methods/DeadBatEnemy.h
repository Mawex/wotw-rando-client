...
namespace app::methods::DeadBatEnemy {
    ...
    IL2CPP_REGISTER_METHOD(0x003FFCE0, SuspendableMask__Enum, get_Mask, (app::DeadBatEnemy * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00DD7B60, void, __ctor, (app::DeadBatEnemy * this_ptr));
    IL2CPP_REGISTER_METHOD(0x004F4750, GameObject*, IDamageReciever_get_gameObject, (app::DeadBatEnemy * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00506170, Transform*, IDamageReciever_get_transform, (app::DeadBatEnemy * this_ptr));
} // namespace app::methods::DeadBatEnemy
