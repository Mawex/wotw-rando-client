...
namespace app::methods::System_Collections_Generic::Stack_1_System_Single_ {
IL2CPP_REGISTER_METHOD(0x0243CB70, void, __ctor_1, (app::Stack_1_System_Single_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CF8230, void, __ctor_2, (app::Stack_1_System_Single_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x02CF8360, Object *, ICollection_get_SyncRoot, (app::Stack_1_System_Single_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CF6FB0, Stack_1_T_Enumerator_System_Single_, GetEnumerator, (app::Stack_1_System_Single_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CF6FF0, IEnumerator_1_System_Single_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::Stack_1_System_Single_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CF6FF0, IEnumerator *, IEnumerable_GetEnumerator, (app::Stack_1_System_Single_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CF7210, Single__Array *, ToArray, (app::Stack_1_System_Single_ * this_ptr));
