...
namespace app::methods::Triangulate {
    ...
    IL2CPP_REGISTER_METHOD(0x00B10CD0, bool, Process, (app::List_1_UnityEngine_Vector2_ * *contour, app::List_1_System_Int32_** result, app::bool* counter_clockwise));
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::Triangulate * this_ptr));
