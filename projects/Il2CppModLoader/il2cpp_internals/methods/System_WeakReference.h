...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_1, (app::WeakReference * this_ptr));
IL2CPP_REGISTER_METHOD(0x0314DC70, void, __ctor_2, (app::WeakReference * this_ptr, app::Object * target));
IL2CPP_REGISTER_METHOD(0x0314DCA0, void, __ctor_3, (app::WeakReference * this_ptr, app::Object * target, bool track_resurrection));
IL2CPP_REGISTER_METHOD(0x0314DCD0, void, __ctor_4, (app::WeakReference * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
...
IL2CPP_REGISTER_METHOD(0x0314DE30, Object *, get_Target, (app::WeakReference * this_ptr));
