...
IL2CPP_REGISTER_METHOD(0x02798650, UGCQueryHandle_t, CreateQueryUserUGCRequest, (app::AccountID_t un_account_i_d, app::EUserUGCList__Enum e_list_type, app::EUGCMatchingUGCType__Enum e_matching_u_g_c_type, app::EUserUGCListSortOrder__Enum e_sort_order, app::AppId_t n_creator_app_i_d, app::AppId_t n_consumer_app_i_d, uint32_t un_page));
IL2CPP_REGISTER_METHOD(0x02798760, UGCQueryHandle_t, CreateQueryAllUGCRequest_1, (app::EUGCQuery__Enum e_query_type, app::EUGCMatchingUGCType__Enum e_matchinge_matching_u_g_c_type_file_type, app::AppId_t n_creator_app_i_d, app::AppId_t n_consumer_app_i_d, uint32_t un_page));
IL2CPP_REGISTER_METHOD(0x02798860, UGCQueryHandle_t, CreateQueryAllUGCRequest_2, (app::EUGCQuery__Enum e_query_type, app::EUGCMatchingUGCType__Enum e_matchinge_matching_u_g_c_type_file_type, app::AppId_t n_creator_app_i_d, app::AppId_t n_consumer_app_i_d, app::String * pch_cursor));
IL2CPP_REGISTER_METHOD(0x02798AC0, UGCQueryHandle_t, CreateQueryUGCDetailsRequest, (app::PublishedFileId_t__Array * pvec_published_file_i_d, uint32_t un_num_published_file_i_ds));
IL2CPP_REGISTER_METHOD(0x02798B90, SteamAPICall_t, SendQueryUGCRequest, (app::UGCQueryHandle_t handle));
...
IL2CPP_REGISTER_METHOD(0x02798F50, bool, GetQueryUGCStatistic, (app::UGCQueryHandle_t handle, uint32_t index, app::EItemStatistic__Enum e_stat_type, app::uint64_t * p_stat_value));
...
IL2CPP_REGISTER_METHOD(0x0279A720, SteamAPICall_t, RequestUGCDetails, (app::PublishedFileId_t n_published_file_i_d, uint32_t un_max_age_seconds));
IL2CPP_REGISTER_METHOD(0x0279A7E0, SteamAPICall_t, CreateItem, (app::AppId_t n_consumer_app_id, app::EWorkshopFileType__Enum e_file_type));
IL2CPP_REGISTER_METHOD(0x0279A8A0, UGCUpdateHandle_t, StartItemUpdate, (app::AppId_t n_consumer_app_id, app::PublishedFileId_t n_published_file_i_d));
...
IL2CPP_REGISTER_METHOD(0x0279C6A0, SteamAPICall_t, SubmitItemUpdate, (app::UGCUpdateHandle_t handle, app::String * pch_change_note));
IL2CPP_REGISTER_METHOD(0x0279C8E0, EItemUpdateStatus__Enum, GetItemUpdateProgress, (app::UGCUpdateHandle_t handle, app::uint64_t * pun_bytes_processed, app::uint64_t * pun_bytes_total));
IL2CPP_REGISTER_METHOD(0x0279C930, SteamAPICall_t, SetUserItemVote, (app::PublishedFileId_t n_published_file_i_d, bool b_vote_up));
IL2CPP_REGISTER_METHOD(0x0279CA00, SteamAPICall_t, GetUserItemVote, (app::PublishedFileId_t n_published_file_i_d));
IL2CPP_REGISTER_METHOD(0x0279CAB0, SteamAPICall_t, AddItemToFavorites, (app::AppId_t n_app_id, app::PublishedFileId_t n_published_file_i_d));
IL2CPP_REGISTER_METHOD(0x0279CB70, SteamAPICall_t, RemoveItemFromFavorites, (app::AppId_t n_app_id, app::PublishedFileId_t n_published_file_i_d));
IL2CPP_REGISTER_METHOD(0x0279CC30, SteamAPICall_t, SubscribeItem, (app::PublishedFileId_t n_published_file_i_d));
IL2CPP_REGISTER_METHOD(0x0279CCE0, SteamAPICall_t, UnsubscribeItem, (app::PublishedFileId_t n_published_file_i_d));
...
IL2CPP_REGISTER_METHOD(0x0279CE20, bool, GetItemInstallInfo, (app::PublishedFileId_t n_published_file_i_d, app::uint64_t * pun_size_on_disk, app::String * * pch_folder, uint32_t cch_folder_size, app::uint32_t * pun_time_stamp));
IL2CPP_REGISTER_METHOD(0x0279CF60, bool, GetItemDownloadInfo, (app::PublishedFileId_t n_published_file_i_d, app::uint64_t * pun_bytes_downloaded, app::uint64_t * pun_bytes_total));
...
IL2CPP_REGISTER_METHOD(0x0279D240, SteamAPICall_t, StartPlaytimeTracking, (app::PublishedFileId_t__Array * pvec_published_file_i_d, uint32_t un_num_published_file_i_ds));
IL2CPP_REGISTER_METHOD(0x0279D310, SteamAPICall_t, StopPlaytimeTracking, (app::PublishedFileId_t__Array * pvec_published_file_i_d, uint32_t un_num_published_file_i_ds));
IL2CPP_REGISTER_METHOD(0x0279D3E0, SteamAPICall_t, StopPlaytimeTrackingForAllItems, ());
IL2CPP_REGISTER_METHOD(0x0279D490, SteamAPICall_t, AddDependency, (app::PublishedFileId_t n_parent_published_file_i_d, app::PublishedFileId_t n_child_published_file_i_d));
IL2CPP_REGISTER_METHOD(0x0279D550, SteamAPICall_t, RemoveDependency, (app::PublishedFileId_t n_parent_published_file_i_d, app::PublishedFileId_t n_child_published_file_i_d));
IL2CPP_REGISTER_METHOD(0x0279D610, SteamAPICall_t, AddAppDependency, (app::PublishedFileId_t n_published_file_i_d, app::AppId_t n_app_i_d));
IL2CPP_REGISTER_METHOD(0x0279D6D0, SteamAPICall_t, RemoveAppDependency, (app::PublishedFileId_t n_published_file_i_d, app::AppId_t n_app_i_d));
IL2CPP_REGISTER_METHOD(0x0279D790, SteamAPICall_t, GetAppDependencies, (app::PublishedFileId_t n_published_file_i_d));
IL2CPP_REGISTER_METHOD(0x0279D840, SteamAPICall_t, DeleteItem, (app::PublishedFileId_t n_published_file_i_d));
}
