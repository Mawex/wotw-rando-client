...
namespace app::methods::System_Security_Util::Tokenizer {
...
IL2CPP_REGISTER_METHOD(0x01E23330, void, __ctor, (app::Tokenizer * this_ptr, app::String * input));
...
IL2CPP_REGISTER_METHOD(0x01E245A0, String *, GetStringToken, (app::Tokenizer * this_ptr));
}
