...
IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::ConditionalPlatform * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, IUberState__Array *, get_AffectingUberStates, (app::ConditionalPlatform * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CC8EF0, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::ConditionalPlatform * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008223A0, void, __ctor, (app::ConditionalPlatform * this_ptr));
}
