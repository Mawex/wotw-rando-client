...
namespace app::methods::System_Collections_Generic::List_1_SinMovement_Affect_ {
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_SinMovement_Affect_, GetEnumerator, (app::List_1_SinMovement_Affect_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EFC50, SinMovement_Affect *, get_Item, (app::List_1_SinMovement_Affect_ * this_ptr, int32_t index));
