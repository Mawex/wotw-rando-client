...
IL2CPP_REGISTER_METHOD(0x01420350, KeyCode__Enum__Array *, StringToKeyBinding, (app::String * s));
IL2CPP_REGISTER_METHOD(0x014206D0, void, WriteKeyRebindSettings, ());
IL2CPP_REGISTER_METHOD(0x01421A80, String *, KeyBindingToString, (app::KeyCode__Enum__Array * codes));
...
IL2CPP_REGISTER_METHOD(0x01423BB0, XboxControllerInput_Button__Enum, GetRemappedJoystickButton, (app::XboxControllerInput_Button__Enum joystick_button_index));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::PlayerInputRebinding * this_ptr));
