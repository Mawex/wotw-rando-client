...
namespace app::methods::System_Runtime_Serialization_Formatters_Binary::BinaryArray {
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_1, (app::BinaryArray * this_ptr));
    IL2CPP_REGISTER_METHOD(0x004C5130, void, __ctor_2, (app::BinaryArray * this_ptr, app::BinaryHeaderEnum__Enum binary_header_enum));
