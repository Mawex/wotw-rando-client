...
namespace app::methods::AngularSpring {
    ...
    IL2CPP_REGISTER_METHOD(0x003FD3F0, SuspendableMask__Enum, get_Mask, (app::AngularSpring * this_ptr));
    IL2CPP_REGISTER_METHOD(0x004FA580, void, set_Mask, (app::AngularSpring * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x004FA630, void, __ctor, (app::AngularSpring * this_ptr));
} // namespace app::methods::AngularSpring
