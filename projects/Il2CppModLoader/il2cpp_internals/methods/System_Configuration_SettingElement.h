...
namespace app::methods::System_Configuration::SettingElement {
IL2CPP_REGISTER_METHOD(0x029623B0, void, __ctor_1, (app::SettingElement * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0471BFB0, SettingElement__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x029623E0, void, __ctor_2, (app::SettingElement * this_ptr, app::String * name, app::SettingsSerializeAs__Enum serialize_as));
IL2CPP_REGISTER_METHODINFO(0x04758A98, SettingElement__ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02962410, String *, get_Name, (app::SettingElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02962470, ConfigurationPropertyCollection *, get_Properties, (app::SettingElement * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04702F90, SettingElement_get_Properties__MethodInfo);
IL2CPP_REGISTER_METHOD(0x029624A0, SettingsSerializeAs__Enum, get_SerializeAs, (app::SettingElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02962500, SettingValueElement *, get_Value, (app::SettingElement * this_ptr));
