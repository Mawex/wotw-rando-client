...
IL2CPP_REGISTER_METHOD(0x012EA820, BehaviourStatus__Enum, OnExecute, (app::KwolokBossSludgeLaserBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x012EB630, void, ModifyLookAngleChangeSpeed, (app::KwolokBossSludgeLaserBehaviour * this_ptr, app::float * speed));
IL2CPP_REGISTER_METHODINFO(0x0470F900, KwolokBossSludgeLaserBehaviour_ModifyLookAngleChangeSpeed__MethodInfo);
IL2CPP_REGISTER_METHOD(0x012EB650, void, __ctor, (app::KwolokBossSludgeLaserBehaviour * this_ptr));
}
