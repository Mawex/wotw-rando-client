...
IL2CPP_REGISTER_METHOD(0x02478470, Material *, get_material, (app::CameraFilterPack_Glow_Glow * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02479180, void, __ctor, (app::CameraFilterPack_Glow_Glow * this_ptr));
}
