...
IL2CPP_REGISTER_METHOD(0x002FC6D0, PlayFabEventType__Enum, get_EventType, (app::PlayFabEvent * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FC6E0, void, set_EventType, (app::PlayFabEvent * this_ptr, app::PlayFabEventType__Enum value));
IL2CPP_REGISTER_METHOD(0x0195B0D0, String *, get_Name, (app::PlayFabEvent * this_ptr));
IL2CPP_REGISTER_METHOD(0x01A27F10, void, set_Name, (app::PlayFabEvent * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB930, EventContents *, get_EventContents, (app::PlayFabEvent * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_EventContents, (app::PlayFabEvent * this_ptr, app::EventContents * value));
IL2CPP_REGISTER_METHOD(0x01A27F30, void, __ctor, (app::PlayFabEvent * this_ptr));
