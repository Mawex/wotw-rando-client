...
IL2CPP_REGISTER_METHOD(0x024F0C60, Material *, get_material, (app::CameraFilterPack_Drawing_Curve * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E70F0, void, __ctor, (app::CameraFilterPack_Drawing_Curve * this_ptr));
}
