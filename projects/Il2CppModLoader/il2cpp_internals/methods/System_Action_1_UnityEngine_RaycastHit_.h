...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::Action_1_UnityEngine_RaycastHit_ * this_ptr, app::Object * object, app::void * method_1));
IL2CPP_REGISTER_METHODINFO(0x0471CD88, Action_1_UnityEngine_RaycastHit___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02C0C350, IAsyncResult *, BeginInvoke, (app::Action_1_UnityEngine_RaycastHit_ * this_ptr, app::RaycastHit obj, app::AsyncCallback * callback, app::Object * object));
