...
IL2CPP_REGISTER_METHOD(0x00C3C6E0, PhysicsUpdateHandlerAttribute *, GetTypeInfo, (app::Type * type));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::PhysicsUpdateHandlerManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C3C8A0, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x00C3CA10, IJobSystem__Array *, _Init_g__CreateSystems_5_0, (app::Dictionary_2_Moon_PhysicsUpdateHandlerAttribute_List_1_UnityEngine_Component_ * system_dictionary));
}
