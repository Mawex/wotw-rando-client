...
IL2CPP_REGISTER_METHOD(0x00DCB630, EffectSpawn, ProvideDamageEffect, (app::DamagerAnimator * this_ptr, app::DamageResult result));
...
IL2CPP_REGISTER_METHOD(0x00DCB6D0, void, __ctor, (app::DamagerAnimator * this_ptr));
