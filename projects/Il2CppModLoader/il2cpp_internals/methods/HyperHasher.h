...
namespace app::methods::HyperHasher {
    ...
    IL2CPP_REGISTER_METHOD(0x025576C0, void, Partition, (int32_t value, app::Byte__Array* into, app::int32_t* start));
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::HyperHasher * this_ptr));
} // namespace app::methods::HyperHasher
