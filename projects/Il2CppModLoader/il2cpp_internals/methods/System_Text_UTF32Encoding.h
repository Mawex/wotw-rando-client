...
namespace app::methods::System_Text::UTF32Encoding {
IL2CPP_REGISTER_METHOD(0x027C77C0, void, __ctor_1, (app::UTF32Encoding * this_ptr));
IL2CPP_REGISTER_METHOD(0x027C7800, void, __ctor_2, (app::UTF32Encoding * this_ptr, bool big_endian, bool byte_order_mark));
IL2CPP_REGISTER_METHOD(0x027C7860, void, __ctor_3, (app::UTF32Encoding * this_ptr, bool big_endian, bool byte_order_mark, bool throw_on_invalid_characters));
...
IL2CPP_REGISTER_METHOD(0x027C7DE0, int32_t, GetByteCount_3, (app::UTF32Encoding * this_ptr, app::uint16_t * chars, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x027C8450, int32_t, GetBytes_3, (app::UTF32Encoding * this_ptr, app::uint16_t * chars, int32_t char_count, app::uint8_t * bytes, int32_t byte_count));
...
IL2CPP_REGISTER_METHOD(0x027C87A0, int32_t, GetCharCount_2, (app::UTF32Encoding * this_ptr, app::uint8_t * bytes, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x027C8B80, int32_t, GetChars_2, (app::UTF32Encoding * this_ptr, app::uint8_t * bytes, int32_t byte_count, app::uint16_t * chars, int32_t char_count));
IL2CPP_REGISTER_METHODINFO(0x04714B00, UTF32Encoding_GetChars_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027C8D00, String *, GetString, (app::UTF32Encoding * this_ptr, app::Byte__Array * bytes, int32_t index, int32_t count));
IL2CPP_REGISTER_METHODINFO(0x04776BC8, UTF32Encoding_GetString__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027C8ED0, int32_t, GetByteCount_4, (app::UTF32Encoding * this_ptr, app::uint16_t * chars, int32_t count, app::EncoderNLS * encoder));
IL2CPP_REGISTER_METHODINFO(0x04710290, UTF32Encoding_GetByteCount_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027C92C0, int32_t, GetBytes_4, (app::UTF32Encoding * this_ptr, app::uint16_t * chars, int32_t char_count, app::uint8_t * bytes, int32_t byte_count, app::EncoderNLS * encoder));
IL2CPP_REGISTER_METHODINFO(0x0473F310, UTF32Encoding_GetBytes_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027C98C0, int32_t, GetCharCount_3, (app::UTF32Encoding * this_ptr, app::uint8_t * bytes, int32_t count, app::DecoderNLS * base_decoder));
IL2CPP_REGISTER_METHODINFO(0x04707348, UTF32Encoding_GetCharCount_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027C9D30, int32_t, GetChars_3, (app::UTF32Encoding * this_ptr, app::uint8_t * bytes, int32_t byte_count, app::uint16_t * chars, int32_t char_count, app::DecoderNLS * base_decoder));
...
IL2CPP_REGISTER_METHOD(0x027CA3C0, Decoder *, GetDecoder, (app::UTF32Encoding * this_ptr));
IL2CPP_REGISTER_METHOD(0x027CA530, Encoder *, GetEncoder, (app::UTF32Encoding * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x027CA940, Byte__Array *, GetPreamble, (app::UTF32Encoding * this_ptr));
