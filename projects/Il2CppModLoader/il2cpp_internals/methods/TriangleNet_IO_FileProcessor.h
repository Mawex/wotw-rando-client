...
namespace app::methods::TriangleNet_IO::FileProcessor {
...
IL2CPP_REGISTER_METHOD(0x02620AE0, IPolygon *, Read, (app::String * filename));
...
IL2CPP_REGISTER_METHOD(0x02620F60, IMesh *, Import, (app::String * filename));
