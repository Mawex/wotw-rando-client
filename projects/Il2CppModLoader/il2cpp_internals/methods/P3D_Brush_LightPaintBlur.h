...
IL2CPP_REGISTER_METHOD(0x0308CAF0, Texture2D *, InitTextureIfNeeded, (app::Texture2D * texture, int32_t main_tex_width, int32_t main_tex_height));
IL2CPP_REGISTER_METHOD(0x0308CE10, void, __cctor, ());
}
