...
IL2CPP_REGISTER_METHOD(0x0313DB80, void, __ctor, (app::AudioClip * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0313DDB0, AudioClipLoadType__Enum, get_loadType, (app::AudioClip * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0313DF40, AudioDataLoadState__Enum, get_loadState, (app::AudioClip * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0313E0C0, AudioClip *, Create_1, (app::String * name, int32_t length_samples, int32_t channels, int32_t frequency, bool _3_d, bool stream));
IL2CPP_REGISTER_METHOD(0x0313E0F0, AudioClip *, Create_2, (app::String * name, int32_t length_samples, int32_t channels, int32_t frequency, bool _3_d, bool stream, app::AudioClip_PCMReaderCallback * pcmreadercallback));
IL2CPP_REGISTER_METHOD(0x0313E120, AudioClip *, Create_3, (app::String * name, int32_t length_samples, int32_t channels, int32_t frequency, bool _3_d, bool stream, app::AudioClip_PCMReaderCallback * pcmreadercallback, app::AudioClip_PCMSetPositionCallback * pcmsetpositioncallback));
IL2CPP_REGISTER_METHOD(0x0313E160, AudioClip *, Create_4, (app::String * name, int32_t length_samples, int32_t channels, int32_t frequency, bool stream));
IL2CPP_REGISTER_METHOD(0x0313E190, AudioClip *, Create_5, (app::String * name, int32_t length_samples, int32_t channels, int32_t frequency, bool stream, app::AudioClip_PCMReaderCallback * pcmreadercallback));
IL2CPP_REGISTER_METHOD(0x0313E1C0, AudioClip *, Create_6, (app::String * name, int32_t length_samples, int32_t channels, int32_t frequency, bool stream, app::AudioClip_PCMReaderCallback * pcmreadercallback, app::AudioClip_PCMSetPositionCallback * pcmsetpositioncallback));
