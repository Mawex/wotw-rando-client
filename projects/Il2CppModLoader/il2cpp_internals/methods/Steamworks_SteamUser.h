...
IL2CPP_REGISTER_METHOD(0x0279E360, EVoiceResult__Enum, GetAvailableVoice, (app::uint32_t * pcb_compressed));
IL2CPP_REGISTER_METHOD(0x0279E480, EVoiceResult__Enum, GetVoice, (bool b_want_compressed, app::Byte__Array * p_dest_buffer, uint32_t cb_dest_buffer_size, app::uint32_t * n_bytes_written));
IL2CPP_REGISTER_METHOD(0x0279E600, EVoiceResult__Enum, DecompressVoice, (app::Byte__Array * p_compressed, uint32_t cb_compressed, app::Byte__Array * p_dest_buffer, uint32_t cb_dest_buffer_size, app::uint32_t * n_bytes_written, uint32_t n_desired_sample_rate));
IL2CPP_REGISTER_METHOD(0x0279E720, uint32_t, GetVoiceOptimalSampleRate, ());
IL2CPP_REGISTER_METHOD(0x0279E7D0, HAuthTicket, GetAuthSessionTicket, (app::Byte__Array * p_ticket, int32_t cb_max_ticket, app::uint32_t * pcb_ticket));
IL2CPP_REGISTER_METHOD(0x0279E940, EBeginAuthSessionResult__Enum, BeginAuthSession, (app::Byte__Array * p_auth_ticket, int32_t cb_auth_ticket, app::CSteamID steam_i_d));
...
IL2CPP_REGISTER_METHOD(0x0279EB90, EUserHasLicenseForAppResult__Enum, UserHasLicenseForApp, (app::CSteamID steam_i_d, app::AppId_t app_i_d));
...
IL2CPP_REGISTER_METHOD(0x0279EDF0, SteamAPICall_t, RequestEncryptedAppTicket, (app::Byte__Array * p_data_to_include, int32_t cb_data_to_include));
IL2CPP_REGISTER_METHOD(0x0279EF50, bool, GetEncryptedAppTicket, (app::Byte__Array * p_ticket, int32_t cb_max_ticket, app::uint32_t * pcb_ticket));
...
IL2CPP_REGISTER_METHOD(0x0279F1B0, SteamAPICall_t, RequestStoreAuthURL, (app::String * pch_redirect_u_r_l));
