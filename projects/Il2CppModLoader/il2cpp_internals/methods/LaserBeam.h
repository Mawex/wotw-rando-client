...
namespace app::methods::LaserBeam {
    ...
    IL2CPP_REGISTER_METHOD(0x00F06A80, GameObject*, GetTimelineScaleTarget, (app::LaserBeam * this_ptr, app::MoonTimeline* timeline));
    IL2CPP_REGISTER_METHOD(0x00F06C40, int32_t, GetPrewarmAmount, (app::LaserBeam * this_ptr, app::GameObject* entry));
    IL2CPP_REGISTER_METHOD(0x00F06D50, void, __ctor, (app::LaserBeam * this_ptr));
} // namespace app::methods::LaserBeam
