...
IL2CPP_REGISTER_METHOD(0x0169C680, Bounds, GetOuterBounds, (app::CameraOffsetZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x015DD640, Bounds, GetInnerBounds, (app::CameraOffsetZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417920, SelectableCategory__Enum, get_Category, (app::CameraOffsetZone * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::CameraOffsetZone * this_ptr));
}
