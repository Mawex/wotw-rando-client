...
namespace app::methods::System_Xml_Schema::XmlSchemaImport {
IL2CPP_REGISTER_METHOD(0x01CA9660, void, __ctor, (app::XmlSchemaImport * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBA0, String *, get_Namespace, (app::XmlSchemaImport * this_ptr));
