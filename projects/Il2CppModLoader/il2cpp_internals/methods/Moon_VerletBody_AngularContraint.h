...
IL2CPP_REGISTER_METHOD(0x0126FF10, void, __ctor, (app::VerletBody_AngularContraint * this_ptr, app::VerletBody_Link * link0, app::VerletBody_Link * link1, float max_angle));
