...
IL2CPP_REGISTER_METHOD(0x00998570, SuspendableMask__Enum, get_Mask, (app::FishingMiniGameController * this_ptr));
IL2CPP_REGISTER_METHOD(0x0126D160, void, set_Mask, (app::FishingMiniGameController * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x0126D210, SeinCharacter *, get_Sein, (app::FishingMiniGameController * this_ptr));
IL2CPP_REGISTER_METHOD(0x0126D2A0, Input_InputButtonProcessor *, get_Button, (app::FishingMiniGameController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0126D630, VerletStructure_VerletJoint *, get_BaitJoint, (app::FishingMiniGameController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0126E0D0, void, __ctor, (app::FishingMiniGameController * this_ptr));
}
