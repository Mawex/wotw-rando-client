...
namespace app::methods::UnityEngine::Vector2 {
    ...
    IL2CPP_REGISTER_METHOD(0x00EB0C50, app::Vector2, operator___1, (app::Vector2 a, app::Vector2 b));
    IL2CPP_REGISTER_METHOD(0x02C73DE0, app::Vector2, operator___2, (app::Vector2 a, app::Vector2 b));
    IL2CPP_REGISTER_METHOD(0x018308E0, app::Vector2, operator___3, (app::Vector2 a, app::Vector2 b));
    IL2CPP_REGISTER_METHOD(0x01830950, app::Vector2, operator___4, (app::Vector2 a, app::Vector2 b));
    IL2CPP_REGISTER_METHOD(0x02C73E20, app::Vector2, operator___5, (app::Vector2 a));
    IL2CPP_REGISTER_METHOD(0x0182ACE0, app::Vector2, operator___6, (app::Vector2 a, float d));
    IL2CPP_REGISTER_METHOD(0x02C73E50, app::Vector2, operator___7, (float d, app::Vector2 a));
    IL2CPP_REGISTER_METHOD(0x0182AD10, app::Vector2, operator___8, (app::Vector2 a, float d));
    ...
    IL2CPP_REGISTER_METHOD(0x0296D4D0, app::Vector2, operator__1, (app::Vector3 v));
    IL2CPP_REGISTER_METHOD(0x02C74010, app::Vector3, operator__2, (app::Vector2 v));
