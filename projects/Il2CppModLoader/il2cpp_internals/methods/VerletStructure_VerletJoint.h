...
IL2CPP_REGISTER_METHOD(0x013D00E0, Vector3, get_Velocity, (app::VerletStructure_VerletJoint * this_ptr));
IL2CPP_REGISTER_METHOD(0x013D01E0, void, set_Velocity, (app::VerletStructure_VerletJoint * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x013D02E0, Vector3, get_WorldAnchor, (app::VerletStructure_VerletJoint * this_ptr));
IL2CPP_REGISTER_METHOD(0x013D0430, void, set_WorldAnchor, (app::VerletStructure_VerletJoint * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x013D0580, void, __ctor, (app::VerletStructure_VerletJoint * this_ptr, app::Vector3 position, float mass));
