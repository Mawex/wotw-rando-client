...
namespace app::methods::UnityStandardAssets_ImageEffects::ScreenSpaceAmbientObscurance {
    ...
    IL2CPP_REGISTER_METHOD(0x02D61A80, void, __ctor, (app::ScreenSpaceAmbientObscurance * this_ptr));
}
