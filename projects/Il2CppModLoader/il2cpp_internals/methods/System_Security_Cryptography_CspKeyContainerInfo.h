...
namespace app::methods::System_Security_Cryptography::CspKeyContainerInfo {
IL2CPP_REGISTER_METHOD(0x020D0390, void, __ctor, (app::CspKeyContainerInfo * this_ptr, app::CspParameters * parameters));
IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, get_Accessible, (app::CspKeyContainerInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, CryptoKeySecurity *, get_CryptoKeySecurity, (app::CspKeyContainerInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00571730, String *, get_KeyContainerName, (app::CspKeyContainerInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E83750, KeyNumber__Enum, get_KeyNumber, (app::CspKeyContainerInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004173F0, String *, get_ProviderName, (app::CspKeyContainerInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020D03C0, String *, get_UniqueKeyContainerName, (app::CspKeyContainerInfo * this_ptr));
}
