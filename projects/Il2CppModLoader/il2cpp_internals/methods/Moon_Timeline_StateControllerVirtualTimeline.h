...
namespace app::methods::Moon_Timeline::StateControllerVirtualTimeline {
IL2CPP_REGISTER_METHOD(0x002FBBE0, NewSetupStateController *, get_StateController, (app::StateControllerVirtualTimeline * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E82610, void, __ctor, (app::StateControllerVirtualTimeline * this_ptr, app::NewSetupStateController * state_controller));
IL2CPP_REGISTER_METHOD(0x01E82660, void, Reset, (app::StateControllerVirtualTimeline * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x01E82720, EntityOperationPermit__Enum, OnBeforeAddChild, (app::StateControllerVirtualTimeline * this_ptr, app::ITimelineEntity * entity));
IL2CPP_REGISTER_METHOD(0x01E82830, EntityId, CustomAddChild, (app::StateControllerVirtualTimeline * this_ptr, app::ITimelineEntity * entity));
...
IL2CPP_REGISTER_METHOD(0x01E82BE0, EntityOperationPermit__Enum, OnBeforeRemoveChild, (app::StateControllerVirtualTimeline * this_ptr, app::ITimelineEntity * entity));
