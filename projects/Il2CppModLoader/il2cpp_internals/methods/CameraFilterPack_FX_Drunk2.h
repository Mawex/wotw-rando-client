...
IL2CPP_REGISTER_METHOD(0x0246C2F0, Material *, get_material, (app::CameraFilterPack_FX_Drunk2 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020F7040, void, __ctor, (app::CameraFilterPack_FX_Drunk2 * this_ptr));
}
