...
namespace app::methods::System_Collections_Generic::GenericEqualityComparer_1_UnityEngine_UI_ColorBlock_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0225BDA0, void, __ctor, (app::GenericEqualityComparer_1_UnityEngine_UI_ColorBlock_ * this_ptr));
}
