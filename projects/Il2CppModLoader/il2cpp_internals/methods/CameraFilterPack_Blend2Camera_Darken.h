...
IL2CPP_REGISTER_METHOD(0x02746C10, Material *, get_material, (app::CameraFilterPack_Blend2Camera_Darken * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02747DE0, void, __ctor, (app::CameraFilterPack_Blend2Camera_Darken * this_ptr));
}
