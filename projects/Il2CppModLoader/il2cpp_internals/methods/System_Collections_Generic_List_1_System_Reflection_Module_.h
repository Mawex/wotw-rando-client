...
namespace app::methods::System_Collections_Generic::List_1_System_Reflection_Module_ {
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor, (app::List_1_System_Reflection_Module_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, Module__Array *, ToArray, (app::List_1_System_Reflection_Module_ * this_ptr));
