...
namespace app::methods::System_Xml_Serialization::XmlTypeMapElementInfo {
IL2CPP_REGISTER_METHOD(0x0194CD70, void, __ctor, (app::XmlTypeMapElementInfo * this_ptr, app::XmlTypeMapMember * member, app::TypeData * type));
IL2CPP_REGISTER_METHOD(0x002FB9F0, TypeData *, get_TypeData, (app::XmlTypeMapElementInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB990, Object *, get_ChoiceValue, (app::XmlTypeMapElementInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9A0, void, set_ChoiceValue, (app::XmlTypeMapElementInfo * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_ElementName, (app::XmlTypeMapElementInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_ElementName, (app::XmlTypeMapElementInfo * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Namespace, (app::XmlTypeMapElementInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_Namespace, (app::XmlTypeMapElementInfo * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x0194CE40, String *, get_DataTypeNamespace, (app::XmlTypeMapElementInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x0194CED0, String *, get_DataTypeName, (app::XmlTypeMapElementInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FD1D0, XmlSchemaForm__Enum, get_Form, (app::XmlTypeMapElementInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FD1E0, void, set_Form, (app::XmlTypeMapElementInfo * this_ptr, app::XmlSchemaForm__Enum value));
IL2CPP_REGISTER_METHOD(0x002FB9D0, XmlTypeMapping *, get_MappedType, (app::XmlTypeMapElementInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB00, XmlTypeMapMember *, get_Member, (app::XmlTypeMapElementInfo * this_ptr));
