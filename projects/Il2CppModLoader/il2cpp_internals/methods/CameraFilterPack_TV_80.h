...
IL2CPP_REGISTER_METHOD(0x020E3540, Material *, get_material, (app::CameraFilterPack_TV_80 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0136E200, void, __ctor, (app::CameraFilterPack_TV_80 * this_ptr));
}
