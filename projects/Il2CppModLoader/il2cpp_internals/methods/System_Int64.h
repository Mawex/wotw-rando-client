...
namespace app::methods::System::Int64 {
    ...
    IL2CPP_REGISTER_METHOD(0x001E89B0, String*, ToString_1, (app::Int64__Boxed * this_ptr));
    IL2CPP_REGISTER_METHOD(0x001E89E0, String*, ToString_2, (app::Int64__Boxed * this_ptr, app::IFormatProvider* provider));
    IL2CPP_REGISTER_METHOD(0x001E8A10, String*, ToString_3, (app::Int64__Boxed * this_ptr, app::String* format, app::IFormatProvider* provider));
    ...
    IL2CPP_REGISTER_METHOD(0x0238D2B0, bool, TryParse_1, (app::String * s, app::int64_t* result));
    IL2CPP_REGISTER_METHOD(0x0238D2F0, bool, TryParse_2, (app::String * s, app::NumberStyles__Enum style, app::IFormatProvider* provider, app::int64_t* result));
    IL2CPP_REGISTER_METHOD(0x001E8A50, TypeCode__Enum, GetTypeCode, (app::Int64__Boxed * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x001E9520, Decimal, IConvertible_ToDecimal, (app::Int64__Boxed * this_ptr, app::IFormatProvider* provider));
    IL2CPP_REGISTER_METHOD(0x001E9680, DateTime, IConvertible_ToDateTime, (app::Int64__Boxed * this_ptr, app::IFormatProvider* provider));
    IL2CPP_REGISTER_METHODINFO(0x04746248, Int64_System_IConvertible_ToDateTime__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x001E9690, Object*, IConvertible_ToType, (app::Int64__Boxed * this_ptr, app::Type* type, app::IFormatProvider* provider));
} // namespace app::methods::System::Int64
