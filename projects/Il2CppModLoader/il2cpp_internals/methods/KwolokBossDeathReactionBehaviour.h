...
IL2CPP_REGISTER_METHOD(0x01252360, KwolokBossEntity *, get_Kwolok, (app::KwolokBossDeathReactionBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x01252430, KwolokBossLocomotion *, get_Locomotion, (app::KwolokBossDeathReactionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01252B30, BehaviourStatus__Enum, OnExecuteTask, (app::KwolokBossDeathReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x012540D0, void, ModifyMaxMovementSpeed, (app::KwolokBossDeathReactionBehaviour * this_ptr, app::float * speed));
IL2CPP_REGISTER_METHODINFO(0x04761030, KwolokBossDeathReactionBehaviour_ModifyMaxMovementSpeed__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01251800, void, ModifyDesiredLookAngle, (app::KwolokBossDeathReactionBehaviour * this_ptr, app::float * angle));
