...
IL2CPP_REGISTER_METHOD(0x007E7250, GhostFrame_FrameDataTypes__Enum, get_FrameType, (app::GhostServerEventsPlugin_ServerEventData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007E78D0, void, __ctor, (app::GhostServerEventsPlugin_ServerEventData * this_ptr));
}
