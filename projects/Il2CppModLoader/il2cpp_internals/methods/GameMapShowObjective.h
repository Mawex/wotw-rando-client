...
IL2CPP_REGISTER_METHOD(0x006A3860, Vector3, WorldToUIPosition, (app::GameMapShowObjective * this_ptr, app::Vector3 position));
...
IL2CPP_REGISTER_METHOD(0x006A40B0, void, __ctor, (app::GameMapShowObjective * this_ptr));
}
