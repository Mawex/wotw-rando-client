...
namespace app::methods::Mono_Security_Protocol_Tls_Handshake_Server::TlsServerKeyExchange {
IL2CPP_REGISTER_METHOD(0x01F75430, void, __ctor, (app::TlsServerKeyExchange * this_ptr, app::Context_1 * context));
...
IL2CPP_REGISTER_METHOD(0x01F758C0, Byte__Array *, createSignature, (app::TlsServerKeyExchange * this_ptr, app::RSA * rsa, app::Byte__Array * buffer));
}
