...
IL2CPP_REGISTER_METHOD(0x00DC85E0, IDamageNotifier *, get_ResolvedDamageNotifier, (app::DamageReceiverCondition * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::DamageReceiverCondition * this_ptr));
}
