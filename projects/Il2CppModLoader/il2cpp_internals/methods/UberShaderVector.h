...
IL2CPP_REGISTER_METHOD(0x01289810, void, __ctor_1, (app::UberShaderVector * this_ptr, float x, float y, float z, float w));
IL2CPP_REGISTER_METHOD(0x01289910, void, __ctor_2, (app::UberShaderVector * this_ptr));
IL2CPP_REGISTER_METHOD(0x012899C0, void, BindProperties, (app::UberShaderVector * this_ptr));
IL2CPP_REGISTER_METHOD(0x01289ED0, Vector4, get_VectorValue, (app::UberShaderVector * this_ptr));
