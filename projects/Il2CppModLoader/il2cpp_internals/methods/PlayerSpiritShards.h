...
IL2CPP_REGISTER_METHOD(0x01428CF0, PlayerUberStateShards *, get_PlayerUberStateShards, (app::PlayerSpiritShards * this_ptr));
IL2CPP_REGISTER_METHOD(0x01428DD0, List_1_Moon_uberSerializationWisp_PlayerUberStateShards_Shard_ *, get_Shards, (app::PlayerSpiritShards * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0142ADC0, bool, GetGlobalShardProperty_1, (app::PlayerSpiritShards * this_ptr, app::SpiritShardType__Enum spirit_shard_type, app::UpgradablePropertyType__Enum property_type, app::float * value));
...
IL2CPP_REGISTER_METHOD(0x0142B1F0, PlayerUberStateShards_Shard *, AddNewShardToInventory_1, (app::PlayerSpiritShards * this_ptr, app::SpiritShardType__Enum spirit_shard_type));
...
IL2CPP_REGISTER_METHOD(0x0142BE60, bool, GetGlobalShardPropertyHelper, (app::SpiritShardType__Enum spirit_shard_type, app::UpgradablePropertyType__Enum property_type, app::float * value));
...
IL2CPP_REGISTER_METHOD(0x0142D1A0, PlayerUberStateShards_Shard *, GetActualInventoryItem, (app::PlayerSpiritShards * this_ptr, app::SpiritShardType__Enum typ));
...
IL2CPP_REGISTER_METHOD(0x0142D370, IUberState__Array *, get_AffectingUberStates, (app::PlayerSpiritShards * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC80, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::PlayerSpiritShards * this_ptr));
IL2CPP_REGISTER_METHOD(0x0142D4B0, void, __ctor, (app::PlayerSpiritShards * this_ptr));
