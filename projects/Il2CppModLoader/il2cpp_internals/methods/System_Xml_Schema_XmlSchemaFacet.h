...
namespace app::methods::System_Xml_Schema::XmlSchemaFacet {
IL2CPP_REGISTER_METHOD(0x002FBB40, String *, get_Value, (app::XmlSchemaFacet * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003FF2B0, FacetType__Enum, get_FacetType, (app::XmlSchemaFacet * this_ptr));
IL2CPP_REGISTER_METHOD(0x003FF2C0, void, set_FacetType, (app::XmlSchemaFacet * this_ptr, app::FacetType__Enum value));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::XmlSchemaFacet * this_ptr));
}
