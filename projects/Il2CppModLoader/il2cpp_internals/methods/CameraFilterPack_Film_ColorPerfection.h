...
IL2CPP_REGISTER_METHOD(0x02476090, Material *, get_material, (app::CameraFilterPack_Film_ColorPerfection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024769E0, void, __ctor, (app::CameraFilterPack_Film_ColorPerfection * this_ptr));
}
