...
namespace app::methods::System_Collections_Generic::List_1_System_Attribute_ {
    IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_System_Attribute_ * this_ptr));
