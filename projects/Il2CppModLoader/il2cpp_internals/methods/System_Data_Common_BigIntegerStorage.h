...
namespace app::methods::System_Data_Common::BigIntegerStorage {
IL2CPP_REGISTER_METHOD(0x02154A20, void, __ctor, (app::BigIntegerStorage * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x02154B70, Object *, Aggregate, (app::BigIntegerStorage * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x02154DE0, BigInteger_2, ConvertToBigInteger, (app::Object * value, app::IFormatProvider * format_provider));
IL2CPP_REGISTER_METHODINFO(0x047642E0, BigIntegerStorage_ConvertToBigInteger__MethodInfo);
IL2CPP_REGISTER_METHOD(0x021554C0, Object *, ConvertFromBigInteger, (app::BigInteger_2 value, app::Type * type, app::IFormatProvider * format_provider));
IL2CPP_REGISTER_METHODINFO(0x04711CA0, BigIntegerStorage_ConvertFromBigInteger__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02155BE0, Object *, ConvertValue, (app::BigIntegerStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02155CC0, void, Copy, (app::BigIntegerStorage * this_ptr, int32_t record_no1, int32_t record_no2));
IL2CPP_REGISTER_METHOD(0x02155D80, Object *, Get, (app::BigIntegerStorage * this_ptr, int32_t record));
...
IL2CPP_REGISTER_METHOD(0x02156140, Object *, ConvertXmlToObject, (app::BigIntegerStorage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x02156230, String *, ConvertObjectToXml, (app::BigIntegerStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02156330, Object *, GetEmptyStorage, (app::BigIntegerStorage * this_ptr, int32_t record_count));
