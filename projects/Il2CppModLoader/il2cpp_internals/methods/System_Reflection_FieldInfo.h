...
namespace app::methods::System_Reflection::FieldInfo {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::FieldInfo_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x00910BD0, MemberTypes__Enum, get_MemberType, (app::FieldInfo_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0268A4D0, FieldInfo_1 *, internal_from_handle_type, (app::void * field_handle, app::void * type_handle));
IL2CPP_REGISTER_METHOD(0x0268A530, FieldInfo_1 *, GetFieldFromHandle_1, (app::RuntimeFieldHandle handle));
IL2CPP_REGISTER_METHODINFO(0x04788BB8, FieldInfo_1_GetFieldFromHandle__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0268A5F0, FieldInfo_1 *, GetFieldFromHandle_2, (app::RuntimeFieldHandle handle, app::RuntimeTypeHandle declaring_type));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, MarshalAsAttribute *, get_marshal_info, (app::FieldInfo_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x0268A7F0, Object__Array *, GetPseudoCustomAttributes, (app::FieldInfo_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x0268ABA0, Object *, GetRawConstantValue, (app::FieldInfo_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02283820, bool, operator____1, (app::FieldInfo_1 * left, app::FieldInfo_1 * right));
IL2CPP_REGISTER_METHOD(0x02283870, bool, operator____2, (app::FieldInfo_1 * left, app::FieldInfo_1 * right));
}
