...
IL2CPP_REGISTER_METHOD(0x006410F0, SuspendableMask__Enum, get_Mask, (app::PlatformMovementEnvironmentForceController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0116F470, void, __ctor, (app::PlatformMovementEnvironmentForceController * this_ptr));
}
