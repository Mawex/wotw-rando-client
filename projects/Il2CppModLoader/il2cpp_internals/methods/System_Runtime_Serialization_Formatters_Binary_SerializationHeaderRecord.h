...
namespace app::methods::System_Runtime_Serialization_Formatters_Binary::SerializationHeaderRecord {
    IL2CPP_REGISTER_METHOD(0x00D34AF0, void, __ctor_1, (app::SerializationHeaderRecord * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01DA1550, void, __ctor_2, (app::SerializationHeaderRecord * this_ptr, app::BinaryHeaderEnum__Enum binary_header_enum, int32_t top_id, int32_t header_id, int32_t major_version, int32_t minor_version));
