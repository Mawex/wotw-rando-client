...
namespace app::methods::System_Xml_Linq::StreamingElementWriter {
IL2CPP_REGISTER_METHOD(0x00241380, void, __ctor, (app::StreamingElementWriter__Boxed * this_ptr, app::XmlWriter * w));
IL2CPP_REGISTER_METHOD(0x00241390, void, FlushElement, (app::StreamingElementWriter__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x002413A0, String *, GetPrefixOfNamespace, (app::StreamingElementWriter__Boxed * this_ptr, app::XNamespace * ns, bool allow_default_namespace));
