...
IL2CPP_REGISTER_METHOD(0x002FBB80, GlobalRecordingTable *, get_GlobalRecordingTable, (app::GhostTimelineEventsPlugin * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, GhostRecorder_GhostPluginRecordingType__Enum, GetRecordingType, (app::GhostTimelineEventsPlugin * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007EBDD0, void, __ctor, (app::GhostTimelineEventsPlugin * this_ptr));
}
