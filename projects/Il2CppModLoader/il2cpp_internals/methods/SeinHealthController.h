...
IL2CPP_REGISTER_METHOD(0x002FBCC0, IUberState__Array *, get_AffectingUberStates, (app::SeinHealthController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBCE0, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::SeinHealthController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FFF4F0, void, __ctor, (app::SeinHealthController * this_ptr));
}
