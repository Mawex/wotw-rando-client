...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::Comparison_1_WaterPoisonTrail_DamagePoint_ * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02C86140, IAsyncResult *, BeginInvoke, (app::Comparison_1_WaterPoisonTrail_DamagePoint_ * this_ptr, app::WaterPoisonTrail_DamagePoint x, app::WaterPoisonTrail_DamagePoint y, app::AsyncCallback * callback, app::Object * object));
