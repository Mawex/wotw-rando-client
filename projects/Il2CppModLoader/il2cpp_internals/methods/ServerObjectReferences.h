...
IL2CPP_REGISTER_METHOD(0x00AC0C60, ServerObject *, GetServerObjByGameojb, (app::GameObject * game_obj));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::ServerObjectReferences * this_ptr));
IL2CPP_REGISTER_METHOD(0x00AC1060, void, __cctor, ());
}
