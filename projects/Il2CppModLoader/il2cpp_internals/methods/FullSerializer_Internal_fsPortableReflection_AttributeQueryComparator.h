...
IL2CPP_REGISTER_METHOD(0x0165B1B0, int32_t, GetHashCode, (fsPortableReflection_AttributeQueryComparator * __this, fsPortableReflection_AttributeQuery obj));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (fsPortableReflection_AttributeQueryComparator * __this));
}
