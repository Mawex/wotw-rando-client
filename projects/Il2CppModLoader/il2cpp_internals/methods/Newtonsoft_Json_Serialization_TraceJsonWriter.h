...
namespace app::methods::Newtonsoft_Json_Serialization::TraceJsonWriter {
IL2CPP_REGISTER_METHOD(0x01BFD6D0, void, __ctor, (app::TraceJsonWriter * this_ptr, app::JsonWriter * inner_writer));
IL2CPP_REGISTER_METHOD(0x01BFDA40, String *, GetSerializedJsonMessage, (app::TraceJsonWriter * this_ptr));
