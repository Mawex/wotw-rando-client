...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::AkAudioInputManager_AudioSamplesInteropDelegate * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x026C8CE0, IAsyncResult *, BeginInvoke, (app::AkAudioInputManager_AudioSamplesInteropDelegate * this_ptr, uint32_t playing_i_d, app::Single__Array * samples, uint32_t channel_index, uint32_t frames, app::AsyncCallback * callback, app::Object * object));
