...
IL2CPP_REGISTER_METHOD(0x01492620, Vector3, get_EffectivePatrollOrigin, (app::GroundPatrolBehaviourNew * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01492E40, BehaviourStatus__Enum, OnExecute, (app::GroundPatrolBehaviourNew * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x014939E0, BehaviourStatus__Enum, OnChangePatrolPoint, (app::GroundPatrolBehaviourNew * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01493BC0, Vector3, ClampToAllowedArea, (app::GroundPatrolBehaviourNew * this_ptr, app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x01493D80, Vector3, CastPositionToGround, (app::GroundPatrolBehaviourNew * this_ptr, app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x014940E0, void, __ctor, (app::GroundPatrolBehaviourNew * this_ptr));
}
