...
namespace app::methods::Mono_Security_X509::X509CertificateBuilder {
...
IL2CPP_REGISTER_METHOD(0x002FB950, Byte__Array *, get_SerialNumber, (app::X509CertificateBuilder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB960, void, set_SerialNumber, (app::X509CertificateBuilder * this_ptr, app::Byte__Array * value));
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, get_IssuerName, (app::X509CertificateBuilder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB10, void, set_IssuerName, (app::X509CertificateBuilder * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB990, DateTime, get_NotBefore, (app::X509CertificateBuilder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9A0, void, set_NotBefore, (app::X509CertificateBuilder * this_ptr, app::DateTime value));
IL2CPP_REGISTER_METHOD(0x002FB9B0, DateTime, get_NotAfter, (app::X509CertificateBuilder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9C0, void, set_NotAfter, (app::X509CertificateBuilder * this_ptr, app::DateTime value));
IL2CPP_REGISTER_METHOD(0x002FB9D0, String *, get_SubjectName, (app::X509CertificateBuilder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9E0, void, set_SubjectName, (app::X509CertificateBuilder * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB9F0, AsymmetricAlgorithm *, get_SubjectPublicKey, (app::X509CertificateBuilder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB40, Byte__Array *, get_IssuerUniqueId, (app::X509CertificateBuilder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB50, void, set_IssuerUniqueId, (app::X509CertificateBuilder * this_ptr, app::Byte__Array * value));
IL2CPP_REGISTER_METHOD(0x002FBB60, Byte__Array *, get_SubjectUniqueId, (app::X509CertificateBuilder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB70, void, set_SubjectUniqueId, (app::X509CertificateBuilder * this_ptr, app::Byte__Array * value));
IL2CPP_REGISTER_METHOD(0x002FBB80, X509ExtensionCollection_1 *, get_Extensions, (app::X509CertificateBuilder * this_ptr));
IL2CPP_REGISTER_METHOD(0x0293DED0, ASN1_1 *, SubjectPublicKeyInfo, (app::X509CertificateBuilder * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0478CEA0, X509CertificateBuilder_SubjectPublicKeyInfo__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0293E7A0, Byte__Array *, UniqueIdentifier, (app::X509CertificateBuilder * this_ptr, app::Byte__Array * id));
IL2CPP_REGISTER_METHOD(0x0293E940, ASN1_1 *, ToBeSigned, (app::X509CertificateBuilder * this_ptr, app::String * oid));
}
