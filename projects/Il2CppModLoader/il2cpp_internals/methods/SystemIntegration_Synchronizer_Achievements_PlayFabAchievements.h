...
namespace app::methods::SystemIntegration_Synchronizer_Achievements::PlayFabAchievements {
IL2CPP_REGISTER_METHOD(0x0052C5D0, String *, get_Name, (app::PlayFabAchievements * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB930, CacheData__Array *, AwardedOnServer, (app::PlayFabAchievements * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0052DD00, void, __ctor, (app::PlayFabAchievements * this_ptr));
}
