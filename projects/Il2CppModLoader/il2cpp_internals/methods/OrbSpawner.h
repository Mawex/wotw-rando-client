...
namespace app::methods::OrbSpawner {
    ...
    IL2CPP_REGISTER_METHOD(0x0061B850, void, SpawnExpOrbs, (app::OrbSpawner * this_ptr, int32_t amount, app::Vector2 force, app::int32_t* spawned_orb_index));
    IL2CPP_REGISTER_METHOD(0x0061B9F0, void, SpawnHealthOrbs, (app::OrbSpawner * this_ptr, app::Vector2 force, app::int32_t* spawned_orb_index));
    IL2CPP_REGISTER_METHOD(0x0061BA70, void, SpawnEnergyOrbs, (app::OrbSpawner * this_ptr, app::Vector2 force, app::int32_t* spawned_orb_index));
    ...
    IL2CPP_REGISTER_METHOD(0x0061CC30, void, __ctor, (app::OrbSpawner * this_ptr));
} // namespace app::methods::OrbSpawner
