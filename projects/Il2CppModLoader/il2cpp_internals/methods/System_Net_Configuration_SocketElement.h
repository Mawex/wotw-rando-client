...
namespace app::methods::System_Net_Configuration::SocketElement {
IL2CPP_REGISTER_METHOD(0x01E99320, void, __ctor, (app::SocketElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E99410, IPProtectionLevel__Enum, get_IPProtectionLevel, (app::SocketElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E99470, ConfigurationPropertyCollection *, get_Properties, (app::SocketElement * this_ptr));
