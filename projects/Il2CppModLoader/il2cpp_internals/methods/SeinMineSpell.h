...
namespace app::methods::SeinMineSpell {
    ...
    IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement*, get_PlatformMovement, (app::SeinMineSpell * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x008ADAC0, void, __ctor, (app::SeinMineSpell * this_ptr));
} // namespace app::methods::SeinMineSpell
