...
IL2CPP_REGISTER_METHOD(0x0049F2B0, VolumeEntityMovementProcessor *, get_VolumeMovement, (app::VolumeEntityLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x01199DC0, Transform *, get_FeetTransform, (app::VolumeEntityLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x01199DF0, Vector3, get_FeetPosition, (app::VolumeEntityLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00974AE0, EntityWeightData_EntityWeight__Enum, get_Weight, (app::VolumeEntityLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00418200, EntityLocomotionTask *, get_DefaultFSMState, (app::VolumeEntityLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0119B2E0, EntityLocomotionTask *, GetNextBehaviour, (app::VolumeEntityLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0119CA30, Vector2, get_LookDirection, (app::VolumeEntityLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x0119CC70, Vector2, get_LookDirectionXYNormalized, (app::VolumeEntityLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0049F2B0, MovementProcessor *, get_MovementProcessor, (app::VolumeEntityLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F1990, void, __ctor, (app::VolumeEntityLocomotion * this_ptr));
