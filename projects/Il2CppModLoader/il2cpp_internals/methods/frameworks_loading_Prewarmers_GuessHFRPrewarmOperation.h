...
namespace app::methods::frameworks_loading_Prewarmers::GuessHFRPrewarmOperation {
    IL2CPP_REGISTER_METHOD(0x00F5FF40, void, __ctor, (app::GuessHFRPrewarmOperation * this_ptr));
