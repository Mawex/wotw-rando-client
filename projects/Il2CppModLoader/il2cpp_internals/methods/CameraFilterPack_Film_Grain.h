...
IL2CPP_REGISTER_METHOD(0x02476A10, Material *, get_material, (app::CameraFilterPack_Film_Grain * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02477280, void, __ctor, (app::CameraFilterPack_Film_Grain * this_ptr));
}
