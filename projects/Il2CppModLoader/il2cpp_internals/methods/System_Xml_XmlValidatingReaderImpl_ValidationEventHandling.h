...
namespace app::methods::System_Xml::XmlValidatingReaderImpl_ValidationEventHandling {
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::XmlValidatingReaderImpl_ValidationEventHandling * this_ptr, app::XmlValidatingReaderImpl * reader));
IL2CPP_REGISTER_METHOD(0x002FB930, Object *, IValidationEventHandling_get_EventHandler, (app::XmlValidatingReaderImpl_ValidationEventHandling * this_ptr));
