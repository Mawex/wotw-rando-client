...
namespace app::methods::Moon_BehaviourSystem::PositionInBoxColliderCondition {
IL2CPP_REGISTER_METHOD(0x00CBAB10, String *, get_Info, (app::PositionInBoxColliderCondition * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CB75E0, void, __ctor, (app::PositionInBoxColliderCondition * this_ptr));
}
