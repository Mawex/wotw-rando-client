...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_Int32_System_String_ {
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_System_Int32_System_String_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0283B2B0, Dictionary_2_TKey_TValue_KeyCollection_System_Int32_System_String_ *, get_Keys, (app::Dictionary_2_System_Int32_System_String_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04787688, Dictionary_2_System_Int32_System_String__get_Keys__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02BB8880, String *, get_Item, (app::Dictionary_2_System_Int32_System_String_ * this_ptr, int32_t key));
...
IL2CPP_REGISTER_METHOD(0x0283B3E0, Dictionary_2_TKey_TValue_ValueCollection_System_Int32_System_String_ *, get_Values, (app::Dictionary_2_System_Int32_System_String_ * this_ptr));
