...
namespace app::methods::System_Collections_Generic::List_1_SpiritTurret_ {
...
IL2CPP_REGISTER_METHOD(0x025EFC50, SpiritTurret *, get_Item, (app::List_1_SpiritTurret_ * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x04793798, List_1_SpiritTurret__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_SpiritTurret_ * this_ptr));
