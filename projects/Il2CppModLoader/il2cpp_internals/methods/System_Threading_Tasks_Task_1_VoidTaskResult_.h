...
IL2CPP_REGISTER_METHOD(0x02A5CCE0, Task_1_VoidTaskResult_ *, StartNew_1, (app::Task * parent, app::Func_1_System_Threading_Tasks_VoidTaskResult_ * function, app::CancellationToken cancellation_token, app::TaskCreationOptions__Enum creation_options, app::InternalTaskOptions__Enum internal_options, app::TaskScheduler * scheduler, app::StackCrawlMark__Enum * stack_mark));
IL2CPP_REGISTER_METHODINFO(0x0474ECA0, Task_1_VoidTaskResult__StartNew__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02A5CFF0, Task_1_VoidTaskResult_ *, StartNew_2, (app::Task * parent, app::Func_2_Object_System_Threading_Tasks_VoidTaskResult_ * function, app::Object * state, app::CancellationToken cancellation_token, app::TaskCreationOptions__Enum creation_options, app::InternalTaskOptions__Enum internal_options, app::TaskScheduler * scheduler, app::StackCrawlMark__Enum * stack_mark));
IL2CPP_REGISTER_METHODINFO(0x04789A18, Task_1_VoidTaskResult__StartNew_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02A5D300, String *, get_DebuggerDisplayResultDescription, (app::Task_1_VoidTaskResult_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A5D3F0, String *, get_DebuggerDisplayMethodDescription, (app::Task_1_VoidTaskResult_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0277F770, void, DangerousSetResult, (app::Task_1_VoidTaskResult_ * this_ptr, app::VoidTaskResult result));
IL2CPP_REGISTER_METHOD(0x0277F7C0, VoidTaskResult, get_Result, (app::Task_1_VoidTaskResult_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x004430B0, VoidTaskResult, get_ResultOnSuccess, (app::Task_1_VoidTaskResult_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0277F810, VoidTaskResult, GetResultCore, (app::Task_1_VoidTaskResult_ * this_ptr, bool wait_completion_notification));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, TaskAwaiter_1_System_Threading_Tasks_VoidTaskResult_, GetAwaiter, (app::Task_1_VoidTaskResult_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0277FBD0, ConfiguredTaskAwaitable_1_System_Threading_Tasks_VoidTaskResult_, ConfigureAwait, (app::Task_1_VoidTaskResult_ * this_ptr, bool continue_on_captured_context));
IL2CPP_REGISTER_METHOD(0x02A5D590, Task *, ContinueWith_1, (app::Task_1_VoidTaskResult_ * this_ptr, app::Action_1_System_Threading_Tasks_Task_1__9 * continuation_action));
IL2CPP_REGISTER_METHOD(0x02A5D690, Task *, ContinueWith_2, (app::Task_1_VoidTaskResult_ * this_ptr, app::Action_1_System_Threading_Tasks_Task_1__9 * continuation_action, app::TaskScheduler * scheduler, app::CancellationToken cancellation_token, app::TaskContinuationOptions__Enum continuation_options, app::StackCrawlMark__Enum * stack_mark));
