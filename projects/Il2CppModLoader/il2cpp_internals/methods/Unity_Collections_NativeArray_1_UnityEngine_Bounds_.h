...
namespace app::methods::Unity_Collections::NativeArray_1_UnityEngine_Bounds_ {
IL2CPP_REGISTER_METHOD(0x001DF770, void, __ctor, (app::NativeArray_1_UnityEngine_Bounds___Boxed * this_ptr, int32_t length, app::Allocator__Enum allocator, app::NativeArrayOptions__Enum options));
...
IL2CPP_REGISTER_METHOD(0x001DFEF0, Bounds, get_Item, (app::NativeArray_1_UnityEngine_Bounds___Boxed * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x001DFA50, Bounds__Array *, ToArray, (app::NativeArray_1_UnityEngine_Bounds___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001DFB30, NativeArray_1_T_Enumerator_UnityEngine_Bounds_, GetEnumerator, (app::NativeArray_1_UnityEngine_Bounds___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001DFB90, IEnumerator_1_UnityEngine_Bounds_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::NativeArray_1_UnityEngine_Bounds___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001DFC30, IEnumerator *, IEnumerable_GetEnumerator, (app::NativeArray_1_UnityEngine_Bounds___Boxed * this_ptr));
