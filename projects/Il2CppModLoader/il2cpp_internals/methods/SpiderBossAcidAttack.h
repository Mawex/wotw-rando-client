...
IL2CPP_REGISTER_METHOD(0x009634D0, BehaviourStatus__Enum, OnExecute, (app::SpiderBossAcidAttack * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00964E80, void, __ctor, (app::SpiderBossAcidAttack * this_ptr));
}
