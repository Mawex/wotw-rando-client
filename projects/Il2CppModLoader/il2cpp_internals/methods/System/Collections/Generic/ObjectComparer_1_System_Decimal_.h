...
namespace app::methods::System::Collections::Generic::ObjectComparer_1_System_Decimal_ {
    ...
    IL2CPP_REGISTER_METHOD(0x019F8810, void, __ctor, (app::ObjectComparer_1_System_Decimal_ * this_ptr));
}
