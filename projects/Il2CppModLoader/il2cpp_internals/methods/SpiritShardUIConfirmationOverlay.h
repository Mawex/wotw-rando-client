...
IL2CPP_REGISTER_METHOD(0x003FF610, SpiritShardUIConfirmationOverlay_Context__Enum, get_CurrentContext, (app::SpiritShardUIConfirmationOverlay * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D6C0E0, void, __ctor, (app::SpiritShardUIConfirmationOverlay * this_ptr));
}
