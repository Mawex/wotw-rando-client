...
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_AnimationName, (app::GhostAnimationData * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_1, (app::GhostAnimationData * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor_2, (app::GhostAnimationData * this_ptr, app::String * animation_name));
...
IL2CPP_REGISTER_METHOD(0x00E13080, GhostFrame_FrameDataTypes__Enum, get_FrameType, (app::GhostAnimationData * this_ptr));
