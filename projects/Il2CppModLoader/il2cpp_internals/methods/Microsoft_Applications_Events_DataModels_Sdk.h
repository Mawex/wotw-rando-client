...
namespace app::methods::Microsoft_Applications_Events_DataModels::Sdk {
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_libVer, (app::Sdk * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_libVer, (app::Sdk * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_epoch, (app::Sdk * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, get_installId, (app::Sdk * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB10, void, set_installId, (app::Sdk * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::Sdk * this_ptr));
}
