...
namespace app::methods::Newtonsoft_Json_Converters::BinaryConverter {
...
IL2CPP_REGISTER_METHOD(0x01A4D4A0, Byte__Array *, GetByteArray, (app::BinaryConverter_1 * this_ptr, app::Object * value));
...
IL2CPP_REGISTER_METHOD(0x01A4D8F0, Object *, ReadJson, (app::BinaryConverter_1 * this_ptr, app::JsonReader * reader, app::Type * object_type, app::Object * existing_value, app::JsonSerializer * serializer));
IL2CPP_REGISTER_METHODINFO(0x04769C28, BinaryConverter_1_ReadJson__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A4DD80, Byte__Array *, ReadByteArray, (app::BinaryConverter_1 * this_ptr, app::JsonReader * reader));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::BinaryConverter_1 * this_ptr));
}
