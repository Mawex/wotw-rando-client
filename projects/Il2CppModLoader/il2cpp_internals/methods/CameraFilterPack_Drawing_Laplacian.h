...
IL2CPP_REGISTER_METHOD(0x024F2680, Material *, get_material, (app::CameraFilterPack_Drawing_Laplacian * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0136E200, void, __ctor, (app::CameraFilterPack_Drawing_Laplacian * this_ptr));
}
