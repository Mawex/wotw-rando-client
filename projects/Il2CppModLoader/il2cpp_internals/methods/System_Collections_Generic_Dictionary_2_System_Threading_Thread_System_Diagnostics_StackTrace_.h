...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_Threading_Thread_System_Diagnostics_StackTrace_ {
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_System_Threading_Thread_System_Diagnostics_StackTrace_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BD24D0, StackTrace *, get_Item, (app::Dictionary_2_System_Threading_Thread_System_Diagnostics_StackTrace_ * this_ptr, app::Thread * key));
