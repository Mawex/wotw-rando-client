...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::KeyEvents {
IL2CPP_REGISTER_METHOD(0x002FB930, List_1_UnityEngine_Event_ *, get_Events, (app::KeyEvents * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01DE7E60, void, __ctor, (app::KeyEvents * this_ptr));
