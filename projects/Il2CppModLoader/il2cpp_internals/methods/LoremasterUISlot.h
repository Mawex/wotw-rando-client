...
IL2CPP_REGISTER_METHOD(0x002FBB60, ReplaySetting *, get_ReplaySetting, (app::LoremasterUISlot * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::LoremasterUISlot * this_ptr));
}
