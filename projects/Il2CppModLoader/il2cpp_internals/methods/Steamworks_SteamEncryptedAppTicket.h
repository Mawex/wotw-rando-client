...
IL2CPP_REGISTER_METHOD(0x016022C0, bool, BDecryptTicket, (app::Byte__Array * rgub_ticket_encrypted, uint32_t cub_ticket_encrypted, app::Byte__Array * rgub_ticket_decrypted, app::uint32_t * pcub_ticket_decrypted, app::Byte__Array * rgub_key, int32_t cub_key));
...
IL2CPP_REGISTER_METHOD(0x027E9A40, Byte__Array *, GetUserVariableData, (app::Byte__Array * rgub_ticket_decrypted, uint32_t cub_ticket_decrypted, app::uint32_t * pcub_user_data));
