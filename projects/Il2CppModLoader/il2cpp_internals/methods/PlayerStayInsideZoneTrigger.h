...
IL2CPP_REGISTER_METHOD(0x00886330, Rect, get_Bounds, (app::PlayerStayInsideZoneTrigger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0142E7E0, Vector3, GetSize, (app::PlayerStayInsideZoneTrigger * this_ptr));
IL2CPP_REGISTER_METHOD(0x0142EA60, void, __ctor, (app::PlayerStayInsideZoneTrigger * this_ptr));
}
