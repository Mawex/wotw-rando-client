...
IL2CPP_REGISTER_METHOD(0x00EC1200, Vector3, get_DashTargetPosition, (app::SandWormDashBehaviourNew * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00EC1D20, BehaviourStatus__Enum, OnExecute, (app::SandWormDashBehaviourNew * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00EC24A0, SandWormSandDigLocomotionBehaviour_SpeedEntry, GetSpeedSetting, (app::SandWormDashBehaviourNew * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00EC26B0, BehaviourStatus__Enum, OnAnticUpdate, (app::SandWormDashBehaviourNew * this_ptr, float d_time));
IL2CPP_REGISTER_METHOD(0x00EC2960, BehaviourStatus__Enum, OnDashUpdate, (app::SandWormDashBehaviourNew * this_ptr, float d_time));
IL2CPP_REGISTER_METHOD(0x00EC2BB0, BehaviourStatus__Enum, OnResolveUpdate, (app::SandWormDashBehaviourNew * this_ptr, float d_time));
IL2CPP_REGISTER_METHOD(0x00EC2C10, void, __ctor, (app::SandWormDashBehaviourNew * this_ptr));
}
