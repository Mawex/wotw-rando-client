...
IL2CPP_REGISTER_METHOD(0x00A2E940, Material *, get_Mat, (app::LegacyMaterialTransparencyAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A2F2D0, void, __ctor, (app::LegacyMaterialTransparencyAnimator * this_ptr));
}
