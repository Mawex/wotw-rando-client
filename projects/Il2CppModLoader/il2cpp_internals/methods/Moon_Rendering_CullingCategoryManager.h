...
namespace app::methods::Moon_Rendering::CullingCategoryManager {
IL2CPP_REGISTER_METHOD(0x00C53A00, void, __ctor, (app::CullingCategoryManager * this_ptr, app::CullingCategory__Enum mask, bool needs_list, bool per_slice));
IL2CPP_REGISTER_METHOD(0x002FA280, RendererCullingCategoryParameters, ICullingCategoryManager_get_Parameters, (app::CullingCategoryManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C3DD30, RendererCullingCategoryResults, get_lastResults, (app::CullingCategoryManager * this_ptr));
