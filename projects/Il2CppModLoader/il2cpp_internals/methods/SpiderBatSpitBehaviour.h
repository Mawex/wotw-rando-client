...
IL2CPP_REGISTER_METHOD(0x00960D80, BehaviourStatus__Enum, OnExecute, (app::SpiderBatSpitBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00961C50, void, __ctor, (app::SpiderBatSpitBehaviour * this_ptr));
}
