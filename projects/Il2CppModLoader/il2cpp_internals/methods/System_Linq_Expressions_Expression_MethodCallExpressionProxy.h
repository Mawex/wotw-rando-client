...
namespace app::methods::System_Linq_Expressions::Expression_MethodCallExpressionProxy {
    IL2CPP_REGISTER_METHOD(0x022C71E0, void, __ctor, (app::Expression_MethodCallExpressionProxy * this_ptr, app::MethodCallExpression * node));
