...
IL2CPP_REGISTER_METHOD(0x01385BC0, GameObject *, get_EffectiveCollectedEffect, (app::MaxEnergyHalfContainerPickup * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005AC260, void, __ctor, (app::MaxEnergyHalfContainerPickup * this_ptr));
}
