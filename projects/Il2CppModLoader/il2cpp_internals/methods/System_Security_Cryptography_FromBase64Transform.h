...
namespace app::methods::System_Security_Cryptography::FromBase64Transform {
...
IL2CPP_REGISTER_METHOD(0x020D8380, Byte__Array *, TransformFinalBlock, (app::FromBase64Transform * this_ptr, app::Byte__Array * input_buffer, int32_t input_offset, int32_t input_count));
IL2CPP_REGISTER_METHODINFO(0x04760FD8, FromBase64Transform_TransformFinalBlock__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020D8730, Byte__Array *, DiscardWhiteSpaces, (app::FromBase64Transform * this_ptr, app::Byte__Array * input_buffer, int32_t input_offset, int32_t input_count));
