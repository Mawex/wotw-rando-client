...
IL2CPP_REGISTER_METHOD(0x002FBC00, EntityEvent *, get_ReactionEvent, (app::EntityReactionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005B3EC0, void, __ctor, (app::EntityReactionBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x015E8300, Object *, GetReactionEvent_1, (app::EntityReactionBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x015E8300, EntityDeathEvent *, GetReactionEvent_2, (app::EntityReactionBehaviour * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04723360, EntityReactionBehaviour_GetReactionEvent_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015E8300, EntityDamageEvent *, GetReactionEvent_3, (app::EntityReactionBehaviour * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047657D8, EntityReactionBehaviour_GetReactionEvent_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015E8300, EntityKickbackEvent *, GetReactionEvent_4, (app::EntityReactionBehaviour * this_ptr));
