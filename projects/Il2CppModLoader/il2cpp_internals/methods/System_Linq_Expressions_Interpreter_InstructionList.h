...
namespace app::methods::System_Linq_Expressions_Interpreter::InstructionList {
...
IL2CPP_REGISTER_METHOD(0x01CD81A0, Instruction *, GetInstruction, (app::InstructionList * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x01CD8250, InstructionArray, ToArray, (app::InstructionList * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01CDDD60, Instruction *, GetLoadField, (app::InstructionList * this_ptr, app::FieldInfo_1 * field));
...
IL2CPP_REGISTER_METHOD(0x01CDE6C0, RuntimeLabel__Array *, BuildRuntimeLabels, (app::InstructionList * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CDE920, BranchLabel *, MakeLabel, (app::InstructionList * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01CDFCE0, EnterTryFaultInstruction *, EmitEnterTryFault, (app::InstructionList * this_ptr, app::BranchLabel * try_end));
...
IL2CPP_REGISTER_METHOD(0x01CE0690, void, __ctor, (app::InstructionList * this_ptr));
