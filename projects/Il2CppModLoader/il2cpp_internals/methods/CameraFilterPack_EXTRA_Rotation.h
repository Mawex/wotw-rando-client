...
IL2CPP_REGISTER_METHOD(0x024623D0, Material *, get_material, (app::CameraFilterPack_EXTRA_Rotation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02462D30, void, __ctor, (app::CameraFilterPack_EXTRA_Rotation * this_ptr));
}
