...
IL2CPP_REGISTER_METHOD(0x002FBBC0, Transform *, get_FollowedTarget, (app::TargetBreadcrumbsTracker * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CE1B20, Vector3, NewestPoint, (app::TargetBreadcrumbsTracker * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CE1BE0, Vector3, OldestPoint, (app::TargetBreadcrumbsTracker * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B68B50, Vector3, DefaultProcessAddedPointFunction, (app::TargetBreadcrumbsTracker * this_ptr, app::Vector3 point));
...
IL2CPP_REGISTER_METHOD(0x00CE1FD0, void, __ctor, (app::TargetBreadcrumbsTracker * this_ptr));
}
