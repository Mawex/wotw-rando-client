...
namespace app::methods::System_Linq_Expressions_Interpreter::MulOvfInstruction_MulOvfUInt32 {
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MulOvfInstruction_MulOvfUInt32 * this_ptr));
}
