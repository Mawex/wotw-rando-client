...
IL2CPP_REGISTER_METHOD(0x00417920, GhostRecorder_GhostPluginRecordingType__Enum, GetRecordingType, (app::GhostStateMachinePlugin * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007E59B0, void, __ctor, (app::GhostStateMachinePlugin * this_ptr));
