...
IL2CPP_REGISTER_METHOD(0x00FC3080, IEnumerator *, PerformActionCoroutine, (app::LockPlayerInputAction * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0043BB90, void, __ctor, (app::LockPlayerInputAction * this_ptr));
}
