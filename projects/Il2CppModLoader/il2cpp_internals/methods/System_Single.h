...
IL2CPP_REGISTER_METHOD(0x001D4A30, String *, ToString_1, (app::Single__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001D4A60, String *, ToString_2, (app::Single__Boxed * this_ptr, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHOD(0x001D4AA0, String *, ToString_3, (app::Single__Boxed * this_ptr, app::String * format));
IL2CPP_REGISTER_METHOD(0x001D4AE0, String *, ToString_4, (app::Single__Boxed * this_ptr, app::String * format, app::IFormatProvider * provider));
...
IL2CPP_REGISTER_METHOD(0x01E26470, bool, TryParse_1, (app::String * s, app::float * result));
IL2CPP_REGISTER_METHOD(0x01E264B0, bool, TryParse_2, (app::String * s, app::NumberStyles__Enum style, app::IFormatProvider * provider, app::float * result));
IL2CPP_REGISTER_METHOD(0x01E26510, bool, TryParse_3, (app::String * s, app::NumberStyles__Enum style, app::NumberFormatInfo * info, app::float * result));
IL2CPP_REGISTER_METHOD(0x001D4B20, TypeCode__Enum, GetTypeCode, (app::Single__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x001D5630, Decimal, IConvertible_ToDecimal, (app::Single__Boxed * this_ptr, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHOD(0x001D5790, DateTime, IConvertible_ToDateTime, (app::Single__Boxed * this_ptr, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHODINFO(0x04711AC0, Single_System_IConvertible_ToDateTime__MethodInfo);
IL2CPP_REGISTER_METHOD(0x001D57A0, Object *, IConvertible_ToType, (app::Single__Boxed * this_ptr, app::Type * type, app::IFormatProvider * provider));
}
