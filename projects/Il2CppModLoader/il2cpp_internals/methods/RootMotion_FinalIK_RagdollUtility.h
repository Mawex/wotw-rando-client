...
namespace app::methods::RootMotion_FinalIK::RagdollUtility {
...
IL2CPP_REGISTER_METHOD(0x02A1A430, IEnumerator *, DisableRagdollSmooth, (app::RagdollUtility * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A1B830, void, __ctor, (app::RagdollUtility * this_ptr));
}
