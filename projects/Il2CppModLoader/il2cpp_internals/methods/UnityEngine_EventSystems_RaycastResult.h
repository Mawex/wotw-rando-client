...
namespace app::methods::UnityEngine_EventSystems::RaycastResult {
IL2CPP_REGISTER_METHOD(0x001D9820, GameObject *, get_gameObject, (app::RaycastResult__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x001D9970, String *, ToString, (app::RaycastResult__Boxed * this_ptr));
}
