...
IL2CPP_REGISTER_METHOD(0x004A1A90, void, __ctor, (app::PetrifiedOwlBossDiveBombVerticalBehaviour_PostAttackState * this_ptr, app::PetrifiedOwlBossDiveBombVerticalBehaviour * behaviour));
