...
namespace app::methods::Moon_Telemetry_Performance_Settings::InstantiationProfilingProfilingSetting {
IL2CPP_REGISTER_METHOD(0x007EC3F0, ProfilingSettings_SettingType__Enum, get_SettingType, (app::InstantiationProfilingProfilingSetting * this_ptr));
