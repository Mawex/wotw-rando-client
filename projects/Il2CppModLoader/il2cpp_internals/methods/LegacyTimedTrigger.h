...
IL2CPP_REGISTER_METHOD(0x003FF610, SuspendableMask__Enum, get_Mask, (app::LegacyTimedTrigger * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A3C920, void, set_Mask, (app::LegacyTimedTrigger * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x00A3C9D0, void, __ctor, (app::LegacyTimedTrigger * this_ptr));
}
