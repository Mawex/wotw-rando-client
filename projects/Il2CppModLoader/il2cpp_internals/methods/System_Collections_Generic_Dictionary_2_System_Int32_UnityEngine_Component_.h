...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_Int32_UnityEngine_Component_ {
...
IL2CPP_REGISTER_METHOD(0x02BB8880, Component_1 *, get_Item, (app::Dictionary_2_System_Int32_UnityEngine_Component_ * this_ptr, int32_t key));
