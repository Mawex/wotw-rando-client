...
IL2CPP_REGISTER_METHOD(0x02750C30, Material *, get_material, (app::CameraFilterPack_Blend2Camera_Lighten * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02751E00, void, __ctor, (app::CameraFilterPack_Blend2Camera_Lighten * this_ptr));
}
