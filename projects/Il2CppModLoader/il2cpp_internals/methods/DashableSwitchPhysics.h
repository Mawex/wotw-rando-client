...
IL2CPP_REGISTER_METHOD(0x002FB990, IMoonSetupLogic *, get_MoonSetupLogic, (app::DashableSwitchPhysics * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::DashableSwitchPhysics * this_ptr));
}
