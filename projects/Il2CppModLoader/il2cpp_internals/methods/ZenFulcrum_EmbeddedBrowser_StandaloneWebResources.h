...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::StandaloneWebResources {
IL2CPP_REGISTER_METHOD(0x0166CDC0, void, __ctor, (app::StandaloneWebResources * this_ptr, app::String * data_file));
