...
namespace app::methods::System_Configuration::SettingsPropertyCollection {
IL2CPP_REGISTER_METHOD(0x02963130, void, __ctor, (app::SettingsPropertyCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x029631C0, SettingsProperty *, get_Item, (app::SettingsPropertyCollection * this_ptr, app::String * name));
IL2CPP_REGISTER_METHODINFO(0x047849D0, SettingsPropertyCollection_get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x029631F0, Object *, get_SyncRoot, (app::SettingsPropertyCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02963280, Object *, Clone, (app::SettingsPropertyCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x029632E0, IEnumerator *, GetEnumerator, (app::SettingsPropertyCollection * this_ptr));
