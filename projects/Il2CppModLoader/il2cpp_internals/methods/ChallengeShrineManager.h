...
IL2CPP_REGISTER_METHOD(0x003FFCE0, SuspendableMask__Enum, get_Mask, (app::ChallengeShrineManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x01044E30, void, set_Mask, (app::ChallengeShrineManager * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x01044EF0, void, __ctor, (app::ChallengeShrineManager * this_ptr));
}
