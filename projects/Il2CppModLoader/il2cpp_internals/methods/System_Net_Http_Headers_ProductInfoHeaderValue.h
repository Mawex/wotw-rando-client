...
namespace app::methods::System_Net_Http_Headers::ProductInfoHeaderValue {
IL2CPP_REGISTER_METHOD(0x02D13B10, void, __ctor_1, (app::ProductInfoHeaderValue * this_ptr, app::ProductHeaderValue * product));
IL2CPP_REGISTER_METHODINFO(0x0471BE88, ProductInfoHeaderValue__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_2, (app::ProductInfoHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_Comment, (app::ProductInfoHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_Comment, (app::ProductInfoHeaderValue * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB930, ProductHeaderValue *, get_Product, (app::ProductInfoHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_Product, (app::ProductInfoHeaderValue * this_ptr, app::ProductHeaderValue * value));
IL2CPP_REGISTER_METHOD(0x0173F610, Object *, ICloneable_Clone, (app::ProductInfoHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D144F0, String *, ToString, (app::ProductInfoHeaderValue * this_ptr));
}
