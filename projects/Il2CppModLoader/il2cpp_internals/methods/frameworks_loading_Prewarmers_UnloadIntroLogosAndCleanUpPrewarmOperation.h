...
namespace app::methods::frameworks_loading_Prewarmers::UnloadIntroLogosAndCleanUpPrewarmOperation {
IL2CPP_REGISTER_METHOD(0x00F62740, void, __ctor, (app::UnloadIntroLogosAndCleanUpPrewarmOperation * this_ptr));
