...
IL2CPP_REGISTER_METHOD(0x008F83A0, FieldInfo_1 *, GetFieldInfo, (app::RecorderPlaybackUIInspector * this_ptr, app::AbilitiesData * abilities_data));
...
IL2CPP_REGISTER_METHOD(0x008F9140, void, __ctor, (app::RecorderPlaybackUIInspector * this_ptr));
}
