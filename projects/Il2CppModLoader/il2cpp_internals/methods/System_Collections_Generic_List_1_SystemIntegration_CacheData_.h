...
namespace app::methods::System_Collections_Generic::List_1_SystemIntegration_CacheData_ {
IL2CPP_REGISTER_METHOD(0x025EAEF0, CacheData__Array *, ToArray, (app::List_1_SystemIntegration_CacheData_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04789BF0, List_1_SystemIntegration_CacheData__ToArray__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_SystemIntegration_CacheData_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_SystemIntegration_CacheData_, GetEnumerator, (app::List_1_SystemIntegration_CacheData_ * this_ptr));
