...
IL2CPP_REGISTER_METHOD(0x00597B10, UpdateType__Enum, get_UpdateType, (app::UberShaderRuntimeUpdate * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00998570, SuspendableMask__Enum, get_Mask, (app::UberShaderRuntimeUpdate * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01287370, Vector2, RotateVector, (app::Vector2 vec, float rotation));
IL2CPP_REGISTER_METHOD(0x01287470, Vector2, RotateVectorAroundPoint, (app::Vector2 point_to_rotate, app::Vector2 center_point, float angle_in_degrees));
...
IL2CPP_REGISTER_METHOD(0x01287920, void, __ctor, (app::UberShaderRuntimeUpdate * this_ptr));
}
