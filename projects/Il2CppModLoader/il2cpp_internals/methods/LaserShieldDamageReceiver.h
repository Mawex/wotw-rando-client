...
IL2CPP_REGISTER_METHOD(0x00F08460, Vector3, get_AnchorLocalPosition, (app::LaserShieldDamageReceiver * this_ptr));
IL2CPP_REGISTER_METHOD(0x00F08480, Quaternion, get_AnchorLocalRotation, (app::LaserShieldDamageReceiver * this_ptr));
IL2CPP_REGISTER_METHOD(0x00F08490, Vector3, get_DirectonToCenter, (app::LaserShieldDamageReceiver * this_ptr));
IL2CPP_REGISTER_METHOD(0x00F08530, Vector3, get_IndividualHitLocalPositionOffset, (app::LaserShieldDamageReceiver * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F08570, Vector3, get_SharedLocalPositionOffset, (app::LaserShieldDamageReceiver * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F085B0, Vector3, get_SharedWorldPositionOffset, (app::LaserShieldDamageReceiver * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F085F0, Transform *, get_Pivot, (app::LaserShieldDamageReceiver * this_ptr));
IL2CPP_REGISTER_METHOD(0x00F086A0, Transform *, get_CircleRotator, (app::LaserShieldDamageReceiver * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F0A8C0, void, __ctor, (app::LaserShieldDamageReceiver * this_ptr));
}
