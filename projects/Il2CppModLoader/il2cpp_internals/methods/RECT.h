...
namespace app::methods::RECT {
    IL2CPP_REGISTER_METHOD(0x0011FC50, void, __ctor, (app::RECT__Boxed * this_ptr, int32_t left, int32_t top, int32_t right, int32_t bottom));
    ...
    operator == (app::RECT r1, app::RECT r2) {
