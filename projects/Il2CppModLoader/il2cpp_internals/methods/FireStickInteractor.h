...
IL2CPP_REGISTER_METHOD(0x0125C7A0, FireStick *, GetFireStick, (app::FireStickInteractor * this_ptr, app::Collider * collider));
IL2CPP_REGISTER_METHOD(0x0125C980, void, ShowMessage, (app::FireStickInteractor * this_ptr));
IL2CPP_REGISTER_METHOD(0x0125CB70, String *, get_StressTestName, (app::FireStickInteractor * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FD490, StressTestStatus__Enum, get_StressTestStatus, (app::FireStickInteractor * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::FireStickInteractor * this_ptr));
}
