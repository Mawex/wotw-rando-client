...
namespace app::methods::SeinAbilities {
    IL2CPP_REGISTER_METHOD(0x004173F0, SeinDoubleJump*, get_DoubleJump, (app::SeinAbilities * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01072410, void, set_DoubleJump, (app::SeinAbilities * this_ptr, app::SeinDoubleJump* value));
    IL2CPP_REGISTER_METHOD(0x005E0120, SeinJump*, get_Jump, (app::SeinAbilities * this_ptr));
    IL2CPP_REGISTER_METHOD(0x010724C0, void, set_Jump, (app::SeinAbilities * this_ptr, app::SeinJump* value));
    IL2CPP_REGISTER_METHOD(0x005E01F0, SeinWallJump*, get_WallJump, (app::SeinAbilities * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01072570, void, set_WallJump, (app::SeinAbilities * this_ptr, app::SeinWallJump* value));
    IL2CPP_REGISTER_METHOD(0x005E02C0, SeinChargeJumpCharging*, get_ChargeJumpCharging, (app::SeinAbilities * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01074170, SeinSpiritFlameTargetting*, get_SpiritFlameTargetting, (app::SeinAbilities * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01075A80, void, __ctor, (app::SeinAbilities * this_ptr));
} // namespace app::methods::SeinAbilities
