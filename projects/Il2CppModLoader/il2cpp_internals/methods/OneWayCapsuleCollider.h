...
IL2CPP_REGISTER_METHOD(0x00616150, Vector3, get_CollisionDirection, (app::OneWayCapsuleCollider * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047725B8, OneWayCapsuleCollider_get_CollisionDirection__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00616370, Vector3, get_CapsuleDirection, (app::OneWayCapsuleCollider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00617040, void, __ctor, (app::OneWayCapsuleCollider * this_ptr));
}
