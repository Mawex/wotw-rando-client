...
namespace app::methods::System_IO::MemoryStream {
IL2CPP_REGISTER_METHOD(0x02370060, void, __ctor_1, (app::MemoryStream * this_ptr));
IL2CPP_REGISTER_METHOD(0x02370070, void, __ctor_2, (app::MemoryStream * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHODINFO(0x04755540, MemoryStream__ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02370180, void, __ctor_3, (app::MemoryStream * this_ptr, app::Byte__Array * buffer));
IL2CPP_REGISTER_METHOD(0x02370290, void, __ctor_4, (app::MemoryStream * this_ptr, app::Byte__Array * buffer, bool writable));
IL2CPP_REGISTER_METHODINFO(0x04774B48, MemoryStream__ctor_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x023703B0, void, __ctor_5, (app::MemoryStream * this_ptr, app::Byte__Array * buffer, int32_t index, int32_t count));
IL2CPP_REGISTER_METHOD(0x023703E0, void, __ctor_6, (app::MemoryStream * this_ptr, app::Byte__Array * buffer, int32_t index, int32_t count, bool writable, bool publicly_visible));
...
IL2CPP_REGISTER_METHOD(0x02370770, Task *, FlushAsync, (app::MemoryStream * this_ptr, app::CancellationToken cancellation_token));
IL2CPP_REGISTER_METHOD(0x023708B0, Byte__Array *, GetBuffer, (app::MemoryStream * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04742A60, MemoryStream_GetBuffer__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FBB00, Byte__Array *, InternalGetBuffer, (app::MemoryStream * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x023710C0, Task_1_System_Int32_ *, ReadAsync, (app::MemoryStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::CancellationToken cancellation_token));
...
IL2CPP_REGISTER_METHOD(0x02371900, Byte__Array *, ToArray, (app::MemoryStream * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02371D40, Task *, WriteAsync, (app::MemoryStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::CancellationToken cancellation_token));
