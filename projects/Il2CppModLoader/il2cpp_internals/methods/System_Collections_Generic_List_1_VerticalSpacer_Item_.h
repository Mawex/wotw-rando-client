...
namespace app::methods::System_Collections_Generic::List_1_VerticalSpacer_Item_ {
IL2CPP_REGISTER_METHOD(0x02C1F070, List_1_T_Enumerator_VerticalSpacer_Item_, GetEnumerator, (app::List_1_VerticalSpacer_Item_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0473B478, List_1_VerticalSpacer_Item__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_VerticalSpacer_Item_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04700B88, List_1_VerticalSpacer_Item___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_VerticalSpacer_Item_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02C1D9C0, void, __ctor_3, (app::List_1_VerticalSpacer_Item_ * this_ptr, app::IEnumerable_1_VerticalSpacer_Item_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02C1DE50, Object *, ICollection_get_SyncRoot, (app::List_1_VerticalSpacer_Item_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02C1DFB0, VerticalSpacer_Item, get_Item, (app::List_1_VerticalSpacer_Item_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02C1E150, Object *, IList_get_Item, (app::List_1_VerticalSpacer_Item_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_VerticalSpacer_Item_ *, AsReadOnly, (app::List_1_VerticalSpacer_Item_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C1EA20, VerticalSpacer_Item, Find, (app::List_1_VerticalSpacer_Item_ * this_ptr, app::Predicate_1_VerticalSpacer_Item_ * match));
IL2CPP_REGISTER_METHOD(0x02C1EB60, List_1_VerticalSpacer_Item_ *, FindAll, (app::List_1_VerticalSpacer_Item_ * this_ptr, app::Predicate_1_VerticalSpacer_Item_ * match));
...
IL2CPP_REGISTER_METHOD(0x02C1F0C0, IEnumerator_1_VerticalSpacer_Item_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_VerticalSpacer_Item_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02C1F0C0, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_VerticalSpacer_Item_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_VerticalSpacer_Item_ *, GetRange, (app::List_1_VerticalSpacer_Item_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, VerticalSpacer_Item__Array *, ToArray, (app::List_1_VerticalSpacer_Item_ * this_ptr));
