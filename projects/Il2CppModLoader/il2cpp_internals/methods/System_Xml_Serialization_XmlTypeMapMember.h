...
namespace app::methods::System_Xml_Serialization::XmlTypeMapMember {
IL2CPP_REGISTER_METHOD(0x0194D4F0, void, __ctor, (app::XmlTypeMapMember * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_Name, (app::XmlTypeMapMember * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_Name, (app::XmlTypeMapMember * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB9F0, Object *, get_DefaultValue, (app::XmlTypeMapMember * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0194D780, Object *, GetValue_1, (app::Object * ob, app::String * name));
IL2CPP_REGISTER_METHOD(0x0194DA20, Object *, GetValue_2, (app::XmlTypeMapMember * this_ptr, app::Object * ob));
...
IL2CPP_REGISTER_METHOD(0x002FBB00, TypeData *, get_TypeData, (app::XmlTypeMapMember * this_ptr));
