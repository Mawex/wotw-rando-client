...
namespace app::methods::System_Collections_Generic::Dictionary_2_UnityEngine_KeyCode_System_Int32_ {
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_UnityEngine_KeyCode_System_Int32_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BAC6E0, Dictionary_2_TKey_TValue_Enumerator_UnityEngine_KeyCode_System_Int32_, GetEnumerator, (app::Dictionary_2_UnityEngine_KeyCode_System_Int32_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BB43A0, bool, TryGetValue, (app::Dictionary_2_UnityEngine_KeyCode_System_Int32_ * this_ptr, app::KeyCode__Enum key, app::int32_t * value));
