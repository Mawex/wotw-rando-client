...
namespace app::methods::System_Collections_Generic::KeyValuePair_2_Moon_ActiveAnimationHandle_System_Int32_ {
    IL2CPP_REGISTER_METHOD(0x0014F9F0, void, __ctor, (app::KeyValuePair_2_Moon_ActiveAnimationHandle_System_Int32___Boxed * this_ptr, app::ActiveAnimationHandle key, int32_t value));
