...
namespace app::methods::LaserPulsator {
    ...
    IL2CPP_REGISTER_METHOD(0x003FF610, SuspendableMask__Enum, get_Mask, (app::LaserPulsator * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00F08400, void, __ctor, (app::LaserPulsator * this_ptr));
} // namespace app::methods::LaserPulsator
