...
namespace app::methods::System_Text::EncoderReplacementFallbackBuffer {
IL2CPP_REGISTER_METHOD(0x0244EE60, void, __ctor, (app::EncoderReplacementFallbackBuffer * this_ptr, app::EncoderReplacementFallback * fallback));
