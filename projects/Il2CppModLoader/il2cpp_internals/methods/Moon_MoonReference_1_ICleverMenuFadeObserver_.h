...
IL2CPP_REGISTER_METHOD(0x02720AC0, ICleverMenuFadeObserver *, Resolve, (app::MoonReference_1_ICleverMenuFadeObserver_ * this_ptr, app::IMoonResolverContext * context));
