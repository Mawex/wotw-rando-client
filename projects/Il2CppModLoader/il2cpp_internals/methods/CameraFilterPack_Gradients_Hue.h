...
IL2CPP_REGISTER_METHOD(0x0247BB80, Material *, get_material, (app::CameraFilterPack_Gradients_Hue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0247C1A0, void, __ctor, (app::CameraFilterPack_Gradients_Hue * this_ptr));
}
