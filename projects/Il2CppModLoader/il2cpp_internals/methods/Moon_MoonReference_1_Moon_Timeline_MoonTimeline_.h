...
IL2CPP_REGISTER_METHOD(0x02720AC0, MoonTimeline *, Resolve, (app::MoonReference_1_Moon_Timeline_MoonTimeline_ * this_ptr, app::IMoonResolverContext * context));
...
IL2CPP_REGISTER_METHOD(0x02720EB0, MoonTimeline *, SafeResolve, (app::MoonReference_1_Moon_Timeline_MoonTimeline_ * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x04786BC0, MoonReference_1_Moon_Timeline_MoonTimeline__SafeResolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027205B0, void, __ctor, (app::MoonReference_1_Moon_Timeline_MoonTimeline_ * this_ptr, app::MoonTimeline * reference));
