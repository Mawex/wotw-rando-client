...
IL2CPP_REGISTER_METHOD(0x024704A0, Material *, get_material, (app::CameraFilterPack_FX_Hexagon_Black * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E70F0, void, __ctor, (app::CameraFilterPack_FX_Hexagon_Black * this_ptr));
}
