...
IL2CPP_REGISTER_METHOD(0x011C1220, GroundPatrolDirectionMode__Enum, get_MovementPattern, (app::SpiderlingEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011C1E40, void, __ctor, (app::SpiderlingEntity * this_ptr));
}
