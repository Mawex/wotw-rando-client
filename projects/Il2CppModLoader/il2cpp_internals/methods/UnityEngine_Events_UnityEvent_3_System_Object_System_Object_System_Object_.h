...
namespace app::methods::UnityEngine_Events::UnityEvent_3_System_Object_System_Object_System_Object_ {
    IL2CPP_REGISTER_METHOD(0x01F2C230, void, __ctor, (app::UnityEvent_3_System_Object_System_Object_System_Object_ * this_ptr));
