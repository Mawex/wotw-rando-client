...
namespace app::methods::System_Text_RegularExpressions::RegexFCD {
IL2CPP_REGISTER_METHOD(0x02591660, RegexPrefix *, FirstChars, (app::RegexTree * t));
IL2CPP_REGISTER_METHOD(0x025919D0, RegexPrefix *, Prefix, (app::RegexTree * tree));
...
IL2CPP_REGISTER_METHOD(0x02592070, void, __ctor, (app::RegexFCD * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025923C0, RegexFC *, PopFC, (app::RegexFCD * this_ptr));
IL2CPP_REGISTER_METHOD(0x02592410, RegexFC *, TopFC, (app::RegexFCD * this_ptr));
IL2CPP_REGISTER_METHOD(0x02592450, RegexFC *, RegexFCFromRegexTree, (app::RegexFCD * this_ptr, app::RegexTree * tree));
