...
namespace app::methods::ZenFulcrum_VR_OpenVRBinding::CVRChaperoneSetup {
IL2CPP_REGISTER_METHOD(0x016774C0, void, __ctor, (app::CVRChaperoneSetup * this_ptr, app::void * p_interface));
...
IL2CPP_REGISTER_METHOD(0x01677650, bool, GetWorkingPlayAreaSize, (app::CVRChaperoneSetup * this_ptr, app::float * p_size_x, app::float * p_size_z));
...
IL2CPP_REGISTER_METHOD(0x01677BB0, bool, ExportLiveToBuffer, (app::CVRChaperoneSetup * this_ptr, app::StringBuilder * p_buffer, app::uint32_t * pn_buffer_length));
