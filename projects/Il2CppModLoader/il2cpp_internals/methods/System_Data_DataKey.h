...
namespace app::methods::System_Data::DataKey {
IL2CPP_REGISTER_METHOD(0x001E9F50, void, __ctor, (app::DataKey__Boxed * this_ptr, app::DataColumn__Array * columns, bool copy_columns));
IL2CPP_REGISTER_METHODINFO(0x04722508, DataKey__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00107C00, DataColumn__Array *, get_ColumnsReference, (app::DataKey__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0011D880, bool, get_HasValue, (app::DataKey__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001E9F60, DataTable *, get_Table, (app::DataKey__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x001EA060, String__Array *, GetColumnNames, (app::DataKey__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001EA070, IndexField__Array *, GetIndexDesc, (app::DataKey__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001EA080, Object__Array *, GetKeyValues, (app::DataKey__Boxed * this_ptr, int32_t record));
IL2CPP_REGISTER_METHOD(0x001EA090, Index *, GetSortIndex_1, (app::DataKey__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001EA0A0, Index *, GetSortIndex_2, (app::DataKey__Boxed * this_ptr, app::DataViewRowState__Enum record_states));
IL2CPP_REGISTER_METHOD(0x001EA0B0, bool, RecordsEqual, (app::DataKey__Boxed * this_ptr, int32_t record1, int32_t record2));
IL2CPP_REGISTER_METHOD(0x001EA0C0, DataColumn__Array *, ToArray, (app::DataKey__Boxed * this_ptr));
}
