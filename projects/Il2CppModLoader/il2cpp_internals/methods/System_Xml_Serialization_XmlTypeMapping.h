...
namespace app::methods::System_Xml_Serialization::XmlTypeMapping {
IL2CPP_REGISTER_METHOD(0x0194FA20, void, __ctor, (app::XmlTypeMapping * this_ptr, app::String * element_name, app::String * ns, app::TypeData * type_data, app::String * xml_type, app::String * xml_type_namespace));
IL2CPP_REGISTER_METHOD(0x0194FBB0, String *, get_TypeFullName, (app::XmlTypeMapping * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB60, TypeData *, get_TypeData, (app::XmlTypeMapping * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, String *, get_XmlType, (app::XmlTypeMapping * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBA00, void, set_XmlType, (app::XmlTypeMapping * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x0194FBD0, String *, get_XmlTypeNamespace, (app::XmlTypeMapping * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBC0, ArrayList *, get_DerivedTypes, (app::XmlTypeMapping * this_ptr));
IL2CPP_REGISTER_METHOD(0x0051DB40, bool, get_MultiReferenceType, (app::XmlTypeMapping * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB80, XmlTypeMapping *, get_BaseMap, (app::XmlTypeMapping * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0194FC90, XmlTypeMapping *, GetRealTypeMap, (app::XmlTypeMapping * this_ptr, app::Type * object_type));
IL2CPP_REGISTER_METHOD(0x0194FE50, XmlTypeMapping *, GetRealElementMap, (app::XmlTypeMapping * this_ptr, app::String * name, app::String * ens));
