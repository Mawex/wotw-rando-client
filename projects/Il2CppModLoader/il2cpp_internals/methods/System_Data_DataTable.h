...
namespace app::methods::System_Data::DataTable {
IL2CPP_REGISTER_METHOD(0x017F2E00, void, __ctor_1, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x017F39A0, void, __ctor_2, (app::DataTable * this_ptr, app::String * table_name));
IL2CPP_REGISTER_METHOD(0x017F3A50, void, __ctor_3, (app::DataTable * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
...
IL2CPP_REGISTER_METHOD(0x017FA6A0, DataRowState__Enum, ConvertToRowState, (app::DataTable * this_ptr, app::BitArray * bit_states, int32_t bit_index));
...
IL2CPP_REGISTER_METHOD(0x017FBB80, List_1_System_Data_Index_ *, get_LiveIndexes, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x017FBC80, SerializationFormat__Enum_1, get_RemotingFormat, (app::DataTable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x017FBD80, DataRelationCollection *, get_ChildRelations, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9D0, DataColumnCollection *, get_Columns, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x017FBEE0, CompareInfo *, get_CompareInfo, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, ConstraintCollection *, get_Constraints, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x017FBF30, void, ResetConstraints, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB950, DataSet *, get_DataSet, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x017FBF50, void, SetDataSet, (app::DataTable * this_ptr, app::DataSet * data_set));
IL2CPP_REGISTER_METHOD(0x017FC010, DataView *, get_DefaultView, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x017FC1E0, String *, get_DisplayExpressionInternal, (app::DataTable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x017FC880, PropertyCollection *, get_ExtendedProperties, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x017FC9F0, IFormatProvider *, get_FormatProvider, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCE0, CultureInfo *, get_Locale, (app::DataTable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x017FD5F0, DataRelationCollection *, get_ParentRelations, (app::DataTable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A5BA40, DataRelation__Array *, get_NestedParentRelations, (app::DataTable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x017FD780, DataRelation__Array *, FindNestedParentRelations, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x017FDB40, int32_t, get_NestedParentsCount, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x017FDDF0, DataColumn__Array *, get_PrimaryKey, (app::DataTable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, DataRowCollection *, get_Rows, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC40, String *, get_TableName, (app::DataTable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x017FEA90, String *, get_EncodedTableName, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x017FEB50, String *, GetInheritedNamespace, (app::DataTable * this_ptr, app::List_1_System_Data_DataTable_ * visited_tables));
IL2CPP_REGISTER_METHOD(0x017FEE30, String *, get_Namespace, (app::DataTable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC80, String *, get_Prefix, (app::DataTable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0049F2B0, DataColumn *, get_XmlText, (app::DataTable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01800B10, Decimal, get_MaxOccurs, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x01800B20, void, set_MaxOccurs, (app::DataTable * this_ptr, app::Decimal value));
IL2CPP_REGISTER_METHOD(0x00D7D770, Decimal, get_MinOccurs, (app::DataTable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01800BE0, DataRow *, FindByIndex, (app::DataTable * this_ptr, app::Index * ndx, app::Object__Array * key));
IL2CPP_REGISTER_METHOD(0x01800D00, DataRow *, FindMergeTarget, (app::DataTable * this_ptr, app::DataRow * row, app::DataKey key, app::Index * ndx));
...
IL2CPP_REGISTER_METHOD(0x01800F20, DataRow *, MergeRow, (app::DataTable * this_ptr, app::DataRow * row, app::DataRow * target_row, bool preserve_changes, app::Index * idx_search));
IL2CPP_REGISTER_METHOD(0x01801650, DataTable *, CreateInstance, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x01801740, DataTable *, Clone_1, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x01801750, DataTable *, Clone_2, (app::DataTable * this_ptr, app::DataSet * clone_d_s));
IL2CPP_REGISTER_METHOD(0x01801990, DataTable *, IncrementalCloneTo, (app::DataTable * this_ptr, app::DataTable * source_table, app::DataTable * target_table));
IL2CPP_REGISTER_METHOD(0x01801C60, DataTable *, CloneHierarchy, (app::DataTable * this_ptr, app::DataTable * source_table, app::DataSet * ds, app::Hashtable * visited_map));
IL2CPP_REGISTER_METHOD(0x01802230, DataTable *, CloneTo, (app::DataTable * this_ptr, app::DataTable * clone, app::DataSet * clone_d_s, bool skip_expression_columns));
...
IL2CPP_REGISTER_METHOD(0x002FA280, ISite *, get_Site, (app::DataTable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x018045B0, String *, FormatSortString, (app::DataTable * this_ptr, app::IndexField__Array * index_desc));
IL2CPP_REGISTER_METHOD(0x018047D0, void, FreeRecord, (app::DataTable * this_ptr, app::int32_t * record));
IL2CPP_REGISTER_METHOD(0x018047F0, Index *, GetIndex_1, (app::DataTable * this_ptr, app::String * sort, app::DataViewRowState__Enum record_states, app::IFilter * row_filter));
IL2CPP_REGISTER_METHOD(0x01804840, Index *, GetIndex_2, (app::DataTable * this_ptr, app::IndexField__Array * index_desc, app::DataViewRowState__Enum record_states, app::IFilter * row_filter));
IL2CPP_REGISTER_METHOD(0x01804B50, IList *, IListSource_GetList, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x006C8770, List_1_System_Data_DataViewListener_ *, GetListeners, (app::DataTable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01805240, DataRow *, NewEmptyRow, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x018052B0, DataRow *, NewUninitializedRow, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x018052F0, DataRow *, NewRow_1, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x018053A0, DataRow *, CreateEmptyRow, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x018056A0, void, NewRowCreated, (app::DataTable * this_ptr, app::DataRow * row));
IL2CPP_REGISTER_METHOD(0x01805890, DataRow *, NewRow_2, (app::DataTable * this_ptr, int32_t record));
IL2CPP_REGISTER_METHOD(0x01805940, DataRow *, NewRowFromBuilder, (app::DataTable * this_ptr, app::DataRowBuilder * builder));
IL2CPP_REGISTER_METHOD(0x01805B30, Type *, GetRowType, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x01805BD0, DataRow__Array *, NewRowArray, (app::DataTable * this_ptr, int32_t size));
...
IL2CPP_REGISTER_METHOD(0x018060A0, DataRowChangeEventArgs *, OnRowChanged_1, (app::DataTable * this_ptr, app::DataRowChangeEventArgs * args, app::DataRow * e_row, app::DataRowAction__Enum e_action));
IL2CPP_REGISTER_METHOD(0x01806240, DataRowChangeEventArgs *, OnRowChanging_1, (app::DataTable * this_ptr, app::DataRowChangeEventArgs * args, app::DataRow * e_row, app::DataRowAction__Enum e_action));
...
IL2CPP_REGISTER_METHOD(0x01806C10, IndexField__Array *, ParseSortString, (app::DataTable * this_ptr, app::String * sort_string));
...
IL2CPP_REGISTER_METHOD(0x01807AC0, Int32__Array *, RemoveRecordFromIndexes, (app::DataTable * this_ptr, app::DataRow * row, app::DataRowVersion__Enum version));
IL2CPP_REGISTER_METHOD(0x01807D70, Int32__Array *, InsertRecordToIndexes, (app::DataTable * this_ptr, app::DataRow * row, app::DataRowVersion__Enum version));
...
IL2CPP_REGISTER_METHOD(0x01808BA0, DataRowChangeEventArgs *, RaiseRowChanged, (app::DataTable * this_ptr, app::DataRowChangeEventArgs * args, app::DataRow * e_row, app::DataRowAction__Enum e_action));
IL2CPP_REGISTER_METHODINFO(0x04772AD0, DataTable_RaiseRowChanged__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01808E60, DataRowChangeEventArgs *, RaiseRowChanging_1, (app::DataTable * this_ptr, app::DataRowChangeEventArgs * args, app::DataRow * e_row, app::DataRowAction__Enum e_action));
IL2CPP_REGISTER_METHOD(0x01809190, DataRowChangeEventArgs *, RaiseRowChanging_2, (app::DataTable * this_ptr, app::DataRowChangeEventArgs * args, app::DataRow * e_row, app::DataRowAction__Enum e_action, bool fire_event));
...
IL2CPP_REGISTER_METHOD(0x0180A3B0, String *, ToString, (app::DataTable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0180A520, DataColumn *, AddUniqueKey_1, (app::DataTable * this_ptr, int32_t position));
IL2CPP_REGISTER_METHOD(0x0180A8B0, DataColumn *, AddUniqueKey_2, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x0180A8C0, DataColumn *, AddForeignKey, (app::DataTable * this_ptr, app::DataColumn * parent_key));
IL2CPP_REGISTER_METHOD(0x0180AA70, void, UpdatePropertyDescriptorCollectionCache, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x0180AA80, PropertyDescriptorCollection *, GetPropertyDescriptorCollection, (app::DataTable * this_ptr, app::Attribute__Array * attributes));
IL2CPP_REGISTER_METHOD(0x0180B140, XmlQualifiedName *, get_TypeName, (app::DataTable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0180C960, XmlReadMode__Enum, ReadXml, (app::DataTable * this_ptr, app::XmlReader * reader, app::XmlReadMode__Enum mode, bool deny_resolving));
...
IL2CPP_REGISTER_METHOD(0x01810720, XmlSchemaComplexType *, GetDataTableSchema, (app::XmlSchemaSet * schema_set));
IL2CPP_REGISTER_METHOD(0x01810C60, XmlSchema *, IXmlSerializable_GetSchema, (app::DataTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x01810C80, XmlSchema *, GetSchema, (app::DataTable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01811280, Hashtable *, get_RowDiffId, (app::DataTable * this_ptr));
