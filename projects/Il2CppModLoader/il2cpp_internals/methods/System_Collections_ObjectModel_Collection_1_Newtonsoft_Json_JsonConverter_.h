...
namespace app::methods::System_Collections_ObjectModel::Collection_1_Newtonsoft_Json_JsonConverter_ {
IL2CPP_REGISTER_METHOD(0x02776BF0, void, __ctor, (app::Collection_1_Newtonsoft_Json_JsonConverter_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CFA3A0, JsonConverter *, get_Item, (app::Collection_1_Newtonsoft_Json_JsonConverter_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02B833F0, IEnumerator_1_Newtonsoft_Json_JsonConverter_ *, GetEnumerator, (app::Collection_1_Newtonsoft_Json_JsonConverter_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CFAD00, IEnumerator *, IEnumerable_GetEnumerator, (app::Collection_1_Newtonsoft_Json_JsonConverter_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CFA3A0, Object *, IList_get_Item, (app::Collection_1_Newtonsoft_Json_JsonConverter_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02CFAD90, Object *, ICollection_get_SyncRoot, (app::Collection_1_Newtonsoft_Json_JsonConverter_ * this_ptr));
