...
namespace app::methods::System_Security_Cryptography_X509Certificates::X509ChainPolicy {
IL2CPP_REGISTER_METHOD(0x021D3F90, void, __ctor_1, (app::X509ChainPolicy * this_ptr));
IL2CPP_REGISTER_METHOD(0x021D3FA0, void, __ctor_2, (app::X509ChainPolicy * this_ptr, app::X509CertificateCollection_1 * store));
IL2CPP_REGISTER_METHOD(0x021D3FB0, X509Certificate2Collection *, get_ExtraStore, (app::X509ChainPolicy * this_ptr));
IL2CPP_REGISTER_METHOD(0x00654950, X509RevocationFlag__Enum, get_RevocationFlag, (app::X509ChainPolicy * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00998570, X509RevocationMode__Enum, get_RevocationMode, (app::X509ChainPolicy * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004E57A0, X509VerificationFlags__Enum, get_VerificationFlags, (app::X509ChainPolicy * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9F0, DateTime, get_VerificationTime, (app::X509ChainPolicy * this_ptr));
