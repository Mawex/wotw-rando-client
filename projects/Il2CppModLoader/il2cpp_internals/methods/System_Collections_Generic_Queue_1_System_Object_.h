...
namespace app::methods::System_Collections_Generic::Queue_1_System_Object_ {
...
IL2CPP_REGISTER_METHOD(0x02CA71B0, Object *, ICollection_get_SyncRoot, (app::Queue_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0243CB70, void, __ctor_1, (app::Queue_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA7080, void, __ctor_2, (app::Queue_1_System_Object_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x02CA76E0, Queue_1_T_Enumerator_System_Object_, GetEnumerator, (app::Queue_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA7720, IEnumerator_1_System_Object_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::Queue_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA7720, IEnumerator *, IEnumerable_GetEnumerator, (app::Queue_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA77B0, Object *, Dequeue, (app::Queue_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047824F8, Queue_1_System_Object__Dequeue__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02CA7860, Object *, Peek, (app::Queue_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0243D5D0, Object__Array *, ToArray, (app::Queue_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0243D6C0, void, SetCapacity, (app::Queue_1_System_Object_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x0243D7A0, void, MoveNext, (app::Queue_1_System_Object_ * this_ptr, app::int32_t * index));
