...
namespace app::methods::System_Security_Cryptography::SHA1Internal {
IL2CPP_REGISTER_METHOD(0x028F4BC0, void, __ctor, (app::SHA1Internal * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x028F4DA0, Byte__Array *, HashFinal, (app::SHA1Internal * this_ptr));
