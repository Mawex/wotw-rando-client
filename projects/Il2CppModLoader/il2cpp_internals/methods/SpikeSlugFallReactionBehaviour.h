...
IL2CPP_REGISTER_METHOD(0x011CCD70, SpikeSlugLocomotion *, get_Locomotion, (app::SpikeSlugFallReactionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011CD200, BehaviourStatus__Enum, OnExecuteTask, (app::SpikeSlugFallReactionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x011CD390, void, OnEnterLand, (app::SpikeSlugFallReactionBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x011CD460, void, __ctor, (app::SpikeSlugFallReactionBehaviour * this_ptr));
}
