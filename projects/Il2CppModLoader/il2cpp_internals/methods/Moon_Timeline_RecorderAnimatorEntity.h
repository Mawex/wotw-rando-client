...
namespace app::methods::Moon_Timeline::RecorderAnimatorEntity {
IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::RecorderAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x0077CB40, RecorderData *, get_RecorderData, (app::RecorderAnimatorEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0077D790, IEnumerable_1_SceneMetaData_ *, GetSceneListFromAsset, (app::RecorderData * data));
...
IL2CPP_REGISTER_METHOD(0x0077E420, RecorderFrame *, GetFrame, (app::RecorderAnimatorEntity * this_ptr, float value));
IL2CPP_REGISTER_METHOD(0x0077E5F0, Vector3, GetCharacterPositionFromFirstFrame, (app::RecorderAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x0077E810, bool, HasFinished, (app::RecorderAnimatorEntity * this_ptr, int32_t event_id));
IL2CPP_REGISTER_METHOD(0x0077E830, void, __ctor, (app::RecorderAnimatorEntity * this_ptr));
}
