...
IL2CPP_REGISTER_METHOD(0x0138FA50, Vector2, get_EffectiveRootMotionMultiplier, (app::MeleeComboMoveHammerBase * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0138FB80, String *, get_AnimationSpeedMultiplierParameterName, (app::MeleeComboMoveHammerBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CC7710, AbilityType__Enum, get_ComboAbilityType, (app::MeleeComboMoveHammerBase * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01391360, void, __ctor, (app::MeleeComboMoveHammerBase * this_ptr));
}
