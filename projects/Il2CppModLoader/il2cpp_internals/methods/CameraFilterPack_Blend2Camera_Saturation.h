...
IL2CPP_REGISTER_METHOD(0x0275C8D0, Material *, get_material, (app::CameraFilterPack_Blend2Camera_Saturation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0275DAA0, void, __ctor, (app::CameraFilterPack_Blend2Camera_Saturation * this_ptr));
}
