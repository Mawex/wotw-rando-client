...
namespace app::methods::System_Collections_Generic::List_1_EnemyArenaController_EnemyWave_ {
...
IL2CPP_REGISTER_METHOD(0x025EFC50, EnemyArenaController_EnemyWave *, get_Item, (app::List_1_EnemyArenaController_EnemyWave_ * this_ptr, int32_t index));
