...
IL2CPP_REGISTER_METHOD(0x00F1B330, LaserShooterMinibossPath *, get_Paths, (app::LaserShooterMinibossPathMover * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, LaserShooterMinibossEntity *, get_Entity, (app::LaserShooterMinibossPathMover * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F1C830, void, __ctor, (app::LaserShooterMinibossPathMover * this_ptr));
}
