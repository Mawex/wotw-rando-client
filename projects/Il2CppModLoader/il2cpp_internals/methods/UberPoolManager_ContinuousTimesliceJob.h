...
IL2CPP_REGISTER_METHOD(0x00FDF8A0, void, __ctor, (app::UberPoolManager_ContinuousTimesliceJob * this_ptr, app::UberPoolManager * manager, app::String * name, app::TimeSlicedJobPriority__Enum priority, app::Func_2_UberPoolManager_Boolean_ * callback));
...
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_JobName, (app::UberPoolManager_ContinuousTimesliceJob * this_ptr));
IL2CPP_REGISTER_METHOD(0x00FDF970, String *, get_TimesliceJobOwnerName, (app::UberPoolManager_ContinuousTimesliceJob * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FDF9F0, String *, get_ContextualDebugData, (app::UberPoolManager_ContinuousTimesliceJob * this_ptr));
