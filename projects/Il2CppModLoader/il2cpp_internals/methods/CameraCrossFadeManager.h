...
IL2CPP_REGISTER_METHOD(0x003FF3C0, SuspendableMask__Enum, get_Mask, (app::CameraCrossFadeManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x016883F0, void, set_Mask, (app::CameraCrossFadeManager * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x016884A0, void, __ctor, (app::CameraCrossFadeManager * this_ptr));
