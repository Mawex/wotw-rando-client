...
IL2CPP_REGISTER_METHOD(0x0043DA30, MoonAnimator *, get_OriAnimator, (app::OriLayeredAnimationsController * this_ptr));
IL2CPP_REGISTER_METHOD(0x0043DB30, List_1_ICondition_ *, get_ResolvedConditions, (app::OriLayeredAnimationsController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::OriLayeredAnimationsController * this_ptr));
}
