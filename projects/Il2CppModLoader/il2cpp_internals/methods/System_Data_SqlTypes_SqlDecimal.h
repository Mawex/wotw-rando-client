...
namespace app::methods::System_Data_SqlTypes::SqlDecimal {
...
IL2CPP_REGISTER_METHOD(0x001E34C0, Decimal, get_Value, (app::SqlDecimal__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x001E3530, Int32__Array *, get_Data, (app::SqlDecimal__Boxed * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047140E0, SqlDecimal_get_Data__MethodInfo);
IL2CPP_REGISTER_METHOD(0x001E3540, String *, ToString, (app::SqlDecimal__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x022A6EC0, SqlDecimal, Parse, (app::String * s));
...
IL2CPP_REGISTER_METHOD(0x001E34C0, Decimal, ToDecimal, (app::SqlDecimal__Boxed * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04777DE0, SqlDecimal_ToDecimal__MethodInfo);
IL2CPP_REGISTER_METHOD(0x022A7980, SqlDecimal, operator__1, (app::Decimal x));
IL2CPP_REGISTER_METHOD(0x022A79B0, SqlDecimal, operator__2, (int64_t x));
IL2CPP_REGISTER_METHOD(0x022A7A20, SqlDecimal, operator___1, (app::SqlDecimal x));
IL2CPP_REGISTER_METHOD(0x022A7B60, SqlDecimal, operator___2, (app::SqlDecimal x, app::SqlDecimal y));
IL2CPP_REGISTER_METHODINFO(0x04739388, SqlDecimal_op_Addition__MethodInfo);
IL2CPP_REGISTER_METHOD(0x022A8320, SqlDecimal, operator___3, (app::SqlDecimal x, app::SqlDecimal y));
IL2CPP_REGISTER_METHOD(0x022A8440, SqlDecimal, operator___4, (app::SqlDecimal x, app::SqlDecimal y));
IL2CPP_REGISTER_METHODINFO(0x04796D10, SqlDecimal_op_Multiply__MethodInfo);
IL2CPP_REGISTER_METHOD(0x022A91A0, SqlDecimal, operator___5, (app::SqlDecimal x, app::SqlDecimal y));
IL2CPP_REGISTER_METHODINFO(0x04799A58, SqlDecimal_op_Division__MethodInfo);
IL2CPP_REGISTER_METHOD(0x022A97F0, SqlDecimal, operator__3, (app::SqlByte x));
IL2CPP_REGISTER_METHOD(0x022A9940, SqlDecimal, operator__4, (app::SqlInt16 x));
IL2CPP_REGISTER_METHOD(0x022A9A90, SqlDecimal, operator__5, (app::SqlInt32 x));
IL2CPP_REGISTER_METHOD(0x022A9BE0, SqlDecimal, operator__6, (app::SqlInt64 x));
IL2CPP_REGISTER_METHOD(0x022A9CE0, SqlDecimal, operator__7, (app::SqlMoney x));
...
IL2CPP_REGISTER_METHOD(0x022AB480, void, MpMove, (app::UInt32__Array * rgul_s, int32_t ciul_s, app::UInt32__Array * rgul_d, app::int32_t * ciul_d));
IL2CPP_REGISTER_METHOD(0x022AB4F0, void, MpSet, (app::UInt32__Array * rgul_d, app::int32_t * ciul_d, uint32_t iul_n));
IL2CPP_REGISTER_METHOD(0x021E6970, void, MpNormalize, (app::UInt32__Array * rgul_u, app::int32_t * ciul_u));
IL2CPP_REGISTER_METHOD(0x022AB530, void, MpMul1, (app::UInt32__Array * piul_d, app::int32_t * ciul_d, uint32_t iul_x));
IL2CPP_REGISTER_METHOD(0x022AB690, void, MpDiv1, (app::UInt32__Array * rgul_u, app::int32_t * ciul_u, uint32_t iul_d, app::uint32_t * iul_r));
...
IL2CPP_REGISTER_METHOD(0x022AB830, void, MpDiv, (app::UInt32__Array * rgul_u, int32_t ciul_u, app::UInt32__Array * rgul_d, int32_t ciul_d, app::UInt32__Array * rgul_q, app::int32_t * ciul_q, app::UInt32__Array * rgul_r, app::int32_t * ciul_r));
IL2CPP_REGISTER_METHOD(0x001E3640, EComparison__Enum, CompareNm, (app::SqlDecimal__Boxed * this_ptr, app::SqlDecimal snum_op));
...
IL2CPP_REGISTER_METHOD(0x022AC800, SqlBoolean, operator___, (app::SqlDecimal x, app::SqlDecimal y));
IL2CPP_REGISTER_METHOD(0x022AC900, SqlBoolean, operator___6, (app::SqlDecimal x, app::SqlDecimal y));
IL2CPP_REGISTER_METHOD(0x022ACA00, SqlBoolean, operator___7, (app::SqlDecimal x, app::SqlDecimal y));
IL2CPP_REGISTER_METHOD(0x022ACB00, SqlBoolean, LessThan, (app::SqlDecimal x, app::SqlDecimal y));
IL2CPP_REGISTER_METHOD(0x022ACBD0, SqlBoolean, GreaterThan, (app::SqlDecimal x, app::SqlDecimal y));
IL2CPP_REGISTER_METHOD(0x001E3670, SqlDouble, ToSqlDouble, (app::SqlDecimal__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001E36A0, SqlInt64, ToSqlInt64, (app::SqlDecimal__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001E36D0, SqlMoney, ToSqlMoney, (app::SqlDecimal__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0013BB70, XmlSchema *, IXmlSerializable_GetSchema, (app::SqlDecimal__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x022AD760, XmlQualifiedName *, GetXsdType, (app::XmlSchemaSet * schema_set));
