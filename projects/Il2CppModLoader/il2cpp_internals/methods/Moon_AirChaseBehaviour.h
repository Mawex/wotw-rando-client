...
IL2CPP_REGISTER_METHOD(0x013336E0, Vector3, get_TargetPos, (app::AirChaseBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01333DB0, BehaviourStatus__Enum, OnExecute, (app::AirChaseBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x013344D0, void, __ctor, (app::AirChaseBehaviour * this_ptr));
}
