...
namespace app::methods::PlayFab_Internal::SingletonMonoBehaviour_1_System_Object_ {
IL2CPP_REGISTER_METHOD(0x01D14FB0, Object *, get_instance, ());
...
IL2CPP_REGISTER_METHOD(0x019FAA80, void, __ctor, (app::SingletonMonoBehaviour_1_System_Object_ * this_ptr));
}
