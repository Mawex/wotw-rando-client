...
IL2CPP_REGISTER_METHOD(0x002FBB00, MemberInfo_1 *, get_TargetMemberInfo, (app::NewSetupStateControllerResolver_RuntimeUberStateControllerDataLink_1_System_Int64_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB990, Type *, get_ReturnedValueType, (app::NewSetupStateControllerResolver_RuntimeUberStateControllerDataLink_1_System_Int64_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02727540, SetupStateModifierDataType__Enum, get_ModifierDataClassType, (app::NewSetupStateControllerResolver_RuntimeUberStateControllerDataLink_1_System_Int64_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02727580, NewSetupStateController *, get_TargetController, (app::NewSetupStateControllerResolver_RuntimeUberStateControllerDataLink_1_System_Int64_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x027275C0, SetupStateModifierData *, get_ModifierData, (app::NewSetupStateControllerResolver_RuntimeUberStateControllerDataLink_1_System_Int64_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA280, NewSetupStateControllerResolver_SetupStateControllerLinkSerializedData *, get_Data, (app::NewSetupStateControllerResolver_RuntimeUberStateControllerDataLink_1_System_Int64_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01CFFD20, NewSetupStateControllerResolver_SetupStateControllerLinkSerializedData *, GetSerializedData, (app::NewSetupStateControllerResolver_RuntimeUberStateControllerDataLink_1_System_Int64_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x027319E0, String *, ToString, (app::NewSetupStateControllerResolver_RuntimeUberStateControllerDataLink_1_System_Int64_ * this_ptr));
