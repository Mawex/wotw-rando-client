...
IL2CPP_REGISTER_METHOD(0x00245440, void, __ctor, (app::JsonBuilder_Object__Boxed * this_ptr, int32_t ident, app::JsonBuilder * builder));
...
IL2CPP_REGISTER_METHOD(0x00245460, JsonBuilder_Slot, Slot, (app::JsonBuilder_Object__Boxed * this_ptr, app::String * property_name));
