...
IL2CPP_REGISTER_METHOD(0x01B0B210, Transform *, DuplicateHierarchy, (app::Transform * transform, app::Transform * mask_transform, app::Transform * parent));
...
IL2CPP_REGISTER_METHOD(0x01B0C8F0, void, __ctor, (app::BlendAnimationPostprocess * this_ptr));
}
