...
namespace app::methods::UnityEngine_Experimental_LowLevel::PlayerLoop {
...
IL2CPP_REGISTER_METHOD(0x024325C0, PlayerLoopSystem, InternalToPlayerLoopSystem, (app::PlayerLoopSystemInternal__Array * internal_sys, app::int32_t * offset));
