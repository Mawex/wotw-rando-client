...
namespace app::methods::System_Net_Sockets::LingerOption {
    IL2CPP_REGISTER_METHOD(0x01BE0270, void, __ctor, (app::LingerOption * this_ptr, bool enable, int32_t seconds));
