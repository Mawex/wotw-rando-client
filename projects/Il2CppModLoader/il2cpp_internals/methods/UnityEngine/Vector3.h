...
namespace app::methods::UnityEngine::Vector3 {
    IL2CPP_REGISTER_METHOD(0x00229570, void, __ctor_1, (app::Vector3__Boxed * this_ptr, float x, float y, float z));
    IL2CPP_REGISTER_METHOD(0x00229580, void, __ctor_2, (app::Vector3__Boxed * this_ptr, float x, float y));
