...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_Int32_WorldMapAreaState_ {
...
IL2CPP_REGISTER_METHOD(0x02BAC6E0, Dictionary_2_TKey_TValue_Enumerator_System_Int32_WorldMapAreaState_, GetEnumerator, (app::Dictionary_2_System_Int32_WorldMapAreaState_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04722E98, Dictionary_2_System_Int32_WorldMapAreaState__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_System_Int32_WorldMapAreaState_ * this_ptr));
