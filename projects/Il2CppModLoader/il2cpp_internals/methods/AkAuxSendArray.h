...
IL2CPP_REGISTER_METHOD(0x026CA1A0, void, __ctor, (app::AkAuxSendArray * this_ptr));
IL2CPP_REGISTER_METHOD(0x026CA3D0, AkAuxSendValue *, get_Item, (app::AkAuxSendArray * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x026CAC80, AKRESULT__Enum, SetValues, (app::AkAuxSendArray * this_ptr, app::GameObject * game_object));
IL2CPP_REGISTER_METHOD(0x026CAD70, AKRESULT__Enum, GetValues, (app::AkAuxSendArray * this_ptr, app::GameObject * game_object));
