...
IL2CPP_REGISTER_METHOD(0x005D06C0, CharacterPlatformMovement *, get_SeinPlatformMovement, (app::SeinMeleeAttack * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008A6F60, Transform *, get_WeaponJoint, (app::SeinMeleeAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, Transform *, get_RootJoint, (app::SeinMeleeAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD40, Animator *, get_Animator, (app::SeinMeleeAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x006A63A0, MeleeWeapon *, get_CurrentWeapon, (app::SeinMeleeAttack * this_ptr));
IL2CPP_REGISTER_METHOD(0x0065FBA0, MeleeComboMove *, get_CurrentComboMove, (app::SeinMeleeAttack * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008AC760, void, __ctor, (app::SeinMeleeAttack * this_ptr));
