...
namespace app::methods::Moon::UberID {
    IL2CPP_REGISTER_METHOD(0x01B66E50, void, __ctor_1, (app::UberID * this_ptr, app::String* guid));
    IL2CPP_REGISTER_METHOD(0x01B67010, void, __ctor_2, (app::UberID * this_ptr, uint16_t b));
    IL2CPP_REGISTER_METHOD(0x01B67020, void, __ctor_3, (app::UberID * this_ptr, app::BinaryReader* binary_reader));
    ...
    IL2CPP_REGISTER_METHOD(0x01B67080, String*, ToString, (app::UberID * this_ptr));
