...
namespace app::methods::System_Linq_Expressions::StackGuard {
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::StackGuard_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x018F0F40, Object *, RunOnEmptyStackCore, (app::StackGuard_1 * this_ptr, app::Func_2_Object_Object_ * action, app::Object * state));
