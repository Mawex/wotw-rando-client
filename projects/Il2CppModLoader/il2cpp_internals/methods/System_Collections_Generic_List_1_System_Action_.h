...
namespace app::methods::System_Collections_Generic::List_1_System_Action_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_System_Action_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EFC50, Action *, get_Item, (app::List_1_System_Action_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, Action__Array *, ToArray, (app::List_1_System_Action_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0477BB00, List_1_System_Action__ToArray__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_System_Action_, GetEnumerator, (app::List_1_System_Action_ * this_ptr));
