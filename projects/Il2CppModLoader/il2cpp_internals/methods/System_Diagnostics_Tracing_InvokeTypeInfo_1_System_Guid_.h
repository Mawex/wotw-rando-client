...
namespace app::methods::System_Diagnostics_Tracing::InvokeTypeInfo_1_System_Guid_ {
IL2CPP_REGISTER_METHOD(0x02B98CC0, void, __ctor, (app::InvokeTypeInfo_1_System_Guid_ * this_ptr, app::TypeAnalysis * type_analysis));
...
IL2CPP_REGISTER_METHOD(0x02B9C240, Object *, GetData, (app::InvokeTypeInfo_1_System_Guid_ * this_ptr, app::Object * value));
