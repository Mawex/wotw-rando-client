...
namespace app::methods::Bubble {
    IL2CPP_REGISTER_METHOD(0x00654950, SuspendableMask__Enum, get_Mask, (app::Bubble * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FBCA0, Collider*, get_Collider, (app::Bubble * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBCC0, Collider__Array*, get_Colliders, (app::Bubble * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00597B10, UpdateType__Enum, get_UpdateType, (app::Bubble * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00D55340, void, __ctor, (app::Bubble * this_ptr));
} // namespace app::methods::Bubble
