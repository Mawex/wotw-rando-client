...
namespace app::methods::UnityStandardAssets_CinematicEffects::FXAA {
IL2CPP_REGISTER_METHOD(0x02504DF0, void, __ctor, (app::FXAA * this_ptr, bool use_separate_alpha));
IL2CPP_REGISTER_METHOD(0x02504EC0, Shader *, get_shader, (app::FXAA * this_ptr));
IL2CPP_REGISTER_METHOD(0x02504FC0, Material *, get_material, (app::FXAA * this_ptr));
