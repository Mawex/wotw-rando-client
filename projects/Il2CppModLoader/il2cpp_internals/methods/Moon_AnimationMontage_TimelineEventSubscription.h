...
namespace app::methods::Moon::AnimationMontage_TimelineEventSubscription {
    IL2CPP_REGISTER_METHOD(0x0133C0B0, void, __ctor, (app::AnimationMontage_TimelineEventSubscription * this_ptr, app::String * event_id, app::AnimationMontage * montage, app::IMontageEventProvider * provider));
