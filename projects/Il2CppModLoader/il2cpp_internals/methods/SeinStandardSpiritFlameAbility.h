...
IL2CPP_REGISTER_METHOD(0x00A7C0F0, SpiritFlame *, get_CurrentSpiritFlame, (app::SeinStandardSpiritFlameAbility * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A7C960, SpiritFlame *, GetStandardSpiritFlame, (app::SeinStandardSpiritFlameAbility * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x005E2D20, List_1_ISpiritFlameAttackable_ *, get_ClosestAttackables, (app::SeinStandardSpiritFlameAbility * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A7CB90, void, __ctor, (app::SeinStandardSpiritFlameAbility * this_ptr));
}
