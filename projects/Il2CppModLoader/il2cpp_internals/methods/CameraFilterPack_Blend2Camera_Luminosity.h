...
IL2CPP_REGISTER_METHOD(0x02756860, Material *, get_material, (app::CameraFilterPack_Blend2Camera_Luminosity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02757A30, void, __ctor, (app::CameraFilterPack_Blend2Camera_Luminosity * this_ptr));
}
