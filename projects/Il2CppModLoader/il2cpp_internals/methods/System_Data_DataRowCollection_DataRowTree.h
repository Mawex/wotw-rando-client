...
namespace app::methods::System_Data::DataRowCollection_DataRowTree {
    IL2CPP_REGISTER_METHOD(0x017E11B0, void, __ctor, (app::DataRowCollection_DataRowTree * this_ptr));
