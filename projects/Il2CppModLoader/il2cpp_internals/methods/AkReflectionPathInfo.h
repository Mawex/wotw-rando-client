...
IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkReflectionPathInfo * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x01893410, void *, getCPtr, (app::AkReflectionPathInfo * obj));
IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkReflectionPathInfo * this_ptr, app::void * c_ptr));
...
IL2CPP_REGISTER_METHOD(0x01893870, AkVector *, get_imageSource, (app::AkReflectionPathInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01894460, AkVector *, GetPathPoint, (app::AkReflectionPathInfo * this_ptr, uint32_t idx));
IL2CPP_REGISTER_METHOD(0x01894680, AkAcousticSurface *, GetAcousticSurface, (app::AkReflectionPathInfo * this_ptr, uint32_t idx));
...
IL2CPP_REGISTER_METHOD(0x01894AD0, void, __ctor_2, (app::AkReflectionPathInfo * this_ptr));
}
