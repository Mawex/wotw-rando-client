...
namespace app::methods::System_Text::UTF7Encoding_Encoder {
    IL2CPP_REGISTER_METHOD(0x0244DBE0, void, __ctor_1, (app::UTF7Encoding_Encoder * this_ptr, app::UTF7Encoding * encoding));
    IL2CPP_REGISTER_METHOD(0x027CDF60, void, __ctor_2, (app::UTF7Encoding_Encoder * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
