...
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_FullTypeName, (app::TypeInformation * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_AssemblyString, (app::TypeInformation * this_ptr));
