...
namespace app::methods::Moon_Setups::ChangeStateOnCondition {
IL2CPP_REGISTER_METHOD(0x003FCB00, bool, ShouldCreateCheckpoint, (app::ChangeStateOnCondition * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E24500, void, __ctor, (app::ChangeStateOnCondition * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::ChangeStateOnCondition * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E24B80, IDesiredUberState *, GetRequirementsForTimeline, (app::ChangeStateOnCondition * this_ptr, app::MoonTimeline * timeline));
