...
namespace app::methods::Newtonsoft_Json_Converters::BsonObjectIdConverter {
...
IL2CPP_REGISTER_METHOD(0x01A4E5C0, Object *, ReadJson, (app::BsonObjectIdConverter * this_ptr, app::JsonReader * reader, app::Type * object_type, app::Object * existing_value, app::JsonSerializer * serializer));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::BsonObjectIdConverter * this_ptr));
}
