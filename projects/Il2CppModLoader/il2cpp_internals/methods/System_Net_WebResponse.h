...
namespace app::methods::System_Net::WebResponse {
...
IL2CPP_REGISTER_METHOD(0x021B8910, String *, get_ContentType, (app::WebResponse * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x021B8990, Stream *, GetResponseStream, (app::WebResponse * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0476D1D8, WebResponse_GetResponseStream__MethodInfo);
IL2CPP_REGISTER_METHOD(0x021B89D0, Uri *, get_ResponseUri, (app::WebResponse * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04758790, WebResponse_get_ResponseUri__MethodInfo);
IL2CPP_REGISTER_METHOD(0x021B8A10, WebHeaderCollection *, get_Headers, (app::WebResponse * this_ptr));
