...
IL2CPP_REGISTER_METHOD(0x01697000, Vector3, GetExtraZoomAmount, (app::CameraOffsetController * this_ptr, float offset));
...
IL2CPP_REGISTER_METHOD(0x01697150, Vector3, get_Offset, (app::CameraOffsetController * this_ptr));
IL2CPP_REGISTER_METHOD(0x01697230, void, set_Offset, (app::CameraOffsetController * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x01697300, Vector3, get_Rotation, (app::CameraOffsetController * this_ptr));
IL2CPP_REGISTER_METHOD(0x01697460, void, set_Rotation, (app::CameraOffsetController * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x01697550, Vector3, get_DefaultCameraZoom, (app::CameraOffsetController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00933260, Vector3, get_LastOffsetWithoutCamera, (app::CameraOffsetController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00F0E6F0, Vector3, get_LastRotationWithoutCamera, (app::CameraOffsetController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0169A690, void, __ctor, (app::CameraOffsetController * this_ptr));
