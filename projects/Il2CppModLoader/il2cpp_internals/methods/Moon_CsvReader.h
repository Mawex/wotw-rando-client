...
IL2CPP_REGISTER_METHOD(0x030E8D60, void, __ctor, (app::CsvReader * this_ptr, app::TextReader * reader, bool should_dispose_reader));
IL2CPP_REGISTER_METHODINFO(0x04789CE8, CsvReader__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x030E8F00, IEnumerable_1_Moon_CsvReader_Cell_ *, ReadRow, (app::CsvReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x030E9090, IEnumerable_1_Moon_CsvReader_Cell_ *, ReadToEnd, (app::CsvReader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030E96A0, CsvReader_Cell, ReadQuotedCell, (app::CsvReader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030EA000, CsvReader_Cell, ReadUnquotedCell, (app::CsvReader * this_ptr));
