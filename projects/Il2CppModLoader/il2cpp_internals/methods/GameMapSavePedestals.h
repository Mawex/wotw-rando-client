...
IL2CPP_REGISTER_METHOD(0x006A1160, List_1_GameMapSavePedestal_ *, get_Pedestals, (app::GameMapSavePedestals * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006A2440, GameMapSavePedestal *, get_SelectedPedestal, (app::GameMapSavePedestals * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006A2A10, String *, GetIdentifierForIndex, (app::GameMapSavePedestals * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x006A2B00, void, SetIndex, (app::GameMapSavePedestals * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x006A2E70, void, __ctor, (app::GameMapSavePedestals * this_ptr));
}
