...
namespace app::methods::UnityEngine_Experimental_Animations::TransformStreamHandle {
...
IL2CPP_REGISTER_METHOD(0x002432C0, Vector3, GetPosition, (app::TransformStreamHandle__Boxed * this_ptr, app::AnimationStream stream));
...
IL2CPP_REGISTER_METHOD(0x00243430, Quaternion, GetRotation, (app::TransformStreamHandle__Boxed * this_ptr, app::AnimationStream stream));
...
IL2CPP_REGISTER_METHOD(0x002435B0, Vector3, GetPositionInternal, (app::TransformStreamHandle__Boxed * this_ptr, app::AnimationStream * stream));
...
IL2CPP_REGISTER_METHOD(0x002436D0, Quaternion, GetRotationInternal, (app::TransformStreamHandle__Boxed * this_ptr, app::AnimationStream * stream));
