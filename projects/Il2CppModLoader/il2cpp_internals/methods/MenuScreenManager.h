...
IL2CPP_REGISTER_METHOD(0x009DB610, MenuScreen *, get_InventoryManager, (app::MenuScreenManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009DCAA0, MenuScreen *, GetScreenInstance, (app::MenuScreenManager * this_ptr, app::MenuScreenManager_Screens__Enum screen));
...
IL2CPP_REGISTER_METHOD(0x009DE4F0, IEnumerator *, CallNextFrame, (app::MenuScreenManager * this_ptr, app::Action * action));
...
IL2CPP_REGISTER_METHOD(0x009DF680, IEnumerator *, PostFadeMenuOpen, (app::MenuScreenManager * this_ptr, app::MenuScreenManager_Screens__Enum screen));
...
IL2CPP_REGISTER_METHOD(0x009E2B10, GameObject *, Instantiate, (app::MenuScreenManager * this_ptr, app::GameObject * prefab));
...
IL2CPP_REGISTER_METHOD(0x009E3460, IMenuTab *, GetScreenTab, (app::MenuScreenManager * this_ptr, app::MenuScreenManager_Screens__Enum screen));
...
IL2CPP_REGISTER_METHOD(0x009E3660, MenuTabBackground__Enum, BackgroundMode, (app::MenuScreenManager * this_ptr, app::MenuScreenManager_Screens__Enum screen));
IL2CPP_REGISTER_METHOD(0x009E3710, void, __ctor, (app::MenuScreenManager * this_ptr));
