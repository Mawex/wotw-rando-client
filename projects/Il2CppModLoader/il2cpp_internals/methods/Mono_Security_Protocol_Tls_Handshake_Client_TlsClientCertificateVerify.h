...
namespace app::methods::Mono_Security_Protocol_Tls_Handshake_Client::TlsClientCertificateVerify {
IL2CPP_REGISTER_METHOD(0x01F6AC60, void, __ctor, (app::TlsClientCertificateVerify_1 * this_ptr, app::Context_1 * context));
...
IL2CPP_REGISTER_METHOD(0x01F6B3E0, RSA *, getClientCertRSA, (app::TlsClientCertificateVerify_1 * this_ptr, app::RSA * priv_key));
IL2CPP_REGISTER_METHOD(0x01F6B870, Byte__Array *, getUnsignedBigInteger, (app::TlsClientCertificateVerify_1 * this_ptr, app::Byte__Array * integer));
}
