...
namespace app::methods::UnityEngine_UI::AspectRatioFitter {
IL2CPP_REGISTER_METHOD(0x01F2AB50, void, __ctor, (app::AspectRatioFitter * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F2AB70, AspectRatioFitter_AspectMode__Enum, get_aspectMode, (app::AspectRatioFitter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F2AD00, RectTransform *, get_rectTransform, (app::AspectRatioFitter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F2B3E0, Vector2, GetParentSize, (app::AspectRatioFitter * this_ptr));
