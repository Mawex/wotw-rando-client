...
namespace app::methods::System_Xml_Serialization::XmlRootAttribute {
IL2CPP_REGISTER_METHOD(0x00447ED0, void, __ctor_1, (app::XmlRootAttribute * this_ptr));
IL2CPP_REGISTER_METHOD(0x025AB880, void, __ctor_2, (app::XmlRootAttribute * this_ptr, app::String * element_name));
IL2CPP_REGISTER_METHOD(0x025AB890, String *, get_DataType, (app::XmlRootAttribute * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_DataType, (app::XmlRootAttribute * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x025AB920, String *, get_ElementName, (app::XmlRootAttribute * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, get_Namespace, (app::XmlRootAttribute * this_ptr));
