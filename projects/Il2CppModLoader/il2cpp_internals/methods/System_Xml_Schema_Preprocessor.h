...
namespace app::methods::System_Xml_Schema::Preprocessor {
IL2CPP_REGISTER_METHOD(0x016D9770, void, __ctor, (app::Preprocessor * this_ptr, app::XmlNameTable * name_table, app::SchemaNames * schema_names, app::ValidationEventHandler * event_handler, app::XmlSchemaCompilationSettings * compilation_settings));
...
IL2CPP_REGISTER_METHOD(0x002FBB60, XmlSchema *, get_RootSchema, (app::Preprocessor * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x016DFBF0, XmlSchema *, GetParentSchema, (app::XmlSchemaObject * current_schema_object));
...
IL2CPP_REGISTER_METHOD(0x016E4EC0, Uri *, ResolveSchemaLocationUri, (app::Preprocessor * this_ptr, app::XmlSchema * enclosing_schema, app::String * location));
IL2CPP_REGISTER_METHOD(0x016E4F20, Object *, GetSchemaEntity, (app::Preprocessor * this_ptr, app::Uri * ruri));
IL2CPP_REGISTER_METHOD(0x016E4F60, XmlSchema *, GetChameleonSchema, (app::Preprocessor * this_ptr, app::String * target_namespace, app::XmlSchema * schema));
