...
IL2CPP_REGISTER_METHOD(0x01E70E40, bool, IsThreadPoolLow, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x01E70E70, bool, get_HasShutdownStarted, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x01E71020, ContextCallback *, get_ContextRelativeDemandCallback, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x01E71450, IPHostEntry *, GetLocalHost, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x01E714F0, IPAddress__Array *, get_LocalAddresses, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x01E71B90, Object *, get_LocalAddressesLock, (MethodInfo * method));
}
