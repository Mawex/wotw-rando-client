...
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_Path, (app::NumericDebugMenuItem_1_System_Single_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Text, (app::NumericDebugMenuItem_1_System_Single_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_HelpText, (app::NumericDebugMenuItem_1_System_Single_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, Func_1_String_ *, get_DynamicText, (app::NumericDebugMenuItem_1_System_Single_ * this_ptr));
