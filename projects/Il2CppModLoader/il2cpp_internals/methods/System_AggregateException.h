...
IL2CPP_REGISTER_METHOD(0x002FBC20, ReadOnlyCollection_1_System_Exception_ *, get_InnerExceptions, (app::AggregateException * this_ptr));
IL2CPP_REGISTER_METHOD(0x0228C440, AggregateException *, Flatten, (app::AggregateException * this_ptr));
IL2CPP_REGISTER_METHOD(0x0228C860, String *, ToString, (app::AggregateException * this_ptr));
