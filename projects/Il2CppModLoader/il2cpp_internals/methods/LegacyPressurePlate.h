...
IL2CPP_REGISTER_METHOD(0x00A320A0, ICanActivatePressurePlate *, FilterTarget, (app::LegacyPressurePlate * this_ptr, app::GameObject * target));
...
IL2CPP_REGISTER_METHOD(0x00A32960, void, __ctor, (app::LegacyPressurePlate * this_ptr));
}
