...
IL2CPP_REGISTER_METHOD(0x02753110, Material *, get_material, (app::CameraFilterPack_Blend2Camera_LinearBurn * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x027542E0, void, __ctor, (app::CameraFilterPack_Blend2Camera_LinearBurn * this_ptr));
}
