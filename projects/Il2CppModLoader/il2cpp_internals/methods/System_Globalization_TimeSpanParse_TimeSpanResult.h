...
namespace app::methods::System_Globalization::TimeSpanParse_TimeSpanResult {
...
IL2CPP_REGISTER_METHOD(0x001D4420, Exception *, GetTimeSpanParseException, (app::TimeSpanParse_TimeSpanResult__Boxed * this_ptr));
}
