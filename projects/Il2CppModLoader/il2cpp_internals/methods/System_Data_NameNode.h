...
namespace app::methods::System_Data::NameNode {
IL2CPP_REGISTER_METHOD(0x01E44480, void, __ctor_1, (app::NameNode * this_ptr, app::DataTable * table, app::Char__Array * text, int32_t start, int32_t pos));
IL2CPP_REGISTER_METHOD(0x0058DA40, void, __ctor_2, (app::NameNode * this_ptr, app::DataTable * table, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x01E446C0, Object *, Eval_1, (app::NameNode * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047338C0, NameNode_Eval__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E44700, Object *, Eval_2, (app::NameNode * this_ptr, app::DataRow * row, app::DataRowVersion__Enum version));
IL2CPP_REGISTER_METHODINFO(0x0473B598, NameNode_Eval_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E44880, Object *, Eval_3, (app::NameNode * this_ptr, app::Int32__Array * records));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, ExpressionNode *, Optimize, (app::NameNode * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E449C0, String *, ParseName, (app::Char__Array * text, int32_t start, int32_t pos));
