...
namespace app::methods::Microsoft_Win32::UnsafeNativeMethods_ManifestEtw {
IL2CPP_REGISTER_METHOD(0x023B70F0, uint32_t, EventRegister, (app::Guid * provider_id, app::UnsafeNativeMethods_ManifestEtw_EtwEnableCallback * enable_callback, app::Void * callback_context, app::int64_t * registration_handle));
...
IL2CPP_REGISTER_METHOD(0x023B75F0, int32_t, EnumerateTraceGuidsEx, (app::UnsafeNativeMethods_ManifestEtw_TRACE_QUERY_INFO_CLASS__Enum trace_query_info_class, app::Void * in_buffer, int32_t in_buffer_size, app::Void * out_buffer, int32_t out_buffer_size, app::int32_t * return_length));
}
