...
namespace app::methods::SwarmEntity {
    ...
    IL2CPP_REGISTER_METHOD(0x00F189C0, List_1_SwarmAgent_*, get_SwarmAgents, (app::SwarmEntity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01819E80, Transform*, get_GetFirstLiveAgent, (app::SwarmEntity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0181DBF0, SwarmAgent*, GetKilledAgent, (app::SwarmEntity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0181EAD0, Transform*, GetNextTarget, (app::SwarmEntity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0181EDA0, Transform*, GetDefaultTarget, (app::SwarmEntity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0181F840, Vector3, GetNestPosition, (app::SwarmEntity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x018202A0, void, __ctor, (app::SwarmEntity * this_ptr));
} // namespace app::methods::SwarmEntity
