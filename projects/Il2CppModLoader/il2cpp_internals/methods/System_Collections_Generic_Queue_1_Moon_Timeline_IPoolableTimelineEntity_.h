...
IL2CPP_REGISTER_METHOD(0x02CA7610, void, Enqueue, (Queue_1_Moon_Timeline_IPoolableTimelineEntity_ * __this, IPoolableTimelineEntity * item));
IL2CPP_REGISTER_METHODINFO(0x047824D0, Queue_1_Moon_Timeline_IPoolableTimelineEntity__Enqueue__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FD1D0, int32_t, get_Count, (Queue_1_Moon_Timeline_IPoolableTimelineEntity_ * __this));
IL2CPP_REGISTER_METHODINFO(0x04729D80, Queue_1_Moon_Timeline_IPoolableTimelineEntity__get_Count__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02CA77B0, IPoolableTimelineEntity *, Dequeue, (Queue_1_Moon_Timeline_IPoolableTimelineEntity_ * __this));
