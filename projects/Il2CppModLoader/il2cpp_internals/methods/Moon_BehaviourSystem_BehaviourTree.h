...
namespace app::methods::Moon_BehaviourSystem::BehaviourTree {
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, BehaviourNode *, get_Root, (app::BehaviourTree * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBC0, IBehaviourNode *, get_LastExecutedLeafNode, (app::BehaviourTree * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03006630, String *, get_SkippedUpdateReason, (app::BehaviourTree * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9D0, IBlackboard *, get_Blackboard, (app::BehaviourTree * this_ptr));
IL2CPP_REGISTER_METHOD(0x030066C0, BehaviourStatus__Enum, get_RootStatus, (app::BehaviourTree * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03006CB0, BehaviourStatus__Enum, Execute, (app::BehaviourTree * this_ptr, app::IContext * context, bool update_whole_tree));
...
IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::BehaviourTree * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03006F60, void, __ctor, (app::BehaviourTree * this_ptr));
}
