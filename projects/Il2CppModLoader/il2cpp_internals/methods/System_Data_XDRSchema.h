...
namespace app::methods::System_Data::XDRSchema {
IL2CPP_REGISTER_METHOD(0x022C1A50, void, __ctor, (app::XDRSchema * this_ptr, app::DataSet * ds, bool f_inline));
IL2CPP_REGISTER_METHOD(0x022C1B10, void, LoadSchema, (app::XDRSchema * this_ptr, app::XmlElement * schema_root, app::DataSet * ds));
IL2CPP_REGISTER_METHOD(0x022C1D70, XmlElement *, FindTypeNode, (app::XDRSchema * this_ptr, app::XmlElement * node));
...
IL2CPP_REGISTER_METHOD(0x022C2480, DataTable *, HandleTable, (app::XDRSchema * this_ptr, app::XmlElement * node));
IL2CPP_REGISTER_METHOD(0x022C2840, XDRSchema_NameType *, FindNameType, (app::String * name));
IL2CPP_REGISTER_METHODINFO(0x0476ADF0, XDRSchema_FindNameType__MethodInfo);
IL2CPP_REGISTER_METHOD(0x022C2980, Type *, ParseDataType, (app::XDRSchema * this_ptr, app::String * dt, app::String * dt_values));
IL2CPP_REGISTER_METHODINFO(0x047596A0, XDRSchema_ParseDataType__MethodInfo);
IL2CPP_REGISTER_METHOD(0x022C2B20, String *, GetInstanceName, (app::XDRSchema * this_ptr, app::XmlElement * node));
...
IL2CPP_REGISTER_METHOD(0x022C3750, void, GetMinMax_1, (app::XDRSchema * this_ptr, app::XmlElement * el_node, app::int32_t * min_occurs, app::int32_t * max_occurs));
IL2CPP_REGISTER_METHOD(0x022C3780, void, GetMinMax_2, (app::XDRSchema * this_ptr, app::XmlElement * el_node, bool is_attribute, app::int32_t * min_occurs, app::int32_t * max_occurs));
...
IL2CPP_REGISTER_METHOD(0x022C3D50, DataTable *, InstantiateTable, (app::XDRSchema * this_ptr, app::DataSet * data_set, app::XmlElement * node, app::XmlElement * type_node));
IL2CPP_REGISTER_METHODINFO(0x04751B68, XDRSchema_InstantiateTable__MethodInfo);
IL2CPP_REGISTER_METHOD(0x022C4520, DataTable *, InstantiateSimpleTable, (app::XDRSchema * this_ptr, app::DataSet * data_set, app::XmlElement * node));
