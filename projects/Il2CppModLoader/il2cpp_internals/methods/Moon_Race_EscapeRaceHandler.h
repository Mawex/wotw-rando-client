...
namespace app::methods::Moon_Race::EscapeRaceHandler {
IL2CPP_REGISTER_METHOD(0x00C419B0, RaceStateMachineContext *, get_Context, (app::EscapeRaceHandler * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C42970, IEnumerator *, StartMenuRaceNextFrame, (app::EscapeRaceHandler * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C42AC0, void, OnEnable, (app::EscapeRaceHandler * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::EscapeRaceHandler * this_ptr));
}
