...
namespace app::methods::UnityEngine_EventSystems::EventTrigger {
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::EventTrigger * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F1DF80, List_1_UnityEngine_EventSystems_EventTrigger_Entry_ *, get_triggers, (app::EventTrigger * this_ptr));
