...
namespace app::methods::System_Net::HttpListenerPrefixCollection {
IL2CPP_REGISTER_METHOD(0x01D45B30, void, __ctor_1, (app::HttpListenerPrefixCollection * this_ptr, app::HttpListener * listener));
...
IL2CPP_REGISTER_METHOD(0x01D461B0, IEnumerator_1_System_String_ *, GetEnumerator, (app::HttpListenerPrefixCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x01D46280, IEnumerator *, IEnumerable_GetEnumerator, (app::HttpListenerPrefixCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D464B0, void, __ctor_2, (app::HttpListenerPrefixCollection * this_ptr));
