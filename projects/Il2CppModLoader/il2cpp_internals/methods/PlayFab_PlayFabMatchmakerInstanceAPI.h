...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_1, (app::PlayFabMatchmakerInstanceAPI * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor_2, (app::PlayFabMatchmakerInstanceAPI * this_ptr, app::PlayFabApiSettings * settings));
IL2CPP_REGISTER_METHOD(0x002FB940, void, __ctor_3, (app::PlayFabMatchmakerInstanceAPI * this_ptr, app::PlayFabAuthenticationContext * context));
IL2CPP_REGISTER_METHOD(0x0058DA40, void, __ctor_4, (app::PlayFabMatchmakerInstanceAPI * this_ptr, app::PlayFabApiSettings * settings, app::PlayFabAuthenticationContext * context));
...
IL2CPP_REGISTER_METHOD(0x002FB930, PlayFabAuthenticationContext *, GetAuthenticationContext, (app::PlayFabMatchmakerInstanceAPI * this_ptr));
