...
namespace app::methods::System_Net_Configuration::ModuleElement {
IL2CPP_REGISTER_METHOD(0x02019CB0, void, __ctor, (app::ModuleElement * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0470C0D0, ModuleElement__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02019CE0, ConfigurationPropertyCollection *, get_Properties, (app::ModuleElement * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0470F330, ModuleElement_get_Properties__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02019D10, String *, get_Type, (app::ModuleElement * this_ptr));
