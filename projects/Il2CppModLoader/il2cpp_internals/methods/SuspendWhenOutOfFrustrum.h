...
IL2CPP_REGISTER_METHOD(0x00674B80, Bounds, get_Bounds, (app::SuspendWhenOutOfFrustrum * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006750A0, void, __ctor, (app::SuspendWhenOutOfFrustrum * this_ptr));
}
