...
namespace app::methods::Moon::MoonBool {
    ...
    IL2CPP_REGISTER_METHOD(0x02F8F030, CrossSceneReferenceId, get_CrossSceneReferenceId, (app::MoonBool * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x02F8F210, void, __ctor, (app::MoonBool * this_ptr, bool static_value));
    ...
    IL2CPP_REGISTER_METHOD(0x02F8F8C0, bool, TryResolve, (app::MoonBool * this_ptr, app::bool* value, app::IMoonResolverContext* context));
    ...
    IL2CPP_REGISTER_METHOD(0x00C3DD30, MoonTypeData, GetTypeData, (app::MoonBool * this_ptr));
} // namespace app::methods::Moon::MoonBool
