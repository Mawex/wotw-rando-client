...
IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkImageSourceParams * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x026E6390, void *, getCPtr, (app::AkImageSourceParams * obj));
IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkImageSourceParams * this_ptr, app::void * c_ptr));
...
IL2CPP_REGISTER_METHOD(0x026E66B0, void, __ctor_2, (app::AkImageSourceParams * this_ptr));
IL2CPP_REGISTER_METHOD(0x026E67D0, void, __ctor_3, (app::AkImageSourceParams * this_ptr, app::AkVector * in_source_position, float in_f_distance_scaling_factor, float in_f_level));
IL2CPP_REGISTER_METHOD(0x026E6940, void, set_sourcePosition, (app::AkImageSourceParams * this_ptr, app::AkVector * value));
IL2CPP_REGISTER_METHOD(0x026E6A80, AkVector *, get_sourcePosition, (app::AkImageSourceParams * this_ptr));
