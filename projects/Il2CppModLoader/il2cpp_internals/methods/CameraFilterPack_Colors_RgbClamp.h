...
IL2CPP_REGISTER_METHOD(0x024E2B40, Material *, get_material, (app::CameraFilterPack_Colors_RgbClamp * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024E3410, void, __ctor, (app::CameraFilterPack_Colors_RgbClamp * this_ptr));
}
