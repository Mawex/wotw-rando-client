...
namespace app::methods::Moon_Rendering::VolumetricPointLight {
IL2CPP_REGISTER_METHOD(0x002FB990, Light *, get_Light, (app::VolumetricPointLight * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::VolumetricPointLight * this_ptr));
}
