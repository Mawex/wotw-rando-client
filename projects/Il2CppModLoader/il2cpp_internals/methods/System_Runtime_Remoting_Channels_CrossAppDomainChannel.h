...
IL2CPP_REGISTER_METHOD(0x01A9E3F0, void, RegisterCrossAppDomainChannel, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x01A9E9E0, void, __cctor, (MethodInfo * method));
}
