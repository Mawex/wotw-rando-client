...
IL2CPP_REGISTER_METHOD(0x00868870, Vector3, get_OriginalScale, (app::ScaleAxisAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00933870, bool, get_IsLooping, (app::ScaleAxisAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00933A20, void, __ctor, (app::ScaleAxisAnimator * this_ptr));
}
