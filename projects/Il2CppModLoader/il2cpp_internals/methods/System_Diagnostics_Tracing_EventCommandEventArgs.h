...
namespace app::methods::System_Diagnostics_Tracing::EventCommandEventArgs {
IL2CPP_REGISTER_METHOD(0x002FC6D0, EventCommand__Enum, get_Command, (app::EventCommandEventArgs * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FC6E0, void, set_Command, (app::EventCommandEventArgs * this_ptr, app::EventCommand__Enum value));
IL2CPP_REGISTER_METHOD(0x002FB930, IDictionary_2_System_String_System_String_ *, get_Arguments, (app::EventCommandEventArgs * this_ptr));
