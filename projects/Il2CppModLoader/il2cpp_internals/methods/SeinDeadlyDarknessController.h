...
IL2CPP_REGISTER_METHOD(0x006FD900, ZoneDamageSettings *, get_DamageSettings, (app::SeinDeadlyDarknessController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003FF3C0, SuspendableMask__Enum, get_Mask, (app::SeinDeadlyDarknessController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006FEE70, void, __ctor, (app::SeinDeadlyDarknessController * this_ptr));
}
