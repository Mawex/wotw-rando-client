...
namespace app::methods::Moon_Telemetry_Performance_profilers::GPUAutoProfilerReportRenderer {
...
IL2CPP_REGISTER_METHOD(0x00E49710, void, __ctor, (app::GPUAutoProfilerReportRenderer * this_ptr));
