...
IL2CPP_REGISTER_METHOD(0x02462D60, Material *, get_material, (app::CameraFilterPack_EXTRA_SHOWFPS * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02463670, IEnumerator *, FPSX, (app::CameraFilterPack_EXTRA_SHOWFPS * this_ptr));
