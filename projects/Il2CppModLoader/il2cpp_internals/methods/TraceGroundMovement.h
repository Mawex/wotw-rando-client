...
IL2CPP_REGISTER_METHOD(0x00B00C00, Vector3, get_Right, (app::TraceGroundMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B00D50, Vector3, get_Left, (app::TraceGroundMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B00E50, Vector3, get_Up, (app::TraceGroundMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B00E70, Vector3, get_Down, (app::TraceGroundMovement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003FF8B0, SuspendableMask__Enum, get_Mask, (app::TraceGroundMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B01D10, void, set_Mask, (app::TraceGroundMovement * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x00B01DC0, void, __ctor, (app::TraceGroundMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::TraceGroundMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::TraceGroundMovement * this_ptr));
}
