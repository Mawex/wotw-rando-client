...
namespace app::methods::System_Configuration::LocalFileSettingsProvider {
IL2CPP_REGISTER_METHOD(0x02961D20, void, __ctor, (app::LocalFileSettingsProvider * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04722668, LocalFileSettingsProvider__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02961D50, String *, get_ApplicationName, (app::LocalFileSettingsProvider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02961DB0, SettingsPropertyValue *, GetPreviousVersion, (app::LocalFileSettingsProvider * this_ptr, app::SettingsContext * context, app::SettingsProperty * property));
IL2CPP_REGISTER_METHODINFO(0x0473A210, LocalFileSettingsProvider_GetPreviousVersion__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02961DE0, SettingsPropertyValueCollection *, GetPropertyValues, (app::LocalFileSettingsProvider * this_ptr, app::SettingsContext * context, app::SettingsPropertyCollection * properties));
