...
namespace app::methods::Newtonsoft_Json::JsonTextWriter {
IL2CPP_REGISTER_METHOD(0x01EFAB00, Base64Encoder_1 *, get_Base64Encoder, (app::JsonTextWriter * this_ptr));
IL2CPP_REGISTER_METHOD(0x01EFACE0, uint16_t, get_QuoteChar, (app::JsonTextWriter * this_ptr));
IL2CPP_REGISTER_METHOD(0x01EFACF0, void, __ctor, (app::JsonTextWriter * this_ptr, app::TextWriter * text_writer));
