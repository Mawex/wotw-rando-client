...
namespace app::methods::System_Runtime_Serialization_Formatters_Binary::ObjectProgress {
    IL2CPP_REGISTER_METHOD(0x01D94700, void, __ctor, (app::ObjectProgress * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01D94A10, void, __cctor, ());
}
