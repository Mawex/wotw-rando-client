...
IL2CPP_REGISTER_METHOD(0x026F81B0, void, __ctor, (app::AkMIDIPostArray * this_ptr, int32_t size));
IL2CPP_REGISTER_METHOD(0x026F82A0, AkMIDIPost *, get_Item, (app::AkMIDIPostArray * this_ptr, int32_t index));
