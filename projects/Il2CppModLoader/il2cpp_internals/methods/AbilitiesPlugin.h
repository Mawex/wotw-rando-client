...
IL2CPP_REGISTER_METHOD(0x004ABA40, Object *, ReflectionHack, (app::String * full_name));
...
IL2CPP_REGISTER_METHOD(0x004ACB20, List_1_UnityEngine_Vector3_ *, ExtractDataFromRecorder, (app::RecorderData * recorder_data));
IL2CPP_REGISTER_METHOD(0x004ACE50, void, __ctor, (app::AbilitiesPlugin * this_ptr));
}
