...
namespace app::methods::System_Data_Common::SqlBooleanStorage {
IL2CPP_REGISTER_METHOD(0x02843600, void, __ctor, (app::SqlBooleanStorage * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x02843790, Object *, Aggregate, (app::SqlBooleanStorage * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x02843D20, Object *, ConvertValue, (app::SqlBooleanStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02843DE0, void, Copy, (app::SqlBooleanStorage * this_ptr, int32_t record_no1, int32_t record_no2));
IL2CPP_REGISTER_METHOD(0x02843E50, Object *, Get, (app::SqlBooleanStorage * this_ptr, int32_t record));
...
IL2CPP_REGISTER_METHOD(0x028440A0, Object *, ConvertXmlToObject, (app::SqlBooleanStorage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x028443F0, String *, ConvertObjectToXml, (app::SqlBooleanStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02844750, Object *, GetEmptyStorage, (app::SqlBooleanStorage * this_ptr, int32_t record_count));
