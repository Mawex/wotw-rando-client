...
namespace app::methods::Moon_Rendering::MoonRenderPipelineView_UpscalePost {
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MoonRenderPipelineView_UpscalePost * this_ptr));
}
