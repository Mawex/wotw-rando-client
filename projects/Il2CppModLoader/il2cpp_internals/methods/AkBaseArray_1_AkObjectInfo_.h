...
IL2CPP_REGISTER_METHOD(0x019D7280, void, __ctor, (app::AkBaseArray_1_AkObjectInfo_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, ReleaseAllocatedMemoryFromReferenceAtIntPtr, (app::AkBaseArray_1_AkObjectInfo_ * this_ptr, app::void * address));
}
