...
IL2CPP_REGISTER_METHOD(0x00A64220, EntityDamageEvent *, get_DamageEvent, (app::SpiderlingHitReactionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011C4AA0, BehaviourStatus__Enum, OnExecuteTask, (app::SpiderlingHitReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x011C5750, void, __ctor, (app::SpiderlingHitReactionBehaviour * this_ptr));
}
