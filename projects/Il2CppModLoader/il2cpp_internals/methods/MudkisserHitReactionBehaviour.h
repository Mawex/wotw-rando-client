...
IL2CPP_REGISTER_METHOD(0x00418200, EntityDamageEvent *, get_DamageEvent, (app::MudkisserHitReactionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00876960, Vector2, ProcessSpecialMultipliers, (app::MudkisserHitReactionBehaviour * this_ptr, app::Damage * damage, app::Vector2 final_force));
...
IL2CPP_REGISTER_METHOD(0x00420230, BehaviourStatus__Enum, OnExecuteTask, (app::MudkisserHitReactionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x008775B0, void, OnExitTask, (app::MudkisserHitReactionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x008775C0, void, __ctor, (app::MudkisserHitReactionBehaviour * this_ptr));
}
