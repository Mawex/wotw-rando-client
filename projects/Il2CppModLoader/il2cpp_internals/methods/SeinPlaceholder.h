...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::SeinPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDisableOnRecordablePreview_get_gameObject, (app::SeinPlaceholder * this_ptr));
}
