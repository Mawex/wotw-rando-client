...
namespace app::methods::BaseZone {
    ...
    IL2CPP_REGISTER_METHOD(0x003FC830, SuspendableMask__Enum, get_Mask, (app::BaseZone * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00F8C680, void, set_Mask, (app::BaseZone * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x0043D9A0, SelectableCategory__Enum, get_Category, (app::BaseZone * this_ptr));
    IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, get_ShouldSerialize, (app::BaseZone * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00F8C730, Transform*, get_Transform, (app::BaseZone * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00597B10, UpdateType__Enum, get_UpdateType, (app::BaseZone * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0043BB90, void, __ctor, (app::BaseZone * this_ptr));
} // namespace app::methods::BaseZone
