...
IL2CPP_REGISTER_METHOD(0x00BF8110, BehaviourStatus__Enum, OnExecute, (app::ElectricFieldSlugBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00BF8680, void, __ctor, (app::ElectricFieldSlugBehaviour * this_ptr));
}
