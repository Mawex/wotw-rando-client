...
namespace app::methods::System_Text::UnicodeEncoding_Decoder {
    IL2CPP_REGISTER_METHOD(0x027D7930, void, __ctor_1, (app::UnicodeEncoding_Decoder * this_ptr, app::UnicodeEncoding * encoding));
    IL2CPP_REGISTER_METHOD(0x027D7970, void, __ctor_2, (app::UnicodeEncoding_Decoder * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
