...
namespace app::methods::UnityEngine_UI::Selectable {
IL2CPP_REGISTER_METHOD(0x026714F0, void, __ctor, (app::Selectable * this_ptr));
IL2CPP_REGISTER_METHOD(0x02671830, List_1_UnityEngine_UI_Selectable_ *, get_allSelectables, ());
IL2CPP_REGISTER_METHOD(0x026718D0, Navigation, get_navigation, (app::Selectable * this_ptr));
IL2CPP_REGISTER_METHOD(0x026718F0, void, set_navigation, (app::Selectable * this_ptr, app::Navigation value));
IL2CPP_REGISTER_METHOD(0x02671A20, Selectable_Transition__Enum, get_transition, (app::Selectable * this_ptr));
IL2CPP_REGISTER_METHOD(0x02671A30, void, set_transition, (app::Selectable * this_ptr, app::Selectable_Transition__Enum value));
IL2CPP_REGISTER_METHOD(0x02671AE0, ColorBlock, get_colors, (app::Selectable * this_ptr));
IL2CPP_REGISTER_METHOD(0x02671B20, void, set_colors, (app::Selectable * this_ptr, app::ColorBlock value));
IL2CPP_REGISTER_METHOD(0x02671CB0, SpriteState, get_spriteState, (app::Selectable * this_ptr));
IL2CPP_REGISTER_METHOD(0x02671CD0, void, set_spriteState, (app::Selectable * this_ptr, app::SpriteState value));
IL2CPP_REGISTER_METHOD(0x02671DF0, AnimationTriggers *, get_animationTriggers, (app::Selectable * this_ptr));
IL2CPP_REGISTER_METHOD(0x02671E00, void, set_animationTriggers, (app::Selectable * this_ptr, app::AnimationTriggers * value));
IL2CPP_REGISTER_METHOD(0x024B76C0, Graphic *, get_targetGraphic, (app::Selectable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x026721C0, Image *, get_image, (app::Selectable * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD50, void, set_image, (app::Selectable * this_ptr, app::Image * value));
IL2CPP_REGISTER_METHOD(0x02672280, Animator *, get_animator, (app::Selectable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02672820, Selectable_SelectionState__Enum, get_currentSelectionState, (app::Selectable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02672B90, Selectable *, FindSelectable, (app::Selectable * this_ptr, app::Vector3 dir));
IL2CPP_REGISTER_METHOD(0x02673350, Vector3, GetPointOnRectEdge, (app::RectTransform * rect, app::Vector2 dir));
IL2CPP_REGISTER_METHOD(0x02673680, void, Navigate, (app::Selectable * this_ptr, app::AxisEventData * event_data, app::Selectable * sel));
IL2CPP_REGISTER_METHOD(0x02673780, Selectable *, FindSelectableOnLeft, (app::Selectable * this_ptr));
IL2CPP_REGISTER_METHOD(0x02673940, Selectable *, FindSelectableOnRight, (app::Selectable * this_ptr));
IL2CPP_REGISTER_METHOD(0x02673B00, Selectable *, FindSelectableOnUp, (app::Selectable * this_ptr));
IL2CPP_REGISTER_METHOD(0x02673CC0, Selectable *, FindSelectableOnDown, (app::Selectable * this_ptr));
