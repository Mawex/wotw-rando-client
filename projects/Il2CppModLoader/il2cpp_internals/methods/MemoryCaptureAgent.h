...
IL2CPP_REGISTER_METHOD(0x009D6C00, String__Array *, GetDataHeaderNames, (app::MemoryCaptureAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x009D6CD0, String__Array *, GetFrameData_1, (app::MemoryCaptureAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MemoryCaptureAgent * this_ptr));
}
