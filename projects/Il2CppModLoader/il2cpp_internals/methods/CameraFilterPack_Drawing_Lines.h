...
IL2CPP_REGISTER_METHOD(0x024F2D80, Material *, get_material, (app::CameraFilterPack_Drawing_Lines * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E4C90, void, __ctor, (app::CameraFilterPack_Drawing_Lines * this_ptr));
}
