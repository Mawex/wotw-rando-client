...
IL2CPP_REGISTER_METHOD(0x00756A30, SkeetoDeathReaction *, get_DeathReaction, (app::SkeetoFallingReactionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00756F90, void, __ctor, (app::SkeetoFallingReactionBehaviour * this_ptr));
}
