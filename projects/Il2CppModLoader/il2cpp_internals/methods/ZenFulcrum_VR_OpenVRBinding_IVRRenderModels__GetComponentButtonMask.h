...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::IVRRenderModels_GetComponentButtonMask * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x01435260, IAsyncResult *, BeginInvoke, (app::IVRRenderModels_GetComponentButtonMask * this_ptr, app::String * pch_render_model_name, app::String * pch_component_name, app::AsyncCallback * callback, app::Object * object));
