...
IL2CPP_REGISTER_METHOD(0x01F5EF20, DataKey, get_ChildKey, (app::ForeignKeyConstraint * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F5EF40, DataColumn__Array *, get_Columns, (app::ForeignKeyConstraint * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F5EF60, DataTable *, get_Table, (app::ForeignKeyConstraint * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F5EFB0, String__Array *, get_ParentColumnNames, (app::ForeignKeyConstraint * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F5EFC0, String__Array *, get_ChildColumnNames, (app::ForeignKeyConstraint * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F61550, AcceptRejectRule__Enum, get_AcceptRejectRule, (app::ForeignKeyConstraint * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F616E0, Constraint_1 *, Clone_1, (app::ForeignKeyConstraint * this_ptr, app::DataSet * destination));
IL2CPP_REGISTER_METHOD(0x01F61700, Constraint_1 *, Clone_2, (app::ForeignKeyConstraint * this_ptr, app::DataSet * destination, bool ignor_n_sfor_table_lookup));
IL2CPP_REGISTER_METHOD(0x01F61F70, ForeignKeyConstraint *, Clone_3, (app::ForeignKeyConstraint * this_ptr, app::DataTable * destination));
...
IL2CPP_REGISTER_METHOD(0x01F62820, Rule__Enum, get_DeleteRule, (app::ForeignKeyConstraint * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F62A80, DataColumn__Array *, get_RelatedColumns, (app::ForeignKeyConstraint * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F62AA0, DataColumn__Array *, get_RelatedColumnsReference, (app::ForeignKeyConstraint * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F62AA0, DataKey, get_ParentKey, (app::ForeignKeyConstraint * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F62AC0, DataRelation *, FindParentRelation, (app::ForeignKeyConstraint * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F62BB0, DataTable *, get_RelatedTable, (app::ForeignKeyConstraint * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F62C00, Rule__Enum, get_UpdateRule, (app::ForeignKeyConstraint * this_ptr));
