...
IL2CPP_REGISTER_METHOD(0x011B3EE0, BehaviourStatus__Enum, OnExecute, (app::SpiderBossLocationTurningTimelineBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x011B3F40, void, __ctor, (app::SpiderBossLocationTurningTimelineBehaviour * this_ptr));
}
