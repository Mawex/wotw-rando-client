...
namespace app::methods::Moon_ArtOptimization::TexturePoolEntity {
IL2CPP_REGISTER_METHOD(0x00CB2DB0, void, __ctor, (app::TexturePoolEntity * this_ptr, app::TexturesPool * pool));
...
IL2CPP_REGISTER_METHOD(0x002FB930, Texture2D *, get_Texture, (app::TexturePoolEntity * this_ptr));
