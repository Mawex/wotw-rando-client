...
IL2CPP_REGISTER_METHOD(0x0064B2F0, void, __ctor, (app::JUnitReporter_TestSuites * this_ptr, app::String * id, app::String * name));
IL2CPP_REGISTER_METHOD(0x0064B460, JUnitReporter_TestSuite *, AddTestSuite, (app::JUnitReporter_TestSuites * this_ptr, app::JUnitReporter_TestSuite * test_suite));
