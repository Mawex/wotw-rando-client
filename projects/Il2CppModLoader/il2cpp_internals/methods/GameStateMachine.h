...
IL2CPP_REGISTER_METHOD(0x002FC6D0, GameStateMachine_State__Enum, get_CurrentState, (app::GameStateMachine * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::GameStateMachine * this_ptr));
}
