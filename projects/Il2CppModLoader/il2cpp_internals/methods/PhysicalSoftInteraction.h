...
IL2CPP_REGISTER_METHOD(0x014EE7B0, Bounds, get_Bounds, (app::PhysicalSoftInteraction * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D3D6A0, Vector3, GetPosition, (app::PhysicalSoftInteraction * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B68B50, Vector3, GetExplodePoint, (app::PhysicalSoftInteraction * this_ptr, app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x014EF200, void, OnDrawGizmosSelected, (app::PhysicalSoftInteraction * this_ptr));
IL2CPP_REGISTER_METHOD(0x014EF300, void, __ctor, (app::PhysicalSoftInteraction * this_ptr));
