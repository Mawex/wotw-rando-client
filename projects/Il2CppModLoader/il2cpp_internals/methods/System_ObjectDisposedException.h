...
IL2CPP_REGISTER_METHOD(0x0227B5E0, String *, get_Message, (app::ObjectDisposedException * this_ptr));
IL2CPP_REGISTER_METHOD(0x0227B740, String *, get_ObjectName, (app::ObjectDisposedException * this_ptr));
