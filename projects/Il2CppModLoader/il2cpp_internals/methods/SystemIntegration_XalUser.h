...
IL2CPP_REGISTER_METHOD(0x002FB990, Texture2D *, get_Image, (app::XalUser * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9A0, void, set_Image, (app::XalUser * this_ptr, app::Texture2D * value));
IL2CPP_REGISTER_METHOD(0x00CDE950, String *, get_GamerTag, (app::XalUser * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CDEA00, String *, get_Uid, (app::XalUser * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CDEB80, String *, get_SignInPrefix, (app::XalUser * this_ptr));
IL2CPP_REGISTER_METHOD(0x0058DA40, void, __ctor, (app::XalUser * this_ptr, app::XalUser_1 * xal_user, app::Action * on_sign_out));
IL2CPP_REGISTER_METHOD(0x00CDEC00, Task *, GetGamerPicture, (app::XalUser * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CDEF30, Task_1_System_Boolean_ *, BuildIntoUnityImage, (app::XalUser * this_ptr, app::Task_1_System_Byte_ * buffer));
