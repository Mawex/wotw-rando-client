...
IL2CPP_REGISTER_METHOD(0x0110E920, GroundEntityLocomotion *, get_Locomotion, (app::MapMakerInteractionBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x0110EA50, void, OnEnter, (app::MapMakerInteractionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x0110EB30, BehaviourStatus__Enum, OnExecute, (app::MapMakerInteractionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0060C1C0, void, __ctor, (app::MapMakerInteractionBehaviour * this_ptr));
}
