...
namespace app::methods::Moon_InteractionGraph::CallbackState {
IL2CPP_REGISTER_METHOD(0x0198B7F0, CallbackState *, AddUpdateStateAction, (app::CallbackState * this_ptr, app::Action * update_state_action));
IL2CPP_REGISTER_METHOD(0x0198B8B0, void, __ctor, (app::CallbackState * this_ptr, app::IState_1 * state));
