...
IL2CPP_REGISTER_METHOD(0x002FB9D0, SceneSettings *, get_FromSettings, (app::SceneSettingsTransitionZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, SceneSettings *, get_ToSettings, (app::SceneSettingsTransitionZone * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00910BD0, SelectableCategory__Enum, get_Category, (app::SceneSettingsTransitionZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::SceneSettingsTransitionZone * this_ptr));
