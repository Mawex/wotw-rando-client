...
namespace app::methods::DigZone {
    IL2CPP_REGISTER_METHOD(0x00B92F40, Collider*, get_CageCollider, (app::DigZone * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00B93010, CageStructureTool*, get_CageStructure, (app::DigZone * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00910BD0, NavigationType__Enum, AreaType, (app::DigZone * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00B93870, Vector2, GetVelocityAtPoint, (app::DigZone * this_ptr, app::Vector2 point));
    IL2CPP_REGISTER_METHOD(0x00B93900, void, __ctor, (app::DigZone * this_ptr));
} // namespace app::methods::DigZone
