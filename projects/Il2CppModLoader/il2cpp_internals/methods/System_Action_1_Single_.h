...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::Action_1_Single_ * this_ptr, app::Object * object, app::void * method_1));
IL2CPP_REGISTER_METHODINFO(0x0477D0B0, Action_1_Single___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02C07D60, IAsyncResult *, BeginInvoke, (app::Action_1_Single_ * this_ptr, float obj, app::AsyncCallback * callback, app::Object * object));
