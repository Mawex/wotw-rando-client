...
IL2CPP_REGISTER_METHOD(0x0044E710, MoonRenderPipelineAsset *, get_MoonRenderAsset, (app::ColorVariationManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011D9E00, void, __ctor, (app::ColorVariationManager * this_ptr));
