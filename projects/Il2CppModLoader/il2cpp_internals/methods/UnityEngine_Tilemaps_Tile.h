...
namespace app::methods::UnityEngine_Tilemaps::Tile {
IL2CPP_REGISTER_METHOD(0x031BEEA0, void, __ctor, (app::Tile * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F25880, Sprite *, get_sprite, (app::Tile * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_sprite, (app::Tile * this_ptr, app::Sprite * value));
IL2CPP_REGISTER_METHOD(0x031BEF90, Color, get_color, (app::Tile * this_ptr));
IL2CPP_REGISTER_METHOD(0x02071D00, void, set_color, (app::Tile * this_ptr, app::Color value));
IL2CPP_REGISTER_METHOD(0x031BEFA0, Matrix4x4, get_transform, (app::Tile * this_ptr));
IL2CPP_REGISTER_METHOD(0x031BEFD0, void, set_transform, (app::Tile * this_ptr, app::Matrix4x4 value));
IL2CPP_REGISTER_METHOD(0x029F05B0, GameObject *, get_gameObject, (app::Tile * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBD0, void, set_gameObject, (app::Tile * this_ptr, app::GameObject * value));
IL2CPP_REGISTER_METHOD(0x031BEFF0, TileFlags__Enum, get_flags, (app::Tile * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B0E550, void, set_flags, (app::Tile * this_ptr, app::TileFlags__Enum value));
IL2CPP_REGISTER_METHOD(0x031BF000, Tile_ColliderType__Enum, get_colliderType, (app::Tile * this_ptr));
