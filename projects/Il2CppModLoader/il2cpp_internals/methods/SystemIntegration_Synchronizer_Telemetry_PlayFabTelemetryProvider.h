...
namespace app::methods::SystemIntegration_Synchronizer_Telemetry::PlayFabTelemetryProvider {
IL2CPP_REGISTER_METHOD(0x00CD9930, void, __ctor, (app::PlayFabTelemetryProvider * this_ptr, app::INetworkConnectivityChecker * network_connectivity_checker));
