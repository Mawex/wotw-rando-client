...
IL2CPP_REGISTER_METHOD(0x002FB9F0, RecordableObjectPuppet *, get_Puppet, (app::RecordableObject * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0044C850, void, __ctor, (app::RecordableObject * this_ptr));
}
