...
IL2CPP_REGISTER_METHOD(0x00654950, SuspendableMask__Enum, get_Mask, (app::Suspendable * this_ptr));
IL2CPP_REGISTER_METHOD(0x031AC170, void, set_Mask, (app::Suspendable * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x00444DD0, void, __ctor, (app::Suspendable * this_ptr));
}
