...
namespace app::methods::System_Collections_Generic::List_1_System_Object_ {
...
IL2CPP_REGISTER_METHOD(0x02FE87E0, Object *, ICollection_get_SyncRoot, (app::List_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025EFC50, Object *, get_Item, (app::List_1_System_Object_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02FE89B0, Object *, IList_get_Item, (app::List_1_System_Object_ * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x02FE89E0, void, IList_set_Item, (app::List_1_System_Object_ * this_ptr, int32_t index, app::Object * value));
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04700D70, List_1_System_Object___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_System_Object_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHODINFO(0x047366E0, List_1_System_Object___ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02FE8360, void, __ctor_3, (app::List_1_System_Object_ * this_ptr, app::IEnumerable_1_System_Object_ * collection));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_System_Object_ *, AsReadOnly, (app::List_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01EB9F00, List_1_System_Object_ *, ConvertAll, (app::List_1_System_Object_ * this_ptr, app::Converter_2_Object_Object_ * converter));
...
IL2CPP_REGISTER_METHOD(0x025F05A0, Object *, Find, (app::List_1_System_Object_ * this_ptr, app::Predicate_1_Object_ * match));
IL2CPP_REGISTER_METHOD(0x02F1E5B0, List_1_System_Object_ *, FindAll, (app::List_1_System_Object_ * this_ptr, app::Predicate_1_Object_ * match));
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_System_Object_, GetEnumerator, (app::List_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04726828, List_1_System_Object__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F0B50, IEnumerator_1_System_Object_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025F0B50, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_System_Object_ *, GetRange, (app::List_1_System_Object_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, Object__Array *, ToArray, (app::List_1_System_Object_ * this_ptr));
