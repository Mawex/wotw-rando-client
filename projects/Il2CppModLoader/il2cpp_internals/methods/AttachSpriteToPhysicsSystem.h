...
IL2CPP_REGISTER_METHOD(0x003FBE90, SuspendableMask__Enum, ISuspendable_get_Mask, (app::AttachSpriteToPhysicsSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, TrackingExclusions, IRecordableTransform_get_TrackingExclusions, (app::AttachSpriteToPhysicsSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, RecordableParsingGroup__Enum, IRecordable_get_ParsingGroup, (app::AttachSpriteToPhysicsSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0084C030, void, __ctor, (app::AttachSpriteToPhysicsSystem * this_ptr));
}
