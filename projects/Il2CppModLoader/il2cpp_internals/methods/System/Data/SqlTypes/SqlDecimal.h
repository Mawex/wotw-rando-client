...
namespace app::methods::System::Data::SqlTypes::SqlDecimal {
    ...
    IL2CPP_REGISTER_METHOD(0x001E3440, void, __ctor_1, (app::SqlDecimal__Boxed * this_ptr, bool f_null));
    IL2CPP_REGISTER_METHOD(0x001E3450, void, __ctor_2, (app::SqlDecimal__Boxed * this_ptr, app::Decimal value));
    IL2CPP_REGISTER_METHOD(0x001E3470, void, __ctor_3, (app::SqlDecimal__Boxed * this_ptr, int32_t value));
    IL2CPP_REGISTER_METHOD(0x001E3480, void, __ctor_4, (app::SqlDecimal__Boxed * this_ptr, int64_t value));
    IL2CPP_REGISTER_METHOD(0x001E3490, void, __ctor_5, (app::SqlDecimal__Boxed * this_ptr, app::UInt32__Array * rgl_data, uint8_t b_len, uint8_t b_prec, uint8_t b_scale, bool f_positive));
    ...
    operator - (app::SqlDecimal x) {
        return op_UnaryNegation(x);
    }
    operator + (app::SqlDecimal x, app::SqlDecimal y) {
