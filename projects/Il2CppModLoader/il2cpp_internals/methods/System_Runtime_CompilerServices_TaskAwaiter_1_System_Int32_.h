...
namespace app::methods::System_Runtime_CompilerServices::TaskAwaiter_1_System_Int32_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor, (app::TaskAwaiter_1_System_Int32___Boxed * this_ptr, app::Task_1_System_Int32_ * task));
