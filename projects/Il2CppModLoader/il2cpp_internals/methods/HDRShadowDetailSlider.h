...
IL2CPP_REGISTER_METHOD(0x0109BDD0, String *, GetValueToDisplay, (app::HDRShadowDetailSlider * this_ptr));
IL2CPP_REGISTER_METHOD(0x00444040, void, __ctor, (app::HDRShadowDetailSlider * this_ptr));
}
