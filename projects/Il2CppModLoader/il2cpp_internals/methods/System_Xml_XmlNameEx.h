...
namespace app::methods::System_Xml::XmlNameEx {
...
IL2CPP_REGISTER_METHOD(0x01DC0C70, XmlSchemaValidity__Enum, get_Validity, (app::XmlNameEx * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB40, XmlSchemaSimpleType *, get_MemberType, (app::XmlNameEx * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB60, XmlSchemaType *, get_SchemaType, (app::XmlNameEx * this_ptr));
IL2CPP_REGISTER_METHOD(0x01DC0CC0, XmlSchemaElement *, get_SchemaElement, (app::XmlNameEx * this_ptr));
IL2CPP_REGISTER_METHOD(0x01DC0D80, XmlSchemaAttribute *, get_SchemaAttribute, (app::XmlNameEx * this_ptr));
