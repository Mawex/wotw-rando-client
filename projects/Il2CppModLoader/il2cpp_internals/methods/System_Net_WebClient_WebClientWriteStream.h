...
namespace app::methods::System_Net::WebClient_WebClientWriteStream {
IL2CPP_REGISTER_METHOD(0x01D611E0, void, __ctor, (app::WebClient_WebClientWriteStream * this_ptr, app::Stream * stream, app::WebRequest * request, app::WebClient * web_client));
...
IL2CPP_REGISTER_METHOD(0x01D614B0, IAsyncResult *, BeginRead, (app::WebClient_WebClientWriteStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t size, app::AsyncCallback * callback, app::Object * state));
IL2CPP_REGISTER_METHOD(0x01D614E0, IAsyncResult *, BeginWrite, (app::WebClient_WebClientWriteStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t size, app::AsyncCallback * callback, app::Object * state));
