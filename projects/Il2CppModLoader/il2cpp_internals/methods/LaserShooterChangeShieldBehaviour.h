...
IL2CPP_REGISTER_METHOD(0x00417920, BehaviourStatus__Enum, OnExecute, (app::LaserShooterChangeShieldBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00F131F0, void, __ctor, (app::LaserShooterChangeShieldBehaviour * this_ptr));
}
