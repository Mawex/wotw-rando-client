...
IL2CPP_REGISTER_METHOD(0x00BFD240, IEnumerator *, EnableRoutine, (app::EnableSceneSuspendedAction * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0044C850, void, __ctor, (app::EnableSceneSuspendedAction * this_ptr));
}
