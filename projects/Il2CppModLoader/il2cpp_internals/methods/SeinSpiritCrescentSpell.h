...
IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement *, get_PlatformMovement, (app::SeinSpiritCrescentSpell * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005E2B10, void, __ctor, (app::SeinSpiritCrescentSpell * this_ptr));
}
