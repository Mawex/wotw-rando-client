...
namespace app::methods::Newtonsoft_Json_Serialization::JsonFormatterConverter {
IL2CPP_REGISTER_METHOD(0x018719E0, void, __ctor, (app::JsonFormatterConverter * this_ptr, app::JsonSerializerInternalReader * reader, app::JsonISerializableContract * contract, app::JsonProperty * member));
IL2CPP_REGISTER_METHOD(0x01871AB0, Object *, Convert, (app::JsonFormatterConverter * this_ptr, app::Object * value, app::Type * type));
...
IL2CPP_REGISTER_METHOD(0x01871F50, String *, ToString, (app::JsonFormatterConverter * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x015F4080, Object *, GetTokenValue_1, (app::JsonFormatterConverter * this_ptr, app::Object * value));
...
IL2CPP_REGISTER_METHOD(0x015F4080, String *, GetTokenValue_6, (app::JsonFormatterConverter * this_ptr, app::Object * value));
