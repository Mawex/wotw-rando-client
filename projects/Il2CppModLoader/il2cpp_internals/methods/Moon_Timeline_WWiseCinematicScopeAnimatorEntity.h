...
namespace app::methods::Moon_Timeline::WWiseCinematicScopeAnimatorEntity {
...
IL2CPP_REGISTER_METHOD(0x00D1D680, void, __ctor, (app::WWiseCinematicScopeAnimatorEntity * this_ptr));
}
