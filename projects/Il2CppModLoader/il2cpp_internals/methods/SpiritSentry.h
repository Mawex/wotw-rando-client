...
namespace app::methods::SpiritSentry {
    ...
    IL2CPP_REGISTER_METHOD(0x00D651B0, Transform*, get_m_target, (app::SpiritSentry * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00D652E0, Vector3, HoverOffset, (app::SpiritSentry * this_ptr, float time));
    IL2CPP_REGISTER_METHOD(0x00C47CC0, Vector3, get_Position, (app::SpiritSentry * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x008519C0, SuspendableMask__Enum, get_Mask, (app::SpiritSentry * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00D65EC0, IAttackable*, FindNearestAttackable, (app::SpiritSentry * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00D678D0, void, __ctor, (app::SpiritSentry * this_ptr));
