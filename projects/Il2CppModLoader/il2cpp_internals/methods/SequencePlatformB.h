...
IL2CPP_REGISTER_METHOD(0x0057A5A0, SuspendableMask__Enum, get_Mask, (app::SequencePlatformB * this_ptr));
IL2CPP_REGISTER_METHOD(0x00AB8220, void, set_Mask, (app::SequencePlatformB * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x00AB82E0, void, __ctor, (app::SequencePlatformB * this_ptr));
}
