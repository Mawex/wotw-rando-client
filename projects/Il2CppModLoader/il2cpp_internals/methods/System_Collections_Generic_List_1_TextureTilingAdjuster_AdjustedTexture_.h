...
namespace app::methods::System_Collections_Generic::List_1_TextureTilingAdjuster_AdjustedTexture_ {
...
IL2CPP_REGISTER_METHOD(0x02D49B80, TextureTilingAdjuster_AdjustedTexture, get_Item, (app::List_1_TextureTilingAdjuster_AdjustedTexture_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_TextureTilingAdjuster_AdjustedTexture_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047189D0, List_1_TextureTilingAdjuster_AdjustedTexture___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_TextureTilingAdjuster_AdjustedTexture_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02F257B0, void, __ctor_3, (app::List_1_TextureTilingAdjuster_AdjustedTexture_ * this_ptr, app::IEnumerable_1_TextureTilingAdjuster_AdjustedTexture_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02F25C40, Object *, ICollection_get_SyncRoot, (app::List_1_TextureTilingAdjuster_AdjustedTexture_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D49D10, Object *, IList_get_Item, (app::List_1_TextureTilingAdjuster_AdjustedTexture_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_TextureTilingAdjuster_AdjustedTexture_ *, AsReadOnly, (app::List_1_TextureTilingAdjuster_AdjustedTexture_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D4A5E0, TextureTilingAdjuster_AdjustedTexture, Find, (app::List_1_TextureTilingAdjuster_AdjustedTexture_ * this_ptr, app::Predicate_1_TextureTilingAdjuster_AdjustedTexture_ * match));
IL2CPP_REGISTER_METHOD(0x02D4A710, List_1_TextureTilingAdjuster_AdjustedTexture_ *, FindAll, (app::List_1_TextureTilingAdjuster_AdjustedTexture_ * this_ptr, app::Predicate_1_TextureTilingAdjuster_AdjustedTexture_ * match));
...
IL2CPP_REGISTER_METHOD(0x02D4AC20, List_1_T_Enumerator_TextureTilingAdjuster_AdjustedTexture_, GetEnumerator, (app::List_1_TextureTilingAdjuster_AdjustedTexture_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D4AC60, IEnumerator_1_TextureTilingAdjuster_AdjustedTexture_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_TextureTilingAdjuster_AdjustedTexture_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D4AC60, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_TextureTilingAdjuster_AdjustedTexture_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_TextureTilingAdjuster_AdjustedTexture_ *, GetRange, (app::List_1_TextureTilingAdjuster_AdjustedTexture_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, TextureTilingAdjuster_AdjustedTexture__Array *, ToArray, (app::List_1_TextureTilingAdjuster_AdjustedTexture_ * this_ptr));
