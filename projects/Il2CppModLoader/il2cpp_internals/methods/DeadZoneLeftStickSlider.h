...
IL2CPP_REGISTER_METHOD(0x00DDC660, String *, GetValueToDisplay, (app::DeadZoneLeftStickSlider * this_ptr));
IL2CPP_REGISTER_METHOD(0x00867970, void, __ctor, (app::DeadZoneLeftStickSlider * this_ptr));
}
