...
namespace app::methods::Mono_Security_Protocol_Tls::SslStreamBase_InternalAsyncResult {
IL2CPP_REGISTER_METHOD(0x0291A490, void, __ctor, (app::SslStreamBase_InternalAsyncResult * this_ptr, app::AsyncCallback * user_callback, app::Object * user_state, app::Byte__Array * buffer, int32_t offset, int32_t count, bool from_write, bool proceed_after_handshake));
...
IL2CPP_REGISTER_METHOD(0x002FB9F0, Byte__Array *, get_Buffer, (app::SslStreamBase_InternalAsyncResult * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB950, Object *, get_AsyncState, (app::SslStreamBase_InternalAsyncResult * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB00, Exception *, get_AsyncException, (app::SslStreamBase_InternalAsyncResult * this_ptr));
IL2CPP_REGISTER_METHOD(0x0291A620, bool, get_CompletedWithError, (app::SslStreamBase_InternalAsyncResult * this_ptr));
IL2CPP_REGISTER_METHOD(0x0291A650, WaitHandle *, get_AsyncWaitHandle, (app::SslStreamBase_InternalAsyncResult * this_ptr));
