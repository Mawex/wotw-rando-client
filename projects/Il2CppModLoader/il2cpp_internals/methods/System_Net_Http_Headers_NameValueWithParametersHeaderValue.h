...
IL2CPP_REGISTER_METHOD(0x02D11540, ICollection_1_System_Net_Http_Headers_NameValueHeaderValue_ *, get_Parameters, (app::NameValueWithParametersHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D116A0, Object *, ICloneable_Clone, (app::NameValueWithParametersHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D11A80, String *, ToString, (app::NameValueWithParametersHeaderValue * this_ptr));
