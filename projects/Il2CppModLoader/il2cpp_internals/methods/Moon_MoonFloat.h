...
IL2CPP_REGISTER_METHOD(0x02F943A0, CrossSceneReferenceId, get_CrossSceneReferenceId, (app::MoonFloat * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F94580, void, __ctor, (app::MoonFloat * this_ptr, float static_value));
...
IL2CPP_REGISTER_METHOD(0x02F94C30, bool, TryResolve, (app::MoonFloat * this_ptr, app::float * value, app::IMoonResolverContext * context));
...
IL2CPP_REGISTER_METHOD(0x00C3DD30, MoonTypeData, GetTypeData, (app::MoonFloat * this_ptr));
}
