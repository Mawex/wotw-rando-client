...
IL2CPP_REGISTER_METHOD(0x02759FB0, Material *, get_material, (app::CameraFilterPack_Blend2Camera_PhotoshopFilters * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0275B5C0, void, __ctor, (app::CameraFilterPack_Blend2Camera_PhotoshopFilters * this_ptr));
}
