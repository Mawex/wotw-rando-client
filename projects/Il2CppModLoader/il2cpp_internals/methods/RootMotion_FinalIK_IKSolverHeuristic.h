...
namespace app::methods::RootMotion_FinalIK::IKSolverHeuristic {
...
IL2CPP_REGISTER_METHOD(0x002FBBC0, IKSolver_Point__Array *, GetPoints, (app::IKSolverHeuristic * this_ptr));
IL2CPP_REGISTER_METHOD(0x02BFACF0, IKSolver_Point *, GetPoint, (app::IKSolverHeuristic * this_ptr, app::Transform * transform));
...
IL2CPP_REGISTER_METHOD(0x02BFB6B0, Vector3, get_localDirection, (app::IKSolverHeuristic * this_ptr));
IL2CPP_REGISTER_METHOD(0x02BFB9B0, float, get_positionOffset, (app::IKSolverHeuristic * this_ptr));
IL2CPP_REGISTER_METHOD(0x02BFBAC0, Vector3, GetSingularityOffset, (app::IKSolverHeuristic * this_ptr));
