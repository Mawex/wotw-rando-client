...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::Comparison_1_OneWayCapsuleCollider_ColliderEntry_ * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02C7B490, IAsyncResult *, BeginInvoke, (app::Comparison_1_OneWayCapsuleCollider_ColliderEntry_ * this_ptr, app::OneWayCapsuleCollider_ColliderEntry x, app::OneWayCapsuleCollider_ColliderEntry y, app::AsyncCallback * callback, app::Object * object));
