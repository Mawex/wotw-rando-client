...
namespace app::methods::System_Security_Cryptography_X509Certificates::X509ChainImpl {
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::X509ChainImpl * this_ptr));
}
