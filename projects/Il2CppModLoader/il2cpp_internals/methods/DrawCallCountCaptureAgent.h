...
IL2CPP_REGISTER_METHOD(0x00BDBB50, String__Array *, GetDataHeaderNames, (app::DrawCallCountCaptureAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x00BDBC40, String__Array *, GetFrameData_1, (app::DrawCallCountCaptureAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::DrawCallCountCaptureAgent * this_ptr));
}
