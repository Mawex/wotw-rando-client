...
namespace app::methods::System_Data::DataColumn {
IL2CPP_REGISTER_METHOD(0x02392480, void, __ctor_1, (app::DataColumn * this_ptr));
IL2CPP_REGISTER_METHOD(0x02392550, void, __ctor_2, (app::DataColumn * this_ptr, app::String * column_name, app::Type * data_type));
IL2CPP_REGISTER_METHOD(0x02392580, void, __ctor_3, (app::DataColumn * this_ptr, app::String * column_name, app::Type * data_type, app::String * expr, app::MappingType__Enum type));
...
IL2CPP_REGISTER_METHOD(0x02392EC0, Object *, get_AutoIncrementCurrent, (app::DataColumn * this_ptr));
IL2CPP_REGISTER_METHOD(0x02392F80, void, set_AutoIncrementCurrent, (app::DataColumn * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x023930E0, AutoIncrementValue *, get_AutoInc, (app::DataColumn * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x023935F0, String *, get_Caption, (app::DataColumn * this_ptr));
IL2CPP_REGISTER_METHOD(0x02393600, void, set_Caption, (app::DataColumn * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_ColumnName, (app::DataColumn * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02393C40, String *, get_EncodedColumnName, (app::DataColumn * this_ptr));
IL2CPP_REGISTER_METHOD(0x02393D00, IFormatProvider *, get_FormatProvider, (app::DataColumn * this_ptr));
IL2CPP_REGISTER_METHOD(0x02393DC0, CultureInfo *, get_Locale, (app::DataColumn * this_ptr));
IL2CPP_REGISTER_METHOD(0x003FFBD0, int32_t, get_ObjectID, (app::DataColumn * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD00, String *, get_Prefix, (app::DataColumn * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02394030, String *, GetColumnValueAsString, (app::DataColumn * this_ptr, app::DataRow * row, app::DataRowVersion__Enum version));
IL2CPP_REGISTER_METHOD(0x02394170, bool, get_Computed, (app::DataColumn * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB60, DataExpression *, get_DataExpression, (app::DataColumn * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9B0, Type *, get_DataType, (app::DataColumn * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FD490, DataSetDateTime__Enum, get_DateTimeMode, (app::DataColumn * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02394C20, Object *, get_DefaultValue, (app::DataColumn * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x023950C0, String *, get_Expression, (app::DataColumn * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02395940, PropertyCollection *, get_ExtendedProperties, (app::DataColumn * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02396110, String *, get_Namespace, (app::DataColumn * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x023966A0, Index *, get_SortIndex, (app::DataColumn * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBE0, DataTable *, get_Table, (app::DataColumn * this_ptr));
IL2CPP_REGISTER_METHOD(0x023967B0, void, SetTable, (app::DataColumn * this_ptr, app::DataTable * table));
IL2CPP_REGISTER_METHOD(0x02396880, DataRow *, GetDataRow, (app::DataColumn * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x023968E0, Object *, get_Item, (app::DataColumn * this_ptr, int32_t record));
...
IL2CPP_REGISTER_METHOD(0x00660430, String *, get_XmlDataType, (app::DataColumn * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660440, void, set_XmlDataType, (app::DataColumn * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBD40, SimpleType *, get_SimpleType, (app::DataColumn * this_ptr));
IL2CPP_REGISTER_METHOD(0x02397240, void, set_SimpleType, (app::DataColumn * this_ptr, app::SimpleType * value));
IL2CPP_REGISTER_METHOD(0x00653FB0, MappingType__Enum, get_ColumnMapping, (app::DataColumn * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02398280, Object *, ConvertValue, (app::DataColumn * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x023982B0, void, Copy, (app::DataColumn * this_ptr, int32_t src_record_no, int32_t dst_record_no));
IL2CPP_REGISTER_METHOD(0x023982E0, DataColumn *, Clone, (app::DataColumn * this_ptr));
IL2CPP_REGISTER_METHOD(0x02398760, Object *, GetAggregateValue, (app::DataColumn * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x02399800, String *, ToString, (app::DataColumn * this_ptr));
IL2CPP_REGISTER_METHOD(0x023998C0, Object *, ConvertXmlToObject_1, (app::DataColumn * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x02399910, Object *, ConvertXmlToObject_2, (app::DataColumn * this_ptr, app::XmlReader * xml_reader, app::XmlRootAttribute * xml_attrib));
IL2CPP_REGISTER_METHOD(0x02399970, String *, ConvertObjectToXml_1, (app::DataColumn * this_ptr, app::Object * value));
...
IL2CPP_REGISTER_METHOD(0x02399A30, Object *, GetEmptyColumnStore, (app::DataColumn * this_ptr, int32_t record_count));
