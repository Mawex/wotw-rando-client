...
namespace app::methods::System_Net_Http_Headers::TransferCodingWithQualityHeaderValue {
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::TransferCodingWithQualityHeaderValue * this_ptr));
