...
namespace app::methods::UnityEngine_Events::UnityAction_2_UnityEngine_SceneManagement_Scene_UnityEngine_SceneManagement_Scene_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::UnityAction_2_UnityEngine_SceneManagement_Scene_UnityEngine_SceneManagement_Scene_ * this_ptr, app::Object * object, void * method_1));
