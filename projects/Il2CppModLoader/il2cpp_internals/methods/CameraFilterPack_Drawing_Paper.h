...
IL2CPP_REGISTER_METHOD(0x024F89F0, Material *, get_material, (app::CameraFilterPack_Drawing_Paper * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024F9310, void, __ctor, (app::CameraFilterPack_Drawing_Paper * this_ptr));
}
