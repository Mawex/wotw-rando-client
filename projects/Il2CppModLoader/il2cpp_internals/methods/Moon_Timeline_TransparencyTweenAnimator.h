...
namespace app::methods::Moon_Timeline::TransparencyTweenAnimator {
IL2CPP_REGISTER_METHOD(0x002FA000, void, OnEntityCreated, (app::TransparencyTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D10DB0, GameObject *, get_ExternalTarget, (app::TransparencyTweenAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBC0, MoonReference_1_UnityEngine_GameObject_ *, GetGameObjectTarget, (app::TransparencyTweenAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D11D80, bool, ApproximateEvent, (app::TransparencyTweenAnimator * this_ptr, int32_t evt, app::float * time));
IL2CPP_REGISTER_METHOD(0x00D11FB0, void, __ctor, (app::TransparencyTweenAnimator * this_ptr));
}
