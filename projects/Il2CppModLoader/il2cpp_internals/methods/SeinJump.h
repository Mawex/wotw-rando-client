...
namespace app::methods::SeinJump {
    ...
    IL2CPP_REGISTER_METHOD(0x005D06C0, CharacterPlatformMovement*, get_PlatformMovement, (app::SeinJump * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x005D0720, CharacterSpriteMirror*, get_CharacterSpriteMirror, (app::SeinJump * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0101B850, void, PerformCrouchJump, (app::SeinJump * this_ptr, app::bool* jumped_down_though_platform));
    ...
    IL2CPP_REGISTER_METHOD(0x0101DBB0, OriJumpPuppet*, get_Puppet, (app::SeinJump * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0101DC70, void, __ctor, (app::SeinJump * this_ptr));
