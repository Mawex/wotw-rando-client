...
namespace app::methods::System_Runtime_CompilerServices::ConfiguredTaskAwaitable_1_TResult__ConfiguredTaskAwaiter_System_Object_ {
...
IL2CPP_REGISTER_METHOD(0x00151890, void, __ctor, (app::ConfiguredTaskAwaitable_1_TResult_ConfiguredTaskAwaiter_System_Object___Boxed * this_ptr, app::Task_1_System_Object_ * task, bool continue_on_captured_context));
...
IL2CPP_REGISTER_METHOD(0x001FF750, Object *, GetResult, (app::ConfiguredTaskAwaitable_1_TResult_ConfiguredTaskAwaiter_System_Object___Boxed * this_ptr));
}
