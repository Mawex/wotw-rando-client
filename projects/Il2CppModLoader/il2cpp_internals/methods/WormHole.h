...
namespace app::methods::WormHole {
    ...
    IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::WormHole * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0058E220, Quaternion, get_Rotation, (app::WormHole * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0058E300, void, OnEmerge, (app::WormHole * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0044C850, void, __ctor, (app::WormHole * this_ptr));
} // namespace app::methods::WormHole
