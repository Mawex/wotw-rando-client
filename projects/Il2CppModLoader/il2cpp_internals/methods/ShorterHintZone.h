...
IL2CPP_REGISTER_METHOD(0x005C3FE0, Rect, get_Bounds, (app::ShorterHintZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::ShorterHintZone * this_ptr));
}
