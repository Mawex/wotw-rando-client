...
IL2CPP_REGISTER_METHOD(0x011F8410, XboxControllerManager *, get_CurrentController, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x011F8920, void, ResetControllerVibration, (MethodInfo * method));
