...
IL2CPP_REGISTER_METHOD(0x011A2300, BehaviourStatus__Enum, OnExecute, (app::VolumePatrolBehaviourNew * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x011A2BC0, BehaviourStatus__Enum, OnChangePatrolPoint, (app::VolumePatrolBehaviourNew * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011A2E70, void, __ctor, (app::VolumePatrolBehaviourNew * this_ptr));
}
