...
IL2CPP_REGISTER_METHOD(0x0246B1C0, Material *, get_material, (app::CameraFilterPack_FX_Dot_Circle * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0246BA40, void, __ctor, (app::CameraFilterPack_FX_Dot_Circle * this_ptr));
}
