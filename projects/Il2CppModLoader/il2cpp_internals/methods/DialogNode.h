...
namespace app::methods::DialogNode {
    IL2CPP_REGISTER_METHOD(0x00B900E0, IDialogActor*, get_Actor, (app::DialogNode * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB9B0, MessageProvider*, get_MessageProvider, (app::DialogNode * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBC40, Action_1_IContext_*, get_OnActivated, (app::DialogNode * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBC50, void, set_OnActivated, (app::DialogNode * this_ptr, app::Action_1_IContext_* value));
    IL2CPP_REGISTER_METHOD(0x002FBC60, Action_1_IContext_*, get_OnFinished, (app::DialogNode * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBC70, void, set_OnFinished, (app::DialogNode * this_ptr, app::Action_1_IContext_* value));
    IL2CPP_REGISTER_METHOD(0x00B901A0, List_1_IDialogTransition_*, get_Transitions, (app::DialogNode * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00B903E0, List_1_IDialogDecorator_*, get_Decorators, (app::DialogNode * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FBC00, InteractionSettings*, get_InteractionSettings, (app::DialogNode * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00B90840, bool, get_HideUiHidables, (app::DialogNode * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00B900E0, IDialogActor*, get_ResolvedActor, (app::DialogNode * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00B91450, void, __ctor, (app::DialogNode * this_ptr));
} // namespace app::methods::DialogNode
