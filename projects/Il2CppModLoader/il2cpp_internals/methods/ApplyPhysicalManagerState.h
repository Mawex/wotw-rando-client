...
IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::ApplyPhysicalManagerState * this_ptr));
IL2CPP_REGISTER_METHOD(0x00507A70, void, OnUpdate, (app::ApplyPhysicalManagerState * this_ptr, float dt));
IL2CPP_REGISTER_METHOD(0x00507B60, void, __ctor, (app::ApplyPhysicalManagerState * this_ptr));
}
