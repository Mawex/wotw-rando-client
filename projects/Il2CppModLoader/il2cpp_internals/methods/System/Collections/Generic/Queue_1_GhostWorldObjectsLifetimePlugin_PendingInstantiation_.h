...
namespace app::methods::System::Collections::Generic::Queue_1_GhostWorldObjectsLifetimePlugin_PendingInstantiation_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0243CB70, void, __ctor_1, (app::Queue_1_GhostWorldObjectsLifetimePlugin_PendingInstantiation_ * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x04727C38, Queue_1_GhostWorldObjectsLifetimePlugin_PendingInstantiation___ctor__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x02CA2D40, void, __ctor_2, (app::Queue_1_GhostWorldObjectsLifetimePlugin_PendingInstantiation_ * this_ptr, int32_t capacity));
