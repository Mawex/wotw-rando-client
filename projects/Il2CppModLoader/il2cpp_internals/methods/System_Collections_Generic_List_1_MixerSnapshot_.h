...
namespace app::methods::System_Collections_Generic::List_1_MixerSnapshot_ {
...
IL2CPP_REGISTER_METHOD(0x025EFC50, MixerSnapshot *, get_Item, (app::List_1_MixerSnapshot_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor, (app::List_1_MixerSnapshot_ * this_ptr, int32_t capacity));
