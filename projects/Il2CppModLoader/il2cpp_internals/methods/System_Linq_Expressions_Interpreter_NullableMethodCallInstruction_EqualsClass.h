...
namespace app::methods::System_Linq_Expressions_Interpreter::NullableMethodCallInstruction_EqualsClass {
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::NullableMethodCallInstruction_EqualsClass * this_ptr));
}
