...
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::AllContainer_1_CameraShake_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047008A0, AllContainer_1_CameraShake___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x019D7800, CameraShake *, get_Item, (app::AllContainer_1_CameraShake_ * this_ptr, int32_t index));
