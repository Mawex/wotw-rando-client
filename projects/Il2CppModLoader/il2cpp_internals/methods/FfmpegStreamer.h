...
namespace app::methods::FfmpegStreamer {
    ...
    IL2CPP_REGISTER_METHOD(0x01254830, void, __ctor, (app::FfmpegStreamer * this_ptr, int32_t width, int32_t height, app::String * out_file, bool bake_frame_count, int32_t start_frame));
