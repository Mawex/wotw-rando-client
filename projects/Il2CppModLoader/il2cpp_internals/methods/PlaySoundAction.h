...
IL2CPP_REGISTER_METHOD(0x0117B130, String *, get_AudioClipName, (app::PlaySoundAction * this_ptr));
IL2CPP_REGISTER_METHOD(0x0117B220, String *, GetNiceName, (app::PlaySoundAction * this_ptr));
