...
namespace app::methods::System_Net::TimerThread_Timer {
    IL2CPP_REGISTER_METHOD(0x020A8FC0, void, __ctor, (app::TimerThread_Timer * this_ptr, int32_t duration_milliseconds));
