...
namespace app::methods::System_Collections_Generic::HashSet_1_UberSwarmPOI_ {
...
IL2CPP_REGISTER_METHOD(0x02ABCD80, HashSet_1_T_Enumerator_UberSwarmPOI_, GetEnumerator, (app::HashSet_1_UberSwarmPOI_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04743388, HashSet_1_UberSwarmPOI__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02AB4370, void, __ctor, (app::HashSet_1_UberSwarmPOI_ * this_ptr));
