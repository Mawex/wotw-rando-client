...
namespace app::methods::System_Net_Configuration::ProxyElement {
IL2CPP_REGISTER_METHOD(0x02019FE0, void, __ctor, (app::ProxyElement * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047390A0, ProxyElement__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0201A010, ProxyElement_AutoDetectValues__Enum, get_AutoDetect, (app::ProxyElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0201A070, ProxyElement_BypassOnLocalValues__Enum, get_BypassOnLocal, (app::ProxyElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0201A0D0, ConfigurationPropertyCollection *, get_Properties, (app::ProxyElement * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04702ED0, ProxyElement_get_Properties__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0201A100, Uri *, get_ProxyAddress, (app::ProxyElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0201A160, Uri *, get_ScriptLocation, (app::ProxyElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0201A1C0, ProxyElement_UseSystemDefaultValues__Enum, get_UseSystemDefault, (app::ProxyElement * this_ptr));
