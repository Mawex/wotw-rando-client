...
IL2CPP_REGISTER_METHOD(0x012D70E0, Collider__Array *, get_AllColliders, (app::KwolokBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012D72E0, DamageDealer__Array *, get_AllDamageDealers, (app::KwolokBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012D7AD0, KwolokBossEntity_Phases__Enum, get_CurrentPhase, (app::KwolokBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012D7FF0, KwolokBossBehaviourZones *, get_BehaviourZones, (app::KwolokBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012D8440, List_1_KwolokBossBaseBehaviour_ *, get_ExecutingBehaviours, (app::KwolokBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x012D8450, SeinCharacter *, get_Ori, (app::KwolokBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x012D84E0, KwolokBossLocomotion *, get_KwolokLocomotion, (app::KwolokBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012D97F0, Transform *, get_MouthShootBonePosition, (app::KwolokBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x012D9800, Transform *, get_OriTransform, (app::KwolokBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012DB0E0, Vector2, GetMaxLookAtWeights, (app::KwolokBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012DD270, IUberState__Array *, get_AffectingUberStates, (app::KwolokBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x012DD300, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::KwolokBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, OnGUI, (app::KwolokBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x012DD4C0, void, __ctor, (app::KwolokBossEntity * this_ptr));
}
