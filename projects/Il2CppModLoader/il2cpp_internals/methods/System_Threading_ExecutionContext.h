...
IL2CPP_REGISTER_METHOD(0x027DBCA0, Object *, GetLocalValue, (app::IAsyncLocal * local));
...
IL2CPP_REGISTER_METHOD(0x027DC710, LogicalCallContext *, get_LogicalCallContext, (app::ExecutionContext * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB960, void, set_LogicalCallContext, (app::ExecutionContext * this_ptr, app::LogicalCallContext * value));
IL2CPP_REGISTER_METHOD(0x027DC860, IllogicalCallContext *, get_IllogicalCallContext, (app::ExecutionContext * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA280, SynchronizationContext *, get_SynchronizationContext, (app::ExecutionContext * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB930, SynchronizationContext *, get_SynchronizationContextNoFlow, (app::ExecutionContext * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x027DCFE0, ExecutionContextSwitcher, SetExecutionContext, (app::ExecutionContext * execution_context, bool preserve_sync_ctx));
IL2CPP_REGISTER_METHODINFO(0x047453C0, ExecutionContext_SetExecutionContext__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027DD160, ExecutionContext *, CreateCopy, (app::ExecutionContext * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04763EE8, ExecutionContext_CreateCopy__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027DD380, ExecutionContext *, CreateMutableCopy, (app::ExecutionContext * this_ptr));
IL2CPP_REGISTER_METHOD(0x027DD6B0, bool, IsFlowSuppressed, ());
IL2CPP_REGISTER_METHOD(0x027DD6E0, ExecutionContext *, Capture_1, ());
IL2CPP_REGISTER_METHOD(0x027DD780, ExecutionContext *, FastCapture, ());
IL2CPP_REGISTER_METHOD(0x027DD820, ExecutionContext *, Capture_2, (app::StackCrawlMark__Enum * stack_mark, app::ExecutionContext_CaptureOptions__Enum options));
