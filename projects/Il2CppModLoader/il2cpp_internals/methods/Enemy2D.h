...
namespace app::methods::Enemy2D {
    IL2CPP_REGISTER_METHOD(0x00B39300, CharacterSpriteMirror*, get_SpriteMirror, (app::Enemy2D * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00BFE4E0, SpriteAnimatorWithTransitions*, get_SpriteAnimator, (app::Enemy2D * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00BFE500, MoonAnimator*, get_Animator, (app::Enemy2D * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x0478D520, Enemy2D_get_Animator__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x00BFE550, SoundHost*, get_SoundHost, (app::Enemy2D * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FBC60, CharacterAnimationSystem*, IPuppetBase_get_Animation, (app::Enemy2D * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00443680, void, __ctor, (app::Enemy2D * this_ptr));
} // namespace app::methods::Enemy2D
