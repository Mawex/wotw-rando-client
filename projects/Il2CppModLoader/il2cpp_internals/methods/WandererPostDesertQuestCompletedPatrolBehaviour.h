...
IL2CPP_REGISTER_METHOD(0x00420EE0, BehaviourStatus__Enum, OnExecute, (app::WandererPostDesertQuestCompletedPatrolBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0060C1C0, void, __ctor, (app::WandererPostDesertQuestCompletedPatrolBehaviour * this_ptr));
}
