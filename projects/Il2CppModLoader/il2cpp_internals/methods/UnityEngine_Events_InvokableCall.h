...
namespace app::methods::UnityEngine_Events::InvokableCall {
    IL2CPP_REGISTER_METHOD(0x0242EB20, void, __ctor_1, (app::InvokableCall * this_ptr, app::Object * target, app::MethodInfo_1 * the_function));
    IL2CPP_REGISTER_METHOD(0x0242EC50, void, __ctor_2, (app::InvokableCall * this_ptr, app::UnityAction * action));
