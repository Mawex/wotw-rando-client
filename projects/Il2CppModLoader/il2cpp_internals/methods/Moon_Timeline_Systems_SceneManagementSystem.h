...
IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::SceneManagementSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00417920, SuspendableMask__Enum, get_Mask, (app::SceneManagementSystem * this_ptr));
