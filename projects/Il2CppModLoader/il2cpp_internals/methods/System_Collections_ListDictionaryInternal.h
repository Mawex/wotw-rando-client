...
namespace app::methods::System_Collections::ListDictionaryInternal {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::ListDictionaryInternal * this_ptr));
IL2CPP_REGISTER_METHOD(0x02028E50, Object *, get_Item, (app::ListDictionaryInternal * this_ptr, app::Object * key));
...
IL2CPP_REGISTER_METHOD(0x02029290, ICollection *, get_Keys, (app::ListDictionaryInternal * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020293E0, Object *, get_SyncRoot, (app::ListDictionaryInternal * this_ptr));
IL2CPP_REGISTER_METHOD(0x02029540, ICollection *, get_Values, (app::ListDictionaryInternal * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02029D80, IDictionaryEnumerator *, GetEnumerator, (app::ListDictionaryInternal * this_ptr));
IL2CPP_REGISTER_METHOD(0x02029EE0, IEnumerator *, IEnumerable_GetEnumerator, (app::ListDictionaryInternal * this_ptr));
