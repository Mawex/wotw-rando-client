...
IL2CPP_REGISTER_METHOD(0x01B7A5D0, Vector3, get_Scale, (app::ScaleStateModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01B7A9A0, void, __ctor, (app::ScaleStateModifier * this_ptr));
