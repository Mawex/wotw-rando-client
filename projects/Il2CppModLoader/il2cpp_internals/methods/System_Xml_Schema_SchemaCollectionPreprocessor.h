...
namespace app::methods::System_Xml_Schema::SchemaCollectionPreprocessor {
IL2CPP_REGISTER_METHOD(0x01AA5130, void, __ctor, (app::SchemaCollectionPreprocessor * this_ptr, app::XmlNameTable * name_table, app::SchemaNames * schema_names, app::ValidationEventHandler * event_handler));
...
IL2CPP_REGISTER_METHOD(0x01AAE180, Uri *, ResolveSchemaLocationUri, (app::SchemaCollectionPreprocessor * this_ptr, app::XmlSchema * enclosing_schema, app::String * location));
IL2CPP_REGISTER_METHOD(0x01AAE260, Stream *, GetSchemaEntity, (app::SchemaCollectionPreprocessor * this_ptr, app::Uri * ruri));
}
