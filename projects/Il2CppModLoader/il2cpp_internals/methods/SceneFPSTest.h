...
namespace app::methods::SceneFPSTest {
    IL2CPP_REGISTER_METHOD(0x00939BC0, List_1_RuntimeSceneMetaData_*, get_SceneList, (app::SceneFPSTest * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0093E740, MoonProfilerFrame, MoonProfilerFrameFromDataProvider, (app::SceneFPSTest * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00940470, List_1_UnityEngine_Vector3_*, GetSceneSamples, (app::SceneFPSTest * this_ptr, int32_t meta_data_index));
    IL2CPP_REGISTER_METHOD(0x00940A10, RuntimeSceneMetaData*, GetMetaData, (app::SceneFPSTest * this_ptr, int32_t meta_data_index));
    IL2CPP_REGISTER_METHOD(0x00940AC0, bool, SceneHasSamples, (app::SceneFPSTest * this_ptr, int32_t meta_data_index));
    IL2CPP_REGISTER_METHOD(0x00940B60, Vector3, GetSamplePosition, (app::SceneFPSTest * this_ptr, int32_t meta_data_index, int32_t sample_index));
    ...
    IL2CPP_REGISTER_METHOD(0x00941990, Texture2D*, GetBackgroundTexture, (app::SceneFPSTest * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x009421E0, String*, GetSampleID_1, (float x_position, float y_position, app::String* scene_name));
    IL2CPP_REGISTER_METHOD(0x00942320, String*, GetSampleID_2, (int32_t meta_data_index, int32_t sample_index, app::String* scene_name));
    IL2CPP_REGISTER_METHOD(0x00942470, void, __ctor, (app::SceneFPSTest * this_ptr));
