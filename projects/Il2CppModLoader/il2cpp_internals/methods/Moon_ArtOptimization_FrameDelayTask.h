...
namespace app::methods::Moon_ArtOptimization::FrameDelayTask {
IL2CPP_REGISTER_METHOD(0x002FD1E0, void, __ctor, (app::FrameDelayTask * this_ptr, int32_t frames_delay));
