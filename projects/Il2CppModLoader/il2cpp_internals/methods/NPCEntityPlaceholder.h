...
IL2CPP_REGISTER_METHOD(0x0087F600, ICharacterInteractable *, get_CharacterInteractable, (app::NPCEntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x0087F690, NPCEntity *, get_CurrentInstance, (app::NPCEntityPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x0087F780, GameObject *, get_CurrentInstanceRig, (app::NPCEntityPlaceholder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00880020, void, __ctor, (app::NPCEntityPlaceholder * this_ptr));
}
