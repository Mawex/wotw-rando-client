...
IL2CPP_REGISTER_METHOD(0x001FF7C0, void, __ctor, (app::RuntimeType_ListBuilder_1_System_Reflection_PropertyInfo___Boxed * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x001FF820, PropertyInfo_1__Array *, ToArray, (app::RuntimeType_ListBuilder_1_System_Reflection_PropertyInfo___Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x001FF7E0, PropertyInfo_1 *, get_Item, (app::RuntimeType_ListBuilder_1_System_Reflection_PropertyInfo___Boxed * this_ptr, int32_t index));
