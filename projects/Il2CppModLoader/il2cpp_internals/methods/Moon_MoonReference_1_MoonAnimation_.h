...
IL2CPP_REGISTER_METHOD(0x02720AC0, MoonAnimation *, Resolve, (app::MoonReference_1_MoonAnimation_ * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x04798948, MoonReference_1_MoonAnimation__Resolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027206E0, void, __ctor, (app::MoonReference_1_MoonAnimation_ * this_ptr, app::MoonReference_1_MoonAnimation_ * moon_ref));
...
IL2CPP_REGISTER_METHOD(0x02720EB0, MoonAnimation *, SafeResolve, (app::MoonReference_1_MoonAnimation_ * this_ptr, app::IMoonResolverContext * context));
