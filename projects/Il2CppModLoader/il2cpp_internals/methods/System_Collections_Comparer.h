...
namespace app::methods::System_Collections::Comparer {
IL2CPP_REGISTER_METHOD(0x0063D180, void, __ctor_1, (app::Comparer * this_ptr));
IL2CPP_REGISTER_METHOD(0x02020380, void, __ctor_2, (app::Comparer * this_ptr, app::CultureInfo * culture));
IL2CPP_REGISTER_METHODINFO(0x04745FF8, Comparer__ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02020450, void, __ctor_3, (app::Comparer * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
