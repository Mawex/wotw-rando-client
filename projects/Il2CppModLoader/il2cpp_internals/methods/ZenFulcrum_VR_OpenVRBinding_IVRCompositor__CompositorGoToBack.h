...
namespace app::methods::ZenFulcrum_VR_OpenVRBinding::IVRCompositor__CompositorGoToBack {
    IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::IVRCompositor_CompositorGoToBack * this_ptr, app::Object * object, void * method_1));
