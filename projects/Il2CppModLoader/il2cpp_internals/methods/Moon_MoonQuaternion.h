...
IL2CPP_REGISTER_METHOD(0x02F97380, CrossSceneReferenceId, get_CrossSceneReferenceId, (app::MoonQuaternion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F92180, void, __ctor, (app::MoonQuaternion * this_ptr, app::Quaternion static_value));
IL2CPP_REGISTER_METHOD(0x02F97560, Quaternion, Resolve, (app::MoonQuaternion * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x0477B970, MoonQuaternion_Resolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02F97760, Quaternion, SafeResolve, (app::MoonQuaternion * this_ptr, app::IMoonResolverContext * context));
...
IL2CPP_REGISTER_METHOD(0x01746A40, MoonTypeData, GetTypeData, (app::MoonQuaternion * this_ptr));
}
