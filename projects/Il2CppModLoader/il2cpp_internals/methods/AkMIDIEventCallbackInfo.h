...
IL2CPP_REGISTER_METHOD(0x026F60E0, void, __ctor_1, (app::AkMIDIEventCallbackInfo * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x026F61B0, void *, getCPtr, (app::AkMIDIEventCallbackInfo * obj));
IL2CPP_REGISTER_METHOD(0x026F6240, void, setCPtr, (app::AkMIDIEventCallbackInfo * this_ptr, app::void * c_ptr));
...
IL2CPP_REGISTER_METHOD(0x026F6920, AkMIDIEventTypes__Enum, get_byType, (app::AkMIDIEventCallbackInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x026F6C80, AkMIDICcTypes__Enum, get_byCc, (app::AkMIDIEventCallbackInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x026F7580, void, __ctor_2, (app::AkMIDIEventCallbackInfo * this_ptr));
}
