...
IL2CPP_REGISTER_METHOD(0x027205B0, void, __ctor, (app::MoonReference_1_IGenericUberState_ * this_ptr, app::IGenericUberState * reference));
...
IL2CPP_REGISTER_METHOD(0x02720EB0, IGenericUberState *, SafeResolve, (app::MoonReference_1_IGenericUberState_ * this_ptr, app::IMoonResolverContext * context));
...
IL2CPP_REGISTER_METHOD(0x02720AC0, IGenericUberState *, Resolve, (app::MoonReference_1_IGenericUberState_ * this_ptr, app::IMoonResolverContext * context));
