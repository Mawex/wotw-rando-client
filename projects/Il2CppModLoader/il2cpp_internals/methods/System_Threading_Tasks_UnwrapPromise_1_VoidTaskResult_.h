...
namespace app::methods::System_Threading_Tasks::UnwrapPromise_1_VoidTaskResult_ {
IL2CPP_REGISTER_METHOD(0x02A5E7F0, void, __ctor, (app::UnwrapPromise_1_VoidTaskResult_ * this_ptr, app::Task * outer_task, bool look_for_oce));
