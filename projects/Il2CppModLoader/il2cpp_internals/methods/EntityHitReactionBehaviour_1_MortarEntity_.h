...
IL2CPP_REGISTER_METHOD(0x00420230, BehaviourStatus__Enum, OnExecuteTask, (app::EntityHitReactionBehaviour_1_MortarEntity_ * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHODINFO(0x0474A668, EntityHitReactionBehaviour_1_MortarEntity__OnExecuteTask__MethodInfo);
IL2CPP_REGISTER_METHOD(0x019E1830, void, __ctor, (app::EntityHitReactionBehaviour_1_MortarEntity_ * this_ptr));
