...
namespace app::methods::PetrifiedOwlBossFinalComboBehaviour_StompState {
    IL2CPP_REGISTER_METHOD(0x01771BE0, void, __ctor, (app::PetrifiedOwlBossFinalComboBehaviour_StompState * this_ptr, app::PetrifiedOwlBossFinalComboBehaviour * behaviour));
