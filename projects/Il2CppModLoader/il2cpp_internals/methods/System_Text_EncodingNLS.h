...
namespace app::methods::System_Text::EncodingNLS {
...
IL2CPP_REGISTER_METHOD(0x024561C0, int32_t, GetByteCount_3, (app::EncodingNLS * this_ptr, app::uint16_t * chars, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x02456830, int32_t, GetBytes_3, (app::EncodingNLS * this_ptr, app::uint16_t * chars, int32_t char_count, app::uint8_t * bytes, int32_t byte_count));
...
IL2CPP_REGISTER_METHOD(0x02456B80, int32_t, GetCharCount_2, (app::EncodingNLS * this_ptr, app::uint8_t * bytes, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x02456F60, int32_t, GetChars_2, (app::EncodingNLS * this_ptr, app::uint8_t * bytes, int32_t byte_count, app::uint16_t * chars, int32_t char_count));
IL2CPP_REGISTER_METHODINFO(0x04725180, EncodingNLS_GetChars_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x024570E0, String *, GetString, (app::EncodingNLS * this_ptr, app::Byte__Array * bytes, int32_t index, int32_t count));
IL2CPP_REGISTER_METHODINFO(0x04731F70, EncodingNLS_GetString__MethodInfo);
IL2CPP_REGISTER_METHOD(0x024572B0, Decoder *, GetDecoder, (app::EncodingNLS * this_ptr));
IL2CPP_REGISTER_METHOD(0x02457420, Encoder *, GetEncoder, (app::EncodingNLS * this_ptr));
}
