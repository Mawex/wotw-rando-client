...
namespace app::methods::System_Collections_Generic::List_1_MoonGuid_ {
...
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_1, (app::List_1_MoonGuid_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHODINFO(0x04712700, List_1_MoonGuid___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_2, (app::List_1_MoonGuid_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04743BE0, List_1_MoonGuid___ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EAEF0, MoonGuid__Array *, ToArray, (app::List_1_MoonGuid_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0470D5B8, List_1_MoonGuid__ToArray__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_MoonGuid_, GetEnumerator, (app::List_1_MoonGuid_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047233A8, List_1_MoonGuid__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EFC50, MoonGuid *, get_Item, (app::List_1_MoonGuid_ * this_ptr, int32_t index));
