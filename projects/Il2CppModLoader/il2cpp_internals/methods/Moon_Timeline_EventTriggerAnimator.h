...
namespace app::methods::Moon_Timeline::EventTriggerAnimator {
IL2CPP_REGISTER_METHOD(0x002FBBC0, Action_1_Moon_Timeline_EventTriggerAnimator_ *, get_EventStartWithTriggerInfo, (app::EventTriggerAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBE0, Action *, get_EventStart, (app::EventTriggerAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBF0, void, set_EventStart, (app::EventTriggerAnimator * this_ptr, app::Action * value));
IL2CPP_REGISTER_METHOD(0x002FBC00, Action *, get_EventStay, (app::EventTriggerAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC10, void, set_EventStay, (app::EventTriggerAnimator * this_ptr, app::Action * value));
IL2CPP_REGISTER_METHOD(0x002FBC20, Action *, get_EventEnd, (app::EventTriggerAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BBD2B0, void, __ctor, (app::EventTriggerAnimator * this_ptr));
}
