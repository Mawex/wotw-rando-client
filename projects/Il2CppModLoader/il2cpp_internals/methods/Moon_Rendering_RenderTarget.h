...
namespace app::methods::Moon_Rendering::RenderTarget {
IL2CPP_REGISTER_METHOD(0x00EB1BB0, void, __ctor_1, (app::RenderTarget * this_ptr));
IL2CPP_REGISTER_METHOD(0x00EB1C10, void, __ctor_2, (app::RenderTarget * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x002FC6D0, RenderTargetType__Enum, get_type, (app::RenderTarget * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_name, (app::RenderTarget * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00EB1C90, Int2, get_size, (app::RenderTarget * this_ptr));
IL2CPP_REGISTER_METHOD(0x00EB1CB0, int64_t, get_vramSize, (app::RenderTarget * this_ptr));
IL2CPP_REGISTER_METHOD(0x00EB1D20, RenderTargetDescriptor, get_currentDesc, (app::RenderTarget * this_ptr));
IL2CPP_REGISTER_METHOD(0x00EB1D60, RenderTargetIdentifier, operator_, (app::RenderTarget * rt));
...
IL2CPP_REGISTER_METHOD(0x002FBD00, RenderTexture *, get_tex, (app::RenderTarget * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00EB2190, RenderTargetIdentifier, get_id, (app::RenderTarget * this_ptr));
