...
namespace app::methods::ProximityMine {
    IL2CPP_REGISTER_METHOD(0x00C7FA90, SeinCharacter*, get_Sein, (app::ProximityMine * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00C80EA0, void, __ctor, (app::ProximityMine * this_ptr));
} // namespace app::methods::ProximityMine
