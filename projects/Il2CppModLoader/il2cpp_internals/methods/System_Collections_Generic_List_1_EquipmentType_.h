...
namespace app::methods::System_Collections_Generic::List_1_EquipmentType_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_EquipmentType_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D201B0, List_1_T_Enumerator_EquipmentType_, GetEnumerator, (app::List_1_EquipmentType_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D1F360, EquipmentType__Enum, get_Item, (app::List_1_EquipmentType_ * this_ptr, int32_t index));
