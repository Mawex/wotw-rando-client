...
IL2CPP_REGISTER_METHOD(0x00910BD0, RecorderFrame_FrameDataTypes__Enum, FrameType, (app::LogCallbackData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::LogCallbackData * this_ptr));
}
