...
namespace app::methods::System_Globalization::EncodingTable {
IL2CPP_REGISTER_METHOD(0x02607260, int32_t, GetNumEncodingItems, ());
IL2CPP_REGISTER_METHOD(0x02607310, InternalEncodingDataItem, ENC, (app::String * name, uint16_t cp));
IL2CPP_REGISTER_METHOD(0x02607340, InternalCodePageDataItem, MapCodePageDataItem, (uint16_t cp, uint16_t fcp, app::String * names, uint32_t flags));
