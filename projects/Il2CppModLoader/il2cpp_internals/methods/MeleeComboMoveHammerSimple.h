...
IL2CPP_REGISTER_METHOD(0x01396CD0, HammerComboMoveBase_BalancingData *, get_BalancingBase, (app::MeleeComboMoveHammerSimple * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01399670, Vector2, ComputeEffectiveKickback, (app::MeleeComboMoveHammerSimple * this_ptr, app::Vector3 enemy_position));
...
IL2CPP_REGISTER_METHOD(0x0139A160, EffectSpawn, DamageEffectProvider, (app::MeleeComboMoveHammerSimple * this_ptr, app::DamageResult damage_result));
IL2CPP_REGISTER_METHODINFO(0x04788AF8, MeleeComboMoveHammerSimple_DamageEffectProvider__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0139A460, IEnumerator *, HitStop, (app::MeleeComboMoveHammerSimple * this_ptr, app::GameObject * to_suspend, float suspend_time));
...
IL2CPP_REGISTER_METHOD(0x0139BC90, void, __ctor, (app::MeleeComboMoveHammerSimple * this_ptr));
