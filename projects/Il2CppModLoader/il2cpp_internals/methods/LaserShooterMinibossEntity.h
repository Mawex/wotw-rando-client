...
IL2CPP_REGISTER_METHOD(0x00F189C0, LaserShieldRotationController *, get_ShieldController, (app::LaserShooterMinibossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00F189D0, LaserShooterMinibossPathMover *, get_PathMover, (app::LaserShooterMinibossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F18A00, Vector3, get_AccumulatedForce, (app::LaserShooterMinibossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0096CB80, LaserShooterMinibossPath *, get_Paths, (app::LaserShooterMinibossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F18E70, List_1_LaserShooterRockSpawnPoint_ *, get_RockSpawnPositions, (app::LaserShooterMinibossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F1A6C0, Vector3, GetSelfSpringOffset, (app::LaserShooterMinibossEntity * this_ptr, float delta_time));
IL2CPP_REGISTER_METHOD(0x00F1A9D0, Tuple_2_UnityEngine_GameObject_Moon_UberTransformFollow_ *, SpawnFollowingEffect, (app::GameObject * prefab, app::Transform * follow_target));
IL2CPP_REGISTER_METHOD(0x00F1ADF0, void, __ctor, (app::LaserShooterMinibossEntity * this_ptr));
}
