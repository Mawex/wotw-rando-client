...
IL2CPP_REGISTER_METHOD(0x012DF160, BehaviourStatus__Enum, OnExecute, (app::KwolokBossEscapeBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x012DFF20, void, __ctor, (app::KwolokBossEscapeBehaviour * this_ptr));
}
