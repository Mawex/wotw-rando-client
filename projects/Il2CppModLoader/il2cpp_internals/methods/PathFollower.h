...
namespace app::methods::PathFollower {
    IL2CPP_REGISTER_METHOD(0x00446940, Vector3, get_WorldPosition, (app::PathFollower * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::PathFollower * this_ptr));
} // namespace app::methods::PathFollower
