...
IL2CPP_REGISTER_METHOD(0x00B76D30, Transform *, FindSolidsRootGameObject, (app::DebugRendererSettings * this_ptr, app::SceneRoot * scene_root));
IL2CPP_REGISTER_METHOD(0x00B76FE0, Transform *, FindSeinCharacterRootGameObject, (app::DebugRendererSettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B77140, Transform *, FindOriRootGameObject, (app::DebugRendererSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B79380, GUIStyle *, get_LabelStyle, (app::DebugRendererSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B7BCB0, void, __ctor, (app::DebugRendererSettings * this_ptr));
