...
IL2CPP_REGISTER_METHOD(0x009AC680, Renderer *, get_Renderer, (app::SpriteAnimatorWithTransitions * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC60, TextureAnimator *, get_TextureAnimator, (app::SpriteAnimatorWithTransitions * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009AD540, TextureAnimation *, get_CurrentAnimation, (app::SpriteAnimatorWithTransitions * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009ADEF0, Atlas *, get_SettingsAtlas, (app::SpriteAnimatorWithTransitions * this_ptr));
IL2CPP_REGISTER_METHOD(0x009AE150, UberScreenMode__Enum, GetExternalUberScreenMode, (app::SpriteAnimatorWithTransitions * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009AE3D0, void, __ctor, (app::SpriteAnimatorWithTransitions * this_ptr));
}
