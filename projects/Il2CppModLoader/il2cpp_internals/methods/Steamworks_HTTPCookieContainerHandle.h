...
IL2CPP_REGISTER_METHOD(0x0012ECC0, String *, ToString, (app::HTTPCookieContainerHandle__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006CE970, HTTPCookieContainerHandle, operator__1, (uint32_t value));
