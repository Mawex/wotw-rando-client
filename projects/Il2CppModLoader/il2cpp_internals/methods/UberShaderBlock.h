...
IL2CPP_REGISTER_METHOD(0x0190AF20, MeshFilter *, get_Filter, (app::UberShaderBlock * this_ptr));
IL2CPP_REGISTER_METHOD(0x0190B010, bool, get_HasCustomMesh, (app::UberShaderBlock * this_ptr));
IL2CPP_REGISTER_METHOD(0x0190B3C0, UberShaderComponent *, get_Component, (app::UberShaderBlock * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0190B520, Renderer *, get_Renderer, (app::UberShaderBlock * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBCC0, Material *, get_MaterialInPrefab, (app::UberShaderBlock * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0190B9A0, Material *, get_ActiveMaterial, (app::UberShaderBlock * this_ptr));
IL2CPP_REGISTER_METHOD(0x0190BAC0, RuntimeTypeHandle, get_TypeId, (app::UberShaderBlock * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0190BD30, void, __ctor, (app::UberShaderBlock * this_ptr));
}
