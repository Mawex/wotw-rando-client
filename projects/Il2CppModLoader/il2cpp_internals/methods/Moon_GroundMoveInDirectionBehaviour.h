...
IL2CPP_REGISTER_METHOD(0x01491910, Locomotion *, get_Locomotion, (app::GroundMoveInDirectionBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00615280, void, __ctor, (app::GroundMoveInDirectionBehaviour * this_ptr));
}
