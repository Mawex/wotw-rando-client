...
namespace app::methods::KwolokBossCleanWaterPhaseStartBehaviour_MoveToCenterState {
    IL2CPP_REGISTER_METHOD(0x01251B60, void, __ctor, (app::KwolokBossCleanWaterPhaseStartBehaviour_MoveToCenterState * this_ptr, app::KwolokBossCleanWaterPhaseStartBehaviour * behaviour));
