...
namespace app::methods::System_Net_Http_Headers::StringWithQualityHeaderValue {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::StringWithQualityHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x01349560, Nullable_1_Double_, get_Quality, (app::StringWithQualityHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_Value, (app::StringWithQualityHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB960, void, set_Value, (app::StringWithQualityHeaderValue * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x0173F610, Object *, ICloneable_Clone, (app::StringWithQualityHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D18150, String *, ToString, (app::StringWithQualityHeaderValue * this_ptr));
}
