...
IL2CPP_REGISTER_METHOD(0x0247FE20, Material *, get_material, (app::CameraFilterPack_Light_Water2 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02480770, void, __ctor, (app::CameraFilterPack_Light_Water2 * this_ptr));
}
