...
IL2CPP_REGISTER_METHOD(0x005B0220, BlendAnimation2D_Input__Array *, get_ValidInputs, (app::BlendAnimation2D * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420230, AnimationType__Enum, get_Type, (app::BlendAnimation2D * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B080D0, int32_t, get_BlendTreeSize, (app::BlendAnimation2D * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBE0, FloatAnimationParameter *, get_ParameterX, (app::BlendAnimation2D * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B081F0, void, set_ParameterX, (app::BlendAnimation2D * this_ptr, app::FloatAnimationParameter * value));
IL2CPP_REGISTER_METHOD(0x002FBC00, FloatAnimationParameter *, get_ParameterY, (app::BlendAnimation2D * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01B092D0, MoonAnimation_RootMotionSample, EvaluateRootMotion, (app::BlendAnimation2D * this_ptr, float time, app::AnimationParameterSet * parameter_set));
IL2CPP_REGISTER_METHOD(0x01B09440, void, ComputeCurrentBlendNodes, (app::BlendAnimation2D * this_ptr, float parameter_value_x, float parameter_value_y, app::BlendAnimationMode__Enum mode, app::Single__Array * * current_blend_weights, app::Int32__Array * * current_blend_node_indices, app::int32_t * active_blend_nodes_count));
IL2CPP_REGISTER_METHOD(0x01B0A1C0, void, ClosestPointInterpolation, (app::BlendAnimation2D * this_ptr, app::BlendAnimation2D_Input__Array * inputs, float parameter_value_x, float parameter_value_y, app::BlendAnimationMode__Enum mode, app::Single__Array * * current_blend_weights, app::Int32__Array * * current_blend_node_indices, app::int32_t * active_blend_nodes_count));
IL2CPP_REGISTER_METHOD(0x01B0A790, Vector3, CalculateBaricentricCoords, (app::BlendAnimation2D * this_ptr, app::Vector3 point, app::Vector3 p1, app::Vector3 p2, app::Vector3 p3));
IL2CPP_REGISTER_METHOD(0x01B0AA40, float, InverseLerp, (app::Vector3 a, app::Vector3 b, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x01B0ABA0, Vector2, ClosestPointOnLine, (app::Vector2 line_start, app::Vector2 line_end, app::Vector2 point));
...
IL2CPP_REGISTER_METHOD(0x01B0B090, void, __ctor, (app::BlendAnimation2D * this_ptr));
}
