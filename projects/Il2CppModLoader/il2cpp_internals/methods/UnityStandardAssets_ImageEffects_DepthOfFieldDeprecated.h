...
namespace app::methods::UnityStandardAssets_ImageEffects::DepthOfFieldDeprecated {
...
IL2CPP_REGISTER_METHOD(0x02D58040, void, __ctor, (app::DepthOfFieldDeprecated * this_ptr));
