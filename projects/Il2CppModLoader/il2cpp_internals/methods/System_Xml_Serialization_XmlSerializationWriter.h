...
IL2CPP_REGISTER_METHOD(0x002FBB00, XmlWriter *, get_Writer, (app::XmlSerializationWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025BA5D0, Exception *, CreateUnknownAnyElementException, (app::XmlSerializationWriter * this_ptr, app::String * name, app::String * ns));
IL2CPP_REGISTER_METHOD(0x025BA790, Exception *, CreateUnknownTypeException_1, (app::XmlSerializationWriter * this_ptr, app::Object * o));
IL2CPP_REGISTER_METHOD(0x025BA7D0, Exception *, CreateUnknownTypeException_2, (app::XmlSerializationWriter * this_ptr, app::Type * type));
IL2CPP_REGISTER_METHOD(0x025BA980, String *, FromXmlQualifiedName, (app::XmlSerializationWriter * this_ptr, app::XmlQualifiedName * xml_qualified_name));
IL2CPP_REGISTER_METHOD(0x025BAA90, String *, GetId, (app::XmlSerializationWriter * this_ptr, app::Object * o, bool add_to_references_list));
IL2CPP_REGISTER_METHOD(0x025BACC0, bool, AlreadyQueued, (app::XmlSerializationWriter * this_ptr, app::Object * ob));
IL2CPP_REGISTER_METHOD(0x025BAD00, String *, GetNamespacePrefix, (app::XmlSerializationWriter * this_ptr, app::String * ns));
IL2CPP_REGISTER_METHOD(0x025BAE90, String *, GetQualifiedName, (app::XmlSerializationWriter * this_ptr, app::String * name, app::String * ns));
