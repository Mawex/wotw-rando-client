...
namespace app::methods::System_Xml::XmlDeclaration {
IL2CPP_REGISTER_METHOD(0x0196B610, void, __ctor, (app::XmlDeclaration * this_ptr, app::String * version, app::String * encoding, app::String * standalone, app::XmlDocument * doc));
IL2CPP_REGISTER_METHODINFO(0x04741538, XmlDeclaration__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_Version, (app::XmlDeclaration * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB960, void, set_Version, (app::XmlDeclaration * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, get_Encoding, (app::XmlDeclaration * this_ptr));
IL2CPP_REGISTER_METHOD(0x0196B800, void, set_Encoding, (app::XmlDeclaration * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_Standalone, (app::XmlDeclaration * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0195B1F0, String *, get_Value, (app::XmlDeclaration * this_ptr));
IL2CPP_REGISTER_METHOD(0x0195B210, void, set_Value, (app::XmlDeclaration * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x0196BA30, String *, get_InnerText, (app::XmlDeclaration * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0196BE20, String *, get_Name, (app::XmlDeclaration * this_ptr));
IL2CPP_REGISTER_METHOD(0x015A1590, String *, get_LocalName, (app::XmlDeclaration * this_ptr));
IL2CPP_REGISTER_METHOD(0x007EC3F0, XmlNodeType__Enum, get_NodeType, (app::XmlDeclaration * this_ptr));
IL2CPP_REGISTER_METHOD(0x0196BEA0, XmlNode *, CloneNode, (app::XmlDeclaration * this_ptr, bool deep));
