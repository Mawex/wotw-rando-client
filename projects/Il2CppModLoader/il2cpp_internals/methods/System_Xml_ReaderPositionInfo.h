...
namespace app::methods::System_Xml::ReaderPositionInfo {
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::ReaderPositionInfo * this_ptr, app::IXmlLineInfo * line_info));
