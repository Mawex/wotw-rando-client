...
IL2CPP_REGISTER_METHOD(0x018220E0, BehaviourStatus__Enum, OnExecute, (app::SwarmMinigunAttackBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01823110, SwarmAgent *, GetLaunchAttackingAgent, (app::SwarmMinigunAttackBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01823680, void, __ctor, (app::SwarmMinigunAttackBehaviour * this_ptr));
}
