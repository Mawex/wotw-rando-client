...
namespace app::methods::Newtonsoft_Json_Bson::BsonToken {
IL2CPP_REGISTER_METHOD(0x002FA280, BsonToken *, get_Parent, (app::BsonToken * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::BsonToken * this_ptr));
}
