...
IL2CPP_REGISTER_METHOD(0x0011DCE0, void, __ctor_1, (app::TempBrigthnessContributionAgent__Boxed * this_ptr, app::IBrigthnessContributionAgent * agent, app::Ease_Easing__Enum easing, float speed, float timer));
IL2CPP_REGISTER_METHOD(0x0011DCF0, void, __ctor_2, (app::TempBrigthnessContributionAgent__Boxed * this_ptr, app::IBrigthnessContributionAgent * agent, app::WeightController * weight_controller));
IL2CPP_REGISTER_METHOD(0x0010E170, GlobalBrightnessController_BrigthnessContributionOrder__Enum, get_BrightnessInfluceOrder, (app::TempBrigthnessContributionAgent__Boxed * this_ptr));
