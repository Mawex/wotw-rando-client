...
namespace app::methods::System_Security::SecureString {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x01E1D750, void, __ctor_1, (app::SecureString * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E1D7E0, void, __ctor_2, (app::SecureString * this_ptr, app::uint16_t * value, int32_t length));
...
IL2CPP_REGISTER_METHOD(0x01E1DA50, SecureString *, Copy, (app::SecureString * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E1DE70, Byte__Array *, GetBuffer, (app::SecureString * this_ptr));
}
