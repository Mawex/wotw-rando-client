...
namespace app::methods::System_Configuration::SettingsProviderCollection {
IL2CPP_REGISTER_METHOD(0x01FFE110, void, __ctor, (app::SettingsProviderCollection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0470E830, SettingsProviderCollection__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01FFE140, SettingsProvider *, get_Item, (app::SettingsProviderCollection * this_ptr, app::String * name));
