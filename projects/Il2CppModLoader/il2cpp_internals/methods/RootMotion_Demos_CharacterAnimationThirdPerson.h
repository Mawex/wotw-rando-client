...
namespace app::methods::RootMotion_Demos::CharacterAnimationThirdPerson {
IL2CPP_REGISTER_METHOD(0x0220E8C0, void, Start, (app::CharacterAnimationThirdPerson * this_ptr));
IL2CPP_REGISTER_METHOD(0x0220E9E0, Vector3, GetPivotPoint, (app::CharacterAnimationThirdPerson * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0220F680, void, __ctor, (app::CharacterAnimationThirdPerson * this_ptr));
}
