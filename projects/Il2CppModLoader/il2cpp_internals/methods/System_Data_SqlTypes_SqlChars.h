...
namespace app::methods::System_Data_SqlTypes::SqlChars {
IL2CPP_REGISTER_METHOD(0x01E518F0, void, __ctor_1, (app::SqlChars * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E51910, void, __ctor_2, (app::SqlChars * this_ptr, app::Char__Array * buffer));
IL2CPP_REGISTER_METHOD(0x01E52680, void, __ctor_3, (app::SqlChars * this_ptr, app::SqlString value));
IL2CPP_REGISTER_METHOD(0x01E519D0, bool, get_IsNull, (app::SqlChars * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E52710, Char__Array *, get_Buffer, (app::SqlChars * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E52810, Char__Array *, get_Value, (app::SqlChars * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, XmlSchema *, IXmlSerializable_GetSchema, (app::SqlChars * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E52F90, XmlQualifiedName *, GetXsdType, (app::XmlSchemaSet * schema_set));
