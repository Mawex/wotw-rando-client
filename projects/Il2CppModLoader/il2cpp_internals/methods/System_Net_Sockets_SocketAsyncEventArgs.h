...
namespace app::methods::System_Net_Sockets::SocketAsyncEventArgs {
IL2CPP_REGISTER_METHOD(0x002FB990, Socket *, get_AcceptSocket, (app::SocketAsyncEventArgs * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9A0, void, set_AcceptSocket, (app::SocketAsyncEventArgs * this_ptr, app::Socket * value));
IL2CPP_REGISTER_METHOD(0x002FB9B0, IList_1_System_ArraySegment_1_ *, get_BufferList, (app::SocketAsyncEventArgs * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FD490, SocketError__Enum, get_SocketError, (app::SocketAsyncEventArgs * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FD4A0, void, set_SocketError, (app::SocketAsyncEventArgs * this_ptr, app::SocketError__Enum value));
IL2CPP_REGISTER_METHOD(0x002FBB60, Object *, get_UserToken, (app::SocketAsyncEventArgs * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020A1950, void, __ctor, (app::SocketAsyncEventArgs * this_ptr));
