...
namespace app::methods::ZenFulcrum_VR_OpenVRBinding::IVRRenderModels__GetRenderModelThumbnailURL {
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::IVRRenderModels_GetRenderModelThumbnailURL * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02CE48D0, IAsyncResult *, BeginInvoke, (app::IVRRenderModels_GetRenderModelThumbnailURL * this_ptr, app::String * pch_render_model_name, app::StringBuilder * pch_thumbnail_u_r_l, uint32_t un_thumbnail_u_r_l_len, app::EVRRenderModelError__Enum * pe_error, app::AsyncCallback * callback, app::Object * object));
