...
namespace app::methods::PetrifiedOwlBossFight1FeatherFlurryBehaviour_LoopState {
    IL2CPP_REGISTER_METHOD(0x01768570, void, __ctor, (app::PetrifiedOwlBossFight1FeatherFlurryBehaviour_LoopState * this_ptr, app::PetrifiedOwlBossFight1FeatherFlurryBehaviour * behaviour));
