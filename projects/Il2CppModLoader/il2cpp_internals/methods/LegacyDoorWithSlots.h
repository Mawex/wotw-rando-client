...
IL2CPP_REGISTER_METHOD(0x00660200, StressTestStatus__Enum, get_StressTestStatus, (app::LegacyDoorWithSlots * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A1DB90, String *, get_StressTestName, (app::LegacyDoorWithSlots * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A1DC10, void, __ctor, (app::LegacyDoorWithSlots * this_ptr));
