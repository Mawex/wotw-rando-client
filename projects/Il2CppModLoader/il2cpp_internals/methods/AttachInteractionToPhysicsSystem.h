...
IL2CPP_REGISTER_METHOD(0x008468B0, SuspendableMask__Enum, get_Mask, (app::AttachInteractionToPhysicsSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBE0, Transform *, get_ConnectedTransform1, (app::AttachInteractionToPhysicsSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC00, Transform *, get_ConnectedTransform2, (app::AttachInteractionToPhysicsSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00847BD0, void, __ctor, (app::AttachInteractionToPhysicsSystem * this_ptr));
