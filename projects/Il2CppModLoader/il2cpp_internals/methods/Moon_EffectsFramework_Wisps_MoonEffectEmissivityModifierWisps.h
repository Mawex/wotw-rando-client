...
namespace app::methods::Moon_EffectsFramework_Wisps::MoonEffectEmissivityModifierWisps {
    ...
    IL2CPP_REGISTER_METHOD(0x0120A4F0, void, __ctor, (app::MoonEffectEmissivityModifierWisps * this_ptr));
}
