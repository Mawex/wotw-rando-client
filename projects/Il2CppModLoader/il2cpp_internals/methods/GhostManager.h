...
IL2CPP_REGISTER_METHOD(0x00E22090, bool, get_IsPreRecordTrackingEnabled, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x00E222B0, bool, ShouldSaveRaceDataOffline, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x00E23950, bool, get_IsRecording, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x00E23A10, GhostRecorder *, GetRecorder, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x00E23AF0, GhostRecorder *, GetOrCreateRecorder, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x00E23C70, void, StartPreRecording, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x00E23CF0, void, StopPreRecording, (MethodInfo * method));
