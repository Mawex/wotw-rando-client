...
IL2CPP_REGISTER_METHOD(0x02720AC0, GameObject *, Resolve, (app::MoonReference_1_UnityEngine_GameObject_ * this_ptr, app::IMoonResolverContext * context));
...
IL2CPP_REGISTER_METHOD(0x02720EB0, GameObject *, SafeResolve, (app::MoonReference_1_UnityEngine_GameObject_ * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x047033E8, MoonReference_1_UnityEngine_GameObject__SafeResolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027205B0, void, __ctor, (app::MoonReference_1_UnityEngine_GameObject_ * this_ptr, app::GameObject * reference));
