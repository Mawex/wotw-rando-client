...
namespace app::methods::Moon_Wwise::SoundListenerReference {
IL2CPP_REGISTER_METHOD(0x001FEA80, void, __ctor, (app::SoundListenerReference__Boxed * this_ptr, app::ISoundListener * listener));
IL2CPP_REGISTER_METHOD(0x001FEA90, bool, get_IsValid, (app::SoundListenerReference__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00107C00, ISoundListener *, get_Listener, (app::SoundListenerReference__Boxed * this_ptr));
