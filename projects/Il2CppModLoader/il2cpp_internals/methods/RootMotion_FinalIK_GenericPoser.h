...
namespace app::methods::RootMotion_FinalIK::GenericPoser {
...
IL2CPP_REGISTER_METHOD(0x02064B70, Transform *, GetTargetNamed, (app::GenericPoser * this_ptr, app::String * t_name, app::Transform__Array * array));
IL2CPP_REGISTER_METHOD(0x02064C40, void, LateUpdate, (app::GenericPoser * this_ptr));
IL2CPP_REGISTER_METHOD(0x02064DB0, void, __ctor, (app::GenericPoser * this_ptr));
}
