...
IL2CPP_REGISTER_METHOD(0x0195BF70, XmlAttribute *, get_ItemOf_1, (app::XmlAttributeCollection * this_ptr, int32_t i));
IL2CPP_REGISTER_METHODINFO(0x04702848, XmlAttributeCollection_get_ItemOf__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0195C0A0, XmlAttribute *, get_ItemOf_2, (app::XmlAttributeCollection * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x0195C240, XmlAttribute *, get_ItemOf_3, (app::XmlAttributeCollection * this_ptr, app::String * local_name, app::String * namespace_u_r_i));
IL2CPP_REGISTER_METHOD(0x0195C420, int32_t, FindNodeOffsetNS, (app::XmlAttributeCollection * this_ptr, app::XmlAttribute * node));
IL2CPP_REGISTER_METHOD(0x0195C650, XmlNode *, SetNamedItem, (app::XmlAttributeCollection * this_ptr, app::XmlNode * node));
IL2CPP_REGISTER_METHODINFO(0x04738E30, XmlAttributeCollection_SetNamedItem__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0195C800, XmlAttribute *, Append, (app::XmlAttributeCollection * this_ptr, app::XmlAttribute * node));
IL2CPP_REGISTER_METHODINFO(0x047373F0, XmlAttributeCollection_Append__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0195CA80, XmlAttribute *, Remove, (app::XmlAttributeCollection * this_ptr, app::XmlAttribute * node));
IL2CPP_REGISTER_METHOD(0x0195CB00, XmlAttribute *, RemoveAt, (app::XmlAttributeCollection * this_ptr, int32_t i));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, Object *, ICollection_get_SyncRoot, (app::XmlAttributeCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x0195CDA0, int32_t, ICollection_get_Count, (app::XmlAttributeCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x0195CDB0, XmlNode *, AddNode, (app::XmlAttributeCollection * this_ptr, app::XmlNode * node));
IL2CPP_REGISTER_METHOD(0x0195D030, XmlNode *, InsertNodeAt, (app::XmlAttributeCollection * this_ptr, int32_t i, app::XmlNode * node));
IL2CPP_REGISTER_METHOD(0x0195D130, XmlNode *, RemoveNodeAt, (app::XmlAttributeCollection * this_ptr, int32_t i));
...
IL2CPP_REGISTER_METHOD(0x0195DCC0, XmlAttribute *, InternalAppendAttribute, (app::XmlAttributeCollection * this_ptr, app::XmlAttribute * node));
}
