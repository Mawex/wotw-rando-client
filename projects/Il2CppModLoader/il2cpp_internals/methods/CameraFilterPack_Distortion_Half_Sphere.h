...
IL2CPP_REGISTER_METHOD(0x024E8DC0, Material *, get_material, (app::CameraFilterPack_Distortion_Half_Sphere * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024E9790, void, __ctor, (app::CameraFilterPack_Distortion_Half_Sphere * this_ptr));
}
