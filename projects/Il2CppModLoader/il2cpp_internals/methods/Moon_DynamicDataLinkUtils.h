...
IL2CPP_REGISTER_METHOD(0x02F8A060, IRuntimeDynamicDataLink *, CreateRuntimeDynamicDataLinkFromData, (app::DynamicDataLinkSerializedData data));
IL2CPP_REGISTER_METHOD(0x02F8A890, DynamicDataLinkUtils_InfoStruct, GetMemberInfoFromString_1, (app::DynamicDataLinkSerializedData data));
IL2CPP_REGISTER_METHOD(0x02F8AED0, DynamicDataLinkUtils_InfoStruct, GetMemberInfoFromString_2, (app::DynamicDataLinkUtils_DataTargetMemberType__Enum member_type, app::Type * target_object_type, app::String * member_name));
IL2CPP_REGISTER_METHOD(0x02F8B4B0, DynamicDataLinkUtils_InfoStruct, GetMemberInfoFromID, (app::DynamicDataLinkSerializedData data));
...
IL2CPP_REGISTER_METHOD(0x02F8BBD0, Type *, HackGetType, (app::String * name));
