...
namespace app::methods::EnemyShield {
    ...
    IL2CPP_REGISTER_METHOD(0x00C83A70, Vector2, GetShieldDirection, (app::EnemyShield * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00C84770, Vector2, GetDamageToProtectionConeOriginOffset, (app::EnemyShield * this_ptr, app::Damage* damage));
    ...
    IL2CPP_REGISTER_METHOD(0x00C85370, Vector3, ProcessDamagePosition, (app::EnemyShield * this_ptr, app::Vector3 damage_origin_point, app::DamageType__Enum damage_type));
    IL2CPP_REGISTER_METHOD(0x00C85650, void, OnDrawGizmos, (app::EnemyShield * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00C858E0, void, __ctor, (app::EnemyShield * this_ptr));
