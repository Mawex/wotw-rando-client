...
namespace app::methods::System_Collections::EmptyReadOnlyDictionaryInternal {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::EmptyReadOnlyDictionaryInternal * this_ptr));
IL2CPP_REGISTER_METHOD(0x020210F0, IEnumerator *, IEnumerable_GetEnumerator, (app::EmptyReadOnlyDictionaryInternal * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, Object *, get_SyncRoot, (app::EmptyReadOnlyDictionaryInternal * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_IsSynchronized, (app::EmptyReadOnlyDictionaryInternal * this_ptr));
IL2CPP_REGISTER_METHOD(0x020213D0, Object *, get_Item, (app::EmptyReadOnlyDictionaryInternal * this_ptr, app::Object * key));
...
IL2CPP_REGISTER_METHOD(0x020216A0, ICollection *, get_Keys, (app::EmptyReadOnlyDictionaryInternal * this_ptr));
IL2CPP_REGISTER_METHOD(0x02021740, ICollection *, get_Values, (app::EmptyReadOnlyDictionaryInternal * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02021A50, IDictionaryEnumerator *, GetEnumerator, (app::EmptyReadOnlyDictionaryInternal * this_ptr));
