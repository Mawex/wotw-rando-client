...
IL2CPP_REGISTER_METHOD(0x017644B0, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossShriekBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0177E300, Enum__Array *, GetEntries, (app::PetrifiedOwlBossShriekBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x0177E3A0, Enum, Evaluate, (app::PetrifiedOwlBossShriekBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_ShouldSkip, (app::PetrifiedOwlBossShriekBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x017657C0, void, __ctor, (app::PetrifiedOwlBossShriekBehaviour * this_ptr));
}
