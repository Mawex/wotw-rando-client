...
namespace app::methods::UnityEngine_Animations::AnimationVerletPlayable {
IL2CPP_REGISTER_METHOD(0x00241FC0, void, __ctor, (app::AnimationVerletPlayable__Boxed * this_ptr, app::PlayableHandle handle));
...
IL2CPP_REGISTER_METHOD(0x0307E820, AnimationVerletPlayable, Create, (app::PlayableGraph graph));
IL2CPP_REGISTER_METHOD(0x0307E990, PlayableHandle, CreateHandle, (app::PlayableGraph graph));
IL2CPP_REGISTER_METHOD(0x001D9980, PlayableHandle, GetHandle, (app::AnimationVerletPlayable__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0307C600, Playable, operator_, (app::AnimationVerletPlayable playable));
