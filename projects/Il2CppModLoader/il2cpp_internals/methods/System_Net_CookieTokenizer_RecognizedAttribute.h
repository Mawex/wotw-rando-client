...
namespace app::methods::System_Net::CookieTokenizer_RecognizedAttribute {
    IL2CPP_REGISTER_METHOD(0x0011D2D0, void, __ctor, (app::CookieTokenizer_RecognizedAttribute__Boxed * this_ptr, app::String * name, app::CookieToken__Enum token));
