...
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_Filename, (app::AVProWindowsMedia * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03127F10, Texture *, get_OutputTexture, (app::AVProWindowsMedia * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031281C0, bool, StartVideoFromMemory, (app::AVProWindowsMedia * this_ptr, app::String * name, app::void * movie_pointer, int64_t movie_length, bool allow_native_format, bool use_b_t709, bool allow_audio, bool use_audio_delay, bool use_audio_mixer, bool use_display_sync, bool ignore_flips, app::FilterMode__Enum texture_filter_mode, app::TextureWrapMode__Enum texture_wrap_mode));
IL2CPP_REGISTER_METHOD(0x03128400, Material *, GetConversionMaterial, (app::AVProWindowsMedia * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03129820, void, __ctor, (app::AVProWindowsMedia * this_ptr));
}
