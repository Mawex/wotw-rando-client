...
IL2CPP_REGISTER_METHOD(0x024D68F0, Material *, get_material, (app::CameraFilterPack_Blur_Tilt_Shift_Hole * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024D7490, void, __ctor, (app::CameraFilterPack_Blur_Tilt_Shift_Hole * this_ptr));
}
