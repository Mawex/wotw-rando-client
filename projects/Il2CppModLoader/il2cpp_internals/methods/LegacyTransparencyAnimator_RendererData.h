...
namespace app::methods::LegacyTransparencyAnimator_RendererData {
    IL2CPP_REGISTER_METHOD(0x00124870, void, __ctor, (app::LegacyTransparencyAnimator_RendererData__Boxed * this_ptr, app::Renderer * renderer, app::UberShaderProperty_Color__Enum property));
