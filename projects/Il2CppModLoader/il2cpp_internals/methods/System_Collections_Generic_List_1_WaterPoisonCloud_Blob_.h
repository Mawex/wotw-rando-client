...
namespace app::methods::System_Collections_Generic::List_1_WaterPoisonCloud_Blob_ {
...
IL2CPP_REGISTER_METHOD(0x025EC760, WaterPoisonCloud_Blob, get_Item, (app::List_1_WaterPoisonCloud_Blob_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_WaterPoisonCloud_Blob_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0477FD70, List_1_WaterPoisonCloud_Blob___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_WaterPoisonCloud_Blob_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02C1FDC0, void, __ctor_3, (app::List_1_WaterPoisonCloud_Blob_ * this_ptr, app::IEnumerable_1_WaterPoisonCloud_Blob_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02C20250, Object *, ICollection_get_SyncRoot, (app::List_1_WaterPoisonCloud_Blob_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025EC810, bool, IsCompatibleObject, (app::Object * value));
IL2CPP_REGISTER_METHOD(0x025EC910, Object *, IList_get_Item, (app::List_1_WaterPoisonCloud_Blob_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_WaterPoisonCloud_Blob_ *, AsReadOnly, (app::List_1_WaterPoisonCloud_Blob_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025ED1F0, WaterPoisonCloud_Blob, Find, (app::List_1_WaterPoisonCloud_Blob_ * this_ptr, app::Predicate_1_WaterPoisonCloud_Blob_ * match));
IL2CPP_REGISTER_METHOD(0x025ED330, List_1_WaterPoisonCloud_Blob_ *, FindAll, (app::List_1_WaterPoisonCloud_Blob_ * this_ptr, app::Predicate_1_WaterPoisonCloud_Blob_ * match));
...
IL2CPP_REGISTER_METHOD(0x025ED850, List_1_T_Enumerator_WaterPoisonCloud_Blob_, GetEnumerator, (app::List_1_WaterPoisonCloud_Blob_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025ED8A0, IEnumerator_1_WaterPoisonCloud_Blob_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_WaterPoisonCloud_Blob_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025ED8A0, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_WaterPoisonCloud_Blob_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_WaterPoisonCloud_Blob_ *, GetRange, (app::List_1_WaterPoisonCloud_Blob_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, WaterPoisonCloud_Blob__Array *, ToArray, (app::List_1_WaterPoisonCloud_Blob_ * this_ptr));
