...
IL2CPP_REGISTER_METHOD(0x012D6A10, BehaviourStatus__Enum, OnExecute, (app::KwolokBossDryPhaseStartBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x012D6F40, void, ModifyBodyHeight, (app::KwolokBossDryPhaseStartBehaviour * this_ptr, app::float * height));
IL2CPP_REGISTER_METHODINFO(0x04707D98, KwolokBossDryPhaseStartBehaviour_ModifyBodyHeight__MethodInfo);
IL2CPP_REGISTER_METHOD(0x012D6F50, void, ModifyLookAngle, (app::KwolokBossDryPhaseStartBehaviour * this_ptr, app::float * angle));
IL2CPP_REGISTER_METHODINFO(0x04778728, KwolokBossDryPhaseStartBehaviour_ModifyLookAngle__MethodInfo);
IL2CPP_REGISTER_METHOD(0x012D6F70, void, __ctor, (app::KwolokBossDryPhaseStartBehaviour * this_ptr));
}
