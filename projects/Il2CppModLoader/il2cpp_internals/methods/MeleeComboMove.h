...
IL2CPP_REGISTER_METHOD(0x01386360, Entity *, GetEntityForCollider, (app::MeleeComboMove * this_ptr, app::Collider * collider));
...
IL2CPP_REGISTER_METHOD(0x01386720, Vector2, get_EffectiveRootMotionMultiplier, (app::MeleeComboMove * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC40, MeleeWeapon *, get_Weapon, (app::MeleeComboMove * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC60, MaterialBasedSeinEffectsMap *, get_HitVFX, (app::MeleeComboMove * this_ptr));
IL2CPP_REGISTER_METHOD(0x01386740, bool, get_DealtDamage, (app::MeleeComboMove * this_ptr));
IL2CPP_REGISTER_METHOD(0x013867D0, Vector3, get_GetTargetPosition, (app::MeleeComboMove * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01387120, GameObject *, GetHitEffectPrefab, (app::MeleeComboMove * this_ptr, app::DamageResult damage_result));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, ComboMoveType__Enum, get_ComboMoveType, (app::MeleeComboMove * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, ButtonInputType__Enum, get_ButtonInputType, (app::MeleeComboMove * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01387280, IComboMove *, GetComboMove, (app::MeleeComboMove * this_ptr, app::ComboInput * input));
IL2CPP_REGISTER_METHOD(0x013873F0, List_1_Moon_ComboSystem_IComboMove_ *, get_ComboMoves, (app::MeleeComboMove * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01389F30, IAttackable *, GetNearestTarget, (app::MeleeComboMove * this_ptr));
IL2CPP_REGISTER_METHOD(0x0138A3C0, IAttackable *, GetNearestPotentialTarget, (app::MeleeComboMove * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0138ADA0, void, __ctor, (app::MeleeComboMove * this_ptr));
}
