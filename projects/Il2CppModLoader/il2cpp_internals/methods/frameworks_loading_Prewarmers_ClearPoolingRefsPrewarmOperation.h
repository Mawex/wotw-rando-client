...
namespace app::methods::frameworks_loading_Prewarmers::ClearPoolingRefsPrewarmOperation {
IL2CPP_REGISTER_METHOD(0x00F5E7C0, void, __ctor, (app::ClearPoolingRefsPrewarmOperation * this_ptr));
