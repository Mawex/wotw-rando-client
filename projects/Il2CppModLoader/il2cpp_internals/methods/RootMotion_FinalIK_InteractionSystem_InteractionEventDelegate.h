...
namespace app::methods::RootMotion_FinalIK::InteractionSystem_InteractionEventDelegate {
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::InteractionSystem_InteractionEventDelegate * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02A14640, IAsyncResult *, BeginInvoke, (app::InteractionSystem_InteractionEventDelegate * this_ptr, app::FullBodyBipedEffector__Enum effector_type, app::InteractionObject * interaction_object, app::InteractionObject_InteractionEvent * interaction_event, app::AsyncCallback * callback, app::Object * object));
