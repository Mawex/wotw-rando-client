...
namespace app::methods::PlayFab_Pipeline::EventBatchingStage {
...
IL2CPP_REGISTER_METHOD(0x002FB990, TimeSpan, get_BatchFillTimeout, (app::EventBatchingStage * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9A0, void, set_BatchFillTimeout, (app::EventBatchingStage * this_ptr, app::TimeSpan value));
IL2CPP_REGISTER_METHOD(0x017AE930, void, __ctor_1, (app::EventBatchingStage * this_ptr, app::ILogger_1 * logger));
IL2CPP_REGISTER_METHOD(0x017AEA00, void, __ctor_2, (app::EventBatchingStage * this_ptr, int32_t batch_size, app::TimeSpan batch_fill_timeout, app::ILogger_1 * logger));
...
IL2CPP_REGISTER_METHOD(0x017AEFA0, IEnumerable_1_PlayFab_IPlayFabEmitEventRequest_ *, GetInputConsumingEnumerable, (app::EventBatchingStage * this_ptr));
