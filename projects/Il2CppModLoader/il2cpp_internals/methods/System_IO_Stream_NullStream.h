...
namespace app::methods::System_IO::Stream_NullStream {
IL2CPP_REGISTER_METHOD(0x0237E700, void, __ctor, (app::Stream_NullStream * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0237E790, Task *, FlushAsync, (app::Stream_NullStream * this_ptr, app::CancellationToken cancellation_token));
IL2CPP_REGISTER_METHOD(0x0237E870, IAsyncResult *, BeginRead, (app::Stream_NullStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::AsyncCallback * callback, app::Object * state));
...
IL2CPP_REGISTER_METHOD(0x0237E9B0, IAsyncResult *, BeginWrite, (app::Stream_NullStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::AsyncCallback * callback, app::Object * state));
...
IL2CPP_REGISTER_METHOD(0x0237EAF0, Task_1_System_Int32_ *, ReadAsync, (app::Stream_NullStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::CancellationToken cancellation_token));
...
IL2CPP_REGISTER_METHOD(0x0237ED10, Task *, WriteAsync, (app::Stream_NullStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::CancellationToken cancellation_token));
