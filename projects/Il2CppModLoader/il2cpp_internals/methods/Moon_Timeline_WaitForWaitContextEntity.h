...
namespace app::methods::Moon_Timeline::WaitForWaitContextEntity {
IL2CPP_REGISTER_METHOD(0x008693A0, float, get_CurrentTime, (app::WaitForWaitContextEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBE0, IWaitContext *, get_CurrentWaitContext, (app::WaitForWaitContextEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E934D0, void, __ctor, (app::WaitForWaitContextEntity * this_ptr));
}
