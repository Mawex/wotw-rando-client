...
IL2CPP_REGISTER_METHOD(0x00D692E0, SpiritShardDescription *, GetUpgradableAbility, (app::SpiritShardSettings * this_ptr, app::SpiritShardType__Enum shard_type));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::SpiritShardSettings * this_ptr));
