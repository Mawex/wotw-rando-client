...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_Int32_System_Action_ {
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_System_Int32_System_Action_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BB8880, Action *, get_Item, (app::Dictionary_2_System_Int32_System_Action_ * this_ptr, int32_t key));
