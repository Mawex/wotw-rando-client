...
IL2CPP_REGISTER_METHOD(0x00A6D240, Vector3, get_SeinPosition, (app::SeinSpiritSlash * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement *, get_PlatformMovement, (app::SeinSpiritSlash * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A6D2B0, Vector3, get_GetTargetPosition, (app::SeinSpiritSlash * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A71120, ISpiritSlashAttackable *, FindClosestAttackHandler, (app::SeinSpiritSlash * this_ptr, bool both_directions));
IL2CPP_REGISTER_METHOD(0x00A71810, void, __ctor, (app::SeinSpiritSlash * this_ptr));
}
