...
IL2CPP_REGISTER_METHOD(0x001311C0, String *, ToString, (app::SteamItemDef_t__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006CE970, SteamItemDef_t, operator__1, (int32_t value));
