...
namespace app::methods::UnityEngine_EventSystems::PointerInputModule_MouseButtonEventData {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::PointerInputModule_MouseButtonEventData * this_ptr));
