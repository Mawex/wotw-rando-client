...
IL2CPP_REGISTER_METHOD(0x002FBB40, RaceSettings *, get_RaceSetting, (app::RaceMenuScreenUISlot * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::RaceMenuScreenUISlot * this_ptr));
