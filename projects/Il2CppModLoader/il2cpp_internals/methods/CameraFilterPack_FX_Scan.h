...
IL2CPP_REGISTER_METHOD(0x024734B0, Material *, get_material, (app::CameraFilterPack_FX_Scan * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02473E00, void, __ctor, (app::CameraFilterPack_FX_Scan * this_ptr));
}
