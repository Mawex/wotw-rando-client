...
namespace app::methods::UnityEngine_UI_CoroutineTween::TweenRunner_1_FloatTween_ {
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::TweenRunner_1_FloatTween_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02ACE370, IEnumerator *, Start, (app::FloatTween tween_info));
