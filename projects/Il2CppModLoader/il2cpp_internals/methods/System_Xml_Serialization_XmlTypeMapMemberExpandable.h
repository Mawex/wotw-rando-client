...
namespace app::methods::System_Xml_Serialization::XmlTypeMapMemberExpandable {
    ...
    IL2CPP_REGISTER_METHOD(0x0194ED90, void, __ctor, (app::XmlTypeMapMemberExpandable * this_ptr));
}
