...
namespace app::methods::System_Runtime_CompilerServices::TaskAwaiter_1_System_Object_ {
IL2CPP_REGISTER_METHOD(0x0018EEE0, bool, get_IsCompleted, (app::TaskAwaiter_1_System_Object___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor, (app::TaskAwaiter_1_System_Object___Boxed * this_ptr, app::Task_1_System_Object_ * task));
...
IL2CPP_REGISTER_METHOD(0x001FF750, Object *, GetResult, (app::TaskAwaiter_1_System_Object___Boxed * this_ptr));
}
