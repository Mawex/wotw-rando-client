...
IL2CPP_REGISTER_METHOD(0x020F39F0, Material *, get_material, (app::CameraFilterPack_VHS_Tracking * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E70F0, void, __ctor, (app::CameraFilterPack_VHS_Tracking * this_ptr));
}
