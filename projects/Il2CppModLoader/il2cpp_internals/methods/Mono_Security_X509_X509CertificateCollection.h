...
namespace app::methods::Mono_Security_X509::X509CertificateCollection {
IL2CPP_REGISTER_METHOD(0x01C9A650, void, __ctor_1, (app::X509CertificateCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x022856E0, X509Certificate *, get_Item_1, (app::X509CertificateCollection * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x022858C0, X509CertificateCollection_X509CertificateEnumerator *, GetEnumerator_1, (app::X509CertificateCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x020202A0, IEnumerator *, IEnumerable_GetEnumerator_1, (app::X509CertificateCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0293F390, X509Certificate_2 *, get_Item_2, (app::X509CertificateCollection_2 * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x0293F840, X509CertificateCollection_X509CertificateEnumerator_2 *, GetEnumerator_2, (app::X509CertificateCollection_2 * this_ptr));
IL2CPP_REGISTER_METHOD(0x020202A0, IEnumerator *, IEnumerable_GetEnumerator_2, (app::X509CertificateCollection_2 * this_ptr));
