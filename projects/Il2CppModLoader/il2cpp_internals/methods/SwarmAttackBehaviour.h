...
IL2CPP_REGISTER_METHOD(0x01814660, BehaviourStatus__Enum, OnExecute, (app::SwarmAttackBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01814EA0, Vector3, GetAfterAttackPosition, (app::SwarmAttackBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01816D80, void, __ctor, (app::SwarmAttackBehaviour * this_ptr));
}
