...
IL2CPP_REGISTER_METHOD(0x002FB930, IAnimation *, get_Animation, (app::MoonAnimator_ActiveAnimation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, Func_1_Boolean_ *, get_ContinueCondition, (app::MoonAnimator_ActiveAnimation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB990, Action *, get_OnStartedPlaying, (app::MoonAnimator_ActiveAnimation * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9A0, void, set_OnStartedPlaying, (app::MoonAnimator_ActiveAnimation * this_ptr, app::Action * value));
IL2CPP_REGISTER_METHOD(0x002FBB00, Action *, get_OnStoppedPlaying, (app::MoonAnimator_ActiveAnimation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB40, Nullable_1_Single_, get_CroffadeTimeOverride, (app::MoonAnimator_ActiveAnimation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0210E630, MoonAnimator_AnimationInstance *, InstantiateAnimation, (app::MoonAnimator_ActiveAnimation * this_ptr, app::MoonAnimator * animator));
...
IL2CPP_REGISTER_METHOD(0x0210E920, void, __ctor, (app::MoonAnimator_ActiveAnimation * this_ptr));
}
