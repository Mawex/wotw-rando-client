...
namespace app::methods::Moon_Wwise::WwiseSyncProcessor_RtpcSyncTask {
IL2CPP_REGISTER_METHOD(0x002FB930, Func_1_Single_ *, get_Getter, (app::WwiseSyncProcessor_RtpcSyncTask * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_Getter, (app::WwiseSyncProcessor_RtpcSyncTask * this_ptr, app::Func_1_Single_ * value));
IL2CPP_REGISTER_METHOD(0x01746A40, SoundHostReference, get_Host, (app::WwiseSyncProcessor_RtpcSyncTask * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB990, RTPC *, get_Target, (app::WwiseSyncProcessor_RtpcSyncTask * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FC6E0, void, __ctor, (app::WwiseSyncProcessor_RtpcSyncTask * this_ptr, int32_t i));
