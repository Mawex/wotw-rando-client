...
namespace app::methods::Moon::MoonLong {
    ...
    IL2CPP_REGISTER_METHOD(0x02F95A30, CrossSceneReferenceId, get_CrossSceneReferenceId, (app::MoonLong * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x02F95C10, void, __ctor, (app::MoonLong * this_ptr, int64_t static_value));
    ...
    IL2CPP_REGISTER_METHOD(0x02F962B0, bool, TryResolve, (app::MoonLong * this_ptr, app::int64_t* value, app::IMoonResolverContext* context));
    ...
    IL2CPP_REGISTER_METHOD(0x00C3DD30, MoonTypeData, GetTypeData, (app::MoonLong * this_ptr));
} // namespace app::methods::Moon::MoonLong
