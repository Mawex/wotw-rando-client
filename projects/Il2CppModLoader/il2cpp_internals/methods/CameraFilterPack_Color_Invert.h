...
IL2CPP_REGISTER_METHOD(0x024DA180, Material *, get_material, (app::CameraFilterPack_Color_Invert * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0136E200, void, __ctor, (app::CameraFilterPack_Color_Invert * this_ptr));
}
