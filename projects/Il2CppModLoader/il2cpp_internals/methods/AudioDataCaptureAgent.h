...
IL2CPP_REGISTER_METHOD(0x00857900, String__Array *, GetDataHeaderNames, (app::AudioDataCaptureAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x00857E90, String__Array *, GetFrameData_1, (app::AudioDataCaptureAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::AudioDataCaptureAgent * this_ptr));
}
