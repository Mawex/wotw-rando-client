...
IL2CPP_REGISTER_METHOD(0x00917F50, MoonAnimation *, get_EffectiveTeleportingStart, (app::SavePedestalController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00917F70, MoonAnimation *, get_EffectiveTeleportingLoop, (app::SavePedestalController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0091D5A0, SuspendableMask__Enum, get_Mask, (app::SavePedestalController * this_ptr));
