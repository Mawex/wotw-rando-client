...
namespace app::methods::Moon_dialogGraph::ChangeStateDialogDecorator_StateConditionSetupHolder {
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_UseMapping, (app::ChangeStateDialogDecorator_StateConditionSetupHolder * this_ptr));
IL2CPP_REGISTER_METHOD(0x00F2C7F0, ChangeStateDialogDecorator_StateConditionSetupData *, get_DesiredState, (app::ChangeStateDialogDecorator_StateConditionSetupHolder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F2CA70, void, __ctor, (app::ChangeStateDialogDecorator_StateConditionSetupHolder * this_ptr));
}
