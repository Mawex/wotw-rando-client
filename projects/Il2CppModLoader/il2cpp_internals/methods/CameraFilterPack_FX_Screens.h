...
IL2CPP_REGISTER_METHOD(0x02473E30, Material *, get_material, (app::CameraFilterPack_FX_Screens * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02474780, void, __ctor, (app::CameraFilterPack_FX_Screens * this_ptr));
}
