...
namespace app::methods::System_Globalization::Calendar {
IL2CPP_REGISTER_METHOD(0x01A1E410, DateTime, get_MinSupportedDateTime, (app::Calendar * this_ptr));
IL2CPP_REGISTER_METHOD(0x01A1E4B0, DateTime, get_MaxSupportedDateTime, (app::Calendar * this_ptr));
IL2CPP_REGISTER_METHOD(0x01A1E550, void, __ctor, (app::Calendar * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01A1E560, Object *, Clone, (app::Calendar * this_ptr));
IL2CPP_REGISTER_METHOD(0x01A1E700, Calendar *, ReadOnly, (app::Calendar * calendar));
...
IL2CPP_REGISTER_METHOD(0x01A1E980, DateTime, ToDateTime, (app::Calendar * this_ptr, int32_t year, int32_t month, int32_t day, int32_t hour, int32_t minute, int32_t second, int32_t millisecond));
