...
namespace app::methods::System_Collections_Generic::List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ {
    IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor, (app::List_1_System_Text_RegularExpressions_RegexCharClass_SingleRange_ * this_ptr, int32_t capacity));
