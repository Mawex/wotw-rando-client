...
IL2CPP_REGISTER_METHOD(0x00CE92F0, Vector3, get_Position, (app::TeleportPlayerOnTimelineEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::TeleportPlayerOnTimelineEvent * this_ptr));
}
