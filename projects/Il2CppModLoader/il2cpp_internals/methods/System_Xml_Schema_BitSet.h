...
namespace app::methods::System_Xml_Schema::BitSet {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_1, (app::BitSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x019A87C0, void, __ctor_2, (app::BitSet * this_ptr, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x019A8EA0, BitSet *, Clone, (app::BitSet * this_ptr));
