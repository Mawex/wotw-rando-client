...
IL2CPP_REGISTER_METHOD(0x002FBBA0, String *, get_PlayerName, (app::RaceLeaderboardEntry * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBB0, void, set_PlayerName, (app::RaceLeaderboardEntry * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBBE0, String *, get_UserID, (app::RaceLeaderboardEntry * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::RaceLeaderboardEntry * this_ptr));
}
