...
namespace app::methods::NightBerry {
    ...
    IL2CPP_REGISTER_METHOD(0x005FF510, Vector3, get_Position, (app::NightBerry * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x003FFCE0, SuspendableMask__Enum, get_Mask, (app::NightBerry * this_ptr));
    IL2CPP_REGISTER_METHOD(0x006010A0, void, set_Mask, (app::NightBerry * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x00601160, void, __ctor, (app::NightBerry * this_ptr));
} // namespace app::methods::NightBerry
