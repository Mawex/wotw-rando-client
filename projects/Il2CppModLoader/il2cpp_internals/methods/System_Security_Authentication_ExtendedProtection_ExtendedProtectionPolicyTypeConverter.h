...
namespace app::methods::System_Security_Authentication_ExtendedProtection::ExtendedProtectionPolicyTypeConverter {
...
IL2CPP_REGISTER_METHOD(0x021BC880, Object *, ConvertTo, (app::ExtendedProtectionPolicyTypeConverter * this_ptr, app::ITypeDescriptorContext * context, app::CultureInfo * culture, app::Object * value, app::Type * destination_type));
