...
IL2CPP_REGISTER_METHOD(0x011E4120, IDialogNode *, get_TransitionDestination, (app::ConditionalDialogTransition * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::ConditionalDialogTransition * this_ptr));
}
