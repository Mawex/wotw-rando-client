...
IL2CPP_REGISTER_METHOD(0x02035400, TypeCode__Enum, GetTypeCode, (app::Object * value));
IL2CPP_REGISTER_METHOD(0x020354B0, Object *, ChangeType_1, (app::Object * value, app::TypeCode__Enum type_code, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHODINFO(0x04749528, Convert_ChangeType__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02035950, Object *, DefaultToType, (app::IConvertible * value, app::Type * target_type, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHODINFO(0x047113F8, Convert_DefaultToType__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02036940, Object *, ChangeType_2, (app::Object * value, app::Type * conversion_type));
IL2CPP_REGISTER_METHOD(0x02036A20, Object *, ChangeType_3, (app::Object * value, app::Type * conversion_type, app::IFormatProvider * provider));
...
IL2CPP_REGISTER_METHOD(0x0203D130, Decimal, ToDecimal_1, (app::Object * value, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHOD(0x0203D260, Decimal, ToDecimal_2, (int8_t value));
IL2CPP_REGISTER_METHOD(0x0203D340, Decimal, ToDecimal_3, (uint8_t value));
IL2CPP_REGISTER_METHOD(0x0203D400, Decimal, ToDecimal_4, (int16_t value));
IL2CPP_REGISTER_METHOD(0x0203D4E0, Decimal, ToDecimal_5, (uint16_t value));
IL2CPP_REGISTER_METHOD(0x0203D5A0, Decimal, ToDecimal_6, (int32_t value));
IL2CPP_REGISTER_METHOD(0x0203D670, Decimal, ToDecimal_7, (uint32_t value));
IL2CPP_REGISTER_METHOD(0x0203D730, Decimal, ToDecimal_8, (int64_t value));
IL2CPP_REGISTER_METHOD(0x0203D810, Decimal, ToDecimal_9, (uint64_t value));
IL2CPP_REGISTER_METHOD(0x0203D8D0, Decimal, ToDecimal_10, (float value));
IL2CPP_REGISTER_METHOD(0x0203D9B0, Decimal, ToDecimal_11, (double value));
IL2CPP_REGISTER_METHOD(0x0203DA90, Decimal, ToDecimal_12, (app::String * value, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHOD(0x0203DBB0, Decimal, ToDecimal_13, (bool value));
IL2CPP_REGISTER_METHOD(0x0203DC70, DateTime, ToDateTime_1, (app::Object * value, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHOD(0x0203DDA0, DateTime, ToDateTime_2, (app::String * value));
IL2CPP_REGISTER_METHOD(0x0203DEB0, DateTime, ToDateTime_3, (app::String * value, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHOD(0x0203DF90, String *, ToString_1, (app::Object * value));
IL2CPP_REGISTER_METHOD(0x0203E030, String *, ToString_2, (app::Object * value, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHOD(0x019637F0, String *, ToString_3, (uint16_t value, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHOD(0x0203E150, String *, ToString_4, (int32_t value, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHOD(0x0203E180, String *, ToString_5, (uint64_t value));
...
IL2CPP_REGISTER_METHOD(0x0203EB10, String *, ToBase64String_1, (app::Byte__Array * in_array));
IL2CPP_REGISTER_METHODINFO(0x0472D708, Convert_ToBase64String__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0203EC00, String *, ToBase64String_2, (app::Byte__Array * in_array, int32_t offset, int32_t length));
IL2CPP_REGISTER_METHOD(0x0203ECD0, String *, ToBase64String_3, (app::Byte__Array * in_array, int32_t offset, int32_t length, app::Base64FormattingOptions__Enum options));
...
IL2CPP_REGISTER_METHOD(0x0203F4E0, int32_t, ConvertToBase64Array, (app::uint16_t * out_chars, app::uint8_t * in_data, int32_t offset, int32_t length, bool insert_line_breaks));
...
IL2CPP_REGISTER_METHOD(0x0203F910, Byte__Array *, FromBase64String, (app::String * s));
IL2CPP_REGISTER_METHODINFO(0x04786F98, Convert_FromBase64String__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0203FA00, Byte__Array *, FromBase64CharArray, (app::Char__Array * in_array, int32_t offset, int32_t length));
IL2CPP_REGISTER_METHODINFO(0x0473E6B0, Convert_FromBase64CharArray__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0203FBF0, Byte__Array *, FromBase64CharPtr, (app::uint16_t * input_ptr, int32_t input_length));
IL2CPP_REGISTER_METHOD(0x0203FE40, int32_t, FromBase64_Decode, (app::uint16_t * start_input_ptr, int32_t input_length, app::uint8_t * start_dest_ptr, int32_t dest_length));
IL2CPP_REGISTER_METHODINFO(0x0474D828, Convert_FromBase64_Decode__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02040180, int32_t, FromBase64_ComputeResultLength, (app::uint16_t * input_ptr, int32_t input_length));
