...
IL2CPP_REGISTER_METHOD(0x02034910, void, __ctor_1, (app::ConsoleCancelEventArgs * this_ptr, app::ConsoleSpecialKey__Enum type));
IL2CPP_REGISTER_METHOD(0x00724AE0, bool, get_Cancel, (app::ConsoleCancelEventArgs * this_ptr));
IL2CPP_REGISTER_METHOD(0x020349C0, void, __ctor_2, (app::ConsoleCancelEventArgs * this_ptr));
