...
IL2CPP_REGISTER_METHOD(0x00BEAB40, Vector3, get_EffectiveInterestDirection, (app::DynamicInterestPoint * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00BEB140, Vector3, get_CameraTargetPosition, (app::DynamicInterestPoint * this_ptr));
IL2CPP_REGISTER_METHOD(0x00BEB430, Vector2, get_CameraTargetPadding, (app::DynamicInterestPoint * this_ptr));
IL2CPP_REGISTER_METHOD(0x00BEB450, Vector3, get_CameraInfluencePosition, (app::DynamicInterestPoint * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00BEB8F0, void, AdjustCameraTargetWeight, (app::DynamicInterestPoint * this_ptr, app::float * weight, app::CameraTargetData * data, app::Vector3 primary_target_position));
IL2CPP_REGISTER_METHOD(0x00BEC040, float, get_CameraInfluenceMaxDist, (app::DynamicInterestPoint * this_ptr));
IL2CPP_REGISTER_METHOD(0x00BEC050, Vector2, get_CameraZoomFactor, (app::DynamicInterestPoint * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, CameraTargetType__Enum, get_TargetType, (app::DynamicInterestPoint * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00BEC400, void, __ctor, (app::DynamicInterestPoint * this_ptr));
}
