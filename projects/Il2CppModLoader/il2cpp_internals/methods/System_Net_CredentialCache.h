...
namespace app::methods::System_Net::CredentialCache {
IL2CPP_REGISTER_METHOD(0x01EA98F0, bool, get_IsDefaultInCache, (app::CredentialCache * this_ptr));
IL2CPP_REGISTER_METHOD(0x01EA9900, void, __ctor, (app::CredentialCache * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01EAA5C0, NetworkCredential *, GetCredential_1, (app::CredentialCache * this_ptr, app::Uri * uri_prefix, app::String * auth_type));
IL2CPP_REGISTER_METHODINFO(0x0472C9D0, CredentialCache_GetCredential__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EAA8E0, NetworkCredential *, GetCredential_2, (app::CredentialCache * this_ptr, app::String * host, int32_t port, app::String * authentication_type));
IL2CPP_REGISTER_METHODINFO(0x04789400, CredentialCache_GetCredential_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EAAC70, IEnumerator *, GetEnumerator, (app::CredentialCache * this_ptr));
