...
namespace app::methods::System_Data::ColumnTypeConverter {
...
IL2CPP_REGISTER_METHOD(0x02151900, Object *, ConvertTo, (app::ColumnTypeConverter * this_ptr, app::ITypeDescriptorContext * context, app::CultureInfo * culture, app::Object * value, app::Type * destination_type));
...
IL2CPP_REGISTER_METHOD(0x02151F90, Object *, ConvertFrom, (app::ColumnTypeConverter * this_ptr, app::ITypeDescriptorContext * context, app::CultureInfo * culture, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02152230, TypeConverter_StandardValuesCollection *, GetStandardValues, (app::ColumnTypeConverter * this_ptr, app::ITypeDescriptorContext * context));
