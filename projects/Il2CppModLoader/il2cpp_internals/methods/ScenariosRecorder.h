...
IL2CPP_REGISTER_METHOD(0x00937180, String *, GetScenarioFolderPath, (app::String * scene_name));
IL2CPP_REGISTER_METHOD(0x00937210, String__Array *, GetScenarioFilesForPath, (app::String * path));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::ScenariosRecorder * this_ptr));
