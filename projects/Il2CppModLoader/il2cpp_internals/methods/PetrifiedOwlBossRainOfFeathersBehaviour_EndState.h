...
IL2CPP_REGISTER_METHOD(0x0177CC60, void, __ctor, (app::PetrifiedOwlBossRainOfFeathersBehaviour_EndState * this_ptr, app::PetrifiedOwlBossRainOfFeathersBehaviour * behaviour));
