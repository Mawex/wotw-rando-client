...
namespace app::methods::System_Collections_Generic::List_1_LaserShieldPieceProjectile_ {
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_LaserShieldPieceProjectile_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04760A78, List_1_LaserShieldPieceProjectile___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EFC50, LaserShieldPieceProjectile *, get_Item, (app::List_1_LaserShieldPieceProjectile_ * this_ptr, int32_t index));
