...
namespace app::methods::Moon_UberStateVisualization::NonSerializedIntUberStateWrapper {
    IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::NonSerializedIntUberStateWrapper * this_ptr, app::IntUberState * state));
