...
namespace app::methods::System_Collections_Generic::List_1_NotificationChecker_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_NotificationChecker_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0474AAA0, List_1_NotificationChecker___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_NotificationChecker_, GetEnumerator, (app::List_1_NotificationChecker_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025F05A0, NotificationChecker *, Find, (app::List_1_NotificationChecker_ * this_ptr, app::Predicate_1_NotificationChecker_ * match));
