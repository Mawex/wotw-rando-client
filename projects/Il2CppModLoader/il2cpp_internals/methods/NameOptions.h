...
namespace app::methods::NameOptions {
    IL2CPP_REGISTER_METHOD(0x002FBC00, String*, get_FirstLetter, (app::NameOptions * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBC10, void, set_FirstLetter, (app::NameOptions * this_ptr, app::String* value));
    IL2CPP_REGISTER_METHOD(0x002FBC20, String*, get_SecondLetter, (app::NameOptions * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBC30, void, set_SecondLetter, (app::NameOptions * this_ptr, app::String* value));
    IL2CPP_REGISTER_METHOD(0x002FBBE0, String*, get_CurrentlySelected, (app::NameOptions * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBBF0, void, set_CurrentlySelected, (app::NameOptions * this_ptr, app::String* value));
    IL2CPP_REGISTER_METHOD(0x002FBC60, List_1_System_String_*, get_UnavailableNames, (app::NameOptions * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00882E80, void, __ctor, (app::NameOptions * this_ptr));
} // namespace app::methods::NameOptions
