...
IL2CPP_REGISTER_METHOD(0x00CB5CD0, Rect, get_Bounds, (app::CheckpointRestrictZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x01323340, Vector2, GetSize, (app::CheckpointRestrictZone * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01323990, void, __ctor, (app::CheckpointRestrictZone * this_ptr));
