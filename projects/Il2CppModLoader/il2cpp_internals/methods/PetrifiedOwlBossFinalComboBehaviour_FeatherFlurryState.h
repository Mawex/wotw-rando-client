...
namespace app::methods::PetrifiedOwlBossFinalComboBehaviour_FeatherFlurryState {
    IL2CPP_REGISTER_METHOD(0x0176FFA0, void, __ctor, (app::PetrifiedOwlBossFinalComboBehaviour_FeatherFlurryState * this_ptr, app::PetrifiedOwlBossFinalComboBehaviour * behaviour));
