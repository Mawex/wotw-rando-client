...
IL2CPP_REGISTER_METHOD(0x00989BF0, BehaviourStatus__Enum, get_Status, (app::LocomotionFallingBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FC5390, Nullable_1_Moon_BehaviourSystem_BehaviourStatus_, get_ForceReturnStatus, (app::LocomotionFallingBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FC53B0, BehaviourStatus__Enum, OnExecute_2, (app::LocomotionFallingBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00615280, void, __ctor, (app::LocomotionFallingBehaviour * this_ptr));
