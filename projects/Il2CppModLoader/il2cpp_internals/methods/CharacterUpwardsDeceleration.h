...
IL2CPP_REGISTER_METHOD(0x01051AC0, PlatformMovement *, get_PlatformMovement, (app::CharacterUpwardsDeceleration * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005C9550, void, __ctor, (app::CharacterUpwardsDeceleration * this_ptr));
}
