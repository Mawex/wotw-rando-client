...
namespace app::methods::System_Collections_Generic::Dictionary_2_TKey_TValue__ValueCollection_System_Object_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(0x026BFFC0, void, __ctor, (app::Dictionary_2_TKey_TValue_ValueCollection_System_Object_System_Object_ * this_ptr, app::Dictionary_2_System_Object_System_Object_ * dictionary));
