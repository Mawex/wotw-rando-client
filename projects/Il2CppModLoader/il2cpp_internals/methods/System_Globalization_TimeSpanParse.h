...
namespace app::methods::System_Globalization::TimeSpanParse {
IL2CPP_REGISTER_METHOD(0x01DF2000, bool, TryTimeToTicks, (bool positive, app::TimeSpanParse_TimeSpanToken days, app::TimeSpanParse_TimeSpanToken hours, app::TimeSpanParse_TimeSpanToken minutes, app::TimeSpanParse_TimeSpanToken seconds, app::TimeSpanParse_TimeSpanToken fraction, app::int64_t * result));
IL2CPP_REGISTER_METHOD(0x01DF2350, TimeSpan, Parse, (app::String * input, app::IFormatProvider * format_provider));
