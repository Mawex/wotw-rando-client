...
namespace app::methods::System_Runtime_Serialization_Formatters_Binary::BinaryCrossAppDomainString {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::BinaryCrossAppDomainString * this_ptr));
