...
namespace app::methods::System_Collections_Generic::List_1_Panel_ {
...
IL2CPP_REGISTER_METHOD(0x025EFC50, Panel *, get_Item, (app::List_1_Panel_ * this_ptr, int32_t index));
