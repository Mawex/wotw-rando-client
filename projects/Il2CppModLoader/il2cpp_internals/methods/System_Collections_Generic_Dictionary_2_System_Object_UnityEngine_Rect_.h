...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_Object_UnityEngine_Rect_ {
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor_1, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02259DF0, void, __ctor_2, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x0283AC50, void, __ctor_3, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr, app::IEqualityComparer_1_System_Object_ * comparer));
IL2CPP_REGISTER_METHOD(0x02E188A0, void, __ctor_4, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr, int32_t capacity, app::IEqualityComparer_1_System_Object_ * comparer));
IL2CPP_REGISTER_METHODINFO(0x04769038, Dictionary_2_System_Object_UnityEngine_Rect___ctor_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0283ADC0, void, __ctor_5, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr, app::IDictionary_2_System_Object_UnityEngine_Rect_ * dictionary));
IL2CPP_REGISTER_METHOD(0x02E189E0, void, __ctor_6, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr, app::IDictionary_2_System_Object_UnityEngine_Rect_ * dictionary, app::IEqualityComparer_1_System_Object_ * comparer));
IL2CPP_REGISTER_METHODINFO(0x04734B50, Dictionary_2_System_Object_UnityEngine_Rect___ctor_5__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02E18DC0, void, __ctor_7, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
IL2CPP_REGISTER_METHOD(0x002FB990, IEqualityComparer_1_System_Object_ *, get_Comparer, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B2A0, int32_t, get_Count, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B2B0, Dictionary_2_TKey_TValue_KeyCollection_System_Object_UnityEngine_Rect_ *, get_Keys, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B2B0, ICollection_1_System_Object_ *, System_Collections_Generic_IDictionary_TKey_TValue__get_Keys, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B2B0, IEnumerable_1_System_Object_ *, System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Keys, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B3E0, Dictionary_2_TKey_TValue_ValueCollection_System_Object_UnityEngine_Rect_ *, get_Values, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B3E0, ICollection_1_UnityEngine_Rect_ *, System_Collections_Generic_IDictionary_TKey_TValue__get_Values, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B3E0, IEnumerable_1_UnityEngine_Rect_ *, System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Values, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02E18E90, Rect, get_Item, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr, app::Object * key));
...
IL2CPP_REGISTER_METHOD(0x0283BD60, Dictionary_2_TKey_TValue_Enumerator_System_Object_UnityEngine_Rect_, GetEnumerator, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283BDB0, IEnumerator_1_KeyValuePair_2_System_Object_UnityEngine_Rect_ *, System_Collections_Generic_IEnumerable_System_Collections_Generic_KeyValuePair_TKey_TValue___GetEnumerator, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0283BDB0, IEnumerator *, IEnumerable_GetEnumerator, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02E1B040, Object *, ICollection_get_SyncRoot, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0283E020, ICollection *, IDictionary_get_Keys, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283E050, ICollection *, IDictionary_get_Values, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02BC7E50, Object *, IDictionary_get_Item, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr, app::Object * key));
...
IL2CPP_REGISTER_METHOD(0x0283E8F0, IDictionaryEnumerator *, IDictionary_GetEnumerator, (app::Dictionary_2_System_Object_UnityEngine_Rect_ * this_ptr));
