...
namespace app::methods::System_Xml::Ucs4Encoding {
IL2CPP_REGISTER_METHOD(0x0173D7B0, String *, get_WebName, (app::Ucs4Encoding * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9B0, Decoder *, GetDecoder, (app::Ucs4Encoding * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, Byte__Array *, GetBytes_1, (app::Ucs4Encoding * this_ptr, app::String * s));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, Encoder *, GetEncoder, (app::Ucs4Encoding * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01952A10, void, __ctor, (app::Ucs4Encoding * this_ptr));
}
