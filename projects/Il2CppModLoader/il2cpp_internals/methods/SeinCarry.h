...
namespace app::methods::SeinCarry {
    ...
    IL2CPP_REGISTER_METHOD(0x005D06F0, CharacterLeftRightMovement*, get_LeftRightMovement, (app::SeinCarry * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement*, get_PlatformMovement, (app::SeinCarry * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005D0720, CharacterSpriteMirror*, get_SpriteMirror, (app::SeinCarry * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x005B0220, ICarryable*, get_CurrentCarryable, (app::SeinCarry * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00DA4E80, IEnumerator*, DelayedPickupSound, (app::SeinCarry * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00DA76F0, void, __ctor, (app::SeinCarry * this_ptr));
} // namespace app::methods::SeinCarry
