...
namespace app::methods::JumpBehaviour {
    IL2CPP_REGISTER_METHOD(0x0064D930, Vector3, get_TargetPosition, (app::JumpBehaviour * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0064E140, void, __ctor, (app::JumpBehaviour * this_ptr));
