...
namespace app::methods::Newtonsoft_Json_Linq::JProperty {
IL2CPP_REGISTER_METHOD(0x002FBB60, IList_1_Newtonsoft_Json_Linq_JToken_ *, get_ChildrenTokens, (app::JProperty * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB80, String *, get_Name, (app::JProperty * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F0CFD0, JToken *, get_Value, (app::JProperty * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F0CFF0, void, set_Value, (app::JProperty * this_ptr, app::JToken * value));
IL2CPP_REGISTER_METHOD(0x01F0D070, void, __ctor_1, (app::JProperty * this_ptr, app::JProperty * other));
IL2CPP_REGISTER_METHOD(0x01F0D1D0, JToken *, GetItem, (app::JProperty * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x01F0D8C0, JToken *, CloneToken, (app::JProperty * this_ptr));
IL2CPP_REGISTER_METHOD(0x00910BD0, JTokenType__Enum, get_Type, (app::JProperty * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F0DB40, void, __ctor_2, (app::JProperty * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x01F0DCA0, void, __ctor_3, (app::JProperty * this_ptr, app::String * name, app::Object * content));
...
IL2CPP_REGISTER_METHOD(0x01F0DFB0, JProperty *, Load, (app::JsonReader * reader, app::JsonLoadSettings * settings));
