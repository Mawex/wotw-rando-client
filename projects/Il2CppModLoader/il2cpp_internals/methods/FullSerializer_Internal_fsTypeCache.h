...
namespace app::methods::FullSerializer_Internal::fsTypeCache {
IL2CPP_REGISTER_METHOD(0x0165DC10, void, __cctor, ());
...
IL2CPP_REGISTER_METHOD(0x0165EF60, Type *, GetType_1, (app::String * name));
IL2CPP_REGISTER_METHOD(0x0165F000, Type *, GetType_2, (app::String * name, app::String * assembly_hint));
}
