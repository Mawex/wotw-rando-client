...
IL2CPP_REGISTER_METHOD(0x0043D9E0, MenuTabBackground__Enum, get_BackgroundMode, (app::RaceMenuScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00EA7130, CleverMenuItemSelectionManager *, get_Navigation, (app::RaceMenuScreen * this_ptr));
IL2CPP_REGISTER_METHOD(0x00EA7200, RaceMenuScreenUISlot *, get_SelectedItem, (app::RaceMenuScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00EA9170, SuspendableMask__Enum, get_Mask, (app::RaceMenuScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00EABB40, DifficultyMode__Enum, GetSelectedSlotDifficulty, (app::RaceMenuScreen * this_ptr));
IL2CPP_REGISTER_METHOD(0x00EABC80, DifficultyMode__Enum, GetSlotDifficulty, (app::RaceMenuScreen * this_ptr, app::UberStateValueStore * store));
IL2CPP_REGISTER_METHOD(0x00EABD70, String *, GetSlotDifficultyString, (app::RaceMenuScreen * this_ptr, app::UberStateValueStore * store));
IL2CPP_REGISTER_METHOD(0x00EABF10, String *, GetRaceLeaderboardID, (app::RaceMenuScreen * this_ptr, app::RaceSettings * settings, app::UberStateValueStore * store));
...
IL2CPP_REGISTER_METHOD(0x00EAC9B0, void, __ctor, (app::RaceMenuScreen * this_ptr));
