...
IL2CPP_REGISTER_METHOD(0x00B69C40, BehaviourStatus__Enum, OnExecuteTask, (app::HornBugDeathReaction * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00B68B50, Vector3, ProcessRootMotion, (app::HornBugDeathReaction * this_ptr, app::Vector3 motion));
IL2CPP_REGISTER_METHODINFO(0x047287A8, HornBugDeathReaction_ProcessRootMotion__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00B6AEB0, void, __ctor, (app::HornBugDeathReaction * this_ptr));
