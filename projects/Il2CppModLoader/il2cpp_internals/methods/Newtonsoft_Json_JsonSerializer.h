...
IL2CPP_REGISTER_METHOD(0x002FB9F0, ITraceWriter *, get_TraceWriter, (app::JsonSerializer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB970, NullValueHandling__Enum, get_NullValueHandling, (app::JsonSerializer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00998570, MetadataPropertyHandling__Enum, get_MetadataPropertyHandling, (app::JsonSerializer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01A6D060, JsonConverterCollection *, get_Converters, (app::JsonSerializer * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9D0, IContractResolver *, get_ContractResolver, (app::JsonSerializer * this_ptr));
IL2CPP_REGISTER_METHOD(0x01A6D220, void, set_ContractResolver, (app::JsonSerializer * this_ptr, app::IContractResolver * value));
IL2CPP_REGISTER_METHOD(0x01A6D2E0, StreamingContext, get_Context, (app::JsonSerializer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01A6D4D0, JsonSerializer *, Create_1, ());
IL2CPP_REGISTER_METHOD(0x01A6D610, JsonSerializer *, Create_2, (app::JsonSerializerSettings * settings));
...
IL2CPP_REGISTER_METHOD(0x01A6E5E0, Object *, Deserialize_1, (app::JsonSerializer * this_ptr, app::JsonReader * reader, app::Type * object_type));
IL2CPP_REGISTER_METHOD(0x01A6E600, Object *, DeserializeInternal, (app::JsonSerializer * this_ptr, app::JsonReader * reader, app::Type * object_type));
...
IL2CPP_REGISTER_METHOD(0x01A6EF90, TraceJsonReader *, CreateTraceJsonReader, (app::JsonSerializer * this_ptr, app::JsonReader * reader));
...
IL2CPP_REGISTER_METHOD(0x01A6F920, IReferenceResolver *, GetReferenceResolver, (app::JsonSerializer * this_ptr));
IL2CPP_REGISTER_METHOD(0x01A6FA70, JsonConverter *, GetMatchingConverter_1, (app::JsonSerializer * this_ptr, app::Type * type));
IL2CPP_REGISTER_METHOD(0x01A6FA80, JsonConverter *, GetMatchingConverter_2, (app::IList_1_Newtonsoft_Json_JsonConverter_ * converters, app::Type * object_type));
IL2CPP_REGISTER_METHOD(0x01A6FB70, void, OnError, (app::JsonSerializer * this_ptr, app::ErrorEventArgs * e));
IL2CPP_REGISTER_METHOD(0x015F3820, Object *, Deserialize_2, (app::JsonSerializer * this_ptr, app::JsonReader * reader));
IL2CPP_REGISTER_METHOD(0x015F36F0, RegexOptions__Enum, Deserialize_3, (app::JsonSerializer * this_ptr, app::JsonReader * reader));
IL2CPP_REGISTER_METHODINFO(0x047423F0, JsonSerializer_Deserialize_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015F36F0, Int32Enum__Enum, Deserialize_4, (app::JsonSerializer * this_ptr, app::JsonReader * reader));
}
