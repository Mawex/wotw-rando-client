...
namespace app::methods::Moon_Telemetry_Performance_Settings::TimesliceEOFProfilingSetting {
IL2CPP_REGISTER_METHOD(0x00E40410, ProfilingSettings_SettingType__Enum, get_SettingType, (app::TimesliceEOFProfilingSetting * this_ptr));
