...
namespace app::methods::System_Xml_Schema::XmlSchema {
IL2CPP_REGISTER_METHOD(0x02256A30, void, __ctor, (app::XmlSchema * this_ptr));
IL2CPP_REGISTER_METHOD(0x022571E0, XmlSchema *, Read, (app::XmlReader * reader, app::ValidationEventHandler * validation_event_handler));
...
IL2CPP_REGISTER_METHOD(0x003FC7F0, XmlSchemaForm__Enum, get_AttributeFormDefault, (app::XmlSchema * this_ptr));
IL2CPP_REGISTER_METHOD(0x00617D40, void, set_AttributeFormDefault, (app::XmlSchema * this_ptr, app::XmlSchemaForm__Enum value));
IL2CPP_REGISTER_METHOD(0x004E57A0, XmlSchemaDerivationMethod__Enum, get_BlockDefault, (app::XmlSchema * this_ptr));
IL2CPP_REGISTER_METHOD(0x004E57B0, void, set_BlockDefault, (app::XmlSchema * this_ptr, app::XmlSchemaDerivationMethod__Enum value));
IL2CPP_REGISTER_METHOD(0x0057AAC0, XmlSchemaDerivationMethod__Enum, get_FinalDefault, (app::XmlSchema * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C08D30, void, set_FinalDefault, (app::XmlSchema * this_ptr, app::XmlSchemaDerivationMethod__Enum value));
IL2CPP_REGISTER_METHOD(0x003FC830, XmlSchemaForm__Enum, get_ElementFormDefault, (app::XmlSchema * this_ptr));
IL2CPP_REGISTER_METHOD(0x004C5130, void, set_ElementFormDefault, (app::XmlSchema * this_ptr, app::XmlSchemaForm__Enum value));
IL2CPP_REGISTER_METHOD(0x002FB9F0, String *, get_TargetNamespace, (app::XmlSchema * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBA00, void, set_TargetNamespace, (app::XmlSchema * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBB40, String *, get_Version, (app::XmlSchema * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB50, void, set_Version, (app::XmlSchema * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBB60, XmlSchemaObjectCollection *, get_Includes, (app::XmlSchema * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB80, XmlSchemaObjectCollection *, get_Items, (app::XmlSchema * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02257B30, XmlSchemaObjectTable *, get_Attributes, (app::XmlSchema * this_ptr));
IL2CPP_REGISTER_METHOD(0x02257C90, XmlSchemaObjectTable *, get_AttributeGroups, (app::XmlSchema * this_ptr));
IL2CPP_REGISTER_METHOD(0x02257DF0, XmlSchemaObjectTable *, get_SchemaTypes, (app::XmlSchema * this_ptr));
IL2CPP_REGISTER_METHOD(0x02257F50, XmlSchemaObjectTable *, get_Elements, (app::XmlSchema * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBA0, String *, get_Id, (app::XmlSchema * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBB0, void, set_Id, (app::XmlSchema * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBC80, XmlSchemaObjectTable *, get_Groups, (app::XmlSchema * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCA0, XmlSchemaObjectTable *, get_Notations, (app::XmlSchema * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCC0, XmlSchemaObjectTable *, get_IdentityConstraints, (app::XmlSchema * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD40, Uri *, get_BaseUri, (app::XmlSchema * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00660430, Hashtable *, get_Ids, (app::XmlSchema * this_ptr));
IL2CPP_REGISTER_METHOD(0x02258170, XmlDocument *, get_Document, (app::XmlSchema * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x022582D0, XmlSchema *, Clone, (app::XmlSchema * this_ptr));
IL2CPP_REGISTER_METHOD(0x02258480, XmlSchema *, DeepClone, (app::XmlSchema * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBA0, String *, get_IdAttribute, (app::XmlSchema * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02258920, ArrayList *, get_ImportedSchemas, (app::XmlSchema * this_ptr));
IL2CPP_REGISTER_METHOD(0x02258A80, ArrayList *, get_ImportedNamespaces, (app::XmlSchema * this_ptr));
