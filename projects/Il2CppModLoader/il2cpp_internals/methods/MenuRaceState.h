...
namespace app::methods::MenuRaceState {
    ...
    IL2CPP_REGISTER_METHOD(0x002FA280, IState*, GetNextState, (app::MenuRaceState * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MenuRaceState * this_ptr));
} // namespace app::methods::MenuRaceState
