...
IL2CPP_REGISTER_METHOD(0x0110A280, Vector3, RootMotionProc, (app::LizardSpitAttackBehaviour * this_ptr, app::Vector3 motion));
IL2CPP_REGISTER_METHOD(0x0110A330, BehaviourStatus__Enum, OnExecute, (app::LizardSpitAttackBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0110A910, void, __ctor, (app::LizardSpitAttackBehaviour * this_ptr));
