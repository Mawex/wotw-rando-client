...
IL2CPP_REGISTER_METHOD(0x019E1830, void, __ctor, (app::EntityHitReactionBehaviour_1_SandWormEntity_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047244A8, EntityHitReactionBehaviour_1_SandWormEntity___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00420230, BehaviourStatus__Enum, OnExecuteTask, (app::EntityHitReactionBehaviour_1_SandWormEntity_ * this_ptr, app::IContext * context));
