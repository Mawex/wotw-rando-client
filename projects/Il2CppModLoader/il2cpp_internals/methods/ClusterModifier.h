...
IL2CPP_REGISTER_METHOD(0x012C5DE0, String *, get_BoneName, (app::ClusterModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012C6ED0, void, __ctor, (app::ClusterModifier * this_ptr));
}
