...
IL2CPP_REGISTER_METHOD(0x0012F2F0, void, __ctor_1, (app::CSteamID__Boxed * this_ptr, app::AccountID_t un_account_i_d, app::EUniverse__Enum e_universe, app::EAccountType__Enum e_account_type));
IL2CPP_REGISTER_METHOD(0x0012F300, void, __ctor_2, (app::CSteamID__Boxed * this_ptr, app::AccountID_t un_account_i_d, uint32_t un_account_instance, app::EUniverse__Enum e_universe, app::EAccountType__Enum e_account_type));
IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor_3, (app::CSteamID__Boxed * this_ptr, uint64_t ul_steam_i_d));
...
IL2CPP_REGISTER_METHOD(0x0010E170, AccountID_t, GetAccountID, (app::CSteamID__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0012F600, uint32_t, GetUnAccountInstance, (app::CSteamID__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0012F610, EAccountType__Enum, GetEAccountType, (app::CSteamID__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0012F620, EUniverse__Enum, GetEUniverse, (app::CSteamID__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0012F630, bool, IsValid, (app::CSteamID__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0012F1B0, String *, ToString, (app::CSteamID__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x015F8190, bool, operator____1, (app::CSteamID x, app::CSteamID y));
IL2CPP_REGISTER_METHOD(0x015FA5E0, bool, operator____2, (app::CSteamID x, app::CSteamID y));
IL2CPP_REGISTER_METHOD(0x004C50A0, CSteamID, operator__1, (uint64_t value));
IL2CPP_REGISTER_METHOD(0x004C50A0, uint64_t, operator__2, (app::CSteamID that));
