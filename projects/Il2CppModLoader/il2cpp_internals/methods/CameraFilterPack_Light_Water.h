...
IL2CPP_REGISTER_METHOD(0x0247F500, Material *, get_material, (app::CameraFilterPack_Light_Water * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0247FDF0, void, __ctor, (app::CameraFilterPack_Light_Water * this_ptr));
}
