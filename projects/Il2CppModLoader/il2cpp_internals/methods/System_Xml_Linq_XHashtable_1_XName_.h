...
namespace app::methods::System_Xml_Linq::XHashtable_1_XName_ {
IL2CPP_REGISTER_METHOD(0x0225AE80, void, __ctor, (app::XHashtable_1_XName_ * this_ptr, app::XHashtable_1_TValue_ExtractKeyDelegate_XName_ * extract_key, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x0225B000, XName *, Add, (app::XHashtable_1_XName_ * this_ptr, app::XName * value));
