...
namespace app::methods::Steamworks::HServerQuery {
    ...
    IL2CPP_REGISTER_METHOD(0x015F7650, bool, operator____1, (app::HServerQuery x, app::HServerQuery y));
    IL2CPP_REGISTER_METHOD(0x015FBAE0, bool, operator____2, (app::HServerQuery x, app::HServerQuery y));
    IL2CPP_REGISTER_METHOD(0x006CE970, app::HServerQuery, operator__1, (int32_t value));
    IL2CPP_REGISTER_METHOD(0x006CE970, int32_t, operator__2, (app::HServerQuery that));
