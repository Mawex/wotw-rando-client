...
namespace app::methods::Mono_Security_Protocol_Ntlm::Type1Message {
IL2CPP_REGISTER_METHOD(0x02A4B920, void, __ctor, (app::Type1Message * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A4BCA0, Byte__Array *, GetBytes, (app::Type1Message * this_ptr));
}
