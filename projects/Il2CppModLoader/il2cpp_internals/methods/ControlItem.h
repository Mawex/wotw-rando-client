...
namespace app::methods::ControlItem {
    IL2CPP_REGISTER_METHOD(0x011E8210, void, __ctor, (app::ControlItem * this_ptr, app::CommandBinding* binding));
    IL2CPP_REGISTER_METHOD(0x011E83E0, KeyCode__Enum__Array*, GetModifiedKeys, (app::ControlItem * this_ptr));
    IL2CPP_REGISTER_METHOD(0x011E84C0, void, AssignFromCommandInputButton, (app::ControlItem * this_ptr));
    IL2CPP_REGISTER_METHOD(0x011E8860, KeyCode__Enum, GetProposedKey, (app::ControlItem * this_ptr, int32_t sub_index));
