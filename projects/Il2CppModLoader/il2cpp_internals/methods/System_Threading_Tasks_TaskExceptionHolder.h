...
IL2CPP_REGISTER_METHOD(0x00417870, bool, ShouldFailFastOnUnobservedException, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0233C2C0, void, EnsureADUnloadCallbackRegistered, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x0233DE30, void, __cctor, (MethodInfo * method));
}
