...
IL2CPP_REGISTER_METHOD(0x00418EB0, Vector2, GasBallBaitCenter, (app::GasBallAttractionRect * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00419200, void, __ctor, (app::GasBallAttractionRect * this_ptr));
}
