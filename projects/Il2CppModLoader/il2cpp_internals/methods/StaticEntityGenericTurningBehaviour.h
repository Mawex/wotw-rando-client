...
IL2CPP_REGISTER_METHOD(0x008D2CA0, BehaviourStatus__Enum, OnExecuteTask, (app::StaticEntityGenericTurningBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x009B6E80, bool, ShouldEndBehaviour, (app::StaticEntityGenericTurningBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x005B3EC0, void, __ctor, (app::StaticEntityGenericTurningBehaviour * this_ptr));
}
