...
IL2CPP_REGISTER_METHOD(0x00FCBA80, Bounds, get_Bounds, (app::UberInteractionModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FCC950, Vector2, TransformVelocity, (app::UberInteractionModifier * this_ptr, app::Vector2 velocity));
...
IL2CPP_REGISTER_METHOD(0x00FCCEA0, String *, get_InteractionName, (app::UberInteractionModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FCD140, IEnumerable_1_System_String_ *, GetBaseVertexTextureNames, (app::UberInteractionModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x00FCD2D0, IEnumerable_1_System_String_ *, GetKeywordsForShader, (app::UberInteractionModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FCE7A0, Vector3, GetPosition, (app::UberInteractionModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x00FCE7C0, Vector3, GetExplodePoint, (app::UberInteractionModifier * this_ptr, app::Vector3 position));
...
IL2CPP_REGISTER_METHOD(0x00FCEB20, void, __ctor, (app::UberInteractionModifier * this_ptr));
