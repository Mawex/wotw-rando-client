...
namespace app::methods::SinMovement {
    ...
    IL2CPP_REGISTER_METHOD(0x0065B580, SuspendableMask__Enum, get_Mask, (app::SinMovement * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0074A410, void, __ctor, (app::SinMovement * this_ptr));
} // namespace app::methods::SinMovement
