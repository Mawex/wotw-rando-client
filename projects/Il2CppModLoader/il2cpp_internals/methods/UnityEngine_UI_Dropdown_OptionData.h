...
namespace app::methods::UnityEngine_UI::Dropdown_OptionData {
...
IL2CPP_REGISTER_METHOD(0x01F2AB40, String *, get_text, (app::Dropdown_OptionData * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_text, (app::Dropdown_OptionData * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x01F25880, Sprite *, get_image, (app::Dropdown_OptionData * this_ptr));
