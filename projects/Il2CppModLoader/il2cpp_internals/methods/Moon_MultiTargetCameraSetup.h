...
IL2CPP_REGISTER_METHOD(0x00C03C70, SuspendableMask__Enum, get_Mask, (app::MultiTargetCameraSetup * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0111EAC0, Rect, GetRect, (app::MultiTargetCameraSetup * this_ptr, app::CameraTargetSettings setting));
IL2CPP_REGISTER_METHOD(0x0111EBE0, Vector3, GetTargetPos, (app::MultiTargetCameraSetup * this_ptr, app::CameraTargetSettings setting));
IL2CPP_REGISTER_METHOD(0x0111EC00, Rect, BoundingRectangle, (app::MultiTargetCameraSetup * this_ptr, app::List_1_UnityEngine_Rect_ * rects));
...
IL2CPP_REGISTER_METHOD(0x01120260, void, __ctor, (app::MultiTargetCameraSetup * this_ptr));
}
