...
IL2CPP_REGISTER_METHOD(0x00417920, BehaviourStatus__Enum, OnExecute, (app::DropSlugDropAttackBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00BE1280, void, __ctor, (app::DropSlugDropAttackBehaviour * this_ptr));
}
