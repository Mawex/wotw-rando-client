...
namespace app::methods::SeinInput {
    ...
    IL2CPP_REGISTER_METHOD(0x0100ED90, Vector2, get_Axis, (app::SeinInput * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0100EDA0, Vector2, WorldToLocal, (app::SeinInput * this_ptr, app::Vector2 speed));
    IL2CPP_REGISTER_METHOD(0x0100EDF0, void, Update, (app::SeinInput * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0100F030, Input_InputButtonProcessor*, GetButton, (app::SeinInput * this_ptr, app::AbilityType__Enum ability));
    IL2CPP_REGISTER_METHOD(0x0100F0E0, AbilityType__Enum, GetAssignedAbility, (app::SeinInput * this_ptr, app::Input_Command__Enum button));
