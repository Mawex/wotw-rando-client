...
namespace app::methods::UnityEngine_Playables::PlayableGraph {
IL2CPP_REGISTER_METHOD(0x02964A30, PlayableGraph, Create_1, ());
IL2CPP_REGISTER_METHOD(0x02964AA0, PlayableGraph, Create_2, (app::String * name));
