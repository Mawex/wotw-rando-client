...
namespace app::methods::UnityEngine_Events::BaseInvokableCall {
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_1, (app::BaseInvokableCall * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0242E930, void, __ctor_2, (app::BaseInvokableCall * this_ptr, app::Object * target, app::MethodInfo_1 * function));
