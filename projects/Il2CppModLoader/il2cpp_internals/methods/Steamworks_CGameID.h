...
IL2CPP_REGISTER_METHOD(0x0012F120, AppId_t, AppID, (app::CGameID__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0012F130, CGameID_EGameIDType__Enum, Type, (app::CGameID__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0012F1B0, String *, ToString, (app::CGameID__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, CGameID, operator__1, (uint64_t value));
