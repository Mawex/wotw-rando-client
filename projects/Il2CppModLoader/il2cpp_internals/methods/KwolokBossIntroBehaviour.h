...
IL2CPP_REGISTER_METHOD(0x012E2570, BehaviourStatus__Enum, OnExecute, (app::KwolokBossIntroBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x012E28D0, void, __ctor, (app::KwolokBossIntroBehaviour * this_ptr));
}
