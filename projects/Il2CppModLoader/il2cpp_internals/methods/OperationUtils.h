...
IL2CPP_REGISTER_METHOD(0x03113830, Vector3, Operate_3, (app::Vector3 a, app::Vector3 b, app::OperationMethod__Enum om));
IL2CPP_REGISTER_METHOD(0x03113AB0, String *, GetOperationString, (app::OperationMethod__Enum om));
}
