...
IL2CPP_REGISTER_METHOD(0x01478B50, Vector3, TweakVelocity, (app::Vector3 v));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MortarEntity_AimVeloCache_Caster * this_ptr));
