...
IL2CPP_REGISTER_METHOD(0x030A2DB0, Rigidbody *, get_connectedBody, (app::Joint * this_ptr));
IL2CPP_REGISTER_METHOD(0x030A2E00, void, set_connectedBody, (app::Joint * this_ptr, app::Rigidbody * value));
IL2CPP_REGISTER_METHOD(0x030A2E60, Vector3, get_axis, (app::Joint * this_ptr));
IL2CPP_REGISTER_METHOD(0x030A2EE0, void, set_axis, (app::Joint * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x030A2F40, Vector3, get_anchor, (app::Joint * this_ptr));
IL2CPP_REGISTER_METHOD(0x030A2FC0, void, set_anchor, (app::Joint * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x030A3020, Vector3, get_connectedAnchor, (app::Joint * this_ptr));
