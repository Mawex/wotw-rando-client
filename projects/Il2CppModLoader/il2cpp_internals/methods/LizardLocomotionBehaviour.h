...
IL2CPP_REGISTER_METHOD(0x00FB0BA0, Transform *, get_VFXHolder, (app::LizardLocomotionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FB1400, BehaviourStatus__Enum, OnExecuteTask, (app::LizardLocomotionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00842340, void, __ctor, (app::LizardLocomotionBehaviour * this_ptr));
}
