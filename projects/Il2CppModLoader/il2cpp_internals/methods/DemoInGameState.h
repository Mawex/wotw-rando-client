...
IL2CPP_REGISTER_METHOD(0x002FA280, IState *, GetNextState, (app::DemoInGameState * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::DemoInGameState * this_ptr));
}
