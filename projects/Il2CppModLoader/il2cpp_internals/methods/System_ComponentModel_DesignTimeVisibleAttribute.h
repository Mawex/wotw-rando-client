...
namespace app::methods::System_ComponentModel::DesignTimeVisibleAttribute {
    IL2CPP_REGISTER_METHOD(0x0052C650, void, __ctor_1, (app::DesignTimeVisibleAttribute * this_ptr, bool visible));
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_2, (app::DesignTimeVisibleAttribute * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01FE6050, void, __cctor, ());
}
