...
IL2CPP_REGISTER_METHOD(0x01763DD0, Vector3, get_AttackPosition, (app::PetrifiedOwlBossFeatherFlurryBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x017644B0, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossFeatherFlurryBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01765130, Projectile *, SpawnProjectile, (app::Vector2 shoot_point, app::Vector3 shoot_velocity, app::ProjectileSpawner * spawner, float gravity, float damage));
IL2CPP_REGISTER_METHOD(0x01765350, Enum__Array *, GetEntries, (app::PetrifiedOwlBossFeatherFlurryBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x017653F0, Enum, Evaluate, (app::PetrifiedOwlBossFeatherFlurryBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_ShouldSkip, (app::PetrifiedOwlBossFeatherFlurryBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x01765490, void, __ctor, (app::PetrifiedOwlBossFeatherFlurryBehaviour * this_ptr));
}
