...
namespace app::methods::Newtonsoft_Json_Utilities::StringReference {
IL2CPP_REGISTER_METHOD(0x00240CB0, uint16_t, get_Item, (app::StringReference__Boxed * this_ptr, int32_t i));
IL2CPP_REGISTER_METHOD(0x00107C00, Char__Array *, get_Chars, (app::StringReference__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00240CF0, String *, ToString, (app::StringReference__Boxed * this_ptr));
}
