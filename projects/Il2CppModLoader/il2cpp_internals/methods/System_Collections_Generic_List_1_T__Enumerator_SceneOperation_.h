...
namespace app::methods::System_Collections_Generic::List_1_T__Enumerator_SceneOperation_ {
IL2CPP_REGISTER_METHOD(0x00136440, SceneOperation, get_Current, (app::List_1_T_Enumerator_SceneOperation___Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0014CA00, void, __ctor, (app::List_1_T_Enumerator_SceneOperation___Boxed * this_ptr, app::List_1_SceneOperation_ * list));
IL2CPP_REGISTER_METHOD(0x0014CAF0, bool, MoveNextRare, (app::List_1_T_Enumerator_SceneOperation___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0014CB40, Object *, IEnumerator_get_Current, (app::List_1_T_Enumerator_SceneOperation___Boxed * this_ptr));
