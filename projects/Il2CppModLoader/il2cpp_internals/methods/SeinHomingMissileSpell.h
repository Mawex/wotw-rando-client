...
IL2CPP_REGISTER_METHOD(0x00A6D240, Vector3, get_SeinPosition, (app::SeinHomingMissileSpell * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement *, get_PlatformMovement, (app::SeinHomingMissileSpell * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0100A9A0, void, __ctor, (app::SeinHomingMissileSpell * this_ptr));
}
