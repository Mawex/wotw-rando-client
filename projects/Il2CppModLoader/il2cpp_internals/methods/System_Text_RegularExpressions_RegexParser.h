...
namespace app::methods::System_Text_RegularExpressions::RegexParser {
IL2CPP_REGISTER_METHOD(0x02597B50, RegexTree *, Parse, (app::String * re, app::RegexOptions__Enum op));
IL2CPP_REGISTER_METHOD(0x02597F70, RegexReplacement *, ParseReplacement, (app::String * rep, app::Hashtable * caps, int32_t capsize, app::Hashtable * capnames, app::RegexOptions__Enum op));
IL2CPP_REGISTER_METHOD(0x02598260, String *, Escape, (app::String * input));
IL2CPP_REGISTER_METHOD(0x02598540, void, __ctor, (app::RegexParser * this_ptr, app::CultureInfo * culture));
...
IL2CPP_REGISTER_METHOD(0x02598970, RegexNode *, ScanRegex, (app::RegexParser * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04788888, RegexParser_ScanRegex__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02599350, RegexNode *, ScanReplacement, (app::RegexParser * this_ptr));
IL2CPP_REGISTER_METHOD(0x02599590, RegexCharClass *, ScanCharClass_1, (app::RegexParser * this_ptr, bool case_insensitive));
IL2CPP_REGISTER_METHOD(0x025995A0, RegexCharClass *, ScanCharClass_2, (app::RegexParser * this_ptr, bool case_insensitive, bool scan_only));
IL2CPP_REGISTER_METHODINFO(0x0474EAA8, RegexParser_ScanCharClass_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0259A020, RegexNode *, ScanGroupOpen, (app::RegexParser * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0259B740, RegexNode *, ScanBackslash, (app::RegexParser * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04712A28, RegexParser_ScanBackslash__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0259C4C0, RegexNode *, ScanBasicBackslash, (app::RegexParser * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04762A30, RegexParser_ScanBasicBackslash__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0259CEB0, RegexNode *, ScanDollar, (app::RegexParser * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04744220, RegexParser_ScanDollar__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0259D670, String *, ScanCapname, (app::RegexParser * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0259E1F0, String *, ParseProperty, (app::RegexParser * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB990, RegexNode *, Unit, (app::RegexParser * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025A1630, ArgumentException *, MakeException, (app::RegexParser * this_ptr, app::String * message));
