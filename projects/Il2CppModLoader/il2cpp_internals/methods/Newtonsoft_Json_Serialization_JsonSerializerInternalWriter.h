...
namespace app::methods::Newtonsoft_Json_Serialization::JsonSerializerInternalWriter {
IL2CPP_REGISTER_METHOD(0x01BF1EA0, void, __ctor, (app::JsonSerializerInternalWriter * this_ptr, app::JsonSerializer * serializer));
...
IL2CPP_REGISTER_METHOD(0x01BF2260, JsonSerializerProxy *, GetInternalSerializer, (app::JsonSerializerInternalWriter * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BF2440, JsonContract *, GetContractSafe, (app::JsonSerializerInternalWriter * this_ptr, app::Object * value));
...
IL2CPP_REGISTER_METHOD(0x01BF2C30, Nullable_1_Boolean_, ResolveIsReference, (app::JsonSerializerInternalWriter * this_ptr, app::JsonContract * contract, app::JsonProperty * property, app::JsonContainerContract * collection_contract, app::JsonProperty * container_property));
...
IL2CPP_REGISTER_METHOD(0x01BF36F0, String *, GetReference, (app::JsonSerializerInternalWriter * this_ptr, app::JsonWriter * writer, app::Object * value));
...
IL2CPP_REGISTER_METHOD(0x01BF79D0, String *, GetPropertyName, (app::JsonSerializerInternalWriter * this_ptr, app::JsonWriter * writer, app::Object * name, app::JsonContract * contract, app::bool * escape));
