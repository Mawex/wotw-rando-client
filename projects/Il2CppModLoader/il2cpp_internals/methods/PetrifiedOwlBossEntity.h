...
IL2CPP_REGISTER_METHOD(0x004A21A0, Vector2, get_ArenaBoundsX, (app::PetrifiedOwlBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x004A24C0, Vector2, get_ArenaBoundLeft, (app::PetrifiedOwlBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x004A2730, Vector2, get_ArenaBoundRight, (app::PetrifiedOwlBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004A2AE0, PetrifiedOwlBossLavaController *, get_LavaController, (app::PetrifiedOwlBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004A2CB0, PetrifiedOwlBossEntity_Phases__Enum, get_CurrentPhase, (app::PetrifiedOwlBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004A30A0, List_1_PetrifiedOwlBossBaseBehaviour_ *, get_ExecutingBehaviours, (app::PetrifiedOwlBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004A31B0, Vector3, get_ProjectedSpitShootPoint, (app::PetrifiedOwlBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004A34C0, PetrifiedOwlBossLocomotion *, get_PowlLocomotion, (app::PetrifiedOwlBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x004A3580, Transform *, get_TargetCharacterTransform, (app::PetrifiedOwlBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004A4730, Vector3, get_EntityPositionXY, (app::PetrifiedOwlBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004A4C70, Vector3, get_TargetPosition, (app::PetrifiedOwlBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004A4F50, Vector3, ClampToLimits, (app::PetrifiedOwlBossEntity * this_ptr, app::Vector3 pos));
IL2CPP_REGISTER_METHOD(0x004A4FA0, Vector3, get_ArenaCenterPosition, (app::PetrifiedOwlBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004A5310, Vector3, GetClosestGroundPosition, (app::PetrifiedOwlBossEntity * this_ptr, app::Vector3 pos));
...
IL2CPP_REGISTER_METHOD(0x004A7F30, PetrifiedOwlBossGroundPiece *, HasRemainingDestructibles, (app::PetrifiedOwlBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004A8E00, Vector2, GetMaxLookAt, (app::PetrifiedOwlBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004AA510, IBrainController_1_PetrifiedOwlBossEntity_AnimationDirections_ *, GetExecutingBrain, (app::PetrifiedOwlBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004AA6E0, IUberState__Array *, get_AffectingUberStates, (app::PetrifiedOwlBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x004AA770, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::PetrifiedOwlBossEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x004AA930, void, __ctor, (app::PetrifiedOwlBossEntity * this_ptr));
}
