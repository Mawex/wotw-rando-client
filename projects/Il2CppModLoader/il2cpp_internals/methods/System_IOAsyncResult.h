...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_1, (app::IOAsyncResult * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0058DA40, void, __ctor_2, (app::IOAsyncResult * this_ptr, app::AsyncCallback * async_callback, app::Object * async_state));
IL2CPP_REGISTER_METHOD(0x002FA280, AsyncCallback *, get_AsyncCallback, (app::IOAsyncResult * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, Object *, get_AsyncState, (app::IOAsyncResult * this_ptr));
IL2CPP_REGISTER_METHOD(0x0200AAB0, WaitHandle *, get_AsyncWaitHandle, (app::IOAsyncResult * this_ptr));
