...
IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor_1, (app::RuntimeFieldHandle__Boxed * this_ptr, app::void * v));
IL2CPP_REGISTER_METHOD(0x001D7E50, void, __ctor_2, (app::RuntimeFieldHandle__Boxed * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
...
IL2CPP_REGISTER_METHOD(0x01EE2430, void, SetValue, (app::RtFieldInfo * field, app::Object * obj, app::Object * value, app::RuntimeType * field_type, app::FieldAttributes__Enum field_attr, app::RuntimeType * declaring_type, app::bool * domain_initialized));
