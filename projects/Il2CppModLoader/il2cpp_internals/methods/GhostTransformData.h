...
IL2CPP_REGISTER_METHOD(0x007EC230, Vector3, get_Position, (app::GhostTransformData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_1, (app::GhostTransformData * this_ptr));
IL2CPP_REGISTER_METHOD(0x007EC250, void, __ctor_2, (app::GhostTransformData * this_ptr, app::Vector3 position, bool face_left, float feet_angle));
...
IL2CPP_REGISTER_METHOD(0x003FFDF0, GhostFrame_FrameDataTypes__Enum, get_FrameType, (app::GhostTransformData * this_ptr));
