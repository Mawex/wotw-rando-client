...
IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::ControllerShake * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B1D310, void, __ctor, (app::ControllerShake * this_ptr));
}
