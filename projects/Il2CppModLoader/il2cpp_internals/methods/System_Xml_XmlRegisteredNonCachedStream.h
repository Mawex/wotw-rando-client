...
namespace app::methods::System_Xml::XmlRegisteredNonCachedStream {
IL2CPP_REGISTER_METHOD(0x01706880, void, __ctor, (app::XmlRegisteredNonCachedStream * this_ptr, app::Stream * stream, app::XmlDownloadManager * download_manager, app::String * host));
...
IL2CPP_REGISTER_METHOD(0x01706B30, IAsyncResult *, BeginRead, (app::XmlRegisteredNonCachedStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::AsyncCallback * callback, app::Object * state));
IL2CPP_REGISTER_METHOD(0x01706B60, IAsyncResult *, BeginWrite, (app::XmlRegisteredNonCachedStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::AsyncCallback * callback, app::Object * state));
