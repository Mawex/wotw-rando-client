...
IL2CPP_REGISTER_METHOD(0x024E3BF0, Material *, get_material, (app::CameraFilterPack_Distortion_Aspiration * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024E4550, void, __ctor, (app::CameraFilterPack_Distortion_Aspiration * this_ptr));
}
