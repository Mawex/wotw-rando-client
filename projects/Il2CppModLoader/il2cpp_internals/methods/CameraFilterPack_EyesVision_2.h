...
IL2CPP_REGISTER_METHOD(0x02467580, Material *, get_material, (app::CameraFilterPack_EyesVision_2 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02467550, void, __ctor, (app::CameraFilterPack_EyesVision_2 * this_ptr));
}
