...
namespace app::methods::System_Configuration::ConfigurationPropertyCollection {
...
IL2CPP_REGISTER_METHOD(0x031BBD50, Object *, get_SyncRoot, (app::ConfigurationPropertyCollection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04758510, ConfigurationPropertyCollection_get_SyncRoot__MethodInfo);
IL2CPP_REGISTER_METHOD(0x031BBD80, IEnumerator *, GetEnumerator, (app::ConfigurationPropertyCollection * this_ptr));
