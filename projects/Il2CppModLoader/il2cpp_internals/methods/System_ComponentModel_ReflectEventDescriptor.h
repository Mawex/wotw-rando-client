...
namespace app::methods::System_ComponentModel::ReflectEventDescriptor {
IL2CPP_REGISTER_METHOD(0x0299A110, void, __ctor_1, (app::ReflectEventDescriptor * this_ptr, app::Type * component_class, app::String * name, app::Type * type, app::Attribute__Array * attributes));
IL2CPP_REGISTER_METHODINFO(0x04743DF0, ReflectEventDescriptor__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0299A360, void, __ctor_2, (app::ReflectEventDescriptor * this_ptr, app::Type * component_class, app::EventInfo_1 * event_info));
IL2CPP_REGISTER_METHODINFO(0x04784D60, ReflectEventDescriptor__ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0299A4E0, void, __ctor_3, (app::ReflectEventDescriptor * this_ptr, app::Type * component_type, app::EventDescriptor_1 * old_reflect_event_descriptor, app::Attribute__Array * attributes));
IL2CPP_REGISTER_METHOD(0x002FBBA0, Type *, get_ComponentType, (app::ReflectEventDescriptor * this_ptr));
IL2CPP_REGISTER_METHOD(0x0299A5E0, Type *, get_EventType, (app::ReflectEventDescriptor * this_ptr));
