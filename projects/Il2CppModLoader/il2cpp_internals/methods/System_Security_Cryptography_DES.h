...
namespace app::methods::System_Security_Cryptography::DES {
IL2CPP_REGISTER_METHOD(0x020D07E0, void, __ctor, (app::DES * this_ptr));
IL2CPP_REGISTER_METHOD(0x020D08C0, Byte__Array *, get_Key, (app::DES * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020D0D30, DES *, Create_1, ());
IL2CPP_REGISTER_METHOD(0x020D0E70, DES *, Create_2, (app::String * alg_name));
...
IL2CPP_REGISTER_METHOD(0x020D1450, void, __cctor, ());
}
