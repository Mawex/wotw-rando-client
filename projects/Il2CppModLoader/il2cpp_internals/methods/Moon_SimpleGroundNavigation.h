...
IL2CPP_REGISTER_METHOD(0x00E278A0, Vector3, Navigate, (app::SimpleGroundNavigation * this_ptr, app::Vector3 target, app::Vector3 * next_move_point));
IL2CPP_REGISTER_METHOD(0x00E29C40, bool, CanJumpTo, (app::SimpleGroundNavigation * this_ptr, app::Vector3 jump_position));
IL2CPP_REGISTER_METHOD(0x00E2A5C0, void, __ctor, (app::SimpleGroundNavigation * this_ptr));
}
