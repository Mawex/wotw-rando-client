...
IL2CPP_REGISTER_METHOD(0x00B95F70, Bounds, get_Bounds, (app::DisableGameObjectWhenOutOfFrustrum * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B97A80, void, __ctor, (app::DisableGameObjectWhenOutOfFrustrum * this_ptr));
