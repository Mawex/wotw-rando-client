...
IL2CPP_REGISTER_METHOD(0x00A84680, List_1_UnityEngine_Vector3_ *, GetUnburrowPoints, (app::SneezeSlugEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00EDC0C0, PlatformMovement *, GetPlatformMovement, (app::SneezeSlugEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00EDC890, SneezeSlugEntity_HitProtectionState__Enum, get_ProtectionState, (app::SneezeSlugEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00EDC9B0, void, __ctor, (app::SneezeSlugEntity * this_ptr));
}
