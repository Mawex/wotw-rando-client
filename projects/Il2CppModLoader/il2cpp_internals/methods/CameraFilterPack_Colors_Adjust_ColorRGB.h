...
IL2CPP_REGISTER_METHOD(0x024DD2A0, Material *, get_material, (app::CameraFilterPack_Colors_Adjust_ColorRGB * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0136E200, void, __ctor, (app::CameraFilterPack_Colors_Adjust_ColorRGB * this_ptr));
}
