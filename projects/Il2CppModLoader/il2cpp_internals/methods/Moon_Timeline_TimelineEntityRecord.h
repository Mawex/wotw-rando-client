...
namespace app::methods::Moon_Timeline::TimelineEntityRecord {
IL2CPP_REGISTER_METHOD(0x01E85EE0, void, set_Parent, (app::TimelineEntityRecord * this_ptr, app::ITimelineEntityParent * value));
IL2CPP_REGISTER_METHOD(0x01E85EF0, TimelineEntityRecord *, Copy, (app::TimelineEntityRecord * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB970, EntityId, get_EntityId, (app::TimelineEntityRecord * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB980, void, SetEntityIdUnsafe, (app::TimelineEntityRecord * this_ptr, int32_t entity_id));
IL2CPP_REGISTER_METHOD(0x01E86400, TimelineConstraint *, GetConstraint, (app::TimelineEntityRecord * this_ptr, app::Constraint__Enum constraint));
...
IL2CPP_REGISTER_METHOD(0x01E86BB0, IConstrainedEntity *, AsConstrainedEntity, (app::TimelineEntityRecord * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04781D30, TimelineEntityRecord_AsConstrainedEntity__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FB9B0, IConstrainedEntity *, AsCachedConstrainedEntity, (app::TimelineEntityRecord * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E87650, Dictionary_2_System_Int32_Moon_Timeline_EventHistoryItem_ *, get_EventHistory, (app::TimelineEntityRecord * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04764D48, TimelineEntityRecord_get_EventHistory__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0076C7B0, bool, GetEvent, (app::TimelineEntityRecord * this_ptr, int32_t event_id, app::float * time));
