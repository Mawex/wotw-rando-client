...
IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement *, get_PlatformMovement, (app::SeinHeavySpiritSlash * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010019D0, void, __ctor, (app::SeinHeavySpiritSlash * this_ptr));
}
