...
namespace app::methods::TriangleNet_Topology::Triangle {
IL2CPP_REGISTER_METHOD(0x02AA4E20, void, __ctor, (app::Triangle * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AA4CA0, Vertex *, GetVertex, (app::Triangle * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x02AA4ED0, int32_t, GetVertexID, (app::Triangle * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x02AA4F20, ITriangle *, GetNeighbor, (app::Triangle * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x02AA4F80, int32_t, GetNeighborID, (app::Triangle * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x02AA4CE0, ISegment *, GetSegment, (app::Triangle * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x002FC6D0, int32_t, GetHashCode, (app::Triangle * this_ptr));
IL2CPP_REGISTER_METHOD(0x02AA5000, String *, ToString, (app::Triangle * this_ptr));
}
