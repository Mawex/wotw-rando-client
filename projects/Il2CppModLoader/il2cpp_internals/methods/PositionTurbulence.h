...
IL2CPP_REGISTER_METHOD(0x00C68D00, Transform *, get_MyTransform, (app::PositionTurbulence * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C690F0, void, __ctor, (app::PositionTurbulence * this_ptr));
}
