...
namespace app::methods::System_Collections_Generic::Queue_1_SimpleGenericPool_1_PoolItem_ {
...
IL2CPP_REGISTER_METHOD(0x02CA5B40, void, __ctor_1, (app::Queue_1_SimpleGenericPool_1_PoolItem_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHODINFO(0x0471FC18, Queue_1_SimpleGenericPool_1_PoolItem___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02CA6320, SimpleGenericPool_1_T_PoolItem_InstantiateUtility_InstantiateInfo_, Dequeue, (app::Queue_1_SimpleGenericPool_1_PoolItem_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0243CB70, void, __ctor_2, (app::Queue_1_SimpleGenericPool_1_PoolItem_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, ICollection_get_IsSynchronized, (app::Queue_1_SimpleGenericPool_1_PoolItem_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA5C70, Object *, ICollection_get_SyncRoot, (app::Queue_1_SimpleGenericPool_1_PoolItem_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CA61D0, Queue_1_T_Enumerator_SimpleGenericPool_1_PoolItem_, GetEnumerator, (app::Queue_1_SimpleGenericPool_1_PoolItem_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA6240, IEnumerator_1_SimpleGenericPool_1_PoolItem_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::Queue_1_SimpleGenericPool_1_PoolItem_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA6240, IEnumerator *, IEnumerable_GetEnumerator, (app::Queue_1_SimpleGenericPool_1_PoolItem_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA6470, SimpleGenericPool_1_T_PoolItem_InstantiateUtility_InstantiateInfo_, Peek, (app::Queue_1_SimpleGenericPool_1_PoolItem_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0243D5D0, SimpleGenericPool_1_T_PoolItem_InstantiateUtility_InstantiateInfo___Array *, ToArray, (app::Queue_1_SimpleGenericPool_1_PoolItem_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0243D6C0, void, SetCapacity, (app::Queue_1_SimpleGenericPool_1_PoolItem_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x0243D7A0, void, MoveNext, (app::Queue_1_SimpleGenericPool_1_PoolItem_ * this_ptr, app::int32_t * index));
