...
namespace app::methods::System_Collections_Generic::KeyValuePair_2_System_ByteEnum_System_Int32Enum_ {
    IL2CPP_REGISTER_METHOD(0x00150050, void, __ctor, (app::KeyValuePair_2_System_ByteEnum_System_Int32Enum___Boxed * this_ptr, app::ByteEnum__Enum key, app::Int32Enum__Enum value));
