...
IL2CPP_REGISTER_METHOD(0x00AFA0A0, IEnumerator *, WaitToShowFirstTimeQualitySettings, (app::TitleScreenManager * this_ptr, bool immediate));
IL2CPP_REGISTER_METHOD(0x00AFA200, ITimelineEntity *, get_PrologueMaster, ());
IL2CPP_REGISTER_METHOD(0x00AFA330, void, __ctor, (app::TitleScreenManager * this_ptr));
