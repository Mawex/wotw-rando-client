...
IL2CPP_REGISTER_METHOD(0x00BA6D00, String__Array *, GetDataHeaderNames, (app::SceneLoadingCaptureAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x00BA6E40, String__Array *, GetFrameData_1, (app::SceneLoadingCaptureAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00BA72A0, void, __ctor, (app::SceneLoadingCaptureAgent * this_ptr));
}
