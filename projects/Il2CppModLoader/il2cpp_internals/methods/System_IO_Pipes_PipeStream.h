...
IL2CPP_REGISTER_METHOD(0x01F99960, Stream *, get_Stream, (app::PipeStream * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F9A0B0, IAsyncResult *, BeginRead, (app::PipeStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::AsyncCallback * callback, app::Object * state));
IL2CPP_REGISTER_METHOD(0x01F9A300, IAsyncResult *, BeginWrite, (app::PipeStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::AsyncCallback * callback, app::Object * state));
