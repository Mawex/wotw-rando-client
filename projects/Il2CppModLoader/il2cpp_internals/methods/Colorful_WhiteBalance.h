...
IL2CPP_REGISTER_METHOD(0x03055740, String *, GetShaderName, (app::WhiteBalance * this_ptr));
IL2CPP_REGISTER_METHOD(0x030557C0, void, __ctor, (app::WhiteBalance * this_ptr));
}
