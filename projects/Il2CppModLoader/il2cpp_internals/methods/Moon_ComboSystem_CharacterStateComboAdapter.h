...
namespace app::methods::Moon_ComboSystem::CharacterStateComboAdapter {
...
IL2CPP_REGISTER_METHOD(0x00CC5850, void, __ctor, (app::CharacterStateComboAdapter * this_ptr));
}
