...
IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor, (app::ParticleSystem_MainModule__Boxed * this_ptr, app::ParticleSystem * particle_system));
...
IL2CPP_REGISTER_METHOD(0x00247E50, ParticleSystem_MinMaxCurve, get_startLifetime, (app::ParticleSystem_MainModule__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00247F50, ParticleSystem_MinMaxCurve, get_startSpeed, (app::ParticleSystem_MainModule__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002480C0, ParticleSystem_MinMaxCurve, get_startSizeX, (app::ParticleSystem_MainModule__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002481C0, ParticleSystem_MinMaxCurve, get_startSizeY, (app::ParticleSystem_MainModule__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002482C0, ParticleSystem_MinMaxCurve, get_startSizeZ, (app::ParticleSystem_MainModule__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00248440, ParticleSystem_MinMaxGradient, get_startColor, (app::ParticleSystem_MainModule__Boxed * this_ptr));
