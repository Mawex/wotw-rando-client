...
namespace app::methods::Microsoft_Xbox_Services_Xal::InitArgs {
...
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_ClientId, (app::InitArgs * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_ClientId, (app::InitArgs * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_Sandbox, (app::InitArgs * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB960, void, set_Sandbox, (app::InitArgs * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, get_RedirectUri, (app::InitArgs * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB10, void, set_RedirectUri, (app::InitArgs * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB990, String__Array *, get_ThirdPartyConsents, (app::InitArgs * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9D0, String *, get_CorrelationVector, (app::InitArgs * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9E0, void, set_CorrelationVector, (app::InitArgs * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB9F0, DeviceInfo *, get_DeviceInfo, (app::InitArgs * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB40, TelemetryInfo *, get_TelemetryInfo, (app::InitArgs * this_ptr));
IL2CPP_REGISTER_METHOD(0x01434070, void, __ctor, (app::InitArgs * this_ptr));
}
