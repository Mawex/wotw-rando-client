...
IL2CPP_REGISTER_METHOD(0x01E09640, String *, get_Message, (app::FileNotFoundException * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E09700, void, SetMessageField, (app::FileNotFoundException * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E097B0, String *, ToString, (app::FileNotFoundException * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC60, String *, get_FusionLog, (app::FileNotFoundException * this_ptr));
