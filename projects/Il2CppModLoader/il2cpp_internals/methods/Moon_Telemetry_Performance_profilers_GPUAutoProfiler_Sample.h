...
namespace app::methods::Moon_Telemetry_Performance_profilers::GPUAutoProfiler_Sample {
IL2CPP_REGISTER_METHOD(0x002FD1D0, GPUAutoProfiler_Sample_SamplingState__Enum, get_State, (app::GPUAutoProfiler_Sample * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E45530, void, __ctor, (app::GPUAutoProfiler_Sample * this_ptr, app::GPUAutoProfilerReport * report));
