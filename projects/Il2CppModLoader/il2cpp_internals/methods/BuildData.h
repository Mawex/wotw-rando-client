...
namespace app::methods::BuildData {
    IL2CPP_REGISTER_METHOD(0x005D89A0, RecorderFrame_FrameDataTypes__Enum, FrameType, (app::BuildData * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00815A10, void, __ctor, (app::BuildData * this_ptr));
} // namespace app::methods::BuildData
