...
namespace app::methods::Moon_UI::Text {
    IL2CPP_REGISTER_METHOD(0x01184DB0, int32_t, get_LineCount, (app::Text_1 * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB80, String*, get_DefaultText, (app::Text_1 * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01185490, CharMetaData, GetCharacterMetaData, (app::Text_1 * this_ptr, int32_t index));
    ...
    IL2CPP_REGISTER_METHOD(0x01185930, Vector2, ComputeAnchorAndBounds, (app::Text_1 * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01186750, LineDescent, FindLineDataForLastWord, (app::Text_1 * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01187C90, TextBoxLine_1, GetLineInfo, (app::Text_1 * this_ptr, int32_t index));
    ...
    IL2CPP_REGISTER_METHOD(0x01188560, void, __ctor, (app::Text_1 * this_ptr));
} // namespace app::methods::Moon_UI::Text
