...
IL2CPP_REGISTER_METHOD(0x012E0C90, BehaviourStatus__Enum, OnExecute, (app::KwolokBossHeadbuttBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x012E0E80, void, __ctor, (app::KwolokBossHeadbuttBehaviour * this_ptr));
}
