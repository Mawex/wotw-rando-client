...
IL2CPP_REGISTER_METHOD(0x019F5A80, bool, PerformCastInternal, (app::SpherecastCommand cmd, app::RaycastHit * hit, app::int32_t * request_i_d, bool guarantee_immediate_result));
...
IL2CPP_REGISTER_METHOD(0x019F6BB0, bool, PerformMultipleCastsInternal, (app::SpherecastCommand__Array * cmds, app::RaycastHit__Array * hits, app::Boolean__Array * hit_results, int32_t cmd_count, app::int32_t * request_i_d, bool guarantee_immediate_result));
...
IL2CPP_REGISTER_METHOD(0x019EE1D0, void, __ctor, (app::GenericCastManager_1_UnityEngine_SpherecastCommand_ * this_ptr));
