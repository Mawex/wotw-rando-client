...
IL2CPP_REGISTER_METHOD(0x02469ED0, Material *, get_material, (app::CameraFilterPack_FX_DigitalMatrix * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0246A860, void, __ctor, (app::CameraFilterPack_FX_DigitalMatrix * this_ptr));
}
