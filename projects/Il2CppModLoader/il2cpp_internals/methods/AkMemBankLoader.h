...
IL2CPP_REGISTER_METHOD(0x026F97D0, IEnumerator *, LoadFile, (app::AkMemBankLoader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x026F9C30, void, __ctor, (app::AkMemBankLoader * this_ptr));
}
