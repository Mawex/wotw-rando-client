...
namespace app::methods::ClearRotation {
    IL2CPP_REGISTER_METHOD(0x01326B20, Quaternion, get_EffectiveRotation, (app::ClearRotation * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x013270D0, void, __ctor, (app::ClearRotation * this_ptr));
} // namespace app::methods::ClearRotation
