...
IL2CPP_REGISTER_METHOD(0x00420EE0, GhostRecorder_GhostPluginRecordingType__Enum, GetRecordingType, (app::GhostServerEventsPlugin * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007E6F50, void, __ctor, (app::GhostServerEventsPlugin * this_ptr));
}
