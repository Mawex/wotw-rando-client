...
namespace app::methods::DemoEndState {
    ...
    IL2CPP_REGISTER_METHOD(0x00B80F20, IState*, GetNextState, (app::DemoEndState * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::DemoEndState * this_ptr));
} // namespace app::methods::DemoEndState
