...
IL2CPP_REGISTER_METHOD(0x004140E0, void, __ctor, (app::AudioListenerExtension * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F25880, AudioListener *, get_audioListener, (app::AudioListenerExtension * this_ptr));
