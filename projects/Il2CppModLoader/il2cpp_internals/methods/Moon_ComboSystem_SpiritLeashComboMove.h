...
namespace app::methods::Moon_ComboSystem::SpiritLeashComboMove {
IL2CPP_REGISTER_METHOD(0x003FC7F0, ComboMoveState__Enum, get_m_comboMoveState, (app::SpiritLeashComboMove * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006FB830, AbilityType__Enum, get_ComboAbilityType, (app::SpiritLeashComboMove * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CC8530, CharacterState *, get_CharacterState, (app::SpiritLeashComboMove * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CC5850, void, __ctor, (app::SpiritLeashComboMove * this_ptr));
}
