...
namespace app::methods::System_Diagnostics_Tracing::EtwSession___c {
IL2CPP_REGISTER_METHOD(0x0174A5D0, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::EtwSession_c * this_ptr));
