...
namespace app::methods::System_Dynamic_Utils::TypeUtils {
IL2CPP_REGISTER_METHOD(0x01F965B0, Type *, GetNonNullableType, (app::Type * type));
IL2CPP_REGISTER_METHOD(0x01F96620, Type *, GetNullableType, (app::Type * type));
...
IL2CPP_REGISTER_METHOD(0x01F98190, MethodInfo_1 *, GetUserDefinedCoercionMethod, (app::Type * convert_from, app::Type * convert_to_type));
IL2CPP_REGISTER_METHOD(0x01F98310, MethodInfo_1 *, FindConversionOperator, (app::MethodInfo_1__Array * methods, app::Type * type_from, app::Type * type_to));
...
IL2CPP_REGISTER_METHOD(0x01F98940, Type *, FindGenericType, (app::Type * definition, app::Type * type));
IL2CPP_REGISTER_METHOD(0x01F98C50, MethodInfo_1 *, GetBooleanOperator, (app::Type * type, app::String * name));
IL2CPP_REGISTER_METHOD(0x01F98E30, Type *, GetNonRefType, (app::Type * type));
...
IL2CPP_REGISTER_METHOD(0x01F995A0, MethodInfo_1 *, GetInvokeMethod, (app::Type * delegate_type));
}
