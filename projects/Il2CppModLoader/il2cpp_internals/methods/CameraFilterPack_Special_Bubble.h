...
IL2CPP_REGISTER_METHOD(0x020E24C0, Material *, get_material, (app::CameraFilterPack_Special_Bubble * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E2E10, void, __ctor, (app::CameraFilterPack_Special_Bubble * this_ptr));
}
