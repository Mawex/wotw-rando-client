...
IL2CPP_REGISTER_METHOD(0x00B99D90, IEnumerable_1_System_String_ *, GetKeywordsForShader, (app::DistortModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B9A210, void, __ctor, (app::DistortModifier * this_ptr));
}
