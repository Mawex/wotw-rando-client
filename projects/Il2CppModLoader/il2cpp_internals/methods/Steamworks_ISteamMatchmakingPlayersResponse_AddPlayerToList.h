...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::ISteamMatchmakingPlayersResponse_AddPlayerToList * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x015FD2E0, IAsyncResult *, BeginInvoke, (app::ISteamMatchmakingPlayersResponse_AddPlayerToList * this_ptr, app::String * pch_name, int32_t n_score, float fl_time_played, app::AsyncCallback * callback, app::Object * object));
