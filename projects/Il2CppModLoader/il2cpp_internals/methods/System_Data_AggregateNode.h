...
namespace app::methods::System_Data::AggregateNode {
IL2CPP_REGISTER_METHOD(0x02148550, void, __ctor_1, (app::AggregateNode * this_ptr, app::DataTable * table, app::FunctionId__Enum aggregate_type, app::String * column_name));
IL2CPP_REGISTER_METHOD(0x02148570, void, __ctor_2, (app::AggregateNode * this_ptr, app::DataTable * table, app::FunctionId__Enum aggregate_type, app::String * column_name, bool local, app::String * relation_name));
...
IL2CPP_REGISTER_METHOD(0x01E34480, Object *, Eval_1, (app::AggregateNode * this_ptr));
IL2CPP_REGISTER_METHOD(0x02148B70, Object *, Eval_2, (app::AggregateNode * this_ptr, app::DataRow * row, app::DataRowVersion__Enum version));
IL2CPP_REGISTER_METHODINFO(0x047027D8, AggregateNode_Eval_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02149180, Object *, Eval_3, (app::AggregateNode * this_ptr, app::Int32__Array * records));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, ExpressionNode *, Optimize, (app::AggregateNode * this_ptr));
}
