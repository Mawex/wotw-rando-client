...
IL2CPP_REGISTER_METHOD(0x01380BD0, List_1_MaterialBasedResourceMapEntry_ *, get_Entries, (app::MaterialBasedResourceMap_MaterialBasedResourceMapRuntimeCache * this_ptr));
IL2CPP_REGISTER_METHOD(0x01380D30, List_1_System_Object_ *, get_Defaults, (app::MaterialBasedResourceMap_MaterialBasedResourceMapRuntimeCache * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MaterialBasedResourceMap_MaterialBasedResourceMapRuntimeCache * this_ptr));
