...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_String_System_UriParser_ {
    IL2CPP_REGISTER_METHOD(0x02259DF0, void, __ctor, (app::Dictionary_2_System_String_System_UriParser_ * this_ptr, int32_t capacity));
