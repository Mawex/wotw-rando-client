...
namespace app::methods::RootMotion_FinalIK::GenericPoser_Map {
IL2CPP_REGISTER_METHOD(0x02064DD0, void, __ctor, (app::GenericPoser_Map * this_ptr, app::Transform * bone, app::Transform * target));
