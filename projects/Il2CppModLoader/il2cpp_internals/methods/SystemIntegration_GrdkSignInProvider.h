...
IL2CPP_REGISTER_METHOD(0x00514DE0, void, __ctor, (app::GrdkSignInProvider * this_ptr, app::INetworkConnectivityChecker * net_connectivity_checker));
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, IPlatformUser *, get_User, (app::GrdkSignInProvider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005150E0, String *, get_LinkToken, (app::GrdkSignInProvider * this_ptr));
