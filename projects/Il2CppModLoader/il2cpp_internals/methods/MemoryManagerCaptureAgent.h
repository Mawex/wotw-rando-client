...
IL2CPP_REGISTER_METHOD(0x009D8D50, String__Array *, GetDataHeaderNames, (app::MemoryManagerCaptureAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009D91F0, String__Array *, GetFrameData_1, (app::MemoryManagerCaptureAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MemoryManagerCaptureAgent * this_ptr));
}
