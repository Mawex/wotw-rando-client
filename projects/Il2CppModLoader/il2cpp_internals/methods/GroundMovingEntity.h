...
IL2CPP_REGISTER_METHOD(0x00864A60, GroundEntityLocomotion *, get_GroundLocomotion, (app::GroundMovingEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01098310, void, __ctor, (app::GroundMovingEntity * this_ptr));
}
