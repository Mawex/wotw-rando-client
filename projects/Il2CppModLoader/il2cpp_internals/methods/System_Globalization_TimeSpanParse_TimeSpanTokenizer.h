...
namespace app::methods::System_Globalization::TimeSpanParse_TimeSpanTokenizer {
...
IL2CPP_REGISTER_METHOD(0x001D45B0, TimeSpanParse_TimeSpanToken, GetNextToken, (app::TimeSpanParse_TimeSpanTokenizer__Boxed * this_ptr));
