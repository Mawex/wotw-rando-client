...
namespace app::methods::RockyEnemy {
    IL2CPP_REGISTER_METHOD(0x0135B560, Vector2, get_ThrownDirection, (app::RockyEnemy * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01360030, void, __ctor, (app::RockyEnemy * this_ptr));
