...
IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::GenericDamageTrigger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB80, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::GenericDamageTrigger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E070B0, IUberState__Array *, get_AffectingUberStates, (app::GenericDamageTrigger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBC0, IDamageReciever__Array *, get_AffectedReceivers, (app::GenericDamageTrigger * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E074E0, void, __ctor, (app::GenericDamageTrigger * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::GenericDamageTrigger * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::GenericDamageTrigger * this_ptr));
}
