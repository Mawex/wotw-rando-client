...
namespace app::methods::System_Data_Common::StringStorage {
IL2CPP_REGISTER_METHOD(0x02863480, void, __ctor, (app::StringStorage * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x028635A0, Object *, Aggregate, (app::StringStorage * this_ptr, app::Int32__Array * record_nos, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x02863B20, Object *, ConvertValue, (app::StringStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x0216B500, void, Copy, (app::StringStorage * this_ptr, int32_t record_no1, int32_t record_no2));
IL2CPP_REGISTER_METHOD(0x0216B5A0, Object *, Get, (app::StringStorage * this_ptr, int32_t record_no));
...
IL2CPP_REGISTER_METHOD(0x00502220, Object *, ConvertXmlToObject, (app::StringStorage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x02863D80, String *, ConvertObjectToXml, (app::StringStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02863E20, Object *, GetEmptyStorage, (app::StringStorage * this_ptr, int32_t record_count));
