...
IL2CPP_REGISTER_METHOD(0x010AC8E0, Quaternion, HeadAnimatedRotation, (app::TentacleAnimationPostprocess * this_ptr));
IL2CPP_REGISTER_METHOD(0x010ACB70, Vector3, HeadAnimatedDirection, (app::TentacleAnimationPostprocess * this_ptr));
IL2CPP_REGISTER_METHOD(0x008A2C20, void, __ctor, (app::TentacleAnimationPostprocess * this_ptr));
IL2CPP_REGISTER_METHOD(0x010ACBF0, void, __cctor, ());
}
