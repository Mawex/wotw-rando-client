...
IL2CPP_REGISTER_METHOD(0x014A4850, HPerfTestResult *, Aggregate, (HierarchyTestResultAggregator * __this, HPerfTestResult__Array * objectSamples));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (HierarchyTestResultAggregator * __this));
}
