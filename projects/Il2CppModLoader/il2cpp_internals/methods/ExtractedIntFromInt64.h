...
IL2CPP_REGISTER_METHOD(0x00988420, void, __ctor, (app::ExtractedIntFromInt64 * this_ptr, int32_t bits));
...
IL2CPP_REGISTER_METHOD(0x00988520, void, Encode, (app::ExtractedIntFromInt64 * this_ptr, app::int32_t * data));
IL2CPP_REGISTER_METHOD(0x00988540, void, Decode, (app::ExtractedIntFromInt64 * this_ptr, app::int32_t * data));
