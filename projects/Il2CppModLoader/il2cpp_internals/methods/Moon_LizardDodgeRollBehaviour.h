...
IL2CPP_REGISTER_METHOD(0x00420230, BehaviourStatus__Enum, OnExecute, (app::LizardDodgeRollBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x011045F0, void, OnExit, (app::LizardDodgeRollBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00B68B50, Vector3, RootMotionRollBackModifier, (app::LizardDodgeRollBehaviour * this_ptr, app::Vector3 motion));
...
IL2CPP_REGISTER_METHOD(0x01104680, void, __ctor, (app::LizardDodgeRollBehaviour * this_ptr));
}
