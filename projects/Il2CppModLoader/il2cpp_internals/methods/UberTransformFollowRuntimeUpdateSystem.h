...
IL2CPP_REGISTER_METHOD(0x00420EE0, UpdateType__Enum, get_UpdateType, (app::UberTransformFollowRuntimeUpdateSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::UberTransformFollowRuntimeUpdateSystem * this_ptr));
}
