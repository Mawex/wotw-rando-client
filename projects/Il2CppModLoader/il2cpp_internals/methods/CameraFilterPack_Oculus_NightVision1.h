...
IL2CPP_REGISTER_METHOD(0x024841F0, Material *, get_material, (app::CameraFilterPack_Oculus_NightVision1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024849C0, void, __ctor, (app::CameraFilterPack_Oculus_NightVision1 * this_ptr));
}
