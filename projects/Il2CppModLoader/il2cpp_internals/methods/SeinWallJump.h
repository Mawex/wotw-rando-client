...
namespace app::methods::SeinWallJump {
    ...
    IL2CPP_REGISTER_METHOD(0x005D06C0, CharacterPlatformMovement*, get_PlatformMovement, (app::SeinWallJump * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A7EB40, SeinDoubleJump*, get_DoubleJump, (app::SeinWallJump * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005D06F0, CharacterLeftRightMovement*, get_LeftRightMovement, (app::SeinWallJump * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005D0720, CharacterSpriteMirror*, get_CharacterSpriteMirror, (app::SeinWallJump * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00AAB500, SeinWallJumpPuppet*, get_Puppet, (app::SeinWallJump * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00AADF90, IEnumerator*, HandleChangeDirectionWhileJumpingInwards, (app::SeinWallJump * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00AAE0E0, bool, IsRunningChangeDirectionWhileJumpingCouroutine, (app::SeinWallJump * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00AAE0F0, IEnumerator*, RoutineToReenableAirDeceleration, (app::SeinWallJump * this_ptr, float delay));
    ...
    IL2CPP_REGISTER_METHOD(0x00AAE310, Func_1_Boolean_*, ShouldKeepPlayingWallJumpTowardsAnimation, (app::SeinWallJump * this_ptr, bool to_left));
    IL2CPP_REGISTER_METHOD(0x00AAE530, Func_1_Boolean_*, ShouldKeepPlayingWallJumpAwayAnimation, (app::SeinWallJump * this_ptr, bool to_left));
    IL2CPP_REGISTER_METHOD(0x00AAE750, Func_1_Boolean_*, ShouldKeepPlayingWallJumpRegularAnimation, (app::SeinWallJump * this_ptr, bool to_left));
    ...
    IL2CPP_REGISTER_METHOD(0x00AB0310, void, __ctor, (app::SeinWallJump * this_ptr));
