...
IL2CPP_REGISTER_METHOD(0x01F2AB40, String *, get_text, (app::GUIContent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01704A60, String *, get_tooltip, (app::GUIContent * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB960, void, set_tooltip, (app::GUIContent * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x029E2C20, GUIContent *, Temp_1, (app::String * t));
IL2CPP_REGISTER_METHOD(0x029E2D20, GUIContent *, Temp_2, (app::Texture * i));
