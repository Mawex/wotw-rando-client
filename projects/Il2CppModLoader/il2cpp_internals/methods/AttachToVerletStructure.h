...
IL2CPP_REGISTER_METHOD(0x008519C0, SuspendableMask__Enum, ISuspendable_get_Mask, (app::AttachToVerletStructure * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00852930, void, __ctor, (app::AttachToVerletStructure * this_ptr));
}
