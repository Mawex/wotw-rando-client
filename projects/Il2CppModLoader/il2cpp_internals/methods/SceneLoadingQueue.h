...
IL2CPP_REGISTER_METHOD(0x00BA7400, SceneLoadingQueue_QueueSceneToLoad, get_Item, (app::SceneLoadingQueue * this_ptr, int32_t i));
...
IL2CPP_REGISTER_METHOD(0x00BA79D0, SceneLoadingQueue_QueueSceneToLoad, GetTopScene, (app::SceneLoadingQueue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00BA83F0, void, __ctor, (app::SceneLoadingQueue * this_ptr));
