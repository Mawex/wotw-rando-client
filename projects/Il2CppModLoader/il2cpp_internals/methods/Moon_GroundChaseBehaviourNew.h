...
IL2CPP_REGISTER_METHOD(0x0148C6A0, Vector3, get_m_targetPos, (app::GroundChaseBehaviourNew * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0148CDA0, BehaviourStatus__Enum, OnExecute, (app::GroundChaseBehaviourNew * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0148D410, void, __ctor, (app::GroundChaseBehaviourNew * this_ptr));
}
