...
IL2CPP_REGISTER_METHOD(0x023B4B80, void, __ctor_2, (app::RegistryKey * this_ptr, app::RegistryHive__Enum hive_id, app::void * key_handle, bool remote_root));
...
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_Name, (app::RegistryKey * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x023B52A0, SafeRegistryHandle *, get_Handle, (app::RegistryKey * this_ptr));
IL2CPP_REGISTER_METHOD(0x023B54C0, RegistryKey *, OpenSubKey_1, (app::RegistryKey * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x023B54D0, RegistryKey *, OpenSubKey_2, (app::RegistryKey * this_ptr, app::String * name, bool writable));
IL2CPP_REGISTER_METHODINFO(0x047793F0, RegistryKey_OpenSubKey_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x023B5700, Object *, GetValue_1, (app::RegistryKey * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x023B5860, Object *, GetValue_2, (app::RegistryKey * this_ptr, app::String * name, app::Object * default_value));
IL2CPP_REGISTER_METHOD(0x023B59D0, String__Array *, GetSubKeyNames, (app::RegistryKey * this_ptr));
IL2CPP_REGISTER_METHOD(0x023B5B10, String *, ToString, (app::RegistryKey * this_ptr));
IL2CPP_REGISTER_METHOD(0x01D60150, bool, get_IsRoot, (app::RegistryKey * this_ptr));
IL2CPP_REGISTER_METHOD(0x023B5C50, RegistryHive__Enum, get_Hive, (app::RegistryKey * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0474EA28, RegistryKey_get_Hive__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FB930, Object *, get_InternalHandle, (app::RegistryKey * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x023B5E90, String *, DecodeString, (app::Byte__Array * data));
...
IL2CPP_REGISTER_METHOD(0x023B5FF0, String *, GetHiveName, (app::RegistryHive__Enum hive));
