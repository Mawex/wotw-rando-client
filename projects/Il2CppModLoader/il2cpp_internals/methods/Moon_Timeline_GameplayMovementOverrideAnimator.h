...
namespace app::methods::Moon_Timeline::GameplayMovementOverrideAnimator {
...
IL2CPP_REGISTER_METHOD(0x00417920, UpdateCategory__Enum, get_UpdateCategory, (app::GameplayMovementOverrideAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x0076D1A0, CharacterGravity *, get_Gravity, (app::GameplayMovementOverrideAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x0076D2D0, CharacterLeftRightMovement *, get_LeftRightMovement, (app::GameplayMovementOverrideAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x0076D400, AnimationSwapSet *, get_CurrentSet, (app::GameplayMovementOverrideAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0076E630, void, __ctor, (app::GameplayMovementOverrideAnimator * this_ptr));
}
