...
IL2CPP_REGISTER_METHOD(0x005065F0, SuspendableMask__Enum, get_Mask, (app::CollectablePlaceholder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00BFB3D0, IUberState__Array *, get_AffectingUberStates, (app::CollectablePlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::CollectablePlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x012CDD20, void, __ctor, (app::CollectablePlaceholder * this_ptr));
