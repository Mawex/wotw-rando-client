...
IL2CPP_REGISTER_METHOD(0x020C5B20, Func_1_System_Security_Claims_ClaimsPrincipal_ *, get_ClaimsPrincipalSelector, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x020C74B0, void, __cctor, (MethodInfo * method));
}
