...
namespace app::methods::GardenerItem {
    IL2CPP_REGISTER_METHOD(0x004173F0, MessageProvider*, get_ItemName, (app::GardenerItem * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00417410, MessageProvider*, get_ItemDescription, (app::GardenerItem * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00417550, MessageProvider*, get_ItemNextLevelDescription, (app::GardenerItem * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00417880, Texture2D*, get_ItemIcon, (app::GardenerItem * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::GardenerItem * this_ptr));
} // namespace app::methods::GardenerItem
