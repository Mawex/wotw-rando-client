...
IL2CPP_REGISTER_METHOD(0x002FBB80, ConfigurableJoint *, get_GeneratedConfigurableJoint, (app::AttachToPhysicsSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0084F6D0, void, __ctor, (app::AttachToPhysicsSystem * this_ptr));
}
