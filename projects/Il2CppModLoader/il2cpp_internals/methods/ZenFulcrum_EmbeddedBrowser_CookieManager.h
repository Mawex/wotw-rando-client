...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::CookieManager {
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::CookieManager * this_ptr, app::Browser * browser));
IL2CPP_REGISTER_METHOD(0x01DD0FF0, IPromise_1_System_Collections_Generic_List_1_ *, GetCookies, (app::CookieManager * this_ptr));
