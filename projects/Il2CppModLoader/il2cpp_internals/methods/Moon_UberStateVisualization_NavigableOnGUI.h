...
namespace app::methods::Moon_UberStateVisualization::NavigableOnGUI {
IL2CPP_REGISTER_METHOD(0x01B73260, bool, get_isSelected, (app::NavigableOnGUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B73280, void, __ctor, (app::NavigableOnGUI * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01B74A70, NavigableOnGUI_Field, GetField, (app::NavigableOnGUI * this_ptr, app::String * label));
