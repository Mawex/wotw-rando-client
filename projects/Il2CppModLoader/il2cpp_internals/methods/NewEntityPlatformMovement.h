...
IL2CPP_REGISTER_METHOD(0x005FB0D0, Vector2, GetKickback, (app::NewEntityPlatformMovement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005FB7F0, Vector2, GetAirSuspension, (app::NewEntityPlatformMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x005FB9A0, void, UpdateHeadAndFeetAgainstTheWall, (app::NewEntityPlatformMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x005FBD40, void, __ctor, (app::NewEntityPlatformMovement * this_ptr));
}
