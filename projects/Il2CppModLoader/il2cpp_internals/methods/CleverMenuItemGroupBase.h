...
IL2CPP_REGISTER_METHOD(0x003FC830, SuspendableMask__Enum, get_Mask, (app::CleverMenuItemGroupBase * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012B37C0, void, __ctor, (app::CleverMenuItemGroupBase * this_ptr));
}
