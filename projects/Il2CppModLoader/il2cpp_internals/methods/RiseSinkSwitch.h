...
IL2CPP_REGISTER_METHOD(0x006DC050, SuspendableMask__Enum, get_Mask, (app::RiseSinkSwitch * this_ptr));
IL2CPP_REGISTER_METHOD(0x013565C0, void, set_Mask, (app::RiseSinkSwitch * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x01356670, void, __ctor, (app::RiseSinkSwitch * this_ptr));
}
