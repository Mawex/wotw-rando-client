...
namespace app::methods::System_Collections_Generic::ObjectEqualityComparer {
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::ObjectEqualityComparer * this_ptr));
