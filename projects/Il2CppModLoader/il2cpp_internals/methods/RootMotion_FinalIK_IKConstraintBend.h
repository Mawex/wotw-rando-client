...
namespace app::methods::RootMotion_FinalIK::IKConstraintBend {
...
IL2CPP_REGISTER_METHOD(0x02077FC0, void, __ctor_1, (app::IKConstraintBend * this_ptr));
IL2CPP_REGISTER_METHOD(0x02078080, void, __ctor_2, (app::IKConstraintBend * this_ptr, app::Transform * bone1, app::Transform * bone2, app::Transform * bone3));
...
IL2CPP_REGISTER_METHOD(0x02079B60, Vector3, GetDir, (app::IKConstraintBend * this_ptr, app::IKSolverFullBody * solver));
IL2CPP_REGISTER_METHOD(0x0207A6E0, Vector3, OrthoToLimb, (app::IKConstraintBend * this_ptr, app::IKSolverFullBody * solver, app::Vector3 tangent));
IL2CPP_REGISTER_METHOD(0x0207A880, Vector3, OrthoToBone1, (app::IKConstraintBend * this_ptr, app::IKSolverFullBody * solver, app::Vector3 tangent));
}
