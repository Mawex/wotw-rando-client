...
IL2CPP_REGISTER_METHOD(0x00EEEE30, ListenerSoundZoneTaskData, InitializeListenerZoneTask, (app::SoundZoneProcessor * this_ptr, app::ListenerSoundZoneTaskData data, app::AudioListenerZone * zone));
IL2CPP_REGISTER_METHOD(0x00EEF180, EmitterSoundZoneTaskData, InitializeEmitterZoneTask, (app::SoundZoneProcessor * this_ptr, app::EmitterSoundZoneTaskData data, app::AudioEmitterZone * zone));
...
IL2CPP_REGISTER_METHOD(0x00EEFB40, void, __ctor, (app::SoundZoneProcessor * this_ptr));
