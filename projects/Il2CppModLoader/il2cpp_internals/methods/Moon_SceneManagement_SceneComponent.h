...
namespace app::methods::Moon_SceneManagement::SceneComponent {
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Path, (app::SceneComponent * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_Path, (app::SceneComponent * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_Group, (app::SceneComponent * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB960, void, set_Group, (app::SceneComponent * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, get_Name, (app::SceneComponent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004140E0, void, __ctor, (app::SceneComponent * this_ptr));
}
