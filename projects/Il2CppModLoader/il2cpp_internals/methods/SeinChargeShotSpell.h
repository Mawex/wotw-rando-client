...
IL2CPP_REGISTER_METHOD(0x005D06C0, CharacterPlatformMovement *, get_PlatformMovement, (app::SeinChargeShotSpell * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A56A30, bool, TestScatterShotShard, (app::SeinChargeShotSpell * this_ptr, app::int32_t * count, app::float * interval, app::bool * split_damage));
...
IL2CPP_REGISTER_METHOD(0x00A57850, void, __ctor, (app::SeinChargeShotSpell * this_ptr));
}
