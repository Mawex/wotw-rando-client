...
IL2CPP_REGISTER_METHOD(0x01BAB930, Transform *, get_EffectiveTranform, (app::PositionLerpTweenAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BAC290, void, __ctor, (app::PositionLerpTweenAnimator * this_ptr));
}
