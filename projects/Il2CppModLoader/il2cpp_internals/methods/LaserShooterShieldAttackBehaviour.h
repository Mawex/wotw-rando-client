...
IL2CPP_REGISTER_METHOD(0x00F21220, BehaviourStatus__Enum, OnExecute, (app::LaserShooterShieldAttackBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00F21C60, void, __ctor, (app::LaserShooterShieldAttackBehaviour * this_ptr));
}
