...
IL2CPP_REGISTER_METHOD(0x019E9910, int32_t, GetRequestID, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x019EB2A0, void, ResetStatics, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x019EB4A0, GenericCastManager_1_UnityEngine_CapsulecastCommand_ *, get_Instance, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x019EE1E0, void, __cctor, (MethodInfo * method));
}
