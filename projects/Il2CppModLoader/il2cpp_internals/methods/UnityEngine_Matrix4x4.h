...
IL2CPP_REGISTER_METHOD(0x001F28F0, void, __ctor, (app::Matrix4x4__Boxed * this_ptr, app::Vector4 column0, app::Vector4 column1, app::Vector4 column2, app::Vector4 column3));
IL2CPP_REGISTER_METHOD(0x001F29A0, Quaternion, GetRotation, (app::Matrix4x4__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001F29D0, float, GetDeterminant, (app::Matrix4x4__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001F29A0, Quaternion, get_rotation, (app::Matrix4x4__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001F29E0, float, get_determinant, (app::Matrix4x4__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x02536A60, Matrix4x4, TRS, (app::Vector3 pos, app::Quaternion q, app::Vector3 s));
...
IL2CPP_REGISTER_METHOD(0x02536DE0, Matrix4x4, Inverse, (app::Matrix4x4 m));
IL2CPP_REGISTER_METHOD(0x001F2A40, Matrix4x4, get_inverse, (app::Matrix4x4__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x02537060, Matrix4x4, Ortho, (float left, float right, float bottom, float top, float z_near, float z_far));
IL2CPP_REGISTER_METHOD(0x02537200, Matrix4x4, Perspective, (float fov, float aspect, float z_near, float z_far));
...
IL2CPP_REGISTER_METHOD(0x02537C80, Matrix4x4, operator___1, (app::Matrix4x4 lhs, app::Matrix4x4 rhs));
IL2CPP_REGISTER_METHOD(0x02538150, Vector4, operator___2, (app::Matrix4x4 lhs, app::Vector4 vector));
IL2CPP_REGISTER_METHOD(0x02538270, bool, operator____1, (app::Matrix4x4 lhs, app::Matrix4x4 rhs));
IL2CPP_REGISTER_METHOD(0x025384B0, bool, operator____2, (app::Matrix4x4 lhs, app::Matrix4x4 rhs));
IL2CPP_REGISTER_METHOD(0x001F2B10, Vector4, GetColumn, (app::Matrix4x4__Boxed * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x001F2C20, Vector3, MultiplyPoint, (app::Matrix4x4__Boxed * this_ptr, app::Vector3 point));
IL2CPP_REGISTER_METHOD(0x001F2D20, Vector3, MultiplyPoint3x4, (app::Matrix4x4__Boxed * this_ptr, app::Vector3 point));
IL2CPP_REGISTER_METHOD(0x001F2DE0, Vector3, MultiplyVector, (app::Matrix4x4__Boxed * this_ptr, app::Vector3 vector));
IL2CPP_REGISTER_METHOD(0x02538790, Matrix4x4, Scale, (app::Vector3 vector));
IL2CPP_REGISTER_METHOD(0x02538840, Matrix4x4, Translate, (app::Vector3 vector));
IL2CPP_REGISTER_METHOD(0x025388E0, Matrix4x4, get_zero, ());
IL2CPP_REGISTER_METHOD(0x025389B0, Matrix4x4, get_identity, ());
IL2CPP_REGISTER_METHOD(0x001F2E90, String *, ToString, (app::Matrix4x4__Boxed * this_ptr));
