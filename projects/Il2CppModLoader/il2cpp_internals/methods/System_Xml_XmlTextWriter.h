...
namespace app::methods::System_Xml::XmlTextWriter {
IL2CPP_REGISTER_METHOD(0x01FBCAE0, void, __ctor_1, (app::XmlTextWriter * this_ptr));
IL2CPP_REGISTER_METHOD(0x01FBCC40, void, __ctor_2, (app::XmlTextWriter * this_ptr, app::Stream * w, app::Encoding * encoding));
IL2CPP_REGISTER_METHOD(0x01FBCF70, void, __ctor_3, (app::XmlTextWriter * this_ptr, app::String * filename, app::Encoding * encoding));
IL2CPP_REGISTER_METHOD(0x01FBD100, void, __ctor_4, (app::XmlTextWriter * this_ptr, app::TextWriter * w));
IL2CPP_REGISTER_METHOD(0x01FBD2A0, Stream *, get_BaseStream, (app::XmlTextWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01FBFBD0, WriteState__Enum, get_WriteState, (app::XmlTextWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01FBFDC0, String *, LookupPrefix, (app::XmlTextWriter * this_ptr, app::String * ns));
...
IL2CPP_REGISTER_METHOD(0x01FC1ED0, String *, GeneratePrefix, (app::XmlTextWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01FC2540, String *, FindPrefix, (app::XmlTextWriter * this_ptr, app::String * ns));
