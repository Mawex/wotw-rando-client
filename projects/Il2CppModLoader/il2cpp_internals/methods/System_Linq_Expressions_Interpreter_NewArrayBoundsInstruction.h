...
namespace app::methods::System_Linq_Expressions_Interpreter::NewArrayBoundsInstruction {
IL2CPP_REGISTER_METHOD(0x00CC8D50, void, __ctor, (app::NewArrayBoundsInstruction * this_ptr, app::Type * element_type, int32_t rank));
...
IL2CPP_REGISTER_METHOD(0x02401850, String *, get_InstructionName, (app::NewArrayBoundsInstruction * this_ptr));
