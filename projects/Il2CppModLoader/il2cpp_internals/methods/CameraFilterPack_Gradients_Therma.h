...
IL2CPP_REGISTER_METHOD(0x0247DD40, Material *, get_material, (app::CameraFilterPack_Gradients_Therma * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0247E360, void, __ctor, (app::CameraFilterPack_Gradients_Therma * this_ptr));
}
