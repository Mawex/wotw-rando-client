...
IL2CPP_REGISTER_METHOD(0x00984A10, IEnumerator *, StartExceptionsTest, (app::GameObject * go));
...
IL2CPP_REGISTER_METHOD(0x00985B00, RuntimeSceneMetaData *, GetMetaData, (app::ExceptionsTest * this_ptr, int32_t meta_data_index));
...
IL2CPP_REGISTER_METHOD(0x00985F50, void, __ctor, (app::ExceptionsTest * this_ptr));
}
