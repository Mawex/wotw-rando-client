...
namespace app::methods::Moon_Timeline::PositionTweenAnimator {
IL2CPP_REGISTER_METHOD(0x01E7AF70, Transform *, get_TransformTarget, (app::PositionTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E7B090, GameObject *, get_ExternalTarget, (app::PositionTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E7B120, Transform *, get_EffectiveTransform, (app::PositionTweenAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC20, MoonReference_1_UnityEngine_GameObject_ *, GetGameObjectTarget, (app::PositionTweenAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E7C310, GameObject *, GetDynamicGraphicTarget, (app::PositionTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E7C3E0, bool, ApproximateEvent, (app::PositionTweenAnimator * this_ptr, int32_t evt, app::float * time));
IL2CPP_REGISTER_METHOD(0x01E7C630, void, __ctor, (app::PositionTweenAnimator * this_ptr));
}
