...
IL2CPP_REGISTER_METHOD(0x0110E760, BehaviourStatus__Enum, OnExecute, (app::MapMakerGiveMapBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x0110E7B0, void, OnExit, (app::MapMakerGiveMapBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x0060C1C0, void, __ctor, (app::MapMakerGiveMapBehaviour * this_ptr));
}
