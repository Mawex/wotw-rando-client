...
namespace app::methods::System_Reflection_Emit::FieldBuilder {
IL2CPP_REGISTER_METHOD(0x02680210, FieldAttributes__Enum, get_Attributes, (app::FieldBuilder * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047217D8, FieldBuilder_get_Attributes__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02680260, Type *, get_DeclaringType, (app::FieldBuilder * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047277D8, FieldBuilder_get_DeclaringType__MethodInfo);
IL2CPP_REGISTER_METHOD(0x026802B0, Type *, get_FieldType, (app::FieldBuilder * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04700D40, FieldBuilder_get_FieldType__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02680300, String *, get_Name, (app::FieldBuilder * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04777698, FieldBuilder_get_Name__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02680350, Object *, GetValue, (app::FieldBuilder * this_ptr, app::Object * obj));
IL2CPP_REGISTER_METHODINFO(0x04756A78, FieldBuilder_GetValue__MethodInfo);
IL2CPP_REGISTER_METHOD(0x026803A0, RuntimeFieldHandle, get_FieldHandle, (app::FieldBuilder * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0474AD48, FieldBuilder_get_FieldHandle__MethodInfo);
IL2CPP_REGISTER_METHOD(0x026803D0, Type *, get_ReflectedType, (app::FieldBuilder * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0474DD78, FieldBuilder_get_ReflectedType__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02680400, Object__Array *, GetCustomAttributes_1, (app::FieldBuilder * this_ptr, bool inherit));
IL2CPP_REGISTER_METHODINFO(0x0476A2A0, FieldBuilder_GetCustomAttributes__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02680430, Object__Array *, GetCustomAttributes_2, (app::FieldBuilder * this_ptr, app::Type * attribute_type, bool inherit));
