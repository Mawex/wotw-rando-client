...
IL2CPP_REGISTER_METHOD(0x004C6660, SuspendableMask__Enum, get_Mask, (app::ValleyOfTheWindKuroGameplayController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x013B8FD0, void, __ctor, (app::ValleyOfTheWindKuroGameplayController * this_ptr));
}
