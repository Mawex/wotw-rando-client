...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::IVROverlay_SetKeyboardTransformAbsolute * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02D7E780, IAsyncResult *, BeginInvoke, (app::IVROverlay_SetKeyboardTransformAbsolute * this_ptr, app::ETrackingUniverseOrigin__Enum e_tracking_origin, app::HmdMatrix34_t * pmat_tracking_origin_to_keyboard_transform, app::AsyncCallback * callback, app::Object * object));
