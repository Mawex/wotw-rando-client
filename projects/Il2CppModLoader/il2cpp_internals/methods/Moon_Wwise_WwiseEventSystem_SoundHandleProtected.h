...
namespace app::methods::Moon_Wwise::WwiseEventSystem_SoundHandleProtected {
...
IL2CPP_REGISTER_METHOD(0x002FB9F0, WwiseEventSystem_EventState *, get_State, (app::WwiseEventSystem_SoundHandleProtected * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02714F60, void, __ctor, (app::WwiseEventSystem_SoundHandleProtected * this_ptr));
