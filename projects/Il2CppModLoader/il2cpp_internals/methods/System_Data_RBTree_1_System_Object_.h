...
namespace app::methods::System_Data::RBTree_1_System_Object_ {
...
IL2CPP_REGISTER_METHOD(0x02FB3CE0, Object *, get_Item, (app::RBTree_1_System_Object_ * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x02FAF680, void, __ctor, (app::RBTree_1_System_Object_ * this_ptr, app::TreeAccessMethod__Enum access_method));
...
IL2CPP_REGISTER_METHOD(0x02FB5B70, RBTree_1_K_TreePage_System_Object_ *, AllocPage, (app::RBTree_1_System_Object_ * this_ptr, int32_t size));
...
IL2CPP_REGISTER_METHOD(0x02FB67D0, bool, Successor_2, (app::RBTree_1_System_Object_ * this_ptr, app::int32_t * node_id, app::int32_t * main_tree_node_id));
...
IL2CPP_REGISTER_METHOD(0x02FB8300, Object *, DeleteByIndex, (app::RBTree_1_System_Object_ * this_ptr, int32_t i));
...
IL2CPP_REGISTER_METHOD(0x02FB9B00, RBTree_1_K_NodePath_System_Object_, GetNodeByKey, (app::RBTree_1_System_Object_ * this_ptr, app::Object * key));
...
IL2CPP_REGISTER_METHOD(0x02FB9D30, RBTree_1_K_NodePath_System_Object_, GetNodeByIndex, (app::RBTree_1_System_Object_ * this_ptr, int32_t user_index));
IL2CPP_REGISTER_METHODINFO(0x04737878, RBTree_1_System_Object__GetNodeByIndex__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02FB44A0, int32_t, ComputeNodeByIndex_1, (app::RBTree_1_System_Object_ * this_ptr, int32_t index, app::int32_t * satellite_root_id));
...
IL2CPP_REGISTER_METHOD(0x02FB9E60, IEnumerator *, GetEnumerator, (app::RBTree_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02FBAC20, RBTree_1_K_NodeColor_System_Object_ *, color, (app::RBTree_1_System_Object_ * this_ptr, int32_t node_id));
...
IL2CPP_REGISTER_METHOD(0x02FBADA0, Object *, Key, (app::RBTree_1_System_Object_ * this_ptr, int32_t node_id));
}
