...
IL2CPP_REGISTER_METHOD(0x01526DD0, PoleSetupData *, get_ReleasedState, (app::PoleSetupHolder * this_ptr));
IL2CPP_REGISTER_METHOD(0x01526E70, PoleSetupData *, get_PulledState, (app::PoleSetupHolder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01527320, void, __ctor, (app::PoleSetupHolder * this_ptr));
}
