...
namespace app::methods::System_Threading_Tasks::TaskCompletionSource_1_System_Boolean_ {
IL2CPP_REGISTER_METHOD(0x02776BF0, void, __ctor_1, (app::TaskCompletionSource_1_System_Boolean_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA280, Task_1_System_Boolean_ *, get_Task, (app::TaskCompletionSource_1_System_Boolean_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02776D20, void, __ctor_2, (app::TaskCompletionSource_1_System_Boolean_ * this_ptr, app::Object * state));
IL2CPP_REGISTER_METHOD(0x02776D50, void, __ctor_3, (app::TaskCompletionSource_1_System_Boolean_ * this_ptr, app::Object * state, app::TaskCreationOptions__Enum creation_options));
