...
IL2CPP_REGISTER_METHOD(0x008ADB50, AtlasSpriteTexture *, get_NaruCurrentTexture, (app::SeinNaruComboAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008AE5F0, Atlas *, get_SettingsAtlas, (app::SeinNaruComboAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x008AE6F0, UberScreenMode__Enum, GetExternalUberScreenMode, (app::SeinNaruComboAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008AE940, void, __ctor, (app::SeinNaruComboAnimator * this_ptr));
}
