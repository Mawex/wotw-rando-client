...
namespace app::methods::RootMotion_FinalIK::IKSolverFABRIK {
...
IL2CPP_REGISTER_METHOD(0x02BEB9B0, Vector3, GetIKPosition, (app::IKSolverFABRIK * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BEC4E0, Vector3, SolveJoint, (app::IKSolverFABRIK * this_ptr, app::Vector3 pos1, app::Vector3 pos2, float length));
...
IL2CPP_REGISTER_METHOD(0x02BEDFE0, Quaternion, GetParentSolverRotation, (app::IKSolverFABRIK * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x02BEE2C0, Vector3, GetParentSolverPosition, (app::IKSolverFABRIK * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x02BEE5C0, Quaternion, GetLimitedRotation, (app::IKSolverFABRIK * this_ptr, int32_t index, app::Quaternion q, app::bool * changed));
...
IL2CPP_REGISTER_METHOD(0x02BF02A0, void, __ctor, (app::IKSolverFABRIK * this_ptr));
}
