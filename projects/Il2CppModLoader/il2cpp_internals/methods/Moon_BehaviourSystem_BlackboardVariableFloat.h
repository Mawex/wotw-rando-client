...
namespace app::methods::Moon_BehaviourSystem::BlackboardVariableFloat {
IL2CPP_REGISTER_METHOD(0x002FB9B0, IMoonType_1_System_Single_ *, GetMoonType, (app::BlackboardVariableFloat * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03009DB0, void, __ctor, (app::BlackboardVariableFloat * this_ptr));
}
