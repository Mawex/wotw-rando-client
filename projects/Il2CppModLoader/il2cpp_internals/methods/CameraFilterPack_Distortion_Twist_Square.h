...
IL2CPP_REGISTER_METHOD(0x024EC460, Material *, get_material, (app::CameraFilterPack_Distortion_Twist_Square * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024ECCC0, void, __ctor, (app::CameraFilterPack_Distortion_Twist_Square * this_ptr));
}
