...
namespace app::methods::Moon_Telemetry_Performance::ProfilingSettings_Setting {
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::ProfilingSettings_Setting * this_ptr));
}
