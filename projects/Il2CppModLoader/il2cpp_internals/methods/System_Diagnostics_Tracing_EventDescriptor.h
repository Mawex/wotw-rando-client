...
namespace app::methods::System_Diagnostics_Tracing::EventDescriptor {
IL2CPP_REGISTER_METHOD(0x0013DFE0, void, __ctor_1, (app::EventDescriptor__Boxed * this_ptr, int32_t tracelogging_id, uint8_t level, uint8_t opcode, int64_t keywords));
IL2CPP_REGISTER_METHOD(0x0013E010, void, __ctor_2, (app::EventDescriptor__Boxed * this_ptr, int32_t id, uint8_t version, uint8_t channel, uint8_t level, uint8_t opcode, int32_t task, int64_t keywords));
