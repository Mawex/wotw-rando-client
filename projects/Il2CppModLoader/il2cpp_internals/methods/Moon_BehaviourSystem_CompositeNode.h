...
namespace app::methods::Moon_BehaviourSystem::CompositeNode {
...
IL2CPP_REGISTER_METHOD(0x002FBC40, List_1_Moon_BehaviourSystem_BehaviourNode_ *, get_Children, (app::CompositeNode * this_ptr));
IL2CPP_REGISTER_METHOD(0x0300AA90, void, AddChild, (app::CompositeNode * this_ptr, int32_t index, app::BehaviourNode * node));
IL2CPP_REGISTER_METHOD(0x0300AB40, BehaviourStatus__Enum, Execute, (app::CompositeNode * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0300AF80, void, __ctor, (app::CompositeNode * this_ptr));
}
