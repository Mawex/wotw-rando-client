...
IL2CPP_REGISTER_METHOD(0x015113F0, fsMetaType *, Get, (app::fsConfig * config, app::Type * type));
IL2CPP_REGISTER_METHOD(0x01511900, void, ClearCache, ());
IL2CPP_REGISTER_METHOD(0x01511B80, void, __ctor, (app::fsMetaType * this_ptr, app::fsConfig * config, app::Type * reflected_type));
...
IL2CPP_REGISTER_METHOD(0x002FB930, fsMetaProperty__Array *, get_Properties, (app::fsMetaType * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x015139A0, Object *, CreateInstance, (app::fsMetaType * this_ptr));
