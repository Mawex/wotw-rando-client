...
IL2CPP_REGISTER_METHOD(0x0043D9A0, SelectableCategory__Enum, get_Category, (app::ForceGrabReleaseZone * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::ForceGrabReleaseZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x01280A00, void, __cctor, ());
}
