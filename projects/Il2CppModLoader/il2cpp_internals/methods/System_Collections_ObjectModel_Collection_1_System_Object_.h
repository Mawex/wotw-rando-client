...
namespace app::methods::System_Collections_ObjectModel::Collection_1_System_Object_ {
IL2CPP_REGISTER_METHOD(0x02B7DF30, int32_t, get_Count, (app::Collection_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA280, IList_1_System_Object_ *, get_Items, (app::Collection_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CFA3A0, Object *, get_Item, (app::Collection_1_System_Object_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02CFAD90, Object *, ICollection_get_SyncRoot, (app::Collection_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CFA3A0, Object *, IList_get_Item, (app::Collection_1_System_Object_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02776BF0, void, __ctor_1, (app::Collection_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02B7DCF0, void, __ctor_2, (app::Collection_1_System_Object_ * this_ptr, app::IList_1_System_Object_ * list));
...
IL2CPP_REGISTER_METHOD(0x02B833F0, IEnumerator_1_System_Object_ *, GetEnumerator, (app::Collection_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CFAD00, IEnumerator *, IEnumerable_GetEnumerator, (app::Collection_1_System_Object_ * this_ptr));
