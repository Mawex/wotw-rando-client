...
namespace app::methods::Moon_Setups::ChangeStateSetupHolder {
IL2CPP_REGISTER_METHOD(0x00E253C0, String *, get_NewStateName, (app::ChangeStateSetupHolder * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_UseMapping, (app::ChangeStateSetupHolder * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E25440, ChangeStateSetupData *, get_NewState, (app::ChangeStateSetupHolder * this_ptr));
