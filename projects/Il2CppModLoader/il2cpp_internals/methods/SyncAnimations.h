...
IL2CPP_REGISTER_METHOD(0x005136D0, KuController *, get_KuController, (app::SyncAnimations * this_ptr));
IL2CPP_REGISTER_METHOD(0x00513770, Ku *, get_Ku, (app::SyncAnimations * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::SyncAnimations * this_ptr));
}
