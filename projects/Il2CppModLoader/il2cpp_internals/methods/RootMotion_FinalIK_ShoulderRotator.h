...
namespace app::methods::RootMotion_FinalIK::ShoulderRotator {
...
IL2CPP_REGISTER_METHOD(0x02A27B20, IKMapping_BoneMap *, GetParentBoneMap, (app::ShoulderRotator * this_ptr, app::FullBodyBipedChain__Enum chain));
IL2CPP_REGISTER_METHOD(0x02A27C30, void, OnDestroy, (app::ShoulderRotator * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A27E20, void, __ctor, (app::ShoulderRotator * this_ptr));
}
