...
namespace app::methods::RootMotion_FinalIK::RotationLimitSpline {
...
IL2CPP_REGISTER_METHOD(0x02A26280, Quaternion, LimitRotation, (app::RotationLimitSpline * this_ptr, app::Quaternion rotation));
IL2CPP_REGISTER_METHOD(0x02A26340, Quaternion, LimitSwing, (app::RotationLimitSpline * this_ptr, app::Quaternion rotation));
IL2CPP_REGISTER_METHOD(0x02A26CC0, void, __ctor, (app::RotationLimitSpline * this_ptr));
}
