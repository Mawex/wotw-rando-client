...
IL2CPP_REGISTER_METHOD(0x008C4330, BehaviourStatus__Enum, OnExecute, (app::VolumeMovementTimelineBehaviourNew * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x008C4410, void, OnExit, (app::VolumeMovementTimelineBehaviourNew * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x008C4520, Vector3, RootMotionModifier, (app::VolumeMovementTimelineBehaviourNew * this_ptr, app::Vector3 motion));
