...
namespace app::methods::Moon_Rendering::CullingCategoryManager_1_System_Object_ {
IL2CPP_REGISTER_METHOD(0x02904890, String *, get_typeName, ());
IL2CPP_REGISTER_METHOD(0x02904370, void, __ctor, (app::CullingCategoryManager_1_System_Object_ * this_ptr, app::CullingCategory__Enum mask, bool per_slice));
...
IL2CPP_REGISTER_METHOD(0x02904830, CullingCategoryManager_1_T_Enumerator_System_Object_, Resolve, (app::CullingCategoryManager_1_System_Object_ * this_ptr, app::RendererCullingCategoryResults results));
