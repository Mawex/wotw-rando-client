...
IL2CPP_REGISTER_METHOD(0x0064E760, SteeringForces_SteeringForcesBuilder *, GetForcesBuilder, (app::SteeringForces * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0064E860, void, __ctor, (app::SteeringForces * this_ptr));
}
