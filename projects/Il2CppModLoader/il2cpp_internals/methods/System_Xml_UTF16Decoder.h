...
namespace app::methods::System_Xml::UTF16Decoder {
IL2CPP_REGISTER_METHOD(0x019509A0, void, __ctor, (app::UTF16Decoder * this_ptr, bool big_endian));
...
IL2CPP_REGISTER_METHOD(0x01950E90, void, Convert, (app::UTF16Decoder * this_ptr, app::Byte__Array * bytes, int32_t byte_index, int32_t byte_count, app::Char__Array * chars, int32_t char_index, int32_t char_count, bool flush, app::int32_t * bytes_used, app::int32_t * chars_used, app::bool * completed));
}
