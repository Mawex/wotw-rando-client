...
IL2CPP_REGISTER_METHOD(0x01451470, BehaviourStatus__Enum, OnExecute, (app::MinerThrowAttack * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01452330, void, __ctor, (app::MinerThrowAttack * this_ptr));
}
