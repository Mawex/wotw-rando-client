...
namespace app::methods::AkVector {
    IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkVector * this_ptr, app::void* c_ptr, bool c_memory_own));
    IL2CPP_REGISTER_METHOD(0x02700D80, void*, getCPtr, (app::AkVector * obj));
    IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkVector * this_ptr, app::void* c_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x027018B0, void, __ctor_2, (app::AkVector * this_ptr));
} // namespace app::methods::AkVector
