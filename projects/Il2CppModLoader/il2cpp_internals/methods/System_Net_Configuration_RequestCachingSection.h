...
namespace app::methods::System_Net_Configuration::RequestCachingSection {
IL2CPP_REGISTER_METHOD(0x01E98330, void, __ctor, (app::RequestCachingSection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0474D600, RequestCachingSection__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E98360, FtpCachePolicyElement *, get_DefaultFtpCachePolicy, (app::RequestCachingSection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04799C88, RequestCachingSection_get_DefaultFtpCachePolicy__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E98390, HttpCachePolicyElement *, get_DefaultHttpCachePolicy, (app::RequestCachingSection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04722D20, RequestCachingSection_get_DefaultHttpCachePolicy__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E983C0, RequestCacheLevel__Enum, get_DefaultPolicyLevel, (app::RequestCachingSection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E984E0, ConfigurationPropertyCollection *, get_Properties, (app::RequestCachingSection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047864D8, RequestCachingSection_get_Properties__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E98510, TimeSpan, get_UnspecifiedMaximumAge, (app::RequestCachingSection * this_ptr));
