...
namespace app::methods::System_Globalization::GregorianCalendar {
...
IL2CPP_REGISTER_METHOD(0x02610770, DateTime, get_MinSupportedDateTime, (app::GregorianCalendar * this_ptr));
IL2CPP_REGISTER_METHOD(0x02610810, DateTime, get_MaxSupportedDateTime, (app::GregorianCalendar * this_ptr));
IL2CPP_REGISTER_METHOD(0x026108B0, Calendar *, GetDefaultInstance, ());
IL2CPP_REGISTER_METHOD(0x02610AA0, void, __ctor_1, (app::GregorianCalendar * this_ptr));
IL2CPP_REGISTER_METHOD(0x02610AB0, void, __ctor_2, (app::GregorianCalendar * this_ptr, app::GregorianCalendarTypes__Enum type));
...
IL2CPP_REGISTER_METHOD(0x02610E80, DayOfWeek__Enum, GetDayOfWeek, (app::GregorianCalendar * this_ptr, app::DateTime time));
...
IL2CPP_REGISTER_METHOD(0x026111E0, Int32__Array *, get_Eras, (app::GregorianCalendar * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x026116A0, DateTime, ToDateTime, (app::GregorianCalendar * this_ptr, int32_t year, int32_t month, int32_t day, int32_t hour, int32_t minute, int32_t second, int32_t millisecond, int32_t era));
