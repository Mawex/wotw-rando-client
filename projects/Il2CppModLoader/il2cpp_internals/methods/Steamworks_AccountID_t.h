...
IL2CPP_REGISTER_METHOD(0x0012ECC0, String *, ToString, (app::AccountID_t__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006CE970, AccountID_t, operator__1, (uint32_t value));
