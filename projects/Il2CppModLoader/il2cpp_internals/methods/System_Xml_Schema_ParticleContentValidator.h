...
namespace app::methods::System_Xml_Schema::ParticleContentValidator {
...
IL2CPP_REGISTER_METHOD(0x016D5620, Object *, ValidateElement, (app::ParticleContentValidator * this_ptr, app::XmlQualifiedName * name, app::ValidationState * context, app::int32_t * error_code));
...
IL2CPP_REGISTER_METHOD(0x016D6D50, ContentValidator *, Finish, (app::ParticleContentValidator * this_ptr, bool use_d_f_a));
IL2CPP_REGISTER_METHOD(0x016D7C50, BitSet__Array *, CalculateTotalFollowposForRangeNodes, (app::ParticleContentValidator * this_ptr, app::BitSet * firstpos, app::BitSet__Array * followpos, app::BitSet * * pos_with_range_terminals));
...
IL2CPP_REGISTER_METHOD(0x016D8350, BitSet *, GetApplicableMinMaxFollowPos, (app::ParticleContentValidator * this_ptr, app::BitSet * curpos, app::BitSet * pos_with_range_terminals, app::BitSet__Array * minmax_follow_pos));
...
IL2CPP_REGISTER_METHOD(0x016D8940, Int32__Array__Array *, BuildTransitionTable, (app::ParticleContentValidator * this_ptr, app::BitSet * firstpos, app::BitSet__Array * followpos, int32_t end_marker_pos));
}
