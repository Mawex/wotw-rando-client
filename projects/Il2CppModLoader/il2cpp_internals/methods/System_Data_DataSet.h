...
namespace app::methods::System_Data::DataSet {
IL2CPP_REGISTER_METHOD(0x017E2750, void, __ctor_1, (app::DataSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x017E2B90, void, __ctor_2, (app::DataSet * this_ptr, app::String * data_set_name));
IL2CPP_REGISTER_METHOD(0x003FF8B0, SerializationFormat__Enum_1, get_RemotingFormat, (app::DataSet * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00417920, SchemaSerializationMode__Enum, get_SchemaSerializationMode, (app::DataSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x017E2CE0, void, __ctor_3, (app::DataSet * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
IL2CPP_REGISTER_METHOD(0x017E2D10, void, __ctor_4, (app::DataSet * this_ptr, app::SerializationInfo * info, app::StreamingContext context, bool construct_schema));
...
IL2CPP_REGISTER_METHOD(0x017E5B20, DataViewManager *, get_DefaultViewManager, (app::DataSet * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9D0, String *, get_DataSetName, (app::DataSet * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB40, String *, get_Namespace, (app::DataSet * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9F0, String *, get_Prefix, (app::DataSet * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x017E6CA0, PropertyCollection *, get_ExtendedProperties, (app::DataSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x017E6E10, bool, get_IsInitialized, (app::DataSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB80, CultureInfo *, get_Locale, (app::DataSet * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA280, ISite *, get_Site, (app::DataSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x017E7980, void, set_Site, (app::DataSet * this_ptr, app::ISite * value));
IL2CPP_REGISTER_METHOD(0x002FB990, DataRelationCollection *, get_Relations, (app::DataSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB00, DataTableCollection *, get_Tables, (app::DataSet * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x017E8220, DataSet *, Clone, (app::DataSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x017E8FA0, int32_t, EstimatedXmlStringSize, (app::DataSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x017E9130, IList *, IListSource_GetList, (app::DataSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x017E9140, String *, GetRemotingDiffGram, (app::DataSet * this_ptr, app::DataTable * table));
IL2CPP_REGISTER_METHOD(0x017E94B0, String *, GetXmlSchemaForRemoting, (app::DataSet * this_ptr, app::DataTable * table));
...
IL2CPP_REGISTER_METHOD(0x017EB450, XmlReadMode__Enum, ReadXml_1, (app::DataSet * this_ptr, app::XmlReader * reader));
IL2CPP_REGISTER_METHOD(0x017EB460, XmlReadMode__Enum, ReadXml_2, (app::DataSet * this_ptr, app::XmlReader * reader, bool deny_resolving));
...
IL2CPP_REGISTER_METHOD(0x017EE830, XmlReadMode__Enum, ReadXml_3, (app::DataSet * this_ptr, app::XmlReader * reader, app::XmlReadMode__Enum mode));
IL2CPP_REGISTER_METHOD(0x017EE850, XmlReadMode__Enum, ReadXml_4, (app::DataSet * this_ptr, app::XmlReader * reader, app::XmlReadMode__Enum mode, bool deny_resolving));
...
IL2CPP_REGISTER_METHOD(0x017F0AF0, DataTable__Array *, TopLevelTables_1, (app::DataSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x017F0B00, DataTable__Array *, TopLevelTables_2, (app::DataSet * this_ptr, bool for_schema));
...
IL2CPP_REGISTER_METHOD(0x017F19C0, DataTable *, FindTable, (app::DataSet * this_ptr, app::DataTable * base_table, app::PropertyDescriptor__Array * props, int32_t prop_start));
...
IL2CPP_REGISTER_METHOD(0x017F21A0, XmlSchemaComplexType *, GetDataSetSchema, (app::XmlSchemaSet * schema_set));
IL2CPP_REGISTER_METHOD(0x017F2780, XmlSchema *, IXmlSerializable_GetSchema, (app::DataSet * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBC0, String *, get_MainTableName, (app::DataSet * this_ptr));
