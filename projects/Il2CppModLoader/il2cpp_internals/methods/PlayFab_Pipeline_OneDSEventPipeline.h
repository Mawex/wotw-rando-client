...
namespace app::methods::PlayFab_Pipeline::OneDSEventPipeline {
IL2CPP_REGISTER_METHOD(0x002FB950, OneDSEventPipelineSettings *, get_Settings, (app::OneDSEventPipeline * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBC0, Task *, get_PipelineTask, (app::OneDSEventPipeline * this_ptr));
IL2CPP_REGISTER_METHOD(0x017B0D30, void, __ctor, (app::OneDSEventPipeline * this_ptr, app::OneDSEventPipelineSettings * settings, app::ILogger_1 * logger));
IL2CPP_REGISTER_METHODINFO(0x0478F470, OneDSEventPipeline__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x017B11E0, Task *, StartAsync_1, (app::OneDSEventPipeline * this_ptr));
IL2CPP_REGISTER_METHOD(0x017B12E0, Task *, StartAsync_2, (app::OneDSEventPipeline * this_ptr, app::CancellationToken cancellation_token));
...
IL2CPP_REGISTER_METHOD(0x017B1BB0, Task_1_PlayFab_IPlayFabEmitEventResponse_ *, IntakeEventAsync, (app::OneDSEventPipeline * this_ptr, app::IPlayFabEmitEventRequest * request));
