...
IL2CPP_REGISTER_METHOD(0x01288740, Vector2, get_TextureScale, (app::UberShaderTextureBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x01288760, void, set_TextureScale, (app::UberShaderTextureBase * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x01288790, Vector2, get_TextureOffset, (app::UberShaderTextureBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x012887B0, void, set_TextureOffset, (app::UberShaderTextureBase * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x012887F0, Vector4, GetTextureShaderSettings, (app::UberShaderTextureBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x01288970, Vector2, get_TextureScroll, (app::UberShaderTextureBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x01288990, void, set_TextureScroll, (app::UberShaderTextureBase * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x012889C0, Vector2, get_TextureScrollMultiplier, (app::UberShaderTextureBase * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012894D0, void, __ctor, (app::UberShaderTextureBase * this_ptr));
