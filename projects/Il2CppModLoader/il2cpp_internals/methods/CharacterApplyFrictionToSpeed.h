...
IL2CPP_REGISTER_METHOD(0x00B39300, PlatformMovement *, get_PlatformMovement, (app::CharacterApplyFrictionToSpeed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005C9550, void, __ctor, (app::CharacterApplyFrictionToSpeed * this_ptr));
}
