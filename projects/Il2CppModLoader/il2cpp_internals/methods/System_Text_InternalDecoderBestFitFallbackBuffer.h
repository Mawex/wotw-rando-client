...
namespace app::methods::System_Text::InternalDecoderBestFitFallbackBuffer {
IL2CPP_REGISTER_METHOD(0x02458200, Object *, get_InternalSyncObject, ());
IL2CPP_REGISTER_METHOD(0x02458370, void, __ctor, (app::InternalDecoderBestFitFallbackBuffer * this_ptr, app::InternalDecoderBestFitFallback * fallback));
...
IL2CPP_REGISTER_METHOD(0x00417920, int32_t, InternalFallback, (app::InternalDecoderBestFitFallbackBuffer * this_ptr, app::Byte__Array * bytes, app::uint8_t * p_bytes));
