...
namespace app::methods::System_Text::DecoderFallbackBuffer {
...
IL2CPP_REGISTER_METHOD(0x0058DA40, void, InternalInitialize, (app::DecoderFallbackBuffer * this_ptr, app::uint8_t * byte_start, app::uint16_t * char_end));
IL2CPP_REGISTER_METHOD(0x024499A0, bool, InternalFallback_1, (app::DecoderFallbackBuffer * this_ptr, app::Byte__Array * bytes, app::uint8_t * p_bytes, app::uint16_t * * chars));
IL2CPP_REGISTER_METHODINFO(0x0474E960, DecoderFallbackBuffer_InternalFallback__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02449C10, int32_t, InternalFallback_2, (app::DecoderFallbackBuffer * this_ptr, app::Byte__Array * bytes, app::uint8_t * p_bytes));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::DecoderFallbackBuffer * this_ptr));
}
