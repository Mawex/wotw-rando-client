...
IL2CPP_REGISTER_METHOD(0x00B15660, TurbulenceManagerBinder *, get_Binder, (app::TurbulenceManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B157B0, SceneSettingsComponent *, get_m_currentSettings, (app::TurbulenceManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, Renderer *, get_TurbulenceMapRenderer, (app::TurbulenceManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B16E90, TurbulenceSettings *, GetTurbulenceSettings, (app::TurbulenceManager * this_ptr, app::SceneSettings * scene_settings));
...
IL2CPP_REGISTER_METHOD(0x00B16FB0, void, __ctor, (app::TurbulenceManager * this_ptr));
