...
namespace app::methods::UnityEngine_UI_Collections::IndexedSet_1_System_Object_ {
...
IL2CPP_REGISTER_METHOD(0x02ACD8A0, Object *, get_Item, (app::IndexedSet_1_System_Object_ * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x02ACD8D0, void, set_Item, (app::IndexedSet_1_System_Object_ * this_ptr, int32_t index, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02ACD120, void, __ctor, (app::IndexedSet_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02ACD540, IEnumerator_1_System_Object_ *, GetEnumerator, (app::IndexedSet_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04735C80, IndexedSet_1_System_Object__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02986CA0, IEnumerator *, IEnumerable_GetEnumerator, (app::IndexedSet_1_System_Object_ * this_ptr));
