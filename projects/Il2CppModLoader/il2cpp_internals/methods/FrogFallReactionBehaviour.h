...
IL2CPP_REGISTER_METHOD(0x01647F20, BehaviourStatus__Enum, OnExecuteTask, (app::FrogFallReactionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00C0C910, void, OnExitTask, (app::FrogFallReactionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x005B3EC0, void, __ctor, (app::FrogFallReactionBehaviour * this_ptr));
}
