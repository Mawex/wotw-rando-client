...
namespace app::methods::System_Net::SocketPermission {
IL2CPP_REGISTER_METHOD(0x01BDD090, void, __ctor_1, (app::SocketPermission * this_ptr, app::PermissionState__Enum state));
IL2CPP_REGISTER_METHOD(0x01BDD2B0, void, __ctor_2, (app::SocketPermission * this_ptr, app::NetworkAccess__Enum access, app::TransportType__Enum transport, app::String * host_name, int32_t port_number));
IL2CPP_REGISTER_METHOD(0x01BDD500, IEnumerator *, get_AcceptList, (app::SocketPermission * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BDD530, IEnumerator *, get_ConnectList, (app::SocketPermission * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BDD720, IPermission *, Copy, (app::SocketPermission * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BDD980, IPermission *, Intersect_1, (app::SocketPermission * this_ptr, app::IPermission * target));
...
IL2CPP_REGISTER_METHOD(0x01BDE690, SecurityElement *, ToXml_1, (app::SocketPermission * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BDF640, IPermission *, Union, (app::SocketPermission * this_ptr, app::IPermission * target));
