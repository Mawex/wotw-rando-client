...
namespace app::methods::System_Net_Configuration::HttpWebRequestElement {
IL2CPP_REGISTER_METHOD(0x02019980, void, __ctor, (app::HttpWebRequestElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02019AD0, ConfigurationPropertyCollection *, get_Properties, (app::HttpWebRequestElement * this_ptr));
