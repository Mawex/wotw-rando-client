...
IL2CPP_REGISTER_METHOD(0x00ECB3A0, void, __ctor, (app::SceneLoadingTest_GatherStatsScope * this_ptr, app::SceneLoadingTest_Context * ctx, app::SceneLoadingTest_Stats * stats));
