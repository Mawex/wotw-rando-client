...
IL2CPP_REGISTER_METHOD(0x002FBB60, ShopkeeperItem *, get_Item, (app::ShopkeeperUIItem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::ShopkeeperUIItem * this_ptr));
}
