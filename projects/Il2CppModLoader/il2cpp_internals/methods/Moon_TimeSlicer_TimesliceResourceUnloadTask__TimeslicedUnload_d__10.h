...
namespace app::methods::Moon_TimeSlicer::TimesliceResourceUnloadTask__TimeslicedUnload_d__10 {
IL2CPP_REGISTER_METHOD(0x002FC6E0, void, __ctor, (app::TimesliceResourceUnloadTask_TimeslicedUnload_d_10 * this_ptr, int32_t __1__state));
...
IL2CPP_REGISTER_METHOD(0x002FB930, Object *, IEnumerator_object__get_Current, (app::TimesliceResourceUnloadTask_TimeslicedUnload_d_10 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB930, Object *, IEnumerator_get_Current, (app::TimesliceResourceUnloadTask_TimeslicedUnload_d_10 * this_ptr));
}
