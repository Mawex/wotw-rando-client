...
IL2CPP_REGISTER_METHOD(0x0057AB90, int32_t, SetWindowLong, (app::void * h_wnd, int32_t n_index, int32_t dw_new_long));
IL2CPP_REGISTER_METHOD(0x0057AC40, int32_t, GetWindowLong, (app::void * h_wnd, int32_t index));
IL2CPP_REGISTER_METHOD(0x0057ACF0, void *, FindWindowByCaption, (app::void * zero_only, app::String * lp_window_name));
IL2CPP_REGISTER_METHOD(0x0057AED0, bool, DrawMenuBar, (app::void * h_wnd));
IL2CPP_REGISTER_METHOD(0x0057AF70, void *, SetWindowPos, (app::void * h_wnd, int32_t h_wnd_insert_after, int32_t x, int32_t Y, int32_t cx, int32_t cy, int32_t w_flags));
IL2CPP_REGISTER_METHOD(0x0057B030, bool, GetWindowRect, (app::void * h_wnd, app::RECT * lp_rect));
IL2CPP_REGISTER_METHOD(0x0057B0E0, void *, GetForegroundWindow, ());
IL2CPP_REGISTER_METHOD(0x0057B170, void *, GetActiveWindow, ());
IL2CPP_REGISTER_METHOD(0x0057B200, bool, ShowWindow, (app::void * hwnd, int32_t n_cmd_show));
...
IL2CPP_REGISTER_METHOD(0x0057B9D0, void, __ctor, (app::WindowManager * this_ptr));
}
