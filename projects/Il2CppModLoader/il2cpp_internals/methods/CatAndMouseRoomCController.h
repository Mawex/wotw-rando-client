...
IL2CPP_REGISTER_METHOD(0x0057A5A0, SuspendableMask__Enum, get_Mask, (app::CatAndMouseRoomCController * this_ptr));
IL2CPP_REGISTER_METHOD(0x0102B5D0, void, set_Mask, (app::CatAndMouseRoomCController * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x0102B690, void, __ctor, (app::CatAndMouseRoomCController * this_ptr));
}
