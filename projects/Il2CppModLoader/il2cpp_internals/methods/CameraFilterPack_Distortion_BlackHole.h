...
IL2CPP_REGISTER_METHOD(0x024E4E50, Material *, get_material, (app::CameraFilterPack_Distortion_BlackHole * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024E5820, void, __ctor, (app::CameraFilterPack_Distortion_BlackHole * this_ptr));
}
