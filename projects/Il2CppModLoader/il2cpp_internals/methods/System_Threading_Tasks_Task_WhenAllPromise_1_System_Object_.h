...
namespace app::methods::System_Threading_Tasks::Task_WhenAllPromise_1_System_Object_ {
...
IL2CPP_REGISTER_METHOD(0x02776470, void, __ctor, (app::Task_WhenAllPromise_1_System_Object_ * this_ptr, app::Task_1_System_Object___Array * tasks));
