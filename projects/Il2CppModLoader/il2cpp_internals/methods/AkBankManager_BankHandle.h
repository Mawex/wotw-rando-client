...
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::AkBankManager_BankHandle * this_ptr, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x026CDBC0, AKRESULT__Enum, DoLoadBank, (app::AkBankManager_BankHandle * this_ptr));
