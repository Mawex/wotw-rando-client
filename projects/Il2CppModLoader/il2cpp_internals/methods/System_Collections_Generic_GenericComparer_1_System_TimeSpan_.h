...
namespace app::methods::System_Collections_Generic::GenericComparer_1_System_TimeSpan_ {
...
IL2CPP_REGISTER_METHOD(0x0225BDA0, void, __ctor, (app::GenericComparer_1_System_TimeSpan_ * this_ptr));
}
