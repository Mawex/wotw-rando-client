...
namespace app::methods::System_Resources::ResourceReader_ResourceEnumerator {
IL2CPP_REGISTER_METHOD(0x01A8D130, void, __ctor, (app::ResourceReader_ResourceEnumerator * this_ptr, app::ResourceReader * reader));
IL2CPP_REGISTER_METHOD(0x01A8D150, bool, MoveNext, (app::ResourceReader_ResourceEnumerator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01A8D1A0, Object *, get_Key, (app::ResourceReader_ResourceEnumerator * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04773AD8, ResourceReader_ResourceEnumerator_get_Key__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A8D320, Object *, get_Current, (app::ResourceReader_ResourceEnumerator * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FD1D0, int32_t, get_DataPosition, (app::ResourceReader_ResourceEnumerator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01A8D3C0, DictionaryEntry, get_Entry, (app::ResourceReader_ResourceEnumerator * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0474E728, ResourceReader_ResourceEnumerator_get_Entry__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A8D7D0, Object *, get_Value, (app::ResourceReader_ResourceEnumerator * this_ptr));
