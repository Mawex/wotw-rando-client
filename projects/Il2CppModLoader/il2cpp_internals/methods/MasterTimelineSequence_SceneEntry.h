...
IL2CPP_REGISTER_METHOD(0x00A13F40, BaseAnimator *, get_Animator, (app::MasterTimelineSequence_SceneEntry * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, LegacyTimelineSequence_SequenceEntry_Constraint *, get_StartConstraint, (app::MasterTimelineSequence_SceneEntry * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, LegacyTimelineSequence_SequenceEntry_Constraint *, get_EndConstraint, (app::MasterTimelineSequence_SceneEntry * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A14220, void, __ctor, (app::MasterTimelineSequence_SceneEntry * this_ptr));
}
