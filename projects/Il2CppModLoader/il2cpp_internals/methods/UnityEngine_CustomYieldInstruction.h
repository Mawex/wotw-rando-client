...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::CustomYieldInstruction * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F1B660, Object *, get_Current, (app::CustomYieldInstruction * this_ptr));
