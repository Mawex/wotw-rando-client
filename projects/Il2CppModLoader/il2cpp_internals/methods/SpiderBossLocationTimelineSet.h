...
IL2CPP_REGISTER_METHOD(0x011B2290, MoonTimeline *, GetTimeline, (app::SpiderBossLocationTimelineSet * this_ptr, app::SpiderBossLocationZone__Enum zone, float facing_direction));
IL2CPP_REGISTER_METHOD(0x011B2B50, MoonTimeline *, GetAnyTimeline, (app::SpiderBossLocationTimelineSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::SpiderBossLocationTimelineSet * this_ptr));
}
