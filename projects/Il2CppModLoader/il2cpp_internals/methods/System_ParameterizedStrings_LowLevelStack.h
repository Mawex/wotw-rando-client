...
IL2CPP_REGISTER_METHOD(0x0227E470, void, __ctor, (app::ParameterizedStrings_LowLevelStack * this_ptr));
IL2CPP_REGISTER_METHOD(0x0227E500, ParameterizedStrings_FormatParam, Pop, (app::ParameterizedStrings_LowLevelStack * this_ptr));
