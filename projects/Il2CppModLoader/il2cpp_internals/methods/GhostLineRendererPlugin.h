...
IL2CPP_REGISTER_METHOD(0x00E216F0, void, __ctor, (app::GhostLineRendererPlugin * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, GhostRecorder_GhostPluginRecordingType__Enum, GetRecordingType, (app::GhostLineRendererPlugin * this_ptr));
