...
IL2CPP_REGISTER_METHOD(0x02B27D90, void, __ctor, (app::RobustPredicates * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B283A0, Point *, FindCircumcenter_1, (app::RobustPredicates * this_ptr, app::Point * org, app::Point * dest, app::Point * apex, app::double * xi, app::double * eta, double offconstant));
IL2CPP_REGISTER_METHOD(0x02B28910, Point *, FindCircumcenter_2, (app::RobustPredicates * this_ptr, app::Point * org, app::Point * dest, app::Point * apex, app::double * xi, app::double * eta));
