...
namespace app::methods::System_Collections_Generic::Stack_1_System_Collections_IList_ {
IL2CPP_REGISTER_METHOD(0x0243CB70, void, __ctor, (app::Stack_1_System_Collections_IList_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CF7F90, IList *, Pop, (app::Stack_1_System_Collections_IList_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04798570, Stack_1_System_Collections_IList__Pop__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02CF7F30, IList *, Peek, (app::Stack_1_System_Collections_IList_ * this_ptr));
