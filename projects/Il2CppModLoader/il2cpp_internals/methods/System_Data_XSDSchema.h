...
namespace app::methods::System_Data::XSDSchema {
...
IL2CPP_REGISTER_METHOD(0x023D4B40, String *, QualifiedName, (app::String * name));
...
IL2CPP_REGISTER_METHOD(0x023D5B60, String *, GetMsdataAttribute, (app::XmlSchemaAnnotated * node, app::String * ln));
...
IL2CPP_REGISTER_METHOD(0x023D7510, XmlSchemaElement *, FindDatasetElement, (app::XSDSchema * this_ptr, app::XmlSchemaObjectCollection * elements));
...
IL2CPP_REGISTER_METHOD(0x023D92C0, XmlSchemaObjectCollection *, GetParticleItems, (app::XSDSchema * this_ptr, app::XmlSchemaParticle * pt));
...
IL2CPP_REGISTER_METHOD(0x023DAC80, XmlSchemaParticle *, GetParticle, (app::XSDSchema * this_ptr, app::XmlSchemaComplexType * ct));
IL2CPP_REGISTER_METHOD(0x023DAE70, DataColumn *, FindField, (app::XSDSchema * this_ptr, app::DataTable * table, app::String * field));
IL2CPP_REGISTER_METHODINFO(0x04745D58, XSDSchema_FindField__MethodInfo);
IL2CPP_REGISTER_METHOD(0x023DB190, DataColumn__Array *, BuildKey, (app::XSDSchema * this_ptr, app::XmlSchemaIdentityConstraint * key_node, app::DataTable * table));
...
IL2CPP_REGISTER_METHOD(0x023DB6B0, String *, GetStringAttribute, (app::XSDSchema * this_ptr, app::XmlSchemaAnnotated * element, app::String * attr_name, app::String * def_val));
IL2CPP_REGISTER_METHOD(0x023DB770, AcceptRejectRule__Enum, TranslateAcceptRejectRule, (app::String * str_rule));
IL2CPP_REGISTER_METHOD(0x023DB850, Rule__Enum, TranslateRule, (app::String * str_rule));
...
IL2CPP_REGISTER_METHOD(0x023DCD10, DataTable *, InstantiateSimpleTable, (app::XSDSchema * this_ptr, app::XmlSchemaElement * node));
IL2CPP_REGISTER_METHODINFO(0x04721F88, XSDSchema_InstantiateSimpleTable__MethodInfo);
IL2CPP_REGISTER_METHOD(0x023DD650, String *, GetInstanceName, (app::XSDSchema * this_ptr, app::XmlSchemaAnnotated * node));
IL2CPP_REGISTER_METHOD(0x023DD810, DataTable *, InstantiateTable, (app::XSDSchema * this_ptr, app::XmlSchemaElement * node, app::XmlSchemaComplexType * type_node, bool is_ref));
IL2CPP_REGISTER_METHODINFO(0x0473C220, XSDSchema_InstantiateTable__MethodInfo);
IL2CPP_REGISTER_METHOD(0x023DEE90, Type *, XsdtoClr, (app::String * xsd_type_name));
IL2CPP_REGISTER_METHODINFO(0x0470C508, XSDSchema_XsdtoClr__MethodInfo);
IL2CPP_REGISTER_METHOD(0x023DEFD0, XSDSchema_NameType *, FindNameType, (app::String * name));
IL2CPP_REGISTER_METHODINFO(0x0478F780, XSDSchema_FindNameType__MethodInfo);
IL2CPP_REGISTER_METHOD(0x023DF110, Type *, ParseDataType, (app::XSDSchema * this_ptr, app::String * dt));
...
IL2CPP_REGISTER_METHOD(0x023DF560, XmlSchemaAnnotated *, FindTypeNode, (app::XSDSchema * this_ptr, app::XmlSchemaAnnotated * node));
...
IL2CPP_REGISTER_METHOD(0x023E4660, String *, GetPrefix, (app::XSDSchema * this_ptr, app::String * ns));
IL2CPP_REGISTER_METHOD(0x023E4960, String *, GetNamespaceFromPrefix, (app::XSDSchema * this_ptr, app::String * prefix));
IL2CPP_REGISTER_METHOD(0x023E4C70, String *, GetTableNamespace, (app::XSDSchema * this_ptr, app::XmlSchemaIdentityConstraint * key));
IL2CPP_REGISTER_METHODINFO(0x04779200, XSDSchema_GetTableNamespace__MethodInfo);
IL2CPP_REGISTER_METHOD(0x023E4EB0, String *, GetTableName, (app::XSDSchema * this_ptr, app::XmlSchemaIdentityConstraint * key));
...
IL2CPP_REGISTER_METHOD(0x023E5390, DataTable *, HandleTable, (app::XSDSchema * this_ptr, app::XmlSchemaElement * node));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::XSDSchema * this_ptr));
