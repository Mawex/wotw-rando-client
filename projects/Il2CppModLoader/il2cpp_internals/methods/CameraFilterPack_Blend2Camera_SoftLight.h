...
IL2CPP_REGISTER_METHOD(0x0275EDB0, Material *, get_material, (app::CameraFilterPack_Blend2Camera_SoftLight * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0275FF80, void, __ctor, (app::CameraFilterPack_Blend2Camera_SoftLight * this_ptr));
}
