...
namespace app::methods::System_Runtime_Remoting::RemotingConfiguration {
...
IL2CPP_REGISTER_METHOD(0x023217A0, ActivatedClientTypeEntry *, IsRemotelyActivatedClientType, (app::Type * svr_type));
IL2CPP_REGISTER_METHOD(0x023219C0, WellKnownClientTypeEntry *, IsWellKnownClientType, (app::Type * svr_type));
