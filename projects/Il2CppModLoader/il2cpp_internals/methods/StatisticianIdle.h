...
IL2CPP_REGISTER_METHOD(0x009B7B50, BehaviourStatus__Enum, OnExecuteTask, (app::StatisticianIdle * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x009B8AB0, void, __ctor, (app::StatisticianIdle * this_ptr));
}
