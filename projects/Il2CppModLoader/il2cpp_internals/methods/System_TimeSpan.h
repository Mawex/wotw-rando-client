...
namespace app::methods::System::TimeSpan {
    ...
    IL2CPP_REGISTER_METHOD(0x027ADF80, app::TimeSpan, operator___1, (app::TimeSpan t1, app::TimeSpan t2));
    IL2CPP_REGISTER_METHOD(0x027ADFA0, app::TimeSpan, operator___2, (app::TimeSpan t1, app::TimeSpan t2));
