...
namespace app::methods::Moon_ArtOptimization::SceneOptimizationResults {
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_SceneName, (app::SceneOptimizationResults * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_SceneName, (app::SceneOptimizationResults * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x00CAFFB0, void, __ctor, (app::SceneOptimizationResults * this_ptr, app::String * scene_name));
...
IL2CPP_REGISTER_METHOD(0x002FB990, IReadOnlyDictionary_2_System_String_System_Int32_ *, get_StrippedModifiers, (app::SceneOptimizationResults * this_ptr));
