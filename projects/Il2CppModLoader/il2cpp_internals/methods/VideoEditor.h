...
namespace app::methods::VideoEditor {
    ...
    IL2CPP_REGISTER_METHOD(0x008BE4C0, String*, TimeToTimestamp, (app::VideoEditor * this_ptr, double time));
    ...
    IL2CPP_REGISTER_METHOD(0x008C0350, void, __ctor, (app::VideoEditor * this_ptr));
} // namespace app::methods::VideoEditor
