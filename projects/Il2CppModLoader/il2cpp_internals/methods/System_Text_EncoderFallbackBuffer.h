...
namespace app::methods::System_Text::EncoderFallbackBuffer {
...
IL2CPP_REGISTER_METHOD(0x0244D270, void, InternalInitialize, (app::EncoderFallbackBuffer * this_ptr, app::uint16_t * char_start, app::uint16_t * char_end, app::EncoderNLS * encoder, bool set_encoder));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::EncoderFallbackBuffer * this_ptr));
}
