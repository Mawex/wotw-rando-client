...
namespace app::methods::Mono_Security_Protocol_Tls_Handshake_Client::TlsClientFinished {
    IL2CPP_REGISTER_METHOD(0x01F6B960, void, __ctor, (app::TlsClientFinished_1 * this_ptr, app::Context_1 * context));
