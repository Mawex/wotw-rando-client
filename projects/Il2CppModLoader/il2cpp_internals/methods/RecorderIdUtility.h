...
IL2CPP_REGISTER_METHOD(0x008F0F70, String *, GetAssetGuid, (app::Object_1 * asset));
IL2CPP_REGISTER_METHOD(0x008F0FF0, String *, GetPath, (app::Transform * transform));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::RecorderIdUtility * this_ptr));
}
