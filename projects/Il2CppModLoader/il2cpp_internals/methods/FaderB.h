...
namespace app::methods::FaderB {
    ...
    IL2CPP_REGISTER_METHOD(0x009921F0, UberGCLogic_CleanupOutsideOfGameplayTrigger__Enum, GetTriggerType, (app::FaderB * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x009935C0, void, __ctor, (app::FaderB * this_ptr));
