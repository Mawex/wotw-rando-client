...
namespace app::methods::Moon_Timeline::WaitForInputEntity {
IL2CPP_REGISTER_METHOD(0x00420EE0, RecordableParsingGroup__Enum, get_ParsingGroup, (app::WaitForInputEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D1E540, void, __ctor, (app::WaitForInputEntity * this_ptr));
}
