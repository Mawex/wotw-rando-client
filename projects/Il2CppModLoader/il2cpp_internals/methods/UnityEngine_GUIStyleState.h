...
IL2CPP_REGISTER_METHOD(0x029F75C0, void, __ctor_1, (app::GUIStyleState * this_ptr));
IL2CPP_REGISTER_METHOD(0x0231B8E0, void, __ctor_2, (app::GUIStyleState * this_ptr, app::GUIStyle * source_style, app::void * source));
IL2CPP_REGISTER_METHOD(0x029F7620, Texture2D *, get_background, (app::GUIStyleState * this_ptr));
IL2CPP_REGISTER_METHOD(0x029F7670, void, set_background, (app::GUIStyleState * this_ptr, app::Texture2D * value));
IL2CPP_REGISTER_METHOD(0x029F76D0, Color, get_textColor, (app::GUIStyleState * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x029F7850, GUIStyleState *, GetGUIStyleState, (app::GUIStyle * source_style, app::void * source));
