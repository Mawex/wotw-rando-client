...
namespace app::methods::UnityEngine_Events::InvokableCallList {
IL2CPP_REGISTER_METHOD(0x0242EF00, void, __ctor, (app::InvokableCallList * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0242F780, List_1_UnityEngine_Events_BaseInvokableCall_ *, PrepareInvoke, (app::InvokableCallList * this_ptr));
}
