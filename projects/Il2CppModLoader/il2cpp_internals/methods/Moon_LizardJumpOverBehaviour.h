...
IL2CPP_REGISTER_METHOD(0x011061C0, BehaviourStatus__Enum, OnExecute, (app::LizardJumpOverBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0088C860, Vector2, GetVector2, (app::LizardJumpOverBehaviour * this_ptr, app::Vector3 vector));
IL2CPP_REGISTER_METHOD(0x01106CC0, void, __ctor, (app::LizardJumpOverBehaviour * this_ptr));
