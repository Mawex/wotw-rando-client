...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::VRMainControlPanel {
...
IL2CPP_REGISTER_METHOD(0x01672210, VRBrowserPanel *, OpenNewTab, (app::VRMainControlPanel * this_ptr, app::VRBrowserPanel * next_to));
...
IL2CPP_REGISTER_METHOD(0x01672A80, IEnumerator *, _DestroyBrowser, (app::VRMainControlPanel * this_ptr, app::VRBrowserPanel * pane));
