...
IL2CPP_REGISTER_METHOD(0x01312230, void, __ctor_1, (app::CharacterPlatformMovement_ScheduledSpeedCurve * this_ptr, app::CharacterPlatformMovement_SpeedSpace__Enum space, bool additive, app::AnimationCurve * curve_x, app::AnimationCurve * curve_y, float curve_scale_x, float curve_scale_y, app::Func_1_Boolean_ * can_continue));
IL2CPP_REGISTER_METHOD(0x01312280, void, __ctor_2, (app::CharacterPlatformMovement_ScheduledSpeedCurve * this_ptr, app::CharacterPlatformMovement_SpeedSpace__Enum space, bool additive, app::AnimationCurve * curve, app::Vector2 direction, float curve_scale, float time_scale, app::Func_1_Boolean_ * can_continue));
