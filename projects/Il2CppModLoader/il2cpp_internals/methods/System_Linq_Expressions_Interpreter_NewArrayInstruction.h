...
namespace app::methods::System_Linq_Expressions_Interpreter::NewArrayInstruction {
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::NewArrayInstruction * this_ptr, app::Type * element_type));
...
IL2CPP_REGISTER_METHOD(0x02401C10, String *, get_InstructionName, (app::NewArrayInstruction * this_ptr));
