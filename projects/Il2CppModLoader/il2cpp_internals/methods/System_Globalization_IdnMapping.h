...
namespace app::methods::System_Globalization::IdnMapping {
IL2CPP_REGISTER_METHOD(0x026168E0, void, __ctor, (app::IdnMapping * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02616B40, String *, GetAscii_1, (app::IdnMapping * this_ptr, app::String * unicode));
IL2CPP_REGISTER_METHODINFO(0x04797928, IdnMapping_GetAscii__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02616CC0, String *, GetAscii_2, (app::IdnMapping * this_ptr, app::String * unicode, int32_t index, int32_t count));
IL2CPP_REGISTER_METHODINFO(0x0471A6B0, IdnMapping_GetAscii_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02616E30, String *, Convert, (app::IdnMapping * this_ptr, app::String * input, int32_t index, int32_t count, bool to_ascii));
IL2CPP_REGISTER_METHOD(0x026170D0, String *, ToAscii, (app::IdnMapping * this_ptr, app::String * s, int32_t offset));
...
IL2CPP_REGISTER_METHOD(0x026176A0, String *, NamePrep, (app::IdnMapping * this_ptr, app::String * s, int32_t offset));
...
IL2CPP_REGISTER_METHOD(0x02617CC0, String *, GetUnicode_1, (app::IdnMapping * this_ptr, app::String * ascii));
IL2CPP_REGISTER_METHODINFO(0x0472CF48, IdnMapping_GetUnicode__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02617E40, String *, GetUnicode_2, (app::IdnMapping * this_ptr, app::String * ascii, int32_t index, int32_t count));
IL2CPP_REGISTER_METHODINFO(0x047334A8, IdnMapping_GetUnicode_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02617FB0, String *, ToUnicode, (app::IdnMapping * this_ptr, app::String * s, int32_t offset));
