...
namespace app::methods::StatUISlot {
    IL2CPP_REGISTER_METHOD(0x002FBBA0, StatSetting*, get_StatSetting, (app::StatUISlot * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::StatUISlot * this_ptr));
} // namespace app::methods::StatUISlot
