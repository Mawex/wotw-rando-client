...
namespace app::methods::System_Diagnostics_Tracing::EnumInt16TypeInfo_1_System_IntPtr_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0298B8E0, void, __ctor, (app::EnumInt16TypeInfo_1_System_IntPtr_ * this_ptr));
}
