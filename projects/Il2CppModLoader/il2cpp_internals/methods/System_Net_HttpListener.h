...
namespace app::methods::System_Net::HttpListener {
IL2CPP_REGISTER_METHOD(0x01D411E0, void, __ctor_1, (app::HttpListener * this_ptr, app::X509Certificate_1 * certificate, app::MonoTlsProvider * tls_provider, app::MonoTlsSettings * tls_settings));
IL2CPP_REGISTER_METHOD(0x01D41230, X509Certificate_1 *, LoadCertificateAndKey, (app::HttpListener * this_ptr, app::IPAddress * addr, int32_t port));
IL2CPP_REGISTER_METHOD(0x01D41710, SslStream *, CreateSslStream, (app::HttpListener * this_ptr, app::Stream * inner_stream, bool owns_stream, app::RemoteCertificateValidationCallback * callback));
IL2CPP_REGISTER_METHOD(0x01D41AD0, void, __ctor_2, (app::HttpListener * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB970, AuthenticationSchemes__Enum, get_AuthenticationSchemes, (app::HttpListener * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, AuthenticationSchemeSelector *, get_AuthenticationSchemeSelectorDelegate, (app::HttpListener * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC20, HttpListener_ExtendedProtectionSelector *, get_ExtendedProtectionSelectorDelegate, (app::HttpListener * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D42560, HttpListenerPrefixCollection *, get_Prefixes, (app::HttpListener * this_ptr));
IL2CPP_REGISTER_METHOD(0x01D42580, HttpListenerTimeoutManager *, get_TimeoutManager, (app::HttpListener * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04745970, HttpListener_get_TimeoutManager__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FBC00, ExtendedProtectionPolicy *, get_ExtendedProtectionPolicy, (app::HttpListener * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D426C0, ServiceNameCollection *, get_DefaultServiceNames, (app::HttpListener * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9D0, String *, get_Realm, (app::HttpListener * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D43410, IAsyncResult *, BeginGetContext, (app::HttpListener * this_ptr, app::AsyncCallback * callback, app::Object * state));
IL2CPP_REGISTER_METHODINFO(0x0476C950, HttpListener_BeginGetContext__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01D439A0, HttpListenerContext *, EndGetContext, (app::HttpListener * this_ptr, app::IAsyncResult * async_result));
IL2CPP_REGISTER_METHODINFO(0x04762890, HttpListener_EndGetContext__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01D43CE0, AuthenticationSchemes__Enum, SelectAuthenticationScheme, (app::HttpListener * this_ptr, app::HttpListenerContext * context));
IL2CPP_REGISTER_METHOD(0x01D43D20, HttpListenerContext *, GetContext, (app::HttpListener * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D43FE0, Task_1_System_Net_HttpListenerContext_ *, GetContextAsync, (app::HttpListener * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D44360, HttpListenerContext *, GetContextFromQueue, (app::HttpListener * this_ptr));
