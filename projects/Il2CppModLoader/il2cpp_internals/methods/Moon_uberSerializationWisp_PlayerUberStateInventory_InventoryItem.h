...
namespace app::methods::Moon_uberSerializationWisp::PlayerUberStateInventory_InventoryItem {
IL2CPP_REGISTER_METHOD(0x00F3E1C0, void, __ctor_1, (app::PlayerUberStateInventory_InventoryItem * this_ptr, app::EquipmentType__Enum type, app::Action * set_dirty_callback));
IL2CPP_REGISTER_METHOD(0x00F3E4A0, void, __ctor_2, (app::PlayerUberStateInventory_InventoryItem * this_ptr, app::UberStateArchive * archive, app::Action * set_dirty_callback));
IL2CPP_REGISTER_METHOD(0x002FC6D0, EquipmentType__Enum, get_Type, (app::PlayerUberStateInventory_InventoryItem * this_ptr));
