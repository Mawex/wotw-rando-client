...
namespace app::methods::System_Linq_Expressions::DebugViewWriter {
IL2CPP_REGISTER_METHOD(0x01FA3B10, void, __ctor, (app::DebugViewWriter * this_ptr, app::TextWriter * file));
...
IL2CPP_REGISTER_METHOD(0x01FA47C0, DebugViewWriter_Flow__Enum, GetFlow, (app::DebugViewWriter * this_ptr, app::DebugViewWriter_Flow__Enum flow));
IL2CPP_REGISTER_METHOD(0x01FA48C0, DebugViewWriter_Flow__Enum, CheckBreak, (app::DebugViewWriter * this_ptr, app::DebugViewWriter_Flow__Enum flow));
...
IL2CPP_REGISTER_METHOD(0x01FA4A80, Expression *, VisitBinary, (app::DebugViewWriter * this_ptr, app::BinaryExpression * node));
IL2CPP_REGISTER_METHODINFO(0x047213A0, DebugViewWriter_VisitBinary__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01FA4FA0, Expression *, VisitParameter, (app::DebugViewWriter * this_ptr, app::ParameterExpression * node));
IL2CPP_REGISTER_METHOD(0x01FA5110, bool, IsSimpleExpression, (app::Expression * node));
IL2CPP_REGISTER_METHOD(0x01FA5270, Expression *, VisitConditional, (app::DebugViewWriter * this_ptr, app::ConditionalExpression * node));
IL2CPP_REGISTER_METHOD(0x01FA5550, Expression *, VisitConstant, (app::DebugViewWriter * this_ptr, app::ConstantExpression * node));
IL2CPP_REGISTER_METHOD(0x01FA5970, String *, GetConstantValueSuffix, (app::Type * type));
IL2CPP_REGISTER_METHOD(0x01FA5BC0, Expression *, VisitRuntimeVariables, (app::DebugViewWriter * this_ptr, app::RuntimeVariablesExpression * node));
...
IL2CPP_REGISTER_METHOD(0x01FA5E10, Expression *, VisitMember, (app::DebugViewWriter * this_ptr, app::MemberExpression * node));
IL2CPP_REGISTER_METHOD(0x01FA5E80, Expression *, VisitInvocation, (app::DebugViewWriter * this_ptr, app::InvocationExpression * node));
...
IL2CPP_REGISTER_METHOD(0x01FA63E0, Expression *, VisitMethodCall, (app::DebugViewWriter * this_ptr, app::MethodCallExpression * node));
IL2CPP_REGISTER_METHOD(0x01FA6630, Expression *, VisitNewArray, (app::DebugViewWriter * this_ptr, app::NewArrayExpression * node));
IL2CPP_REGISTER_METHOD(0x01FA6800, Expression *, VisitNew, (app::DebugViewWriter * this_ptr, app::NewExpression * node));
IL2CPP_REGISTER_METHOD(0x01FA6930, ElementInit *, VisitElementInit, (app::DebugViewWriter * this_ptr, app::ElementInit * node));
IL2CPP_REGISTER_METHOD(0x01FA6AE0, Expression *, VisitListInit, (app::DebugViewWriter * this_ptr, app::ListInitExpression * node));
IL2CPP_REGISTER_METHOD(0x01FA6C90, MemberAssignment *, VisitMemberAssignment, (app::DebugViewWriter * this_ptr, app::MemberAssignment * assignment));
IL2CPP_REGISTER_METHOD(0x01FA6D90, MemberListBinding *, VisitMemberListBinding, (app::DebugViewWriter * this_ptr, app::MemberListBinding * binding));
IL2CPP_REGISTER_METHOD(0x01FA6F80, MemberMemberBinding *, VisitMemberMemberBinding, (app::DebugViewWriter * this_ptr, app::MemberMemberBinding * binding));
IL2CPP_REGISTER_METHOD(0x01FA7170, Expression *, VisitMemberInit, (app::DebugViewWriter * this_ptr, app::MemberInitExpression * node));
IL2CPP_REGISTER_METHOD(0x01FA7320, Expression *, VisitTypeBinary, (app::DebugViewWriter * this_ptr, app::TypeBinaryExpression * node));
IL2CPP_REGISTER_METHOD(0x01FA7440, Expression *, VisitUnary, (app::DebugViewWriter * this_ptr, app::UnaryExpression * node));
IL2CPP_REGISTER_METHOD(0x01FA7870, Expression *, VisitBlock, (app::DebugViewWriter * this_ptr, app::BlockExpression * node));
IL2CPP_REGISTER_METHOD(0x01FA7C10, Expression *, VisitDefault, (app::DebugViewWriter * this_ptr, app::DefaultExpression * node));
IL2CPP_REGISTER_METHOD(0x01FA7D10, Expression *, VisitLabel, (app::DebugViewWriter * this_ptr, app::LabelExpression * node));
IL2CPP_REGISTER_METHOD(0x01FA7E00, Expression *, VisitGoto, (app::DebugViewWriter * this_ptr, app::GotoExpression * node));
IL2CPP_REGISTER_METHOD(0x01FA7F70, Expression *, VisitLoop, (app::DebugViewWriter * this_ptr, app::LoopExpression * node));
IL2CPP_REGISTER_METHOD(0x01FA80C0, SwitchCase *, VisitSwitchCase, (app::DebugViewWriter * this_ptr, app::SwitchCase * node));
IL2CPP_REGISTER_METHOD(0x01FA8370, Expression *, VisitSwitch, (app::DebugViewWriter * this_ptr, app::SwitchExpression * node));
IL2CPP_REGISTER_METHOD(0x01FA85D0, CatchBlock *, VisitCatchBlock, (app::DebugViewWriter * this_ptr, app::CatchBlock * node));
IL2CPP_REGISTER_METHOD(0x01FA8760, Expression *, VisitTry, (app::DebugViewWriter * this_ptr, app::TryExpression * node));
IL2CPP_REGISTER_METHOD(0x01FA89C0, Expression *, VisitIndex, (app::DebugViewWriter * this_ptr, app::IndexExpression * node));
IL2CPP_REGISTER_METHOD(0x01FA8AC0, Expression *, VisitExtension, (app::DebugViewWriter * this_ptr, app::Expression * node));
IL2CPP_REGISTER_METHOD(0x01FA8CD0, Expression *, VisitDebugInfo, (app::DebugViewWriter * this_ptr, app::DebugInfoExpression * node));
IL2CPP_REGISTER_METHOD(0x01FA9070, void, DumpLabel, (app::DebugViewWriter * this_ptr, app::LabelTarget * target));
IL2CPP_REGISTER_METHOD(0x01FA91C0, String *, GetLabelTargetName, (app::DebugViewWriter * this_ptr, app::LabelTarget * target));
IL2CPP_REGISTER_METHOD(0x01FA9310, void, WriteLambda, (app::DebugViewWriter * this_ptr, app::LambdaExpression * lambda));
IL2CPP_REGISTER_METHOD(0x01FA9530, String *, GetLambdaName, (app::DebugViewWriter * this_ptr, app::LambdaExpression * lambda));
IL2CPP_REGISTER_METHOD(0x01FA96A0, bool, ContainsWhiteSpace, (app::String * name));
IL2CPP_REGISTER_METHOD(0x01FA9790, String *, QuoteName, (app::String * name));
IL2CPP_REGISTER_METHOD(0x01FA98A0, String *, GetDisplayName, (app::String * name));
...
IL2CPP_REGISTER_METHOD(0x0153B940, Expression *, VisitLambda, (app::DebugViewWriter * this_ptr, app::Expression_1_System_Object_ * node));
