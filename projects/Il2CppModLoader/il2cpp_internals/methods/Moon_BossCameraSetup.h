...
IL2CPP_REGISTER_METHOD(0x00CBCEC0, SuspendableMask__Enum, get_Mask, (app::BossCameraSetup * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CBED60, void, __ctor, (app::BossCameraSetup * this_ptr));
}
