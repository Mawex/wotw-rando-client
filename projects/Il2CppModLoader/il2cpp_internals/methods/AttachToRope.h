...
namespace app::methods::AttachToRope {
    IL2CPP_REGISTER_METHOD(0x002FBB60, ConfigurableJoint*, get_GeneratedConfigurableJoint, (app::AttachToRope * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00850F10, void, __ctor, (app::AttachToRope * this_ptr));
} // namespace app::methods::AttachToRope
