...
IL2CPP_REGISTER_METHOD(0x005FDE00, EntityDamageEvent *, get_DamageEvent, (app::MantisHitReactionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009FE1C0, BehaviourStatus__Enum, OnExecuteTask, (app::MantisHitReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x009FE4B0, void, __ctor, (app::MantisHitReactionBehaviour * this_ptr));
}
