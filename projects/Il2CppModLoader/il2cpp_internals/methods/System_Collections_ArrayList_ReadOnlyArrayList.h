...
namespace app::methods::System_Collections::ArrayList_ReadOnlyArrayList {
IL2CPP_REGISTER_METHOD(0x0201C4D0, void, __ctor, (app::ArrayList_ReadOnlyArrayList * this_ptr, app::ArrayList * l));
...
IL2CPP_REGISTER_METHOD(0x0201C5E0, Object *, get_Item, (app::ArrayList_ReadOnlyArrayList * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x0201C680, Object *, get_SyncRoot, (app::ArrayList_ReadOnlyArrayList * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0201C870, Object *, Clone, (app::ArrayList_ReadOnlyArrayList * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0201CAB0, IEnumerator *, GetEnumerator, (app::ArrayList_ReadOnlyArrayList * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0201CDB0, Object__Array *, ToArray_1, (app::ArrayList_ReadOnlyArrayList * this_ptr));
IL2CPP_REGISTER_METHOD(0x0201CDE0, Array *, ToArray_2, (app::ArrayList_ReadOnlyArrayList * this_ptr, app::Type * type));
}
