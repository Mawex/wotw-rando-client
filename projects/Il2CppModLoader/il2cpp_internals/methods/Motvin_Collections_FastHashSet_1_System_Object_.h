...
namespace app::methods::Motvin_Collections::FastHashSet_1_System_Object_ {
...
IL2CPP_REGISTER_METHOD(0x002FBB00, IEqualityComparer_1_System_Object_ *, get_Comparer, (app::FastHashSet_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AF89C0, void, __ctor_1, (app::FastHashSet_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02AF8A20, void, __ctor_2, (app::FastHashSet_1_System_Object_ * this_ptr, app::IEnumerable_1_System_Object_ * collection));
IL2CPP_REGISTER_METHOD(0x02AF8A90, void, __ctor_3, (app::FastHashSet_1_System_Object_ * this_ptr, app::IEqualityComparer_1_System_Object_ * comparer));
IL2CPP_REGISTER_METHOD(0x02AF8B00, void, __ctor_4, (app::FastHashSet_1_System_Object_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02AF8B70, void, __ctor_5, (app::FastHashSet_1_System_Object_ * this_ptr, app::IEnumerable_1_System_Object_ * collection, app::IEqualityComparer_1_System_Object_ * comparer));
IL2CPP_REGISTER_METHOD(0x02AF8BE0, void, __ctor_6, (app::FastHashSet_1_System_Object_ * this_ptr, int32_t capacity, app::IEqualityComparer_1_System_Object_ * comparer));
...
IL2CPP_REGISTER_METHOD(0x02AFB2E0, int32_t, GetNewSlotsArraySizeIncrease, (app::FastHashSet_1_System_Object_ * this_ptr, app::int32_t * old_array_size));
...
IL2CPP_REGISTER_METHOD(0x02AFB720, FastHashSet_1_T_TNode_System_Object___Array *, IncreaseCapacityNoCopy, (app::FastHashSet_1_System_Object_ * this_ptr, int32_t capacity_increase));
...
IL2CPP_REGISTER_METHOD(0x02AFCA80, int32_t, AddToHashSetIfNotFound, (app::FastHashSet_1_System_Object_ * this_ptr, app::Object * * item, int32_t hash, app::bool * is_found));
...
IL2CPP_REGISTER_METHOD(0x02AFDD40, Object * *, FindOrAdd, (app::FastHashSet_1_System_Object_ * this_ptr, app::Object * * item, app::bool * is_found));
IL2CPP_REGISTER_METHOD(0x02AFE040, Object * *, Find, (app::FastHashSet_1_System_Object_ * this_ptr, app::Object * * item, app::bool * is_found));
IL2CPP_REGISTER_METHOD(0x02AFE270, Object * *, FindAndRemoveIf, (app::FastHashSet_1_System_Object_ * this_ptr, app::Object * * item, app::Predicate_1_Object_ * remove_if_pred_is_true, app::bool * is_found, app::bool * is_removed));
IL2CPP_REGISTER_METHODINFO(0x04719988, FastHashSet_1_System_Object__FindAndRemoveIf__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02AFE790, void, FindInSlotsArray_1, (app::FastHashSet_1_System_Object_ * this_ptr, app::Object * * item, app::int32_t * found_node_index, app::int32_t * prior_node_index, app::int32_t * buckets_index));
...
IL2CPP_REGISTER_METHOD(0x02AFEDC0, FastHashSet_1_T_FoundType_System_Object_ *, FindInSlotsArrayAndMark, (app::FastHashSet_1_System_Object_ * this_ptr, app::Object * * item, app::int32_t * found_node_index));
IL2CPP_REGISTER_METHOD(0x02AFF000, List_1_Motvin_Collections_ChainLevelAndCount_ *, GetChainLevelsCounts, (app::FastHashSet_1_System_Object_ * this_ptr, app::double * avg_node_visits_per_chain));
...
IL2CPP_REGISTER_METHOD(0x02B03E60, IEnumerator_1_System_Object_ *, GetEnumerator, (app::FastHashSet_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02B03E60, IEnumerator *, IEnumerable_GetEnumerator, (app::FastHashSet_1_System_Object_ * this_ptr));
