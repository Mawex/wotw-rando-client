...
namespace app::methods::FullSerializer_Internal::fsVersionManager {
IL2CPP_REGISTER_METHOD(0x01502EE0, fsResult, GetVersionImportPath, (app::String * current_version, app::fsVersionedType target_version, app::List_1_FullSerializer_Internal_fsVersionedType_ * * path));
...
IL2CPP_REGISTER_METHOD(0x015035B0, fsOption_1_fsVersionedType_, GetVersionedType, (app::Type * type));
