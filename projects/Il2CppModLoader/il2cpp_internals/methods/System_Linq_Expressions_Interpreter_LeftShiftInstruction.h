...
namespace app::methods::System_Linq_Expressions_Interpreter::LeftShiftInstruction {
...
IL2CPP_REGISTER_METHOD(0x01CE51C0, String *, get_InstructionName, (app::LeftShiftInstruction * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::LeftShiftInstruction * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CE5240, Instruction *, Create, (app::Type * type));
