...
namespace app::methods::System_Net::Base64Stream_WriteAsyncResult {
IL2CPP_REGISTER_METHOD(0x020139E0, void, __ctor, (app::Base64Stream_WriteAsyncResult * this_ptr, app::Base64Stream * parent, app::Byte__Array * buffer, int32_t offset, int32_t count, app::AsyncCallback * callback, app::Object * state));
