...
namespace app::methods::TriangleNet_IO::TriangleFormat {
IL2CPP_REGISTER_METHOD(0x02621520, bool, IsSupported, (app::TriangleFormat * this_ptr, app::String * file));
IL2CPP_REGISTER_METHOD(0x02621670, IMesh *, Import, (app::TriangleFormat * this_ptr, app::String * filename));
...
IL2CPP_REGISTER_METHOD(0x02621C80, IPolygon *, Read, (app::TriangleFormat * this_ptr, app::String * filename));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::TriangleFormat * this_ptr));
}
