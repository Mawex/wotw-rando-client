...
IL2CPP_REGISTER_METHOD(0x0256FFC0, Transform *, GetTarget, (app::UberTransformFollow * this_ptr, int32_t idx));
...
IL2CPP_REGISTER_METHOD(0x02570C20, ValueTuple_2_UnityEngine_Vector3_UnityEngine_Vector3_, DoPositionAndRotation, (app::UberTransformFollow * this_ptr, float delta_time));
IL2CPP_REGISTER_METHOD(0x025712B0, Vector3, DoPosition, (app::UberTransformFollow * this_ptr, float delta_time, app::Vector3 my_position, app::Vector3 avg_position));
IL2CPP_REGISTER_METHOD(0x02571F30, Vector3, DoRotation, (app::UberTransformFollow * this_ptr, float delta_time, app::Vector3 my_position, app::Vector3 my_rotation, app::Vector3 avg_position, app::Vector3 avg_rotation));
...
IL2CPP_REGISTER_METHOD(0x02573100, Vector3, ComputeLookRotation3D, (app::UberTransformFollow * this_ptr, app::Vector3 from, app::Vector3 to));
...
IL2CPP_REGISTER_METHOD(0x02573700, void, __ctor, (app::UberTransformFollow * this_ptr));
