...
namespace app::methods::Moon_ArtOptimization::ArtOptimizer {
...
IL2CPP_REGISTER_METHOD(0x01344850, void, __ctor, (app::ArtOptimizer * this_ptr));
IL2CPP_REGISTER_METHOD(0x01344E50, void, __cctor, ());
}
