...
IL2CPP_REGISTER_METHOD(0x00420EE0, AnimationType__Enum, get_Type, (app::ClipAnimation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01B0CE50, MoonAnimation_RootMotionSample, EvaluateRootMotion, (app::ClipAnimation * this_ptr, float time, app::AnimationParameterSet * parameter_set));
IL2CPP_REGISTER_METHOD(0x002FA000, void, RefreshRootMotionData, (app::ClipAnimation * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B0D070, void, __ctor, (app::ClipAnimation * this_ptr));
}
