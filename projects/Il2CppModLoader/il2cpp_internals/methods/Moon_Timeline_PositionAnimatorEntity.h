...
namespace app::methods::Moon_Timeline::PositionAnimatorEntity {
IL2CPP_REGISTER_METHOD(0x01E794A0, Transform *, get_TransformTarget, (app::PositionAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E79530, GameObject *, get_ExternalTarget, (app::PositionAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E795E0, Transform *, get_EffectiveTransform, (app::PositionAnimatorEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E79B80, Vector3, GetOffsetAtValue, (app::PositionAnimatorEntity * this_ptr, float value));
IL2CPP_REGISTER_METHOD(0x01E79CF0, bool, GetCurrentValueAssociatedWithCurve, (app::PositionAnimatorEntity * this_ptr, app::String * curve, app::float * value));
IL2CPP_REGISTER_METHOD(0x01E79F60, void, OnBeforeSerialize, (app::PositionAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC20, MoonReference_1_UnityEngine_Transform_ *, GetTransformTarget, (app::PositionAnimatorEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BB9E30, GameObject *, get_ObservedTarget, (app::PositionAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00910BD0, SetupStateModifierDataType__Enum, get_ObservedModifierType, (app::PositionAnimatorEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E7AED0, void, __ctor, (app::PositionAnimatorEntity * this_ptr));
}
