...
IL2CPP_REGISTER_METHOD(0x0100F690, SeinInteraction_ThrowKeystoneSettings__Array *, get_CurrentThrowKeystoneSet, (app::SeinInteraction * this_ptr));
IL2CPP_REGISTER_METHOD(0x0100F710, SeinInteraction_ThrowKeystoneSettings *, get_CurrentThrowKeystoneSetting, (app::SeinInteraction * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0100F940, SeinInteraction_KeystoneThrowMode__Enum, get_SuitableThrowMode, (app::SeinInteraction * this_ptr));
IL2CPP_REGISTER_METHOD(0x0100F960, bool, get_IsOnGround, (app::SeinInteraction * this_ptr));
IL2CPP_REGISTER_METHOD(0x0100FAE0, PlatformMovement *, get_PlatformMovement, (app::SeinInteraction * this_ptr));
IL2CPP_REGISTER_METHOD(0x0100FC30, MoonAnimator *, get_KuAnimator, (app::SeinInteraction * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01011EB0, ICharacterInteractable *, GetAvailableInteractable, (app::SeinInteraction * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01012C70, NPCEntity *, get_CurrentNpc, (app::SeinInteraction * this_ptr));
IL2CPP_REGISTER_METHOD(0x01012D30, MoonAnimation *, get_ListenAnimation, (app::SeinInteraction * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01013CF0, void, __ctor, (app::SeinInteraction * this_ptr));
