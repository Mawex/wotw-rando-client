...
IL2CPP_REGISTER_METHOD(0x00DBF870, String__Array *, GetDataHeaderNames, (app::DRSCaptureAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00DBF9B0, String__Array *, GetFrameData_1, (app::DRSCaptureAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::DRSCaptureAgent * this_ptr));
}
