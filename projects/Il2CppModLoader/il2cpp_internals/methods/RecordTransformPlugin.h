...
IL2CPP_REGISTER_METHOD(0x00735E00, Vector4, QuaternionToVector, (app::RecordTransformPlugin * this_ptr, app::Quaternion q));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::RecordTransformPlugin * this_ptr));
}
