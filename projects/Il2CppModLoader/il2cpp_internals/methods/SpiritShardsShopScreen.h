...
IL2CPP_REGISTER_METHOD(0x006B8940, CleverMenuItemSelectionManager *, get_NavigationManager, (app::SpiritShardsShopScreen * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417920, MenuTabBackground__Enum, get_BackgroundMode, (app::SpiritShardsShopScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D77870, SpellUIItem *, get_SelectedSpellUIItem, (app::SpiritShardsShopScreen * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D77970, PlayerUberStateInventory_InventoryItem *, get_SelectedSpell, (app::SpiritShardsShopScreen * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D77B10, SpiritShardShopUIItem *, get_SelectedSpiritShardUIItem, (app::SpiritShardsShopScreen * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D77C10, PlayerUberStateShards_Shard *, get_SelectedSpiritShard, (app::SpiritShardsShopScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C1F020, SuspendableMask__Enum, get_Mask, (app::SpiritShardsShopScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D795A0, PlayerUberStateShards_Shard *, GetActualInventoryItem, (app::SpiritShardsShopScreen * this_ptr, app::SpiritShardType__Enum typ));
...
IL2CPP_REGISTER_METHOD(0x002FBCC0, GameObject *, get_EffectTarget, (app::SpiritShardsShopScreen * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D7A820, Event_1 *, get_PurchaseCompleteSound, (app::SpiritShardsShopScreen * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D7A840, Event_1 *, get_PurchaseBeginSound, (app::SpiritShardsShopScreen * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D7A860, RTPC *, get_PurchaseRTPC, (app::SpiritShardsShopScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D7B590, void, __ctor, (app::SpiritShardsShopScreen * this_ptr));
}
