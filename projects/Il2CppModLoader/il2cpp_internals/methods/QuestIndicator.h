...
IL2CPP_REGISTER_METHOD(0x00E8A8E0, Vector3, get_TargetPositon, (app::QuestIndicator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00723FF0, void, __ctor, (app::QuestIndicator * this_ptr));
}
