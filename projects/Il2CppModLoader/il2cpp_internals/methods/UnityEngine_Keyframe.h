...
IL2CPP_REGISTER_METHOD(0x001F2820, void, __ctor_1, (app::Keyframe__Boxed * this_ptr, float time, float value));
IL2CPP_REGISTER_METHOD(0x001F2840, void, __ctor_2, (app::Keyframe__Boxed * this_ptr, float time, float value, float in_tangent, float out_tangent));
...
IL2CPP_REGISTER_METHOD(0x00120160, WeightedMode__Enum, get_weightedMode, (app::Keyframe__Boxed * this_ptr));
