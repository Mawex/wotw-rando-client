...
namespace app::methods::moonTools_recording::ScreenshotRecorder {
IL2CPP_REGISTER_METHOD(0x00F717F0, bool, get_Enabled, ());
IL2CPP_REGISTER_METHOD(0x00F718C0, void, set_Enabled, (bool value));
IL2CPP_REGISTER_METHOD(0x00F71BA0, String *, get_OutputDirectory, (app::ScreenshotRecorder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F72870, void, __ctor, (app::ScreenshotRecorder * this_ptr));
