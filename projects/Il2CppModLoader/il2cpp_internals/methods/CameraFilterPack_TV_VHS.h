...
IL2CPP_REGISTER_METHOD(0x020EE460, Material *, get_material, (app::CameraFilterPack_TV_VHS * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020EEDB0, void, __ctor, (app::CameraFilterPack_TV_VHS * this_ptr));
}
