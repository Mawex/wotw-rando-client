...
IL2CPP_REGISTER_METHOD(0x002FD750, SuspendableMask__Enum, get_Mask, (app::AlignSplineToVerletStructure * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004F2730, void, __ctor, (app::AlignSplineToVerletStructure * this_ptr));
}
