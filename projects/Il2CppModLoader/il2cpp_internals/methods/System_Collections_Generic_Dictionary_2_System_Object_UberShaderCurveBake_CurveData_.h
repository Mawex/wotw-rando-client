...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ {
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor_1, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02259DF0, void, __ctor_2, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x0283AC50, void, __ctor_3, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr, app::IEqualityComparer_1_System_Object_ * comparer));
IL2CPP_REGISTER_METHOD(0x02E8A9B0, void, __ctor_4, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr, int32_t capacity, app::IEqualityComparer_1_System_Object_ * comparer));
IL2CPP_REGISTER_METHODINFO(0x0475B768, Dictionary_2_System_Object_UberShaderCurveBake_CurveData___ctor_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0283ADC0, void, __ctor_5, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr, app::IDictionary_2_System_Object_UberShaderCurveBake_CurveData_ * dictionary));
IL2CPP_REGISTER_METHOD(0x02E8AAF0, void, __ctor_6, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr, app::IDictionary_2_System_Object_UberShaderCurveBake_CurveData_ * dictionary, app::IEqualityComparer_1_System_Object_ * comparer));
IL2CPP_REGISTER_METHODINFO(0x0478D638, Dictionary_2_System_Object_UberShaderCurveBake_CurveData___ctor_5__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02E8AF00, void, __ctor_7, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
IL2CPP_REGISTER_METHOD(0x002FB990, IEqualityComparer_1_System_Object_ *, get_Comparer, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0283B2B0, Dictionary_2_TKey_TValue_KeyCollection_System_Object_UberShaderCurveBake_CurveData_ *, get_Keys, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B2B0, ICollection_1_System_Object_ *, System_Collections_Generic_IDictionary_TKey_TValue__get_Keys, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B2B0, IEnumerable_1_System_Object_ *, System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Keys, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B3E0, Dictionary_2_TKey_TValue_ValueCollection_System_Object_UberShaderCurveBake_CurveData_ *, get_Values, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B3E0, ICollection_1_UberShaderCurveBake_CurveData_ *, System_Collections_Generic_IDictionary_TKey_TValue__get_Values, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B3E0, IEnumerable_1_UberShaderCurveBake_CurveData_ *, System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Values, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02E8AFD0, UberShaderCurveBake_CurveData, get_Item, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr, app::Object * key));
...
IL2CPP_REGISTER_METHOD(0x02DA8610, Dictionary_2_TKey_TValue_Enumerator_System_Object_UberShaderCurveBake_CurveData_, GetEnumerator, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02DA8680, IEnumerator_1_KeyValuePair_2_System_Object_UberShaderCurveBake_CurveData_ *, System_Collections_Generic_IEnumerable_System_Collections_Generic_KeyValuePair_TKey_TValue___GetEnumerator, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02DA8680, IEnumerator *, IEnumerable_GetEnumerator, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02E8D240, Object *, ICollection_get_SyncRoot, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0283E020, ICollection *, IDictionary_get_Keys, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283E050, ICollection *, IDictionary_get_Values, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02DD8610, Object *, IDictionary_get_Item, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr, app::Object * key));
...
IL2CPP_REGISTER_METHOD(0x02DAB050, IDictionaryEnumerator *, IDictionary_GetEnumerator, (app::Dictionary_2_System_Object_UberShaderCurveBake_CurveData_ * this_ptr));
