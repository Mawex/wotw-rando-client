...
namespace app::methods::System_Security_Cryptography_X509Certificates::X509Helper2 {
...
IL2CPP_REGISTER_METHOD(0x0257BF50, X509Certificate_1 *, GetNativeInstance, (app::X509CertificateImpl * impl));
IL2CPP_REGISTER_METHODINFO(0x04729EF8, X509Helper2_GetNativeInstance__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0257BFA0, X509Certificate2Impl *, Import_1, (app::Byte__Array * raw_data, app::String * password, app::X509KeyStorageFlags__Enum key_storage_flags, bool disable_provider));
IL2CPP_REGISTER_METHOD(0x0257C120, X509Certificate2Impl *, Import_2, (app::X509Certificate_1 * cert, bool disable_provider));
IL2CPP_REGISTER_METHOD(0x021C5A50, X509Certificate_2 *, GetMonoCertificate, (app::X509Certificate2 * certificate));
IL2CPP_REGISTER_METHODINFO(0x04780110, X509Helper2_GetMonoCertificate__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0257C2A0, X509ChainImpl *, CreateChainImpl, (bool use_machine_context));
