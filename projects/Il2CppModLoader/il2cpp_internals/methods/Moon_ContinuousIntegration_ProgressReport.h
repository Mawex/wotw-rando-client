...
IL2CPP_REGISTER_METHOD(0x00502220, String *, Build_1, (app::ProgressReport * this_ptr, app::String * task_name));
IL2CPP_REGISTER_METHOD(0x0318BB30, String *, Build_2, (app::ProgressReport * this_ptr, app::String * task_name, int32_t task_index, int32_t task_count));
}
