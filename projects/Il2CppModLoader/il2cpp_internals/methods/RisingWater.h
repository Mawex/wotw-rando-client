...
namespace app::methods::RisingWater {
    ...
    IL2CPP_REGISTER_METHOD(0x003FF3C0, SuspendableMask__Enum, get_Mask, (app::RisingWater * this_ptr));
    IL2CPP_REGISTER_METHOD(0x013584B0, void, set_Mask, (app::RisingWater * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x01358560, void, __ctor, (app::RisingWater * this_ptr));
