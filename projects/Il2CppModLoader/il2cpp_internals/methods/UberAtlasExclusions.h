...
IL2CPP_REGISTER_METHOD(0x013DE2F0, void, BuildDictionary, (UberAtlasExclusions * __this));
IL2CPP_REGISTER_METHOD(0x013DE530, void, __ctor, (UberAtlasExclusions * __this));
}
