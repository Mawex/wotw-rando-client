...
IL2CPP_REGISTER_METHOD(0x0064EB90, Vector3, get_SmoothedWorldSpeed, (app::OriPredictionHelper * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B8DCD0, Vector3, GetOriPredictedPosition, (app::OriPredictionHelper * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C32620, void, __ctor, (app::OriPredictionHelper * this_ptr));
}
