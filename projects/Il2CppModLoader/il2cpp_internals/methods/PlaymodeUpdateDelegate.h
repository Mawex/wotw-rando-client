...
IL2CPP_REGISTER_METHOD(0x02EA0B20, PlaymodeUpdateDelegate *, get_Instance, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x02EA0EC0, void, __cctor, (MethodInfo * method));
}
