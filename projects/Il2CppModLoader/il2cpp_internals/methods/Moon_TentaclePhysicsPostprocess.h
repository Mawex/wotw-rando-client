...
IL2CPP_REGISTER_METHOD(0x010ADED0, TentaclePhysicsController *, get_PhysCtrl, (app::TentaclePhysicsPostprocess * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010B2E70, Quaternion, GetSimpleHeadRot, (app::TentaclePhysicsPostprocess * this_ptr, app::Vector3__Array * joint_pos));
...
IL2CPP_REGISTER_METHOD(0x010B3F90, Vector3, ApplyTargetIKToJoint, (app::TentaclePhysicsPostprocess * this_ptr, app::Vector3 joint_pos, app::Vector3 ref_origin, app::Vector3 ref_tangent, app::Vector3 ref_normal, app::Vector3 target_tangent, app::Vector3 target_normal, float target_tangent_scale, float weight));
...
IL2CPP_REGISTER_METHOD(0x010B4D00, void, __ctor, (app::TentaclePhysicsPostprocess * this_ptr));
