...
namespace app::methods::System_Xml::XmlUtf8RawTextWriterIndent {
IL2CPP_REGISTER_METHOD(0x01FC8790, void, __ctor, (app::XmlUtf8RawTextWriterIndent * this_ptr, app::Stream * stream, app::XmlWriterSettings * settings));
