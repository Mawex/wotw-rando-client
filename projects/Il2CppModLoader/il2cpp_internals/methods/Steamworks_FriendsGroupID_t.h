...
namespace app::methods::Steamworks::FriendsGroupID_t {
    IL2CPP_REGISTER_METHOD(0x00113CD0, void, __ctor, (app::FriendsGroupID_t__Boxed * this_ptr, int16_t value));
    ...
    IL2CPP_REGISTER_METHOD(0x015FADA0, bool, operator____1, (app::FriendsGroupID_t x, app::FriendsGroupID_t y));
    IL2CPP_REGISTER_METHOD(0x015FADB0, bool, operator____2, (app::FriendsGroupID_t x, app::FriendsGroupID_t y));
    IL2CPP_REGISTER_METHOD(0x015FAE60, app::FriendsGroupID_t, operator__1, (int16_t value));
    IL2CPP_REGISTER_METHOD(0x015FAE60, int16_t, operator__2, (app::FriendsGroupID_t that));
