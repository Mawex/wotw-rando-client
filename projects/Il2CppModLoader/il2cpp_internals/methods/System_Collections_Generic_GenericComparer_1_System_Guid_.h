...
namespace app::methods::System_Collections_Generic::GenericComparer_1_System_Guid_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0225BDA0, void, __ctor, (app::GenericComparer_1_System_Guid_ * this_ptr));
}
