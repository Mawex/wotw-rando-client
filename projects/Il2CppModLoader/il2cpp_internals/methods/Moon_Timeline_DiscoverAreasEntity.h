...
namespace app::methods::Moon_Timeline::DiscoverAreasEntity {
IL2CPP_REGISTER_METHOD(0x00764800, SpellUIExperience *, get_Experience, (app::DiscoverAreasEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00765D00, void, __ctor, (app::DiscoverAreasEntity * this_ptr));
