...
namespace app::methods::System_Linq_Expressions_Interpreter::NewInstruction {
...
IL2CPP_REGISTER_METHOD(0x02401D90, String *, get_InstructionName, (app::NewInstruction * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02401F60, Object__Array *, GetArgs, (app::NewInstruction * this_ptr, app::InterpretedFrame * frame, int32_t first));
IL2CPP_REGISTER_METHOD(0x024020D0, String *, ToString, (app::NewInstruction * this_ptr));
}
