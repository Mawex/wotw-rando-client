...
namespace app::methods::System_Security_Cryptography::RandomNumberGenerator {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::RandomNumberGenerator * this_ptr));
IL2CPP_REGISTER_METHOD(0x028EE2B0, RandomNumberGenerator *, Create_1, ());
IL2CPP_REGISTER_METHOD(0x028EE3F0, RandomNumberGenerator *, Create_2, (app::String * rng_name));
