...
namespace app::methods::System_Data::DataRowCollection {
IL2CPP_REGISTER_METHOD(0x017E0200, void, __ctor, (app::DataRowCollection * this_ptr, app::DataTable * table));
IL2CPP_REGISTER_METHOD(0x017E0400, int32_t, get_Count, (app::DataRowCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x017E0490, DataRow *, get_Item, (app::DataRowCollection * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x017E0A80, DataRow *, AddWithColumnEvents, (app::DataRowCollection * this_ptr, app::Object__Array * values));
...
IL2CPP_REGISTER_METHOD(0x017E10B0, IEnumerator *, GetEnumerator, (app::DataRowCollection * this_ptr));
}
