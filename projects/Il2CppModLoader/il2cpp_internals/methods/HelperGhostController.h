...
IL2CPP_REGISTER_METHOD(0x010A3C10, IEnumerator *, OnFinishedRoutive, (app::HelperGhostController * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::HelperGhostController * this_ptr));
}
