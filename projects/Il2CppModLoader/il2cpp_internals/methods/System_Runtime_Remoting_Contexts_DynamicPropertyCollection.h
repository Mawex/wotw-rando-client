...
namespace app::methods::System_Runtime_Remoting_Contexts::DynamicPropertyCollection {
    ...
    IL2CPP_REGISTER_METHOD(0x023061F0, void, __ctor, (app::DynamicPropertyCollection * this_ptr));
}
