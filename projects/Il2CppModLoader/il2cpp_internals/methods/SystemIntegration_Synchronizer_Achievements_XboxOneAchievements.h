...
namespace app::methods::SystemIntegration_Synchronizer_Achievements::XboxOneAchievements {
IL2CPP_REGISTER_METHOD(0x00532FC0, bool, get_Disable, ());
IL2CPP_REGISTER_METHOD(0x00533040, void, set_Disable, (bool value));
IL2CPP_REGISTER_METHOD(0x005330D0, String *, get_Name, (app::XboxOneAchievements_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA280, CacheData__Array *, AwardedOnServer, (app::XboxOneAchievements_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00533210, void, __ctor, (app::XboxOneAchievements_1 * this_ptr));
}
