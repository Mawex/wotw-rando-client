...
namespace app::methods::System_Collections_Generic::List_1_SpiritSentry_ {
...
IL2CPP_REGISTER_METHOD(0x025EFC50, SpiritSentry *, get_Item, (app::List_1_SpiritSentry_ * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x04747298, List_1_SpiritSentry__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_SpiritSentry_ * this_ptr));
