...
IL2CPP_REGISTER_METHOD(0x00A11DB0, MasterTimelineSequence_SceneEntry *, FindSceneToPreloadAtTime, (app::MasterTimelineSequence * this_ptr, float time));
...
IL2CPP_REGISTER_METHOD(0x00A138B0, void, __ctor, (app::MasterTimelineSequence * this_ptr));
