...
namespace app::methods::Moon_TimeSlicer::TimeSlicedSimpleJob {
...
IL2CPP_REGISTER_METHOD(0x010C47E0, void, __ctor, (app::TimeSlicedSimpleJob * this_ptr, app::TimeSlicedSimpleJob_TimeSlicedJobDelegate * job, app::GameObject * owner, app::Func_1_String_ * contextual_data));
...
IL2CPP_REGISTER_METHOD(0x010C4860, String *, get_JobName, (app::TimeSlicedSimpleJob * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, get_TimesliceJobOwnerName, (app::TimeSlicedSimpleJob * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010C48E0, String *, get_ContextualDebugData, (app::TimeSlicedSimpleJob * this_ptr));
