...
namespace app::methods::System_Text::DecoderNLS {
IL2CPP_REGISTER_METHOD(0x0244A220, void, __ctor_1, (app::DecoderNLS * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
...
IL2CPP_REGISTER_METHOD(0x0244A470, void, __ctor_2, (app::DecoderNLS * this_ptr, app::Encoding * encoding));
IL2CPP_REGISTER_METHOD(0x0244A4A0, void, __ctor_3, (app::DecoderNLS * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0244A6D0, int32_t, GetCharCount_3, (app::DecoderNLS * this_ptr, app::uint8_t * bytes, int32_t count, bool flush));
...
IL2CPP_REGISTER_METHOD(0x0244AB40, int32_t, GetChars_3, (app::DecoderNLS * this_ptr, app::uint8_t * bytes, int32_t byte_count, app::uint16_t * chars, int32_t char_count, bool flush));
IL2CPP_REGISTER_METHODINFO(0x0475A0E0, DecoderNLS_GetChars_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0244ACE0, void, Convert_1, (app::DecoderNLS * this_ptr, app::Byte__Array * bytes, int32_t byte_index, int32_t byte_count, app::Char__Array * chars, int32_t char_index, int32_t char_count, bool flush, app::int32_t * bytes_used, app::int32_t * chars_used, app::bool * completed));
IL2CPP_REGISTER_METHODINFO(0x0474A010, DecoderNLS_Convert__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0244B030, void, Convert_2, (app::DecoderNLS * this_ptr, app::uint8_t * bytes, int32_t byte_count, app::uint16_t * chars, int32_t char_count, bool flush, app::int32_t * bytes_used, app::int32_t * chars_used, app::bool * completed));
