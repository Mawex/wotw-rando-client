...
IL2CPP_REGISTER_METHOD(0x02530570, void, __ctor, (app::Logger * this_ptr, app::ILogHandler * log_handler));
IL2CPP_REGISTER_METHOD(0x01F2AB40, ILogHandler *, get_logHandler, (app::Logger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024AD180, LogType__Enum, get_filterLogType, (app::Logger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025305C0, String *, GetString, (app::Object * message));
