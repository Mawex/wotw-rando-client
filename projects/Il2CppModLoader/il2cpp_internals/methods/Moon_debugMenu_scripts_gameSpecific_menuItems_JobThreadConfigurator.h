...
IL2CPP_REGISTER_METHOD(0x00F2BFB0, JobThreadConfigurator_SaveIOThreadingMode__Enum, get_SaveIOThreadMode, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x00F2C050, void, set_SaveIOThreadMode, (JobThreadConfigurator_SaveIOThreadingMode__Enum value));
IL2CPP_REGISTER_METHOD(0x00F2C120, JobThreadConfigurator_ThreadingMode__Enum, get_CurrentThreadingMode, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x00F2C1C0, void, set_CurrentThreadingMode, (JobThreadConfigurator_ThreadingMode__Enum value));
IL2CPP_REGISTER_METHOD(0x00F2C290, ThreadPriority__Enum_1, get_RenderThreadPriority, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x00F2C330, void, set_RenderThreadPriority, (ThreadPriority__Enum_1 value));
IL2CPP_REGISTER_METHOD(0x00F2C400, JobThreadConfigurator_PreloadManagerThreadingMode__Enum, get_PreloadManagerMode, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x00F2C570, void, __cctor, (MethodInfo * method));
}
