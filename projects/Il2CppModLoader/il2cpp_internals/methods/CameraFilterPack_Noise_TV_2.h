...
IL2CPP_REGISTER_METHOD(0x02482E90, Material *, get_material, (app::CameraFilterPack_Noise_TV_2 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E9B00, void, __ctor, (app::CameraFilterPack_Noise_TV_2 * this_ptr));
}
