...
IL2CPP_REGISTER_METHOD(0x024DE600, Material *, get_material, (app::CameraFilterPack_Colors_Adjust_PreFilters * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024DF880, void, __ctor, (app::CameraFilterPack_Colors_Adjust_PreFilters * this_ptr));
}
