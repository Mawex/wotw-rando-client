...
namespace app::methods::Moon_ContinuousIntegration::RecorderSettings {
IL2CPP_REGISTER_METHOD(0x031C46C0, RecorderSettings *, get_Instance, ());
IL2CPP_REGISTER_METHOD(0x031C4740, void, set_Instance, (app::RecorderSettings * value));
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_ShotName, (app::RecorderSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031C47E0, RecorderSettings *, Create, (app::IRecorderShot * shot, bool show_input_screen, bool dump_frames, bool spawn_enemies, float playback_scale, bool scale_entire_shot, bool enable_motion_blur, bool enable120_f_p_s));
IL2CPP_REGISTER_METHOD(0x031C4A70, void, Reset, ());
IL2CPP_REGISTER_METHOD(0x031C4A80, void, __ctor, (app::RecorderSettings * this_ptr));
}
