...
IL2CPP_REGISTER_METHOD(0x02465DD0, Material *, get_material, (app::CameraFilterPack_Edge_Sigmoid * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024666C0, void, __ctor, (app::CameraFilterPack_Edge_Sigmoid * this_ptr));
}
