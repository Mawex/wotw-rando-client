...
namespace app::methods::FPSMonitor {
    ...
    IL2CPP_REGISTER_METHOD(0x002FB990, DroppedFrameMonitor*, get_DroppedFrameMonitor, (app::FPSMonitor * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00989C40, FPSMonitor_FrameTimingData*, GetFrameAtIndex, (app::FPSMonitor * this_ptr, int32_t index));
    IL2CPP_REGISTER_METHOD(0x00989C80, FPSMonitor_FrameTimingData*, GetFrameAtOffset, (app::FPSMonitor * this_ptr, int32_t offset));
    IL2CPP_REGISTER_METHOD(0x00989CF0, FPSMonitor_FrameTimingData*, get_CurrentFrame, (app::FPSMonitor * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0098A8C0, void, __ctor, (app::FPSMonitor * this_ptr));
