...
namespace app::methods::System_Net_Configuration::BypassElement {
IL2CPP_REGISTER_METHOD(0x02018500, void, __ctor_1, (app::BypassElement * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0477BF78, BypassElement__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02018530, void, __ctor_2, (app::BypassElement * this_ptr, app::String * address));
IL2CPP_REGISTER_METHODINFO(0x047227C8, BypassElement__ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02018560, String *, get_Address, (app::BypassElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020185C0, ConfigurationPropertyCollection *, get_Properties, (app::BypassElement * this_ptr));
