...
namespace app::methods::System_Net_Configuration::AuthenticationModuleElementCollection {
IL2CPP_REGISTER_METHOD(0x020181A0, void, __ctor, (app::AuthenticationModuleElementCollection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04710510, AuthenticationModuleElementCollection__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020181D0, AuthenticationModuleElement *, get_Item_1, (app::AuthenticationModuleElementCollection * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02018230, AuthenticationModuleElement *, get_Item_2, (app::AuthenticationModuleElementCollection * this_ptr, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x020182F0, ConfigurationElement *, CreateNewElement, (app::AuthenticationModuleElementCollection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04725E78, AuthenticationModuleElementCollection_CreateNewElement__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02018320, Object *, GetElementKey, (app::AuthenticationModuleElementCollection * this_ptr, app::ConfigurationElement * element));
