...
namespace app::methods::System_Data_SqlTypes::SqlBoolean {
IL2CPP_REGISTER_METHOD(0x001D6160, void, __ctor_1, (app::SqlBoolean__Boxed * this_ptr, bool value));
IL2CPP_REGISTER_METHOD(0x001D6170, void, __ctor_2, (app::SqlBoolean__Boxed * this_ptr, int32_t value));
IL2CPP_REGISTER_METHOD(0x001D6180, void, __ctor_3, (app::SqlBoolean__Boxed * this_ptr, int32_t value, bool f_null));
...
IL2CPP_REGISTER_METHOD(0x01E4FB30, SqlBoolean, operator___1, (app::SqlBoolean x, app::SqlBoolean y));
IL2CPP_REGISTER_METHOD(0x01E4FC80, SqlBoolean, operator___2, (app::SqlBoolean x, app::SqlBoolean y));
...
IL2CPP_REGISTER_METHOD(0x001D61E0, String *, ToString, (app::SqlBoolean__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E4FE80, SqlBoolean, operator___, (app::SqlBoolean x, app::SqlBoolean y));
IL2CPP_REGISTER_METHOD(0x01E4FF50, SqlBoolean, And, (app::SqlBoolean x, app::SqlBoolean y));
IL2CPP_REGISTER_METHOD(0x01E50120, SqlBoolean, Or, (app::SqlBoolean x, app::SqlBoolean y));
...
IL2CPP_REGISTER_METHOD(0x0013BB70, XmlSchema *, IXmlSerializable_GetSchema, (app::SqlBoolean__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E50490, XmlQualifiedName *, GetXsdType, (app::XmlSchemaSet * schema_set));
