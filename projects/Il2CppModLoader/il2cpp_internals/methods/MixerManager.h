...
IL2CPP_REGISTER_METHOD(0x0132C9C0, MixerManager *, get_Instance, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x0132D770, AudioMixer *, GetMasterMixer, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0132D950, AudioMixerGroup *, GetMixerGroup, (MixerGroupType__Enum group));
IL2CPP_REGISTER_METHOD(0x0132E410, void, WarmUpResource, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0132E4A0, void, __ctor, (MixerManager * __this));
IL2CPP_REGISTER_METHOD(0x0132E740, void, __cctor, (MethodInfo * method));
}
