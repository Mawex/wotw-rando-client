...
IL2CPP_REGISTER_METHOD(0x003FF8B0, SpellUIConfirmationOverlay_Context__Enum, get_CurrentContext, (app::SpellUIConfirmationOverlay * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00946590, void, __ctor, (app::SpellUIConfirmationOverlay * this_ptr));
}
