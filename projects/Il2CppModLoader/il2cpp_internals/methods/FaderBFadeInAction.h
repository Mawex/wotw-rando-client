...
IL2CPP_REGISTER_METHOD(0x00993EB0, String *, GetNiceName, (app::FaderBFadeInAction * this_ptr));
IL2CPP_REGISTER_METHOD(0x00993F70, void, __ctor, (app::FaderBFadeInAction * this_ptr));
}
