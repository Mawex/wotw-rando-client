...
namespace app::methods::System_Collections_Generic::List_1_PlayFab_ClientModels_LinkedPlatformAccountModel_ {
    ...
    IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_PlayFab_ClientModels_LinkedPlatformAccountModel_ * this_ptr));
