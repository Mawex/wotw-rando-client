...
namespace app::methods::System_Net_Configuration::SmtpSpecifiedPickupDirectoryElement {
IL2CPP_REGISTER_METHOD(0x01E99260, void, __ctor, (app::SmtpSpecifiedPickupDirectoryElement * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04718AB8, SmtpSpecifiedPickupDirectoryElement__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E99290, String *, get_PickupDirectoryLocation, (app::SmtpSpecifiedPickupDirectoryElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E992F0, ConfigurationPropertyCollection *, get_Properties, (app::SmtpSpecifiedPickupDirectoryElement * this_ptr));
