...
namespace app::methods::System_Linq_Expressions_Interpreter::OffsetInstruction {
    ...
    IL2CPP_REGISTER_METHOD(0x01834240, void, __ctor, (app::OffsetInstruction * this_ptr));
}
