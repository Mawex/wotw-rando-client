...
namespace app::methods::System_Data::Listeners_1_DataViewListener_ {
IL2CPP_REGISTER_METHOD(0x02FAEC80, void, __ctor, (app::Listeners_1_DataViewListener_ * this_ptr, int32_t object_i_d, app::Listeners_1_TElem_Func_2_DataViewListener_DataViewListener_System_Boolean_ * notify_filter));
