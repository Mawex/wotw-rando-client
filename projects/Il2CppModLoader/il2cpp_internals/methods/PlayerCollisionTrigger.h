...
IL2CPP_REGISTER_METHOD(0x0043D9A0, SelectableCategory__Enum, get_Category, (app::PlayerCollisionTrigger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0140C7F0, String *, get_StressTestName, (app::PlayerCollisionTrigger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008519C0, StressTestStatus__Enum, get_StressTestStatus, (app::PlayerCollisionTrigger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0140D120, void, __ctor, (app::PlayerCollisionTrigger * this_ptr));
}
