...
namespace app::methods::Newtonsoft_Json_Linq::JPropertyDescriptor {
IL2CPP_REGISTER_METHOD(0x01F0E5C0, void, __ctor, (app::JPropertyDescriptor * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x00417870, bool, CanResetValue, (app::JPropertyDescriptor * this_ptr, app::Object * component));
IL2CPP_REGISTER_METHOD(0x01F0E5D0, Object *, GetValue, (app::JPropertyDescriptor * this_ptr, app::Object * component));
...
IL2CPP_REGISTER_METHOD(0x01F0E900, Type *, get_ComponentType, (app::JPropertyDescriptor * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_IsReadOnly, (app::JPropertyDescriptor * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F0E9A0, Type *, get_PropertyType, (app::JPropertyDescriptor * this_ptr));
