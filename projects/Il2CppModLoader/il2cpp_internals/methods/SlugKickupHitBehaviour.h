...
IL2CPP_REGISTER_METHOD(0x006C7DB0, BehaviourStatus__Enum, OnExecuteTask, (app::SlugKickupHitBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x006C8710, void, __ctor, (app::SlugKickupHitBehaviour * this_ptr));
}
