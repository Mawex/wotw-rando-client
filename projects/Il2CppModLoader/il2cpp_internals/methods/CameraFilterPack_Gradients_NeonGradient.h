...
IL2CPP_REGISTER_METHOD(0x0247C240, Material *, get_material, (app::CameraFilterPack_Gradients_NeonGradient * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0247C860, void, __ctor, (app::CameraFilterPack_Gradients_NeonGradient * this_ptr));
}
