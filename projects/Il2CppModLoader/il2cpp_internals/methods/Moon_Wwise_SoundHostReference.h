...
namespace app::methods::Moon_Wwise::SoundHostReference {
IL2CPP_REGISTER_METHOD(0x001FE930, void, __ctor, (app::SoundHostReference__Boxed * this_ptr, app::ISoundHost * host));
