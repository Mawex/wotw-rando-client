...
namespace app::methods::Moon_Timeline::UberShaderAnimatorStrategyStandard_RendererState {
...
IL2CPP_REGISTER_METHOD(0x00D18DD0, Color, GetBaseColor, (app::UberShaderAnimatorStrategyStandard_RendererState * this_ptr, app::Renderer * renderer, app::UberShaderProperty_Color__Enum property));
...
IL2CPP_REGISTER_METHOD(0x00D19700, void, __ctor, (app::UberShaderAnimatorStrategyStandard_RendererState * this_ptr));
}
