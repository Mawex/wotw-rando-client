...
namespace app::methods::System_Data::DataRelationCollection_DataSetRelationCollection {
IL2CPP_REGISTER_METHOD(0x023A7010, void, __ctor, (app::DataRelationCollection_DataSetRelationCollection * this_ptr, app::DataSet * data_set));
IL2CPP_REGISTER_METHODINFO(0x04734D60, DataRelationCollection_DataSetRelationCollection__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FB9D0, ArrayList *, get_List, (app::DataRelationCollection_DataSetRelationCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x023A7190, void, Clear, (app::DataRelationCollection_DataSetRelationCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9B0, DataSet *, GetDataSet, (app::DataRelationCollection_DataSetRelationCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x023A71D0, DataRelation *, get_Item_1, (app::DataRelationCollection_DataSetRelationCollection * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x04792428, DataRelationCollection_DataSetRelationCollection_get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x023A72E0, DataRelation *, get_Item_2, (app::DataRelationCollection_DataSetRelationCollection * this_ptr, app::String * name));
