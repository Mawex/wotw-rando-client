...
IL2CPP_REGISTER_METHOD(0x00C7C010, Vector3, get_Position, (app::ProjectileSpawner * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C7CA90, Projectile *, SpawnProjectile, (app::ProjectileSpawner * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C7CE50, GameObject *, SpawnProjectileGameObject, (app::ProjectileSpawner * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003FFB70, SuspendableMask__Enum, get_Mask, (app::ProjectileSpawner * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C7D9F0, void, __ctor, (app::ProjectileSpawner * this_ptr));
}
