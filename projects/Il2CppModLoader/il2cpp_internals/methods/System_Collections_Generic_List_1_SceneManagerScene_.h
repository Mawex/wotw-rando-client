...
namespace app::methods::System_Collections_Generic::List_1_SceneManagerScene_ {
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_SceneManagerScene_, GetEnumerator, (app::List_1_SceneManagerScene_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04704698, List_1_SceneManagerScene__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EFC50, SceneManagerScene *, get_Item, (app::List_1_SceneManagerScene_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, SceneManagerScene__Array *, ToArray, (app::List_1_SceneManagerScene_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04715BB0, List_1_SceneManagerScene__ToArray__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_SceneManagerScene_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04701380, List_1_SceneManagerScene___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_SceneManagerScene_ * this_ptr, int32_t capacity));
