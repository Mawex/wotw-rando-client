...
IL2CPP_REGISTER_METHOD(0x0257AAB0, void, __ctor, (app::MoonMath_VerletDynamicsValue * this_ptr, float X, float K, float friction, float max_speed, float min_x, float max_x));
