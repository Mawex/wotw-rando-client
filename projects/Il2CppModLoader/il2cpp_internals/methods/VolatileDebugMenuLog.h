...
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_Path, (app::VolatileDebugMenuLog * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9A0, void, set_Path, (app::VolatileDebugMenuLog * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB9B0, String *, get_Text, (app::VolatileDebugMenuLog * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9C0, void, set_Text, (app::VolatileDebugMenuLog * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB9D0, String *, get_HelpText, (app::VolatileDebugMenuLog * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9F0, Func_1_String_ *, get_DynamicText, (app::VolatileDebugMenuLog * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB60, List_1_List_1_IDebugMenuItem_ *, get_Items, (app::VolatileDebugMenuLog * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::VolatileDebugMenuLog * this_ptr));
