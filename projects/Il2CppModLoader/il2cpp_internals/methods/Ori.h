...
namespace app::methods::Ori {
    IL2CPP_REGISTER_METHOD(0x0061E140, Transform*, get_m_target, (app::Ori * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0061E240, Vector3, get_TargetPosition, (app::Ori * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0061E300, Vector3, get_HoverOffset, (app::Ori * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0061E4B0, Vector3, get_Position, (app::Ori * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0061E5E0, SuspendableMask__Enum, get_Mask, (app::Ori * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00620970, Color, SetRGB, (app::Ori * this_ptr, app::Color old, app::Color new_color));
    ...
    IL2CPP_REGISTER_METHOD(0x00620A30, void, __ctor, (app::Ori * this_ptr));
} // namespace app::methods::Ori
