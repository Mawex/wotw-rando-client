...
namespace app::methods::System_Collections_Generic::List_1_System_ByteEnum_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_System_ByteEnum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_System_ByteEnum_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02F53730, void, __ctor_3, (app::List_1_System_ByteEnum_ * this_ptr, app::IEnumerable_1_System_ByteEnum_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02F53BB0, Object *, ICollection_get_SyncRoot, (app::List_1_System_ByteEnum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02F50D40, ByteEnum__Enum, get_Item, (app::List_1_System_ByteEnum_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02F50EA0, Object *, IList_get_Item, (app::List_1_System_ByteEnum_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_System_ByteEnum_ *, AsReadOnly, (app::List_1_System_ByteEnum_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F51620, ByteEnum__Enum, Find, (app::List_1_System_ByteEnum_ * this_ptr, app::Predicate_1_ByteEnum_ * match));
IL2CPP_REGISTER_METHOD(0x02F51700, List_1_System_ByteEnum_ *, FindAll, (app::List_1_System_ByteEnum_ * this_ptr, app::Predicate_1_ByteEnum_ * match));
...
IL2CPP_REGISTER_METHOD(0x02F51B80, List_1_T_Enumerator_System_ByteEnum_, GetEnumerator, (app::List_1_System_ByteEnum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02F51BC0, IEnumerator_1_System_ByteEnum_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_System_ByteEnum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02F51BC0, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_System_ByteEnum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_System_ByteEnum_ *, GetRange, (app::List_1_System_ByteEnum_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, ByteEnum__Enum__Array *, ToArray, (app::List_1_System_ByteEnum_ * this_ptr));
