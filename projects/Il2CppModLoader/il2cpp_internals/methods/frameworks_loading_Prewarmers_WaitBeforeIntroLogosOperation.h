...
namespace app::methods::frameworks_loading_Prewarmers::WaitBeforeIntroLogosOperation {
    IL2CPP_REGISTER_METHOD(0x00F62B80, void, __ctor, (app::WaitBeforeIntroLogosOperation * this_ptr));
