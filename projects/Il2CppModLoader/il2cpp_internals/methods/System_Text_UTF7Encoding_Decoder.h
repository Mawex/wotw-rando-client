...
namespace app::methods::System_Text::UTF7Encoding_Decoder {
IL2CPP_REGISTER_METHOD(0x0244A470, void, __ctor_1, (app::UTF7Encoding_Decoder * this_ptr, app::UTF7Encoding * encoding));
IL2CPP_REGISTER_METHOD(0x027CD830, void, __ctor_2, (app::UTF7Encoding_Decoder * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
