...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_String_System_Object_ {
...
IL2CPP_REGISTER_METHOD(0x02BA5400, Dictionary_2_TKey_TValue_Enumerator_System_String_System_Object_, GetEnumerator, (app::Dictionary_2_System_String_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0475D790, Dictionary_2_System_String_System_Object__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02BD24D0, Object *, get_Item, (app::Dictionary_2_System_String_System_Object_ * this_ptr, app::String * key));
...
IL2CPP_REGISTER_METHOD(0x0283B2B0, Dictionary_2_TKey_TValue_KeyCollection_System_String_System_Object_ *, get_Keys, (app::Dictionary_2_System_String_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0470AB08, Dictionary_2_System_String_System_Object__get_Keys__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0283B3E0, Dictionary_2_TKey_TValue_ValueCollection_System_String_System_Object_ *, get_Values, (app::Dictionary_2_System_String_System_Object_ * this_ptr));
