...
namespace app::methods::PetrifiedOwlBossTripleSlamBehaviour_LoopState {
    IL2CPP_REGISTER_METHOD(0x017813E0, void, __ctor, (app::PetrifiedOwlBossTripleSlamBehaviour_LoopState * this_ptr, app::PetrifiedOwlBossTripleSlamBehaviour * behaviour));
