...
namespace app::methods::System_Net::ServicePoint {
IL2CPP_REGISTER_METHOD(0x01BD4A90, void, __ctor_1, (app::ServicePoint * this_ptr, app::Uri * uri, int32_t connection_limit, int32_t max_idle_time));
IL2CPP_REGISTER_METHOD(0x002FA280, Uri *, get_Address, (app::ServicePoint * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BD4C30, Exception *, GetMustImplement, ());
IL2CPP_REGISTER_METHOD(0x002FBBC0, BindIPEndPoint *, get_BindIPEndPointDelegate, (app::ServicePoint * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BD4EA0, String *, get_ConnectionName, (app::ServicePoint * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FD1D0, int32_t, get_CurrentConnections, (app::ServicePoint * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BD4EC0, DateTime, get_IdleSince, (app::ServicePoint * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, Version *, get_ProtocolVersion, (app::ServicePoint * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BD5890, WebConnectionGroup *, GetConnectionGroup, (app::ServicePoint * this_ptr, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x01BD6780, IPHostEntry *, get_HostEntry, (app::ServicePoint * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9C0, void, SetVersion, (app::ServicePoint * this_ptr, app::Version * version));
IL2CPP_REGISTER_METHOD(0x01BD6C10, EventHandler *, SendRequest, (app::ServicePoint * this_ptr, app::HttpWebRequest * request, app::String * group_name));
IL2CPP_REGISTER_METHOD(0x01BD6F90, bool, CloseConnectionGroup, (app::ServicePoint * this_ptr, app::String * connection_group_name));
IL2CPP_REGISTER_METHOD(0x01BD70C0, X509Certificate_1 *, get_Certificate, (app::ServicePoint * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BD7340, X509Certificate_1 *, get_ClientCertificate, (app::ServicePoint * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BD7710, Socket *, GetConnection, (app::ServicePoint * this_ptr, app::PooledStream * pooled_stream, app::Object * owner, bool async, app::IPAddress * * address, app::Socket * * abort_socket, app::Socket * * abort_socket6));
...
IL2CPP_REGISTER_METHOD(0x01BD7770, void, __ctor_2, (app::ServicePoint * this_ptr));
