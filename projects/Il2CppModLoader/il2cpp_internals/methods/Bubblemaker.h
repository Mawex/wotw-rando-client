...
namespace app::methods::Bubblemaker {
    IL2CPP_REGISTER_METHOD(0x00654950, SuspendableMask__Enum, get_Mask, (app::Bubblemaker * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00805420, void, __ctor, (app::Bubblemaker * this_ptr));
} // namespace app::methods::Bubblemaker
