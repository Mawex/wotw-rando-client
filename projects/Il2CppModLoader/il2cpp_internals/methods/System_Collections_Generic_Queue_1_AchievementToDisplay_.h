...
namespace app::methods::System_Collections_Generic::Queue_1_AchievementToDisplay_ {
...
IL2CPP_REGISTER_METHOD(0x0243D360, AchievementToDisplay, Dequeue, (app::Queue_1_AchievementToDisplay_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0243CB70, void, __ctor_1, (app::Queue_1_AchievementToDisplay_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04795C80, Queue_1_AchievementToDisplay___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0243CBB0, void, __ctor_2, (app::Queue_1_AchievementToDisplay_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x0243CCE0, Object *, ICollection_get_SyncRoot, (app::Queue_1_AchievementToDisplay_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0243D290, Queue_1_T_Enumerator_AchievementToDisplay_, GetEnumerator, (app::Queue_1_AchievementToDisplay_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0243D2D0, IEnumerator_1_AchievementToDisplay_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::Queue_1_AchievementToDisplay_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0243D2D0, IEnumerator *, IEnumerable_GetEnumerator, (app::Queue_1_AchievementToDisplay_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0243D430, AchievementToDisplay, Peek, (app::Queue_1_AchievementToDisplay_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0243D4B0, bool, Contains, (app::Queue_1_AchievementToDisplay_ * this_ptr, app::AchievementToDisplay item));
IL2CPP_REGISTER_METHOD(0x0243D5D0, AchievementToDisplay__Array *, ToArray, (app::Queue_1_AchievementToDisplay_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0243D6C0, void, SetCapacity, (app::Queue_1_AchievementToDisplay_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x0243D7A0, void, MoveNext, (app::Queue_1_AchievementToDisplay_ * this_ptr, app::int32_t * index));
