...
IL2CPP_REGISTER_METHOD(0x01202580, SuspendableMask__Enum, get_Mask, (app::DynamicCameraTargetting * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01202F50, void, AdjustCameraTargetWeightForLeashHooks, (app::float * weight, app::ICameraTarget * target, app::CameraTargetData * data, app::Vector3 primary_target_position));
...
IL2CPP_REGISTER_METHOD(0x01203BF0, Rect, GetRect, (app::DynamicCameraTargetting * this_ptr, app::CameraTargetSettings setting, app::Vector3 primary_target_position));
IL2CPP_REGISTER_METHOD(0x0111EBE0, Vector3, GetTargetPos, (app::DynamicCameraTargetting * this_ptr, app::CameraTargetSettings setting));
IL2CPP_REGISTER_METHOD(0x01203DA0, Rect, BoundingRectangle, (app::DynamicCameraTargetting * this_ptr, app::List_1_UnityEngine_Rect_ * rects));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, GlobalBrightnessController_BrigthnessContributionOrder__Enum, get_BrightnessInfluceOrder, (app::DynamicCameraTargetting * this_ptr));
IL2CPP_REGISTER_METHOD(0x01206910, void, __ctor, (app::DynamicCameraTargetting * this_ptr));
}
