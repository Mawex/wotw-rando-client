...
IL2CPP_REGISTER_METHOD(0x016A8680, CameraSettings *, GetSettings, (app::CameraSettingsZone * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00910BD0, SelectableCategory__Enum, get_Category, (app::CameraSettingsZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x016A9380, void, __ctor, (app::CameraSettingsZone * this_ptr));
