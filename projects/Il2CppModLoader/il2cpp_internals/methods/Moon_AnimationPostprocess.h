...
IL2CPP_REGISTER_METHOD(0x00597B10, UpdateType__Enum, get_UpdateType, (app::AnimationPostprocess * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01B04300, GameObject *, get_AnimatedObject, (app::AnimationPostprocess * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008A2C20, void, __ctor, (app::AnimationPostprocess * this_ptr));
}
