...
namespace app::methods::System_Security_Cryptography::SHA256Managed {
IL2CPP_REGISTER_METHOD(0x028F7DA0, void, __ctor, (app::SHA256Managed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x028F7EC0, Byte__Array *, HashFinal, (app::SHA256Managed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x028F82B0, Byte__Array *, _EndHash, (app::SHA256Managed * this_ptr));
IL2CPP_REGISTER_METHOD(0x028F8550, void, SHATransform, (app::uint32_t * expanded_buffer, app::uint32_t * state, app::uint8_t * block));
...
IL2CPP_REGISTER_METHOD(0x028F9070, void, SHA256Expand, (app::uint32_t * x));
