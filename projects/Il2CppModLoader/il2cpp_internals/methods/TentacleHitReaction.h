...
IL2CPP_REGISTER_METHOD(0x002FBC20, EntityDamageEvent *, get_DamageEvent, (app::TentacleHitReaction * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D014B0, BehaviourStatus__Enum, OnExecuteTask, (app::TentacleHitReaction * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00D01540, void, OnExitTask, (app::TentacleHitReaction * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00D01550, Vector3, ProcessKickback, (app::TentacleHitReaction * this_ptr, app::Damage * damage, float multiplier, float knockup_multiplier));
...
IL2CPP_REGISTER_METHOD(0x00D01AF0, void, __ctor, (app::TentacleHitReaction * this_ptr));
}
