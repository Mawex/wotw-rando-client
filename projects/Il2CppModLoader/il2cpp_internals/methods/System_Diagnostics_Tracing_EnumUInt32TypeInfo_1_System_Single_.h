...
namespace app::methods::System_Diagnostics_Tracing::EnumUInt32TypeInfo_1_System_Single_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0298B8E0, void, __ctor, (app::EnumUInt32TypeInfo_1_System_Single_ * this_ptr));
}
