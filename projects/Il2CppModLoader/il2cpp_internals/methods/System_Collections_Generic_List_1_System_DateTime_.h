...
namespace app::methods::System_Collections_Generic::List_1_System_DateTime_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_System_DateTime_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_System_DateTime_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02EF1620, void, __ctor_3, (app::List_1_System_DateTime_ * this_ptr, app::IEnumerable_1_System_DateTime_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02EF1AA0, Object *, ICollection_get_SyncRoot, (app::List_1_System_DateTime_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025EFC50, DateTime, get_Item, (app::List_1_System_DateTime_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025EFDB0, Object *, IList_get_Item, (app::List_1_System_DateTime_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_System_DateTime_ *, AsReadOnly, (app::List_1_System_DateTime_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025F05A0, DateTime, Find, (app::List_1_System_DateTime_ * this_ptr, app::Predicate_1_DateTime_ * match));
IL2CPP_REGISTER_METHOD(0x025F0680, List_1_System_DateTime_ *, FindAll, (app::List_1_System_DateTime_ * this_ptr, app::Predicate_1_DateTime_ * match));
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_System_DateTime_, GetEnumerator, (app::List_1_System_DateTime_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025F0B50, IEnumerator_1_System_DateTime_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_System_DateTime_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025F0B50, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_System_DateTime_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_System_DateTime_ *, GetRange, (app::List_1_System_DateTime_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, DateTime__Array *, ToArray, (app::List_1_System_DateTime_ * this_ptr));
