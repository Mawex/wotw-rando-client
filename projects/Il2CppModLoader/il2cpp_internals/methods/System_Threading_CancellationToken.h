...
namespace app::methods::System_Threading::CancellationToken {
...
IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor, (app::CancellationToken__Boxed * this_ptr, app::CancellationTokenSource * source));
...
IL2CPP_REGISTER_METHOD(0x00206B20, CancellationTokenRegistration, Register_1, (app::CancellationToken__Boxed * this_ptr, app::Action * callback));
IL2CPP_REGISTER_METHODINFO(0x0476BC18, CancellationToken_Register__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00206B50, CancellationTokenRegistration, InternalRegisterWithoutEC, (app::CancellationToken__Boxed * this_ptr, app::Action_1_Object_ * callback, app::Object * state));
IL2CPP_REGISTER_METHOD(0x00206B90, CancellationTokenRegistration, Register_2, (app::CancellationToken__Boxed * this_ptr, app::Action_1_Object_ * callback, app::Object * state, bool use_synchronization_context, bool use_execution_context));
...
IL2CPP_REGISTER_METHOD(0x027D8D80, bool, operator____1, (app::CancellationToken left, app::CancellationToken right));
IL2CPP_REGISTER_METHOD(0x027D8DA0, bool, operator____2, (app::CancellationToken left, app::CancellationToken right));
