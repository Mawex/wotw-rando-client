...
IL2CPP_REGISTER_METHOD(0x01494FE0, Vector3, get_PatrolOrigin, (app::GroundPatrolWithDirectionBehaviourNew * this_ptr));
IL2CPP_REGISTER_METHOD(0x01495030, Vector3, get_TargetPosition, (app::GroundPatrolWithDirectionBehaviourNew * this_ptr));
IL2CPP_REGISTER_METHOD(0x01495080, Vector2, get_MovingDirection, (app::GroundPatrolWithDirectionBehaviourNew * this_ptr));
IL2CPP_REGISTER_METHOD(0x014952A0, Vector2, get_MovingDirectionRotated, (app::GroundPatrolWithDirectionBehaviourNew * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014956F0, BehaviourStatus__Enum, OnExecute, (app::GroundPatrolWithDirectionBehaviourNew * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01495C20, BehaviourStatus__Enum, UpdateIdle, (app::GroundPatrolWithDirectionBehaviourNew * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01496C30, BehaviourStatus__Enum, ChangePatrolDirection, (app::GroundPatrolWithDirectionBehaviourNew * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01496D50, void, __ctor, (app::GroundPatrolWithDirectionBehaviourNew * this_ptr));
}
