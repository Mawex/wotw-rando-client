...
namespace app::methods::Newtonsoft_Json_Utilities::JavaScriptUtils {
IL2CPP_REGISTER_METHOD(0x0301B750, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x0301C5B0, Boolean__Array *, GetCharEscapeFlags, (app::StringEscapeHandling__Enum string_escape_handling, uint16_t quote_char));
...
IL2CPP_REGISTER_METHOD(0x0301CDE0, String *, ToEscapedJavaScriptString, (app::String * value, uint16_t delimiter, bool append_delimiters, app::StringEscapeHandling__Enum string_escape_handling));
