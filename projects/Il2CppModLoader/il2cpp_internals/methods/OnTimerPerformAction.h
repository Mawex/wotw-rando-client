...
IL2CPP_REGISTER_METHOD(0x004C6660, SuspendableMask__Enum, get_Mask, (app::OnTimerPerformAction * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006146F0, void, __ctor, (app::OnTimerPerformAction * this_ptr));
}
