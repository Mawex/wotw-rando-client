...
namespace app::methods::System_Text::EncoderNLS {
IL2CPP_REGISTER_METHOD(0x0244D970, void, __ctor_1, (app::EncoderNLS * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
...
IL2CPP_REGISTER_METHOD(0x0244DBE0, void, __ctor_2, (app::EncoderNLS * this_ptr, app::Encoding * encoding));
IL2CPP_REGISTER_METHOD(0x0244DC10, void, __ctor_3, (app::EncoderNLS * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0244DE50, int32_t, GetByteCount_2, (app::EncoderNLS * this_ptr, app::uint16_t * chars, int32_t count, bool flush));
...
IL2CPP_REGISTER_METHOD(0x0244E280, int32_t, GetBytes_2, (app::EncoderNLS * this_ptr, app::uint16_t * chars, int32_t char_count, app::uint8_t * bytes, int32_t byte_count, bool flush));
IL2CPP_REGISTER_METHODINFO(0x04797B68, EncoderNLS_GetBytes_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0244E420, void, Convert_1, (app::EncoderNLS * this_ptr, app::Char__Array * chars, int32_t char_index, int32_t char_count, app::Byte__Array * bytes, int32_t byte_index, int32_t byte_count, bool flush, app::int32_t * chars_used, app::int32_t * bytes_used, app::bool * completed));
IL2CPP_REGISTER_METHODINFO(0x047198A0, EncoderNLS_Convert__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0244E770, void, Convert_2, (app::EncoderNLS * this_ptr, app::uint16_t * chars, int32_t char_count, app::uint8_t * bytes, int32_t byte_count, bool flush, app::int32_t * chars_used, app::int32_t * bytes_used, app::bool * completed));
IL2CPP_REGISTER_METHODINFO(0x047506E0, EncoderNLS_Convert_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FBB00, Encoding *, get_Encoding, (app::EncoderNLS * this_ptr));
