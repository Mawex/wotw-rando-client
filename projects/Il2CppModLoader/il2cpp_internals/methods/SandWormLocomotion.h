...
IL2CPP_REGISTER_METHOD(0x006A63A0, Transform *, get_FeetTransform, (app::SandWormLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C1ED20, Vector3, get_FeetPosition, (app::SandWormLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C1EDB0, Vector3, get_UpDirection, (app::SandWormLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C1EE70, void, set_UpDirection, (app::SandWormLocomotion * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x006D6510, SandWormLocomotion_SpeedSetting__Enum, get_CurrentSpeedSettings, (app::SandWormLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C1F020, EntityWeightData_EntityWeight__Enum, get_Weight, (app::SandWormLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C1F040, SuspendableMask__Enum, get_Mask, (app::SandWormLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C1F250, Vector2, GetCurrentVelocity, (app::SandWormLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0071F210, EntityLocomotionTask *, get_DefaultFSMState, (app::SandWormLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C1F4E0, EntityLocomotionTask *, GetNextBehaviour, (app::SandWormLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C1FD50, void, __ctor, (app::SandWormLocomotion * this_ptr));
}
