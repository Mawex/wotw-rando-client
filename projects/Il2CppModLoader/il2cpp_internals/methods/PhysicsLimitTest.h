...
IL2CPP_REGISTER_METHOD(0x01152C10, String *, get_Path, (app::PhysicsLimitTest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011530C0, String *, get_Name, (app::PhysicsLimitTest * this_ptr));
IL2CPP_REGISTER_METHOD(0x01153140, String *, get_HelpText, (app::PhysicsLimitTest * this_ptr));
IL2CPP_REGISTER_METHOD(0x011531C0, String__Array *, get_ToggleOptions, (app::PhysicsLimitTest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01153D00, void, __ctor, (app::PhysicsLimitTest * this_ptr));
