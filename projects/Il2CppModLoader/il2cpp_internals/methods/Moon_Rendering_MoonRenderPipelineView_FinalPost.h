...
namespace app::methods::Moon_Rendering::MoonRenderPipelineView_FinalPost {
IL2CPP_REGISTER_METHOD(0x00EAD3B0, Material *, get_Material, ());
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MoonRenderPipelineView_FinalPost * this_ptr));
}
