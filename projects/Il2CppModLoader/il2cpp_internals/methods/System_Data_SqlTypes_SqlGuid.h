...
namespace app::methods::System_Data_SqlTypes::SqlGuid {
    ...
    IL2CPP_REGISTER_METHOD(0x022B00A0, app::SqlGuid, operator__1, (app::Guid x));
    ...
    IL2CPP_REGISTER_METHOD(0x022B0260, app::SqlGuid, operator__2, (app::SqlBinary x));
    IL2CPP_REGISTER_METHOD(0x022B0350, app::SqlBoolean, operator___, (app::SqlGuid x, app::SqlGuid y));
    IL2CPP_REGISTER_METHOD(0x022B0450, app::SqlBoolean, operator___1, (app::SqlGuid x, app::SqlGuid y));
    IL2CPP_REGISTER_METHOD(0x022B0550, app::SqlBoolean, operator___2, (app::SqlGuid x, app::SqlGuid y));
