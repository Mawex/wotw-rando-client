...
namespace app::methods::Moon_HierarchyPerformanceTest::HierarchyPerformanceTester_Old {
...
IL2CPP_REGISTER_METHOD(0x0149D370, List_1_Moon_HierarchyPerformanceTest_HPerfTestResult_ *, SortResults, (app::HierarchyPerformanceTester_Old * this_ptr, app::HashSet_1_Moon_HierarchyPerformanceTest_HPerfTestResult_ * results));
...
IL2CPP_REGISTER_METHOD(0x0149EC90, String *, GetFullPath, (app::HierarchyPerformanceTester_Old * this_ptr, app::GameObject * game_object));
IL2CPP_REGISTER_METHOD(0x0149EEC0, GameObject *, GetArtGroupGameObject, (app::HierarchyPerformanceTester_Old * this_ptr, app::SceneRoot * scene_root));
IL2CPP_REGISTER_METHOD(0x0149F160, void, __ctor, (app::HierarchyPerformanceTester_Old * this_ptr));
}
