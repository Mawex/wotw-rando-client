...
IL2CPP_REGISTER_METHOD(0x01365120, Vector2, WorldToGround, (app::RollingMovement * this_ptr, app::Vector2 world));
IL2CPP_REGISTER_METHOD(0x01365170, Vector2, GroundToWorld, (app::RollingMovement * this_ptr, app::Vector2 local));
...
IL2CPP_REGISTER_METHOD(0x002FD490, SuspendableMask__Enum, get_Mask, (app::RollingMovement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01366000, Vector3, get_GroundBinormal, (app::RollingMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x01366150, void, FixedUpdate, (app::RollingMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x01366410, void, __ctor, (app::RollingMovement * this_ptr));
}
