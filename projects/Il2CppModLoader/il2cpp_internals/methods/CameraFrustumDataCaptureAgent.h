...
IL2CPP_REGISTER_METHOD(0x01689DC0, String__Array *, GetDataHeaderNames, (app::CameraFrustumDataCaptureAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x01689EB0, String__Array *, GetFrameData_1, (app::CameraFrustumDataCaptureAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::CameraFrustumDataCaptureAgent * this_ptr));
}
