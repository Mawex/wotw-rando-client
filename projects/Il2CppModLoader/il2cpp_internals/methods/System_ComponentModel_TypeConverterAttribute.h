...
namespace app::methods::System_ComponentModel::TypeConverterAttribute {
...
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_ConverterTypeName, (app::TypeConverterAttribute * this_ptr));
