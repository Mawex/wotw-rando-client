...
IL2CPP_REGISTER_METHOD(0x01051AC0, PlatformMovement *, get_PlatformMovement, (app::CharacterLeftRightMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x01301AA0, CharacterSpriteMirror *, get_SpriteMirror, (app::CharacterLeftRightMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC60, HorizontalPlatformMovementSettings *, get_CurrentSettings, (app::CharacterLeftRightMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCA0, HorizontalPlatformMovementSettings *, get_BaseSettings, (app::CharacterLeftRightMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD40, ICharacterTurningHandler *, get_TurningHandler, (app::CharacterLeftRightMovement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01301C10, HorizontalPlatformMovementSettings_SpeedSet *, get_SpeedSet, (app::CharacterLeftRightMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x01301C80, HorizontalPlatformMovementSettings_SpeedSet *, get_BaseSpeedSet, (app::CharacterLeftRightMovement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01302A10, void, __ctor, (app::CharacterLeftRightMovement * this_ptr));
}
