...
IL2CPP_REGISTER_METHOD(0x00E16AD0, GhostFrame_FrameDataTypes__Enum, get_FrameType, (app::GhostCharacterData * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E16AE0, int32_t, GetDataSize, (app::GhostCharacterData * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E16AF0, void, __ctor_1, (app::GhostCharacterData * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E16FE0, void, __ctor_2, (app::GhostCharacterData * this_ptr, app::BinaryReader * binary_reader));
