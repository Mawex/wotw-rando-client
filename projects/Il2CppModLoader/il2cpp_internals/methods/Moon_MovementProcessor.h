...
IL2CPP_REGISTER_METHOD(0x00F28550, Vector2, get_TargetLocalSpeed, (app::MovementProcessor * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MovementProcessor * this_ptr));
}
