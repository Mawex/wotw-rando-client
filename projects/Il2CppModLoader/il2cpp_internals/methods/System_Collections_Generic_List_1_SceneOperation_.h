...
namespace app::methods::System_Collections_Generic::List_1_SceneOperation_ {
IL2CPP_REGISTER_METHOD(0x025E9D20, List_1_T_Enumerator_SceneOperation_, GetEnumerator, (app::List_1_SceneOperation_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0471E338, List_1_SceneOperation__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8A60, SceneOperation, get_Item, (app::List_1_SceneOperation_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02E54760, Object *, ICollection_get_SyncRoot, (app::List_1_SceneOperation_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025E8BE0, Object *, IList_get_Item, (app::List_1_SceneOperation_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_SceneOperation_ *, AsReadOnly, (app::List_1_SceneOperation_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025E96E0, SceneOperation, Find, (app::List_1_SceneOperation_ * this_ptr, app::Predicate_1_SceneOperation_ * match));
IL2CPP_REGISTER_METHOD(0x025E9800, List_1_SceneOperation_ *, FindAll, (app::List_1_SceneOperation_ * this_ptr, app::Predicate_1_SceneOperation_ * match));
...
IL2CPP_REGISTER_METHOD(0x025E9D60, IEnumerator_1_SceneOperation_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_SceneOperation_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9D60, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_SceneOperation_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_SceneOperation_ *, GetRange, (app::List_1_SceneOperation_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, SceneOperation__Array *, ToArray, (app::List_1_SceneOperation_ * this_ptr));
