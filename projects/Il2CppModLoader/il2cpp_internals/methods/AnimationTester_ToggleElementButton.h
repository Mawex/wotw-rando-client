...
IL2CPP_REGISTER_METHOD(0x002FA280, AnimationTester_IToogleGroup *, get_ToogleGroup, (app::AnimationTester_ToggleElementButton * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01AFEC80, void, __ctor, (app::AnimationTester_ToggleElementButton * this_ptr, app::AnimationTester_IToogleGroup * group));
