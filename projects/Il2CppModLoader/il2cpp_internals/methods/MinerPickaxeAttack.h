...
IL2CPP_REGISTER_METHOD(0x0144F3A0, void, CalculateSlope, (app::MinerPickaxeAttack * this_ptr, app::float * slope_value));
...
IL2CPP_REGISTER_METHOD(0x0144FAC0, void, __ctor, (app::MinerPickaxeAttack * this_ptr));
}
