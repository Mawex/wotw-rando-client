...
IL2CPP_REGISTER_METHOD(0x024EF2B0, Material *, get_material, (app::CameraFilterPack_Drawing_CellShading2 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024EFC10, void, __ctor, (app::CameraFilterPack_Drawing_CellShading2 * this_ptr));
}
