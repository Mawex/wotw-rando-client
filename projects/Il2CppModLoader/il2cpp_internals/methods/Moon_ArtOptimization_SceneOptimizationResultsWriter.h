...
IL2CPP_REGISTER_METHOD(0x00CB0310, void, WriteReport, (SceneOptimizationResultsWriter * __this));
IL2CPP_REGISTER_METHOD(0x00CB1630, String *, PrintSceneResult, (SceneOptimizationResultsWriter * __this, SceneOptimizationResults * sceneResult));
}
