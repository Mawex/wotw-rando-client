...
namespace app::methods::System_Data::RBTree_1_System_Int32_ {
...
IL2CPP_REGISTER_METHOD(0x02FAF680, void, __ctor, (app::RBTree_1_System_Int32_ * this_ptr, app::TreeAccessMethod__Enum access_method));
...
IL2CPP_REGISTER_METHOD(0x02FAF9C0, RBTree_1_K_TreePage_System_Int32_ *, AllocPage, (app::RBTree_1_System_Int32_ * this_ptr, int32_t size));
...
IL2CPP_REGISTER_METHOD(0x02FB0900, bool, Successor_2, (app::RBTree_1_System_Int32_ * this_ptr, app::int32_t * node_id, app::int32_t * main_tree_node_id));
...
IL2CPP_REGISTER_METHOD(0x02FB3D40, RBTree_1_K_NodePath_System_Int32_, GetNodeByKey, (app::RBTree_1_System_Int32_ * this_ptr, int32_t key));
...
IL2CPP_REGISTER_METHOD(0x02FB4370, RBTree_1_K_NodePath_System_Int32_, GetNodeByIndex, (app::RBTree_1_System_Int32_ * this_ptr, int32_t user_index));
IL2CPP_REGISTER_METHODINFO(0x0477A140, RBTree_1_System_Int32__GetNodeByIndex__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02FB44A0, int32_t, ComputeNodeByIndex_1, (app::RBTree_1_System_Int32_ * this_ptr, int32_t index, app::int32_t * satellite_root_id));
...
IL2CPP_REGISTER_METHOD(0x02FB47F0, IEnumerator *, GetEnumerator, (app::RBTree_1_System_Int32_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02FB5710, RBTree_1_K_NodeColor_System_Int32_ *, color, (app::RBTree_1_System_Int32_ * this_ptr, int32_t node_id));
}
