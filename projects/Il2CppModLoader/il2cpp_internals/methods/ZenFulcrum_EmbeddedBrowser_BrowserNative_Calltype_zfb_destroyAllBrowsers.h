...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::BrowserNative_Calltype_zfb_destroyAllBrowsers {
    IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::BrowserNative_Calltype_zfb_destroyAllBrowsers * this_ptr, app::Object * object, void * method_1));
