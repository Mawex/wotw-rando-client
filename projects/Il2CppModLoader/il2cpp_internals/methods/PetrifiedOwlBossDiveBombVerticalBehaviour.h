...
IL2CPP_REGISTER_METHOD(0x00418200, StateMachine_2 *, get_StateMachine, (app::PetrifiedOwlBossDiveBombVerticalBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x0049F2B0, PetrifiedOwlBossBaseBehaviour_PetrifiedOwlBossBaseStatesSet *, get_States, (app::PetrifiedOwlBossDiveBombVerticalBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0049FA60, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossDiveBombVerticalBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x004A11E0, Enum__Array *, GetEntries, (app::PetrifiedOwlBossDiveBombVerticalBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x004A1280, Enum, Evaluate, (app::PetrifiedOwlBossDiveBombVerticalBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_ShouldSkip, (app::PetrifiedOwlBossDiveBombVerticalBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x004A1320, void, __ctor, (app::PetrifiedOwlBossDiveBombVerticalBehaviour * this_ptr));
}
