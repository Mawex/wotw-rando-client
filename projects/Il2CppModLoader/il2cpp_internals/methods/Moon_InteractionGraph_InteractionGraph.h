...
namespace app::methods::Moon_InteractionGraph::InteractionGraph {
IL2CPP_REGISTER_METHOD(0x0198D6D0, IInteractionNode *, get_ResolvedRootNode, (app::InteractionGraph * this_ptr));
IL2CPP_REGISTER_METHOD(0x0198D790, IInteractionNode *, get_CurrentActiveNode, (app::InteractionGraph * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006DC050, SuspendableMask__Enum, get_Mask, (app::InteractionGraph * this_ptr));
IL2CPP_REGISTER_METHOD(0x0198D820, void, set_Mask, (app::InteractionGraph * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x0198D8D0, IInteractionNode__Array *, get_Nodes, (app::InteractionGraph * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0198D950, IInteractionNode__Array *, GetNodes, (app::InteractionGraph * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::InteractionGraph * this_ptr));
IL2CPP_REGISTER_METHOD(0x0198EA10, void, __ctor, (app::InteractionGraph * this_ptr));
}
