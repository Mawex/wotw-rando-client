...
IL2CPP_REGISTER_METHOD(0x00C0D180, NavigationType__Enum, get_CurrentTailAreaType, (app::SandWormEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C0D850, SandTrail *, get_Trail, (app::SandWormEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C0DC60, SandWormEntity_BodyPhysicsMode__Enum, get_BodyPhysics, (app::SandWormEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C0DC80, Transform *, get_HeadTransform, (app::SandWormEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C0DD30, Transform *, get_TailTransform, (app::SandWormEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, get_CanBeDamagedBySpikes, (app::SandWormEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C0DDE0, Vector3, get_LastSafePosition, (app::SandWormEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C0DE00, bool, get_IsHeadInDigZone, (app::SandWormEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C0DEF0, DigZone *, get_HeadCurrentDigZone, (app::SandWormEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C0DFF0, bool, get_IsHeadTopInDigZone, (app::SandWormEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C0E0E0, DigZone *, get_HeadTopCurrentDigZone, (app::SandWormEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C0E1E0, bool, get_IsTailInDigZone, (app::SandWormEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C0E2D0, DigZone *, get_TailCurrentDigZone, (app::SandWormEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C0E3D0, DigZone *, get_CurrentOriDigZone, (app::SandWormEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C0E510, bool, get_IsInWaterZone, (app::SandWormEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C0E5D0, WaterZone *, get_CurrentWaterZone, (app::SandWormEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C0E690, bool, get_IsOriInWaterZone, (app::SandWormEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C0E7F0, WaterZone *, get_CurrentOriWaterZone, (app::SandWormEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C10220, Vector3, get_CameraTargetPosition, (app::SandWormEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C132E0, IEnumerator *, EnableVerletTentacles, (app::SandWormEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C18CD0, Vector3, GetClosestMortarPositionTo, (app::Entity * entity, app::Vector3 position));
...
IL2CPP_REGISTER_METHOD(0x00C19430, Vector3, ModifyKickbackForce, (app::SandWormEntity * this_ptr, app::Vector3 force, app::Damage * damage, bool apply_death_modification));
IL2CPP_REGISTER_METHOD(0x00C19590, void, OnDestroy, (app::SandWormEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C19BC0, void, __ctor, (app::SandWormEntity * this_ptr));
