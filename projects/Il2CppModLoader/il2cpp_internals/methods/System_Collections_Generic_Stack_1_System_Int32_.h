...
namespace app::methods::System_Collections_Generic::Stack_1_System_Int32_ {
...
IL2CPP_REGISTER_METHOD(0x02CF6B50, Object *, ICollection_get_SyncRoot, (app::Stack_1_System_Int32_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CF6FB0, Stack_1_T_Enumerator_System_Int32_, GetEnumerator, (app::Stack_1_System_Int32_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CF6FF0, IEnumerator_1_System_Int32_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::Stack_1_System_Int32_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CF6FF0, IEnumerator *, IEnumerable_GetEnumerator, (app::Stack_1_System_Int32_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CF7210, Int32__Array *, ToArray, (app::Stack_1_System_Int32_ * this_ptr));
