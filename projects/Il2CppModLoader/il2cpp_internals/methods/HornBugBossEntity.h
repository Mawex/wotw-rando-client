...
IL2CPP_REGISTER_METHOD(0x00B64210, Vector3, get_TargetPosition, (app::HornBugBossEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B64D40, void, __ctor, (app::HornBugBossEntity * this_ptr));
}
