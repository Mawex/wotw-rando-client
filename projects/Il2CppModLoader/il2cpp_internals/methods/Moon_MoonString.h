...
IL2CPP_REGISTER_METHOD(0x02F990E0, CrossSceneReferenceId, get_CrossSceneReferenceId, (app::MoonString * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F95C10, void, __ctor, (app::MoonString * this_ptr, app::String * static_value));
IL2CPP_REGISTER_METHOD(0x02F992C0, String *, Resolve, (app::MoonString * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x047137C8, MoonString_Resolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02F994A0, String *, SafeResolve, (app::MoonString * this_ptr, app::IMoonResolverContext * context));
...
IL2CPP_REGISTER_METHOD(0x00C3DD30, MoonTypeData, GetTypeData, (app::MoonString * this_ptr));
}
