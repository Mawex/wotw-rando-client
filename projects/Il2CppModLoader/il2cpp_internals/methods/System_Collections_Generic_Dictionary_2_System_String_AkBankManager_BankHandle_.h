...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_String_AkBankManager_BankHandle_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_System_String_AkBankManager_BankHandle_ * this_ptr));
