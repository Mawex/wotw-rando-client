...
IL2CPP_REGISTER_METHOD(0x02760020, Material *, get_material, (app::CameraFilterPack_Blend2Camera_SplitScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02760EB0, void, __ctor, (app::CameraFilterPack_Blend2Camera_SplitScreen * this_ptr));
}
