...
IL2CPP_REGISTER_METHOD(0x01ED7150, bool, MoveNext, (ObjectHolderListEnumerator * __this));
IL2CPP_REGISTER_METHOD(0x01ED7230, ObjectHolder *, get_Current, (ObjectHolderListEnumerator * __this));
}
