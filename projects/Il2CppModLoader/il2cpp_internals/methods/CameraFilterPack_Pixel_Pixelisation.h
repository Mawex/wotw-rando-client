...
IL2CPP_REGISTER_METHOD(0x02488710, Material *, get_material, (app::CameraFilterPack_Pixel_Pixelisation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02488E60, void, __ctor, (app::CameraFilterPack_Pixel_Pixelisation * this_ptr));
}
