...
IL2CPP_REGISTER_METHOD(0x00C2FD70, List_1_Moon_Profile_Metric_ *, get_SupportedMetrics, (app::NanoProfilerDataProvider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::NanoProfilerDataProvider * this_ptr));
}
