...
namespace app::methods::Moon_UberStateVisualization::ObjectUberStateWrapper {
IL2CPP_REGISTER_METHOD(0x0199AEF0, void, __ctor, (app::ObjectUberStateWrapper * this_ptr, app::IUberState * state));
