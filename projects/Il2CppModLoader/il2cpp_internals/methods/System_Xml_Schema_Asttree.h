...
namespace app::methods::System_Xml_Schema::Asttree {
IL2CPP_REGISTER_METHOD(0x002FA280, ArrayList *, get_SubtreeArray, (app::Asttree * this_ptr));
IL2CPP_REGISTER_METHOD(0x019A16D0, void, __ctor, (app::Asttree * this_ptr, app::String * x_path, bool is_field, app::XmlNamespaceManager * nsmgr));
