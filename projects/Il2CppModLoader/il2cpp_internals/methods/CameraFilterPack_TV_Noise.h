...
IL2CPP_REGISTER_METHOD(0x020EA2B0, Material *, get_material, (app::CameraFilterPack_TV_Noise * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020EAC00, void, __ctor, (app::CameraFilterPack_TV_Noise * this_ptr));
}
