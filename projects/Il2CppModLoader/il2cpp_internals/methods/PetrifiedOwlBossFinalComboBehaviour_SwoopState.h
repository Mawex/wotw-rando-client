...
IL2CPP_REGISTER_METHOD(0x017723D0, void, __ctor, (app::PetrifiedOwlBossFinalComboBehaviour_SwoopState * this_ptr, app::PetrifiedOwlBossFinalComboBehaviour * behaviour));
