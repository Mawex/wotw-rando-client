...
namespace app::methods::System_Collections_ObjectModel::KeyedCollection_2_System_Object_System_Object_ {
IL2CPP_REGISTER_METHOD(0x02CFBD00, Object *, get_Item, (app::KeyedCollection_2_System_Object_System_Object_ * this_ptr, app::Object * key));
IL2CPP_REGISTER_METHOD(0x002FBB00, IDictionary_2_System_Object_System_Object_ *, get_Dictionary, (app::KeyedCollection_2_System_Object_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor_1, (app::KeyedCollection_2_System_Object_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02259DF0, void, __ctor_2, (app::KeyedCollection_2_System_Object_System_Object_ * this_ptr, app::IEqualityComparer_1_System_Object_ * comparer));
IL2CPP_REGISTER_METHOD(0x02CFBC60, void, __ctor_3, (app::KeyedCollection_2_System_Object_System_Object_ * this_ptr, app::IEqualityComparer_1_System_Object_ * comparer, int32_t dictionary_creation_threshold));
