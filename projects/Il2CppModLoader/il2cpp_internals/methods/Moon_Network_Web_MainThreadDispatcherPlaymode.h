...
namespace app::methods::Moon_Network_Web::MainThreadDispatcherPlaymode {
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::MainThreadDispatcherPlaymode * this_ptr));
