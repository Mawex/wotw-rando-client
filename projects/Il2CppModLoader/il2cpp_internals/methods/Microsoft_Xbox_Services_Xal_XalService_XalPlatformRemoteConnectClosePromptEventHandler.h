...
namespace app::methods::Microsoft_Xbox_Services_Xal::XalService_XalPlatformRemoteConnectClosePromptEventHandler {
    IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::XalService_XalPlatformRemoteConnectClosePromptEventHandler * this_ptr, app::Object * object, void * method_1));
