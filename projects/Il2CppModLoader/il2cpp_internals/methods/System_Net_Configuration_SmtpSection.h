...
namespace app::methods::System_Net_Configuration::SmtpSection {
IL2CPP_REGISTER_METHOD(0x01E99080, void, __ctor, (app::SmtpSection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04780160, SmtpSection__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E990B0, SmtpDeliveryFormat__Enum, get_DeliveryFormat, (app::SmtpSection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E99110, SmtpDeliveryMethod__Enum, get_DeliveryMethod, (app::SmtpSection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E99170, String *, get_From, (app::SmtpSection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E991D0, SmtpNetworkElement *, get_Network, (app::SmtpSection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0470AC60, SmtpSection_get_Network__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E99200, ConfigurationPropertyCollection *, get_Properties, (app::SmtpSection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047506C0, SmtpSection_get_Properties__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E99230, SmtpSpecifiedPickupDirectoryElement *, get_SpecifiedPickupDirectory, (app::SmtpSection * this_ptr));
