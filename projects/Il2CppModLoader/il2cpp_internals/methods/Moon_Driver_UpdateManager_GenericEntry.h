...
namespace app::methods::Moon_Driver::UpdateManager_GenericEntry {
IL2CPP_REGISTER_METHOD(0x002FB9F0, IUpdateHandlerBase *, get_Handler, (app::UpdateManager_GenericEntry * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0313AC10, void, __ctor, (app::UpdateManager_GenericEntry * this_ptr));
}
