...
IL2CPP_REGISTER_METHOD(0x002FBC20, String *, get_Name, (app::MoonTelemetryPlayerSuspendScreenClosedEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01470AB0, void, __ctor, (app::MoonTelemetryPlayerSuspendScreenClosedEvent * this_ptr));
}
