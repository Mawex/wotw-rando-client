...
namespace app::methods::Steamworks::ControllerHandle_t {
    IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor, (app::ControllerHandle_t__Boxed * this_ptr, uint64_t value));
    ...
    IL2CPP_REGISTER_METHOD(0x015F8190, bool, operator____1, (app::ControllerHandle_t x, app::ControllerHandle_t y));
    IL2CPP_REGISTER_METHOD(0x015F81A0, bool, operator____2, (app::ControllerHandle_t x, app::ControllerHandle_t y));
    IL2CPP_REGISTER_METHOD(0x004C50A0, app::ControllerHandle_t, operator__1, (uint64_t value));
    IL2CPP_REGISTER_METHOD(0x004C50A0, uint64_t, operator__2, (app::ControllerHandle_t that));
