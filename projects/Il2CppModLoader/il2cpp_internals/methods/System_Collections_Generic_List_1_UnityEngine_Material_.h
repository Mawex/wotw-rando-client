...
namespace app::methods::System_Collections_Generic::List_1_UnityEngine_Material_ {
IL2CPP_REGISTER_METHOD(0x02FE8360, void, __ctor, (app::List_1_UnityEngine_Material_ * this_ptr, app::IEnumerable_1_UnityEngine_Material_ * collection));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, Material__Array *, ToArray, (app::List_1_UnityEngine_Material_ * this_ptr));
