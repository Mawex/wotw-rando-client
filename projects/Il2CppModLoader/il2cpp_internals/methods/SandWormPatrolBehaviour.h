...
IL2CPP_REGISTER_METHOD(0x00C20380, BehaviourStatus__Enum, OnExecute, (app::SandWormPatrolBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00C20770, bool, PointIsInChaseZone, (app::SandWormPatrolBehaviour * this_ptr, app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x00C20910, void, __ctor, (app::SandWormPatrolBehaviour * this_ptr));
}
