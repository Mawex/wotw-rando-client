...
IL2CPP_REGISTER_METHOD(0x01B5BC20, void, __ctor, (app::FloatUberStateMatcher * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01B5C240, FloatRangeUberStatePair *, GetStatePairAt, (app::FloatUberStateMatcher * this_ptr, int32_t index));
