...
namespace app::methods::System_Linq_Expressions_Interpreter::LabelInfo {
IL2CPP_REGISTER_METHOD(0x01CE31F0, void, __ctor, (app::LabelInfo * this_ptr, app::LabelTarget * node));
IL2CPP_REGISTER_METHOD(0x01CE3350, BranchLabel *, GetLabel, (app::LabelInfo * this_ptr, app::LightCompiler * compiler));
...
IL2CPP_REGISTER_METHOD(0x01CE3D30, LabelScopeInfo *, FirstDefinition, (app::LabelInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0157A0D0, Object *, CommonNode_1, (app::Object * first, app::Object * second, app::Func_2_Object_Object_ * parent));
IL2CPP_REGISTER_METHOD(0x0157A0D0, LabelScopeInfo *, CommonNode_2, (app::LabelScopeInfo * first, app::LabelScopeInfo * second, app::Func_2_System_Linq_Expressions_Interpreter_LabelScopeInfo_System_Linq_Expressions_Interpreter_LabelScopeInfo_ * parent));
