...
namespace app::methods::Moon_Timeline::MoveEventWindowAnimator {
IL2CPP_REGISTER_METHOD(0x002FBBE0, Action_1_Moon_Timeline_MoveEventType_ *, get_EventStart, (app::MoveEventWindowAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC00, Action_1_Moon_Timeline_MoveEventType_ *, get_EventStay, (app::MoveEventWindowAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC20, Action_1_Moon_Timeline_MoveEventType_ *, get_EventEnd, (app::MoveEventWindowAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00777280, void, __ctor, (app::MoveEventWindowAnimator * this_ptr));
}
