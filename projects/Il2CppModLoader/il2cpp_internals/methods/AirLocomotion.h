...
namespace app::methods::AirLocomotion {
    IL2CPP_REGISTER_METHOD(0x004F15D0, Transform*, get_FeetTransform, (app::AirLocomotion * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x04709C00, AirLocomotion_get_FeetTransform__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x004F1620, Vector3, get_FeetPosition, (app::AirLocomotion * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x004F1760, EntityLocomotionTask*, get_DefaultFSMState, (app::AirLocomotion * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x004F1850, EntityWeightData_EntityWeight__Enum, get_Weight, (app::AirLocomotion * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x004F18F0, EntityLocomotionTask*, GetNextBehaviour, (app::AirLocomotion * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x004F1990, void, __ctor, (app::AirLocomotion * this_ptr));
} // namespace app::methods::AirLocomotion
