...
namespace app::methods::System_Reflection::ReflectionTypeLoadException {
...
IL2CPP_REGISTER_METHOD(0x002FBC20, Type__Array *, get_Types, (app::ReflectionTypeLoadException * this_ptr));
