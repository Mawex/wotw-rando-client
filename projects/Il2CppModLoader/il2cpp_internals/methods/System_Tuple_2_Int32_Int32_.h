...
IL2CPP_REGISTER_METHOD(0x02A64360, void, __ctor, (app::Tuple_2_Int32_Int32_ * this_ptr, int32_t item1, int32_t item2));
...
IL2CPP_REGISTER_METHOD(0x02A64BD0, String *, ToString, (app::Tuple_2_Int32_Int32_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A64D50, String *, ITupleInternal_ToString, (app::Tuple_2_Int32_Int32_ * this_ptr, app::StringBuilder * sb));
}
