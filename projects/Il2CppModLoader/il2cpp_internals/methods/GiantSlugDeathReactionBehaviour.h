...
IL2CPP_REGISTER_METHOD(0x00417920, BehaviourStatus__Enum, OnExecuteTask, (app::GiantSlugDeathReactionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x005B3EC0, void, __ctor, (app::GiantSlugDeathReactionBehaviour * this_ptr));
}
