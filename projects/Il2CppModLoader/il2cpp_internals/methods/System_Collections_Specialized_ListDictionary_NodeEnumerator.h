...
namespace app::methods::System_Collections_Specialized::ListDictionary_NodeEnumerator {
IL2CPP_REGISTER_METHOD(0x0202A190, void, __ctor, (app::ListDictionary_NodeEnumerator * this_ptr, app::ListDictionary * list));
IL2CPP_REGISTER_METHOD(0x024959B0, Object *, get_Current, (app::ListDictionary_NodeEnumerator * this_ptr));
IL2CPP_REGISTER_METHOD(0x02495B00, DictionaryEntry, get_Entry, (app::ListDictionary_NodeEnumerator * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047363A0, ListDictionary_NodeEnumerator_get_Entry__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02495BE0, Object *, get_Key, (app::ListDictionary_NodeEnumerator * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0471E3A0, ListDictionary_NodeEnumerator_get_Key__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02495CB0, Object *, get_Value, (app::ListDictionary_NodeEnumerator * this_ptr));
