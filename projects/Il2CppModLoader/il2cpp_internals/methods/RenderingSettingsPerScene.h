...
IL2CPP_REGISTER_METHOD(0x008FE140, RenderingSettingsPerScene *, Clone, (app::RenderingSettingsPerScene * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008FE390, void, __ctor, (app::RenderingSettingsPerScene * this_ptr));
}
