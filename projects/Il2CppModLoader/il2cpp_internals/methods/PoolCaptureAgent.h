...
IL2CPP_REGISTER_METHOD(0x00C5FDC0, String__Array *, GetFrameData_1, (app::PoolCaptureAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C606C0, String__Array *, GetDataHeaderNames, (app::PoolCaptureAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::PoolCaptureAgent * this_ptr));
}
