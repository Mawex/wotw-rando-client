...
namespace app::methods::Mono_Security_Protocol_Ntlm::MessageBase {
IL2CPP_REGISTER_METHOD(0x002FC6E0, void, __ctor, (app::MessageBase * this_ptr, int32_t message_type));
IL2CPP_REGISTER_METHOD(0x00CC59E0, NtlmFlags__Enum, get_Flags, (app::MessageBase * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A4B130, Byte__Array *, PrepareMessage, (app::MessageBase * this_ptr, int32_t message_size));
