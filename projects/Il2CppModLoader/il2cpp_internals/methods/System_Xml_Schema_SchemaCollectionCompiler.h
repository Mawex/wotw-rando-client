...
namespace app::methods::System_Xml_Schema::SchemaCollectionCompiler {
IL2CPP_REGISTER_METHOD(0x016E7DC0, void, __ctor, (app::SchemaCollectionCompiler * this_ptr, app::XmlNameTable * name_table, app::ValidationEventHandler * event_handler));
...
IL2CPP_REGISTER_METHOD(0x016EDF80, XmlSchemaSimpleType__Array *, CompileBaseMemberTypes, (app::SchemaCollectionCompiler * this_ptr, app::XmlSchemaSimpleType * simple_type));
...
IL2CPP_REGISTER_METHOD(0x016EFF20, XmlSchemaParticle *, CompileContentTypeParticle, (app::SchemaCollectionCompiler * this_ptr, app::XmlSchemaParticle * particle, bool substitution));
IL2CPP_REGISTER_METHOD(0x016F0120, XmlSchemaParticle *, CannonicalizeParticle, (app::SchemaCollectionCompiler * this_ptr, app::XmlSchemaParticle * particle, bool root, bool substitution));
IL2CPP_REGISTER_METHOD(0x016F0510, XmlSchemaParticle *, CannonicalizeElement, (app::SchemaCollectionCompiler * this_ptr, app::XmlSchemaElement * element, bool substitution));
IL2CPP_REGISTER_METHOD(0x016F06D0, XmlSchemaParticle *, CannonicalizeGroupRef, (app::SchemaCollectionCompiler * this_ptr, app::XmlSchemaGroupRef * group_ref, bool root, bool substitution));
IL2CPP_REGISTER_METHOD(0x016F0F40, XmlSchemaParticle *, CannonicalizeAll, (app::SchemaCollectionCompiler * this_ptr, app::XmlSchemaAll * all, bool root, bool substitution));
IL2CPP_REGISTER_METHOD(0x016F1630, XmlSchemaParticle *, CannonicalizeChoice, (app::SchemaCollectionCompiler * this_ptr, app::XmlSchemaChoice * choice, bool root, bool substitution));
IL2CPP_REGISTER_METHOD(0x016F1D90, XmlSchemaParticle *, CannonicalizeSequence, (app::SchemaCollectionCompiler * this_ptr, app::XmlSchemaSequence * sequence, bool root, bool substitution));
...
IL2CPP_REGISTER_METHOD(0x016F5F70, XmlSchemaContentType__Enum, GetSchemaContentType, (app::SchemaCollectionCompiler * this_ptr, app::XmlSchemaComplexType * complex_type, app::XmlSchemaComplexContent * complex_content, app::XmlSchemaParticle * particle));
...
IL2CPP_REGISTER_METHOD(0x016F7700, XmlSchemaAnyAttribute *, CompileAnyAttributeUnion, (app::SchemaCollectionCompiler * this_ptr, app::XmlSchemaAnyAttribute * a, app::XmlSchemaAnyAttribute * b));
IL2CPP_REGISTER_METHOD(0x016F77F0, XmlSchemaAnyAttribute *, CompileAnyAttributeIntersection, (app::SchemaCollectionCompiler * this_ptr, app::XmlSchemaAnyAttribute * a, app::XmlSchemaAnyAttribute * b));
...
IL2CPP_REGISTER_METHOD(0x016F9660, ContentValidator *, CompileComplexContent, (app::SchemaCollectionCompiler * this_ptr, app::XmlSchemaComplexType * complex_type));
...
IL2CPP_REGISTER_METHOD(0x016FACC0, XmlSchemaSimpleType *, GetSimpleType, (app::SchemaCollectionCompiler * this_ptr, app::XmlQualifiedName * name));
IL2CPP_REGISTER_METHOD(0x016FAE80, XmlSchemaComplexType *, GetComplexType, (app::SchemaCollectionCompiler * this_ptr, app::XmlQualifiedName * name));
IL2CPP_REGISTER_METHOD(0x016FAF90, XmlSchemaType *, GetAnySchemaType, (app::SchemaCollectionCompiler * this_ptr, app::XmlQualifiedName * name));
}
