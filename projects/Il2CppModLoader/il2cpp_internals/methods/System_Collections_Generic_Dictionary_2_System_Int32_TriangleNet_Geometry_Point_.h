...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_Int32_TriangleNet_Geometry_Point_ {
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_System_Int32_TriangleNet_Geometry_Point_ * this_ptr));
