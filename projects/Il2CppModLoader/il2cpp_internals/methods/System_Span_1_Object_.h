...
IL2CPP_REGISTER_METHOD(0x001FFA00, String *, get_DebuggerDisplay, (app::Span_1_Object___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00114150, int32_t, get_Length, (app::Span_1_Object___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001FF9C0, Object * *, get_Item, (app::Span_1_Object___Boxed * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x00107C00, Pinnable_1_Object_ *, get_Pinnable, (app::Span_1_Object___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00107C10, void *, get_ByteOffset, (app::Span_1_Object___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001FF9F0, void, __ctor, (app::Span_1_Object___Boxed * this_ptr, app::Object__Array * array));
...
IL2CPP_REGISTER_METHOD(0x02775030, Span_1_Object_, operator_, (app::Object__Array * array));
}
