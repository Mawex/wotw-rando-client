...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::Comparison_1_MicroProfilerGraph_MarkerCache_ * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02B8A7C0, IAsyncResult *, BeginInvoke, (app::Comparison_1_MicroProfilerGraph_MarkerCache_ * this_ptr, app::MicroProfilerGraph_MarkerCache x, app::MicroProfilerGraph_MarkerCache y, app::AsyncCallback * callback, app::Object * object));
