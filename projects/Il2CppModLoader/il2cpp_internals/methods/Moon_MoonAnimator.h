...
IL2CPP_REGISTER_METHOD(0x01B17B10, MoonAnimator_AnimationInstance *, CreateAnimationInstance, (app::MoonAnimator * this_ptr, app::IAnimation * anim, bool preview_mode));
...
IL2CPP_REGISTER_METHOD(0x01B18450, PlayableGraph, get_PreviewPlayableGraph, (app::MoonAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01B18C50, MoonAnimator_PreviewAnimation *, AddPreviewAnimation_1, (app::MoonAnimator * this_ptr, app::MoonAnimation * animation, float speed, int32_t priority, float start_time, float end_time, float weight));
...
IL2CPP_REGISTER_METHOD(0x01B1A090, MoonAnimator_PreviewAnimation *, GetPreviewAnimationAtTime, (app::MoonAnimator * this_ptr, float time, int32_t start_index, app::MoonAnimatorLayerName layer));
...
IL2CPP_REGISTER_METHOD(0x01B1A990, PlayableGraph, get_PlayableGraph, (app::MoonAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A5BA50, AnimationPostprocessGroupManager *, get_PostprocessGroupManager, (app::MoonAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B1A9A0, AnimationParameterSet *, get_ParameterSet, (app::MoonAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01B1AA80, Vector3, get_RootVelocity, (app::MoonAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B1ABF0, GameObject *, get_EffectiveAnimatedObject, (app::MoonAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B1ACC0, AnimationPostprocess__Array *, get_PostprocessChain, (app::MoonAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00756A30, List_1_Moon_MoonAnimator_Layer_ *, get_Layers, (app::MoonAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B1B0B0, MoonAnimator_Layer *, get_BaseLayer, (app::MoonAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A64240, Animator *, get_UnityAnimator, (app::MoonAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003FFB70, RecordableParsingGroup__Enum, get_ParsingGroup, (app::MoonAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01B1C4F0, Vector3, GetParameterValue_2, (app::MoonAnimator * this_ptr, app::VectorAnimationParameter * parameter));
...
IL2CPP_REGISTER_METHOD(0x01B1C7C0, ActiveAnimationHandle, Play, (app::MoonAnimator * this_ptr, app::IAnimation * animation, int32_t priority, app::Func_1_Boolean_ * continue_condition, app::Nullable_1_Moon_MoonAnimatorLayerName_ layer, app::Action * on_stopped_playing));
IL2CPP_REGISTER_METHOD(0x01B1C9B0, ActiveAnimationHandle, GetActiveAnimation, (app::MoonAnimator * this_ptr, app::IAnimation * animation));
...
IL2CPP_REGISTER_METHOD(0x01B1F940, MoonAnimator_LayersUpdateResult, UpdateLayers, (app::MoonAnimator * this_ptr, float delta_time));
...
IL2CPP_REGISTER_METHOD(0x01B214D0, MoonAnimator_AnimationPostprocessMetadata *, GetAnimationPostprocessMetadata, (app::MoonAnimator * this_ptr, app::AnimationPostprocess * postprocess));
IL2CPP_REGISTER_METHOD(0x01B21650, MoonAnimator_Layer *, GetLayer, (app::MoonAnimator * this_ptr, app::MoonAnimatorLayerName layer_name));
IL2CPP_REGISTER_METHOD(0x01B217F0, bool, ContainsLayer, (app::MoonAnimator * this_ptr, app::MoonAnimatorLayerName layer_name));
IL2CPP_REGISTER_METHOD(0x01B218F0, Playable, GetRootPlayable, (app::MoonAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B21A70, void, UpdateSystemRegistration, (app::MoonAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B21CF0, void, __ctor, (app::MoonAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B23150, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x015F1D50, Object *, GetAnimationInstanceFromPool_1, (app::MoonAnimator * this_ptr, app::List_1_System_Object_ * pool, bool is_preview));
IL2CPP_REGISTER_METHOD(0x015F1D50, MoonAnimator_ClipInstance *, GetAnimationInstanceFromPool_2, (app::MoonAnimator * this_ptr, app::List_1_Moon_MoonAnimator_ClipInstance_ * pool, bool is_preview));
IL2CPP_REGISTER_METHODINFO(0x04732B50, MoonAnimator_GetAnimationInstanceFromPool_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015F1D50, MoonAnimator_BlendInstance *, GetAnimationInstanceFromPool_3, (app::MoonAnimator * this_ptr, app::List_1_Moon_MoonAnimator_BlendInstance_ * pool, bool is_preview));
IL2CPP_REGISTER_METHODINFO(0x0472BBF8, MoonAnimator_GetAnimationInstanceFromPool_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015F1D50, MoonAnimator_LayeredInstance *, GetAnimationInstanceFromPool_4, (app::MoonAnimator * this_ptr, app::List_1_Moon_MoonAnimator_LayeredInstance_ * pool, bool is_preview));
IL2CPP_REGISTER_METHODINFO(0x04743958, MoonAnimator_GetAnimationInstanceFromPool_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015F1D50, MoonAnimator_DirectBlendInstance *, GetAnimationInstanceFromPool_5, (app::MoonAnimator * this_ptr, app::List_1_Moon_MoonAnimator_DirectBlendInstance_ * pool, bool is_preview));
IL2CPP_REGISTER_METHODINFO(0x04789338, MoonAnimator_GetAnimationInstanceFromPool_4__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015F1D50, MoonAnimator_Blend2DInstance *, GetAnimationInstanceFromPool_6, (app::MoonAnimator * this_ptr, app::List_1_Moon_MoonAnimator_Blend2DInstance_ * pool, bool is_preview));
IL2CPP_REGISTER_METHODINFO(0x04768960, MoonAnimator_GetAnimationInstanceFromPool_5__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015F1D50, MoonAnimator_SimpleCrossfadeInstance *, GetAnimationInstanceFromPool_7, (app::MoonAnimator * this_ptr, app::List_1_Moon_MoonAnimator_SimpleCrossfadeInstance_ * pool, bool is_preview));
IL2CPP_REGISTER_METHODINFO(0x04713D28, MoonAnimator_GetAnimationInstanceFromPool_6__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015F1D50, MoonAnimator_AnimatedCrossfadeInstance *, GetAnimationInstanceFromPool_8, (app::MoonAnimator * this_ptr, app::List_1_Moon_MoonAnimator_AnimatedCrossfadeInstance_ * pool, bool is_preview));
