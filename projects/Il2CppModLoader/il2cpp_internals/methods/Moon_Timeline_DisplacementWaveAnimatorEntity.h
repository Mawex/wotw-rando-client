...
namespace app::methods::Moon_Timeline::DisplacementWaveAnimatorEntity {
    ...
    IL2CPP_REGISTER_METHOD(0x007660E0, void, __ctor, (app::DisplacementWaveAnimatorEntity * this_ptr));
}
