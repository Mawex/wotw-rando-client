...
namespace app::methods::System_Data_Common::Int16Storage {
IL2CPP_REGISTER_METHOD(0x021668C0, void, __ctor, (app::Int16Storage * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x021669E0, Object *, Aggregate, (app::Int16Storage * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x021673D0, Object *, ConvertValue, (app::Int16Storage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02159340, void, Copy, (app::Int16Storage * this_ptr, int32_t record_no1, int32_t record_no2));
IL2CPP_REGISTER_METHOD(0x02167500, Object *, Get, (app::Int16Storage * this_ptr, int32_t record));
...
IL2CPP_REGISTER_METHOD(0x021678D0, Object *, ConvertXmlToObject, (app::Int16Storage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x021679B0, String *, ConvertObjectToXml, (app::Int16Storage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02167A90, Object *, GetEmptyStorage, (app::Int16Storage * this_ptr, int32_t record_count));
