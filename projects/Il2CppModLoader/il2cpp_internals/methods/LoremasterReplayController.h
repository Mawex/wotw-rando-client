...
IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::LoremasterReplayController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009F18E0, void, __ctor, (app::LoremasterReplayController * this_ptr));
}
