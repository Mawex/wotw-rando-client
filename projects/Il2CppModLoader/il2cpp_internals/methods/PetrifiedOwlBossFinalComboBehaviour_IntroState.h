...
namespace app::methods::PetrifiedOwlBossFinalComboBehaviour_IntroState {
    IL2CPP_REGISTER_METHOD(0x01770D60, void, __ctor, (app::PetrifiedOwlBossFinalComboBehaviour_IntroState * this_ptr, app::PetrifiedOwlBossFinalComboBehaviour * behaviour));
