...
IL2CPP_REGISTER_METHOD(0x002FA280, IUberState *, get_UberState, (app::DesiredUberStateFloat * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B59900, bool, IsFulfilled, (app::DesiredUberStateFloat * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B599E0, String *, get_NiceName, (app::DesiredUberStateFloat * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::DesiredUberStateFloat * this_ptr));
}
