...
IL2CPP_REGISTER_METHOD(0x012C4160, Rect, get_DotRect, (app::CleverValueSlider * this_ptr));
IL2CPP_REGISTER_METHOD(0x012C4320, Rect, get_SliderRect, (app::CleverValueSlider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012C4750, String *, GetValueToDisplay, (app::CleverValueSlider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00867970, void, __ctor, (app::CleverValueSlider * this_ptr));
