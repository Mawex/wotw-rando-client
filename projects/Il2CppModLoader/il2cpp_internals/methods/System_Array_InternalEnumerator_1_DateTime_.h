...
IL2CPP_REGISTER_METHOD(0x00160580, void, __ctor, (app::Array_InternalEnumerator_1_DateTime___Boxed * this_ptr, app::Array * array));
...
IL2CPP_REGISTER_METHOD(0x0019B0D0, DateTime, get_Current, (app::Array_InternalEnumerator_1_DateTime___Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0019B250, Object *, IEnumerator_get_Current, (app::Array_InternalEnumerator_1_DateTime___Boxed * this_ptr));
}
