...
namespace app::methods::System_Configuration::SettingsLoadedEventHandler {
IL2CPP_REGISTER_METHOD(0x02962C80, void, __ctor, (app::SettingsLoadedEventHandler * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02962CE0, IAsyncResult *, BeginInvoke, (app::SettingsLoadedEventHandler * this_ptr, app::Object * sender, app::SettingsLoadedEventArgs * e, app::AsyncCallback * callback, app::Object * object));
