...
namespace app::methods::TriangleNet_Smoothing::VoronoiFactory_ObjectPool_1_System_Object_ {
...
IL2CPP_REGISTER_METHOD(0x0225C010, void, __ctor_1, (app::VoronoiFactory_ObjectPool_1_System_Object_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x0225C080, void, __ctor_2, (app::VoronoiFactory_ObjectPool_1_System_Object_ * this_ptr, app::Object__Array * pool));
