...
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::AllContainer_1_ICarryable_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04743848, AllContainer_1_ICarryable___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x019D7800, ICarryable *, get_Item, (app::AllContainer_1_ICarryable_ * this_ptr, int32_t index));
