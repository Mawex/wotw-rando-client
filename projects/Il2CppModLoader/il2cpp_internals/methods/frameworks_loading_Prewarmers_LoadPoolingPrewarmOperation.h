...
namespace app::methods::frameworks_loading_Prewarmers::LoadPoolingPrewarmOperation {
IL2CPP_REGISTER_METHOD(0x00F60DA0, void, __ctor, (app::LoadPoolingPrewarmOperation * this_ptr));
