...
namespace app::methods::System_Collections_Specialized::ListDictionary_NodeKeyValueCollection {
IL2CPP_REGISTER_METHOD(0x01669060, void, __ctor, (app::ListDictionary_NodeKeyValueCollection * this_ptr, app::ListDictionary * list, bool is_keys));
...
IL2CPP_REGISTER_METHOD(0x024960E0, Object *, ICollection_get_SyncRoot, (app::ListDictionary_NodeKeyValueCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x02496240, IEnumerator *, IEnumerable_GetEnumerator, (app::ListDictionary_NodeKeyValueCollection * this_ptr));
}
