...
IL2CPP_REGISTER_METHOD(0x006410F0, SuspendableMask__Enum, get_Mask, (app::ColosseumTimer * this_ptr));
IL2CPP_REGISTER_METHOD(0x011DDAC0, void, set_Mask, (app::ColosseumTimer * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x011DDB70, void, __ctor, (app::ColosseumTimer * this_ptr));
}
