...
namespace app::methods::UnityEngine_SceneManagement::Scene {
IL2CPP_REGISTER_METHOD(0x02978E80, bool, IsValidInternal, (int32_t scene_handle));
IL2CPP_REGISTER_METHOD(0x02978ED0, String *, GetPathInternal, (int32_t scene_handle));
IL2CPP_REGISTER_METHOD(0x02978F20, String *, GetNameInternal, (int32_t scene_handle));
...
IL2CPP_REGISTER_METHOD(0x002185F0, String *, get_path, (app::Scene__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00218640, String *, get_name, (app::Scene__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00218780, GameObject__Array *, GetRootGameObjects_1, (app::Scene__Boxed * this_ptr));
