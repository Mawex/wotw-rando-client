...
namespace app::methods::System_Runtime_Serialization::SerializationObjectManager {
    IL2CPP_REGISTER_METHOD(0x01EE1730, void, __ctor, (app::SerializationObjectManager * this_ptr, app::StreamingContext context));
