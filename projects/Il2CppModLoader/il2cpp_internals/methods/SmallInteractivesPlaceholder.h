...
IL2CPP_REGISTER_METHOD(0x006C9D10, void, __ctor, (app::SmallInteractivesPlaceholder * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDisableOnRecordablePreview_get_gameObject, (app::SmallInteractivesPlaceholder * this_ptr));
}
