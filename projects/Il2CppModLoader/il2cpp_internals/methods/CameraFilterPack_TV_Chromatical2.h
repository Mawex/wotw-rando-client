...
IL2CPP_REGISTER_METHOD(0x020E7890, Material *, get_material, (app::CameraFilterPack_TV_Chromatical2 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E81E0, void, __ctor, (app::CameraFilterPack_TV_Chromatical2 * this_ptr));
}
