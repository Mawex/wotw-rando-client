...
namespace app::methods::System_Xml_Schema::Datatype_int {
    ...
    IL2CPP_REGISTER_METHOD(0x0235E630, void, __ctor, (app::Datatype_int * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0235E6D0, void, __cctor, ());
}
