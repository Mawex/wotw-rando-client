...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::PlatformRemoteConnectShowPromptEventHandler * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x00DC7DB0, IAsyncResult *, BeginInvoke, (app::PlatformRemoteConnectShowPromptEventHandler * this_ptr, app::String * url, app::String * code, app::CancellationTokenSource * cancellation, app::AsyncCallback * callback, app::Object * object));
