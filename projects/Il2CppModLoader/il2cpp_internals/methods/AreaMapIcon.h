...
namespace app::methods::AreaMapIcon {
    ...
    IL2CPP_REGISTER_METHOD(0x002FBBA0, GameObject*, GetTransparencyAnimatorContainer, (app::AreaMapIcon * this_ptr));
    IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::AreaMapIcon * this_ptr));
} // namespace app::methods::AreaMapIcon
