...
IL2CPP_REGISTER_METHOD(0x007E5B60, GhostFrame_FrameDataTypes__Enum, get_FrameType, (app::GhostSceneTrackingPlugin_Data * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::GhostSceneTrackingPlugin_Data * this_ptr));
}
