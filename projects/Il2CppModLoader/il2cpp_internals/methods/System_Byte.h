...
namespace app::methods::System::Byte {
    ...
    IL2CPP_REGISTER_METHOD(0x0229F650, bool, TryParse_1, (app::String * s, app::uint8_t* result));
    IL2CPP_REGISTER_METHOD(0x0229F6C0, bool, TryParse_2, (app::String * s, app::NumberStyles__Enum style, app::IFormatProvider* provider, app::uint8_t* result));
    IL2CPP_REGISTER_METHOD(0x0229F750, bool, TryParse_3, (app::String * s, app::NumberStyles__Enum style, app::NumberFormatInfo* info, app::uint8_t* result));
    IL2CPP_REGISTER_METHOD(0x001E1F30, String*, ToString_1, (app::Byte__Boxed * this_ptr));
    IL2CPP_REGISTER_METHOD(0x001E1F60, String*, ToString_2, (app::Byte__Boxed * this_ptr, app::String* format));
    IL2CPP_REGISTER_METHOD(0x001E1FA0, String*, ToString_3, (app::Byte__Boxed * this_ptr, app::IFormatProvider* provider));
    IL2CPP_REGISTER_METHOD(0x001E1FD0, String*, ToString_4, (app::Byte__Boxed * this_ptr, app::String* format, app::IFormatProvider* provider));
    IL2CPP_REGISTER_METHOD(0x001E2010, TypeCode__Enum, GetTypeCode, (app::Byte__Boxed * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x001E27A0, Decimal, IConvertible_ToDecimal, (app::Byte__Boxed * this_ptr, app::IFormatProvider* provider));
    IL2CPP_REGISTER_METHOD(0x001E28E0, DateTime, IConvertible_ToDateTime, (app::Byte__Boxed * this_ptr, app::IFormatProvider* provider));
    IL2CPP_REGISTER_METHODINFO(0x0475C078, Byte_System_IConvertible_ToDateTime__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x001E28F0, Object*, IConvertible_ToType, (app::Byte__Boxed * this_ptr, app::Type* type, app::IFormatProvider* provider));
} // namespace app::methods::System::Byte
