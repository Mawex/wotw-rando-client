...
namespace app::methods::StressTester {
    ...
    IL2CPP_REGISTER_METHOD(0x0065FBA0, String*, get_Message, (app::StressTester * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0065FBB0, void, set_Message, (app::StressTester * this_ptr, app::String* value));
    IL2CPP_REGISTER_METHOD(0x0065FBC0, String*, get_ScreenshotFilename, (app::StressTester * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0065FBD0, void, set_ScreenshotFilename, (app::StressTester * this_ptr, app::String* value));
    IL2CPP_REGISTER_METHOD(0x0065FBE0, String*, get_ScreenshotFilenameTemplate, (app::StressTester * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0065FD90, String*, get_TestID, (app::StressTester * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBBA0, List_1_StressTester_StressTestPoint_*, get_OrderedPoints, (app::StressTester * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0065FF00, StressTester_SceneIdentifier*, get_SceneToStartTestFrom, (app::StressTester * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0065FFD0, bool, get_TestModeOn, ());
    IL2CPP_REGISTER_METHOD(0x00660070, void, set_TestModeOn, (bool value));
    IL2CPP_REGISTER_METHOD(0x00660120, IStressTest*, get_CurrentTest, (app::StressTester * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FBD40, Action*, get_OnTestSetupBegin, (app::StressTester * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBD50, void, set_OnTestSetupBegin, (app::StressTester * this_ptr, app::Action* value));
    IL2CPP_REGISTER_METHOD(0x002FBD60, Action*, get_OnTestStarted, (app::StressTester * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00660430, Action*, get_OnTestFinished, (app::StressTester * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00660440, void, set_OnTestFinished, (app::StressTester * this_ptr, app::Action* value));
    IL2CPP_REGISTER_METHOD(0x0065FD90, String*, GetTestID, (app::StressTester * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00660450, Vector2, get_CurrentWaypoint, (app::StressTester * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00660510, Vector2, get_PreviousWaypoint, (app::StressTester * this_ptr));
    IL2CPP_REGISTER_METHOD(0x006605D0, Vector2, get_CurentPathDirection, (app::StressTester * this_ptr));
    IL2CPP_REGISTER_METHOD(0x006606A0, CageStructureTool*, get_Cage, (app::StressTester * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBBC0, List_1_StressTester_SceneIdentifier_*, get_OverlapingScenes, (app::StressTester * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00660AE0, IEnumerator*, StartTestFromScene, (app::String * scene_names));
    ...
    IL2CPP_REGISTER_METHOD(0x00660C40, List_1_SceneMetaData_*, GetAllScenesThatIntersectsWithBounds, (app::StressTester * this_ptr, app::Rect path_bounds));
    ...
    IL2CPP_REGISTER_METHOD(0x006610B0, SceneMetaData*, GetSceneAt, (app::StressTester * this_ptr, app::Vector3 point, app::List_1_SceneMetaData_* overlaping_scenes));
    ...
    IL2CPP_REGISTER_METHOD(0x00665980, IEnumerator*, RecordScreenshot, (app::StressTester * this_ptr, app::String* path));
    ...
    IL2CPP_REGISTER_METHOD(0x00669F40, IStressTest*, GetValidInteractionTester, (app::StressTester * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0066B5B0, void, __ctor, (app::StressTester * this_ptr));
