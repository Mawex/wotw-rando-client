...
IL2CPP_REGISTER_METHOD(0x01B57FF0, IUberState *, get_UberState, (app::DesiredUberStateByte * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B580B0, bool, IsFulfilled, (app::DesiredUberStateByte * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B58190, String *, get_NiceName, (app::DesiredUberStateByte * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::DesiredUberStateByte * this_ptr));
}
