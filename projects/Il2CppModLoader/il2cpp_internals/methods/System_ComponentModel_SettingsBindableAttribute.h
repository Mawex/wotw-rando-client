...
namespace app::methods::System_ComponentModel::SettingsBindableAttribute {
IL2CPP_REGISTER_METHOD(0x0052C650, void, __ctor, (app::SettingsBindableAttribute * this_ptr, bool bindable));
...
IL2CPP_REGISTER_METHOD(0x029ACC10, void, __cctor, ());
}
