...
namespace app::methods::System_Collections_Generic::List_1_CleverMenuItem_ {
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_CleverMenuItem_, GetEnumerator, (app::List_1_CleverMenuItem_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0475F068, List_1_CleverMenuItem__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EFC50, CleverMenuItem *, get_Item, (app::List_1_CleverMenuItem_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_CleverMenuItem_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02FE8360, void, __ctor_2, (app::List_1_CleverMenuItem_ * this_ptr, app::IEnumerable_1_CleverMenuItem_ * collection));
