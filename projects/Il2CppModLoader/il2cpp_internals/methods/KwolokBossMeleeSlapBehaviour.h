...
IL2CPP_REGISTER_METHOD(0x012E0C90, BehaviourStatus__Enum, OnExecute, (app::KwolokBossMeleeSlapBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x012E83C0, void, ModifyLookAngle, (app::KwolokBossMeleeSlapBehaviour * this_ptr, app::float * angle));
...
IL2CPP_REGISTER_METHOD(0x012E8600, Enum__Array *, GetEntries, (app::KwolokBossMeleeSlapBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x012E86A0, Enum, Evaluate, (app::KwolokBossMeleeSlapBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_ShouldSkip, (app::KwolokBossMeleeSlapBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x012E28D0, void, __ctor, (app::KwolokBossMeleeSlapBehaviour * this_ptr));
}
