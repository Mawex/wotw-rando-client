...
IL2CPP_REGISTER_METHOD(0x0211B730, MoonAnimatorLayerDefinition__Array *, get_AdditionalLayers, (app::MoonAnimatorDefinition * this_ptr));
IL2CPP_REGISTER_METHOD(0x0211B820, int32_t, get_AdditionalLayerCount, (app::MoonAnimatorDefinition * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, GameObject *, get_Rig, (app::MoonAnimatorDefinition * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_Rig, (app::MoonAnimatorDefinition * this_ptr, app::GameObject * value));
IL2CPP_REGISTER_METHOD(0x0211B8B0, MoonAnimatorLayerDefinition, GetAdditionalLayer_1, (app::MoonAnimatorDefinition * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x0211B980, MoonAnimatorLayerDefinition, GetAdditionalLayer_2, (app::MoonAnimatorDefinition * this_ptr, app::MoonAnimatorLayerName layer_name));
IL2CPP_REGISTER_METHOD(0x0211BAD0, MoonAnimatorLayerDefinition, GetAdditionalLayer_3, (app::MoonAnimatorDefinition * this_ptr, app::String * display_name));
...
IL2CPP_REGISTER_METHOD(0x0211BFD0, MoonAnimatorLayerDefinition, CreateNewAdditionalLayer, (app::MoonAnimatorDefinition * this_ptr, app::String * display_name));
...
IL2CPP_REGISTER_METHOD(0x0211C510, void, __ctor, (app::MoonAnimatorDefinition * this_ptr));
}
