...
IL2CPP_REGISTER_METHOD(0x02720AC0, IUberState *, Resolve, (app::MoonReference_1_IUberState_ * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x0475C6B0, MoonReference_1_IUberState__Resolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02720EB0, IUberState *, SafeResolve, (app::MoonReference_1_IUberState_ * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x047932E8, MoonReference_1_IUberState__SafeResolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027205B0, void, __ctor, (app::MoonReference_1_IUberState_ * this_ptr, app::IUberState * reference));
