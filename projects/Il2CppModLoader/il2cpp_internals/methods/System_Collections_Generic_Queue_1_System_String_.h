...
namespace app::methods::System_Collections_Generic::Queue_1_System_String_ {
IL2CPP_REGISTER_METHOD(0x0243CB70, void, __ctor, (app::Queue_1_System_String_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CA77B0, String *, Dequeue, (app::Queue_1_System_String_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047070F0, Queue_1_System_String__Dequeue__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02CA76E0, Queue_1_T_Enumerator_System_String_, GetEnumerator, (app::Queue_1_System_String_ * this_ptr));
