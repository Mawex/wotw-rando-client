...
namespace app::methods::Moon_Timeline::ConstraintOperation {
...
IL2CPP_REGISTER_METHOD(0x01BB0BA0, IConstraint *, ModifyConstraint, (app::MoonTimeline * owning_timeline, app::EntityId from_entity, app::Constraint__Enum from_constraint, app::EntityId to_entity, int32_t to_event, float time_offset));
...
IL2CPP_REGISTER_METHOD(0x01BB0EE0, ConstraintsMetaData *, GetMeta, (app::ITimelineEntityParent * timeline, app::EntityId entity_id, app::Constraint__Enum constraint));
...
IL2CPP_REGISTER_METHOD(0x01BB1380, ConstraintsMetaData *, GetOrCreateMeta, (app::ITimelineEntityParent * timeline, app::EntityId entity_id, app::Constraint__Enum constraint));
