...
IL2CPP_REGISTER_METHOD(0x009069A0, String *, GetAspectRatio, (app::Vector2 res, float precision));
...
IL2CPP_REGISTER_METHOD(0x00906F70, void, __ctor, (app::ResolutionOptions * this_ptr));
