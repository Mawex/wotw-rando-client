...
namespace app::methods::Mono_Math::BigInteger {
    ...
    IL2CPP_REGISTER_METHOD(0x023C5C60, app::BigInteger *, operator__1, (uint32_t value));
    IL2CPP_REGISTER_METHOD(0x023C5DB0, app::BigInteger *, operator__2, (int32_t value));
    IL2CPP_REGISTER_METHODINFO(0x04791F48, BigInteger_op_Implicit_1__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x023C5F30, app::BigInteger *, operator___1, (app::BigInteger * bi1, app::BigInteger * bi2));
    IL2CPP_REGISTER_METHOD(0x023C61C0, app::BigInteger *, operator___2, (app::BigInteger * bi1, app::BigInteger * bi2));
    ...
    IL2CPP_REGISTER_METHOD(0x023C64F0, app::BigInteger *, operator___4, (app::BigInteger * bi1, app::BigInteger * bi2));
    IL2CPP_REGISTER_METHOD(0x023C6530, app::BigInteger *, operator___5, (app::BigInteger * bi1, app::BigInteger * bi2));
    IL2CPP_REGISTER_METHOD(0x023C6570, app::BigInteger *, operator___6, (app::BigInteger * bi1, app::BigInteger * bi2));
    IL2CPP_REGISTER_METHODINFO(0x04779D90, BigInteger_op_Multiply__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x023C6880, app::BigInteger *, operator___7, (app::BigInteger * bi, int32_t i));
    IL2CPP_REGISTER_METHODINFO(0x04715198, BigInteger_op_Multiply_1__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x023C6A70, app::BigInteger *, operator____1, (app::BigInteger * bi1, int32_t shift_val));
    IL2CPP_REGISTER_METHOD(0x023C6A80, app::BigInteger *, operator____2, (app::BigInteger * bi1, int32_t shift_val));
    ...
    IL2CPP_REGISTER_METHOD(0x02A2F8C0, app::BigInteger_1 *, operator__3, (uint32_t value));
    IL2CPP_REGISTER_METHOD(0x02A2FA10, app::BigInteger_1 *, operator__4, (int32_t value));
    IL2CPP_REGISTER_METHODINFO(0x0474D650, BigInteger_1_op_Implicit_1__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x02A2FB90, app::BigInteger_1 *, operator___10, (app::BigInteger_1 * bi1, app::BigInteger_1 * bi2));
    IL2CPP_REGISTER_METHOD(0x02A2FE20, app::BigInteger_1 *, operator___11, (app::BigInteger_1 * bi1, app::BigInteger_1 * bi2));
    ...
    IL2CPP_REGISTER_METHOD(0x02A300E0, app::BigInteger_1 *, operator___13, (app::BigInteger_1 * bi1, app::BigInteger_1 * bi2));
    IL2CPP_REGISTER_METHOD(0x02A30120, app::BigInteger_1 *, operator___14, (app::BigInteger_1 * bi1, app::BigInteger_1 * bi2));
    IL2CPP_REGISTER_METHOD(0x02A30160, app::BigInteger_1 *, operator___15, (app::BigInteger_1 * bi1, app::BigInteger_1 * bi2));
    IL2CPP_REGISTER_METHODINFO(0x04782AA8, BigInteger_1_op_Multiply__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x02A30470, app::BigInteger_1 *, operator____9, (app::BigInteger_1 * bi1, int32_t shift_val));
    IL2CPP_REGISTER_METHOD(0x02A30480, app::BigInteger_1 *, operator____10, (app::BigInteger_1 * bi1, int32_t shift_val));
