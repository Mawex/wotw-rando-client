...
IL2CPP_REGISTER_METHOD(0x0231A250, IMessage *, SyncProcessMessage, (app::ServerObjectReplySink * this_ptr, app::IMessage * msg));
IL2CPP_REGISTER_METHOD(0x0231A320, IMessageCtrl *, AsyncProcessMessage, (app::ServerObjectReplySink * this_ptr, app::IMessage * msg, app::IMessageSink * reply_sink));
