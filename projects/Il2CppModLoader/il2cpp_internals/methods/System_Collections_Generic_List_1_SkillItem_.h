...
IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (List_1_SkillItem_ * __this));
IL2CPP_REGISTER_METHODINFO(0x04775DC0, List_1_SkillItem__get_Count__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_SkillItem_, GetEnumerator, (List_1_SkillItem_ * __this));
IL2CPP_REGISTER_METHODINFO(0x04751B78, List_1_SkillItem__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (List_1_SkillItem_ * __this));
IL2CPP_REGISTER_METHODINFO(0x04701218, List_1_SkillItem___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EFC50, SkillItem *, get_Item, (List_1_SkillItem_ * __this, int32_t index));
