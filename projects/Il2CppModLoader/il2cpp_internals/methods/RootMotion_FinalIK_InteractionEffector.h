...
namespace app::methods::RootMotion_FinalIK::InteractionEffector {
IL2CPP_REGISTER_METHOD(0x002FC6D0, FullBodyBipedEffector__Enum, get_effectorType, (app::InteractionEffector * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB930, InteractionObject *, get_interactionObject, (app::InteractionEffector * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A071E0, void, __ctor, (app::InteractionEffector * this_ptr, app::FullBodyBipedEffector__Enum effector_type));
...
IL2CPP_REGISTER_METHOD(0x02A09760, void, TriggerUntriggeredEvents, (app::InteractionEffector * this_ptr, bool check_time, app::bool * pick_up, app::bool * pause));
