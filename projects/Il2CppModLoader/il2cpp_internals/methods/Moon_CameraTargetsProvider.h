...
IL2CPP_REGISTER_METHOD(0x00CC28F0, List_1_Moon_CameraTargetSettings_ *, GetTargets, (app::CameraTargetsProvider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, ModifyLerping, (app::CameraTargetsProvider * this_ptr, app::float * camera_target_lerp_speed, app::float * zoom_lerp_speed_dec, app::float * zoom_lerp_speed_inc));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::CameraTargetsProvider * this_ptr));
}
