...
namespace app::methods::System_Xml::XmlSqlBinaryReader {
IL2CPP_REGISTER_METHOD(0x01707790, void, __ctor, (app::XmlSqlBinaryReader * this_ptr, app::Stream * stream, app::Byte__Array * data, int32_t len, app::String * base_uri, bool close_input, app::XmlReaderSettings * settings));
IL2CPP_REGISTER_METHOD(0x01707E60, XmlReaderSettings *, get_Settings, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x005065F0, XmlNodeType__Enum, get_NodeType, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCA0, String *, get_LocalName, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCC0, String *, get_NamespaceURI, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC80, String *, get_Prefix, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x01708100, String *, get_Value, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x017082E0, int32_t, get_Depth, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC20, String *, get_BaseURI, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x017083B0, bool, get_IsEmptyElement, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x017083D0, XmlSpace__Enum, get_XmlSpace, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x01708460, String *, get_XmlLang, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x0065FBC0, Type *, get_ValueType, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x01708560, int32_t, get_AttributeCount, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x017085C0, String *, GetAttribute_1, (app::XmlSqlBinaryReader * this_ptr, app::String * name, app::String * ns));
IL2CPP_REGISTER_METHODINFO(0x0478FCA0, XmlSqlBinaryReader_GetAttribute__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01708760, String *, GetAttribute_2, (app::XmlSqlBinaryReader * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x017087D0, String *, GetAttribute_3, (app::XmlSqlBinaryReader * this_ptr, int32_t i));
...
IL2CPP_REGISTER_METHOD(0x002FBB80, XmlNameTable *, get_NameTable, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x01708F40, String *, LookupNamespace, (app::XmlSqlBinaryReader * this_ptr, app::String * prefix));
...
IL2CPP_REGISTER_METHOD(0x017090E0, ReadState__Enum_1, get_ReadState, (app::XmlSqlBinaryReader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01709370, IDictionary_2_System_String_System_String_ *, IXmlNamespaceResolver_GetNamespacesInScope, (app::XmlSqlBinaryReader * this_ptr, app::XmlNamespaceScope__Enum scope));
IL2CPP_REGISTER_METHOD(0x017097C0, String *, IXmlNamespaceResolver_LookupPrefix, (app::XmlSqlBinaryReader * this_ptr, app::String * namespace_name));
...
IL2CPP_REGISTER_METHOD(0x0170AD90, BinXmlToken__Enum, PeekToken, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x0170AE00, BinXmlToken__Enum, ReadToken, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x0170AE80, BinXmlToken__Enum, NextToken2, (app::XmlSqlBinaryReader * this_ptr, app::BinXmlToken__Enum token));
IL2CPP_REGISTER_METHOD(0x0170B0E0, BinXmlToken__Enum, NextToken1, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x0170B1B0, BinXmlToken__Enum, NextToken, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x0170B2D0, BinXmlToken__Enum, PeekNextToken, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x0170B2F0, BinXmlToken__Enum, RescanNextToken, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04703510, XmlSqlBinaryReader_RescanNextToken__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0170B690, String *, ParseText, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x0170B770, int32_t, ScanText, (app::XmlSqlBinaryReader * this_ptr, app::int32_t * start));
IL2CPP_REGISTER_METHODINFO(0x0472AA30, XmlSqlBinaryReader_ScanText__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0170B8A0, String *, GetString, (app::XmlSqlBinaryReader * this_ptr, int32_t pos, int32_t cch));
IL2CPP_REGISTER_METHODINFO(0x04705540, XmlSqlBinaryReader_GetString__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0170BA40, String *, GetStringAligned, (app::XmlSqlBinaryReader * this_ptr, app::Byte__Array * data, int32_t offset, int32_t cch));
IL2CPP_REGISTER_METHOD(0x0170BA70, String *, GetAttributeText, (app::XmlSqlBinaryReader * this_ptr, int32_t i));
...
IL2CPP_REGISTER_METHOD(0x0170D8F0, String *, XmlDeclValue, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x0170DB20, String *, CDATAValue, (app::XmlSqlBinaryReader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01710E70, Type *, GetValueType, (app::XmlSqlBinaryReader * this_ptr, app::BinXmlToken__Enum token));
...
IL2CPP_REGISTER_METHOD(0x01710FC0, XmlNodeType__Enum, ScanOverValue, (app::XmlSqlBinaryReader * this_ptr, app::BinXmlToken__Enum token, bool attr, bool check_chars));
IL2CPP_REGISTER_METHODINFO(0x04743B18, XmlSqlBinaryReader_ScanOverValue__MethodInfo);
IL2CPP_REGISTER_METHOD(0x017111F0, XmlNodeType__Enum, ScanOverAnyValue, (app::XmlSqlBinaryReader * this_ptr, app::BinXmlToken__Enum token, bool attr, bool check_chars));
IL2CPP_REGISTER_METHODINFO(0x0477CA10, XmlSqlBinaryReader_ScanOverAnyValue__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01711790, XmlNodeType__Enum, CheckText, (app::XmlSqlBinaryReader * this_ptr, bool attr));
IL2CPP_REGISTER_METHODINFO(0x047953C8, XmlSqlBinaryReader_CheckText__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01711A30, XmlNodeType__Enum, CheckTextIsWS, (app::XmlSqlBinaryReader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x017121F0, Decimal, ValueAsDecimal, (app::XmlSqlBinaryReader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x017126B0, String *, ValueAsDateTimeString, (app::XmlSqlBinaryReader * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04785880, XmlSqlBinaryReader_ValueAsDateTimeString__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01712D40, String *, ValueAsString, (app::XmlSqlBinaryReader * this_ptr, app::BinXmlToken__Enum token));
...
IL2CPP_REGISTER_METHOD(0x01713B70, Exception *, ThrowUnexpectedToken, (app::XmlSqlBinaryReader * this_ptr, app::BinXmlToken__Enum token));
IL2CPP_REGISTER_METHOD(0x01713C00, Exception *, ThrowXmlException_1, (app::XmlSqlBinaryReader * this_ptr, app::String * res));
IL2CPP_REGISTER_METHOD(0x01713D60, Exception *, ThrowXmlException_2, (app::XmlSqlBinaryReader * this_ptr, app::String * res, app::String * arg1, app::String * arg2));
IL2CPP_REGISTER_METHOD(0x01713F80, Exception *, ThrowNotSupported, (app::XmlSqlBinaryReader * this_ptr, app::String * res));
