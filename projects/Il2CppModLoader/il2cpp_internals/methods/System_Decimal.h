...
namespace app::methods::System::Decimal {
    ...
    IL2CPP_REGISTER_METHOD(0x01734B90, app::Decimal, operator__1, (uint8_t value));
    IL2CPP_REGISTER_METHOD(0x01734BB0, app::Decimal, operator__2, (int8_t value));
    IL2CPP_REGISTER_METHOD(0x01734BE0, app::Decimal, operator__3, (int16_t value));
    IL2CPP_REGISTER_METHOD(0x01734C10, app::Decimal, operator__4, (uint16_t value));
    IL2CPP_REGISTER_METHOD(0x01734C10, app::Decimal, operator__5, (uint16_t value));
    IL2CPP_REGISTER_METHOD(0x01734C30, app::Decimal, operator__6, (int32_t value));
    IL2CPP_REGISTER_METHOD(0x01734C60, app::Decimal, operator__7, (uint32_t value));
    IL2CPP_REGISTER_METHOD(0x01734C70, app::Decimal, operator__8, (int64_t value));
    IL2CPP_REGISTER_METHOD(0x01734CB0, app::Decimal, operator__9, (uint64_t value));
    IL2CPP_REGISTER_METHOD(0x01734CD0, app::Decimal, operator__10, (float value));
    IL2CPP_REGISTER_METHOD(0x01734D10, app::Decimal, operator__11, (double value));
    ...
    IL2CPP_REGISTER_METHOD(0x01735110, app::Decimal, operator___1, (app::Decimal d));
    IL2CPP_REGISTER_METHOD(0x01735200, app::Decimal, operator____1, (app::Decimal d));
    IL2CPP_REGISTER_METHOD(0x01735360, app::Decimal, operator___2, (app::Decimal d1, app::Decimal d2));
    IL2CPP_REGISTER_METHOD(0x01735420, app::Decimal, operator___3, (app::Decimal d1, app::Decimal d2));
    IL2CPP_REGISTER_METHOD(0x017354E0, app::Decimal, operator___4, (app::Decimal d1, app::Decimal d2));
    IL2CPP_REGISTER_METHOD(0x017355E0, app::Decimal, operator___5, (app::Decimal d1, app::Decimal d2));
