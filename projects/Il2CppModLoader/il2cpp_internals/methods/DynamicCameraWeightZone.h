...
IL2CPP_REGISTER_METHOD(0x00BEA320, Rect, get_Bounds, (app::DynamicCameraWeightZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x00BEA670, void, set_Bounds, (app::DynamicCameraWeightZone * this_ptr, app::Rect value));
IL2CPP_REGISTER_METHOD(0x00BEA910, void, __ctor, (app::DynamicCameraWeightZone * this_ptr));
