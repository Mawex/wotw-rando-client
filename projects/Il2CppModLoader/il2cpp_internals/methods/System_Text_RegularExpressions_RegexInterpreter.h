...
namespace app::methods::System_Text_RegularExpressions::RegexInterpreter {
IL2CPP_REGISTER_METHOD(0x02593420, void, __ctor, (app::RegexInterpreter * this_ptr, app::RegexCode * code, app::CultureInfo * culture));
