...
IL2CPP_REGISTER_METHOD(0x0243D830, StringComparer *, get_InvariantCultureIgnoreCase, ());
IL2CPP_REGISTER_METHOD(0x0243D8D0, StringComparer *, get_CurrentCultureIgnoreCase, ());
IL2CPP_REGISTER_METHOD(0x0243DA60, StringComparer *, get_Ordinal, ());
IL2CPP_REGISTER_METHOD(0x0243DB00, StringComparer *, get_OrdinalIgnoreCase, ());
IL2CPP_REGISTER_METHOD(0x0243DBA0, StringComparer *, Create, (app::CultureInfo * culture, bool ignore_case));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::StringComparer * this_ptr));
IL2CPP_REGISTER_METHOD(0x0243E0A0, void, __cctor, ());
}
