...
namespace app::methods::System_Runtime_CompilerServices::AsyncMethodBuilderCore_MoveNextRunner {
    IL2CPP_REGISTER_METHOD(0x0058DA40, void, __ctor, (app::AsyncMethodBuilderCore_MoveNextRunner * this_ptr, app::ExecutionContext * context, app::IAsyncStateMachine * state_machine));
