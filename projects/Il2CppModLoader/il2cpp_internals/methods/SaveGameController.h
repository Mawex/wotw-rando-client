...
IL2CPP_REGISTER_METHOD(0x00C2BFB0, UberStateValueStore *, LoadTemporaryValueStoreForCurrentSlot, (app::SaveGameController * this_ptr, app::UberStateSaveFileHandler_LoadStatus__Enum * status));
IL2CPP_REGISTER_METHOD(0x00C2C010, UberStateValueStore *, LoadTemporaryValueStoreForSlot, (app::SaveGameController * this_ptr, int32_t slot_index, int32_t backup_index, app::UberStateSaveFileHandler_LoadStatus__Enum * status));
IL2CPP_REGISTER_METHOD(0x00C2C060, UberStateValueStore *, LoadWithGRDK, (app::SaveGameController * this_ptr, int32_t slot, int32_t backupslot, app::UberStateSaveFileHandler_LoadStatus__Enum * status));
IL2CPP_REGISTER_METHOD(0x00C2C420, UberStateValueStore *, LoadTemporaryUberState_1, (app::SaveGameController * this_ptr, app::String * filename, app::UberStateSaveFileHandler_LoadStatus__Enum * status));
IL2CPP_REGISTER_METHOD(0x00C2C770, UberStateValueStore *, LoadTemporaryUberState_2, (app::SaveGameController * this_ptr, app::Byte__Array * bytes, app::UberStateSaveFileHandler_LoadStatus__Enum * status));
IL2CPP_REGISTER_METHOD(0x00C2C920, void, LoadUberState_1, (app::SaveGameController * this_ptr, app::String * filename));
IL2CPP_REGISTER_METHOD(0x00C2CAE0, Byte__Array *, ReadAllBytes, (app::BinaryReader * reader));
...
IL2CPP_REGISTER_METHOD(0x00C2D770, SaveFileInfo *, get_CurrentSaveFileInfo, (app::SaveGameController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C2D7A0, SaveFileInfo *, GetSaveFileInfo, (app::SaveGameController * this_ptr, int32_t slot_index, int32_t backup_index));
...
IL2CPP_REGISTER_METHOD(0x00C2F5A0, void, __ctor, (app::SaveGameController * this_ptr));
