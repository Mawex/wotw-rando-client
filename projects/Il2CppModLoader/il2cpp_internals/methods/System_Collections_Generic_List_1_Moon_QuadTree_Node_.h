...
namespace app::methods::System_Collections_Generic::List_1_Moon_QuadTree_Node_ {
IL2CPP_REGISTER_METHOD(0x025EFC50, QuadTree_Node *, get_Item, (app::List_1_Moon_QuadTree_Node_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_Moon_QuadTree_Node_ * this_ptr));
