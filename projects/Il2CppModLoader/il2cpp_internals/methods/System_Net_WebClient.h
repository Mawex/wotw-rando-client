...
namespace app::methods::System_Net::WebClient {
IL2CPP_REGISTER_METHOD(0x020AD8D0, void, __ctor, (app::WebClient * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB60, Encoding *, get_Encoding, (app::WebClient * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020AE650, String *, get_BaseAddress, (app::WebClient * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB990, ICredentials *, get_Credentials, (app::WebClient * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020AEA10, WebHeaderCollection *, get_Headers, (app::WebClient * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9C0, void, set_Headers, (app::WebClient * this_ptr, app::WebHeaderCollection * value));
IL2CPP_REGISTER_METHOD(0x020AEB70, NameValueCollection *, get_QueryString, (app::WebClient * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9E0, void, set_QueryString, (app::WebClient * this_ptr, app::NameValueCollection * value));
IL2CPP_REGISTER_METHOD(0x020AECD0, WebHeaderCollection *, get_ResponseHeaders, (app::WebClient * this_ptr));
IL2CPP_REGISTER_METHOD(0x020AECF0, IWebProxy *, get_Proxy, (app::WebClient * this_ptr));
IL2CPP_REGISTER_METHOD(0x020AEDA0, void, set_Proxy, (app::WebClient * this_ptr, app::IWebProxy * value));
IL2CPP_REGISTER_METHOD(0x002FBC40, RequestCachePolicy *, get_CachePolicy, (app::WebClient * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020AEDC0, WebRequest *, GetWebRequest, (app::WebClient * this_ptr, app::Uri * address));
IL2CPP_REGISTER_METHOD(0x020AEF60, WebResponse *, GetWebResponse_1, (app::WebClient * this_ptr, app::WebRequest * request));
IL2CPP_REGISTER_METHOD(0x020AEFA0, WebResponse *, GetWebResponse_2, (app::WebClient * this_ptr, app::WebRequest * request, app::IAsyncResult * result));
IL2CPP_REGISTER_METHOD(0x020AEFE0, Byte__Array *, DownloadData_1, (app::WebClient * this_ptr, app::String * address));
IL2CPP_REGISTER_METHODINFO(0x0476A7A0, WebClient_DownloadData__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020AF0B0, Byte__Array *, DownloadData_2, (app::WebClient * this_ptr, app::Uri * address));
IL2CPP_REGISTER_METHODINFO(0x04791A08, WebClient_DownloadData_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020AF260, Byte__Array *, DownloadDataInternal, (app::WebClient * this_ptr, app::Uri * address, app::WebRequest * * request));
...
IL2CPP_REGISTER_METHOD(0x020AF980, Stream *, OpenRead_1, (app::WebClient * this_ptr, app::String * address));
IL2CPP_REGISTER_METHODINFO(0x04774968, WebClient_OpenRead__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020AFA50, Stream *, OpenRead_2, (app::WebClient * this_ptr, app::Uri * address));
IL2CPP_REGISTER_METHODINFO(0x0476C2E8, WebClient_OpenRead_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020AFD50, Stream *, OpenWrite_1, (app::WebClient * this_ptr, app::String * address));
IL2CPP_REGISTER_METHODINFO(0x0473D150, WebClient_OpenWrite__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020AFE30, Stream *, OpenWrite_2, (app::WebClient * this_ptr, app::Uri * address));
IL2CPP_REGISTER_METHOD(0x020AFE40, Stream *, OpenWrite_3, (app::WebClient * this_ptr, app::String * address, app::String * method_1));
IL2CPP_REGISTER_METHODINFO(0x04782400, WebClient_OpenWrite_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020AFF20, Stream *, OpenWrite_4, (app::WebClient * this_ptr, app::Uri * address, app::String * method_1));
IL2CPP_REGISTER_METHODINFO(0x0475A1C8, WebClient_OpenWrite_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020B0300, Byte__Array *, UploadData_1, (app::WebClient * this_ptr, app::String * address, app::Byte__Array * data));
IL2CPP_REGISTER_METHODINFO(0x04749730, WebClient_UploadData__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020B03F0, Byte__Array *, UploadData_2, (app::WebClient * this_ptr, app::Uri * address, app::Byte__Array * data));
IL2CPP_REGISTER_METHOD(0x020B0410, Byte__Array *, UploadData_3, (app::WebClient * this_ptr, app::String * address, app::String * method_1, app::Byte__Array * data));
IL2CPP_REGISTER_METHODINFO(0x047587E8, WebClient_UploadData_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020B0510, Byte__Array *, UploadData_4, (app::WebClient * this_ptr, app::Uri * address, app::String * method_1, app::Byte__Array * data));
IL2CPP_REGISTER_METHODINFO(0x04755BE8, WebClient_UploadData_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020B0750, Byte__Array *, UploadDataInternal, (app::WebClient * this_ptr, app::Uri * address, app::String * method_1, app::Byte__Array * data, app::WebRequest * * request));
...
IL2CPP_REGISTER_METHOD(0x020B1330, Byte__Array *, UploadFile_1, (app::WebClient * this_ptr, app::String * address, app::String * file_name));
IL2CPP_REGISTER_METHODINFO(0x0470B320, WebClient_UploadFile__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020B1420, Byte__Array *, UploadFile_2, (app::WebClient * this_ptr, app::Uri * address, app::String * file_name));
IL2CPP_REGISTER_METHOD(0x020B1440, Byte__Array *, UploadFile_3, (app::WebClient * this_ptr, app::String * address, app::String * method_1, app::String * file_name));
IL2CPP_REGISTER_METHOD(0x020B1490, Byte__Array *, UploadFile_4, (app::WebClient * this_ptr, app::Uri * address, app::String * method_1, app::String * file_name));
IL2CPP_REGISTER_METHODINFO(0x04754CA0, WebClient_UploadFile_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020B1900, Byte__Array *, UploadValuesInternal, (app::WebClient * this_ptr, app::NameValueCollection * data));
IL2CPP_REGISTER_METHODINFO(0x0478A7A8, WebClient_UploadValuesInternal__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020B1E40, Byte__Array *, UploadValues_1, (app::WebClient * this_ptr, app::String * address, app::NameValueCollection * data));
IL2CPP_REGISTER_METHODINFO(0x04710418, WebClient_UploadValues__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020B1F30, Byte__Array *, UploadValues_2, (app::WebClient * this_ptr, app::Uri * address, app::NameValueCollection * data));
IL2CPP_REGISTER_METHOD(0x020B1F50, Byte__Array *, UploadValues_3, (app::WebClient * this_ptr, app::String * address, app::String * method_1, app::NameValueCollection * data));
IL2CPP_REGISTER_METHODINFO(0x0476CC00, WebClient_UploadValues_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020B2050, Byte__Array *, UploadValues_4, (app::WebClient * this_ptr, app::Uri * address, app::String * method_1, app::NameValueCollection * data));
IL2CPP_REGISTER_METHODINFO(0x04701690, WebClient_UploadValues_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020B23E0, String *, UploadString_1, (app::WebClient * this_ptr, app::String * address, app::String * data));
IL2CPP_REGISTER_METHODINFO(0x04744138, WebClient_UploadString__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020B24D0, String *, UploadString_2, (app::WebClient * this_ptr, app::Uri * address, app::String * data));
IL2CPP_REGISTER_METHOD(0x020B24F0, String *, UploadString_3, (app::WebClient * this_ptr, app::String * address, app::String * method_1, app::String * data));
IL2CPP_REGISTER_METHODINFO(0x04710B38, WebClient_UploadString_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020B25F0, String *, UploadString_4, (app::WebClient * this_ptr, app::Uri * address, app::String * method_1, app::String * data));
IL2CPP_REGISTER_METHODINFO(0x0475AB10, WebClient_UploadString_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020B2860, String *, DownloadString_1, (app::WebClient * this_ptr, app::String * address));
IL2CPP_REGISTER_METHODINFO(0x04700F38, WebClient_DownloadString__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020B2930, String *, DownloadString_2, (app::WebClient * this_ptr, app::Uri * address));
...
IL2CPP_REGISTER_METHOD(0x020B33C0, Uri *, GetUri_1, (app::WebClient * this_ptr, app::String * path));
IL2CPP_REGISTER_METHOD(0x020B3760, Uri *, GetUri_2, (app::WebClient * this_ptr, app::Uri * address));
...
IL2CPP_REGISTER_METHOD(0x020B4730, Byte__Array *, DownloadBits, (app::WebClient * this_ptr, app::WebRequest * request, app::Stream * write_stream, app::CompletionDelegate * completion_delegate, app::AsyncOperation * async_op));
...
IL2CPP_REGISTER_METHOD(0x020B56D0, String *, GetStringUsingEncoding, (app::WebClient * this_ptr, app::WebRequest * request, app::Byte__Array * data));
IL2CPP_REGISTER_METHOD(0x020B5BF0, String *, MapToDefaultMethod, (app::WebClient * this_ptr, app::Uri * address));
IL2CPP_REGISTER_METHOD(0x020B5E40, String *, UrlEncode_1, (app::String * str));
IL2CPP_REGISTER_METHOD(0x020B5EF0, String *, UrlEncode_2, (app::String * str, app::Encoding * e));
IL2CPP_REGISTER_METHOD(0x020B5FA0, Byte__Array *, UrlEncodeToBytes, (app::String * str, app::Encoding * e));
IL2CPP_REGISTER_METHOD(0x020B6000, Byte__Array *, UrlEncodeBytesToBytesInternal, (app::Byte__Array * bytes, int32_t offset, int32_t count, bool always_create_return_value));
...
IL2CPP_REGISTER_METHOD(0x020BDA10, Task_1_System_String_ *, DownloadStringTaskAsync_1, (app::WebClient * this_ptr, app::String * address));
IL2CPP_REGISTER_METHOD(0x020BDA40, Task_1_System_String_ *, DownloadStringTaskAsync_2, (app::WebClient * this_ptr, app::Uri * address));
IL2CPP_REGISTER_METHODINFO(0x0470F980, WebClient_DownloadStringTaskAsync_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020BDE90, Task_1_System_IO_Stream_ *, OpenReadTaskAsync_1, (app::WebClient * this_ptr, app::String * address));
IL2CPP_REGISTER_METHOD(0x020BDEC0, Task_1_System_IO_Stream_ *, OpenReadTaskAsync_2, (app::WebClient * this_ptr, app::Uri * address));
IL2CPP_REGISTER_METHODINFO(0x047934A8, WebClient_OpenReadTaskAsync_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020BE310, Task_1_System_IO_Stream_ *, OpenWriteTaskAsync_1, (app::WebClient * this_ptr, app::String * address));
IL2CPP_REGISTER_METHOD(0x020BE340, Task_1_System_IO_Stream_ *, OpenWriteTaskAsync_2, (app::WebClient * this_ptr, app::Uri * address));
IL2CPP_REGISTER_METHOD(0x020BE350, Task_1_System_IO_Stream_ *, OpenWriteTaskAsync_3, (app::WebClient * this_ptr, app::String * address, app::String * method_1));
IL2CPP_REGISTER_METHOD(0x020BE390, Task_1_System_IO_Stream_ *, OpenWriteTaskAsync_4, (app::WebClient * this_ptr, app::Uri * address, app::String * method_1));
IL2CPP_REGISTER_METHODINFO(0x0477F4C8, WebClient_OpenWriteTaskAsync_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020BE7E0, Task_1_System_String_ *, UploadStringTaskAsync_1, (app::WebClient * this_ptr, app::String * address, app::String * data));
IL2CPP_REGISTER_METHOD(0x020BE820, Task_1_System_String_ *, UploadStringTaskAsync_2, (app::WebClient * this_ptr, app::Uri * address, app::String * data));
IL2CPP_REGISTER_METHOD(0x020BE840, Task_1_System_String_ *, UploadStringTaskAsync_3, (app::WebClient * this_ptr, app::String * address, app::String * method_1, app::String * data));
IL2CPP_REGISTER_METHOD(0x020BE890, Task_1_System_String_ *, UploadStringTaskAsync_4, (app::WebClient * this_ptr, app::Uri * address, app::String * method_1, app::String * data));
IL2CPP_REGISTER_METHODINFO(0x047171F8, WebClient_UploadStringTaskAsync_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020BED00, Task_1_System_Byte_ *, DownloadDataTaskAsync_1, (app::WebClient * this_ptr, app::String * address));
IL2CPP_REGISTER_METHOD(0x020BED30, Task_1_System_Byte_ *, DownloadDataTaskAsync_2, (app::WebClient * this_ptr, app::Uri * address));
IL2CPP_REGISTER_METHODINFO(0x0477DD28, WebClient_DownloadDataTaskAsync_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020BF0E0, Task *, DownloadFileTaskAsync_1, (app::WebClient * this_ptr, app::String * address, app::String * file_name));
IL2CPP_REGISTER_METHOD(0x020BF120, Task *, DownloadFileTaskAsync_2, (app::WebClient * this_ptr, app::Uri * address, app::String * file_name));
IL2CPP_REGISTER_METHODINFO(0x04714DE8, WebClient_DownloadFileTaskAsync_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020BF570, Task_1_System_Byte_ *, UploadDataTaskAsync_1, (app::WebClient * this_ptr, app::String * address, app::Byte__Array * data));
IL2CPP_REGISTER_METHOD(0x020BF5B0, Task_1_System_Byte_ *, UploadDataTaskAsync_2, (app::WebClient * this_ptr, app::Uri * address, app::Byte__Array * data));
IL2CPP_REGISTER_METHOD(0x020BF5D0, Task_1_System_Byte_ *, UploadDataTaskAsync_3, (app::WebClient * this_ptr, app::String * address, app::String * method_1, app::Byte__Array * data));
IL2CPP_REGISTER_METHOD(0x020BF620, Task_1_System_Byte_ *, UploadDataTaskAsync_4, (app::WebClient * this_ptr, app::Uri * address, app::String * method_1, app::Byte__Array * data));
IL2CPP_REGISTER_METHODINFO(0x04766748, WebClient_UploadDataTaskAsync_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020BF9E0, Task_1_System_Byte_ *, UploadFileTaskAsync_1, (app::WebClient * this_ptr, app::String * address, app::String * file_name));
IL2CPP_REGISTER_METHOD(0x020BFA20, Task_1_System_Byte_ *, UploadFileTaskAsync_2, (app::WebClient * this_ptr, app::Uri * address, app::String * file_name));
IL2CPP_REGISTER_METHOD(0x020BFA40, Task_1_System_Byte_ *, UploadFileTaskAsync_3, (app::WebClient * this_ptr, app::String * address, app::String * method_1, app::String * file_name));
IL2CPP_REGISTER_METHOD(0x020BFA90, Task_1_System_Byte_ *, UploadFileTaskAsync_4, (app::WebClient * this_ptr, app::Uri * address, app::String * method_1, app::String * file_name));
IL2CPP_REGISTER_METHODINFO(0x04737FA8, WebClient_UploadFileTaskAsync_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020BFF00, Task_1_System_Byte_ *, UploadValuesTaskAsync_1, (app::WebClient * this_ptr, app::String * address, app::NameValueCollection * data));
IL2CPP_REGISTER_METHOD(0x020BFF40, Task_1_System_Byte_ *, UploadValuesTaskAsync_2, (app::WebClient * this_ptr, app::String * address, app::String * method_1, app::NameValueCollection * data));
IL2CPP_REGISTER_METHOD(0x020BFF90, Task_1_System_Byte_ *, UploadValuesTaskAsync_3, (app::WebClient * this_ptr, app::Uri * address, app::NameValueCollection * data));
IL2CPP_REGISTER_METHOD(0x020BFFB0, Task_1_System_Byte_ *, UploadValuesTaskAsync_4, (app::WebClient * this_ptr, app::Uri * address, app::String * method_1, app::NameValueCollection * data));
