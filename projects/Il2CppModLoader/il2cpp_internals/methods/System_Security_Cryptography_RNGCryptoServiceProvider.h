...
namespace app::methods::System_Security_Cryptography::RNGCryptoServiceProvider {
IL2CPP_REGISTER_METHOD(0x028E3DB0, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x028E3E20, void, __ctor_1, (app::RNGCryptoServiceProvider * this_ptr));
IL2CPP_REGISTER_METHOD(0x028E3ED0, void, __ctor_2, (app::RNGCryptoServiceProvider * this_ptr, app::Byte__Array * rgb));
IL2CPP_REGISTER_METHOD(0x028E3F90, void, __ctor_3, (app::RNGCryptoServiceProvider * this_ptr, app::CspParameters * csp_params));
IL2CPP_REGISTER_METHOD(0x028E4040, void, __ctor_4, (app::RNGCryptoServiceProvider * this_ptr, app::String * str));
...
IL2CPP_REGISTER_METHOD(0x028E4220, void *, RngGetBytes, (app::void * handle, app::Byte__Array * data));
IL2CPP_REGISTER_METHOD(0x028E42A0, void, RngClose, (app::void * handle));
