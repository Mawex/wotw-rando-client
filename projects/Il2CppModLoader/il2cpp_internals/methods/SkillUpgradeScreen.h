...
IL2CPP_REGISTER_METHOD(0x006B8940, CleverMenuItemSelectionManager *, get_NavigationManager, (app::SkillUpgradeScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00417920, MenuTabBackground__Enum, get_BackgroundMode, (app::SkillUpgradeScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006B8EC0, SkillUpgradeShopUIItem *, get_SelectedSkillUpgradeUIItem, (app::SkillUpgradeScreen * this_ptr));
IL2CPP_REGISTER_METHOD(0x006B8FC0, UpgradeAbilityItem *, get_SelectedUpgradeItem, (app::SkillUpgradeScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006B90B0, SuspendableMask__Enum, get_Mask, (app::SkillUpgradeScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006BA290, PlayerUberStateShards_Shard *, GetActualInventoryItem, (app::SkillUpgradeScreen * this_ptr, app::SpiritShardType__Enum typ));
...
IL2CPP_REGISTER_METHOD(0x002FBCA0, GameObject *, get_EffectTarget, (app::SkillUpgradeScreen * this_ptr));
IL2CPP_REGISTER_METHOD(0x00572C50, Event_1 *, get_PurchaseCompleteSound, (app::SkillUpgradeScreen * this_ptr));
IL2CPP_REGISTER_METHOD(0x00572C30, Event_1 *, get_PurchaseBeginSound, (app::SkillUpgradeScreen * this_ptr));
IL2CPP_REGISTER_METHOD(0x00572C70, RTPC *, get_PurchaseRTPC, (app::SkillUpgradeScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006BBAB0, void, __ctor, (app::SkillUpgradeScreen * this_ptr));
}
