...
namespace app::methods::System_Collections_Generic::Queue_1_OrbSpawnerManager_ItemToSpawn_ {
...
IL2CPP_REGISTER_METHOD(0x02CA5190, OrbSpawnerManager_ItemToSpawn, Dequeue, (app::Queue_1_OrbSpawnerManager_ItemToSpawn_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CA49B0, void, __ctor_1, (app::Queue_1_OrbSpawnerManager_ItemToSpawn_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHODINFO(0x0470BBF8, Queue_1_OrbSpawnerManager_ItemToSpawn___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0243CB70, void, __ctor_2, (app::Queue_1_OrbSpawnerManager_ItemToSpawn_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CA4AE0, Object *, ICollection_get_SyncRoot, (app::Queue_1_OrbSpawnerManager_ItemToSpawn_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CA5040, Queue_1_T_Enumerator_OrbSpawnerManager_ItemToSpawn_, GetEnumerator, (app::Queue_1_OrbSpawnerManager_ItemToSpawn_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA50B0, IEnumerator_1_OrbSpawnerManager_ItemToSpawn_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::Queue_1_OrbSpawnerManager_ItemToSpawn_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA50B0, IEnumerator *, IEnumerable_GetEnumerator, (app::Queue_1_OrbSpawnerManager_ItemToSpawn_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA52E0, OrbSpawnerManager_ItemToSpawn, Peek, (app::Queue_1_OrbSpawnerManager_ItemToSpawn_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0243D5D0, OrbSpawnerManager_ItemToSpawn__Array *, ToArray, (app::Queue_1_OrbSpawnerManager_ItemToSpawn_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0243D6C0, void, SetCapacity, (app::Queue_1_OrbSpawnerManager_ItemToSpawn_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x0243D7A0, void, MoveNext, (app::Queue_1_OrbSpawnerManager_ItemToSpawn_ * this_ptr, app::int32_t * index));
