...
IL2CPP_REGISTER_METHOD(0x01170A90, Collider *, get_GroundCollider, (app::PlatformMovementListOfColliders * this_ptr));
IL2CPP_REGISTER_METHOD(0x01170B40, Collider *, get_CeilingCollider, (app::PlatformMovementListOfColliders * this_ptr));
IL2CPP_REGISTER_METHOD(0x01170BF0, Collider *, get_WallLeftCollider, (app::PlatformMovementListOfColliders * this_ptr));
IL2CPP_REGISTER_METHOD(0x01170CA0, Collider *, get_WallRightCollider, (app::PlatformMovementListOfColliders * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01171190, void, __ctor, (app::PlatformMovementListOfColliders * this_ptr));
}
