...
IL2CPP_REGISTER_METHOD(0x022E5C40, void, Update, (FieldByRefUpdater * __this, InterpretedFrame * frame, Object * value));
IL2CPP_REGISTER_METHOD(0x022E5D70, void, UndefineTemps, (FieldByRefUpdater * __this, InstructionList * instructions, LocalVariables * locals));
}
