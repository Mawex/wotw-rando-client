...
IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor, (app::ParticleSystem_ShapeModule__Boxed * this_ptr, app::ParticleSystem * particle_system));
IL2CPP_REGISTER_METHOD(0x00248950, Vector3, get_scale, (app::ParticleSystem_ShapeModule__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03135730, Vector3, GetScale, (app::ParticleSystem * system));
