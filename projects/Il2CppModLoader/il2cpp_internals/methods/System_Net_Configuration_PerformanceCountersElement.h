...
namespace app::methods::System_Net_Configuration::PerformanceCountersElement {
IL2CPP_REGISTER_METHOD(0x02019F20, void, __ctor, (app::PerformanceCountersElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02019FB0, ConfigurationPropertyCollection *, get_Properties, (app::PerformanceCountersElement * this_ptr));
