...
namespace app::methods::Moon_BehaviourSystem::UtilitySelectorNode {
IL2CPP_REGISTER_METHOD(0x002FBCA0, Single__Array *, get_Utilities, (app::UtilitySelectorNode * this_ptr));
IL2CPP_REGISTER_METHOD(0x03012540, BehaviourStatus__Enum, OnExecute, (app::UtilitySelectorNode * this_ptr, app::IContext * context));
