...
IL2CPP_REGISTER_METHOD(0x00E05C90, Vector3, get_Position, (app::GenericAttackable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, IDamageReciever__Array *, get_AffectedReceivers, (app::GenericAttackable * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::GenericAttackable * this_ptr));
}
