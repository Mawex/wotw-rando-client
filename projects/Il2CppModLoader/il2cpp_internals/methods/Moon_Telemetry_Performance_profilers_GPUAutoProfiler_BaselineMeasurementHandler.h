...
namespace app::methods::Moon_Telemetry_Performance_profilers::GPUAutoProfiler_BaselineMeasurementHandler {
...
IL2CPP_REGISTER_METHOD(0x00E44790, String *, get_DebugString, (app::GPUAutoProfiler_BaselineMeasurementHandler * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E44870, void, __ctor, (app::GPUAutoProfiler_BaselineMeasurementHandler * this_ptr));
}
