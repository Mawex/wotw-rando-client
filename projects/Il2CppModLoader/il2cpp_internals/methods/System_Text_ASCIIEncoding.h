...
namespace app::methods::System_Text::ASCIIEncoding {
IL2CPP_REGISTER_METHOD(0x02445830, void, __ctor, (app::ASCIIEncoding * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02445BA0, int32_t, GetByteCount_3, (app::ASCIIEncoding * this_ptr, app::uint16_t * chars, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x02446210, int32_t, GetBytes_3, (app::ASCIIEncoding * this_ptr, app::uint16_t * chars, int32_t char_count, app::uint8_t * bytes, int32_t byte_count));
...
IL2CPP_REGISTER_METHOD(0x02446560, int32_t, GetCharCount_2, (app::ASCIIEncoding * this_ptr, app::uint8_t * bytes, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x02446940, int32_t, GetChars_2, (app::ASCIIEncoding * this_ptr, app::uint8_t * bytes, int32_t byte_count, app::uint16_t * chars, int32_t char_count));
IL2CPP_REGISTER_METHODINFO(0x04725170, ASCIIEncoding_GetChars_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02446AC0, String *, GetString, (app::ASCIIEncoding * this_ptr, app::Byte__Array * bytes, int32_t byte_index, int32_t byte_count));
IL2CPP_REGISTER_METHODINFO(0x04758BB0, ASCIIEncoding_GetString__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02446C90, int32_t, GetByteCount_4, (app::ASCIIEncoding * this_ptr, app::uint16_t * chars, int32_t char_count, app::EncoderNLS * encoder));
IL2CPP_REGISTER_METHODINFO(0x0471B7A8, ASCIIEncoding_GetByteCount_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02447050, int32_t, GetBytes_4, (app::ASCIIEncoding * this_ptr, app::uint16_t * chars, int32_t char_count, app::uint8_t * bytes, int32_t byte_count, app::EncoderNLS * encoder));
IL2CPP_REGISTER_METHODINFO(0x04711EC8, ASCIIEncoding_GetBytes_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x024475F0, int32_t, GetCharCount_3, (app::ASCIIEncoding * this_ptr, app::uint8_t * bytes, int32_t count, app::DecoderNLS * decoder));
IL2CPP_REGISTER_METHOD(0x024477C0, int32_t, GetChars_3, (app::ASCIIEncoding * this_ptr, app::uint8_t * bytes, int32_t byte_count, app::uint16_t * chars, int32_t char_count, app::DecoderNLS * decoder));
...
IL2CPP_REGISTER_METHOD(0x02447E20, Decoder *, GetDecoder, (app::ASCIIEncoding * this_ptr));
IL2CPP_REGISTER_METHOD(0x02447F90, Encoder *, GetEncoder, (app::ASCIIEncoding * this_ptr));
}
