...
IL2CPP_REGISTER_METHOD(0x001E1570, String *, ToString_1, (app::Boolean__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001E1580, String *, ToString_2, (app::Boolean__Boxed * this_ptr, app::IFormatProvider * provider));
...
IL2CPP_REGISTER_METHOD(0x0229DF00, bool, TryParse, (app::String * value, app::bool * result));
IL2CPP_REGISTER_METHOD(0x0229E3D0, String *, TrimWhiteSpaceAndNull, (app::String * value));
IL2CPP_REGISTER_METHOD(0x001E15D0, TypeCode__Enum, GetTypeCode, (app::Boolean__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x001E1CC0, Decimal, IConvertible_ToDecimal, (app::Boolean__Boxed * this_ptr, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHOD(0x001E1E10, DateTime, IConvertible_ToDateTime, (app::Boolean__Boxed * this_ptr, app::IFormatProvider * provider));
IL2CPP_REGISTER_METHODINFO(0x047644C0, Boolean_System_IConvertible_ToDateTime__MethodInfo);
IL2CPP_REGISTER_METHOD(0x001E1E20, Object *, IConvertible_ToType, (app::Boolean__Boxed * this_ptr, app::Type * type, app::IFormatProvider * provider));
