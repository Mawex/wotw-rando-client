...
namespace app::methods::System_Xml_Schema::XmlSchemaComplexContent {
...
IL2CPP_REGISTER_METHOD(0x002FBB40, XmlSchemaContent *, get_Content, (app::XmlSchemaComplexContent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::XmlSchemaComplexContent * this_ptr));
}
