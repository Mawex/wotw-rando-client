...
IL2CPP_REGISTER_METHOD(0x00420230, BehaviourStatus__Enum, OnExecuteTask, (app::StunnBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00672030, void, __ctor, (app::StunnBehaviour * this_ptr));
