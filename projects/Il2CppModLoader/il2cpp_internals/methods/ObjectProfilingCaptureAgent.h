...
IL2CPP_REGISTER_METHOD(0x0060F440, String *, GetPathForID, (app::ObjectProfilingCaptureAgent * this_ptr, int32_t id));
IL2CPP_REGISTER_METHOD(0x002FA000, void, UpdateData, (app::ObjectProfilingCaptureAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x0060F4C0, String__Array *, GetFrameData, (app::ObjectProfilingCaptureAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8E90, void, OnTestEnd, (app::ObjectProfilingCaptureAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x0060F660, String__Array *, GetDataHeaderNames, (app::ObjectProfilingCaptureAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x0060F6E0, void, __ctor, (app::ObjectProfilingCaptureAgent * this_ptr));
}
