...
namespace app::methods::UnityEngine_Experimental_Rendering::BuiltinRuntimeReflectionSystem {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::BuiltinRuntimeReflectionSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02432CE0, BuiltinRuntimeReflectionSystem *, Internal_BuiltinRuntimeReflectionSystem_New, ());
}
