...
namespace app::methods::SeinRun {
    ...
    IL2CPP_REGISTER_METHOD(0x005D6EE0, SeinRunPuppet*, get_Puppet, (app::SeinRun * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement*, get_PlatformMovement, (app::SeinRun * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005D06F0, CharacterLeftRightMovement*, get_LeftRightMovement, (app::SeinRun * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005D0720, CharacterSpriteMirror*, get_SpriteMirror, (app::SeinRun * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x005D8980, void, __ctor, (app::SeinRun * this_ptr));
} // namespace app::methods::SeinRun
