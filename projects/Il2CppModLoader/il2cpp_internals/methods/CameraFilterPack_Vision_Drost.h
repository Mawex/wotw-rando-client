...
IL2CPP_REGISTER_METHOD(0x020F7070, Material *, get_material, (app::CameraFilterPack_Vision_Drost * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020F79C0, void, __ctor, (app::CameraFilterPack_Vision_Drost * this_ptr));
}
