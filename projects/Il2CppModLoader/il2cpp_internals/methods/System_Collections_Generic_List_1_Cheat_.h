...
namespace app::methods::System_Collections_Generic::List_1_Cheat_ {
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_Cheat_, GetEnumerator, (app::List_1_Cheat_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0475EDD8, List_1_Cheat__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EFC50, Cheat *, get_Item, (app::List_1_Cheat_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_Cheat_ * this_ptr));
