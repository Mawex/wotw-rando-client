...
namespace app::methods::Swing::RectExt {
    IL2CPP_REGISTER_METHOD(0x0182E030, app::RectExt, operator__1, (app::Rect _rect));
    IL2CPP_REGISTER_METHOD(0x0182E050, app::Rect, operator__2, (app::RectExt _rect));
    ...
    IL2CPP_REGISTER_METHOD(0x0182E620, app::RectExt, operator___1, (app::RectExt _rect, float _mult));
    IL2CPP_REGISTER_METHOD(0x0182E640, app::RectExt, operator___2, (app::RectExt _rect, app::Vector2 _mult));
    IL2CPP_REGISTER_METHOD(0x0182E690, app::RectExt, operator___3, (app::RectExt _rect, float _div));
    IL2CPP_REGISTER_METHOD(0x0182E6B0, app::RectExt, operator___4, (app::RectExt _rect, app::Vector2 _div));
