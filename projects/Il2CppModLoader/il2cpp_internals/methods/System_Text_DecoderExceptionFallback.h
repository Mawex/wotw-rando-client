...
namespace app::methods::System_Text::DecoderExceptionFallback {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::DecoderExceptionFallback * this_ptr));
IL2CPP_REGISTER_METHOD(0x02448D80, DecoderFallbackBuffer *, CreateFallbackBuffer, (app::DecoderExceptionFallback * this_ptr));
