...
IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::StompableFloor * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006567D0, Vector2, GasBallBaitCenter, (app::StompableFloor * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417FF0, float, get_GasBallAttractionTime, (app::StompableFloor * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCE0, IDamageReciever__Array *, get_AffectedReceivers, (app::StompableFloor * this_ptr));
IL2CPP_REGISTER_METHOD(0x00656930, void, __ctor, (app::StompableFloor * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::StompableFloor * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::StompableFloor * this_ptr));
}
