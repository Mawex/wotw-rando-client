...
IL2CPP_REGISTER_METHOD(0x02C65D20, void, __ctor, (app::Texture * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C65F90, TextureWrapMode__Enum, get_wrapMode, (app::Texture * this_ptr));
IL2CPP_REGISTER_METHOD(0x02C65FE0, void, set_wrapMode, (app::Texture * this_ptr, app::TextureWrapMode__Enum value));
IL2CPP_REGISTER_METHOD(0x02C66040, FilterMode__Enum, get_filterMode, (app::Texture * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C66200, Vector2, get_texelSize, (app::Texture * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C66920, UnityException *, CreateNonReadableException, (app::Texture * this_ptr, app::Texture * t));
