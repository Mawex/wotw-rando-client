...
IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkExternalSourceInfo * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x026E46F0, void *, getCPtr, (app::AkExternalSourceInfo * obj));
IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkExternalSourceInfo * this_ptr, app::void * c_ptr));
...
IL2CPP_REGISTER_METHOD(0x026E4A10, void, __ctor_2, (app::AkExternalSourceInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x026E4B30, void, __ctor_3, (app::AkExternalSourceInfo * this_ptr, app::void * in_p_in_memory, uint32_t in_ui_memory_size, uint32_t in_i_external_src_cookie, uint32_t in_id_codec));
IL2CPP_REGISTER_METHOD(0x026E4C90, void, __ctor_4, (app::AkExternalSourceInfo * this_ptr, app::String * in_psz_file_name, uint32_t in_i_external_src_cookie, uint32_t in_id_codec));
IL2CPP_REGISTER_METHOD(0x026E4DF0, void, __ctor_5, (app::AkExternalSourceInfo * this_ptr, uint32_t in_id_file, uint32_t in_i_external_src_cookie, uint32_t in_id_codec));
...
IL2CPP_REGISTER_METHOD(0x026E56E0, String *, get_szFile, (app::AkExternalSourceInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x026E5830, void, set_pInMemory, (app::AkExternalSourceInfo * this_ptr, app::void * value));
