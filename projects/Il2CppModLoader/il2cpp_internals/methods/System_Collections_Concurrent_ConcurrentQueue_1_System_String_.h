...
namespace app::methods::System_Collections_Concurrent::ConcurrentQueue_1_System_String_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02F272B0, void, __ctor, (app::ConcurrentQueue_1_System_String_ * this_ptr));
