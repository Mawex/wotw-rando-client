...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::BrowserNative_Calltype_zfb_numBrowsers * this_ptr, app::Object * object, app::void * method_1));
IL2CPP_REGISTER_METHOD(0x0167F180, int32_t, Invoke, (app::BrowserNative_Calltype_zfb_numBrowsers * this_ptr));
IL2CPP_REGISTER_METHOD(0x00611B10, IAsyncResult *, BeginInvoke, (app::BrowserNative_Calltype_zfb_numBrowsers * this_ptr, app::AsyncCallback * callback, app::Object * object));
