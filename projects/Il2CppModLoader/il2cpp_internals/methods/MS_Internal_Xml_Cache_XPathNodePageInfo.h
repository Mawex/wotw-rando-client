...
namespace app::methods::MS_Internal_Xml_Cache::XPathNodePageInfo {
...
IL2CPP_REGISTER_METHOD(0x002FB930, XPathNode__Array *, get_NextPage, (app::XPathNodePageInfo * this_ptr));
}
