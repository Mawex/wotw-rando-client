...
IL2CPP_REGISTER_METHOD(0x029F0090, void, __ctor, (app::GUISettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x029F0120, Color, get_cursorColor, (app::GUISettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x029F0130, float, get_cursorFlashSpeed, (app::GUISettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x029F0190, Color, get_selectionColor, (app::GUISettings * this_ptr));
}
