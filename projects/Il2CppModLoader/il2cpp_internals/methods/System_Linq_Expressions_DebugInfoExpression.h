...
namespace app::methods::System_Linq_Expressions::DebugInfoExpression {
IL2CPP_REGISTER_METHOD(0x01FA3900, Type *, get_Type, (app::DebugInfoExpression * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E3E530, ExpressionType__Enum, get_NodeType, (app::DebugInfoExpression * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA280, SymbolDocumentInfo *, get_Document, (app::DebugInfoExpression * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01FA3AE0, Expression *, Accept, (app::DebugInfoExpression * this_ptr, app::ExpressionVisitor * visitor));
}
