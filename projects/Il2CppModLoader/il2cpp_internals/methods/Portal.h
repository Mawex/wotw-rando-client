...
namespace app::methods::Portal {
    IL2CPP_REGISTER_METHOD(0x00C60E20, SceneRoot*, get_SceneRoot, (app::Portal * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00C61270, Bounds, get_Bounds, (app::Portal * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00417870, bool, get_AllowCacheBounds, (app::Portal * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00C61370, ISoundHost*, get_SoundHost, (app::Portal * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_CenterPosition, (app::Portal * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00C63E60, Vector3, get_OutwardsFacingWorldDir, (app::Portal * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00C64100, void, PerformPortalTeleportation, (app::Portal * this_ptr, app::IPortalVisitor* portal_visitor));
    IL2CPP_REGISTER_METHOD(0x00C655F0, Vector3, ClampPosition, (app::Portal * this_ptr, app::Vector3 position, app::Portal* portal));
    IL2CPP_REGISTER_METHOD(0x00C65920, IEnumerator*, DisableOriForABit, (app::Portal * this_ptr, app::Portal* other));
    IL2CPP_REGISTER_METHOD(0x00C65A80, Vector3, CalculateEndPosition_1, (app::Portal * this_ptr, app::Portal* other, app::Vector3 position));
    IL2CPP_REGISTER_METHOD(0x00C65C80, Vector3, CalculateEndPosition_2, (app::Portal * this_ptr, app::Portal* other, app::Vector3 position, app::Portal_AssistConfig* config));
    IL2CPP_REGISTER_METHOD(0x00C65D00, Vector3, CalculateEndSpeed_1, (app::Portal * this_ptr, app::Portal* other, app::Vector3 speed));
    IL2CPP_REGISTER_METHOD(0x00C66060, Vector3, CalculateEndSpeed_2, (app::Portal * this_ptr, app::Portal* other, app::Vector3 speed, app::Portal_AssistConfig* config));
    ...
    IL2CPP_REGISTER_METHOD(0x0043D9A0, SelectableCategory__Enum, get_Category, (app::Portal * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00C66220, bool, IsSein, (app::Portal * this_ptr, app::IPortalVisitor* visitor));
    IL2CPP_REGISTER_METHOD(0x00C66460, Portal_AssistConfig*, GetAssistConfig, (app::Portal * this_ptr, app::IPortalVisitor* visitor));
    IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::Portal * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00C66970, void, __ctor, (app::Portal * this_ptr));
} // namespace app::methods::Portal
