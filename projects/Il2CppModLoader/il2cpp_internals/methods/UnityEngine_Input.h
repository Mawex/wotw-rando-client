...
IL2CPP_REGISTER_METHOD(0x0252D5C0, String__Array *, GetJoystickNames, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x0252D6D0, bool, get_simulateMouseWithTouches, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x0252D770, Vector2, get_mouseScrollDelta, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x01F19C80, IMECompositionMode__Enum, get_imeCompositionMode, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0252D7D0, void, set_imeCompositionMode, (IMECompositionMode__Enum value));
IL2CPP_REGISTER_METHOD(0x01F19C30, String *, get_compositionString, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0252D820, Vector2, get_compositionCursorPos, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0252D880, void, set_compositionCursorPos, (Vector2 value));
IL2CPP_REGISTER_METHOD(0x01F19DE0, bool, get_mousePresent, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x01F19FE0, int32_t, get_touchCount, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x01F19F90, bool, get_touchSupported, (MethodInfo * method));
