...
IL2CPP_REGISTER_METHOD(0x020E8960, Material *, get_material, (app::CameraFilterPack_TV_Distorted * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E9130, void, __ctor, (app::CameraFilterPack_TV_Distorted * this_ptr));
}
