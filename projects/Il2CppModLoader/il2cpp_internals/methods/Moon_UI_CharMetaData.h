...
namespace app::methods::Moon_UI::CharMetaData {
...
IL2CPP_REGISTER_METHOD(0x0011E350, BitmapFontChar_1 *, MarkAsVisible, (app::CharMetaData_1__Boxed * this_ptr, int32_t unstyled_index, app::Vector2 position, app::AppliedTextStyle_1 * style));
