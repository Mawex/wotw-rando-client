...
namespace app::methods::System_Collections_Generic::EqualityComparer_1_Datadog_ThresholdItem_ {
IL2CPP_REGISTER_METHOD(0x02807CD0, EqualityComparer_1_Datadog_ThresholdItem_ *, get_Default, ());
IL2CPP_REGISTER_METHOD(0x02CC5980, EqualityComparer_1_Datadog_ThresholdItem_ *, CreateComparer, ());
...
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::EqualityComparer_1_Datadog_ThresholdItem_ * this_ptr));
}
