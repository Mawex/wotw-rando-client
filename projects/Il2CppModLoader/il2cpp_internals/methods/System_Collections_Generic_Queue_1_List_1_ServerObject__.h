...
IL2CPP_REGISTER_METHOD(0x002FD1D0, int32_t, get_Count, (Queue_1_List_1_ServerObject_ * __this));
IL2CPP_REGISTER_METHODINFO(0x047951E0, Queue_1_List_1_ServerObject__get_Count__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02CA77B0, List_1_ServerObject_ *, Dequeue, (Queue_1_List_1_ServerObject_ * __this));
IL2CPP_REGISTER_METHODINFO(0x0476A6E0, Queue_1_List_1_ServerObject__Dequeue__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02CA7610, void, Enqueue, (Queue_1_List_1_ServerObject_ * __this, List_1_ServerObject_ * item));
