...
IL2CPP_REGISTER_METHOD(0x00D2CC30, Vector3, get_TransformedLaserDirection, (app::BlockableLaser * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D2FAC0, Damage *, DealLaserDamage, (app::BlockableLaser * this_ptr, app::GameObject * hit_object));
IL2CPP_REGISTER_METHOD(0x00D2FFE0, void, FixedUpdate, (app::BlockableLaser * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D30000, GameObject *, GetImpactEffectPrefab, (app::BlockableLaser * this_ptr, app::Collider * hit_collider));
IL2CPP_REGISTER_METHOD(0x00D30310, GameObject *, GetImpactLoopEffectPrefab, (app::BlockableLaser * this_ptr, app::Collider * hit_collider));
...
IL2CPP_REGISTER_METHOD(0x00D321E0, void, PerformLaserRaycast, (app::BlockableLaser * this_ptr, app::Vector3 * laser_end_point, app::Vector3 * hit_normal, app::float * best_distance, app::Collider * * hit_collider));
...
IL2CPP_REGISTER_METHOD(0x00D338F0, SuspendableMask__Enum, get_Mask, (app::BlockableLaser * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D339D0, Vector3, NearestPointOnFiniteLine, (app::Vector2 start, app::Vector2 end, app::Vector2 pnt));
IL2CPP_REGISTER_METHOD(0x00D33BE0, void, __ctor, (app::BlockableLaser * this_ptr));
