...
namespace app::methods::MoonGuid {
    IL2CPP_REGISTER_METHOD(0x00F506D0, void, __ctor_1, (app::MoonGuid * this_ptr, app::MoonGuid* moon_guid));
    IL2CPP_REGISTER_METHOD(0x00F50700, void, __ctor_2, (app::MoonGuid * this_ptr, int32_t a, int32_t b, int32_t c, int32_t d));
    IL2CPP_REGISTER_METHOD(0x00F50720, void, __ctor_3, (app::MoonGuid * this_ptr, app::Guid guid));
    IL2CPP_REGISTER_METHOD(0x00F50760, void, __ctor_4, (app::MoonGuid * this_ptr, app::String* guid));
    IL2CPP_REGISTER_METHOD(0x00F50770, void, __ctor_5, (app::MoonGuid * this_ptr, app::Byte__Array* guid_byte_array));
    IL2CPP_REGISTER_METHOD(0x00F50780, void, __ctor_6, (app::MoonGuid * this_ptr, app::BinaryReader* reader));
    ...
    IL2CPP_REGISTER_METHOD(0x00F50B80, Byte__Array*, ToByteArray, (app::MoonGuid * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00F51090, String*, get_GUIDString, (app::MoonGuid * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00F51090, String*, ToString, (app::MoonGuid * this_ptr));
