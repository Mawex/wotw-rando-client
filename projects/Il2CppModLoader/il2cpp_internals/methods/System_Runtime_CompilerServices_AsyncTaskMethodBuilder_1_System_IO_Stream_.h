...
namespace app::methods::System_Runtime_CompilerServices::AsyncTaskMethodBuilder_1_System_IO_Stream_ {
...
IL2CPP_REGISTER_METHOD(0x001FF3E0, Task_1_System_IO_Stream_ *, get_Task, (app::AsyncTaskMethodBuilder_1_System_IO_Stream___Boxed * this_ptr));
