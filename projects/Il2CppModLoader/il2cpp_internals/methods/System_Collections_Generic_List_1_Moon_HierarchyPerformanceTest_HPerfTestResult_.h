...
namespace app::methods::System_Collections_Generic::List_1_Moon_HierarchyPerformanceTest_HPerfTestResult_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_Moon_HierarchyPerformanceTest_HPerfTestResult_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EFC50, HPerfTestResult *, get_Item, (app::List_1_Moon_HierarchyPerformanceTest_HPerfTestResult_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_Moon_HierarchyPerformanceTest_HPerfTestResult_ * this_ptr, int32_t capacity));
