...
namespace app::methods::System_Data::XMLDiffLoader {
...
IL2CPP_REGISTER_METHOD(0x023D2570, DataTable *, GetTable, (app::XMLDiffLoader * this_ptr, app::String * table_name, app::String * ns));
IL2CPP_REGISTER_METHOD(0x023D2850, int32_t, ReadOldRowData, (app::XMLDiffLoader * this_ptr, app::DataSet * ds, app::DataTable * * table, app::int32_t * pos, app::XmlReader * row));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::XMLDiffLoader * this_ptr));
}
