...
namespace app::methods::Moon_BehaviourSystem::Blackboard_BlackboardMoonTypes {
...
IL2CPP_REGISTER_METHOD(0x03009580, void, __ctor, (app::Blackboard_BlackboardMoonTypes * this_ptr));
IL2CPP_REGISTER_METHOD(0x015EBDA0, Object *, GetNewVariable_1, (app::Blackboard_BlackboardMoonTypes * this_ptr, app::String * var_name, app::Type * type));
...
IL2CPP_REGISTER_METHOD(0x015EBDA0, BlackboardVariableInt *, GetNewVariable_2, (app::Blackboard_BlackboardMoonTypes * this_ptr, app::String * var_name, app::Type * type));
IL2CPP_REGISTER_METHODINFO(0x0475C5B0, Blackboard_BlackboardMoonTypes_GetNewVariable_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015EBDA0, BlackboardVariableBool *, GetNewVariable_3, (app::Blackboard_BlackboardMoonTypes * this_ptr, app::String * var_name, app::Type * type));
IL2CPP_REGISTER_METHODINFO(0x04734CD8, Blackboard_BlackboardMoonTypes_GetNewVariable_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015EBDA0, BlackboardVariableFloat *, GetNewVariable_4, (app::Blackboard_BlackboardMoonTypes * this_ptr, app::String * var_name, app::Type * type));
IL2CPP_REGISTER_METHODINFO(0x04738CE8, Blackboard_BlackboardMoonTypes_GetNewVariable_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015EBDA0, BlackboardVariableVector3 *, GetNewVariable_5, (app::Blackboard_BlackboardMoonTypes * this_ptr, app::String * var_name, app::Type * type));
IL2CPP_REGISTER_METHODINFO(0x04752820, Blackboard_BlackboardMoonTypes_GetNewVariable_4__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015EBDA0, BlackboardVariableGameObject *, GetNewVariable_6, (app::Blackboard_BlackboardMoonTypes * this_ptr, app::String * var_name, app::Type * type));
IL2CPP_REGISTER_METHODINFO(0x047540D0, Blackboard_BlackboardMoonTypes_GetNewVariable_5__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015EBDA0, BlackboardVariableObject *, GetNewVariable_7, (app::Blackboard_BlackboardMoonTypes * this_ptr, app::String * var_name, app::Type * type));
IL2CPP_REGISTER_METHODINFO(0x04739A40, Blackboard_BlackboardMoonTypes_GetNewVariable_6__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015EBDA0, BlackboardVariableString *, GetNewVariable_8, (app::Blackboard_BlackboardMoonTypes * this_ptr, app::String * var_name, app::Type * type));
