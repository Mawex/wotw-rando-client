...
namespace app::methods::System_Collections_Specialized::NameObjectCollectionBase_KeysCollection {
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor_1, (app::NameObjectCollectionBase_KeysCollection * this_ptr, app::NameObjectCollectionBase * coll));
IL2CPP_REGISTER_METHOD(0x02498E10, IEnumerator *, GetEnumerator, (app::NameObjectCollectionBase_KeysCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024993A0, Object *, ICollection_get_SyncRoot, (app::NameObjectCollectionBase_KeysCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02499430, void, __ctor_2, (app::NameObjectCollectionBase_KeysCollection * this_ptr));
