...
IL2CPP_REGISTER_METHOD(0x01449D90, BehaviourStatus__Enum, OnExecuteTask, (app::MinerFallReactionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x01449DF0, void, OnExitTask, (app::MinerFallReactionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x01449E00, void, __ctor, (app::MinerFallReactionBehaviour * this_ptr));
}
