...
IL2CPP_REGISTER_METHOD(0x020E8210, Material *, get_material, (app::CameraFilterPack_TV_CompressionFX * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E8940, void, __ctor, (app::CameraFilterPack_TV_CompressionFX * this_ptr));
}
