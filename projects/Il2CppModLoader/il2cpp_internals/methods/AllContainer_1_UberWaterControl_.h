...
IL2CPP_REGISTER_METHOD(0x019D7800, UberWaterControl *, get_Item, (app::AllContainer_1_UberWaterControl_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x002FA280, List_1_UberWaterControl_ *, RawList, (app::AllContainer_1_UberWaterControl_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::AllContainer_1_UberWaterControl_ * this_ptr));
