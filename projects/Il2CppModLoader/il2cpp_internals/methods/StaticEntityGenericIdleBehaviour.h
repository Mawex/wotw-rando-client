...
IL2CPP_REGISTER_METHOD(0x00420EE0, BehaviourStatus__Enum, OnExecuteTask, (app::StaticEntityGenericIdleBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x005B3EC0, void, __ctor, (app::StaticEntityGenericIdleBehaviour * this_ptr));
}
