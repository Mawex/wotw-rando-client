...
namespace app::methods::Moon_Timeline::TimelineConstraint {
IL2CPP_REGISTER_METHOD(0x0052A010, ConstraintFlag__Enum, get_Flags, (app::TimelineConstraint * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00529FF0, EntityId, get_ConstrainedTo, (app::TimelineConstraint * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E83BA0, TimelineConstraint *, Copy, (app::TimelineConstraint * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E83D00, void, __ctor, (app::TimelineConstraint * this_ptr));
}
