...
IL2CPP_REGISTER_METHOD(0x00FC1DC0, Vector3, get_TargetPosition, (app::LockOnTargetProjectile * this_ptr));
IL2CPP_REGISTER_METHOD(0x00FC1E90, Vector3, get_Position, (app::LockOnTargetProjectile * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FC2DE0, void, __ctor, (app::LockOnTargetProjectile * this_ptr));
}
