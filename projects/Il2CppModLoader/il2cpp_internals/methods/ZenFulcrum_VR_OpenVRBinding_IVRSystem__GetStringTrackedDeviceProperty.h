...
namespace app::methods::ZenFulcrum_VR_OpenVRBinding::IVRSystem__GetStringTrackedDeviceProperty {
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::IVRSystem_GetStringTrackedDeviceProperty * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02CEEAD0, IAsyncResult *, BeginInvoke, (app::IVRSystem_GetStringTrackedDeviceProperty * this_ptr, uint32_t un_device_index, app::ETrackedDeviceProperty__Enum prop, app::StringBuilder * pch_value, uint32_t un_buffer_size, app::ETrackedPropertyError__Enum * p_error, app::AsyncCallback * callback, app::Object * object));
