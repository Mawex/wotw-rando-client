...
IL2CPP_REGISTER_METHOD(0x01046700, CharacterLeftRightMovement *, get_CharacterLeftRightMovement, (app::CharacterAirNoDeceleration * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B39300, PlatformMovement *, get_PlatformMovement, (app::CharacterAirNoDeceleration * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005C9550, void, __ctor, (app::CharacterAirNoDeceleration * this_ptr));
}
