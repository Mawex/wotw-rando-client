...
namespace app::methods::System_Collections_Generic::List_1_System_Net_WebConnection_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_System_Net_WebConnection_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_System_Net_WebConnection_, GetEnumerator, (app::List_1_System_Net_WebConnection_ * this_ptr));
