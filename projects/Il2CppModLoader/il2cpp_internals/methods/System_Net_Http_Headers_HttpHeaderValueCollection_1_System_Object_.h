...
namespace app::methods::System_Net_Http_Headers::HttpHeaderValueCollection_1_System_Object_ {
IL2CPP_REGISTER_METHOD(0x0243AC00, int32_t, get_Count, (app::HttpHeaderValueCollection_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB950, List_1_System_String_ *, get_InvalidValues, (app::HttpHeaderValueCollection_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0254D920, String *, ToString, (app::HttpHeaderValueCollection_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0254D9D0, IEnumerator_1_System_Object_ *, GetEnumerator, (app::HttpHeaderValueCollection_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x019D9BE0, IEnumerator *, IEnumerable_GetEnumerator, (app::HttpHeaderValueCollection_1_System_Object_ * this_ptr));
}
