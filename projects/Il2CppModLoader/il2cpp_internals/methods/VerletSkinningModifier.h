...
IL2CPP_REGISTER_METHOD(0x005035C0, SuspendableMask__Enum, get_Mask, (app::VerletSkinningModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x013C84F0, void, set_Mask, (app::VerletSkinningModifier * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x013C8500, void, __ctor, (app::VerletSkinningModifier * this_ptr));
