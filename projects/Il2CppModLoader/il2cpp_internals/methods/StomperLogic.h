...
namespace app::methods::StomperLogic {
    ...
    IL2CPP_REGISTER_METHOD(0x0065B580, SuspendableMask__Enum, get_Mask, (app::StomperLogic * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0065B590, void, set_Mask, (app::StomperLogic * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x002FBCC0, IMoonSetupAnimator*, get_MoonSetupAnimator, (app::StomperLogic * this_ptr));
