...
IL2CPP_REGISTER_METHOD(0x011C0510, BehaviourStatus__Enum, OnExecuteTask, (app::SpiderlingDeathReaction * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x011C1090, void, __ctor, (app::SpiderlingDeathReaction * this_ptr));
}
