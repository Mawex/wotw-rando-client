...
namespace app::methods::Moon::TurtleShellRollAttackBehaviourNew_StartRollState {
    IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::TurtleShellRollAttackBehaviourNew_StartRollState * this_ptr, app::TurtleShellRollAttackBehaviourNew * behaviour));
