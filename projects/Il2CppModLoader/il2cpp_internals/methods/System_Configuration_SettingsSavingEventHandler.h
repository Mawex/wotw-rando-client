...
namespace app::methods::System_Configuration::SettingsSavingEventHandler {
IL2CPP_REGISTER_METHOD(0x01FFE1A0, void, __ctor, (app::SettingsSavingEventHandler * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x01FFE200, IAsyncResult *, BeginInvoke, (app::SettingsSavingEventHandler * this_ptr, app::Object * sender, app::CancelEventArgs * e, app::AsyncCallback * callback, app::Object * object));
