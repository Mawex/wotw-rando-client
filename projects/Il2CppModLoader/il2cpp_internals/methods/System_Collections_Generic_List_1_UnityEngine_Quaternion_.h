...
namespace app::methods::System_Collections_Generic::List_1_UnityEngine_Quaternion_ {
IL2CPP_REGISTER_METHOD(0x025E8A60, Quaternion, get_Item, (app::List_1_UnityEngine_Quaternion_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02EDFE50, Object *, ICollection_get_SyncRoot, (app::List_1_UnityEngine_Quaternion_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025E8BE0, Object *, IList_get_Item, (app::List_1_UnityEngine_Quaternion_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_UnityEngine_Quaternion_ *, AsReadOnly, (app::List_1_UnityEngine_Quaternion_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025E96E0, Quaternion, Find, (app::List_1_UnityEngine_Quaternion_ * this_ptr, app::Predicate_1_UnityEngine_Quaternion_ * match));
IL2CPP_REGISTER_METHOD(0x025E9800, List_1_UnityEngine_Quaternion_ *, FindAll, (app::List_1_UnityEngine_Quaternion_ * this_ptr, app::Predicate_1_UnityEngine_Quaternion_ * match));
...
IL2CPP_REGISTER_METHOD(0x025E9D20, List_1_T_Enumerator_UnityEngine_Quaternion_, GetEnumerator, (app::List_1_UnityEngine_Quaternion_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9D60, IEnumerator_1_UnityEngine_Quaternion_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_UnityEngine_Quaternion_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9D60, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_UnityEngine_Quaternion_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_UnityEngine_Quaternion_ *, GetRange, (app::List_1_UnityEngine_Quaternion_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, Quaternion__Array *, ToArray, (app::List_1_UnityEngine_Quaternion_ * this_ptr));
