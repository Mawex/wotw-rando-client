...
namespace app::methods::Moon_HierarchyPerformanceTest::HierarchyTester {
...
IL2CPP_REGISTER_METHOD(0x002FBC40, SceneTestData *, get_Data, (app::HierarchyTester * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014A70C0, CompositeTask *, CreateProcessingTask, (app::HierarchyTester * this_ptr, app::SceneTestData * data));
...
IL2CPP_REGISTER_METHOD(0x014A7F30, GameObject *, GetArtGroupGameObject, (app::HierarchyTester * this_ptr, app::SceneRoot * scene_root));
IL2CPP_REGISTER_METHOD(0x014A81D0, SceneRoot *, GetCurrentScene, ());
IL2CPP_REGISTER_METHOD(0x014A8270, String *, FormatEstimateTime, (app::HierarchyTester * this_ptr, int32_t total_seconds));
...
IL2CPP_REGISTER_METHOD(0x014A83B0, void, __ctor, (app::HierarchyTester * this_ptr));
