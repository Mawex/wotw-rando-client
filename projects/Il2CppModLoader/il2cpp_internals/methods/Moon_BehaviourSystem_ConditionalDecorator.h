...
namespace app::methods::Moon_BehaviourSystem::ConditionalDecorator {
IL2CPP_REGISTER_METHOD(0x0300B200, String *, get_Info, (app::ConditionalDecorator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00855600, ConditionalDecorator_ConditionsCheckMode__Enum, get_CheckMode, (app::ConditionalDecorator * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD20, List_1_Moon_BehaviourSystem_Condition_ *, get_Conditions, (app::ConditionalDecorator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0300B9E0, BehaviourStatus__Enum, OnExecute, (app::ConditionalDecorator * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0300BFF0, void, __ctor, (app::ConditionalDecorator * this_ptr));
}
