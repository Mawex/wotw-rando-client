...
IL2CPP_REGISTER_METHOD(0x00B8C1E0, String *, GetNiceName, (app::DestroyObjectAction * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9B0, GameObject *, GetDynamicGraphicTarget, (app::DestroyObjectAction * this_ptr));
