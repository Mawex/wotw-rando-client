...
namespace app::methods::RootMotion_FinalIK::HitReaction_HitPoint {
...
IL2CPP_REGISTER_METHOD(0x020763D0, Vector3, get_force, (app::HitReaction_HitPoint * this_ptr));
IL2CPP_REGISTER_METHOD(0x020763F0, void, set_force, (app::HitReaction_HitPoint * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x0168C6F0, Vector3, get_point, (app::HitReaction_HitPoint * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02076780, void, __ctor, (app::HitReaction_HitPoint * this_ptr));
}
