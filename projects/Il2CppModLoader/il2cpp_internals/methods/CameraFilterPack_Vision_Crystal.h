...
IL2CPP_REGISTER_METHOD(0x020F66F0, Material *, get_material, (app::CameraFilterPack_Vision_Crystal * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020F7040, void, __ctor, (app::CameraFilterPack_Vision_Crystal * this_ptr));
}
