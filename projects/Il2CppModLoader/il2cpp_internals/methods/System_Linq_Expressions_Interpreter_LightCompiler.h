...
namespace app::methods::System_Linq_Expressions_Interpreter::LightCompiler {
IL2CPP_REGISTER_METHOD(0x01CEBBD0, void, __ctor_1, (app::LightCompiler * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CEC400, void, __ctor_2, (app::LightCompiler * this_ptr, app::LightCompiler * parent));
IL2CPP_REGISTER_METHOD(0x002FA280, InstructionList *, get_Instructions, (app::LightCompiler * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CEC430, LightDelegateCreator *, CompileTop, (app::LightCompiler * this_ptr, app::LambdaExpression * node));
IL2CPP_REGISTER_METHOD(0x01CEC7C0, Interpreter *, MakeInterpreter, (app::LightCompiler * this_ptr, app::String * lambda_name));
...
IL2CPP_REGISTER_METHOD(0x01CED140, LocalVariable *, EnsureAvailableForClosure, (app::LightCompiler * this_ptr, app::ParameterExpression * expr));
IL2CPP_REGISTER_METHODINFO(0x04736970, LightCompiler_EnsureAvailableForClosure__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01CED2B0, LocalVariable *, ResolveLocal, (app::LightCompiler * this_ptr, app::ParameterExpression * variable));
...
IL2CPP_REGISTER_METHOD(0x01CEDE80, LocalDefinition__Array *, CompileBlockStart, (app::LightCompiler * this_ptr, app::BlockExpression * node));
...
IL2CPP_REGISTER_METHOD(0x01CF5BD0, LabelInfo *, EnsureLabel, (app::LightCompiler * this_ptr, app::LabelTarget * node));
IL2CPP_REGISTER_METHOD(0x01CF5D80, LabelInfo *, ReferenceLabel, (app::LightCompiler * this_ptr, app::LabelTarget * node));
IL2CPP_REGISTER_METHOD(0x01CF5E60, LabelInfo *, DefineLabel, (app::LightCompiler * this_ptr, app::LabelTarget * node));
...
IL2CPP_REGISTER_METHOD(0x01CF88A0, ByRefUpdater *, CompileArrayIndexAddress, (app::LightCompiler * this_ptr, app::Expression * array, app::Expression * index, int32_t argument_index));
...
IL2CPP_REGISTER_METHOD(0x01CF8DE0, ByRefUpdater *, CompileAddress, (app::LightCompiler * this_ptr, app::Expression * node, int32_t index));
IL2CPP_REGISTER_METHOD(0x01CF99E0, ByRefUpdater *, CompileMultiDimArrayAccess, (app::LightCompiler * this_ptr, app::Expression * array, app::IArgumentProvider * arguments, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x01CFCC70, Type *, GetMemberType, (app::MemberInfo_1 * member));
