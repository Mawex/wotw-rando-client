...
IL2CPP_REGISTER_METHOD(0x0312D090, IEnumerator *, FinalRenderCapture, (app::AVProWindowsMediaManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0312D470, Shader *, GetPixelConversionShader, (app::AVProWindowsMediaManager * this_ptr, app::AVProWindowsMediaPlugin_VideoFrameFormat__Enum format, bool use_b_t709));
IL2CPP_REGISTER_METHOD(0x00597BB0, void, __ctor, (app::AVProWindowsMediaManager * this_ptr));
}
