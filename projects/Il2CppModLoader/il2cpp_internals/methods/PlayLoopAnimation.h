...
IL2CPP_REGISTER_METHOD(0x003FF2B0, SuspendableMask__Enum, get_Mask, (app::PlayLoopAnimation * this_ptr));
IL2CPP_REGISTER_METHOD(0x031B6700, void, set_Mask, (app::PlayLoopAnimation * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x002FD750, UpdateType__Enum, get_UpdateType, (app::PlayLoopAnimation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031B6C30, void, __ctor, (app::PlayLoopAnimation * this_ptr));
}
