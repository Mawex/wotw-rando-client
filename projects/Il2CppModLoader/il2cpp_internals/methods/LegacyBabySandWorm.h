...
IL2CPP_REGISTER_METHOD(0x015CE700, DigZone *, GetDigZoneIntersectingCircle, (app::LegacyBabySandWorm * this_ptr, app::Vector3 center, float radius));
...
IL2CPP_REGISTER_METHOD(0x015D14C0, Vector3, GetPositionFromHistory, (app::LegacyBabySandWorm * this_ptr, float time));
...
IL2CPP_REGISTER_METHOD(0x015D1EE0, void, __ctor, (app::LegacyBabySandWorm * this_ptr));
