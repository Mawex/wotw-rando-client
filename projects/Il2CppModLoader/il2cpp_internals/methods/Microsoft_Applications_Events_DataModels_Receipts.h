...
namespace app::methods::Microsoft_Applications_Events_DataModels::Receipts {
    ...
    IL2CPP_REGISTER_METHOD(0x002FD3B0, void, __ctor_1, (app::Receipts * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_2, (app::Receipts * this_ptr, app::String * full_name, app::String * name));
}
