...
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (Dictionary_2_System_String_System_Net_WebConnectionGroup_ * __this));
IL2CPP_REGISTER_METHODINFO(0x0471BA90, Dictionary_2_System_String_System_Net_WebConnectionGroup___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02BAC170, void, Add, (Dictionary_2_System_String_System_Net_WebConnectionGroup_ * __this, String * key, WebConnectionGroup * value));
IL2CPP_REGISTER_METHODINFO(0x04702FC8, Dictionary_2_System_String_System_Net_WebConnectionGroup__Add__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0283B2A0, int32_t, get_Count, (Dictionary_2_System_String_System_Net_WebConnectionGroup_ * __this));
IL2CPP_REGISTER_METHODINFO(0x04767FC8, Dictionary_2_System_String_System_Net_WebConnectionGroup__get_Count__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02BD3EC0, bool, Remove, (Dictionary_2_System_String_System_Net_WebConnectionGroup_ * __this, String * key));
IL2CPP_REGISTER_METHODINFO(0x04772C10, Dictionary_2_System_String_System_Net_WebConnectionGroup__Remove__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0283B3E0, Dictionary_2_TKey_TValue_ValueCollection_System_String_System_Net_WebConnectionGroup_ *, get_Values, (Dictionary_2_System_String_System_Net_WebConnectionGroup_ * __this));
IL2CPP_REGISTER_METHODINFO(0x0472D300, Dictionary_2_System_String_System_Net_WebConnectionGroup__get_Values__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02BA5090, bool, ContainsKey, (Dictionary_2_System_String_System_Net_WebConnectionGroup_ * __this, String * key));
