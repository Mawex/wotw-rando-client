...
namespace app::methods::System_Xml_Serialization::XmlSerializer {
...
IL2CPP_REGISTER_METHOD(0x002FB930, XmlMapping *, get_Mapping, (app::XmlSerializer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0194A3D0, XmlSerializationReader *, CreateReader_1, (app::XmlSerializer * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0479A220, XmlSerializer_CreateReader__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0194A420, XmlSerializationWriter *, CreateWriter_1, (app::XmlSerializer * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04721DE8, XmlSerializer_CreateWriter__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0194A470, Object *, Deserialize_1, (app::XmlSerializer * this_ptr, app::TextReader * text_reader));
IL2CPP_REGISTER_METHOD(0x0194A5F0, Object *, Deserialize_2, (app::XmlSerializer * this_ptr, app::XmlReader * xml_reader));
IL2CPP_REGISTER_METHOD(0x0194A7B0, Object *, Deserialize_3, (app::XmlSerializer * this_ptr, app::XmlSerializationReader * reader));
...
IL2CPP_REGISTER_METHOD(0x0194B2D0, XmlSerializationWriter *, CreateWriter_2, (app::XmlSerializer * this_ptr, app::XmlMapping * type_mapping));
IL2CPP_REGISTER_METHOD(0x0194B830, XmlSerializationReader *, CreateReader_2, (app::XmlSerializer * this_ptr, app::XmlMapping * type_mapping));
}
