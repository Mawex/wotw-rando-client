...
IL2CPP_REGISTER_METHOD(0x002FC6D0, GCHandle, get_CallbackHandle, (app::XRegistrationToken * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, XTaskQueueRegistrationToken, get_Token, (app::XRegistrationToken * this_ptr));
}
