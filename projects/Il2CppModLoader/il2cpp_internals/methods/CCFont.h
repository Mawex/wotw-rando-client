...
namespace app::methods::CCFont {
    IL2CPP_REGISTER_METHOD(0x0315ACC0, CCFont_Char*, get_Item, (app::CCFont * this_ptr, uint16_t c));
    ...
    IL2CPP_REGISTER_METHOD(0x004140E0, void, __ctor, (app::CCFont * this_ptr));
} // namespace app::methods::CCFont
