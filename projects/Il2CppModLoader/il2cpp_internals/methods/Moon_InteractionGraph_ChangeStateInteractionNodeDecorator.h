...
namespace app::methods::Moon_InteractionGraph::ChangeStateInteractionNodeDecorator {
    ...
    IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::ChangeStateInteractionNodeDecorator * this_ptr));
}
