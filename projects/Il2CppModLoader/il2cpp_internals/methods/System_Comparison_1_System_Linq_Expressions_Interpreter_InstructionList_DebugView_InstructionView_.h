...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::Comparison_1_System_Linq_Expressions_Interpreter_InstructionList_DebugView_InstructionView_ * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02C7EBE0, IAsyncResult *, BeginInvoke, (app::Comparison_1_System_Linq_Expressions_Interpreter_InstructionList_DebugView_InstructionView_ * this_ptr, app::InstructionList_DebugView_InstructionView x, app::InstructionList_DebugView_InstructionView y, app::AsyncCallback * callback, app::Object * object));
