...
IL2CPP_REGISTER_METHOD(0x029683A0, void, __ctor_2, (app::CustomSampler * this_ptr, app::void * ptr));
IL2CPP_REGISTER_METHOD(0x02968450, CustomSampler *, Create, (app::String * name, app::BuiltinCategory__Enum group));
