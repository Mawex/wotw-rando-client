...
namespace app::methods::ZenFulcrum_VR_OpenVRBinding::CVRRenderModels__GetComponentStatePacked {
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::CVRRenderModels_GetComponentStatePacked * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x0167B110, IAsyncResult *, BeginInvoke, (app::CVRRenderModels_GetComponentStatePacked * this_ptr, app::String * pch_render_model_name, app::String * pch_component_name, app::VRControllerState_t_Packed * p_controller_state, app::RenderModel_ControllerMode_State_t * p_state, app::RenderModel_ComponentState_t * p_component_state, app::AsyncCallback * callback, app::Object * object));
