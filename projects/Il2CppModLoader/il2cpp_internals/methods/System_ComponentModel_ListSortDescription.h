...
namespace app::methods::System_ComponentModel::ListSortDescription {
    IL2CPP_REGISTER_METHOD(0x00CC8D50, void, __ctor, (app::ListSortDescription * this_ptr, app::PropertyDescriptor * property, app::ListSortDirection__Enum direction));
