...
namespace app::methods::CartFlip {
    ...
    IL2CPP_REGISTER_METHOD(0x00B38750, Collider*, CheckAboveCart, (app::CartFlip * this_ptr, app::Collider* ignored_collider, app::Rail* current_rail, app::CapsuleCollider* capsule_collider, app::Transform* go_through_above_rail_raycast_position, int32_t rail_mask));
    IL2CPP_REGISTER_METHOD(0x005C9550, void, __ctor, (app::CartFlip * this_ptr));
} // namespace app::methods::CartFlip
