...
IL2CPP_REGISTER_METHOD(0x003FC830, SuspendableMask__Enum, get_Mask, (app::CameraShakeLogic * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B1DF40, void, set_Mask, (app::CameraShakeLogic * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x00856B30, void, __ctor, (app::CameraShakeLogic * this_ptr));
