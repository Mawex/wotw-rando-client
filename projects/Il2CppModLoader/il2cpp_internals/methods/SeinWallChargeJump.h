...
IL2CPP_REGISTER_METHOD(0x00A50B70, PlayerAbilities *, get_PlayerAbilities, (app::SeinWallChargeJump * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement *, get_PlatformMovement, (app::SeinWallChargeJump * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005D0720, CharacterSpriteMirror *, get_CharacterSpriteMirror, (app::SeinWallChargeJump * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00AAB2B0, void, __ctor, (app::SeinWallChargeJump * this_ptr));
}
