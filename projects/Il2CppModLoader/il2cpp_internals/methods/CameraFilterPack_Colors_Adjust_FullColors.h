...
IL2CPP_REGISTER_METHOD(0x024DDBF0, Material *, get_material, (app::CameraFilterPack_Colors_Adjust_FullColors * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024DE5D0, void, __ctor, (app::CameraFilterPack_Colors_Adjust_FullColors * this_ptr));
}
