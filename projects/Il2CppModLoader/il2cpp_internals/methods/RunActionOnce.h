...
namespace app::methods::RunActionOnce {
    ...
    IL2CPP_REGISTER_METHOD(0x01372FB0, String*, GetNiceName, (app::RunActionOnce * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0044C850, void, __ctor, (app::RunActionOnce * this_ptr));
} // namespace app::methods::RunActionOnce
