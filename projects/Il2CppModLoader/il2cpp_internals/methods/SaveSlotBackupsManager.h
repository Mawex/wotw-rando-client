...
IL2CPP_REGISTER_METHOD(0x0091E090, SaveSlotBackup *, get_CurrentSlotBackup, (app::SaveSlotBackupsManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB990, List_1_SaveSlotBackupsManager_BackupParseQueue_ *, get_BackupParsingQueue, (app::SaveSlotBackupsManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00920EB0, SaveSlotBackup *, FindByIndex, (app::SaveSlotBackupsManager * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x00920F60, String *, BackupName, (app::SaveSlotBackupsManager * this_ptr, int32_t slot, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x00922470, void, __ctor, (app::SaveSlotBackupsManager * this_ptr));
