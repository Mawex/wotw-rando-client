...
namespace app::methods::RootMotion_FinalIK::FBIKChain_ChildConstraint {
    ...
    IL2CPP_REGISTER_METHOD(0x02060CC0, void, __ctor, (app::FBIKChain_ChildConstraint * this_ptr, app::Transform * bone1, app::Transform * bone2, float push_elasticity, float pull_elasticity));
