...
namespace app::methods::PetrifiedOwlBossTripleSlamBehaviour_EndState {
    IL2CPP_REGISTER_METHOD(0x01780F60, void, __ctor, (app::PetrifiedOwlBossTripleSlamBehaviour_EndState * this_ptr, app::PetrifiedOwlBossTripleSlamBehaviour * behaviour));
