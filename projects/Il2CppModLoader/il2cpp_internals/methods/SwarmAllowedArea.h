...
IL2CPP_REGISTER_METHOD(0x018139E0, List_1_UnityEngine_Transform_ *, GenerateTargets, (app::SwarmAllowedArea * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x018143B0, void, __ctor, (app::SwarmAllowedArea * this_ptr));
}
