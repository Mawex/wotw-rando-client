...
namespace app::methods::System_Collections_Concurrent::BlockingCollection_1_PlayFab_IPlayFabEmitEventRequest_ {
...
IL2CPP_REGISTER_METHOD(0x02AD8390, void, __ctor, (app::BlockingCollection_1_PlayFab_IPlayFabEmitEventRequest_ * this_ptr, int32_t bounded_capacity));
