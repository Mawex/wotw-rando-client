...
namespace app::methods::System_Configuration::ConfigurationSection {
...
IL2CPP_REGISTER_METHOD(0x031BBE70, String *, SerializeSection, (app::ConfigurationSection * this_ptr, app::ConfigurationElement * parent_element, app::String * name, app::ConfigurationSaveMode__Enum save_mode));
