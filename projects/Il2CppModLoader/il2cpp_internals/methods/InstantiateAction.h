...
IL2CPP_REGISTER_METHOD(0x0062C2D0, String *, GetNiceName, (app::InstantiateAction * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0062C4E0, void, __ctor, (app::InstantiateAction * this_ptr));
}
