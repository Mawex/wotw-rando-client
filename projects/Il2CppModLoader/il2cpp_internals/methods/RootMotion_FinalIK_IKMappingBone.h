...
namespace app::methods::RootMotion_FinalIK::IKMappingBone {
    IL2CPP_REGISTER_METHOD(0x02BDE790, bool, IsValid, (app::IKMappingBone * this_ptr, app::IKSolver * solver, app::String * * message));
    IL2CPP_REGISTER_METHOD(0x02BDE860, void, __ctor_1, (app::IKMappingBone * this_ptr));
    IL2CPP_REGISTER_METHOD(0x02BDE9D0, void, __ctor_2, (app::IKMappingBone * this_ptr, app::Transform * bone));
