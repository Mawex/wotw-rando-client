...
IL2CPP_REGISTER_METHOD(0x02754380, Material *, get_material, (app::CameraFilterPack_Blend2Camera_LinearDodge * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02755550, void, __ctor, (app::CameraFilterPack_Blend2Camera_LinearDodge * this_ptr));
}
