...
IL2CPP_REGISTER_METHOD(0x0014BA90, Vector2, get_position, (app::Rect__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0011D290, void, set_position, (app::Rect__Boxed * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x00217C90, Vector2, get_center, (app::Rect__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0014C5B0, void, set_center, (app::Rect__Boxed * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x00217CC0, Vector2, get_min, (app::Rect__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00217CE0, void, set_min, (app::Rect__Boxed * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x00217D30, Vector2, get_max, (app::Rect__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0014BC10, Vector2, get_size, (app::Rect__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0296D5C0, Rect, OrderMinMax, (app::Rect rect));
...
IL2CPP_REGISTER_METHOD(0x0296D790, Vector2, PointToNormalized, (app::Rect rectangle, app::Vector2 point));
IL2CPP_REGISTER_METHOD(0x0296D880, bool, operator____1, (app::Rect lhs, app::Rect rhs));
IL2CPP_REGISTER_METHOD(0x0296D8E0, bool, operator____2, (app::Rect lhs, app::Rect rhs));
...
IL2CPP_REGISTER_METHOD(0x00217F00, String *, ToString, (app::Rect__Boxed * this_ptr));
