...
IL2CPP_REGISTER_METHOD(0x015C8CA0, ILever *, get_Lever, (app::LegacyActionLeverSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x015C9EC0, IDesiredUberState *, GetRequirementsForTimeline, (app::LegacyActionLeverSystem * this_ptr, app::MoonTimeline * timeline));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::LegacyActionLeverSystem * this_ptr));
}
