...
namespace app::methods::System_Net::TimerThread {
IL2CPP_REGISTER_METHOD(0x020A5FD0, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x020A6780, TimerThread_Queue *, CreateQueue, (int32_t duration_milliseconds));
IL2CPP_REGISTER_METHODINFO(0x04743780, TimerThread_CreateQueue__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020A6D40, TimerThread_Queue *, GetOrCreateQueue, (int32_t duration_milliseconds));
