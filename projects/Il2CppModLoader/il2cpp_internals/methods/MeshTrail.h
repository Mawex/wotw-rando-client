...
namespace app::methods::MeshTrail {
    IL2CPP_REGISTER_METHOD(0x011354B0, Mesh*, get_RenderMesh, (app::MeshTrail * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0310DB50, Single__Array*, GetTrianglesWeight, (app::MeshTrail * this_ptr, app::Int32__Array* indices, app::Vector3__Array* vertices, app::Vector2__Array* uvs));
    IL2CPP_REGISTER_METHOD(0x0310E9B0, Texture2D*, CreateAnimatedParametersTexture, (app::MeshTrail * this_ptr, app::HideFlags__Enum hide_flags));
    ...
    IL2CPP_REGISTER_METHOD(0x0310FEF0, void, __ctor, (app::MeshTrail * this_ptr));
