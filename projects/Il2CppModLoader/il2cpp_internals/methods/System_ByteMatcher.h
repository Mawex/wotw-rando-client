...
IL2CPP_REGISTER_METHOD(0x0229FB00, TermInfoStrings__Enum, Match, (app::ByteMatcher * this_ptr, app::Char__Array * buffer, int32_t offset, int32_t length, app::int32_t * used));
IL2CPP_REGISTER_METHOD(0x0229FE40, void, __ctor, (app::ByteMatcher * this_ptr));
}
