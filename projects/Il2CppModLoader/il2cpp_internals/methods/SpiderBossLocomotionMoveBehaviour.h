...
IL2CPP_REGISTER_METHOD(0x00A1FBC0, Vector3, get_TargetPosition, (app::SpiderBossLocomotionMoveBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011B6750, BehaviourStatus__Enum, OnExecuteTask, (app::SpiderBossLocomotionMoveBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x011B6AB0, void, __ctor, (app::SpiderBossLocomotionMoveBehaviour * this_ptr));
}
