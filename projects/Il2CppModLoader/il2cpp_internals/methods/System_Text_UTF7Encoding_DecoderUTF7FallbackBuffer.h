...
namespace app::methods::System_Text::UTF7Encoding_DecoderUTF7FallbackBuffer {
IL2CPP_REGISTER_METHOD(0x027CDE00, void, __ctor, (app::UTF7Encoding_DecoderUTF7FallbackBuffer * this_ptr, app::UTF7Encoding_DecoderUTF7Fallback * fallback));
...
IL2CPP_REGISTER_METHOD(0x027CDE80, int32_t, InternalFallback, (app::UTF7Encoding_DecoderUTF7FallbackBuffer * this_ptr, app::Byte__Array * bytes, app::uint8_t * p_bytes));
