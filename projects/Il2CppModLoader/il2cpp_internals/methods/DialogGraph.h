...
namespace app::methods::DialogGraph {
    IL2CPP_REGISTER_METHOD(0x00B8E940, IDialogNode*, get_ResolvedRootNode, (app::DialogGraph * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00B8EA00, IDialogNode*, get_CurrentActiveNode, (app::DialogGraph * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00653FB0, SuspendableMask__Enum, get_Mask, (app::DialogGraph * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00B8EA90, void, set_Mask, (app::DialogGraph * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x00B8EB50, IDialogNode__Array*, get_Nodes, (app::DialogGraph * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::DialogGraph * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00B8FE10, void, __ctor, (app::DialogGraph * this_ptr));
} // namespace app::methods::DialogGraph
