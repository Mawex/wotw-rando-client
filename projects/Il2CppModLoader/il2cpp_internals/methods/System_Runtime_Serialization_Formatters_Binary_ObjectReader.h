...
namespace app::methods::System_Runtime_Serialization_Formatters_Binary::ObjectReader {
IL2CPP_REGISTER_METHOD(0x01D94A90, SerStack *, get_ValueFixupStack, (app::ObjectReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB80, Object *, get_TopObject, (app::ObjectReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x01D94C00, void, set_TopObject, (app::ObjectReader * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x01D94C20, void, __ctor, (app::ObjectReader * this_ptr, app::Stream * stream, app::ISurrogateSelector * selector, app::StreamingContext context, app::InternalFE * formatter_enums, app::SerializationBinder * binder));
IL2CPP_REGISTER_METHODINFO(0x04731DE0, ObjectReader__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01D94DF0, Object *, Deserialize, (app::ObjectReader * this_ptr, app::HeaderHandler * handler, app::_BinaryParser * ser_parser, bool f_check));
...
IL2CPP_REGISTER_METHOD(0x01D959A0, Object *, CrossAppDomainArray, (app::ObjectReader * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x01D959E0, ReadObjectInfo *, CreateReadObjectInfo_1, (app::ObjectReader * this_ptr, app::Type * object_type));
IL2CPP_REGISTER_METHOD(0x01D95AA0, ReadObjectInfo *, CreateReadObjectInfo_2, (app::ObjectReader * this_ptr, app::Type * object_type, app::String__Array * member_names, app::Type__Array * member_types));
...
IL2CPP_REGISTER_METHOD(0x01D99510, Type *, Bind, (app::ObjectReader * this_ptr, app::String * assembly_string, app::String * type_string));
IL2CPP_REGISTER_METHOD(0x01D99570, Type *, FastBindToType, (app::ObjectReader * this_ptr, app::String * assembly_name, app::String * type_name));
IL2CPP_REGISTER_METHOD(0x01D99980, Assembly *, ResolveSimpleAssemblyName, (app::AssemblyName * assembly_name));
...
IL2CPP_REGISTER_METHOD(0x01D99DA0, Type *, GetType, (app::ObjectReader * this_ptr, app::BinaryAssemblyInfo * assembly_info, app::String * name));
