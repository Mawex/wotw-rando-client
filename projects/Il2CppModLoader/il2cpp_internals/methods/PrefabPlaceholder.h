...
IL2CPP_REGISTER_METHOD(0x002FBB60, GameObject *, get_CurrentInstance, (app::PrefabPlaceholder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C6E9E0, void, __ctor, (app::PrefabPlaceholder * this_ptr));
}
