...
namespace app::methods::System_Collections_Generic::List_1_Moon_AnimationPostprocess_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_Moon_AnimationPostprocess_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, AnimationPostprocess__Array *, ToArray, (app::List_1_Moon_AnimationPostprocess_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04727518, List_1_Moon_AnimationPostprocess__ToArray__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EFC50, AnimationPostprocess *, get_Item, (app::List_1_Moon_AnimationPostprocess_ * this_ptr, int32_t index));
