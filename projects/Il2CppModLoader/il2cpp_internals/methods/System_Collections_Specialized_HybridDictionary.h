...
IL2CPP_REGISTER_METHOD(0x02493270, Object *, get_Item, (app::HybridDictionary * this_ptr, app::Object * key));
...
IL2CPP_REGISTER_METHOD(0x02493590, ListDictionary *, get_List, (app::HybridDictionary * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02493B80, ICollection *, get_Keys, (app::HybridDictionary * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, Object *, get_SyncRoot, (app::HybridDictionary * this_ptr));
IL2CPP_REGISTER_METHOD(0x02493D20, ICollection *, get_Values, (app::HybridDictionary * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024943B0, IDictionaryEnumerator *, GetEnumerator, (app::HybridDictionary * this_ptr));
IL2CPP_REGISTER_METHOD(0x02494570, IEnumerator *, IEnumerable_GetEnumerator, (app::HybridDictionary * this_ptr));
