...
namespace app::methods::Moon_UberStateVisualization::UberStateGroupDataItemView {
    IL2CPP_REGISTER_METHOD(0x030C41D0, app::Texture2D *, get_Circle, ());
    IL2CPP_REGISTER_METHOD(0x030C4320, void, __ctor, (app::UberStateGroupDataItemView * this_ptr, int32_t control_id, app::UberStateGroupData group_data, app::ListView * parent_view));
