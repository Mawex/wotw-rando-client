...
namespace app::methods::System_Collections_Generic::List_1_Moon_Substr_ {
...
IL2CPP_REGISTER_METHOD(0x02DE9400, Object *, ICollection_get_SyncRoot, (app::List_1_Moon_Substr_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025EFC50, Substr, get_Item, (app::List_1_Moon_Substr_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025EFDB0, Object *, IList_get_Item, (app::List_1_Moon_Substr_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_Moon_Substr_ *, AsReadOnly, (app::List_1_Moon_Substr_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025F05A0, Substr, Find, (app::List_1_Moon_Substr_ * this_ptr, app::Predicate_1_Moon_Substr_ * match));
IL2CPP_REGISTER_METHOD(0x025F0680, List_1_Moon_Substr_ *, FindAll, (app::List_1_Moon_Substr_ * this_ptr, app::Predicate_1_Moon_Substr_ * match));
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_Moon_Substr_, GetEnumerator, (app::List_1_Moon_Substr_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025F0B50, IEnumerator_1_Moon_Substr_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_Moon_Substr_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025F0B50, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_Moon_Substr_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_Moon_Substr_ *, GetRange, (app::List_1_Moon_Substr_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, Substr__Array *, ToArray, (app::List_1_Moon_Substr_ * this_ptr));
