...
namespace app::methods::System_Collections_Generic::Dictionary_2_DeathInformation_DeathWisp_ {
IL2CPP_REGISTER_METHOD(0x0283B3E0, Dictionary_2_TKey_TValue_ValueCollection_DeathInformation_DeathWisp_ *, get_Values, (app::Dictionary_2_DeathInformation_DeathWisp_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BD24D0, DeathWisp *, get_Item, (app::Dictionary_2_DeathInformation_DeathWisp_ * this_ptr, app::DeathInformation * key));
...
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_DeathInformation_DeathWisp_ * this_ptr));
