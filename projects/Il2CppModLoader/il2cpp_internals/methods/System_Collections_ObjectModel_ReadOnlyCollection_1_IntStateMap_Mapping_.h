...
namespace app::methods::System_Collections_ObjectModel::ReadOnlyCollection_1_IntStateMap_Mapping_ {
IL2CPP_REGISTER_METHOD(0x02B7DCF0, void, __ctor, (app::ReadOnlyCollection_1_IntStateMap_Mapping_ * this_ptr, app::IList_1_IntStateMap_Mapping_ * list));
IL2CPP_REGISTER_METHOD(0x02B7DD20, int32_t, get_Count, (app::ReadOnlyCollection_1_IntStateMap_Mapping_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02E41B30, IntStateMap_Mapping, get_Item, (app::ReadOnlyCollection_1_IntStateMap_Mapping_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02B7DF30, IEnumerator_1_IntStateMap_Mapping_ *, GetEnumerator, (app::ReadOnlyCollection_1_IntStateMap_Mapping_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02E41B30, IntStateMap_Mapping, System_Collections_Generic_IList_T__get_Item, (app::ReadOnlyCollection_1_IntStateMap_Mapping_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02F14A30, IEnumerator *, IEnumerable_GetEnumerator, (app::ReadOnlyCollection_1_IntStateMap_Mapping_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F14AC0, Object *, ICollection_get_SyncRoot, (app::ReadOnlyCollection_1_IntStateMap_Mapping_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02E423A0, Object *, IList_get_Item, (app::ReadOnlyCollection_1_IntStateMap_Mapping_ * this_ptr, int32_t index));
