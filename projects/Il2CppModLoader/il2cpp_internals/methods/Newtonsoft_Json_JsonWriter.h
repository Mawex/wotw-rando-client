...
namespace app::methods::Newtonsoft_Json::JsonWriter {
...
IL2CPP_REGISTER_METHOD(0x01EFE4E0, WriteState__Enum_1, get_WriteState, (app::JsonWriter * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0478F198, JsonWriter_get_WriteState__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EFE630, String *, get_ContainerPath, (app::JsonWriter * this_ptr));
IL2CPP_REGISTER_METHOD(0x01EFE720, String *, get_Path, (app::JsonWriter * this_ptr));
IL2CPP_REGISTER_METHOD(0x00998570, Formatting__Enum_1, get_Formatting, (app::JsonWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003FC830, DateFormatHandling__Enum, get_DateFormatHandling, (app::JsonWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004E57A0, DateTimeZoneHandling__Enum, get_DateTimeZoneHandling, (app::JsonWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0057AAC0, StringEscapeHandling__Enum, get_StringEscapeHandling, (app::JsonWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006410F0, FloatFormatHandling__Enum, get_FloatFormatHandling, (app::JsonWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB40, String *, get_DateFormatString, (app::JsonWriter * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB50, void, set_DateFormatString, (app::JsonWriter * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x01EFEC50, CultureInfo *, get_Culture, (app::JsonWriter * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB70, void, set_Culture, (app::JsonWriter * this_ptr, app::CultureInfo * value));
IL2CPP_REGISTER_METHOD(0x01EFED00, void, __ctor, (app::JsonWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01EFEFB0, JsonContainerType__Enum, Pop, (app::JsonWriter * this_ptr));
IL2CPP_REGISTER_METHOD(0x00529FF0, JsonContainerType__Enum, Peek, (app::JsonWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F00400, JsonToken__Enum_1, GetCloseTokenForType, (app::JsonWriter * this_ptr, app::JsonContainerType__Enum type));
...
IL2CPP_REGISTER_METHOD(0x01F03200, JsonWriterException *, CreateUnsupportedTypeException, (app::JsonWriter * writer, app::Object * value));
