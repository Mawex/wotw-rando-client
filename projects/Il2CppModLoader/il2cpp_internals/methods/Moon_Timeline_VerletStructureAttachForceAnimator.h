...
namespace app::methods::Moon_Timeline::VerletStructureAttachForceAnimator {
    ...
    IL2CPP_REGISTER_METHOD(0x00D1D200, void, __ctor, (app::VerletStructureAttachForceAnimator * this_ptr));
}
