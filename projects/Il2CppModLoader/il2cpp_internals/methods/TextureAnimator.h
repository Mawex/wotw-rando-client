...
IL2CPP_REGISTER_METHOD(0x010EA2E0, void, __ctor, (app::TextureAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB00, TextureAnimation *, get_Animation, (app::TextureAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x010EA8B0, AtlasSpriteTexture *, get_Texture, (app::TextureAnimator * this_ptr));
