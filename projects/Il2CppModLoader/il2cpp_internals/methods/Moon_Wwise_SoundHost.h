...
namespace app::methods::Moon_Wwise::SoundHost {
...
IL2CPP_REGISTER_METHOD(0x0270B850, ISoundListener *, get_AsListener, (app::SoundHost * this_ptr));
IL2CPP_REGISTER_METHOD(0x0270B8D0, Vector3, get_Position, (app::SoundHost * this_ptr));
IL2CPP_REGISTER_METHOD(0x0270B960, Quaternion, get_Rotation, (app::SoundHost * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00597B10, UpdateType__Enum, get_UpdateType, (app::SoundHost * this_ptr));
IL2CPP_REGISTER_METHOD(0x00597BB0, void, __ctor, (app::SoundHost * this_ptr));
}
