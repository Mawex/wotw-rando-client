...
namespace app::methods::System_Collections_Generic::List_1_Moon_DamageReceiver_DamageEntry_ {
...
IL2CPP_REGISTER_METHOD(0x025EFC50, DamageReceiver_DamageEntry *, get_Item, (app::List_1_Moon_DamageReceiver_DamageEntry_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_Moon_DamageReceiver_DamageEntry_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04710D30, List_1_Moon_DamageReceiver_DamageEntry___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_Moon_DamageReceiver_DamageEntry_, GetEnumerator, (app::List_1_Moon_DamageReceiver_DamageEntry_ * this_ptr));
