...
IL2CPP_REGISTER_METHOD(0x014BE840, SeinGrabSurfacePuppet *, get_Puppet, (app::SeinGrabSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x014BE900, ActiveAnimationHandle, get_ActiveAnimation, (app::SeinGrabSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x014BE910, void, set_ActiveAnimation, (app::SeinGrabSurface * this_ptr, app::ActiveAnimationHandle value));
IL2CPP_REGISTER_METHOD(0x006C8770, GrabbableSurface *, get_TouchedGrabSurface, (app::SeinGrabSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x014BE960, void, set_TouchedGrabSurface, (app::SeinGrabSurface * this_ptr, app::GrabbableSurface * value));
IL2CPP_REGISTER_METHOD(0x01303770, GrabbableSurface *, get_GrabbedGrabSurface, (app::SeinGrabSurface * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014BED70, Vector3, get_GrabPosition, (app::SeinGrabSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, get_IsBlindForest, (app::SeinGrabSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x006E4240, CharacterGravity *, get_CharacterGravity, (app::SeinGrabSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D06F0, CharacterLeftRightMovement *, get_CharacterLeftRightMovement, (app::SeinGrabSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D06C0, CharacterPlatformMovement *, get_PlatformMovement, (app::SeinGrabSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x014BEF70, CapsuleCollider *, get_OriCollider, (app::SeinGrabSurface * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014BF1A0, Vector3, get_SurfaceNormal, (app::SeinGrabSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x014BF2B0, Vector3, get_SurfaceNormalSmooth, (app::SeinGrabSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x014BF3A0, Vector3, get_SurfaceDirection, (app::SeinGrabSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x014BF4B0, Vector3, get_SurfacePosition, (app::SeinGrabSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x014BF5C0, Vector3, get_SurfaceNormalFront, (app::SeinGrabSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x014BF6D0, Vector3, get_SurfaceDirectionFront, (app::SeinGrabSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x014BF7E0, Vector3, get_SurfacePositionFront, (app::SeinGrabSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x014BF8F0, Vector3, get_SurfaceNormalBack, (app::SeinGrabSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x014BFA00, Vector3, get_SurfaceDirectionBack, (app::SeinGrabSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x014BFB10, Vector3, get_SurfacePositionBack, (app::SeinGrabSurface * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014C70F0, ActiveAnimationHandle, PlayAnimation, (app::SeinGrabSurface * this_ptr, app::MoonAnimation * animation, int32_t layer, app::Action * on_stop_playing, app::Func_1_Boolean_ * condition, float speed));
IL2CPP_REGISTER_METHOD(0x014C7200, Vector2, get_m_currentClimbVelocity, (app::SeinGrabSurface * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014CC060, void, __ctor, (app::SeinGrabSurface * this_ptr));
