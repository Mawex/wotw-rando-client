...
namespace app::methods::System_Runtime_Serialization_Formatters_Binary::ObjectReader_TopLevelAssemblyTypeResolver {
    IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::ObjectReader_TopLevelAssemblyTypeResolver * this_ptr, app::Assembly * top_level_assembly));
