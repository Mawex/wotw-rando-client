...
IL2CPP_REGISTER_METHOD(0x02F965F0, CrossSceneReferenceId, get_CrossSceneReferenceId, (app::MoonMatrix4x4 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F967D0, void, __ctor, (app::MoonMatrix4x4 * this_ptr, app::Matrix4x4 static_value));
IL2CPP_REGISTER_METHOD(0x02F96810, Matrix4x4, Resolve, (app::MoonMatrix4x4 * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x0470CA50, MoonMatrix4x4_Resolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02F96A50, Matrix4x4, SafeResolve, (app::MoonMatrix4x4 * this_ptr, app::IMoonResolverContext * context));
...
IL2CPP_REGISTER_METHOD(0x01CB97B0, MoonTypeData, GetTypeData, (app::MoonMatrix4x4 * this_ptr));
}
