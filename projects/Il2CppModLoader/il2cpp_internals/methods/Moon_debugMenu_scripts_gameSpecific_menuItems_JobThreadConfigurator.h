...
namespace app::methods::Moon_debugMenu_scripts_gameSpecific_menuItems::JobThreadConfigurator {
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::JobThreadConfigurator * this_ptr));
