...
namespace app::methods::System_Collections_Generic::List_1_LeaderboardData_Entry_ {
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_LeaderboardData_Entry_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_LeaderboardData_Entry_, GetEnumerator, (app::List_1_LeaderboardData_Entry_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04705A08, List_1_LeaderboardData_Entry__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EFC50, LeaderboardData_Entry *, get_Item, (app::List_1_LeaderboardData_Entry_ * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x04797040, List_1_LeaderboardData_Entry__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F05A0, LeaderboardData_Entry *, Find, (app::List_1_LeaderboardData_Entry_ * this_ptr, app::Predicate_1_LeaderboardData_Entry_ * match));
