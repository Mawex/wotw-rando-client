...
IL2CPP_REGISTER_METHOD(0x020D3E80, DSA *, Create, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x020D5790, Exception *, DerivedClassMustOverride, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x020D58F0, Exception *, HashAlgorithmNameNullOrEmpty, (MethodInfo * method));
}
