...
IL2CPP_REGISTER_METHOD(0x02A4CF10, String *, DecodeString, (app::Type3Message * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t len));
IL2CPP_REGISTER_METHOD(0x02A4CF90, Byte__Array *, EncodeString, (app::Type3Message * this_ptr, app::String * text));
IL2CPP_REGISTER_METHOD(0x02A4D070, Byte__Array *, GetBytes, (app::Type3Message * this_ptr));
