...
IL2CPP_REGISTER_METHOD(0x0212E450, Vector3, DetectChainBoneDirectionAxis, (app::VerletPhysicsAnimationPostprocess * this_ptr, app::JointChains_Chain * chain));
IL2CPP_REGISTER_METHOD(0x0212E7F0, void, __ctor, (app::VerletPhysicsAnimationPostprocess * this_ptr));
