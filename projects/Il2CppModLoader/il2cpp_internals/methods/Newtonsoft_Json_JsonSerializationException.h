...
IL2CPP_REGISTER_METHOD(0x01A6C280, JsonSerializationException *, Create_1, (app::JsonReader * reader, app::String * message));
IL2CPP_REGISTER_METHOD(0x01A6C290, JsonSerializationException *, Create_2, (app::JsonReader * reader, app::String * message, app::Exception * ex));
IL2CPP_REGISTER_METHOD(0x01A6C380, JsonSerializationException *, Create_3, (app::IJsonLineInfo * line_info, app::String * path, app::String * message, app::Exception * ex));
}
