...
namespace app::methods::Moon_UberStateVisualization::UberStateVisualizationMenu {
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, List_1_List_1_IDebugMenuItem_ *, get_Items, (app::UberStateVisualizationMenu * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9D0, String *, get_Path, (app::UberStateVisualizationMenu * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9E0, void, set_Path, (app::UberStateVisualizationMenu * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB9F0, String *, get_Text, (app::UberStateVisualizationMenu * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBA00, void, set_Text, (app::UberStateVisualizationMenu * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBB40, String *, get_HelpText, (app::UberStateVisualizationMenu * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB50, void, set_HelpText, (app::UberStateVisualizationMenu * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBB60, Func_1_String_ *, get_DynamicText, (app::UberStateVisualizationMenu * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::UberStateVisualizationMenu * this_ptr));
}
