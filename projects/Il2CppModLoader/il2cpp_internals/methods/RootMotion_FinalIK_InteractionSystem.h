...
namespace app::methods::RootMotion_FinalIK::InteractionSystem {
...
IL2CPP_REGISTER_METHOD(0x02A0F180, InteractionObject *, GetInteractionObject, (app::InteractionSystem * this_ptr, app::FullBodyBipedEffector__Enum effector_type));
...
IL2CPP_REGISTER_METHOD(0x02A0FDB0, InteractionTrigger_Range *, GetClosestInteractionRange, (app::InteractionSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A0FEE0, InteractionObject *, GetClosestInteractionObjectInRange, (app::InteractionSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A0FF40, InteractionTarget *, GetClosestInteractionTargetInRange, (app::InteractionSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A10000, InteractionObject__Array *, GetClosestInteractionObjectsInRange, (app::InteractionSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A101A0, InteractionTarget__Array *, GetClosestInteractionTargetsInRange, (app::InteractionSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A10420, bool, TriggerEffectorsReady, (app::InteractionSystem * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x02A108B0, InteractionTrigger_Range *, GetTriggerRange, (app::InteractionSystem * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x02A10A20, int32_t, GetClosestTriggerIndex, (app::InteractionSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD60, FullBodyBipedIK *, get_ik, (app::InteractionSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB80, List_1_RootMotion_FinalIK_InteractionTrigger_ *, get_triggersInRange, (app::InteractionSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A11AF0, bool, ContactIsInRange, (app::InteractionSystem * this_ptr, int32_t index, app::int32_t * best_range_index));
...
IL2CPP_REGISTER_METHOD(0x02A137D0, void, __ctor, (app::InteractionSystem * this_ptr));
}
