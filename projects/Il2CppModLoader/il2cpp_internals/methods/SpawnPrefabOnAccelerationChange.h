...
IL2CPP_REGISTER_METHOD(0x00608710, SuspendableMask__Enum, get_Mask, (app::SpawnPrefabOnAccelerationChange * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00EF65A0, void, __ctor, (app::SpawnPrefabOnAccelerationChange * this_ptr));
}
