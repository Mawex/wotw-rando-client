...
namespace app::methods::UnityEngine_UI::LayoutGroup {
IL2CPP_REGISTER_METHOD(0x024CF7B0, void, __ctor, (app::LayoutGroup * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F22F90, RectOffset *, get_padding, (app::LayoutGroup * this_ptr));
IL2CPP_REGISTER_METHOD(0x024CFBD0, void, set_padding, (app::LayoutGroup * this_ptr, app::RectOffset * value));
IL2CPP_REGISTER_METHOD(0x01F22020, TextAnchor__Enum, get_childAlignment, (app::LayoutGroup * this_ptr));
IL2CPP_REGISTER_METHOD(0x024CFCA0, void, set_childAlignment, (app::LayoutGroup * this_ptr, app::TextAnchor__Enum value));
IL2CPP_REGISTER_METHOD(0x024CFD40, RectTransform *, get_rectTransform, (app::LayoutGroup * this_ptr));
IL2CPP_REGISTER_METHOD(0x024CFE10, List_1_UnityEngine_RectTransform_ *, get_rectChildren, (app::LayoutGroup * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024D0CD0, IEnumerator *, DelayedSetDirty, (app::LayoutGroup * this_ptr, app::RectTransform * rect_transform));
...
IL2CPP_REGISTER_METHOD(0x015E6890, void, SetProperty_6, (app::LayoutGroup * this_ptr, app::int32_t * current_value, int32_t new_value));
IL2CPP_REGISTER_METHODINFO(0x0477A1D0, LayoutGroup_SetProperty_5__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015E6A70, void, SetProperty_7, (app::LayoutGroup * this_ptr, app::float * current_value, float new_value));
IL2CPP_REGISTER_METHODINFO(0x0477CBE0, LayoutGroup_SetProperty_6__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015E6800, void, SetProperty_8, (app::LayoutGroup * this_ptr, app::bool * current_value, bool new_value));
