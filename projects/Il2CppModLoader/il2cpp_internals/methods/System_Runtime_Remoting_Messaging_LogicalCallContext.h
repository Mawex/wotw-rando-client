...
IL2CPP_REGISTER_METHOD(0x02311330, Object *, Clone, (app::LogicalCallContext * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02311F60, Hashtable *, get_Datastore, (app::LogicalCallContext * this_ptr));
