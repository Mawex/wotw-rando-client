...
namespace app::methods::System_Security_Util::TokenizerStream {
IL2CPP_REGISTER_METHOD(0x01E24D80, void, __ctor, (app::TokenizerStream * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E254B0, String *, GetNextString, (app::TokenizerStream * this_ptr));
