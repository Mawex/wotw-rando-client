...
namespace app::methods::UnityEngine_Experimental_Rendering::BlendState {
IL2CPP_REGISTER_METHOD(0x001EC6F0, void, __ctor, (app::BlendState__Boxed * this_ptr, bool separate_m_r_t_blend, bool alpha_to_mask));
