...
namespace app::methods::Moon_UberStateVisualization::SerializedByteUberStateWrapper {
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::SerializedByteUberStateWrapper * this_ptr, app::ISerializedUberState * state));
