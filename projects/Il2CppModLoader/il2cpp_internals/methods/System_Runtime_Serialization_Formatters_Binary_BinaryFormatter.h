...
namespace app::methods::System_Runtime_Serialization_Formatters_Binary::BinaryFormatter {
...
IL2CPP_REGISTER_METHOD(0x01D8D4A0, void, __ctor_1, (app::BinaryFormatter * this_ptr));
IL2CPP_REGISTER_METHOD(0x01D8D4E0, void, __ctor_2, (app::BinaryFormatter * this_ptr, app::ISurrogateSelector * selector, app::StreamingContext context));
IL2CPP_REGISTER_METHOD(0x01D8D500, Object *, Deserialize_1, (app::BinaryFormatter * this_ptr, app::Stream * serialization_stream));
IL2CPP_REGISTER_METHOD(0x01D8D520, Object *, Deserialize_2, (app::BinaryFormatter * this_ptr, app::Stream * serialization_stream, app::HeaderHandler * handler, bool f_check));
IL2CPP_REGISTER_METHODINFO(0x04748850, BinaryFormatter_Deserialize_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01D8D9A0, Object *, Deserialize_3, (app::BinaryFormatter * this_ptr, app::Stream * serialization_stream, app::HeaderHandler * handler));
...
IL2CPP_REGISTER_METHOD(0x01D8DF50, TypeInformation *, GetTypeInformation, (app::Type * type));
