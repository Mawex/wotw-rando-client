...
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_Message, (app::MessageAndStackTrace * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_Message, (app::MessageAndStackTrace * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_StackTrace, (app::MessageAndStackTrace * this_ptr));
