...
namespace app::methods::System_Runtime_Serialization_Formatters_Binary::__BinaryParser {
IL2CPP_REGISTER_METHOD(0x01DA46A0, void, __ctor, (app::_BinaryParser * this_ptr, app::Stream * stream, app::ObjectReader * object_reader));
IL2CPP_REGISTER_METHOD(0x01DA4920, BinaryAssemblyInfo *, get_SystemAssemblyInfo, (app::_BinaryParser * this_ptr));
IL2CPP_REGISTER_METHOD(0x01DA4AC0, SizedArray *, get_ObjectMapIdTable, (app::_BinaryParser * this_ptr));
IL2CPP_REGISTER_METHOD(0x01DA4C90, SizedArray *, get_AssemIdToAssemblyTable, (app::_BinaryParser * this_ptr));
IL2CPP_REGISTER_METHOD(0x01DA4E60, ParseRecord *, get_prs, (app::_BinaryParser * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BCD510, Byte__Array *, ReadBytes_1, (app::_BinaryParser * this_ptr, int32_t length));
...
IL2CPP_REGISTER_METHOD(0x01DA5580, Char__Array *, ReadChars, (app::_BinaryParser * this_ptr, int32_t length));
IL2CPP_REGISTER_METHOD(0x01DA55B0, Decimal, ReadDecimal, (app::_BinaryParser * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01DA5740, String *, ReadString, (app::_BinaryParser * this_ptr));
IL2CPP_REGISTER_METHOD(0x01DA5710, TimeSpan, ReadTimeSpan, (app::_BinaryParser * this_ptr));
IL2CPP_REGISTER_METHOD(0x01DA5770, DateTime, ReadDateTime, (app::_BinaryParser * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01DAA300, Object *, ReadValue, (app::_BinaryParser * this_ptr, app::InternalPrimitiveTypeE__Enum code));
IL2CPP_REGISTER_METHODINFO(0x04784DF0, _BinaryParser_ReadValue__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01DAA8F0, ObjectProgress *, GetOp, (app::_BinaryParser * this_ptr));
