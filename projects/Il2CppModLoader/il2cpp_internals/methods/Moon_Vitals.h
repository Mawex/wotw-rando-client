...
namespace app::methods::Moon::Vitals {
    ...
    IL2CPP_REGISTER_METHOD(0x003FC830, SuspendableMask__Enum, get_Mask, (app::Vitals * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x011970B0, String*, get_StressTestName, (app::Vitals * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x009C6AF0, StressTestStatus__Enum, get_StressTestStatus, (app::Vitals * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01197DA0, void, __ctor, (app::Vitals * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_1, (app::Vitals * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_2, (app::Vitals * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_3, (app::Vitals * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_4, (app::Vitals * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_5, (app::Vitals * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_6, (app::Vitals * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_7, (app::Vitals * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_8, (app::Vitals * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_9, (app::Vitals * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_10, (app::Vitals * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_11, (app::Vitals * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_12, (app::Vitals * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_13, (app::Vitals * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_14, (app::Vitals * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_15, (app::Vitals * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_16, (app::Vitals * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_17, (app::Vitals * this_ptr));
} // namespace app::methods::Moon::Vitals
