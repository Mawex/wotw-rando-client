...
namespace app::methods::Moon_BehaviourSystem::CooldownDecorator {
...
IL2CPP_REGISTER_METHOD(0x0300C6E0, BehaviourStatus__Enum, OnExecute, (app::CooldownDecorator * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0300C7E0, void, __ctor, (app::CooldownDecorator * this_ptr));
}
