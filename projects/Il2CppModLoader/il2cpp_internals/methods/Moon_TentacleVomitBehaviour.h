...
IL2CPP_REGISTER_METHOD(0x010BBF50, BehaviourStatus__Enum, OnExecute, (app::TentacleVomitBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x010BC9E0, void, __ctor, (app::TentacleVomitBehaviour * this_ptr));
}
