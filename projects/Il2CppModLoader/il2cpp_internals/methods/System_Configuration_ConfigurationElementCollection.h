...
namespace app::methods::System_Configuration::ConfigurationElementCollection {
IL2CPP_REGISTER_METHOD(0x031BBAB0, ConfigurationElementCollectionType__Enum, get_CollectionType, (app::ConfigurationElementCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031BBB10, String *, get_ElementName, (app::ConfigurationElementCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031BBB70, Object *, get_SyncRoot, (app::ConfigurationElementCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031BBBD0, IEnumerator *, GetEnumerator, (app::ConfigurationElementCollection * this_ptr));
