...
IL2CPP_REGISTER_METHOD(0x001FF7C0, void, __ctor, (app::RuntimeType_ListBuilder_1_Type___Boxed * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x001FF820, Type__Array *, ToArray, (app::RuntimeType_ListBuilder_1_Type___Boxed * this_ptr));
