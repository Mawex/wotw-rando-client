...
namespace app::methods::Mono_Security_X509::PKCS12 {
IL2CPP_REGISTER_METHOD(0x025DAA00, void, __ctor_1, (app::PKCS12 * this_ptr));
IL2CPP_REGISTER_METHOD(0x025DADB0, void, __ctor_2, (app::PKCS12 * this_ptr, app::Byte__Array * data));
IL2CPP_REGISTER_METHOD(0x025DAE70, void, __ctor_3, (app::PKCS12 * this_ptr, app::Byte__Array * data, app::String * password));
...
IL2CPP_REGISTER_METHOD(0x025DBE80, ArrayList *, get_Keys_1, (app::PKCS12 * this_ptr));
IL2CPP_REGISTER_METHOD(0x025DC770, X509CertificateCollection *, get_Certificates_1, (app::PKCS12 * this_ptr));
IL2CPP_REGISTER_METHOD(0x025DCCB0, RandomNumberGenerator *, get_RNG_1, (app::PKCS12 * this_ptr));
IL2CPP_REGISTER_METHOD(0x025DCCE0, bool, Compare_1, (app::PKCS12 * this_ptr, app::Byte__Array * expected, app::Byte__Array * actual));
IL2CPP_REGISTER_METHOD(0x025DCD70, SymmetricAlgorithm *, GetSymmetricAlgorithm_1, (app::PKCS12 * this_ptr, app::String * algorithm_oid, app::Byte__Array * salt, int32_t iteration_count));
IL2CPP_REGISTER_METHODINFO(0x04741AC0, PKCS12_GetSymmetricAlgorithm__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025DD700, Byte__Array *, Decrypt_1, (app::PKCS12 * this_ptr, app::String * algorithm_oid, app::Byte__Array * salt, int32_t iteration_count, app::Byte__Array * encrypted_data));
IL2CPP_REGISTER_METHOD(0x025DD8A0, Byte__Array *, Decrypt_2, (app::PKCS12 * this_ptr, app::PKCS7_EncryptedData * ed));
IL2CPP_REGISTER_METHOD(0x025DDAC0, Byte__Array *, Encrypt_1, (app::PKCS12 * this_ptr, app::String * algorithm_oid, app::Byte__Array * salt, int32_t iteration_count, app::Byte__Array * data));
IL2CPP_REGISTER_METHOD(0x025DDC60, DSAParameters, GetExistingParameters_1, (app::PKCS12 * this_ptr, app::bool * found));
...
IL2CPP_REGISTER_METHOD(0x025DED50, ASN1 *, CertificateSafeBag_1, (app::PKCS12 * this_ptr, app::X509Certificate * x509, app::IDictionary * attributes));
IL2CPP_REGISTER_METHOD(0x025DFC80, Byte__Array *, MAC_1, (app::PKCS12 * this_ptr, app::Byte__Array * password, app::Byte__Array * salt, int32_t iterations, app::Byte__Array * data));
IL2CPP_REGISTER_METHOD(0x025DFF50, Byte__Array *, GetBytes_1, (app::PKCS12 * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E2A30, PKCS7_ContentInfo *, EncryptedContentInfo_1, (app::PKCS12 * this_ptr, app::ASN1 * safe_bags, app::String * algorithm_oid));
...
IL2CPP_REGISTER_METHOD(0x025E3F40, Object *, Clone_1, (app::PKCS12 * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E41E0, int32_t, get_MaximumPasswordLength_1, ());
IL2CPP_REGISTER_METHOD(0x025E4280, void, __cctor_1, ());
IL2CPP_REGISTER_METHOD(0x02923130, void, __ctor_4, (app::PKCS12_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x029234E0, void, __ctor_5, (app::PKCS12_1 * this_ptr, app::Byte__Array * data));
IL2CPP_REGISTER_METHOD(0x029235A0, void, __ctor_6, (app::PKCS12_1 * this_ptr, app::Byte__Array * data, app::String * password));
IL2CPP_REGISTER_METHOD(0x029235F0, void, __ctor_7, (app::PKCS12_1 * this_ptr, app::Byte__Array * data, app::Byte__Array * password));
...
IL2CPP_REGISTER_METHOD(0x029245F0, ArrayList *, get_Keys_2, (app::PKCS12_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x02924EF0, ArrayList *, get_Secrets, (app::PKCS12_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x02925220, X509CertificateCollection_2 *, get_Certificates_2, (app::PKCS12_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x025DCCB0, RandomNumberGenerator *, get_RNG_2, (app::PKCS12_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x025DCCE0, bool, Compare_2, (app::PKCS12_1 * this_ptr, app::Byte__Array * expected, app::Byte__Array * actual));
IL2CPP_REGISTER_METHOD(0x02925760, SymmetricAlgorithm *, GetSymmetricAlgorithm_2, (app::PKCS12_1 * this_ptr, app::String * algorithm_oid, app::Byte__Array * salt, int32_t iteration_count));
IL2CPP_REGISTER_METHODINFO(0x0472AFF8, PKCS12_1_GetSymmetricAlgorithm__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02926020, Byte__Array *, Decrypt_3, (app::PKCS12_1 * this_ptr, app::String * algorithm_oid, app::Byte__Array * salt, int32_t iteration_count, app::Byte__Array * encrypted_data));
IL2CPP_REGISTER_METHOD(0x029261C0, Byte__Array *, Decrypt_4, (app::PKCS12_1 * this_ptr, app::PKCS7_EncryptedData_1 * ed));
IL2CPP_REGISTER_METHOD(0x029263E0, Byte__Array *, Encrypt_2, (app::PKCS12_1 * this_ptr, app::String * algorithm_oid, app::Byte__Array * salt, int32_t iteration_count, app::Byte__Array * data));
IL2CPP_REGISTER_METHOD(0x02926580, DSAParameters, GetExistingParameters_2, (app::PKCS12_1 * this_ptr, app::bool * found));
...
IL2CPP_REGISTER_METHOD(0x02927680, ASN1_1 *, Pkcs8ShroudedKeyBagSafeBag, (app::PKCS12_1 * this_ptr, app::AsymmetricAlgorithm * aa, app::IDictionary * attributes));
IL2CPP_REGISTER_METHODINFO(0x047601C0, PKCS12_1_Pkcs8ShroudedKeyBagSafeBag__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02928990, ASN1_1 *, KeyBagSafeBag, (app::PKCS12_1 * this_ptr, app::AsymmetricAlgorithm * aa, app::IDictionary * attributes));
IL2CPP_REGISTER_METHODINFO(0x0478FF20, PKCS12_1_KeyBagSafeBag__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02929A00, ASN1_1 *, SecretBagSafeBag, (app::PKCS12_1 * this_ptr, app::Byte__Array * secret, app::IDictionary * attributes));
IL2CPP_REGISTER_METHOD(0x0292A720, ASN1_1 *, CertificateSafeBag_2, (app::PKCS12_1 * this_ptr, app::X509Certificate_2 * x509, app::IDictionary * attributes));
IL2CPP_REGISTER_METHOD(0x0292B650, Byte__Array *, MAC_2, (app::PKCS12_1 * this_ptr, app::Byte__Array * password, app::Byte__Array * salt, int32_t iterations, app::Byte__Array * data));
IL2CPP_REGISTER_METHOD(0x0292B920, Byte__Array *, GetBytes_2, (app::PKCS12_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x0292E400, PKCS7_ContentInfo_1 *, EncryptedContentInfo_2, (app::PKCS12_1 * this_ptr, app::ASN1_1 * safe_bags, app::String * algorithm_oid));
...
IL2CPP_REGISTER_METHOD(0x02931360, AsymmetricAlgorithm *, GetAsymmetricAlgorithm, (app::PKCS12_1 * this_ptr, app::IDictionary * attrs));
IL2CPP_REGISTER_METHOD(0x02931DF0, Byte__Array *, GetSecret, (app::PKCS12_1 * this_ptr, app::IDictionary * attrs));
IL2CPP_REGISTER_METHOD(0x02932320, X509Certificate_2 *, GetCertificate, (app::PKCS12_1 * this_ptr, app::IDictionary * attrs));
IL2CPP_REGISTER_METHOD(0x02932A30, IDictionary *, GetAttributes_1, (app::PKCS12_1 * this_ptr, app::AsymmetricAlgorithm * aa));
IL2CPP_REGISTER_METHOD(0x029335B0, IDictionary *, GetAttributes_2, (app::PKCS12_1 * this_ptr, app::X509Certificate_2 * cert));
...
IL2CPP_REGISTER_METHOD(0x02933F20, Object *, Clone_2, (app::PKCS12_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x029343B0, Byte__Array *, LoadFile, (app::String * filename));
IL2CPP_REGISTER_METHODINFO(0x04742AF0, PKCS12_1_LoadFile__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02934550, PKCS12_1 *, LoadFromFile_1, (app::String * filename));
IL2CPP_REGISTER_METHODINFO(0x0478D068, PKCS12_1_LoadFromFile__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02934700, PKCS12_1 *, LoadFromFile_2, (app::String * filename, app::String * password));
IL2CPP_REGISTER_METHODINFO(0x0476CD70, PKCS12_1_LoadFromFile_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x029348D0, void, __cctor_2, ());
}
