...
IL2CPP_REGISTER_METHOD(0x02540E10, Array *, ExtractArrayFromList, (app::Object * list));
...
IL2CPP_REGISTER_METHOD(0x02FF64F0, Object__Array *, ExtractArrayFromListT_1, (app::List_1_System_Object_ * list));
IL2CPP_REGISTER_METHOD(0x02FF64F0, Vector4__Array *, ExtractArrayFromListT_2, (app::List_1_UnityEngine_Vector4_ * list));
...
IL2CPP_REGISTER_METHOD(0x02FF64F0, Rect__Array *, ExtractArrayFromListT_3, (app::List_1_UnityEngine_Rect_ * list));
