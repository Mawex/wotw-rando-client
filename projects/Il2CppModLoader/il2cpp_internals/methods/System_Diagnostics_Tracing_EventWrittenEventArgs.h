...
namespace app::methods::System_Diagnostics_Tracing::EventWrittenEventArgs {
...
IL2CPP_REGISTER_METHOD(0x019FD850, void, __ctor, (app::EventWrittenEventArgs * this_ptr, app::EventSource * event_source));
}
