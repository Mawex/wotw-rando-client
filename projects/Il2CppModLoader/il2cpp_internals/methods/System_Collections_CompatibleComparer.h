...
namespace app::methods::System_Collections::CompatibleComparer {
IL2CPP_REGISTER_METHOD(0x0058DA40, void, __ctor, (app::CompatibleComparer * this_ptr, app::IComparer * comparer, app::IHashCodeProvider * hash_code_provider));
...
IL2CPP_REGISTER_METHOD(0x002FA280, IComparer *, get_Comparer, (app::CompatibleComparer * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, IHashCodeProvider *, get_HashCodeProvider, (app::CompatibleComparer * this_ptr));
}
