...
IL2CPP_REGISTER_METHOD(0x00DF7B50, void, __ctor, (app::DebugMenuTogglerItem * this_ptr, app::String * path, app::IDebugMenuToggleable * toggleable));
IL2CPP_REGISTER_METHOD(0x00DF7B60, bool, Draw, (app::DebugMenuTogglerItem * this_ptr, app::Rect rect, bool selected));
IL2CPP_REGISTER_METHOD(0x00DF7E50, String *, get_Text, (app::DebugMenuTogglerItem * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, set_Text, (app::DebugMenuTogglerItem * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x00DF7EE0, String *, get_HelpText, (app::DebugMenuTogglerItem * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, set_HelpText, (app::DebugMenuTogglerItem * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Path, (app::DebugMenuTogglerItem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB950, Func_1_String_ *, get_DynamicText, (app::DebugMenuTogglerItem * this_ptr));
