...
IL2CPP_REGISTER_METHOD(0x002FA280, Object *, get_Item1, (app::Tuple_2_Object_UnityEngine_Vector3_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0064EB90, Vector3, get_Item2, (app::Tuple_2_Object_UnityEngine_Vector3_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A68AC0, void, __ctor, (app::Tuple_2_Object_UnityEngine_Vector3_ * this_ptr, app::Object * item1, app::Vector3 item2));
...
IL2CPP_REGISTER_METHOD(0x02A69280, String *, ToString, (app::Tuple_2_Object_UnityEngine_Vector3_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A69400, String *, ITupleInternal_ToString, (app::Tuple_2_Object_UnityEngine_Vector3_ * this_ptr, app::StringBuilder * sb));
}
