...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::IVRSettings_RemoveSection * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02CE82B0, IAsyncResult *, BeginInvoke, (app::IVRSettings_RemoveSection * this_ptr, app::String * pch_section, app::EVRSettingsError__Enum * pe_error, app::AsyncCallback * callback, app::Object * object));
