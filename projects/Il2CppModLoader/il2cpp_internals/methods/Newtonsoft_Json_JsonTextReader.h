...
namespace app::methods::Newtonsoft_Json::JsonTextReader {
IL2CPP_REGISTER_METHOD(0x002FBD20, JsonNameTable *, get_PropertyNameTable, (app::JsonTextReader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01EF24F0, Nullable_1_Int32_, ReadAsInt32, (app::JsonTextReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x01EF25A0, Nullable_1_DateTime_, ReadAsDateTime, (app::JsonTextReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x01EF2660, String *, ReadAsString, (app::JsonTextReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x01EF2710, Byte__Array *, ReadAsBytes, (app::JsonTextReader * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047904A0, JsonTextReader_ReadAsBytes__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EF2D80, Object *, ReadStringValue, (app::JsonTextReader * this_ptr, app::ReadType__Enum read_type));
IL2CPP_REGISTER_METHODINFO(0x0477ECC0, JsonTextReader_ReadStringValue__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EF3490, Object *, FinishReadQuotedStringValue, (app::JsonTextReader * this_ptr, app::ReadType__Enum read_type));
IL2CPP_REGISTER_METHODINFO(0x04778098, JsonTextReader_FinishReadQuotedStringValue__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EF3760, JsonReaderException *, CreateUnexpectedCharacterException, (app::JsonTextReader * this_ptr, uint16_t c));
IL2CPP_REGISTER_METHOD(0x01EF3850, Nullable_1_Boolean_, ReadAsBoolean, (app::JsonTextReader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01EF4100, Object *, ReadNumberValue, (app::JsonTextReader * this_ptr, app::ReadType__Enum read_type));
IL2CPP_REGISTER_METHODINFO(0x0474CB28, JsonTextReader_ReadNumberValue__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EF4680, Object *, FinishReadQuotedNumber, (app::JsonTextReader * this_ptr, app::ReadType__Enum read_type));
IL2CPP_REGISTER_METHODINFO(0x0477ED00, JsonTextReader_FinishReadQuotedNumber__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EF4830, Nullable_1_DateTimeOffset_, ReadAsDateTimeOffset, (app::JsonTextReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x01EF4900, Nullable_1_Decimal_, ReadAsDecimal, (app::JsonTextReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x01EF49D0, Nullable_1_Double_, ReadAsDouble, (app::JsonTextReader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01EF8DB0, JsonReaderException *, ThrowReaderError, (app::JsonTextReader * this_ptr, app::String * message, app::Exception * ex));
IL2CPP_REGISTER_METHOD(0x01EF8E80, Object *, BigIntegerParse, (app::String * number, app::CultureInfo * culture));
...
IL2CPP_REGISTER_METHOD(0x01EF9E00, Object *, ParseNumberNegativeInfinity_1, (app::JsonTextReader * this_ptr, app::ReadType__Enum read_type));
IL2CPP_REGISTER_METHOD(0x01EFA050, Object *, ParseNumberNegativeInfinity_2, (app::JsonTextReader * this_ptr, app::ReadType__Enum read_type, bool matched));
IL2CPP_REGISTER_METHODINFO(0x0477A538, JsonTextReader_ParseNumberNegativeInfinity_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EFA200, Object *, ParseNumberPositiveInfinity_1, (app::JsonTextReader * this_ptr, app::ReadType__Enum read_type));
IL2CPP_REGISTER_METHOD(0x01EFA450, Object *, ParseNumberPositiveInfinity_2, (app::JsonTextReader * this_ptr, app::ReadType__Enum read_type, bool matched));
IL2CPP_REGISTER_METHODINFO(0x04798248, JsonTextReader_ParseNumberPositiveInfinity_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EFA600, Object *, ParseNumberNaN_1, (app::JsonTextReader * this_ptr, app::ReadType__Enum read_type));
IL2CPP_REGISTER_METHOD(0x01EFA850, Object *, ParseNumberNaN_2, (app::JsonTextReader * this_ptr, app::ReadType__Enum read_type, bool matched));
