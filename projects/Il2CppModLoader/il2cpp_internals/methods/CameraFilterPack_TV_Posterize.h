...
IL2CPP_REGISTER_METHOD(0x020ECC00, Material *, get_material, (app::CameraFilterPack_TV_Posterize * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020ED390, void, __ctor, (app::CameraFilterPack_TV_Posterize * this_ptr));
}
