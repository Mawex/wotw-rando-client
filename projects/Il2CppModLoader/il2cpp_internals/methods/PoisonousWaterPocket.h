...
IL2CPP_REGISTER_METHOD(0x00420EE0, UpdateType__Enum, get_UpdateType, (app::PoisonousWaterPocket * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01433D40, void, __ctor, (app::PoisonousWaterPocket * this_ptr));
}
