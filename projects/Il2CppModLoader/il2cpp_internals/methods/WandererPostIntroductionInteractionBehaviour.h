...
IL2CPP_REGISTER_METHOD(0x008D2050, BehaviourStatus__Enum, OnExecute, (app::WandererPostIntroductionInteractionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0060C1C0, void, __ctor, (app::WandererPostIntroductionInteractionBehaviour * this_ptr));
}
