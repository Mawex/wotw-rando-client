...
IL2CPP_REGISTER_METHOD(0x005B3DD0, BehaviourStatus__Enum, OnExecuteTask, (app::ShellSlugKickupAndStunReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x005B3EC0, void, __ctor, (app::ShellSlugKickupAndStunReactionBehaviour * this_ptr));
}
