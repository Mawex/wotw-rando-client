...
IL2CPP_REGISTER_METHOD(0x00B26760, Vector3, get_Position, (app::CarryableRigidBody * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B26760, Vector3, get_CarryablePosition, (app::CarryableRigidBody * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B295C0, void, __ctor, (app::CarryableRigidBody * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B297B0, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::CarryableRigidBody * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::CarryableRigidBody * this_ptr));
}
