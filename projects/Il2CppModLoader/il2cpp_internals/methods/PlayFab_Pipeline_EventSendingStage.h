...
namespace app::methods::PlayFab_Pipeline::EventSendingStage {
IL2CPP_REGISTER_METHOD(0x017AFCF0, void, __ctor, (app::EventSendingStage * this_ptr, app::ILogger_1 * logger));
