...
namespace app::methods::System_Collections_Specialized::NotifyCollectionChangedEventArgs {
    IL2CPP_REGISTER_METHOD(0x0249AF80, void, __ctor_1, (app::NotifyCollectionChangedEventArgs * this_ptr, app::NotifyCollectionChangedAction__Enum action));
    IL2CPP_REGISTER_METHODINFO(0x04736580, NotifyCollectionChangedEventArgs__ctor__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x0249B130, void, __ctor_2, (app::NotifyCollectionChangedEventArgs * this_ptr, app::NotifyCollectionChangedAction__Enum action, app::Object * changed_item, int32_t index));
    IL2CPP_REGISTER_METHODINFO(0x04755BA8, NotifyCollectionChangedEventArgs__ctor_1__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x0249B3A0, void, __ctor_3, (app::NotifyCollectionChangedEventArgs * this_ptr, app::NotifyCollectionChangedAction__Enum action, app::Object * new_item, app::Object * old_item, int32_t index));
    IL2CPP_REGISTER_METHODINFO(0x04790910, NotifyCollectionChangedEventArgs__ctor_2__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x0249B620, void, __ctor_4, (app::NotifyCollectionChangedEventArgs * this_ptr, app::NotifyCollectionChangedAction__Enum action, app::IList * new_items, app::IList * old_items, int32_t starting_index));
