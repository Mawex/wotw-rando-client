...
IL2CPP_REGISTER_METHOD(0x00ED5340, BehaviourStatus__Enum, OnExecute, (app::SneezeSlugBurrowBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00ED7CA0, void, __ctor, (app::SneezeSlugBurrowBehaviour * this_ptr));
