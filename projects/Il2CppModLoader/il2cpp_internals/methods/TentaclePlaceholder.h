...
IL2CPP_REGISTER_METHOD(0x010D6940, GameObject *, get_Prefab, (app::TentaclePlaceholder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010D7050, void, __ctor, (app::TentaclePlaceholder * this_ptr));
}
