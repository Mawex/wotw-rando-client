...
namespace app::methods::System_Collections_Generic::List_1_ReplayModel_ {
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_ReplayModel_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04799148, List_1_ReplayModel___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_ReplayModel_, GetEnumerator, (app::List_1_ReplayModel_ * this_ptr));
