...
namespace app::methods::Moon_UI::ItemSelectionManager {
...
IL2CPP_REGISTER_METHOD(0x00D258C0, UIComponent *, CheckNeighbour, (app::ItemSelectionManager * this_ptr, app::UIComponent * current, app::Vector2 direction));
...
IL2CPP_REGISTER_METHOD(0x00D266F0, UIInteractable *, get_MenuItemUnderCursor, (app::ItemSelectionManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D26E30, void, __ctor, (app::ItemSelectionManager * this_ptr));
}
