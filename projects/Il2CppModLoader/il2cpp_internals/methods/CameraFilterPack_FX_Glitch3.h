...
IL2CPP_REGISTER_METHOD(0x0246EDA0, Material *, get_material, (app::CameraFilterPack_FX_Glitch3 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0246C2D0, void, __ctor, (app::CameraFilterPack_FX_Glitch3 * this_ptr));
}
