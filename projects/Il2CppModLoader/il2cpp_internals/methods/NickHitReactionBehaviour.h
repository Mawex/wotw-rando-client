...
IL2CPP_REGISTER_METHOD(0x005FDE00, EntityDamageEvent *, get_DamageEvent, (app::NickHitReactionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420230, BehaviourStatus__Enum, OnExecuteTask, (app::NickHitReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x005FEF90, void, __ctor, (app::NickHitReactionBehaviour * this_ptr));
}
