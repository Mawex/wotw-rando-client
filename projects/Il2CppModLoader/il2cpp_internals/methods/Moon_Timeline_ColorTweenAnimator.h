...
namespace app::methods::Moon_Timeline::ColorTweenAnimator {
IL2CPP_REGISTER_METHOD(0x007620B0, GameObject *, get_ExternalTarget, (app::ColorTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, OnEntityCreated, (app::ColorTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x003FF8B0, UberShaderProperty_Color__Enum, get_ColorUberShaderProperty, (app::ColorTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, CanUpdate, (app::ColorTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00762140, Color, get_CurrentColor, (app::ColorTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00762210, Renderer *, get_EffectiveRenderer, (app::ColorTweenAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBC0, MoonReference_1_UnityEngine_GameObject_ *, GetGameObjectTarget, (app::ColorTweenAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00762D10, void, __ctor, (app::ColorTweenAnimator * this_ptr));
}
