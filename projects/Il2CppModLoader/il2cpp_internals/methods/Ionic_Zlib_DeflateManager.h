...
namespace app::methods::Ionic_Zlib::DeflateManager {
IL2CPP_REGISTER_METHOD(0x03065460, void, __ctor, (app::DeflateManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030681F0, BlockState__Enum, DeflateNone, (app::DeflateManager * this_ptr, app::FlushType__Enum flush));
...
IL2CPP_REGISTER_METHOD(0x03068D20, BlockState__Enum, DeflateFast, (app::DeflateManager * this_ptr, app::FlushType__Enum flush));
IL2CPP_REGISTER_METHODINFO(0x0474A650, DeflateManager_DeflateFast__MethodInfo);
IL2CPP_REGISTER_METHOD(0x03069460, BlockState__Enum, DeflateSlow, (app::DeflateManager * this_ptr, app::FlushType__Enum flush));
