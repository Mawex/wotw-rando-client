...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::PlayFabEvents_PlayFabErrorEvent * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x01435260, IAsyncResult *, BeginInvoke, (app::PlayFabEvents_PlayFabErrorEvent * this_ptr, app::PlayFabRequestCommon * request, app::PlayFabError * error, app::AsyncCallback * callback, app::Object * object));
