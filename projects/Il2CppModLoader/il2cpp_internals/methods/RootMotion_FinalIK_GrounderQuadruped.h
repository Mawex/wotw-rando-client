...
namespace app::methods::RootMotion_FinalIK::GrounderQuadruped {
...
IL2CPP_REGISTER_METHOD(0x0206CA60, Transform__Array *, InitiateFeet, (app::GrounderQuadruped * this_ptr, app::IK__Array * ik_components, app::GrounderQuadruped_Foot__Array * * f, int32_t index_offset));
...
IL2CPP_REGISTER_METHOD(0x0206FEB0, void, __ctor, (app::GrounderQuadruped * this_ptr));
}
