...
namespace app::methods::Microsoft_Applications_Events_DataModels::Value {
IL2CPP_REGISTER_METHOD(0x002FC6D0, ValueKind__Enum, get_type, (app::Value * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FC6E0, void, set_type, (app::Value * this_ptr, app::ValueKind__Enum value));
IL2CPP_REGISTER_METHOD(0x002FB930, List_1_Microsoft_Applications_Events_DataModels_Attributes_ *, get_attributes, (app::Value * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_stringValue, (app::Value * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, List_1_List_1_System_Byte_ *, get_guidValue, (app::Value * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9C0, void, set_guidValue, (app::Value * this_ptr, app::List_1_List_1_System_Byte_ * value));
IL2CPP_REGISTER_METHOD(0x002FB9D0, List_1_List_1_System_String_ *, get_stringArray, (app::Value * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9E0, void, set_stringArray, (app::Value * this_ptr, app::List_1_List_1_System_String_ * value));
IL2CPP_REGISTER_METHOD(0x002FB9F0, List_1_List_1_System_Int64_ *, get_longArray, (app::Value * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBA00, void, set_longArray, (app::Value * this_ptr, app::List_1_List_1_System_Int64_ * value));
IL2CPP_REGISTER_METHOD(0x002FBB40, List_1_List_1_System_Double_ *, get_doubleArray, (app::Value * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB50, void, set_doubleArray, (app::Value * this_ptr, app::List_1_List_1_System_Double_ * value));
IL2CPP_REGISTER_METHOD(0x002FBB60, List_1_List_1_List_1_System_Int64_ *, get_guidArray, (app::Value * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB70, void, set_guidArray, (app::Value * this_ptr, app::List_1_List_1_List_1_System_Int64_ * value));
IL2CPP_REGISTER_METHOD(0x002FD540, void, __ctor_1, (app::Value * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FD5D0, void, __ctor_2, (app::Value * this_ptr, app::String * full_name, app::String * name));
