...
namespace app::methods::Microsoft_Applications_Events_DataModels::App {
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_expId, (app::App * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_expId, (app::App * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_userId, (app::App * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_userId, (app::App * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_env, (app::App * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_id, (app::App * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9A0, void, set_id, (app::App * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB9B0, String *, get_ver, (app::App * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9C0, void, set_ver, (app::App * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB9D0, String *, get_locale, (app::App * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9E0, void, set_locale, (app::App * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB9F0, String *, get_name, (app::App * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBA00, void, set_name, (app::App * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBA10, void, __ctor_1, (app::App * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_2, (app::App * this_ptr, app::String * full_name, app::String * name));
}
