...
namespace app::methods::Moon_Rendering::RenderTargetDescriptor {
IL2CPP_REGISTER_METHOD(0x001200A0, void, __ctor, (app::RenderTargetDescriptor__Boxed * this_ptr, app::RenderTargetType__Enum _type, app::String * _name, app::RenderTextureDescriptor _desc, app::FilterMode__Enum _filter_mode, app::RenderTexture * _external, bool drs));
...
IL2CPP_REGISTER_METHOD(0x00120180, Int2, get_size, (app::RenderTargetDescriptor__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00EB2EF0, bool, operator____1, (app::RenderTargetDescriptor left, app::RenderTargetDescriptor right));
IL2CPP_REGISTER_METHOD(0x00EB2F30, bool, operator____2, (app::RenderTargetDescriptor left, app::RenderTargetDescriptor right));
