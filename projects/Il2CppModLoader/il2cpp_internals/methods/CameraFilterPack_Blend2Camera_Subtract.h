...
IL2CPP_REGISTER_METHOD(0x02760F60, Material *, get_material, (app::CameraFilterPack_Blend2Camera_Subtract * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02762130, void, __ctor, (app::CameraFilterPack_Blend2Camera_Subtract * this_ptr));
}
