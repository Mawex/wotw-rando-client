...
namespace app::methods::System_Xml_Schema::Compiler {
IL2CPP_REGISTER_METHOD(0x019AA4E0, void, __ctor, (app::Compiler * this_ptr, app::XmlNameTable * name_table, app::ValidationEventHandler * event_handler, app::XmlSchema * schema_for_schema, app::XmlSchemaCompilationSettings * compilation_settings));
...
IL2CPP_REGISTER_METHOD(0x019B1470, XmlSchemaSimpleType__Array *, CompileBaseMemberTypes, (app::Compiler * this_ptr, app::XmlSchemaSimpleType * simple_type));
...
IL2CPP_REGISTER_METHOD(0x019B3530, XmlSchemaParticle *, CompileContentTypeParticle, (app::Compiler * this_ptr, app::XmlSchemaParticle * particle));
IL2CPP_REGISTER_METHOD(0x019B3720, XmlSchemaParticle *, CannonicalizeParticle, (app::Compiler * this_ptr, app::XmlSchemaParticle * particle, bool root));
IL2CPP_REGISTER_METHOD(0x019B3AA0, XmlSchemaParticle *, CannonicalizeElement, (app::Compiler * this_ptr, app::XmlSchemaElement * element));
IL2CPP_REGISTER_METHOD(0x019B3E40, XmlSchemaParticle *, CannonicalizeGroupRef, (app::Compiler * this_ptr, app::XmlSchemaGroupRef * group_ref, bool root));
IL2CPP_REGISTER_METHOD(0x019B4670, XmlSchemaParticle *, CannonicalizeAll, (app::Compiler * this_ptr, app::XmlSchemaAll * all, bool root));
IL2CPP_REGISTER_METHOD(0x019B4A60, XmlSchemaParticle *, CannonicalizeChoice, (app::Compiler * this_ptr, app::XmlSchemaChoice * choice, bool root));
IL2CPP_REGISTER_METHOD(0x019B51E0, XmlSchemaParticle *, CannonicalizeSequence, (app::Compiler * this_ptr, app::XmlSchemaSequence * sequence, bool root));
IL2CPP_REGISTER_METHOD(0x019B58C0, XmlSchemaParticle *, CannonicalizePointlessRoot, (app::Compiler * this_ptr, app::XmlSchemaParticle * particle));
...
IL2CPP_REGISTER_METHOD(0x016F5F70, XmlSchemaContentType__Enum, GetSchemaContentType, (app::Compiler * this_ptr, app::XmlSchemaComplexType * complex_type, app::XmlSchemaComplexContent * complex_content, app::XmlSchemaParticle * particle));
...
IL2CPP_REGISTER_METHOD(0x019BC560, XmlSchemaAnyAttribute *, CompileAnyAttributeUnion, (app::Compiler * this_ptr, app::XmlSchemaAnyAttribute * a, app::XmlSchemaAnyAttribute * b));
IL2CPP_REGISTER_METHOD(0x019BC650, XmlSchemaAnyAttribute *, CompileAnyAttributeIntersection, (app::Compiler * this_ptr, app::XmlSchemaAnyAttribute * a, app::XmlSchemaAnyAttribute * b));
...
IL2CPP_REGISTER_METHOD(0x019BE5D0, ContentValidator *, CompileComplexContent, (app::Compiler * this_ptr, app::XmlSchemaComplexType * complex_type));
...
IL2CPP_REGISTER_METHOD(0x019BFEF0, XmlSchemaSimpleType *, GetSimpleType, (app::Compiler * this_ptr, app::XmlQualifiedName * name));
IL2CPP_REGISTER_METHOD(0x019C0020, XmlSchemaComplexType *, GetComplexType, (app::Compiler * this_ptr, app::XmlQualifiedName * name));
IL2CPP_REGISTER_METHOD(0x019C0120, XmlSchemaType *, GetAnySchemaType, (app::Compiler * this_ptr, app::XmlQualifiedName * name));
