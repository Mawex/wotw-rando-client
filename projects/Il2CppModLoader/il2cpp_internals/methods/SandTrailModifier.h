...
IL2CPP_REGISTER_METHOD(0x00C08580, IEnumerable_1_System_String_ *, GetKeywordsForShader, (app::SandTrailModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C08700, void, __ctor, (app::SandTrailModifier * this_ptr));
}
