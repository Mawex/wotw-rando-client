...
namespace app::methods::System_Threading_Tasks::TaskCompletionSource_1_System_Object_ {
IL2CPP_REGISTER_METHOD(0x002FA280, Task_1_System_Object_ *, get_Task, (app::TaskCompletionSource_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047936C0, TaskCompletionSource_1_System_Object__get_Task__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02776BF0, void, __ctor_1, (app::TaskCompletionSource_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04737768, TaskCompletionSource_1_System_Object___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02776D20, void, __ctor_2, (app::TaskCompletionSource_1_System_Object_ * this_ptr, app::Object * state));
IL2CPP_REGISTER_METHODINFO(0x04712B28, TaskCompletionSource_1_System_Object___ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02776D50, void, __ctor_3, (app::TaskCompletionSource_1_System_Object_ * this_ptr, app::Object * state, app::TaskCreationOptions__Enum creation_options));
