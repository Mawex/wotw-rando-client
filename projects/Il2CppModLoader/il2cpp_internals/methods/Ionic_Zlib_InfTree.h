...
namespace app::methods::Ionic_Zlib::InfTree {
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::InfTree * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0306FD90, void, __cctor, ());
}
