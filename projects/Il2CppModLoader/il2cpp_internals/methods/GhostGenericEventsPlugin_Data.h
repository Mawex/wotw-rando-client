...
IL2CPP_REGISTER_METHOD(0x0011F5D0, void, __ctor, (app::GhostGenericEventsPlugin_Data__Boxed * this_ptr, int32_t recording_i_d, int32_t property_id));
IL2CPP_REGISTER_METHOD(0x0011F5F0, GhostFrame_FrameDataTypes__Enum, get_FrameType, (app::GhostGenericEventsPlugin_Data__Boxed * this_ptr));
