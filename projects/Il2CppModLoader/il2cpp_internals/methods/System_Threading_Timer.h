...
namespace app::methods::System_Threading::Timer {
IL2CPP_REGISTER_METHOD(0x02349880, void, __ctor_1, (app::Timer * this_ptr, app::TimerCallback * callback, app::Object * state, int32_t due_time, int32_t period));
IL2CPP_REGISTER_METHOD(0x023498A0, void, __ctor_2, (app::Timer * this_ptr, app::TimerCallback * callback, app::Object * state, app::TimeSpan due_time, app::TimeSpan period));
