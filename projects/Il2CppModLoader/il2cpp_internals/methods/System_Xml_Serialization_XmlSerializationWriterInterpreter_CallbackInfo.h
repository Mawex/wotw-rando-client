...
namespace app::methods::System_Xml_Serialization::XmlSerializationWriterInterpreter_CallbackInfo {
IL2CPP_REGISTER_METHOD(0x0058DA40, void, __ctor, (app::XmlSerializationWriterInterpreter_CallbackInfo * this_ptr, app::XmlSerializationWriterInterpreter * swi, app::XmlTypeMapping * type_map));
