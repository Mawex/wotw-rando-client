...
namespace app::methods::System_Runtime_Versioning::TargetFrameworkAttribute {
IL2CPP_REGISTER_METHOD(0x01EE21A0, void, __ctor, (app::TargetFrameworkAttribute * this_ptr, app::String * framework_name));
