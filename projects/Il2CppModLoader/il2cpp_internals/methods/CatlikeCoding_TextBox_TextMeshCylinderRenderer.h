...
namespace app::methods::CatlikeCoding_TextBox::TextMeshCylinderRenderer {
    ...
    IL2CPP_REGISTER_METHOD(0x010373D0, void, __ctor, (app::TextMeshCylinderRenderer * this_ptr));
}
