...
IL2CPP_REGISTER_METHOD(0x00417920, BehaviourStatus__Enum, OnExecute, (app::SwarmFollowPathBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x002FA000, void, OnExit, (app::SwarmFollowPathBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x01821540, Vector3, GetPatrolNodePosition, (app::SwarmFollowPathBehaviour * this_ptr));
