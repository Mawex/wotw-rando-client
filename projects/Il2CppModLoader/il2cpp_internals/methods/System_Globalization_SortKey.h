...
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_OriginalString, (app::SortKey * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, Byte__Array *, get_KeyData, (app::SortKey * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01DEC320, String *, ToString, (app::SortKey * this_ptr));
