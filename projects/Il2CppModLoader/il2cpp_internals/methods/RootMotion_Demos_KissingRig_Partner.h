...
namespace app::methods::RootMotion_Demos::KissingRig_Partner {
...
IL2CPP_REGISTER_METHOD(0x02222AE0, Transform *, get_neck, (app::KissingRig_Partner * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02222F80, void, __ctor, (app::KissingRig_Partner * this_ptr));
}
