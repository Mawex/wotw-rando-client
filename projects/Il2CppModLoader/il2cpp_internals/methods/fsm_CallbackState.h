...
IL2CPP_REGISTER_METHOD(0x00F6CC00, CallbackState_1 *, AddUpdateStateAction, (app::CallbackState_1 * this_ptr, app::Action * update_state_action));
IL2CPP_REGISTER_METHOD(0x00F6CCC0, void, __ctor, (app::CallbackState_1 * this_ptr, app::IState_2 * state));
