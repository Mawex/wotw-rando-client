...
namespace app::methods::MS_Internal_Xml_Linq_ComponentModel::XAttributeValuePropertyDescriptor {
IL2CPP_REGISTER_METHOD(0x03028C80, void, __ctor, (app::XAttributeValuePropertyDescriptor * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_IsReadOnly, (app::XAttributeValuePropertyDescriptor * this_ptr));
IL2CPP_REGISTER_METHOD(0x03028D10, Object *, GetValue, (app::XAttributeValuePropertyDescriptor * this_ptr, app::Object * component));
