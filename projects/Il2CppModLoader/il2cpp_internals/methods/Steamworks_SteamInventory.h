...
IL2CPP_REGISTER_METHOD(0x027843B0, EResult__Enum, GetResultStatus, (app::SteamInventoryResult_t result_handle));
IL2CPP_REGISTER_METHOD(0x027843E0, bool, GetResultItems, (app::SteamInventoryResult_t result_handle, app::SteamItemDetails_t__Array * p_out_items_array, app::uint32_t * pun_out_items_array_size));
IL2CPP_REGISTER_METHODINFO(0x0478B860, SteamInventory_GetResultItems__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027844E0, bool, GetResultItemProperty, (app::SteamInventoryResult_t result_handle, uint32_t un_item_index, app::String * pch_property_name, app::String * * pch_value_buffer, app::uint32_t * pun_value_buffer_size_out));
...
IL2CPP_REGISTER_METHOD(0x027848B0, bool, SerializeResult, (app::SteamInventoryResult_t result_handle, app::Byte__Array * p_out_buffer, app::uint32_t * pun_out_buffer_size));
...
IL2CPP_REGISTER_METHOD(0x02784D10, bool, GetItemDefinitionIDs, (app::SteamItemDef_t__Array * p_item_def_i_ds, app::uint32_t * pun_item_def_i_ds_array_size));
IL2CPP_REGISTER_METHODINFO(0x04744BB8, SteamInventory_GetItemDefinitionIDs__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02784E00, bool, GetItemDefinitionProperty, (app::SteamItemDef_t i_definition, app::String * pch_property_name, app::String * * pch_value_buffer, app::uint32_t * pun_value_buffer_size_out));
IL2CPP_REGISTER_METHOD(0x027850A0, SteamAPICall_t, RequestEligiblePromoItemDefinitionsIDs, (app::CSteamID steam_i_d));
IL2CPP_REGISTER_METHOD(0x02785150, bool, GetEligiblePromoItemDefinitionIDs, (app::CSteamID steam_i_d, app::SteamItemDef_t__Array * p_item_def_i_ds, app::uint32_t * pun_item_def_i_ds_array_size));
IL2CPP_REGISTER_METHODINFO(0x04714510, SteamInventory_GetEligiblePromoItemDefinitionIDs__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02785250, SteamAPICall_t, StartPurchase, (app::SteamItemDef_t__Array * p_array_item_defs, app::UInt32__Array * pun_array_quantity, uint32_t un_array_length));
...
IL2CPP_REGISTER_METHOD(0x027855B0, bool, GetItemPrice, (app::SteamItemDef_t i_definition, app::uint64_t * p_current_price, app::uint64_t * p_base_price));
