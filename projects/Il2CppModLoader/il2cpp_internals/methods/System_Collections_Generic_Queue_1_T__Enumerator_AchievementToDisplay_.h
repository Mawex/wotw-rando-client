...
namespace app::methods::System_Collections_Generic::Queue_1_T__Enumerator_AchievementToDisplay_ {
IL2CPP_REGISTER_METHOD(0x001ECB90, void, __ctor, (app::Queue_1_T_Enumerator_AchievementToDisplay___Boxed * this_ptr, app::Queue_1_AchievementToDisplay_ * q));
...
IL2CPP_REGISTER_METHOD(0x001ECBF0, AchievementToDisplay, get_Current, (app::Queue_1_T_Enumerator_AchievementToDisplay___Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x001ECC40, Object *, IEnumerator_get_Current, (app::Queue_1_T_Enumerator_AchievementToDisplay___Boxed * this_ptr));
