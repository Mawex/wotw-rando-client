...
namespace app::methods::Moon_EditorTools_Persistency::PersistencyTools___c {
    IL2CPP_REGISTER_METHOD(0x01208290, void, __cctor, ());
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::PersistencyTools_c * this_ptr));
