...
namespace app::methods::System_Collections_Generic::Queue_1_System_Action_ {
IL2CPP_REGISTER_METHOD(0x02CA77B0, Action *, Dequeue, (app::Queue_1_System_Action_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CA7080, void, __ctor_1, (app::Queue_1_System_Action_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHODINFO(0x04769368, Queue_1_System_Action___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0243CB70, void, __ctor_2, (app::Queue_1_System_Action_ * this_ptr));
