...
IL2CPP_REGISTER_METHOD(0x00420EE0, GhostRecorder_GhostPluginRecordingType__Enum, GetRecordingType, (app::GhostRecordingMetaDataPlugin * this_ptr));
IL2CPP_REGISTER_METHOD(0x007E4690, void, OnStopRecording, (app::GhostRecordingMetaDataPlugin * this_ptr));
IL2CPP_REGISTER_METHOD(0x007E4890, void, __ctor, (app::GhostRecordingMetaDataPlugin * this_ptr));
}
