...
namespace app::methods::UnityEngine_EventSystems::PointerInputModule {
IL2CPP_REGISTER_METHOD(0x01F23A50, void, __ctor, (app::PointerInputModule * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F24060, PointerEventData *, GetTouchPointerEventData, (app::PointerInputModule * this_ptr, app::Touch input, app::bool * pressed, app::bool * released));
...
IL2CPP_REGISTER_METHOD(0x01F24440, PointerEventData_FramePressState__Enum, StateForMouseButton, (app::PointerInputModule * this_ptr, int32_t button_id));
IL2CPP_REGISTER_METHOD(0x01F24500, PointerInputModule_MouseState *, GetMousePointerEventData_1, (app::PointerInputModule * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F24520, PointerInputModule_MouseState *, GetMousePointerEventData_2, (app::PointerInputModule * this_ptr, int32_t id));
IL2CPP_REGISTER_METHOD(0x01F24A70, PointerEventData *, GetLastPointerEventData, (app::PointerInputModule * this_ptr, int32_t id));
...
IL2CPP_REGISTER_METHOD(0x01F25400, String *, ToString, (app::PointerInputModule * this_ptr));
