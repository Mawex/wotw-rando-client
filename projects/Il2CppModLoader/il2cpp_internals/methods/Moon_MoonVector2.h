...
IL2CPP_REGISTER_METHOD(0x02F99C10, CrossSceneReferenceId, get_CrossSceneReferenceId, (app::MoonVector2 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F99DF0, void, __ctor, (app::MoonVector2 * this_ptr, app::Vector2 static_value));
IL2CPP_REGISTER_METHOD(0x02F99E30, Vector2, Resolve, (app::MoonVector2 * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x0478F908, MoonVector2_Resolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02F9A030, Vector2, SafeResolve, (app::MoonVector2 * this_ptr, app::IMoonResolverContext * context));
...
IL2CPP_REGISTER_METHOD(0x00C3DD30, MoonTypeData, GetTypeData, (app::MoonVector2 * this_ptr));
}
