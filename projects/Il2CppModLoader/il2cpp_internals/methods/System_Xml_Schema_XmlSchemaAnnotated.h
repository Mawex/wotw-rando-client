...
namespace app::methods::System_Xml_Schema::XmlSchemaAnnotated {
IL2CPP_REGISTER_METHOD(0x002FB9B0, String *, get_Id, (app::XmlSchemaAnnotated * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9C0, void, set_Id, (app::XmlSchemaAnnotated * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB9D0, XmlSchemaAnnotation *, get_Annotation, (app::XmlSchemaAnnotated * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9E0, void, set_Annotation, (app::XmlSchemaAnnotated * this_ptr, app::XmlSchemaAnnotation * value));
IL2CPP_REGISTER_METHOD(0x002FB9F0, XmlAttribute__Array *, get_UnhandledAttributes, (app::XmlSchemaAnnotated * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, String *, get_IdAttribute, (app::XmlSchemaAnnotated * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::XmlSchemaAnnotated * this_ptr));
}
