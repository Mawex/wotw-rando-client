...
IL2CPP_REGISTER_METHOD(0x024791C0, Material *, get_material, (app::CameraFilterPack_Glow_Glow_Color * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02479F50, void, __ctor, (app::CameraFilterPack_Glow_Glow_Color * this_ptr));
}
