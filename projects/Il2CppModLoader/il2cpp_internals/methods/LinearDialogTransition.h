...
IL2CPP_REGISTER_METHOD(0x00FA74F0, IDialogNode *, get_TransitionDestination, (app::LinearDialogTransition * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::LinearDialogTransition * this_ptr));
}
