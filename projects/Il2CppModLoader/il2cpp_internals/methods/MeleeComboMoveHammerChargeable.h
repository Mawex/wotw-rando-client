...
IL2CPP_REGISTER_METHOD(0x006FB810, HammerComboMoveBase_BalancingData *, get_BalancingBase, (app::MeleeComboMoveHammerChargeable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01391550, SoundProvider *, get_EffectiveGroundHitSound, (app::MeleeComboMoveHammerChargeable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01392C90, GameObject *, GetEffectInstance, (app::MeleeComboMoveHammerChargeable * this_ptr, app::GameObject * current_shock_wave, bool track_as_suspendable));
IL2CPP_REGISTER_METHOD(0x01392EB0, GameObject *, SpawnEffect_1, (app::MeleeComboMoveHammerChargeable * this_ptr, app::GameObject * current_shock_wave, app::Vector3 position, float angle, bool flip, bool track_as_suspendable));
...
IL2CPP_REGISTER_METHOD(0x013934C0, GameObject *, SpawnEffect_3, (app::MeleeComboMoveHammerChargeable * this_ptr, app::GameObject * current_shock_wave));
...
IL2CPP_REGISTER_METHOD(0x013959F0, Vector2, ComputeEffectiveKickback, (app::MeleeComboMoveHammerChargeable * this_ptr, app::Vector3 enemy_position));
...
IL2CPP_REGISTER_METHOD(0x013965E0, EffectSpawn, DamageEffectProvider, (app::MeleeComboMoveHammerChargeable * this_ptr, app::DamageResult damage_result));
IL2CPP_REGISTER_METHODINFO(0x0470D240, MeleeComboMoveHammerChargeable_DamageEffectProvider__MethodInfo);
IL2CPP_REGISTER_METHOD(0x013968E0, void, __ctor, (app::MeleeComboMoveHammerChargeable * this_ptr));
}
