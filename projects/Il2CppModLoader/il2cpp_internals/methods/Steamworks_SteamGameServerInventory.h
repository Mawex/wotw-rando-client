...
IL2CPP_REGISTER_METHOD(0x027FAAF0, EResult__Enum, GetResultStatus, (app::SteamInventoryResult_t result_handle));
IL2CPP_REGISTER_METHOD(0x027FAB20, bool, GetResultItems, (app::SteamInventoryResult_t result_handle, app::SteamItemDetails_t__Array * p_out_items_array, app::uint32_t * pun_out_items_array_size));
IL2CPP_REGISTER_METHODINFO(0x0476F668, SteamGameServerInventory_GetResultItems__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027FAC20, bool, GetResultItemProperty, (app::SteamInventoryResult_t result_handle, uint32_t un_item_index, app::String * pch_property_name, app::String * * pch_value_buffer, app::uint32_t * pun_value_buffer_size_out));
...
IL2CPP_REGISTER_METHOD(0x027FAFF0, bool, SerializeResult, (app::SteamInventoryResult_t result_handle, app::Byte__Array * p_out_buffer, app::uint32_t * pun_out_buffer_size));
...
IL2CPP_REGISTER_METHOD(0x027FB450, bool, GetItemDefinitionIDs, (app::SteamItemDef_t__Array * p_item_def_i_ds, app::uint32_t * pun_item_def_i_ds_array_size));
IL2CPP_REGISTER_METHODINFO(0x04705248, SteamGameServerInventory_GetItemDefinitionIDs__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027FB540, bool, GetItemDefinitionProperty, (app::SteamItemDef_t i_definition, app::String * pch_property_name, app::String * * pch_value_buffer, app::uint32_t * pun_value_buffer_size_out));
IL2CPP_REGISTER_METHOD(0x027FB7E0, SteamAPICall_t, RequestEligiblePromoItemDefinitionsIDs, (app::CSteamID steam_i_d));
IL2CPP_REGISTER_METHOD(0x027FB890, bool, GetEligiblePromoItemDefinitionIDs, (app::CSteamID steam_i_d, app::SteamItemDef_t__Array * p_item_def_i_ds, app::uint32_t * pun_item_def_i_ds_array_size));
IL2CPP_REGISTER_METHODINFO(0x04760390, SteamGameServerInventory_GetEligiblePromoItemDefinitionIDs__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027FB990, SteamAPICall_t, StartPurchase, (app::SteamItemDef_t__Array * p_array_item_defs, app::UInt32__Array * pun_array_quantity, uint32_t un_array_length));
...
IL2CPP_REGISTER_METHOD(0x027FBCF0, bool, GetItemPrice, (app::SteamItemDef_t i_definition, app::uint64_t * p_current_price, app::uint64_t * p_base_price));
