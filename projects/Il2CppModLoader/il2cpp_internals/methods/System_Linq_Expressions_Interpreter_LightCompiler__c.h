...
namespace app::methods::System_Linq_Expressions_Interpreter::LightCompiler___c {
IL2CPP_REGISTER_METHOD(0x023F5F90, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::LightCompiler_c * this_ptr));
