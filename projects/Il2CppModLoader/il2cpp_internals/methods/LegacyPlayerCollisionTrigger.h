...
IL2CPP_REGISTER_METHOD(0x0043D9A0, SelectableCategory__Enum, get_Category, (app::LegacyPlayerCollisionTrigger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A2FEA0, String *, get_StressTestName, (app::LegacyPlayerCollisionTrigger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00855600, StressTestStatus__Enum, get_StressTestStatus, (app::LegacyPlayerCollisionTrigger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00611C70, void, __ctor, (app::LegacyPlayerCollisionTrigger * this_ptr));
}
