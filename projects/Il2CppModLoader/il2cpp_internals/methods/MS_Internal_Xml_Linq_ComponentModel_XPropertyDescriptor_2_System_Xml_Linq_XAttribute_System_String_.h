...
namespace app::methods::MS_Internal_Xml_Linq_ComponentModel::XPropertyDescriptor_2_System_Xml_Linq_XAttribute_System_String_ {
IL2CPP_REGISTER_METHOD(0x019F8960, void, __ctor, (app::XPropertyDescriptor_2_System_Xml_Linq_XAttribute_System_String_ * this_ptr, app::String * name));
IL2CPP_REGISTER_METHODINFO(0x04720C40, XPropertyDescriptor_2_System_Xml_Linq_XAttribute_System_String___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x019F8980, Type *, get_ComponentType, (app::XPropertyDescriptor_2_System_Xml_Linq_XAttribute_System_String_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x019F8A30, Type *, get_PropertyType, (app::XPropertyDescriptor_2_System_Xml_Linq_XAttribute_System_String_ * this_ptr));
