...
IL2CPP_REGISTER_METHOD(0x01AFD900, Transform *, get_Transform, (app::AnimationTester_AnimationTestEntry * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01AFDBA0, String *, get_ToogleName, (app::AnimationTester_AnimationTestEntry * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01AFDC40, void, __ctor, (app::AnimationTester_AnimationTestEntry * this_ptr));
}
