...
namespace app::methods::System_Xml_Schema::XmlNumeric2Converter {
IL2CPP_REGISTER_METHOD(0x02254180, void, __ctor, (app::XmlNumeric2Converter * this_ptr, app::XmlSchemaType * schema_type));
IL2CPP_REGISTER_METHOD(0x02254230, XmlValueConverter *, Create, (app::XmlSchemaType * schema_type));
...
IL2CPP_REGISTER_METHOD(0x02254E00, String *, ToString_1, (app::XmlNumeric2Converter * this_ptr, double value));
IL2CPP_REGISTER_METHOD(0x02254F00, String *, ToString_2, (app::XmlNumeric2Converter * this_ptr, float value));
IL2CPP_REGISTER_METHOD(0x02254FE0, String *, ToString_3, (app::XmlNumeric2Converter * this_ptr, app::Object * value, app::IXmlNamespaceResolver * ns_resolver));
IL2CPP_REGISTER_METHODINFO(0x04782A20, XmlNumeric2Converter_ToString_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02255380, Object *, ChangeType_1, (app::XmlNumeric2Converter * this_ptr, double value, app::Type * destination_type));
IL2CPP_REGISTER_METHODINFO(0x04780198, XmlNumeric2Converter_ChangeType__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02255880, Object *, ChangeType_2, (app::XmlNumeric2Converter * this_ptr, app::String * value, app::Type * destination_type, app::IXmlNamespaceResolver * ns_resolver));
IL2CPP_REGISTER_METHODINFO(0x0474CF20, XmlNumeric2Converter_ChangeType_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02255DB0, Object *, ChangeType_3, (app::XmlNumeric2Converter * this_ptr, app::Object * value, app::Type * destination_type, app::IXmlNamespaceResolver * ns_resolver));
