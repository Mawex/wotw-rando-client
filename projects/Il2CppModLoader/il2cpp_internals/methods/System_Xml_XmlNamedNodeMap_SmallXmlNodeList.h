...
namespace app::methods::System_Xml::XmlNamedNodeMap_SmallXmlNodeList {
IL2CPP_REGISTER_METHOD(0x001CFBF0, int32_t, get_Count, (app::XmlNamedNodeMap_SmallXmlNodeList__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001CFC00, Object *, get_Item, (app::XmlNamedNodeMap_SmallXmlNodeList__Boxed * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x001CFC40, IEnumerator *, GetEnumerator, (app::XmlNamedNodeMap_SmallXmlNodeList__Boxed * this_ptr));
}
