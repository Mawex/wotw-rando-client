...
IL2CPP_REGISTER_METHOD(0x00AEE110, Input_InputButtonProcessor *, get_Button, (app::SeinGoldenSeinAbility * this_ptr));
IL2CPP_REGISTER_METHOD(0x00720040, GoldenSein *, get_GoldenSeinInstance, (app::SeinGoldenSeinAbility * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00AF25A0, void, __ctor, (app::SeinGoldenSeinAbility * this_ptr));
}
