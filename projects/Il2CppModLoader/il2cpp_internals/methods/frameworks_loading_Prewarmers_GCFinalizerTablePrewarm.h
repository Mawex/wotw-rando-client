...
namespace app::methods::frameworks_loading_Prewarmers::GCFinalizerTablePrewarm {
    IL2CPP_REGISTER_METHOD(0x00F5F0A0, void, __ctor, (app::GCFinalizerTablePrewarm * this_ptr));
