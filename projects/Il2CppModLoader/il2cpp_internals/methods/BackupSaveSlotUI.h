...
IL2CPP_REGISTER_METHOD(0x00F83480, Rect, get_Bounds, (app::BackupSaveSlotUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::BackupSaveSlotUI * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::BackupSaveSlotUI * this_ptr));
}
