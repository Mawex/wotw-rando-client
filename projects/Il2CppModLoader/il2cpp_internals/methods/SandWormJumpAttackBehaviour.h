...
IL2CPP_REGISTER_METHOD(0x00C1BAD0, BehaviourStatus__Enum, OnExecute, (app::SandWormJumpAttackBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00C1DF00, SandWormSandDigLocomotionBehaviour_SpeedEntry, GetCurrentSpeedEntry, (app::SandWormJumpAttackBehaviour * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0475F010, SandWormJumpAttackBehaviour_GetCurrentSpeedEntry__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00C1DF70, void, __ctor, (app::SandWormJumpAttackBehaviour * this_ptr));
}
