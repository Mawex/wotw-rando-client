...
namespace app::methods::System_Xml_Serialization::XmlElementAttributes {
IL2CPP_REGISTER_METHOD(0x025A1D20, XmlElementAttribute *, get_Item, (app::XmlElementAttributes * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x01C9A650, void, __ctor, (app::XmlElementAttributes * this_ptr));
}
