...
namespace app::methods::ZenFulcrum_VR_OpenVRBinding::IVRApplications__GetApplicationPropertyString {
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::IVRApplications_GetApplicationPropertyString * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02F3DD30, IAsyncResult *, BeginInvoke, (app::IVRApplications_GetApplicationPropertyString * this_ptr, app::String * pch_app_key, app::EVRApplicationProperty__Enum e_property, app::StringBuilder * pch_property_value_buffer, uint32_t un_property_value_buffer_len, app::EVRApplicationError__Enum * pe_error, app::AsyncCallback * callback, app::Object * object));
