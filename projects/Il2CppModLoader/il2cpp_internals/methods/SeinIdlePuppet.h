...
IL2CPP_REGISTER_METHOD(0x0100E640, GameObject *, GetInstantiatedFieldValue, (app::SeinIdlePuppet * this_ptr, int32_t attribute_id));
IL2CPP_REGISTER_METHOD(0x0100E670, void, __ctor, (app::SeinIdlePuppet * this_ptr));
}
