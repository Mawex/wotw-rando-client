...
IL2CPP_REGISTER_METHOD(0x002FB930, MoonAnimatorDefinition *, IAnimation_get_AnimatorDefinition, (app::MoonAnimation * this_ptr));
IL2CPP_REGISTER_METHOD(0x00446960, float, IAnimation_get_AdditiveWeightMultiplier, (app::MoonAnimation * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B171E0, GameObject *, get_Rig, (app::MoonAnimation * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CB5CD0, MoonAnimatorLayerName, get_Layer, (app::MoonAnimation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB60, AnimationPostprocessGroup__Array *, get_DisabledPostprocessGroups, (app::MoonAnimation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB80, AnimationPostprocessGroupModifier__Array *, get_PostprocessGroupModifiers, (app::MoonAnimation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00BAB250, String *, get_Name, (app::MoonAnimation * this_ptr));
IL2CPP_REGISTER_METHOD(0x0051DB40, bool, get_UseDefaultTransitionIn, (app::MoonAnimation * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBC0, AnimationTransition *, get_DefaultTransitionIn, (app::MoonAnimation * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B172B0, AnimationTransition *, GetTransition, (app::MoonAnimation * this_ptr, app::IAnimation * target_animation, float current_normalized_time));
...
IL2CPP_REGISTER_METHOD(0x01B17740, void, __ctor, (app::MoonAnimation * this_ptr));
}
