...
IL2CPP_REGISTER_METHOD(0x00807A70, String *, get_Name, (app::BugReportMenuItem * this_ptr));
IL2CPP_REGISTER_METHOD(0x00807AF0, String *, get_Path, (app::BugReportMenuItem * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, set_Path, (app::BugReportMenuItem * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_Text, (app::BugReportMenuItem * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9A0, void, set_Text, (app::BugReportMenuItem * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x00807B70, String *, get_HelpText, (app::BugReportMenuItem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, Func_1_String_ *, get_DynamicText, (app::BugReportMenuItem * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::BugReportMenuItem * this_ptr));
}
