...
IL2CPP_REGISTER_METHOD(0x010B4F20, MoonTimeline *, get_EffectiveSpawnTimeline, (app::TentacleSpawnBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010B5290, BehaviourStatus__Enum, OnExecuteTask, (app::TentacleSpawnBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x010B5A50, void, __ctor, (app::TentacleSpawnBehaviour * this_ptr));
}
