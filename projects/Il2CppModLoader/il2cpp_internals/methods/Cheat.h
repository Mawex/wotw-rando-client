...
namespace app::methods::Cheat {
    IL2CPP_REGISTER_METHOD(0x00522850, void, __ctor, (app::Cheat * this_ptr, app::Input_InputButtonProcessor__Array * combination, app::Action * action, app::Func_1_Boolean_ * condition));
