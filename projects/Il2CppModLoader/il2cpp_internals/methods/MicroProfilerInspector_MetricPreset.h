...
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_Name, (app::MicroProfilerInspector_MetricPreset * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01433F20, void, __ctor, (app::MicroProfilerInspector_MetricPreset * this_ptr));
}
