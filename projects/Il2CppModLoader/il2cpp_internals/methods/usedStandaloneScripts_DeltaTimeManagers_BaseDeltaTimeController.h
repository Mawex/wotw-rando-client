...
namespace app::methods::usedStandaloneScripts_DeltaTimeManagers::BaseDeltaTimeController {
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::BaseDeltaTimeController * this_ptr));
}
