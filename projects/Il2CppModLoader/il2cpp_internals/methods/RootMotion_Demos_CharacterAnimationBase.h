...
namespace app::methods::RootMotion_Demos::CharacterAnimationBase {
IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, GetPivotPoint, (app::CharacterAnimationBase * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0220E260, void, __ctor, (app::CharacterAnimationBase * this_ptr));
}
