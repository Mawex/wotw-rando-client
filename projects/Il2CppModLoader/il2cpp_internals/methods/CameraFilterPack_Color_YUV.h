...
IL2CPP_REGISTER_METHOD(0x024DC990, Material *, get_material, (app::CameraFilterPack_Color_YUV * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0136E200, void, __ctor, (app::CameraFilterPack_Color_YUV * this_ptr));
}
