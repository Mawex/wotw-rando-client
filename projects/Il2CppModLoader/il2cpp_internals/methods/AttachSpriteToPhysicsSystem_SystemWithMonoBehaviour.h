...
namespace app::methods::AttachSpriteToPhysicsSystem_SystemWithMonoBehaviour {
    IL2CPP_REGISTER_METHOD(0x0084C970, void, __ctor, (app::AttachSpriteToPhysicsSystem_SystemWithMonoBehaviour * this_ptr, app::AttachSpriteToPhysicsSystem__Array * entities));
