...
namespace app::methods::ReplaySetting {
    ...
    IL2CPP_REGISTER_METHOD(0x00902A70, IEnumerator*, ApplyRoutine, (app::ReplaySetting * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00902E70, IEnumerator*, GoToSceneRoutine, (app::String * scene_name, app::SceneMetaData* meta_data, app::Vector3 position, app::Action* on_complete, bool exit));
    ...
    IL2CPP_REGISTER_METHOD(0x00903110, void, __ctor, (app::ReplaySetting * this_ptr));
