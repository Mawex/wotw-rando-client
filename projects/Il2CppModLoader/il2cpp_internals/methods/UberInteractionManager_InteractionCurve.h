...
IL2CPP_REGISTER_METHOD(0x013FECC0, Texture2D *, GetTexture, (app::UberInteractionManager_InteractionCurve * this_ptr));
IL2CPP_REGISTER_METHOD(0x013FED80, void, __ctor, (app::UberInteractionManager_InteractionCurve * this_ptr));
}
