...
IL2CPP_REGISTER_METHOD(0x00CCD6E0, BehaviourStatus__Enum, OnExecute, (app::CrabSpinLoopAttackBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00CCE410, void, __ctor, (app::CrabSpinLoopAttackBehaviour * this_ptr));
}
