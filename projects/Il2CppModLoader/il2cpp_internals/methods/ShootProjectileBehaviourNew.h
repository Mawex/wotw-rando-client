...
IL2CPP_REGISTER_METHOD(0x005B8560, BehaviourStatus__Enum, OnExecute, (app::ShootProjectileBehaviourNew * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x005B9380, void, __ctor, (app::ShootProjectileBehaviourNew * this_ptr));
}
