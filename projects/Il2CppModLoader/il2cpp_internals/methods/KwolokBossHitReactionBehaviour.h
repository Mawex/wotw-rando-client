...
IL2CPP_REGISTER_METHOD(0x012E1970, BehaviourStatus__Enum, OnExecuteTask, (app::KwolokBossHitReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x012E1CB0, void, __ctor, (app::KwolokBossHitReactionBehaviour * this_ptr));
}
