...
IL2CPP_REGISTER_METHOD(0x00E27270, BehaviourStatus__Enum, OnExecute, (app::ShardTraderInShopBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00E27000, void, OnExit, (app::ShardTraderInShopBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x0060C1C0, void, __ctor, (app::ShardTraderInShopBehaviour * this_ptr));
}
