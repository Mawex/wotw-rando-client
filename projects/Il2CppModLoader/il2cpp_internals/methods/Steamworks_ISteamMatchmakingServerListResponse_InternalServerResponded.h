...
namespace app::methods::Steamworks::ISteamMatchmakingServerListResponse_InternalServerResponded {
    IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::ISteamMatchmakingServerListResponse_InternalServerResponded * this_ptr, app::Object * object, void * method_1));
