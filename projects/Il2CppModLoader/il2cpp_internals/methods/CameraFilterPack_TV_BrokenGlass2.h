...
IL2CPP_REGISTER_METHOD(0x020E6640, Material *, get_material, (app::CameraFilterPack_TV_BrokenGlass2 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E70F0, void, __ctor, (app::CameraFilterPack_TV_BrokenGlass2 * this_ptr));
}
