...
namespace app::methods::Moon_BehaviourSystem::ReceivedDamageCondition {
IL2CPP_REGISTER_METHOD(0x00CBB040, String *, get_Info, (app::ReceivedDamageCondition * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CB75E0, void, __ctor, (app::ReceivedDamageCondition * this_ptr));
}
