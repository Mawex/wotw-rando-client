...
namespace app::methods::System_Threading_Tasks::TaskCompletionSource_1_Microsoft_Xbox_Services_Xal_XalUser_ {
    IL2CPP_REGISTER_METHOD(0x02776BF0, void, __ctor, (app::TaskCompletionSource_1_Microsoft_Xbox_Services_Xal_XalUser_ * this_ptr));
