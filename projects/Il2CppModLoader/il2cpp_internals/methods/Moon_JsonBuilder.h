...
IL2CPP_REGISTER_METHOD(0x030EB680, JsonBuilder_Slot, RootSlot, (app::JsonBuilder * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0475DD90, JsonBuilder_RootSlot__MethodInfo);
IL2CPP_REGISTER_METHOD(0x030EB760, JsonBuilder_Slot, NewSlot, (app::JsonBuilder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01B65290, String *, ToString, (app::JsonBuilder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030EC6A0, void, __ctor, (app::JsonBuilder * this_ptr));
}
