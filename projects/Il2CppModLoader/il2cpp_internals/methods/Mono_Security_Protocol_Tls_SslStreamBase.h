...
IL2CPP_REGISTER_METHOD(0x01F811B0, X509Certificate_1 *, RaiseLocalCertificateSelection, (app::SslStreamBase * this_ptr, app::X509CertificateCollection_1 * certificates, app::X509Certificate_1 * remote_certificate, app::String * target_host, app::X509CertificateCollection_1 * requested_certificates));
...
IL2CPP_REGISTER_METHOD(0x01F81190, ValidationResult *, RaiseRemoteCertificateValidation2, (app::SslStreamBase * this_ptr, app::X509CertificateCollection_2 * collection));
IL2CPP_REGISTER_METHOD(0x01F811F0, AsymmetricAlgorithm *, RaiseLocalPrivateKeySelection, (app::SslStreamBase * this_ptr, app::X509Certificate_1 * certificate, app::String * target_host));
...
IL2CPP_REGISTER_METHOD(0x01F84180, CipherAlgorithmType__Enum, get_CipherAlgorithm, (app::SslStreamBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F841E0, int32_t, get_CipherStrength, (app::SslStreamBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F84240, HashAlgorithmType__Enum, get_HashAlgorithm, (app::SslStreamBase * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F843B0, ExchangeAlgorithmType__Enum, get_KeyExchangeAlgorithm, (app::SslStreamBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F84410, SecurityProtocolType__Enum_1, get_SecurityProtocol, (app::SslStreamBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F84450, X509Certificate_1 *, get_ServerCertificate, (app::SslStreamBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F846C0, X509CertificateCollection_2 *, get_ServerCertificates, (app::SslStreamBase * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F84AF0, IAsyncResult *, BeginRead, (app::SslStreamBase * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::AsyncCallback * callback, app::Object * state));
...
IL2CPP_REGISTER_METHOD(0x01F863F0, IAsyncResult *, BeginWrite, (app::SslStreamBase * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::AsyncCallback * callback, app::Object * state));
