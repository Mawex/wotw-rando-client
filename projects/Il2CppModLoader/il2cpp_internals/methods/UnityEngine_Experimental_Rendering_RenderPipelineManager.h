...
IL2CPP_REGISTER_METHOD(0x02523610, IRenderPipeline *, get_currentPipeline, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x02523690, void, set_currentPipeline, (IRenderPipeline * value));
IL2CPP_REGISTER_METHOD(0x02523720, void, CleanupRenderPipeline, (MethodInfo * method));
