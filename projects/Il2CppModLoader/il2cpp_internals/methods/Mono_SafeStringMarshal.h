...
IL2CPP_REGISTER_METHOD(0x023CEE20, void, GFree, (app::void * ptr));
IL2CPP_REGISTER_METHOD(0x001EA8E0, void, __ctor, (app::SafeStringMarshal__Boxed * this_ptr, app::String * str));
