...
IL2CPP_REGISTER_METHOD(0x008FB2B0, Rect, get_EditorBounds, (app::RectangleGameplayZone * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0043BB90, void, __ctor, (app::RectangleGameplayZone * this_ptr));
}
