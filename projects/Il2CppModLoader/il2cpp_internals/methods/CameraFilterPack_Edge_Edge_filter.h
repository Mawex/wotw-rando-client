...
IL2CPP_REGISTER_METHOD(0x024643F0, Material *, get_material, (app::CameraFilterPack_Edge_Edge_filter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02464D50, void, __ctor, (app::CameraFilterPack_Edge_Edge_filter * this_ptr));
}
