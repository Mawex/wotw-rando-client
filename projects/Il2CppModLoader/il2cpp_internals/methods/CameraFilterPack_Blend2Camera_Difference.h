...
IL2CPP_REGISTER_METHOD(0x027490F0, Material *, get_material, (app::CameraFilterPack_Blend2Camera_Difference * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0274A2C0, void, __ctor, (app::CameraFilterPack_Blend2Camera_Difference * this_ptr));
}
