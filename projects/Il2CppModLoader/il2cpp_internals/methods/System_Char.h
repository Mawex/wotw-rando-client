...
namespace app::methods::System::Char {
    ...
    IL2CPP_REGISTER_METHOD(0x00123DF0, String*, ToString_1, (app::Char__Boxed * this_ptr));
    IL2CPP_REGISTER_METHOD(0x001E2A10, String*, ToString_2, (app::Char__Boxed * this_ptr, app::IFormatProvider* provider));
    IL2CPP_REGISTER_METHOD(0x022A0550, String*, ToString_3, (uint16_t c));
    ...
    IL2CPP_REGISTER_METHOD(0x022A0680, bool, TryParse, (app::String * s, app::uint16_t* result));
    ...
    IL2CPP_REGISTER_METHOD(0x001E2A20, TypeCode__Enum, GetTypeCode, (app::Char__Boxed * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x001E3140, Decimal, IConvertible_ToDecimal, (app::Char__Boxed * this_ptr, app::IFormatProvider* provider));
    IL2CPP_REGISTER_METHODINFO(0x04700D10, Char_System_IConvertible_ToDecimal__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x001E3150, DateTime, IConvertible_ToDateTime, (app::Char__Boxed * this_ptr, app::IFormatProvider* provider));
    IL2CPP_REGISTER_METHODINFO(0x04743090, Char_System_IConvertible_ToDateTime__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x001E3160, Object*, IConvertible_ToType, (app::Char__Boxed * this_ptr, app::Type* type, app::IFormatProvider* provider));
    ...
    IL2CPP_REGISTER_METHOD(0x022A2870, UnicodeCategory__Enum, GetUnicodeCategory_1, (uint16_t c));
    IL2CPP_REGISTER_METHOD(0x022A2960, UnicodeCategory__Enum, GetUnicodeCategory_2, (app::String * s, int32_t index));
