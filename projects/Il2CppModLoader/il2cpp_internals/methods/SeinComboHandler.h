...
IL2CPP_REGISTER_METHOD(0x002FBCA0, SeinComboHandler_StubbedComboMove *, get_MovementAbility, (app::SeinComboHandler * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCC0, SeinComboHandler_StubbedComboMove *, get_AttackAbility, (app::SeinComboHandler * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005D06C0, CharacterPlatformMovement *, get_SeinPlatformMovement, (app::SeinComboHandler * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A5B980, Transform *, get_WeaponJoint, (app::SeinComboHandler * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A5BA30, bool, get_IsPerformingWeaponCombo, (app::SeinComboHandler * this_ptr));
IL2CPP_REGISTER_METHOD(0x0071F210, Transform *, get_RootJoint, (app::SeinComboHandler * this_ptr));
IL2CPP_REGISTER_METHOD(0x00720150, Animator *, get_Animator, (app::SeinComboHandler * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A5BA40, MeleeWeapon *, get_CurrentWeapon, (app::SeinComboHandler * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A5BA50, IComboMove *, get_CurrentComboMove, (app::SeinComboHandler * this_ptr));
IL2CPP_REGISTER_METHOD(0x00756A30, IComboMove *, get_UpcomingComboMove, (app::SeinComboHandler * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006A63A0, ComboInput *, GetNextInput, (app::SeinComboHandler * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A5F4E0, IComboMove *, FindComboMoveForInput, (app::SeinComboHandler * this_ptr, app::ComboInput * input));
IL2CPP_REGISTER_METHOD(0x00A5F5D0, IComboMove *, FindInitialComboMoveForInput, (app::SeinComboHandler * this_ptr, app::ComboInput * input));
...
IL2CPP_REGISTER_METHOD(0x00A5FF50, IComboMove *, FindChainedComboMoveForInput, (app::SeinComboHandler * this_ptr, app::ComboInput * input));
...
IL2CPP_REGISTER_METHOD(0x00A634E0, void, __ctor, (app::SeinComboHandler * this_ptr));
