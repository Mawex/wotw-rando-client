...
namespace app::methods::System_Security_Cryptography::CryptoConfig {
IL2CPP_REGISTER_METHOD(0x020C91F0, Byte__Array *, EncodeOID, (app::String * str));
...
IL2CPP_REGISTER_METHOD(0x020C98E0, Object *, CreateFromName_1, (app::String * name));
IL2CPP_REGISTER_METHOD(0x020C98F0, Object *, CreateFromName_2, (app::String * name, app::Object__Array * args));
IL2CPP_REGISTER_METHODINFO(0x0470EDC0, CryptoConfig_CreateFromName_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020CC640, String *, MapNameToOID_1, (app::String * name, app::Object * arg));
IL2CPP_REGISTER_METHOD(0x020CC650, String *, MapNameToOID_2, (app::String * name));
IL2CPP_REGISTER_METHODINFO(0x04730F38, CryptoConfig_MapNameToOID_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::CryptoConfig * this_ptr));
}
