...
IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkDiffractionPathInfo * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x026DF2E0, void *, getCPtr, (app::AkDiffractionPathInfo * obj));
IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkDiffractionPathInfo * this_ptr, app::void * c_ptr));
...
IL2CPP_REGISTER_METHOD(0x026DF740, AkTransform *, get_virtualPos, (app::AkDiffractionPathInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x026E0320, AkVector *, GetNodes, (app::AkDiffractionPathInfo * this_ptr, uint32_t idx));
...
IL2CPP_REGISTER_METHOD(0x026E09F0, void, __ctor_2, (app::AkDiffractionPathInfo * this_ptr));
}
