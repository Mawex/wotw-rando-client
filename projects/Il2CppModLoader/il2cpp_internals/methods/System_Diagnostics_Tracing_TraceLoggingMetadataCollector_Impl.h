...
namespace app::methods::System_Diagnostics_Tracing::TraceLoggingMetadataCollector_Impl {
...
IL2CPP_REGISTER_METHOD(0x01A0D9F0, void, __ctor, (app::TraceLoggingMetadataCollector_Impl * this_ptr));
}
