...
namespace app::methods::System_Threading::Thread {
...
IL2CPP_REGISTER_METHOD(0x02341920, void, __ctor_1, (app::Thread * this_ptr, app::ThreadStart * start));
IL2CPP_REGISTER_METHODINFO(0x0472D738, Thread__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x023419F0, void, __ctor_2, (app::Thread * this_ptr, app::ParameterizedThreadStart * start));
...
IL2CPP_REGISTER_METHOD(0x002FB9D0, ExecutionContext_Reader, GetExecutionContextReader, (app::Thread * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02341E10, ExecutionContext *, GetMutableExecutionContext, (app::Thread * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02342990, CultureInfo *, get_CurrentUICulture, (app::Thread * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02342E20, CultureInfo *, GetCurrentUICultureNoAppX, (app::Thread * this_ptr));
IL2CPP_REGISTER_METHOD(0x02343090, CultureInfo *, get_CurrentCulture, (app::Thread * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02343450, CultureInfo *, GetCurrentCultureNoAppX, (app::Thread * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02343810, InternalThread *, get_Internal, (app::Thread * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02343DB0, ThreadState__Enum, get_ThreadState, (app::Thread * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02343FC0, ThreadState__Enum, GetState, (app::InternalThread * thread));
...
IL2CPP_REGISTER_METHOD(0x02344240, ThreadState__Enum, ValidateThreadState, (app::Thread * this_ptr));
