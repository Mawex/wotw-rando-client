...
namespace app::methods::SeinCinematic {
    ...
    IL2CPP_REGISTER_METHOD(0x00A586F0, Vector3, CurveVector, (app::SeinCinematic * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A58850, ActiveAnimationHandle, PerformAnimation_1, (app::SeinCinematic * this_ptr, app::MoonAnimation* animation, bool disable_collider, bool use_perspective_rotation, float disable_collider_duration_offset, bool dismount, app::EventTriggerAnimator* mount_trigger));
    ...
    IL2CPP_REGISTER_METHOD(0x00A59630, ActiveAnimationHandle, PerformAnimation_2, (app::SeinCinematic * this_ptr, app::MoonAnimation* animation, app::Vector3 initial_position, app::AnimationCurve* curve_x, app::AnimationCurve* curve_y, app::AnimationCurve* curve_z, float interpolation_duration, bool disable_collider, bool use_perspective_adjustment, float disable_collider_duration_offset, bool dismount, app::EventTriggerAnimator* mount_trigger));
    ...
    IL2CPP_REGISTER_METHOD(0x005C9550, void, __ctor, (app::SeinCinematic * this_ptr));
