...
IL2CPP_REGISTER_METHOD(0x008519C0, SuspendableMask__Enum, get_Mask, (app::MistyWoodsKuroGameplayController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0132A790, void, __ctor, (app::MistyWoodsKuroGameplayController * this_ptr));
