...
IL2CPP_REGISTER_METHOD(0x013ACD50, IEnumerator *, ResetTrail, (app::TrailRenderer * trail));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::UnparentTrailRenderer * this_ptr));
}
