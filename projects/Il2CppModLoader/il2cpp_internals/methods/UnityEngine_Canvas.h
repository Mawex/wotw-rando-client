...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::Canvas * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031A5710, RenderMode__Enum, get_renderMode, (app::Canvas * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031A5C10, Canvas *, get_rootCanvas, (app::Canvas * this_ptr));
IL2CPP_REGISTER_METHOD(0x031A5C60, Camera *, get_worldCamera, (app::Canvas * this_ptr));
