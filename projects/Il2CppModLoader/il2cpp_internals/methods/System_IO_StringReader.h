...
namespace app::methods::System_IO::StringReader {
IL2CPP_REGISTER_METHOD(0x02383B30, void, __ctor, (app::StringReader * this_ptr, app::String * s));
...
IL2CPP_REGISTER_METHOD(0x02383EA0, String *, ReadToEnd, (app::StringReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x02383EE0, String *, ReadLine, (app::StringReader * this_ptr));
}
