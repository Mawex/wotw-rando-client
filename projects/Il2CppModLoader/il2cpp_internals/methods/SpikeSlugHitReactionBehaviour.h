...
IL2CPP_REGISTER_METHOD(0x00A64240, EntityDamageEvent *, get_DamageEvent, (app::SpikeSlugHitReactionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420230, BehaviourStatus__Enum, OnExecuteTask, (app::SpikeSlugHitReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x011CECE0, MoonTimeline *, GetShelledHitTimeline, (app::SpikeSlugHitReactionBehaviour * this_ptr, app::Vector3 normalized_damage_force));
...
IL2CPP_REGISTER_METHOD(0x011D08E0, void, __ctor, (app::SpikeSlugHitReactionBehaviour * this_ptr));
}
