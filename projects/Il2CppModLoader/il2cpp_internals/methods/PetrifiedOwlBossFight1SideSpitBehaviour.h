...
IL2CPP_REGISTER_METHOD(0x017644B0, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossFight1SideSpitBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0176C1A0, Enum__Array *, GetEntries, (app::PetrifiedOwlBossFight1SideSpitBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x0176C240, Enum, Evaluate, (app::PetrifiedOwlBossFight1SideSpitBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_ShouldSkip, (app::PetrifiedOwlBossFight1SideSpitBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x0176C2E0, void, __ctor, (app::PetrifiedOwlBossFight1SideSpitBehaviour * this_ptr));
}
