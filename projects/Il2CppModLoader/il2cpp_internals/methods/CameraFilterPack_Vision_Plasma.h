...
IL2CPP_REGISTER_METHOD(0x020F8380, Material *, get_material, (app::CameraFilterPack_Vision_Plasma * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020F8CD0, void, __ctor, (app::CameraFilterPack_Vision_Plasma * this_ptr));
}
