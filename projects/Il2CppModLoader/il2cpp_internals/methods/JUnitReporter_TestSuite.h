...
IL2CPP_REGISTER_METHOD(0x006498D0, void, __ctor, (app::JUnitReporter_TestSuite * this_ptr, app::String * id, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x00649CC0, JUnitReporter_TestCase *, AddTestCase_1, (app::JUnitReporter_TestSuite * this_ptr, app::String * name, app::String * class_name));
IL2CPP_REGISTER_METHOD(0x00649FF0, JUnitReporter_TestCase *, AddTestCase_2, (app::JUnitReporter_TestSuite * this_ptr, app::JUnitReporter_TestCase * test_case));
IL2CPP_REGISTER_METHOD(0x0064A0C0, String *, ToString, (app::JUnitReporter_TestSuite * this_ptr));
