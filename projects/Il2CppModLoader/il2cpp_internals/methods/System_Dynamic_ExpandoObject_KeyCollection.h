...
namespace app::methods::System_Dynamic::ExpandoObject_KeyCollection {
IL2CPP_REGISTER_METHOD(0x01F8FDB0, void, __ctor, (app::ExpandoObject_KeyCollection * this_ptr, app::ExpandoObject * expando));
...
IL2CPP_REGISTER_METHOD(0x01F904E0, IEnumerator_1_System_String_ *, GetEnumerator, (app::ExpandoObject_KeyCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F904E0, IEnumerator *, IEnumerable_GetEnumerator, (app::ExpandoObject_KeyCollection * this_ptr));
}
