...
namespace app::methods::RootMotion_Demos::CharacterAnimationThirdPersonIK {
...
IL2CPP_REGISTER_METHOD(0x0220F680, void, __ctor, (app::CharacterAnimationThirdPersonIK * this_ptr));
}
