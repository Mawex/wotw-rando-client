...
namespace app::methods::SeinStomp {
    ...
    IL2CPP_REGISTER_METHOD(0x005D06F0, CharacterLeftRightMovement*, get_LeftRightMovement, (app::SeinStomp * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A7EB40, SeinDoubleJump*, get_DoubleJump, (app::SeinStomp * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A52480, CharacterUpwardsDeceleration*, get_UpwardsDeceleration, (app::SeinStomp * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement*, get_PlatformMovement, (app::SeinStomp * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00A83490, void, __ctor, (app::SeinStomp * this_ptr));
