...
namespace app::methods::Mono_Security_Protocol_Tls::SslHandshakeHash {
IL2CPP_REGISTER_METHOD(0x01F81810, void, __ctor, (app::SslHandshakeHash * this_ptr, app::Byte__Array * secret));
IL2CPP_REGISTER_METHOD(0x01F818B0, void, Initialize, (app::SslHandshakeHash * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F81910, Byte__Array *, HashFinal, (app::SslHandshakeHash * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F81DE0, Byte__Array *, CreateSignature, (app::SslHandshakeHash * this_ptr, app::RSA * rsa));
