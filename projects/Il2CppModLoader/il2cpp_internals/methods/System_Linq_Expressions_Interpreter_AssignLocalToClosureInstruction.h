...
namespace app::methods::System_Linq_Expressions_Interpreter::AssignLocalToClosureInstruction {
...
IL2CPP_REGISTER_METHOD(0x022D5E00, String *, get_InstructionName, (app::AssignLocalToClosureInstruction * this_ptr));
