...
namespace app::methods::Moon_Timeline::PathTweenAnimator {
IL2CPP_REGISTER_METHOD(0x00778090, float, get_CurrentNormalizedPosition, (app::PathTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x007780D0, GameObject *, get_ExternalTarget, (app::PathTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, OnEntityCreated, (app::PathTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00778180, Transform *, get_EffectiveTransform, (app::PathTweenAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00778DC0, Vector3, GetPoint, (app::PathTweenAnimator * this_ptr, app::Matrix4x4 * world_to_local, float time));
IL2CPP_REGISTER_METHOD(0x00778EC0, Matrix4x4, GetWorldToLocal, (app::PathTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00778F30, void, __ctor, (app::PathTweenAnimator * this_ptr));
}
