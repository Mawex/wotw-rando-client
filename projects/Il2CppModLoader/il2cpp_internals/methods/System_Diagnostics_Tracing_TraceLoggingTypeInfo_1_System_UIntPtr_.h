...
namespace app::methods::System_Diagnostics_Tracing::TraceLoggingTypeInfo_1_System_UIntPtr_ {
...
IL2CPP_REGISTER_METHOD(0x02878F80, TraceLoggingTypeInfo_1_System_UIntPtr_ *, GetInstance, (app::List_1_System_Type_ * recursion_check));
