...
IL2CPP_REGISTER_METHOD(0x017644B0, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossFight1SideShriekBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0176B2A0, Enum__Array *, GetEntries, (app::PetrifiedOwlBossFight1SideShriekBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x0176B340, Enum, Evaluate, (app::PetrifiedOwlBossFight1SideShriekBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_ShouldSkip, (app::PetrifiedOwlBossFight1SideShriekBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x017657C0, void, __ctor, (app::PetrifiedOwlBossFight1SideShriekBehaviour * this_ptr));
}
