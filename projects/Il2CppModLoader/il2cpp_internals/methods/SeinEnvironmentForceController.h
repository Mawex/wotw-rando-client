...
IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement *, get_PlatformMovement, (app::SeinEnvironmentForceController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00AD1280, PlatformMovementListOfColliders *, get_PlatformMovementListOfColliders, (app::SeinEnvironmentForceController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00AD12B0, SeinGrabWall *, get_GrabWall, (app::SeinEnvironmentForceController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00AD31A0, Vector3, get_SeinSpeed, (app::SeinEnvironmentForceController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00AD38C0, void, __ctor, (app::SeinEnvironmentForceController * this_ptr));
}
