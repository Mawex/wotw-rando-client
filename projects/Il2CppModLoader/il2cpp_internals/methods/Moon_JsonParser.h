...
IL2CPP_REGISTER_METHOD(0x030EDB40, void, __ctor, (app::JsonParser * this_ptr, app::String * json));
...
IL2CPP_REGISTER_METHOD(0x030EE0E0, JsonParser_Slot, RootSlot, (app::JsonParser * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04704CD0, JsonParser_RootSlot__MethodInfo);
IL2CPP_REGISTER_METHOD(0x030EE1B0, JsonToken__Enum, NextTokenWithoutAdvancing, (app::JsonParser * this_ptr, app::double * number, app::Substr * remainder));
IL2CPP_REGISTER_METHODINFO(0x0471AFD8, JsonParser_NextTokenWithoutAdvancing__MethodInfo);
IL2CPP_REGISTER_METHOD(0x030EE290, JsonToken__Enum, NextToken, (app::JsonParser * this_ptr, app::double * number));
