...
IL2CPP_REGISTER_METHOD(0x02763B70, Material *, get_material, (app::CameraFilterPack_Blur_Bloom * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02764490, void, __ctor, (app::CameraFilterPack_Blur_Bloom * this_ptr));
}
