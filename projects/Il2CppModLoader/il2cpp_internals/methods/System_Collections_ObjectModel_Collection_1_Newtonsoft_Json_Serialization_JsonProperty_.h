...
namespace app::methods::System_Collections_ObjectModel::Collection_1_Newtonsoft_Json_Serialization_JsonProperty_ {
IL2CPP_REGISTER_METHOD(0x02B833F0, IEnumerator_1_Newtonsoft_Json_Serialization_JsonProperty_ *, GetEnumerator, (app::Collection_1_Newtonsoft_Json_Serialization_JsonProperty_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04725468, Collection_1_Newtonsoft_Json_Serialization_JsonProperty__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FA280, IList_1_Newtonsoft_Json_Serialization_JsonProperty_ *, get_Items, (app::Collection_1_Newtonsoft_Json_Serialization_JsonProperty_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CFA3A0, JsonProperty *, get_Item, (app::Collection_1_Newtonsoft_Json_Serialization_JsonProperty_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02CFAD00, IEnumerator *, IEnumerable_GetEnumerator, (app::Collection_1_Newtonsoft_Json_Serialization_JsonProperty_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CFA3A0, Object *, IList_get_Item, (app::Collection_1_Newtonsoft_Json_Serialization_JsonProperty_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02CFAD90, Object *, ICollection_get_SyncRoot, (app::Collection_1_Newtonsoft_Json_Serialization_JsonProperty_ * this_ptr));
