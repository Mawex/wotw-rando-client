...
namespace app::methods::System_Collections_Generic::List_1_WaterPoisonTrail_DamagePoint_ {
...
IL2CPP_REGISTER_METHOD(0x02C21490, WaterPoisonTrail_DamagePoint, get_Item, (app::List_1_WaterPoisonTrail_DamagePoint_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_WaterPoisonTrail_DamagePoint_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047906F0, List_1_WaterPoisonTrail_DamagePoint___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_WaterPoisonTrail_DamagePoint_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02C20EA0, void, __ctor_3, (app::List_1_WaterPoisonTrail_DamagePoint_ * this_ptr, app::IEnumerable_1_WaterPoisonTrail_DamagePoint_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02C21330, Object *, ICollection_get_SyncRoot, (app::List_1_WaterPoisonTrail_DamagePoint_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02C21530, bool, IsCompatibleObject, (app::Object * value));
IL2CPP_REGISTER_METHOD(0x02C21620, Object *, IList_get_Item, (app::List_1_WaterPoisonTrail_DamagePoint_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_WaterPoisonTrail_DamagePoint_ *, AsReadOnly, (app::List_1_WaterPoisonTrail_DamagePoint_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C21EE0, WaterPoisonTrail_DamagePoint, Find, (app::List_1_WaterPoisonTrail_DamagePoint_ * this_ptr, app::Predicate_1_WaterPoisonTrail_DamagePoint_ * match));
IL2CPP_REGISTER_METHOD(0x02C22010, List_1_WaterPoisonTrail_DamagePoint_ *, FindAll, (app::List_1_WaterPoisonTrail_DamagePoint_ * this_ptr, app::Predicate_1_WaterPoisonTrail_DamagePoint_ * match));
...
IL2CPP_REGISTER_METHOD(0x02C22520, List_1_T_Enumerator_WaterPoisonTrail_DamagePoint_, GetEnumerator, (app::List_1_WaterPoisonTrail_DamagePoint_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02C22570, IEnumerator_1_WaterPoisonTrail_DamagePoint_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_WaterPoisonTrail_DamagePoint_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02C22570, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_WaterPoisonTrail_DamagePoint_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_WaterPoisonTrail_DamagePoint_ *, GetRange, (app::List_1_WaterPoisonTrail_DamagePoint_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, WaterPoisonTrail_DamagePoint__Array *, ToArray, (app::List_1_WaterPoisonTrail_DamagePoint_ * this_ptr));
