...
IL2CPP_REGISTER_METHOD(0x00A183F0, String *, get_StressTestName, (app::LegacyDamageReciever * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00736620, StressTestStatus__Enum, get_StressTestStatus, (app::LegacyDamageReciever * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A18A20, void, __ctor, (app::LegacyDamageReciever * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::LegacyDamageReciever * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::LegacyDamageReciever * this_ptr));
}
