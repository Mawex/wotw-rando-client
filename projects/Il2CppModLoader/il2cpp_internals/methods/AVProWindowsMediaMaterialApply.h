...
IL2CPP_REGISTER_METHOD(0x0312DE60, void, ApplyMapping, (AVProWindowsMediaMaterialApply * __this, Texture * texture));
IL2CPP_REGISTER_METHOD(0x0312DF70, void, OnDisable, (AVProWindowsMediaMaterialApply * __this));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (AVProWindowsMediaMaterialApply * __this));
}
