...
namespace app::methods::System_Data::DataViewManager {
IL2CPP_REGISTER_METHOD(0x01F49040, void, __ctor, (app::DataViewManager * this_ptr, app::DataSet * data_set, bool locked));
IL2CPP_REGISTER_METHOD(0x002FBB00, DataSet *, get_DataSet, (app::DataViewManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB950, DataViewSettingCollection *, get_DataViewSettings, (app::DataViewManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F49590, IEnumerator *, IEnumerable_GetEnumerator, (app::DataViewManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417920, int32_t, ICollection_get_Count, (app::DataViewManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x004C50A0, Object *, ICollection_get_SyncRoot, (app::DataViewManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB990, Object *, IList_get_Item, (app::DataViewManager * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x01F49970, Object *, IBindingList_AddNew, (app::DataViewManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F49AD0, PropertyDescriptor *, IBindingList_get_SortProperty, (app::DataViewManager * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04721418, DataViewManager_System_ComponentModel_IBindingList_get_SortProperty__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01F49B80, ListSortDirection__Enum, IBindingList_get_SortDirection, (app::DataViewManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F4A020, String *, ITypedList_GetListName, (app::DataViewManager * this_ptr, app::PropertyDescriptor__Array * list_accessors));
IL2CPP_REGISTER_METHODINFO(0x04782310, DataViewManager_System_ComponentModel_ITypedList_GetListName__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01F4A130, PropertyDescriptorCollection *, ITypedList_GetItemProperties, (app::DataViewManager * this_ptr, app::PropertyDescriptor__Array * list_accessors));
IL2CPP_REGISTER_METHODINFO(0x0476D358, DataViewManager_System_ComponentModel_ITypedList_GetItemProperties__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01F4A3C0, DataView *, CreateDataView, (app::DataViewManager * this_ptr, app::DataTable * table));
