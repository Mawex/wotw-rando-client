...
namespace app::methods::Core::Ambience_Layer {
    ...
    IL2CPP_REGISTER_METHOD(0x011F79A0, void, __ctor, (app::Ambience_Layer * this_ptr, app::SoundProvider * sound_provider, float fade_in_duration, float fade_out_duration, int32_t priority, app::AmbienceZone * ambience_zone, app::AkCurveInterpolation__Enum fade_type));
