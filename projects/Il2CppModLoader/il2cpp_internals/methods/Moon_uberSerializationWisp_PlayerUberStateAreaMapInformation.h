...
namespace app::methods::Moon_uberSerializationWisp::PlayerUberStateAreaMapInformation {
...
IL2CPP_REGISTER_METHOD(0x00F35DC0, void, __ctor, (app::PlayerUberStateAreaMapInformation * this_ptr, app::PlayerUberStateDescriptor * desc, app::Action * dirty_call_back));
...
IL2CPP_REGISTER_METHOD(0x00F36860, WorldMapAreaState__Enum, GetAreaState, (app::PlayerUberStateAreaMapInformation * this_ptr, app::GameWorldAreaID__Enum area_i_d, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x00F36E40, Dictionary_2_System_Int32_WorldMapAreaState_ *, GetAreaStates, (app::PlayerUberStateAreaMapInformation * this_ptr, app::GameWorldAreaID__Enum area_i_d));
...
IL2CPP_REGISTER_METHOD(0x00F37270, PlayerUberStateAreaMapInformation_MapTrailEntry *, GetTrailEntryContainingPoint, (app::PlayerUberStateAreaMapInformation * this_ptr, app::Vector2 point, app::int32_t * index));
IL2CPP_REGISTER_METHOD(0x002FB930, List_1_Moon_uberSerializationWisp_PlayerUberStateAreaMapInformation_MapTrailEntry_ *, GetTrailPoints, (app::PlayerUberStateAreaMapInformation * this_ptr));
