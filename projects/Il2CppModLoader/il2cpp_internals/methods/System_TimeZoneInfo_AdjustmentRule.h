...
IL2CPP_REGISTER_METHOD(0x002FA280, DateTime, get_DateStart, (app::TimeZoneInfo_AdjustmentRule * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, DateTime, get_DateEnd, (app::TimeZoneInfo_AdjustmentRule * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB950, TimeSpan, get_DaylightDelta, (app::TimeZoneInfo_AdjustmentRule * this_ptr));
IL2CPP_REGISTER_METHOD(0x027B9780, TimeZoneInfo_TransitionTime, get_DaylightTransitionStart, (app::TimeZoneInfo_AdjustmentRule * this_ptr));
IL2CPP_REGISTER_METHOD(0x027B97A0, TimeZoneInfo_TransitionTime, get_DaylightTransitionEnd, (app::TimeZoneInfo_AdjustmentRule * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_1, (app::TimeZoneInfo_AdjustmentRule * this_ptr));
IL2CPP_REGISTER_METHOD(0x027B99A0, TimeZoneInfo_AdjustmentRule *, CreateAdjustmentRule_1, (app::DateTime date_start, app::DateTime date_end, app::TimeSpan daylight_delta, app::TimeZoneInfo_TransitionTime daylight_transition_start, app::TimeZoneInfo_TransitionTime daylight_transition_end));
IL2CPP_REGISTER_METHOD(0x027B9BE0, TimeZoneInfo_AdjustmentRule *, CreateAdjustmentRule_2, (app::DateTime date_start, app::DateTime date_end, app::TimeSpan daylight_delta, app::TimeZoneInfo_TransitionTime daylight_transition_start, app::TimeZoneInfo_TransitionTime daylight_transition_end, app::TimeSpan base_utc_offset_delta));
...
IL2CPP_REGISTER_METHOD(0x027BA380, void, __ctor_2, (app::TimeZoneInfo_AdjustmentRule * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
