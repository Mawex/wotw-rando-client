...
namespace app::methods::Microsoft_Applications_Events_DataModels::CsEvent {
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_ver, (app::CsEvent * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_ver, (app::CsEvent * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_name, (app::CsEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_iKey, (app::CsEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9D0, String *, get_cV, (app::CsEvent * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9E0, void, set_cV, (app::CsEvent * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB9F0, List_1_Microsoft_Applications_Events_DataModels_Ingest_ *, get_extIngest, (app::CsEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB40, List_1_Microsoft_Applications_Events_DataModels_Protocol_ *, get_extProtocol, (app::CsEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB60, List_1_Microsoft_Applications_Events_DataModels_User_ *, get_extUser, (app::CsEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB80, List_1_Microsoft_Applications_Events_DataModels_Device_ *, get_extDevice, (app::CsEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBA0, List_1_Microsoft_Applications_Events_DataModels_Os_ *, get_extOs, (app::CsEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBC0, List_1_Microsoft_Applications_Events_DataModels_App_ *, get_extApp, (app::CsEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBE0, List_1_Microsoft_Applications_Events_DataModels_Utc_ *, get_extUtc, (app::CsEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC00, List_1_Microsoft_Applications_Events_DataModels_Xbl_ *, get_extXbl, (app::CsEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC20, List_1_Microsoft_Applications_Events_DataModels_Javascript_ *, get_extJavascript, (app::CsEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC40, List_1_Microsoft_Applications_Events_DataModels_Receipts_ *, get_extReceipts, (app::CsEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC60, List_1_Microsoft_Applications_Events_DataModels_Net_ *, get_extNet, (app::CsEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC80, List_1_Microsoft_Applications_Events_DataModels_Sdk_ *, get_extSdk, (app::CsEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBCA0, List_1_Microsoft_Applications_Events_DataModels_Loc_ *, get_extLoc, (app::CsEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBCC0, List_1_Microsoft_Applications_Events_DataModels_Cloud_ *, get_extCloud, (app::CsEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBCE0, List_1_Microsoft_Applications_Events_DataModels_Data_ *, get_ext, (app::CsEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBD00, Dictionary_2_System_String_System_String_ *, get_tags, (app::CsEvent * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD10, void, set_tags, (app::CsEvent * this_ptr, app::Dictionary_2_System_String_System_String_ * value));
IL2CPP_REGISTER_METHOD(0x002FBD20, String *, get_baseType, (app::CsEvent * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD30, void, set_baseType, (app::CsEvent * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBD40, List_1_Microsoft_Applications_Events_DataModels_Data_ *, get_baseData, (app::CsEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBD60, List_1_Microsoft_Applications_Events_DataModels_Data_ *, get_data, (app::CsEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBD80, void, __ctor_1, (app::CsEvent * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBE10, void, __ctor_2, (app::CsEvent * this_ptr, app::String * full_name, app::String * name));
