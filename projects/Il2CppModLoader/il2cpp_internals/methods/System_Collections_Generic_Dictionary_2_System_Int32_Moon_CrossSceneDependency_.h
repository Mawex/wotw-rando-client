...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_Int32_Moon_CrossSceneDependency_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_System_Int32_Moon_CrossSceneDependency_ * this_ptr));
