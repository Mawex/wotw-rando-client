...
namespace app::methods::System_Collections_Specialized::NameObjectCollectionBase_NameObjectKeysEnumerator {
IL2CPP_REGISTER_METHOD(0x02499460, void, __ctor, (app::NameObjectCollectionBase_NameObjectKeysEnumerator * this_ptr, app::NameObjectCollectionBase * coll));
...
IL2CPP_REGISTER_METHOD(0x024996A0, Object *, get_Current, (app::NameObjectCollectionBase_NameObjectKeysEnumerator * this_ptr));
