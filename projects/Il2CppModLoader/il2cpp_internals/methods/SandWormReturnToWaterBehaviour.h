...
IL2CPP_REGISTER_METHOD(0x00C23E30, BehaviourStatus__Enum, OnExecute, (app::SandWormReturnToWaterBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00C24CC0, void, __ctor, (app::SandWormReturnToWaterBehaviour * this_ptr));
}
