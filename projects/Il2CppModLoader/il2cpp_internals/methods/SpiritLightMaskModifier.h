...
IL2CPP_REGISTER_METHOD(0x00D62090, IEnumerable_1_System_String_ *, GetKeywordsForShader, (app::SpiritLightMaskModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D62370, void, __ctor, (app::SpiritLightMaskModifier * this_ptr));
}
