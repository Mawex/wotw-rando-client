...
namespace app::methods::Moon_Timeline_Systems::ReplayFastForwardSystem {
IL2CPP_REGISTER_METHOD(0x00417920, UpdateType__Enum, get_UpdateType, (app::ReplayFastForwardSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D093A0, void, __ctor, (app::ReplayFastForwardSystem * this_ptr));
}
