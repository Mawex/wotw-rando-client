...
namespace app::methods::System_Collections_Generic::List_1_Moon_UI_TextBoxLine_ {
...
IL2CPP_REGISTER_METHOD(0x02DE4ED0, TextBoxLine_1, get_Item, (app::List_1_Moon_UI_TextBoxLine_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_Moon_UI_TextBoxLine_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0470E1E8, List_1_Moon_UI_TextBoxLine___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_Moon_UI_TextBoxLine_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02E035F0, void, __ctor_3, (app::List_1_Moon_UI_TextBoxLine_ * this_ptr, app::IEnumerable_1_Moon_UI_TextBoxLine_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02E03A80, Object *, ICollection_get_SyncRoot, (app::List_1_Moon_UI_TextBoxLine_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02DE5090, Object *, IList_get_Item, (app::List_1_Moon_UI_TextBoxLine_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_Moon_UI_TextBoxLine_ *, AsReadOnly, (app::List_1_Moon_UI_TextBoxLine_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02DE59C0, TextBoxLine_1, Find, (app::List_1_Moon_UI_TextBoxLine_ * this_ptr, app::Predicate_1_Moon_UI_TextBoxLine_ * match));
IL2CPP_REGISTER_METHOD(0x02DE5B10, List_1_Moon_UI_TextBoxLine_ *, FindAll, (app::List_1_Moon_UI_TextBoxLine_ * this_ptr, app::Predicate_1_Moon_UI_TextBoxLine_ * match));
...
IL2CPP_REGISTER_METHOD(0x02DE6050, List_1_T_Enumerator_Moon_UI_TextBoxLine_, GetEnumerator, (app::List_1_Moon_UI_TextBoxLine_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02DE60A0, IEnumerator_1_Moon_UI_TextBoxLine_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_Moon_UI_TextBoxLine_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02DE60A0, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_Moon_UI_TextBoxLine_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_Moon_UI_TextBoxLine_ *, GetRange, (app::List_1_Moon_UI_TextBoxLine_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, TextBoxLine_1__Array *, ToArray, (app::List_1_Moon_UI_TextBoxLine_ * this_ptr));
