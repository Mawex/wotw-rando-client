...
namespace app::methods::TriangleNet_Voronoi_Legacy::VoronoiRegion {
IL2CPP_REGISTER_METHOD(0x002FC6D0, int32_t, get_ID, (app::VoronoiRegion * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, Point *, get_Generator, (app::VoronoiRegion * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB950, ICollection_1_TriangleNet_Geometry_Point_ *, get_Vertices, (app::VoronoiRegion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AAE280, void, __ctor, (app::VoronoiRegion * this_ptr, app::Vertex * generator));
...
IL2CPP_REGISTER_METHOD(0x02AAE630, VoronoiRegion *, GetNeighbor, (app::VoronoiRegion * this_ptr, app::Point * p));
IL2CPP_REGISTER_METHOD(0x02AAE730, void, AddNeighbor, (app::VoronoiRegion * this_ptr, int32_t id, app::VoronoiRegion * neighbor));
IL2CPP_REGISTER_METHOD(0x02AAE7F0, String *, ToString, (app::VoronoiRegion * this_ptr));
}
