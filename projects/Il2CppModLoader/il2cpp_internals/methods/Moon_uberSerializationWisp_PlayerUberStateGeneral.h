...
namespace app::methods::Moon_uberSerializationWisp::PlayerUberStateGeneral {
IL2CPP_REGISTER_METHOD(0x007EC230, Vector3, get_WorldPosition, (app::PlayerUberStateGeneral * this_ptr));
IL2CPP_REGISTER_METHOD(0x00F39440, void, set_WorldPosition, (app::PlayerUberStateGeneral * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x007EC230, Vector3, get_FastWorldPosition, (app::PlayerUberStateGeneral * this_ptr));
IL2CPP_REGISTER_METHOD(0x009C51C0, void, set_FastWorldPosition, (app::PlayerUberStateGeneral * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x005C3FF0, GameWorldAreaID__Enum, get_AreaID, (app::PlayerUberStateGeneral * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F39530, void, __ctor, (app::PlayerUberStateGeneral * this_ptr, app::Action * set_dirty_callback));
