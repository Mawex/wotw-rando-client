...
IL2CPP_REGISTER_METHOD(0x0313C330, UpdateManager *, CreateManager, (app::MoonDriver * this_ptr, app::UpdateType__Enum update_type));
...
IL2CPP_REGISTER_METHOD(0x0313C650, void, GetEntryCounts, (app::MoonDriver * this_ptr, app::int32_t * update_manager_count, app::int32_t * fixed_update_manager_count, app::int32_t * late_update_manager_count));
...
IL2CPP_REGISTER_METHOD(0x0313C890, void, __ctor, (app::MoonDriver * this_ptr));
