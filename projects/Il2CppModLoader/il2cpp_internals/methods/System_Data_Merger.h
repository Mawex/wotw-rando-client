...
namespace app::methods::System_Data::Merger {
IL2CPP_REGISTER_METHOD(0x01E40FC0, void, __ctor_1, (app::Merger * this_ptr, app::DataSet * data_set, bool preserve_changes, app::MissingSchemaAction__Enum missing_schema_action));
IL2CPP_REGISTER_METHOD(0x01E40FE0, void, __ctor_2, (app::Merger * this_ptr, app::DataTable * data_table, bool preserve_changes, app::MissingSchemaAction__Enum missing_schema_action));
...
IL2CPP_REGISTER_METHOD(0x01E425E0, DataTable *, MergeSchema, (app::Merger * this_ptr, app::DataTable * table));
...
IL2CPP_REGISTER_METHOD(0x01E442B0, DataKey, GetSrcKey, (app::Merger * this_ptr, app::DataTable * src, app::DataTable * dst));
}
