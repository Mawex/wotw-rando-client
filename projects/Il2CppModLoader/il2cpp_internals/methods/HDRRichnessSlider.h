...
IL2CPP_REGISTER_METHOD(0x0109BA60, String *, GetValueToDisplay, (app::HDRRichnessSlider * this_ptr));
IL2CPP_REGISTER_METHOD(0x00444040, void, __ctor, (app::HDRRichnessSlider * this_ptr));
}
