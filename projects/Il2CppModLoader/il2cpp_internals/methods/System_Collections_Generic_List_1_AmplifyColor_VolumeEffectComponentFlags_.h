...
namespace app::methods::System_Collections_Generic::List_1_AmplifyColor_VolumeEffectComponentFlags_ {
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_AmplifyColor_VolumeEffectComponentFlags_, GetEnumerator, (app::List_1_AmplifyColor_VolumeEffectComponentFlags_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04734568, List_1_AmplifyColor_VolumeEffectComponentFlags__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EFC50, VolumeEffectComponentFlags *, get_Item, (app::List_1_AmplifyColor_VolumeEffectComponentFlags_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_AmplifyColor_VolumeEffectComponentFlags_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04785658, List_1_AmplifyColor_VolumeEffectComponentFlags___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F05A0, VolumeEffectComponentFlags *, Find, (app::List_1_AmplifyColor_VolumeEffectComponentFlags_ * this_ptr, app::Predicate_1_AmplifyColor_VolumeEffectComponentFlags_ * match));
