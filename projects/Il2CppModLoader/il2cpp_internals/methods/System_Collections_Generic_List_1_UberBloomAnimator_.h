...
namespace app::methods::System_Collections_Generic::List_1_UberBloomAnimator_ {
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_UberBloomAnimator_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04706DB8, List_1_UberBloomAnimator___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EFC50, UberBloomAnimator *, get_Item, (app::List_1_UberBloomAnimator_ * this_ptr, int32_t index));
