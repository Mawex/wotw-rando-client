...
IL2CPP_REGISTER_METHOD(0x03132B70, Color, get_startColor, (app::ParticleSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0238D4F0, ParticleSystem_MainModule, get_main, (app::ParticleSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x0238D4F0, ParticleSystem_EmissionModule, get_emission, (app::ParticleSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x0238D4F0, ParticleSystem_ShapeModule, get_shape, (app::ParticleSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x0238D4F0, ParticleSystem_VelocityOverLifetimeModule, get_velocityOverLifetime, (app::ParticleSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x0238D4F0, ParticleSystem_ForceOverLifetimeModule, get_forceOverLifetime, (app::ParticleSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x0238D4F0, ParticleSystem_ColorOverLifetimeModule, get_colorOverLifetime, (app::ParticleSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x0238D4F0, ParticleSystem_CollisionModule, get_collision, (app::ParticleSystem * this_ptr));
