...
IL2CPP_REGISTER_METHOD(0x015B8B20, LeaderboardTableUI_LeaderboardMetaData *, get_CurrentMetaData, (app::LeaderboardTableUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x015B8C90, LeaderboardRowUI *, GetRowByIndex, (app::LeaderboardTableUI * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x015B9CD0, void, __ctor, (app::LeaderboardTableUI * this_ptr));
