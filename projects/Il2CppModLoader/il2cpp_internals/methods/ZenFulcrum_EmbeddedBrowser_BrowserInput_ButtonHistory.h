...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::BrowserInput_ButtonHistory {
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::BrowserInput_ButtonHistory * this_ptr));
}
