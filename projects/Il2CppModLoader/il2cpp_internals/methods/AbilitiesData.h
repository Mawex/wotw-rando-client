...
namespace app::methods::AbilitiesData {
    IL2CPP_REGISTER_METHOD(0x004AB2B0, RecorderFrame_FrameDataTypes__Enum, FrameType, (app::AbilitiesData * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::AbilitiesData * this_ptr));
} // namespace app::methods::AbilitiesData
