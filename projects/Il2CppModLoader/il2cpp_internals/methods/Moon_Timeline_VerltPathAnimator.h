...
namespace app::methods::Moon_Timeline::VerltPathAnimator {
IL2CPP_REGISTER_METHOD(0x002FBC20, MoonReference_1_UnityEngine_Transform_ *, GetTransformTarget, (app::VerltPathAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D1D2E0, Transform *, get_EffectiveTransform, (app::VerltPathAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D1D480, void, __ctor, (app::VerltPathAnimator * this_ptr));
}
