...
IL2CPP_REGISTER_METHOD(0x02306340, IMessage *, SyncProcessMessage, (app::DisposerReplySink * this_ptr, app::IMessage * msg));
IL2CPP_REGISTER_METHOD(0x02306400, IMessageCtrl *, AsyncProcessMessage, (app::DisposerReplySink * this_ptr, app::IMessage * msg, app::IMessageSink * reply_sink));
