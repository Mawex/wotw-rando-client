...
IL2CPP_REGISTER_METHOD(0x001311C0, String *, ToString, (app::HSteamPipe__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006CE970, HSteamPipe, operator__1, (int32_t value));
