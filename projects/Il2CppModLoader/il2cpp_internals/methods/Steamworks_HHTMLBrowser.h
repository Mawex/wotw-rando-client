...
IL2CPP_REGISTER_METHOD(0x0012ECC0, String *, ToString, (app::HHTMLBrowser__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006CE970, HHTMLBrowser, operator__1, (uint32_t value));
