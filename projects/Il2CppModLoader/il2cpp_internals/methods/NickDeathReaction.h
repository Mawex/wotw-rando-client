...
IL2CPP_REGISTER_METHOD(0x005FCC40, NickDeathReaction_DeathState__Enum, GetNextOnHitGroundState, (app::NickDeathReaction * this_ptr));
IL2CPP_REGISTER_METHOD(0x005FCC70, void, OnEnterTask, (app::NickDeathReaction * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x005FCDF0, BehaviourStatus__Enum, OnExecuteTask, (app::NickDeathReaction * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x005FD940, Vector3, ProcessRootMotion, (app::NickDeathReaction * this_ptr, app::Vector3 motion));
IL2CPP_REGISTER_METHOD(0x005FD990, void, __ctor, (app::NickDeathReaction * this_ptr));
}
