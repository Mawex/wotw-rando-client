...
IL2CPP_REGISTER_METHOD(0x027644B0, Material *, get_material, (app::CameraFilterPack_Blur_BlurHole * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02764F00, void, __ctor, (app::CameraFilterPack_Blur_BlurHole * this_ptr));
}
