...
namespace app::methods::System_Data::RecordManager {
IL2CPP_REGISTER_METHOD(0x01E49910, void, __ctor, (app::RecordManager * this_ptr, app::DataTable * table));
...
IL2CPP_REGISTER_METHOD(0x01E4A0E0, void, FreeRecord, (app::RecordManager * this_ptr, app::int32_t * record));
IL2CPP_REGISTER_METHOD(0x01E4A310, void, Clear, (app::RecordManager * this_ptr, bool clear_all));
IL2CPP_REGISTER_METHOD(0x01E4A710, DataRow *, get_Item, (app::RecordManager * this_ptr, int32_t record));
