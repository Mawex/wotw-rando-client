...
namespace app::methods::UnityStandardAssets_ImageEffects::NoiseAndScratches {
IL2CPP_REGISTER_METHOD(0x02D5C780, void, Start, (app::NoiseAndScratches * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D5C9C0, Material *, get_material, (app::NoiseAndScratches * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D5D850, void, __ctor, (app::NoiseAndScratches * this_ptr));
}
