...
namespace app::methods::Archive {
    IL2CPP_REGISTER_METHOD(0x002FA280, MemoryStream*, get_MemoryStream, (app::Archive * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005082A0, void, set_MemoryStream, (app::Archive * this_ptr, app::MemoryStream* value));
    IL2CPP_REGISTER_METHOD(0x00508510, void, __ctor, (app::Archive * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00508940, void, Serialize_1, (app::Archive * this_ptr, app::float* value));
    IL2CPP_REGISTER_METHOD(0x00508960, void, Serialize_2, (app::Archive * this_ptr, app::int32_t* value));
    IL2CPP_REGISTER_METHOD(0x005089E0, void, Serialize_3, (app::Archive * this_ptr, app::bool* value));
    ...
    IL2CPP_REGISTER_METHOD(0x00508DD0, String*, Serialize_11, (app::Archive * this_ptr, app::String* value));
    IL2CPP_REGISTER_METHOD(0x00508E30, Vector2, Serialize_12, (app::Archive * this_ptr, app::Vector2 value));
    IL2CPP_REGISTER_METHOD(0x00508E80, Vector3, Serialize_13, (app::Archive * this_ptr, app::Vector3 value));
    IL2CPP_REGISTER_METHOD(0x00508F30, Quaternion, Serialize_14, (app::Archive * this_ptr, app::Quaternion value));
    IL2CPP_REGISTER_METHOD(0x002FA000, void, SerializeVersion, (app::Archive * this_ptr, app::int32_t* version));
} // namespace app::methods::Archive
