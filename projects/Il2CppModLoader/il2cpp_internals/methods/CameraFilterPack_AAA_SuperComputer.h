...
IL2CPP_REGISTER_METHOD(0x0273C630, Material *, get_material, (app::CameraFilterPack_AAA_SuperComputer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0273D260, void, __ctor, (app::CameraFilterPack_AAA_SuperComputer * this_ptr));
