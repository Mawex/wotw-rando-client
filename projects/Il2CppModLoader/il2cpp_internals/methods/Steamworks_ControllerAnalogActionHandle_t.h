...
IL2CPP_REGISTER_METHOD(0x0012F1B0, String *, ToString, (app::ControllerAnalogActionHandle_t__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, ControllerAnalogActionHandle_t, operator__1, (uint64_t value));
