...
namespace app::methods::usedStandaloneScripts_DeltaTimeManagers::DeltaTimeManager {
...
IL2CPP_REGISTER_METHOD(0x006410F0, DeltaTimeManager_ControllerType__Enum, get_Controller, (app::DeltaTimeManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03124640, DeltaTimeManager_DeltaTimeFrameHistory *, GetHistoricFrame, (app::DeltaTimeManager * this_ptr, int32_t frames_in_past));
...
IL2CPP_REGISTER_METHOD(0x03124F30, void, __ctor, (app::DeltaTimeManager * this_ptr));
