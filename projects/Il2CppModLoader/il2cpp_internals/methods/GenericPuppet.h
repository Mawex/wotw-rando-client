...
namespace app::methods::GenericPuppet {
    ...
    IL2CPP_REGISTER_METHOD(0x00E08840, GhostGenericResourceAttribute*, GetGhostGenericResourceAttributeForFieldWithValue, (app::GenericPuppet * this_ptr, app::Object* obj));
    ...
    IL2CPP_REGISTER_METHOD(0x00E09B70, SoundPlayer*, PlaySoundHelper, (app::GenericPuppet * this_ptr, app::SoundDescriptor* sound, bool attach, float volume, app::SoundHost* host));
    ...
    IL2CPP_REGISTER_METHOD(0x00E09F00, Object_1*, Instantiate, (app::GenericPuppet * this_ptr, app::GameObject* prefab, app::Vector3 position, app::Quaternion rotation, bool record));
    ...
    IL2CPP_REGISTER_METHOD(0x00E0B270, ActiveAnimationHandle, PlayAnimationIndexed, (app::GenericPuppet * this_ptr, app::MoonAnimation__Array* animations, int32_t index, int32_t priority, app::Func_1_Boolean_* condition, app::Action* on_start, app::Action* on_stop));
    ...
    IL2CPP_REGISTER_METHOD(0x00E0C460, ActiveAnimationHandle, PlayAnimation, (app::GenericPuppet * this_ptr, app::MoonAnimation* animation, int32_t priority, app::Func_1_Boolean_* condition, app::Action* on_start, app::Action* on_stop, bool force_play_from_start, float speed, app::Nullable_1_Moon_MoonAnimatorLayerName_ layer_name));
    IL2CPP_REGISTER_METHOD(0x00E0CC70, ActiveAnimationHandle, GetActiveAnimation, (app::GenericPuppet * this_ptr, app::MoonAnimation* animation));
    ...
    IL2CPP_REGISTER_METHOD(0x00E0DDA0, MoonAnimation*, GetAnimationFromID, (app::GenericPuppet * this_ptr, int32_t resource_id, int32_t array_index));
    ...
    IL2CPP_REGISTER_METHOD(0x00E0E3C0, FloatAnimationParameter*, GetAnimationParameterValueById, (app::GenericPuppet * this_ptr, int32_t resource_id));
    IL2CPP_REGISTER_METHOD(0x00E0E530, MoonTimeline*, GetMoonTimelineById, (app::GenericPuppet * this_ptr, int32_t resource_id));
    IL2CPP_REGISTER_METHOD(0x00E0E6A0, ParticleSystem*, GetParticleSystemById, (app::GenericPuppet * this_ptr, int32_t resource_id));
    IL2CPP_REGISTER_METHOD(0x00E0E800, Transform*, GetTransformById, (app::GenericPuppet * this_ptr, int32_t resource_id));
    ...
    IL2CPP_REGISTER_METHOD(0x00E0F240, FieldInfo_1__Array*, get_Fields, (app::GenericPuppet * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBBE0, ISoundHost*, get_SoundHost, (app::GenericPuppet * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBBF0, void, set_SoundHost, (app::GenericPuppet * this_ptr, app::ISoundHost* value));
    IL2CPP_REGISTER_METHOD(0x00E0F290, Object__Array*, FieldInfoAttributes, (app::GenericPuppet * this_ptr, app::FieldInfo_1* fi));
    IL2CPP_REGISTER_METHOD(0x00E0F420, FieldInfo_1*, FieldFromResourceID, (app::GenericPuppet * this_ptr, int32_t resource_id));
    IL2CPP_REGISTER_METHOD(0x00E0F710, FieldInfo_1*, FieldByValue, (app::GenericPuppet * this_ptr, app::Object* obj));
    IL2CPP_REGISTER_METHOD(0x00E0F810, FieldInfo_1*, FieldFromPlayerID, (app::GenericPuppet * this_ptr, int32_t player_id));
    IL2CPP_REGISTER_METHOD(0x00E0FA00, void, __ctor, (app::GenericPuppet * this_ptr));
