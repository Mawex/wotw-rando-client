...
IL2CPP_REGISTER_METHOD(0x00FB7030, PlayerLoopSystem, FilterLoopSubsytems, (app::PlayerLoopSystem root, app::Type__Array * types));
...
IL2CPP_REGISTER_METHOD(0x00FB8E40, String *, ParseArgument, (app::String * flag));
IL2CPP_REGISTER_METHOD(0x00FB9260, bool, ToggleBoolBasedOnCommandline, (app::String * cmdline_arg, app::bool * bool_to_toggle));
IL2CPP_REGISTER_METHOD(0x00FB93A0, IEnumerator *, Start, (app::LoadingBootstrap * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FBA790, IEnumerator *, OnEndOfFrame, (app::LoadingBootstrap * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FBDC40, void, __ctor, (app::LoadingBootstrap * this_ptr));
