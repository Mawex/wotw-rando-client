...
IL2CPP_REGISTER_METHOD(0x0057AAC0, SuspendableMask__Enum, get_Mask, (app::WindZoneVisualizer * this_ptr));
IL2CPP_REGISTER_METHOD(0x0057AAD0, void, set_Mask, (app::WindZoneVisualizer * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x0057AB80, void, __ctor, (app::WindZoneVisualizer * this_ptr));
}
