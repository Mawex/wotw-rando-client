...
IL2CPP_REGISTER_METHOD(0x011B2160, BehaviourStatus__Enum, OnExecute, (app::SpiderBossLaserAttackHorizontal * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x011B1480, void, __ctor, (app::SpiderBossLaserAttackHorizontal * this_ptr));
}
