...
namespace app::methods::WaitAction {
    ...
    IL2CPP_REGISTER_METHOD(0x008C48F0, String*, GetNiceName, (app::WaitAction * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00608710, SuspendableMask__Enum, get_Mask, (app::WaitAction * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00608720, void, set_Mask, (app::WaitAction * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x00420EE0, UpdateType__Enum, get_UpdateType, (app::WaitAction * this_ptr));
    IL2CPP_REGISTER_METHOD(0x008C5500, void, __ctor, (app::WaitAction * this_ptr));
} // namespace app::methods::WaitAction
