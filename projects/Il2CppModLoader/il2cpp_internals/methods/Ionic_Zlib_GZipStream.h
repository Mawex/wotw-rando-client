...
IL2CPP_REGISTER_METHOD(0x002FBB60, String *, get_Comment, (app::GZipStream_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB40, String *, get_FileName, (app::GZipStream_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0306E080, Byte__Array *, CompressBuffer, (app::Byte__Array * b));
IL2CPP_REGISTER_METHOD(0x0306E380, Byte__Array *, UncompressBuffer, (app::Byte__Array * compressed));
