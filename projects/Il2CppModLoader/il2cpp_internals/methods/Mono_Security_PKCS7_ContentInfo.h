...
namespace app::methods::Mono_Security::PKCS7_ContentInfo {
...
IL2CPP_REGISTER_METHOD(0x025DA200, ASN1 *, get_ASN1_1, (app::PKCS7_ContentInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, ASN1 *, get_Content_1, (app::PKCS7_ContentInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_Content_1, (app::PKCS7_ContentInfo * this_ptr, app::ASN1 * value));
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_ContentType_1, (app::PKCS7_ContentInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_ContentType_1, (app::PKCS7_ContentInfo * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x025DA210, ASN1 *, GetASN1_1, (app::PKCS7_ContentInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A47B50, ASN1_1 *, get_ASN1_2, (app::PKCS7_ContentInfo_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, ASN1_1 *, get_Content_2, (app::PKCS7_ContentInfo_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_Content_2, (app::PKCS7_ContentInfo_1 * this_ptr, app::ASN1_1 * value));
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_ContentType_2, (app::PKCS7_ContentInfo_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_ContentType_2, (app::PKCS7_ContentInfo_1 * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x02A47B60, ASN1_1 *, GetASN1_2, (app::PKCS7_ContentInfo_1 * this_ptr));
}
