...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::Rigidbody * this_ptr));
IL2CPP_REGISTER_METHOD(0x030ABAC0, Vector3, get_velocity, (app::Rigidbody * this_ptr));
IL2CPP_REGISTER_METHOD(0x030ABB40, void, set_velocity, (app::Rigidbody * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x030ABBA0, Vector3, get_angularVelocity, (app::Rigidbody * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030AC260, RigidbodyConstraints__Enum, get_constraints, (app::Rigidbody * this_ptr));
IL2CPP_REGISTER_METHOD(0x030AC2B0, void, set_constraints, (app::Rigidbody * this_ptr, app::RigidbodyConstraints__Enum value));
IL2CPP_REGISTER_METHOD(0x030AC310, CollisionDetectionMode__Enum, get_collisionDetectionMode, (app::Rigidbody * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030AC3C0, Vector3, get_centerOfMass, (app::Rigidbody * this_ptr));
IL2CPP_REGISTER_METHOD(0x030AC440, void, set_centerOfMass, (app::Rigidbody * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x030AC4A0, Vector3, get_worldCenterOfMass, (app::Rigidbody * this_ptr));
IL2CPP_REGISTER_METHOD(0x030AC520, Quaternion, get_inertiaTensorRotation, (app::Rigidbody * this_ptr));
IL2CPP_REGISTER_METHOD(0x030AC5A0, void, set_inertiaTensorRotation, (app::Rigidbody * this_ptr, app::Quaternion value));
IL2CPP_REGISTER_METHOD(0x030AC600, Vector3, get_inertiaTensor, (app::Rigidbody * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030AC790, Vector3, get_position, (app::Rigidbody * this_ptr));
IL2CPP_REGISTER_METHOD(0x030AC810, void, set_position, (app::Rigidbody * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x030AC870, Quaternion, get_rotation, (app::Rigidbody * this_ptr));
IL2CPP_REGISTER_METHOD(0x030AC8F0, void, set_rotation, (app::Rigidbody * this_ptr, app::Quaternion value));
IL2CPP_REGISTER_METHOD(0x030AC950, RigidbodyInterpolation__Enum, get_interpolation, (app::Rigidbody * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030ACE60, Vector3, GetRelativePointVelocity, (app::Rigidbody * this_ptr, app::Vector3 relative_point));
IL2CPP_REGISTER_METHOD(0x030ACEF0, Vector3, GetPointVelocity, (app::Rigidbody * this_ptr, app::Vector3 world_point));
...
IL2CPP_REGISTER_METHOD(0x030ADC00, void, Internal_ClosestPointOnBounds, (app::Rigidbody * this_ptr, app::Vector3 point, app::Vector3 * out_pos, app::float * distance));
IL2CPP_REGISTER_METHOD(0x030ADC80, Vector3, ClosestPointOnBounds, (app::Rigidbody * this_ptr, app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x030ADDD0, RaycastHit, SweepTest_1, (app::Rigidbody * this_ptr, app::Vector3 direction, float max_distance, app::QueryTriggerInteraction__Enum query_trigger_interaction, app::bool * has_hit));
...
IL2CPP_REGISTER_METHOD(0x030AE110, RaycastHit__Array *, Internal_SweepTestAll, (app::Rigidbody * this_ptr, app::Vector3 direction, float max_distance, app::QueryTriggerInteraction__Enum query_trigger_interaction));
IL2CPP_REGISTER_METHOD(0x030AE190, RaycastHit__Array *, SweepTestAll_1, (app::Rigidbody * this_ptr, app::Vector3 direction, float max_distance, app::QueryTriggerInteraction__Enum query_trigger_interaction));
IL2CPP_REGISTER_METHOD(0x030AE310, RaycastHit__Array *, SweepTestAll_2, (app::Rigidbody * this_ptr, app::Vector3 direction, float max_distance));
IL2CPP_REGISTER_METHOD(0x030AE340, RaycastHit__Array *, SweepTestAll_3, (app::Rigidbody * this_ptr, app::Vector3 direction));
...
IL2CPP_REGISTER_METHOD(0x030AF350, void, Internal_ClosestPointOnBounds_Injected, (app::Rigidbody * this_ptr, app::Vector3 * point, app::Vector3 * out_pos, app::float * distance));
IL2CPP_REGISTER_METHOD(0x030AF3D0, void, SweepTest_Injected, (app::Rigidbody * this_ptr, app::Vector3 * direction, float max_distance, app::QueryTriggerInteraction__Enum query_trigger_interaction, app::bool * has_hit, app::RaycastHit * ret));
IL2CPP_REGISTER_METHOD(0x030AF460, RaycastHit__Array *, Internal_SweepTestAll_Injected, (app::Rigidbody * this_ptr, app::Vector3 * direction, float max_distance, app::QueryTriggerInteraction__Enum query_trigger_interaction));
}
