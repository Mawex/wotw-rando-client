...
IL2CPP_REGISTER_METHOD(0x00C9F580, void, __ctor, (app::EntityPlatformingMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::EntityPlatformingMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::EntityPlatformingMovement * this_ptr));
}
