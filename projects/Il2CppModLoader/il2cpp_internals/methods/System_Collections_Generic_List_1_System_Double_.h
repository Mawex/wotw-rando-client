...
namespace app::methods::System_Collections_Generic::List_1_System_Double_ {
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_System_Double_, GetEnumerator, (app::List_1_System_Double_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0474CB60, List_1_System_Double__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_System_Double_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_System_Double_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02EF58C0, void, __ctor_3, (app::List_1_System_Double_ * this_ptr, app::IEnumerable_1_System_Double_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02EF5D40, Object *, ICollection_get_SyncRoot, (app::List_1_System_Double_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02EF6000, Object *, IList_get_Item, (app::List_1_System_Double_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_System_Double_ *, AsReadOnly, (app::List_1_System_Double_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02EF68F0, List_1_System_Double_ *, FindAll, (app::List_1_System_Double_ * this_ptr, app::Predicate_1_Double_ * match));
...
IL2CPP_REGISTER_METHOD(0x025F0B50, IEnumerator_1_System_Double_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_System_Double_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025F0B50, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_System_Double_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_System_Double_ *, GetRange, (app::List_1_System_Double_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, Double__Array *, ToArray, (app::List_1_System_Double_ * this_ptr));
