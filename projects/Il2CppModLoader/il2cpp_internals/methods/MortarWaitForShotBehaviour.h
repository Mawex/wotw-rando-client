...
IL2CPP_REGISTER_METHOD(0x0147F8C0, BehaviourStatus__Enum, OnExecute, (app::MortarWaitForShotBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00F15500, void, OnExit, (app::MortarWaitForShotBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x0147F9C0, void, __ctor, (app::MortarWaitForShotBehaviour * this_ptr));
}
