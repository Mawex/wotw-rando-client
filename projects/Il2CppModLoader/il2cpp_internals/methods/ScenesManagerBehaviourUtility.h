...
IL2CPP_REGISTER_METHOD(0x0105D090, Vector2, get_CurrentCameraTargetPositionExtrapolated, (app::ScenesManagerBehaviourUtility * this_ptr));
IL2CPP_REGISTER_METHOD(0x0105D0C0, Vector2, get_CurrentCameraTargetPositionExtrapolatedShort, (app::ScenesManagerBehaviourUtility * this_ptr));
IL2CPP_REGISTER_METHOD(0x0105D090, Vector2, get_PredictedTargetPosition, (app::ScenesManagerBehaviourUtility * this_ptr));
IL2CPP_REGISTER_METHOD(0x00989BF0, ScenesManagerUpdateType__Enum, get_CurrentUpdateType, (app::ScenesManagerBehaviourUtility * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0105ED10, void, UpdateSceneUtilityInternal, (app::ScenesManagerBehaviourUtility * this_ptr, app::List_1_ScenesManagerBehaviourUtility_SceneMetaAndData_ * scene_list, bool has_nearby, app::int32_t * idx));
...
IL2CPP_REGISTER_METHOD(0x01063A40, void, __ctor, (app::ScenesManagerBehaviourUtility * this_ptr));
