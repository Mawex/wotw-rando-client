...
namespace app::methods::UnityEngine_Playables::PlayableExtensions {
...
IL2CPP_REGISTER_METHOD(0x02FF8050, Playable, GetInput_1, (app::Playable playable, int32_t input_port));
...
IL2CPP_REGISTER_METHOD(0x02FF8050, Playable, GetInput_2, (app::AnimationLayerMixerPlayable playable, int32_t input_port));
...
IL2CPP_REGISTER_METHOD(0x02FF8080, PlayableGraph, GetGraph_1, (app::AnimationLayerMixerPlayable playable));
IL2CPP_REGISTER_METHOD(0x02FF8080, PlayableGraph, GetGraph_2, (app::AnimationMixerPlayable playable));
IL2CPP_REGISTER_METHOD(0x02FF8080, PlayableGraph, GetGraph_3, (app::Playable playable));
}
