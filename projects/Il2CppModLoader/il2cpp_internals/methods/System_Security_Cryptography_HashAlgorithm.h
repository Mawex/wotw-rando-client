...
namespace app::methods::System_Security_Cryptography::HashAlgorithm {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::HashAlgorithm * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FC6D0, int32_t, get_HashSize, (app::HashAlgorithm * this_ptr));
IL2CPP_REGISTER_METHOD(0x020DAAD0, Byte__Array *, get_Hash, (app::HashAlgorithm * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04786D30, HashAlgorithm_get_Hash__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020DAC90, HashAlgorithm *, Create_1, ());
IL2CPP_REGISTER_METHOD(0x020DADD0, HashAlgorithm *, Create_2, (app::String * hash_name));
IL2CPP_REGISTER_METHOD(0x020DAEB0, Byte__Array *, ComputeHash_1, (app::HashAlgorithm * this_ptr, app::Stream * input_stream));
IL2CPP_REGISTER_METHODINFO(0x047045C0, HashAlgorithm_ComputeHash__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020DB0D0, Byte__Array *, ComputeHash_2, (app::HashAlgorithm * this_ptr, app::Byte__Array * buffer));
IL2CPP_REGISTER_METHODINFO(0x04752FF0, HashAlgorithm_ComputeHash_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020DB2E0, Byte__Array *, ComputeHash_3, (app::HashAlgorithm * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x020DB800, Byte__Array *, TransformFinalBlock, (app::HashAlgorithm * this_ptr, app::Byte__Array * input_buffer, int32_t input_offset, int32_t input_count));
