...
namespace app::methods::Moon_Timeline::CameraShakeAnimator {
...
IL2CPP_REGISTER_METHOD(0x010C92B0, Vector3, get_CurrentOffset, (app::CameraShakeAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x010C9480, Vector3, get_CurrentRotation, (app::CameraShakeAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010C9650, Transform *, get_EffectiveShakeLocation, (app::CameraShakeAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010C9F40, bool, ApproximateEvent, (app::CameraShakeAnimator * this_ptr, int32_t evt, app::float * time));
IL2CPP_REGISTER_METHOD(0x010CA020, void, __ctor, (app::CameraShakeAnimator * this_ptr));
