...
namespace app::methods::System_Collections_Generic::Queue_1_T__Enumerator_FullSerializer_Internal_fsVersionedType_ {
    IL2CPP_REGISTER_METHOD(0x001ECDC0, void, __ctor, (app::Queue_1_T_Enumerator_FullSerializer_Internal_fsVersionedType___Boxed * this_ptr, app::Queue_1_FullSerializer_Internal_fsVersionedType_ * q));
