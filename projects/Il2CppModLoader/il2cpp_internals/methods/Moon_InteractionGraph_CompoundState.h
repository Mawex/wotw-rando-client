...
namespace app::methods::Moon_InteractionGraph::CompoundState {
IL2CPP_REGISTER_METHOD(0x0198C3C0, void, __ctor, (app::CompoundState * this_ptr, app::IState_1__Array * states));
