...
IL2CPP_REGISTER_METHOD(0x010B7740, Enum__Array *, GetEntries, (app::TentacleStabBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x010B77E0, Enum, Evaluate, (app::TentacleStabBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010B8FF0, BehaviourStatus__Enum, OnExecute, (app::TentacleStabBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x010BAD70, void, __ctor, (app::TentacleStabBehaviour * this_ptr));
