...
IL2CPP_REGISTER_METHOD(0x006EF460, IChargeDashAttackable *, get_FindClosestAttackable, (app::SeinDashAttack * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006F3AE0, void, __ctor, (app::SeinDashAttack * this_ptr));
