...
IL2CPP_REGISTER_METHOD(0x002FB980, void, __ctor, (app::SeinComboHandler_StubbedComboMove * this_ptr, app::ComboMoveType__Enum move_type));
IL2CPP_REGISTER_METHOD(0x00420EE0, IComboMove *, GetComboMove, (app::SeinComboHandler_StubbedComboMove * this_ptr, app::ComboInput * input));
IL2CPP_REGISTER_METHOD(0x00420EE0, ButtonInputType__Enum, get_ButtonInputType, (app::SeinComboHandler_StubbedComboMove * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA280, List_1_Moon_ComboSystem_IComboMove_ *, get_ComboMoves, (app::SeinComboHandler_StubbedComboMove * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0052A280, AbilityType__Enum, get_ComboAbilityType, (app::SeinComboHandler_StubbedComboMove * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB970, ComboMoveType__Enum, get_ComboMoveType, (app::SeinComboHandler_StubbedComboMove * this_ptr));
