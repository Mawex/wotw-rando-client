...
namespace app::methods::System_Configuration::IdnElement {
IL2CPP_REGISTER_METHOD(0x02961B40, void, __ctor, (app::IdnElement * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0473A4B8, IdnElement__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02961B70, UriIdnScope__Enum, get_Enabled, (app::IdnElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02961BD0, ConfigurationPropertyCollection *, get_Properties, (app::IdnElement * this_ptr));
