...
IL2CPP_REGISTER_METHOD(0x01BA4D70, GameObject *, get_ExternalTarget, (app::AnimationPlayer * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BA4E20, MoonAnimation *, get_EffectiveAnimation, (app::AnimationPlayer * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BA4F30, ActiveAnimationHandle *, get_ActiveAnimation, (app::AnimationPlayer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BA61F0, void, __ctor, (app::AnimationPlayer * this_ptr));
}
