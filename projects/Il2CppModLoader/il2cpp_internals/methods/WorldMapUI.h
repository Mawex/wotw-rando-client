...
namespace app::methods::WorldMapUI {
    ...
    IL2CPP_REGISTER_METHOD(0x00585660, SceneSettingsComponent*, get_SceneSettings, (app::WorldMapUI * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00585750, GameObject*, get_SceneRootObject, (app::WorldMapUI * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FBC60, Transform*, get_UiGroup, (app::WorldMapUI * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00587640, AnimationCurve*, get_ScrollingSensitivityCurve, (app::WorldMapUI * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005876E0, Vector3, WorldToProjectedPosition, (app::WorldMapUI * this_ptr, app::Vector3 position));
    IL2CPP_REGISTER_METHOD(0x00587820, Vector3, WorldToUIPosition, (app::WorldMapUI * this_ptr, app::Vector3 position));
    IL2CPP_REGISTER_METHOD(0x005878A0, Vector3, get_AreaMapScrollPosition, (app::WorldMapUI * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005879A0, Vector3, get_ClosePosition, (app::WorldMapUI * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00587BC0, Vector3, get_FarPosition, (app::WorldMapUI * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00587CE0, WorldMapOverworldArea*, get_CurrentArea, (app::WorldMapUI * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0058A4B0, Vector3, ApplyIconLerp, (app::WorldMapUI * this_ptr, app::Vector2 world_map_position, app::Vector2 area_map_position, float normalized_value));
    IL2CPP_REGISTER_METHOD(0x0058A630, Vector3, WorldToScreenToUI, (app::WorldMapUI * this_ptr, app::Vector3 position));
    ...
    IL2CPP_REGISTER_METHOD(0x0058AEE0, SuspendableMask__Enum, get_Mask, (app::WorldMapUI * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0058B820, Vector3, ClampToArea, (app::WorldMapUI * this_ptr, app::Rect rect, app::Vector3 value));
    IL2CPP_REGISTER_METHOD(0x0058B960, void, CreateQuestIcons, (app::WorldMapUI * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0058BC90, QuestIconUI*, CreateIcon, (app::WorldMapUI * this_ptr, app::RuntimeQuest* quest, app::List_1_QuestIconUI_* icons));
    ...
    IL2CPP_REGISTER_METHOD(0x0058CD40, void, __ctor, (app::WorldMapUI * this_ptr));
