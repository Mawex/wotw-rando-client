...
namespace app::methods::Moon_Wwise::UberStateWwiseStateManager {
...
IL2CPP_REGISTER_METHOD(0x002FB9D0, IUberState__Array *, get_AffectingUberStates, (app::UberStateWwiseStateManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::UberStateWwiseStateManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x0270E410, void, __ctor, (app::UberStateWwiseStateManager * this_ptr));
}
