...
namespace app::methods::System_ComponentModel::AsyncOperation {
IL2CPP_REGISTER_METHOD(0x024A0500, void, __ctor_1, (app::AsyncOperation * this_ptr, app::Object * user_supplied_state, app::SynchronizationContext * sync_context));
IL2CPP_REGISTER_METHOD(0x024A0540, void, Finalize, (app::AsyncOperation * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, Object *, get_UserSuppliedState, (app::AsyncOperation * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA280, SynchronizationContext *, get_SynchronizationContext, (app::AsyncOperation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024A09D0, AsyncOperation *, CreateOperation, (app::Object * user_supplied_state, app::SynchronizationContext * sync_context));
IL2CPP_REGISTER_METHOD(0x024A0B40, void, __ctor_2, (app::AsyncOperation * this_ptr));
