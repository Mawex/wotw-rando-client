...
namespace app::methods::Steamworks::ControllerActionSetHandle_t {
    IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor, (app::ControllerActionSetHandle_t__Boxed * this_ptr, uint64_t value));
    ...
    IL2CPP_REGISTER_METHOD(0x015F8190, bool, operator____1, (app::ControllerActionSetHandle_t x, app::ControllerActionSetHandle_t y));
    IL2CPP_REGISTER_METHOD(0x015F81A0, bool, operator____2, (app::ControllerActionSetHandle_t x, app::ControllerActionSetHandle_t y));
    IL2CPP_REGISTER_METHOD(0x004C50A0, app::ControllerActionSetHandle_t, operator__1, (uint64_t value));
    IL2CPP_REGISTER_METHOD(0x004C50A0, uint64_t, operator__2, (app::ControllerActionSetHandle_t that));
