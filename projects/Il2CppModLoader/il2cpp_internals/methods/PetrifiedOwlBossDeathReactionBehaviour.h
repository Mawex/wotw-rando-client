...
IL2CPP_REGISTER_METHOD(0x0049EB60, BehaviourStatus__Enum, OnExecuteTask, (app::PetrifiedOwlBossDeathReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0049F220, void, __ctor, (app::PetrifiedOwlBossDeathReactionBehaviour * this_ptr));
}
