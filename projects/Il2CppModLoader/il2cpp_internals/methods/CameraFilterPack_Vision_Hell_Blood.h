...
IL2CPP_REGISTER_METHOD(0x020F79F0, Material *, get_material, (app::CameraFilterPack_Vision_Hell_Blood * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020F8350, void, __ctor, (app::CameraFilterPack_Vision_Hell_Blood * this_ptr));
}
