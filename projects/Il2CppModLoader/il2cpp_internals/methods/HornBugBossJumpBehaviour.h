...
IL2CPP_REGISTER_METHOD(0x00B67490, Vector3, get_OriginalTarget, (app::HornBugBossJumpBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B67940, BehaviourStatus__Enum, OnExecute, (app::HornBugBossJumpBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00B682C0, void, __ctor, (app::HornBugBossJumpBehaviour * this_ptr));
}
