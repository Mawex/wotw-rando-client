...
namespace app::methods::System_Diagnostics_Tracing::DataCollector {
IL2CPP_REGISTER_METHOD(0x0013DDE0, void, Enable, (app::DataCollector__Boxed * this_ptr, app::uint8_t * scratch, int32_t scratch_size, app::EventSource_EventData * datas, int32_t data_count, app::GCHandle * pins, int32_t pin_count));
IL2CPP_REGISTER_METHOD(0x0013DE30, void, Disable, (app::DataCollector__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0013DE40, EventSource_EventData *, Finish, (app::DataCollector__Boxed * this_ptr));
