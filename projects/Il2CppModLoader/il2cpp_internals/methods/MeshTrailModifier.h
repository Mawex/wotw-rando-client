...
IL2CPP_REGISTER_METHOD(0x002FD750, SuspendableMask__Enum, get_Mask, (app::MeshTrailModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00597BB0, void, __ctor, (app::MeshTrailModifier * this_ptr));
