...
namespace app::methods::UberSwarmPOI {
    IL2CPP_REGISTER_METHOD(0x0128C2C0, Vector2, get_Position, (app::UberSwarmPOI * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0128CAC0, Vector2, CalculateVelocity, (app::UberSwarmPOI * this_ptr, app::ISwarmer* swarmer));
    IL2CPP_REGISTER_METHOD(0x0128CBA0, Vector2, CalculateVelocityCircle, (app::UberSwarmPOI * this_ptr, app::ISwarmer* swarmer));
    IL2CPP_REGISTER_METHOD(0x0128CE80, Vector2, CalculateVelocityRectangle, (app::UberSwarmPOI * this_ptr, app::ISwarmer* swarmer));
    IL2CPP_REGISTER_METHOD(0x0128D500, void, __ctor, (app::UberSwarmPOI * this_ptr));
} // namespace app::methods::UberSwarmPOI
