...
namespace app::methods::System_Collections_ObjectModel::ReadOnlyCollection_1_Moon_UberStateController_ApplierContext_ {
IL2CPP_REGISTER_METHOD(0x02B7DCF0, void, __ctor, (app::ReadOnlyCollection_1_Moon_UberStateController_ApplierContext_ * this_ptr, app::IList_1_Moon_UberStateController_ApplierContext_ * list));
...
IL2CPP_REGISTER_METHOD(0x02B815D0, UberStateController_ApplierContext, get_Item, (app::ReadOnlyCollection_1_Moon_UberStateController_ApplierContext_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02B7DF30, IEnumerator_1_Moon_UberStateController_ApplierContext_ *, GetEnumerator, (app::ReadOnlyCollection_1_Moon_UberStateController_ApplierContext_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B815D0, UberStateController_ApplierContext, System_Collections_Generic_IList_T__get_Item, (app::ReadOnlyCollection_1_Moon_UberStateController_ApplierContext_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02E47F50, IEnumerator *, IEnumerable_GetEnumerator, (app::ReadOnlyCollection_1_Moon_UberStateController_ApplierContext_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02E47FE0, Object *, ICollection_get_SyncRoot, (app::ReadOnlyCollection_1_Moon_UberStateController_ApplierContext_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B81E90, Object *, IList_get_Item, (app::ReadOnlyCollection_1_Moon_UberStateController_ApplierContext_ * this_ptr, int32_t index));
