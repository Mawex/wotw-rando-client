...
IL2CPP_REGISTER_METHOD(0x01D48FC0, Encoding *, get_ContentEncoding, (app::HttpListenerResponse * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_ContentType, (app::HttpListenerResponse * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E55B10, CookieCollection *, get_Cookies, (app::HttpListenerResponse * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9C0, void, set_Cookies, (app::HttpListenerResponse * this_ptr, app::CookieCollection * value));
IL2CPP_REGISTER_METHOD(0x002FB9D0, WebHeaderCollection *, get_Headers, (app::HttpListenerResponse * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E55D90, Stream *, get_OutputStream, (app::HttpListenerResponse * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB60, Version *, get_ProtocolVersion, (app::HttpListenerResponse * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB80, String *, get_RedirectLocation, (app::HttpListenerResponse * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBC0, String *, get_StatusDescription, (app::HttpListenerResponse * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E57A40, String *, FormatHeaders, (app::WebHeaderCollection * headers));
IL2CPP_REGISTER_METHOD(0x01E57DE0, String *, CookieToClientString, (app::Cookie * cookie));
IL2CPP_REGISTER_METHOD(0x01E58170, String *, QuotedString, (app::Cookie * cookie, app::String * value));
