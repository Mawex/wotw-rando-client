...
IL2CPP_REGISTER_METHOD(0x0056FAD0, ICondition *, get_ResolvedCondition, (app::WeaponMasterPlaceholder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004181F0, void, __ctor, (app::WeaponMasterPlaceholder * this_ptr));
}
