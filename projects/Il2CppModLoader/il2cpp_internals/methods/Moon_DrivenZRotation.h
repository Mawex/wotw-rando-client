...
IL2CPP_REGISTER_METHOD(0x00597B10, UpdateType__Enum, get_UpdateType, (app::DrivenZRotation * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BA9280, ITweenLerpInputProvider *, get_ResolvedInputProvider, (app::DrivenZRotation * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BA9340, Transform *, get_EffectiveTranform, (app::DrivenZRotation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BA9EE0, void, __ctor, (app::DrivenZRotation * this_ptr));
}
