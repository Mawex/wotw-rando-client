...
namespace app::methods::UnityEngine_AI::NavMeshAgent {
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::NavMeshAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031B12B0, Vector3, get_destination, (app::NavMeshAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031B1500, Vector3, get_velocity, (app::NavMeshAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031B16A0, Vector3, get_nextPosition, (app::NavMeshAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031B1840, Vector3, get_steeringTarget, (app::NavMeshAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x031B18C0, void, INTERNAL_get_steeringTarget, (app::NavMeshAgent * this_ptr, app::Vector3 * value));
IL2CPP_REGISTER_METHOD(0x031B1920, Vector3, get_desiredVelocity, (app::NavMeshAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031B1BB0, OffMeshLinkData, get_currentOffMeshLinkData, (app::NavMeshAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x031B1BB0, OffMeshLinkData, GetCurrentOffMeshLinkDataInternal, (app::NavMeshAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x031B1C30, OffMeshLinkData, get_nextOffMeshLinkData, (app::NavMeshAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x031B1C30, OffMeshLinkData, GetNextOffMeshLinkDataInternal, (app::NavMeshAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031B2000, NavMeshPathStatus__Enum, get_pathStatus, (app::NavMeshAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x031B2050, Vector3, get_pathEndPosition, (app::NavMeshAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031B24B0, NavMeshPath *, get_path, (app::NavMeshAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031B2CF0, Object_1 *, get_navMeshOwner, (app::NavMeshAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031B2CF0, Object_1 *, GetOwnerInternal, (app::NavMeshAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031B34D0, ObstacleAvoidanceType__Enum, get_obstacleAvoidanceType, (app::NavMeshAgent * this_ptr));
