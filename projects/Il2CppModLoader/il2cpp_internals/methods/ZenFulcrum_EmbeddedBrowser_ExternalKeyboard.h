...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::ExternalKeyboard {
IL2CPP_REGISTER_METHOD(0x002FBB80, Browser *, get_ActiveBrowser, (app::ExternalKeyboard * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01DDAF00, IEnumerator *, FindAndListenForBrowsers, (app::ExternalKeyboard * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01DDC750, void, __ctor, (app::ExternalKeyboard * this_ptr));
}
