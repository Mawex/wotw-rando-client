...
IL2CPP_REGISTER_METHOD(0x00B5D6D0, SeinSpiritLeashAbility *, get_Leash, (app::HookFlingPlant * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD20, Transform *, get_HookTargetTransform, (app::HookFlingPlant * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B5E430, void, __ctor, (app::HookFlingPlant * this_ptr));
}
