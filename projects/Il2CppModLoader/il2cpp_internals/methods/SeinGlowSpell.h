...
namespace app::methods::SeinGlowSpell {
    ...
    IL2CPP_REGISTER_METHOD(0x00AE6430, SeinGlowSpell_QuickGlowSetupInfo*, get_m_currentQuickGlowSetup, (app::SeinGlowSpell * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00AE6650, Input_InputButtonProcessor*, get_Button, (app::SeinGlowSpell * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00AED1F0, SeinGlowSpell_QuickGlowTypes__Enum, GetSuitableQuickGlowType, (app::SeinGlowSpell * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00AED6E0, String*, get_StressTestName, (app::SeinGlowSpell * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00AED7A0, StressTestStatus__Enum, get_StressTestStatus, (app::SeinGlowSpell * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00AED7C0, void, __ctor, (app::SeinGlowSpell * this_ptr));
} // namespace app::methods::SeinGlowSpell
