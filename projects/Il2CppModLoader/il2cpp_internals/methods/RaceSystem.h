...
namespace app::methods::RaceSystem {
    ...
    IL2CPP_REGISTER_METHOD(0x003FC7F0, SuspendableMask__Enum, get_Mask, (app::RaceSystem * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0071E930, void, set_Mask, (app::RaceSystem * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x002FB9D0, RaceTimer*, get_Timer, (app::RaceSystem * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0071E9E0, GhostRecorder*, get_Recorder, (app::RaceSystem * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0065FBA0, RaceLeaderboardScreen*, get_LeaderboardScreen, (app::RaceSystem * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0071EAB0, RaceTargetIndicator*, get_TargetIndicator, (app::RaceSystem * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0071F210, RaceStateMachineContext*, get_Context, (app::RaceSystem * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0071F570, LeaderboardFilter__Enum, get_LeaderboardFilter, (app::RaceSystem * this_ptr));
    IL2CPP_REGISTER_METHOD(0x004B67E0, RaceSystem_PrimaryFilter__Enum, get_CurrentPrimaryFilter, (app::RaceSystem * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0071F5B0, RaceSystem_SecondaryFilter__Enum, get_CurrentSecondaryFilter, (app::RaceSystem * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00720040, StateMachine_2*, get_StateMachine, (app::RaceSystem * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720050, bool, get_HasState, (app::RaceSystem * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720080, RaceBaseState*, get_CurrentState, (app::RaceSystem * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720150, GhostService*, get_GhostService, (app::RaceSystem * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00721F40, MessageProvider*, GetLeaderboardFilterMessage, (app::RaceSystem * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00722890, IEnumerator*, StartRaceFromMainMenuCoroutine, (app::RaceSystem * this_ptr));
