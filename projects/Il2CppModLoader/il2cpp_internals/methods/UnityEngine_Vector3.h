...
namespace app::methods::UnityEngine::Vector3 {
    ...
    IL2CPP_REGISTER_METHOD(0x02C77480, app::Vector3, operator___1, (app::Vector3 a, app::Vector3 b));
    IL2CPP_REGISTER_METHOD(0x02C774D0, app::Vector3, operator___2, (app::Vector3 a, app::Vector3 b));
    IL2CPP_REGISTER_METHOD(0x02C77520, app::Vector3, operator___3, (app::Vector3 a));
    IL2CPP_REGISTER_METHOD(0x02C77570, app::Vector3, operator___4, (app::Vector3 a, float d));
    IL2CPP_REGISTER_METHOD(0x02C775B0, app::Vector3, operator___5, (float d, app::Vector3 a));
    IL2CPP_REGISTER_METHOD(0x02C775F0, app::Vector3, operator___6, (app::Vector3 a, float d));
