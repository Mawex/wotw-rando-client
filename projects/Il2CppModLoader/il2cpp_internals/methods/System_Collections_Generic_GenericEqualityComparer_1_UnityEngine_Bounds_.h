...
namespace app::methods::System_Collections_Generic::GenericEqualityComparer_1_UnityEngine_Bounds_ {
...
IL2CPP_REGISTER_METHOD(0x0225BDA0, void, __ctor, (app::GenericEqualityComparer_1_UnityEngine_Bounds_ * this_ptr));
}
