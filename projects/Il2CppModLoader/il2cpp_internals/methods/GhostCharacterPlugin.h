...
IL2CPP_REGISTER_METHOD(0x00420EE0, GhostRecorder_GhostPluginRecordingType__Enum, GetRecordingType, (app::GhostCharacterPlugin * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E188D0, void, __ctor, (app::GhostCharacterPlugin * this_ptr));
}
