...
namespace app::methods::frameworks_loading_Prewarmers::LoadIntroLogosPrewarmOperation {
    IL2CPP_REGISTER_METHOD(0x00F60840, void, __ctor, (app::LoadIntroLogosPrewarmOperation * this_ptr));
