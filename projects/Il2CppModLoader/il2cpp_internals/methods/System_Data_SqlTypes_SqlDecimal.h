...
namespace app::methods::System_Data_SqlTypes::SqlDecimal {
    ...
    IL2CPP_REGISTER_METHOD(0x022A7980, app::SqlDecimal, operator__1, (app::Decimal x));
    IL2CPP_REGISTER_METHOD(0x022A79B0, app::SqlDecimal, operator__2, (int64_t x));
    IL2CPP_REGISTER_METHOD(0x022A7A20, app::SqlDecimal, operator___1, (app::SqlDecimal x));
    IL2CPP_REGISTER_METHOD(0x022A7B60, app::SqlDecimal, operator___2, (app::SqlDecimal x, app::SqlDecimal y));
    IL2CPP_REGISTER_METHODINFO(0x04739388, SqlDecimal_op_Addition__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x022A8320, app::SqlDecimal, operator___3, (app::SqlDecimal x, app::SqlDecimal y));
    IL2CPP_REGISTER_METHOD(0x022A8440, app::SqlDecimal, operator___4, (app::SqlDecimal x, app::SqlDecimal y));
    IL2CPP_REGISTER_METHODINFO(0x04796D10, SqlDecimal_op_Multiply__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x022A91A0, app::SqlDecimal, operator___5, (app::SqlDecimal x, app::SqlDecimal y));
    IL2CPP_REGISTER_METHODINFO(0x04799A58, SqlDecimal_op_Division__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x022A97F0, app::SqlDecimal, operator__3, (app::SqlByte x));
    IL2CPP_REGISTER_METHOD(0x022A9940, app::SqlDecimal, operator__4, (app::SqlInt16 x));
    IL2CPP_REGISTER_METHOD(0x022A9A90, app::SqlDecimal, operator__5, (app::SqlInt32 x));
    IL2CPP_REGISTER_METHOD(0x022A9BE0, app::SqlDecimal, operator__6, (app::SqlInt64 x));
    IL2CPP_REGISTER_METHOD(0x022A9CE0, app::SqlDecimal, operator__7, (app::SqlMoney x));
    ...
    IL2CPP_REGISTER_METHOD(0x022AC800, app::SqlBoolean, operator___, (app::SqlDecimal x, app::SqlDecimal y));
    IL2CPP_REGISTER_METHOD(0x022AC900, app::SqlBoolean, operator___6, (app::SqlDecimal x, app::SqlDecimal y));
    IL2CPP_REGISTER_METHOD(0x022ACA00, app::SqlBoolean, operator___7, (app::SqlDecimal x, app::SqlDecimal y));
