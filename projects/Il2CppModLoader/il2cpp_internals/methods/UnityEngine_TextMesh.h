...
IL2CPP_REGISTER_METHOD(0x0319D520, String *, get_text, (app::TextMesh * this_ptr));
IL2CPP_REGISTER_METHOD(0x0319D570, void, set_text, (app::TextMesh * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x0319D5D0, Font *, get_font, (app::TextMesh * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0319D7E0, TextAlignment__Enum, get_alignment, (app::TextMesh * this_ptr));
IL2CPP_REGISTER_METHOD(0x0319D830, void, set_alignment, (app::TextMesh * this_ptr, app::TextAlignment__Enum value));
IL2CPP_REGISTER_METHOD(0x0319D890, TextAnchor__Enum, get_anchor, (app::TextMesh * this_ptr));
