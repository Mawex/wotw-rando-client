...
namespace app::methods::Moon_Timeline::ExternalTimelineEntity {
IL2CPP_REGISTER_METHOD(0x01BBDF00, String *, get_FullAddress, (app::ExternalTimelineEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BBDFF0, MoonTimeline *, get_ExternalTimeline, (app::ExternalTimelineEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BBE720, List_1_Moon_Timeline_TimelineEntityRecord_ *, get_EntityRecords, (app::ExternalTimelineEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BBEA60, List_1_Moon_Timeline_ConstraintsMetaData_ *, get_ConstraintMetaDatas, (app::ExternalTimelineEntity * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04747E98, ExternalTimelineEntity_get_ConstraintMetaDatas__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01BBEAB0, List_1_Moon_Timeline_TimelineMarkerRecord_ *, get_MarkerRecords, (app::ExternalTimelineEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BBEC00, List_1_Moon_Timeline_ExternalTimelineRecord_ *, get_ExternalRecords, (app::ExternalTimelineEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBC0, MoonReference_1_Moon_Timeline_ITimelineEntity_ *, get_ActiveTimeline, (app::ExternalTimelineEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BBEFE0, bool, HasFinished, (app::ExternalTimelineEntity * this_ptr, int32_t event_id));
IL2CPP_REGISTER_METHOD(0x01BBF0D0, List_1_Moon_MoonReference_1__2 *, get_Timelines, (app::ExternalTimelineEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BBF3F0, bool, ApproximateEvent, (app::ExternalTimelineEntity * this_ptr, int32_t evt, app::float * time));
...
IL2CPP_REGISTER_METHOD(0x002FBC60, ITrimController *, get_TrimController, (app::ExternalTimelineEntity * this_ptr));
