...
namespace app::methods::System_Data::DataRelationPropertyDescriptor {
IL2CPP_REGISTER_METHOD(0x023A9200, void, __ctor, (app::DataRelationPropertyDescriptor * this_ptr, app::DataRelation * data_relation));
IL2CPP_REGISTER_METHOD(0x002FBC20, DataRelation *, get_Relation, (app::DataRelationPropertyDescriptor * this_ptr));
IL2CPP_REGISTER_METHOD(0x023A9260, Type *, get_ComponentType, (app::DataRelationPropertyDescriptor * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_IsReadOnly, (app::DataRelationPropertyDescriptor * this_ptr));
IL2CPP_REGISTER_METHOD(0x023A9300, Type *, get_PropertyType, (app::DataRelationPropertyDescriptor * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x023A9480, Object *, GetValue, (app::DataRelationPropertyDescriptor * this_ptr, app::Object * component));
