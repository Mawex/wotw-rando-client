...
namespace app::methods::System_Data_Common::DecimalStorage {
IL2CPP_REGISTER_METHOD(0x02163820, void, __ctor, (app::DecimalStorage * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x02163970, Object *, Aggregate, (app::DecimalStorage * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x02164A60, Object *, ConvertValue, (app::DecimalStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02155CC0, void, Copy, (app::DecimalStorage * this_ptr, int32_t record_no1, int32_t record_no2));
IL2CPP_REGISTER_METHOD(0x02164B90, Object *, Get, (app::DecimalStorage * this_ptr, int32_t record));
...
IL2CPP_REGISTER_METHOD(0x02164FB0, Object *, ConvertXmlToObject, (app::DecimalStorage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x02165070, String *, ConvertObjectToXml, (app::DecimalStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02165160, Object *, GetEmptyStorage, (app::DecimalStorage * this_ptr, int32_t record_count));
