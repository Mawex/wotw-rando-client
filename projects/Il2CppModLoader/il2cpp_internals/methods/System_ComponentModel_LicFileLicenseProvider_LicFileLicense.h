...
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_LicenseKey, (LicFileLicenseProvider_LicFileLicense * __this));
IL2CPP_REGISTER_METHOD(0x01FF07F0, void, Dispose, (LicFileLicenseProvider_LicFileLicense * __this));
}
