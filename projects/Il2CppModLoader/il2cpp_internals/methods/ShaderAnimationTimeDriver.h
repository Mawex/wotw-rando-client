...
IL2CPP_REGISTER_METHOD(0x003FC830, SuspendableMask__Enum, get_Mask, (app::ShaderAnimationTimeDriver * this_ptr));
IL2CPP_REGISTER_METHOD(0x004C5130, void, set_Mask, (app::ShaderAnimationTimeDriver * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x005A6500, void, __ctor, (app::ShaderAnimationTimeDriver * this_ptr));
}
