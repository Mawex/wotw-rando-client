...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::CharacterController * this_ptr));
IL2CPP_REGISTER_METHOD(0x0309E7C0, bool, SimpleMove, (app::CharacterController * this_ptr, app::Vector3 speed));
IL2CPP_REGISTER_METHOD(0x0309E820, CollisionFlags__Enum, Move, (app::CharacterController * this_ptr, app::Vector3 motion));
IL2CPP_REGISTER_METHOD(0x0309E880, Vector3, get_velocity, (app::CharacterController * this_ptr));
IL2CPP_REGISTER_METHOD(0x0309E900, bool, get_isGrounded, (app::CharacterController * this_ptr));
IL2CPP_REGISTER_METHOD(0x0309E950, CollisionFlags__Enum, get_collisionFlags, (app::CharacterController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0309EB00, Vector3, get_center, (app::CharacterController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0309F060, CollisionFlags__Enum, Move_Injected, (app::CharacterController * this_ptr, app::Vector3 * motion));
