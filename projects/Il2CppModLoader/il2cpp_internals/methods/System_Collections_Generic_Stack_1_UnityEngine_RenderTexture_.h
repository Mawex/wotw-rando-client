...
IL2CPP_REGISTER_METHOD(0x02CF7F90, RenderTexture *, Pop, (Stack_1_UnityEngine_RenderTexture_ * __this));
IL2CPP_REGISTER_METHODINFO(0x04778228, Stack_1_UnityEngine_RenderTexture__Pop__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (Stack_1_UnityEngine_RenderTexture_ * __this));
IL2CPP_REGISTER_METHODINFO(0x04712C08, Stack_1_UnityEngine_RenderTexture__get_Count__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0243CB70, void, __ctor, (Stack_1_UnityEngine_RenderTexture_ * __this));
