...
namespace app::methods::DropPickup {
    ...
    IL2CPP_REGISTER_METHOD(0x002FBBE0, Transform*, get_TransformSource, (app::DropPickup * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00BDDCF0, void, set_TransformSource, (app::DropPickup * this_ptr, app::Transform* value));
    IL2CPP_REGISTER_METHOD(0x00BDDD00, Vector3, get_CurrentGravity, (app::DropPickup * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x003FBE90, SuspendableMask__Enum, get_Mask, (app::DropPickup * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00BE0640, void, set_Mask, (app::DropPickup * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x00BE0700, void, __ctor, (app::DropPickup * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00BE0740, void, __cctor, ());
    IL2CPP_REGISTER_METHOD(0x004F4750, GameObject*, IDamageReciever_get_gameObject, (app::DropPickup * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00506170, Transform*, IDamageReciever_get_transform, (app::DropPickup * this_ptr));
} // namespace app::methods::DropPickup
