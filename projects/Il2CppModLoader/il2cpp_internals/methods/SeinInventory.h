...
namespace app::methods::SeinInventory {
    ...
    IL2CPP_REGISTER_METHOD(0x01014670, PlayerUberStateInventory*, get_PlayerUberInventory, (app::SeinInventory * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x010151D0, void, __ctor, (app::SeinInventory * this_ptr));
} // namespace app::methods::SeinInventory
