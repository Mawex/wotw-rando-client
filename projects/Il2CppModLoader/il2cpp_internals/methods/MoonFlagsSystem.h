...
IL2CPP_REGISTER_METHOD(0x00420EE0, UpdateType__Enum, get_UpdateType, (app::MoonFlagsSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03121780, MoonFlagsSystem_ObjectState *, GetObjectState, (app::MoonFlagsSystem * this_ptr, app::Renderer * renderer, bool force_update));
...
IL2CPP_REGISTER_METHOD(0x03121CA0, void, ApplyObjectState_2, (app::MoonFlagsSystem * this_ptr, app::MoonFlagsSystem_ObjectState * object_state, app::bool * state_can_be_removed, bool force_apply));
...
IL2CPP_REGISTER_METHOD(0x03122910, MoonFlagsSystem_ObjectState *, AcquireObjectStateFromPool, (app::MoonFlagsSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03122B60, void, __ctor, (app::MoonFlagsSystem * this_ptr));
}
