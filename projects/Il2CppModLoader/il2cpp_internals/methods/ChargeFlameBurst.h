...
IL2CPP_REGISTER_METHOD(0x002FD750, SuspendableMask__Enum, get_Mask, (app::ChargeFlameBurst * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FD760, void, set_Mask, (app::ChargeFlameBurst * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x013194C0, void, __ctor, (app::ChargeFlameBurst * this_ptr));
}
