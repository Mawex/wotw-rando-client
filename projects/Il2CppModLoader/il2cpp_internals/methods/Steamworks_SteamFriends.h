...
IL2CPP_REGISTER_METHOD(0x027E9C60, SteamAPICall_t, SetPersonaName, (app::String * pch_persona_name));
...
IL2CPP_REGISTER_METHOD(0x027EA0C0, CSteamID, GetFriendByIndex, (int32_t i_friend, app::EFriendFlags__Enum i_friend_flags));
IL2CPP_REGISTER_METHOD(0x027EA210, EFriendRelationship__Enum, GetFriendRelationship, (app::CSteamID steam_i_d_friend));
IL2CPP_REGISTER_METHOD(0x027EA2D0, EPersonaState__Enum, GetFriendPersonaState, (app::CSteamID steam_i_d_friend));
IL2CPP_REGISTER_METHOD(0x027EA390, String *, GetFriendPersonaName, (app::CSteamID steam_i_d_friend));
...
IL2CPP_REGISTER_METHOD(0x027EA520, String *, GetFriendPersonaNameHistory, (app::CSteamID steam_i_d_friend, int32_t i_persona_name));
IL2CPP_REGISTER_METHOD(0x027EA5F0, int32_t, GetFriendSteamLevel, (app::CSteamID steam_i_d_friend));
IL2CPP_REGISTER_METHOD(0x027EA6B0, String *, GetPlayerNickname, (app::CSteamID steam_i_d_player));
IL2CPP_REGISTER_METHOD(0x027EA770, int32_t, GetFriendsGroupCount, ());
IL2CPP_REGISTER_METHOD(0x027EA820, FriendsGroupID_t, GetFriendsGroupIDByIndex, (int32_t i_f_g));
IL2CPP_REGISTER_METHOD(0x027EA960, String *, GetFriendsGroupName, (app::FriendsGroupID_t friends_group_i_d));
...
IL2CPP_REGISTER_METHOD(0x027EAD40, CSteamID, GetClanByIndex, (int32_t i_clan));
IL2CPP_REGISTER_METHOD(0x027EAE80, String *, GetClanName, (app::CSteamID steam_i_d_clan));
IL2CPP_REGISTER_METHOD(0x027EAF40, String *, GetClanTag, (app::CSteamID steam_i_d_clan));
IL2CPP_REGISTER_METHOD(0x027EB000, bool, GetClanActivityCounts, (app::CSteamID steam_i_d_clan, app::int32_t * pn_online, app::int32_t * pn_in_game, app::int32_t * pn_chatting));
IL2CPP_REGISTER_METHOD(0x027EB0F0, SteamAPICall_t, DownloadClanActivityCounts, (app::CSteamID__Array * psteam_i_d_clans, int32_t c_clans_to_request));
IL2CPP_REGISTER_METHOD(0x027EB250, int32_t, GetFriendCountFromSource, (app::CSteamID steam_i_d_source));
IL2CPP_REGISTER_METHOD(0x027EB310, CSteamID, GetFriendFromSourceByIndex, (app::CSteamID steam_i_d_source, int32_t i_friend));
...
IL2CPP_REGISTER_METHOD(0x027EC3D0, SteamAPICall_t, RequestClanOfficerList, (app::CSteamID steam_i_d_clan));
IL2CPP_REGISTER_METHOD(0x027EC510, CSteamID, GetClanOwner, (app::CSteamID steam_i_d_clan));
IL2CPP_REGISTER_METHOD(0x027EC650, int32_t, GetClanOfficerCount, (app::CSteamID steam_i_d_clan));
IL2CPP_REGISTER_METHOD(0x027EC710, CSteamID, GetClanOfficerByIndex, (app::CSteamID steam_i_d_clan, int32_t i_officer));
...
IL2CPP_REGISTER_METHOD(0x027ECE10, String *, GetFriendRichPresence, (app::CSteamID steam_i_d_friend, app::String * pch_key));
IL2CPP_REGISTER_METHOD(0x027ED100, int32_t, GetFriendRichPresenceKeyCount, (app::CSteamID steam_i_d_friend));
IL2CPP_REGISTER_METHOD(0x027ED1C0, String *, GetFriendRichPresenceKeyByIndex, (app::CSteamID steam_i_d_friend, int32_t i_key));
...
IL2CPP_REGISTER_METHOD(0x027ED6F0, CSteamID, GetCoplayFriend, (int32_t i_coplay_friend));
IL2CPP_REGISTER_METHOD(0x027ED830, int32_t, GetFriendCoplayTime, (app::CSteamID steam_i_d_friend));
IL2CPP_REGISTER_METHOD(0x027ED8F0, AppId_t, GetFriendCoplayGame, (app::CSteamID steam_i_d_friend));
IL2CPP_REGISTER_METHOD(0x027EDA30, SteamAPICall_t, JoinClanChatRoom, (app::CSteamID steam_i_d_clan));
...
IL2CPP_REGISTER_METHOD(0x027EDCF0, CSteamID, GetChatMemberByIndex, (app::CSteamID steam_i_d_clan, int32_t i_user));
...
IL2CPP_REGISTER_METHOD(0x027EEBA0, SteamAPICall_t, GetFollowerCount, (app::CSteamID steam_i_d));
IL2CPP_REGISTER_METHOD(0x027EECE0, SteamAPICall_t, IsFollowing, (app::CSteamID steam_i_d));
IL2CPP_REGISTER_METHOD(0x027EEE20, SteamAPICall_t, EnumerateFollowingList, (uint32_t un_start_index));
