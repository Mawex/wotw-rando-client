...
namespace app::methods::FrogGroup {
    IL2CPP_REGISTER_METHOD(0x002FB990, List_1_FrogEntity_*, get_AliveFrogsInGroup, (app::FrogGroup * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x016490D0, void, __ctor, (app::FrogGroup * this_ptr));
} // namespace app::methods::FrogGroup
