...
IL2CPP_REGISTER_METHOD(0x00608710, SuspendableMask__Enum, get_Mask, (app::DealDamageOverTime * this_ptr));
IL2CPP_REGISTER_METHOD(0x00DDDB80, void, set_Mask, (app::DealDamageOverTime * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x00DDDC30, void, __ctor, (app::DealDamageOverTime * this_ptr));
}
