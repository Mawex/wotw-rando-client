...
IL2CPP_REGISTER_METHOD(0x00D84CB0, ActiveAnimationHandle, Play_2, (app::MoonAnimation * animation, app::Action * on_stop_playing, app::Func_1_Boolean_ * condition, int32_t layer));
