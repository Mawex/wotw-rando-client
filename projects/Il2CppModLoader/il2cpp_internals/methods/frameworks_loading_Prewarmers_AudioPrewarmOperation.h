...
namespace app::methods::frameworks_loading_Prewarmers::AudioPrewarmOperation {
    IL2CPP_REGISTER_METHOD(0x00F5DDD0, void, __ctor, (app::AudioPrewarmOperation * this_ptr));
