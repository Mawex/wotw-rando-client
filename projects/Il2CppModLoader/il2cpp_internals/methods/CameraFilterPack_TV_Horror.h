...
IL2CPP_REGISTER_METHOD(0x020E9150, Material *, get_material, (app::CameraFilterPack_TV_Horror * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E9B00, void, __ctor, (app::CameraFilterPack_TV_Horror * this_ptr));
}
