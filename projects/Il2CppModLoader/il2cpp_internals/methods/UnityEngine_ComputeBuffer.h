...
IL2CPP_REGISTER_METHOD(0x024296E0, void, __ctor_1, (app::ComputeBuffer * this_ptr, int32_t count, int32_t stride));
IL2CPP_REGISTER_METHOD(0x02429710, void, __ctor_2, (app::ComputeBuffer * this_ptr, int32_t count, int32_t stride, app::ComputeBufferType__Enum type));
IL2CPP_REGISTER_METHOD(0x02429730, void, __ctor_3, (app::ComputeBuffer * this_ptr, int32_t count, int32_t stride, app::ComputeBufferType__Enum type, int32_t stack_depth));
