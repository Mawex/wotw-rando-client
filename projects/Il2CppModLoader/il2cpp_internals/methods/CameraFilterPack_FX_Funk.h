...
IL2CPP_REGISTER_METHOD(0x0246D5C0, Material *, get_material, (app::CameraFilterPack_FX_Funk * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0136E200, void, __ctor, (app::CameraFilterPack_FX_Funk * this_ptr));
}
