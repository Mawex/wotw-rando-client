...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::ClickMeshBrowserUI {
IL2CPP_REGISTER_METHOD(0x01DCE780, ClickMeshBrowserUI *, Create, (app::MeshCollider * mesh_collider));
IL2CPP_REGISTER_METHOD(0x01DCE880, void, Awake, (app::ClickMeshBrowserUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x01DCEB90, Ray, get_LookRay, (app::ClickMeshBrowserUI * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01464270, Vector2, get_MousePosition, (app::ClickMeshBrowserUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x01464290, void, set_MousePosition, (app::ClickMeshBrowserUI * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x003FF2B0, MouseButton__Enum, get_MouseButtons, (app::ClickMeshBrowserUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x003FF2C0, void, set_MouseButtons, (app::ClickMeshBrowserUI * this_ptr, app::MouseButton__Enum value));
IL2CPP_REGISTER_METHOD(0x01056D40, Vector2, get_MouseScroll, (app::ClickMeshBrowserUI * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9F0, List_1_UnityEngine_Event_ *, get_KeyEvents, (app::ClickMeshBrowserUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBC0, BrowserCursor *, get_BrowserCursor, (app::ClickMeshBrowserUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBD0, void, set_BrowserCursor, (app::ClickMeshBrowserUI * this_ptr, app::BrowserCursor * value));
IL2CPP_REGISTER_METHOD(0x002FBBE0, BrowserInputSettings *, get_InputSettings, (app::ClickMeshBrowserUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBF0, void, set_InputSettings, (app::ClickMeshBrowserUI * this_ptr, app::BrowserInputSettings * value));
IL2CPP_REGISTER_METHOD(0x01DCFA20, void, __ctor, (app::ClickMeshBrowserUI * this_ptr));
