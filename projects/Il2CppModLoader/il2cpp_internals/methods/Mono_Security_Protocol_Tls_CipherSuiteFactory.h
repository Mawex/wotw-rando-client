...
namespace app::methods::Mono_Security_Protocol_Tls::CipherSuiteFactory {
IL2CPP_REGISTER_METHOD(0x01F65BD0, CipherSuiteCollection *, GetSupportedCiphers, (bool server, app::SecurityProtocolType__Enum_1 protocol));
