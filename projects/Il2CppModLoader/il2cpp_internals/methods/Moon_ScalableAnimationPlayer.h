...
IL2CPP_REGISTER_METHOD(0x00420EE0, RecordableParsingGroup__Enum, get_ParsingGroup, (app::ScalableAnimationPlayer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BAD160, Single__Array *, GetEventPreviewTimes, (app::ScalableAnimationPlayer * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BAD270, bool, ApproximateEvent, (app::ScalableAnimationPlayer * this_ptr, int32_t evt, app::float * time));
...
IL2CPP_REGISTER_METHOD(0x01BADCD0, void, GetNextIntervalFrom, (app::ScalableAnimationPlayer * this_ptr, float time, app::float * start, app::float * end, app::bool * scalable));
IL2CPP_REGISTER_METHOD(0x01BADF20, float, GetSpeedForNormalizedTime, (app::ScalableAnimationPlayer * this_ptr, float time));
IL2CPP_REGISTER_METHOD(0x01BADF90, EntityId, AddNewEvent, (app::ScalableAnimationPlayer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BAEB10, void, GetBestInterval, (app::ScalableAnimationPlayer * this_ptr, float time, app::int32_t * left_index, app::int32_t * right_index));
IL2CPP_REGISTER_METHOD(0x01BAEC70, void, __ctor, (app::ScalableAnimationPlayer * this_ptr));
}
