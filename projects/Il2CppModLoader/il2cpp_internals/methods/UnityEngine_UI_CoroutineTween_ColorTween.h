...
namespace app::methods::UnityEngine_UI_CoroutineTween::ColorTween {
IL2CPP_REGISTER_METHOD(0x001D9AC0, Color, get_startColor, (app::ColorTween__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001D9AD0, void, set_startColor, (app::ColorTween__Boxed * this_ptr, app::Color value));
IL2CPP_REGISTER_METHOD(0x001D9AE0, Color, get_targetColor, (app::ColorTween__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001D9AF0, void, set_targetColor, (app::ColorTween__Boxed * this_ptr, app::Color value));
IL2CPP_REGISTER_METHOD(0x001D9B00, ColorTween_ColorTweenMode__Enum, get_tweenMode, (app::ColorTween__Boxed * this_ptr));
