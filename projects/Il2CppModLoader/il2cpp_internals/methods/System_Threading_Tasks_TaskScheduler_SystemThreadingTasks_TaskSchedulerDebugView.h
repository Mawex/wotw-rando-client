...
IL2CPP_REGISTER_METHOD(0x016D9400, IEnumerable_1_System_Threading_Tasks_Task_ *, get_ScheduledTasks, (app::TaskScheduler_SystemThreadingTasks_TaskSchedulerDebugView * this_ptr));
}
