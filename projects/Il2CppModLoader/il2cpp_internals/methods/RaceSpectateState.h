...
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::RaceSpectateState * this_ptr, app::RaceSystem * race_system));
...
IL2CPP_REGISTER_METHOD(0x007194C0, GhostPlayer *, get_TargetGhost, (app::RaceSpectateState * this_ptr));
IL2CPP_REGISTER_METHOD(0x00719500, GhostPlayer *, get_TopGhost, (app::RaceSpectateState * this_ptr));
