...
namespace app::methods::frameworks_loading_Prewarmers::BasePrewarmOperation {
IL2CPP_REGISTER_METHOD(0x002FC6D0, PrewarmOperationType__Enum, get_OperationType, (app::BasePrewarmOperation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CC59E0, PrewarmOperationSlot__Enum, get_OperationSlot, (app::BasePrewarmOperation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_Name, (app::BasePrewarmOperation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F5E2D0, String *, ParseArgument, (app::String * flag));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::BasePrewarmOperation * this_ptr));
}
