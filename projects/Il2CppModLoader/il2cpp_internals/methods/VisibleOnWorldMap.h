...
IL2CPP_REGISTER_METHOD(0x002FBB80, ConditionUberState *, get_VisibilityCondition, (app::VisibleOnWorldMap * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008C1FD0, SerializedBooleanUberState *, get_CollectedState, (app::VisibleOnWorldMap * this_ptr));
IL2CPP_REGISTER_METHOD(0x008C2440, void, OnUpdate, (app::VisibleOnWorldMap * this_ptr, float delta));
IL2CPP_REGISTER_METHOD(0x00597B10, UpdateType__Enum, get_UpdateType, (app::VisibleOnWorldMap * this_ptr));
IL2CPP_REGISTER_METHOD(0x008C25F0, void, __ctor, (app::VisibleOnWorldMap * this_ptr));
}
