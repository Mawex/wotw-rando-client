...
namespace app::methods::UnityEngine_Experimental_XR::TrackableId {
IL2CPP_REGISTER_METHOD(0x0024AF50, String *, ToString, (app::TrackableId__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031767B0, void, __cctor, ());
}
