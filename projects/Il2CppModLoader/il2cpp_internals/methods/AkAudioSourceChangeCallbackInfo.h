...
IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkAudioSourceChangeCallbackInfo * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x026C9C30, void *, getCPtr, (app::AkAudioSourceChangeCallbackInfo * obj));
IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkAudioSourceChangeCallbackInfo * this_ptr, app::void * c_ptr));
...
IL2CPP_REGISTER_METHOD(0x026CA080, void, __ctor_2, (app::AkAudioSourceChangeCallbackInfo * this_ptr));
}
