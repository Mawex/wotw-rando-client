...
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_Name, (app::GeneralDebugMenuPage * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004371B0, IEnumerator *, GoToSceneRoutine, (app::String * scene_name));
IL2CPP_REGISTER_METHOD(0x00437300, void, __ctor, (app::GeneralDebugMenuPage * this_ptr));
