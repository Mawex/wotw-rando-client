...
IL2CPP_REGISTER_METHOD(0x013C8520, Bounds, get_Bounds, (app::VerletSoftInteraction * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x013C8E70, Vector3, GetPosition, (app::VerletSoftInteraction * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B68B50, Vector3, GetExplodePoint, (app::VerletSoftInteraction * this_ptr, app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x013C8EE0, void, __ctor, (app::VerletSoftInteraction * this_ptr));
}
