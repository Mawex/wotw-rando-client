...
namespace app::methods::FPSData {
    ...
    IL2CPP_REGISTER_METHOD(0x002FC6E0, void, __ctor, (app::FPSData * this_ptr, int32_t fps));
    ...
    IL2CPP_REGISTER_METHOD(0x008556D0, RecorderFrame_FrameDataTypes__Enum, FrameType, (app::FPSData * this_ptr));
} // namespace app::methods::FPSData
