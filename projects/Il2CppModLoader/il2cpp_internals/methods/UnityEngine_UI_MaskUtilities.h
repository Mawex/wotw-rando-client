...
namespace app::methods::UnityEngine_UI::MaskUtilities {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MaskUtilities * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x026603B0, Transform *, FindRootSortOverrideCanvas, (app::Transform * start));
...
IL2CPP_REGISTER_METHOD(0x02660AE0, RectMask2D *, GetRectMaskForClippable, (app::IClippable * clippable));
