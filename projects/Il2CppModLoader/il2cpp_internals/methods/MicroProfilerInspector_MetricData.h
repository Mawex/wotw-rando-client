...
IL2CPP_REGISTER_METHOD(0x00107C00, String *, get_MetricHeaderName, (app::MicroProfilerInspector_MetricData__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0010A860, Metric__Enum, get_Metric, (app::MicroProfilerInspector_MetricData__Boxed * this_ptr));
