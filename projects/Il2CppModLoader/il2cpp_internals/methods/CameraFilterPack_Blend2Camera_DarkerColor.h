...
IL2CPP_REGISTER_METHOD(0x02747E80, Material *, get_material, (app::CameraFilterPack_Blend2Camera_DarkerColor * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02749050, void, __ctor, (app::CameraFilterPack_Blend2Camera_DarkerColor * this_ptr));
}
