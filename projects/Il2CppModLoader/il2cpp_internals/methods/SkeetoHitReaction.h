...
IL2CPP_REGISTER_METHOD(0x0049F2B0, EntityDamageEvent *, get_DamageEvent, (app::SkeetoHitReaction * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007574B0, BehaviourStatus__Enum, OnExecuteTask, (app::SkeetoHitReaction * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00757F50, void, __ctor, (app::SkeetoHitReaction * this_ptr));
}
