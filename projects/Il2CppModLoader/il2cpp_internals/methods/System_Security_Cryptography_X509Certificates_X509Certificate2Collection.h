...
namespace app::methods::System_Security_Cryptography_X509Certificates::X509Certificate2Collection {
IL2CPP_REGISTER_METHOD(0x01C9A650, void, __ctor_1, (app::X509Certificate2Collection * this_ptr));
IL2CPP_REGISTER_METHOD(0x021C5C40, void, __ctor_2, (app::X509Certificate2Collection * this_ptr, app::X509Certificate2Collection * certificates));
IL2CPP_REGISTER_METHOD(0x021C5C70, X509Certificate2 *, get_Item, (app::X509Certificate2Collection * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x021C61D0, X509Certificate2Collection *, Find, (app::X509Certificate2Collection * this_ptr, app::X509FindType__Enum find_type, app::Object * find_value, bool valid_only));
IL2CPP_REGISTER_METHODINFO(0x0472A1B0, X509Certificate2Collection_Find__MethodInfo);
IL2CPP_REGISTER_METHOD(0x021C7150, X509Certificate2Enumerator *, GetEnumerator, (app::X509Certificate2Collection * this_ptr));
