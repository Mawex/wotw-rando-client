...
namespace app::methods::DebugMenu {
    ...
    IL2CPP_REGISTER_METHOD(0x002FB9B0, List_1_WorldEvents_*, get_WorldEvents, (app::DebugMenu * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00DED8E0, Vector2, get_HelpTextPosition, (app::DebugMenu * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00DED900, void, set_HelpTextPosition, (app::DebugMenu * this_ptr, app::Vector2 value));
    IL2CPP_REGISTER_METHOD(0x002FBD40, List_1_DebugMenu_ExternalItem_*, get_ExternalItems, (app::DebugMenu * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0049F2B0, List_1_IDebugMenuItem_*, get_AllItems, (app::DebugMenu * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00DED930, void, ResetStatics, ());
    IL2CPP_REGISTER_METHOD(0x00720040, HierarchySuspensionTest*, get_SuspensionTest, (app::DebugMenu * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00DF29C0, void, __ctor, (app::DebugMenu * this_ptr));
