...
namespace app::methods::System_Security_Cryptography::SymmetricAlgorithm {
IL2CPP_REGISTER_METHOD(0x01E0FF80, void, __ctor, (app::SymmetricAlgorithm * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E103A0, Byte__Array *, get_IV, (app::SymmetricAlgorithm * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E106D0, Byte__Array *, get_Key, (app::SymmetricAlgorithm * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E10A10, KeySizes__Array *, get_LegalBlockSizes, (app::SymmetricAlgorithm * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E10B50, KeySizes__Array *, get_LegalKeySizes, (app::SymmetricAlgorithm * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003FC830, CipherMode__Enum, get_Mode, (app::SymmetricAlgorithm * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004E57A0, PaddingMode__Enum, get_Padding, (app::SymmetricAlgorithm * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E11010, SymmetricAlgorithm *, Create_1, ());
IL2CPP_REGISTER_METHOD(0x01E11150, SymmetricAlgorithm *, Create_2, (app::String * alg_name));
IL2CPP_REGISTER_METHOD(0x01E11230, ICryptoTransform *, CreateEncryptor, (app::SymmetricAlgorithm * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E11290, ICryptoTransform *, CreateDecryptor, (app::SymmetricAlgorithm * this_ptr));
}
