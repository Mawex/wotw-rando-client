...
IL2CPP_REGISTER_METHOD(0x0124C3F0, Vector3, get_ProjectedShootPoint, (app::KwolokBossCannonBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0124D5C0, BehaviourStatus__Enum, OnExecute, (app::KwolokBossCannonBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0124E170, void, ModifyAcceleration, (app::KwolokBossCannonBehaviour * this_ptr, app::float * acceleration, app::float * deceleration));
IL2CPP_REGISTER_METHODINFO(0x047074C0, KwolokBossCannonBehaviour_ModifyAcceleration__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0124E210, void, ModifyMaxMovementSpeed, (app::KwolokBossCannonBehaviour * this_ptr, app::float * speed));
IL2CPP_REGISTER_METHODINFO(0x04768FE0, KwolokBossCannonBehaviour_ModifyMaxMovementSpeed__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0124E220, void, ModifyDesiredLookAngle, (app::KwolokBossCannonBehaviour * this_ptr, app::float * angle));
...
IL2CPP_REGISTER_METHOD(0x0124F3D0, Projectile *, SpawnProjectile, (app::KwolokBossCannonBehaviour * this_ptr, app::Vector2 shoot_point, app::Vector3 shoot_velocity));
...
IL2CPP_REGISTER_METHOD(0x01250690, Enum__Array *, GetEntries, (app::KwolokBossCannonBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x01250730, Enum, Evaluate, (app::KwolokBossCannonBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_ShouldSkip, (app::KwolokBossCannonBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x012507F0, void, __ctor, (app::KwolokBossCannonBehaviour * this_ptr));
}
