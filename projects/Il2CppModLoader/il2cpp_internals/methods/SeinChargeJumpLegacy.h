...
IL2CPP_REGISTER_METHOD(0x00A50B70, PlayerAbilities *, get_PlayerAbilities, (app::SeinChargeJumpLegacy * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement *, get_PlatformMovement, (app::SeinChargeJumpLegacy * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A50B90, SeinChargeJump *, get_ChargeJump, (app::SeinChargeJumpLegacy * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A52480, CharacterUpwardsDeceleration *, get_UpwardsDeceleration, (app::SeinChargeJumpLegacy * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A53940, void, __ctor, (app::SeinChargeJumpLegacy * this_ptr));
}
