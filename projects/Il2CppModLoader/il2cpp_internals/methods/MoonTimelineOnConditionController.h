...
IL2CPP_REGISTER_METHOD(0x014732D0, MoonTimeline *, get_OnConditionEnterResolved, (app::MoonTimelineOnConditionController * this_ptr));
IL2CPP_REGISTER_METHOD(0x014733D0, MoonTimeline *, get_OnConditionStayResolved, (app::MoonTimelineOnConditionController * this_ptr));
IL2CPP_REGISTER_METHOD(0x014734D0, MoonTimeline *, get_OnConditionExitResolved, (app::MoonTimelineOnConditionController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::MoonTimelineOnConditionController * this_ptr));
