...
IL2CPP_REGISTER_METHOD(0x01593ED0, Vector3, Flatten, (app::MessageBoxVisibility * this_ptr, app::Vector3 v));
...
IL2CPP_REGISTER_METHOD(0x0057A5A0, SuspendableMask__Enum, get_Mask, (app::MessageBoxVisibility * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x015948D0, void, __ctor, (app::MessageBoxVisibility * this_ptr));
}
