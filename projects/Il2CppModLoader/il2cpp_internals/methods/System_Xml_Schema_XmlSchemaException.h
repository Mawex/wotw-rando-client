...
namespace app::methods::System_Xml_Schema::XmlSchemaException {
...
IL2CPP_REGISTER_METHOD(0x01CA8D00, String *, CreateMessage, (app::String * res, app::String__Array * args));
IL2CPP_REGISTER_METHOD(0x002FBC20, String *, get_GetRes, (app::XmlSchemaException * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC40, String__Array *, get_Args, (app::XmlSchemaException * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC60, String *, get_SourceUri, (app::XmlSchemaException * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBCA0, XmlSchemaObject *, get_SourceSchemaObject, (app::XmlSchemaException * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01CA8E20, String *, get_Message, (app::XmlSchemaException * this_ptr));
}
