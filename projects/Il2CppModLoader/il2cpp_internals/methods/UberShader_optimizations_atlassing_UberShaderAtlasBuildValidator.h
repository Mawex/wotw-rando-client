...
namespace app::methods::UberShader_optimizations_atlassing::UberShaderAtlasBuildValidator {
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::UberShaderAtlasBuildValidator * this_ptr));
    IL2CPP_REGISTER_METHOD(0x018FD9D0, void, __cctor, ());
}
