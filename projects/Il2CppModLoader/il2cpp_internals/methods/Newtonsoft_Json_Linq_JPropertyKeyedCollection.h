...
namespace app::methods::Newtonsoft_Json_Linq::JPropertyKeyedCollection {
IL2CPP_REGISTER_METHOD(0x01F0EA40, void, __ctor, (app::JPropertyKeyedCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F0F010, String *, GetKeyForItem, (app::JPropertyKeyedCollection * this_ptr, app::JToken * item));
...
IL2CPP_REGISTER_METHOD(0x01F0F660, ICollection_1_System_String_ *, get_Keys, (app::JPropertyKeyedCollection * this_ptr));
