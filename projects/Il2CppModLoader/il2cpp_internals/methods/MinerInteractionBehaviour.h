...
IL2CPP_REGISTER_METHOD(0x0144CBC0, BehaviourStatus__Enum, OnExecute, (app::MinerInteractionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0144E060, void, __ctor, (app::MinerInteractionBehaviour * this_ptr));
