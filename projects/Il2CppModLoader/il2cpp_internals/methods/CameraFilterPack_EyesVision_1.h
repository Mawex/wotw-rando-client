...
IL2CPP_REGISTER_METHOD(0x02466DE0, Material *, get_material, (app::CameraFilterPack_EyesVision_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02467550, void, __ctor, (app::CameraFilterPack_EyesVision_1 * this_ptr));
}
