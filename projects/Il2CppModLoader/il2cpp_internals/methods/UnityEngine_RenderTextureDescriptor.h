...
IL2CPP_REGISTER_METHOD(0x00218070, void, __ctor_1, (app::RenderTextureDescriptor__Boxed * this_ptr, int32_t width, int32_t height));
IL2CPP_REGISTER_METHOD(0x002180C0, void, __ctor_2, (app::RenderTextureDescriptor__Boxed * this_ptr, int32_t width, int32_t height, app::RenderTextureFormat__Enum color_format, int32_t depth_buffer_bits));
...
IL2CPP_REGISTER_METHOD(0x00120160, RenderTextureFormat__Enum, get_colorFormat, (app::RenderTextureDescriptor__Boxed * this_ptr));
