...
namespace app::methods::Unity_IO_Compression::OutputBuffer {
...
IL2CPP_REGISTER_METHOD(0x02B7D540, OutputBuffer_BufferState, DumpState, (app::OutputBuffer * this_ptr));
IL2CPP_REGISTER_METHOD(0x02B7D570, void, RestoreState, (app::OutputBuffer * this_ptr, app::OutputBuffer_BufferState state));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::OutputBuffer * this_ptr));
}
