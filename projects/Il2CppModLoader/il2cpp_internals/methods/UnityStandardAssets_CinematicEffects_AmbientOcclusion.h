...
namespace app::methods::UnityStandardAssets_CinematicEffects::AmbientOcclusion {
...
IL2CPP_REGISTER_METHOD(0x007FBA30, AmbientOcclusion_SampleCount__Enum, get_sampleCount, (app::AmbientOcclusion * this_ptr));
IL2CPP_REGISTER_METHOD(0x024FC8F0, int32_t, get_sampleCountValue, (app::AmbientOcclusion * this_ptr));
IL2CPP_REGISTER_METHOD(0x024FCA10, AmbientOcclusion_OcclusionSource__Enum, get_occlusionSource, (app::AmbientOcclusion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024FCBB0, RenderTextureFormat__Enum, get_aoTextureFormat, (app::AmbientOcclusion * this_ptr));
IL2CPP_REGISTER_METHOD(0x024FCBE0, Shader *, get_aoShader, (app::AmbientOcclusion * this_ptr));
IL2CPP_REGISTER_METHOD(0x024FCCE0, Material *, get_aoMaterial, (app::AmbientOcclusion * this_ptr));
IL2CPP_REGISTER_METHOD(0x024FCDB0, CommandBuffer *, get_aoCommands, (app::AmbientOcclusion * this_ptr));
IL2CPP_REGISTER_METHOD(0x024FCF60, Camera *, get_targetCamera, (app::AmbientOcclusion * this_ptr));
IL2CPP_REGISTER_METHOD(0x024FCFE0, AmbientOcclusion_PropertyObserver, get_propertyObserver, (app::AmbientOcclusion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBA0, Mesh *, get_quadMesh, (app::AmbientOcclusion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024FF4C0, void, __ctor, (app::AmbientOcclusion * this_ptr));
}
