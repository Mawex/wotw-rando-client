...
namespace app::methods::System_Diagnostics_Tracing::TraceLoggingTypeInfo_1_System_Single_ {
...
IL2CPP_REGISTER_METHOD(0x02871710, TraceLoggingTypeInfo_1_System_Single_ *, get_Instance, ());
...
IL2CPP_REGISTER_METHOD(0x02877450, TraceLoggingTypeInfo_1_System_Single_ *, GetInstance, (app::List_1_System_Type_ * recursion_check));
IL2CPP_REGISTER_METHOD(0x02877640, TraceLoggingTypeInfo_1_System_Single_ *, InitInstance, ());
}
