...
namespace app::methods::UnityEngine_UI::Dropdown {
IL2CPP_REGISTER_METHOD(0x01F36670, void, __ctor, (app::Dropdown * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F2BCB0, RectTransform *, get_template, (app::Dropdown * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F36B10, void, set_template, (app::Dropdown * this_ptr, app::RectTransform * value));
IL2CPP_REGISTER_METHOD(0x01F36B20, Text *, get_captionText, (app::Dropdown * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F36B30, void, set_captionText, (app::Dropdown * this_ptr, app::Text * value));
IL2CPP_REGISTER_METHOD(0x01F36B40, Image *, get_captionImage, (app::Dropdown * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F36B50, void, set_captionImage, (app::Dropdown * this_ptr, app::Image * value));
IL2CPP_REGISTER_METHOD(0x01F36B60, Text *, get_itemText, (app::Dropdown * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F36B70, void, set_itemText, (app::Dropdown * this_ptr, app::Text * value));
IL2CPP_REGISTER_METHOD(0x01F36B80, Image *, get_itemImage, (app::Dropdown * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F36B90, void, set_itemImage, (app::Dropdown * this_ptr, app::Image * value));
IL2CPP_REGISTER_METHOD(0x01F36BA0, List_1_UnityEngine_UI_Dropdown_OptionData_ *, get_options, (app::Dropdown * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F36BF0, Dropdown_DropdownEvent *, get_onValueChanged, (app::Dropdown * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F39070, GameObject *, CreateBlocker, (app::Dropdown * this_ptr, app::Canvas * root_canvas));
IL2CPP_REGISTER_METHOD(0x01F39860, void, DestroyBlocker, (app::Dropdown * this_ptr, app::GameObject * blocker));
IL2CPP_REGISTER_METHOD(0x01F39900, GameObject *, CreateDropdownList, (app::Dropdown * this_ptr, app::GameObject * template_1));
IL2CPP_REGISTER_METHOD(0x01F399A0, void, DestroyDropdownList, (app::Dropdown * this_ptr, app::GameObject * dropdown_list));
IL2CPP_REGISTER_METHOD(0x01F39A40, Dropdown_DropdownItem *, CreateItem, (app::Dropdown * this_ptr, app::Dropdown_DropdownItem * item_template));
IL2CPP_REGISTER_METHOD(0x002FA000, void, DestroyItem, (app::Dropdown * this_ptr, app::Dropdown_DropdownItem * item));
IL2CPP_REGISTER_METHOD(0x01F39AE0, Dropdown_DropdownItem *, AddItem, (app::Dropdown * this_ptr, app::Dropdown_OptionData * data, bool selected, app::Dropdown_DropdownItem * item_template, app::List_1_UnityEngine_UI_Dropdown_DropdownItem_ * items));
...
IL2CPP_REGISTER_METHOD(0x01F3A790, IEnumerator *, DelayedDestroyDropdownList, (app::Dropdown * this_ptr, float delay));
...
IL2CPP_REGISTER_METHOD(0x0157DAE0, Object *, GetOrAddComponent_1, (app::GameObject * go));
IL2CPP_REGISTER_METHOD(0x0157DAE0, Canvas *, GetOrAddComponent_2, (app::GameObject * go));
IL2CPP_REGISTER_METHODINFO(0x04702908, Dropdown_GetOrAddComponent_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0157DAE0, GraphicRaycaster *, GetOrAddComponent_3, (app::GameObject * go));
IL2CPP_REGISTER_METHODINFO(0x047188B0, Dropdown_GetOrAddComponent_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0157DAE0, CanvasGroup *, GetOrAddComponent_4, (app::GameObject * go));
