...
namespace app::methods::System_Collections_Generic::List_1_EquipmentUIInventoryItem_ {
...
IL2CPP_REGISTER_METHOD(0x025EFC50, EquipmentUIInventoryItem *, get_Item, (app::List_1_EquipmentUIInventoryItem_ * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x0477D8B0, List_1_EquipmentUIInventoryItem__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_EquipmentUIInventoryItem_ * this_ptr));
