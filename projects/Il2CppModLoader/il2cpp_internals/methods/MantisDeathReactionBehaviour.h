...
IL2CPP_REGISTER_METHOD(0x009F84E0, BehaviourStatus__Enum, OnExecuteTask, (app::MantisDeathReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x009F9530, Vector3, ProcessRootMotion, (app::MantisDeathReactionBehaviour * this_ptr, app::Vector3 motion));
IL2CPP_REGISTER_METHOD(0x009F9580, void, __ctor, (app::MantisDeathReactionBehaviour * this_ptr));
