...
namespace app::methods::System_Collections_Generic::List_1_CatlikeCoding_TextBox_LineDescent_ {
...
IL2CPP_REGISTER_METHOD(0x02DC5DD0, LineDescent, get_Item, (app::List_1_CatlikeCoding_TextBox_LineDescent_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_CatlikeCoding_TextBox_LineDescent_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047255F8, List_1_CatlikeCoding_TextBox_LineDescent___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_CatlikeCoding_TextBox_LineDescent_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02E553E0, void, __ctor_3, (app::List_1_CatlikeCoding_TextBox_LineDescent_ * this_ptr, app::IEnumerable_1_CatlikeCoding_TextBox_LineDescent_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02E55860, Object *, ICollection_get_SyncRoot, (app::List_1_CatlikeCoding_TextBox_LineDescent_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EFDB0, Object *, IList_get_Item, (app::List_1_CatlikeCoding_TextBox_LineDescent_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_CatlikeCoding_TextBox_LineDescent_ *, AsReadOnly, (app::List_1_CatlikeCoding_TextBox_LineDescent_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02DC65F0, LineDescent, Find, (app::List_1_CatlikeCoding_TextBox_LineDescent_ * this_ptr, app::Predicate_1_CatlikeCoding_TextBox_LineDescent_ * match));
IL2CPP_REGISTER_METHOD(0x02DC66F0, List_1_CatlikeCoding_TextBox_LineDescent_ *, FindAll, (app::List_1_CatlikeCoding_TextBox_LineDescent_ * this_ptr, app::Predicate_1_CatlikeCoding_TextBox_LineDescent_ * match));
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_CatlikeCoding_TextBox_LineDescent_, GetEnumerator, (app::List_1_CatlikeCoding_TextBox_LineDescent_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025F0B50, IEnumerator_1_CatlikeCoding_TextBox_LineDescent_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_CatlikeCoding_TextBox_LineDescent_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025F0B50, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_CatlikeCoding_TextBox_LineDescent_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_CatlikeCoding_TextBox_LineDescent_ *, GetRange, (app::List_1_CatlikeCoding_TextBox_LineDescent_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, LineDescent__Array *, ToArray, (app::List_1_CatlikeCoding_TextBox_LineDescent_ * this_ptr));
