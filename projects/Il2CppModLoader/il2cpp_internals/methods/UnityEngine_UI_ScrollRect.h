...
namespace app::methods::UnityEngine_UI::ScrollRect {
IL2CPP_REGISTER_METHOD(0x02668580, void, __ctor, (app::ScrollRect * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F22F90, RectTransform *, get_content, (app::ScrollRect * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F22030, ScrollRect_MovementType__Enum, get_movementType, (app::ScrollRect * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F1A580, RectTransform *, get_viewport, (app::ScrollRect * this_ptr));
IL2CPP_REGISTER_METHOD(0x02668840, void, set_viewport, (app::ScrollRect * this_ptr, app::RectTransform * value));
IL2CPP_REGISTER_METHOD(0x02668850, Scrollbar *, get_horizontalScrollbar, (app::ScrollRect * this_ptr));
IL2CPP_REGISTER_METHOD(0x02668860, void, set_horizontalScrollbar, (app::ScrollRect * this_ptr, app::Scrollbar * value));
IL2CPP_REGISTER_METHOD(0x02668BB0, Scrollbar *, get_verticalScrollbar, (app::ScrollRect * this_ptr));
IL2CPP_REGISTER_METHOD(0x02668BC0, void, set_verticalScrollbar, (app::ScrollRect * this_ptr, app::Scrollbar * value));
IL2CPP_REGISTER_METHOD(0x02668F10, ScrollRect_ScrollbarVisibility__Enum, get_horizontalScrollbarVisibility, (app::ScrollRect * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02668F30, ScrollRect_ScrollbarVisibility__Enum, get_verticalScrollbarVisibility, (app::ScrollRect * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02668F80, ScrollRect_ScrollRectEvent *, get_onValueChanged, (app::ScrollRect * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBF0, void, set_onValueChanged, (app::ScrollRect * this_ptr, app::ScrollRect_ScrollRectEvent * value));
IL2CPP_REGISTER_METHOD(0x02668F90, RectTransform *, get_viewRect, (app::ScrollRect * this_ptr));
IL2CPP_REGISTER_METHOD(0x026690C0, Vector2, get_velocity, (app::ScrollRect * this_ptr));
IL2CPP_REGISTER_METHOD(0x026690E0, void, set_velocity, (app::ScrollRect * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x02669110, RectTransform *, get_rectTransform, (app::ScrollRect * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0266BC50, Vector2, get_normalizedPosition, (app::ScrollRect * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0266E5C0, Bounds, GetBounds, (app::ScrollRect * this_ptr));
IL2CPP_REGISTER_METHOD(0x0266E750, Bounds, InternalGetBounds, (app::Vector3__Array * corners, app::Matrix4x4 * view_world_to_local_matrix));
IL2CPP_REGISTER_METHOD(0x0266EC40, Vector2, CalculateOffset, (app::ScrollRect * this_ptr, app::Vector2 delta));
IL2CPP_REGISTER_METHOD(0x0266EC90, Vector2, InternalCalculateOffset, (app::Bounds * view_bounds, app::Bounds * content_bounds, bool horizontal, bool vertical, app::ScrollRect_MovementType__Enum movement_type, app::Vector2 * delta));
...
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, ICanvasElement_get_transform, (app::ScrollRect * this_ptr));
}
