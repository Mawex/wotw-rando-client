...
namespace app::methods::System_IO::TextWriter {
IL2CPP_REGISTER_METHOD(0x02385F00, String *, get_InitialNewLine, ());
IL2CPP_REGISTER_METHOD(0x02385F10, void, __ctor_1, (app::TextWriter * this_ptr));
IL2CPP_REGISTER_METHOD(0x02385FD0, void, __ctor_2, (app::TextWriter * this_ptr, app::IFormatProvider * format_provider));
IL2CPP_REGISTER_METHOD(0x023860A0, IFormatProvider *, get_FormatProvider, (app::TextWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02386240, String *, get_NewLine, (app::TextWriter * this_ptr));
IL2CPP_REGISTER_METHOD(0x02386250, TextWriter *, Synchronized, (app::TextWriter * writer));
