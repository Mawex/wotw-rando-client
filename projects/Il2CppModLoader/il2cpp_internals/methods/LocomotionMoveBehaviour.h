...
IL2CPP_REGISTER_METHOD(0x0064D930, Vector3, get_TargetPosition, (app::LocomotionMoveBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00855600, BehaviourStatus__Enum, get_Status, (app::LocomotionMoveBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A15650, void, set_Status, (app::LocomotionMoveBehaviour * this_ptr, app::BehaviourStatus__Enum value));
IL2CPP_REGISTER_METHOD(0x002FBD00, Nullable_1_Moon_BehaviourSystem_BehaviourStatus_, get_ForceReturnStatus, (app::LocomotionMoveBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FC8E70, BehaviourStatus__Enum, OnExecute_2, (app::LocomotionMoveBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00FC9000, void, __ctor, (app::LocomotionMoveBehaviour * this_ptr));
}
