...
IL2CPP_REGISTER_METHOD(0x007EA270, GhostFrame_FrameDataTypes__Enum, get_FrameType, (app::GhostTimeTrackingPlugin_Data * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::GhostTimeTrackingPlugin_Data * this_ptr));
}
