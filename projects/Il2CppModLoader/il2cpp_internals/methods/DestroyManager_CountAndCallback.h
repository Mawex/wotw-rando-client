...
IL2CPP_REGISTER_METHOD(0x002FB930, Action *, get_Callback, (app::DestroyManager_CountAndCallback * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::DestroyManager_CountAndCallback * this_ptr));
}
