...
namespace app::methods::Trail {
    ...
    IL2CPP_REGISTER_METHOD(0x00B02430, Vector3, get_TargetPosition, (app::Trail_1 * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x003FF7B0, SuspendableMask__Enum, get_Mask, (app::Trail_1 * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00B02FA0, void, set_Mask, (app::Trail_1 * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x00B02430, Vector3, get_Position, (app::Trail_1 * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FA000, void, set_Position, (app::Trail_1 * this_ptr, app::Vector3 value));
    IL2CPP_REGISTER_METHOD(0x00B03050, Vector3, get_Speed, (app::Trail_1 * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00B03080, void, __ctor, (app::Trail_1 * this_ptr));
} // namespace app::methods::Trail
