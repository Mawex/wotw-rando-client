...
IL2CPP_REGISTER_METHOD(0x02720EB0, MoonAnimator *, SafeResolve, (app::MoonReference_1_MoonAnimator_ * this_ptr, app::IMoonResolverContext * context));
...
IL2CPP_REGISTER_METHOD(0x02720AC0, MoonAnimator *, Resolve, (app::MoonReference_1_MoonAnimator_ * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x0476CF30, MoonReference_1_MoonAnimator__Resolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027206E0, void, __ctor, (app::MoonReference_1_MoonAnimator_ * this_ptr, app::MoonReference_1_MoonAnimator_ * moon_ref));
