...
namespace app::methods::SystemIntegration_Synchronizer::DataProvider {
IL2CPP_REGISTER_METHOD(0x005332A0, bool, get_HasSynchronised, (app::DataProvider * this_ptr));
IL2CPP_REGISTER_METHOD(0x00533330, CacheData__Array *, get_Remote, (app::DataProvider * this_ptr));
IL2CPP_REGISTER_METHOD(0x005333C0, CacheData__Array *, get_Local, (app::DataProvider * this_ptr));
IL2CPP_REGISTER_METHOD(0x00533450, void, __ctor, (app::DataProvider * this_ptr, app::IServiceSynchronizer * service_synchronizer));
