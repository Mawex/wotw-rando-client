...
namespace app::methods::Moon_Race::ReplayValidator {
...
IL2CPP_REGISTER_METHOD(0x00C49AF0, ReplayValidator_ValidReason, IsValidReason, (app::String * race_id, app::String * replay_data, int32_t score, app::ReplayValidatorData * validator_data, app::RaceSettings * race_settings, bool uploading));
