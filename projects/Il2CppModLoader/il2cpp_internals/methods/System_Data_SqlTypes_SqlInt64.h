...
namespace app::methods::System_Data_SqlTypes::SqlInt64 {
    ...
    IL2CPP_REGISTER_METHOD(0x022B3C70, app::SqlInt64, operator__1, (int64_t x));
    IL2CPP_REGISTER_METHOD(0x001E4F30, app::String *, ToString, (app::SqlInt64__Boxed * this_ptr));
    IL2CPP_REGISTER_METHOD(0x022B3C80, app::SqlInt64, operator___1, (app::SqlInt64 x));
    IL2CPP_REGISTER_METHOD(0x022B3D80, app::SqlInt64, operator___2, (app::SqlInt64 x, app::SqlInt64 y));
    IL2CPP_REGISTER_METHODINFO(0x04716380, SqlInt64_op_Addition__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x022B3F40, app::SqlInt64, operator___3, (app::SqlInt64 x, app::SqlInt64 y));
    IL2CPP_REGISTER_METHODINFO(0x04744BB0, SqlInt64_op_Subtraction__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x022B4100, app::SqlInt64, operator___4, (app::SqlInt64 x, app::SqlInt64 y));
    IL2CPP_REGISTER_METHODINFO(0x04738168, SqlInt64_op_Multiply__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x022B4400, app::SqlInt64, operator___5, (app::SqlInt64 x, app::SqlInt64 y));
    IL2CPP_REGISTER_METHODINFO(0x04701A30, SqlInt64_op_Division__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x022B45C0, app::SqlInt64, operator___6, (app::SqlInt64 x, app::SqlInt64 y));
    IL2CPP_REGISTER_METHODINFO(0x04764058, SqlInt64_op_Modulus__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x022B4780, app::SqlInt64, operator__2, (app::SqlByte x));
    IL2CPP_REGISTER_METHOD(0x022B48C0, app::SqlInt64, operator__3, (app::SqlInt16 x));
    IL2CPP_REGISTER_METHOD(0x022B4A00, app::SqlInt64, operator__4, (app::SqlInt32 x));
    IL2CPP_REGISTER_METHOD(0x022B4B40, app::SqlInt64, operator__5, (app::SqlDecimal x));
    ...
    IL2CPP_REGISTER_METHOD(0x022B4DB0, app::SqlBoolean, operator___, (app::SqlInt64 x, app::SqlInt64 y));
    IL2CPP_REGISTER_METHOD(0x022B4EA0, app::SqlBoolean, operator___7, (app::SqlInt64 x, app::SqlInt64 y));
    IL2CPP_REGISTER_METHOD(0x022B4F90, app::SqlBoolean, operator___8, (app::SqlInt64 x, app::SqlInt64 y));
