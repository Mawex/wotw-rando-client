...
namespace app::methods::System_Configuration::SettingElementCollection {
IL2CPP_REGISTER_METHOD(0x02962560, void, __ctor, (app::SettingElementCollection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04785788, SettingElementCollection__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02962590, ConfigurationElementCollectionType__Enum, get_CollectionType, (app::SettingElementCollection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04755B40, SettingElementCollection_get_CollectionType__MethodInfo);
IL2CPP_REGISTER_METHOD(0x029625C0, String *, get_ElementName, (app::SettingElementCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02962650, ConfigurationElement *, CreateNewElement, (app::SettingElementCollection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0477E278, SettingElementCollection_CreateNewElement__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02962680, SettingElement *, Get, (app::SettingElementCollection * this_ptr, app::String * element_key));
IL2CPP_REGISTER_METHODINFO(0x04749728, SettingElementCollection_Get__MethodInfo);
IL2CPP_REGISTER_METHOD(0x029626B0, Object *, GetElementKey, (app::SettingElementCollection * this_ptr, app::ConfigurationElement * element));
