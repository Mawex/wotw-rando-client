...
namespace app::methods::Moon_Timeline::ScaleAxisTweenAnimator {
IL2CPP_REGISTER_METHOD(0x01E7F860, Transform *, get_TransformTarget, (app::ScaleAxisTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E7F8F0, Transform *, get_EffectiveTransform, (app::ScaleAxisTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E7F9C0, GameObject *, get_ExternalTarget, (app::ScaleAxisTweenAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E808E0, bool, ApproximateEvent, (app::ScaleAxisTweenAnimator * this_ptr, int32_t evt, app::float * time));
IL2CPP_REGISTER_METHOD(0x01E80B30, void, __ctor, (app::ScaleAxisTweenAnimator * this_ptr));
}
