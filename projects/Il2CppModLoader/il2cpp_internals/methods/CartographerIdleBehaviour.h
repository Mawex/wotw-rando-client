...
IL2CPP_REGISTER_METHOD(0x00B41C60, BehaviourStatus__Enum, OnExecuteTask, (app::CartographerIdleBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x005B3EC0, void, __ctor, (app::CartographerIdleBehaviour * this_ptr));
}
