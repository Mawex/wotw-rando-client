...
namespace app::methods::System_Collections_ObjectModel::ReadOnlyCollection_1_UnityEngine_Resolution_ {
IL2CPP_REGISTER_METHOD(0x02B7DCF0, void, __ctor, (app::ReadOnlyCollection_1_UnityEngine_Resolution_ * this_ptr, app::IList_1_UnityEngine_Resolution_ * list));
IL2CPP_REGISTER_METHOD(0x02B7DD20, int32_t, get_Count, (app::ReadOnlyCollection_1_UnityEngine_Resolution_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02E41B30, Resolution, get_Item, (app::ReadOnlyCollection_1_UnityEngine_Resolution_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02B7DF30, IEnumerator_1_UnityEngine_Resolution_ *, GetEnumerator, (app::ReadOnlyCollection_1_UnityEngine_Resolution_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02E41B30, Resolution, System_Collections_Generic_IList_T__get_Item, (app::ReadOnlyCollection_1_UnityEngine_Resolution_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02ED1640, IEnumerator *, IEnumerable_GetEnumerator, (app::ReadOnlyCollection_1_UnityEngine_Resolution_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02ED16D0, Object *, ICollection_get_SyncRoot, (app::ReadOnlyCollection_1_UnityEngine_Resolution_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02E423A0, Object *, IList_get_Item, (app::ReadOnlyCollection_1_UnityEngine_Resolution_ * this_ptr, int32_t index));
