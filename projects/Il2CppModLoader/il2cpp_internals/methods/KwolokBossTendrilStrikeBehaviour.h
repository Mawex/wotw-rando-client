...
IL2CPP_REGISTER_METHOD(0x012EE6E0, void, ModifyPostAttackCooldown, (app::KwolokBossTendrilStrikeBehaviour * this_ptr, app::bool * cooldown));
...
IL2CPP_REGISTER_METHOD(0x012EF250, BehaviourStatus__Enum, OnExecute, (app::KwolokBossTendrilStrikeBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x012F0110, Vector2, GetClosestPointInPath, (app::KwolokBossTendrilStrikeBehaviour * this_ptr, app::Vector3 pos));
IL2CPP_REGISTER_METHOD(0x012F0340, void, __ctor, (app::KwolokBossTendrilStrikeBehaviour * this_ptr));
}
