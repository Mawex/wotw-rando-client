...
namespace app::methods::PetrifiedOwlBossDiveBombHorizontalBehaviour_WaitState {
    IL2CPP_REGISTER_METHOD(0x004A0790, void, __ctor, (app::PetrifiedOwlBossDiveBombHorizontalBehaviour_WaitState * this_ptr, app::PetrifiedOwlBossDiveBombHorizontalBehaviour * behaviour));
