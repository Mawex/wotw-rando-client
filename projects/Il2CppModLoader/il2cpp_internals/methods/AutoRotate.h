...
namespace app::methods::AutoRotate {
    ...
    IL2CPP_REGISTER_METHOD(0x0085D010, Quaternion, ZOnlyQuaternion, (app::AutoRotate * this_ptr, float z_angle));
    ...
    IL2CPP_REGISTER_METHOD(0x0085DCE0, void, __ctor, (app::AutoRotate * this_ptr));
