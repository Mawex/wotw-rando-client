...
IL2CPP_REGISTER_METHOD(0x00B82AD0, void, __ctor, (app::DemoTimeoutTimeMenuItem * this_ptr, app::String * path, app::String * str, app::DemoTimeoutTimeMenuItem_TimeoutType__Enum type));
