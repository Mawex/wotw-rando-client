...
IL2CPP_REGISTER_METHOD(0x02720EB0, MoonTrail *, SafeResolve, (app::MoonReference_1_MoonTrail_ * this_ptr, app::IMoonResolverContext * context));
...
IL2CPP_REGISTER_METHOD(0x02720AC0, MoonTrail *, Resolve, (app::MoonReference_1_MoonTrail_ * this_ptr, app::IMoonResolverContext * context));
