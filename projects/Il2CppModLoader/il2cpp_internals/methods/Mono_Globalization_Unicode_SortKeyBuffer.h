...
namespace app::methods::Mono_Globalization_Unicode::SortKeyBuffer {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::SortKeyBuffer * this_ptr, int32_t lcid));
...
IL2CPP_REGISTER_METHOD(0x023C4AB0, void, AppendBufferPrimitive, (app::SortKeyBuffer * this_ptr, uint8_t value, app::Byte__Array * * buf, app::int32_t * bidx));
IL2CPP_REGISTER_METHOD(0x023C4BB0, SortKey *, GetResultAndReset, (app::SortKeyBuffer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x023C4C40, SortKey *, GetResult, (app::SortKeyBuffer * this_ptr));
}
