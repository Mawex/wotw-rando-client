...
namespace app::methods::AmbienceZone {
    IL2CPP_REGISTER_METHOD(0x004F7280, Rect, get_EditorBounds, (app::AmbienceZone * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0043D9E0, SelectableCategory__Enum, get_Category, (app::AmbienceZone * this_ptr));
    IL2CPP_REGISTER_METHOD(0x004F8FA0, void, __ctor, (app::AmbienceZone * this_ptr));
} // namespace app::methods::AmbienceZone
