...
IL2CPP_REGISTER_METHOD(0x00E21D20, GhostFrame_FrameDataTypes__Enum, get_FrameType, (app::GhostLineRendererPlugin_LineRendererData * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, int32_t, GetDataSize, (app::GhostLineRendererPlugin_LineRendererData * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E21D30, void, __ctor, (app::GhostLineRendererPlugin_LineRendererData * this_ptr));
