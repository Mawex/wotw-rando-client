...
IL2CPP_REGISTER_METHOD(0x01E838F0, IConstrainedEntity *, GetConstrainedEntityFrom, (app::TimelineConstrainedTimelineEntity * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x01E839C0, IConstrainedEntity *, GetConstrainedEntity, (app::TimelineConstrainedTimelineEntity * this_ptr, app::EntityId entity_id));
...
IL2CPP_REGISTER_METHOD(0x002FB930, MoonTimeline *, get_GetTimeline, (app::TimelineConstrainedTimelineEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, ITimelineEntityParent *, get_GetITimelineEntityParent, (app::TimelineConstrainedTimelineEntity * this_ptr));
