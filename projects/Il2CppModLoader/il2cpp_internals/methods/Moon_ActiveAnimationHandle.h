...
IL2CPP_REGISTER_METHOD(0x001B48E0, void, __ctor, (app::ActiveAnimationHandle__Boxed * this_ptr, app::IActiveAnimation * active_animation));
...
IL2CPP_REGISTER_METHOD(0x001B4900, IAnimation *, get_Animation, (app::ActiveAnimationHandle__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x001B49B0, Func_1_Boolean_ *, get_ContinueCondition, (app::ActiveAnimationHandle__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x001B4A70, Action *, get_OnStartedPlaying, (app::ActiveAnimationHandle__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001B4A80, void, set_OnStartedPlaying, (app::ActiveAnimationHandle__Boxed * this_ptr, app::Action * value));
IL2CPP_REGISTER_METHOD(0x001B4A90, Action *, get_OnStoppedPlaying, (app::ActiveAnimationHandle__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001B4AA0, void, set_OnStoppedPlaying, (app::ActiveAnimationHandle__Boxed * this_ptr, app::Action * value));
IL2CPP_REGISTER_METHOD(0x001B4AB0, Nullable_1_Single_, get_CroffadeTimeOverride, (app::ActiveAnimationHandle__Boxed * this_ptr));
