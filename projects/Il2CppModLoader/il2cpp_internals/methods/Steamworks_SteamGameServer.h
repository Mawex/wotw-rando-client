...
IL2CPP_REGISTER_METHOD(0x027F1530, void, LogOnAnonymous, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x027F15E0, void, LogOff, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x027F1690, bool, BLoggedOn, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x027F1740, bool, BSecure, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x027F17F0, CSteamID, GetSteamID, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x027F1920, bool, WasRestartRequested, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x027F24F0, void, ClearAllKeyValues, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x027F3320, CSteamID, CreateUnauthenticatedUserConnection, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x027F3D70, void, GetGameplayStats, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x027F3E20, SteamAPICall_t, GetServerReputation, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x027F3F50, uint32_t, GetPublicIP, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x027F4370, void, ForceHeartbeat, (MethodInfo * method));
