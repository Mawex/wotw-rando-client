...
namespace app::methods::LeakDetector {
    ...
    IL2CPP_REGISTER_METHOD(0x015C2DE0, String*, GetTexturePath, (app::String * texture_name));
    IL2CPP_REGISTER_METHOD(0x015C2F80, void, __ctor, (app::LeakDetector * this_ptr));
