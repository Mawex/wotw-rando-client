...
IL2CPP_REGISTER_METHOD(0x00CE3830, TargetSpheres_Sphere *, GetRandomSphereFromClosestGroup, (app::TargetSpheres * this_ptr, app::Transform * transform, app::Vector3 position));
...
IL2CPP_REGISTER_METHOD(0x00CE45A0, void, __ctor, (app::TargetSpheres * this_ptr));
}
