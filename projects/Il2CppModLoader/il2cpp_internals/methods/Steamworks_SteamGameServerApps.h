...
IL2CPP_REGISTER_METHOD(0x027F4850, bool, BGetDLCDataByIndex, (int32_t i_d_l_c, app::AppId_t * p_app_i_d, app::bool * pb_available, app::String * * pch_name, int32_t cch_name_buffer_size));
...
IL2CPP_REGISTER_METHOD(0x027F4DE0, String *, GetLaunchQueryParam, (app::String * pch_key));
IL2CPP_REGISTER_METHOD(0x027F4FF0, bool, GetDlcDownloadProgress, (app::AppId_t n_app_i_d, app::uint64_t * pun_bytes_downloaded, app::uint64_t * pun_bytes_total));
...
IL2CPP_REGISTER_METHOD(0x027F5080, SteamAPICall_t, GetFileDetails, (app::String * psz_file_name));
