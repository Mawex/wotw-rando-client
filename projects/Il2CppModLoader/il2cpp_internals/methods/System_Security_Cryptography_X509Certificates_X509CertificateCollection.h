...
namespace app::methods::System_Security_Cryptography_X509Certificates::X509CertificateCollection {
IL2CPP_REGISTER_METHOD(0x01C9A650, void, __ctor_1, (app::X509CertificateCollection_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x021CB260, void, __ctor_2, (app::X509CertificateCollection_1 * this_ptr, app::X509Certificate_1__Array * value));
IL2CPP_REGISTER_METHOD(0x021CB380, void, __ctor_3, (app::X509CertificateCollection_1 * this_ptr, app::X509CertificateCollection_1 * value));
IL2CPP_REGISTER_METHOD(0x021CB4D0, X509Certificate_1 *, get_Item, (app::X509CertificateCollection_1 * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x021CB910, X509CertificateCollection_X509CertificateEnumerator_1 *, GetEnumerator, (app::X509CertificateCollection_1 * this_ptr));
