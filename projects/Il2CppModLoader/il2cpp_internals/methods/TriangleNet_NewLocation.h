...
IL2CPP_REGISTER_METHOD(0x02B16840, void, __ctor, (app::NewLocation * this_ptr, app::Mesh_1 * mesh, app::IPredicates * predicates));
IL2CPP_REGISTER_METHOD(0x02B169D0, Point *, FindLocation, (app::NewLocation * this_ptr, app::Vertex * org, app::Vertex * dest, app::Vertex * apex, app::double * xi, app::double * eta, bool offcenter, app::Otri badotri));
IL2CPP_REGISTER_METHOD(0x02B16A90, Point *, FindNewLocationWithoutMaxAngle, (app::NewLocation * this_ptr, app::Vertex * torg, app::Vertex * tdest, app::Vertex * tapex, app::double * xi, app::double * eta, bool offcenter, app::Otri badotri));
IL2CPP_REGISTER_METHOD(0x02B18EB0, Point *, FindNewLocation, (app::NewLocation * this_ptr, app::Vertex * torg, app::Vertex * tdest, app::Vertex * tapex, app::double * xi, app::double * eta, bool offcenter, app::Otri badotri));
