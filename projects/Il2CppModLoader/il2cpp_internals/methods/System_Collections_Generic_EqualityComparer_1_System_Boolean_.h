...
namespace app::methods::System_Collections_Generic::EqualityComparer_1_System_Boolean_ {
IL2CPP_REGISTER_METHOD(0x02807CD0, EqualityComparer_1_System_Boolean_ *, get_Default, ());
IL2CPP_REGISTER_METHOD(0x02D9A7D0, EqualityComparer_1_System_Boolean_ *, CreateComparer, ());
...
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::EqualityComparer_1_System_Boolean_ * this_ptr));
}
