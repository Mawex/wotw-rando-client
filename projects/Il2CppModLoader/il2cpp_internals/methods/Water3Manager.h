...
IL2CPP_REGISTER_METHOD(0x02D76260, Texture2D *, GetDisplacementHeightMap, (app::Water3Manager * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02D766F0, Color, GetMaterialColor, (app::Water3Manager * this_ptr, int32_t name));
IL2CPP_REGISTER_METHOD(0x02D76790, void, SetMaterialColor, (app::Water3Manager * this_ptr, int32_t name, app::Color color));
IL2CPP_REGISTER_METHOD(0x02D76810, Vector4, GetMaterialVector, (app::Water3Manager * this_ptr, int32_t name));
IL2CPP_REGISTER_METHOD(0x02D768B0, void, SetMaterialVector, (app::Water3Manager * this_ptr, int32_t name, app::Vector4 vector));
IL2CPP_REGISTER_METHOD(0x02D76960, Texture *, GetMaterialTexture, (app::Water3Manager * this_ptr, int32_t the_name));
...
IL2CPP_REGISTER_METHOD(0x02D77510, void, __ctor, (app::Water3Manager * this_ptr));
