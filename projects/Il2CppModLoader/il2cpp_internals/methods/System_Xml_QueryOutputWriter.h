...
namespace app::methods::System_Xml::QueryOutputWriter {
IL2CPP_REGISTER_METHOD(0x0199E650, void, __ctor, (app::QueryOutputWriter * this_ptr, app::XmlRawWriter * writer, app::XmlWriterSettings * settings));
