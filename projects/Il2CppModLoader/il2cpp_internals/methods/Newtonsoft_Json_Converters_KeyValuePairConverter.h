...
namespace app::methods::Newtonsoft_Json_Converters::KeyValuePairConverter {
IL2CPP_REGISTER_METHOD(0x01A53E30, ReflectionObject *, InitializeReflectionObject, (app::Type * t));
...
IL2CPP_REGISTER_METHOD(0x01A543D0, Object *, ReadJson, (app::KeyValuePairConverter * this_ptr, app::JsonReader * reader, app::Type * object_type, app::Object * existing_value, app::JsonSerializer * serializer));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::KeyValuePairConverter * this_ptr));
