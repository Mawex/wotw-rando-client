...
namespace app::methods::System_Xml_Schema::XsdBuilder {
IL2CPP_REGISTER_METHOD(0x01938610, void, __ctor, (app::XsdBuilder * this_ptr, app::XmlReader * reader, app::XmlNamespaceManager * curmgr, app::XmlSchema * schema, app::XmlNameTable * name_table, app::SchemaNames * schema_names, app::ValidationEventHandler * eventhandler));
...
IL2CPP_REGISTER_METHOD(0x01939E80, SchemaNames_Token__Enum, get_CurrentElement, (app::XsdBuilder * this_ptr));
IL2CPP_REGISTER_METHOD(0x01939EA0, SchemaNames_Token__Enum, get_ParentElement, (app::XsdBuilder * this_ptr));
IL2CPP_REGISTER_METHOD(0x01939F60, XmlSchemaObject *, get_ParentContainer, (app::XsdBuilder * this_ptr));
IL2CPP_REGISTER_METHOD(0x0193A050, XmlSchemaObject *, GetContainer, (app::XsdBuilder * this_ptr, app::XsdBuilder_State__Enum state));
...
IL2CPP_REGISTER_METHOD(0x01943180, XmlQualifiedName *, ParseQName, (app::XsdBuilder * this_ptr, app::String * value, app::String * attribute_name));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, String *, ParseUriReference, (app::String * s));
