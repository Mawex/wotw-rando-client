...
namespace app::methods::UnityEngine_Events::InvokableCall_1_UnityEngine_Vector2_ {
    IL2CPP_REGISTER_METHOD(0x02AC63F0, void, __ctor_1, (app::InvokableCall_1_UnityEngine_Vector2_ * this_ptr, app::Object * target, app::MethodInfo_1 * the_function));
    IL2CPP_REGISTER_METHOD(0x02722840, void, __ctor_2, (app::InvokableCall_1_UnityEngine_Vector2_ * this_ptr, app::UnityAction_1_UnityEngine_Vector2_ * action));
