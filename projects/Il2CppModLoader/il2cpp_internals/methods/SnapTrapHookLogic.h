...
IL2CPP_REGISTER_METHOD(0x007008C0, IMoonSetupAnimator *, get_MoonSetupAnimator, (app::SnapTrapHookLogic * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00ED34A0, void, __ctor, (app::SnapTrapHookLogic * this_ptr));
}
