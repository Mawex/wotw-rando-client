...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::Action_1_Moon_TimeSlicer_SliceExecutionStats_ * this_ptr, app::Object * object, app::void * method_1));
IL2CPP_REGISTER_METHODINFO(0x0473D358, Action_1_Moon_TimeSlicer_SliceExecutionStats___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02A01000, IAsyncResult *, BeginInvoke, (app::Action_1_Moon_TimeSlicer_SliceExecutionStats_ * this_ptr, app::SliceExecutionStats obj, app::AsyncCallback * callback, app::Object * object));
