...
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_Name, (app::HierarchyDebugMenuPage * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9B0, IDebugMenuPage *, get_Page, (app::HierarchyDebugMenuPage * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B54390, void, __ctor, (app::HierarchyDebugMenuPage * this_ptr));
}
