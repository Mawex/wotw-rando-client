...
namespace app::methods::Moon_Telemetry_Performance_Settings::DistortionProfilingSetting {
IL2CPP_REGISTER_METHOD(0x00AD8BA0, ProfilingSettings_SettingType__Enum, get_SettingType, (app::DistortionProfilingSetting * this_ptr));
