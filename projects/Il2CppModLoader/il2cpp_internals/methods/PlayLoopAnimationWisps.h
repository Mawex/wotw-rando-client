...
IL2CPP_REGISTER_METHOD(0x01179690, MoonAnimator *, get_Animator, (app::PlayLoopAnimationWisps * this_ptr));
IL2CPP_REGISTER_METHOD(0x01179770, MoonAnimation *, get_Animation, (app::PlayLoopAnimationWisps * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00608710, SuspendableMask__Enum, get_Mask, (app::PlayLoopAnimationWisps * this_ptr));
IL2CPP_REGISTER_METHOD(0x01179850, void, set_Mask, (app::PlayLoopAnimationWisps * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x003FF7B0, UpdateType__Enum, get_UpdateType, (app::PlayLoopAnimationWisps * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01179DC0, void, __ctor, (app::PlayLoopAnimationWisps * this_ptr));
}
