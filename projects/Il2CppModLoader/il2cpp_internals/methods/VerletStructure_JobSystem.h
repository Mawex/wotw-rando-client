...
IL2CPP_REGISTER_METHOD(0x013CEDE0, void, Finalize, (VerletStructure_JobSystem * __this));
IL2CPP_REGISTER_METHOD(0x013CEE80, void, Dispose, (VerletStructure_JobSystem * __this));
IL2CPP_REGISTER_METHOD(0x013CEEB0, void, Execute, (VerletStructure_JobSystem * __this, float dt));
