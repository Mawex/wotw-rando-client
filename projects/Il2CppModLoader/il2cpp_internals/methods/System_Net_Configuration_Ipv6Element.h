...
namespace app::methods::System_Net_Configuration::Ipv6Element {
IL2CPP_REGISTER_METHOD(0x02019B90, void, __ctor, (app::Ipv6Element * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02019C20, ConfigurationPropertyCollection *, get_Properties, (app::Ipv6Element * this_ptr));
