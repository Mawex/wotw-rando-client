...
IL2CPP_REGISTER_METHOD(0x00C906C0, String__Array *, GetDataHeaderNames, (app::EntityDataCaptureAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C90740, void, OnInitialize, (app::EntityDataCaptureAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C907E0, String__Array *, GetFrameData, (app::EntityDataCaptureAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, OnTestEnd, (app::EntityDataCaptureAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::EntityDataCaptureAgent * this_ptr));
}
