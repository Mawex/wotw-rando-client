...
IL2CPP_REGISTER_METHOD(0x002FB930, Dictionary_2_Moon_AnimationParameter_Moon_AnimationParameter_Instance_ *, get_Parameters, (app::AnimationParameterSet * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01B03AF0, Vector3, GetValue_2, (app::AnimationParameterSet * this_ptr, app::VectorAnimationParameter * parameter));
...
IL2CPP_REGISTER_METHOD(0x01B03F40, void, __ctor, (app::AnimationParameterSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B04180, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x01EB8980, List_1_System_Object_ *, GetParametersOfType_1, (app::AnimationParameterSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x015EBAB0, Object *, GetParameterInstance_1, (app::AnimationParameterSet * this_ptr, app::AnimationParameter * parameter));
IL2CPP_REGISTER_METHOD(0x015EBAB0, FloatAnimationParameter_Instance *, GetParameterInstance_2, (app::AnimationParameterSet * this_ptr, app::AnimationParameter * parameter));
IL2CPP_REGISTER_METHODINFO(0x04719B68, AnimationParameterSet_GetParameterInstance_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015EBAB0, VectorAnimationParameter_Instance *, GetParameterInstance_3, (app::AnimationParameterSet * this_ptr, app::AnimationParameter * parameter));
IL2CPP_REGISTER_METHODINFO(0x04748A48, AnimationParameterSet_GetParameterInstance_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EB8980, List_1_Moon_FloatAnimationParameter_ *, GetParametersOfType_2, (app::AnimationParameterSet * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04725610, AnimationParameterSet_GetParametersOfType_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EB8980, List_1_Moon_VectorAnimationParameter_ *, GetParametersOfType_3, (app::AnimationParameterSet * this_ptr));
