...
namespace app::methods::System_Data_Common::UInt16Storage {
IL2CPP_REGISTER_METHOD(0x02866120, void, __ctor, (app::UInt16Storage * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x02866270, Object *, Aggregate, (app::UInt16Storage * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x02866DC0, Object *, ConvertValue, (app::UInt16Storage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02159340, void, Copy, (app::UInt16Storage * this_ptr, int32_t record_no1, int32_t record_no2));
IL2CPP_REGISTER_METHOD(0x02866EF0, Object *, Get, (app::UInt16Storage * this_ptr, int32_t record));
...
IL2CPP_REGISTER_METHOD(0x02867350, Object *, ConvertXmlToObject, (app::UInt16Storage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x02867430, String *, ConvertObjectToXml, (app::UInt16Storage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02867510, Object *, GetEmptyStorage, (app::UInt16Storage * this_ptr, int32_t record_count));
