...
namespace app::methods::System_Collections_Generic::Queue_1_T__Enumerator_QuestsController_QueuedQuestMessage_ {
    IL2CPP_REGISTER_METHOD(0x001ECB90, void, __ctor, (app::Queue_1_T_Enumerator_QuestsController_QueuedQuestMessage___Boxed * this_ptr, app::Queue_1_QuestsController_QueuedQuestMessage_ * q));
