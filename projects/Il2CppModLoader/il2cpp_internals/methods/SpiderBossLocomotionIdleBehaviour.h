...
IL2CPP_REGISTER_METHOD(0x011B5740, MoonTimeline *, GetIdleAnimation, (app::SpiderBossLocomotionIdleBehaviour * this_ptr, app::SpiderBossLocationZone__Enum location_zone));
...
IL2CPP_REGISTER_METHOD(0x011B6050, BehaviourStatus__Enum, OnExecuteTask, (app::SpiderBossLocomotionIdleBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x005B3EC0, void, __ctor, (app::SpiderBossLocomotionIdleBehaviour * this_ptr));
}
