...
IL2CPP_REGISTER_METHOD(0x00A07580, BehaviourStatus__Enum, OnExecute, (app::MantisJumpAttackBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00A07BE0, Switch_1 *, GetSoundSwitchForIndex, (app::MantisJumpAttackBehaviour * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x00A083A0, Vector3, ProcessRootMotion, (app::MantisJumpAttackBehaviour * this_ptr, app::Vector3 motion));
IL2CPP_REGISTER_METHODINFO(0x04742EC8, MantisJumpAttackBehaviour_ProcessRootMotion__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00A084E0, void, __ctor, (app::MantisJumpAttackBehaviour * this_ptr));
}
