...
namespace app::methods::System_Collections_ObjectModel::ReadOnlyCollection_1_Moon_Trail_Point_ {
IL2CPP_REGISTER_METHOD(0x02B7DCF0, void, __ctor, (app::ReadOnlyCollection_1_Moon_Trail_Point_ * this_ptr, app::IList_1_Moon_Trail_Point_ * list));
IL2CPP_REGISTER_METHOD(0x02B7DD20, int32_t, get_Count, (app::ReadOnlyCollection_1_Moon_Trail_Point_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02E46C30, Trail_Point, get_Item, (app::ReadOnlyCollection_1_Moon_Trail_Point_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02B7DF30, IEnumerator_1_Moon_Trail_Point_ *, GetEnumerator, (app::ReadOnlyCollection_1_Moon_Trail_Point_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02E46C30, Trail_Point, System_Collections_Generic_IList_T__get_Item, (app::ReadOnlyCollection_1_Moon_Trail_Point_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02E46E70, IEnumerator *, IEnumerable_GetEnumerator, (app::ReadOnlyCollection_1_Moon_Trail_Point_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02E46F00, Object *, ICollection_get_SyncRoot, (app::ReadOnlyCollection_1_Moon_Trail_Point_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02E474D0, Object *, IList_get_Item, (app::ReadOnlyCollection_1_Moon_Trail_Point_ * this_ptr, int32_t index));
