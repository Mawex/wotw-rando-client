...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::BrowserNative_Calltype_zfb_setZoom * this_ptr, app::Object * object, app::void * method_1));
IL2CPP_REGISTER_METHOD(0x01DCC050, void, Invoke, (app::BrowserNative_Calltype_zfb_setZoom * this_ptr, int32_t id, double zoom));
IL2CPP_REGISTER_METHOD(0x01DCC3C0, IAsyncResult *, BeginInvoke, (app::BrowserNative_Calltype_zfb_setZoom * this_ptr, int32_t id, double zoom, app::AsyncCallback * callback, app::Object * object));
