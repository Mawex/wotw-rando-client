...
IL2CPP_REGISTER_METHOD(0x001206F0, AsyncRaycast_Result__Enum, get_ArcResult, (app::Sensor_SensorLineOfSightRequest__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0010E170, Sensor_SensorLineOfSightRequest_State__Enum, get_CurrentState, (app::Sensor_SensorLineOfSightRequest__Boxed * this_ptr));
