...
IL2CPP_REGISTER_METHOD(0x01BAB3B0, Quaternion, Update, (app::MoveTowardsQuaternionTweenable * this_ptr, app::Quaternion current_value, app::Quaternion start_value, app::Quaternion end_value, float speed));
