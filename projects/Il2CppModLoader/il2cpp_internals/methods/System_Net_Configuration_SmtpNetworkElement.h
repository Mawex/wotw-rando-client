...
namespace app::methods::System_Net_Configuration::SmtpNetworkElement {
IL2CPP_REGISTER_METHOD(0x01E98CF0, void, __ctor, (app::SmtpNetworkElement * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04755560, SmtpNetworkElement__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E98D20, String *, get_ClientDomain, (app::SmtpNetworkElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E98E40, String *, get_Host, (app::SmtpNetworkElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E98EA0, String *, get_Password, (app::SmtpNetworkElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E98F60, ConfigurationPropertyCollection *, get_Properties, (app::SmtpNetworkElement * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04706C60, SmtpNetworkElement_get_Properties__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E98F90, String *, get_TargetName, (app::SmtpNetworkElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E98FF0, String *, get_UserName, (app::SmtpNetworkElement * this_ptr));
