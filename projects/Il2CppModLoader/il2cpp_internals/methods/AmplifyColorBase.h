...
IL2CPP_REGISTER_METHOD(0x030D48D0, Texture2D *, get_DefaultLut, (app::AmplifyColorBase * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030D4AA0, String *, get_SharedInstanceID, (app::AmplifyColorBase * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030D6FE0, Texture2D *, CreateDefaultLut, (app::AmplifyColorBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x030D7420, Texture2D *, CreateDepthCurveLut, (app::AmplifyColorBase * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030DA7A0, void, __ctor, (app::AmplifyColorBase * this_ptr));
