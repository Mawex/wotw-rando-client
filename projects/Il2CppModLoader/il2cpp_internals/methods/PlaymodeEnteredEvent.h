...
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Scene, (app::PlaymodeEnteredEvent * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_Scene, (app::PlaymodeEnteredEvent * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x02EA0730, DatadogEvent *, GetCompatibleEvent, (app::PlaymodeEnteredEvent * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::PlaymodeEnteredEvent * this_ptr));
}
