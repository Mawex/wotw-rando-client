...
namespace app::methods::Moon_InteractionGraph::TimelineNode {
IL2CPP_REGISTER_METHOD(0x01993A90, List_1_Moon_Timeline_MoonTimeline_ *, get_ResolvedTimelines, (app::TimelineNode * this_ptr));
IL2CPP_REGISTER_METHOD(0x01993D10, MoonTimeline *, get_CurrentTimeline, (app::TimelineNode * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0056FAC0, void, __ctor, (app::TimelineNode * this_ptr));
}
