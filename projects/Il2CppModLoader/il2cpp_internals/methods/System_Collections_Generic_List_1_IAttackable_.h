...
namespace app::methods::System_Collections_Generic::List_1_IAttackable_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_IAttackable_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EFC50, IAttackable *, get_Item, (app::List_1_IAttackable_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_IAttackable_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_IAttackable_, GetEnumerator, (app::List_1_IAttackable_ * this_ptr));
