...
IL2CPP_REGISTER_METHOD(0x01175E40, LegacyAnimator__Array *, get_Animators, (app::PlayAnimatorAction * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011761E0, IEnumerator *, PerformActionCoroutine, (app::PlayAnimatorAction * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01176340, void, __ctor, (app::PlayAnimatorAction * this_ptr));
}
