...
namespace app::methods::System_Collections_Generic::SortedList_2_TKey_TValue__Enumerator_System_Single_System_Object_ {
    IL2CPP_REGISTER_METHOD(0x0022B5F0, void, __ctor, (app::SortedList_2_TKey_TValue_Enumerator_System_Single_System_Object___Boxed * this_ptr, app::SortedList_2_System_Single_System_Object_ * sorted_list, int32_t get_enumerator_ret_type));
