...
IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor, (app::ParticleSystem_ForceOverLifetimeModule__Boxed * this_ptr, app::ParticleSystem * particle_system));
...
IL2CPP_REGISTER_METHOD(0x00247A10, ParticleSystem_MinMaxCurve, get_x, (app::ParticleSystem_ForceOverLifetimeModule__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00247B10, ParticleSystem_MinMaxCurve, get_y, (app::ParticleSystem_ForceOverLifetimeModule__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00247C10, ParticleSystem_MinMaxCurve, get_z, (app::ParticleSystem_ForceOverLifetimeModule__Boxed * this_ptr));
