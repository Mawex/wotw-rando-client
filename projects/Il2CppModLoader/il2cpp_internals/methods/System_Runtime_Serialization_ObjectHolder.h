...
namespace app::methods::System_Runtime_Serialization::ObjectHolder {
IL2CPP_REGISTER_METHOD(0x01ED59B0, void, __ctor_1, (app::ObjectHolder * this_ptr, int64_t obj_i_d));
IL2CPP_REGISTER_METHOD(0x01ED5A70, void, __ctor_2, (app::ObjectHolder * this_ptr, app::Object * obj, int64_t obj_i_d, app::SerializationInfo * info, app::ISerializationSurrogate * surrogate, int64_t id_of_containing_obj, app::FieldInfo_1 * field, app::Int32__Array * array_index));
IL2CPP_REGISTER_METHODINFO(0x04755758, ObjectHolder__ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01ED5D60, void, __ctor_3, (app::ObjectHolder * this_ptr, app::String * obj, int64_t obj_i_d, app::SerializationInfo * info, app::ISerializationSurrogate * surrogate, int64_t id_of_containing_obj, app::FieldInfo_1 * field, app::Int32__Array * array_index));
...
IL2CPP_REGISTER_METHOD(0x002FBB80, TypeLoadExceptionHolder *, get_TypeLoadException, (app::ObjectHolder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB90, void, set_TypeLoadException, (app::ObjectHolder * this_ptr, app::TypeLoadExceptionHolder * value));
IL2CPP_REGISTER_METHOD(0x002FA280, Object *, get_ObjectValue, (app::ObjectHolder * this_ptr));
IL2CPP_REGISTER_METHOD(0x01ED6AB0, void, SetObjectValue, (app::ObjectHolder * this_ptr, app::Object * obj, app::ObjectManager * manager));
IL2CPP_REGISTER_METHOD(0x002FBB00, SerializationInfo *, get_SerializationInfo, (app::ObjectHolder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB10, void, set_SerializationInfo, (app::ObjectHolder * this_ptr, app::SerializationInfo * value));
IL2CPP_REGISTER_METHOD(0x002FB990, ISerializationSurrogate *, get_Surrogate, (app::ObjectHolder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9D0, LongList *, get_DependentObjects, (app::ObjectHolder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB60, ValueTypeFixupInfo *, get_ValueFixup, (app::ObjectHolder * this_ptr));
