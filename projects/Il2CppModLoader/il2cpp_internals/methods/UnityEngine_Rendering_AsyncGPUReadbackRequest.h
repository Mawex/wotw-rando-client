...
namespace app::methods::UnityEngine_Rendering::AsyncGPUReadbackRequest {
...
IL2CPP_REGISTER_METHOD(0x002406C0, NativeArray_1_System_Byte_, GetData, (app::AsyncGPUReadbackRequest__Boxed * this_ptr, int32_t layer));
