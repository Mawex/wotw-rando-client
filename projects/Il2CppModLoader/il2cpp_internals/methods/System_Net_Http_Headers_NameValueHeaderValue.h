...
namespace app::methods::System_Net_Http_Headers::NameValueHeaderValue {
IL2CPP_REGISTER_METHOD(0x02D101C0, void, __ctor_1, (app::NameValueHeaderValue * this_ptr, app::NameValueHeaderValue * source));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_2, (app::NameValueHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Name, (app::NameValueHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_Name, (app::NameValueHeaderValue * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x02D101F0, NameValueHeaderValue *, Create, (app::String * name, app::String * value));
IL2CPP_REGISTER_METHOD(0x02D10350, Object *, ICloneable_Clone, (app::NameValueHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D10E30, String *, ToString, (app::NameValueHeaderValue * this_ptr));
