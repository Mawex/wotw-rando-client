...
IL2CPP_REGISTER_METHOD(0x02780440, HTTPRequestHandle, CreateHTTPRequest, (app::EHTTPMethod__Enum e_h_t_t_p_request_method, app::String * pch_absolute_u_r_l));
...
IL2CPP_REGISTER_METHOD(0x02780E60, bool, GetHTTPResponseHeaderSize, (app::HTTPRequestHandle h_request, app::String * pch_header_name, app::uint32_t * un_response_header_size));
...
IL2CPP_REGISTER_METHOD(0x027812B0, bool, GetHTTPResponseBodySize, (app::HTTPRequestHandle h_request, app::uint32_t * un_body_size));
...
IL2CPP_REGISTER_METHOD(0x027813D0, bool, GetHTTPDownloadProgressPct, (app::HTTPRequestHandle h_request, app::float * pfl_percent_out));
...
IL2CPP_REGISTER_METHOD(0x02781630, HTTPCookieContainerHandle, CreateCookieContainer, (bool b_allow_responses_to_modify));
...
IL2CPP_REGISTER_METHOD(0x02781E60, bool, GetHTTPRequestWasTimedOut, (app::HTTPRequestHandle h_request, app::bool * pb_was_timed_out));
}
