...
IL2CPP_REGISTER_METHOD(0x00CC59E0, Int32Enum__Enum, get_Item2, (app::Tuple_3_Single_Int32Enum_Boolean_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0052A280, bool, get_Item3, (app::Tuple_3_Single_Int32Enum_Boolean_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A69ED0, void, __ctor, (app::Tuple_3_Single_Int32Enum_Boolean_ * this_ptr, float item1, app::Int32Enum__Enum item2, bool item3));
...
IL2CPP_REGISTER_METHOD(0x02A6A8E0, String *, ToString, (app::Tuple_3_Single_Int32Enum_Boolean_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A6AA60, String *, ITupleInternal_ToString, (app::Tuple_3_Single_Int32Enum_Boolean_ * this_ptr, app::StringBuilder * sb));
}
