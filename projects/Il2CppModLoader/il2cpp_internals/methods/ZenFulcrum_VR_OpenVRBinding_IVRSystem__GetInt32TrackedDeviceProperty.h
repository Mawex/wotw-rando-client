...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::IVRSystem_GetInt32TrackedDeviceProperty * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02CEC8E0, IAsyncResult *, BeginInvoke, (app::IVRSystem_GetInt32TrackedDeviceProperty * this_ptr, uint32_t un_device_index, app::ETrackedDeviceProperty__Enum prop, app::ETrackedPropertyError__Enum * p_error, app::AsyncCallback * callback, app::Object * object));
