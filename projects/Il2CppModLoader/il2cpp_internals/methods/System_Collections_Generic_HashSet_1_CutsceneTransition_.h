...
namespace app::methods::System_Collections_Generic::HashSet_1_CutsceneTransition_ {
IL2CPP_REGISTER_METHOD(0x02ABCD80, HashSet_1_T_Enumerator_CutsceneTransition_, GetEnumerator, (app::HashSet_1_CutsceneTransition_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AB4370, void, __ctor, (app::HashSet_1_CutsceneTransition_ * this_ptr));
