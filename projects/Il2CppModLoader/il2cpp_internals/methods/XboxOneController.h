...
IL2CPP_REGISTER_METHOD(0x005977E0, Action *, get_OnLastControllerDisconnect, ());
IL2CPP_REGISTER_METHOD(0x00597860, void, set_OnLastControllerDisconnect, (app::Action * value));
IL2CPP_REGISTER_METHOD(0x005978F0, Action *, get_OnActiveControllerDisconnect, ());
IL2CPP_REGISTER_METHOD(0x00597970, void, set_OnActiveControllerDisconnect, (app::Action * value));
IL2CPP_REGISTER_METHOD(0x00597A00, Action_1_Int32_ *, get_OnWillSwitchController, ());
...
IL2CPP_REGISTER_METHOD(0x00597BB0, void, __ctor, (app::XboxOneController * this_ptr));
}
