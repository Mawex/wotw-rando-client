...
namespace app::methods::UnityEngine_UI::Button {
IL2CPP_REGISTER_METHOD(0x01F2BB30, void, __ctor, (app::Button * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F2BCB0, Button_ButtonClickedEvent *, get_onClick, (app::Button * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F2BF70, IEnumerator *, OnFinishSubmit, (app::Button * this_ptr));
}
