...
namespace app::methods::PetrifiedOwlBossFinalComboBehaviour_RainOfFeathersLoopState {
    IL2CPP_REGISTER_METHOD(0x01771360, void, __ctor, (app::PetrifiedOwlBossFinalComboBehaviour_RainOfFeathersLoopState * this_ptr, app::PetrifiedOwlBossFinalComboBehaviour * behaviour));
