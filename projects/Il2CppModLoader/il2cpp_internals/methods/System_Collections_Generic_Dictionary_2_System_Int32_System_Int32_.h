...
IL2CPP_REGISTER_METHOD(0x0283B3E0, Dictionary_2_TKey_TValue_ValueCollection_System_Int32_System_Int32_ *, get_Values, (app::Dictionary_2_System_Int32_System_Int32_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0283B2B0, Dictionary_2_TKey_TValue_KeyCollection_System_Int32_System_Int32_ *, get_Keys, (app::Dictionary_2_System_Int32_System_Int32_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BAC6E0, Dictionary_2_TKey_TValue_Enumerator_System_Int32_System_Int32_, GetEnumerator, (app::Dictionary_2_System_Int32_System_Int32_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BB43A0, bool, TryGetValue, (app::Dictionary_2_System_Int32_System_Int32_ * this_ptr, int32_t key, app::int32_t * value));
...
IL2CPP_REGISTER_METHOD(0x002FB990, IEqualityComparer_1_System_Int32_ *, get_Comparer, (app::Dictionary_2_System_Int32_System_Int32_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B2B0, ICollection_1_System_Int32_ *, System_Collections_Generic_IDictionary_TKey_TValue__get_Keys, (app::Dictionary_2_System_Int32_System_Int32_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B2B0, IEnumerable_1_System_Int32_ *, System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Keys, (app::Dictionary_2_System_Int32_System_Int32_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B3E0, ICollection_1_System_Int32_ *, System_Collections_Generic_IDictionary_TKey_TValue__get_Values, (app::Dictionary_2_System_Int32_System_Int32_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B3E0, IEnumerable_1_System_Int32_ *, System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Values, (app::Dictionary_2_System_Int32_System_Int32_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BAC720, IEnumerator_1_KeyValuePair_2_System_Int32_System_Int32_ *, System_Collections_Generic_IEnumerable_System_Collections_Generic_KeyValuePair_TKey_TValue___GetEnumerator, (app::Dictionary_2_System_Int32_System_Int32_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BAC720, IEnumerator *, IEnumerable_GetEnumerator, (app::Dictionary_2_System_Int32_System_Int32_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BB4A10, Object *, ICollection_get_SyncRoot, (app::Dictionary_2_System_Int32_System_Int32_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0283E020, ICollection *, IDictionary_get_Keys, (app::Dictionary_2_System_Int32_System_Int32_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283E050, ICollection *, IDictionary_get_Values, (app::Dictionary_2_System_Int32_System_Int32_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02BB4B70, Object *, IDictionary_get_Item, (app::Dictionary_2_System_Int32_System_Int32_ * this_ptr, app::Object * key));
...
IL2CPP_REGISTER_METHOD(0x02BAEFE0, IDictionaryEnumerator *, IDictionary_GetEnumerator, (app::Dictionary_2_System_Int32_System_Int32_ * this_ptr));
