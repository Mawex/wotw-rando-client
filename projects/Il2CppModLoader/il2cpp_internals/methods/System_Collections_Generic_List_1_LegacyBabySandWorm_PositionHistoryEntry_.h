...
namespace app::methods::System_Collections_Generic::List_1_LegacyBabySandWorm_PositionHistoryEntry_ {
...
IL2CPP_REGISTER_METHOD(0x025E8A60, LegacyBabySandWorm_PositionHistoryEntry, get_Item, (app::List_1_LegacyBabySandWorm_PositionHistoryEntry_ * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x047733F0, List_1_LegacyBabySandWorm_PositionHistoryEntry__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_LegacyBabySandWorm_PositionHistoryEntry_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047498A0, List_1_LegacyBabySandWorm_PositionHistoryEntry___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_LegacyBabySandWorm_PositionHistoryEntry_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02DF3780, void, __ctor_3, (app::List_1_LegacyBabySandWorm_PositionHistoryEntry_ * this_ptr, app::IEnumerable_1_LegacyBabySandWorm_PositionHistoryEntry_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02DF3C00, Object *, ICollection_get_SyncRoot, (app::List_1_LegacyBabySandWorm_PositionHistoryEntry_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025E8BE0, Object *, IList_get_Item, (app::List_1_LegacyBabySandWorm_PositionHistoryEntry_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_LegacyBabySandWorm_PositionHistoryEntry_ *, AsReadOnly, (app::List_1_LegacyBabySandWorm_PositionHistoryEntry_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025E96E0, LegacyBabySandWorm_PositionHistoryEntry, Find, (app::List_1_LegacyBabySandWorm_PositionHistoryEntry_ * this_ptr, app::Predicate_1_LegacyBabySandWorm_PositionHistoryEntry_ * match));
IL2CPP_REGISTER_METHOD(0x025E9800, List_1_LegacyBabySandWorm_PositionHistoryEntry_ *, FindAll, (app::List_1_LegacyBabySandWorm_PositionHistoryEntry_ * this_ptr, app::Predicate_1_LegacyBabySandWorm_PositionHistoryEntry_ * match));
...
IL2CPP_REGISTER_METHOD(0x025E9D20, List_1_T_Enumerator_LegacyBabySandWorm_PositionHistoryEntry_, GetEnumerator, (app::List_1_LegacyBabySandWorm_PositionHistoryEntry_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9D60, IEnumerator_1_LegacyBabySandWorm_PositionHistoryEntry_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_LegacyBabySandWorm_PositionHistoryEntry_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9D60, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_LegacyBabySandWorm_PositionHistoryEntry_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_LegacyBabySandWorm_PositionHistoryEntry_ *, GetRange, (app::List_1_LegacyBabySandWorm_PositionHistoryEntry_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, LegacyBabySandWorm_PositionHistoryEntry__Array *, ToArray, (app::List_1_LegacyBabySandWorm_PositionHistoryEntry_ * this_ptr));
