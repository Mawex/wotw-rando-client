...
namespace app::methods::System_Diagnostics_Tracing::UInt16TypeInfo {
...
IL2CPP_REGISTER_METHOD(0x01A0E9B0, void, WriteData, (app::UInt16TypeInfo * this_ptr, app::TraceLoggingDataCollector * collector, app::uint16_t * value));
