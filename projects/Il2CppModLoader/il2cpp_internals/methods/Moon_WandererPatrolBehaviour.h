...
IL2CPP_REGISTER_METHOD(0x011A3C20, BehaviourStatus__Enum, OnExecute, (app::WandererPatrolBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x002FA000, void, OnExit, (app::WandererPatrolBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x0060C1C0, void, __ctor, (app::WandererPatrolBehaviour * this_ptr));
}
