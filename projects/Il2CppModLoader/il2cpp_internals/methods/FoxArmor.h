...
namespace app::methods::FoxArmor {
    ...
    IL2CPP_REGISTER_METHOD(0x01282C70, IEnumerator*, HidePiecesTemp, (app::FoxArmor * this_ptr, float seconds));
    IL2CPP_REGISTER_METHOD(0x01282DD0, void, HidePieces, (app::FoxArmor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::FoxArmor * this_ptr));
} // namespace app::methods::FoxArmor
