...
IL2CPP_REGISTER_METHOD(0x025EFC50, EnemyZone *, get_Item, (List_1_EnemyZone_ * __this, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x04771318, List_1_EnemyZone__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (List_1_EnemyZone_ * __this));
IL2CPP_REGISTER_METHODINFO(0x0476BD70, List_1_EnemyZone__get_Count__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (List_1_EnemyZone_ * __this, EnemyZone * item));
IL2CPP_REGISTER_METHODINFO(0x04797938, List_1_EnemyZone__Add__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F12F0, bool, Remove, (List_1_EnemyZone_ * __this, EnemyZone * item));
IL2CPP_REGISTER_METHODINFO(0x04726DA8, List_1_EnemyZone__Remove__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (List_1_EnemyZone_ * __this));
