...
namespace app::methods::FlyMovement {
    ...
    IL2CPP_REGISTER_METHOD(0x0127A850, Vector2, get_VelocityAsDelta, (app::FlyMovement * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0127A960, void, set_VelocityAsDelta, (app::FlyMovement * this_ptr, app::Vector2 value));
    IL2CPP_REGISTER_METHOD(0x002FBB40, Rigidbody*, get_Rigidbody, (app::FlyMovement * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x003FF2B0, SuspendableMask__Enum, get_Mask, (app::FlyMovement * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0127B470, void, set_Mask, (app::FlyMovement * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x0127B520, void, __ctor, (app::FlyMovement * this_ptr));
    IL2CPP_REGISTER_METHOD(0x004F4750, GameObject*, IDamageReciever_get_gameObject, (app::FlyMovement * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00506170, Transform*, IDamageReciever_get_transform, (app::FlyMovement * this_ptr));
} // namespace app::methods::FlyMovement
