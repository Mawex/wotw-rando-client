...
namespace app::methods::Moon_Timeline::TransparencyAnimatorSystemStrategy {
...
IL2CPP_REGISTER_METHOD(0x00D0F200, TransparencyAnimatorSystemStrategy_RendererState *, GetRenderState, (app::TransparencyAnimatorSystemStrategy * this_ptr, app::Renderer * renderer, app::UberShaderProperty_Color__Enum property));
IL2CPP_REGISTER_METHOD(0x00D0F360, bool, GetHandoverAlpha, (app::TransparencyAnimatorSystemStrategy * this_ptr, app::Renderer * renderer, app::UberShaderProperty_Color__Enum property, app::float * value));
...
IL2CPP_REGISTER_METHOD(0x00D10460, TransparencyAnimatorSystemStrategy_RendererState *, GetStateFromPool, (app::TransparencyAnimatorSystemStrategy * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D10710, void, __ctor, (app::TransparencyAnimatorSystemStrategy * this_ptr));
}
