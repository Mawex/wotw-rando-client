...
namespace app::methods::MS_Internal_Xml_Cache::XPathNodeRef {
    IL2CPP_REGISTER_METHOD(0x0011D2D0, void, __ctor, (app::XPathNodeRef__Boxed * this_ptr, app::XPathNode__Array * page, int32_t idx));
