...
namespace app::methods::System_Data_Common::SqlInt64Storage {
IL2CPP_REGISTER_METHOD(0x0285A5B0, void, __ctor, (app::SqlInt64Storage * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x0285A730, Object *, Aggregate, (app::SqlInt64Storage * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x0285B6E0, Object *, ConvertValue, (app::SqlInt64Storage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02854E00, void, Copy, (app::SqlInt64Storage * this_ptr, int32_t record_no1, int32_t record_no2));
IL2CPP_REGISTER_METHOD(0x0285B7A0, Object *, Get, (app::SqlInt64Storage * this_ptr, int32_t record));
...
IL2CPP_REGISTER_METHOD(0x0285B9E0, Object *, ConvertXmlToObject, (app::SqlInt64Storage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x0285BD30, String *, ConvertObjectToXml, (app::SqlInt64Storage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x0285C090, Object *, GetEmptyStorage, (app::SqlInt64Storage * this_ptr, int32_t record_count));
