...
namespace app::methods::GizmoHelper {
    ...
    IL2CPP_REGISTER_METHOD(0x02555B50, Vector2, GetCameraDistance, (app::Transform * transform));
    IL2CPP_REGISTER_METHOD(0x02556050, void, DrawStartEndGizmo, (app::Vector3 start_position, app::Vector3 end_position));
    IL2CPP_REGISTER_METHOD(0x02556330, Vector3, ScreenToWorld, (app::Vector2 screen, app::Transform* transform));
    IL2CPP_REGISTER_METHOD(0x025563E0, Vector2, WorldToScreen, (app::Vector3 world));
    IL2CPP_REGISTER_METHOD(0x025564C0, Bounds, BoundsFromTransform, (app::Transform * transform));
    IL2CPP_REGISTER_METHOD(0x025569E0, Bounds, BoundsFromPoints, (app::Vector3 p1, app::Vector3 p2, app::Vector3 p3, app::Vector3 p4));
