...
namespace app::methods::DebugControls {
    ...
    IL2CPP_REGISTER_METHOD(0x003FF3C0, SuspendableMask__Enum, get_Mask, (app::DebugControls * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00DE3F20, void, set_Mask, (app::DebugControls * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x00DE3FD0, void, __ctor, (app::DebugControls * this_ptr));
} // namespace app::methods::DebugControls
