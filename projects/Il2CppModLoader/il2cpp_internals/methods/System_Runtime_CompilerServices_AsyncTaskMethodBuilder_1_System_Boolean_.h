...
namespace app::methods::System_Runtime_CompilerServices::AsyncTaskMethodBuilder_1_System_Boolean_ {
...
IL2CPP_REGISTER_METHOD(0x001FF3E0, Task_1_System_Boolean_ *, get_Task, (app::AsyncTaskMethodBuilder_1_System_Boolean___Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x001FF470, Task_1_System_Boolean_ *, GetTaskForResult, (app::AsyncTaskMethodBuilder_1_System_Boolean___Boxed * this_ptr, bool result));
