...
namespace app::methods::System_Net::CredentialKey {
IL2CPP_REGISTER_METHOD(0x01EABCD0, void, __ctor, (app::CredentialKey * this_ptr, app::Uri * uri_prefix, app::String * authentication_type));
...
IL2CPP_REGISTER_METHOD(0x01EAC350, String *, ToString, (app::CredentialKey * this_ptr));
}
