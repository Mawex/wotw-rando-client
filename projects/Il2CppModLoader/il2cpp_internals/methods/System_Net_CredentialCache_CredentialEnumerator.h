...
namespace app::methods::System_Net::CredentialCache_CredentialEnumerator {
IL2CPP_REGISTER_METHOD(0x01EAAF30, void, __ctor, (app::CredentialCache_CredentialEnumerator * this_ptr, app::CredentialCache * cache, app::Hashtable * table, app::Hashtable * host_table, int32_t version));
IL2CPP_REGISTER_METHOD(0x01EAB0C0, Object *, IEnumerator_get_Current, (app::CredentialCache_CredentialEnumerator * this_ptr));
