...
IL2CPP_REGISTER_METHOD(0x004173F0, MessageProvider *, get_ItemName, (app::WeaponmasterItem * this_ptr));
IL2CPP_REGISTER_METHOD(0x005712D0, MessageProvider *, get_ItemDescription, (app::WeaponmasterItem * this_ptr));
IL2CPP_REGISTER_METHOD(0x00571410, MessageProvider *, get_ItemNextLevelDescription, (app::WeaponmasterItem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00571730, Texture2D *, get_ItemIcon, (app::WeaponmasterItem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::WeaponmasterItem * this_ptr));
}
