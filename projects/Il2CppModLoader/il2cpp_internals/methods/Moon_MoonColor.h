...
IL2CPP_REGISTER_METHOD(0x02F91FA0, CrossSceneReferenceId, get_CrossSceneReferenceId, (app::MoonColor * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F92180, void, __ctor, (app::MoonColor * this_ptr, app::Color static_value));
IL2CPP_REGISTER_METHOD(0x02F921B0, Color, Resolve, (app::MoonColor * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x047050B8, MoonColor_Resolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02F923B0, Color, SafeResolve, (app::MoonColor * this_ptr, app::IMoonResolverContext * context));
...
IL2CPP_REGISTER_METHOD(0x01746A40, MoonTypeData, GetTypeData, (app::MoonColor * this_ptr));
}
