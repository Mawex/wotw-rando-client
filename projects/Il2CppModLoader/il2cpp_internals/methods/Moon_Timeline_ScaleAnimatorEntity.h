...
namespace app::methods::Moon_Timeline::ScaleAnimatorEntity {
IL2CPP_REGISTER_METHOD(0x01E7E8B0, Transform *, get_TransformTarget, (app::ScaleAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E7E940, GameObject *, get_ExternalTarget, (app::ScaleAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, OnEntityCreated, (app::ScaleAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E7E9F0, Transform *, get_EffectiveTransform, (app::ScaleAnimatorEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E7F190, Vector3, GetOffsetAtValue, (app::ScaleAnimatorEntity * this_ptr, float value, app::Vector3 starting_scale));
IL2CPP_REGISTER_METHOD(0x01E7F2A0, Vector3, GetMultiplyAtValue, (app::ScaleAnimatorEntity * this_ptr, float value, app::Vector3 starting_scale));
IL2CPP_REGISTER_METHOD(0x002FA000, void, OnDrawGizmos, (app::ScaleAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E7F390, bool, GetCurrentValueAssociatedWithCurve, (app::ScaleAnimatorEntity * this_ptr, app::String * curve, app::float * value));
...
IL2CPP_REGISTER_METHOD(0x01BB9E30, GameObject *, get_ObservedTarget, (app::ScaleAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00AB4D20, SetupStateModifierDataType__Enum, get_ObservedModifierType, (app::ScaleAnimatorEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E7F7C0, void, __ctor, (app::ScaleAnimatorEntity * this_ptr));
}
