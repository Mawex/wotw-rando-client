...
namespace app::methods::Moon_TimeSlicer::AllocFreeTimeSlicedJob_1_ScenesManagerPrediction_UpdateExtrapolatedPositionTask_ {
IL2CPP_REGISTER_METHOD(0x02AF3CC0, void, __ctor, (app::AllocFreeTimeSlicedJob_1_ScenesManagerPrediction_UpdateExtrapolatedPositionTask_ * this_ptr, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x002FBC20, String *, get_JobName, (app::AllocFreeTimeSlicedJob_1_ScenesManagerPrediction_UpdateExtrapolatedPositionTask_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, String *, get_TimesliceJobOwnerName, (app::AllocFreeTimeSlicedJob_1_ScenesManagerPrediction_UpdateExtrapolatedPositionTask_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AF3D40, String *, get_ContextualDebugData, (app::AllocFreeTimeSlicedJob_1_ScenesManagerPrediction_UpdateExtrapolatedPositionTask_ * this_ptr));
