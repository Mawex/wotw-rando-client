...
namespace app::methods::usedStandaloneScripts_DeltaTimeManagers::FixedDeltaTimeController {
IL2CPP_REGISTER_METHOD(0x002FC6E0, void, __ctor, (app::FixedDeltaTimeController * this_ptr, int32_t f_p_s));
