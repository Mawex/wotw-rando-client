...
IL2CPP_REGISTER_METHOD(0x021CC320, X509CertificateImpl *, get_Item, (app::X509CertificateImplCollection * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x021CC4A0, X509CertificateImplCollection *, Clone, (app::X509CertificateImplCollection * this_ptr));
