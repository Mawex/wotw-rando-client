...
IL2CPP_REGISTER_METHOD(0x00574860, WiggleTreeController_WiggleSettings *, get_CurrentWiggleData, (app::WiggleTreeController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00574C70, void, __ctor, (app::WiggleTreeController * this_ptr));
}
