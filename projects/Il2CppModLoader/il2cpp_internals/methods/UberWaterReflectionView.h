...
IL2CPP_REGISTER_METHOD(0x012A1690, UberWaterReflectionView_AutomaticGroup *, FindAutomaticGroup, (app::UberWaterReflectionView * this_ptr, app::UberWaterReflectionPlane * plane, bool is_game_view));
...
IL2CPP_REGISTER_METHOD(0x012A7AC0, Vector4, CameraSpacePlane, (app::Matrix4x4 view_matrix, app::Vector3 pos, app::Vector3 normal, float side_sign));
IL2CPP_REGISTER_METHOD(0x012A7ED0, void, CalculateObliqueMatrix, (app::Matrix4x4 * projection, app::Vector4 clip_plane));
IL2CPP_REGISTER_METHOD(0x012A8490, Matrix4x4, CalculateReflectionMatrix, (app::Vector4 plane));
IL2CPP_REGISTER_METHOD(0x012A8690, void, __ctor, (app::UberWaterReflectionView * this_ptr));
