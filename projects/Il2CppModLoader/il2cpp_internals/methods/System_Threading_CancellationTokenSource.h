...
namespace app::methods::System_Threading::CancellationTokenSource {
...
IL2CPP_REGISTER_METHOD(0x027D95F0, CancellationToken, get_Token, (app::CancellationTokenSource * this_ptr));
IL2CPP_REGISTER_METHOD(0x027D9610, bool, get_CanBeCanceled, (app::CancellationTokenSource * this_ptr));
IL2CPP_REGISTER_METHOD(0x027D9620, CancellationCallbackInfo *, get_ExecutingCallback, (app::CancellationTokenSource * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x027D9B80, CancellationTokenRegistration, InternalRegister, (app::CancellationTokenSource * this_ptr, app::Action_1_Object_ * callback, app::Object * state_for_callback, app::SynchronizationContext * target_sync_context, app::ExecutionContext * execution_context));
...
IL2CPP_REGISTER_METHOD(0x027DAA70, CancellationTokenSource *, CreateLinkedTokenSource_1, (app::CancellationToken token1, app::CancellationToken token2));
IL2CPP_REGISTER_METHOD(0x027DAD80, CancellationTokenSource *, CreateLinkedTokenSource_2, (app::CancellationToken__Array * tokens));
