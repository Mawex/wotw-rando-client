...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::Comparison_1_UberPoolGroupWarmer_PrewarmItem_ * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02C80AE0, IAsyncResult *, BeginInvoke, (app::Comparison_1_UberPoolGroupWarmer_PrewarmItem_ * this_ptr, app::UberPoolGroupWarmer_PrewarmItem x, app::UberPoolGroupWarmer_PrewarmItem y, app::AsyncCallback * callback, app::Object * object));
