...
namespace app::methods::AkAudioFormat {
    IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkAudioFormat * this_ptr, app::void* c_ptr, bool c_memory_own));
    IL2CPP_REGISTER_METHOD(0x026C5310, void*, getCPtr, (app::AkAudioFormat * obj));
    IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkAudioFormat * this_ptr, app::void* c_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x026C59C0, AkChannelConfig*, get_channelConfig, (app::AkAudioFormat * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x026C6D50, void, __ctor_2, (app::AkAudioFormat * this_ptr));
} // namespace app::methods::AkAudioFormat
