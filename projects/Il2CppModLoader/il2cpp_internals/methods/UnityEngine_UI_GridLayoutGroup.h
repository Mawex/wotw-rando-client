...
namespace app::methods::UnityEngine_UI::GridLayoutGroup {
IL2CPP_REGISTER_METHOD(0x024B4F90, void, __ctor, (app::GridLayoutGroup * this_ptr));
IL2CPP_REGISTER_METHOD(0x024B5080, GridLayoutGroup_Corner__Enum, get_startCorner, (app::GridLayoutGroup * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024B5130, GridLayoutGroup_Axis__Enum, get_startAxis, (app::GridLayoutGroup * this_ptr));
IL2CPP_REGISTER_METHOD(0x024B5140, void, set_startAxis, (app::GridLayoutGroup * this_ptr, app::GridLayoutGroup_Axis__Enum value));
IL2CPP_REGISTER_METHOD(0x024B51E0, Vector2, get_cellSize, (app::GridLayoutGroup * this_ptr));
IL2CPP_REGISTER_METHOD(0x024B5200, void, set_cellSize, (app::GridLayoutGroup * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x024B5290, Vector2, get_spacing, (app::GridLayoutGroup * this_ptr));
IL2CPP_REGISTER_METHOD(0x024B52B0, void, set_spacing, (app::GridLayoutGroup * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x024B5350, GridLayoutGroup_Constraint__Enum, get_constraint, (app::GridLayoutGroup * this_ptr));
