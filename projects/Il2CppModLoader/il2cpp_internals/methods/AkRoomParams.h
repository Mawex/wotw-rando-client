...
namespace app::methods::AkRoomParams {
    IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkRoomParams * this_ptr, app::void* c_ptr, bool c_memory_own));
    IL2CPP_REGISTER_METHOD(0x01894F20, void*, getCPtr, (app::AkRoomParams * obj));
    IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkRoomParams * this_ptr, app::void* c_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01895240, void, __ctor_2, (app::AkRoomParams * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01895360, void, set_Up, (app::AkRoomParams * this_ptr, app::AkVector* value));
    IL2CPP_REGISTER_METHOD(0x018954A0, AkVector*, get_Up, (app::AkRoomParams * this_ptr));
    IL2CPP_REGISTER_METHOD(0x018956B0, void, set_Front, (app::AkRoomParams * this_ptr, app::AkVector* value));
    IL2CPP_REGISTER_METHOD(0x018957F0, AkVector*, get_Front, (app::AkRoomParams * this_ptr));
