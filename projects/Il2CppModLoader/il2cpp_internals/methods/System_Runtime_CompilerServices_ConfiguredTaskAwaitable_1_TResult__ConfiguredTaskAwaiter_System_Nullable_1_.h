...
namespace app::methods::System_Runtime_CompilerServices::ConfiguredTaskAwaitable_1_TResult__ConfiguredTaskAwaiter_System_Nullable_1_ {
...
IL2CPP_REGISTER_METHOD(0x001FF6C0, Nullable_1_Int32_, GetResult, (app::ConfiguredTaskAwaitable_1_TResult_ConfiguredTaskAwaiter_System_Nullable_1___Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00151890, void, __ctor, (app::ConfiguredTaskAwaitable_1_TResult_ConfiguredTaskAwaiter_System_Nullable_1___Boxed * this_ptr, app::Task_1_System_Nullable_1_ * task, bool continue_on_captured_context));
