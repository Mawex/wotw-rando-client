...
namespace app::methods::System_Collections_Generic::SortedList_2_System_Int32_CharacterState_ {
...
IL2CPP_REGISTER_METHOD(0x02CAFD90, IEnumerator_1_KeyValuePair_2_System_Int32_CharacterState_ *, GetEnumerator, (app::SortedList_2_System_Int32_CharacterState_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0470F0C8, SortedList_2_System_Int32_CharacterState__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02CAE5F0, void, __ctor, (app::SortedList_2_System_Int32_CharacterState_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CAEF10, IList_1_CharacterState_ *, get_Values, (app::SortedList_2_System_Int32_CharacterState_ * this_ptr));
