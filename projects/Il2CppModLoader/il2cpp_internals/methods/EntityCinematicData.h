...
IL2CPP_REGISTER_METHOD(0x002FB950, MoonAnimation *, get_Animation, (app::EntityCinematicData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::EntityCinematicData * this_ptr));
}
