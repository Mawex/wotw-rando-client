...
IL2CPP_REGISTER_METHOD(0x02766390, Material *, get_material, (app::CameraFilterPack_Blur_Dithering2x2 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024D35E0, void, __ctor, (app::CameraFilterPack_Blur_Dithering2x2 * this_ptr));
}
