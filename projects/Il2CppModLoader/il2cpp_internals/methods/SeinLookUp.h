...
namespace app::methods::SeinLookUp {
    ...
    IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement*, get_PlatformMovement, (app::SeinLookUp * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005D06F0, CharacterLeftRightMovement*, get_LeftRightMovement, (app::SeinLookUp * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x008A2940, void, __ctor, (app::SeinLookUp * this_ptr));
} // namespace app::methods::SeinLookUp
