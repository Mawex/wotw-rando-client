...
IL2CPP_REGISTER_METHOD(0x00420EE0, UpdateType__Enum, get_UpdateType, (app::WaterCurrentZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_ShouldSerialize, (app::WaterCurrentZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x008D4DF0, Vector2, get_NormalizedCurrentDirection, (app::WaterCurrentZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x008D4E20, Vector2, get_ActualCurrentSpeed, (app::WaterCurrentZone * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008D5150, Vector2, ActualCurrentSpeedForPoint, (app::WaterCurrentZone * this_ptr, app::Vector3 point));
...
IL2CPP_REGISTER_METHOD(0x008D6020, void, __ctor, (app::WaterCurrentZone * this_ptr));
}
