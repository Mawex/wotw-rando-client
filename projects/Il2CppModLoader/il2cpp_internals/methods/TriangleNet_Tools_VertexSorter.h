...
namespace app::methods::TriangleNet_Tools::VertexSorter {
IL2CPP_REGISTER_METHOD(0x02A9F090, void, __ctor, (app::VertexSorter * this_ptr, app::Vertex__Array * points, int32_t seed));
