...
namespace app::methods::Mono_Security_Protocol_Tls::CipherSuite {
IL2CPP_REGISTER_METHOD(0x002FBB60, ICryptoTransform *, get_EncryptionCipher, (app::CipherSuite * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBA0, ICryptoTransform *, get_DecryptionCipher, (app::CipherSuite * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBC0, KeyedHashAlgorithm *, get_ClientHMAC, (app::CipherSuite * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBE0, KeyedHashAlgorithm *, get_ServerHMAC, (app::CipherSuite * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FD1D0, CipherAlgorithmType__Enum, get_CipherAlgorithmType, (app::CipherSuite * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F62CE0, String *, get_HashAlgorithmName, (app::CipherSuite * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F62D80, HashAlgorithm *, CreateHashAlgorithm, (app::CipherSuite * this_ptr));
IL2CPP_REGISTER_METHOD(0x00529E80, HashAlgorithmType__Enum, get_HashAlgorithmType, (app::CipherSuite * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F62DA0, int32_t, get_HashSize, (app::CipherSuite * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB970, ExchangeAlgorithmType__Enum, get_ExchangeAlgorithmType, (app::CipherSuite * this_ptr));
IL2CPP_REGISTER_METHOD(0x00654950, CipherMode__Enum, get_CipherMode, (app::CipherSuite * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B67060, int16_t, get_Code, (app::CipherSuite * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Name, (app::CipherSuite * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F631D0, Byte__Array *, EncryptRecord, (app::CipherSuite * this_ptr, app::Byte__Array * fragment, app::Byte__Array * mac));
...
IL2CPP_REGISTER_METHOD(0x01F635A0, Byte__Array *, CreatePremasterSecret, (app::CipherSuite * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F636E0, Byte__Array *, PRF, (app::CipherSuite * this_ptr, app::Byte__Array * secret, app::String * label, app::Byte__Array * data, int32_t length));
IL2CPP_REGISTER_METHOD(0x01F63AD0, Byte__Array *, Expand, (app::CipherSuite * this_ptr, app::HashAlgorithm * hash, app::Byte__Array * secret, app::Byte__Array * seed, int32_t length));
