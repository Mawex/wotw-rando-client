...
IL2CPP_REGISTER_METHOD(0x01313C70, List_1_UnityEngine_Vector3_ *, ExtractDataFromRecorder, (app::RecorderData * recorder_data));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::CharacterPlugin * this_ptr));
}
