...
namespace app::methods::System_Security_Cryptography::AsymmetricSignatureDeformatter {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::AsymmetricSignatureDeformatter * this_ptr));
