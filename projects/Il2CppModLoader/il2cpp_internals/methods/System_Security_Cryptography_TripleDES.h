...
namespace app::methods::System_Security_Cryptography::TripleDES {
IL2CPP_REGISTER_METHOD(0x01E12060, void, __ctor, (app::TripleDES * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E12140, Byte__Array *, get_Key, (app::TripleDES * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E12530, TripleDES *, Create_1, ());
IL2CPP_REGISTER_METHOD(0x01E12670, TripleDES *, Create_2, (app::String * str));
