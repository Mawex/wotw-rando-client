...
namespace app::methods::System_Data_Common::SqlCharsStorage {
IL2CPP_REGISTER_METHOD(0x02847880, void, __ctor, (app::SqlCharsStorage * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x028479B0, Object *, Aggregate, (app::SqlCharsStorage * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x02846A70, Object *, Get, (app::SqlCharsStorage * this_ptr, int32_t record));
...
IL2CPP_REGISTER_METHOD(0x02847E60, Object *, ConvertXmlToObject, (app::SqlCharsStorage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x02848340, String *, ConvertObjectToXml, (app::SqlCharsStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x028486A0, Object *, GetEmptyStorage, (app::SqlCharsStorage * this_ptr, int32_t record_count));
