...
IL2CPP_REGISTER_METHOD(0x01121E00, InteractionGraph *, get_CurrentInteractionGraph, (app::NPCEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01121FA0, Vector2, get_EffectivePlayerAnchor, (app::NPCEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00417920, CharacterInteractableType__Enum, get_InteractableType, (app::NPCEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01122950, Input_InputButtonProcessor *, get_ActivationButton, (app::NPCEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B31590, MessageProvider *, get_InteractionMessageHint, (app::NPCEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x005E0530, MoonAnimator *, get_DialogActorAnimator, (app::NPCEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x011229F0, Vector2, get_DialogActorPosition, (app::NPCEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x005E0530, MoonAnimator *, get_InteractionActorAnimator, (app::NPCEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01122AB0, Vector3, get_InteractionActorPosition, (app::NPCEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, UpdateAnimParameter, (app::NPCEntity * this_ptr, app::MoonAnimator * character_animator));
IL2CPP_REGISTER_METHOD(0x01122AE0, MoonAnimation *, get_TalkAnimation, (app::NPCEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01122B70, MoonAnimation *, get_ThrowAnimation, (app::NPCEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01123030, MessageProvider *, get_CurrentQuestMessageProvider, (app::NPCEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01123130, MoonAnimation *, get_Idle, (app::NPCEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x011231C0, bool, get_IsInInteractionRange, (app::NPCEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01123420, Transform *, get_ItemBone, (app::NPCEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01123480, StaticEntityLocomotion *, get_StaticLocomotion, (app::NPCEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, CharacterInteractableActivationMode__Enum, get_ActivationMode, (app::NPCEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01126660, Vector2, get_CameraTargetPadding, (app::NPCEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, AdjustCameraTargetWeight, (app::NPCEntity * this_ptr, app::float * weight, app::CameraTargetData * data, app::Vector3 primary_target_position));
IL2CPP_REGISTER_METHOD(0x011268B0, Vector2, get_CameraZoomFactor, (app::NPCEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420230, CameraTargetType__Enum, get_TargetType, (app::NPCEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x011269B0, void, __ctor, (app::NPCEntity * this_ptr));
}
