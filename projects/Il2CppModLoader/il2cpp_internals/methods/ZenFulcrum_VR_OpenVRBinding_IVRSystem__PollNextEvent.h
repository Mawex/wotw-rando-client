...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::IVRSystem_PollNextEvent * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02CEF610, IAsyncResult *, BeginInvoke, (app::IVRSystem_PollNextEvent * this_ptr, app::VREvent_t * p_event, uint32_t uncb_v_r_event, app::AsyncCallback * callback, app::Object * object));
