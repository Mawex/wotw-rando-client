...
namespace app::methods::System::Tuple_2_GameController_ProfilingConfiguration_FrameCaptureTester_ {
    IL2CPP_REGISTER_METHOD(0x02A64EE0, void, __ctor, (app::Tuple_2_GameController_ProfilingConfiguration_FrameCaptureTester_ * this_ptr, app::GameController_ProfilingConfiguration__Enum item1, app::FrameCaptureTester * item2));
