...
IL2CPP_REGISTER_METHOD(0x024EB2B0, Material *, get_material, (app::CameraFilterPack_Distortion_ShockWave * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E2E10, void, __ctor, (app::CameraFilterPack_Distortion_ShockWave * this_ptr));
}
