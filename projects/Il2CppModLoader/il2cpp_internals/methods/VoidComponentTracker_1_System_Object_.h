...
namespace app::methods::VoidComponentTracker_1_System_Object_ {
...
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::VoidComponentTracker_1_System_Object_ * this_ptr));
}
