...
IL2CPP_REGISTER_METHOD(0x02763440, Material *, get_material, (app::CameraFilterPack_Blizzard * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E5E50, void, __ctor, (app::CameraFilterPack_Blizzard * this_ptr));
}
