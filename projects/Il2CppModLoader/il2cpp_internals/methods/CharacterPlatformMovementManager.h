...
IL2CPP_REGISTER_METHOD(0x01312690, CharacterPlatformMovementManager *, get_Instance, ());
IL2CPP_REGISTER_METHOD(0x00597B10, UpdateType__Enum, get_UpdateType, (app::CharacterPlatformMovementManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01313670, void, __ctor, (app::CharacterPlatformMovementManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x01313920, void, __cctor, ());
}
