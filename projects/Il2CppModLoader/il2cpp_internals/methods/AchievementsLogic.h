...
IL2CPP_REGISTER_METHOD(0x004B6340, List_1_AchievementAsset_ *, get_WispsAchievements, (app::AchievementsLogic * this_ptr));
IL2CPP_REGISTER_METHOD(0x004B67E0, SuspendableMask__Enum, get_Mask, (app::AchievementsLogic * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004B8CD0, List_1_AbilityType_ *, get_m_allAbilities, (app::AchievementsLogic * this_ptr));
IL2CPP_REGISTER_METHOD(0x004B8D70, List_1_SpiritShardType_ *, get_m_allShards, (app::AchievementsLogic * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004B8F00, bool, GetUnlockedAbilitiesProgress, (app::AchievementsLogic * this_ptr, app::int32_t * unlocked_count, app::int32_t * all_count));
...
IL2CPP_REGISTER_METHOD(0x004B92B0, bool, GetSkillUpgradesProgress, (app::AchievementsLogic * this_ptr, app::int32_t * upgraded, app::int32_t * all));
...
IL2CPP_REGISTER_METHOD(0x004B9720, bool, GetShardSlotsUpgradeProgress, (app::AchievementsLogic * this_ptr, app::int32_t * unlocked_count, app::int32_t * all_count));
...
IL2CPP_REGISTER_METHOD(0x004B9AC0, bool, GetShardsUnlockedProgress, (app::AchievementsLogic * this_ptr, app::int32_t * unlocked_count, app::int32_t * all_count));
IL2CPP_REGISTER_METHODINFO(0x04719D00, AchievementsLogic_GetShardsUnlockedProgress__MethodInfo);
IL2CPP_REGISTER_METHOD(0x004B9CF0, bool, GetShardsUpgradedProgress, (app::AchievementsLogic * this_ptr, app::int32_t * upgraded_count, app::int32_t * all_count));
...
IL2CPP_REGISTER_METHOD(0x004BA200, bool, GetHealthContainerProgress, (app::AchievementsLogic * this_ptr, app::int32_t * collected_count, app::int32_t * all_count));
...
IL2CPP_REGISTER_METHOD(0x004BA480, bool, GetEnergyContainerProgress, (app::AchievementsLogic * this_ptr, app::int32_t * collected_count, app::int32_t * all_count));
...
IL2CPP_REGISTER_METHOD(0x004BBF10, void, __ctor, (app::AchievementsLogic * this_ptr));
}
