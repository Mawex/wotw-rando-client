...
namespace app::methods::System_Collections_Generic::Queue_1_QuestsController_QueuedQuestMessage_ {
...
IL2CPP_REGISTER_METHOD(0x0243D360, QuestsController_QueuedQuestMessage, Dequeue, (app::Queue_1_QuestsController_QueuedQuestMessage_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CA5680, Object *, ICollection_get_SyncRoot, (app::Queue_1_QuestsController_QueuedQuestMessage_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0243D290, Queue_1_T_Enumerator_QuestsController_QueuedQuestMessage_, GetEnumerator, (app::Queue_1_QuestsController_QueuedQuestMessage_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0243D2D0, IEnumerator_1_QuestsController_QueuedQuestMessage_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::Queue_1_QuestsController_QueuedQuestMessage_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0243D2D0, IEnumerator *, IEnumerable_GetEnumerator, (app::Queue_1_QuestsController_QueuedQuestMessage_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0243D430, QuestsController_QueuedQuestMessage, Peek, (app::Queue_1_QuestsController_QueuedQuestMessage_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0243D5D0, QuestsController_QueuedQuestMessage__Array *, ToArray, (app::Queue_1_QuestsController_QueuedQuestMessage_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0243D7A0, void, MoveNext, (app::Queue_1_QuestsController_QueuedQuestMessage_ * this_ptr, app::int32_t * index));
