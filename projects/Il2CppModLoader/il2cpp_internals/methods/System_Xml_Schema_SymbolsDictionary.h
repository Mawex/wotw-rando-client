...
namespace app::methods::System_Xml_Schema::SymbolsDictionary {
IL2CPP_REGISTER_METHOD(0x01ABB750, void, __ctor, (app::SymbolsDictionary * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01ABC010, ICollection *, GetNamespaceListSymbols, (app::SymbolsDictionary * this_ptr, app::NamespaceList * list));
...
IL2CPP_REGISTER_METHOD(0x01ABC770, Object *, GetParticle, (app::SymbolsDictionary * this_ptr, int32_t symbol));
IL2CPP_REGISTER_METHOD(0x01ABC7B0, String *, NameOf, (app::SymbolsDictionary * this_ptr, int32_t symbol));
}
