...
namespace app::methods::System_Collections_Generic::List_1_UnityEngine_Transform_ {
...
IL2CPP_REGISTER_METHOD(0x025EFC50, Transform *, get_Item, (app::List_1_UnityEngine_Transform_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_UnityEngine_Transform_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_UnityEngine_Transform_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHODINFO(0x0478EF10, List_1_UnityEngine_Transform___ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_UnityEngine_Transform_, GetEnumerator, (app::List_1_UnityEngine_Transform_ * this_ptr));
