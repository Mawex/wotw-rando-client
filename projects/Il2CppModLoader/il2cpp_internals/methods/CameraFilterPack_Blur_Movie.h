...
IL2CPP_REGISTER_METHOD(0x024D2150, Material *, get_material, (app::CameraFilterPack_Blur_Movie * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024D2BF0, void, __ctor, (app::CameraFilterPack_Blur_Movie * this_ptr));
}
