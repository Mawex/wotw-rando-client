...
IL2CPP_REGISTER_METHOD(0x003FDCE0, SuspendableMask__Enum, get_Mask, (app::WaitForAnimationEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008C5E20, void, __ctor, (app::WaitForAnimationEvent * this_ptr));
}
