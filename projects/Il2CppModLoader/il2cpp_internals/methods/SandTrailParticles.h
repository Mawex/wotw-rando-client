...
IL2CPP_REGISTER_METHOD(0x0057AAC0, SuspendableMask__Enum, get_Mask, (app::SandTrailParticles * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C095F0, void, __ctor, (app::SandTrailParticles * this_ptr));
}
