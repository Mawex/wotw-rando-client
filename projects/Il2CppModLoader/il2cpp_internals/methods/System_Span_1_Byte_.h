...
IL2CPP_REGISTER_METHOD(0x02774C60, Span_1_Byte_, operator_, (app::Byte__Array * array));
IL2CPP_REGISTER_METHODINFO(0x04770B10, Span_1_Byte__op_Implicit__MethodInfo);
IL2CPP_REGISTER_METHOD(0x001FF850, void, __ctor, (app::Span_1_Byte___Boxed * this_ptr, app::Byte__Array * array));
IL2CPP_REGISTER_METHOD(0x001FF860, String *, get_DebuggerDisplay, (app::Span_1_Byte___Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00107C00, Pinnable_1_Byte_ *, get_Pinnable, (app::Span_1_Byte___Boxed * this_ptr));
