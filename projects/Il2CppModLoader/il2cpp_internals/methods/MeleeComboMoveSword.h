...
IL2CPP_REGISTER_METHOD(0x013A1280, String *, get_AnimationSpeedMultiplierParameterName, (app::MeleeComboMoveSword * this_ptr));
IL2CPP_REGISTER_METHOD(0x013A1300, Vector2, get_EffectiveRootMotionMultiplier, (app::MeleeComboMoveSword * this_ptr));
IL2CPP_REGISTER_METHOD(0x013A1410, float, get_EffectiveKnockbackAddY, (app::MeleeComboMoveSword * this_ptr));
IL2CPP_REGISTER_METHOD(0x009C1070, CharacterPlatformMovement *, get_PlatformMovement, (app::MeleeComboMoveSword * this_ptr));
IL2CPP_REGISTER_METHOD(0x006A67A0, MeleeWeaponSword *, get_Sword, (app::MeleeComboMoveSword * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CC8D40, AbilityType__Enum, get_ComboAbilityType, (app::MeleeComboMoveSword * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x013A3D50, Vector2, ComputeEffectiveKickback, (app::MeleeComboMoveSword * this_ptr, app::Vector3 enemy_position));
...
IL2CPP_REGISTER_METHOD(0x013A4E60, EffectSpawn, DamageEffectProvider, (app::MeleeComboMoveSword * this_ptr, app::DamageResult damage_result));
IL2CPP_REGISTER_METHODINFO(0x0478BA50, MeleeComboMoveSword_DamageEffectProvider__MethodInfo);
IL2CPP_REGISTER_METHOD(0x013A50F0, IEnumerator *, DummyHitStop, (app::MeleeComboMoveSword * this_ptr, app::GameObject * to_suspend, float suspend_time));
