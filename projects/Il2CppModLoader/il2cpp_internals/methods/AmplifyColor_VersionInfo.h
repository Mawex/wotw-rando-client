...
IL2CPP_REGISTER_METHOD(0x030CCAE0, String *, StaticToString, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x030CCE40, VersionInfo *, Current, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x030CCF90, bool, Matches, (VersionInfo * version));
IL2CPP_REGISTER_METHOD(0x030CCFC0, void, __cctor, (MethodInfo * method));
}
