...
namespace app::methods::System_Runtime_CompilerServices::TaskAwaiter {
IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor, (app::TaskAwaiter__Boxed * this_ptr, app::Task * task));
