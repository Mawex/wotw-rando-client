...
IL2CPP_REGISTER_METHOD(0x0246A8A0, Material *, get_material, (app::CameraFilterPack_FX_DigitalMatrixDistortion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0246B190, void, __ctor, (app::CameraFilterPack_FX_DigitalMatrixDistortion * this_ptr));
}
