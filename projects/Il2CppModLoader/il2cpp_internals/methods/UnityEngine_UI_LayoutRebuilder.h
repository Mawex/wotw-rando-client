...
IL2CPP_REGISTER_METHOD(0x01F2AB40, Transform *, get_transform, (app::LayoutRebuilder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0265D950, String *, ToString, (app::LayoutRebuilder * this_ptr));
