...
namespace app::methods::System_Linq_Expressions_Interpreter::Instruction {
...
IL2CPP_REGISTER_METHOD(0x01CD7A40, String *, ToString, (app::Instruction * this_ptr));
IL2CPP_REGISTER_METHOD(0x01742A00, String *, ToDebugString, (app::Instruction * this_ptr, int32_t instruction_index, app::Object * cookie, app::Func_2_Int32_Int32_ * label_indexer, app::IReadOnlyList_1_System_Object_ * objects));
IL2CPP_REGISTER_METHOD(0x018E6D70, void, NullCheck, (app::Object * o));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::Instruction * this_ptr));
}
