...
IL2CPP_REGISTER_METHOD(0x03148C40, void, __ctor, (app::UberStateArchive * this_ptr, app::Byte__Array * data, bool writing));
...
IL2CPP_REGISTER_METHOD(0x03148EC0, Vector2, Serialize_7, (app::UberStateArchive * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x03148F90, Vector3, Serialize_8, (app::UberStateArchive * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x031490E0, Quaternion, Serialize_9, (app::UberStateArchive * this_ptr, app::Quaternion value));
