...
namespace app::methods::SeinGrabRope {
    ...
    IL2CPP_REGISTER_METHOD(0x005D06C0, CharacterPlatformMovement*, get_PlatformMovement, (app::SeinGrabRope * this_ptr));
    IL2CPP_REGISTER_METHOD(0x014B26A0, Vector3, get_SeinSpeed, (app::SeinGrabRope * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x014B2940, SeinGrabRopePuppet*, get_Puppet, (app::SeinGrabRope * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x014B9C50, void, UpdateStickToRope_2, (app::SeinGrabRope * this_ptr, bool update_handstand_and_dangle_positions, app::bool* in_hand_stand_zone, app::bool* in_dangle_zone, app::bool* stop_at_the_top));
    IL2CPP_REGISTER_METHOD(0x014BB240, Vector3, GetDanglePoint, (app::SeinGrabRope * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x014BB480, void, OnPreDash, (app::SeinGrabRope * this_ptr, app::bool* allow));
    ...
    IL2CPP_REGISTER_METHOD(0x014BE1A0, GameObject*, GetDashToVerticalVFXPrefab, (app::SeinGrabRope * this_ptr));
    IL2CPP_REGISTER_METHOD(0x014BE250, GameObject*, GetSwitchingSideVerticalVFXPrefab, (app::SeinGrabRope * this_ptr));
    IL2CPP_REGISTER_METHOD(0x014BE300, GameObject*, GetJumpingUpPoleVFXPrefab, (app::SeinGrabRope * this_ptr));
    IL2CPP_REGISTER_METHOD(0x014BE3B0, GameObject*, GetHandStandJumpVFXPrefab, (app::SeinGrabRope * this_ptr));
    IL2CPP_REGISTER_METHOD(0x014BE460, void, __ctor, (app::SeinGrabRope * this_ptr));
