...
namespace app::methods::Moon_Timeline::ActivateAnimator {
IL2CPP_REGISTER_METHOD(0x01BAF670, GameObject *, get_ExternalTarget, (app::ActivateAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBC0, MoonReference_1_UnityEngine_GameObject_ *, GetGameObjectTarget, (app::ActivateAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BAFBF0, void, __ctor, (app::ActivateAnimator * this_ptr));
}
