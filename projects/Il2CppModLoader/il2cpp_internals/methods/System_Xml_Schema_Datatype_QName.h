...
IL2CPP_REGISTER_METHOD(0x023576E0, FacetsChecker *, get_FacetsChecker, (Datatype_QName * __this));
IL2CPP_REGISTER_METHOD(0x00E3E950, XmlTypeCode__Enum, get_TypeCode, (Datatype_QName * __this));
IL2CPP_REGISTER_METHOD(0x008556D0, XmlTokenizedType__Enum, get_TokenizedType, (Datatype_QName * __this));
IL2CPP_REGISTER_METHOD(0x00E40570, RestrictionFlags__Enum, get_ValidRestrictionFlags, (Datatype_QName * __this));
IL2CPP_REGISTER_METHOD(0x02357780, Type *, get_ValueType, (Datatype_QName * __this));
IL2CPP_REGISTER_METHOD(0x02357820, Type *, get_ListValueType, (Datatype_QName * __this));
