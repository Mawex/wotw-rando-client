...
IL2CPP_REGISTER_METHOD(0x009B5160, StateCondition_StateConditionSetupData *, get_Pass, (app::StateCondition_StateConditionSetupHolder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009B5340, void, __ctor, (app::StateCondition_StateConditionSetupHolder * this_ptr));
}
