...
namespace app::methods::System_Collections_Generic::Dictionary_2_Moon_UberID_Moon_UberStateValueGroup_ {
IL2CPP_REGISTER_METHOD(0x02BA5400, Dictionary_2_TKey_TValue_Enumerator_Moon_UberID_Moon_UberStateValueGroup_, GetEnumerator, (app::Dictionary_2_Moon_UberID_Moon_UberStateValueGroup_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0473A758, Dictionary_2_Moon_UberID_Moon_UberStateValueGroup__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_Moon_UberID_Moon_UberStateValueGroup_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0283B2B0, Dictionary_2_TKey_TValue_KeyCollection_Moon_UberID_Moon_UberStateValueGroup_ *, get_Keys, (app::Dictionary_2_Moon_UberID_Moon_UberStateValueGroup_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0470FA18, Dictionary_2_Moon_UberID_Moon_UberStateValueGroup__get_Keys__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02BD24D0, UberStateValueGroup *, get_Item, (app::Dictionary_2_Moon_UberID_Moon_UberStateValueGroup_ * this_ptr, app::UberID * key));
