...
IL2CPP_REGISTER_METHOD(0x02744730, Material *, get_material, (app::CameraFilterPack_Blend2Camera_ColorBurn * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02745900, void, __ctor, (app::CameraFilterPack_Blend2Camera_ColorBurn * this_ptr));
}
