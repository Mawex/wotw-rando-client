...
IL2CPP_REGISTER_METHOD(0x002FBC60, LegacyTimelineSequence *, get_EffectiveLandSequence, (app::MantisFallReactionBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC20, MoonTimeline *, get_EffectiveLandSequenceNew, (app::MantisFallReactionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009F9A60, BehaviourStatus__Enum, OnExecuteTask, (app::MantisFallReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x009FC0E0, void, __ctor, (app::MantisFallReactionBehaviour * this_ptr));
