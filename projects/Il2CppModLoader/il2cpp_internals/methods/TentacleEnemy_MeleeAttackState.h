...
IL2CPP_REGISTER_METHOD(0x00CF88D0, String *, get_Name, (app::TentacleEnemy_MeleeAttackState * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CF8980, BehaviourTreeStatus__Enum, OnTentacleStateUpdate, (app::TentacleEnemy_MeleeAttackState * this_ptr, app::TickData tick));
...
IL2CPP_REGISTER_METHOD(0x00CFA460, void, __ctor, (app::TentacleEnemy_MeleeAttackState * this_ptr));
}
