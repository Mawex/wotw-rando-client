...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::Camera * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02421260, RenderingPath__Enum, get_renderingPath, (app::Camera * this_ptr));
IL2CPP_REGISTER_METHOD(0x024212B0, void, set_renderingPath, (app::Camera * this_ptr, app::RenderingPath__Enum value));
IL2CPP_REGISTER_METHOD(0x02421310, RenderingPath__Enum, get_actualRenderingPath, (app::Camera * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024217D0, OpaqueSortMode__Enum, get_opaqueSortMode, (app::Camera * this_ptr));
IL2CPP_REGISTER_METHOD(0x02421820, void, set_opaqueSortMode, (app::Camera * this_ptr, app::OpaqueSortMode__Enum value));
IL2CPP_REGISTER_METHOD(0x02421880, TransparencySortMode__Enum, get_transparencySortMode, (app::Camera * this_ptr));
IL2CPP_REGISTER_METHOD(0x024218D0, void, set_transparencySortMode, (app::Camera * this_ptr, app::TransparencySortMode__Enum value));
IL2CPP_REGISTER_METHOD(0x02421930, Vector3, get_transparencySortAxis, (app::Camera * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02421C10, Vector3, get_velocity, (app::Camera * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02421F50, CameraType__Enum, get_cameraType, (app::Camera * this_ptr));
IL2CPP_REGISTER_METHOD(0x02421FA0, void, set_cameraType, (app::Camera * this_ptr, app::CameraType__Enum value));
IL2CPP_REGISTER_METHOD(0x02422000, Single__Array *, GetLayerCullDistances, (app::Camera * this_ptr));
IL2CPP_REGISTER_METHOD(0x02422050, void, SetLayerCullDistances, (app::Camera * this_ptr, app::Single__Array * d));
IL2CPP_REGISTER_METHOD(0x02422000, Single__Array *, get_layerCullDistances, (app::Camera * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024222C0, Matrix4x4, get_cullingMatrix, (app::Camera * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02422420, Color, get_backgroundColor, (app::Camera * this_ptr));
IL2CPP_REGISTER_METHOD(0x024224A0, void, set_backgroundColor, (app::Camera * this_ptr, app::Color value));
IL2CPP_REGISTER_METHOD(0x02422500, CameraClearFlags__Enum, get_clearFlags, (app::Camera * this_ptr));
IL2CPP_REGISTER_METHOD(0x02422550, void, set_clearFlags, (app::Camera * this_ptr, app::CameraClearFlags__Enum value));
IL2CPP_REGISTER_METHOD(0x024225B0, DepthTextureMode__Enum, get_depthTextureMode, (app::Camera * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02422820, Camera_ProjectionMatrixMode__Enum, get_projectionMatrixMode, (app::Camera * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02422920, Vector2, get_sensorSize, (app::Camera * this_ptr));
IL2CPP_REGISTER_METHOD(0x02422990, void, set_sensorSize, (app::Camera * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x024229F0, Vector2, get_lensShift, (app::Camera * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02422B70, Camera_GateFitMode__Enum, get_gateFit, (app::Camera * this_ptr));
IL2CPP_REGISTER_METHOD(0x02422BC0, void, set_gateFit, (app::Camera * this_ptr, app::Camera_GateFitMode__Enum value));
IL2CPP_REGISTER_METHOD(0x02422C20, Vector3, GetLocalSpaceAim, (app::Camera * this_ptr));
IL2CPP_REGISTER_METHOD(0x02422CA0, Rect, get_rect, (app::Camera * this_ptr));
IL2CPP_REGISTER_METHOD(0x02422D20, void, set_rect, (app::Camera * this_ptr, app::Rect value));
IL2CPP_REGISTER_METHOD(0x02422D80, Rect, get_pixelRect, (app::Camera * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02422FA0, RenderTexture *, get_targetTexture, (app::Camera * this_ptr));
IL2CPP_REGISTER_METHOD(0x02422FF0, void, set_targetTexture, (app::Camera * this_ptr, app::RenderTexture * value));
IL2CPP_REGISTER_METHOD(0x02423050, RenderTexture *, get_activeTexture, (app::Camera * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02423310, String__Array *, GetCameraBufferWarnings, (app::Camera * this_ptr));
IL2CPP_REGISTER_METHOD(0x02423360, Matrix4x4, get_cameraToWorldMatrix, (app::Camera * this_ptr));
IL2CPP_REGISTER_METHOD(0x02423410, Matrix4x4, get_worldToCameraMatrix, (app::Camera * this_ptr));
IL2CPP_REGISTER_METHOD(0x024234C0, void, set_worldToCameraMatrix, (app::Camera * this_ptr, app::Matrix4x4 value));
IL2CPP_REGISTER_METHOD(0x02423520, Matrix4x4, get_projectionMatrix, (app::Camera * this_ptr));
IL2CPP_REGISTER_METHOD(0x024235D0, void, set_projectionMatrix, (app::Camera * this_ptr, app::Matrix4x4 value));
IL2CPP_REGISTER_METHOD(0x02423630, Matrix4x4, get_nonJitteredProjectionMatrix, (app::Camera * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024237F0, Matrix4x4, get_previousViewProjectionMatrix, (app::Camera * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02423940, Matrix4x4, CalculateObliqueMatrix, (app::Camera * this_ptr, app::Vector4 clip_plane));
IL2CPP_REGISTER_METHOD(0x02423A00, Vector3, WorldToScreenPoint_1, (app::Camera * this_ptr, app::Vector3 position, app::Camera_MonoOrStereoscopicEye__Enum eye));
IL2CPP_REGISTER_METHOD(0x02423AA0, Vector3, WorldToViewportPoint_1, (app::Camera * this_ptr, app::Vector3 position, app::Camera_MonoOrStereoscopicEye__Enum eye));
IL2CPP_REGISTER_METHOD(0x02423B40, Vector3, ViewportToWorldPoint_1, (app::Camera * this_ptr, app::Vector3 position, app::Camera_MonoOrStereoscopicEye__Enum eye));
IL2CPP_REGISTER_METHOD(0x02423BE0, Vector3, ScreenToWorldPoint_1, (app::Camera * this_ptr, app::Vector3 position, app::Camera_MonoOrStereoscopicEye__Enum eye));
IL2CPP_REGISTER_METHOD(0x02423C80, Vector3, WorldToScreenPoint_2, (app::Camera * this_ptr, app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x02423D20, Vector3, WorldToViewportPoint_2, (app::Camera * this_ptr, app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x02423DC0, Vector3, ViewportToWorldPoint_2, (app::Camera * this_ptr, app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x02423E60, Vector3, ScreenToWorldPoint_2, (app::Camera * this_ptr, app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x02423F00, Vector3, ScreenToViewportPoint, (app::Camera * this_ptr, app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x02423F90, Vector3, ViewportToScreenPoint, (app::Camera * this_ptr, app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x02424020, Vector2, GetFrustumPlaneSizeAt, (app::Camera * this_ptr, float distance));
IL2CPP_REGISTER_METHOD(0x024240A0, Ray, ViewportPointToRay_1, (app::Camera * this_ptr, app::Vector2 pos, app::Camera_MonoOrStereoscopicEye__Enum eye));
IL2CPP_REGISTER_METHOD(0x02424150, Ray, ViewportPointToRay_2, (app::Camera * this_ptr, app::Vector3 pos, app::Camera_MonoOrStereoscopicEye__Enum eye));
IL2CPP_REGISTER_METHOD(0x024242A0, Ray, ViewportPointToRay_3, (app::Camera * this_ptr, app::Vector3 pos));
IL2CPP_REGISTER_METHOD(0x024243F0, Ray, ScreenPointToRay_1, (app::Camera * this_ptr, app::Vector2 pos, app::Camera_MonoOrStereoscopicEye__Enum eye));
IL2CPP_REGISTER_METHOD(0x024244A0, Ray, ScreenPointToRay_2, (app::Camera * this_ptr, app::Vector3 pos, app::Camera_MonoOrStereoscopicEye__Enum eye));
IL2CPP_REGISTER_METHOD(0x024245F0, Ray, ScreenPointToRay_3, (app::Camera * this_ptr, app::Vector3 pos));
IL2CPP_REGISTER_METHOD(0x02424740, GameObject *, RaycastTry, (app::Camera * this_ptr, app::Ray ray, float distance, int32_t layer_mask));
IL2CPP_REGISTER_METHOD(0x024247C0, GameObject *, RaycastTry2D, (app::Camera * this_ptr, app::Ray ray, float distance, int32_t layer_mask));
...
IL2CPP_REGISTER_METHOD(0x02424D30, Scene, get_scene, (app::Camera * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02425000, StereoTargetEyeMask__Enum, get_stereoTargetEye, (app::Camera * this_ptr));
IL2CPP_REGISTER_METHOD(0x02425050, void, set_stereoTargetEye, (app::Camera * this_ptr, app::StereoTargetEyeMask__Enum value));
IL2CPP_REGISTER_METHOD(0x024250B0, Camera_MonoOrStereoscopicEye__Enum, get_stereoActiveEye, (app::Camera * this_ptr));
IL2CPP_REGISTER_METHOD(0x02425100, Matrix4x4, GetStereoNonJitteredProjectionMatrix, (app::Camera * this_ptr, app::Camera_StereoscopicEye__Enum eye));
IL2CPP_REGISTER_METHOD(0x024251C0, Matrix4x4, GetStereoViewMatrix, (app::Camera * this_ptr, app::Camera_StereoscopicEye__Enum eye));
...
IL2CPP_REGISTER_METHOD(0x024252E0, Matrix4x4, GetStereoProjectionMatrix, (app::Camera * this_ptr, app::Camera_StereoscopicEye__Enum eye));
...
IL2CPP_REGISTER_METHOD(0x02426220, CommandBuffer__Array *, GetCommandBuffers, (app::Camera * this_ptr, app::CameraEvent__Enum evt));
...
IL2CPP_REGISTER_METHOD(0x02427300, GameObject *, RaycastTry_Injected, (app::Camera * this_ptr, app::Ray * ray, float distance, int32_t layer_mask));
IL2CPP_REGISTER_METHOD(0x02427380, GameObject *, RaycastTry2D_Injected, (app::Camera * this_ptr, app::Ray * ray, float distance, int32_t layer_mask));
