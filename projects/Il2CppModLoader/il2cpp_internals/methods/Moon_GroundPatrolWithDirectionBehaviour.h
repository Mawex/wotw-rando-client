...
IL2CPP_REGISTER_METHOD(0x003FF610, GroundPatrolMode__Enum, get_PatrolMode, (app::GroundPatrolWithDirectionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00608710, GroundPatrolDirectionMode__Enum, get_PatrolDirectionMode, (app::GroundPatrolWithDirectionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01494130, Vector3, get_PatrolOrigin, (app::GroundPatrolWithDirectionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01494160, Vector2, get_MovingDirection, (app::GroundPatrolWithDirectionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01494FD0, void, __ctor, (app::GroundPatrolWithDirectionBehaviour * this_ptr));
}
