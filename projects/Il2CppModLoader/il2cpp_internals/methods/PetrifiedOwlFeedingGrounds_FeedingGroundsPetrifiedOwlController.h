...
IL2CPP_REGISTER_METHOD(0x014D9E30, Quaternion, get_RootMotionRotation, (app::FeedingGroundsPetrifiedOwlController * this_ptr));
IL2CPP_REGISTER_METHOD(0x014D9EF0, Quaternion, get_NonRootMotionRotation, (app::FeedingGroundsPetrifiedOwlController * this_ptr));
IL2CPP_REGISTER_METHOD(0x014D9FB0, PetrifiedOwlFeedingGroundsState__Enum, get_CurrentState, (app::FeedingGroundsPetrifiedOwlController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014DA010, FeedingGroundsPetrifiedOwlController_FeedingGroundsChaseState__Enum, get_CurrentChaseState, (app::FeedingGroundsPetrifiedOwlController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014DD860, Vector3, GetKillSweepOffset, (app::FeedingGroundsPetrifiedOwlController * this_ptr, app::FeedingGroundsPetrifiedOwlController_KillType__Enum kill_type));
IL2CPP_REGISTER_METHOD(0x014DD8C0, MoonTimeline *, GetKillSweepTimeline, (app::FeedingGroundsPetrifiedOwlController * this_ptr, app::FeedingGroundsPetrifiedOwlController_KillType__Enum kill_type));
...
IL2CPP_REGISTER_METHOD(0x014DE8B0, MoonTimeline *, GetCurrentTakeOffTimeline, (app::FeedingGroundsPetrifiedOwlController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014DEDA0, void, __ctor, (app::FeedingGroundsPetrifiedOwlController * this_ptr));
