...
namespace app::methods::System_Diagnostics_Tracing::InvokeTypeInfo_1_System_DateTimeOffset_ {
...
IL2CPP_REGISTER_METHOD(0x02B9ACB0, Object *, GetData, (app::InvokeTypeInfo_1_System_DateTimeOffset_ * this_ptr, app::Object * value));
