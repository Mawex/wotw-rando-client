...
namespace app::methods::System_Timers::Timer {
IL2CPP_REGISTER_METHOD(0x02A7AED0, void, __ctor_1, (app::Timer_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A7B060, void, __ctor_2, (app::Timer_1 * this_ptr, double interval));
...
IL2CPP_REGISTER_METHOD(0x002FB930, ISite *, get_Site, (app::Timer_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A7BB30, ISynchronizeInvoke *, get_SynchronizingObject, (app::Timer_1 * this_ptr));
