...
IL2CPP_REGISTER_METHOD(0x00B80520, ActionWithDuration *, get_ActionWithDuration, (app::DelayedActionExecuter * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B80630, ActionMethod *, get_ActionMethod, (app::DelayedActionExecuter * this_ptr));
