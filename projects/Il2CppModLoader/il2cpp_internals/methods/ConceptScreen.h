...
namespace app::methods::ConceptScreen {
    ...
    IL2CPP_REGISTER_METHOD(0x003FD3F0, SuspendableMask__Enum, get_Mask, (app::ConceptScreen * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x011E3990, void, __ctor, (app::ConceptScreen * this_ptr));
} // namespace app::methods::ConceptScreen
