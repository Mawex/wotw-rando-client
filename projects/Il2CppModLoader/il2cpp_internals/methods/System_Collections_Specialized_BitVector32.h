...
namespace app::methods::System_Collections_Specialized::BitVector32 {
...
IL2CPP_REGISTER_METHOD(0x02492720, String *, ToString_1, (app::BitVector32 value));
IL2CPP_REGISTER_METHOD(0x001EF5F0, String *, ToString_2, (app::BitVector32__Boxed * this_ptr));
}
