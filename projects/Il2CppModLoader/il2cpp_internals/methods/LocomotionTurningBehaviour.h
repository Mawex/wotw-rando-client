...
IL2CPP_REGISTER_METHOD(0x00FC9390, BehaviourStatus__Enum, OnExecuteTask, (app::LocomotionTurningBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x002FA000, void, OnResetTask, (app::LocomotionTurningBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00D201A0, void, __ctor, (app::LocomotionTurningBehaviour * this_ptr));
}
