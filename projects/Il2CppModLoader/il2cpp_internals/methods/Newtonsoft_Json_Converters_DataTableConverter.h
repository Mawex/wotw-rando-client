...
namespace app::methods::Newtonsoft_Json_Converters::DataTableConverter {
...
IL2CPP_REGISTER_METHOD(0x01A4F910, Object *, ReadJson, (app::DataTableConverter * this_ptr, app::JsonReader * reader, app::Type * object_type, app::Object * existing_value, app::JsonSerializer * serializer));
...
IL2CPP_REGISTER_METHOD(0x01A50400, Type *, GetColumnDataType, (app::JsonReader * reader));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::DataTableConverter * this_ptr));
}
