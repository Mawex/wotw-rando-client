...
IL2CPP_REGISTER_METHOD(0x002FB990, ColorVariationSettings *, get_ColorVariationSettings, (app::ColorVariationZoneModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, ColorVariationManager_ColorVariationInfluencerOrder__Enum, get_ColorVariationInfluencerOrder, (app::ColorVariationZoneModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::ColorVariationZoneModifier * this_ptr));
}
