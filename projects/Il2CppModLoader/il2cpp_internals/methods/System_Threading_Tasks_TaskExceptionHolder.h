...
namespace app::methods::System_Threading_Tasks::TaskExceptionHolder {
IL2CPP_REGISTER_METHOD(0x0233C210, void, __ctor, (app::TaskExceptionHolder * this_ptr, app::Task * task));
...
IL2CPP_REGISTER_METHOD(0x0233D860, AggregateException *, CreateExceptionObject, (app::TaskExceptionHolder * this_ptr, bool called_from_finalizer, app::Exception * include_this_exception));
IL2CPP_REGISTER_METHOD(0x0233DCC0, ReadOnlyCollection_1_System_Runtime_ExceptionServices_ExceptionDispatchInfo_ *, GetExceptionDispatchInfos, (app::TaskExceptionHolder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB950, ExceptionDispatchInfo *, GetCancellationExceptionDispatchInfo, (app::TaskExceptionHolder * this_ptr));
