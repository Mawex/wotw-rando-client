...
namespace app::methods::Mono_Security_X509::X509ExtensionCollection {
...
IL2CPP_REGISTER_METHOD(0x020202A0, IEnumerator *, IEnumerable_GetEnumerator_1, (app::X509ExtensionCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020202A0, IEnumerator *, IEnumerable_GetEnumerator_2, (app::X509ExtensionCollection_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x03167240, X509Extension_2 *, get_Item_1, (app::X509ExtensionCollection_1 * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x03167340, X509Extension_2 *, get_Item_2, (app::X509ExtensionCollection_1 * this_ptr, app::String * oid));
IL2CPP_REGISTER_METHOD(0x03167470, Byte__Array *, GetBytes, (app::X509ExtensionCollection_1 * this_ptr));
}
