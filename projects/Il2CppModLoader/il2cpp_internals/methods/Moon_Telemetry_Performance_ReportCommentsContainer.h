...
namespace app::methods::Moon_Telemetry_Performance::ReportCommentsContainer {
...
IL2CPP_REGISTER_METHOD(0x00E39C90, void, __ctor, (app::ReportCommentsContainer * this_ptr));
}
