...
IL2CPP_REGISTER_METHOD(0x01160790, Vector3, get_TargetPosition, (app::PiranhaLocomotionSwimmingBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01160B80, PiranhaLocomotionSwimmingBehaviour_SpeedSetting *, GetSpeedSettingForTier, (app::PiranhaLocomotionSwimmingBehaviour * this_ptr, float speed_tier));
...
IL2CPP_REGISTER_METHOD(0x01161160, BehaviourStatus__Enum, OnExecuteTask, (app::PiranhaLocomotionSwimmingBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01162F80, void, __ctor, (app::PiranhaLocomotionSwimmingBehaviour * this_ptr));
}
