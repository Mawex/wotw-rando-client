...
IL2CPP_REGISTER_METHOD(0x0064D930, Vector3, get_PatrolOrigin, (app::PatrolBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C33480, Locomotion *, get_Locomotion, (app::PatrolBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00615280, void, __ctor, (app::PatrolBehaviour * this_ptr));
}
