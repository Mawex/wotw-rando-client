...
namespace app::methods::Mono_Security_Cryptography::HMAC {
IL2CPP_REGISTER_METHOD(0x02A3C290, Byte__Array *, get_Key, (app::HMAC_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A3C590, void, __ctor, (app::HMAC_1 * this_ptr, app::HashAlgorithm * ha, app::Byte__Array * rgb_key));
IL2CPP_REGISTER_METHOD(0x02A3C750, void, Initialize, (app::HMAC_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A3C790, Byte__Array *, HashFinal, (app::HMAC_1 * this_ptr));
