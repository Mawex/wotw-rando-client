...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_Type_System_MonoCustomAttrs_AttributeInfo_ {
    IL2CPP_REGISTER_METHOD(0x02259DF0, void, __ctor, (app::Dictionary_2_System_Type_System_MonoCustomAttrs_AttributeInfo_ * this_ptr, int32_t capacity));
