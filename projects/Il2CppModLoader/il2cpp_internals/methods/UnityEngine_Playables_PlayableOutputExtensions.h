...
IL2CPP_REGISTER_METHOD(0x015E6720, void, SetSourcePlayable, (AnimationPlayableOutput output, Playable value));
IL2CPP_REGISTER_METHODINFO(0x04709298, PlayableOutputExtensions_SetSourcePlayable_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015E6700, void, SetSourceOutputPort, (AnimationPlayableOutput output, int32_t value));
