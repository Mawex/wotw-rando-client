...
namespace app::methods::UnityEngine_Rendering::RenderTargetIdentifier {
    ...
    IL2CPP_REGISTER_METHOD(0x02978090, app::RenderTargetIdentifier, operator__1, (app::BuiltinRenderTextureType__Enum type));
    IL2CPP_REGISTER_METHOD(0x02978170, app::RenderTargetIdentifier, operator__2, (int32_t name_i_d));
    IL2CPP_REGISTER_METHOD(0x02978250, app::RenderTargetIdentifier, operator__3, (app::Texture * tex));
