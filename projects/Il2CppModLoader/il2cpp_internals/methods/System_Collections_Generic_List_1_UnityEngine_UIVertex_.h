...
namespace app::methods::System_Collections_Generic::List_1_UnityEngine_UIVertex_ {
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_1, (app::List_1_UnityEngine_UIVertex_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x02EE7B70, UIVertex, get_Item, (app::List_1_UnityEngine_UIVertex_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_2, (app::List_1_UnityEngine_UIVertex_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02EE7550, void, __ctor_3, (app::List_1_UnityEngine_UIVertex_ * this_ptr, app::IEnumerable_1_UnityEngine_UIVertex_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02EE7A10, Object *, ICollection_get_SyncRoot, (app::List_1_UnityEngine_UIVertex_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02EE7C60, bool, IsCompatibleObject, (app::Object * value));
IL2CPP_REGISTER_METHOD(0x02EE7DA0, Object *, IList_get_Item, (app::List_1_UnityEngine_UIVertex_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_UnityEngine_UIVertex_ *, AsReadOnly, (app::List_1_UnityEngine_UIVertex_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02EE8830, UIVertex, Find, (app::List_1_UnityEngine_UIVertex_ * this_ptr, app::Predicate_1_UnityEngine_UIVertex_ * match));
IL2CPP_REGISTER_METHOD(0x02EE8A00, List_1_UnityEngine_UIVertex_ *, FindAll, (app::List_1_UnityEngine_UIVertex_ * this_ptr, app::Predicate_1_UnityEngine_UIVertex_ * match));
...
IL2CPP_REGISTER_METHOD(0x02EE9000, List_1_T_Enumerator_UnityEngine_UIVertex_, GetEnumerator, (app::List_1_UnityEngine_UIVertex_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02EE9080, IEnumerator_1_UnityEngine_UIVertex_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_UnityEngine_UIVertex_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02EE9080, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_UnityEngine_UIVertex_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_UnityEngine_UIVertex_ *, GetRange, (app::List_1_UnityEngine_UIVertex_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, UIVertex__Array *, ToArray, (app::List_1_UnityEngine_UIVertex_ * this_ptr));
