...
IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkMIDIEvent_tCc * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x026F2760, void *, getCPtr, (app::AkMIDIEvent_tCc * obj));
IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkMIDIEvent_tCc * this_ptr, app::void * c_ptr));
