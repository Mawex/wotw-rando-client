...
IL2CPP_REGISTER_METHOD(0x00719D50, String *, get_RaceName, (app::RaceStateMachineContext * this_ptr));
IL2CPP_REGISTER_METHOD(0x00719DF0, RaceStateMachineContext_Waiter *, Wait, (app::RaceStateMachineContext * this_ptr, float time));
IL2CPP_REGISTER_METHOD(0x00719F50, String__Array *, GetFilesAtPath, (app::String * path));
...
IL2CPP_REGISTER_METHOD(0x0071B200, DifficultyMode__Enum, get_CurrentDifficulty, (app::RaceStateMachineContext * this_ptr));
IL2CPP_REGISTER_METHOD(0x0071B380, void, __ctor, (app::RaceStateMachineContext * this_ptr));
