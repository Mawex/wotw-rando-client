...
IL2CPP_REGISTER_METHOD(0x02CA77B0, ColliderAnimatorSystem_SphereColliderAnimationState *, Dequeue, (app::Queue_1_ColliderAnimatorSystem_SphereColliderAnimationState_ * this_ptr));
