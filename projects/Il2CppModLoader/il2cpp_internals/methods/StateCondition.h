...
IL2CPP_REGISTER_METHOD(0x009B4650, IUberState__Array *, get_AffectingUberStates, (app::StateCondition * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB40, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::StateCondition * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009B5000, void, __ctor, (app::StateCondition * this_ptr));
}
