...
namespace app::methods::UnityEngine_UI::RawImage {
IL2CPP_REGISTER_METHOD(0x02663790, void, __ctor, (app::RawImage * this_ptr));
IL2CPP_REGISTER_METHOD(0x026637C0, Texture *, get_mainTexture, (app::RawImage * this_ptr));
IL2CPP_REGISTER_METHOD(0x024B76C0, Texture *, get_texture, (app::RawImage * this_ptr));
IL2CPP_REGISTER_METHOD(0x02663990, void, set_texture, (app::RawImage * this_ptr, app::Texture * value));
IL2CPP_REGISTER_METHOD(0x02663A80, Rect, get_uvRect, (app::RawImage * this_ptr));
