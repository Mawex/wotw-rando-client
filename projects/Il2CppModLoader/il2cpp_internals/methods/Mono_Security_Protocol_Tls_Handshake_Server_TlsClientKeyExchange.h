...
namespace app::methods::Mono_Security_Protocol_Tls_Handshake_Server::TlsClientKeyExchange {
IL2CPP_REGISTER_METHOD(0x01F738E0, void, __ctor, (app::TlsClientKeyExchange * this_ptr, app::Context_1 * context, app::Byte__Array * buffer));
