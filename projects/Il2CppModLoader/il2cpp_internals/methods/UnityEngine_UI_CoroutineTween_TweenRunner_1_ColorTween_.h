...
namespace app::methods::UnityEngine_UI_CoroutineTween::TweenRunner_1_ColorTween_ {
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::TweenRunner_1_ColorTween_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02ACDFA0, IEnumerator *, Start, (app::ColorTween tween_info));
}
