...
IL2CPP_REGISTER_METHOD(0x00F76EC0, IEnumerator *, Perform_2, (app::BabySeinRunToTargetAction * this_ptr));
IL2CPP_REGISTER_METHOD(0x0044C850, void, __ctor, (app::BabySeinRunToTargetAction * this_ptr));
}
