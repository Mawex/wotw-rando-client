...
namespace app::methods::System_Collections_Specialized::ListDictionary {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_1, (app::ListDictionary * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB960, void, __ctor_2, (app::ListDictionary * this_ptr, app::IComparer * comparer));
IL2CPP_REGISTER_METHOD(0x02494840, Object *, get_Item, (app::ListDictionary * this_ptr, app::Object * key));
...
IL2CPP_REGISTER_METHOD(0x02494BF0, ICollection *, get_Keys, (app::ListDictionary * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02494D40, Object *, get_SyncRoot, (app::ListDictionary * this_ptr));
IL2CPP_REGISTER_METHOD(0x02494EA0, ICollection *, get_Values, (app::ListDictionary * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02495570, IDictionaryEnumerator *, GetEnumerator, (app::ListDictionary * this_ptr));
IL2CPP_REGISTER_METHOD(0x024956D0, IEnumerator *, IEnumerable_GetEnumerator, (app::ListDictionary * this_ptr));
