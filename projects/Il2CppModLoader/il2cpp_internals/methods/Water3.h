...
namespace app::methods::Water3 {
    ...
    IL2CPP_REGISTER_METHOD(0x02D70A10, Mesh*, GetMesh, (app::Water3 * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x02D72240, Vector3, GetNormalAt, (app::Water3 * this_ptr, app::Vector3 pos, float scale));
    IL2CPP_REGISTER_METHOD(0x02D72500, Vector3, GetHeightOffsetAt, (app::Water3 * this_ptr, app::Vector3 pos));
    ...
    IL2CPP_REGISTER_METHOD(0x02D749A0, Water3_WaterMode__Enum, GetWaterMode, (app::Water3 * this_ptr));
    IL2CPP_REGISTER_METHOD(0x02D749B0, Water3_WaterMode__Enum, FindHardwareWaterSupport, (app::Water3 * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00DBCEE0, float, sgn, (float a));
    IL2CPP_REGISTER_METHOD(0x02D74B20, Vector4, CameraSpacePlane, (app::Water3 * this_ptr, app::Camera* cam, app::Vector3 pos, app::Vector3 normal, float side_sign));
    ...
    IL2CPP_REGISTER_METHOD(0x02D75590, void, __ctor, (app::Water3 * this_ptr));
