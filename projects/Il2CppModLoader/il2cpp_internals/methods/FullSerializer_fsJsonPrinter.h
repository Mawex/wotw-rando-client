...
IL2CPP_REGISTER_METHOD(0x0150FBD0, String *, EscapeString, (app::String * str));
...
IL2CPP_REGISTER_METHOD(0x01510BF0, String *, PrettyJson_2, (app::fsData * data));
IL2CPP_REGISTER_METHOD(0x01510ED0, void, CompressedJson_1, (app::fsData * data, app::StreamWriter * output_stream));
IL2CPP_REGISTER_METHOD(0x01510EE0, String *, CompressedJson_2, (app::fsData * data));
