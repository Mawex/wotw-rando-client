...
namespace app::methods::System_Net::EndPointListener {
IL2CPP_REGISTER_METHOD(0x01EB42F0, void, __ctor, (app::EndPointListener * this_ptr, app::HttpListener * listener, app::IPAddress * addr, int32_t port, bool secure));
IL2CPP_REGISTER_METHOD(0x002FA280, HttpListener *, get_Listener, (app::EndPointListener * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01EB5160, HttpListener *, SearchListener, (app::EndPointListener * this_ptr, app::Uri * uri, app::ListenerPrefix * * prefix));
IL2CPP_REGISTER_METHOD(0x01EB56B0, HttpListener *, MatchFromList, (app::EndPointListener * this_ptr, app::String * host, app::String * path, app::ArrayList * list, app::ListenerPrefix * * prefix));
