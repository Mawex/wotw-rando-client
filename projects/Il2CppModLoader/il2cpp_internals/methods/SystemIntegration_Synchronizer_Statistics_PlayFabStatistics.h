...
namespace app::methods::SystemIntegration_Synchronizer_Statistics::PlayFabStatistics {
IL2CPP_REGISTER_METHOD(0x00535A80, String *, get_Name, (app::PlayFabStatistics * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00535B00, void, __ctor, (app::PlayFabStatistics * this_ptr, app::ISignInProvider * primary_sign_in_provider, app::ISignInProvider * secondary_sign_in_provider));
IL2CPP_REGISTER_METHOD(0x00535C70, CacheData__Array *, AwardedOnServer, (app::PlayFabStatistics * this_ptr));
