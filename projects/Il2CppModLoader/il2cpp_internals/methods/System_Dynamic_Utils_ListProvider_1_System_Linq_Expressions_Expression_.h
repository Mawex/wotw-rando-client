...
namespace app::methods::System_Dynamic_Utils::ListProvider_1_System_Linq_Expressions_Expression_ {
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::ListProvider_1_System_Linq_Expressions_Expression_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04749F60, ListProvider_1_System_Linq_Expressions_Expression___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02879B70, Expression *, get_Item, (app::ListProvider_1_System_Linq_Expressions_Expression_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02879EF0, IEnumerator_1_System_Linq_Expressions_Expression_ *, GetEnumerator, (app::ListProvider_1_System_Linq_Expressions_Expression_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x019DF3A0, IEnumerator *, IEnumerable_GetEnumerator, (app::ListProvider_1_System_Linq_Expressions_Expression_ * this_ptr));
}
