...
IL2CPP_REGISTER_METHOD(0x024D3F80, Material *, get_material, (app::CameraFilterPack_Blur_Radial_Fast * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024D3F50, void, __ctor, (app::CameraFilterPack_Blur_Radial_Fast * this_ptr));
}
