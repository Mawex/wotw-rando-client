...
namespace app::methods::System_Dynamic::BindingRestrictions_TypeRestriction {
...
IL2CPP_REGISTER_METHOD(0x01F8A7D0, Expression *, GetExpression, (app::BindingRestrictions_TypeRestriction * this_ptr));
}
