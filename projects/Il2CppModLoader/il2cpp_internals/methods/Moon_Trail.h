...
namespace app::methods::Moon::Trail {
    ...
    IL2CPP_REGISTER_METHOD(0x02569F10, List_1_Moon_Trail_Point_*, UpdatedRenderablePoints, (app::Trail * this_ptr, int32_t start, int32_t end));
    IL2CPP_REGISTER_METHOD(0x0256AA20, List_1_Moon_Trail_Point_*, GetRenderablePoints, (app::Trail * this_ptr, int32_t start, int32_t end));
    IL2CPP_REGISTER_METHOD(0x0256B340, void, UpdateTrailMesh, (app::Trail * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0256B650, Trail_CurveFrame, InitializeCurveFrame, (app::Trail * this_ptr, app::Vector3 point, app::Vector3 next_point));
    ...
    IL2CPP_REGISTER_METHOD(0x0256D3E0, void, __ctor, (app::Trail * this_ptr));
