...
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_Name, (app::SearchDebugMenuPage * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0106BA10, void, __ctor, (app::SearchDebugMenuPage * this_ptr));
}
