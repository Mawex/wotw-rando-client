...
IL2CPP_REGISTER_METHOD(0x02461BE0, Material *, get_material, (app::CameraFilterPack_Drawing_Toon * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024623B0, void, __ctor, (app::CameraFilterPack_Drawing_Toon * this_ptr));
}
