...
namespace app::methods::SeinCharacter {
    IL2CPP_REGISTER_METHOD(0x006A63A0, SpiritLightRadialVisualAffector*, get_LightAffector, (app::SeinCharacter * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00A3F500, Vector2, get_PhysicsSpeed, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A3F530, CharacterAnimationSystem*, get_Animation, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A3F570, MoonAnimator*, get_Animator, (app::SeinCharacter * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0070BB00, NavigationType__Enum, get_CurrentAreaType, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A3F600, void, set_CurrentAreaType, (app::SeinCharacter * this_ptr, app::NavigationType__Enum value));
    IL2CPP_REGISTER_METHOD(0x0065FBC0, SoundHost*, get_SoundHost, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A3F610, Transform*, get_Root, (app::SeinCharacter * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00A3F980, Vector3, get_Position, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A3F9E0, void, set_Position, (app::SeinCharacter * this_ptr, app::Vector3 value));
    IL2CPP_REGISTER_METHOD(0x00A3FA40, Vector3, get_MapDisplayPosition, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A3FB80, Vector3, get_PreviousPosition, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A3FBD0, Vector3, get_DeltaPosition, (app::SeinCharacter * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x004F4750, GameObject*, get_GameObject, (app::SeinCharacter * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00A42760, Vector2, get_PreviusPositionForWaterfallInteraction, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A42840, Vector2, get_PositionForWaterfallInteraction, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A42930, Vector2, get_SpeedForWaterfallInteraction, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A42A70, void, set_SpeedForWaterfallInteraction, (app::SeinCharacter * this_ptr, app::Vector2 value));
    IL2CPP_REGISTER_METHOD(0x00A42BC0, Rect, get_BoundsForWaterfallInteraction, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00420EE0, WaterfallIntersectionMode__Enum, get_WaterfallIntersectionMode, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A42D00, Rigidbody*, get_RigidbodyForWaterfallInteraction, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00417870, bool, get_IsFlamable, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A42D30, Vector3, get_Speed, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A42E30, void, set_Speed, (app::SeinCharacter * this_ptr, app::Vector3 value));
    IL2CPP_REGISTER_METHOD(0x00506170, Transform*, get_Transform, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A42F30, Transform*, get_CameraTarget, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A42FE0, CharacterCapsuleController*, get_CapsuleController, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0071EAB0, DamageOwner*, get_DamageOwner, (app::SeinCharacter * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00A43800, Vector3, get_FeetPosition, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A43850, Vector2, get_LocalSpeed, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A43890, SurfaceMaterialType__Enum, get_GroundMaterialType, (app::SeinCharacter * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00A43E40, void, __ctor, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720040, IMoonTypeResolver*, GetResolverForType_1, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720040, IMoonTypeResolver*, GetResolverForType_2, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720040, IMoonTypeResolver*, GetResolverForType_3, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720040, IMoonTypeResolver*, GetResolverForType_4, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720040, IMoonTypeResolver*, GetResolverForType_5, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720040, IMoonTypeResolver*, GetResolverForType_6, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720040, IMoonTypeResolver*, GetResolverForType_7, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720040, IMoonTypeResolver*, GetResolverForType_8, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720040, IMoonTypeResolver*, GetResolverForType_9, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720040, IMoonTypeResolver*, GetResolverForType_10, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720040, IMoonTypeResolver*, GetResolverForType_11, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720040, IMoonTypeResolver*, GetResolverForType_12, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720040, IMoonTypeResolver*, GetResolverForType_13, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720040, IMoonTypeResolver*, GetResolverForType_14, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720040, IMoonTypeResolver*, GetResolverForType_15, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720040, IMoonTypeResolver*, GetResolverForType_16, (app::SeinCharacter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720040, IMoonTypeResolver*, GetResolverForType_17, (app::SeinCharacter * this_ptr));
} // namespace app::methods::SeinCharacter
