...
IL2CPP_REGISTER_METHOD(0x030E5C50, void, __ctor, (app::DynamicInstantiationScanner_GameObjectVisitor * this_ptr, bool is_moon_reference, app::FieldInfo_1 * field, app::DynamicInstantiationAttribute * attribute));
IL2CPP_REGISTER_METHOD(0x030E5D50, Expression *, Visit, (app::DynamicInstantiationScanner_GameObjectVisitor * this_ptr, app::DynamicInstantiationScanner_VisitorCtx * visitor_ctx));
