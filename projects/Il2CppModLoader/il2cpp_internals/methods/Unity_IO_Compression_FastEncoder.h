...
namespace app::methods::Unity_IO_Compression::FastEncoder {
IL2CPP_REGISTER_METHOD(0x02B76210, void, __ctor, (app::FastEncoder * this_ptr));
IL2CPP_REGISTER_METHOD(0x02B76420, int32_t, get_BytesInHistory, (app::FastEncoder * this_ptr));
IL2CPP_REGISTER_METHOD(0x02B76440, DeflateInput *, get_UnprocessedInput, (app::FastEncoder * this_ptr));
