...
namespace app::methods::Moon_HierarchyPerformanceTest::HierarchyTestBulkTool {
    ...
    IL2CPP_REGISTER_METHOD(0x014A2E00, void, __ctor, (app::HierarchyTestBulkTool * this_ptr));
