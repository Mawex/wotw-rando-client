...
namespace app::methods::System_Text::Encoding_DefaultDecoder {
IL2CPP_REGISTER_METHOD(0x02453EF0, void, __ctor_1, (app::Encoding_DefaultDecoder * this_ptr, app::Encoding * encoding));
IL2CPP_REGISTER_METHOD(0x02453F00, void, __ctor_2, (app::Encoding_DefaultDecoder * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
IL2CPP_REGISTER_METHODINFO(0x0478EFF0, Encoding_DefaultDecoder__ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02454120, Object *, GetRealObject, (app::Encoding_DefaultDecoder * this_ptr, app::StreamingContext context));
...
IL2CPP_REGISTER_METHOD(0x02454280, int32_t, GetCharCount_3, (app::Encoding_DefaultDecoder * this_ptr, app::uint8_t * bytes, int32_t count, bool flush));
...
IL2CPP_REGISTER_METHOD(0x024542E0, int32_t, GetChars_3, (app::Encoding_DefaultDecoder * this_ptr, app::uint8_t * bytes, int32_t byte_count, app::uint16_t * chars, int32_t char_count, bool flush));
}
