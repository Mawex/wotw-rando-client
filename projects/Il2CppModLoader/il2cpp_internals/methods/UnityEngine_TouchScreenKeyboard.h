...
IL2CPP_REGISTER_METHOD(0x01F1B660, TouchScreenKeyboard *, Open_1, (app::String * text, app::TouchScreenKeyboardType__Enum keyboard_type, bool autocorrection, bool multiline, bool secure, bool alert, app::String * text_placeholder, int32_t character_limit));
IL2CPP_REGISTER_METHOD(0x01F1B660, TouchScreenKeyboard *, Open_2, (app::String * text, app::TouchScreenKeyboardType__Enum keyboard_type, bool autocorrection, bool multiline, bool secure));
IL2CPP_REGISTER_METHOD(0x02C6A9C0, String *, get_text, (app::TouchScreenKeyboard * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024CE020, TouchScreenKeyboard_Status__Enum, get_status, (app::TouchScreenKeyboard * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C6AA40, RangeInt, get_selection, (app::TouchScreenKeyboard * this_ptr));
