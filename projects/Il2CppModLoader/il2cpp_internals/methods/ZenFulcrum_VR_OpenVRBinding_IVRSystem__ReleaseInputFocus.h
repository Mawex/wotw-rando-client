...
namespace app::methods::ZenFulcrum_VR_OpenVRBinding::IVRSystem__ReleaseInputFocus {
    IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::IVRSystem_ReleaseInputFocus * this_ptr, app::Object * object, void * method_1));
