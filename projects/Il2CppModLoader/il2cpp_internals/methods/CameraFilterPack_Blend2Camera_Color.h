...
IL2CPP_REGISTER_METHOD(0x027434C0, Material *, get_material, (app::CameraFilterPack_Blend2Camera_Color * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02744690, void, __ctor, (app::CameraFilterPack_Blend2Camera_Color * this_ptr));
}
