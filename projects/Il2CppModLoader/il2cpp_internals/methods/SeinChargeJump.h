...
IL2CPP_REGISTER_METHOD(0x002FBC60, List_1_Moon_ComboSystem_IComboMove_ *, get_ComboMoves, (app::SeinChargeJump * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A47A30, SeinChargeJumpPuppet *, get_Puppet, (app::SeinChargeJump * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D0720, CharacterSpriteMirror *, get_CharacterSpriteMirror, (app::SeinChargeJump * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, ButtonInputType__Enum, get_ButtonInputType, (app::SeinChargeJump * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement *, get_PlatformMovement, (app::SeinChargeJump * this_ptr));
IL2CPP_REGISTER_METHOD(0x007E3F20, AbilityType__Enum, get_ComboAbilityType, (app::SeinChargeJump * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00417920, ComboMoveType__Enum, get_ComboMoveType, (app::SeinChargeJump * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A47F50, IAttackable *, GetValidTarget, (app::SeinChargeJump * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A481A0, IComboMove *, GetComboMove, (app::SeinChargeJump * this_ptr, app::ComboInput * input));
...
IL2CPP_REGISTER_METHOD(0x00A4B0E0, EffectSpawn, DamageEffectProvider, (app::SeinChargeJump * this_ptr, app::DamageResult damage_result));
...
IL2CPP_REGISTER_METHOD(0x00A4CDE0, void, UpdateDPadAngle, (bool smooth, app::float * angle_in_out, app::float * kbd_speed_in_out, app::float * kbd_angle_in_out, app::bool * kbd_clockwise_in_out));
...
IL2CPP_REGISTER_METHOD(0x005D06F0, CharacterLeftRightMovement *, get_LeftRightMovement, (app::SeinChargeJump * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A50960, void, __ctor, (app::SeinChargeJump * this_ptr));
}
