...
namespace app::methods::System_Security_Cryptography::AesManaged {
IL2CPP_REGISTER_METHOD(0x02FC8A30, void, __ctor, (app::AesManaged * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02FC8C70, Byte__Array *, get_IV, (app::AesManaged * this_ptr));
IL2CPP_REGISTER_METHOD(0x02FC8CA0, void, set_IV, (app::AesManaged * this_ptr, app::Byte__Array * value));
IL2CPP_REGISTER_METHOD(0x0210EA10, Byte__Array *, get_Key, (app::AesManaged * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02FC8D60, CipherMode__Enum, get_Mode, (app::AesManaged * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02FC8E80, PaddingMode__Enum, get_Padding, (app::AesManaged * this_ptr));
IL2CPP_REGISTER_METHOD(0x02FC8EB0, void, set_Padding, (app::AesManaged * this_ptr, app::PaddingMode__Enum value));
IL2CPP_REGISTER_METHOD(0x02FC8EE0, ICryptoTransform *, CreateDecryptor_1, (app::AesManaged * this_ptr));
IL2CPP_REGISTER_METHOD(0x02FC8F10, ICryptoTransform *, CreateDecryptor_2, (app::AesManaged * this_ptr, app::Byte__Array * key, app::Byte__Array * iv));
IL2CPP_REGISTER_METHODINFO(0x04746A28, AesManaged_CreateDecryptor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02FC90B0, ICryptoTransform *, CreateEncryptor_1, (app::AesManaged * this_ptr));
IL2CPP_REGISTER_METHOD(0x02FC90E0, ICryptoTransform *, CreateEncryptor_2, (app::AesManaged * this_ptr, app::Byte__Array * key, app::Byte__Array * iv));
