...
IL2CPP_REGISTER_METHOD(0x00EC44D0, BehaviourStatus__Enum, OnExecute, (app::SandWormShootingBehaviourNew * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00EC4D80, Vector2, get_ProjectilePeak, (app::SandWormShootingBehaviourNew * this_ptr));
IL2CPP_REGISTER_METHOD(0x00EC50A0, Vector3, get_ProjectileSpawnerPositionToPlayerPosition, (app::SandWormShootingBehaviourNew * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00EC5470, void, __ctor, (app::SandWormShootingBehaviourNew * this_ptr));
}
