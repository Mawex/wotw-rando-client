...
IL2CPP_REGISTER_METHOD(0x00218FB0, void, __ctor, (app::SliderHandler__Boxed * this_ptr, app::Rect position, float current_value, float size, float start, float end, app::GUIStyle * slider, app::GUIStyle * thumb, bool horiz, int32_t id));
...
IL2CPP_REGISTER_METHOD(0x00219050, EventType__Enum, CurrentEventType, (app::SliderHandler__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00219110, Event *, CurrentEvent, (app::SliderHandler__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00219140, Rect, ThumbSelectionRect, (app::SliderHandler__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00219190, void, StartDraggingWithValue, (app::SliderHandler__Boxed * this_ptr, float drag_start_value));
IL2CPP_REGISTER_METHOD(0x002191F0, SliderState *, SliderState, (app::SliderHandler__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00219140, Rect, ThumbRect, (app::SliderHandler__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00219200, Rect, VerticalThumbRect, (app::SliderHandler__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00219230, Rect, HorizontalThumbRect, (app::SliderHandler__Boxed * this_ptr));
