...
namespace app::methods::System_Collections_Generic::InternalStringComparer {
...
IL2CPP_REGISTER_METHOD(0x02022530, void, __ctor, (app::InternalStringComparer * this_ptr));
}
