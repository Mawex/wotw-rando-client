...
namespace app::methods::System_Collections_Generic::LinkedList_1_System_Net_WebConnectionGroup_ConnectionState_ {
    IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::LinkedList_1_System_Net_WebConnectionGroup_ConnectionState_ * this_ptr));
