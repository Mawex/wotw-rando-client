...
IL2CPP_REGISTER_METHOD(0x01149AE0, Int32__Array *, GetAllStateGUIDs, (app::LightCanvasStateController * this_ptr));
IL2CPP_REGISTER_METHOD(0x01149C10, String *, GetStateName, (app::LightCanvasStateController * this_ptr, int32_t state_g_u_i_d));
IL2CPP_REGISTER_METHOD(0x01149CC0, bool, HasStateGUID, (app::LightCanvasStateController * this_ptr, int32_t state_g_u_i_d));
IL2CPP_REGISTER_METHOD(0x01149CE0, LightCanvasStateController_LightCanvasState *, GetStateByGuid, (app::LightCanvasStateController * this_ptr, int32_t guid));
...
IL2CPP_REGISTER_METHOD(0x0114A310, void, __ctor, (app::LightCanvasStateController * this_ptr));
}
