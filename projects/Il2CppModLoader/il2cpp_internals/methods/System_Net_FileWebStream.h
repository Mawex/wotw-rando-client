...
namespace app::methods::System_Net::FileWebStream {
IL2CPP_REGISTER_METHOD(0x01D2BB10, void, __ctor_1, (app::FileWebStream * this_ptr, app::FileWebRequest * request, app::String * path, app::FileMode__Enum mode, app::FileAccess__Enum access, app::FileShare__Enum sharing));
IL2CPP_REGISTER_METHOD(0x01D2BC10, void, __ctor_2, (app::FileWebStream * this_ptr, app::FileWebRequest * request, app::String * path, app::FileMode__Enum mode, app::FileAccess__Enum access, app::FileShare__Enum sharing, int32_t length, bool async));
...
IL2CPP_REGISTER_METHOD(0x01D2C000, IAsyncResult *, BeginRead, (app::FileWebStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t size, app::AsyncCallback * callback, app::Object * state));
...
IL2CPP_REGISTER_METHOD(0x01D2C1C0, IAsyncResult *, BeginWrite, (app::FileWebStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t size, app::AsyncCallback * callback, app::Object * state));
