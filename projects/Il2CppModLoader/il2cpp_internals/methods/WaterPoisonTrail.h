...
IL2CPP_REGISTER_METHOD(0x008DE010, Damage *, GetDamageForPosition, (app::WaterPoisonTrail * this_ptr, app::Vector3 position));
...
IL2CPP_REGISTER_METHOD(0x008DFC00, void, __ctor, (app::WaterPoisonTrail * this_ptr));
}
