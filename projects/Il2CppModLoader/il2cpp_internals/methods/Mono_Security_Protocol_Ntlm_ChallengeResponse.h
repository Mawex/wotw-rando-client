...
namespace app::methods::Mono_Security_Protocol_Ntlm::ChallengeResponse {
IL2CPP_REGISTER_METHOD(0x02A48350, void, __ctor_1, (app::ChallengeResponse * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A483F0, void, __ctor_2, (app::ChallengeResponse * this_ptr, app::String * password, app::Byte__Array * challenge));
...
IL2CPP_REGISTER_METHOD(0x02A48BF0, Byte__Array *, get_LM, (app::ChallengeResponse * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0472FCC0, ChallengeResponse_get_LM__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02A48CB0, Byte__Array *, get_NT, (app::ChallengeResponse * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A48EE0, Byte__Array *, GetResponse, (app::ChallengeResponse * this_ptr, app::Byte__Array * pwd));
IL2CPP_REGISTER_METHOD(0x02A49130, Byte__Array *, PrepareDESKey, (app::ChallengeResponse * this_ptr, app::Byte__Array * key56bits, int32_t position));
IL2CPP_REGISTER_METHOD(0x02A49510, Byte__Array *, PasswordToKey, (app::ChallengeResponse * this_ptr, app::String * password, int32_t position));
