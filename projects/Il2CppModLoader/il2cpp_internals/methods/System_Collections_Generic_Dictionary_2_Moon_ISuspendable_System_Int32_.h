...
namespace app::methods::System_Collections_Generic::Dictionary_2_Moon_ISuspendable_System_Int32_ {
...
IL2CPP_REGISTER_METHOD(0x02BCDF80, bool, TryGetValue, (app::Dictionary_2_Moon_ISuspendable_System_Int32_ * this_ptr, app::ISuspendable * key, app::int32_t * value));
...
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_Moon_ISuspendable_System_Int32_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04702C88, Dictionary_2_Moon_ISuspendable_System_Int32___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0283B2B0, Dictionary_2_TKey_TValue_KeyCollection_Moon_ISuspendable_System_Int32_ *, get_Keys, (app::Dictionary_2_Moon_ISuspendable_System_Int32_ * this_ptr));
