...
namespace app::methods::KuDashPuppet {
    IL2CPP_REGISTER_METHOD(0x012345B0, MoonAnimator*, get_KuAnimator, (app::KuDashPuppet * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x012348F0, void, __ctor, (app::KuDashPuppet * this_ptr));
} // namespace app::methods::KuDashPuppet
