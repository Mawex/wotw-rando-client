...
IL2CPP_REGISTER_METHOD(0x02472D00, Material *, get_material, (app::CameraFilterPack_FX_Psycho * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02473490, void, __ctor, (app::CameraFilterPack_FX_Psycho * this_ptr));
}
