...
namespace app::methods::PetrifiedOwlBossRainOfFeathersBehaviour_StartState {
    IL2CPP_REGISTER_METHOD(0x0177D1A0, void, __ctor, (app::PetrifiedOwlBossRainOfFeathersBehaviour_StartState * this_ptr, app::PetrifiedOwlBossRainOfFeathersBehaviour * behaviour));
