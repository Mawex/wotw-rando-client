...
namespace app::methods::System_Xml::XmlTextReaderImpl {
IL2CPP_REGISTER_METHOD(0x01717AA0, void, __ctor_1, (app::XmlTextReaderImpl * this_ptr, app::XmlNameTable * nt));
IL2CPP_REGISTER_METHOD(0x017181C0, void, __ctor_2, (app::XmlTextReaderImpl * this_ptr, app::XmlResolver * resolver, app::XmlReaderSettings * settings, app::XmlParserContext * context));
IL2CPP_REGISTER_METHOD(0x01718AA0, void, __ctor_3, (app::XmlTextReaderImpl * this_ptr, app::Stream * input));
IL2CPP_REGISTER_METHOD(0x01718C20, void, __ctor_4, (app::XmlTextReaderImpl * this_ptr, app::String * url, app::Stream * input, app::XmlNameTable * nt));
IL2CPP_REGISTER_METHOD(0x01718E50, void, __ctor_5, (app::XmlTextReaderImpl * this_ptr, app::TextReader * input));
IL2CPP_REGISTER_METHOD(0x01718FD0, void, __ctor_6, (app::XmlTextReaderImpl * this_ptr, app::TextReader * input, app::XmlNameTable * nt));
IL2CPP_REGISTER_METHOD(0x01719090, void, __ctor_7, (app::XmlTextReaderImpl * this_ptr, app::String * url, app::TextReader * input, app::XmlNameTable * nt));
IL2CPP_REGISTER_METHOD(0x01719250, void, __ctor_8, (app::XmlTextReaderImpl * this_ptr, app::String * xml_fragment, app::XmlNodeType__Enum frag_type, app::XmlParserContext * context));
IL2CPP_REGISTER_METHOD(0x01719460, void, __ctor_9, (app::XmlTextReaderImpl * this_ptr, app::String * xml_fragment, app::XmlParserContext * context));
...
IL2CPP_REGISTER_METHOD(0x01719A90, void, __ctor_10, (app::XmlTextReaderImpl * this_ptr, app::Stream * stream, app::Byte__Array * bytes, int32_t byte_count, app::XmlReaderSettings * settings, app::Uri * base_uri, app::String * base_uri_str, app::XmlParserContext * context, bool close_input));
IL2CPP_REGISTER_METHOD(0x01719E80, void, FinishInitStream, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x01719F70, void, __ctor_11, (app::XmlTextReaderImpl * this_ptr, app::TextReader * input, app::XmlReaderSettings * settings, app::String * base_uri_str, app::XmlParserContext * context));
IL2CPP_REGISTER_METHOD(0x0171A180, void, FinishInitTextReader, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x0171A220, void, __ctor_12, (app::XmlTextReaderImpl * this_ptr, app::String * xml_fragment, app::XmlParserContext * context, app::XmlReaderSettings * settings));
IL2CPP_REGISTER_METHOD(0x0171A320, XmlReaderSettings *, get_Settings, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x0171A840, XmlNodeType__Enum, get_NodeType, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x0171A860, String *, get_Name, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x01073370, String *, get_LocalName, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D07570, String *, get_NamespaceURI, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x0171A890, String *, get_Prefix, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x0171A8B0, String *, get_Value, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x0171A920, int32_t, get_Depth, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x006D64E0, String *, get_BaseURI, (app::XmlTextReaderImpl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0171A9E0, XmlSpace__Enum, get_XmlSpace, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x01074330, String *, get_XmlLang, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x0171AA00, ReadState__Enum_1, get_ReadState, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x0171AA10, bool, get_EOF, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x00660430, XmlNameTable *, get_NameTable, (app::XmlTextReaderImpl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0171AA20, String *, GetAttribute_1, (app::XmlTextReaderImpl * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x0171AB00, String *, GetAttribute_2, (app::XmlTextReaderImpl * this_ptr, app::String * local_name, app::String * namespace_u_r_i));
IL2CPP_REGISTER_METHOD(0x0171ACF0, String *, GetAttribute_3, (app::XmlTextReaderImpl * this_ptr, int32_t i));
...
IL2CPP_REGISTER_METHOD(0x0171BBF0, String *, LookupNamespace_1, (app::XmlTextReaderImpl * this_ptr, app::String * prefix));
...
IL2CPP_REGISTER_METHOD(0x0171C390, String *, ReadString, (app::XmlTextReaderImpl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0171CA10, IDictionary_2_System_String_System_String_ *, IXmlNamespaceResolver_GetNamespacesInScope, (app::XmlTextReaderImpl * this_ptr, app::XmlNamespaceScope__Enum scope));
IL2CPP_REGISTER_METHOD(0x0171CA40, String *, IXmlNamespaceResolver_LookupNamespace, (app::XmlTextReaderImpl * this_ptr, app::String * prefix));
IL2CPP_REGISTER_METHOD(0x0171CA60, String *, IXmlNamespaceResolver_LookupPrefix, (app::XmlTextReaderImpl * this_ptr, app::String * namespace_name));
IL2CPP_REGISTER_METHOD(0x0171CA10, IDictionary_2_System_String_System_String_ *, GetNamespacesInScope, (app::XmlTextReaderImpl * this_ptr, app::XmlNamespaceScope__Enum scope));
IL2CPP_REGISTER_METHOD(0x0171CA60, String *, LookupPrefix, (app::XmlTextReaderImpl * this_ptr, app::String * namespace_name));
...
IL2CPP_REGISTER_METHOD(0x00660430, XmlNameTable *, get_DtdParserProxy_NameTable, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x0071EAB0, IXmlNamespaceResolver *, get_DtdParserProxy_NamespaceResolver, (app::XmlTextReaderImpl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0171D1E0, Uri *, get_DtdParserProxy_BaseUri, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x003FFE10, bool, get_DtdParserProxy_IsEof, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB00, Char__Array *, get_DtdParserProxy_ParsingBuffer, (app::XmlTextReaderImpl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00813FA0, IValidationEventHandling *, get_DtdParserProxy_ValidationEventHandling, (app::XmlTextReaderImpl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0171D5D0, XmlResolver *, GetTempResolver, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x0171D720, bool, DtdParserProxy_PushEntity, (app::XmlTextReaderImpl * this_ptr, app::IDtdEntityInfo * entity, app::int32_t * entity_id));
IL2CPP_REGISTER_METHOD(0x0171D820, bool, DtdParserProxy_PopEntity, (app::XmlTextReaderImpl * this_ptr, app::IDtdEntityInfo * * old_entity, app::int32_t * new_entity_id));
...
IL2CPP_REGISTER_METHOD(0x0171F970, Encoding *, DetectEncoding, (app::XmlTextReaderImpl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01720270, Encoding *, CheckEncoding, (app::XmlTextReaderImpl * this_ptr, app::String * new_encoding_name));
...
IL2CPP_REGISTER_METHOD(0x017213E0, void, InvalidCharRecovery, (app::XmlTextReaderImpl * this_ptr, app::int32_t * bytes_count, app::int32_t * chars_count));
...
IL2CPP_REGISTER_METHOD(0x01726F50, bool, ParseText_2, (app::XmlTextReaderImpl * this_ptr, app::int32_t * start_pos, app::int32_t * end_pos, app::int32_t * out_or_chars));
...
IL2CPP_REGISTER_METHOD(0x01728220, XmlTextReaderImpl_EntityType__Enum, HandleEntityReference, (app::XmlTextReaderImpl * this_ptr, bool is_in_attribute_value, app::XmlTextReaderImpl_EntityExpandType__Enum expand_type, app::int32_t * char_ref_end_pos));
IL2CPP_REGISTER_METHOD(0x017284F0, XmlTextReaderImpl_EntityType__Enum, HandleGeneralEntityReference, (app::XmlTextReaderImpl * this_ptr, app::String * name, bool is_in_attribute_value, bool push_fake_entity_if_null_resolver, int32_t entity_start_line_pos));
...
IL2CPP_REGISTER_METHOD(0x01729520, bool, ParsePIValue, (app::XmlTextReaderImpl * this_ptr, app::int32_t * out_start_pos, app::int32_t * out_end_pos));
...
IL2CPP_REGISTER_METHOD(0x01729BA0, bool, ParseCDataOrComment_2, (app::XmlTextReaderImpl * this_ptr, app::XmlNodeType__Enum type, app::int32_t * out_start_pos, app::int32_t * out_end_pos));
...
IL2CPP_REGISTER_METHOD(0x0172B400, int32_t, ParseCharRefInline, (app::XmlTextReaderImpl * this_ptr, int32_t start_pos, app::int32_t * char_count, app::XmlTextReaderImpl_EntityType__Enum * entity_type));
...
IL2CPP_REGISTER_METHOD(0x0172B590, int32_t, ParseNumericCharRefInline, (app::XmlTextReaderImpl * this_ptr, int32_t start_pos, bool expand, app::StringBuilder * internal_subset_builder, app::int32_t * char_count, app::XmlTextReaderImpl_EntityType__Enum * entity_type));
...
IL2CPP_REGISTER_METHOD(0x0172C270, int32_t, ParseQName_1, (app::XmlTextReaderImpl * this_ptr, app::int32_t * colon_pos));
IL2CPP_REGISTER_METHOD(0x0172C290, int32_t, ParseQName_2, (app::XmlTextReaderImpl * this_ptr, bool is_q_name, int32_t start_offset, app::int32_t * colon_pos));
IL2CPP_REGISTER_METHOD(0x0172C5D0, bool, ReadDataInName, (app::XmlTextReaderImpl * this_ptr, app::int32_t * pos));
IL2CPP_REGISTER_METHOD(0x0172C620, String *, ParseEntityName, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x0172C760, XmlTextReaderImpl_NodeData *, AddNode, (app::XmlTextReaderImpl * this_ptr, int32_t node_index, int32_t node_depth));
IL2CPP_REGISTER_METHOD(0x0172C7B0, XmlTextReaderImpl_NodeData *, AllocNode, (app::XmlTextReaderImpl * this_ptr, int32_t node_index, int32_t node_depth));
IL2CPP_REGISTER_METHOD(0x0172CA30, XmlTextReaderImpl_NodeData *, AddAttributeNoChecks, (app::XmlTextReaderImpl * this_ptr, app::String * name, int32_t attr_depth));
IL2CPP_REGISTER_METHOD(0x0172CB00, XmlTextReaderImpl_NodeData *, AddAttribute_1, (app::XmlTextReaderImpl * this_ptr, int32_t end_name_pos, int32_t colon_pos));
IL2CPP_REGISTER_METHOD(0x0172CD50, XmlTextReaderImpl_NodeData *, AddAttribute_2, (app::XmlTextReaderImpl * this_ptr, app::String * local_name, app::String * prefix, app::String * name_w_prefix));
...
IL2CPP_REGISTER_METHOD(0x0172D030, String *, LookupNamespace_2, (app::XmlTextReaderImpl * this_ptr, app::XmlTextReaderImpl_NodeData * node));
...
IL2CPP_REGISTER_METHOD(0x0172D790, XmlNodeType__Enum, GetWhitespaceType, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x0172D7E0, XmlNodeType__Enum, GetTextNodeType, (app::XmlTextReaderImpl * this_ptr, int32_t or_chars));
...
IL2CPP_REGISTER_METHOD(0x017303E0, String *, ParseUnexpectedToken_1, (app::XmlTextReaderImpl * this_ptr, int32_t pos));
IL2CPP_REGISTER_METHOD(0x017303F0, String *, ParseUnexpectedToken_2, (app::XmlTextReaderImpl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007008C0, IDtdInfo *, get_DtdInfo, (app::XmlTextReaderImpl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0129B9A0, XmlNodeType__Enum, get_FragmentType, (app::XmlTextReaderImpl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00418200, XmlResolver *, GetResolver, (app::XmlTextReaderImpl * this_ptr));
IL2CPP_REGISTER_METHOD(0x017311D0, void, set_InternalSchemaType, (app::XmlTextReaderImpl * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x01731200, Object *, get_InternalTypedValue, (app::XmlTextReaderImpl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0071EAB0, XmlNamespaceManager *, get_NamespaceManager, (app::XmlTextReaderImpl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x017318C0, XmlTextReaderImpl_NodeData *, AddDefaultAttributeInternal, (app::XmlTextReaderImpl * this_ptr, app::String * local_name, app::String * ns, app::String * prefix, app::String * value, int32_t line_no, int32_t line_pos, int32_t value_line_no, int32_t value_line_pos, bool is_xml_attribute));
...
IL2CPP_REGISTER_METHOD(0x01731EA0, String *, StripSpaces_1, (app::String * value));
IL2CPP_REGISTER_METHOD(0x01732160, void, StripSpaces_2, (app::Char__Array * value, int32_t index, app::int32_t * len));
