...
namespace app::methods::System_Text::UTF7Encoding {
IL2CPP_REGISTER_METHOD(0x027CAC80, void, __ctor_1, (app::UTF7Encoding * this_ptr));
IL2CPP_REGISTER_METHOD(0x027CAD20, void, __ctor_2, (app::UTF7Encoding * this_ptr, bool allow_optionals));
...
IL2CPP_REGISTER_METHOD(0x027CB850, int32_t, GetByteCount_3, (app::UTF7Encoding * this_ptr, app::uint16_t * chars, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x027CBEC0, int32_t, GetBytes_3, (app::UTF7Encoding * this_ptr, app::uint16_t * chars, int32_t char_count, app::uint8_t * bytes, int32_t byte_count));
...
IL2CPP_REGISTER_METHOD(0x027CC210, int32_t, GetCharCount_2, (app::UTF7Encoding * this_ptr, app::uint8_t * bytes, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x027CC5F0, int32_t, GetChars_2, (app::UTF7Encoding * this_ptr, app::uint8_t * bytes, int32_t byte_count, app::uint16_t * chars, int32_t char_count));
IL2CPP_REGISTER_METHODINFO(0x0477C638, UTF7Encoding_GetChars_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027CC770, String *, GetString, (app::UTF7Encoding * this_ptr, app::Byte__Array * bytes, int32_t index, int32_t count));
IL2CPP_REGISTER_METHODINFO(0x0472B388, UTF7Encoding_GetString__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027CC940, int32_t, GetByteCount_4, (app::UTF7Encoding * this_ptr, app::uint16_t * chars, int32_t count, app::EncoderNLS * base_encoder));
IL2CPP_REGISTER_METHOD(0x027CC970, int32_t, GetBytes_4, (app::UTF7Encoding * this_ptr, app::uint16_t * chars, int32_t char_count, app::uint8_t * bytes, int32_t byte_count, app::EncoderNLS * base_encoder));
IL2CPP_REGISTER_METHOD(0x027CCF60, int32_t, GetCharCount_3, (app::UTF7Encoding * this_ptr, app::uint8_t * bytes, int32_t count, app::DecoderNLS * base_decoder));
IL2CPP_REGISTER_METHOD(0x027CCF90, int32_t, GetChars_3, (app::UTF7Encoding * this_ptr, app::uint8_t * bytes, int32_t byte_count, app::uint16_t * chars, int32_t char_count, app::DecoderNLS * base_decoder));
IL2CPP_REGISTER_METHOD(0x027CD360, Decoder *, GetDecoder, (app::UTF7Encoding * this_ptr));
IL2CPP_REGISTER_METHOD(0x027CD4D0, Encoder *, GetEncoder, (app::UTF7Encoding * this_ptr));
