...
namespace app::methods::System_Xml_Linq::NamespaceResolver {
...
IL2CPP_REGISTER_METHOD(0x00241350, String *, GetPrefixOfNamespace, (app::NamespaceResolver__Boxed * this_ptr, app::XNamespace * ns, bool allow_default_namespace));
}
