...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::PointerUIGUI {
...
IL2CPP_REGISTER_METHOD(0x01661D40, IEnumerator *, WatchResize, (app::PointerUIGUI * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01661F40, Vector2, MapPointerToBrowser, (app::PointerUIGUI * this_ptr, app::Vector2 screen_position, int32_t pointer_id));
IL2CPP_REGISTER_METHOD(0x016622D0, Vector2, MapRayToBrowser, (app::PointerUIGUI * this_ptr, app::Ray world_ray, int32_t pointer_id));
...
IL2CPP_REGISTER_METHOD(0x01662680, void, __ctor, (app::PointerUIGUI * this_ptr));
}
