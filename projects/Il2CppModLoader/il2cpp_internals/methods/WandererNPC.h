...
namespace app::methods::WandererNPC {
    ...
    IL2CPP_REGISTER_METHOD(0x008C91E0, GroundEntityLocomotion*, get_Locomotion, (app::WandererNPC * this_ptr));
    IL2CPP_REGISTER_METHOD(0x008C92C0, void, Start, (app::WandererNPC * this_ptr));
    IL2CPP_REGISTER_METHOD(0x004B67E0, WandererNPC_State__Enum, get_CurrentState, (app::WandererNPC * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FBB60, IMoonTypeResolver*, GetResolverForType_1, (app::WandererNPC * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB60, IMoonTypeResolver*, GetResolverForType_2, (app::WandererNPC * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB60, IMoonTypeResolver*, GetResolverForType_3, (app::WandererNPC * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB60, IMoonTypeResolver*, GetResolverForType_4, (app::WandererNPC * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB60, IMoonTypeResolver*, GetResolverForType_5, (app::WandererNPC * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB60, IMoonTypeResolver*, GetResolverForType_6, (app::WandererNPC * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB60, IMoonTypeResolver*, GetResolverForType_7, (app::WandererNPC * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB60, IMoonTypeResolver*, GetResolverForType_8, (app::WandererNPC * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB60, IMoonTypeResolver*, GetResolverForType_9, (app::WandererNPC * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB60, IMoonTypeResolver*, GetResolverForType_10, (app::WandererNPC * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB60, IMoonTypeResolver*, GetResolverForType_11, (app::WandererNPC * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB60, IMoonTypeResolver*, GetResolverForType_12, (app::WandererNPC * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB60, IMoonTypeResolver*, GetResolverForType_13, (app::WandererNPC * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB60, IMoonTypeResolver*, GetResolverForType_14, (app::WandererNPC * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB60, IMoonTypeResolver*, GetResolverForType_15, (app::WandererNPC * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB60, IMoonTypeResolver*, GetResolverForType_16, (app::WandererNPC * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB60, IMoonTypeResolver*, GetResolverForType_17, (app::WandererNPC * this_ptr));
} // namespace app::methods::WandererNPC
