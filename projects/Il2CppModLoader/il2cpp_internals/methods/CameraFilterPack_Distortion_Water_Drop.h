...
IL2CPP_REGISTER_METHOD(0x024ECCF0, Material *, get_material, (app::CameraFilterPack_Distortion_Water_Drop * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024ED6E0, void, __ctor, (app::CameraFilterPack_Distortion_Water_Drop * this_ptr));
}
