...
namespace app::methods::System_Collections_Generic::ArrayBuilder_1_System_Object_ {
...
IL2CPP_REGISTER_METHOD(0x00239E00, Object *, get_Item, (app::ArrayBuilder_1_System_Object___Boxed * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x00239DE0, void, __ctor, (app::ArrayBuilder_1_System_Object___Boxed * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x00239E40, void, Add, (app::ArrayBuilder_1_System_Object___Boxed * this_ptr, app::Object * item));
IL2CPP_REGISTER_METHOD(0x00239E50, Object__Array *, ToArray, (app::ArrayBuilder_1_System_Object___Boxed * this_ptr));
