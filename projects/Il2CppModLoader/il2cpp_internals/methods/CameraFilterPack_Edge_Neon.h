...
IL2CPP_REGISTER_METHOD(0x024654E0, Material *, get_material, (app::CameraFilterPack_Edge_Neon * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E70F0, void, __ctor, (app::CameraFilterPack_Edge_Neon * this_ptr));
}
