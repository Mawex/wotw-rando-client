...
namespace app::methods::SpiritTurret {
    ...
    IL2CPP_REGISTER_METHOD(0x00D7C800, Vector3, HoverOffset, (app::SpiritTurret * this_ptr, float time));
    IL2CPP_REGISTER_METHOD(0x00C47CC0, Vector3, get_Position, (app::SpiritTurret * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00974AE0, SuspendableMask__Enum, get_Mask, (app::SpiritTurret * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00D7D3F0, IAttackable*, FindNearestAttackable, (app::SpiritTurret * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00D7D770, Guid, get_AttackableConsumerID, (app::SpiritTurret * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00D7F860, void, __ctor, (app::SpiritTurret * this_ptr));
