...
IL2CPP_REGISTER_METHOD(0x006CA160, void, __ctor, (app::ButtonAxisInput * this_ptr, app::IButtonInput * button_input, app::ButtonAxisInput_Mode__Enum mode));
...
IL2CPP_REGISTER_METHOD(0x002FB930, IButtonInput *, GetButtonInput, (app::ButtonAxisInput * this_ptr));
