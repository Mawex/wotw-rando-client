...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_Xml_XmlQualifiedName_System_Xml_Schema_SchemaEntity_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_System_Xml_XmlQualifiedName_System_Xml_Schema_SchemaEntity_ * this_ptr));
