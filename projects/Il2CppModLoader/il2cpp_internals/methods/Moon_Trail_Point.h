...
namespace app::methods::Moon::Trail_Point {
    ...
    IL2CPP_REGISTER_METHOD(0x0256F950, app::Trail_Point, operator___1, (app::Trail_Point p1, app::Trail_Point p2));
    IL2CPP_REGISTER_METHOD(0x0256FC40, app::Trail_Point, operator___2, (app::Trail_Point p1, app::Trail_Point p2));
}
