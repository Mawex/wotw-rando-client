...
namespace app::methods::System_IO::UnexceptionalStreamWriter {
IL2CPP_REGISTER_METHOD(0x02389090, void, __ctor, (app::UnexceptionalStreamWriter * this_ptr, app::Stream * stream, app::Encoding * encoding));
