...
namespace app::methods::System_Xml::XmlEventCache {
IL2CPP_REGISTER_METHOD(0x01DB6180, void, __ctor, (app::XmlEventCache * this_ptr, app::String * base_uri, bool has_root_node));
...
IL2CPP_REGISTER_METHOD(0x01DB7B90, Byte__Array *, ToBytes, (app::Byte__Array * buffer, int32_t index, int32_t count));
}
