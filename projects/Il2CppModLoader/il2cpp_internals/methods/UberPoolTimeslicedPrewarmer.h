...
IL2CPP_REGISTER_METHOD(0x002FB990, UberPoolGroupWarmer__Array *, get_Warmers, (app::UberPoolTimeslicedPrewarmer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FEDBA0, void, __ctor, (app::UberPoolTimeslicedPrewarmer * this_ptr));
}
