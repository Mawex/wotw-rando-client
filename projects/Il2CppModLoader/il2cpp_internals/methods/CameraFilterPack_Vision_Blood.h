...
IL2CPP_REGISTER_METHOD(0x020F5700, Material *, get_material, (app::CameraFilterPack_Vision_Blood * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020F5EE0, void, __ctor, (app::CameraFilterPack_Vision_Blood * this_ptr));
}
