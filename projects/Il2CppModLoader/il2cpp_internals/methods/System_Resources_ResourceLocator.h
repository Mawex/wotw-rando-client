...
namespace app::methods::System_Resources::ResourceLocator {
IL2CPP_REGISTER_METHOD(0x0018ED30, void, __ctor, (app::ResourceLocator__Boxed * this_ptr, int32_t data_pos, app::Object * value));
IL2CPP_REGISTER_METHOD(0x0010A860, int32_t, get_DataPosition, (app::ResourceLocator__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00107C00, Object *, get_Value, (app::ResourceLocator__Boxed * this_ptr));
