...
IL2CPP_REGISTER_METHOD(0x02F937B0, CrossSceneReferenceId, get_CrossSceneReferenceId, (app::MoonDouble * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F93990, void, __ctor, (app::MoonDouble * this_ptr, double static_value));
...
IL2CPP_REGISTER_METHOD(0x02F94040, bool, TryResolve, (app::MoonDouble * this_ptr, app::double * value, app::IMoonResolverContext * context));
...
IL2CPP_REGISTER_METHOD(0x00C3DD30, MoonTypeData, GetTypeData, (app::MoonDouble * this_ptr));
}
