...
IL2CPP_REGISTER_METHOD(0x001EB5F0, Vector3, get_position, (app::ParticleSystem_Particle__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001EB610, void, set_position, (app::ParticleSystem_Particle__Boxed * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x001EB680, Vector3, get_velocity, (app::ParticleSystem_Particle__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002487E0, Color32, get_startColor, (app::ParticleSystem_Particle__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002487F0, Vector3, get_axisOfRotation, (app::ParticleSystem_Particle__Boxed * this_ptr));
