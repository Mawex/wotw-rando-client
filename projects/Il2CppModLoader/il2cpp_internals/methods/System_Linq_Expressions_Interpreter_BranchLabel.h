...
namespace app::methods::System_Linq_Expressions_Interpreter::BranchLabel {
...
IL2CPP_REGISTER_METHOD(0x022D65B0, RuntimeLabel, ToRuntimeLabel, (app::BranchLabel * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x022D6AD0, void, __ctor, (app::BranchLabel * this_ptr));
}
