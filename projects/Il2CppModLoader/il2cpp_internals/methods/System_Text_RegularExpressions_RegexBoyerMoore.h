...
namespace app::methods::System_Text_RegularExpressions::RegexBoyerMoore {
IL2CPP_REGISTER_METHOD(0x025878B0, void, __ctor, (app::RegexBoyerMoore * this_ptr, app::String * pattern, bool case_insensitive, bool right_to_left, app::CultureInfo * culture));
...
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, ToString, (app::RegexBoyerMoore * this_ptr));
}
