...
namespace app::methods::System_Security_Util::Tokenizer_StreamTokenReader {
IL2CPP_REGISTER_METHOD(0x00E464D0, void, __ctor, (app::Tokenizer_StreamTokenReader * this_ptr, app::StreamReader * input));
