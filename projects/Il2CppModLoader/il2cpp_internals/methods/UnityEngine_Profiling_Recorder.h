...
namespace app::methods::UnityEngine_Profiling::Recorder {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_1, (app::Recorder * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor_2, (app::Recorder * this_ptr, app::void * ptr));
...
IL2CPP_REGISTER_METHOD(0x029699A0, void, DisposeNative, (app::void * ptr));
