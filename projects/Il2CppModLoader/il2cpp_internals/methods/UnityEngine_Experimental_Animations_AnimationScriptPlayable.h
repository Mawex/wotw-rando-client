...
namespace app::methods::UnityEngine_Experimental_Animations::AnimationScriptPlayable {
...
IL2CPP_REGISTER_METHOD(0x001D9980, PlayableHandle, GetHandle, (app::AnimationScriptPlayable__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0307C600, Playable, operator__1, (app::AnimationScriptPlayable playable));
IL2CPP_REGISTER_METHOD(0x03086610, AnimationScriptPlayable, operator__2, (app::Playable playable));
...
IL2CPP_REGISTER_METHOD(0x03086650, bool, CreateHandleInternal, (app::PlayableGraph graph, app::PlayableHandle * handle, app::void * job_reflection_data));
IL2CPP_REGISTER_METHOD(0x03086740, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x03086810, bool, CreateHandleInternal_Injected, (app::PlayableGraph * graph, app::PlayableHandle * handle, app::void * job_reflection_data));
...
IL2CPP_REGISTER_METHOD(0x02FF7A00, AnimationScriptPlayable, Create_1, (app::PlayableGraph graph, app::DelayJointPostprocessJob job_data, int32_t input_count));
IL2CPP_REGISTER_METHOD(0x02FF7B70, AnimationScriptPlayable, Create_2, (app::PlayableGraph graph, app::MatchJointsJob job_data, int32_t input_count));
IL2CPP_REGISTER_METHOD(0x02FF80B0, PlayableHandle, CreateHandle_1, (app::PlayableGraph graph, int32_t input_count));
IL2CPP_REGISTER_METHOD(0x02FF82D0, PlayableHandle, CreateHandle_2, (app::PlayableGraph graph, int32_t input_count));
}
