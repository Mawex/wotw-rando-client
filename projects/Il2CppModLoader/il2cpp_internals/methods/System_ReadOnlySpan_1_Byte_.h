...
IL2CPP_REGISTER_METHOD(0x00219D80, void, __ctor_1, (app::ReadOnlySpan_1_Byte___Boxed * this_ptr, app::Byte__Array * array));
...
IL2CPP_REGISTER_METHOD(0x00219D90, void, __ctor_2, (app::ReadOnlySpan_1_Byte___Boxed * this_ptr, app::Void * pointer, int32_t length));
IL2CPP_REGISTER_METHOD(0x00219EF0, String *, get_DebuggerDisplay, (app::ReadOnlySpan_1_Byte___Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00107C00, Pinnable_1_Byte_ *, get_Pinnable, (app::ReadOnlySpan_1_Byte___Boxed * this_ptr));
