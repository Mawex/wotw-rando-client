...
IL2CPP_REGISTER_METHOD(0x030A3870, void, __ctor, (app::PhysicMaterial * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030A3BD0, PhysicMaterialCombine__Enum, get_frictionCombine, (app::PhysicMaterial * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030A3C80, PhysicMaterialCombine__Enum, get_bounceCombine, (app::PhysicMaterial * this_ptr));
