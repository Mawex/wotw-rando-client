...
namespace app::methods::System_Net::CookieContainer {
IL2CPP_REGISTER_METHOD(0x01EA24B0, void, __ctor_1, (app::CookieContainer * this_ptr));
IL2CPP_REGISTER_METHOD(0x01EA2680, void, __ctor_2, (app::CookieContainer * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHODINFO(0x0477D440, CookieContainer__ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EA2760, void, __ctor_3, (app::CookieContainer * this_ptr, int32_t capacity, int32_t per_domain_capacity, int32_t max_cookie_size));
...
IL2CPP_REGISTER_METHOD(0x01EA58E0, CookieCollection *, CookieCutter, (app::CookieContainer * this_ptr, app::Uri * uri, app::String * header_name, app::String * set_cookie_header, bool is_throw));
IL2CPP_REGISTER_METHODINFO(0x0473E120, CookieContainer_CookieCutter__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EA6240, CookieCollection *, GetCookies, (app::CookieContainer * this_ptr, app::Uri * uri));
IL2CPP_REGISTER_METHODINFO(0x0474DD30, CookieContainer_GetCookies__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EA6320, CookieCollection *, InternalGetCookies, (app::CookieContainer * this_ptr, app::Uri * uri));
...
IL2CPP_REGISTER_METHOD(0x01EA71F0, String *, GetCookieHeader_1, (app::CookieContainer * this_ptr, app::Uri * uri));
IL2CPP_REGISTER_METHODINFO(0x0474A278, CookieContainer_GetCookieHeader__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EA72E0, String *, GetCookieHeader_2, (app::CookieContainer * this_ptr, app::Uri * uri, app::String * * opt_cookie2));
