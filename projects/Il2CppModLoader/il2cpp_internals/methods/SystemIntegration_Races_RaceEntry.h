...
namespace app::methods::SystemIntegration_Races::RaceEntry {
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_UserId, (app::RaceEntry * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_UserId, (app::RaceEntry * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_DisplayName, (app::RaceEntry * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB00, Byte__Array *, get_Data, (app::RaceEntry * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB10, void, set_Data, (app::RaceEntry * this_ptr, app::Byte__Array * value));
IL2CPP_REGISTER_METHOD(0x002FB990, DateTime, get_EntryTime, (app::RaceEntry * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::RaceEntry * this_ptr));
}
