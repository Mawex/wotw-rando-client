...
IL2CPP_REGISTER_METHOD(0x0273E0E0, Material *, get_material, (app::CameraFilterPack_AAA_WaterDrop * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0273E9B0, void, __ctor, (app::CameraFilterPack_AAA_WaterDrop * this_ptr));
}
