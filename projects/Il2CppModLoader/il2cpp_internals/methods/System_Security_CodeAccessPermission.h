...
namespace app::methods::System_Security::CodeAccessPermission {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::CodeAccessPermission * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020C7850, String *, ToString, (app::CodeAccessPermission * this_ptr));
IL2CPP_REGISTER_METHOD(0x020C7890, IPermission *, Union, (app::CodeAccessPermission * this_ptr, app::IPermission * other));
IL2CPP_REGISTER_METHODINFO(0x04782D50, CodeAccessPermission_Union__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020C7930, SecurityElement *, Element, (app::CodeAccessPermission * this_ptr, int32_t version));
IL2CPP_REGISTER_METHOD(0x020C7B80, PermissionState__Enum, CheckPermissionState, (app::PermissionState__Enum state, bool allow_unrestricted));
