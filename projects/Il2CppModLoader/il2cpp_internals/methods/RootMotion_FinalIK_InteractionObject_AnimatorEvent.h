...
namespace app::methods::RootMotion_FinalIK::InteractionObject_AnimatorEvent {
    ...
    IL2CPP_REGISTER_METHOD(0x02A0DC10, void, __ctor, (app::InteractionObject_AnimatorEvent * this_ptr));
}
