...
namespace app::methods::System_Xml::XmlAutoDetectWriter {
IL2CPP_REGISTER_METHOD(0x0195DDC0, void, __ctor_1, (app::XmlAutoDetectWriter * this_ptr, app::XmlWriterSettings * writer_settings));
IL2CPP_REGISTER_METHOD(0x0195DF50, void, __ctor_2, (app::XmlAutoDetectWriter * this_ptr, app::TextWriter * text_writer, app::XmlWriterSettings * writer_settings));
IL2CPP_REGISTER_METHOD(0x0195DF80, void, __ctor_3, (app::XmlAutoDetectWriter * this_ptr, app::Stream * strm, app::XmlWriterSettings * writer_settings));
