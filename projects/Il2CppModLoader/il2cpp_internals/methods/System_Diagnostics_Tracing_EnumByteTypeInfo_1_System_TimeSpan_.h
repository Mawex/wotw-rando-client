...
namespace app::methods::System_Diagnostics_Tracing::EnumByteTypeInfo_1_System_TimeSpan_ {
...
IL2CPP_REGISTER_METHOD(0x00502220, Object *, GetData, (app::EnumByteTypeInfo_1_System_TimeSpan_ * this_ptr, app::Object * value));
