...
IL2CPP_REGISTER_METHOD(0x00BE42F0, BehaviourStatus__Enum, OnExecuteTask, (app::DropSlugFallReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00733FD0, void, __ctor, (app::DropSlugFallReactionBehaviour * this_ptr));
}
