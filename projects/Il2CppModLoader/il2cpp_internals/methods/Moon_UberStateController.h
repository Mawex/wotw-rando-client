...
IL2CPP_REGISTER_METHOD(0x01B6B010, SceneUberStateGroup *, GetSceneGroup, (app::String * scene));
...
IL2CPP_REGISTER_METHOD(0x01B6B850, bool, IsWaitingToApplyApplier_1, (app::UberStateController * this_ptr, app::IUberStateApplier * applier, app::int32_t * index));
...
IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::UberStateController * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, UpdateEditorAppliersCache, ());
IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, get_IsPlaying, ());
IL2CPP_REGISTER_METHOD(0x01B6C550, void, __ctor, (app::UberStateController * this_ptr));
