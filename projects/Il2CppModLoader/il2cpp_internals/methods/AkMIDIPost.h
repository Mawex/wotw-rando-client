...
namespace app::methods::AkMIDIPost {
    IL2CPP_REGISTER_METHOD(0x026F76A0, void, __ctor_1, (app::AkMIDIPost * this_ptr, app::void* c_ptr, bool c_memory_own));
    IL2CPP_REGISTER_METHOD(0x026F7760, void*, getCPtr, (app::AkMIDIPost * obj));
    IL2CPP_REGISTER_METHOD(0x026F77F0, void, setCPtr, (app::AkMIDIPost * this_ptr, app::void* c_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x026F7DD0, AKRESULT__Enum, PostOnEvent, (app::AkMIDIPost * this_ptr, uint32_t in_event_i_d, app::GameObject* in_game_object_i_d, uint32_t in_u_num_posts));
    ...
    IL2CPP_REGISTER_METHOD(0x026F8090, void, __ctor_2, (app::AkMIDIPost * this_ptr));
} // namespace app::methods::AkMIDIPost
