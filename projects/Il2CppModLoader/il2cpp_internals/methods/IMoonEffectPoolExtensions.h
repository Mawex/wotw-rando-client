...
IL2CPP_REGISTER_METHOD(0x015EAF20, Object *, GetInstance_1, (app::IMoonEffectPool_1_System_Object_ * pool));
IL2CPP_REGISTER_METHOD(0x015EAF20, MoonEffectGenericRevertibleData_MoonEffectRevertibleData *, GetInstance_2, (app::IMoonEffectPool_1_Moon_EffectsFramework_MoonEffectGenericRevertibleData_MoonEffectRevertibleData_ * pool));
IL2CPP_REGISTER_METHODINFO(0x047948C8, IMoonEffectPoolExtensions_GetInstance_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015EAF20, MoonEffectGenericRevertibleData_MoonEffectRevertibleParticleData *, GetInstance_3, (app::IMoonEffectPool_1_Moon_EffectsFramework_MoonEffectGenericRevertibleData_MoonEffectRevertibleParticleData_ * pool));
...
IL2CPP_REGISTER_METHOD(0x015EAF20, MoonEffectGenericRevertibleData_MoonEffectRevertibleRendererData *, GetInstance_4, (app::IMoonEffectPool_1_Moon_EffectsFramework_MoonEffectGenericRevertibleData_MoonEffectRevertibleRendererData_ * pool));
IL2CPP_REGISTER_METHODINFO(0x0478FD10, IMoonEffectPoolExtensions_GetInstance_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015EAF20, MoonEffectRevertHandle *, GetInstance_5, (app::IMoonEffectPool_1_Moon_EffectsFramework_MoonEffectRevertHandle_ * pool));
