...
IL2CPP_REGISTER_METHOD(0x024F77C0, Material *, get_material, (app::CameraFilterPack_Drawing_Manga_Flash_Color * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024F81E0, void, __ctor, (app::CameraFilterPack_Drawing_Manga_Flash_Color * this_ptr));
}
