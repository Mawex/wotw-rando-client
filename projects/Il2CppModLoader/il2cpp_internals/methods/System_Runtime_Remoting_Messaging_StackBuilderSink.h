...
namespace app::methods::System_Runtime_Remoting_Messaging::StackBuilderSink {
...
IL2CPP_REGISTER_METHOD(0x0231A830, IMessage *, SyncProcessMessage, (app::StackBuilderSink * this_ptr, app::IMessage * msg));
IL2CPP_REGISTER_METHOD(0x0231A950, IMessageCtrl *, AsyncProcessMessage, (app::StackBuilderSink * this_ptr, app::IMessage * msg, app::IMessageSink * reply_sink));
