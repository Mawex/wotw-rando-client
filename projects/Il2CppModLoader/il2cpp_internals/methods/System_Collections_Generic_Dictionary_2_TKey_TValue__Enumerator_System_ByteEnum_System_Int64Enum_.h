...
namespace app::methods::System_Collections_Generic::Dictionary_2_TKey_TValue__Enumerator_System_ByteEnum_System_Int64Enum_ {
    IL2CPP_REGISTER_METHOD(0x001363F0, void, __ctor, (app::Dictionary_2_TKey_TValue_Enumerator_System_ByteEnum_System_Int64Enum___Boxed * this_ptr, app::Dictionary_2_System_ByteEnum_System_Int64Enum_ * dictionary, int32_t get_enumerator_ret_type));
