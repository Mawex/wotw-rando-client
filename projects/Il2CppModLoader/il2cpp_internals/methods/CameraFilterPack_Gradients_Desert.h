...
IL2CPP_REGISTER_METHOD(0x0247A740, Material *, get_material, (app::CameraFilterPack_Gradients_Desert * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0247AD60, void, __ctor, (app::CameraFilterPack_Gradients_Desert * this_ptr));
}
