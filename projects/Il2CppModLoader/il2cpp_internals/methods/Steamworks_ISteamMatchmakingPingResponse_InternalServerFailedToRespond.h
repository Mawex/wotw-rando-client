...
namespace app::methods::Steamworks::ISteamMatchmakingPingResponse_InternalServerFailedToRespond {
    IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::ISteamMatchmakingPingResponse_InternalServerFailedToRespond * this_ptr, app::Object * object, void * method_1));
