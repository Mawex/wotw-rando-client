...
IL2CPP_REGISTER_METHOD(0x0074DC90, SkeetoLocomotion *, get_Locomotion, (app::SkeetoDeathReaction * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0074E890, BehaviourStatus__Enum, OnExecuteTask, (app::SkeetoDeathReaction * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0074F630, void, __ctor, (app::SkeetoDeathReaction * this_ptr));
