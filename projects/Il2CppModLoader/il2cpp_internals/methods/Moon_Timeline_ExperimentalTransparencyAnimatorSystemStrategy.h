...
namespace app::methods::Moon_Timeline::ExperimentalTransparencyAnimatorSystemStrategy {
IL2CPP_REGISTER_METHOD(0x00767620, void, __ctor, (app::ExperimentalTransparencyAnimatorSystemStrategy * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00768340, bool, GetHandoverAlpha, (app::ExperimentalTransparencyAnimatorSystemStrategy * this_ptr, app::Renderer * renderer, app::UberShaderProperty_Color__Enum property, app::float * value));
...
IL2CPP_REGISTER_METHOD(0x00769A30, ExperimentalTransparencyAnimatorSystemStrategy_RendererState *, GetStateFromPool, (app::ExperimentalTransparencyAnimatorSystemStrategy * this_ptr));
