...
IL2CPP_REGISTER_METHOD(0x00B58CD0, MeleeWeapon *, get_Weapon, (app::HoldableRigidBody * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00998570, SuspendableMask__Enum, get_Mask, (app::HoldableRigidBody * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B5A710, void, __ctor, (app::HoldableRigidBody * this_ptr));
}
