...
namespace app::methods::System_Net::TrackingStringDictionary {
IL2CPP_REGISTER_METHOD(0x020A9E30, void, __ctor_1, (app::TrackingStringDictionary * this_ptr));
IL2CPP_REGISTER_METHOD(0x020A9E50, void, __ctor_2, (app::TrackingStringDictionary * this_ptr, bool is_read_only));
...
IL2CPP_REGISTER_METHOD(0x020AA130, String *, get_Item, (app::TrackingStringDictionary * this_ptr, app::String * key));
