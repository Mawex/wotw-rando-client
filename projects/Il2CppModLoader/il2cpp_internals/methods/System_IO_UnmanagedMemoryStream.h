...
namespace app::methods::System_IO::UnmanagedMemoryStream {
IL2CPP_REGISTER_METHOD(0x02389540, void, __ctor_1, (app::UnmanagedMemoryStream * this_ptr));
IL2CPP_REGISTER_METHOD(0x023895E0, void, __ctor_2, (app::UnmanagedMemoryStream * this_ptr, app::uint8_t * pointer, int64_t length));
IL2CPP_REGISTER_METHOD(0x023896C0, void, __ctor_3, (app::UnmanagedMemoryStream * this_ptr, app::uint8_t * pointer, int64_t length, int64_t capacity, app::FileAccess__Enum access, bool skip_security_check));
IL2CPP_REGISTER_METHOD(0x023897B0, void, Initialize, (app::UnmanagedMemoryStream * this_ptr, app::uint8_t * pointer, int64_t length, int64_t capacity, app::FileAccess__Enum access, bool skip_security_check));
...
IL2CPP_REGISTER_METHOD(0x02389AA0, Task *, FlushAsync, (app::UnmanagedMemoryStream * this_ptr, app::CancellationToken cancellation_token));
...
IL2CPP_REGISTER_METHOD(0x0238A230, Task_1_System_Int32_ *, ReadAsync, (app::UnmanagedMemoryStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::CancellationToken cancellation_token));
...
IL2CPP_REGISTER_METHOD(0x0238B020, Task *, WriteAsync, (app::UnmanagedMemoryStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::CancellationToken cancellation_token));
