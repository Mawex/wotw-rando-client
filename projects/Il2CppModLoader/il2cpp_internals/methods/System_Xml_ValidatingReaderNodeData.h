...
namespace app::methods::System_Xml::ValidatingReaderNodeData {
IL2CPP_REGISTER_METHOD(0x01954890, void, __ctor_1, (app::ValidatingReaderNodeData * this_ptr));
IL2CPP_REGISTER_METHOD(0x019548A0, void, __ctor_2, (app::ValidatingReaderNodeData * this_ptr, app::XmlNodeType__Enum node_type));
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_LocalName, (app::ValidatingReaderNodeData * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_LocalName, (app::ValidatingReaderNodeData * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Namespace, (app::ValidatingReaderNodeData * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_Namespace, (app::ValidatingReaderNodeData * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_Prefix, (app::ValidatingReaderNodeData * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB960, void, set_Prefix, (app::ValidatingReaderNodeData * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x019548B0, String *, GetAtomizedNameWPrefix, (app::ValidatingReaderNodeData * this_ptr, app::XmlNameTable * name_table));
...
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_RawValue, (app::ValidatingReaderNodeData * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9A0, void, set_RawValue, (app::ValidatingReaderNodeData * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB9B0, String *, get_OriginalStringValue, (app::ValidatingReaderNodeData * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FD490, XmlNodeType__Enum, get_NodeType, (app::ValidatingReaderNodeData * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FD4A0, void, set_NodeType, (app::ValidatingReaderNodeData * this_ptr, app::XmlNodeType__Enum value));
IL2CPP_REGISTER_METHOD(0x002FB9F0, AttributePSVIInfo *, get_AttInfo, (app::ValidatingReaderNodeData * this_ptr));
