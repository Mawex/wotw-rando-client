...
namespace app::methods::System_Collections_Generic::Dictionary_2_TKey_TValue__KeyCollection_System_ByteEnum_System_Object_ {
    IL2CPP_REGISTER_METHOD(0x01D561A0, void, __ctor, (app::Dictionary_2_TKey_TValue_KeyCollection_System_ByteEnum_System_Object_ * this_ptr, app::Dictionary_2_System_ByteEnum_System_Object_ * dictionary));
