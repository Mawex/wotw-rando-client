...
namespace app::methods::BugHornEntity {
    ...
    IL2CPP_REGISTER_METHOD(0x00806450, Locomotion*, GetActiveLocomotion, (app::BugHornEntity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00807610, GameObject*, SpawnSlamChargeEffect_2, (app::BugHornEntity * this_ptr, app::GameObject* prefab, app::Vector3 position, app::Quaternion rotation, float damage, app::DamageWeight__Enum weight, app::Transform* force_direction_position));
    IL2CPP_REGISTER_METHOD(0x00807800, void, SpawnSlamChargeEffectDistortion, (app::BugHornEntity * this_ptr, app::Vector3 position));
    IL2CPP_REGISTER_METHOD(0x008079B0, void, __ctor, (app::BugHornEntity * this_ptr));
} // namespace app::methods::BugHornEntity
