...
IL2CPP_REGISTER_METHOD(0x008A4660, Input_InputButtonProcessor *, get_Button, (app::SeinMeditateSpell * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008A66D0, Vector3, get_EffectPosition, (app::SeinMeditateSpell * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008A6BE0, void, __ctor, (app::SeinMeditateSpell * this_ptr));
