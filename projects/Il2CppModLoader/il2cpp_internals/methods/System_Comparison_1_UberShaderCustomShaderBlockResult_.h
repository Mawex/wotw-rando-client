...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::Comparison_1_UberShaderCustomShaderBlockResult_ * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02C80CC0, IAsyncResult *, BeginInvoke, (app::Comparison_1_UberShaderCustomShaderBlockResult_ * this_ptr, app::UberShaderCustomShaderBlockResult x, app::UberShaderCustomShaderBlockResult y, app::AsyncCallback * callback, app::Object * object));
