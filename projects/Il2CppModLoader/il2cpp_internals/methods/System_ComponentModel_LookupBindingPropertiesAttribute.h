...
IL2CPP_REGISTER_METHOD(0x0058D710, void, __ctor, (LookupBindingPropertiesAttribute * __this, String * dataSource, String * displayMember, String * valueMember, String * lookupMember));
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_DataSource, (LookupBindingPropertiesAttribute * __this));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_DisplayMember, (LookupBindingPropertiesAttribute * __this));
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_ValueMember, (LookupBindingPropertiesAttribute * __this));
