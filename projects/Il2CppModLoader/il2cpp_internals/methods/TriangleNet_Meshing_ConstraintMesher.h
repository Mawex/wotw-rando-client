...
namespace app::methods::TriangleNet_Meshing::ConstraintMesher {
IL2CPP_REGISTER_METHOD(0x02639E10, void, __ctor, (app::ConstraintMesher * this_ptr, app::Mesh_1 * mesh, app::Configuration_1 * config));
...
IL2CPP_REGISTER_METHOD(0x0263BC60, FindDirectionResult__Enum, FindDirection, (app::ConstraintMesher * this_ptr, app::Otri * searchtri, app::Vertex * searchpoint));
