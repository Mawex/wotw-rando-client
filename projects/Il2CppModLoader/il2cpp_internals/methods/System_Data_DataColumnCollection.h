...
namespace app::methods::System_Data::DataColumnCollection {
IL2CPP_REGISTER_METHOD(0x0239A1B0, void, __ctor, (app::DataColumnCollection * this_ptr, app::DataTable * table));
IL2CPP_REGISTER_METHOD(0x002FB930, ArrayList *, get_List, (app::DataColumnCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9D0, DataColumn__Array *, get_ColumnsImplementingIChangeTracking, (app::DataColumnCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0239A420, DataColumn *, get_Item_1, (app::DataColumnCollection * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x0472D310, DataColumnCollection_get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0239A550, DataColumn *, get_Item_2, (app::DataColumnCollection * this_ptr, app::String * name));
IL2CPP_REGISTER_METHODINFO(0x047304C0, DataColumnCollection_get_Item_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0239A6F0, DataColumn *, get_Item_3, (app::DataColumnCollection * this_ptr, app::String * name, app::String * ns));
...
IL2CPP_REGISTER_METHOD(0x0239B520, String *, AssignName, (app::DataColumnCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0239D540, String *, MakeName, (app::DataColumnCollection * this_ptr, int32_t index));
