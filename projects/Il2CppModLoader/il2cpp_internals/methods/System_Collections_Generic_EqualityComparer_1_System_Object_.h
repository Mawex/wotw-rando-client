...
namespace app::methods::System_Collections_Generic::EqualityComparer_1_System_Object_ {
IL2CPP_REGISTER_METHOD(0x02807CD0, EqualityComparer_1_System_Object_ *, get_Default, ());
IL2CPP_REGISTER_METHOD(0x02E63AD0, EqualityComparer_1_System_Object_ *, CreateComparer, ());
...
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::EqualityComparer_1_System_Object_ * this_ptr));
}
