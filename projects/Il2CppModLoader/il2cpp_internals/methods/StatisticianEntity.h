...
IL2CPP_REGISTER_METHOD(0x009B7220, String *, get_DialogActorName, (app::StatisticianEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x009B72A0, String *, get_InteractionActorName, (app::StatisticianEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004173E0, void, __ctor, (app::StatisticianEntity * this_ptr));
}
