...
namespace app::methods::System_Net::OpenWriteCompletedEventArgs {
...
IL2CPP_REGISTER_METHOD(0x01BCB280, Stream *, get_Result, (app::OpenWriteCompletedEventArgs * this_ptr));
