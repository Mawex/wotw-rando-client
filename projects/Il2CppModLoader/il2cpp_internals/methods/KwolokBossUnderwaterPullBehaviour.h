...
IL2CPP_REGISTER_METHOD(0x012F3ED0, BehaviourStatus__Enum, OnExecute, (app::KwolokBossUnderwaterPullBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x012F8900, void, ModifyAcceleration, (app::KwolokBossUnderwaterPullBehaviour * this_ptr, app::float * acceleration, app::float * deceleration));
IL2CPP_REGISTER_METHODINFO(0x0475A070, KwolokBossUnderwaterPullBehaviour_ModifyAcceleration__MethodInfo);
IL2CPP_REGISTER_METHOD(0x012F8930, void, ModifyMaxSpeed, (app::KwolokBossUnderwaterPullBehaviour * this_ptr, app::float * speed));
IL2CPP_REGISTER_METHODINFO(0x0474C648, KwolokBossUnderwaterPullBehaviour_ModifyMaxSpeed__MethodInfo);
IL2CPP_REGISTER_METHOD(0x012F8950, void, ModifyDesiredLookAngle, (app::KwolokBossUnderwaterPullBehaviour * this_ptr, app::float * angle));
IL2CPP_REGISTER_METHODINFO(0x04793550, KwolokBossUnderwaterPullBehaviour_ModifyDesiredLookAngle__MethodInfo);
IL2CPP_REGISTER_METHOD(0x012F8AF0, void, ModifyLookAngleChangeSpeed, (app::KwolokBossUnderwaterPullBehaviour * this_ptr, app::float * speed));
IL2CPP_REGISTER_METHODINFO(0x0475D960, KwolokBossUnderwaterPullBehaviour_ModifyLookAngleChangeSpeed__MethodInfo);
IL2CPP_REGISTER_METHOD(0x012F8B10, void, ModifyLegsIK, (app::KwolokBossUnderwaterPullBehaviour * this_ptr, app::float * fl, app::float * fr, app::float * bl, app::float * br));
...
IL2CPP_REGISTER_METHOD(0x012F8D80, Enum__Array *, GetEntries, (app::KwolokBossUnderwaterPullBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x012F8E20, Enum, Evaluate, (app::KwolokBossUnderwaterPullBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_ShouldSkip, (app::KwolokBossUnderwaterPullBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x012F8EE0, void, __ctor, (app::KwolokBossUnderwaterPullBehaviour * this_ptr));
}
