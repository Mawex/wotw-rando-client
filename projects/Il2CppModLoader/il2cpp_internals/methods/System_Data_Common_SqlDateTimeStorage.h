...
namespace app::methods::System_Data_Common::SqlDateTimeStorage {
IL2CPP_REGISTER_METHOD(0x028507E0, void, __ctor, (app::SqlDateTimeStorage * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x02850980, Object *, Aggregate, (app::SqlDateTimeStorage * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x028510A0, Object *, ConvertValue, (app::SqlDateTimeStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02851170, void, Copy, (app::SqlDateTimeStorage * this_ptr, int32_t record_no1, int32_t record_no2));
IL2CPP_REGISTER_METHOD(0x028511F0, Object *, Get, (app::SqlDateTimeStorage * this_ptr, int32_t record));
...
IL2CPP_REGISTER_METHOD(0x02851470, Object *, ConvertXmlToObject, (app::SqlDateTimeStorage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x028517C0, String *, ConvertObjectToXml, (app::SqlDateTimeStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02851B20, Object *, GetEmptyStorage, (app::SqlDateTimeStorage * this_ptr, int32_t record_count));
