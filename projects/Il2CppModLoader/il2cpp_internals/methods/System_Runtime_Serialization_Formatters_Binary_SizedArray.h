...
IL2CPP_REGISTER_METHOD(0x01DA1AC0, Object *, Clone, (app::SizedArray * this_ptr));
IL2CPP_REGISTER_METHOD(0x01DA1CE0, Object *, get_Item, (app::SizedArray * this_ptr, int32_t index));
