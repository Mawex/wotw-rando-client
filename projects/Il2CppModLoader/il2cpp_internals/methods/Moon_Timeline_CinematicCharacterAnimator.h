...
namespace app::methods::Moon_Timeline::CinematicCharacterAnimator {
...
IL2CPP_REGISTER_METHOD(0x005B0220, MoonAnimation *, get_CachedMoonAnimation, (app::CinematicCharacterAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010CD950, void, __ctor, (app::CinematicCharacterAnimator * this_ptr));
}
