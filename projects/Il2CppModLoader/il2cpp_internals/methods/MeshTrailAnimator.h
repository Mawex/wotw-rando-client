...
IL2CPP_REGISTER_METHOD(0x031119D0, MeshTrail *, get_MeshTrail, (app::MeshTrailAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03111E40, void, __ctor, (app::MeshTrailAnimator * this_ptr));
}
