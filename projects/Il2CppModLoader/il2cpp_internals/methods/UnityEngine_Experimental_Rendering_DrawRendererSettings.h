...
namespace app::methods::UnityEngine_Experimental_Rendering::DrawRendererSettings {
    IL2CPP_REGISTER_METHOD(0x001EC740, void, __ctor, (app::DrawRendererSettings__Boxed * this_ptr, app::Camera * camera, app::ShaderPassName shader_pass_name));
