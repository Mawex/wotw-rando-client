...
IL2CPP_REGISTER_METHOD(0x0058E420, MortarWormEnemy *, FindMortarWorm, (app::WormHoleManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003FDCE0, SuspendableMask__Enum, get_Mask, (app::WormHoleManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x0058ED90, void, set_Mask, (app::WormHoleManager * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x0058EE40, void, __ctor, (app::WormHoleManager * this_ptr));
}
