...
IL2CPP_REGISTER_METHOD(0x002FB930, Type *, get_JobSystemType, (app::PhysicsUpdateHandlerAttribute * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_JobSystemType, (app::PhysicsUpdateHandlerAttribute * this_ptr, app::Type * value));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::PhysicsUpdateHandlerAttribute * this_ptr));
}
