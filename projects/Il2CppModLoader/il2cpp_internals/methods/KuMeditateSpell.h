...
IL2CPP_REGISTER_METHOD(0x01241A30, SeinCharacter *, get_Sein, (app::KuMeditateSpell * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012421E0, Input_InputButtonProcessor *, get_Button, (app::KuMeditateSpell * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012441F0, Vector3, get_EffectPosition, (app::KuMeditateSpell * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01244700, void, __ctor, (app::KuMeditateSpell * this_ptr));
