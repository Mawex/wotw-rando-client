...
namespace app::methods::System_Collections_Generic::Queue_1_LegacySwarmEnemyManager_SpawnInfo_ {
...
IL2CPP_REGISTER_METHOD(0x02CA3B30, LegacySwarmEnemyManager_SpawnInfo, Dequeue, (app::Queue_1_LegacySwarmEnemyManager_SpawnInfo_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0243CB70, void, __ctor_1, (app::Queue_1_LegacySwarmEnemyManager_SpawnInfo_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0475EE10, Queue_1_LegacySwarmEnemyManager_SpawnInfo___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02CA3330, void, __ctor_2, (app::Queue_1_LegacySwarmEnemyManager_SpawnInfo_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x02CA3460, Object *, ICollection_get_SyncRoot, (app::Queue_1_LegacySwarmEnemyManager_SpawnInfo_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CA39C0, Queue_1_T_Enumerator_LegacySwarmEnemyManager_SpawnInfo_, GetEnumerator, (app::Queue_1_LegacySwarmEnemyManager_SpawnInfo_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA3A30, IEnumerator_1_LegacySwarmEnemyManager_SpawnInfo_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::Queue_1_LegacySwarmEnemyManager_SpawnInfo_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA3A30, IEnumerator *, IEnumerable_GetEnumerator, (app::Queue_1_LegacySwarmEnemyManager_SpawnInfo_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CA3CB0, LegacySwarmEnemyManager_SpawnInfo, Peek, (app::Queue_1_LegacySwarmEnemyManager_SpawnInfo_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0243D5D0, LegacySwarmEnemyManager_SpawnInfo__Array *, ToArray, (app::Queue_1_LegacySwarmEnemyManager_SpawnInfo_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0243D7A0, void, MoveNext, (app::Queue_1_LegacySwarmEnemyManager_SpawnInfo_ * this_ptr, app::int32_t * index));
