...
IL2CPP_REGISTER_METHOD(0x024807A0, Material *, get_material, (app::CameraFilterPack_NightVisionFX * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02481720, void, __ctor, (app::CameraFilterPack_NightVisionFX * this_ptr));
}
