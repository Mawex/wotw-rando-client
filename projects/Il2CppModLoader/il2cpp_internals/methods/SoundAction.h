...
namespace app::methods::SoundAction {
    ...
    IL2CPP_REGISTER_METHOD(0x00EE4D80, String*, get_TargetName, (app::SoundAction * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00EE4E60, String*, GetNiceName, (app::SoundAction * this_ptr));
