...
IL2CPP_REGISTER_METHOD(0x02970C30, void, __ctor_1, (app::RenderTexture * this_ptr));
IL2CPP_REGISTER_METHOD(0x02970C40, void, __ctor_2, (app::RenderTexture * this_ptr, app::RenderTextureDescriptor desc));
IL2CPP_REGISTER_METHOD(0x02970D40, void, __ctor_3, (app::RenderTexture * this_ptr, app::RenderTexture * texture_to_copy));
IL2CPP_REGISTER_METHODINFO(0x047562F8, RenderTexture__ctor_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02970F40, void, __ctor_4, (app::RenderTexture * this_ptr, int32_t width, int32_t height, int32_t depth, app::GraphicsFormat__Enum format));
IL2CPP_REGISTER_METHOD(0x02971140, void, __ctor_5, (app::RenderTexture * this_ptr, int32_t width, int32_t height, int32_t depth, app::RenderTextureFormat__Enum format, app::RenderTextureReadWrite__Enum read_write));
IL2CPP_REGISTER_METHOD(0x02971430, void, __ctor_6, (app::RenderTexture * this_ptr, int32_t width, int32_t height, int32_t depth, app::RenderTextureFormat__Enum format));
IL2CPP_REGISTER_METHOD(0x02971460, void, __ctor_7, (app::RenderTexture * this_ptr, int32_t width, int32_t height, int32_t depth));
...
IL2CPP_REGISTER_METHOD(0x029716B0, RenderTextureFormat__Enum, get_format, (app::RenderTexture * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02971970, RenderBuffer, GetColorBuffer, (app::RenderTexture * this_ptr));
IL2CPP_REGISTER_METHOD(0x029719F0, RenderBuffer, GetDepthBuffer, (app::RenderTexture * this_ptr));
IL2CPP_REGISTER_METHOD(0x02971970, RenderBuffer, get_colorBuffer, (app::RenderTexture * this_ptr));
IL2CPP_REGISTER_METHOD(0x029719F0, RenderBuffer, get_depthBuffer, (app::RenderTexture * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02971DA0, RenderTextureDescriptor, GetDescriptor, (app::RenderTexture * this_ptr));
IL2CPP_REGISTER_METHOD(0x02971E50, RenderTexture *, GetTemporary_Internal, (app::RenderTextureDescriptor desc));
...
IL2CPP_REGISTER_METHOD(0x02971DA0, RenderTextureDescriptor, get_descriptor, (app::RenderTexture * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02972190, RenderTexture *, GetTemporary_1, (app::RenderTextureDescriptor desc));
...
IL2CPP_REGISTER_METHOD(0x02972310, RenderTexture *, GetTemporary_2, (int32_t width, int32_t height, int32_t depth_buffer, app::RenderTextureFormat__Enum format, app::RenderTextureReadWrite__Enum read_write));
IL2CPP_REGISTER_METHOD(0x029723C0, RenderTexture *, GetTemporary_3, (int32_t width, int32_t height, int32_t depth_buffer, app::RenderTextureFormat__Enum format));
IL2CPP_REGISTER_METHOD(0x02972460, RenderTexture *, GetTemporary_4, (int32_t width, int32_t height, int32_t depth_buffer));
IL2CPP_REGISTER_METHOD(0x02972500, RenderTexture *, GetTemporary_5, (int32_t width, int32_t height));
...
IL2CPP_REGISTER_METHOD(0x02972700, RenderTexture *, GetTemporary_Internal_Injected, (app::RenderTextureDescriptor * desc));
}
