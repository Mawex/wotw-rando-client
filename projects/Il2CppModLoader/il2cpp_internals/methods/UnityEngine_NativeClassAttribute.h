...
IL2CPP_REGISTER_METHOD(0x031BB790, void, __ctor_1, (app::NativeClassAttribute * this_ptr, app::String * qualified_cpp_name));
IL2CPP_REGISTER_METHOD(0x0058DA40, void, __ctor_2, (app::NativeClassAttribute * this_ptr, app::String * qualified_cpp_name, app::String * declaration));
