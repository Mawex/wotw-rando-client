...
namespace app::methods::MemoryUISlot {
    IL2CPP_REGISTER_METHOD(0x002FBB60, ReplaySetting*, get_ReplaySetting, (app::MemoryUISlot * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::MemoryUISlot * this_ptr));
} // namespace app::methods::MemoryUISlot
