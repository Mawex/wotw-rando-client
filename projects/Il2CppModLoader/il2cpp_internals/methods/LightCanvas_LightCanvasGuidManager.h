...
IL2CPP_REGISTER_METHOD(0x01144960, Dictionary_2_SceneMetaData_HashSet_1_System_Int32_ *, get_UsedGuidsPerScene, ());
IL2CPP_REGISTER_METHOD(0x01144B60, void, RegisterGuid, (app::SceneMetaData * scene_meta, int32_t guid, app::bool * success));
