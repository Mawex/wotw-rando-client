...
IL2CPP_REGISTER_METHOD(0x0062A990, ScenesManager *, get_ScenesManager, (app::InstantLoadScenesController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::InstantLoadScenesController * this_ptr));
}
