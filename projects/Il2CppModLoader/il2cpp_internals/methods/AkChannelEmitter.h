...
IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor, (app::AkChannelEmitter * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x026D78D0, void *, getCPtr, (app::AkChannelEmitter * obj));
IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkChannelEmitter * this_ptr, app::void * c_ptr));
...
IL2CPP_REGISTER_METHOD(0x026D7D30, AkTransform *, get_position, (app::AkChannelEmitter * this_ptr));
