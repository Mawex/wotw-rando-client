...
namespace app::methods::Moon_Timeline::RecorderOutputAnimatorEntity {
...
IL2CPP_REGISTER_METHOD(0x00420EE0, UpdateCategory__Enum, get_UpdateCategory, (app::RecorderOutputAnimatorEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC20, String *, get_ShotName, (app::RecorderOutputAnimatorEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0077F7B0, void, __ctor, (app::RecorderOutputAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x0077F870, void, __cctor, ());
}
