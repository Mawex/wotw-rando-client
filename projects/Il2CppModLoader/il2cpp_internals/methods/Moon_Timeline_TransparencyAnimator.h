...
namespace app::methods::Moon_Timeline::TransparencyAnimator {
IL2CPP_REGISTER_METHOD(0x00D0BB50, GameObject *, get_ExternalTarget, (app::TransparencyAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCA0, List_1_UnityEngine_Transform_ *, get_EarlyZTransforms, (app::TransparencyAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D0CF00, void, __ctor, (app::TransparencyAnimator * this_ptr));
