...
namespace app::methods::RootMotion_FinalIK::IKMapping_BoneMap {
...
IL2CPP_REGISTER_METHOD(0x02BDB330, Vector3, get_swingDirection, (app::IKMapping_BoneMap * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BDC440, Vector3, GetPlanePosition, (app::IKMapping_BoneMap * this_ptr, app::IKSolverFullBody * solver));
...
IL2CPP_REGISTER_METHOD(0x02BDDEB0, Quaternion, GetTargetRotation, (app::IKMapping_BoneMap * this_ptr, app::IKSolverFullBody * solver));
IL2CPP_REGISTER_METHOD(0x02BDE230, Quaternion, get_lastAnimatedTargetRotation, (app::IKMapping_BoneMap * this_ptr));
IL2CPP_REGISTER_METHOD(0x02BDE760, void, __ctor, (app::IKMapping_BoneMap * this_ptr));
}
