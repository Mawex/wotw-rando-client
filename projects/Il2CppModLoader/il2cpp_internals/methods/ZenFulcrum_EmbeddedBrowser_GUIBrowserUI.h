...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::GUIBrowserUI {
...
IL2CPP_REGISTER_METHOD(0x01DDEED0, IEnumerator *, WatchResize, (app::GUIBrowserUI * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01464330, Vector2, get_MousePosition, (app::GUIBrowserUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x01464350, void, set_MousePosition, (app::GUIBrowserUI * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x003FF7D0, MouseButton__Enum, get_MouseButtons, (app::GUIBrowserUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x0111BFC0, void, set_MouseButtons, (app::GUIBrowserUI * this_ptr, app::MouseButton__Enum value));
IL2CPP_REGISTER_METHOD(0x01DDFEC0, Vector2, get_MouseScroll, (app::GUIBrowserUI * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB40, List_1_UnityEngine_Event_ *, get_KeyEvents, (app::GUIBrowserUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC20, BrowserCursor *, get_BrowserCursor, (app::GUIBrowserUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC30, void, set_BrowserCursor, (app::GUIBrowserUI * this_ptr, app::BrowserCursor * value));
IL2CPP_REGISTER_METHOD(0x002FBC40, BrowserInputSettings *, get_InputSettings, (app::GUIBrowserUI * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01DE0070, void, __ctor, (app::GUIBrowserUI * this_ptr));
