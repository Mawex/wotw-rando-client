...
IL2CPP_REGISTER_METHOD(0x01643440, String__Array *, GetDataHeaderNames, (app::FrameTimeCaptureAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x016438C0, String__Array *, GetFrameData_1, (app::FrameTimeCaptureAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::FrameTimeCaptureAgent * this_ptr));
}
