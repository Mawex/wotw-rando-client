...
namespace app::methods::System_Collections_Generic::Dictionary_2_LightPriority_Layer_LightInfluence_ {
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_LightPriority_Layer_LightInfluence_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02C35530, LightInfluence *, get_Item, (app::Dictionary_2_LightPriority_Layer_LightInfluence_ * this_ptr, app::LightPriority_Layer__Enum key));
