...
namespace app::methods::CheatsHandler {
    ...
    IL2CPP_REGISTER_METHOD(0x0131E2C0, IEnumerator*, InitDebugMenu, (app::CheatsHandler * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0131EC00, void, __ctor, (app::CheatsHandler * this_ptr));
