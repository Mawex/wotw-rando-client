...
namespace app::methods::System_Collections::ArrayList_ArrayListEnumeratorSimple {
IL2CPP_REGISTER_METHOD(0x0201A310, void, __ctor, (app::ArrayList_ArrayListEnumeratorSimple * this_ptr, app::ArrayList * list));
IL2CPP_REGISTER_METHOD(0x0173F610, Object *, Clone, (app::ArrayList_ArrayListEnumeratorSimple * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0201A6C0, Object *, get_Current, (app::ArrayList_ArrayListEnumeratorSimple * this_ptr));
