...
namespace app::methods::System_Net_Http_Headers::RetryConditionHeaderValue {
IL2CPP_REGISTER_METHOD(0x02D16BF0, void, __ctor_1, (app::RetryConditionHeaderValue * this_ptr, app::DateTimeOffset date));
IL2CPP_REGISTER_METHOD(0x02D16C90, void, __ctor_2, (app::RetryConditionHeaderValue * this_ptr, app::TimeSpan delta));
IL2CPP_REGISTER_METHODINFO(0x04702918, RetryConditionHeaderValue__ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02D14680, Nullable_1_DateTimeOffset_, get_Date, (app::RetryConditionHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CB5CB0, Nullable_1_TimeSpan_, get_Delta, (app::RetryConditionHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CB5CC0, void, set_Delta, (app::RetryConditionHeaderValue * this_ptr, app::Nullable_1_TimeSpan_ value));
IL2CPP_REGISTER_METHOD(0x0173F610, Object *, ICloneable_Clone, (app::RetryConditionHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D17590, String *, ToString, (app::RetryConditionHeaderValue * this_ptr));
}
