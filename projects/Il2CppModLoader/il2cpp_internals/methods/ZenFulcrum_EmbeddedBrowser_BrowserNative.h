...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::BrowserNative {
IL2CPP_REGISTER_METHOD(0x01C74AB0, String *, get_LocalUrlPrefix, ());
...
IL2CPP_REGISTER_METHOD(0x01C74DD0, String *, get_ProfilePath, ());
...
IL2CPP_REGISTER_METHOD(0x01C760C0, String *, GetLibError, ());
...
IL2CPP_REGISTER_METHOD(0x01C76700, void *, GetFunc, (app::void * lib_handle, app::String * fn_name));
...
IL2CPP_REGISTER_METHOD(0x01C76A60, void *, GetProcAddress, (app::void * h_module, app::String * proc_name));
IL2CPP_REGISTER_METHOD(0x01C76C30, bool, FreeLibrary, (app::void * h_module));
