...
IL2CPP_REGISTER_METHOD(0x002FB9F0, GlobalRecordingTable *, get_GlobalRecordingTable, (app::GhostAnimationParameterPlugin * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, GhostRecorder_GhostPluginRecordingType__Enum, GetRecordingType, (app::GhostAnimationParameterPlugin * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E13330, void, __ctor, (app::GhostAnimationParameterPlugin * this_ptr));
}
