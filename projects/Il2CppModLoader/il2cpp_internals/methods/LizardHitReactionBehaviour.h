...
IL2CPP_REGISTER_METHOD(0x00FAE9A0, EntityDamageEvent *, get_DamageEvent, (app::LizardHitReactionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FAF8D0, BehaviourStatus__Enum, OnExecuteTask, (app::LizardHitReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00B68B50, Vector3, RootMotionRollBackModifier, (app::LizardHitReactionBehaviour * this_ptr, app::Vector3 motion));
IL2CPP_REGISTER_METHOD(0x00FB0360, void, __ctor, (app::LizardHitReactionBehaviour * this_ptr));
}
