...
IL2CPP_REGISTER_METHOD(0x00F02D60, RaycastHit, get_Hit, (app::LandPrediction * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::LandPrediction * this_ptr));
}
