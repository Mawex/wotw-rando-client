...
namespace app::methods::UnityEngine::Rect {
    IL2CPP_REGISTER_METHOD(0x00121740, void, __ctor_1, (app::Rect__Boxed * this_ptr, float x, float y, float width, float height));
    IL2CPP_REGISTER_METHOD(0x0014B910, void, __ctor_2, (app::Rect__Boxed * this_ptr, app::Vector2 position, app::Vector2 size));
    IL2CPP_REGISTER_METHOD(0x0014C4D0, void, __ctor_3, (app::Rect__Boxed * this_ptr, app::Rect source));
