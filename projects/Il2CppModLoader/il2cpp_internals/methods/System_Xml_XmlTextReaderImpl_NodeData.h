...
namespace app::methods::System_Xml::XmlTextReaderImpl_NodeData {
IL2CPP_REGISTER_METHOD(0x01FBBCD0, XmlTextReaderImpl_NodeData *, get_None, ());
IL2CPP_REGISTER_METHOD(0x01FBBE60, void, __ctor, (app::XmlTextReaderImpl_NodeData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01FBBEB0, String *, get_StringValue, (app::XmlTextReaderImpl_NodeData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01FBC5E0, String *, GetNameWPrefix, (app::XmlTextReaderImpl_NodeData * this_ptr, app::XmlNameTable * nt));
IL2CPP_REGISTER_METHOD(0x01FBC6D0, String *, CreateNameWPrefix, (app::XmlTextReaderImpl_NodeData * this_ptr, app::XmlNameTable * nt));
