...
namespace app::methods::System_Threading_Tasks::Task {
...
IL2CPP_REGISTER_METHOD(0x02330B90, void, __ctor_1, (app::Task * this_ptr, bool canceled, app::TaskCreationOptions__Enum creation_options, app::CancellationToken ct));
IL2CPP_REGISTER_METHOD(0x02330D30, void, __ctor_2, (app::Task * this_ptr));
IL2CPP_REGISTER_METHOD(0x02330D40, void, __ctor_3, (app::Task * this_ptr, app::Object * state, app::TaskCreationOptions__Enum creation_options, bool promise_style));
IL2CPP_REGISTER_METHODINFO(0x04724848, Task__ctor_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02330E60, void, __ctor_4, (app::Task * this_ptr, app::Delegate * action, app::Object * state, app::Task * parent, app::CancellationToken cancellation_token, app::TaskCreationOptions__Enum creation_options, app::InternalTaskOptions__Enum internal_options, app::TaskScheduler * scheduler));
...
IL2CPP_REGISTER_METHOD(0x02331750, String *, get_DebuggerDisplayMethodDescription, (app::Task * this_ptr));
IL2CPP_REGISTER_METHOD(0x02331860, void, PossiblyCaptureContext, (app::Task * this_ptr, app::StackCrawlMark__Enum * stack_mark));
IL2CPP_REGISTER_METHOD(0x02331970, TaskCreationOptions__Enum, get_Options, (app::Task * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02331B10, bool, AtomicStateUpdate_2, (app::Task * this_ptr, int32_t new_bits, int32_t illegal_bits, app::int32_t * old_flags));
...
IL2CPP_REGISTER_METHOD(0x02332490, Task *, InternalCurrentIfAttached, (app::TaskCreationOptions__Enum creation_options));
IL2CPP_REGISTER_METHOD(0x02332540, StackGuard *, get_CurrentStackGuard, ());
IL2CPP_REGISTER_METHOD(0x02332740, AggregateException *, get_Exception, (app::Task * this_ptr));
IL2CPP_REGISTER_METHOD(0x02332770, TaskStatus__Enum, get_Status, (app::Task * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02332830, Task_ContingentProperties *, EnsureContingentPropertiesInitialized, (app::Task * this_ptr, bool needs_protection));
IL2CPP_REGISTER_METHOD(0x02332860, Task_ContingentProperties *, EnsureContingentPropertiesInitializedCore, (app::Task * this_ptr, bool needs_protection));
IL2CPP_REGISTER_METHOD(0x02332A50, CancellationToken, get_CancellationToken, (app::Task * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02332B60, TaskCreationOptions__Enum, get_CreationOptions, (app::Task * this_ptr));
IL2CPP_REGISTER_METHOD(0x02332B80, WaitHandle *, IAsyncResult_get_AsyncWaitHandle, (app::Task * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047329D8, Task_System_IAsyncResult_get_AsyncWaitHandle__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FB950, Object *, get_AsyncState, (app::Task * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, IAsyncResult_get_CompletedSynchronously, (app::Task * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB00, TaskScheduler *, get_ExecutingTaskScheduler, (app::Task * this_ptr));
IL2CPP_REGISTER_METHOD(0x02332C90, TaskFactory *, get_Factory, ());
IL2CPP_REGISTER_METHOD(0x02332D30, Task *, get_CompletedTask, ());
IL2CPP_REGISTER_METHOD(0x02332F40, ManualResetEventSlim *, get_CompletedEvent, (app::Task * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02333210, ExecutionContext *, get_CapturedContext, (app::Task * this_ptr));
IL2CPP_REGISTER_METHOD(0x023332E0, void, set_CapturedContext, (app::Task * this_ptr, app::ExecutionContext * value));
IL2CPP_REGISTER_METHOD(0x02333340, ExecutionContext *, CopyExecutionContext, (app::ExecutionContext * captured_context));
...
IL2CPP_REGISTER_METHOD(0x02333CE0, AggregateException *, GetExceptions, (app::Task * this_ptr, bool include_task_canceled_exceptions));
IL2CPP_REGISTER_METHOD(0x02334030, ReadOnlyCollection_1_System_Runtime_ExceptionServices_ExceptionDispatchInfo_ *, GetExceptionDispatchInfos, (app::Task * this_ptr));
IL2CPP_REGISTER_METHOD(0x02334240, ExceptionDispatchInfo *, GetCancellationExceptionDispatchInfo, (app::Task * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, TaskAwaiter, GetAwaiter, (app::Task * this_ptr));
IL2CPP_REGISTER_METHOD(0x02335D60, ConfiguredTaskAwaitable, ConfigureAwait, (app::Task * this_ptr, bool continue_on_captured_context));
...
IL2CPP_REGISTER_METHOD(0x023378D0, Task *, ContinueWith_1, (app::Task * this_ptr, app::Action_1_System_Threading_Tasks_Task_ * continuation_action));
IL2CPP_REGISTER_METHOD(0x023379B0, Task *, ContinueWith_2, (app::Task * this_ptr, app::Action_1_System_Threading_Tasks_Task_ * continuation_action, app::TaskScheduler * scheduler, app::CancellationToken cancellation_token, app::TaskContinuationOptions__Enum continuation_options, app::StackCrawlMark__Enum * stack_mark));
IL2CPP_REGISTER_METHODINFO(0x04793640, Task_ContinueWith_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02337C30, Task *, ContinueWith_3, (app::Task * this_ptr, app::Action_2_System_Threading_Tasks_Task_Object_ * continuation_action, app::Object * state, app::CancellationToken cancellation_token, app::TaskContinuationOptions__Enum continuation_options, app::TaskScheduler * scheduler));
IL2CPP_REGISTER_METHOD(0x02337C70, Task *, ContinueWith_4, (app::Task * this_ptr, app::Action_2_System_Threading_Tasks_Task_Object_ * continuation_action, app::Object * state, app::TaskScheduler * scheduler, app::CancellationToken cancellation_token, app::TaskContinuationOptions__Enum continuation_options, app::StackCrawlMark__Enum * stack_mark));
...
IL2CPP_REGISTER_METHOD(0x02338C30, Task *, FromException_1, (app::Exception * exception));
IL2CPP_REGISTER_METHOD(0x02338CD0, Task *, FromCancellation_1, (app::CancellationToken cancellation_token));
IL2CPP_REGISTER_METHODINFO(0x047352C0, Task_FromCancellation__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02338E70, Task *, Run_1, (app::Action * action));
IL2CPP_REGISTER_METHOD(0x02338F80, Task *, Run_2, (app::Func_1_System_Threading_Tasks_Task_ * function));
IL2CPP_REGISTER_METHOD(0x02339030, Task *, Run_3, (app::Func_1_System_Threading_Tasks_Task_ * function, app::CancellationToken cancellation_token));
IL2CPP_REGISTER_METHODINFO(0x04768448, Task_Run_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x023392D0, Task *, Delay_1, (app::TimeSpan delay, app::CancellationToken cancellation_token));
IL2CPP_REGISTER_METHODINFO(0x0471A840, Task_Delay__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02339400, Task *, Delay_2, (int32_t milliseconds_delay));
IL2CPP_REGISTER_METHOD(0x023394B0, Task *, Delay_3, (int32_t milliseconds_delay, app::CancellationToken cancellation_token));
IL2CPP_REGISTER_METHODINFO(0x047239C8, Task_Delay_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02339BE0, Task *, WhenAll_1, (app::Task__Array * tasks));
IL2CPP_REGISTER_METHODINFO(0x04705620, Task_WhenAll__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02339DD0, Task *, InternalWhenAll_1, (app::Task__Array * tasks));
IL2CPP_REGISTER_METHOD(0x02339F70, Task_1_Task_ *, WhenAny, (app::Task__Array * tasks));
IL2CPP_REGISTER_METHODINFO(0x0473E028, Task_WhenAny__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0233A160, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x01544350, Task_1_System_Object_ *, FromResult_1, (app::Object * result));
IL2CPP_REGISTER_METHOD(0x01543DD0, Task_1_System_Object_ *, FromException_2, (app::Exception * exception));
IL2CPP_REGISTER_METHODINFO(0x0477FEE8, Task_FromException_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01543880, Task_1_System_Object_ *, FromCancellation_2, (app::CancellationToken cancellation_token));
IL2CPP_REGISTER_METHODINFO(0x04775770, Task_FromCancellation_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015436B0, Task_1_System_Object_ *, FromCancellation_3, (app::OperationCanceledException * exception));
IL2CPP_REGISTER_METHODINFO(0x04773E30, Task_FromCancellation_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01544980, Task_1_System_Object_ *, Run_4, (app::Func_1_Object_ * function));
IL2CPP_REGISTER_METHOD(0x015445B0, Task_1_System_Object_ *, Run_5, (app::Func_1_System_Threading_Tasks_Task_1_ * function));
IL2CPP_REGISTER_METHOD(0x01544670, Task_1_System_Object_ *, Run_6, (app::Func_1_System_Threading_Tasks_Task_1_ * function, app::CancellationToken cancellation_token));
IL2CPP_REGISTER_METHODINFO(0x04715EF8, Task_Run_5__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01546050, Task_1_System_Object__1 *, WhenAll_2, (app::Task_1_System_Object___Array * tasks));
IL2CPP_REGISTER_METHODINFO(0x04703790, Task_WhenAll_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01545E10, Task_1_System_Object__1 *, InternalWhenAll_2, (app::Task_1_System_Object___Array * tasks));
IL2CPP_REGISTER_METHOD(0x015434F0, Task_1_System_Int32_ *, FromCancellation_4, (app::CancellationToken cancellation_token));
IL2CPP_REGISTER_METHODINFO(0x0470EE70, Task_FromCancellation_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01544250, Task_1_System_Int32_ *, FromResult_2, (int32_t result));
IL2CPP_REGISTER_METHODINFO(0x04721D48, Task_FromResult_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01543320, Task_1_System_Int32_ *, FromCancellation_5, (app::OperationCanceledException * exception));
IL2CPP_REGISTER_METHODINFO(0x0472DD98, Task_FromCancellation_4__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01543C10, Task_1_System_Int32_ *, FromException_3, (app::Exception * exception));
IL2CPP_REGISTER_METHODINFO(0x0476BFD0, Task_FromException_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01543A40, Task_1_VoidTaskResult_ *, FromCancellation_6, (app::OperationCanceledException * exception));
IL2CPP_REGISTER_METHODINFO(0x047057C0, Task_FromCancellation_5__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01543160, Task_1_System_Boolean_ *, FromCancellation_7, (app::CancellationToken cancellation_token));
IL2CPP_REGISTER_METHODINFO(0x04782078, Task_FromCancellation_6__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01543F90, Task_1_VoidTaskResult_ *, FromException_4, (app::Exception * exception));
IL2CPP_REGISTER_METHODINFO(0x04703BB8, Task_FromException_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01544450, Task_1_System_Int32_ *, Run_7, (app::Func_1_Int32_ * function));
IL2CPP_REGISTER_METHODINFO(0x0477FDF0, Task_Run_6__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015445B0, Task_1_System_IO_Stream_ *, Run_8, (app::Func_1_System_Threading_Tasks_Task_1__1 * function));
IL2CPP_REGISTER_METHODINFO(0x0471D0D8, Task_Run_7__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015445B0, Task_1_System_Net_WebResponse_ *, Run_9, (app::Func_1_System_Threading_Tasks_Task_1__2 * function));
IL2CPP_REGISTER_METHODINFO(0x047044C8, Task_Run_8__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01544150, Task_1_System_Boolean_ *, FromResult_3, (bool result));
IL2CPP_REGISTER_METHODINFO(0x04790D98, Task_FromResult_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01544980, Task_1_System_IO_Stream_ *, Run_10, (app::Func_1_System_IO_Stream_ * function));
IL2CPP_REGISTER_METHODINFO(0x0477B208, Task_Run_9__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01544350, Task_1_System_Tuple_4_ *, FromResult_4, (app::Tuple_4_Int32_Int32_Int32_Boolean_ * result));
IL2CPP_REGISTER_METHODINFO(0x0476FE50, Task_FromResult_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01546050, Task_1_SystemIntegration_Races_RaceRequestResultEntry__1 *, WhenAll_3, (app::Task_1_SystemIntegration_Races_RaceRequestResultEntry___Array * tasks));
IL2CPP_REGISTER_METHODINFO(0x0471BA78, Task_WhenAll_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01544350, Task_1_System_Byte_ *, FromResult_5, (app::Byte__Array * result));
