...
IL2CPP_REGISTER_METHOD(0x00954170, BehaviourStatus__Enum, OnExecute, (app::SpiderBatAcidSprayBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00955230, void, __ctor, (app::SpiderBatAcidSprayBehaviour * this_ptr));
}
