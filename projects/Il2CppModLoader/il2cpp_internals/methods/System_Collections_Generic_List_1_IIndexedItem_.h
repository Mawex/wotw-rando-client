...
namespace app::methods::System_Collections_Generic::List_1_IIndexedItem_ {
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_IIndexedItem_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047294E8, List_1_IIndexedItem___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EFC50, IIndexedItem *, get_Item, (app::List_1_IIndexedItem_ * this_ptr, int32_t index));
