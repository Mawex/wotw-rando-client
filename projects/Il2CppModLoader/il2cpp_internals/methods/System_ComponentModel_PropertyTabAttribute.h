...
namespace app::methods::System_ComponentModel::PropertyTabAttribute {
IL2CPP_REGISTER_METHOD(0x029975B0, void, __ctor_1, (app::PropertyTabAttribute * this_ptr));
IL2CPP_REGISTER_METHOD(0x02997650, void, __ctor_2, (app::PropertyTabAttribute * this_ptr, app::Type * tab_class));
IL2CPP_REGISTER_METHOD(0x02997780, void, __ctor_3, (app::PropertyTabAttribute * this_ptr, app::String * tab_class_name));
IL2CPP_REGISTER_METHOD(0x029978B0, void, __ctor_4, (app::PropertyTabAttribute * this_ptr, app::Type * tab_class, app::PropertyTabScope__Enum tab_scope));
IL2CPP_REGISTER_METHODINFO(0x0476A9F0, PropertyTabAttribute__ctor_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02997A40, void, __ctor_5, (app::PropertyTabAttribute * this_ptr, app::String * tab_class_name, app::PropertyTabScope__Enum tab_scope));
IL2CPP_REGISTER_METHODINFO(0x04710630, PropertyTabAttribute__ctor_4__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02997BD0, Type__Array *, get_TabClasses, (app::PropertyTabAttribute * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04700C20, PropertyTabAttribute_get_TabClasses__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02998020, String__Array *, get_TabClassNames, (app::PropertyTabAttribute * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA280, PropertyTabScope__Enum__Array *, get_TabScopes, (app::PropertyTabAttribute * this_ptr));
