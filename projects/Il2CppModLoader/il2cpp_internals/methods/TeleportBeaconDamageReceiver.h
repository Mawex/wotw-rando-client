...
IL2CPP_REGISTER_METHOD(0x00CE7C20, Vector3, get_Position, (app::TeleportBeaconDamageReceiver * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, IDamageReciever__Array *, get_AffectedReceivers, (app::TeleportBeaconDamageReceiver * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::TeleportBeaconDamageReceiver * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::TeleportBeaconDamageReceiver * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::TeleportBeaconDamageReceiver * this_ptr));
}
