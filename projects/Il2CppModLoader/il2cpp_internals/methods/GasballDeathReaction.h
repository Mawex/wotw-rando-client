...
IL2CPP_REGISTER_METHOD(0x0041E730, BehaviourStatus__Enum, OnExecuteTask, (app::GasballDeathReaction * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0041EB70, void, __ctor, (app::GasballDeathReaction * this_ptr));
}
