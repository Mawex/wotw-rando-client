...
IL2CPP_REGISTER_METHOD(0x0307B220, void, __ctor, (app::AnimationClip * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0307B750, WrapMode__Enum, get_wrapMode, (app::AnimationClip * this_ptr));
IL2CPP_REGISTER_METHOD(0x0307B7A0, void, set_wrapMode, (app::AnimationClip * this_ptr, app::WrapMode__Enum value));
IL2CPP_REGISTER_METHOD(0x0307B800, Bounds, get_localBounds, (app::AnimationClip * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0307BD30, AnimationEvent__Array *, get_events, (app::AnimationClip * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0307BE80, Array *, GetEventsInternal, (app::AnimationClip * this_ptr));
