...
IL2CPP_REGISTER_METHOD(0x002FB930, UberID *, get_StateID, (app::BooleanUberState * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9B0, IUberStateGroup *, get_UberStateGroup, (app::BooleanUberState * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B5FB20, UberID *, get_GroupID, (app::BooleanUberState * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01B5FE20, NamedValue_1_System_Boolean___Array *, get_Options, (app::BooleanUberState * this_ptr));
IL2CPP_REGISTER_METHOD(0x00BAB250, String *, get_Name, (app::BooleanUberState * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B5FE40, void, Initialize, (app::BooleanUberState * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B5FE50, String *, ToString, (app::BooleanUberState * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01A66990, Nullable_1_Single_, get_VolitileGenericOverrideValue, (app::BooleanUberState * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01B5FF80, void, __ctor, (app::BooleanUberState * this_ptr));
}
