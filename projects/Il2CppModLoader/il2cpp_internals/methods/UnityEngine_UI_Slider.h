...
namespace app::methods::UnityEngine_UI::Slider {
IL2CPP_REGISTER_METHOD(0x02675C10, void, __ctor, (app::Slider * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F2BCB0, RectTransform *, get_fillRect, (app::Slider * this_ptr));
IL2CPP_REGISTER_METHOD(0x02675E40, void, set_fillRect, (app::Slider * this_ptr, app::RectTransform * value));
IL2CPP_REGISTER_METHOD(0x01F36B20, RectTransform *, get_handleRect, (app::Slider * this_ptr));
IL2CPP_REGISTER_METHOD(0x02675F10, void, set_handleRect, (app::Slider * this_ptr, app::RectTransform * value));
IL2CPP_REGISTER_METHOD(0x02675FE0, Slider_Direction__Enum, get_direction, (app::Slider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x026766B0, Slider_SliderEvent *, get_onValueChanged, (app::Slider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02677060, Slider_Axis__Enum, get_axis, (app::Slider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02677ED0, Selectable *, FindSelectableOnLeft, (app::Slider * this_ptr));
IL2CPP_REGISTER_METHOD(0x02677F00, Selectable *, FindSelectableOnRight, (app::Slider * this_ptr));
IL2CPP_REGISTER_METHOD(0x02677F30, Selectable *, FindSelectableOnUp, (app::Slider * this_ptr));
IL2CPP_REGISTER_METHOD(0x02677F60, Selectable *, FindSelectableOnDown, (app::Slider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, ICanvasElement_get_transform, (app::Slider * this_ptr));
}
