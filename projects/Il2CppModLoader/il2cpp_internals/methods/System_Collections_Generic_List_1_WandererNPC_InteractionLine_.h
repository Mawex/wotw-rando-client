...
namespace app::methods::System_Collections_Generic::List_1_WandererNPC_InteractionLine_ {
IL2CPP_REGISTER_METHOD(0x025EFC50, WandererNPC_InteractionLine *, get_Item, (app::List_1_WandererNPC_InteractionLine_ * this_ptr, int32_t index));
