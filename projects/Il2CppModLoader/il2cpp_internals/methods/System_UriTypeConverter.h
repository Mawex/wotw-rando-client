...
IL2CPP_REGISTER_METHOD(0x031A0790, void, __ctor, (app::UriTypeConverter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031A0AB0, Object *, ConvertFrom, (app::UriTypeConverter * this_ptr, app::ITypeDescriptorContext * context, app::CultureInfo * culture, app::Object * value));
IL2CPP_REGISTER_METHODINFO(0x0474F438, UriTypeConverter_ConvertFrom__MethodInfo);
IL2CPP_REGISTER_METHOD(0x031A0D80, Object *, ConvertTo, (app::UriTypeConverter * this_ptr, app::ITypeDescriptorContext * context, app::CultureInfo * culture, app::Object * value, app::Type * destination_type));
