...
namespace app::methods::System_Xml::HtmlEncodedRawTextWriter {
IL2CPP_REGISTER_METHOD(0x021F89F0, void, __ctor_1, (app::HtmlEncodedRawTextWriter * this_ptr, app::TextWriter * writer, app::XmlWriterSettings * settings));
IL2CPP_REGISTER_METHOD(0x021F8A20, void, __ctor_2, (app::HtmlEncodedRawTextWriter * this_ptr, app::Stream * stream, app::XmlWriterSettings * settings));
...
IL2CPP_REGISTER_METHOD(0x021FA080, void, WriteHtmlElementTextBlock, (app::HtmlEncodedRawTextWriter * this_ptr, app::uint16_t * p_src, app::uint16_t * p_src_end));
IL2CPP_REGISTER_METHOD(0x021FA0A0, void, WriteHtmlAttributeTextBlock, (app::HtmlEncodedRawTextWriter * this_ptr, app::uint16_t * p_src, app::uint16_t * p_src_end));
IL2CPP_REGISTER_METHOD(0x021FA0E0, void, WriteHtmlAttributeText, (app::HtmlEncodedRawTextWriter * this_ptr, app::uint16_t * p_src, app::uint16_t * p_src_end));
IL2CPP_REGISTER_METHOD(0x021FA4A0, void, WriteUriAttributeText, (app::HtmlEncodedRawTextWriter * this_ptr, app::uint16_t * p_src, app::uint16_t * p_src_end));
