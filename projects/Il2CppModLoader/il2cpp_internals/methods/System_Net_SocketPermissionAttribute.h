...
namespace app::methods::System_Net::SocketPermissionAttribute {
IL2CPP_REGISTER_METHOD(0x002FC6E0, void, __ctor, (app::SocketPermissionAttribute * this_ptr, app::SecurityAction__Enum action));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Access, (app::SocketPermissionAttribute * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BDF8D0, void, set_Access, (app::SocketPermissionAttribute * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_Host, (app::SocketPermissionAttribute * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BDF970, void, set_Host, (app::SocketPermissionAttribute * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, get_Port, (app::SocketPermissionAttribute * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BDFA10, void, set_Port, (app::SocketPermissionAttribute * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_Transport, (app::SocketPermissionAttribute * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BDFAB0, void, set_Transport, (app::SocketPermissionAttribute * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x01BDFB50, IPermission *, CreatePermission, (app::SocketPermissionAttribute * this_ptr));
