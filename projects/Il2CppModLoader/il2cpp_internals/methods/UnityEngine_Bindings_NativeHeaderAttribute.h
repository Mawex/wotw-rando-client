...
namespace app::methods::UnityEngine_Bindings::NativeHeaderAttribute {
IL2CPP_REGISTER_METHOD(0x031BB220, void, __ctor, (app::NativeHeaderAttribute * this_ptr, app::String * header));
