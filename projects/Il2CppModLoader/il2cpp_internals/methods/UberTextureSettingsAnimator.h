...
IL2CPP_REGISTER_METHOD(0x012902E0, Vector2, get_OriginalOffset, (app::UberTextureSettingsAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01290300, Vector2, get_OriginalScale, (app::UberTextureSettingsAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012905F0, Vector2, get_CurrentTextureOffset, (app::UberTextureSettingsAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012907C0, Vector2, get_CurrentTextureScale, (app::UberTextureSettingsAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01290B60, UberShaderProperty_Texture__Enum, GetTexturePropertyFromTextureName, (app::UberTextureSettingsAnimator * this_ptr, app::UberTextureSettingsAnimator_TextureName__Enum texture_name));
IL2CPP_REGISTER_METHOD(0x01290C30, UberShaderTextureBase *, UberShaderTextureBaseFromTextureName, (app::UberTextureSettingsAnimator * this_ptr, app::UberTextureSettingsAnimator_TextureName__Enum texture_name, app::UberShaderComponent * uber_shader_component));
...
IL2CPP_REGISTER_METHOD(0x01291C90, void, __ctor, (app::UberTextureSettingsAnimator * this_ptr));
