...
IL2CPP_REGISTER_METHOD(0x00C52F40, SurfaceTypeVFXHandler_2_MaterialBasedHornBugEffectsMap_HornBugMovementEffects_ *, get_VfxHandler, (app::RammingBehaviour_RamState * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C53240, String *, get_StateName, (app::RammingBehaviour_RamState * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::RammingBehaviour_RamState * this_ptr, app::RammingBehaviour * behaviour));
...
IL2CPP_REGISTER_METHOD(0x00C53630, GameObject *, GetEffectsPrefab, (app::RammingBehaviour_RamState * this_ptr, app::HornBugMovementEffects * surface_type));
}
