...
IL2CPP_REGISTER_METHOD(0x002FBCA0, Cart *, get_ActiveCart, (app::CartPlaceholder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B3CD10, LegacyEntity *, Instantiate, (app::CartPlaceholder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B3D6C0, void, __ctor, (app::CartPlaceholder * this_ptr));
