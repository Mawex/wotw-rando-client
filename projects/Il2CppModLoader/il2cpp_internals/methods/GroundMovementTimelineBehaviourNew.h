...
IL2CPP_REGISTER_METHOD(0x010974B0, Vector3, RootMotionModifier, (app::GroundMovementTimelineBehaviourNew * this_ptr, app::Vector3 motion));
IL2CPP_REGISTER_METHODINFO(0x04770278, GroundMovementTimelineBehaviourNew_RootMotionModifier__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00420FE0, void, __ctor, (app::GroundMovementTimelineBehaviourNew * this_ptr));
}
