...
IL2CPP_REGISTER_METHOD(0x00A9C4D0, AbilityType__Enum, get_AbilityType, (app::SeinTeleportSpell * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A7EB30, void, __ctor, (app::SeinTeleportSpell * this_ptr));
}
