...
namespace app::methods::Moon_Timeline::ScaleTweenAnimator {
IL2CPP_REGISTER_METHOD(0x01E80FB0, Transform *, get_TransformTarget, (app::ScaleTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E81040, GameObject *, get_ExternalTarget, (app::ScaleTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, OnEntityCreated, (app::ScaleTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E810F0, Transform *, get_EffectiveTransform, (app::ScaleTweenAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E81B60, void, __ctor, (app::ScaleTweenAnimator * this_ptr));
}
