...
namespace app::methods::UnityEngine_Networking_PlayerConnection::PlayerEditorConnectionEvents {
IL2CPP_REGISTER_METHOD(0x0253F770, void, __ctor, (app::PlayerEditorConnectionEvents * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0253FF60, UnityEvent_1_UnityEngine_Networking_PlayerConnection_MessageEventArgs_ *, AddAndCreate, (app::PlayerEditorConnectionEvents * this_ptr, app::Guid message_id));
