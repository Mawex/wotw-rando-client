...
IL2CPP_REGISTER_METHOD(0x030449B0, String *, GetShaderName, (app::GaussianBlur * this_ptr));
IL2CPP_REGISTER_METHOD(0x03044A30, void, __ctor, (app::GaussianBlur * this_ptr));
}
