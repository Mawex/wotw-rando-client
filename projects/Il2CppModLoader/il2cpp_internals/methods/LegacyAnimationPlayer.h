...
IL2CPP_REGISTER_METHOD(0x015CB5D0, MoonAnimator *, get_MoonAnimator, (app::LegacyAnimationPlayer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x015CBD90, void, __ctor, (app::LegacyAnimationPlayer * this_ptr));
