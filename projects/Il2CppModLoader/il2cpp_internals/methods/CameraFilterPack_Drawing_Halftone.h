...
IL2CPP_REGISTER_METHOD(0x024F1E90, Material *, get_material, (app::CameraFilterPack_Drawing_Halftone * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024F2660, void, __ctor, (app::CameraFilterPack_Drawing_Halftone * this_ptr));
}
