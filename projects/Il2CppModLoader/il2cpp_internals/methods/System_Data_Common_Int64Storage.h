...
namespace app::methods::System_Data_Common::Int64Storage {
IL2CPP_REGISTER_METHOD(0x021692D0, void, __ctor, (app::Int64Storage * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x021693F0, Object *, Aggregate, (app::Int64Storage * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x02169F30, Object *, ConvertValue, (app::Int64Storage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x0216A060, void, Copy, (app::Int64Storage * this_ptr, int32_t record_no1, int32_t record_no2));
IL2CPP_REGISTER_METHOD(0x0216A110, Object *, Get, (app::Int64Storage * this_ptr, int32_t record));
...
IL2CPP_REGISTER_METHOD(0x0216A4E0, Object *, ConvertXmlToObject, (app::Int64Storage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x0216A5C0, String *, ConvertObjectToXml, (app::Int64Storage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x0216A6A0, Object *, GetEmptyStorage, (app::Int64Storage * this_ptr, int32_t record_count));
