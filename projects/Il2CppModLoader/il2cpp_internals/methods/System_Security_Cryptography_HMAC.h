...
namespace app::methods::System_Security_Cryptography::HMAC {
...
IL2CPP_REGISTER_METHOD(0x020D8E70, Byte__Array *, get_Key, (app::HMAC * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, String *, get_HashName, (app::HMAC * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020D9170, HMAC *, Create_1, ());
IL2CPP_REGISTER_METHOD(0x020D92B0, HMAC *, Create_2, (app::String * algorithm_name));
...
IL2CPP_REGISTER_METHOD(0x020D94A0, Byte__Array *, HashFinal, (app::HMAC * this_ptr));
IL2CPP_REGISTER_METHOD(0x020D96A0, void, Dispose, (app::HMAC * this_ptr, bool disposing));
IL2CPP_REGISTER_METHOD(0x020D97D0, HashAlgorithm *, GetHashAlgorithmWithFipsFallback, (app::Func_1_System_Security_Cryptography_HashAlgorithm_ * create_standard_hash_algorithm_callback, app::Func_1_System_Security_Cryptography_HashAlgorithm_ * create_fips_hash_algorithm_callback));
IL2CPP_REGISTER_METHODINFO(0x04771628, HMAC_GetHashAlgorithmWithFipsFallback__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020D9870, void, __ctor, (app::HMAC * this_ptr));
}
