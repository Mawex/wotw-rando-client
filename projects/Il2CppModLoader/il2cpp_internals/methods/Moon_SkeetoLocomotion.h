...
IL2CPP_REGISTER_METHOD(0x00418200, SkeetoAirEntityMovementProcessor *, get_SkeetoMovementProcessor, (app::SkeetoLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E2A650, bool, get_IsTurning, (app::SkeetoLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x00418200, MovementProcessor *, get_MovementProcessor, (app::SkeetoLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E2A6E0, LayerMask, get_GroundMask, (app::SkeetoLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E2A700, Transform *, get_FeetTransform, (app::SkeetoLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E2A720, Vector3, get_FeetPosition, (app::SkeetoLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E2A7C0, Vector3, get_UpDirection, (app::SkeetoLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0083E8C0, EntityWeightData_EntityWeight__Enum, get_Weight, (app::SkeetoLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005B0220, EntityLocomotionTask *, get_DefaultFSMState, (app::SkeetoLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0065FBE0, SkeetoAirMoveBehaviour *, get_MovementBehaviour, (app::SkeetoLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E2AFA0, bool, HasRegisteredLookDirection, (app::SkeetoLocomotion * this_ptr, app::float * registered_look_direction));
...
IL2CPP_REGISTER_METHOD(0x00E2BA00, EntityLocomotionTask *, GetNextBehaviour, (app::SkeetoLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C1F250, Vector2, GetCurrentVelocity, (app::SkeetoLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E2BEA0, Vector2, GetTargetVelocity, (app::SkeetoLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E2C9F0, Vector2, get_LookDirection, (app::SkeetoLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E2CB00, Vector2, get_LookDirectionXYNormalized, (app::SkeetoLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E2CC10, bool, get_IsFacingLeft, (app::SkeetoLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E2CC40, void, __ctor, (app::SkeetoLocomotion * this_ptr));
}
