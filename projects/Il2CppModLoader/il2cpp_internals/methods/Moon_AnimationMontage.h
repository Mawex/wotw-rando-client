...
IL2CPP_REGISTER_METHOD(0x002FBCE0, List_1_Moon_AnimationMontage_Entry_ *, get_Entries, (app::AnimationMontage * this_ptr));
IL2CPP_REGISTER_METHOD(0x01338140, IAnimationMontageEventHandler *, get_EventHandler, (app::AnimationMontage * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01339DC0, IMontageEventProvider *, GetEventProvider, (app::AnimationMontage * this_ptr, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x0133A300, IMontageEventProvider *, ResolveEventProvider, (app::AnimationMontage * this_ptr, app::String * value_name));
...
IL2CPP_REGISTER_METHOD(0x0133ADD0, MoonAnimator *, GetSubMontageAnimator, (app::AnimationMontage * this_ptr, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x0133BA10, void, __ctor, (app::AnimationMontage * this_ptr));
