...
IL2CPP_REGISTER_METHOD(0x0010A980, Guid, GetValueOrDefault_1, (app::Nullable_1_Guid___Boxed * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0477A258, Nullable_1_Guid__GetValueOrDefault__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00120520, void, __ctor, (app::Nullable_1_Guid___Boxed * this_ptr, app::Guid value));
IL2CPP_REGISTER_METHODINFO(0x0472D1E8, Nullable_1_Guid___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0020DCA0, Guid, get_Value, (app::Nullable_1_Guid___Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x001F49C0, Guid, GetValueOrDefault_2, (app::Nullable_1_Guid___Boxed * this_ptr, app::Guid default_value));
IL2CPP_REGISTER_METHOD(0x0020DF40, String *, ToString, (app::Nullable_1_Guid___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0254F710, Object *, Box, (app::Nullable_1_Guid_ o));
IL2CPP_REGISTER_METHOD(0x02888C40, Nullable_1_Guid_, Unbox, (app::Object * o));
}
