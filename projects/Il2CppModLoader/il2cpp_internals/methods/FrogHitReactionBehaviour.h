...
IL2CPP_REGISTER_METHOD(0x016497F0, BehaviourStatus__Enum, OnExecuteTask, (app::FrogHitReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01649980, void, __ctor, (app::FrogHitReactionBehaviour * this_ptr));
}
