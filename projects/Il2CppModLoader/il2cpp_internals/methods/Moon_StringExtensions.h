...
IL2CPP_REGISTER_METHOD(0x030F35E0, String *, ToCSharpStringLiteral, (app::String * this_1, bool omit_quotes, bool escape_all_non_ascii));
...
IL2CPP_REGISTER_METHOD(0x030F3980, void, WriteCSharpLiteral, (app::String * input, app::uint16_t * output, bool omit_quotes, bool escape_all_non_ascii));
