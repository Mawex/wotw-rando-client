...
namespace app::methods::Newtonsoft_Json_Converters::EntityKeyMemberConverter {
...
IL2CPP_REGISTER_METHOD(0x01A530D0, Object *, ReadJson, (app::EntityKeyMemberConverter * this_ptr, app::JsonReader * reader, app::Type * object_type, app::Object * existing_value, app::JsonSerializer * serializer));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::EntityKeyMemberConverter * this_ptr));
}
