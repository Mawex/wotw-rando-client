...
IL2CPP_REGISTER_METHOD(0x03055490, String *, GetShaderName, (app::WaveDistortion * this_ptr));
IL2CPP_REGISTER_METHOD(0x03055510, void, __ctor, (app::WaveDistortion * this_ptr));
}
