...
IL2CPP_REGISTER_METHOD(0x011B1820, BehaviourStatus__Enum, OnExecute, (app::SpiderBossLaserAttackCeiling * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x011B1480, void, __ctor, (app::SpiderBossLaserAttackCeiling * this_ptr));
}
