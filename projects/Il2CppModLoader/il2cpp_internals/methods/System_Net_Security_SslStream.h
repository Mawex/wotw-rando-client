...
namespace app::methods::System_Net_Security::SslStream {
IL2CPP_REGISTER_METHOD(0x01BD1C90, IMonoSslStream *, get_Impl, (app::SslStream * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BD1D40, void, __ctor, (app::SslStream * this_ptr, app::Stream * inner_stream, bool leave_inner_stream_open, app::MonoTlsProvider * provider, app::MonoTlsSettings * settings));
IL2CPP_REGISTER_METHOD(0x01BD1DC0, IMonoSslStream *, CreateMonoSslStream, (app::Stream * inner_stream, bool leave_inner_stream_open, app::MonoTlsProvider * provider, app::MonoTlsSettings * settings));
...
IL2CPP_REGISTER_METHOD(0x01BD2820, Task *, FlushAsync, (app::SslStream * this_ptr, app::CancellationToken cancellation_token));
...
IL2CPP_REGISTER_METHOD(0x01BD2BE0, IAsyncResult *, BeginRead, (app::SslStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::AsyncCallback * async_callback, app::Object * async_state));
IL2CPP_REGISTER_METHOD(0x01BD2CC0, int32_t, EndRead, (app::SslStream * this_ptr, app::IAsyncResult * async_result));
IL2CPP_REGISTER_METHOD(0x01BD2D70, IAsyncResult *, BeginWrite, (app::SslStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::AsyncCallback * async_callback, app::Object * async_state));
