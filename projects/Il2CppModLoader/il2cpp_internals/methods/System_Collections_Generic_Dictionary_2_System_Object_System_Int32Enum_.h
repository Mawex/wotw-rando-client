...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_Object_System_Int32Enum_ {
...
IL2CPP_REGISTER_METHOD(0x002FB990, IEqualityComparer_1_System_Object_ *, get_Comparer, (app::Dictionary_2_System_Object_System_Int32Enum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B2A0, int32_t, get_Count, (app::Dictionary_2_System_Object_System_Int32Enum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B2B0, Dictionary_2_TKey_TValue_KeyCollection_System_Object_System_Int32Enum_ *, get_Keys, (app::Dictionary_2_System_Object_System_Int32Enum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B2B0, ICollection_1_System_Object_ *, System_Collections_Generic_IDictionary_TKey_TValue__get_Keys, (app::Dictionary_2_System_Object_System_Int32Enum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B2B0, IEnumerable_1_System_Object_ *, System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Keys, (app::Dictionary_2_System_Object_System_Int32Enum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B3E0, Dictionary_2_TKey_TValue_ValueCollection_System_Object_System_Int32Enum_ *, get_Values, (app::Dictionary_2_System_Object_System_Int32Enum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B3E0, ICollection_1_System_Int32Enum_ *, System_Collections_Generic_IDictionary_TKey_TValue__get_Values, (app::Dictionary_2_System_Object_System_Int32Enum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283B3E0, IEnumerable_1_System_Int32Enum_ *, System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Values, (app::Dictionary_2_System_Object_System_Int32Enum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02BCF4F0, Int32Enum__Enum, get_Item, (app::Dictionary_2_System_Object_System_Int32Enum_ * this_ptr, app::Object * key));
...
IL2CPP_REGISTER_METHOD(0x02BA5400, Dictionary_2_TKey_TValue_Enumerator_System_Object_System_Int32Enum_, GetEnumerator, (app::Dictionary_2_System_Object_System_Int32Enum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02BA5450, IEnumerator_1_KeyValuePair_2_System_Object_System_Int32Enum_ *, System_Collections_Generic_IEnumerable_System_Collections_Generic_KeyValuePair_TKey_TValue___GetEnumerator, (app::Dictionary_2_System_Object_System_Int32Enum_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BA5450, IEnumerator *, IEnumerable_GetEnumerator, (app::Dictionary_2_System_Object_System_Int32Enum_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BD16C0, Object *, ICollection_get_SyncRoot, (app::Dictionary_2_System_Object_System_Int32Enum_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0283E020, ICollection *, IDictionary_get_Keys, (app::Dictionary_2_System_Object_System_Int32Enum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0283E050, ICollection *, IDictionary_get_Values, (app::Dictionary_2_System_Object_System_Int32Enum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02BCE6F0, Object *, IDictionary_get_Item, (app::Dictionary_2_System_Object_System_Int32Enum_ * this_ptr, app::Object * key));
...
IL2CPP_REGISTER_METHOD(0x02BA7EA0, IDictionaryEnumerator *, IDictionary_GetEnumerator, (app::Dictionary_2_System_Object_System_Int32Enum_ * this_ptr));
