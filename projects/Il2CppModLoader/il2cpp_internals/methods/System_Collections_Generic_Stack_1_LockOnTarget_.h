...
namespace app::methods::System_Collections_Generic::Stack_1_LockOnTarget_ {
...
IL2CPP_REGISTER_METHOD(0x02CF7F90, LockOnTarget *, Pop, (app::Stack_1_LockOnTarget_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0243CB70, void, __ctor, (app::Stack_1_LockOnTarget_ * this_ptr));
