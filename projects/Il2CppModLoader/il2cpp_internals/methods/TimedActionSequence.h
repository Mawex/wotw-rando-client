...
IL2CPP_REGISTER_METHOD(0x010F3450, IEnumerator *, RunSequence, (app::TimedActionSequence * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x0043BB90, void, __ctor, (app::TimedActionSequence * this_ptr));
}
