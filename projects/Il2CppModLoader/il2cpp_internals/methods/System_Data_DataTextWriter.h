...
namespace app::methods::System_Data::DataTextWriter {
IL2CPP_REGISTER_METHOD(0x01F3EB60, XmlWriter *, CreateWriter, (app::XmlWriter * xw));
IL2CPP_REGISTER_METHOD(0x002FB940, void, __ctor, (app::DataTextWriter * this_ptr, app::XmlWriter * w));
IL2CPP_REGISTER_METHOD(0x01F3ECA0, Stream *, get_BaseStream, (app::DataTextWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F3F170, WriteState__Enum, get_WriteState, (app::DataTextWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F3F200, String *, LookupPrefix, (app::DataTextWriter * this_ptr, app::String * ns));
}
