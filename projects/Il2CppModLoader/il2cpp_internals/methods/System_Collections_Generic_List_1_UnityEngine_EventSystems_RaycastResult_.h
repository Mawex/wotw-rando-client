...
namespace app::methods::System_Collections_Generic::List_1_UnityEngine_EventSystems_RaycastResult_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047533A0, List_1_UnityEngine_EventSystems_RaycastResult___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02D22420, RaycastResult, get_Item, (app::List_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02D21E10, void, __ctor_3, (app::List_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr, app::IEnumerable_1_UnityEngine_EventSystems_RaycastResult_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02D222C0, Object *, ICollection_get_SyncRoot, (app::List_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D22650, Object *, IList_get_Item, (app::List_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_UnityEngine_EventSystems_RaycastResult_ *, AsReadOnly, (app::List_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D23090, RaycastResult, Find, (app::List_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr, app::Predicate_1_UnityEngine_EventSystems_RaycastResult_ * match));
IL2CPP_REGISTER_METHOD(0x02D23240, List_1_UnityEngine_EventSystems_RaycastResult_ *, FindAll, (app::List_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr, app::Predicate_1_UnityEngine_EventSystems_RaycastResult_ * match));
...
IL2CPP_REGISTER_METHOD(0x02D23820, List_1_T_Enumerator_UnityEngine_EventSystems_RaycastResult_, GetEnumerator, (app::List_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D238A0, IEnumerator_1_UnityEngine_EventSystems_RaycastResult_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D238A0, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_UnityEngine_EventSystems_RaycastResult_ *, GetRange, (app::List_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, RaycastResult__Array *, ToArray, (app::List_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr));
