...
IL2CPP_REGISTER_METHOD(0x011630F0, SwimmingLocomotion *, get_Locomotion, (app::PiranhaPatrolBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011645B0, BehaviourStatus__Enum, OnExecute, (app::PiranhaPatrolBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x011646E0, void, OnDrawGizmos, (app::PiranhaPatrolBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x01164980, void, __ctor, (app::PiranhaPatrolBehaviour * this_ptr));
}
