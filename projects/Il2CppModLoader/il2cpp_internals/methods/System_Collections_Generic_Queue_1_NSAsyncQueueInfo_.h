...
namespace app::methods::System_Collections_Generic::Queue_1_NSAsyncQueueInfo_ {
...
IL2CPP_REGISTER_METHOD(0x02CA77B0, NSAsyncQueueInfo *, Dequeue, (app::Queue_1_NSAsyncQueueInfo_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0476BCC0, Queue_1_NSAsyncQueueInfo__Dequeue__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02CA7080, void, __ctor, (app::Queue_1_NSAsyncQueueInfo_ * this_ptr, int32_t capacity));
