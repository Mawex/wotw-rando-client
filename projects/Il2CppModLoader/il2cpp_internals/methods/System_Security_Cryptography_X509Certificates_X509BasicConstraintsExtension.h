...
namespace app::methods::System_Security_Cryptography_X509Certificates::X509BasicConstraintsExtension {
IL2CPP_REGISTER_METHOD(0x021C3470, void, __ctor_1, (app::X509BasicConstraintsExtension * this_ptr));
IL2CPP_REGISTER_METHOD(0x021C35D0, void, __ctor_2, (app::X509BasicConstraintsExtension * this_ptr, app::AsnEncodedData * encoded_basic_constraints, bool critical));
IL2CPP_REGISTER_METHOD(0x021C3760, void, __ctor_3, (app::X509BasicConstraintsExtension * this_ptr, bool certificate_authority, bool has_path_length_constraint, int32_t path_length_constraint, bool critical));
...
IL2CPP_REGISTER_METHOD(0x021C3E90, AsnDecodeStatus__Enum, Decode, (app::X509BasicConstraintsExtension * this_ptr, app::Byte__Array * extension));
IL2CPP_REGISTER_METHOD(0x021C4110, Byte__Array *, Encode, (app::X509BasicConstraintsExtension * this_ptr));
IL2CPP_REGISTER_METHOD(0x021C44A0, String *, ToString, (app::X509BasicConstraintsExtension * this_ptr, bool multi_line));
}
