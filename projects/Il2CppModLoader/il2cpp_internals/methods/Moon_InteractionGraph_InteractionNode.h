...
namespace app::methods::Moon_InteractionGraph::InteractionNode {
IL2CPP_REGISTER_METHOD(0x0198ECE0, IInteractionActor *, get_Actor, (app::InteractionNode * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBC0, Action_1_IContext_ *, get_OnActivated, (app::InteractionNode * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBD0, void, set_OnActivated, (app::InteractionNode * this_ptr, app::Action_1_IContext_ * value));
IL2CPP_REGISTER_METHOD(0x002FBBE0, Action_1_IContext_ *, get_OnFinished, (app::InteractionNode * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0198EF20, List_1_Moon_InteractionGraph_IInteractionTransition_ *, get_Transitions, (app::InteractionNode * this_ptr));
IL2CPP_REGISTER_METHOD(0x0198F1A0, List_1_Moon_InteractionGraph_IInteractionNodeDecorator_ *, get_Decorators, (app::InteractionNode * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C03C70, InteractionNodeStatus__Enum, get_InteractionNodeStatus, (app::InteractionNode * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB80, InteractionSettings *, get_InteractionSettings, (app::InteractionNode * this_ptr));
IL2CPP_REGISTER_METHOD(0x0198ECE0, IInteractionActor *, get_ResolvedActor, (app::InteractionNode * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0198FEB0, void, __ctor, (app::InteractionNode * this_ptr));
}
