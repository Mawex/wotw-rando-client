...
namespace app::methods::System_Collections_Generic::List_1_SkillItem_ {
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_SkillItem_, GetEnumerator, (app::List_1_SkillItem_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04751B78, List_1_SkillItem__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_SkillItem_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04701218, List_1_SkillItem___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025EFC50, SkillItem *, get_Item, (app::List_1_SkillItem_ * this_ptr, int32_t index));
