...
namespace app::methods::System_Text::InternalDecoderBestFitFallback {
IL2CPP_REGISTER_METHOD(0x02457F90, void, __ctor, (app::InternalDecoderBestFitFallback * this_ptr, app::Encoding * encoding));
IL2CPP_REGISTER_METHOD(0x02457FB0, DecoderFallbackBuffer *, CreateFallbackBuffer, (app::InternalDecoderBestFitFallback * this_ptr));
