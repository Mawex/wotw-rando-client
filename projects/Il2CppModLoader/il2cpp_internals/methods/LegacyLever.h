...
namespace app::methods::LegacyLever {
    ...
    IL2CPP_REGISTER_METHOD(0x002FBC80, Transform*, get_Transform, (app::LegacyLever * this_ptr));
    IL2CPP_REGISTER_METHOD(0x003FF2B0, LeverDirections__Enum, get_Direction, (app::LegacyLever * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FD750, LeverDirections__Enum, get_OriginalDirection, (app::LegacyLever * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x005065F0, LeverMode__Enum, get_LeverType, (app::LegacyLever * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBC60, SoundHost*, get_SoundHost, (app::LegacyLever * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A28F60, LeverPuppet*, get_Puppet, (app::LegacyLever * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00A2A320, Vector3, get_Position, (app::LegacyLever * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0061E5E0, SuspendableMask__Enum, get_Mask, (app::LegacyLever * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00A2AC30, Bounds, get_Bounds, (app::LegacyLever * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00A2AD00, void, __ctor, (app::LegacyLever * this_ptr));
} // namespace app::methods::LegacyLever
