...
namespace app::methods::System_Threading::CancellationTokenRegistration {
IL2CPP_REGISTER_METHOD(0x00151540, void, __ctor, (app::CancellationTokenRegistration__Boxed * this_ptr, app::CancellationCallbackInfo * callback_info, app::SparselyPopulatedArrayAddInfo_1_CancellationCallbackInfo_ registration_info));
