...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::Rigidbody2D * this_ptr));
IL2CPP_REGISTER_METHOD(0x03172420, Vector2, get_position, (app::Rigidbody2D * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03172660, Vector2, get_velocity, (app::Rigidbody2D * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03172940, PhysicsMaterial2D *, get_sharedMaterial, (app::Rigidbody2D * this_ptr));
IL2CPP_REGISTER_METHOD(0x03172990, void, set_sharedMaterial, (app::Rigidbody2D * this_ptr, app::PhysicsMaterial2D * value));
IL2CPP_REGISTER_METHOD(0x031729F0, Vector2, get_centerOfMass, (app::Rigidbody2D * this_ptr));
IL2CPP_REGISTER_METHOD(0x03172A60, void, set_centerOfMass, (app::Rigidbody2D * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x03172AC0, Vector2, get_worldCenterOfMass, (app::Rigidbody2D * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03172DF0, RigidbodyType2D__Enum, get_bodyType, (app::Rigidbody2D * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031731E0, RigidbodyConstraints2D__Enum, get_constraints, (app::Rigidbody2D * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03173480, RigidbodyInterpolation2D__Enum, get_interpolation, (app::Rigidbody2D * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03173530, RigidbodySleepMode2D__Enum, get_sleepMode, (app::Rigidbody2D * this_ptr));
IL2CPP_REGISTER_METHOD(0x03173580, void, set_sleepMode, (app::Rigidbody2D * this_ptr, app::RigidbodySleepMode2D__Enum value));
IL2CPP_REGISTER_METHOD(0x031735E0, CollisionDetectionMode2D__Enum, get_collisionDetectionMode, (app::Rigidbody2D * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03173A30, ColliderDistance2D, Distance, (app::Rigidbody2D * this_ptr, app::Collider2D * collider));
IL2CPP_REGISTER_METHODINFO(0x04715EA8, Rigidbody2D_Distance__MethodInfo);
IL2CPP_REGISTER_METHOD(0x03173C60, ColliderDistance2D, Distance_Internal, (app::Rigidbody2D * this_ptr, app::Collider2D * collider));
...
IL2CPP_REGISTER_METHOD(0x03174070, Vector2, GetPoint, (app::Rigidbody2D * this_ptr, app::Vector2 point));
IL2CPP_REGISTER_METHOD(0x031740E0, Vector2, GetRelativePoint, (app::Rigidbody2D * this_ptr, app::Vector2 relative_point));
IL2CPP_REGISTER_METHOD(0x03174150, Vector2, GetVector, (app::Rigidbody2D * this_ptr, app::Vector2 vector));
IL2CPP_REGISTER_METHOD(0x031741C0, Vector2, GetRelativeVector, (app::Rigidbody2D * this_ptr, app::Vector2 relative_vector));
IL2CPP_REGISTER_METHOD(0x03174230, Vector2, GetPointVelocity, (app::Rigidbody2D * this_ptr, app::Vector2 point));
IL2CPP_REGISTER_METHOD(0x031742A0, Vector2, GetRelativePointVelocity, (app::Rigidbody2D * this_ptr, app::Vector2 relative_point));
