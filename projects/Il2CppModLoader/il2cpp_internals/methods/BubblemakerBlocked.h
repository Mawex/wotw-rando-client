...
IL2CPP_REGISTER_METHOD(0x002FBD20, IUberState__Array *, get_AffectingUberStates, (app::BubblemakerBlocked * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD40, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::BubblemakerBlocked * this_ptr));
