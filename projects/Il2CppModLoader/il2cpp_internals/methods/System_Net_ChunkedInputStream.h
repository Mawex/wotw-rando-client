...
namespace app::methods::System_Net::ChunkedInputStream {
IL2CPP_REGISTER_METHOD(0x02016D60, void, __ctor, (app::ChunkedInputStream * this_ptr, app::HttpListenerContext * context, app::Stream * stream, app::Byte__Array * buffer, int32_t offset, int32_t length));
IL2CPP_REGISTER_METHOD(0x002FBB60, MonoChunkStream *, get_Decoder, (app::ChunkedInputStream * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02016FC0, IAsyncResult *, BeginRead, (app::ChunkedInputStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::AsyncCallback * cback, app::Object * state));
