...
IL2CPP_REGISTER_METHOD(0x01B62940, void, GetCurrentState_2, (app::ISerializedUberState * uber_state_descriptor, app::bool * state));
IL2CPP_REGISTER_METHOD(0x01B62A20, void, GetCurrentState_3, (app::ISerializedUberState * uber_state_descriptor, app::float * state));
IL2CPP_REGISTER_METHOD(0x01B62AE0, void, GetCurrentState_4, (app::ISerializedUberState * uber_state_descriptor, app::int32_t * state));
IL2CPP_REGISTER_METHOD(0x01B62BC0, void, GetCurrentState_5, (app::ISerializedUberState * uber_state_descriptor, app::uint8_t * state));
