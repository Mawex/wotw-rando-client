...
namespace app::methods::System_Threading::ManualResetEventSlim {
IL2CPP_REGISTER_METHOD(0x027DE960, WaitHandle *, get_WaitHandle, (app::ManualResetEventSlim * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x027DECE0, void, __ctor_1, (app::ManualResetEventSlim * this_ptr, bool initial_state));
IL2CPP_REGISTER_METHOD(0x027DED40, void, __ctor_2, (app::ManualResetEventSlim * this_ptr, bool initial_state, int32_t spin_count));
