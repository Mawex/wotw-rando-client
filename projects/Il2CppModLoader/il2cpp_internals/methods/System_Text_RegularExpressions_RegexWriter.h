...
namespace app::methods::System_Text_RegularExpressions::RegexWriter {
IL2CPP_REGISTER_METHOD(0x02A78D50, RegexCode *, Write, (app::RegexTree * t));
IL2CPP_REGISTER_METHOD(0x02A78EB0, void, __ctor, (app::RegexWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A796E0, ArgumentException *, MakeException, (app::RegexWriter * this_ptr, app::String * message));
IL2CPP_REGISTER_METHOD(0x02A79830, int32_t, MapCapnum, (app::RegexWriter * this_ptr, int32_t capnum));
IL2CPP_REGISTER_METHOD(0x02A79940, RegexCode *, RegexCodeFromRegexTree, (app::RegexWriter * this_ptr, app::RegexTree * tree));
