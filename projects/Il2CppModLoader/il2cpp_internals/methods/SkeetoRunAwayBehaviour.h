...
IL2CPP_REGISTER_METHOD(0x006AF270, SkeetoLocomotion *, get_Locomotion, (app::SkeetoRunAwayBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006B00D0, BehaviourStatus__Enum, UpdateApproach, (app::SkeetoRunAwayBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x006B0610, void, OnExit, (app::SkeetoRunAwayBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x006B0670, BehaviourStatus__Enum, OnExecute, (app::SkeetoRunAwayBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x006B0680, void, __ctor, (app::SkeetoRunAwayBehaviour * this_ptr));
}
