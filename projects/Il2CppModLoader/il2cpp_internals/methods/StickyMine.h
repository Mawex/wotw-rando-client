...
namespace app::methods::StickyMine {
    ...
    IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::StickyMine * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x006515B0, SuspendableMask__Enum, get_Mask, (app::StickyMine * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FBD40, IDamageReciever__Array*, get_AffectedReceivers, (app::StickyMine * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00653970, void, __ctor, (app::StickyMine * this_ptr));
    IL2CPP_REGISTER_METHOD(0x004F4750, GameObject*, IDamageReciever_get_gameObject, (app::StickyMine * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00506170, Transform*, IDamageReciever_get_transform, (app::StickyMine * this_ptr));
} // namespace app::methods::StickyMine
