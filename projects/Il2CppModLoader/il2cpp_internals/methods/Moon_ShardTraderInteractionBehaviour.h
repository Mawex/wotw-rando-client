...
IL2CPP_REGISTER_METHOD(0x00E274A0, BehaviourStatus__Enum, OnExecute, (app::ShardTraderInteractionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00E27000, void, OnExit, (app::ShardTraderInteractionBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x0060C1C0, void, __ctor, (app::ShardTraderInteractionBehaviour * this_ptr));
}
