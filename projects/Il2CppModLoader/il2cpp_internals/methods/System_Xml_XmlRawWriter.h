...
namespace app::methods::System_Xml::XmlRawWriter {
...
IL2CPP_REGISTER_METHOD(0x01701330, String *, LookupPrefix, (app::XmlRawWriter * this_ptr, app::String * ns));
IL2CPP_REGISTER_METHODINFO(0x0477A1D8, XmlRawWriter_LookupPrefix__MethodInfo);
IL2CPP_REGISTER_METHOD(0x017013A0, WriteState__Enum, get_WriteState, (app::XmlRawWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::XmlRawWriter * this_ptr));
}
