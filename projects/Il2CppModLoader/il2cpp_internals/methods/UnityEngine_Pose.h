...
IL2CPP_REGISTER_METHOD(0x001FE8F0, void, __ctor, (app::Pose__Boxed * this_ptr, app::Vector3 position, app::Quaternion rotation));
IL2CPP_REGISTER_METHOD(0x002170A0, String *, ToString, (app::Pose__Boxed * this_ptr));
