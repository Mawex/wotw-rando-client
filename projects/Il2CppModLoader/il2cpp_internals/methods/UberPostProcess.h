...
IL2CPP_REGISTER_METHOD(0x00FF2640, ColorVariationManager *, get_ColorVariationManager, (app::UberPostProcess * this_ptr));
IL2CPP_REGISTER_METHOD(0x00FF27A0, Vector3, get_Speed, (app::UberPostProcess * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FF2880, SeinController3D *, get_CurrentSeinController3D, (app::UberPostProcess * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FF2B30, Camera *, get_MainCamera, (app::UberPostProcess * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FF3570, Material *, CheckShaderAndCreateMaterial, (app::UberPostProcess * this_ptr, app::Shader * s, app::Material * m2_create));
...
IL2CPP_REGISTER_METHOD(0x00FF5430, bool, SetAnimationCurveForChannel, (app::UberPostProcess * this_ptr, app::AnimationCurve * curve, int32_t channel, app::float * len));
...
IL2CPP_REGISTER_METHOD(0x00FF8C40, void, SetCh_1, (app::UberPostProcess * this_ptr, float value, app::float * set));
...
IL2CPP_REGISTER_METHOD(0x00FFA530, void, __ctor, (app::UberPostProcess * this_ptr));
