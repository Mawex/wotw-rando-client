...
namespace app::methods::System_IO::FileStream {
    IL2CPP_REGISTER_METHOD(0x01E09CF0, void, __ctor_1, (app::FileStream * this_ptr, void * handle, app::FileAccess__Enum access, bool owns_handle, int32_t buffer_size));
    IL2CPP_REGISTER_METHOD(0x01E09D20, void, __ctor_2, (app::FileStream * this_ptr, void * handle, app::FileAccess__Enum access, bool owns_handle, int32_t buffer_size, bool is_async));
    IL2CPP_REGISTER_METHOD(0x01E09D50, void, __ctor_3, (app::FileStream * this_ptr, void * handle, app::FileAccess__Enum access, bool owns_handle, int32_t buffer_size, bool is_async, bool is_console_wrapper));
