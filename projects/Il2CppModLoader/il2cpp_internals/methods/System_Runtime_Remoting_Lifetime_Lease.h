...
namespace app::methods::System_Runtime_Remoting_Lifetime::Lease {
IL2CPP_REGISTER_METHOD(0x02306F60, void, __ctor, (app::Lease * this_ptr));
IL2CPP_REGISTER_METHOD(0x023071F0, TimeSpan, get_CurrentLeaseTime, (app::Lease * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FD1D0, LeaseState__Enum, get_CurrentState, (app::Lease * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB990, TimeSpan, get_RenewOnCallTime, (app::Lease * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x023075F0, TimeSpan, Renew, (app::Lease * this_ptr, app::TimeSpan renewal_time));
