...
IL2CPP_REGISTER_METHOD(0x027A8220, int32_t, get_CallbackCount, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x027A8320, void, ResetStatics, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x027A8BA0, void, BuildCallbackData, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x027A9450, void, __cctor, (MethodInfo * method));
}
