...
IL2CPP_REGISTER_METHOD(0x026F88A0, void, __ctor_1, (app::AkMarkerCallbackInfo * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x026F8970, void *, getCPtr, (app::AkMarkerCallbackInfo * obj));
IL2CPP_REGISTER_METHOD(0x026F8A00, void, setCPtr, (app::AkMarkerCallbackInfo * this_ptr, app::void * c_ptr));
...
IL2CPP_REGISTER_METHOD(0x026F8FC0, String *, get_strLabel, (app::AkMarkerCallbackInfo * this_ptr));
