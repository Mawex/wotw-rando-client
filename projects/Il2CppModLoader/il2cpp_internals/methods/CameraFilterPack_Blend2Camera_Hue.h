...
IL2CPP_REGISTER_METHOD(0x0274F9C0, Material *, get_material, (app::CameraFilterPack_Blend2Camera_Hue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02750B90, void, __ctor, (app::CameraFilterPack_Blend2Camera_Hue * this_ptr));
}
