...
IL2CPP_REGISTER_METHOD(0x027C42F0, TypedReference, MakeTypedReference, (app::Object * target, app::FieldInfo_1__Array * flds));
IL2CPP_REGISTER_METHODINFO(0x0470EED8, TypedReference_MakeTypedReference__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027C4880, TypedReference, MakeTypedReferenceInternal, (app::Object * target, app::FieldInfo_1__Array * fields));
