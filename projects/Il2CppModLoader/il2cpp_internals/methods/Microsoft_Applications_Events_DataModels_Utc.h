...
namespace app::methods::Microsoft_Applications_Events_DataModels::Utc {
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_stId, (app::Utc * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_stId, (app::Utc * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_aId, (app::Utc * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_aId, (app::Utc * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_raId, (app::Utc * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB960, void, set_raId, (app::Utc * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, get_op, (app::Utc * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9D0, String *, get_sqmId, (app::Utc * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9E0, void, set_sqmId, (app::Utc * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB9F0, String *, get_mon, (app::Utc * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB60, String *, get_bSeq, (app::Utc * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB70, void, set_bSeq, (app::Utc * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBB80, String *, get_epoch, (app::Utc * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FD4B0, void, __ctor_1, (app::Utc * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_2, (app::Utc * this_ptr, app::String * full_name, app::String * name));
}
