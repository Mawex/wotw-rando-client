...
namespace app::methods::System_Net_Configuration::DefaultProxySection {
IL2CPP_REGISTER_METHOD(0x02018CE0, void, __ctor, (app::DefaultProxySection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04770548, DefaultProxySection__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02018D10, BypassElementCollection *, get_BypassList, (app::DefaultProxySection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02018DA0, ModuleElement *, get_Module, (app::DefaultProxySection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04761A60, DefaultProxySection_get_Module__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02018DD0, ConfigurationPropertyCollection *, get_Properties, (app::DefaultProxySection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0474CE50, DefaultProxySection_get_Properties__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02018E00, ProxyElement *, get_Proxy, (app::DefaultProxySection * this_ptr));
