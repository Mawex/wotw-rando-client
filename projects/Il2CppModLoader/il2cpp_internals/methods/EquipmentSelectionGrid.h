...
IL2CPP_REGISTER_METHOD(0x00977150, EquipmentSelectionGrid_EquipmentAnchorGroup *, GetGroup, (app::EquipmentSelectionGrid * this_ptr, app::Object * inventory_item));
IL2CPP_REGISTER_METHOD(0x009773A0, void, ResetItems, (app::EquipmentSelectionGrid * this_ptr));
IL2CPP_REGISTER_METHOD(0x009775D0, void, __ctor, (app::EquipmentSelectionGrid * this_ptr));
}
