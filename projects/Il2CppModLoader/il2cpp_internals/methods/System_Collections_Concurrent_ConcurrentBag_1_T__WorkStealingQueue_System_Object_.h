...
namespace app::methods::System_Collections_Concurrent::ConcurrentBag_1_T__WorkStealingQueue_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02ADA500, void, __ctor, (app::ConcurrentBag_1_T_WorkStealingQueue_System_Object_ * this_ptr, app::ConcurrentBag_1_T_WorkStealingQueue_System_Object_ * next_queue));
