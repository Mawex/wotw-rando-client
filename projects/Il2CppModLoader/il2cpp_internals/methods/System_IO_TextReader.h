...
namespace app::methods::System_IO::TextReader {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::TextReader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02384E50, String *, ReadToEnd, (app::TextReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x02385040, String *, ReadLine, (app::TextReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x02385370, TextReader *, Synchronized, (app::TextReader * reader));
