...
namespace app::methods::System_Xml_Schema::AxisElement {
IL2CPP_REGISTER_METHOD(0x002FA280, DoubleLinkAxis *, get_CurNode, (app::AxisElement * this_ptr));
IL2CPP_REGISTER_METHOD(0x019A2F80, void, __ctor, (app::AxisElement * this_ptr, app::DoubleLinkAxis * node, int32_t depth));
