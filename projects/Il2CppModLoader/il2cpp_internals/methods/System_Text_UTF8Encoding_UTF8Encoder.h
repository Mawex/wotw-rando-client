...
namespace app::methods::System_Text::UTF8Encoding_UTF8Encoder {
IL2CPP_REGISTER_METHOD(0x0244DBE0, void, __ctor_1, (app::UTF8Encoding_UTF8Encoder * this_ptr, app::UTF8Encoding * encoding));
IL2CPP_REGISTER_METHOD(0x027D2AB0, void, __ctor_2, (app::UTF8Encoding_UTF8Encoder * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
