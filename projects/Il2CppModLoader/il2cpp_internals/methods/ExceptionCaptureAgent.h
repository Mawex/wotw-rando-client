...
IL2CPP_REGISTER_METHOD(0x00983220, String__Array *, GetDataHeaderNames, (app::ExceptionCaptureAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00983470, String__Array *, GetFrameData_1, (app::ExceptionCaptureAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00983630, void, __ctor, (app::ExceptionCaptureAgent * this_ptr));
