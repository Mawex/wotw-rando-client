...
namespace app::methods::System_Data_Common::SByteStorage {
IL2CPP_REGISTER_METHOD(0x0216F1C0, void, __ctor, (app::SByteStorage * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x0216F2E0, Object *, Aggregate, (app::SByteStorage * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x0216FC30, Object *, ConvertValue, (app::SByteStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02158280, void, Copy, (app::SByteStorage * this_ptr, int32_t record_no1, int32_t record_no2));
IL2CPP_REGISTER_METHOD(0x0216FD60, Object *, Get, (app::SByteStorage * this_ptr, int32_t record));
...
IL2CPP_REGISTER_METHOD(0x02170130, Object *, ConvertXmlToObject, (app::SByteStorage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x02170210, String *, ConvertObjectToXml, (app::SByteStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x021702F0, Object *, GetEmptyStorage, (app::SByteStorage * this_ptr, int32_t record_count));
