...
namespace app::methods::System_Xml::XmlChildEnumerator {
IL2CPP_REGISTER_METHOD(0x0195FF00, void, __ctor, (app::XmlChildEnumerator * this_ptr, app::XmlNode * container));
...
IL2CPP_REGISTER_METHOD(0x01960000, Object *, IEnumerator_get_Current, (app::XmlChildEnumerator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01960000, XmlNode *, get_Current, (app::XmlChildEnumerator * this_ptr));
