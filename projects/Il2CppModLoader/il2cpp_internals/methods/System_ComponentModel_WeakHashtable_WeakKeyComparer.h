...
namespace app::methods::System_ComponentModel::WeakHashtable_WeakKeyComparer {
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::WeakHashtable_WeakKeyComparer * this_ptr));
}
