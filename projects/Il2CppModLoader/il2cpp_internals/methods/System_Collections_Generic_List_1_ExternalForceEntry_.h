...
namespace app::methods::System_Collections_Generic::List_1_ExternalForceEntry_ {
...
IL2CPP_REGISTER_METHOD(0x02D24DA0, ExternalForceEntry, get_Item, (app::List_1_ExternalForceEntry_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_ExternalForceEntry_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04767A98, List_1_ExternalForceEntry___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_ExternalForceEntry_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02DF8C00, void, __ctor_3, (app::List_1_ExternalForceEntry_ * this_ptr, app::IEnumerable_1_ExternalForceEntry_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02DF90A0, Object *, ICollection_get_SyncRoot, (app::List_1_ExternalForceEntry_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D24E60, bool, IsCompatibleObject, (app::Object * value));
IL2CPP_REGISTER_METHOD(0x02D24F80, Object *, IList_get_Item, (app::List_1_ExternalForceEntry_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_ExternalForceEntry_ *, AsReadOnly, (app::List_1_ExternalForceEntry_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D258D0, ExternalForceEntry, Find, (app::List_1_ExternalForceEntry_ * this_ptr, app::Predicate_1_ExternalForceEntry_ * match));
IL2CPP_REGISTER_METHOD(0x02D25A30, List_1_ExternalForceEntry_ *, FindAll, (app::List_1_ExternalForceEntry_ * this_ptr, app::Predicate_1_ExternalForceEntry_ * match));
...
IL2CPP_REGISTER_METHOD(0x02D25F90, List_1_T_Enumerator_ExternalForceEntry_, GetEnumerator, (app::List_1_ExternalForceEntry_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D25FF0, IEnumerator_1_ExternalForceEntry_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_ExternalForceEntry_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D25FF0, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_ExternalForceEntry_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_ExternalForceEntry_ *, GetRange, (app::List_1_ExternalForceEntry_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, ExternalForceEntry__Array *, ToArray, (app::List_1_ExternalForceEntry_ * this_ptr));
