...
namespace app::methods::UnityStandardAssets_CinematicEffects::AntiAliasing {
...
IL2CPP_REGISTER_METHOD(0x024FF940, IAntiAliasing *, get_current, (app::AntiAliasing * this_ptr));
IL2CPP_REGISTER_METHOD(0x024FF950, Camera *, get_cameraComponent, (app::AntiAliasing * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025000F0, void, __ctor, (app::AntiAliasing * this_ptr));
