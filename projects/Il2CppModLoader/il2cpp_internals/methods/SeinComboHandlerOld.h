...
IL2CPP_REGISTER_METHOD(0x005D06C0, CharacterPlatformMovement *, get_SeinPlatformMovement, (app::SeinComboHandlerOld * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A64170, Transform *, get_WeaponJoint, (app::SeinComboHandlerOld * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A64220, Transform *, get_RootJoint, (app::SeinComboHandlerOld * this_ptr));
IL2CPP_REGISTER_METHOD(0x0065FBC0, Animator *, get_Animator, (app::SeinComboHandlerOld * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A64230, MeleeWeapon *, get_CurrentWeapon, (app::SeinComboHandlerOld * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A64240, ComboMove *, get_CurrentComboMove, (app::SeinComboHandlerOld * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A64250, MeleeComboMoveSettings *, get_CurrentMeleeComboSettings, (app::SeinComboHandlerOld * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A66740, ComboInput *, GetNextInput, (app::SeinComboHandlerOld * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A66760, ComboMove *, FindComboMoveForInput, (app::SeinComboHandlerOld * this_ptr, app::ComboInput * input));
IL2CPP_REGISTER_METHOD(0x00A66780, ComboMove *, FindInitialComboMoveForInput, (app::SeinComboHandlerOld * this_ptr, app::ComboInput * input));
IL2CPP_REGISTER_METHOD(0x00A66980, ComboMove *, FindChainedComboMoveForInput, (app::SeinComboHandlerOld * this_ptr, app::ComboInput * input));
...
IL2CPP_REGISTER_METHOD(0x00A695D0, void, __ctor, (app::SeinComboHandlerOld * this_ptr));
