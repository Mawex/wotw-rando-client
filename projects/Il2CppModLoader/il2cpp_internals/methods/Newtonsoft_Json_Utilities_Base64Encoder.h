...
namespace app::methods::Newtonsoft_Json_Utilities::Base64Encoder {
IL2CPP_REGISTER_METHOD(0x01BFFFC0, void, __ctor, (app::Base64Encoder_1 * this_ptr, app::TextWriter * writer));
...
IL2CPP_REGISTER_METHOD(0x01C00680, void, StoreLeftOverBytes, (app::Base64Encoder_1 * this_ptr, app::Byte__Array * buffer, int32_t index, app::int32_t * count));
IL2CPP_REGISTER_METHOD(0x01C007C0, bool, FulfillFromLeftover, (app::Base64Encoder_1 * this_ptr, app::Byte__Array * buffer, int32_t index, app::int32_t * count));
