...
namespace app::methods::SmoothCurve {
    ...
    IL2CPP_REGISTER_METHOD(0x006D26A0, SmoothCurve_PathNode*, GetNodeWrapped, (app::SmoothCurve * this_ptr, int32_t index));
    IL2CPP_REGISTER_METHOD(0x006D27A0, SmoothCurve_PathNode*, GetNode, (app::SmoothCurve * this_ptr, int32_t index));
    IL2CPP_REGISTER_METHOD(0x006D2850, int32_t, get_NodeCount, (app::SmoothCurve * this_ptr));
    IL2CPP_REGISTER_METHOD(0x006D28E0, void, __ctor, (app::SmoothCurve * this_ptr));
} // namespace app::methods::SmoothCurve
