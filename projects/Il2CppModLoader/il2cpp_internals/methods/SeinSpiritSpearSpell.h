...
IL2CPP_REGISTER_METHOD(0x00420EE0, ButtonInputType__Enum, get_ButtonInputType, (app::SeinSpiritSpearSpell * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A71890, SeinSpiritSpearSpellPuppet *, get_Puppet, (app::SeinSpiritSpearSpell * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005D06C0, CharacterPlatformMovement *, get_PlatformMovement, (app::SeinSpiritSpearSpell * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A72B10, Vector3, get_AttackTargetPosition, (app::SeinSpiritSpearSpell * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A72C70, void, set_AttackTargetPosition, (app::SeinSpiritSpearSpell * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x00A72C90, Vector3, get_AttackPointNormal, (app::SeinSpiritSpearSpell * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A72CB0, void, set_AttackPointNormal, (app::SeinSpiritSpearSpell * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x00A72CD0, Quaternion, get_AttackRotation, (app::SeinSpiritSpearSpell * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A730F0, Quaternion, get_AttackRotationForVFX, (app::SeinSpiritSpearSpell * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A734B0, Vector3, GetSmoothedVelocity, (app::SeinSpiritSpearSpell * this_ptr, app::Vector3 direction, float speed, float max_speed));
IL2CPP_REGISTER_METHOD(0x00A73630, Vector3, GetJumpTargetPosition, (app::SeinSpiritSpearSpell * this_ptr, app::Vector3 from, float angle, float length));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, ComboMoveType__Enum, get_ComboMoveType, (app::SeinSpiritSpearSpell * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A792F0, IComboMove *, GetComboMove, (app::SeinSpiritSpearSpell * this_ptr, app::ComboInput * input));
...
IL2CPP_REGISTER_METHOD(0x00A79470, List_1_Moon_ComboSystem_IComboMove_ *, get_ComboMoves, (app::SeinSpiritSpearSpell * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A794C0, AbilityType__Enum, get_ComboAbilityType, (app::SeinSpiritSpearSpell * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A794D0, void, __ctor, (app::SeinSpiritSpearSpell * this_ptr));
}
