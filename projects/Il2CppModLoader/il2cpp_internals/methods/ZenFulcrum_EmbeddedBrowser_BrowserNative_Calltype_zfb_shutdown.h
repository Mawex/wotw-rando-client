...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::BrowserNative_Calltype_zfb_shutdown * this_ptr, app::Object * object, app::void * method_1));
IL2CPP_REGISTER_METHOD(0x00611820, void, Invoke, (app::BrowserNative_Calltype_zfb_shutdown * this_ptr));
IL2CPP_REGISTER_METHOD(0x00611B10, IAsyncResult *, BeginInvoke, (app::BrowserNative_Calltype_zfb_shutdown * this_ptr, app::AsyncCallback * callback, app::Object * object));
