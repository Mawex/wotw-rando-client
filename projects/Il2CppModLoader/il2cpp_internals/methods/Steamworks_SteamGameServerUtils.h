...
IL2CPP_REGISTER_METHOD(0x02803EF0, bool, GetImageSize, (int32_t i_image, app::uint32_t * pn_width, app::uint32_t * pn_height));
IL2CPP_REGISTER_METHOD(0x02803F40, bool, GetImageRGBA, (int32_t i_image, app::Byte__Array * pub_dest, int32_t n_dest_buffer_size));
IL2CPP_REGISTER_METHOD(0x02803F90, bool, GetCSERIPPort, (app::uint32_t * un_i_p, app::uint16_t * us_port));
...
IL2CPP_REGISTER_METHOD(0x028040D0, bool, IsAPICallCompleted, (app::SteamAPICall_t h_steam_a_p_i_call, app::bool * pb_failed));
IL2CPP_REGISTER_METHOD(0x02804110, ESteamAPICallFailure__Enum, GetAPICallFailureReason, (app::SteamAPICall_t h_steam_a_p_i_call));
IL2CPP_REGISTER_METHOD(0x02804140, bool, GetAPICallResult, (app::SteamAPICall_t h_steam_a_p_i_call, app::void * p_callback, int32_t cub_callback, int32_t i_callback_expected, app::bool * pb_failed));
...
IL2CPP_REGISTER_METHOD(0x02804240, SteamAPICall_t, CheckFileSignature, (app::String * sz_file_name));
