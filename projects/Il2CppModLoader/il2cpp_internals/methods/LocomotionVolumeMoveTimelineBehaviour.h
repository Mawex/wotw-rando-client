...
IL2CPP_REGISTER_METHOD(0x009EB5F0, Vector3, get_TargetPosition, (app::LocomotionVolumeMoveTimelineBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009EBA40, BehaviourStatus__Enum, OnExecuteTask, (app::LocomotionVolumeMoveTimelineBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x009EC6F0, void, __ctor, (app::LocomotionVolumeMoveTimelineBehaviour * this_ptr));
}
