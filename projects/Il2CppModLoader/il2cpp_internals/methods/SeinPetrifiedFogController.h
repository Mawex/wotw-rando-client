...
IL2CPP_REGISTER_METHOD(0x008B0120, ZoneDamageSettings *, get_DamageSettings, (app::SeinPetrifiedFogController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::SeinPetrifiedFogController * this_ptr));
}
