...
namespace app::methods::Moon_Timeline::UberStateVolitileOverrideAnimator {
IL2CPP_REGISTER_METHOD(0x01E904A0, IGenericUberState *, get_ResolvedUberState, (app::UberStateVolitileOverrideAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E906A0, void, __ctor, (app::UberStateVolitileOverrideAnimator * this_ptr));
}
