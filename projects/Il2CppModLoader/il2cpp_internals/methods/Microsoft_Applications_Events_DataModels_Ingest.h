...
namespace app::methods::Microsoft_Applications_Events_DataModels::Ingest {
...
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_clientIp, (app::Ingest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, String *, get_userAgent, (app::Ingest * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9C0, void, set_userAgent, (app::Ingest * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB9D0, String *, get_client, (app::Ingest * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9E0, void, set_client, (app::Ingest * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FCCC0, void, __ctor_1, (app::Ingest * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FCDA0, void, __ctor_2, (app::Ingest * this_ptr, app::String * full_name, app::String * name));
}
