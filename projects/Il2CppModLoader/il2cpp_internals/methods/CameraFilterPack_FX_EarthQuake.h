...
IL2CPP_REGISTER_METHOD(0x0246CC40, Material *, get_material, (app::CameraFilterPack_FX_EarthQuake * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0246D590, void, __ctor, (app::CameraFilterPack_FX_EarthQuake * this_ptr));
}
