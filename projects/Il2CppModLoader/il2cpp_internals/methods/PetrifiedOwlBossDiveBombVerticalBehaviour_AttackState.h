...
namespace app::methods::PetrifiedOwlBossDiveBombVerticalBehaviour_AttackState {
    IL2CPP_REGISTER_METHOD(0x004A1550, void, __ctor, (app::PetrifiedOwlBossDiveBombVerticalBehaviour_AttackState * this_ptr, app::PetrifiedOwlBossDiveBombVerticalBehaviour * behaviour));
