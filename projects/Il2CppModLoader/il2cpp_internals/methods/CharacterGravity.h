...
IL2CPP_REGISTER_METHOD(0x01051AC0, CharacterPlatformMovement *, get_PlatformMovement, (app::CharacterGravity * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC60, GravityPlatformMovementSettings *, get_CurrentSettings, (app::CharacterGravity * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCA0, GravityPlatformMovementSettings *, get_BaseSettings, (app::CharacterGravity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01052250, void, __ctor, (app::CharacterGravity * this_ptr));
}
