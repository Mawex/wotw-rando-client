...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::Comparison_1_SoundZoneProcessor_Job_PositionZoneEvent_ * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02C7C190, IAsyncResult *, BeginInvoke, (app::Comparison_1_SoundZoneProcessor_Job_PositionZoneEvent_ * this_ptr, app::SoundZoneProcessor_Job_PositionZoneEvent x, app::SoundZoneProcessor_Job_PositionZoneEvent y, app::AsyncCallback * callback, app::Object * object));
