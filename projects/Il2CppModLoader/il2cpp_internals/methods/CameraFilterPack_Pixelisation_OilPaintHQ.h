...
IL2CPP_REGISTER_METHOD(0x0248A080, Material *, get_material, (app::CameraFilterPack_Pixelisation_OilPaintHQ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0248A900, void, __ctor, (app::CameraFilterPack_Pixelisation_OilPaintHQ * this_ptr));
}
