...
IL2CPP_REGISTER_METHOD(0x00E70200, Color, get_ColorValue, (app::KeystoneDoorSlot * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E706A0, void, __ctor, (app::KeystoneDoorSlot * this_ptr));
}
