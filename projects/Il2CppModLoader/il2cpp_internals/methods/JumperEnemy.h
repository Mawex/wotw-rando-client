...
namespace app::methods::JumperEnemy {
    IL2CPP_REGISTER_METHOD(0x00E52DE0, JumperEnemyPuppet*, get_Puppet, (app::JumperEnemy * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00E58A20, void, __ctor, (app::JumperEnemy * this_ptr));
