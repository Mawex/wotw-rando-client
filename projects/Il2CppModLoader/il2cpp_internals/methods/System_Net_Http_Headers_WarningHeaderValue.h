...
namespace app::methods::System_Net_Http_Headers::WarningHeaderValue {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::WarningHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_Agent, (app::WarningHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AF4D20, Nullable_1_DateTimeOffset_, get_Date, (app::WarningHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x02AF4D40, void, set_Date, (app::WarningHeaderValue * this_ptr, app::Nullable_1_DateTimeOffset_ value));
IL2CPP_REGISTER_METHOD(0x002FB9B0, String *, get_Text, (app::WarningHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0173F610, Object *, ICloneable_Clone, (app::WarningHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D1B010, String *, ToString, (app::WarningHeaderValue * this_ptr));
}
