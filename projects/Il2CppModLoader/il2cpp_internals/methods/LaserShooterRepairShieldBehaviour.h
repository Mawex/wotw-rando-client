...
IL2CPP_REGISTER_METHOD(0x00F1FFB0, BehaviourStatus__Enum, OnExecute, (app::LaserShooterRepairShieldBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00F20460, void, ApplyOscilation, (app::LaserShooterRepairShieldBehaviour * this_ptr, float strength));
IL2CPP_REGISTER_METHOD(0x00F205F0, void, __ctor, (app::LaserShooterRepairShieldBehaviour * this_ptr));
}
