...
IL2CPP_REGISTER_METHOD(0x012B4A00, List_1_ICleverMenuFadeObserver_ *, get_ResolvedFaderObservers, (app::CleverMenuItemSelectionManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x012B4C60, int32_t, get_MenuItemsCount, (app::CleverMenuItemSelectionManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x012B4CF0, CleverMenuItem *, GetMenuItem, (app::CleverMenuItemSelectionManager * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x012B5FD0, CleverMenuItem *, get_CurrentMenuItem, (app::CleverMenuItemSelectionManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012BAE00, CleverMenuItem *, get_CleverMenuItemUnderCursor, (app::CleverMenuItemSelectionManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011A4510, SuspendableMask__Enum, get_Mask, (app::CleverMenuItemSelectionManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012BCA80, Vector2, get_MenuItemAxis, (app::CleverMenuItemSelectionManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012BDF00, Int32__Array *, get_GridDirections, (app::CleverMenuItemSelectionManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012BE410, void, __ctor, (app::CleverMenuItemSelectionManager * this_ptr));
