...
namespace app::methods::System_Security_Util::Tokenizer_StringMaker {
...
IL2CPP_REGISTER_METHOD(0x01E24790, void, __ctor, (app::Tokenizer_StringMaker * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E248E0, String *, MakeString, (app::Tokenizer_StringMaker * this_ptr));
}
