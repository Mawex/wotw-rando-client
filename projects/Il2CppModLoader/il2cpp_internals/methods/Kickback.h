...
namespace app::methods::Kickback {
    ...
    IL2CPP_REGISTER_METHOD(0x00E71230, Vector2, get_KickbackDirection, (app::Kickback * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00E712D0, Vector2, get_KickbackVector, (app::Kickback * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::Kickback * this_ptr));
} // namespace app::methods::Kickback
