...
IL2CPP_REGISTER_METHOD(0x002FBB00, Object *, get_TopObject, (app::ObjectManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x01ED7CC0, ObjectHolderList *, get_SpecialFixupObjects, (app::ObjectManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x01ED7E80, ObjectHolder *, FindObjectHolder, (app::ObjectManager * this_ptr, int64_t object_i_d));
IL2CPP_REGISTER_METHOD(0x01ED7EF0, ObjectHolder *, FindOrCreateObjectHolder, (app::ObjectManager * this_ptr, int64_t object_i_d));
...
IL2CPP_REGISTER_METHOD(0x01ED9AF0, Object *, GetObject, (app::ObjectManager * this_ptr, int64_t object_i_d));
...
IL2CPP_REGISTER_METHOD(0x01EDA770, RuntimeConstructorInfo *, GetConstructor, (app::RuntimeType * t));
