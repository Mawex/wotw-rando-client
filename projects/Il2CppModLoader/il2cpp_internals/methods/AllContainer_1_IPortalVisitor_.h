...
IL2CPP_REGISTER_METHOD(0x019D7800, IPortalVisitor *, get_Item, (app::AllContainer_1_IPortalVisitor_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::AllContainer_1_IPortalVisitor_ * this_ptr));
