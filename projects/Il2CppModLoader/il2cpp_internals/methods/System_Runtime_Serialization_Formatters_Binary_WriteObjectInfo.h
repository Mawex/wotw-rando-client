...
namespace app::methods::System_Runtime_Serialization_Formatters_Binary::WriteObjectInfo {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::WriteObjectInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01DA2560, WriteObjectInfo *, Serialize_1, (app::Object * obj, app::ISurrogateSelector * surrogate_selector, app::StreamingContext context, app::SerObjectInfoInit * ser_object_info_init, app::IFormatterConverter * converter, app::ObjectWriter * object_writer, app::SerializationBinder * binder));
...
IL2CPP_REGISTER_METHOD(0x01DA2C50, WriteObjectInfo *, Serialize_2, (app::Type * object_type, app::ISurrogateSelector * surrogate_selector, app::StreamingContext context, app::SerObjectInfoInit * ser_object_info_init, app::IFormatterConverter * converter, app::SerializationBinder * binder));
...
IL2CPP_REGISTER_METHOD(0x01DA4020, String *, GetTypeFullName, (app::WriteObjectInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x01DA4050, String *, GetAssemblyString, (app::WriteObjectInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01DA40C0, Type *, GetMemberType, (app::WriteObjectInfo * this_ptr, app::MemberInfo_1 * obj_member));
...
IL2CPP_REGISTER_METHOD(0x01DA4460, WriteObjectInfo *, GetObjectInfo, (app::SerObjectInfoInit * ser_object_info_init));
