...
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_Key, (app::GameSession * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Time, (app::GameSession * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB990, List_1_Moon_Telemetry_DataPoint_ *, GetPoints_1, (app::GameSession * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E337B0, List_1_Moon_Telemetry_DataPoint_ *, GetPoints_2, (app::GameSession * this_ptr, app::String * level_name));
}
