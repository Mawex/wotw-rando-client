...
namespace app::methods::UnityEngine_Bindings::NativeNameAttribute {
IL2CPP_REGISTER_METHOD(0x031BB4E0, void, __ctor, (app::NativeNameAttribute * this_ptr, app::String * name));
