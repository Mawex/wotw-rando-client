...
IL2CPP_REGISTER_METHOD(0x009655D0, BehaviourStatus__Enum, OnExecute, (app::SpiderBossAttackBite * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x009668D0, void, __ctor, (app::SpiderBossAttackBite * this_ptr));
}
