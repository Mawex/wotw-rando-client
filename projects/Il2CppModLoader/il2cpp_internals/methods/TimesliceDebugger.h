...
IL2CPP_REGISTER_METHOD(0x00AF2610, GUIStyle *, get_LabelStyle, (app::TimesliceDebugger * this_ptr));
IL2CPP_REGISTER_METHOD(0x00AF2980, TimesliceDebugger *, get_Instance, ());
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::TimesliceDebugger * this_ptr));
}
