...
namespace app::methods::Moon_ArtOptimization::AnimationModifierSampleTask {
    IL2CPP_REGISTER_METHOD(0x0133CF00, app::RenderTexture *, get_RenderTex, ());
    IL2CPP_REGISTER_METHOD(0x0133D1F0, void, __ctor, (app::AnimationModifierSampleTask * this_ptr, int32_t index, int32_t anim_sample_index, float progress, app::ArtOptimizationDataModel * data_model, app::UberShaderComponent * uber_shader, app::UberShaderModifier * modifier));
