...
IL2CPP_REGISTER_METHOD(0x00676DD0, GameObject__Array *, GetDynamicGraphicTargets, (app::SwampNightDayTransition * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::SwampNightDayTransition * this_ptr));
}
