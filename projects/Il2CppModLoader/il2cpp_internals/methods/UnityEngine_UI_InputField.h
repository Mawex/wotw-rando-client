...
namespace app::methods::UnityEngine_UI::InputField {
IL2CPP_REGISTER_METHOD(0x024C0BE0, void, __ctor, (app::InputField * this_ptr));
IL2CPP_REGISTER_METHOD(0x024C10C0, BaseInput *, get_input, (app::InputField * this_ptr));
IL2CPP_REGISTER_METHOD(0x024C1240, String *, get_compositionString, (app::InputField * this_ptr));
IL2CPP_REGISTER_METHOD(0x024C1370, Mesh *, get_mesh, (app::InputField * this_ptr));
IL2CPP_REGISTER_METHOD(0x024C1510, TextGenerator *, get_cachedInputTextGenerator, (app::InputField * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024C1810, String *, get_text, (app::InputField * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F36B20, Text *, get_textComponent, (app::InputField * this_ptr));
IL2CPP_REGISTER_METHOD(0x024C1E20, void, set_textComponent, (app::InputField * this_ptr, app::Text * value));
IL2CPP_REGISTER_METHOD(0x01F36B40, Graphic *, get_placeholder, (app::InputField * this_ptr));
IL2CPP_REGISTER_METHOD(0x024C2520, void, set_placeholder, (app::InputField * this_ptr, app::Graphic * value));
IL2CPP_REGISTER_METHOD(0x024C25E0, Color, get_caretColor, (app::InputField * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024C2700, Color, get_selectionColor, (app::InputField * this_ptr));
IL2CPP_REGISTER_METHOD(0x024C2710, void, set_selectionColor, (app::InputField * this_ptr, app::Color value));
IL2CPP_REGISTER_METHOD(0x01F36BF0, InputField_SubmitEvent *, get_onEndEdit, (app::InputField * this_ptr));
IL2CPP_REGISTER_METHOD(0x024C27A0, void, set_onEndEdit, (app::InputField * this_ptr, app::InputField_SubmitEvent * value));
IL2CPP_REGISTER_METHOD(0x024C2860, InputField_OnChangeEvent *, get_onValueChange, (app::InputField * this_ptr));
IL2CPP_REGISTER_METHOD(0x024C2870, void, set_onValueChange, (app::InputField * this_ptr, app::InputField_OnChangeEvent * value));
IL2CPP_REGISTER_METHOD(0x024C2860, InputField_OnChangeEvent *, get_onValueChanged, (app::InputField * this_ptr));
IL2CPP_REGISTER_METHOD(0x024C2870, void, set_onValueChanged, (app::InputField * this_ptr, app::InputField_OnChangeEvent * value));
IL2CPP_REGISTER_METHOD(0x024C2930, InputField_OnValidateInput *, get_onValidateInput, (app::InputField * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024C2B10, InputField_ContentType__Enum, get_contentType, (app::InputField * this_ptr));
IL2CPP_REGISTER_METHOD(0x024C2B20, void, set_contentType, (app::InputField * this_ptr, app::InputField_ContentType__Enum value));
IL2CPP_REGISTER_METHOD(0x01F36C00, InputField_LineType__Enum, get_lineType, (app::InputField * this_ptr));
IL2CPP_REGISTER_METHOD(0x024C2D10, void, set_lineType, (app::InputField * this_ptr, app::InputField_LineType__Enum value));
IL2CPP_REGISTER_METHOD(0x024C2E40, InputField_InputType__Enum, get_inputType, (app::InputField * this_ptr));
IL2CPP_REGISTER_METHOD(0x024C2E50, void, set_inputType, (app::InputField * this_ptr, app::InputField_InputType__Enum value));
IL2CPP_REGISTER_METHOD(0x01F2BCB0, TouchScreenKeyboard *, get_touchScreenKeyboard, (app::InputField * this_ptr));
IL2CPP_REGISTER_METHOD(0x024C2F00, TouchScreenKeyboardType__Enum, get_keyboardType, (app::InputField * this_ptr));
IL2CPP_REGISTER_METHOD(0x024C2F10, void, set_keyboardType, (app::InputField * this_ptr, app::TouchScreenKeyboardType__Enum value));
IL2CPP_REGISTER_METHOD(0x024C2FC0, InputField_CharacterValidation__Enum, get_characterValidation, (app::InputField * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024C31B0, void, ClampPos, (app::InputField * this_ptr, app::int32_t * pos));
...
IL2CPP_REGISTER_METHOD(0x024C3F20, IEnumerator *, CaretBlink, (app::InputField * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024C49B0, Vector2, ScreenToLocal, (app::InputField * this_ptr, app::Vector2 screen));
...
IL2CPP_REGISTER_METHOD(0x024C5950, IEnumerator *, MouseDragOutsideRect, (app::InputField * this_ptr, app::PointerEventData * event_data));
...
IL2CPP_REGISTER_METHOD(0x024C5D00, InputField_EditState__Enum, KeyPressed, (app::InputField * this_ptr, app::Event * evt));
...
IL2CPP_REGISTER_METHOD(0x024C6810, String *, GetSelectedString, (app::InputField * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, ICanvasElement_get_transform, (app::InputField * this_ptr));
}
