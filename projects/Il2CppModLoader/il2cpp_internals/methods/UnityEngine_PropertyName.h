...
namespace app::methods::UnityEngine::PropertyName {
    ...
    IL2CPP_REGISTER_METHOD(0x0296A4C0, app::PropertyName, operator__1, (app::String * name));
    IL2CPP_REGISTER_METHOD(0x0252E560, app::PropertyName, operator__2, (int32_t id));
