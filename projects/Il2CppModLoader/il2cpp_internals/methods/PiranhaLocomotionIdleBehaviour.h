...
IL2CPP_REGISTER_METHOD(0x0115FD00, BehaviourStatus__Enum, OnExecuteTask, (app::PiranhaLocomotionIdleBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01160740, void, __ctor, (app::PiranhaLocomotionIdleBehaviour * this_ptr));
}
