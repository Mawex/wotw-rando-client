...
namespace app::methods::SeinBowAttack {
    ...
    IL2CPP_REGISTER_METHOD(0x00D95480, SeinBowPuppet*, get_Puppet, (app::SeinBowAttack * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00420EE0, ButtonInputType__Enum, get_ButtonInputType, (app::SeinBowAttack * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A791C0, bool, get_MoveHasFinished, (app::SeinBowAttack * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00D95590, AbilityType__Enum, get_ComboAbilityType, (app::SeinBowAttack * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00420EE0, ComboMoveType__Enum, get_ComboMoveType, (app::SeinBowAttack * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00D95860, IContext*, get_TimelineContext, (app::SeinBowAttack * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00D95F70, IComboMove*, GetComboMove, (app::SeinBowAttack * this_ptr, app::ComboInput* input));
    IL2CPP_REGISTER_METHOD(0x00B29C50, List_1_Moon_ComboSystem_IComboMove_*, get_ComboMoves, (app::SeinBowAttack * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x005D06C0, CharacterPlatformMovement*, get_SeinPlatformMovement, (app::SeinBowAttack * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00D47870, SeinBowAttack_State__Enum, get_CurrentState, (app::SeinBowAttack * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00D96180, Kickback*, GetChargeKickback, (app::SeinBowAttack * this_ptr, bool is_on_ground));
    ...
    IL2CPP_REGISTER_METHOD(0x00D9CDB0, IBowAttackable*, GetClosestTarget, (app::SeinBowAttack * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00DA0710, ActiveAnimationHandle, PlayAnimation, (app::SeinBowAttack * this_ptr, app::MoonAnimation* animation, app::Action* on_stop_playing, app::Func_1_Boolean_* condition));
    IL2CPP_REGISTER_METHOD(0x00DA08E0, ActiveAnimationHandle, PlayBowAnimation, (app::SeinBowAttack * this_ptr, app::MoonAnimation* animation, app::Func_1_Boolean_* condition));
    IL2CPP_REGISTER_METHOD(0x00DA0A30, void, OnMoveWindowOpen, (app::SeinBowAttack * this_ptr, app::MoveEventType__Enum event_type));
    IL2CPP_REGISTER_METHOD(0x00DA0B30, String*, get_StressTestName, (app::SeinBowAttack * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00DA0C20, StressTestStatus__Enum, get_StressTestStatus, (app::SeinBowAttack * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00420230, RecordableParsingGroup__Enum, get_ParsingGroup, (app::SeinBowAttack * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00DA0C40, void, __ctor, (app::SeinBowAttack * this_ptr));
