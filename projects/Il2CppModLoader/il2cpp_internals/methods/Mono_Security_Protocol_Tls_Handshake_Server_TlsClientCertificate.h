...
namespace app::methods::Mono_Security_Protocol_Tls_Handshake_Server::TlsClientCertificate {
    IL2CPP_REGISTER_METHOD(0x01F6CD40, void, __ctor, (app::TlsClientCertificate * this_ptr, app::Context_1 * context, app::Byte__Array * buffer));
