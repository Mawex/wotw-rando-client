...
namespace app::methods::System_Net::HttpListenerTimeoutManager {
IL2CPP_REGISTER_METHOD(0x01E58740, TimeSpan, get_EntityBody, (app::HttpListenerTimeoutManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E587E0, TimeSpan, get_DrainEntityBody, (app::HttpListenerTimeoutManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E58880, TimeSpan, get_RequestQueue, (app::HttpListenerTimeoutManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E58920, TimeSpan, get_IdleConnection, (app::HttpListenerTimeoutManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E589C0, TimeSpan, get_HeaderWait, (app::HttpListenerTimeoutManager * this_ptr));
