...
namespace app::methods::System_Data::Constraint {
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, get_ConstraintName, (app::Constraint_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0238D780, String *, get_SchemaName, (app::Constraint_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0238D810, PropertyCollection *, get_ExtendedProperties, (app::Constraint_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB950, DataSet *, get__DataSet, (app::Constraint_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x00980110, String *, ToString, (app::Constraint_1 * this_ptr));
IL2CPP_REGISTER_METHOD(0x0238DB70, void, __ctor, (app::Constraint_1 * this_ptr));
}
