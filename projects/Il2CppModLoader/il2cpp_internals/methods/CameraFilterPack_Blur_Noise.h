...
IL2CPP_REGISTER_METHOD(0x024D2C20, Material *, get_material, (app::CameraFilterPack_Blur_Noise * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024D35E0, void, __ctor, (app::CameraFilterPack_Blur_Noise * this_ptr));
}
