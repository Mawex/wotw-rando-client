...
namespace app::methods::System_Linq_Expressions_Interpreter::EnterExceptionHandlerInstruction {
IL2CPP_REGISTER_METHOD(0x0052C650, void, __ctor, (app::EnterExceptionHandlerInstruction * this_ptr, bool has_value));
IL2CPP_REGISTER_METHOD(0x022DEA70, String *, get_InstructionName, (app::EnterExceptionHandlerInstruction * this_ptr));
