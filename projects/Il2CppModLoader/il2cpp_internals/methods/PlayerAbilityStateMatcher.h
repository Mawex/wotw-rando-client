...
IL2CPP_REGISTER_METHOD(0x0140A570, void, __ctor, (app::PlayerAbilityStateMatcher * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0140AC10, PlayerAbilityStatePair *, GetStatePairAt, (app::PlayerAbilityStateMatcher * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x0140AF60, int32_t, StateValueAt, (app::PlayerAbilityStateMatcher * this_ptr, int32_t entry_index));
IL2CPP_REGISTER_METHOD(0x0140B020, AbilityType__Enum, AbilityValueAt, (app::PlayerAbilityStateMatcher * this_ptr, int32_t entry_index));
...
IL2CPP_REGISTER_METHOD(0x0140B1C0, Dictionary_2_System_Int32_System_Type_ *, GetIdToTypeMap, (app::PlayerAbilityStateMatcher * this_ptr));
}
