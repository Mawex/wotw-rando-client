...
namespace app::methods::Moon_ArtOptimization::ShaderFreezeTask {
    IL2CPP_REGISTER_METHOD(0x00CB29E0, void, __ctor, (app::ShaderFreezeTask * this_ptr, bool freeze_shader_time, float time));
