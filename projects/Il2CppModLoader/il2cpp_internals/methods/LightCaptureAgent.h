...
IL2CPP_REGISTER_METHOD(0x0114A570, String__Array *, GetDataHeaderNames, (app::LightCaptureAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x0114A660, String__Array *, GetFrameData_1, (app::LightCaptureAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::LightCaptureAgent * this_ptr));
}
