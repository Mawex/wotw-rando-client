...
namespace app::methods::Moon_uberSerializationWisp::PlayerUberStatePinInformation {
...
IL2CPP_REGISTER_METHOD(0x00F3EF70, Vector2, GetPinLocation, (app::PlayerUberStatePinInformation * this_ptr, app::GameMapPins_PinColour__Enum color));
IL2CPP_REGISTER_METHOD(0x002FB930, List_1_GameMapPins_Pin_ *, GetPins, (app::PlayerUberStatePinInformation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F3F6F0, void, __ctor, (app::PlayerUberStatePinInformation * this_ptr, app::Action * dirty_call_back));
...
IL2CPP_REGISTER_METHOD(0x00F40450, GameMapPins_Pin *, GetPin, (app::PlayerUberStatePinInformation * this_ptr, app::GameMapPins_PinColour__Enum color));
