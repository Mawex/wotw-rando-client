...
namespace app::methods::System_Collections_Generic::Stack_1_UnityEngine_Object_ {
IL2CPP_REGISTER_METHOD(0x02CF78E0, void, __ctor, (app::Stack_1_UnityEngine_Object_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x02CF7F90, Object_1 *, Pop, (app::Stack_1_UnityEngine_Object_ * this_ptr));
