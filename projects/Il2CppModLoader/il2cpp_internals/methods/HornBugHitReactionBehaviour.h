...
IL2CPP_REGISTER_METHOD(0x0065FBE0, EntityDamageEvent *, get_DamageEvent, (app::HornBugHitReactionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420230, BehaviourStatus__Enum, OnExecuteTask, (app::HornBugHitReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00B6CCB0, void, __ctor, (app::HornBugHitReactionBehaviour * this_ptr));
}
