...
namespace app::methods::SwarmAgent {
    IL2CPP_REGISTER_METHOD(0x002FBC00, Transform*, get_Target, (app::SwarmAgent * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::SwarmAgent * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00681AD0, Vector3, GetBezierPosition, (app::SwarmAgent * this_ptr, app::Vector3 pos_a, app::Vector3 mid_point, app::Vector3 pos_b, float t));
    IL2CPP_REGISTER_METHOD(0x00681D70, Vector3, GetRandomUnacurracy, (app::SwarmAgent * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00682970, void, __ctor, (app::SwarmAgent * this_ptr));
    IL2CPP_REGISTER_METHOD(0x004F4750, GameObject*, IDamageReciever_get_gameObject, (app::SwarmAgent * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00506170, Transform*, IDamageReciever_get_transform, (app::SwarmAgent * this_ptr));
} // namespace app::methods::SwarmAgent
