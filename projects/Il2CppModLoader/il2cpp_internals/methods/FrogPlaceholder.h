...
IL2CPP_REGISTER_METHOD(0x0164A2C0, FrogEntity *, get_CurrentFrogEntity, (app::FrogPlaceholder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0164A770, void, __ctor, (app::FrogPlaceholder * this_ptr));
}
