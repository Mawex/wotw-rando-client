...
namespace app::methods::System_Collections_Generic::List_1_StateValidator_ {
IL2CPP_REGISTER_METHOD(0x025ED850, List_1_T_Enumerator_StateValidator_, GetEnumerator, (app::List_1_StateValidator_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047427A0, List_1_StateValidator__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_StateValidator_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047084F8, List_1_StateValidator___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_StateValidator_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02F4F680, void, __ctor_3, (app::List_1_StateValidator_ * this_ptr, app::IEnumerable_1_StateValidator_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02F4FB10, Object *, ICollection_get_SyncRoot, (app::List_1_StateValidator_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025EC760, StateValidator, get_Item, (app::List_1_StateValidator_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025EC910, Object *, IList_get_Item, (app::List_1_StateValidator_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_StateValidator_ *, AsReadOnly, (app::List_1_StateValidator_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025ED1F0, StateValidator, Find, (app::List_1_StateValidator_ * this_ptr, app::Predicate_1_StateValidator_ * match));
IL2CPP_REGISTER_METHOD(0x025ED330, List_1_StateValidator_ *, FindAll, (app::List_1_StateValidator_ * this_ptr, app::Predicate_1_StateValidator_ * match));
...
IL2CPP_REGISTER_METHOD(0x025ED8A0, IEnumerator_1_StateValidator_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_StateValidator_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025ED8A0, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_StateValidator_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_StateValidator_ *, GetRange, (app::List_1_StateValidator_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, StateValidator__Array *, ToArray, (app::List_1_StateValidator_ * this_ptr));
