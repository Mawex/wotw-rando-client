...
IL2CPP_REGISTER_METHOD(0x00446940, Vector3, get_WorldPosition, (app::PathFollowerVariedSpeed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00447ED0, void, __ctor, (app::PathFollowerVariedSpeed * this_ptr));
}
