...
IL2CPP_REGISTER_METHOD(0x008E77B0, RecorderFrame_FrameDataTypes__Enum, FrameType, (app::RecorderMessageData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008F26B0, void, __ctor, (app::RecorderMessageData * this_ptr));
}
