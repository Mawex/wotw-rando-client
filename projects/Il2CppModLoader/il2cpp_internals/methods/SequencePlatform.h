...
IL2CPP_REGISTER_METHOD(0x00AB66D0, IEnumerator *, PerformNextPlatform, (app::SequencePlatform * this_ptr));
IL2CPP_REGISTER_METHOD(0x00AB6820, IEnumerator *, PerformVanish, (app::SequencePlatform * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003FF610, SuspendableMask__Enum, get_Mask, (app::SequencePlatform * this_ptr));
IL2CPP_REGISTER_METHOD(0x00AB6A30, void, set_Mask, (app::SequencePlatform * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x00AB6AE0, void, __ctor, (app::SequencePlatform * this_ptr));
}
