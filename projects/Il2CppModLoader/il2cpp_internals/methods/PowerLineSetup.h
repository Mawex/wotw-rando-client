...
IL2CPP_REGISTER_METHOD(0x00C6B6C0, MoonTimeline *, get_AllDestroyedResolvedTimeline, (app::PowerLineSetup * this_ptr));
IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, get_ApplyOnEditor, (app::PowerLineSetup * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C6B7C0, IUberState__Array *, get_AffectingUberStates, (app::PowerLineSetup * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C6B8C0, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::PowerLineSetup * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C6CB20, IDesiredUberState *, GetRequirementsForTimeline, (app::PowerLineSetup * this_ptr, app::MoonTimeline * timeline));
IL2CPP_REGISTER_METHOD(0x00C6CD30, void, __ctor, (app::PowerLineSetup * this_ptr));
}
