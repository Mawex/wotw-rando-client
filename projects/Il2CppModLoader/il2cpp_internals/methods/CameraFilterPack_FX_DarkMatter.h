...
IL2CPP_REGISTER_METHOD(0x02469630, Material *, get_material, (app::CameraFilterPack_FX_DarkMatter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02469E90, void, __ctor, (app::CameraFilterPack_FX_DarkMatter * this_ptr));
}
