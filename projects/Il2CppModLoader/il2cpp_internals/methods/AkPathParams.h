...
namespace app::methods::AkPathParams {
    IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkPathParams * this_ptr, app::void* c_ptr, bool c_memory_own));
    IL2CPP_REGISTER_METHOD(0x01887AE0, void*, getCPtr, (app::AkPathParams * obj));
    IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkPathParams * this_ptr, app::void* c_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01887F40, AkVector*, get_listenerPos, (app::AkPathParams * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01888150, void, set_emitterPos, (app::AkPathParams * this_ptr, app::AkVector* value));
    IL2CPP_REGISTER_METHOD(0x01888290, AkVector*, get_emitterPos, (app::AkPathParams * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x018886F0, void, __ctor_2, (app::AkPathParams * this_ptr));
} // namespace app::methods::AkPathParams
