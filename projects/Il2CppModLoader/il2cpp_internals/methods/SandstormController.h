...
IL2CPP_REGISTER_METHOD(0x002FB990, SandstormController *, get_Instance, (app::SandstormController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::SandstormController * this_ptr));
}
