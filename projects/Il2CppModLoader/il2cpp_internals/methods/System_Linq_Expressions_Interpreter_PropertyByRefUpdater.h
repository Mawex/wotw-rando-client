...
namespace app::methods::System_Linq_Expressions_Interpreter::PropertyByRefUpdater {
IL2CPP_REGISTER_METHOD(0x022E5C20, void, __ctor, (app::PropertyByRefUpdater * this_ptr, app::Nullable_1_System_Linq_Expressions_Interpreter_LocalDefinition_ obj, app::PropertyInfo_1 * property, int32_t argument_index));
