...
IL2CPP_REGISTER_METHOD(0x0086B890, IEnumerator *, DestroyRoutine, (app::MovieTextureControllerB * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0086C3F0, void, __ctor, (app::MovieTextureControllerB * this_ptr));
