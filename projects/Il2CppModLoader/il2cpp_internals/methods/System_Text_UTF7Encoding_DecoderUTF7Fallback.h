...
namespace app::methods::System_Text::UTF7Encoding_DecoderUTF7Fallback {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::UTF7Encoding_DecoderUTF7Fallback * this_ptr));
IL2CPP_REGISTER_METHOD(0x027CDC10, DecoderFallbackBuffer *, CreateFallbackBuffer, (app::UTF7Encoding_DecoderUTF7Fallback * this_ptr));
