...
namespace app::methods::System_Collections_Generic::Dictionary_2_Leaderboard_LeaderboardData_ {
...
IL2CPP_REGISTER_METHOD(0x02C35530, LeaderboardData *, get_Item, (app::Dictionary_2_Leaderboard_LeaderboardData_ * this_ptr, app::Leaderboard__Enum key));
...
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_Leaderboard_LeaderboardData_ * this_ptr));
