...
namespace app::methods::System_Data_SqlTypes::SqlString {
IL2CPP_REGISTER_METHOD(0x001E6070, void, __ctor_1, (app::SqlString__Boxed * this_ptr, bool f_null));
IL2CPP_REGISTER_METHOD(0x001E6090, void, __ctor_2, (app::SqlString__Boxed * this_ptr, app::String * data, int32_t lcid, app::SqlCompareOptions__Enum compare_options));
IL2CPP_REGISTER_METHOD(0x001E60A0, void, __ctor_3, (app::SqlString__Boxed * this_ptr, app::String * data));
IL2CPP_REGISTER_METHOD(0x001E60B0, void, __ctor_4, (app::SqlString__Boxed * this_ptr, int32_t lcid, app::SqlCompareOptions__Enum compare_options, app::String * data, app::CompareInfo * cmp_info));
IL2CPP_REGISTER_METHOD(0x001E60C0, bool, get_IsNull, (app::SqlString__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001E60D0, String *, get_Value, (app::SqlString__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x022BA3B0, SqlString, operator_, (app::String * x));
IL2CPP_REGISTER_METHOD(0x001E60F0, String *, ToString, (app::SqlString__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x022BA3E0, SqlString, operator__, (app::SqlString x, app::SqlString y));
...
IL2CPP_REGISTER_METHOD(0x022BAA30, SqlBoolean, Compare, (app::SqlString x, app::SqlString y, app::EComparison__Enum ec_expected_result));
IL2CPP_REGISTER_METHOD(0x022BABF0, SqlBoolean, operator___, (app::SqlString x, app::SqlString y));
...
IL2CPP_REGISTER_METHOD(0x022BAEA0, CompareOptions__Enum, CompareOptionsFromSqlCompareOptions, (app::SqlCompareOptions__Enum compare_options));
...
IL2CPP_REGISTER_METHOD(0x0013BB70, XmlSchema *, IXmlSerializable_GetSchema, (app::SqlString__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x022BBBE0, XmlQualifiedName *, GetXsdType, (app::XmlSchemaSet * schema_set));
IL2CPP_REGISTER_METHOD(0x022BBD30, void, __cctor, ());
}
