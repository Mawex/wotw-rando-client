...
namespace app::methods::Steamworks::ISteamMatchmakingPlayersResponse_InternalPlayersFailedToRespond {
    IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::ISteamMatchmakingPlayersResponse_InternalPlayersFailedToRespond * this_ptr, app::Object * object, void * method_1));
