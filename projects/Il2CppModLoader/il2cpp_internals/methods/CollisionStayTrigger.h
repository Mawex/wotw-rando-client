...
IL2CPP_REGISTER_METHOD(0x0043D9A0, SelectableCategory__Enum, get_Category, (app::CollisionStayTrigger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012D2730, void, __ctor, (app::CollisionStayTrigger * this_ptr));
}
