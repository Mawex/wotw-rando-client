...
namespace app::methods::AkMIDIEvent {
    IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkMIDIEvent * this_ptr, app::void* c_ptr, bool c_memory_own));
    IL2CPP_REGISTER_METHOD(0x026EEE00, void*, getCPtr, (app::AkMIDIEvent * obj));
    IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkMIDIEvent * this_ptr, app::void* c_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x026F14F0, AkMIDICcTypes__Enum, get_byCc, (app::AkMIDIEvent * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x026F2640, void, __ctor_2, (app::AkMIDIEvent * this_ptr));
} // namespace app::methods::AkMIDIEvent
