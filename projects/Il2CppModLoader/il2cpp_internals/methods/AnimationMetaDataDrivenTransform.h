...
IL2CPP_REGISTER_METHOD(0x005035C0, SuspendableMask__Enum, get_Mask, (app::AnimationMetaDataDrivenTransform * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00503690, void, __ctor, (app::AnimationMetaDataDrivenTransform * this_ptr));
}
