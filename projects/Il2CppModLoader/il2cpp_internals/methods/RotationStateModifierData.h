...
IL2CPP_REGISTER_METHOD(0x01B799C0, Vector3, get_RotationEuler, (app::RotationStateModifierData * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B79A80, void, set_RotationEuler, (app::RotationStateModifierData * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x01B79B60, Quaternion, get_RotationQuartenion, (app::RotationStateModifierData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01B7A180, void, __ctor, (app::RotationStateModifierData * this_ptr));
