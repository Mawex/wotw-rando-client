...
IL2CPP_REGISTER_METHOD(0x0115CA60, BehaviourStatus__Enum, OnExecute, (app::PiranhaAttackBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0115D3E0, void, __ctor, (app::PiranhaAttackBehaviour * this_ptr));
