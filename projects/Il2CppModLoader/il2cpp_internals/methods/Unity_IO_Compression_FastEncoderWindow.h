...
namespace app::methods::Unity_IO_Compression::FastEncoderWindow {
IL2CPP_REGISTER_METHOD(0x02B775B0, void, __ctor, (app::FastEncoderWindow * this_ptr));
IL2CPP_REGISTER_METHOD(0x02B775C0, int32_t, get_BytesAvailable, (app::FastEncoderWindow * this_ptr));
IL2CPP_REGISTER_METHOD(0x02B775D0, DeflateInput *, get_UnprocessedInput, (app::FastEncoderWindow * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B779B0, uint32_t, InsertString, (app::FastEncoderWindow * this_ptr, app::uint32_t * hash));
IL2CPP_REGISTER_METHOD(0x02B77A80, void, InsertStrings, (app::FastEncoderWindow * this_ptr, app::uint32_t * hash, int32_t match_len));
IL2CPP_REGISTER_METHOD(0x02B77BA0, bool, GetNextSymbolOrMatch, (app::FastEncoderWindow * this_ptr, app::Match_1 * match));
IL2CPP_REGISTER_METHOD(0x02B77E70, int32_t, FindMatch, (app::FastEncoderWindow * this_ptr, int32_t search, app::int32_t * match_pos, int32_t search_depth, int32_t nice_length));
