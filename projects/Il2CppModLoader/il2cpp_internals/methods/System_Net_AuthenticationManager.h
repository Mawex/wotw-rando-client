...
IL2CPP_REGISTER_METHOD(0x0200E810, void, EnsureModules, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0200EEC0, ICredentialPolicy *, get_CredentialPolicy, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0200EF60, void, set_CredentialPolicy, (ICredentialPolicy * value));
IL2CPP_REGISTER_METHOD(0x0200F010, Exception *, GetMustImplement, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0200F150, StringDictionary *, get_CustomTargetNameDictionary, (MethodInfo * method));
IL2CPP_REGISTER_METHODINFO(0x0474D6A8, AuthenticationManager_get_CustomTargetNameDictionary__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0200F1F0, IEnumerator *, get_RegisteredModules, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_OSSupportsExtendedProtection, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0200F2B0, void, Clear, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x02010450, void, __cctor, (MethodInfo * method));
}
