...
IL2CPP_REGISTER_METHOD(0x004FAA70, AnimatedCritter *, get_CurrentCritter, (app::AnimatedCritterController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004FBAE0, void, __ctor, (app::AnimatedCritterController * this_ptr));
}
