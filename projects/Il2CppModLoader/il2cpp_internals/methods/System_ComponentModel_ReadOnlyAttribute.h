...
namespace app::methods::System_ComponentModel::ReadOnlyAttribute {
IL2CPP_REGISTER_METHOD(0x0052C650, void, __ctor, (app::ReadOnlyAttribute * this_ptr, bool is_read_only));
