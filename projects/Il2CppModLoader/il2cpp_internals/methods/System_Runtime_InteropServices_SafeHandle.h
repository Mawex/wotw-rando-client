...
namespace app::methods::System_Runtime_InteropServices::SafeHandle {
IL2CPP_REGISTER_METHOD(0x01A96E40, void, __ctor, (app::SafeHandle * this_ptr, app::void * invalid_handle_value, bool owns_handle));
IL2CPP_REGISTER_METHOD(0x01A96F10, void, Finalize, (app::SafeHandle * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, SetHandle, (app::SafeHandle * this_ptr, app::void * handle));
...
IL2CPP_REGISTER_METHOD(0x01A971A0, void, DangerousAddRef, (app::SafeHandle * this_ptr, app::bool * success));
