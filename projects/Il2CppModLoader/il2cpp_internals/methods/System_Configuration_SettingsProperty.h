...
namespace app::methods::System_Configuration::SettingsProperty {
...
IL2CPP_REGISTER_METHOD(0x02962E00, SettingsAttributeDictionary *, get_Attributes, (app::SettingsProperty * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04766BF8, SettingsProperty_get_Attributes__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02962E30, Object *, get_DefaultValue, (app::SettingsProperty * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02962EF0, String *, get_Name, (app::SettingsProperty * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02962F50, Type *, get_PropertyType, (app::SettingsProperty * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02962FB0, SettingsProvider *, get_Provider, (app::SettingsProperty * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02963010, SettingsSerializeAs__Enum, get_SerializeAs, (app::SettingsProperty * this_ptr));
