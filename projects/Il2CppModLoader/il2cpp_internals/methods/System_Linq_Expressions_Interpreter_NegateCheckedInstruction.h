...
namespace app::methods::System_Linq_Expressions_Interpreter::NegateCheckedInstruction {
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::NegateCheckedInstruction * this_ptr));
