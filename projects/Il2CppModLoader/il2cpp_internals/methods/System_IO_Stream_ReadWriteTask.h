...
namespace app::methods::System_IO::Stream_ReadWriteTask {
    IL2CPP_REGISTER_METHOD(0x0237EDF0, void, ClearBeginState, (app::Stream_ReadWriteTask * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0237EE00, void, __ctor, (app::Stream_ReadWriteTask * this_ptr, bool is_read, app::Func_2_Object_Int32_ * function, app::Object * state, app::Stream * stream, app::Byte__Array * buffer, int32_t offset, int32_t count, app::AsyncCallback * callback));
