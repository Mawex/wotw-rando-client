...
namespace app::methods::System_Data::ExpressionNode {
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::ExpressionNode * this_ptr, app::DataTable * table));
IL2CPP_REGISTER_METHOD(0x01F5A650, IFormatProvider *, get_FormatProvider, (app::ExpressionNode * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_IsSqlColumn, (app::ExpressionNode * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA280, DataTable *, get_table, (app::ExpressionNode * this_ptr));
