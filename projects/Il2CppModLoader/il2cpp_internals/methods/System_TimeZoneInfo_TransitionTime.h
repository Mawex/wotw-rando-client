...
IL2CPP_REGISTER_METHOD(0x00107C00, DateTime, get_TimeOfDay, (app::TimeZoneInfo_TransitionTime__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x001155B0, DayOfWeek__Enum, get_DayOfWeek, (app::TimeZoneInfo_TransitionTime__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x027BA6A0, bool, operator___, (app::TimeZoneInfo_TransitionTime t1, app::TimeZoneInfo_TransitionTime t2));
...
IL2CPP_REGISTER_METHOD(0x027BA850, TimeZoneInfo_TransitionTime, CreateFixedDateRule, (app::DateTime time_of_day, int32_t month, int32_t day));
IL2CPP_REGISTER_METHOD(0x027BA8F0, TimeZoneInfo_TransitionTime, CreateFloatingDateRule, (app::DateTime time_of_day, int32_t month, int32_t week, app::DayOfWeek__Enum day_of_week));
IL2CPP_REGISTER_METHOD(0x027BA9A0, TimeZoneInfo_TransitionTime, CreateTransitionTime, (app::DateTime time_of_day, int32_t month, int32_t week, int32_t day, app::DayOfWeek__Enum day_of_week, bool is_fixed_date_rule));
