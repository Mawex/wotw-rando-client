...
namespace app::methods::System_Net_Sockets::TcpListener {
IL2CPP_REGISTER_METHOD(0x020A4480, void, __ctor_1, (app::TcpListener * this_ptr, app::IPEndPoint * local_e_p));
IL2CPP_REGISTER_METHODINFO(0x0474A310, TcpListener__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x020A4680, void, __ctor_2, (app::TcpListener * this_ptr, app::IPAddress * localaddr, int32_t port));
...
IL2CPP_REGISTER_METHOD(0x002FB930, Socket *, get_Server, (app::TcpListener * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020A5160, TcpClient *, AcceptTcpClient, (app::TcpListener * this_ptr));
