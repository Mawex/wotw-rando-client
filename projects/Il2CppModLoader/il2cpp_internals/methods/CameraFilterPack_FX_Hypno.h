...
IL2CPP_REGISTER_METHOD(0x02470D10, Material *, get_material, (app::CameraFilterPack_FX_Hypno * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02471660, void, __ctor, (app::CameraFilterPack_FX_Hypno * this_ptr));
}
