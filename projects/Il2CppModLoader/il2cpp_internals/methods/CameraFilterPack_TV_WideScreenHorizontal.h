...
IL2CPP_REGISTER_METHOD(0x020F2750, Material *, get_material, (app::CameraFilterPack_TV_WideScreenHorizontal * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020F1DD0, void, __ctor, (app::CameraFilterPack_TV_WideScreenHorizontal * this_ptr));
}
