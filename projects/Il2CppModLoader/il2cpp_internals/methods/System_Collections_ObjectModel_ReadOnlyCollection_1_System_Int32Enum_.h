...
namespace app::methods::System_Collections_ObjectModel::ReadOnlyCollection_1_System_Int32Enum_ {
IL2CPP_REGISTER_METHOD(0x02B7DCF0, void, __ctor, (app::ReadOnlyCollection_1_System_Int32Enum_ * this_ptr, app::IList_1_System_Int32Enum_ * list));
IL2CPP_REGISTER_METHOD(0x02B7DD20, int32_t, get_Count, (app::ReadOnlyCollection_1_System_Int32Enum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02EC2580, Int32Enum__Enum, get_Item, (app::ReadOnlyCollection_1_System_Int32Enum_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02B7DF30, IEnumerator_1_System_Int32Enum_ *, GetEnumerator, (app::ReadOnlyCollection_1_System_Int32Enum_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02EC2580, Int32Enum__Enum, System_Collections_Generic_IList_T__get_Item, (app::ReadOnlyCollection_1_System_Int32Enum_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02FDA3A0, IEnumerator *, IEnumerable_GetEnumerator, (app::ReadOnlyCollection_1_System_Int32Enum_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02FDA430, Object *, ICollection_get_SyncRoot, (app::ReadOnlyCollection_1_System_Int32Enum_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02FDA300, Object *, IList_get_Item, (app::ReadOnlyCollection_1_System_Int32Enum_ * this_ptr, int32_t index));
