...
IL2CPP_REGISTER_METHOD(0x0314B480, void, __ctor_1, (app::Version * this_ptr, int32_t major, int32_t minor, int32_t build, int32_t revision));
IL2CPP_REGISTER_METHODINFO(0x0471B840, Version__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0314B660, void, __ctor_2, (app::Version * this_ptr, int32_t major, int32_t minor, int32_t build));
IL2CPP_REGISTER_METHODINFO(0x0473EDE8, Version__ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0314B7F0, void, __ctor_3, (app::Version * this_ptr, int32_t major, int32_t minor));
IL2CPP_REGISTER_METHODINFO(0x0474D4D0, Version__ctor_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0314B920, void, __ctor_4, (app::Version * this_ptr, app::String * version));
IL2CPP_REGISTER_METHOD(0x0314BB00, void, __ctor_5, (app::Version * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0314BB10, Object *, Clone, (app::Version * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0314C0F0, String *, ToString_1, (app::Version * this_ptr));
IL2CPP_REGISTER_METHOD(0x0314C230, String *, ToString_2, (app::Version * this_ptr, int32_t field_count));
...
IL2CPP_REGISTER_METHOD(0x0314C7C0, Version *, Parse, (app::String * input));
...
IL2CPP_REGISTER_METHOD(0x0314D040, bool, TryParseComponent, (app::String * component, app::String * component_name, app::Version_VersionResult * result, app::int32_t * parsed_component));
IL2CPP_REGISTER_METHOD(0x0314D160, bool, operator____1, (app::Version * v1, app::Version * v2));
IL2CPP_REGISTER_METHOD(0x0314D180, bool, operator____2, (app::Version * v1, app::Version * v2));
IL2CPP_REGISTER_METHOD(0x0314D250, bool, operator___1, (app::Version * v1, app::Version * v2));
IL2CPP_REGISTER_METHODINFO(0x04796C98, Version_op_LessThan__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0314D320, bool, operator____3, (app::Version * v1, app::Version * v2));
IL2CPP_REGISTER_METHODINFO(0x04717E00, Version_op_LessThanOrEqual__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0314D3F0, bool, operator___2, (app::Version * v1, app::Version * v2));
IL2CPP_REGISTER_METHOD(0x0314D4A0, bool, operator____4, (app::Version * v1, app::Version * v2));
