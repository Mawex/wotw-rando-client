...
namespace app::methods::Water {
    ...
    IL2CPP_REGISTER_METHOD(0x02D6F2D0, Water_WaterMode__Enum, GetWaterMode, (app::Water * this_ptr));
    IL2CPP_REGISTER_METHOD(0x02D6F2E0, Water_WaterMode__Enum, FindHardwareWaterSupport, (app::Water * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00DBCEE0, float, sgn, (float a));
    IL2CPP_REGISTER_METHOD(0x02D6F580, Vector4, CameraSpacePlane, (app::Water * this_ptr, app::Camera* cam, app::Vector3 pos, app::Vector3 normal, float side_sign));
    ...
    IL2CPP_REGISTER_METHOD(0x02D706A0, void, __ctor, (app::Water * this_ptr));
