...
namespace app::methods::System_Collections_Generic::List_1_FramePerformanceMonitor_PerformanceFrameData_ {
...
IL2CPP_REGISTER_METHOD(0x025ED850, List_1_T_Enumerator_FramePerformanceMonitor_PerformanceFrameData_, GetEnumerator, (app::List_1_FramePerformanceMonitor_PerformanceFrameData_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_FramePerformanceMonitor_PerformanceFrameData_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04792CD8, List_1_FramePerformanceMonitor_PerformanceFrameData___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_FramePerformanceMonitor_PerformanceFrameData_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02DFADF0, void, __ctor_3, (app::List_1_FramePerformanceMonitor_PerformanceFrameData_ * this_ptr, app::IEnumerable_1_FramePerformanceMonitor_PerformanceFrameData_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02DFB280, Object *, ICollection_get_SyncRoot, (app::List_1_FramePerformanceMonitor_PerformanceFrameData_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025EC760, FramePerformanceMonitor_PerformanceFrameData, get_Item, (app::List_1_FramePerformanceMonitor_PerformanceFrameData_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025EC910, Object *, IList_get_Item, (app::List_1_FramePerformanceMonitor_PerformanceFrameData_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_FramePerformanceMonitor_PerformanceFrameData_ *, AsReadOnly, (app::List_1_FramePerformanceMonitor_PerformanceFrameData_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025ED1F0, FramePerformanceMonitor_PerformanceFrameData, Find, (app::List_1_FramePerformanceMonitor_PerformanceFrameData_ * this_ptr, app::Predicate_1_FramePerformanceMonitor_PerformanceFrameData_ * match));
IL2CPP_REGISTER_METHOD(0x025ED330, List_1_FramePerformanceMonitor_PerformanceFrameData_ *, FindAll, (app::List_1_FramePerformanceMonitor_PerformanceFrameData_ * this_ptr, app::Predicate_1_FramePerformanceMonitor_PerformanceFrameData_ * match));
...
IL2CPP_REGISTER_METHOD(0x025ED8A0, IEnumerator_1_FramePerformanceMonitor_PerformanceFrameData_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_FramePerformanceMonitor_PerformanceFrameData_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025ED8A0, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_FramePerformanceMonitor_PerformanceFrameData_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_FramePerformanceMonitor_PerformanceFrameData_ *, GetRange, (app::List_1_FramePerformanceMonitor_PerformanceFrameData_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, FramePerformanceMonitor_PerformanceFrameData__Array *, ToArray, (app::List_1_FramePerformanceMonitor_PerformanceFrameData_ * this_ptr));
