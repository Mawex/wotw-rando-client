...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::Light * this_ptr));
IL2CPP_REGISTER_METHOD(0x0252E760, LightType__Enum, get_type, (app::Light * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0252E8C0, Color, get_color, (app::Light * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0252EF20, Flare *, get_flare, (app::Light * this_ptr));
IL2CPP_REGISTER_METHOD(0x0252EF70, void, set_flare, (app::Light * this_ptr, app::Flare * value));
IL2CPP_REGISTER_METHOD(0x0252EFD0, LightBakingOutput, get_bakingOutput, (app::Light * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0252F170, LightShadowCasterMode__Enum, get_lightShadowCasterMode, (app::Light * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0252F270, LightShadows__Enum, get_shadows, (app::Light * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0252F3D0, LightShadowResolution__Enum, get_shadowResolution, (app::Light * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0252F4A0, Single__Array *, get_layerShadowCullDistances, (app::Light * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0252F600, Texture *, get_cookie, (app::Light * this_ptr));
IL2CPP_REGISTER_METHOD(0x0252F650, void, set_cookie, (app::Light * this_ptr, app::Texture * value));
IL2CPP_REGISTER_METHOD(0x0252F6B0, LightRenderMode__Enum, get_renderMode, (app::Light * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0252FB90, CommandBuffer__Array *, GetCommandBuffers, (app::Light * this_ptr, app::LightEvent__Enum evt));
...
IL2CPP_REGISTER_METHOD(0x0252FCE0, Light__Array *, GetLights, (app::LightType__Enum type, int32_t layer));
