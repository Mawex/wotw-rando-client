...
namespace app::methods::BuilderIdle {
    IL2CPP_REGISTER_METHOD(0x00816A70, BuilderEntity*, get_m_builder, (app::BuilderIdle * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00420EE0, BehaviourStatus__Enum, OnExecuteTask, (app::BuilderIdle * this_ptr, app::IContext* context));
    ...
    IL2CPP_REGISTER_METHOD(0x005B3EC0, void, __ctor, (app::BuilderIdle * this_ptr));
} // namespace app::methods::BuilderIdle
