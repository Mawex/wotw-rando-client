...
IL2CPP_REGISTER_METHOD(0x0132EE60, Bounds, get_Bounds, (app::MixerSnapshotZone * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::MixerSnapshotZone * this_ptr));
}
