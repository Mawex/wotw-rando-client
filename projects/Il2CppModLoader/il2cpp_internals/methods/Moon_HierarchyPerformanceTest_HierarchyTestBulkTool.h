...
IL2CPP_REGISTER_METHOD(0x014A0850, HierarchyTestBulkTool *, get_Instance, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x014A08F0, bool, get_IsStopped, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x014A0990, void, set_IsStopped, (bool value));
IL2CPP_REGISTER_METHOD(0x014A0A40, bool, get_IsRunning, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x014A1180, void, Stop, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x014A1220, HierarchyTestBulkTool *, CreateInstance, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x014A3310, void, __cctor, (MethodInfo * method));
