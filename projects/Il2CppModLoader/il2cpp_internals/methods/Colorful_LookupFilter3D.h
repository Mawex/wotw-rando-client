...
IL2CPP_REGISTER_METHOD(0x03049F70, Shader *, get_Shader2DSafe, (app::LookupFilter3D * this_ptr));
IL2CPP_REGISTER_METHOD(0x0304A070, Shader *, get_Shader3DSafe, (app::LookupFilter3D * this_ptr));
IL2CPP_REGISTER_METHOD(0x0304A170, Material *, get_Material, (app::LookupFilter3D * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0136E200, void, __ctor, (app::LookupFilter3D * this_ptr));
}
