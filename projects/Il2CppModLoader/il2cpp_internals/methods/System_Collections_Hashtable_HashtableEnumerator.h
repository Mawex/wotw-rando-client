...
namespace app::methods::System_Collections::Hashtable_HashtableEnumerator {
IL2CPP_REGISTER_METHOD(0x020270A0, void, __ctor, (app::Hashtable_HashtableEnumerator * this_ptr, app::Hashtable * hashtable, int32_t get_obj_ret_type));
IL2CPP_REGISTER_METHOD(0x0173F610, Object *, Clone, (app::Hashtable_HashtableEnumerator * this_ptr));
IL2CPP_REGISTER_METHOD(0x020270E0, Object *, get_Key, (app::Hashtable_HashtableEnumerator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02027370, DictionaryEntry, get_Entry, (app::Hashtable_HashtableEnumerator * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0470D098, Hashtable_HashtableEnumerator_get_Entry__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02027450, Object *, get_Current, (app::Hashtable_HashtableEnumerator * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04751290, Hashtable_HashtableEnumerator_get_Current__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02027570, Object *, get_Value, (app::Hashtable_HashtableEnumerator * this_ptr));
