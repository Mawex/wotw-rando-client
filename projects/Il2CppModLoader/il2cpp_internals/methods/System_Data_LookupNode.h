...
namespace app::methods::System_Data::LookupNode {
IL2CPP_REGISTER_METHOD(0x01E40A50, void, __ctor, (app::LookupNode * this_ptr, app::DataTable * table, app::String * column_name, app::String * relation_name));
...
IL2CPP_REGISTER_METHOD(0x01E40D10, Object *, Eval_1, (app::LookupNode * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047789E8, LookupNode_Eval__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E40D50, Object *, Eval_2, (app::LookupNode * this_ptr, app::DataRow * row, app::DataRowVersion__Enum version));
IL2CPP_REGISTER_METHODINFO(0x04721408, LookupNode_Eval_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E40EB0, Object *, Eval_3, (app::LookupNode * this_ptr, app::Int32__Array * record_nos));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, ExpressionNode *, Optimize, (app::LookupNode * this_ptr));
}
