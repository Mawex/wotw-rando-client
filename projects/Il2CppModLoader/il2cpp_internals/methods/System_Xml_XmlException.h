...
IL2CPP_REGISTER_METHOD(0x01DB8E70, String *, FormatUserMessage, (app::String * message, int32_t line_number, int32_t line_position));
IL2CPP_REGISTER_METHOD(0x01DB8FB0, String *, CreateMessage, (app::String * res, app::String__Array * args, int32_t line_number, int32_t line_position));
IL2CPP_REGISTER_METHOD(0x01DB9220, String__Array *, BuildCharExceptionArgs_1, (app::String * data, int32_t inv_char_index));
IL2CPP_REGISTER_METHOD(0x01DB9280, String__Array *, BuildCharExceptionArgs_2, (app::Char__Array * data, int32_t length, int32_t inv_char_index));
IL2CPP_REGISTER_METHOD(0x01DB9300, String__Array *, BuildCharExceptionArgs_3, (uint16_t inv_char, uint16_t next_char));
...
IL2CPP_REGISTER_METHOD(0x01DB9740, String *, get_Message, (app::XmlException * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC20, String *, get_ResString, (app::XmlException * this_ptr));
}
