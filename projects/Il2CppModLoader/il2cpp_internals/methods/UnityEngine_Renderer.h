...
IL2CPP_REGISTER_METHOD(0x02972900, Bounds, get_bounds, (app::Renderer * this_ptr));
IL2CPP_REGISTER_METHOD(0x02972990, Material *, GetMaterial, (app::Renderer * this_ptr));
IL2CPP_REGISTER_METHOD(0x029729E0, Material *, GetSharedMaterial, (app::Renderer * this_ptr));
IL2CPP_REGISTER_METHOD(0x02972A30, void, SetMaterial, (app::Renderer * this_ptr, app::Material * m));
IL2CPP_REGISTER_METHOD(0x02972A90, Material__Array *, GetMaterialArray, (app::Renderer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02972C10, Bounds, get_customBounds, (app::Renderer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02973440, Vector4, GetLightmapST, (app::Renderer * this_ptr, app::LightmapType__Enum lt));
IL2CPP_REGISTER_METHOD(0x029734D0, Vector4, get_lightmapScaleOffset, (app::Renderer * this_ptr));
IL2CPP_REGISTER_METHOD(0x02973550, Material__Array *, GetSharedMaterialArray, (app::Renderer * this_ptr));
IL2CPP_REGISTER_METHOD(0x02972A90, Material__Array *, get_materials, (app::Renderer * this_ptr));
IL2CPP_REGISTER_METHOD(0x029735A0, Material *, get_cachedMaterial, (app::Renderer * this_ptr));
IL2CPP_REGISTER_METHOD(0x02972990, Material *, get_material, (app::Renderer * this_ptr));
IL2CPP_REGISTER_METHOD(0x02972A30, void, set_material, (app::Renderer * this_ptr, app::Material * value));
IL2CPP_REGISTER_METHOD(0x029729E0, Material *, get_sharedMaterial, (app::Renderer * this_ptr));
IL2CPP_REGISTER_METHOD(0x02972A30, void, set_sharedMaterial, (app::Renderer * this_ptr, app::Material * value));
IL2CPP_REGISTER_METHOD(0x02973550, Material__Array *, get_sharedMaterials, (app::Renderer * this_ptr));
