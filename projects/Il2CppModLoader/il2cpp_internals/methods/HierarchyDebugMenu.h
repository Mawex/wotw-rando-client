...
IL2CPP_REGISTER_METHOD(0x002FB990, List_1_List_1_IDebugMenuItem_ *, get_Items, (app::HierarchyDebugMenu * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBA0, String *, get_Path, (app::HierarchyDebugMenu * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBB0, void, set_Path, (app::HierarchyDebugMenu * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBBC0, String *, get_Text, (app::HierarchyDebugMenu * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBD0, void, set_Text, (app::HierarchyDebugMenu * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBBE0, String *, get_HelpText, (app::HierarchyDebugMenu * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B4C5C0, GameObject *, get_UberPoolsGroup, (app::HierarchyDebugMenu * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B4C720, GameObject *, get_SceneRootsGroup, (app::HierarchyDebugMenu * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B4FCD0, IEnumerator *, WaitForStepEnd, (app::HierarchyDebugMenu * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B4FE20, HierarchyDebugMenu_GameObjectItem *, FindAndPingGameObject, (app::HierarchyDebugMenu * this_ptr, int32_t instance_i_d));
IL2CPP_REGISTER_METHOD(0x00B4FF60, HierarchyDebugMenu_GameObjectItem *, CheckGameObjectItem, (app::HierarchyDebugMenu * this_ptr, app::HierarchyDebugMenu_GameObjectItem * item, int32_t instance_i_d));
IL2CPP_REGISTER_METHOD(0x002FBD20, Func_1_String_ *, get_DynamicText, (app::HierarchyDebugMenu * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD30, void, set_DynamicText, (app::HierarchyDebugMenu * this_ptr, app::Func_1_String_ * value));
IL2CPP_REGISTER_METHOD(0x00B500E0, void, OnItemGUI, (app::HierarchyDebugMenu * this_ptr, app::HierarchyDebugMenu_GameObjectItem * item, app::int32_t * index, int32_t depth));
...
IL2CPP_REGISTER_METHOD(0x00B51D90, void, __ctor, (app::HierarchyDebugMenu * this_ptr));
}
