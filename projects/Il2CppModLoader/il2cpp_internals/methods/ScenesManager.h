...
namespace app::methods::ScenesManager {
    ...
    IL2CPP_REGISTER_METHOD(0x00BC4720, SceneRoot*, FindLoadedSceneRootFromPosition, (app::ScenesManager * this_ptr, app::Vector3 position));
    IL2CPP_REGISTER_METHOD(0x00BC4AF0, SceneManagerScene*, GetFromCurrentScenes_1, (app::ScenesManager * this_ptr, app::RuntimeSceneMetaData* scene_meta_data));
    IL2CPP_REGISTER_METHOD(0x00BC4C10, SceneManagerScene*, GetFromCurrentScenes_2, (app::ScenesManager * this_ptr, app::MoonGuid* guid));
    IL2CPP_REGISTER_METHOD(0x00BC4DA0, RuntimeSceneMetaData*, FindRuntimeSceneMetaData_1, (app::ScenesManager * this_ptr, app::MoonGuid* scene_guid));
    IL2CPP_REGISTER_METHOD(0x00BC4EA0, RuntimeSceneMetaData*, FindRuntimeSceneMetaData_2, (app::ScenesManager * this_ptr, app::Scene scene));
    IL2CPP_REGISTER_METHOD(0x00BC5000, List_1_RuntimeSceneMetaData_*, ListAllScenesAtPosition, (app::ScenesManager * this_ptr, app::Vector3 position));
    ...
    IL2CPP_REGISTER_METHOD(0x00420EE0, SceneMetaData*, GetSceneMetaDataFromRuntimeMetaData, (app::ScenesManager * this_ptr, app::RuntimeSceneMetaData* runtime_meta));
    IL2CPP_REGISTER_METHOD(0x00BC5840, SceneRoot*, GetRoot, (app::Transform * transform));
    IL2CPP_REGISTER_METHOD(0x00BC58E0, RuntimeSceneMetaData*, GetSceneInformation, (app::ScenesManager * this_ptr, app::String* scene_name));
    IL2CPP_REGISTER_METHOD(0x00BC5A20, SceneManagerScene*, GetSceneManagerScene, (app::ScenesManager * this_ptr, app::String* scene_name));
    ...
    IL2CPP_REGISTER_METHOD(0x00BC5F90, IScenesManagerBehaviour*, get_CurrentBehaviour, (app::ScenesManager * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00608710, ScenesManager_SceneManagementMode__Enum, get_Mode, (app::ScenesManager * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00660430, HashSet_1_System_UInt32_*, get_SceneEnableSoundBankFilter, (app::ScenesManager * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00BC6900, RuntimeSceneMetaData*, GetSceneMetaDataByHash, (app::ScenesManager * this_ptr, int32_t hash));
    IL2CPP_REGISTER_METHOD(0x00BC69A0, RuntimeSceneMetaData*, GetSceneFromLinearArray, (app::ScenesManager * this_ptr, int32_t linear_idx));
    IL2CPP_REGISTER_METHOD(0x00BC69E0, bool, get_InstantLoadScenes, (app::ScenesManager * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00BC6AC0, Vector2, get_CurrentCameraTargetPosition, (app::ScenesManager * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00BC6AE0, void, set_CurrentCameraTargetPosition, (app::ScenesManager * this_ptr, app::Vector2 value));
    IL2CPP_REGISTER_METHOD(0x00BC6B10, Vector2, get_PredictedCameraTargetPosition, (app::ScenesManager * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00B2A180, SceneLoadingQueue*, get_Queue, (app::ScenesManager * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00BC6BB0, RuntimeSceneMetaData*, get_CurrentScene, (app::ScenesManager * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00BC6E90, RuntimeSceneMetaData*, get_LastCachedCurrentScene, (app::ScenesManager * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00BC6EA0, SceneManagerScene*, get_CurrentSceneManagerScene, (app::ScenesManager * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00BCAE60, SceneRoot*, RegisterSceneByName, (app::ScenesManager * this_ptr, app::String* scene_name, bool async, bool report_failure));
    ...
    IL2CPP_REGISTER_METHOD(0x00BCF6D0, SceneState__Enum, GetWorstBlockingSceneState, (app::ScenesManager * this_ptr, app::bool* any_queued_scenes));
    ...
    IL2CPP_REGISTER_METHOD(0x00BD0A60, Rect, GetClampedRect_1, (app::ScenesManager * this_ptr, app::Vector3 position));
    IL2CPP_REGISTER_METHOD(0x00BD0C80, Rect, GetClampedRect_2, (app::ScenesManager * this_ptr, app::Vector3 position, app::List_1_System_Int32_* scenes_list));
    ...
    IL2CPP_REGISTER_METHOD(0x00BD2510, IEnumerator*, WaitForSceneToLoadAndSendTelemetryEvent, (app::ScenesManager * this_ptr, app::AsyncOperation_1* load_operation, app::RuntimeSceneMetaData* scene_meta_data));
    IL2CPP_REGISTER_METHOD(0x00BD2680, IEnumerator*, HandleSceneLoadedEvent, (app::ScenesManager * this_ptr, app::RuntimeSceneMetaData* scene_meta_data));
    ...
    IL2CPP_REGISTER_METHOD(0x00BD2C50, List_1_MoonGuid_*, GetConnectedScenesCached, (app::ScenesManager * this_ptr, app::RuntimeSceneMetaData* meta_data));
    ...
    IL2CPP_REGISTER_METHOD(0x00BD4BD0, AsyncOperation_1*, AdditivelyLoadSceneFileEditor, (app::ScenesManager * this_ptr, app::RuntimeSceneMetaData* runtime_scene_meta_data, bool async));
    ...
    IL2CPP_REGISTER_METHOD(0x00BD5EE0, void, GetShowingAndHiddenSceneCount, (app::ScenesManager * this_ptr, app::MoonGuid* guid, app::int32_t* showing_count, app::int32_t* hidden_count));
    ...
    IL2CPP_REGISTER_METHOD(0x00BD6D90, IEnumerator*, ShowFellOutOfWorldMessage, (app::ScenesManager * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00BD8550, ScenesManager_LoadingCameraState__Enum, get_CameraState, (app::ScenesManager * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00BD8AF0, void, __ctor, (app::ScenesManager * this_ptr));
