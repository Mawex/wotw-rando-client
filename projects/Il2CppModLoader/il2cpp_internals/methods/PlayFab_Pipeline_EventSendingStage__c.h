...
namespace app::methods::PlayFab_Pipeline::EventSendingStage___c {
    IL2CPP_REGISTER_METHOD(0x017B0BC0, void, __cctor, ());
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::EventSendingStage_c * this_ptr));
