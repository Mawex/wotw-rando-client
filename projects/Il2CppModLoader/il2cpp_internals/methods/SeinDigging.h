...
namespace app::methods::SeinDigging {
    ...
    IL2CPP_REGISTER_METHOD(0x007007F0, SeinDigging_State__Enum, get_CurrentState, (app::SeinDigging * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x007008C0, SeinDigging_DiggingEffects*, get_CurrentVFX, (app::SeinDigging * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00700910, Vector3, get_TrailAnchorPosition, (app::SeinDigging * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x007009E0, SeinSwimming*, get_SwimAbility, (app::SeinDigging * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0070B580, DigZone*, GetDigZoneAtPoint, (app::SeinDigging * this_ptr, app::Vector3 position));
    IL2CPP_REGISTER_METHOD(0x0070B740, bool, IsInWaterZone, (app::SeinDigging * this_ptr, app::Vector3 position));
    IL2CPP_REGISTER_METHOD(0x0070B910, DigZone*, GetDigZoneIntersectingCircle, (app::SeinDigging * this_ptr, app::Vector3 center, float radius));
    ...
    IL2CPP_REGISTER_METHOD(0x0070BB00, LayerMask, GetDashDamageLayerMask, (app::SeinDigging * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0070C5C0, SeinDiggingPuppet*, get_Puppet, (app::SeinDigging * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0070C9F0, StressTestStatus__Enum, get_StressTestStatus, (app::SeinDigging * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0070CB20, String*, get_StressTestName, (app::SeinDigging * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0070CBA0, void, __ctor, (app::SeinDigging * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0070CE40, EffectSpawn, _UpdateDiggingState_b__182_0, (app::SeinDigging * this_ptr, app::DamageResult result));
