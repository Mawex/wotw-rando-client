...
namespace app::methods::Moon_Telemetry_Performance_profilers::GPUAutoProfiler_LightSpeedMeasurementHandler {
    IL2CPP_REGISTER_METHOD(0x00E449E0, void, __ctor, (app::GPUAutoProfiler_LightSpeedMeasurementHandler * this_ptr, app::List_1_Moon_Telemetry_Performance_profilers_GPUAutoProfiler_Sample_ * samples));
