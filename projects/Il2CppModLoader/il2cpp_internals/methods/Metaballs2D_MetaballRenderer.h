...
IL2CPP_REGISTER_METHOD(0x01056D80, Vector2, get_CellSize, (app::MetaballRenderer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x015A36F0, Vector3, SmoothFunction, (app::MetaballRenderer * this_ptr, app::Vector3 p, float s_a, float s_b, float s_c, float s_d));
...
IL2CPP_REGISTER_METHOD(0x015A3E20, void, __ctor, (app::MetaballRenderer * this_ptr));
}
