...
namespace app::methods::System_Collections_Generic::List_1_CameraSettings_ {
...
IL2CPP_REGISTER_METHOD(0x025EFC50, CameraSettings *, get_Item, (app::List_1_CameraSettings_ * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x047131F8, List_1_CameraSettings__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_CameraSettings_ * this_ptr));
