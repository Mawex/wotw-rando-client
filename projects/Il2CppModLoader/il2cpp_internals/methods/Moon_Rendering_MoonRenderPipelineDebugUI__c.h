...
namespace app::methods::Moon_Rendering::MoonRenderPipelineDebugUI___c {
    IL2CPP_REGISTER_METHOD(0x007A2B90, void, __cctor, ());
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MoonRenderPipelineDebugUI_c * this_ptr));
