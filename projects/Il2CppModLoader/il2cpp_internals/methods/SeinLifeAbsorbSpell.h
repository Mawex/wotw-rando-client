...
IL2CPP_REGISTER_METHOD(0x00890620, SeinLifeAbsorbArm *, ClosestFreeArm, (app::SeinLifeAbsorbSpell * this_ptr, app::Vector3 position));
...
IL2CPP_REGISTER_METHOD(0x008918A0, void, __ctor, (app::SeinLifeAbsorbSpell * this_ptr));
}
