...
namespace app::methods::UnityEngine_UI::GraphicRaycaster {
IL2CPP_REGISTER_METHOD(0x024B1F60, void, __ctor, (app::GraphicRaycaster * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F30530, GraphicRaycaster_BlockingObjects__Enum, get_blockingObjects, (app::GraphicRaycaster * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024B22E0, Canvas *, get_canvas, (app::GraphicRaycaster * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024B35C0, Camera *, get_eventCamera, (app::GraphicRaycaster * this_ptr));
