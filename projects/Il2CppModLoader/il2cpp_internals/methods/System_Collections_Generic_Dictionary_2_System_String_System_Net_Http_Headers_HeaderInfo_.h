...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_String_System_Net_Http_Headers_HeaderInfo_ {
IL2CPP_REGISTER_METHOD(0x0283AC50, void, __ctor, (app::Dictionary_2_System_String_System_Net_Http_Headers_HeaderInfo_ * this_ptr, app::IEqualityComparer_1_System_String_ * comparer));
