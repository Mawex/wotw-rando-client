...
IL2CPP_REGISTER_METHOD(0x00CB56A0, Vector3, get_Size, (app::AxisAlignedBox * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CB57A0, Vector3, get_Center, (app::AxisAlignedBox * this_ptr));
