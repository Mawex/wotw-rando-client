...
namespace app::methods::System_Collections_ObjectModel::ReadOnlyCollection_1_AmbienceZone_WiseAuxSend_ {
IL2CPP_REGISTER_METHOD(0x02B7DCF0, void, __ctor, (app::ReadOnlyCollection_1_AmbienceZone_WiseAuxSend_ * this_ptr, app::IList_1_AmbienceZone_WiseAuxSend_ * list));
IL2CPP_REGISTER_METHOD(0x02B7DD20, int32_t, get_Count, (app::ReadOnlyCollection_1_AmbienceZone_WiseAuxSend_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02B815D0, AmbienceZone_WiseAuxSend, get_Item, (app::ReadOnlyCollection_1_AmbienceZone_WiseAuxSend_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02B7DF30, IEnumerator_1_AmbienceZone_WiseAuxSend_ *, GetEnumerator, (app::ReadOnlyCollection_1_AmbienceZone_WiseAuxSend_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B815D0, AmbienceZone_WiseAuxSend, System_Collections_Generic_IList_T__get_Item, (app::ReadOnlyCollection_1_AmbienceZone_WiseAuxSend_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02CFCAC0, IEnumerator *, IEnumerable_GetEnumerator, (app::ReadOnlyCollection_1_AmbienceZone_WiseAuxSend_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CFCB50, Object *, ICollection_get_SyncRoot, (app::ReadOnlyCollection_1_AmbienceZone_WiseAuxSend_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B81E90, Object *, IList_get_Item, (app::ReadOnlyCollection_1_AmbienceZone_WiseAuxSend_ * this_ptr, int32_t index));
