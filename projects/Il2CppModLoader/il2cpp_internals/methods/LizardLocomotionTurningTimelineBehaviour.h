...
IL2CPP_REGISTER_METHOD(0x00FB17C0, Transform *, get_VFXHolder, (app::LizardLocomotionTurningTimelineBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FB1E40, BehaviourStatus__Enum, OnExecuteTask, (app::LizardLocomotionTurningTimelineBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00FB1F30, Vector3, RootMotionModifier, (app::LizardLocomotionTurningTimelineBehaviour * this_ptr, app::Vector3 motion));
...
IL2CPP_REGISTER_METHOD(0x00FB2310, void, __ctor, (app::LizardLocomotionTurningTimelineBehaviour * this_ptr));
}
