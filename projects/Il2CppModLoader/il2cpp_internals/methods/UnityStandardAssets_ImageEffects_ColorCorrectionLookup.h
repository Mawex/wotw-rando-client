...
namespace app::methods::UnityStandardAssets_ImageEffects::ColorCorrectionLookup {
...
IL2CPP_REGISTER_METHOD(0x0251D8C0, void, __ctor, (app::ColorCorrectionLookup * this_ptr));
}
