...
namespace app::methods::System_Collections_Generic::HashSet_1_UnityEngine_Vector3_ {
IL2CPP_REGISTER_METHOD(0x02AB4370, void, __ctor_1, (app::HashSet_1_UnityEngine_Vector3_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AB43D0, void, __ctor_2, (app::HashSet_1_UnityEngine_Vector3_ * this_ptr, app::IEqualityComparer_1_UnityEngine_Vector3_ * comparer));
IL2CPP_REGISTER_METHOD(0x02AB4420, void, __ctor_3, (app::HashSet_1_UnityEngine_Vector3_ * this_ptr, app::IEnumerable_1_UnityEngine_Vector3_ * collection));
IL2CPP_REGISTER_METHOD(0x030167A0, void, __ctor_4, (app::HashSet_1_UnityEngine_Vector3_ * this_ptr, app::IEnumerable_1_UnityEngine_Vector3_ * collection, app::IEqualityComparer_1_UnityEngine_Vector3_ * comparer));
IL2CPP_REGISTER_METHODINFO(0x0478BEA8, HashSet_1_UnityEngine_Vector3___ctor_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02AB46E0, void, __ctor_5, (app::HashSet_1_UnityEngine_Vector3_ * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
...
IL2CPP_REGISTER_METHOD(0x030172C0, HashSet_1_T_Enumerator_UnityEngine_Vector3_, GetEnumerator, (app::HashSet_1_UnityEngine_Vector3_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x03017300, IEnumerator_1_UnityEngine_Vector3_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::HashSet_1_UnityEngine_Vector3_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x03017300, IEnumerator *, IEnumerable_GetEnumerator, (app::HashSet_1_UnityEngine_Vector3_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB990, IEqualityComparer_1_UnityEngine_Vector3_ *, get_Comparer, (app::HashSet_1_UnityEngine_Vector3_ * this_ptr));
