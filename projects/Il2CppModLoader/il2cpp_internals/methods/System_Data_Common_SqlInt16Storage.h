...
namespace app::methods::System_Data_Common::SqlInt16Storage {
IL2CPP_REGISTER_METHOD(0x02856BC0, void, __ctor, (app::SqlInt16Storage * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x02856D40, Object *, Aggregate, (app::SqlInt16Storage * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x02857C00, Object *, ConvertValue, (app::SqlInt16Storage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02857CC0, void, Copy, (app::SqlInt16Storage * this_ptr, int32_t record_no1, int32_t record_no2));
IL2CPP_REGISTER_METHOD(0x02857D30, Object *, Get, (app::SqlInt16Storage * this_ptr, int32_t record));
...
IL2CPP_REGISTER_METHOD(0x02857F80, Object *, ConvertXmlToObject, (app::SqlInt16Storage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x028582D0, String *, ConvertObjectToXml, (app::SqlInt16Storage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02858630, Object *, GetEmptyStorage, (app::SqlInt16Storage * this_ptr, int32_t record_count));
