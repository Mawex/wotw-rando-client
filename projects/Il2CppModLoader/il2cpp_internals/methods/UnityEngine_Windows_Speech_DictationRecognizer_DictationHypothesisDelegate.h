...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::DictationRecognizer_DictationHypothesisDelegate * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x00674080, IAsyncResult *, BeginInvoke, (app::DictationRecognizer_DictationHypothesisDelegate * this_ptr, app::String * text, app::AsyncCallback * callback, app::Object * object));
