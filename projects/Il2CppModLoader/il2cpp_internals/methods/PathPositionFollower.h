...
IL2CPP_REGISTER_METHOD(0x003FF3C0, SuspendableMask__Enum, get_Mask, (app::PathPositionFollower * this_ptr));
IL2CPP_REGISTER_METHOD(0x00449010, void, set_Mask, (app::PathPositionFollower * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x004490C0, Bounds, get_Bounds, (app::PathPositionFollower * this_ptr));
IL2CPP_REGISTER_METHOD(0x004490E0, void, OnDrawGizmosSelected, (app::PathPositionFollower * this_ptr));
IL2CPP_REGISTER_METHOD(0x00449350, void, __ctor, (app::PathPositionFollower * this_ptr));
}
