...
namespace app::methods::System_Collections_Generic::List_1_Moon_UberStateValueGroup_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_Moon_UberStateValueGroup_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EFC50, UberStateValueGroup *, get_Item, (app::List_1_Moon_UberStateValueGroup_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_Moon_UberStateValueGroup_, GetEnumerator, (app::List_1_Moon_UberStateValueGroup_ * this_ptr));
