...
namespace app::methods::Moon::MoonByte {
    ...
    IL2CPP_REGISTER_METHOD(0x02F90830, CrossSceneReferenceId, get_CrossSceneReferenceId, (app::MoonByte * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x02F8F210, void, __ctor, (app::MoonByte * this_ptr, uint8_t static_value));
    ...
    IL2CPP_REGISTER_METHOD(0x02F91080, bool, TryResolve, (app::MoonByte * this_ptr, app::uint8_t* value, app::IMoonResolverContext* context));
    ...
    IL2CPP_REGISTER_METHOD(0x00C3DD30, MoonTypeData, GetTypeData, (app::MoonByte * this_ptr));
} // namespace app::methods::Moon::MoonByte
