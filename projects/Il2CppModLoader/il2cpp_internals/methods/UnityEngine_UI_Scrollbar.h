...
namespace app::methods::UnityEngine_UI::Scrollbar {
IL2CPP_REGISTER_METHOD(0x0266F180, void, __ctor, (app::Scrollbar * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F2BCB0, RectTransform *, get_handleRect, (app::Scrollbar * this_ptr));
IL2CPP_REGISTER_METHOD(0x0266F3B0, void, set_handleRect, (app::Scrollbar * this_ptr, app::RectTransform * value));
IL2CPP_REGISTER_METHOD(0x0266F480, Scrollbar_Direction__Enum, get_direction, (app::Scrollbar * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F36B60, Scrollbar_ScrollEvent *, get_onValueChanged, (app::Scrollbar * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0266FC50, Scrollbar_Axis__Enum, get_axis, (app::Scrollbar * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02670830, IEnumerator *, ClickRepeat, (app::Scrollbar * this_ptr, app::PointerEventData * event_data));
...
IL2CPP_REGISTER_METHOD(0x02670D80, Selectable *, FindSelectableOnLeft, (app::Scrollbar * this_ptr));
IL2CPP_REGISTER_METHOD(0x02670DB0, Selectable *, FindSelectableOnRight, (app::Scrollbar * this_ptr));
IL2CPP_REGISTER_METHOD(0x02670DE0, Selectable *, FindSelectableOnUp, (app::Scrollbar * this_ptr));
IL2CPP_REGISTER_METHOD(0x02670E10, Selectable *, FindSelectableOnDown, (app::Scrollbar * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, ICanvasElement_get_transform, (app::Scrollbar * this_ptr));
}
