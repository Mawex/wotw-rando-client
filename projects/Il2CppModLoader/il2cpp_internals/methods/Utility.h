...
namespace app::methods::Utility {
    ...
    IL2CPP_REGISTER_METHOD(0x013B2300, IEnumerator*, DisableLater, (app::MonoBehaviour * target));
    IL2CPP_REGISTER_METHOD(0x013B2450, String*, LowercaseFirstLetter, (app::String * s));
    IL2CPP_REGISTER_METHOD(0x013B25D0, Rect, RectFromBounds, (app::Bounds bounds));
    IL2CPP_REGISTER_METHOD(0x013B2690, bool, LineInBox, (app::Rect rect, app::Vector3 origin, app::Vector3 delta));
    IL2CPP_REGISTER_METHOD(0x013B26E0, Bounds, BoundsFromPoints_1, (app::Vector3 p1, app::Vector3 p2));
    IL2CPP_REGISTER_METHOD(0x013B28B0, Bounds, BoundsFromPoints_2, (app::Vector3 p1, app::Vector3 p2, app::Vector3 p3));
    IL2CPP_REGISTER_METHOD(0x013B2A90, Bounds, BoundsFromPoints_3, (app::Vector3 p1, app::Vector3 p2, app::Vector3 p3, app::Vector3 p4));
    IL2CPP_REGISTER_METHOD(0x013B2C90, Bounds, BoundsFromTransform, (app::Transform * transform));
    IL2CPP_REGISTER_METHOD(0x013B31B0, float, ColorDiff, (app::Color a, app::Color b));
    IL2CPP_REGISTER_METHOD(0x013B32D0, Rect, CombineRects_1, (app::Rect a, app::Rect b));
    IL2CPP_REGISTER_METHOD(0x013B33F0, Rect, CombineRects_2, (app::Rect__Array * rects));
    IL2CPP_REGISTER_METHOD(0x013B3540, Rect, CombineRects_3, (app::List_1_UnityEngine_Rect_ * rects));
    ...
    IL2CPP_REGISTER_METHOD(0x013B3DE0, Vector3, Rotate, (app::Vector3 v, float angle));
    IL2CPP_REGISTER_METHOD(0x013B3EF0, Vector3, Unrotate, (app::Vector3 v, float angle));
    IL2CPP_REGISTER_METHOD(0x013B4010, String*, PathGoBack, (app::String * path));
    IL2CPP_REGISTER_METHOD(0x013B4170, Vector3, DirectionToVector, (app::Utility_MoveDirection__Enum direction));
    ...
    IL2CPP_REGISTER_METHOD(0x013B4360, Bounds, LocalHierarchyBoundingBox, (app::GameObject * game_object));
    IL2CPP_REGISTER_METHOD(0x013B4EA0, Bounds, BoundsOfBounds, (app::Matrix4x4 matrix, app::Bounds bounds));
    IL2CPP_REGISTER_METHOD(0x013B5690, Vector3, LerpVector3, (app::Vector3 start, app::Vector3 end, app::Vector3 r));
    IL2CPP_REGISTER_METHOD(0x013B5820, Bounds, EncapsulateChildren, (app::Transform * trans, app::Bounds* current, app::bool* has_bounds, bool use_transform_scale, bool use_colliders));
    IL2CPP_REGISTER_METHOD(0x013B5E80, void, ResetLocalScale, (app::Transform * transform));
    IL2CPP_REGISTER_METHOD(0x013B66C0, Bounds, WorldSpaceHierarchyBoundingBox, (app::GameObject * game_object, bool use_transform_scale, bool use_colliders));
    IL2CPP_REGISTER_METHOD(0x013B6830, float, Round_1, (float value, float grid));
    IL2CPP_REGISTER_METHOD(0x013B6990, Rect, Round_2, (app::Rect rect, float grid));
    IL2CPP_REGISTER_METHOD(0x013B6B10, Vector3, Round_3, (app::Vector3 vector, float grid));
    IL2CPP_REGISTER_METHOD(0x013B6C40, Vector3, Round_4, (app::Vector3 vector));
    IL2CPP_REGISTER_METHOD(0x013B6DF0, Rect, Round_5, (app::Rect rect));
    ...
    IL2CPP_REGISTER_METHOD(0x013B7310, String*, GetObjectHierarchy_1, (app::Component_1 * cmp, bool include_scene));
    IL2CPP_REGISTER_METHOD(0x013B7420, String*, GetObjectHierarchy_2, (app::GameObject * go, bool include_scene));
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::Utility * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __cctor, ());
    IL2CPP_REGISTER_METHOD(0x0157DBD0, Object*, GetComponentUpwards, (app::Transform * transform));
