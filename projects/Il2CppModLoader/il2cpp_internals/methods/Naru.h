...
namespace app::methods::Naru {
    ...
    IL2CPP_REGISTER_METHOD(0x008833C0, CharacterCapsuleController*, get_CapsuleController, (app::Naru * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB60, DamageOwner*, get_DamageOwner, (app::Naru * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB70, void, set_DamageOwner, (app::Naru * this_ptr, app::DamageOwner* value));
    IL2CPP_REGISTER_METHOD(0x008833E0, Vector3, get_Position, (app::Naru * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00883440, void, set_Position, (app::Naru * this_ptr, app::Vector3 value));
    IL2CPP_REGISTER_METHOD(0x00883490, Vector3, get_MapDisplayPosition, (app::Naru * this_ptr));
    IL2CPP_REGISTER_METHOD(0x008835B0, Vector3, get_DeltaPosition, (app::Naru * this_ptr));
    IL2CPP_REGISTER_METHOD(0x008612A0, void, Activate, (app::Naru * this_ptr, bool active));
    IL2CPP_REGISTER_METHOD(0x004F4750, GameObject*, get_GameObject, (app::Naru * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x008837A0, Vector3, get_Speed, (app::Naru * this_ptr));
    IL2CPP_REGISTER_METHOD(0x008838A0, void, set_Speed, (app::Naru * this_ptr, app::Vector3 value));
    IL2CPP_REGISTER_METHOD(0x008839A0, Vector2, get_PhysicsSpeed, (app::Naru * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00506170, Transform*, get_Transform, (app::Naru * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00506170, Transform*, get_CameraTarget, (app::Naru * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::Naru * this_ptr));
} // namespace app::methods::Naru
