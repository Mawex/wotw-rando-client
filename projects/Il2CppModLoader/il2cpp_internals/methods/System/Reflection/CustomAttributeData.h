...
namespace app::methods::System::Reflection::CustomAttributeData {
    ...
    IL2CPP_REGISTER_METHOD(0x0267D660, void, __ctor_2, (app::CustomAttributeData * this_ptr, app::ConstructorInfo * ctor_info, app::Assembly * assembly, void * data, uint32_t data_length));
