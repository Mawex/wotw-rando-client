...
IL2CPP_REGISTER_METHOD(0x00BC6E90, HammerComboMoveBase_BalancingData *, get_BalancingBase, (app::MeleeComboMoveHammer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006965C0, MeleeComboMoveHammer_State__Enum, get_CurrentState, (app::MeleeComboMoveHammer * this_ptr));
IL2CPP_REGISTER_METHOD(0x0138B340, SoundProvider *, get_EffectiveHitSound, (app::MeleeComboMoveHammer * this_ptr));
IL2CPP_REGISTER_METHOD(0x0138B360, SoundProvider *, get_EffectiveAttackSound, (app::MeleeComboMoveHammer * this_ptr));
IL2CPP_REGISTER_METHOD(0x0138B380, float, get_EffectiveDamage, (app::MeleeComboMoveHammer * this_ptr));
IL2CPP_REGISTER_METHOD(0x0138B420, DamageWeight__Enum, get_EffectDamageWeight, (app::MeleeComboMoveHammer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0138B480, GameObject *, get_EffectiveGroundHitEffect, (app::MeleeComboMoveHammer * this_ptr));
IL2CPP_REGISTER_METHOD(0x0138B4A0, SoundProvider *, get_EffectiveGroundHitSound, (app::MeleeComboMoveHammer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0138D8D0, Vector2, ComputeEffectiveKickback, (app::MeleeComboMoveHammer * this_ptr, app::Vector3 enemy_position));
...
IL2CPP_REGISTER_METHOD(0x0138E5C0, EffectSpawn, DamageEffectProvider, (app::MeleeComboMoveHammer * this_ptr, app::DamageResult damage_result));
...
IL2CPP_REGISTER_METHOD(0x0138E8D0, IEnumerator *, HitStop, (app::MeleeComboMoveHammer * this_ptr, app::GameObject * to_suspend, float suspend_time));
...
IL2CPP_REGISTER_METHOD(0x0138F330, void, __ctor, (app::MeleeComboMoveHammer * this_ptr));
