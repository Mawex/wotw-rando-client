...
IL2CPP_REGISTER_METHOD(0x012A1000, UberWaterReflectionView *, GetView, (app::MoonRenderPipelineView * view));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::UberWaterReflection * this_ptr));
IL2CPP_REGISTER_METHOD(0x012A1290, void, __cctor, ());
}
