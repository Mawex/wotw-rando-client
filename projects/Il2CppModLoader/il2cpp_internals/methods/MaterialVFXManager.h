...
IL2CPP_REGISTER_METHOD(0x01384380, GameObject *, InstantiateSurfaceFX, (app::MaterialVFXManager * this_ptr, app::SurfaceMaterialType__Enum material_type, app::MaterialTypeVFXSettings_EffectSize__Enum surface_impact_size, app::Vector3 position, app::Quaternion rotation));
IL2CPP_REGISTER_METHOD(0x013844F0, GameObject *, InstantiateWeaponFX, (app::MaterialVFXManager * this_ptr, app::EquipmentType__Enum weapon, app::MaterialTypeVFXSettings_EffectSize__Enum weapon_impact_size, app::Vector3 position, app::Quaternion rotation));
IL2CPP_REGISTER_METHOD(0x01384660, SurfaceMaterialType__Enum, GetMaterialType_1, (app::MaterialVFXManager * this_ptr, app::Collider * collider));
IL2CPP_REGISTER_METHOD(0x01384780, SurfaceMaterialType__Enum, GetMaterialType_2, (app::MaterialVFXManager * this_ptr, app::PhysicMaterial * material));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::MaterialVFXManager * this_ptr));
}
