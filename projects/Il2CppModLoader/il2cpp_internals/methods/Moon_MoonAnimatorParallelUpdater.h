...
IL2CPP_REGISTER_METHOD(0x003FD3F0, UpdateType__Enum, get_UpdateType, (app::MoonAnimatorParallelUpdater * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005C3FE0, PlayableGraph, get_PlayableGraph, (app::MoonAnimatorParallelUpdater * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0211D680, void, __ctor, (app::MoonAnimatorParallelUpdater * this_ptr));
