...
namespace app::methods::UnityEngine_Experimental_Rendering::RendererCullingParameters_SliceList {
    ...
    IL2CPP_REGISTER_METHOD(0x025243A0, app::RendererCullingParameters_SliceList, operator_, (app::Single__Array * array));
