...
IL2CPP_REGISTER_METHOD(0x03149500, UberStateCollection *, get_Collection, ());
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::UberStateCollectionReference * this_ptr));
}
