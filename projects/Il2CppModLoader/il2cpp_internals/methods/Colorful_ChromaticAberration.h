...
IL2CPP_REGISTER_METHOD(0x03040FA0, String *, GetShaderName, (app::ChromaticAberration * this_ptr));
IL2CPP_REGISTER_METHOD(0x03041020, void, __ctor, (app::ChromaticAberration * this_ptr));
}
