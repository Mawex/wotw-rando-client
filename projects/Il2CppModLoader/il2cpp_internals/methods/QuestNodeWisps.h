...
IL2CPP_REGISTER_METHOD(0x002FBC40, MoonTimeline *, get_IntroTimeline, (app::QuestNodeWisps * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC50, void, set_IntroTimeline, (app::QuestNodeWisps * this_ptr, app::MoonTimeline * value));
IL2CPP_REGISTER_METHOD(0x002FBC60, MoonTimeline *, get_TalkTimeline, (app::QuestNodeWisps * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC70, void, set_TalkTimeline, (app::QuestNodeWisps * this_ptr, app::MoonTimeline * value));
IL2CPP_REGISTER_METHOD(0x002FBC80, MoonTimeline *, get_RewardTimeline, (app::QuestNodeWisps * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC90, void, set_RewardTimeline, (app::QuestNodeWisps * this_ptr, app::MoonTimeline * value));
IL2CPP_REGISTER_METHOD(0x002FBCA0, NPCEventTriggerAnimator *, get_ShowRewardTrigger, (app::QuestNodeWisps * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBCC0, NPCEventTriggerAnimator *, get_ThrowRewardTrigger, (app::QuestNodeWisps * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBCE0, NPCEventTriggerAnimator *, get_CollectRewardTrigger, (app::QuestNodeWisps * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBD00, NPCEntity *, get_NpcEntity, (app::QuestNodeWisps * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E8BDE0, Transform *, get_RewardPrefab, (app::QuestNodeWisps * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E8BE00, MessageProvider *, get_CurrentLine, (app::QuestNodeWisps * this_ptr));
