...
IL2CPP_REGISTER_METHOD(0x002FBC20, IMoonSetupAnimator *, get_MoonSetupAnimator, (app::LeashHookLogic * this_ptr));
IL2CPP_REGISTER_METHOD(0x015C54F0, void, set_MoonSetupAnimator, (app::LeashHookLogic * this_ptr, app::IMoonSetupAnimator * value));
IL2CPP_REGISTER_METHOD(0x015C55C0, MoonAnimator *, get_ModelAnimator, (app::LeashHookLogic * this_ptr));
IL2CPP_REGISTER_METHOD(0x015C55F0, MoonTimeline *, get_OpenTransitionTimeline, (app::LeashHookLogic * this_ptr));
IL2CPP_REGISTER_METHOD(0x015C5610, MoonTimeline *, get_CloseTransitionTimeline, (app::LeashHookLogic * this_ptr));
IL2CPP_REGISTER_METHOD(0x015C5630, MoonTimeline *, get_OpenedTimeline, (app::LeashHookLogic * this_ptr));
IL2CPP_REGISTER_METHOD(0x015C5650, MoonTimeline *, get_ClosedTimeline, (app::LeashHookLogic * this_ptr));
IL2CPP_REGISTER_METHOD(0x015C5670, FloatAnimationParameter *, get_OpenAngle, (app::LeashHookLogic * this_ptr));
IL2CPP_REGISTER_METHOD(0x015C56A0, SeinSpiritLeashAbility *, get_Leash, (app::LeashHookLogic * this_ptr));
IL2CPP_REGISTER_METHOD(0x015C57E0, Transform *, get_HookTarget, (app::LeashHookLogic * this_ptr));
IL2CPP_REGISTER_METHOD(0x015C57E0, Transform *, get_HookTargetTransform, (app::LeashHookLogic * this_ptr));
