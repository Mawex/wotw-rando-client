...
IL2CPP_REGISTER_METHOD(0x01374BF0, PlayerUberStateAreaMapInformation *, get_AreaMapUberState, (app::RuntimeGameWorldArea * this_ptr));
IL2CPP_REGISTER_METHOD(0x01374CA0, Vector2, FindCenterPositionOnDiscoveredAreas, (app::RuntimeGameWorldArea * this_ptr));
IL2CPP_REGISTER_METHOD(0x01375020, Vector2, FindCenterPositionOnUndiscoveredAreas, (app::RuntimeGameWorldArea * this_ptr));
IL2CPP_REGISTER_METHOD(0x013753A0, void, __ctor, (app::RuntimeGameWorldArea * this_ptr, app::GameWorldArea * area));
...
IL2CPP_REGISTER_METHOD(0x013779F0, String *, GetUberStatePath, (app::SerializedBooleanUberState * state));
...
IL2CPP_REGISTER_METHOD(0x0137A470, WorldMapAreaState__Enum, GetFaceState, (app::RuntimeGameWorldArea * this_ptr, int32_t id));
...
IL2CPP_REGISTER_METHOD(0x002FB9F0, IUberState__Array *, get_AffectingUberStates, (app::RuntimeGameWorldArea * this_ptr));
IL2CPP_REGISTER_METHOD(0x0137A4C0, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::RuntimeGameWorldArea * this_ptr));
}
