...
namespace app::methods::System_Runtime_CompilerServices::TaskAwaiter_1_System_Nullable_1_ {
IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor, (app::TaskAwaiter_1_System_Nullable_1___Boxed * this_ptr, app::Task_1_System_Nullable_1_ * task));
...
IL2CPP_REGISTER_METHOD(0x001FF6C0, Nullable_1_Int32_, GetResult, (app::TaskAwaiter_1_System_Nullable_1___Boxed * this_ptr));
}
