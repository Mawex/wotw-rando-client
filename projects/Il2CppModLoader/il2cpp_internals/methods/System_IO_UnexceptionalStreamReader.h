...
namespace app::methods::System_IO::UnexceptionalStreamReader {
IL2CPP_REGISTER_METHOD(0x02388770, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x02388850, void, __ctor, (app::UnexceptionalStreamReader * this_ptr, app::Stream * stream, app::Encoding * encoding));
...
IL2CPP_REGISTER_METHOD(0x02388F50, String *, ReadLine, (app::UnexceptionalStreamReader * this_ptr));
IL2CPP_REGISTER_METHOD(0x02388FF0, String *, ReadToEnd, (app::UnexceptionalStreamReader * this_ptr));
}
