...
IL2CPP_REGISTER_METHOD(0x031C4090, void, __ctor, (app::VirtualClipsBuilder_BuilderScope * this_ptr, app::VirtualMoonTimeline * root));
IL2CPP_REGISTER_METHOD(0x031C42B0, VirtualClipsBuilder_Layout__Enum, get_Layout, (app::VirtualClipsBuilder_BuilderScope * this_ptr));
