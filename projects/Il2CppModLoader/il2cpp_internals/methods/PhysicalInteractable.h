...
IL2CPP_REGISTER_METHOD(0x00413180, SuspendableMask__Enum, get_Mask, (app::PhysicalInteractable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014EB3F0, Bounds, get_Bounds, (app::PhysicalInteractable * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_IsStatic, (app::PhysicalInteractable * this_ptr));
IL2CPP_REGISTER_METHOD(0x014EB5A0, SoundHost *, get_EffectiveSoundHost, (app::PhysicalInteractable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C7C010, Vector3, GetPosition, (app::PhysicalInteractable * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B68B50, Vector3, GetExplodePoint, (app::PhysicalInteractable * this_ptr, app::Vector3 position));
...
IL2CPP_REGISTER_METHOD(0x014ED090, void, __ctor, (app::PhysicalInteractable * this_ptr));
}
