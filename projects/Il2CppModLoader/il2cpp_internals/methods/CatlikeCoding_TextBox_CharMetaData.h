...
namespace app::methods::CatlikeCoding_TextBox::CharMetaData {
IL2CPP_REGISTER_METHOD(0x00123DF0, String *, ToString, (app::CharMetaData__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00123E10, BitmapFontChar *, MarkAsVisible, (app::CharMetaData__Boxed * this_ptr, int32_t unstyled_index, app::Vector2 position, app::AppliedTextStyle * style));
