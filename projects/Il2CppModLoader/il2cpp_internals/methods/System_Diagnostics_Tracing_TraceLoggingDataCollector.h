...
namespace app::methods::System_Diagnostics_Tracing::TraceLoggingDataCollector {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::TraceLoggingDataCollector * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01A0A060, void, AddScalar_10, (app::TraceLoggingDataCollector * this_ptr, app::void * value));
IL2CPP_REGISTER_METHOD(0x01A0A120, void, AddScalar_11, (app::TraceLoggingDataCollector * this_ptr, app::void * value));
