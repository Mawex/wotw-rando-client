...
namespace app::methods::Unity_IO_Compression::Inflater {
IL2CPP_REGISTER_METHOD(0x02B7AD40, void, __ctor, (app::Inflater * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B7B7B0, bool, DecodeUncompressedBlock, (app::Inflater * this_ptr, app::bool * end_of_block));
IL2CPP_REGISTER_METHODINFO(0x047927B8, Inflater_DecodeUncompressedBlock__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02B7BC40, bool, DecodeBlock, (app::Inflater * this_ptr, app::bool * end_of_block_code_seen));
