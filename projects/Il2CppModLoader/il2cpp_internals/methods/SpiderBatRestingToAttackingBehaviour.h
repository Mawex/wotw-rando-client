...
IL2CPP_REGISTER_METHOD(0x0095F1A0, BehaviourStatus__Enum, OnExecute, (app::SpiderBatRestingToAttackingBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0095F690, void, __ctor, (app::SpiderBatRestingToAttackingBehaviour * this_ptr));
}
