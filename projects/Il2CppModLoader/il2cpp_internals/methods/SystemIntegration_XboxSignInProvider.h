...
IL2CPP_REGISTER_METHOD(0x00CDFE20, void, __ctor, (app::XboxSignInProvider * this_ptr, app::INetworkConnectivityChecker * network_connectivity_checker));
...
IL2CPP_REGISTER_METHOD(0x002FB930, IPlatformUser *, get_User, (app::XboxSignInProvider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, get_LinkToken, (app::XboxSignInProvider * this_ptr));
