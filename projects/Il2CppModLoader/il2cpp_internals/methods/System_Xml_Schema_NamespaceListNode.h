...
namespace app::methods::System_Xml_Schema::NamespaceListNode {
IL2CPP_REGISTER_METHOD(0x0058DA40, void, __ctor, (app::NamespaceListNode * this_ptr, app::NamespaceList * namespace_list, app::Object * particle));
IL2CPP_REGISTER_METHOD(0x016CFAA0, ICollection *, GetResolvedSymbols, (app::NamespaceListNode * this_ptr, app::SymbolsDictionary * symbols));
