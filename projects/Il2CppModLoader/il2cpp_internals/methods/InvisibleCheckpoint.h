...
IL2CPP_REGISTER_METHOD(0x00643F40, Rect, get_Bounds, (app::InvisibleCheckpoint * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0043D9A0, SelectableCategory__Enum, get_Category, (app::InvisibleCheckpoint * this_ptr));
IL2CPP_REGISTER_METHOD(0x00645590, Rect, CalculateBounds, (app::InvisibleCheckpoint * this_ptr));
IL2CPP_REGISTER_METHOD(0x006458E0, void, __ctor, (app::InvisibleCheckpoint * this_ptr));
