...
IL2CPP_REGISTER_METHOD(0x011F5820, KeyCode__Enum__Array *, CommandToBinding, (app::ControlsScreen * this_ptr, app::KeybindingCommandMapAsset_CommandBindingEnum__Enum binding));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::ControlsScreen * this_ptr));
}
