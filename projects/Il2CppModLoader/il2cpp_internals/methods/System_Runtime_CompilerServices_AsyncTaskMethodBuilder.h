...
namespace app::methods::System_Runtime_CompilerServices::AsyncTaskMethodBuilder {
...
IL2CPP_REGISTER_METHOD(0x0018EDD0, Task *, get_Task, (app::AsyncTaskMethodBuilder__Boxed * this_ptr));
