...
namespace app::methods::System_Net_Configuration::AuthenticationModulesSection {
IL2CPP_REGISTER_METHOD(0x02018410, void, __ctor, (app::AuthenticationModulesSection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047895E8, AuthenticationModulesSection__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02018440, AuthenticationModuleElementCollection *, get_AuthenticationModules, (app::AuthenticationModulesSection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04792198, AuthenticationModulesSection_get_AuthenticationModules__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02018470, ConfigurationPropertyCollection *, get_Properties, (app::AuthenticationModulesSection * this_ptr));
