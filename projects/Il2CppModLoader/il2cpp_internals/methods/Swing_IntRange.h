...
namespace app::methods::Swing::IntRange {
    IL2CPP_REGISTER_METHOD(0x00115520, void, __ctor, (app::IntRange__Boxed * this_ptr, int32_t _min, int32_t _max));
    IL2CPP_REGISTER_METHOD(0x0182B510, app::IntRange, operator_, (int32_t _i));
    IL2CPP_REGISTER_METHOD(0x0182B170, app::IntRange, operator__, (app::IntRange _r, int32_t _mult));
