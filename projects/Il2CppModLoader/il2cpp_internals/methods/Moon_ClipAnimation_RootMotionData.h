...
IL2CPP_REGISTER_METHOD(0x01B0D2A0, Vector3, SampleRootMotionData, (app::ClipAnimation_RootMotionData * this_ptr, float time));
IL2CPP_REGISTER_METHOD(0x01B0D3F0, Quaternion, SampleRootMotionRotationData, (app::ClipAnimation_RootMotionData * this_ptr, float time));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::ClipAnimation_RootMotionData * this_ptr));
}
