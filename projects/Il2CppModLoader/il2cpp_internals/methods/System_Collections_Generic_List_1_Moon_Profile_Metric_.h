...
namespace app::methods::System_Collections_Generic::List_1_Moon_Profile_Metric_ {
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_1, (app::List_1_Moon_Profile_Metric_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_2, (app::List_1_Moon_Profile_Metric_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, Metric__Enum__Array *, ToArray, (app::List_1_Moon_Profile_Metric_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D1F360, Metric__Enum, get_Item, (app::List_1_Moon_Profile_Metric_ * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x04741198, List_1_Moon_Profile_Metric__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02D201B0, List_1_T_Enumerator_Moon_Profile_Metric_, GetEnumerator, (app::List_1_Moon_Profile_Metric_ * this_ptr));
