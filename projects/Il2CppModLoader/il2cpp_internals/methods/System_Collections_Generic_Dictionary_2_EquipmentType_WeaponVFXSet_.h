...
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (Dictionary_2_EquipmentType_WeaponVFXSet_ * __this));
IL2CPP_REGISTER_METHODINFO(0x04795448, Dictionary_2_EquipmentType_WeaponVFXSet___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02BAC170, void, Add, (Dictionary_2_EquipmentType_WeaponVFXSet_ * __this, EquipmentType__Enum key, WeaponVFXSet * value));
IL2CPP_REGISTER_METHODINFO(0x04793A88, Dictionary_2_EquipmentType_WeaponVFXSet__Add__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02BBA760, bool, TryGetValue, (Dictionary_2_EquipmentType_WeaponVFXSet_ * __this, EquipmentType__Enum key, WeaponVFXSet * * value));
