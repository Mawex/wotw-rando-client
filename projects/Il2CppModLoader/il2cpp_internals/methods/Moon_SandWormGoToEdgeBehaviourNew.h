...
IL2CPP_REGISTER_METHOD(0x00EC2E10, BehaviourStatus__Enum, OnExecute, (app::SandWormGoToEdgeBehaviourNew * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00EC3890, void, OnDrawGizmos, (app::SandWormGoToEdgeBehaviourNew * this_ptr));
IL2CPP_REGISTER_METHOD(0x00EC3BB0, void, __ctor, (app::SandWormGoToEdgeBehaviourNew * this_ptr));
}
