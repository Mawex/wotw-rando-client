...
IL2CPP_REGISTER_METHOD(0x02464D70, Material *, get_material, (app::CameraFilterPack_Edge_Golden * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0136E200, void, __ctor, (app::CameraFilterPack_Edge_Golden * this_ptr));
}
