...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::CursorRendererOverlay {
...
IL2CPP_REGISTER_METHOD(0x010415D0, void, __ctor, (app::CursorRendererOverlay * this_ptr));
}
