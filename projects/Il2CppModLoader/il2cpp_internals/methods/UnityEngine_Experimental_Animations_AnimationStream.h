...
namespace app::methods::UnityEngine_Experimental_Animations::AnimationStream {
...
IL2CPP_REGISTER_METHOD(0x00242900, Vector3, get_velocity, (app::AnimationStream__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00242990, Vector3, get_angularVelocity, (app::AnimationStream__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00242A20, Vector3, get_rootMotionPosition, (app::AnimationStream__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00242AB0, Quaternion, get_rootMotionRotation, (app::AnimationStream__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00242B40, bool, get_isHumanStream, (app::AnimationStream__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00242BA0, AnimationHumanStream, AsHuman, (app::AnimationStream__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00242E80, Vector3, GetVelocity, (app::AnimationStream__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00242F10, Vector3, GetAngularVelocity, (app::AnimationStream__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00242FA0, Vector3, GetRootMotionPosition, (app::AnimationStream__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00243030, Quaternion, GetRootMotionRotation, (app::AnimationStream__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x002430B0, int32_t, GetInputStreamCount, (app::AnimationStream__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00243110, AnimationHumanStream, GetHumanStream, (app::AnimationStream__Boxed * this_ptr));
