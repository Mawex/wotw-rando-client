...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (ReflectionDelegateFactory * __this));
IL2CPP_REGISTER_METHOD(0x02653CC0, Func_2_Object_Object_ *, CreateGet, (ReflectionDelegateFactory * __this, MemberInfo_1 * memberInfo));
IL2CPP_REGISTER_METHODINFO(0x0470C8E0, ReflectionDelegateFactory_CreateGet__MethodInfo);
IL2CPP_REGISTER_METHOD(0x018F1C90, Action_2_Object_Object_ *, CreateSet, (ReflectionDelegateFactory * __this, MemberInfo_1 * memberInfo));
