...
IL2CPP_REGISTER_METHOD(0x00CB5CD0, Color, get_Color, (app::UberShaderColor * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0190CF50, void, __ctor_1, (app::UberShaderColor * this_ptr));
IL2CPP_REGISTER_METHOD(0x0190CF70, void, __ctor_2, (app::UberShaderColor * this_ptr, app::Color default_color));
}
