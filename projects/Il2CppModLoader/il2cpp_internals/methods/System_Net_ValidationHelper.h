...
namespace app::methods::System_Net::ValidationHelper {
IL2CPP_REGISTER_METHOD(0x020AD050, String__Array *, MakeEmptyArrayNull, (app::String__Array * string_array));
IL2CPP_REGISTER_METHOD(0x020AD070, String *, MakeStringNull, (app::String * string_value));
IL2CPP_REGISTER_METHOD(0x020AD090, String *, ExceptionMessage, (app::Exception * exception));
IL2CPP_REGISTER_METHOD(0x020AD1C0, String *, ToString, (app::Object * object_value));
IL2CPP_REGISTER_METHOD(0x020AD3D0, String *, HashString, (app::Object * object_value));
