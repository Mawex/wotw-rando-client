...
namespace app::methods::Moon_Timeline::RigidbodyTranslationAnimatorEntity {
IL2CPP_REGISTER_METHOD(0x00417920, UpdateCategory__Enum, get_UpdateCategory, (app::RigidbodyTranslationAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00780E20, GameObject *, get_ExternalTarget, (app::RigidbodyTranslationAnimatorEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00780FC0, Rigidbody *, get_EffectiveBody, (app::RigidbodyTranslationAnimatorEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007813F0, Vector3, GetPosition, (app::RigidbodyTranslationAnimatorEntity * this_ptr, float time));
IL2CPP_REGISTER_METHOD(0x00781670, Vector3, EffectiveTranslation, (app::RigidbodyTranslationAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x007816C0, void, OnDrawGizmos, (app::RigidbodyTranslationAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00781970, void, __ctor, (app::RigidbodyTranslationAnimatorEntity * this_ptr));
}
