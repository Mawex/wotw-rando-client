...
IL2CPP_REGISTER_METHOD(0x02539620, void, __ctor, (app::Mesh * this_ptr));
IL2CPP_REGISTER_METHOD(0x025396F0, void, Internal_Create, (app::Mesh * mono));
IL2CPP_REGISTER_METHOD(0x02539740, Int32__Array *, GetTrianglesImpl, (app::Mesh * this_ptr, int32_t submesh, bool apply_base_vertex));
IL2CPP_REGISTER_METHOD(0x025397B0, Int32__Array *, GetIndicesImpl, (app::Mesh * this_ptr, int32_t submesh, bool apply_base_vertex));
...
IL2CPP_REGISTER_METHOD(0x025399F0, Array *, GetAllocArrayFromChannelImpl, (app::Mesh * this_ptr, app::VertexAttribute__Enum channel, app::Mesh_InternalVertexChannelType__Enum format, int32_t dim));
IL2CPP_REGISTER_METHOD(0x02539A70, BoneWeight__Array *, get_boneWeights, (app::Mesh * this_ptr));
IL2CPP_REGISTER_METHOD(0x02539AC0, Matrix4x4__Array *, get_bindposes, (app::Mesh * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02539D10, Bounds, get_bounds, (app::Mesh * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02539FB0, VertexAttribute__Enum, GetUVChannel, (app::Mesh * this_ptr, int32_t uv_index));
...
IL2CPP_REGISTER_METHOD(0x0253A270, Vector3__Array *, get_vertices, (app::Mesh * this_ptr));
IL2CPP_REGISTER_METHOD(0x0253A320, void, set_vertices, (app::Mesh * this_ptr, app::Vector3__Array * value));
IL2CPP_REGISTER_METHOD(0x0253A3B0, Vector3__Array *, get_normals, (app::Mesh * this_ptr));
IL2CPP_REGISTER_METHOD(0x0253A470, void, set_normals, (app::Mesh * this_ptr, app::Vector3__Array * value));
IL2CPP_REGISTER_METHOD(0x0253A500, Vector4__Array *, get_tangents, (app::Mesh * this_ptr));
IL2CPP_REGISTER_METHOD(0x0253A5C0, Vector2__Array *, get_uv, (app::Mesh * this_ptr));
IL2CPP_REGISTER_METHOD(0x0253A680, void, set_uv, (app::Mesh * this_ptr, app::Vector2__Array * value));
IL2CPP_REGISTER_METHOD(0x0253A710, Vector2__Array *, get_uv2, (app::Mesh * this_ptr));
IL2CPP_REGISTER_METHOD(0x0253A7D0, void, set_uv2, (app::Mesh * this_ptr, app::Vector2__Array * value));
IL2CPP_REGISTER_METHOD(0x0253A860, Vector2__Array *, get_uv3, (app::Mesh * this_ptr));
IL2CPP_REGISTER_METHOD(0x0253A920, Vector2__Array *, get_uv4, (app::Mesh * this_ptr));
IL2CPP_REGISTER_METHOD(0x0253A9E0, void, set_colors, (app::Mesh * this_ptr, app::Color__Array * value));
IL2CPP_REGISTER_METHOD(0x0253AAC0, Color32__Array *, get_colors32, (app::Mesh * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0253B830, Int32__Array *, get_triangles, (app::Mesh * this_ptr));
IL2CPP_REGISTER_METHOD(0x0253B950, void, set_triangles, (app::Mesh * this_ptr, app::Int32__Array * value));
IL2CPP_REGISTER_METHOD(0x0253BA00, Int32__Array *, GetTriangles_1, (app::Mesh * this_ptr, int32_t submesh));
IL2CPP_REGISTER_METHOD(0x0253BAC0, Int32__Array *, GetTriangles_2, (app::Mesh * this_ptr, int32_t submesh, bool apply_base_vertex));
IL2CPP_REGISTER_METHOD(0x0253BB90, Int32__Array *, GetIndices_1, (app::Mesh * this_ptr, int32_t submesh));
IL2CPP_REGISTER_METHOD(0x0253BC90, Int32__Array *, GetIndices_2, (app::Mesh * this_ptr, int32_t submesh, bool apply_base_vertex));
...
IL2CPP_REGISTER_METHOD(0x02FF6330, Object__Array *, GetAllocArrayFromChannel_1, (app::Mesh * this_ptr, app::VertexAttribute__Enum channel, app::Mesh_InternalVertexChannelType__Enum format, int32_t dim));
IL2CPP_REGISTER_METHOD(0x02FF62D0, Object__Array *, GetAllocArrayFromChannel_2, (app::Mesh * this_ptr, app::VertexAttribute__Enum channel));
...
IL2CPP_REGISTER_METHOD(0x02FF62D0, Vector3__Array *, GetAllocArrayFromChannel_3, (app::Mesh * this_ptr, app::VertexAttribute__Enum channel));
...
IL2CPP_REGISTER_METHOD(0x02FF62D0, Vector4__Array *, GetAllocArrayFromChannel_4, (app::Mesh * this_ptr, app::VertexAttribute__Enum channel));
IL2CPP_REGISTER_METHODINFO(0x047076D8, Mesh_GetAllocArrayFromChannel_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02FF62D0, Vector2__Array *, GetAllocArrayFromChannel_5, (app::Mesh * this_ptr, app::VertexAttribute__Enum channel));
...
IL2CPP_REGISTER_METHOD(0x02FF6330, Color32__Array *, GetAllocArrayFromChannel_6, (app::Mesh * this_ptr, app::VertexAttribute__Enum channel, app::Mesh_InternalVertexChannelType__Enum format, int32_t dim));
...
IL2CPP_REGISTER_METHOD(0x02FF6330, Vector2__Array *, GetAllocArrayFromChannel_7, (app::Mesh * this_ptr, app::VertexAttribute__Enum channel, app::Mesh_InternalVertexChannelType__Enum format, int32_t dim));
IL2CPP_REGISTER_METHOD(0x02FF6330, Vector3__Array *, GetAllocArrayFromChannel_8, (app::Mesh * this_ptr, app::VertexAttribute__Enum channel, app::Mesh_InternalVertexChannelType__Enum format, int32_t dim));
IL2CPP_REGISTER_METHOD(0x02FF6330, Vector4__Array *, GetAllocArrayFromChannel_9, (app::Mesh * this_ptr, app::VertexAttribute__Enum channel, app::Mesh_InternalVertexChannelType__Enum format, int32_t dim));
}
