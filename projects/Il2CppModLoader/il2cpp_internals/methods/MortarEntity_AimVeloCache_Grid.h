...
IL2CPP_REGISTER_METHOD(0x0147BF30, Vector3, SnapOffset, (app::MortarEntity_AimVeloCache_Grid * this_ptr, app::Vector3 target_offset));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MortarEntity_AimVeloCache_Grid * this_ptr));
}
