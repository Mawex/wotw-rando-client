...
namespace app::methods::TriangleNet_IO::InputTriangle {
IL2CPP_REGISTER_METHOD(0x026213E0, void, __ctor, (app::InputTriangle * this_ptr, int32_t p0, int32_t p1, int32_t p2));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, Vertex *, GetVertex, (app::InputTriangle * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x026214E0, int32_t, GetVertexID, (app::InputTriangle * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x00420EE0, ITriangle *, GetNeighbor, (app::InputTriangle * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x00597B10, int32_t, GetNeighborID, (app::InputTriangle * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x00420EE0, ISegment *, GetSegment, (app::InputTriangle * this_ptr, int32_t index));
}
