...
namespace app::methods::AK_Wwise::Event {
IL2CPP_REGISTER_METHOD(0x00420230, WwiseObjectType__Enum, get_WwiseObjectType, (app::Event_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x026C1170, void, __ctor, (app::Event_1 * this_ptr));
}
