...
namespace app::methods::System_Net_Http_Headers::RangeConditionHeaderValue {
IL2CPP_REGISTER_METHOD(0x02D14520, void, __ctor_1, (app::RangeConditionHeaderValue * this_ptr, app::DateTimeOffset date));
IL2CPP_REGISTER_METHOD(0x02D145C0, void, __ctor_2, (app::RangeConditionHeaderValue * this_ptr, app::EntityTagHeaderValue * entity_tag));
IL2CPP_REGISTER_METHODINFO(0x04734210, RangeConditionHeaderValue__ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02D14680, Nullable_1_DateTimeOffset_, get_Date, (app::RangeConditionHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB00, EntityTagHeaderValue *, get_EntityTag, (app::RangeConditionHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0173F610, Object *, ICloneable_Clone, (app::RangeConditionHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D14F60, String *, ToString, (app::RangeConditionHeaderValue * this_ptr));
}
