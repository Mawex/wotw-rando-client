...
namespace app::methods::System_Dynamic::ExpandoObject_ValueCollection {
IL2CPP_REGISTER_METHOD(0x01F92B00, void, __ctor, (app::ExpandoObject_ValueCollection * this_ptr, app::ExpandoObject * expando));
...
IL2CPP_REGISTER_METHOD(0x01F93280, IEnumerator_1_System_Object_ *, GetEnumerator, (app::ExpandoObject_ValueCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F93280, IEnumerator *, IEnumerable_GetEnumerator, (app::ExpandoObject_ValueCollection * this_ptr));
}
