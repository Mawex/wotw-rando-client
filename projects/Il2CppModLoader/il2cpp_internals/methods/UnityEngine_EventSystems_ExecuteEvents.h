...
namespace app::methods::UnityEngine_EventSystems::ExecuteEvents {
...
IL2CPP_REGISTER_METHOD(0x0157C770, Object *, ValidateEventData_1, (app::BaseEventData * data));
...
IL2CPP_REGISTER_METHOD(0x02FF7CB0, GameObject *, ExecuteHierarchy_1, (app::GameObject * root, app::BaseEventData * event_data, app::ExecuteEvents_EventFunction_1_System_Object_ * callback_function));
...
IL2CPP_REGISTER_METHOD(0x02FF7E90, GameObject *, GetEventHandler_1, (app::GameObject * root));
...
IL2CPP_REGISTER_METHOD(0x0157C770, PointerEventData *, ValidateEventData_2, (app::BaseEventData * data));
IL2CPP_REGISTER_METHODINFO(0x04724468, ExecuteEvents_ValidateEventData_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0157C770, AxisEventData *, ValidateEventData_3, (app::BaseEventData * data));
...
IL2CPP_REGISTER_METHOD(0x02FF7E90, GameObject *, GetEventHandler_2, (app::GameObject * root));
...
IL2CPP_REGISTER_METHOD(0x02FF7CB0, GameObject *, ExecuteHierarchy_2, (app::GameObject * root, app::BaseEventData * event_data, app::ExecuteEvents_EventFunction_1_IPointerDownHandler_ * callback_function));
IL2CPP_REGISTER_METHODINFO(0x0473DC38, ExecuteEvents_ExecuteHierarchy_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02FF7E90, GameObject *, GetEventHandler_3, (app::GameObject * root));
IL2CPP_REGISTER_METHODINFO(0x04740280, ExecuteEvents_GetEventHandler_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02FF7E90, GameObject *, GetEventHandler_4, (app::GameObject * root));
...
IL2CPP_REGISTER_METHOD(0x02FF7CB0, GameObject *, ExecuteHierarchy_3, (app::GameObject * root, app::BaseEventData * event_data, app::ExecuteEvents_EventFunction_1_IDropHandler_ * callback_function));
IL2CPP_REGISTER_METHODINFO(0x0472E208, ExecuteEvents_ExecuteHierarchy_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02FF7CB0, GameObject *, ExecuteHierarchy_4, (app::GameObject * root, app::BaseEventData * event_data, app::ExecuteEvents_EventFunction_1_IPointerExitHandler_ * callback_function));
...
IL2CPP_REGISTER_METHOD(0x02FF7E90, GameObject *, GetEventHandler_5, (app::GameObject * root));
IL2CPP_REGISTER_METHODINFO(0x04748720, ExecuteEvents_GetEventHandler_4__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02FF7CB0, GameObject *, ExecuteHierarchy_5, (app::GameObject * root, app::BaseEventData * event_data, app::ExecuteEvents_EventFunction_1_IScrollHandler_ * callback_function));
