...
IL2CPP_REGISTER_METHOD(0x00A64230, EntityDamageEvent *, get_DamageEvent, (app::CrabHitReactionBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420230, BehaviourStatus__Enum, OnExecuteTask, (app::CrabHitReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00DB5CF0, void, __ctor, (app::CrabHitReactionBehaviour * this_ptr));
}
