...
IL2CPP_REGISTER_METHOD(0x0246BA60, Material *, get_material, (app::CameraFilterPack_FX_Drunk * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0246C2D0, void, __ctor, (app::CameraFilterPack_FX_Drunk * this_ptr));
}
