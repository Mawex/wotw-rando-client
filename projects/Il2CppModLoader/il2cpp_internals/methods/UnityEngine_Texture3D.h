...
namespace app::methods::UnityEngine::Texture3D {
    IL2CPP_REGISTER_METHOD(0x02C69E50, void, __ctor_1, (app::Texture3D * this_ptr, int32_t width, int32_t height, int32_t depth, app::GraphicsFormat__Enum format, app::TextureCreationFlags__Enum flags));
    IL2CPP_REGISTER_METHOD(0x02C69EE0, void, __ctor_2, (app::Texture3D * this_ptr, int32_t width, int32_t height, int32_t depth, app::TextureFormat__Enum texture_format, bool mip_chain));
