...
namespace app::methods::Moon_Timeline::MarkerEntity {
IL2CPP_REGISTER_METHOD(0x002FC6D0, AnimatorPlayState__Enum, get_PlayState, (app::MarkerEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, PlaybackStatus *, get_PlaybackStatus, (app::MarkerEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BC16E0, String *, get_Name, (app::MarkerEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BC1760, bool, HasFinished, (app::MarkerEntity * this_ptr, int32_t event_id));
IL2CPP_REGISTER_METHOD(0x002FB9F0, IEventReciever *, get_EventReciever, (app::MarkerEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBA00, void, set_EventReciever, (app::MarkerEntity * this_ptr, app::IEventReciever * value));
IL2CPP_REGISTER_METHOD(0x01BC19C0, void, __ctor, (app::MarkerEntity * this_ptr));
}
