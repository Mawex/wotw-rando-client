...
IL2CPP_REGISTER_METHOD(0x00608710, SuspendableMask__Enum, get_Mask, (app::NightCrawlerReveal * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00608D80, void, __ctor, (app::NightCrawlerReveal * this_ptr));
}
