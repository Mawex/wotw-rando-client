...
namespace app::methods::System_Text_RegularExpressions::CaptureCollection {
IL2CPP_REGISTER_METHOD(0x002FA280, Object *, get_SyncRoot, (app::CaptureCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02580C10, Capture *, get_Item, (app::CaptureCollection * this_ptr, int32_t i));
...
IL2CPP_REGISTER_METHOD(0x02580D20, IEnumerator *, GetEnumerator, (app::CaptureCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x02580E70, Capture *, GetCapture, (app::CaptureCollection * this_ptr, int32_t i));
IL2CPP_REGISTER_METHODINFO(0x04787410, CaptureCollection_GetCapture__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025811F0, void, __ctor, (app::CaptureCollection * this_ptr));
