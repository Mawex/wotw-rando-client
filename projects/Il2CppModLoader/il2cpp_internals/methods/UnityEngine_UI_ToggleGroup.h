...
namespace app::methods::UnityEngine_UI::ToggleGroup {
IL2CPP_REGISTER_METHOD(0x0267C900, void, __ctor, (app::ToggleGroup * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0267D200, IEnumerable_1_UnityEngine_UI_Toggle_ *, ActiveToggles, (app::ToggleGroup * this_ptr));
