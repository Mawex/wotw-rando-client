...
IL2CPP_REGISTER_METHOD(0x00B9D820, GUIStyle *, get_LabelStyle, (app::SceneFrameworkDebugger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B9DFC0, String *, _getColorForBoostMode, (app::SceneFrameworkDebugger * this_ptr, app::LoadingBoostController_BoostModeLevel__Enum level));
IL2CPP_REGISTER_METHOD(0x00B9DFF0, String *, _getColorForSceneState, (app::SceneFrameworkDebugger * this_ptr, app::SceneState__Enum state));
...
IL2CPP_REGISTER_METHOD(0x00B9FB40, void, __ctor, (app::SceneFrameworkDebugger * this_ptr));
}
