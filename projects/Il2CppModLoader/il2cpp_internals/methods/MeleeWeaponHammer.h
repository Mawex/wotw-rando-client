...
IL2CPP_REGISTER_METHOD(0x009D0B00, SuspendableMask__Enum, get_Mask, (app::MeleeWeaponHammer * this_ptr));
IL2CPP_REGISTER_METHOD(0x009D0B10, void, set_Mask, (app::MeleeWeaponHammer * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x009D0BD0, TrackingExclusions, get_TrackingExclusions, (app::MeleeWeaponHammer * this_ptr));
IL2CPP_REGISTER_METHOD(0x009D0BE0, void, __ctor, (app::MeleeWeaponHammer * this_ptr));
}
