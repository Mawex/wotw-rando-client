...
IL2CPP_REGISTER_METHOD(0x00724B00, void, __ctor, (app::RacesUiService * this_ptr));
IL2CPP_REGISTER_METHOD(0x00724BC0, void, Reset, (app::RacesUiService * this_ptr));
IL2CPP_REGISTER_METHOD(0x00724C80, MessageDescriptor, GetStartPedestalBottomHintMessage, (app::RacesUiService * this_ptr, app::RaceStateMachineContext * ctx));
...
IL2CPP_REGISTER_METHOD(0x007262F0, MessageDescriptor, GetRaceLeaveDescriptor, (app::RacesUiService * this_ptr, app::MessageProvider * provider, float time));
