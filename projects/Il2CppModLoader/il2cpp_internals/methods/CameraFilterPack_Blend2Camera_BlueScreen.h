...
IL2CPP_REGISTER_METHOD(0x02742770, Material *, get_material, (app::CameraFilterPack_Blend2Camera_BlueScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02743420, void, __ctor, (app::CameraFilterPack_Blend2Camera_BlueScreen * this_ptr));
}
