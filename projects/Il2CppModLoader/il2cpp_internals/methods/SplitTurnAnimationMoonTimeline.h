...
IL2CPP_REGISTER_METHOD(0x009A3B60, CancelableAnimator *, get_Cancelable, (app::SplitTurnAnimationMoonTimeline * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x009A4A40, void, __ctor, (app::SplitTurnAnimationMoonTimeline * this_ptr));
}
