...
namespace app::methods::Moon_Timeline::PlayableCharacterControlAnimator {
IL2CPP_REGISTER_METHOD(0x00779F10, Vector3, get_Position, (app::PlayableCharacterControlAnimator * this_ptr));
