...
namespace app::methods::Moon_Wwise::PositionSyncTask {
IL2CPP_REGISTER_METHOD(0x00ABE2D0, SoundListenerReference, get_AsListener, (app::PositionSyncTask * this_ptr));
IL2CPP_REGISTER_METHOD(0x0270A8E0, void, set_AsListener, (app::PositionSyncTask * this_ptr, app::SoundListenerReference value));
IL2CPP_REGISTER_METHOD(0x0270A8F0, void, __ctor, (app::PositionSyncTask * this_ptr, int32_t i));
