...
IL2CPP_REGISTER_METHOD(0x002FBB00, Stream *, get_BaseStream, (app::DelegatedStream * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01EACEE0, IAsyncResult *, BeginRead, (app::DelegatedStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::AsyncCallback * callback, app::Object * state));
IL2CPP_REGISTER_METHODINFO(0x04791860, DelegatedStream_BeginRead__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EAD060, IAsyncResult *, BeginWrite, (app::DelegatedStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::AsyncCallback * callback, app::Object * state));
...
IL2CPP_REGISTER_METHOD(0x01BD2820, Task *, FlushAsync, (app::DelegatedStream * this_ptr, app::CancellationToken cancellation_token));
...
IL2CPP_REGISTER_METHOD(0x01EAD530, Task_1_System_Int32_ *, ReadAsync, (app::DelegatedStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::CancellationToken cancellation_token));
...
IL2CPP_REGISTER_METHOD(0x01EAD980, Task *, WriteAsync, (app::DelegatedStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t count, app::CancellationToken cancellation_token));
