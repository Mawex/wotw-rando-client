...
IL2CPP_REGISTER_METHOD(0x024F9CD0, Material *, get_material, (app::CameraFilterPack_Drawing_Paper3 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024FA5F0, void, __ctor, (app::CameraFilterPack_Drawing_Paper3 * this_ptr));
}
