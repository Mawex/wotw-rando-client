...
IL2CPP_REGISTER_METHOD(0x01779E80, void, __ctor, (app::PetrifiedOwlBossLowFlightBehaviour_JumpState * this_ptr, app::PetrifiedOwlBossLowFlightBehaviour * behaviour));
