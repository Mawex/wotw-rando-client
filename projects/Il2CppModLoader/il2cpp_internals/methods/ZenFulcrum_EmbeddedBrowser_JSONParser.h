...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::JSONParser {
IL2CPP_REGISTER_METHOD(0x01DE3CA0, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x01DE3F50, JSONNode *, Parse, (app::String * json));
...
IL2CPP_REGISTER_METHOD(0x01DE41C0, String *, EscapeToJavascriptString, (app::String * json_string));
IL2CPP_REGISTER_METHOD(0x01DE44B0, JSONNode *, ParseObject, (app::Char__Array * json, app::int32_t * index, app::bool * success));
IL2CPP_REGISTER_METHOD(0x01DE47C0, JSONNode *, ParseArray, (app::Char__Array * json, app::int32_t * index, app::bool * success));
IL2CPP_REGISTER_METHOD(0x01DE4A10, JSONNode *, ParseValue, (app::Char__Array * json, app::int32_t * index, app::bool * success));
IL2CPP_REGISTER_METHOD(0x01DE4D40, JSONNode *, ParseString, (app::Char__Array * json, app::int32_t * index, app::bool * success));
...
IL2CPP_REGISTER_METHOD(0x01DE5540, JSONNode *, ParseNumber, (app::Char__Array * json, app::int32_t * index, app::bool * success));
IL2CPP_REGISTER_METHOD(0x01DE59F0, int32_t, GetLastIndexOfNumber, (app::Char__Array * json, int32_t index));
IL2CPP_REGISTER_METHOD(0x01DE5AE0, void, EatWhitespace, (app::Char__Array * json, app::int32_t * index));
IL2CPP_REGISTER_METHOD(0x01DE5BD0, int32_t, LookAhead, (app::Char__Array * json, int32_t index));
IL2CPP_REGISTER_METHOD(0x01DE5C80, int32_t, NextToken, (app::Char__Array * json, app::int32_t * index));
IL2CPP_REGISTER_METHOD(0x01DE6090, String *, Serialize, (app::JSONNode * node));
