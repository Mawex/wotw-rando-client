...
namespace app::methods::Moon::TurtleShellRollAttackBehaviourNew_RollLoopState {
    IL2CPP_REGISTER_METHOD(0x00D21D80, void, __ctor, (app::TurtleShellRollAttackBehaviourNew_RollLoopState * this_ptr, app::TurtleShellRollAttackBehaviourNew * behaviour));
