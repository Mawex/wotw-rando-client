...
namespace app::methods::System_Net_Configuration::ConnectionManagementElementCollection {
IL2CPP_REGISTER_METHOD(0x020189E0, void, __ctor, (app::ConnectionManagementElementCollection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0473FBB0, ConnectionManagementElementCollection__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02018A10, ConnectionManagementElement *, get_Item_1, (app::ConnectionManagementElementCollection * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02018A70, ConnectionManagementElement *, get_Item_2, (app::ConnectionManagementElementCollection * this_ptr, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x02018B30, ConfigurationElement *, CreateNewElement, (app::ConnectionManagementElementCollection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04785D50, ConnectionManagementElementCollection_CreateNewElement__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02018B60, Object *, GetElementKey, (app::ConnectionManagementElementCollection * this_ptr, app::ConfigurationElement * element));
