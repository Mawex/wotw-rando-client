...
namespace app::methods::System_Text_RegularExpressions::RegexRunner {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::RegexRunner * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A77620, Match *, Scan, (app::RegexRunner * this_ptr, app::Regex * regex, app::String * text, int32_t textbeg, int32_t textend, int32_t textstart, int32_t prevlen, bool quick, app::TimeSpan timeout));
...
IL2CPP_REGISTER_METHOD(0x02A78160, Match *, TidyMatch, (app::RegexRunner * this_ptr, bool quick));
