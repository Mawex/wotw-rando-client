...
IL2CPP_REGISTER_METHOD(0x0065B580, StressTestStatus__Enum, get_StressTestStatus, (app::MoonGetAbilityPedestal * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F50090, String *, get_StressTestName, (app::MoonGetAbilityPedestal * this_ptr));
IL2CPP_REGISTER_METHOD(0x00F50110, IDesiredUberState *, GetRequirementsForTimeline, (app::MoonGetAbilityPedestal * this_ptr, app::MoonTimeline * timeline));
...
IL2CPP_REGISTER_METHOD(0x00F50250, IUberState__Array *, get_AffectingUberStates, (app::MoonGetAbilityPedestal * this_ptr));
IL2CPP_REGISTER_METHOD(0x00F502F0, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::MoonGetAbilityPedestal * this_ptr));
IL2CPP_REGISTER_METHOD(0x00F504B0, void, __ctor, (app::MoonGetAbilityPedestal * this_ptr));
