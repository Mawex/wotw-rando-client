...
IL2CPP_REGISTER_METHOD(0x00D51450, GlobalBrightnessController_BrigthnessContributionOrder__Enum, get_BrightnessInfluceOrder, (app::BrightnessZoneModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008A2C20, void, __ctor, (app::BrightnessZoneModifier * this_ptr));
}
