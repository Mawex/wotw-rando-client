...
namespace app::methods::System_Data_Common::DateTimeOffsetStorage {
IL2CPP_REGISTER_METHOD(0x021603E0, void, __ctor, (app::DateTimeOffsetStorage * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x02160530, Object *, Aggregate, (app::DateTimeOffsetStorage * this_ptr, app::Int32__Array * records, app::AggregateType__Enum kind));
...
IL2CPP_REGISTER_METHOD(0x02161130, Object *, ConvertValue, (app::DateTimeOffsetStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02155CC0, void, Copy, (app::DateTimeOffsetStorage * this_ptr, int32_t record_no1, int32_t record_no2));
IL2CPP_REGISTER_METHOD(0x02161200, Object *, Get, (app::DateTimeOffsetStorage * this_ptr, int32_t record));
...
IL2CPP_REGISTER_METHOD(0x021616E0, Object *, ConvertXmlToObject, (app::DateTimeOffsetStorage * this_ptr, app::String * s));
IL2CPP_REGISTER_METHOD(0x021617A0, String *, ConvertObjectToXml, (app::DateTimeOffsetStorage * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x02161890, Object *, GetEmptyStorage, (app::DateTimeOffsetStorage * this_ptr, int32_t record_count));
...
IL2CPP_REGISTER_METHOD(0x02161B80, void, __cctor, ());
}
