...
namespace app::methods::System_Collections_Generic::Dictionary_2_TKey_TValue__KeyCollection_System_Object_System_Byte_ {
    IL2CPP_REGISTER_METHOD(0x026A6980, void, __ctor, (app::Dictionary_2_TKey_TValue_KeyCollection_System_Object_System_Byte_ * this_ptr, app::Dictionary_2_System_Object_System_Byte_ * dictionary));
