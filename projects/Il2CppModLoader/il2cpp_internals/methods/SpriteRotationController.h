...
IL2CPP_REGISTER_METHOD(0x0057AAC0, SuspendableMask__Enum, get_Mask, (app::SpriteRotationController * this_ptr));
IL2CPP_REGISTER_METHOD(0x009AF080, void, set_Mask, (app::SpriteRotationController * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x009AF130, void, __ctor, (app::SpriteRotationController * this_ptr));
}
