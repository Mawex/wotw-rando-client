...
namespace app::methods::RootMotion_FinalIK::IKSolver {
...
IL2CPP_REGISTER_METHOD(0x007EC230, Vector3, GetIKPosition, (app::IKSolver * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB40, Transform *, GetRoot, (app::IKSolver * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BE4690, Transform *, ContainsDuplicateBone, (app::IKSolver_Bone__Array * bones));
...
IL2CPP_REGISTER_METHOD(0x02BE53A0, void, __ctor, (app::IKSolver * this_ptr));
