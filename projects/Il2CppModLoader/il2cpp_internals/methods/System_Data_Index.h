...
namespace app::methods::System_Data::Index {
IL2CPP_REGISTER_METHOD(0x01E39C40, void, __ctor_1, (app::Index * this_ptr, app::DataTable * table, app::IndexField__Array * index_fields, app::DataViewRowState__Enum record_states, app::IFilter * row_filter));
IL2CPP_REGISTER_METHOD(0x01E39C70, void, __ctor_2, (app::Index * this_ptr, app::DataTable * table, app::Comparison_1_System_Data_DataRow_ * comparison, app::DataViewRowState__Enum record_states, app::IFilter * row_filter));
IL2CPP_REGISTER_METHOD(0x01E39DF0, IndexField__Array *, GetAllFields, (app::DataColumnCollection * columns));
IL2CPP_REGISTER_METHOD(0x01E39F10, void, __ctor_3, (app::Index * this_ptr, app::DataTable * table, app::IndexField__Array * index_fields, app::Comparison_1_System_Data_DataRow_ * comparison, app::DataViewRowState__Enum record_states, app::IFilter * row_filter));
...
IL2CPP_REGISTER_METHOD(0x002FB970, DataViewRowState__Enum, get_RecordStates, (app::Index * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E3A5D0, IFilter *, get_RowFilter, (app::Index * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E3BB10, RBTree_1_K_RBTreeEnumerator_System_Int32_, GetEnumerator, (app::Index * this_ptr, int32_t start_index));
...
IL2CPP_REGISTER_METHOD(0x01E3BEF0, Object__Array *, GetUniqueKeyValues_1, (app::Index * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E3CE10, Range, GetRangeFromNode, (app::Index * this_ptr, int32_t node_id));
IL2CPP_REGISTER_METHOD(0x01E3D150, Range, FindRecords_1, (app::Index * this_ptr, app::Object * key));
IL2CPP_REGISTER_METHOD(0x01E3D1A0, Range, FindRecords_2, (app::Index * this_ptr, app::Object__Array * key));
...
IL2CPP_REGISTER_METHOD(0x01E3D340, DataRow *, GetRow, (app::Index * this_ptr, int32_t i));
IL2CPP_REGISTER_METHOD(0x01E3D3B0, DataRow__Array *, GetRows_1, (app::Index * this_ptr, app::Object__Array * values));
IL2CPP_REGISTER_METHOD(0x01E3D400, DataRow__Array *, GetRows_2, (app::Index * this_ptr, app::Range range));
...
IL2CPP_REGISTER_METHOD(0x002FA280, DataTable *, get_Table, (app::Index * this_ptr));
