...
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_Name, (app::TeleportDebugMenuPage * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CE8580, IEnumerator *, GoToSceneRoutine, (app::String * scene_name, app::Action * on_complete));
