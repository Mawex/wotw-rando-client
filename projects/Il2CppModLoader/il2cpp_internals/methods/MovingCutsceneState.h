...
IL2CPP_REGISTER_METHOD(0x0086C6F0, SeinCharacter *, get_Sein, (app::MovingCutsceneState * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0086D240, void, __ctor, (app::MovingCutsceneState * this_ptr));
}
