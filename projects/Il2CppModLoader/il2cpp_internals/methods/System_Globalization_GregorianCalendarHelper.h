...
namespace app::methods::System_Globalization::GregorianCalendarHelper {
IL2CPP_REGISTER_METHOD(0x002FC6D0, int32_t, get_MaxYear, (app::GregorianCalendarHelper * this_ptr));
IL2CPP_REGISTER_METHOD(0x02611CC0, void, __ctor, (app::GregorianCalendarHelper * this_ptr, app::Calendar * cal, app::EraInfo__Array * era_info));
...
IL2CPP_REGISTER_METHOD(0x02612B30, DayOfWeek__Enum, GetDayOfWeek, (app::GregorianCalendarHelper * this_ptr, app::DateTime time));
...
IL2CPP_REGISTER_METHOD(0x02612EF0, Int32__Array *, get_Eras, (app::GregorianCalendarHelper * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x026133A0, DateTime, ToDateTime, (app::GregorianCalendarHelper * this_ptr, int32_t year, int32_t month, int32_t day, int32_t hour, int32_t minute, int32_t second, int32_t millisecond, int32_t era));
