...
IL2CPP_REGISTER_METHOD(0x00CA8670, EnvironmentLight *, GetCharacterLightAtPos, (app::EnvironmentLightingManager * this_ptr, app::Rect bounds));
...
IL2CPP_REGISTER_METHOD(0x00CA8A50, void, __ctor, (app::EnvironmentLightingManager * this_ptr));
}
