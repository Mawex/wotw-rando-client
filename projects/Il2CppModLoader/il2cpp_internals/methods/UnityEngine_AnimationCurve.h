...
IL2CPP_REGISTER_METHOD(0x02419990, void, __ctor_1, (app::AnimationCurve * this_ptr, app::Keyframe__Array * keys));
IL2CPP_REGISTER_METHOD(0x024199F0, void, __ctor_2, (app::AnimationCurve * this_ptr));
IL2CPP_REGISTER_METHOD(0x02419A50, void, Internal_Destroy, (app::void * ptr));
IL2CPP_REGISTER_METHOD(0x02419AA0, void *, Internal_Create, (app::Keyframe__Array * keys));
IL2CPP_REGISTER_METHOD(0x02419AF0, bool, Internal_Equals, (app::AnimationCurve * this_ptr, app::void * other));
...
IL2CPP_REGISTER_METHOD(0x02419C70, Keyframe__Array *, get_keys, (app::AnimationCurve * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02419E60, Keyframe, get_Item, (app::AnimationCurve * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02419E60, Keyframe, GetKey, (app::AnimationCurve * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x02419C70, Keyframe__Array *, GetKeys, (app::AnimationCurve * this_ptr));
IL2CPP_REGISTER_METHOD(0x02419F60, void, SmoothTangents, (app::AnimationCurve * this_ptr, int32_t index, float weight));
IL2CPP_REGISTER_METHOD(0x02419FD0, AnimationCurve *, Constant, (float time_start, float time_end, float value));
IL2CPP_REGISTER_METHOD(0x0241A000, AnimationCurve *, Linear, (float time_start, float value_start, float time_end, float value_end));
IL2CPP_REGISTER_METHOD(0x0241A390, AnimationCurve *, EaseInOut, (float time_start, float value_start, float time_end, float value_end));
IL2CPP_REGISTER_METHOD(0x0241A6F0, WrapMode__Enum, get_preWrapMode, (app::AnimationCurve * this_ptr));
IL2CPP_REGISTER_METHOD(0x0241A740, void, set_preWrapMode, (app::AnimationCurve * this_ptr, app::WrapMode__Enum value));
IL2CPP_REGISTER_METHOD(0x0241A7A0, WrapMode__Enum, get_postWrapMode, (app::AnimationCurve * this_ptr));
