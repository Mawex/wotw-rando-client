...
IL2CPP_REGISTER_METHOD(0x00B98860, Bounds, get_Bounds, (app::DisableRendererWhenOutOfFrustrum * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00597BB0, void, __ctor, (app::DisableRendererWhenOutOfFrustrum * this_ptr));
}
