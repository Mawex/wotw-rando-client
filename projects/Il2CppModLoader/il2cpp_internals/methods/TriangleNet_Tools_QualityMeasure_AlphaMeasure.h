...
namespace app::methods::TriangleNet_Tools::QualityMeasure_AlphaMeasure {
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::QualityMeasure_AlphaMeasure * this_ptr));
}
