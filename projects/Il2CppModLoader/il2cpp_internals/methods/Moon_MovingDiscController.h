...
IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::MovingDiscController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0111DBE0, IUberState__Array *, get_AffectingUberStates, (app::MovingDiscController * this_ptr));
IL2CPP_REGISTER_METHOD(0x0111DC70, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::MovingDiscController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0111DFB0, void, __ctor, (app::MovingDiscController * this_ptr));
}
