...
namespace app::methods::SoundSource {
    ...
    IL2CPP_REGISTER_METHOD(0x0043D9E0, SelectableCategory__Enum, get_Category, (app::SoundSource * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x003FD3F0, SuspendableMask__Enum, get_Mask, (app::SoundSource * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00597B10, UpdateType__Enum, get_UpdateType, (app::SoundSource * this_ptr));
    IL2CPP_REGISTER_METHOD(0x004FA630, void, __ctor, (app::SoundSource * this_ptr));
