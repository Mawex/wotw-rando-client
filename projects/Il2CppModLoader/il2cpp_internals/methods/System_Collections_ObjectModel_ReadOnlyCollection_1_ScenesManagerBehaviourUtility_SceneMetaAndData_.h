...
namespace app::methods::System_Collections_ObjectModel::ReadOnlyCollection_1_ScenesManagerBehaviourUtility_SceneMetaAndData_ {
IL2CPP_REGISTER_METHOD(0x02B7DCF0, void, __ctor, (app::ReadOnlyCollection_1_ScenesManagerBehaviourUtility_SceneMetaAndData_ * this_ptr, app::IList_1_ScenesManagerBehaviourUtility_SceneMetaAndData_ * list));
...
IL2CPP_REGISTER_METHOD(0x02B7DD70, ScenesManagerBehaviourUtility_SceneMetaAndData, get_Item, (app::ReadOnlyCollection_1_ScenesManagerBehaviourUtility_SceneMetaAndData_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02B7DF30, IEnumerator_1_ScenesManagerBehaviourUtility_SceneMetaAndData_ *, GetEnumerator, (app::ReadOnlyCollection_1_ScenesManagerBehaviourUtility_SceneMetaAndData_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B7DD70, ScenesManagerBehaviourUtility_SceneMetaAndData, System_Collections_Generic_IList_T__get_Item, (app::ReadOnlyCollection_1_ScenesManagerBehaviourUtility_SceneMetaAndData_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02EBDF50, IEnumerator *, IEnumerable_GetEnumerator, (app::ReadOnlyCollection_1_ScenesManagerBehaviourUtility_SceneMetaAndData_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02EBDFE0, Object *, ICollection_get_SyncRoot, (app::ReadOnlyCollection_1_ScenesManagerBehaviourUtility_SceneMetaAndData_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B7E6C0, Object *, IList_get_Item, (app::ReadOnlyCollection_1_ScenesManagerBehaviourUtility_SceneMetaAndData_ * this_ptr, int32_t index));
