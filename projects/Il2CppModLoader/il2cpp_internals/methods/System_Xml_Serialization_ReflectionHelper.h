...
namespace app::methods::System_Xml_Serialization::ReflectionHelper {
...
IL2CPP_REGISTER_METHOD(0x01C8F7C0, XmlTypeMapping *, GetRegisteredSchemaType, (app::ReflectionHelper * this_ptr, app::String * xml_type, app::String * ns));
...
IL2CPP_REGISTER_METHOD(0x01C8FA30, XmlTypeMapping *, GetRegisteredClrType, (app::ReflectionHelper * this_ptr, app::Type * type, app::String * ns));
...
IL2CPP_REGISTER_METHOD(0x01C8FF50, void, __ctor, (app::ReflectionHelper * this_ptr));
