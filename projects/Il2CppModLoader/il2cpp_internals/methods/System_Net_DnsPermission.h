...
namespace app::methods::System_Net::DnsPermission {
IL2CPP_REGISTER_METHOD(0x01EB3EA0, void, __ctor, (app::DnsPermission * this_ptr, app::PermissionState__Enum state));
IL2CPP_REGISTER_METHODINFO(0x04709D30, DnsPermission__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01EB3ED0, IPermission *, Copy, (app::DnsPermission * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01EB3F30, IPermission *, Intersect, (app::DnsPermission * this_ptr, app::IPermission * target));
...
IL2CPP_REGISTER_METHOD(0x01EB3FC0, SecurityElement *, ToXml, (app::DnsPermission * this_ptr));
