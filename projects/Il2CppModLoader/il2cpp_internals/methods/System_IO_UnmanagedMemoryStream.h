...
namespace app::methods::System_IO::UnmanagedMemoryStream {
    ...
    IL2CPP_REGISTER_METHOD(0x023895E0, void, __ctor_2, (app::UnmanagedMemoryStream * this_ptr, uint8_t * pointer, int64_t length));
    IL2CPP_REGISTER_METHOD(0x023896C0, void, __ctor_3, (app::UnmanagedMemoryStream * this_ptr, uint8_t * pointer, int64_t length, int64_t capacity, app::FileAccess__Enum access, bool skip_security_check));
