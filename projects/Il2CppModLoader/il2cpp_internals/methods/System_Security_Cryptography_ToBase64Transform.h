...
namespace app::methods::System_Security_Cryptography::ToBase64Transform {
...
IL2CPP_REGISTER_METHOD(0x01E11CC0, Byte__Array *, TransformFinalBlock, (app::ToBase64Transform * this_ptr, app::Byte__Array * input_buffer, int32_t input_offset, int32_t input_count));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::ToBase64Transform * this_ptr));
}
