...
namespace app::methods::GhostPlayer {
    IL2CPP_REGISTER_METHOD(0x002FBC40, String*, get_GhostReplay, (app::GhostPlayer * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x007DBE90, GhostRecordingMetaDataData*, get_MetaData, (app::GhostPlayer * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x006B90B0, SuspendableMask__Enum, get_Mask, (app::GhostPlayer * this_ptr));
    IL2CPP_REGISTER_METHOD(0x007DE890, void, set_Mask, (app::GhostPlayer * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x007DE950, CharacterStatePuppet*, GetPuppet, (app::GhostPlayer * this_ptr, int32_t id));
    IL2CPP_REGISTER_METHOD(0x007DEA50, RecordableObjectPuppet*, CreateRecordableObjectPuppet, (app::GhostPlayer * this_ptr, int32_t id, int32_t recording_id));
    ...
    IL2CPP_REGISTER_METHOD(0x007DED50, IGhostFrameData*, GetFrameDataFast, (app::GhostPlayer * this_ptr, int32_t frame, app::GhostFrame_FrameDataTypes__Enum typ));
    IL2CPP_REGISTER_METHOD(0x007DEE70, GhostCharacterData*, get_CurrentGhostCharacterData, (app::GhostPlayer * this_ptr));
    IL2CPP_REGISTER_METHOD(0x007DEF20, void, ResetGhostCharacterData, (app::GhostPlayer * this_ptr));
    IL2CPP_REGISTER_METHOD(0x007DEF30, Vector3, get_Position, (app::GhostPlayer * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x007DF0B0, Vector2, get_LocalSpeed, (app::GhostPlayer * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00506170, Transform*, get_Transform, (app::GhostPlayer * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00418200, CharacterAnimationSystem*, get_Animation, (app::GhostPlayer * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0049F2B0, MoonAnimator*, get_Animator, (app::GhostPlayer * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0065FBE0, SoundHost*, get_SoundHost, (app::GhostPlayer * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x007DF1D0, void, __ctor, (app::GhostPlayer * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __cctor, ());
    IL2CPP_REGISTER_METHOD(0x015EA340, Object*, GetPlugin_1, (app::GhostPlayer * this_ptr));
    IL2CPP_REGISTER_METHOD(0x015EA250, Object*, GetFrameData, (app::GhostPlayer * this_ptr, int32_t frame));
    IL2CPP_REGISTER_METHOD(0x01EB8750, List_1_System_Object_*, GetFrameDatas, (app::GhostPlayer * this_ptr, int32_t frame));
    IL2CPP_REGISTER_METHOD(0x015EA340, GhostGenericEventsPlugin*, GetPlugin_2, (app::GhostPlayer * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x04768970, GhostPlayer_GetPlugin_1__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x015EA340, GhostCharacterPlugin*, GetPlugin_3, (app::GhostPlayer * this_ptr));
