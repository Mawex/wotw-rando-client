...
IL2CPP_REGISTER_METHOD(0x002FBC80, Texture *, get_LastMainTexture, (app::CustomizeMaterial * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00DBD4D0, void, __ctor, (app::CustomizeMaterial * this_ptr));
}
