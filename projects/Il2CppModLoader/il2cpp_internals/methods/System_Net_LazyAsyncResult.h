...
namespace app::methods::System_Net::LazyAsyncResult {
IL2CPP_REGISTER_METHOD(0x01E6B520, LazyAsyncResult_ThreadContext *, get_CurrentThreadContext, ());
IL2CPP_REGISTER_METHOD(0x01E6B6E0, void, __ctor_1, (app::LazyAsyncResult * this_ptr, app::Object * my_object, app::Object * my_state, app::AsyncCallback * my_call_back));
IL2CPP_REGISTER_METHOD(0x01E6B7C0, void, __ctor_2, (app::LazyAsyncResult * this_ptr, app::Object * my_object, app::Object * my_state, app::AsyncCallback * my_call_back, app::Object * result));
IL2CPP_REGISTER_METHOD(0x002FA280, Object *, get_AsyncObject, (app::LazyAsyncResult * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, Object *, get_AsyncState, (app::LazyAsyncResult * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB950, AsyncCallback *, get_AsyncCallback, (app::LazyAsyncResult * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB960, void, set_AsyncCallback, (app::LazyAsyncResult * this_ptr, app::AsyncCallback * value));
IL2CPP_REGISTER_METHOD(0x01E6B7F0, WaitHandle *, get_AsyncWaitHandle, (app::LazyAsyncResult * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E6BB80, Object *, get_Result, (app::LazyAsyncResult * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E6BC50, void, ProtectedInvokeCallback, (app::LazyAsyncResult * this_ptr, app::Object * result, app::void * user_token));
...
IL2CPP_REGISTER_METHOD(0x01E6BF20, void, Complete, (app::LazyAsyncResult * this_ptr, app::void * user_token));
...
IL2CPP_REGISTER_METHOD(0x01E6C260, Object *, InternalWaitForCompletion, (app::LazyAsyncResult * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E6C270, Object *, WaitForCompletion, (app::LazyAsyncResult * this_ptr, bool snap));
