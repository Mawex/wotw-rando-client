...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::Browser_JSCallback * this_ptr, app::Object * object, app::void * method_1));
IL2CPP_REGISTER_METHOD(0x00673B90, void, Invoke, (app::Browser_JSCallback * this_ptr, app::JSONNode * args));
IL2CPP_REGISTER_METHOD(0x00674080, IAsyncResult *, BeginInvoke, (app::Browser_JSCallback * this_ptr, app::JSONNode * args, app::AsyncCallback * callback, app::Object * object));
