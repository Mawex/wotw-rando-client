...
namespace app::methods::System_Net::AuthenticationManager {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::AuthenticationManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0200F460, Authorization *, Authenticate, (app::String * challenge, app::WebRequest * request, app::ICredentials * credentials));
IL2CPP_REGISTER_METHODINFO(0x0471F160, AuthenticationManager_Authenticate__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0200F5C0, Authorization *, DoAuthenticate, (app::String * challenge, app::WebRequest * request, app::ICredentials * credentials));
IL2CPP_REGISTER_METHOD(0x0200F8E0, Authorization *, PreAuthenticate, (app::WebRequest * request, app::ICredentials * credentials));
