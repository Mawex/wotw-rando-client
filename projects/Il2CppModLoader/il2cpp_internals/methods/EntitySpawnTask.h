...
IL2CPP_REGISTER_METHOD(0x002FBC00, EntitySpawnSetup *, get_SpawnSetup, (app::EntitySpawnTask * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CA23D0, void, __ctor, (app::EntitySpawnTask * this_ptr));
