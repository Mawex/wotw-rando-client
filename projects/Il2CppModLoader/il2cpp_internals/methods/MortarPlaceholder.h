...
IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, IsUsingVariations, (MortarPlaceholder * __this));
IL2CPP_REGISTER_METHOD(0x0147E080, MortarEntity *, get_CurrentEntity, (MortarPlaceholder * __this));
IL2CPP_REGISTER_METHOD(0x0147E140, float, get_MaxSpitRangeEx, (MortarPlaceholder * __this));
