...
namespace app::methods::SystemIntegration_Synchronizer_Achievements::SteamAchievements {
IL2CPP_REGISTER_METHOD(0x0052E6A0, String *, get_Name, (app::SteamAchievements * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB930, CacheData__Array *, AwardedOnServer, (app::SteamAchievements * this_ptr));
