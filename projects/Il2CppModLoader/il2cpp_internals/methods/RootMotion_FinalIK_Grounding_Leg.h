...
namespace app::methods::RootMotion_FinalIK::Grounding_Leg {
...
IL2CPP_REGISTER_METHOD(0x02071CD0, Vector3, get_IKPosition, (app::Grounding_Leg * this_ptr));
IL2CPP_REGISTER_METHOD(0x02071CF0, void, set_IKPosition, (app::Grounding_Leg * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x01746A40, Quaternion, get_rotationOffset, (app::Grounding_Leg * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0168C6F0, Vector3, get_velocity, (app::Grounding_Leg * this_ptr));
IL2CPP_REGISTER_METHOD(0x02071D10, void, set_velocity, (app::Grounding_Leg * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x002FB9F0, Transform *, get_transform, (app::Grounding_Leg * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02073210, RaycastHit, GetCapsuleHit, (app::Grounding_Leg * this_ptr, app::Vector3 offset_from_heel));
IL2CPP_REGISTER_METHOD(0x02073610, RaycastHit, GetRaycastHit, (app::Grounding_Leg * this_ptr, app::Vector3 offset_from_heel));
IL2CPP_REGISTER_METHOD(0x02073A20, Vector3, RotateNormal, (app::Grounding_Leg * this_ptr, app::Vector3 normal));
...
IL2CPP_REGISTER_METHOD(0x020746E0, Quaternion, GetRotationOffsetTarget, (app::Grounding_Leg * this_ptr));
IL2CPP_REGISTER_METHOD(0x02074860, float, get_rootYOffset, (app::Grounding_Leg * this_ptr));
IL2CPP_REGISTER_METHOD(0x02074AC0, void, __ctor, (app::Grounding_Leg * this_ptr));
}
