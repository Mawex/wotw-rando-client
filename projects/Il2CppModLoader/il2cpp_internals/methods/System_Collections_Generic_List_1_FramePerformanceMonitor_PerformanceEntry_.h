...
namespace app::methods::System_Collections_Generic::List_1_FramePerformanceMonitor_PerformanceEntry_ {
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_FramePerformanceMonitor_PerformanceEntry_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_FramePerformanceMonitor_PerformanceEntry_, GetEnumerator, (app::List_1_FramePerformanceMonitor_PerformanceEntry_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04727150, List_1_FramePerformanceMonitor_PerformanceEntry__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02FE8360, void, __ctor_2, (app::List_1_FramePerformanceMonitor_PerformanceEntry_ * this_ptr, app::IEnumerable_1_FramePerformanceMonitor_PerformanceEntry_ * collection));
