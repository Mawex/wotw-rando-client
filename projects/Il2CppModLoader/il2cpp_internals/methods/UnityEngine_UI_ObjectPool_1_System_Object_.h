...
namespace app::methods::UnityEngine_UI::ObjectPool_1_System_Object_ {
...
IL2CPP_REGISTER_METHOD(0x02ACEDE0, void, __ctor, (app::ObjectPool_1_System_Object_ * this_ptr, app::UnityAction_1_System_Object_ * action_on_get, app::UnityAction_1_System_Object_ * action_on_release));
IL2CPP_REGISTER_METHOD(0x02ACEFA0, Object *, Get, (app::ObjectPool_1_System_Object_ * this_ptr));
