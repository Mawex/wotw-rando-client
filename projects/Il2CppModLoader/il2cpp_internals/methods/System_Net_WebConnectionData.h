...
namespace app::methods::System_Net::WebConnectionData {
...
IL2CPP_REGISTER_METHOD(0x002FA280, HttpWebRequest *, get_request, (app::WebConnectionData * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_request, (app::WebConnectionData * this_ptr, app::HttpWebRequest * value));
IL2CPP_REGISTER_METHOD(0x002FD490, ReadState__Enum, get_ReadState, (app::WebConnectionData * this_ptr));
