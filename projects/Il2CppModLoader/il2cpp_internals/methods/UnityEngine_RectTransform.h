...
IL2CPP_REGISTER_METHOD(0x0296EAB0, Rect, get_rect, (app::RectTransform * this_ptr));
IL2CPP_REGISTER_METHOD(0x0296EB30, Vector2, get_anchorMin, (app::RectTransform * this_ptr));
IL2CPP_REGISTER_METHOD(0x0296EBA0, void, set_anchorMin, (app::RectTransform * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x0296EC00, Vector2, get_anchorMax, (app::RectTransform * this_ptr));
IL2CPP_REGISTER_METHOD(0x0296EC70, void, set_anchorMax, (app::RectTransform * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x0296ECD0, Vector2, get_anchoredPosition, (app::RectTransform * this_ptr));
IL2CPP_REGISTER_METHOD(0x0296ED40, void, set_anchoredPosition, (app::RectTransform * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x0296EDA0, Vector2, get_sizeDelta, (app::RectTransform * this_ptr));
IL2CPP_REGISTER_METHOD(0x0296EE10, void, set_sizeDelta, (app::RectTransform * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x0296EE70, Vector2, get_pivot, (app::RectTransform * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02970260, Vector2, GetParentSize, (app::RectTransform * this_ptr));
