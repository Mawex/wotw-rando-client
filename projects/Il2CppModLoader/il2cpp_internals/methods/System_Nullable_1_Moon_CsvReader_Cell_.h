...
IL2CPP_REGISTER_METHOD(0x001F4760, CsvReader_Cell, get_Value, (app::Nullable_1_Moon_CsvReader_Cell___Boxed * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04772920, Nullable_1_Moon_CsvReader_Cell__get_Value__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00120520, void, __ctor, (app::Nullable_1_Moon_CsvReader_Cell___Boxed * this_ptr, app::CsvReader_Cell value));
...
IL2CPP_REGISTER_METHOD(0x0010A980, CsvReader_Cell, GetValueOrDefault_1, (app::Nullable_1_Moon_CsvReader_Cell___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001F49C0, CsvReader_Cell, GetValueOrDefault_2, (app::Nullable_1_Moon_CsvReader_Cell___Boxed * this_ptr, app::CsvReader_Cell default_value));
IL2CPP_REGISTER_METHOD(0x001F49F0, String *, ToString, (app::Nullable_1_Moon_CsvReader_Cell___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0254E8A0, Object *, Box, (app::Nullable_1_Moon_CsvReader_Cell_ o));
IL2CPP_REGISTER_METHOD(0x0254E930, Nullable_1_Moon_CsvReader_Cell_, Unbox, (app::Object * o));
}
