...
IL2CPP_REGISTER_METHOD(0x01C59320, XboxOneRichPresence_Level__Enum, MapAreaNameToLevel, (app::String * area_name));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::XboxOneRichPresence * this_ptr));
IL2CPP_REGISTER_METHOD(0x01C59740, void, __cctor, ());
}
