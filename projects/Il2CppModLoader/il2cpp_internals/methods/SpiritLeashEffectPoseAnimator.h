...
IL2CPP_REGISTER_METHOD(0x00D5CB10, Vector3, get_TargetPosition, (app::SpiritLeashEffectPoseAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D5CC90, Transform *, get_HandTransform, (app::SpiritLeashEffectPoseAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D5EA90, void, __ctor, (app::SpiritLeashEffectPoseAnimator * this_ptr));
}
