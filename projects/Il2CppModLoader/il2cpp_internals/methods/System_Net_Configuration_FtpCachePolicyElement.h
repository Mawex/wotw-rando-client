...
namespace app::methods::System_Net_Configuration::FtpCachePolicyElement {
IL2CPP_REGISTER_METHOD(0x020193E0, void, __ctor, (app::FtpCachePolicyElement * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04742AB0, FtpCachePolicyElement__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02019410, RequestCacheLevel__Enum, get_PolicyLevel, (app::FtpCachePolicyElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02019470, ConfigurationPropertyCollection *, get_Properties, (app::FtpCachePolicyElement * this_ptr));
