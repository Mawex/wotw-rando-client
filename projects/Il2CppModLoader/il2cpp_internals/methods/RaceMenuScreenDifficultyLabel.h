...
IL2CPP_REGISTER_METHOD(0x0070D290, MessageDescriptor, DifficultyModeToMessage, (app::RaceMenuScreenDifficultyLabel * this_ptr, app::DifficultyMode__Enum difficulty));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::RaceMenuScreenDifficultyLabel * this_ptr));
}
