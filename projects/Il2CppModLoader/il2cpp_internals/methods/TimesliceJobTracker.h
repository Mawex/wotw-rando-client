...
IL2CPP_REGISTER_METHOD(0x00AF3960, String *, get_TestName, (app::TimesliceJobTracker * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00AF4260, String *, CollectData, (app::TimesliceJobTracker * this_ptr));
IL2CPP_REGISTER_METHOD(0x00AF43E0, String *, get_CSVHeader, (app::TimesliceJobTracker * this_ptr));
IL2CPP_REGISTER_METHOD(0x0043D9E0, TestTagHelper_TestTypeTag__Enum, get_Tag, (app::TimesliceJobTracker * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::TimesliceJobTracker * this_ptr));
}
