...
namespace app::methods::System_Collections_Generic::GenericEqualityComparer_1_UnityEngine_UI_Navigation_ {
...
IL2CPP_REGISTER_METHOD(0x0225BDA0, void, __ctor, (app::GenericEqualityComparer_1_UnityEngine_UI_Navigation_ * this_ptr));
}
