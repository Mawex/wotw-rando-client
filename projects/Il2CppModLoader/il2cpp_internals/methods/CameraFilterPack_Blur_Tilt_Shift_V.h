...
IL2CPP_REGISTER_METHOD(0x024D74D0, Material *, get_material, (app::CameraFilterPack_Blur_Tilt_Shift_V * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024D68B0, void, __ctor, (app::CameraFilterPack_Blur_Tilt_Shift_V * this_ptr));
}
