...
namespace app::methods::Moon_Rendering::ClearSettings {
    ...
    IL2CPP_REGISTER_METHOD(0x0011D650, void, __ctor, (app::ClearSettings__Boxed * this_ptr, app::ClearFlags__Enum flags, app::Color color, float depth));
    IL2CPP_REGISTER_METHOD(0x00C53830, app::ClearSettings, operator_, (app::ClearFlags__Enum flags));
}
