...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::BrowserNative_Calltype_zfb_mouseMove * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x01C7CC00, IAsyncResult *, BeginInvoke, (app::BrowserNative_Calltype_zfb_mouseMove * this_ptr, int32_t id, float x, float y, app::AsyncCallback * callback, app::Object * object));
