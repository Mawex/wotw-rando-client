...
namespace app::methods::KwolokBossTendrilStrikeBehaviour_StabInState {
    IL2CPP_REGISTER_METHOD(0x012F0720, void, __ctor, (app::KwolokBossTendrilStrikeBehaviour_StabInState * this_ptr, app::KwolokBossTendrilStrikeBehaviour * behaviour));
