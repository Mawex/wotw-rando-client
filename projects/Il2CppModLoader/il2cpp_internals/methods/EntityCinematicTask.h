...
IL2CPP_REGISTER_METHOD(0x002FB9B0, EntityCinematicData *, get_Data, (app::EntityCinematicTask * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9C0, void, set_Data, (app::EntityCinematicTask * this_ptr, app::EntityCinematicData * value));
IL2CPP_REGISTER_METHOD(0x002FC6D0, BehaviourStatus__Enum, get_TaskStatus, (app::EntityCinematicTask * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FC6E0, void, set_TaskStatus, (app::EntityCinematicTask * this_ptr, app::BehaviourStatus__Enum value));
IL2CPP_REGISTER_METHOD(0x002FB9D0, Nullable_1_Moon_BehaviourSystem_BehaviourStatus_, get_ForceReturnTaskStatus, (app::EntityCinematicTask * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C8D3F0, BehaviourStatus__Enum, OnExecuteTask, (app::EntityCinematicTask * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00C8D6A0, void, __ctor, (app::EntityCinematicTask * this_ptr));
}
