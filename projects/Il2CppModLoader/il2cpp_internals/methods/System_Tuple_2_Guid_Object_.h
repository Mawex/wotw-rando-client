...
IL2CPP_REGISTER_METHOD(0x01349560, Guid, get_Item1, (app::Tuple_2_Guid_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB950, Object *, get_Item2, (app::Tuple_2_Guid_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A63920, void, __ctor, (app::Tuple_2_Guid_Object_ * this_ptr, app::Guid item1, app::Object * item2));
...
IL2CPP_REGISTER_METHOD(0x02A64090, String *, ToString, (app::Tuple_2_Guid_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A64210, String *, ITupleInternal_ToString, (app::Tuple_2_Guid_Object_ * this_ptr, app::StringBuilder * sb));
}
