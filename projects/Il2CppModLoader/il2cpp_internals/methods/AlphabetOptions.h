...
IL2CPP_REGISTER_METHOD(0x002FBBE0, String *, get_CurrentlySelected, (app::AlphabetOptions * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004F6C70, void, __ctor, (app::AlphabetOptions * this_ptr));
