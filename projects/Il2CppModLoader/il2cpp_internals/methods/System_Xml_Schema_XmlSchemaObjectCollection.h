...
namespace app::methods::System_Xml_Schema::XmlSchemaObjectCollection {
IL2CPP_REGISTER_METHOD(0x01C9A650, void, __ctor, (app::XmlSchemaObjectCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CB68C0, XmlSchemaObject *, get_Item, (app::XmlSchemaObjectCollection * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x01CB6A60, XmlSchemaObjectEnumerator *, GetEnumerator, (app::XmlSchemaObjectCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01CB6E80, XmlSchemaObjectCollection *, Clone, (app::XmlSchemaObjectCollection * this_ptr));
