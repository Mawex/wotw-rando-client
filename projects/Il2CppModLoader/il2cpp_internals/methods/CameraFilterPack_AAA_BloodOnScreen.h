...
IL2CPP_REGISTER_METHOD(0x0273A7E0, Material *, get_material, (app::CameraFilterPack_AAA_BloodOnScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0273B0B0, void, __ctor, (app::CameraFilterPack_AAA_BloodOnScreen * this_ptr));
}
