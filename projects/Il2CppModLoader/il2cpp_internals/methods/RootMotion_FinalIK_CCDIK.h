...
namespace app::methods::RootMotion_FinalIK::CCDIK {
...
IL2CPP_REGISTER_METHOD(0x002FBB60, IKSolver *, GetIKSolver, (app::CCDIK * this_ptr));
IL2CPP_REGISTER_METHOD(0x02051AC0, void, __ctor, (app::CCDIK * this_ptr));
}
