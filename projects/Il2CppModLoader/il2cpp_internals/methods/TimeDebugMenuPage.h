...
IL2CPP_REGISTER_METHOD(0x002FB9B0, String *, get_Name, (app::TimeDebugMenuPage * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010EF5E0, void, __ctor, (app::TimeDebugMenuPage * this_ptr));
