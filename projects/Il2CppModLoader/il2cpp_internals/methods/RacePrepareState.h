...
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::RacePrepareState * this_ptr, app::RaceSystem * race_system));
...
IL2CPP_REGISTER_METHOD(0x007148C0, IEnumerator *, ShowFlythroughUi, (app::RacePrepareState * this_ptr));
