...
IL2CPP_REGISTER_METHOD(0x020E4340, Material *, get_material, (app::CameraFilterPack_TV_ARCADE_2 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E4C90, void, __ctor, (app::CameraFilterPack_TV_ARCADE_2 * this_ptr));
}
