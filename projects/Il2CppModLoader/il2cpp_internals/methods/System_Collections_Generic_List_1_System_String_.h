...
namespace app::methods::System_Collections_Generic::List_1_System_String_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_System_String_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, String__Array *, ToArray, (app::List_1_System_String_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EFC50, String *, get_Item, (app::List_1_System_String_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_System_String_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_System_String_, GetEnumerator, (app::List_1_System_String_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02FE8360, void, __ctor_3, (app::List_1_System_String_ * this_ptr, app::IEnumerable_1_System_String_ * collection));
