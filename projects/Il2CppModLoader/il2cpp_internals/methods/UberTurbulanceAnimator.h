...
IL2CPP_REGISTER_METHOD(0x00420EE0, TurbulenceInfluencerOrder__Enum, get_TurbulenceApplyOrder, (app::UberTurbulanceAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01292110, void, __ctor, (app::UberTurbulanceAnimator * this_ptr));
}
