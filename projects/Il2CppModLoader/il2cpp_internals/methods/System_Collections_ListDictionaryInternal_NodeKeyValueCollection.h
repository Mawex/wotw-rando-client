...
namespace app::methods::System_Collections::ListDictionaryInternal_NodeKeyValueCollection {
IL2CPP_REGISTER_METHOD(0x01669060, void, __ctor, (app::ListDictionaryInternal_NodeKeyValueCollection * this_ptr, app::ListDictionaryInternal * list, bool is_keys));
...
IL2CPP_REGISTER_METHOD(0x0202A9F0, Object *, ICollection_get_SyncRoot, (app::ListDictionaryInternal_NodeKeyValueCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x0202AB50, IEnumerator *, IEnumerable_GetEnumerator, (app::ListDictionaryInternal_NodeKeyValueCollection * this_ptr));
}
