...
namespace app::methods::System_Collections_Generic::LinkedList_1_System_WeakReference_ {
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::LinkedList_1_System_WeakReference_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0473A018, LinkedList_1_System_WeakReference___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x018E6FE0, LinkedListNode_1_System_WeakReference_ *, AddLast_1, (app::LinkedList_1_System_WeakReference_ * this_ptr, app::WeakReference * value));
...
IL2CPP_REGISTER_METHOD(0x002FA280, LinkedListNode_1_System_WeakReference_ *, get_First, (app::LinkedList_1_System_WeakReference_ * this_ptr));
