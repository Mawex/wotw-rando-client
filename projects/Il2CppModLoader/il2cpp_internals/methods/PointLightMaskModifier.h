...
IL2CPP_REGISTER_METHOD(0x0142FB20, Color, get_LightColor, (app::PointLightMaskModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBD40, Renderer *, get_CachedRenderer, (app::PointLightMaskModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD60, MeshFilter *, get_MeshFilter, (app::PointLightMaskModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01430D90, void, __ctor, (app::PointLightMaskModifier * this_ptr));
