...
IL2CPP_REGISTER_METHOD(0x0069C710, IEnumerator *, Start, (app::GameControllerLate * this_ptr));
IL2CPP_REGISTER_METHOD(0x0069C860, void, OnDestroy, (app::GameControllerLate * this_ptr));
IL2CPP_REGISTER_METHOD(0x0069C890, IEnumerator *, OnEndOfFrame, (app::GameControllerLate * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0069CEC0, void, __ctor, (app::GameControllerLate * this_ptr));
