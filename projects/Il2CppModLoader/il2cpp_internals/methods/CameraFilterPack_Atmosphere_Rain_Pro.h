...
IL2CPP_REGISTER_METHOD(0x02740410, Material *, get_material, (app::CameraFilterPack_Atmosphere_Rain_Pro * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02740D40, void, __ctor, (app::CameraFilterPack_Atmosphere_Rain_Pro * this_ptr));
}
