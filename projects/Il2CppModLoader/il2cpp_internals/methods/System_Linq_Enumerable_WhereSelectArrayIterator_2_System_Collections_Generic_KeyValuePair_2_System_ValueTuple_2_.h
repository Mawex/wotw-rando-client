...
namespace app::methods::System_Linq::Enumerable_WhereSelectArrayIterator_2_System_Collections_Generic_KeyValuePair_2_System_ValueTuple_2_ {
    IL2CPP_REGISTER_METHOD(0x02894D90, void, __ctor, (app::Enumerable_WhereSelectArrayIterator_2_System_Collections_Generic_KeyValuePair_2_System_ValueTuple_2_ * this_ptr, app::KeyValuePair_2_System_Object_System_ValueTuple_2___Array * source, app::Func_2_System_Collections_Generic_KeyValuePair_2_Boolean__5 * predicate, app::Func_2_System_Collections_Generic_KeyValuePair_2_ValueTuple_2_Int32_Object_ * selector));
