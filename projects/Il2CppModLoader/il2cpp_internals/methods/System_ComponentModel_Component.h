...
namespace app::methods::System_ComponentModel::Component {
...
IL2CPP_REGISTER_METHOD(0x024A8F00, EventHandlerList *, get_Events, (app::Component * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, ISite *, get_Site, (app::Component * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024A9360, IContainer *, get_Container, (app::Component * this_ptr));
IL2CPP_REGISTER_METHOD(0x024A9400, Object *, GetService, (app::Component * this_ptr, app::Type * service));
IL2CPP_REGISTER_METHOD(0x024A94B0, bool, get_DesignMode, (app::Component * this_ptr));
IL2CPP_REGISTER_METHOD(0x024A9550, String *, ToString, (app::Component * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::Component * this_ptr));
