...
IL2CPP_REGISTER_METHOD(0x024F6E30, Material *, get_material, (app::CameraFilterPack_Drawing_Manga_FlashWhite * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024F6E00, void, __ctor, (app::CameraFilterPack_Drawing_Manga_FlashWhite * this_ptr));
}
