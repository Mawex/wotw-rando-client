...
IL2CPP_REGISTER_METHOD(0x00107C00, Object *, get_Context, (app::StreamingContext__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0010A860, StreamingContextStates__Enum, get_State, (app::StreamingContext__Boxed * this_ptr));
}
