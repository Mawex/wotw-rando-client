...
IL2CPP_REGISTER_METHOD(0x012E8C30, void, ModifyLookAngleChangeSpeed, (app::KwolokBossProjectileFlurryBehaviour * this_ptr, app::float * speed));
IL2CPP_REGISTER_METHODINFO(0x047294C8, KwolokBossProjectileFlurryBehaviour_ModifyLookAngleChangeSpeed__MethodInfo);
IL2CPP_REGISTER_METHOD(0x012E8C50, BehaviourStatus__Enum, OnExecute, (app::KwolokBossProjectileFlurryBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x012E9950, void, __ctor, (app::KwolokBossProjectileFlurryBehaviour * this_ptr));
}
