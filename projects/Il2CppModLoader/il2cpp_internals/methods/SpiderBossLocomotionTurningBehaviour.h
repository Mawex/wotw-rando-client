...
IL2CPP_REGISTER_METHOD(0x011B6B40, SpiderBossEntity *, get_SpiderBoss, (app::SpiderBossLocomotionTurningBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011B73A0, void, __ctor, (app::SpiderBossLocomotionTurningBehaviour * this_ptr));
}
