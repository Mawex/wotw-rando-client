...
IL2CPP_REGISTER_METHOD(0x026D4AA0, void, Finalize, (AkCallbackManager_EventCallbackPackage * __this));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (AkCallbackManager_EventCallbackPackage * __this));
}
