...
IL2CPP_REGISTER_METHOD(0x002FB9B0, HttpWebRequest *, get_Request, (app::WebConnectionStream * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB990, WebConnection *, get_Connection, (app::WebConnectionStream * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D6B670, Byte__Array *, get_WriteBuffer, (app::WebConnectionStream * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D6C130, IAsyncResult *, BeginRead, (app::WebConnectionStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t size, app::AsyncCallback * cb, app::Object * state));
...
IL2CPP_REGISTER_METHOD(0x01D6CD90, IAsyncResult *, BeginWrite, (app::WebConnectionStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t size, app::AsyncCallback * cb, app::Object * state));
...
IL2CPP_REGISTER_METHOD(0x01D6E6C0, SimpleAsyncResult *, WriteRequestAsync_1, (app::WebConnectionStream * this_ptr, app::SimpleAsyncCallback * callback));
