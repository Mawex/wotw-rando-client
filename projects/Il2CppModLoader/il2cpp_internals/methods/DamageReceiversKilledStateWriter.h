...
IL2CPP_REGISTER_METHOD(0x00DC9510, IDesiredUberState *, GetRequirementsForTimeline, (app::DamageReceiversKilledStateWriter * this_ptr, app::MoonTimeline * timeline));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::DamageReceiversKilledStateWriter * this_ptr));
}
