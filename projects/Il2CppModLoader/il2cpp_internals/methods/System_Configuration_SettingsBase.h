...
namespace app::methods::System_Configuration::SettingsBase {
IL2CPP_REGISTER_METHOD(0x02962950, void, __ctor, (app::SettingsBase * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0477FE60, SettingsBase__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02962980, SettingsContext *, get_Context, (app::SettingsBase * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x029629E0, Object *, get_Item, (app::SettingsBase * this_ptr, app::String * property_name));
...
IL2CPP_REGISTER_METHOD(0x02962A40, SettingsPropertyCollection *, get_Properties, (app::SettingsBase * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04771900, SettingsBase_get_Properties__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02962A70, SettingsPropertyValueCollection *, get_PropertyValues, (app::SettingsBase * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04701848, SettingsBase_get_PropertyValues__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02962AA0, SettingsProviderCollection *, get_Providers, (app::SettingsBase * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02962B30, SettingsBase *, Synchronized, (app::SettingsBase * settings_base));
