...
IL2CPP_REGISTER_METHOD(0x013D5840, TurbulenceManager *, get_Manager, (app::TurbulenceTimelineAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x013D60E0, void, __ctor, (app::TurbulenceTimelineAnimator * this_ptr));
}
