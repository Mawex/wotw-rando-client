...
namespace app::methods::Cart {
    IL2CPP_REGISTER_METHOD(0x00B29A80, Rect, get_WorldRectBounds, (app::Cart * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00B29C50, Rail*, get_CurrentRail, (app::Cart * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0068D630, GameObject*, get_CarryingObj, (app::Cart * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00813FA0, Collider__Array*, get_CarryingColliders, (app::Cart * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00756A30, Transform*, get_CachedTransform, (app::Cart * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00B29D40, Vector3, get_Forward, (app::Cart * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00B29F10, Collider__Array*, get_Colliders, (app::Cart * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00B29FB0, Transform*, get_AttachPoint, (app::Cart * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00420EE0, RideableTypes__Enum, get_RideableType, (app::Cart * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBCA0, PlatformBehaviour*, get_SourcePlatformBehaviour, (app::Cart * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00B2A010, Action_1_Single_*, get_OnJump, (app::Cart * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00B2A180, CartBody*, get_Body, (app::Cart * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00B2A190, CartAnimation*, get_Animation, (app::Cart * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00B2A4B0, ISoundHost*, get_SoundHost, (app::Cart * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00B2B880, Rail*, GetCurrentRail, (app::Cart * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00B2F070, Enemy*, RaycastEnemy, (app::Cart * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00B31590, IDamageReciever__Array*, get_AffectedReceivers, (app::Cart * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00B315A0, void, __ctor, (app::Cart * this_ptr));
    IL2CPP_REGISTER_METHOD(0x004F4750, GameObject*, IDamageReciever_get_gameObject, (app::Cart * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00506170, Transform*, IDamageReciever_get_transform, (app::Cart * this_ptr));
} // namespace app::methods::Cart
