...
IL2CPP_REGISTER_METHOD(0x013D4130, Vector3, get_PostPosition, (app::VerticalCameraSettingsZone * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9D0, CameraSettings *, get_Settings, (app::VerticalCameraSettingsZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, PostProcessInfluencerOrder__Enum, get_PostInfluenceApplyOrder, (app::VerticalCameraSettingsZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x013D4320, CameraSettingsAsset *, get_SettingsAssetForDebug, (app::VerticalCameraSettingsZone * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x013D56D0, void, __ctor, (app::VerticalCameraSettingsZone * this_ptr));
}
