...
IL2CPP_REGISTER_METHOD(0x0159F1D0, Vector2, GetVelocityAtPoint, (app::MetaBallWaterZone * this_ptr, app::Vector2 point));
IL2CPP_REGISTER_METHOD(0x00417870, bool, Contains, (app::MetaBallWaterZone * this_ptr, app::Vector3 position));
IL2CPP_REGISTER_METHOD(0x0159F4A0, void, __ctor, (app::MetaBallWaterZone * this_ptr));
IL2CPP_REGISTER_METHOD(0x0159F4F0, void, __cctor, ());
}
