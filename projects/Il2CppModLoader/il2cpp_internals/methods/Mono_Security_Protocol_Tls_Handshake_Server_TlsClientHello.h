...
namespace app::methods::Mono_Security_Protocol_Tls_Handshake_Server::TlsClientHello {
    IL2CPP_REGISTER_METHOD(0x01F73030, void, __ctor, (app::TlsClientHello * this_ptr, app::Context_1 * context, app::Byte__Array * buffer));
