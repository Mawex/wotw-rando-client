...
namespace app::methods::Steamworks::HServerListRequest {
    IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor, (app::HServerListRequest__Boxed * this_ptr, void * value));
    ...
    IL2CPP_REGISTER_METHOD(0x004C50A0, app::HServerListRequest, operator__1, (void * value));
