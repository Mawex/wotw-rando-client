...
IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement *, get_PlatformMovement, (app::SeinFirewhirlSpell * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00AE08B0, void, __ctor, (app::SeinFirewhirlSpell * this_ptr));
}
