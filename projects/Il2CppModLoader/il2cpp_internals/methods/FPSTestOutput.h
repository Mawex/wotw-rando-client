...
namespace app::methods::FPSTestOutput {
    IL2CPP_REGISTER_METHOD(0x0098DE70, void, __ctor, (app::FPSTestOutput * this_ptr, app::String* output_file_name));
    ...
    IL2CPP_REGISTER_METHOD(0x002FB930, String*, GetOutputPath, (app::FPSTestOutput * this_ptr));
