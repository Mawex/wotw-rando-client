...
namespace app::methods::Moon_Wwise::WwiseGameObjectSystem {
...
IL2CPP_REGISTER_METHOD(0x027157C0, ArtificialSoundHost *, GetFreeSoundHost, (app::WwiseGameObjectSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x02715900, ArtificialSoundHostReference, Allocate, (app::WwiseGameObjectSystem * this_ptr, app::String * name));
