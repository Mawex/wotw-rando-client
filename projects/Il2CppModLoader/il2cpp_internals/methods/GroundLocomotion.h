...
IL2CPP_REGISTER_METHOD(0x01094480, Vector2, get_LookDirection, (app::GroundLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00418200, Transform *, get_FeetTransform, (app::GroundLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x010946C0, Vector3, get_FeetPosition, (app::GroundLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010949E0, EntityLocomotionTask *, get_DefaultFSMState, (app::GroundLocomotion * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0471E6B0, GroundLocomotion_get_DefaultFSMState__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00420EE0, MovementProcessor *, get_MovementProcessor, (app::GroundLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x01094A30, EntityWeightData_EntityWeight__Enum, get_Weight, (app::GroundLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01095320, EntityLocomotionTask *, GetNextBehaviour, (app::GroundLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010968A0, LocomotionGoal *, Chase, (app::GroundLocomotion * this_ptr, app::Func_1_UnityEngine_Vector3_ * get_position));
IL2CPP_REGISTER_METHODINFO(0x047805D0, GroundLocomotion_Chase__MethodInfo);
IL2CPP_REGISTER_METHOD(0x010968F0, LocomotionGoal *, MoveTo, (app::GroundLocomotion * this_ptr, app::Vector3 position));
...
IL2CPP_REGISTER_METHOD(0x01096ED0, void, __ctor, (app::GroundLocomotion * this_ptr));
