...
IL2CPP_REGISTER_METHOD(0x01248F50, BehaviourStatus__Enum, OnExecute, (app::KwolokBossButtSlamBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01249F40, void, ModifyMaxSpeed, (app::KwolokBossButtSlamBehaviour * this_ptr, app::float * speed));
IL2CPP_REGISTER_METHODINFO(0x04768840, KwolokBossButtSlamBehaviour_ModifyMaxSpeed__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01249F50, void, ModifyLookAngleChangeSpeed, (app::KwolokBossButtSlamBehaviour * this_ptr, app::float * speed));
IL2CPP_REGISTER_METHODINFO(0x04773868, KwolokBossButtSlamBehaviour_ModifyLookAngleChangeSpeed__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0124A050, void, ModifyAcceleration, (app::KwolokBossButtSlamBehaviour * this_ptr, app::float * acceleration, app::float * deceleration));
IL2CPP_REGISTER_METHODINFO(0x04759148, KwolokBossButtSlamBehaviour_ModifyAcceleration__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0124A080, void, __ctor, (app::KwolokBossButtSlamBehaviour * this_ptr));
}
