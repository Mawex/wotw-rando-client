...
IL2CPP_REGISTER_METHOD(0x00CED5E0, Vector3, Reproject, (app::TentacleAnimationTest * this_ptr, app::Vector3 point));
IL2CPP_REGISTER_METHOD(0x00CED800, void, __ctor, (app::TentacleAnimationTest * this_ptr));
}
