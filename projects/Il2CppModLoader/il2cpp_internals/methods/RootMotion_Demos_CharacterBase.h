...
namespace app::methods::RootMotion_Demos::CharacterBase {
IL2CPP_REGISTER_METHOD(0x022100A0, Vector3, GetGravity, (app::CharacterBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x022103A0, void, Start, (app::CharacterBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x02210910, RaycastHit, GetSpherecastHit, (app::CharacterBase * this_ptr));
