...
namespace app::methods::System_Diagnostics_Tracing::EventPayload {
IL2CPP_REGISTER_METHOD(0x0058DA40, void, __ctor, (app::EventPayload * this_ptr, app::List_1_System_String_ * payload_names, app::List_1_System_Object_ * payload_values));
IL2CPP_REGISTER_METHOD(0x002FA280, ICollection_1_System_String_ *, get_Keys, (app::EventPayload * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, ICollection_1_System_Object_ *, get_Values, (app::EventPayload * this_ptr));
IL2CPP_REGISTER_METHOD(0x0174C6A0, Object *, get_Item, (app::EventPayload * this_ptr, app::String * key));
...
IL2CPP_REGISTER_METHOD(0x0174CD30, IEnumerator_1_KeyValuePair_2_System_String_System_Object_ *, GetEnumerator, (app::EventPayload * this_ptr));
IL2CPP_REGISTER_METHOD(0x0174CE80, IEnumerator *, IEnumerable_GetEnumerator, (app::EventPayload * this_ptr));
