...
IL2CPP_REGISTER_METHOD(0x006B90B0, SuspendableMask__Enum, get_Mask, (app::DeadEnemyRagdoll * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00DDAF60, void, __ctor, (app::DeadEnemyRagdoll * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::DeadEnemyRagdoll * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::DeadEnemyRagdoll * this_ptr));
}
