...
IL2CPP_REGISTER_METHOD(0x0013B960, Vector3, ZDisplacementFrom, (app::CameraFovOffsetMixer_OffsetResult__Boxed * this_ptr, app::Vector3 current_position, float current_fov));
