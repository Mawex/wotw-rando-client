...
namespace app::methods::System_Configuration::SingleTagSectionHandler {
...
IL2CPP_REGISTER_METHOD(0x01FFE2C0, Object *, Create, (app::SingleTagSectionHandler * this_ptr, app::Object * parent, app::Object * context, app::XmlNode * section));
