...
IL2CPP_REGISTER_METHOD(0x0114B950, String *, get_Name, (app::LightCullingSystem_LightCullingGroup * this_ptr));
IL2CPP_REGISTER_METHOD(0x00529FF0, LightCullingSystem_LightCullingGroupId__Enum, get_Id, (app::LightCullingSystem_LightCullingGroup * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0114BA10, void, __ctor, (app::LightCullingSystem_LightCullingGroup * this_ptr, app::LightCullingSystem_LightCullingGroupId__Enum id, int32_t max_amount, app::LightPriority_Layer__Enum__Array * layers));
