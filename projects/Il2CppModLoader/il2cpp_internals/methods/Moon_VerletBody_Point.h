...
IL2CPP_REGISTER_METHOD(0x00C1B1E0, Vector3, get_Acceleration, (app::VerletBody_Point * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0167FE90, Vector3, get_Position, (app::VerletBody_Point * this_ptr));
IL2CPP_REGISTER_METHOD(0x0167FEB0, void, set_Position, (app::VerletBody_Point * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x007EC230, Vector3, get_PreviousPosition, (app::VerletBody_Point * this_ptr));
IL2CPP_REGISTER_METHOD(0x009C51C0, void, set_PreviousPosition, (app::VerletBody_Point * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x02126F60, void, __ctor, (app::VerletBody_Point * this_ptr, app::Vector3 position, float mass, float damping));
