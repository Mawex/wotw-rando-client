...
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_UserID, (app::LeaderboardData_Entry * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_UserID, (app::LeaderboardData_Entry * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_UserHandle, (app::LeaderboardData_Entry * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB960, void, set_UserHandle, (app::LeaderboardData_Entry * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x015B7110, void, __ctor, (app::LeaderboardData_Entry * this_ptr, app::Leaderboard__Enum leaderboard, uint32_t rank, int32_t score, app::String * user_i_d, app::String * user_handle, bool is_steam_entry, bool is_live_entry));
...
IL2CPP_REGISTER_METHOD(0x015B74D0, String *, ToString, (app::LeaderboardData_Entry * this_ptr));
}
