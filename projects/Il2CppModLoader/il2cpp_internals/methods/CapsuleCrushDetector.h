...
IL2CPP_REGISTER_METHOD(0x00B238D0, PlatformBehaviour *, get_PlatformBehaviour, (app::CapsuleCrushDetector * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005C9550, void, __ctor, (app::CapsuleCrushDetector * this_ptr));
}
