...
namespace app::methods::frameworks_loading_Prewarmers::PoolingPrewarmInstancesOperation {
    IL2CPP_REGISTER_METHOD(0x00F612E0, void, __ctor, (app::PoolingPrewarmInstancesOperation * this_ptr));
