...
namespace app::methods::System_Collections_Specialized::ListDictionary_NodeKeyValueCollection_NodeKeyValueEnumerator {
IL2CPP_REGISTER_METHOD(0x0202ACC0, void, __ctor, (app::ListDictionary_NodeKeyValueCollection_NodeKeyValueEnumerator * this_ptr, app::ListDictionary * list, bool is_keys));
IL2CPP_REGISTER_METHOD(0x024963B0, Object *, get_Current, (app::ListDictionary_NodeKeyValueCollection_NodeKeyValueEnumerator * this_ptr));
