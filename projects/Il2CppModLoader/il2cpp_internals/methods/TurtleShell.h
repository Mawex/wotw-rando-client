...
namespace app::methods::TurtleShell {
    IL2CPP_REGISTER_METHOD(0x00720150, IEquipableOwner*, get_Owner, (app::TurtleShell * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00420EE0, List_1_Moon_ISuspendable_*, GetHitStopAutoSuspendables, (app::TurtleShell * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x007008C0, IDamageReciever__Array*, get_AffectedReceivers, (app::TurtleShell * this_ptr));
    IL2CPP_REGISTER_METHOD(0x013DCA00, void, __ctor, (app::TurtleShell * this_ptr));
    IL2CPP_REGISTER_METHOD(0x004F4750, GameObject*, IDamageReciever_get_gameObject, (app::TurtleShell * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00506170, Transform*, IDamageReciever_get_transform, (app::TurtleShell * this_ptr));
} // namespace app::methods::TurtleShell
