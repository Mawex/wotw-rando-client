...
IL2CPP_REGISTER_METHOD(0x00E749A0, Vector3, get_SeinPos, (app::KillVolumeChaseController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E74A90, Vector3, get_AvalanchePos, (app::KillVolumeChaseController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FD490, SuspendableMask__Enum, get_Mask, (app::KillVolumeChaseController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::KillVolumeChaseController * this_ptr));
}
