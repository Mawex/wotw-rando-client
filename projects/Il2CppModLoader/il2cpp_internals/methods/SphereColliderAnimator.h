...
IL2CPP_REGISTER_METHOD(0x00417920, UpdateCategory__Enum, get_UpdateCategory, (app::SphereColliderAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00952C10, GameObject *, get_ExternalTarget, (app::SphereColliderAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00952E90, void, __ctor, (app::SphereColliderAnimator * this_ptr));
}
