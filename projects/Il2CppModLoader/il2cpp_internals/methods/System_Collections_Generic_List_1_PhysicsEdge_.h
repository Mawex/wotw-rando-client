...
namespace app::methods::System_Collections_Generic::List_1_PhysicsEdge_ {
IL2CPP_REGISTER_METHOD(0x025EFC50, PhysicsEdge *, get_Item, (app::List_1_PhysicsEdge_ * this_ptr, int32_t index));
