...
IL2CPP_REGISTER_METHOD(0x00593850, WwiseEventSystem_SoundHandle, AllocateHandle, (app::WwiseEventSystem * system, app::SoundProvider * sound_provider, app::ISoundHost * host));
