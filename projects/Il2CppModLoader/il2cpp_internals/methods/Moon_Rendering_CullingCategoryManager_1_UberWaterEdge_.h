...
namespace app::methods::Moon_Rendering::CullingCategoryManager_1_UberWaterEdge_ {
...
IL2CPP_REGISTER_METHOD(0x02904370, void, __ctor, (app::CullingCategoryManager_1_UberWaterEdge_ * this_ptr, app::CullingCategory__Enum mask, bool per_slice));
IL2CPP_REGISTER_METHODINFO(0x047996E0, CullingCategoryManager_1_UberWaterEdge___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02904830, CullingCategoryManager_1_T_Enumerator_UberWaterEdge_, Resolve, (app::CullingCategoryManager_1_UberWaterEdge_ * this_ptr, app::RendererCullingCategoryResults results));
