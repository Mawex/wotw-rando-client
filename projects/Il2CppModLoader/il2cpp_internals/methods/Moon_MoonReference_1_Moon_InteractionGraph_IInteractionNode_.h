...
IL2CPP_REGISTER_METHOD(0x02720AC0, IInteractionNode *, Resolve, (app::MoonReference_1_Moon_InteractionGraph_IInteractionNode_ * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x0472B830, MoonReference_1_Moon_InteractionGraph_IInteractionNode__Resolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02720EB0, IInteractionNode *, SafeResolve, (app::MoonReference_1_Moon_InteractionGraph_IInteractionNode_ * this_ptr, app::IMoonResolverContext * context));
