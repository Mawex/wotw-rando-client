...
IL2CPP_REGISTER_METHOD(0x00C8D800, Vector3, get_LastSeenSeinPosition, (app::EntityController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C8D820, void, set_LastSeenSeinPosition, (app::EntityController * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x00C8D830, Enemy2D *, get_Enemy2D, (app::EntityController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0044C850, void, __ctor, (app::EntityController * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::EntityController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::EntityController * this_ptr));
}
