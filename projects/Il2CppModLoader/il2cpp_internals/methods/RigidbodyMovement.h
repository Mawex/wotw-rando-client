...
IL2CPP_REGISTER_METHOD(0x00911F20, Vector3, get_Velocity, (app::RigidbodyMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x00911FB0, void, set_Velocity, (app::RigidbodyMovement * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::RigidbodyMovement * this_ptr));
}
