...
IL2CPP_REGISTER_METHOD(0x01910A70, GUIStyle *, get_LabelStyle, (app::UberShaderDetector * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01911220, String *, FullPath, (app::UberShaderDetector * this_ptr, app::Transform * target));
...
IL2CPP_REGISTER_METHOD(0x019121B0, void, __ctor, (app::UberShaderDetector * this_ptr));
