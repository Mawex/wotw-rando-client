...
namespace app::methods::System_Collections_Generic::HashSet_1_System_Int64_ {
...
IL2CPP_REGISTER_METHOD(0x02ABCD80, HashSet_1_T_Enumerator_System_Int64_, GetEnumerator, (app::HashSet_1_System_Int64_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02ABCDC0, IEnumerator_1_System_Int64__1 *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::HashSet_1_System_Int64_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02ABCDC0, IEnumerator *, IEnumerable_GetEnumerator, (app::HashSet_1_System_Int64_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB990, IEqualityComparer_1_System_Int64_ *, get_Comparer, (app::HashSet_1_System_Int64_ * this_ptr));
