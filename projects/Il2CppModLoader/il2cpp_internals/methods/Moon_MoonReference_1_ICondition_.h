...
IL2CPP_REGISTER_METHOD(0x02720EB0, ICondition *, SafeResolve, (app::MoonReference_1_ICondition_ * this_ptr, app::IMoonResolverContext * context));
...
IL2CPP_REGISTER_METHOD(0x02720AC0, ICondition *, Resolve, (app::MoonReference_1_ICondition_ * this_ptr, app::IMoonResolverContext * context));
