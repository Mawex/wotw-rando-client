...
namespace app::methods::AkObjectInfo {
    IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkObjectInfo * this_ptr, app::void* c_ptr, bool c_memory_own));
    IL2CPP_REGISTER_METHOD(0x018843A0, void*, getCPtr, (app::AkObjectInfo * obj));
    IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkObjectInfo * this_ptr, app::void* c_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01885000, void, __ctor_2, (app::AkObjectInfo * this_ptr));
} // namespace app::methods::AkObjectInfo
