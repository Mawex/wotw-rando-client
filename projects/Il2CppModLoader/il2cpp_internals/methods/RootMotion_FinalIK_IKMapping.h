...
namespace app::methods::RootMotion_FinalIK::IKMapping {
...
IL2CPP_REGISTER_METHOD(0x02BDB0E0, Vector3, SolveFABRIKJoint, (app::IKMapping * this_ptr, app::Vector3 pos1, app::Vector3 pos2, float length));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::IKMapping * this_ptr));
}
