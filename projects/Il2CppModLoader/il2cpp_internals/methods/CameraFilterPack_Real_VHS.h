...
IL2CPP_REGISTER_METHOD(0x0248A920, Material *, get_material, (app::CameraFilterPack_Real_VHS * this_ptr));
IL2CPP_REGISTER_METHOD(0x0248AB00, void, Start, (app::CameraFilterPack_Real_VHS * this_ptr));
IL2CPP_REGISTER_METHOD(0x0248ACB0, Texture2D *, GetRTPixels, (app::Texture2D * t, app::RenderTexture * rt, int32_t sx, int32_t sy));
...
IL2CPP_REGISTER_METHOD(0x0248B2A0, void, __ctor, (app::CameraFilterPack_Real_VHS * this_ptr));
}
