...
namespace app::methods::Unity_IO_Compression::DeflaterManaged {
IL2CPP_REGISTER_METHOD(0x02B756F0, void, __ctor, (app::DeflaterManaged * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B760D0, bool, IDeflater_Finish, (app::DeflaterManaged * this_ptr, app::Byte__Array * output_buffer, app::int32_t * bytes_read));
