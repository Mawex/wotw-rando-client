...
namespace app::methods::System_Collections_Generic::List_1_System_UInt16_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_System_UInt16_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_System_UInt16_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02F1A270, void, __ctor_3, (app::List_1_System_UInt16_ * this_ptr, app::IEnumerable_1_System_UInt16_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02F1A6F0, Object *, ICollection_get_SyncRoot, (app::List_1_System_UInt16_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F1A9B0, Object *, IList_get_Item, (app::List_1_System_UInt16_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_System_UInt16_ *, AsReadOnly, (app::List_1_System_UInt16_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F1B220, List_1_System_UInt16_ *, FindAll, (app::List_1_System_UInt16_ * this_ptr, app::Predicate_1_UInt16_ * match));
...
IL2CPP_REGISTER_METHOD(0x02F1B6B0, List_1_T_Enumerator_System_UInt16_, GetEnumerator, (app::List_1_System_UInt16_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02F1B6F0, IEnumerator_1_System_UInt16_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_System_UInt16_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02F1B6F0, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_System_UInt16_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_System_UInt16_ *, GetRange, (app::List_1_System_UInt16_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, UInt16__Array *, ToArray, (app::List_1_System_UInt16_ * this_ptr));
