...
IL2CPP_REGISTER_METHOD(0x00E10640, GhostGenericResourceAttribute *, Get, (app::GenericPuppet_GhostGenericResourcesReflectionCache * this_ptr, app::Object * obj));
IL2CPP_REGISTER_METHOD(0x00E107B0, void, ResetLocalState, (app::GenericPuppet_GhostGenericResourcesReflectionCache * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E10840, void, __ctor, (app::GenericPuppet_GhostGenericResourcesReflectionCache * this_ptr));
}
