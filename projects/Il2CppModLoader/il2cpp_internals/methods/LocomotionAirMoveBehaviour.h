...
IL2CPP_REGISTER_METHOD(0x009EB5F0, Vector3, get_TargetPosition, (app::LocomotionAirMoveBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FC3E30, BehaviourStatus__Enum, OnExecuteTask, (app::LocomotionAirMoveBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00FC4B30, void, __ctor, (app::LocomotionAirMoveBehaviour * this_ptr));
}
