...
namespace app::methods::System_Collections_Generic::List_1_UnityEngine_Collider_ {
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_UnityEngine_Collider_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_UnityEngine_Collider_, GetEnumerator, (app::List_1_UnityEngine_Collider_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0478A8A8, List_1_UnityEngine_Collider__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_UnityEngine_Collider_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x025EFC50, Collider *, get_Item, (app::List_1_UnityEngine_Collider_ * this_ptr, int32_t index));
