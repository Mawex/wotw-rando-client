...
IL2CPP_REGISTER_METHOD(0x00D4A190, void, __ctor, (app::BreadCrumbPositionTracker * this_ptr, float track_interval, float point_lifetime));
...
IL2CPP_REGISTER_METHOD(0x00D4A990, Vector2, GetCurrentTrackedPoint, (app::BreadCrumbPositionTracker * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D4AA40, Vector2, GetNextTrackedPoint, (app::BreadCrumbPositionTracker * this_ptr));
