...
IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkThreadProperties * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x026FD1D0, void *, getCPtr, (app::AkThreadProperties * obj));
IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkThreadProperties * this_ptr, app::void * c_ptr));
