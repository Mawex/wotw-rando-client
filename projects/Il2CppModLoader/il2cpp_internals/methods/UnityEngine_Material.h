...
IL2CPP_REGISTER_METHOD(0x02531050, void, __ctor_1, (app::Material * this_ptr, app::Shader * shader));
IL2CPP_REGISTER_METHOD(0x02531140, void, __ctor_2, (app::Material * this_ptr, app::Material * source));
IL2CPP_REGISTER_METHOD(0x02531230, void, __ctor_3, (app::Material * this_ptr, app::String * contents));
...
IL2CPP_REGISTER_METHOD(0x02531410, Shader *, get_shader, (app::Material * this_ptr));
IL2CPP_REGISTER_METHOD(0x02531460, void, set_shader, (app::Material * this_ptr, app::Shader * value));
IL2CPP_REGISTER_METHOD(0x025314C0, Color, get_color, (app::Material * this_ptr));
IL2CPP_REGISTER_METHOD(0x025315F0, void, set_color, (app::Material * this_ptr, app::Color value));
IL2CPP_REGISTER_METHOD(0x02531710, Texture *, get_mainTexture, (app::Material * this_ptr));
IL2CPP_REGISTER_METHOD(0x02531820, void, set_mainTexture, (app::Material * this_ptr, app::Texture * value));
IL2CPP_REGISTER_METHOD(0x025318C0, Vector2, get_mainTextureOffset, (app::Material * this_ptr));
IL2CPP_REGISTER_METHOD(0x02531990, void, set_mainTextureOffset, (app::Material * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x02531AC0, Vector2, get_mainTextureScale, (app::Material * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02531FF0, String *, GetTagImpl, (app::Material * this_ptr, app::String * tag, bool current_sub_shader_only, app::String * default_value));
IL2CPP_REGISTER_METHOD(0x02532080, String *, GetTag, (app::Material * this_ptr, app::String * tag, bool search_fallbacks));
...
IL2CPP_REGISTER_METHOD(0x02532600, Color, GetColorImpl, (app::Material * this_ptr, int32_t name));
IL2CPP_REGISTER_METHOD(0x02532690, Texture *, GetTextureImpl, (app::Material * this_ptr, int32_t name));
...
IL2CPP_REGISTER_METHOD(0x025327F0, Vector4, GetTextureScaleAndOffsetImpl, (app::Material * this_ptr, int32_t name));
...
IL2CPP_REGISTER_METHOD(0x02533370, Color, GetColor_1, (app::Material * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x02532600, Color, GetColor_2, (app::Material * this_ptr, int32_t name_i_d));
IL2CPP_REGISTER_METHOD(0x02533440, Vector4, GetVector, (app::Material * this_ptr, int32_t name_i_d));
IL2CPP_REGISTER_METHOD(0x025334D0, Texture *, GetTexture_1, (app::Material * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x02532690, Texture *, GetTexture_2, (app::Material * this_ptr, int32_t name_i_d));
...
IL2CPP_REGISTER_METHOD(0x02533700, Vector2, GetTextureOffset_1, (app::Material * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x02533770, Vector2, GetTextureOffset_2, (app::Material * this_ptr, int32_t name_i_d));
IL2CPP_REGISTER_METHOD(0x02533800, Vector2, GetTextureScale_1, (app::Material * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x02533870, Vector2, GetTextureScale_2, (app::Material * this_ptr, int32_t name_i_d));
