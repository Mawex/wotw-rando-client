...
IL2CPP_REGISTER_METHOD(0x00B68B50, Vector3, ModifyKickbackForce, (app::DropSlugEntity * this_ptr, app::Vector3 force, app::Damage * damage, bool is_on_ground));
IL2CPP_REGISTER_METHOD(0x00BE3EB0, void, ResolveDamage, (app::DropSlugEntity * this_ptr, app::DamageResult * damage_result));
IL2CPP_REGISTER_METHOD(0x00BE3ED0, void, __ctor, (app::DropSlugEntity * this_ptr));
}
