...
namespace app::methods::Moon_Timeline_Systems::GameplayUISystem {
IL2CPP_REGISTER_METHOD(0x00420EE0, UpdateType__Enum, get_UpdateType, (app::GameplayUISystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D091A0, void, __ctor, (app::GameplayUISystem * this_ptr));
}
