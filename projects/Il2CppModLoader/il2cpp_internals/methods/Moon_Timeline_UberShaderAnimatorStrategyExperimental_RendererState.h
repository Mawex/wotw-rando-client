...
namespace app::methods::Moon_Timeline::UberShaderAnimatorStrategyExperimental_RendererState {
    IL2CPP_REGISTER_METHOD(0x00D15290, void, __ctor, (app::UberShaderAnimatorStrategyExperimental_RendererState * this_ptr));
