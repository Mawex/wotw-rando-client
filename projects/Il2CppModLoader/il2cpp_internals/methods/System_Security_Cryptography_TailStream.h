...
namespace app::methods::System_Security_Cryptography::TailStream {
IL2CPP_REGISTER_METHOD(0x01E112F0, void, __ctor, (app::TailStream * this_ptr, int32_t buffer_size));
...
IL2CPP_REGISTER_METHOD(0x01E11470, Byte__Array *, get_Buffer, (app::TailStream * this_ptr));
