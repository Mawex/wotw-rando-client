...
namespace app::methods::System_Collections_Generic::List_1_System_UInt64_ {
IL2CPP_REGISTER_METHOD(0x02F1D9F0, void, __ctor_1, (app::List_1_System_UInt64_ * this_ptr, app::IEnumerable_1_System_UInt64_ * collection));
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_System_UInt64_, GetEnumerator, (app::List_1_System_UInt64_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04756C50, List_1_System_UInt64__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_2, (app::List_1_System_UInt64_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04726F90, List_1_System_UInt64___ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_3, (app::List_1_System_UInt64_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x02F1DE70, Object *, ICollection_get_SyncRoot, (app::List_1_System_UInt64_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EFDB0, Object *, IList_get_Item, (app::List_1_System_UInt64_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_System_UInt64_ *, AsReadOnly, (app::List_1_System_UInt64_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F1E5B0, List_1_System_UInt64_ *, FindAll, (app::List_1_System_UInt64_ * this_ptr, app::Predicate_1_UInt64_ * match));
...
IL2CPP_REGISTER_METHOD(0x025F0B50, IEnumerator_1_System_UInt64_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_System_UInt64_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025F0B50, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_System_UInt64_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_System_UInt64_ *, GetRange, (app::List_1_System_UInt64_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, UInt64__Array *, ToArray, (app::List_1_System_UInt64_ * this_ptr));
