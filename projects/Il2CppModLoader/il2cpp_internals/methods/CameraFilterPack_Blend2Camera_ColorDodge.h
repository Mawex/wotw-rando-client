...
IL2CPP_REGISTER_METHOD(0x027459A0, Material *, get_material, (app::CameraFilterPack_Blend2Camera_ColorDodge * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02746B70, void, __ctor, (app::CameraFilterPack_Blend2Camera_ColorDodge * this_ptr));
}
