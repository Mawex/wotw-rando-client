...
IL2CPP_REGISTER_METHOD(0x002FB990, CameraSettings *, get_CameraSettingsToUse, (app::CameraPostProcessing * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB00, SceneDefaultSettingsHelper *, get_SceneSettingsHelper, (app::CameraPostProcessing * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x016A0DC0, void, __ctor, (app::CameraPostProcessing * this_ptr));
