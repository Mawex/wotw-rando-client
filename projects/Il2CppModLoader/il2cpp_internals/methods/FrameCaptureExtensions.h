...
IL2CPP_REGISTER_METHOD(0x01542520, String__Array *, HeaderNames_1, (app::IFrameCaptureAgent_1_EntityDataCaptureAgent_EntityDataHeader_ * agent));
...
IL2CPP_REGISTER_METHOD(0x01542520, String__Array *, HeaderNames_2, (app::IFrameCaptureAgent_1_NvnMemoryCaptureAgent_MemoryHeader_ * agent));
...
IL2CPP_REGISTER_METHOD(0x01542520, String__Array *, HeaderNames_3, (app::IFrameCaptureAgent_1_ObjectInstantiationCaptureAgent_ObjectInstantiationHeader_ * agent));
...
IL2CPP_REGISTER_METHOD(0x01542520, String__Array *, HeaderNames_4, (app::IFrameCaptureAgent_1_ObjectProfilingCaptureAgent_ObjectProfilingHeader_ * agent));
IL2CPP_REGISTER_METHODINFO(0x0472E5A0, FrameCaptureExtensions_HeaderNames_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01542520, String__Array *, HeaderNames_5, (app::IFrameCaptureAgent_1_SampleOffsetCaptureAgent_FrameSummaryHeader_ * agent));
...
IL2CPP_REGISTER_METHOD(0x01542520, String__Array *, HeaderNames_6, (app::IFrameCaptureAgent_1_TimesliceBudgetCaptureAgent_TimeSliceBudgetHeader_ * agent));
...
IL2CPP_REGISTER_METHOD(0x01542520, String__Array *, HeaderNames_7, (app::IFrameCaptureAgent_1_System_Int32Enum_ * agent));
}
