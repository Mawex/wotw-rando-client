...
namespace app::methods::Moon_Wwise::ArtificialSoundHost {
IL2CPP_REGISTER_METHOD(0x02708AF0, void, __ctor, (app::ArtificialSoundHost * this_ptr, uint64_t i));
...
IL2CPP_REGISTER_METHOD(0x02708BD0, Vector3, get_Position, (app::ArtificialSoundHost * this_ptr));
IL2CPP_REGISTER_METHOD(0x02708D10, Quaternion, get_Rotation, (app::ArtificialSoundHost * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, ISoundListener *, get_AsListener, (app::ArtificialSoundHost * this_ptr));
