...
IL2CPP_REGISTER_METHOD(0x00910BD0, AnimationType__Enum, get_Type, (app::MoonAnimator_CrossfadeAnimation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02115720, MoonAnimation_RootMotionSample, EvaluateRootMotion, (app::MoonAnimator_CrossfadeAnimation * this_ptr, float time, app::AnimationParameterSet * parameter_set));
IL2CPP_REGISTER_METHODINFO(0x04743F80, MoonAnimator_CrossfadeAnimation_EvaluateRootMotion__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02115770, void, __ctor, (app::MoonAnimator_CrossfadeAnimation * this_ptr));
}
