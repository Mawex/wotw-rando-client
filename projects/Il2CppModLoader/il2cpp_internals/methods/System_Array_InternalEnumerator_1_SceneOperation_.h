...
IL2CPP_REGISTER_METHOD(0x00160580, void, __ctor, (app::Array_InternalEnumerator_1_SceneOperation___Boxed * this_ptr, app::Array * array));
...
IL2CPP_REGISTER_METHOD(0x001AFEE0, SceneOperation, get_Current, (app::Array_InternalEnumerator_1_SceneOperation___Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x001AFF10, Object *, IEnumerator_get_Current, (app::Array_InternalEnumerator_1_SceneOperation___Boxed * this_ptr));
}
