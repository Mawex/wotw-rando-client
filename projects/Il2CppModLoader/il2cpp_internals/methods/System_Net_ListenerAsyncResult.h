...
namespace app::methods::System_Net::ListenerAsyncResult {
IL2CPP_REGISTER_METHOD(0x01E6C530, void, __ctor, (app::ListenerAsyncResult * this_ptr, app::AsyncCallback * cb, app::Object * state));
...
IL2CPP_REGISTER_METHOD(0x01E6D230, HttpListenerContext *, GetContext, (app::ListenerAsyncResult * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047940C8, ListenerAsyncResult_GetContext__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E6D2E0, Object *, get_AsyncState, (app::ListenerAsyncResult * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E6D300, WaitHandle *, get_AsyncWaitHandle, (app::ListenerAsyncResult * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E6D690, void, __cctor, ());
}
