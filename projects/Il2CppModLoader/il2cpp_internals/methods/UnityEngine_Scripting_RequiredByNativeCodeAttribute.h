...
namespace app::methods::UnityEngine_Scripting::RequiredByNativeCodeAttribute {
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_1, (app::RequiredByNativeCodeAttribute * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor_2, (app::RequiredByNativeCodeAttribute * this_ptr, app::String * name));
