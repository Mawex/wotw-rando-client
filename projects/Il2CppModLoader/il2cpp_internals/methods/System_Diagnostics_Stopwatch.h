...
IL2CPP_REGISTER_METHOD(0x02004240, int64_t, GetTimestamp, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x02004250, Stopwatch *, StartNew, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x02004980, void, __cctor, (MethodInfo * method));
}
