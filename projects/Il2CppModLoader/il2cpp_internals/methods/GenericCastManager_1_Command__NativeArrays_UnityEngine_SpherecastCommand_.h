...
namespace app::methods::GenericCastManager_1_Command__NativeArrays_UnityEngine_SpherecastCommand_ {
    ...
    IL2CPP_REGISTER_METHOD(0x001548A0, void, __ctor, (app::GenericCastManager_1_Command_NativeArrays_UnityEngine_SpherecastCommand___Boxed * this_ptr, int32_t capacity));
