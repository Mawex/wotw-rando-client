...
namespace app::methods::System_Data::ConstraintCollection {
IL2CPP_REGISTER_METHOD(0x0238DC10, void, __ctor, (app::ConstraintCollection * this_ptr, app::DataTable * table));
IL2CPP_REGISTER_METHOD(0x002FB930, ArrayList *, get_List, (app::ConstraintCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x0238DD90, Constraint_1 *, get_Item_1, (app::ConstraintCollection * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x04742590, ConstraintCollection_get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FA280, DataTable *, get_Table, (app::ConstraintCollection * this_ptr));
IL2CPP_REGISTER_METHOD(0x0238DEB0, Constraint_1 *, get_Item_2, (app::ConstraintCollection * this_ptr, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x0238E7E0, Constraint_1 *, Add_3, (app::ConstraintCollection * this_ptr, app::String * name, app::DataColumn__Array * columns, bool primary_key));
...
IL2CPP_REGISTER_METHOD(0x0238ED70, String *, AssignName, (app::ConstraintCollection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0238FD40, Constraint_1 *, FindConstraint, (app::ConstraintCollection * this_ptr, app::Constraint_1 * constraint));
IL2CPP_REGISTER_METHOD(0x0238FF70, UniqueConstraint *, FindKeyConstraint_1, (app::ConstraintCollection * this_ptr, app::DataColumn__Array * columns));
IL2CPP_REGISTER_METHOD(0x02390100, UniqueConstraint *, FindKeyConstraint_2, (app::ConstraintCollection * this_ptr, app::DataColumn * column));
IL2CPP_REGISTER_METHOD(0x023902A0, ForeignKeyConstraint *, FindForeignKeyConstraint, (app::ConstraintCollection * this_ptr, app::DataColumn__Array * parent_columns, app::DataColumn__Array * child_columns));
...
IL2CPP_REGISTER_METHOD(0x023906D0, String *, MakeName, (app::ConstraintCollection * this_ptr, int32_t index));
