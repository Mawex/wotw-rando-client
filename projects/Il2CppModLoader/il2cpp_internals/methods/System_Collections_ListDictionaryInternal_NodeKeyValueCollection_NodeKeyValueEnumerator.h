...
namespace app::methods::System_Collections::ListDictionaryInternal_NodeKeyValueCollection_NodeKeyValueEnumerator {
IL2CPP_REGISTER_METHOD(0x0202ACC0, void, __ctor, (app::ListDictionaryInternal_NodeKeyValueCollection_NodeKeyValueEnumerator * this_ptr, app::ListDictionaryInternal * list, bool is_keys));
IL2CPP_REGISTER_METHOD(0x0202ACF0, Object *, get_Current, (app::ListDictionaryInternal_NodeKeyValueCollection_NodeKeyValueEnumerator * this_ptr));
