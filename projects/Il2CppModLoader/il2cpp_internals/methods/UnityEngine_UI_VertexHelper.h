...
namespace app::methods::UnityEngine_UI::VertexHelper {
IL2CPP_REGISTER_METHOD(0x009A3B50, void, __ctor_1, (app::VertexHelper * this_ptr));
IL2CPP_REGISTER_METHOD(0x031A82E0, void, __ctor_2, (app::VertexHelper * this_ptr, app::Mesh * m));
