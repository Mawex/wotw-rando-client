...
IL2CPP_REGISTER_METHOD(0x0063D090, SuspendableMask__Enum, get_Mask, (app::InteractiveMessageBox * this_ptr));
IL2CPP_REGISTER_METHOD(0x0063D0A0, void, set_Mask, (app::InteractiveMessageBox * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x0063D160, void, __ctor, (app::InteractiveMessageBox * this_ptr));
