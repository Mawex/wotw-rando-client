...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (UberStateModifierDataVirtualAnimatorFactory * __this));
IL2CPP_REGISTER_METHOD(0x018F0180, ITimelineEntity *, CreateAnimtorInternal, (NewSetupStateController * stateController, SetupStateModifier * modifier, int32_t stateGuid, VirtualTimelineEntityPool * pool));
IL2CPP_REGISTER_METHOD(0x018F0180, ITimelineEntity *, CreateAnimtorInternal, (NewSetupStateController * stateController, SetupStateModifier * modifier, int32_t stateGuid, VirtualTimelineEntityPool * pool));
