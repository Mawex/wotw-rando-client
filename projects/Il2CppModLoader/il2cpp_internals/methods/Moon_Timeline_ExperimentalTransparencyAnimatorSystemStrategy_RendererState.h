...
namespace app::methods::Moon_Timeline::ExperimentalTransparencyAnimatorSystemStrategy_RendererState {
IL2CPP_REGISTER_METHOD(0x00769CA0, void, __ctor, (app::ExperimentalTransparencyAnimatorSystemStrategy_RendererState * this_ptr));
