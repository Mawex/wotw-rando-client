...
IL2CPP_REGISTER_METHOD(0x015FE140, void, InternalOnRulesResponded, (app::ISteamMatchmakingRulesResponse * this_ptr, app::void * thisptr, app::void * pch_rule, app::void * pch_value));
IL2CPP_REGISTER_METHODINFO(0x04743F00, ISteamMatchmakingRulesResponse_InternalOnRulesResponded__MethodInfo);
IL2CPP_REGISTER_METHOD(0x012B0FE0, void, InternalOnRulesFailedToRespond, (app::ISteamMatchmakingRulesResponse * this_ptr, app::void * thisptr));
IL2CPP_REGISTER_METHODINFO(0x04788FF8, ISteamMatchmakingRulesResponse_InternalOnRulesFailedToRespond__MethodInfo);
IL2CPP_REGISTER_METHOD(0x012CB380, void, InternalOnRulesRefreshComplete, (app::ISteamMatchmakingRulesResponse * this_ptr, app::void * thisptr));
IL2CPP_REGISTER_METHODINFO(0x04793900, ISteamMatchmakingRulesResponse_InternalOnRulesRefreshComplete__MethodInfo);
IL2CPP_REGISTER_METHOD(0x015FC460, void *, operator_, (app::ISteamMatchmakingRulesResponse * that));
}
