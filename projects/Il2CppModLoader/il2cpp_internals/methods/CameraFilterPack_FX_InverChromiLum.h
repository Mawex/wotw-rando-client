...
IL2CPP_REGISTER_METHOD(0x02471690, Material *, get_material, (app::CameraFilterPack_FX_InverChromiLum * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0136E200, void, __ctor, (app::CameraFilterPack_FX_InverChromiLum * this_ptr));
}
