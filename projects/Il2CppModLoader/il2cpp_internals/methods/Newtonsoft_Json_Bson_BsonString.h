...
namespace app::methods::Newtonsoft_Json_Bson::BsonString {
...
IL2CPP_REGISTER_METHOD(0x01A4ABA0, void, __ctor, (app::BsonString * this_ptr, app::Object * value, bool include_length));
}
