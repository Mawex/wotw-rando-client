...
namespace app::methods::System_Globalization::TaiwanCalendar {
IL2CPP_REGISTER_METHOD(0x01DEC880, Calendar *, GetDefaultInstance, ());
IL2CPP_REGISTER_METHOD(0x01DECA70, DateTime, get_MinSupportedDateTime, (app::TaiwanCalendar * this_ptr));
IL2CPP_REGISTER_METHOD(0x01DECB10, DateTime, get_MaxSupportedDateTime, (app::TaiwanCalendar * this_ptr));
IL2CPP_REGISTER_METHOD(0x01DECBB0, void, __ctor, (app::TaiwanCalendar * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01DECEF0, DayOfWeek__Enum, GetDayOfWeek, (app::TaiwanCalendar * this_ptr, app::DateTime time));
...
IL2CPP_REGISTER_METHOD(0x01DED030, DateTime, ToDateTime, (app::TaiwanCalendar * this_ptr, int32_t year, int32_t month, int32_t day, int32_t hour, int32_t minute, int32_t second, int32_t millisecond, int32_t era));
IL2CPP_REGISTER_METHOD(0x01DED060, Int32__Array *, get_Eras, (app::TaiwanCalendar * this_ptr));
