...
IL2CPP_REGISTER_METHOD(0x00EE04B0, BehaviourStatus__Enum, OnExecute, (app::SneezeSlugSneezeBehaviourNew * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00EE1ED0, void, __ctor, (app::SneezeSlugSneezeBehaviourNew * this_ptr));
}
