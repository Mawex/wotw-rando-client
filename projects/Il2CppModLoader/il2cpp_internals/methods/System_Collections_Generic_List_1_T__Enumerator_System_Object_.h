...
namespace app::methods::System_Collections_Generic::List_1_T__Enumerator_System_Object_ {
IL2CPP_REGISTER_METHOD(0x00107C20, Object *, get_Current, (app::List_1_T_Enumerator_System_Object___Boxed * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0472EE58, List_1_T_Enumerator_System_Object__get_Current__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0014EA30, Object *, IEnumerator_get_Current, (app::List_1_T_Enumerator_System_Object___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0014CC40, void, __ctor, (app::List_1_T_Enumerator_System_Object___Boxed * this_ptr, app::List_1_System_Object_ * list));
