...
IL2CPP_REGISTER_METHOD(0x00420230, BehaviourStatus__Enum, OnExecuteTask, (app::TurtleRollBackBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x013D8900, void, OnExitTask, (app::TurtleRollBackBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00B68B50, Vector3, RootMotionRollBackModifier, (app::TurtleRollBackBehaviour * this_ptr, app::Vector3 motion));
IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, ShouldPauseLocomotion, (app::TurtleRollBackBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x005B3EC0, void, __ctor, (app::TurtleRollBackBehaviour * this_ptr));
}
