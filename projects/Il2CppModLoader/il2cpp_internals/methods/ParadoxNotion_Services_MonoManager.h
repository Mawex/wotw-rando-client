...
namespace app::methods::ParadoxNotion_Services::MonoManager {
IL2CPP_REGISTER_METHOD(0x031BF2F0, MonoManager_UpdateMode__Enum, get_updateMode, ());
...
IL2CPP_REGISTER_METHOD(0x031BFF20, MonoManager *, get_current, ());
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::MonoManager * this_ptr));
}
