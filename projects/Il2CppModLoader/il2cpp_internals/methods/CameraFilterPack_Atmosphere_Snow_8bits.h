...
IL2CPP_REGISTER_METHOD(0x02740D90, Material *, get_material, (app::CameraFilterPack_Atmosphere_Snow_8bits * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02741570, void, __ctor, (app::CameraFilterPack_Atmosphere_Snow_8bits * this_ptr));
}
