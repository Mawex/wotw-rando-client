...
IL2CPP_REGISTER_METHOD(0x023449C0, void, GetAvailableThreads, (app::int32_t * worker_threads, app::int32_t * completion_port_threads));
IL2CPP_REGISTER_METHOD(0x023449D0, RegisteredWaitHandle *, RegisterWaitForSingleObject_1, (app::WaitHandle * wait_object, app::WaitOrTimerCallback * call_back, app::Object * state, uint32_t milliseconds_time_out_interval, bool execute_only_once, app::StackCrawlMark__Enum * stack_mark, bool compress_stack));
IL2CPP_REGISTER_METHODINFO(0x04748568, ThreadPool_RegisterWaitForSingleObject__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02344F20, RegisteredWaitHandle *, RegisterWaitForSingleObject_2, (app::WaitHandle * wait_object, app::WaitOrTimerCallback * call_back, app::Object * state, int32_t milliseconds_time_out_interval, bool execute_only_once));
IL2CPP_REGISTER_METHODINFO(0x047770E0, ThreadPool_RegisterWaitForSingleObject_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02345040, RegisteredWaitHandle *, RegisterWaitForSingleObject_3, (app::WaitHandle * wait_object, app::WaitOrTimerCallback * call_back, app::Object * state, app::TimeSpan timeout, bool execute_only_once));
...
IL2CPP_REGISTER_METHOD(0x02345810, IEnumerable_1_System_Threading_IThreadPoolWorkItem_ *, GetQueuedWorkItems, ());
IL2CPP_REGISTER_METHOD(0x02345920, IEnumerable_1_System_Threading_IThreadPoolWorkItem_ *, EnumerateQueuedWorkItems, (app::ThreadPoolWorkQueue_WorkStealingQueue__Array * ws_queues, app::ThreadPoolWorkQueue_QueueSegment * global_queue_tail));
IL2CPP_REGISTER_METHOD(0x02345AC0, bool, RequestWorkerThread, ());
IL2CPP_REGISTER_METHOD(0x02345AF0, void, EnsureVMInitialized, ());
IL2CPP_REGISTER_METHOD(0x023449C0, void, GetAvailableThreadsNative, (app::int32_t * worker_threads, app::int32_t * completion_port_threads));
...
IL2CPP_REGISTER_METHOD(0x02346270, void, InitializeVMTp, (app::bool * enable_worker_tracking));
}
