...
namespace app::methods::System_Xml::CharEntityEncoderFallbackBuffer {
IL2CPP_REGISTER_METHOD(0x021E8320, void, __ctor, (app::CharEntityEncoderFallbackBuffer * this_ptr, app::CharEntityEncoderFallback * parent));
