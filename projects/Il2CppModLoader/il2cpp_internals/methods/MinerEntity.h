...
namespace app::methods::MinerEntity {
    ...
    IL2CPP_REGISTER_METHOD(0x01448B00, MinerSpawnType__Enum, get_SpawnType, (app::MinerEntity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00DB7080, void, __ctor, (app::MinerEntity * this_ptr));
} // namespace app::methods::MinerEntity
