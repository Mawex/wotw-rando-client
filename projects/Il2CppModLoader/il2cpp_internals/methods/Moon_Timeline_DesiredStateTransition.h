...
namespace app::methods::Moon_Timeline::DesiredStateTransition {
IL2CPP_REGISTER_METHOD(0x00107C30, IGenericUberState *, get_GenericUberState, (app::DesiredStateTransition__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00107C30, IUberState *, get_UberState, (app::DesiredStateTransition__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001C0CC0, String *, get_NiceName, (app::DesiredStateTransition__Boxed * this_ptr));
