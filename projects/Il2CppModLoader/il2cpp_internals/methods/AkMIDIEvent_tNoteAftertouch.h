...
IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkMIDIEvent_tNoteAftertouch * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x026F3FB0, void *, getCPtr, (app::AkMIDIEvent_tNoteAftertouch * obj));
IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkMIDIEvent_tNoteAftertouch * this_ptr, app::void * c_ptr));
...
IL2CPP_REGISTER_METHOD(0x026F4770, void, __ctor_2, (app::AkMIDIEvent_tNoteAftertouch * this_ptr));
}
