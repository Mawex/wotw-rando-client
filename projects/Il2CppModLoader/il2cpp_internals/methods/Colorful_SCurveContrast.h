...
IL2CPP_REGISTER_METHOD(0x0304D8D0, String *, GetShaderName, (app::SCurveContrast * this_ptr));
IL2CPP_REGISTER_METHOD(0x0304D950, void, __ctor, (app::SCurveContrast * this_ptr));
}
