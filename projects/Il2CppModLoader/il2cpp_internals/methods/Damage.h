...
namespace app::methods::Damage {
    ...
    IL2CPP_REGISTER_METHOD(0x00DC06A0, Vector2, get_Force, (app::Damage * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00DC06C0, void, set_Force, (app::Damage * this_ptr, app::Vector2 value));
    IL2CPP_REGISTER_METHOD(0x00DC06E0, Vector2, get_OriginalForceDirection, (app::Damage * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00DC0700, void, set_OriginalForceDirection, (app::Damage * this_ptr, app::Vector2 value));
    IL2CPP_REGISTER_METHOD(0x00DC0720, Vector3, get_Position, (app::Damage * this_ptr));
    IL2CPP_REGISTER_METHOD(0x004E57A0, DamageType__Enum, get_DamageType, (app::Damage * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0057AAC0, DamageWeight__Enum, get_DamageWeight, (app::Damage * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0098F4A0, AbilityType__Enum, get_AbilityType, (app::Damage * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB40, GameObject*, get_Sender, (app::Damage * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00575470, SpiritShardType__Enum, get_ShardType, (app::Damage * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00DC0DF0, Vector3, GetDamageEffectPosition, (app::IDamageReciever * receiver, app::Damage* damage));
    IL2CPP_REGISTER_METHOD(0x00DC1030, String*, CreateFullDescription, (app::Damage * this_ptr));
} // namespace app::methods::Damage
