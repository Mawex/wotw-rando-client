...
IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::CharacterEnvironmentForceController * this_ptr));
IL2CPP_REGISTER_METHOD(0x0104F070, void, OnUpdate, (app::CharacterEnvironmentForceController * this_ptr, float dt));
IL2CPP_REGISTER_METHOD(0x0104F760, Vector3, get_Velocity, (app::CharacterEnvironmentForceController * this_ptr));
IL2CPP_REGISTER_METHOD(0x0104F850, void, AddGroundImpulse, (app::CharacterEnvironmentForceController * this_ptr, float impulse));
IL2CPP_REGISTER_METHOD(0x0104FA90, void, __ctor, (app::CharacterEnvironmentForceController * this_ptr));
}
