...
namespace app::methods::MinerIdle {
    ...
    IL2CPP_REGISTER_METHOD(0x00420EE0, BehaviourStatus__Enum, OnExecuteTask, (app::MinerIdle * this_ptr, app::IContext* context));
    ...
    IL2CPP_REGISTER_METHOD(0x0144C310, MinerIdle_IdleStates__Enum, PickNewState, (app::MinerIdle * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0144C540, void, __ctor, (app::MinerIdle * this_ptr));
