...
IL2CPP_REGISTER_METHOD(0x00FA49F0, Transform *, get_ConnectedTransform, (app::LimitRigidbodyMovement * this_ptr));
IL2CPP_REGISTER_METHOD(0x00FA4AC0, void, __ctor, (app::LimitRigidbodyMovement * this_ptr));
}
