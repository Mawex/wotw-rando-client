...
namespace app::methods::System::Int32 {
    ...
    IL2CPP_REGISTER_METHOD(0x001311C0, String*, ToString_1, (app::Int32__Boxed * this_ptr));
    IL2CPP_REGISTER_METHOD(0x001E7FA0, String*, ToString_2, (app::Int32__Boxed * this_ptr, app::String* format));
    IL2CPP_REGISTER_METHOD(0x001E7FE0, String*, ToString_3, (app::Int32__Boxed * this_ptr, app::IFormatProvider* provider));
    IL2CPP_REGISTER_METHOD(0x001E8010, String*, ToString_4, (app::Int32__Boxed * this_ptr, app::String* format, app::IFormatProvider* provider));
    ...
    IL2CPP_REGISTER_METHOD(0x0238CE10, bool, TryParse_1, (app::String * s, app::int32_t* result));
    IL2CPP_REGISTER_METHOD(0x0238CE50, bool, TryParse_2, (app::String * s, app::NumberStyles__Enum style, app::IFormatProvider* provider, app::int32_t* result));
    IL2CPP_REGISTER_METHOD(0x001E8050, TypeCode__Enum, GetTypeCode, (app::Int32__Boxed * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x001E8740, Decimal, IConvertible_ToDecimal, (app::Int32__Boxed * this_ptr, app::IFormatProvider* provider));
    IL2CPP_REGISTER_METHOD(0x001E8890, DateTime, IConvertible_ToDateTime, (app::Int32__Boxed * this_ptr, app::IFormatProvider* provider));
    IL2CPP_REGISTER_METHODINFO(0x04725AE8, Int32_System_IConvertible_ToDateTime__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x001E88A0, Object*, IConvertible_ToType, (app::Int32__Boxed * this_ptr, app::Type* type, app::IFormatProvider* provider));
} // namespace app::methods::System::Int32
