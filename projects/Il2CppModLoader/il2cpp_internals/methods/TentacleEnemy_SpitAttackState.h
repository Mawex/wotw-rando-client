...
IL2CPP_REGISTER_METHOD(0x00CFA580, String *, get_Name, (app::TentacleEnemy_SpitAttackState * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CFA7B0, BehaviourTreeStatus__Enum, OnTentacleStateUpdate, (app::TentacleEnemy_SpitAttackState * this_ptr, app::TickData tick));
...
IL2CPP_REGISTER_METHOD(0x00CFB2C0, void, __ctor, (app::TentacleEnemy_SpitAttackState * this_ptr));
}
