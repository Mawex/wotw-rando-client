...
IL2CPP_REGISTER_METHOD(0x00A64220, StateMachine_2 *, get_StateMachine, (app::PetrifiedOwlBossRainOfFeathersBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x005FDE00, PetrifiedOwlBossBaseBehaviour_PetrifiedOwlBossBaseStatesSet *, get_States, (app::PetrifiedOwlBossRainOfFeathersBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0177B560, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossRainOfFeathersBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0177B9E0, Vector3, RandomOffScreenPosition, (app::PetrifiedOwlBossRainOfFeathersBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x0177C080, Vector3, RandomOffsetPosition, (app::PetrifiedOwlBossRainOfFeathersBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0177C660, Projectile *, SpawnProjectile, (app::PetrifiedOwlBossRainOfFeathersBehaviour * this_ptr, app::Vector2 shoot_point, app::Vector3 shoot_velocity, app::ProjectileSpawner * spawner));
IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, ShoulStopAttack, (app::PetrifiedOwlBossRainOfFeathersBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x0177C9E0, void, __ctor, (app::PetrifiedOwlBossRainOfFeathersBehaviour * this_ptr));
}
