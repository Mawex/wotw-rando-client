...
IL2CPP_REGISTER_METHOD(0x0148A9B0, FrameCounter_SecondInfo *, GetSecondById, (app::FrameCounter_1 * this_ptr, int32_t second_id));
IL2CPP_REGISTER_METHOD(0x0148AA20, void, __ctor, (app::FrameCounter_1 * this_ptr));
}
