...
IL2CPP_REGISTER_METHOD(0x024D48D0, Material *, get_material, (app::CameraFilterPack_Blur_Regular * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024D35E0, void, __ctor, (app::CameraFilterPack_Blur_Regular * this_ptr));
}
