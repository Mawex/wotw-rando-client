...
IL2CPP_REGISTER_METHOD(0x006253D0, GameObject *, get_Prefab, (app::CrabPlaceholder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00DB67E0, void, __ctor, (app::CrabPlaceholder * this_ptr));
}
