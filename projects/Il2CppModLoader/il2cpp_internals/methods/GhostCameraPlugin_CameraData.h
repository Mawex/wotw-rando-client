...
IL2CPP_REGISTER_METHOD(0x00E15C60, GhostFrame_FrameDataTypes__Enum, get_FrameType, (app::GhostCameraPlugin_CameraData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::GhostCameraPlugin_CameraData * this_ptr));
}
