...
IL2CPP_REGISTER_METHOD(0x024849F0, Material *, get_material, (app::CameraFilterPack_Oculus_NightVision2 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024856A0, void, __ctor, (app::CameraFilterPack_Oculus_NightVision2 * this_ptr));
}
