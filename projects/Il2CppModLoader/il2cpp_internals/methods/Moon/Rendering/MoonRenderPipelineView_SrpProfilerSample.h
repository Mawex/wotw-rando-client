...
namespace app::methods::Moon::Rendering::MoonRenderPipelineView_SrpProfilerSample {
    ...
    operator + (app::MoonRenderPipelineView_SrpProfilerSample a, app::MoonRenderPipelineView_SrpProfilerSample b) {
        return op_Addition(a, b);
    }
    operator / (app::MoonRenderPipelineView_SrpProfilerSample a, int32_t b) {
