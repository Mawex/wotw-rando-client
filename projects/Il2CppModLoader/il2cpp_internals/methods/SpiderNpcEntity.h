...
IL2CPP_REGISTER_METHOD(0x011BE8A0, String *, get_DialogActorName, (app::SpiderNpcEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x011BE920, String *, get_InteractionActorName, (app::SpiderNpcEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_CameraTargetActive, (app::SpiderNpcEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x011BE9A0, SpiderNpcEntity_State__Enum, get_CurrentState, (app::SpiderNpcEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00C0D850, IUberState__Array *, get_AffectingUberStates, (app::SpiderNpcEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x011BF640, void, set_AffectingUberStates, (app::SpiderNpcEntity * this_ptr, app::IUberState__Array * value));
IL2CPP_REGISTER_METHOD(0x011BF650, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::SpiderNpcEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004173E0, void, __ctor, (app::SpiderNpcEntity * this_ptr));
