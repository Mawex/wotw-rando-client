...
IL2CPP_REGISTER_METHOD(0x02720AC0, ITweenLerpInputProvider *, Resolve, (app::MoonReference_1_ITweenLerpInputProvider_ * this_ptr, app::IMoonResolverContext * context));
