...
IL2CPP_REGISTER_METHOD(0x0059E7A0, Object *, CreateData, (app::ServerProjectileSpawnerPinkPlantBrain * this_ptr, app::Object * data));
IL2CPP_REGISTER_METHOD(0x0059ECD0, Component_1 *, ApplyData, (app::ServerProjectileSpawnerPinkPlantBrain * this_ptr, app::GameObject * * gameobj));
