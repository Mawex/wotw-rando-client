...
namespace app::methods::System_Collections_Generic::EqualityComparer_1_SeinSpiritSpearSpell_FlyingSpear_ {
IL2CPP_REGISTER_METHOD(0x02807CD0, EqualityComparer_1_SeinSpiritSpearSpell_FlyingSpear_ *, get_Default, ());
IL2CPP_REGISTER_METHOD(0x02D93750, EqualityComparer_1_SeinSpiritSpearSpell_FlyingSpear_ *, CreateComparer, ());
...
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::EqualityComparer_1_SeinSpiritSpearSpell_FlyingSpear_ * this_ptr));
}
