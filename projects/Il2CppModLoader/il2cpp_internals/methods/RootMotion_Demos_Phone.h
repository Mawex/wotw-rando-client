...
namespace app::methods::RootMotion_Demos::Phone {
IL2CPP_REGISTER_METHOD(0x0222AB70, void, OnPickUp, (app::Phone * this_ptr));
IL2CPP_REGISTER_METHOD(0x0222AF80, IEnumerator *, EnableDisplay, (app::Phone * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::Phone * this_ptr));
}
