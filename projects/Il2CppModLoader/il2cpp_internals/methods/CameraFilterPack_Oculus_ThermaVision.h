...
IL2CPP_REGISTER_METHOD(0x02486E40, Material *, get_material, (app::CameraFilterPack_Oculus_ThermaVision * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02487790, void, __ctor, (app::CameraFilterPack_Oculus_ThermaVision * this_ptr));
}
