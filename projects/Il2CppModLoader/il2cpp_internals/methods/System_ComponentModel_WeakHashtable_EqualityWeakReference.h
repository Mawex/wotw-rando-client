...
namespace app::methods::System_ComponentModel::WeakHashtable_EqualityWeakReference {
    IL2CPP_REGISTER_METHOD(0x0295E800, void, __ctor, (app::WeakHashtable_EqualityWeakReference * this_ptr, app::Object * o));
