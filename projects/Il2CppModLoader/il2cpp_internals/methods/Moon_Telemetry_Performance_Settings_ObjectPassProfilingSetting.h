...
IL2CPP_REGISTER_METHOD(0x00E3E540, RenderScope__Enum *, GetScope, (ObjectPassProfilingSetting * __this));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (ObjectPassProfilingSetting * __this));
}
