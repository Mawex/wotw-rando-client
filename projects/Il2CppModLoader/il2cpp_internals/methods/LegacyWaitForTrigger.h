...
IL2CPP_REGISTER_METHOD(0x011318A0, Rect, get_Bounds, (app::LegacyWaitForTrigger * this_ptr));
IL2CPP_REGISTER_METHOD(0x01131A70, Func_2_IContext_Boolean_ *, get_CodeCondition, (app::LegacyWaitForTrigger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008C5A70, void, __ctor, (app::LegacyWaitForTrigger * this_ptr));
}
