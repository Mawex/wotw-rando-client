...
namespace app::methods::System_Collections_Generic::List_1_SaveSlotUI_ {
...
IL2CPP_REGISTER_METHOD(0x025EFC50, SaveSlotUI *, get_Item, (app::List_1_SaveSlotUI_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_SaveSlotUI_, GetEnumerator, (app::List_1_SaveSlotUI_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04708780, List_1_SaveSlotUI__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_SaveSlotUI_ * this_ptr));
