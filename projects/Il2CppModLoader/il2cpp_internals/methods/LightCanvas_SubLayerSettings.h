...
IL2CPP_REGISTER_METHOD(0x01145DA0, LightCanvas_SubLayerSettings *, get_ClipBoard, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x01145E20, void, set_ClipBoard, (LightCanvas_SubLayerSettings * value));
IL2CPP_REGISTER_METHOD(0x01145FB0, bool, get_HasClipBoardValue, (MethodInfo * method));
