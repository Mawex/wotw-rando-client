...
IL2CPP_REGISTER_METHOD(0x012708F0, void, __ctor, (app::FloatCurveAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00BAB250, String *, IAnimatedValueProvider_float__get_name, (app::FloatCurveAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00BAB250, String *, IAnimatedValueProvider_bool__get_name, (app::FloatCurveAnimator * this_ptr));
}
