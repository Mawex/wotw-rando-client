...
namespace app::methods::UberShaderVectorDisplay {
    ...
    IL2CPP_REGISTER_METHOD(0x0128A080, void, __ctor_1, (app::UberShaderVectorDisplay * this_ptr, app::String * xy_name, app::String * zw_name));
    IL2CPP_REGISTER_METHOD(0x0128A090, void, __ctor_2, (app::UberShaderVectorDisplay * this_ptr, app::String * x, app::String * y, app::String * z, app::String * w));
}
