...
namespace app::methods::LegacyEntity {
    IL2CPP_REGISTER_METHOD(0x00A1DC40, StateMachine_2*, get_StateMachine, (app::LegacyEntity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A1DD80, BehaviourTree_1*, get_BehaviourTree, (app::LegacyEntity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FBBE0, List_1_Moon_ISuspendable_*, GetHitStopAutoSuspendables, (app::LegacyEntity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00A1F520, Vector3, get_PlayerPosition, (app::LegacyEntity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::LegacyEntity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00736690, void, set_Position, (app::LegacyEntity * this_ptr, app::Vector3 value));
    IL2CPP_REGISTER_METHOD(0x0058E220, Quaternion, get_Rotation, (app::LegacyEntity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A1F680, void, set_Rotation, (app::LegacyEntity * this_ptr, app::Quaternion value));
    IL2CPP_REGISTER_METHOD(0x00A1F750, Vector3, get_PositionToPlayerPosition, (app::LegacyEntity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A1F950, Vector3, get_StartPositionToPlayerPosition, (app::LegacyEntity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A1FA70, bool, get_LeftOfStartPosition, (app::LegacyEntity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A1FAA0, Vector3, get_PositionToStartPosition, (app::LegacyEntity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A1FBC0, Vector3, get_StartPosition, (app::LegacyEntity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00A1FC40, void, __ctor, (app::LegacyEntity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x003FC380, SuspendableMask__Enum, get_Mask, (app::LegacyEntity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00A20A10, Bounds, get_Bounds, (app::LegacyEntity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x004F4750, GameObject*, IHitStopReceiver_get_gameObject, (app::LegacyEntity * this_ptr));
} // namespace app::methods::LegacyEntity
