...
namespace app::methods::Moon_Timeline::StaticEventDescriptor {
IL2CPP_REGISTER_METHOD(0x01E83110, void, __ctor, (app::StaticEventDescriptor * this_ptr, int32_t event_id, float static_time, app::String * name, bool is_constrainable, bool is_deletable));
...
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Name, (app::StaticEventDescriptor * this_ptr));
