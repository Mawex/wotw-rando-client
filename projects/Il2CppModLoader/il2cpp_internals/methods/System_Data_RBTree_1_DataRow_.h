...
namespace app::methods::System_Data::RBTree_1_DataRow_ {
...
IL2CPP_REGISTER_METHOD(0x02FB3CE0, DataRow *, get_Item, (app::RBTree_1_DataRow_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02FB9E60, IEnumerator *, GetEnumerator, (app::RBTree_1_DataRow_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04725028, RBTree_1_DataRow__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02FAF680, void, __ctor, (app::RBTree_1_DataRow_ * this_ptr, app::TreeAccessMethod__Enum access_method));
