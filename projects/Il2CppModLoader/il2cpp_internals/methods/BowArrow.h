...
namespace app::methods::BowArrow {
    ...
    IL2CPP_REGISTER_METHOD(0x00D404E0, Vector3, get_CurrentTipPosition, (app::BowArrow * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00D405A0, float, get_Range, (app::BowArrow * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00D406B0, SpiritShardType__Enum, get_SpiritShardDamageType, (app::BowArrow * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00D40770, SuspendableMask__Enum, get_Mask, (app::BowArrow * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00D41870, Damage*, CreateNewDamage, (app::BowArrow * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0043D9E0, RecordableParsingGroup__Enum, get_ParsingGroup, (app::BowArrow * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00D47870, TrackingExclusions, get_TrackingExclusions, (app::BowArrow * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00D47880, void, __ctor, (app::BowArrow * this_ptr));
