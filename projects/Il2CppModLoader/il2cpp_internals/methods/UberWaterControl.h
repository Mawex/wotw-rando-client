...
IL2CPP_REGISTER_METHOD(0x012946D0, Bounds, UpdateBoundary, (app::UberWaterControl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01296540, Vector4, WaveOffset, (app::UberWaterControl * this_ptr, app::Vector4 speed, app::Vector4 scale));
...
IL2CPP_REGISTER_METHOD(0x01299B60, UberWaterControl_ImpactBuf, GetBufFromSettings, (app::UberWaterControl * this_ptr, app::Vector2 local_uv, float power, float radius));
...
IL2CPP_REGISTER_METHOD(0x0129AA20, UberWaterControl *, GetNearestWaterControl, (app::Vector3 point));
...
IL2CPP_REGISTER_METHOD(0x0129B700, Vector3, IInteractable_GetPosition, (app::UberWaterControl * this_ptr));
IL2CPP_REGISTER_METHOD(0x0129B790, Vector3, IInteractable_GetExplodePoint, (app::UberWaterControl * this_ptr, app::Vector3 position));
...
IL2CPP_REGISTER_METHOD(0x0129B9E0, Bounds, get_Bounds, (app::UberWaterControl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0129C280, Bounds, IFrustumOptimizable_get_Bounds, (app::UberWaterControl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00949D10, SuspendableMask__Enum, ISuspendable_get_Mask, (app::UberWaterControl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0129C460, void, __ctor, (app::UberWaterControl * this_ptr));
