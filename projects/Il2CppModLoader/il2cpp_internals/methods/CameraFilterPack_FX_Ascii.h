...
IL2CPP_REGISTER_METHOD(0x02468F30, Material *, get_material, (app::CameraFilterPack_FX_Ascii * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0136E200, void, __ctor, (app::CameraFilterPack_FX_Ascii * this_ptr));
}
