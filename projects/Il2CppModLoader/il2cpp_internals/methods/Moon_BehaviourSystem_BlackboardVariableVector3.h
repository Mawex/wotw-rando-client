...
namespace app::methods::Moon_BehaviourSystem::BlackboardVariableVector3 {
    ...
    IL2CPP_REGISTER_METHOD(0x0300A7A0, void, __ctor, (app::BlackboardVariableVector3 * this_ptr));
}
