...
IL2CPP_REGISTER_METHOD(0x0049F2B0, StateMachine_2 *, get_StateMachine, (app::PetrifiedOwlBossTripleSlamBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x006A63A0, PetrifiedOwlBossBaseBehaviour_PetrifiedOwlBossBaseStatesSet *, get_States, (app::PetrifiedOwlBossTripleSlamBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x017805D0, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossTripleSlamBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01780C60, void, __ctor, (app::PetrifiedOwlBossTripleSlamBehaviour * this_ptr));
}
