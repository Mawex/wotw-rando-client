...
IL2CPP_REGISTER_METHOD(0x002FB930, UberShaderBlock *, get_AttachedBlock, (app::UberShaderProperty * this_ptr));
IL2CPP_REGISTER_METHOD(0x0191A3A0, bool, get_HasMaterial, (app::UberShaderProperty * this_ptr));
IL2CPP_REGISTER_METHOD(0x0191A500, Material *, GetMaterial, (app::UberShaderProperty * this_ptr, app::Renderer * renderer));
IL2CPP_REGISTER_METHOD(0x0191A560, Material *, get_BindMaterial, (app::UberShaderProperty * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, get_BindName, (app::UberShaderProperty * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::UberShaderProperty * this_ptr));
}
