...
namespace app::methods::System_Collections::ArrayList {
IL2CPP_REGISTER_METHOD(0x022A3560, void, __ctor_1, (app::ArrayList * this_ptr));
IL2CPP_REGISTER_METHOD(0x022A3610, void, __ctor_2, (app::ArrayList * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHODINFO(0x04709B80, ArrayList__ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x022A3770, void, __ctor_3, (app::ArrayList * this_ptr, app::ICollection * c));
...
IL2CPP_REGISTER_METHOD(0x022A3A00, Object *, get_SyncRoot, (app::ArrayList * this_ptr));
IL2CPP_REGISTER_METHOD(0x022A3B60, Object *, get_Item, (app::ArrayList * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x022A3DA0, ArrayList *, Adapter, (app::IList * list));
...
IL2CPP_REGISTER_METHOD(0x022A4050, Object *, Clone, (app::ArrayList * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x022A45E0, IEnumerator *, GetEnumerator, (app::ArrayList * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x022A4BB0, IList *, ReadOnly_1, (app::IList * list));
IL2CPP_REGISTER_METHODINFO(0x04753E48, ArrayList_ReadOnly__MethodInfo);
IL2CPP_REGISTER_METHOD(0x022A4D30, ArrayList *, ReadOnly_2, (app::ArrayList * list));
...
IL2CPP_REGISTER_METHOD(0x022A53F0, Object__Array *, ToArray_1, (app::ArrayList * this_ptr));
IL2CPP_REGISTER_METHOD(0x022A54B0, Array *, ToArray_2, (app::ArrayList * this_ptr, app::Type * type));
