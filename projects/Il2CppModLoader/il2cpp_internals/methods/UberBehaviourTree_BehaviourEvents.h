...
IL2CPP_REGISTER_METHOD(0x013DFB40, List_1_UberBehaviourTree_IBehaviourEvent_ *, Query, (app::BehaviourEvents * this_ptr, int32_t unique_event_id));
IL2CPP_REGISTER_METHOD(0x013DFD50, void, Clear, (app::BehaviourEvents * this_ptr));
IL2CPP_REGISTER_METHOD(0x013DFEE0, void, __ctor, (app::BehaviourEvents * this_ptr));
}
