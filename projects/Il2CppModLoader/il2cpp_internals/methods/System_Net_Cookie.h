...
namespace app::methods::System_Net::Cookie {
IL2CPP_REGISTER_METHOD(0x01E9CEC0, void, __ctor_1, (app::Cookie * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E9D020, void, __ctor_2, (app::Cookie * this_ptr, app::String * name, app::String * value));
IL2CPP_REGISTER_METHOD(0x01E9D1B0, void, __ctor_3, (app::Cookie * this_ptr, app::String * name, app::String * value, app::String * path));
IL2CPP_REGISTER_METHOD(0x01E9D1E0, void, __ctor_4, (app::Cookie * this_ptr, app::String * name, app::String * value, app::String * path, app::String * domain));
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_Comment, (app::Cookie * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E9D220, void, set_Comment, (app::Cookie * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB930, Uri *, get_CommentUri, (app::Cookie * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, get_Domain, (app::Cookie * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E9D2D0, void, set_Domain, (app::Cookie * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x01E9D390, String *, get__Domain, (app::Cookie * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, DateTime, get_Expires, (app::Cookie * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9C0, void, set_Expires, (app::Cookie * this_ptr, app::DateTime value));
IL2CPP_REGISTER_METHOD(0x002FB9D0, String *, get_Name, (app::Cookie * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9F0, String *, get_Path, (app::Cookie * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E9D940, void, set_Path, (app::Cookie * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x01E9D9F0, String *, get__Path, (app::Cookie * this_ptr));
IL2CPP_REGISTER_METHOD(0x01DC7EC0, bool, get_Plain, (app::Cookie * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E9DAB0, Cookie *, Clone, (app::Cookie * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB60, String *, get_Port, (app::Cookie * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBA0, Int32__Array *, get_PortList, (app::Cookie * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E9F590, String *, get__Port, (app::Cookie * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBE0, DateTime, get_TimeStamp, (app::Cookie * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC00, String *, get_Value, (app::Cookie * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E9F680, void, set_Value, (app::Cookie * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FD1D0, CookieVariant__Enum, get_Variant, (app::Cookie * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FD1E0, void, set_Variant, (app::Cookie * this_ptr, app::CookieVariant__Enum value));
IL2CPP_REGISTER_METHOD(0x01E9F730, String *, get_DomainKey, (app::Cookie * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E9F820, String *, get__Version, (app::Cookie * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01EA0200, String *, ToString, (app::Cookie * this_ptr));
IL2CPP_REGISTER_METHOD(0x01EA0970, String *, ToServerString, (app::Cookie * this_ptr));
