...
namespace app::methods::System_Xml_Schema::XmlSchemaElement {
...
IL2CPP_REGISTER_METHOD(0x00C03C70, XmlSchemaDerivationMethod__Enum, get_Block, (app::XmlSchemaElement * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C03C80, void, set_Block, (app::XmlSchemaElement * this_ptr, app::XmlSchemaDerivationMethod__Enum value));
IL2CPP_REGISTER_METHOD(0x002FBC40, String *, get_DefaultValue, (app::XmlSchemaElement * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC50, void, set_DefaultValue, (app::XmlSchemaElement * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x00653FB0, XmlSchemaDerivationMethod__Enum, get_Final, (app::XmlSchemaElement * this_ptr));
IL2CPP_REGISTER_METHOD(0x00881060, void, set_Final, (app::XmlSchemaElement * this_ptr, app::XmlSchemaDerivationMethod__Enum value));
IL2CPP_REGISTER_METHOD(0x002FBC60, String *, get_FixedValue, (app::XmlSchemaElement * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC70, void, set_FixedValue, (app::XmlSchemaElement * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x00989BF0, XmlSchemaForm__Enum, get_Form, (app::XmlSchemaElement * this_ptr));
IL2CPP_REGISTER_METHOD(0x009C9740, void, set_Form, (app::XmlSchemaElement * this_ptr, app::XmlSchemaForm__Enum value));
IL2CPP_REGISTER_METHOD(0x002FBC80, String *, get_Name, (app::XmlSchemaElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBCA0, XmlQualifiedName *, get_RefName, (app::XmlSchemaElement * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CA76A0, void, set_RefName, (app::XmlSchemaElement * this_ptr, app::XmlQualifiedName * value));
IL2CPP_REGISTER_METHOD(0x002FBCC0, XmlQualifiedName *, get_SubstitutionGroup, (app::XmlSchemaElement * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CA7790, void, set_SubstitutionGroup, (app::XmlSchemaElement * this_ptr, app::XmlQualifiedName * value));
IL2CPP_REGISTER_METHOD(0x002FBCE0, XmlQualifiedName *, get_SchemaTypeName, (app::XmlSchemaElement * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CA7880, void, set_SchemaTypeName, (app::XmlSchemaElement * this_ptr, app::XmlQualifiedName * value));
IL2CPP_REGISTER_METHOD(0x002FBD00, XmlSchemaType *, get_SchemaType, (app::XmlSchemaElement * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD10, void, set_SchemaType, (app::XmlSchemaElement * this_ptr, app::XmlSchemaType * value));
IL2CPP_REGISTER_METHOD(0x01CA7970, XmlSchemaObjectCollection *, get_Constraints, (app::XmlSchemaElement * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD20, XmlQualifiedName *, get_QualifiedName, (app::XmlSchemaElement * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD40, XmlSchemaType *, get_ElementSchemaType, (app::XmlSchemaElement * this_ptr));
IL2CPP_REGISTER_METHOD(0x003FFBD0, XmlSchemaDerivationMethod__Enum, get_BlockResolved, (app::XmlSchemaElement * this_ptr));
IL2CPP_REGISTER_METHOD(0x00413180, XmlSchemaDerivationMethod__Enum, get_FinalResolved, (app::XmlSchemaElement * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005B0220, SchemaElementDecl *, get_ElementDecl, (app::XmlSchemaElement * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A2A740, void, set_ElementDecl, (app::XmlSchemaElement * this_ptr, app::SchemaElementDecl * value));
IL2CPP_REGISTER_METHOD(0x002FBC80, String *, get_NameAttribute, (app::XmlSchemaElement * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC90, void, set_NameAttribute, (app::XmlSchemaElement * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x01CA7B20, String *, get_NameString, (app::XmlSchemaElement * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CA7B50, XmlSchemaObject *, Clone_1, (app::XmlSchemaElement * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CA7B60, XmlSchemaObject *, Clone_2, (app::XmlSchemaElement * this_ptr, app::XmlSchema * parent_schema));
IL2CPP_REGISTER_METHOD(0x01CA7E20, void, __ctor, (app::XmlSchemaElement * this_ptr));
}
