...
IL2CPP_REGISTER_METHOD(0x0064D930, Vector3, get_TargetPosition, (app::MoveToBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0111C180, Locomotion *, get_Locomotion, (app::MoveToBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00615280, void, __ctor, (app::MoveToBehaviour * this_ptr));
}
