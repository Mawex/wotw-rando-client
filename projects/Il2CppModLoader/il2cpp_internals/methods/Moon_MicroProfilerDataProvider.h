...
IL2CPP_REGISTER_METHOD(0x03158720, List_1_Moon_Profile_Metric_ *, get_SupportedMetrics, (app::MicroProfilerDataProvider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MicroProfilerDataProvider * this_ptr));
