...
namespace app::methods::Moon::MoonInt {
    ...
    IL2CPP_REGISTER_METHOD(0x02F94F10, CrossSceneReferenceId, get_CrossSceneReferenceId, (app::MoonInt * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x02F92DD0, void, __ctor, (app::MoonInt * this_ptr, int32_t static_value));
    ...
    IL2CPP_REGISTER_METHOD(0x02F95760, bool, TryResolve, (app::MoonInt * this_ptr, app::int32_t* value, app::IMoonResolverContext* context));
    ...
    IL2CPP_REGISTER_METHOD(0x00C3DD30, MoonTypeData, GetTypeData, (app::MoonInt * this_ptr));
} // namespace app::methods::Moon::MoonInt
