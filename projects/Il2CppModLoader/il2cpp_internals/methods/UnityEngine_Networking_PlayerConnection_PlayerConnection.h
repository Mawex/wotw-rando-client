...
namespace app::methods::UnityEngine_Networking_PlayerConnection::PlayerConnection {
IL2CPP_REGISTER_METHOD(0x0253D780, void, __ctor, (app::PlayerConnection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0253DE50, IPlayerEditorConnectionNative *, GetConnectionNativeApi, (app::PlayerConnection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0253F160, void, MessageCallbackInternal, (app::void * data, uint64_t size, uint64_t guid, app::String * message_id));
