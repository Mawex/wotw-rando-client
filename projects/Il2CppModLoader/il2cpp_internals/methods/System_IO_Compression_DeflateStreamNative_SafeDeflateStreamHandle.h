...
namespace app::methods::System_IO_Compression::DeflateStreamNative_SafeDeflateStreamHandle {
IL2CPP_REGISTER_METHOD(0x02009980, bool, get_IsInvalid, (app::DeflateStreamNative_SafeDeflateStreamHandle * this_ptr));
IL2CPP_REGISTER_METHOD(0x02009A00, void, __ctor, (app::DeflateStreamNative_SafeDeflateStreamHandle * this_ptr));
