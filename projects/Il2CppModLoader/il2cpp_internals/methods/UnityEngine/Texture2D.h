...
namespace app::methods::UnityEngine::Texture2D {
    IL2CPP_REGISTER_METHOD(0x02C66B50, void, __ctor_1, (app::Texture2D * this_ptr, int32_t width, int32_t height, app::GraphicsFormat__Enum format, app::TextureCreationFlags__Enum flags, void * native_tex));
    ...
    IL2CPP_REGISTER_METHOD(0x02C66CC0, void, __ctor_3, (app::Texture2D * this_ptr, int32_t width, int32_t height, app::TextureFormat__Enum texture_format, bool mip_chain, bool linear, void * native_tex));
