...
IL2CPP_REGISTER_METHOD(0x03141820, void, __ctor, (app::AudioSource * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03141B00, AudioClip *, get_clip, (app::AudioSource * this_ptr));
IL2CPP_REGISTER_METHOD(0x03141B50, void, set_clip, (app::AudioSource * this_ptr, app::AudioClip * value));
IL2CPP_REGISTER_METHOD(0x03141BB0, AudioMixerGroup *, get_outputAudioMixerGroup, (app::AudioSource * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03142AE0, AudioVelocityUpdateMode__Enum, get_velocityUpdateMode, (app::AudioSource * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03143070, AnimationCurve *, GetCustomCurve, (app::AudioSource * this_ptr, app::AudioSourceCurveType__Enum type));
...
IL2CPP_REGISTER_METHOD(0x031437B0, AudioRolloffMode__Enum, get_rolloffMode, (app::AudioSource * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x031438D0, Single__Array *, GetOutputData_1, (app::AudioSource * this_ptr, int32_t num_samples, int32_t channel));
...
IL2CPP_REGISTER_METHOD(0x03143A10, Single__Array *, GetSpectrumData_1, (app::AudioSource * this_ptr, int32_t num_samples, int32_t channel, app::FFTWindow__Enum window));
...
IL2CPP_REGISTER_METHOD(0x03143C00, PropertyName, ReadExtensionName, (app::AudioSource * this_ptr, int32_t source_index));
...
IL2CPP_REGISTER_METHOD(0x03143CE0, PropertyName, ReadExtensionPropertyName, (app::AudioSource * this_ptr, int32_t source_index));
...
IL2CPP_REGISTER_METHOD(0x03143E20, bool, ReadExtensionProperty, (app::AudioSource * this_ptr, app::PropertyName extension_name, app::PropertyName property_name, app::float * property_value));
IL2CPP_REGISTER_METHOD(0x03143EA0, bool, INTERNAL_CALL_ReadExtensionProperty, (app::AudioSource * self, app::PropertyName * extension_name, app::PropertyName * property_name, app::float * property_value));
...
IL2CPP_REGISTER_METHOD(0x03143FE0, AudioSourceExtension *, AddSpatializerExtension, (app::AudioSource * this_ptr, app::Type * extension_type));
IL2CPP_REGISTER_METHOD(0x03144130, AudioSourceExtension *, AddAmbisonicExtension, (app::AudioSource * this_ptr, app::Type * extension_type));
...
IL2CPP_REGISTER_METHOD(0x03144500, bool, GetSpatializerFloat, (app::AudioSource * this_ptr, int32_t index, app::float * value));
IL2CPP_REGISTER_METHOD(0x03144570, bool, SetAmbisonicDecoderFloat, (app::AudioSource * this_ptr, int32_t index, float value));
IL2CPP_REGISTER_METHOD(0x031445E0, bool, GetAmbisonicDecoderFloat, (app::AudioSource * this_ptr, int32_t index, app::float * value));
}
