...
namespace app::methods::SeinEnergy {
    ...
    IL2CPP_REGISTER_METHOD(0x00ACEE00, Object*, get_EnergyUpgradesCollected, (app::SeinEnergy * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00ACF550, bool, TryGetCurrentBloodPacktHPCost, (app::SeinEnergy * this_ptr, app::float* cost));
    ...
    IL2CPP_REGISTER_METHOD(0x002FBC40, IUberState__Array*, get_AffectingUberStates, (app::SeinEnergy * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBC50, void, set_AffectingUberStates, (app::SeinEnergy * this_ptr, app::IUberState__Array* value));
    IL2CPP_REGISTER_METHOD(0x002FBC60, List_1_UnityEngine_GameObject_*, get_AllTargets, (app::SeinEnergy * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBC70, void, set_AllTargets, (app::SeinEnergy * this_ptr, app::List_1_UnityEngine_GameObject_* value));
    IL2CPP_REGISTER_METHOD(0x00AD0470, void, __ctor, (app::SeinEnergy * this_ptr));
} // namespace app::methods::SeinEnergy
