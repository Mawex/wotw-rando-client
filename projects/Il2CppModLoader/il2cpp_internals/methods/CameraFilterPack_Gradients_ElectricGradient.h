...
IL2CPP_REGISTER_METHOD(0x0247AE00, Material *, get_material, (app::CameraFilterPack_Gradients_ElectricGradient * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0247B420, void, __ctor, (app::CameraFilterPack_Gradients_ElectricGradient * this_ptr));
}
