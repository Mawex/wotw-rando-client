...
namespace app::methods::Moon_Wwise::ListenerSyncProcessor_ListenerSyncTask {
...
IL2CPP_REGISTER_METHOD(0x00C3DD30, SoundListenerReference, get_Listener, (app::ListenerSyncProcessor_ListenerSyncTask * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FC6E0, void, __ctor, (app::ListenerSyncProcessor_ListenerSyncTask * this_ptr, int32_t i));
