...
namespace app::methods::Mono_Security_X509::X509Crl {
...
IL2CPP_REGISTER_METHOD(0x02942000, ArrayList *, get_Entries, (app::X509Crl * this_ptr));
IL2CPP_REGISTER_METHOD(0x029420A0, X509Crl_X509CrlEntry *, get_Item_1, (app::X509Crl * this_ptr, int32_t index));
IL2CPP_REGISTER_METHOD(0x029421A0, X509Crl_X509CrlEntry *, get_Item_2, (app::X509Crl * this_ptr, app::Byte__Array * serial_number));
IL2CPP_REGISTER_METHOD(0x002FB9F0, X509ExtensionCollection_1 *, get_Extensions, (app::X509Crl * this_ptr));
IL2CPP_REGISTER_METHOD(0x029421B0, Byte__Array *, get_Hash, (app::X509Crl * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_IssuerName, (app::X509Crl * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB00, DateTime, get_NextUpdate, (app::X509Crl * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB950, DateTime, get_ThisUpdate, (app::X509Crl * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9B0, String *, get_SignatureAlgorithm, (app::X509Crl * this_ptr));
IL2CPP_REGISTER_METHOD(0x029424B0, Byte__Array *, get_Signature, (app::X509Crl * this_ptr));
IL2CPP_REGISTER_METHOD(0x02942600, Byte__Array *, get_RawData, (app::X509Crl * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02942A80, Byte__Array *, GetBytes, (app::X509Crl * this_ptr));
IL2CPP_REGISTER_METHOD(0x0293FC80, bool, Compare, (app::X509Crl * this_ptr, app::Byte__Array * array1, app::Byte__Array * array2));
IL2CPP_REGISTER_METHOD(0x02942BC0, X509Crl_X509CrlEntry *, GetCrlEntry_1, (app::X509Crl * this_ptr, app::X509Certificate_2 * x509));
IL2CPP_REGISTER_METHODINFO(0x04764308, X509Crl_GetCrlEntry__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02942CA0, X509Crl_X509CrlEntry *, GetCrlEntry_2, (app::X509Crl * this_ptr, app::Byte__Array * serial_number));
...
IL2CPP_REGISTER_METHOD(0x02943B90, X509Crl *, CreateFromFile, (app::String * filename));
