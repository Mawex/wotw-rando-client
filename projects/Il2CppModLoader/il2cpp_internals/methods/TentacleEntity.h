...
IL2CPP_REGISTER_METHOD(0x00CFDE00, Vector3, get_CameraTargetPosition, (app::TentacleEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CFE810, Vector3, SnapTargetToInterestPoint, (app::TentacleEntity * this_ptr, app::Vector3 position));
...
IL2CPP_REGISTER_METHOD(0x00CFEDD0, Vector3, ApplyTargetBounds, (app::TentacleEntity * this_ptr, app::Vector3 target));
...
IL2CPP_REGISTER_METHOD(0x00D001F0, void, __ctor, (app::TentacleEntity * this_ptr));
}
