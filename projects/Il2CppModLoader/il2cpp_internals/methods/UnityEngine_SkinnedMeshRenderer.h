...
IL2CPP_REGISTER_METHOD(0x0297DC60, Transform *, get_rootBone, (app::SkinnedMeshRenderer * this_ptr));
IL2CPP_REGISTER_METHOD(0x0297DCB0, Transform__Array *, get_bones, (app::SkinnedMeshRenderer * this_ptr));
IL2CPP_REGISTER_METHOD(0x0297DD00, void, set_bones, (app::SkinnedMeshRenderer * this_ptr, app::Transform__Array * value));
IL2CPP_REGISTER_METHOD(0x0297DD60, Mesh *, get_sharedMesh, (app::SkinnedMeshRenderer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0297DE70, Bounds, GetLocalAABB, (app::SkinnedMeshRenderer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0297DE70, Bounds, get_localBounds, (app::SkinnedMeshRenderer * this_ptr));
