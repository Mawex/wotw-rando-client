...
IL2CPP_REGISTER_METHOD(0x00DADA90, void, __ctor, (app::Music_Layer * this_ptr, app::SoundProvider * sound_provider, float fade_in_duration, float fade_out_duration));
