...
namespace app::methods::System_Diagnostics_Tracing::NameInfo {
    IL2CPP_REGISTER_METHOD(0x01A06D30, void, ReserveEventIDsBelow, (int32_t event_id));
    IL2CPP_REGISTER_METHOD(0x01A06E30, void, __ctor, (app::NameInfo_1 * this_ptr, app::String * name, app::EventTags__Enum tags, int32_t type_metadata_size));
