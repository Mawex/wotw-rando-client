...
IL2CPP_REGISTER_METHOD(0x002FD490, SuspendableMask__Enum, get_Mask, (app::TiggerWithConditionOrWaitTime * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010ED7F0, void, __ctor, (app::TiggerWithConditionOrWaitTime * this_ptr));
}
