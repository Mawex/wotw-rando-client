...
namespace app::methods::System_Xml_Serialization::XmlAnyElementAttribute {
    IL2CPP_REGISTER_METHOD(0x00443280, void, __ctor, (app::XmlAnyElementAttribute * this_ptr));
