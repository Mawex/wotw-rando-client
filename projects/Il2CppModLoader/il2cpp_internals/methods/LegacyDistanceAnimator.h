...
IL2CPP_REGISTER_METHOD(0x0057AAC0, SuspendableMask__Enum, get_Mask, (app::LegacyDistanceAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A1A3D0, void, set_Mask, (app::LegacyDistanceAnimator * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x00A1A480, void, __ctor, (app::LegacyDistanceAnimator * this_ptr));
}
