...
namespace app::methods::System_Data::XmlDataLoader {
IL2CPP_REGISTER_METHOD(0x023E8760, void, __ctor_1, (app::XmlDataLoader * this_ptr, app::DataSet * dataset, bool is_xdr, bool ignore_schema));
IL2CPP_REGISTER_METHOD(0x023E88E0, void, __ctor_2, (app::XmlDataLoader * this_ptr, app::DataSet * dataset, bool is_xdr, app::XmlElement * top_node, bool ignore_schema));
IL2CPP_REGISTER_METHOD(0x023E8BA0, void, __ctor_3, (app::XmlDataLoader * this_ptr, app::DataTable * datatable, bool is_xdr, bool ignore_schema));
IL2CPP_REGISTER_METHOD(0x023E8D20, void, __ctor_4, (app::XmlDataLoader * this_ptr, app::DataTable * datatable, bool is_xdr, app::XmlElement * top_node, bool ignore_schema));
...
IL2CPP_REGISTER_METHOD(0x023E9380, String *, GetValueForTextOnlyColums, (app::XmlDataLoader * this_ptr, app::XmlNode * n));
IL2CPP_REGISTER_METHOD(0x023E96E0, String *, GetInitialTextFromNodes, (app::XmlDataLoader * this_ptr, app::XmlNode * * n));
IL2CPP_REGISTER_METHOD(0x023E9AB0, DataColumn *, GetTextOnlyColumn, (app::XmlDataLoader * this_ptr, app::DataRow * row));
IL2CPP_REGISTER_METHOD(0x023E9B80, DataRow *, GetRowFromElement, (app::XmlDataLoader * this_ptr, app::XmlElement * e));
