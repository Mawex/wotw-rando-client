...
IL2CPP_REGISTER_METHOD(0x00DDFBB0, SeinDeathsManager *, get_DeathsManager, (app::DeathWispsManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00DE0950, void, __ctor, (app::DeathWispsManager * this_ptr));
}
