...
IL2CPP_REGISTER_METHOD(0x01737180, MethodBase *, BindToMethod, (app::DefaultBinder * this_ptr, app::BindingFlags__Enum binding_attr, app::MethodBase__Array * match, app::Object__Array * * args, app::ParameterModifier__Array * modifiers, app::CultureInfo * culture_info, app::String__Array * names, app::Object * * state));
IL2CPP_REGISTER_METHODINFO(0x0472C568, DefaultBinder_BindToMethod__MethodInfo);
IL2CPP_REGISTER_METHOD(0x017398D0, FieldInfo_1 *, BindToField, (app::DefaultBinder * this_ptr, app::BindingFlags__Enum binding_attr, app::FieldInfo_1__Array * match, app::Object * value, app::CultureInfo * culture_info));
IL2CPP_REGISTER_METHODINFO(0x04714DE0, DefaultBinder_BindToField__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0173A060, MethodBase *, SelectMethod, (app::DefaultBinder * this_ptr, app::BindingFlags__Enum binding_attr, app::MethodBase__Array * match, app::Type__Array * types, app::ParameterModifier__Array * modifiers));
IL2CPP_REGISTER_METHODINFO(0x04768908, DefaultBinder_SelectMethod__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0173A890, PropertyInfo_1 *, SelectProperty, (app::DefaultBinder * this_ptr, app::BindingFlags__Enum binding_attr, app::PropertyInfo_1__Array * match, app::Type * return_type, app::Type__Array * indexes, app::ParameterModifier__Array * modifiers));
IL2CPP_REGISTER_METHODINFO(0x0476FBF0, DefaultBinder_SelectProperty__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0173B440, Object *, ChangeType, (app::DefaultBinder * this_ptr, app::Object * value, app::Type * type, app::CultureInfo * culture_info));
...
IL2CPP_REGISTER_METHOD(0x0173B880, MethodBase *, ExactBinding, (app::MethodBase__Array * match, app::Type__Array * types, app::ParameterModifier__Array * modifiers));
IL2CPP_REGISTER_METHODINFO(0x04784108, DefaultBinder_ExactBinding__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0173BB60, PropertyInfo_1 *, ExactPropertyBinding, (app::PropertyInfo_1__Array * match, app::Type * return_type, app::Type__Array * types, app::ParameterModifier__Array * modifiers));
...
IL2CPP_REGISTER_METHOD(0x0173CC10, MethodBase *, FindMostDerivedNewSlotMeth, (app::MethodBase__Array * match, int32_t c_matches));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::DefaultBinder * this_ptr));
}
