...
IL2CPP_REGISTER_METHOD(0x002FBBC0, Transform *, get_Transform, (app::CartController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00736620, SuspendableMask__Enum, get_Mask, (app::CartController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B35BA0, void, __ctor, (app::CartController * this_ptr));
}
