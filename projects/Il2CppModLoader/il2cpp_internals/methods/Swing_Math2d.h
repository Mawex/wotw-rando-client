...
namespace app::methods::Swing::Math2d {
    ...
    IL2CPP_REGISTER_METHOD(0x0182B6A0, Vector2, getVector_1, (float _angle));
    IL2CPP_REGISTER_METHOD(0x0182B760, Vector2, getVector_2, (app::Angle _angle));
    ...
    IL2CPP_REGISTER_METHOD(0x0182BEF0, Vector2, lerp_2, (app::Vector2 _from, app::Vector2 _to, float _t));
    IL2CPP_REGISTER_METHOD(0x0182BF40, Vector3, lerp_3, (app::Vector3 _from, app::Vector3 _to, float _t));
    IL2CPP_REGISTER_METHOD(0x0182BFD0, Vector4, lerp_4, (app::Vector4 _from, app::Vector4 _to, float _t));
    IL2CPP_REGISTER_METHOD(0x0182C090, Vector2, lerp01_2, (app::Vector2 _from, app::Vector2 _to, float _t));
    IL2CPP_REGISTER_METHOD(0x0182C180, Vector3, lerp01_3, (app::Vector3 _from, app::Vector3 _to, float _t));
    IL2CPP_REGISTER_METHOD(0x0182C2E0, Vector4, lerp01_4, (app::Vector4 _from, app::Vector4 _to, float _t));
