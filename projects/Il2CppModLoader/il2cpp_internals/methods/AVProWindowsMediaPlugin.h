...
IL2CPP_REGISTER_METHOD(0x03130340, bool, LoadMovie, (int32_t handle, app::void * filename, bool play_from_memory, bool allow_native_format, bool allow_audio, bool use_audio_delay, bool use_audio_mixer, bool use_display_sync));
IL2CPP_REGISTER_METHOD(0x03130440, bool, LoadMovieFromMemory, (int32_t handle, app::void * movie_pointer, int64_t movie_length, bool allow_native_format, bool allow_audio, bool use_audio_delay, bool use_audio_mixer, bool use_display_sync));
...
IL2CPP_REGISTER_METHOD(0x03131890, bool, UpdateTextureGL, (int32_t handle, int32_t texture_i_d, app::int32_t * frame_number));
IL2CPP_REGISTER_METHOD(0x03131950, bool, GetFramePixels, (int32_t handle, app::void * data, int32_t buffer_width, int32_t buffer_height, app::int32_t * frame_number));
IL2CPP_REGISTER_METHOD(0x03131A30, bool, SetTexturePointer, (int32_t handle, app::void * data));
...
IL2CPP_REGISTER_METHOD(0x03131F60, void, GetFrameBufferTimes, (int32_t handle, app::void * dest, int32_t dest_size_bytes));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::AVProWindowsMediaPlugin * this_ptr));
}
