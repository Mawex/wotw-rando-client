...
IL2CPP_REGISTER_METHOD(0x0313EDD0, AudioSourceExtension *, AddSpatializerExtension_1, (app::AudioSource * source));
IL2CPP_REGISTER_METHOD(0x0313F140, AudioSourceExtension *, AddAmbisonicDecoderExtension, (app::AudioSource * source));
...
IL2CPP_REGISTER_METHOD(0x0313F740, AudioListenerExtension *, AddSpatializerExtension_2, (app::AudioListener * listener));
