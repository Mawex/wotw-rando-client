...
IL2CPP_REGISTER_METHOD(0x00CFC780, String *, get_Name, (app::TentacleEnemy_StunState * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CFC800, BehaviourTreeStatus__Enum, OnTentacleStateUpdate, (app::TentacleEnemy_StunState * this_ptr, app::TickData tick));
IL2CPP_REGISTER_METHOD(0x00CFC890, void, MakeStun, (app::TentacleEnemy_StunState * this_ptr));
IL2CPP_REGISTER_METHOD(0x00CFC9C0, void, __ctor, (app::TentacleEnemy_StunState * this_ptr));
}
