...
IL2CPP_REGISTER_METHOD(0x008F44B0, Dictionary_2_RecorderMessageData_System_Int32_ *, ExtractRecorderMessagesData, (app::RecorderData * recorder_data));
IL2CPP_REGISTER_METHOD(0x008F4850, void, __ctor, (app::RecorderMessagePlugin * this_ptr));
}
