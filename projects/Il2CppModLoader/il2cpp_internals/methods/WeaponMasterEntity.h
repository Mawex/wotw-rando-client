...
IL2CPP_REGISTER_METHOD(0x008E8120, String *, get_DialogActorName, (app::WeaponMasterEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x008E81A0, String *, get_InteractionActorName, (app::WeaponMasterEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004173E0, void, __ctor, (app::WeaponMasterEntity * this_ptr));
}
