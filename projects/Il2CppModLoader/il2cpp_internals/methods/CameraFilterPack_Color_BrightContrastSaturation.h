...
IL2CPP_REGISTER_METHOD(0x024D8040, Material *, get_material, (app::CameraFilterPack_Color_BrightContrastSaturation * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024D8930, void, __ctor, (app::CameraFilterPack_Color_BrightContrastSaturation * this_ptr));
}
