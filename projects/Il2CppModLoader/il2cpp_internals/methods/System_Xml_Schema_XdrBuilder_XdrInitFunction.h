...
namespace app::methods::System_Xml_Schema::XdrBuilder_XdrInitFunction {
    IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::XdrBuilder_XdrInitFunction * this_ptr, app::Object * object, void * method_1));
