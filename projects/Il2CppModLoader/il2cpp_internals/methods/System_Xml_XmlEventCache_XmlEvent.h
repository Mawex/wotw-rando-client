...
namespace app::methods::System_Xml::XmlEventCache_XmlEvent {
...
IL2CPP_REGISTER_METHOD(0x0010E170, XmlEventCache_XmlEventType__Enum, get_EventType, (app::XmlEventCache_XmlEvent__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00107C10, String *, get_String1, (app::XmlEventCache_XmlEvent__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00107C20, String *, get_String2, (app::XmlEventCache_XmlEvent__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00107C30, String *, get_String3, (app::XmlEventCache_XmlEvent__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00107C40, Object *, get_Object, (app::XmlEventCache_XmlEvent__Boxed * this_ptr));
}
