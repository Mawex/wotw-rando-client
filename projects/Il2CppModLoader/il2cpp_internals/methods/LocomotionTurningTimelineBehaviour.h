...
IL2CPP_REGISTER_METHOD(0x00FC9950, BehaviourStatus__Enum, OnExecuteTask, (app::LocomotionTurningTimelineBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00B68B50, Vector3, RootMotionModifier, (app::LocomotionTurningTimelineBehaviour * this_ptr, app::Vector3 motion));
IL2CPP_REGISTER_METHOD(0x00FC9C40, void, __ctor, (app::LocomotionTurningTimelineBehaviour * this_ptr));
}
