...
namespace app::methods::Core::Ambience {
    IL2CPP_REGISTER_METHOD(0x011F6690, Ambience_Layer*, get_CurrentAmbienceLayer, ());
    ...
    IL2CPP_REGISTER_METHOD(0x011F6B50, Ambience_AmbienceTrack*, PlayTrack, (app::SoundProvider * sound_provider, float fade_in_duration, float fade_out_duration, app::AmbienceZone** ambience_zone, app::AkCurveInterpolation__Enum fade_type));
    ...
    IL2CPP_REGISTER_METHOD(0x011F7110, void, __cctor, ());
} // namespace app::methods::Core::Ambience
