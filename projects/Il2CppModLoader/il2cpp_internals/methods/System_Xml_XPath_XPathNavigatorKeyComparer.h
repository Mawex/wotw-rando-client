...
IL2CPP_REGISTER_METHOD(0x01957CC0, int32_t, IEqualityComparer_GetHashCode, (XPathNavigatorKeyComparer * __this, Object * obj));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (XPathNavigatorKeyComparer * __this));
}
