...
IL2CPP_REGISTER_METHOD(0x002FC6D0, AnimatorPlayState__Enum, get_PlayState, (app::UberStateModifierTargetVirtualAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, PlaybackStatus *, get_PlaybackStatus, (app::UberStateModifierTargetVirtualAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00F9DBA0, int32_t, get_Hash, (app::UberStateModifierTargetVirtualAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E964A0, String *, get_Name, (app::UberStateModifierTargetVirtualAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB950, NewSetupStateController *, get_SetupStateController, (app::UberStateModifierTargetVirtualAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB00, SetupStateModifier *, get_Modifier, (app::UberStateModifierTargetVirtualAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E96520, GameObject *, get_ExternalTarget, (app::UberStateModifierTargetVirtualAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E965C0, void, Reset, (app::UberStateModifierTargetVirtualAnimator * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x01E96680, void, __ctor, (app::UberStateModifierTargetVirtualAnimator * this_ptr, app::SetupStateModifier * modifier, app::NewSetupStateController * state_controller));
...
IL2CPP_REGISTER_METHOD(0x01E96920, IEventReciever *, get_EventReciever, (app::UberStateModifierTargetVirtualAnimator * this_ptr));
