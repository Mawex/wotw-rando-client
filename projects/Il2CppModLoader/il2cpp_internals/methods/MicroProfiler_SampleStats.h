...
IL2CPP_REGISTER_METHOD(0x002FA280, MicroProfiler_MetricStats__Array *, GetMetricStats, (app::MicroProfiler_SampleStats * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, MicroProfiler_StatInfo__Array *, GetStats, (app::MicroProfiler_SampleStats * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB950, MicroProfiler_MarkerInfo__Array *, GetMarkers, (app::MicroProfiler_SampleStats * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01A92420, MicroProfiler_StatInfo, GetStat, (app::MicroProfiler_SampleStats * this_ptr, app::Stat__Enum id));
...
IL2CPP_REGISTER_METHOD(0x031574A0, MicroProfiler_MetricStats, GetMetric, (app::MicroProfiler_SampleStats * this_ptr, app::Metric__Enum id));
...
IL2CPP_REGISTER_METHOD(0x031578B0, void, __ctor, (app::MicroProfiler_SampleStats * this_ptr));
}
