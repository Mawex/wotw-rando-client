...
namespace app::methods::System_Runtime_Serialization_Formatters_Binary::ObjectWriter {
...
IL2CPP_REGISTER_METHOD(0x002FB9F0, SerializationObjectManager *, get_ObjectManager, (app::ObjectWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D9CF40, Object *, GetNext, (app::ObjectWriter * this_ptr, app::int64_t * obj_i_d));
IL2CPP_REGISTER_METHODINFO(0x04712148, ObjectWriter_GetNext__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01D9D110, int64_t, InternalGetId, (app::ObjectWriter * this_ptr, app::Object * obj, bool assign_unique_id_to_value_type, app::Type * type, app::bool * is_new));
...
IL2CPP_REGISTER_METHOD(0x01D9D7B0, NameInfo *, TypeToNameInfo_1, (app::ObjectWriter * this_ptr, app::Type * type, app::WriteObjectInfo * object_info, app::InternalPrimitiveTypeE__Enum code, app::NameInfo * name_info));
IL2CPP_REGISTER_METHOD(0x01D9D870, NameInfo *, TypeToNameInfo_2, (app::ObjectWriter * this_ptr, app::Type * type));
IL2CPP_REGISTER_METHOD(0x01D9D8C0, NameInfo *, TypeToNameInfo_3, (app::ObjectWriter * this_ptr, app::WriteObjectInfo * object_info));
IL2CPP_REGISTER_METHOD(0x01D9D970, NameInfo *, TypeToNameInfo_4, (app::ObjectWriter * this_ptr, app::WriteObjectInfo * object_info, app::NameInfo * name_info));
IL2CPP_REGISTER_METHOD(0x01D9D9E0, void, TypeToNameInfo_5, (app::ObjectWriter * this_ptr, app::Type * type, app::NameInfo * name_info));
IL2CPP_REGISTER_METHOD(0x01D9DA70, NameInfo *, MemberToNameInfo, (app::ObjectWriter * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x01D9DAA0, InternalPrimitiveTypeE__Enum, ToCode, (app::ObjectWriter * this_ptr, app::Type * type));
IL2CPP_REGISTER_METHOD(0x01D9DB80, int64_t, GetAssemblyId, (app::ObjectWriter * this_ptr, app::WriteObjectInfo * object_info));
IL2CPP_REGISTER_METHOD(0x013DD8B0, Type *, GetType, (app::ObjectWriter * this_ptr, app::Object * obj));
IL2CPP_REGISTER_METHOD(0x01D9DF40, NameInfo *, GetNameInfo, (app::ObjectWriter * this_ptr));
