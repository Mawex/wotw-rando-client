...
IL2CPP_REGISTER_METHOD(0x00E5BF60, KamikazeSkeetoDiveAttackBehaviour_DiveAttackState__Enum, get_State, (app::KamikazeSkeetoDiveAttackBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E5BF70, Entity *, get_Owner, (app::KamikazeSkeetoDiveAttackBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E5BFF0, SkeetoLocomotion *, get_Locomotion, (app::KamikazeSkeetoDiveAttackBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E5C0D0, Vector3, get_PegCheckOrigin, (app::KamikazeSkeetoDiveAttackBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E5C1E0, Vector3, get_PegCheckDirection, (app::KamikazeSkeetoDiveAttackBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E5C370, Vector3, get_TargetPosition, (app::KamikazeSkeetoDiveAttackBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E5CDB0, BehaviourStatus__Enum, OnExecute, (app::KamikazeSkeetoDiveAttackBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, BehaviourStatus__Enum, UpdateFlipTowardsTarget, (app::KamikazeSkeetoDiveAttackBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E5DE00, BehaviourStatus__Enum, UpdateAnticipation, (app::KamikazeSkeetoDiveAttackBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E5EAE0, BehaviourStatus__Enum, UpdateAttack, (app::KamikazeSkeetoDiveAttackBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E5F100, BehaviourStatus__Enum, UpdatePegged, (app::KamikazeSkeetoDiveAttackBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E603D0, void, __ctor, (app::KamikazeSkeetoDiveAttackBehaviour * this_ptr));
