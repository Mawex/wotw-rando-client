...
namespace app::methods::System_Collections_Generic::ObjectEqualityComparer_1_System_ValueTuple_3_ {
...
IL2CPP_REGISTER_METHOD(0x019F8810, void, __ctor, (app::ObjectEqualityComparer_1_System_ValueTuple_3_ * this_ptr));
}
