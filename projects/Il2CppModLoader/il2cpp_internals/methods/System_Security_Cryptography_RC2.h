...
namespace app::methods::System_Security_Cryptography::RC2 {
IL2CPP_REGISTER_METHOD(0x028DDDF0, void, __ctor, (app::RC2 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x028DE130, RC2 *, Create_1, ());
IL2CPP_REGISTER_METHOD(0x028DE270, RC2 *, Create_2, (app::String * alg_name));
IL2CPP_REGISTER_METHOD(0x028DE350, void, __cctor, ());
}
