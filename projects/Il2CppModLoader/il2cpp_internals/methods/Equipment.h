...
namespace app::methods::Equipment {
    IL2CPP_REGISTER_METHOD(0x00CAAF90, Equipment_Category__Enum, EquipmentTypeToCategory, (app::EquipmentType__Enum type));
    IL2CPP_REGISTER_METHOD(0x00CAAFD0, AbilityType__Enum, EquipmentTypeToAbilityType, (app::EquipmentType__Enum type));
    IL2CPP_REGISTER_METHODINFO(0x047951D0, Equipment_EquipmentTypeToAbilityType__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x00CAB2F0, EquipmentType__Enum, AbilityTypeToEquipmentType, (app::AbilityType__Enum type));
