...
IL2CPP_REGISTER_METHOD(0x020F4260, Material *, get_material, (app::CameraFilterPack_Vision_Aura * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020F4C90, void, __ctor, (app::CameraFilterPack_Vision_Aura * this_ptr));
}
