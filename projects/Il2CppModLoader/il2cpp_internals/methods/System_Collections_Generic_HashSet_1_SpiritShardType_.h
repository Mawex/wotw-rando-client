...
namespace app::methods::System_Collections_Generic::HashSet_1_SpiritShardType_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02AB4370, void, __ctor, (app::HashSet_1_SpiritShardType_ * this_ptr));
