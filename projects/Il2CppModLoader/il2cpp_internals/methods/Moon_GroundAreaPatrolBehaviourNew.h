...
IL2CPP_REGISTER_METHOD(0x0148B1D0, Vector3, ProcessRootMotion, (app::GroundAreaPatrolBehaviourNew * this_ptr, app::Vector3 motion));
...
IL2CPP_REGISTER_METHOD(0x0148BCB0, BehaviourStatus__Enum, OnExecute, (app::GroundAreaPatrolBehaviourNew * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x0148C090, void, OnExit, (app::GroundAreaPatrolBehaviourNew * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x0144E510, void, __ctor, (app::GroundAreaPatrolBehaviourNew * this_ptr));
}
