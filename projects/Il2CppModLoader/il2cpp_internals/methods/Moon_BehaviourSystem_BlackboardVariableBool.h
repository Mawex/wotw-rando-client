...
namespace app::methods::Moon_BehaviourSystem::BlackboardVariableBool {
IL2CPP_REGISTER_METHOD(0x002FB9B0, IMoonType_1_System_Boolean_ *, GetMoonType, (app::BlackboardVariableBool * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03009C60, void, __ctor, (app::BlackboardVariableBool * this_ptr));
}
