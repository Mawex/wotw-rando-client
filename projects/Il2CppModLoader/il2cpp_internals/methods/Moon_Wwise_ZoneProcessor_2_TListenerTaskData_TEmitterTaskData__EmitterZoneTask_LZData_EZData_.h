...
namespace app::methods::Moon_Wwise::ZoneProcessor_2_TListenerTaskData_TEmitterTaskData__EmitterZoneTask_LZData_EZData_ {
IL2CPP_REGISTER_METHOD(0x00724AE0, EZData, get_Data, (app::ZoneProcessor_2_TListenerTaskData_TEmitterTaskData_EmitterZoneTask_LZData_EZData_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AF4D20, AudioEmitterZoneReference, get_Zone, (app::ZoneProcessor_2_TListenerTaskData_TEmitterTaskData_EmitterZoneTask_LZData_EZData_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02AF4D60, void, __ctor, (app::ZoneProcessor_2_TListenerTaskData_TEmitterTaskData_EmitterZoneTask_LZData_EZData_ * this_ptr, int32_t i));
