...
IL2CPP_REGISTER_METHOD(0x02720EB0, ITask *, SafeResolve, (app::MoonReference_1_Moon_BehaviourSystem_ITask_ * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x047070D0, MoonReference_1_Moon_BehaviourSystem_ITask__SafeResolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027205B0, void, __ctor, (app::MoonReference_1_Moon_BehaviourSystem_ITask_ * this_ptr, app::ITask * reference));
...
IL2CPP_REGISTER_METHOD(0x02720AC0, ITask *, Resolve, (app::MoonReference_1_Moon_BehaviourSystem_ITask_ * this_ptr, app::IMoonResolverContext * context));
