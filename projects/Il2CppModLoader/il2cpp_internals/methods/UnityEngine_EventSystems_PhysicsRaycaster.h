...
namespace app::methods::UnityEngine_EventSystems::PhysicsRaycaster {
IL2CPP_REGISTER_METHOD(0x01F215C0, void, __ctor, (app::PhysicsRaycaster * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F21C90, Camera *, get_eventCamera, (app::PhysicsRaycaster * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F22020, LayerMask, get_eventMask, (app::PhysicsRaycaster * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F22040, bool, ComputeRayAndDistance, (app::PhysicsRaycaster * this_ptr, app::PointerEventData * event_data, app::Ray * ray, app::int32_t * event_display_index, app::float * distance_to_clip_plane));
