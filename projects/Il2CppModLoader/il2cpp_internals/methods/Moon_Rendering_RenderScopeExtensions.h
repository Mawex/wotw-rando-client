...
namespace app::methods::Moon_Rendering::RenderScopeExtensions {
...
IL2CPP_REGISTER_METHOD(0x00EB1B90, RenderScope__Enum, setFlag, (app::RenderScope__Enum scope, app::RenderScope__Enum flag, bool on));
}
