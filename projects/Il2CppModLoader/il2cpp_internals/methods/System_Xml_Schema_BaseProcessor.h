...
namespace app::methods::System_Xml_Schema::BaseProcessor {
IL2CPP_REGISTER_METHOD(0x019A3F00, void, __ctor_1, (app::BaseProcessor * this_ptr, app::XmlNameTable * name_table, app::SchemaNames * schema_names, app::ValidationEventHandler * event_handler));
IL2CPP_REGISTER_METHOD(0x019A4080, void, __ctor_2, (app::BaseProcessor * this_ptr, app::XmlNameTable * name_table, app::SchemaNames * schema_names, app::ValidationEventHandler * event_handler, app::XmlSchemaCompilationSettings * compilation_settings));
IL2CPP_REGISTER_METHOD(0x002FA280, XmlNameTable *, get_NameTable, (app::BaseProcessor * this_ptr));
IL2CPP_REGISTER_METHOD(0x019A4160, SchemaNames *, get_SchemaNames, (app::BaseProcessor * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB950, ValidationEventHandler *, get_EventHandler, (app::BaseProcessor * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB00, XmlSchemaCompilationSettings *, get_CompilationSettings, (app::BaseProcessor * this_ptr));
