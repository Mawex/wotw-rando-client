...
namespace app::methods::SeinGrabWall {
    ...
    IL2CPP_REGISTER_METHOD(0x006E4240, CharacterGravity*, get_CharacterGravity, (app::SeinGrabWall * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005D06F0, CharacterLeftRightMovement*, get_CharacterLeftRightMovement, (app::SeinGrabWall * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00AD1280, PlatformMovementListOfColliders*, get_ListOfCollidedObjects, (app::SeinGrabWall * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005D06C0, CharacterPlatformMovement*, get_PlatformMovement, (app::SeinGrabWall * this_ptr));
    IL2CPP_REGISTER_METHOD(0x014CC310, SeinGrabWallPuppet*, get_Puppet, (app::SeinGrabWall * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x014D0980, void, __ctor, (app::SeinGrabWall * this_ptr));
} // namespace app::methods::SeinGrabWall
