...
namespace app::methods::System_Data::DataView {
IL2CPP_REGISTER_METHOD(0x01F3F230, void, __ctor_1, (app::DataView * this_ptr, app::DataTable * table, bool locked));
IL2CPP_REGISTER_METHOD(0x01F3F840, void, __ctor_2, (app::DataView * this_ptr, app::DataTable * table));
...
IL2CPP_REGISTER_METHOD(0x002FB950, DataViewManager *, get_DataViewManager, (app::DataView * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F3F9F0, String *, get_RowFilter, (app::DataView * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F3FAA0, void, set_RowFilter, (app::DataView * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FD750, DataViewRowState__Enum, get_RowStateFilter, (app::DataView * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F3FEB0, String *, get_Sort, (app::DataView * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F3FF10, void, set_Sort, (app::DataView * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBB40, Comparison_1_System_Data_DataRow_ *, get_SortComparison, (app::DataView * this_ptr));
IL2CPP_REGISTER_METHOD(0x004C50A0, Object *, ICollection_get_SyncRoot, (app::DataView * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB00, DataTable *, get_Table, (app::DataView * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F40560, Object *, IList_get_Item, (app::DataView * this_ptr, int32_t record_index));
...
IL2CPP_REGISTER_METHOD(0x01F40560, DataRowView *, get_Item, (app::DataView * this_ptr, int32_t record_index));
IL2CPP_REGISTER_METHOD(0x01F405D0, DataRowView *, AddNew, (app::DataView * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F419C0, IEnumerator *, GetEnumerator, (app::DataView * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F42080, Index *, GetFindIndex, (app::DataView * this_ptr, app::String * column, bool keep_index));
IL2CPP_REGISTER_METHOD(0x01F3F910, bool, IBindingList_get_AllowNew, (app::DataView * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F42390, Object *, IBindingList_AddNew, (app::DataView * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F42410, PropertyDescriptor *, IBindingList_get_SortProperty, (app::DataView * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F42420, PropertyDescriptor *, GetSortProperty, (app::DataView * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F425E0, ListSortDirection__Enum, IBindingList_get_SortDirection, (app::DataView * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F43340, String *, CreateSortString, (app::DataView * this_ptr, app::PropertyDescriptor * property, app::ListSortDirection__Enum direction));
IL2CPP_REGISTER_METHOD(0x01F43520, void, IBindingListView_RemoveFilter, (app::DataView * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F43610, String *, IBindingListView_get_Filter, (app::DataView * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F43630, void, IBindingListView_set_Filter, (app::DataView * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x01F43650, ListSortDescriptionCollection *, IBindingListView_get_SortDescriptions, (app::DataView * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F43660, ListSortDescriptionCollection *, GetSortDescriptions, (app::DataView * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F43C70, String *, ITypedList_GetListName, (app::DataView * this_ptr, app::PropertyDescriptor__Array * list_accessors));
IL2CPP_REGISTER_METHOD(0x01F43D60, PropertyDescriptorCollection *, ITypedList_GetItemProperties, (app::DataView * this_ptr, app::PropertyDescriptor__Array * list_accessors));
IL2CPP_REGISTER_METHOD(0x002FBB60, IFilter *, GetFilter, (app::DataView * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F44070, DataRow *, GetRow, (app::DataView * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x04783930, DataView_GetRow__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01F44250, DataRowView *, GetRowView_1, (app::DataView * this_ptr, int32_t record));
IL2CPP_REGISTER_METHOD(0x01F442B0, DataRowView *, GetRowView_2, (app::DataView * this_ptr, app::DataRow * dr));
