...
IL2CPP_REGISTER_METHOD(0x005046D0, String *, get_TargetName, (app::AnimatorAction * this_ptr));
IL2CPP_REGISTER_METHOD(0x00504860, String *, GetNiceName, (app::AnimatorAction * this_ptr));
IL2CPP_REGISTER_METHOD(0x0044C850, void, __ctor, (app::AnimatorAction * this_ptr));
}
