...
namespace app::methods::System_Threading::WaitHandle {
IL2CPP_REGISTER_METHOD(0x0234B740, void, __ctor, (app::WaitHandle * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0234B8D0, void, set_Handle, (app::WaitHandle * this_ptr, app::void * value));
IL2CPP_REGISTER_METHOD(0x0234BAB0, SafeWaitHandle *, get_SafeWaitHandle, (app::WaitHandle * this_ptr));
