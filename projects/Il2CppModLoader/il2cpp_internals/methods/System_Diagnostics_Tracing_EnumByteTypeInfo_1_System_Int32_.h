...
namespace app::methods::System_Diagnostics_Tracing::EnumByteTypeInfo_1_System_Int32_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0298B8E0, void, __ctor, (app::EnumByteTypeInfo_1_System_Int32_ * this_ptr));
}
