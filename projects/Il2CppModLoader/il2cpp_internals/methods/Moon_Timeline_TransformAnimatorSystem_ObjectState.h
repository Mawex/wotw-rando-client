...
namespace app::methods::Moon_Timeline::TransformAnimatorSystem_ObjectState {
IL2CPP_REGISTER_METHOD(0x0311F8F0, Nullable_1_Moon_Timeline_TransformAnimatorSystem_PositionModification_ *, get_HandoverPosition, (app::TransformAnimatorSystem_ObjectState * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0311F9A0, Nullable_1_Moon_Timeline_TransformAnimatorSystem_RotationModification_ *, get_HandoverRotation, (app::TransformAnimatorSystem_ObjectState * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0311FA50, Nullable_1_Moon_Timeline_TransformAnimatorSystem_ScaleModification_ *, get_HandoverScale, (app::TransformAnimatorSystem_ObjectState * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::TransformAnimatorSystem_ObjectState * this_ptr));
}
