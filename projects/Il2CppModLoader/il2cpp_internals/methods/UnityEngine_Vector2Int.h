...
IL2CPP_REGISTER_METHOD(0x001EBC90, int32_t, get_x, (Vector2Int__Boxed * __this));
IL2CPP_REGISTER_METHOD(0x00218130, int32_t, get_y, (Vector2Int__Boxed * __this));
IL2CPP_REGISTER_METHOD(0x00229450, bool, Equals, (Vector2Int__Boxed * __this, Object * other));
