...
IL2CPP_REGISTER_METHOD(0x012FBAD0, String *, get_DialogActorName, (app::KwolokNpcEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x012FBB50, String *, get_InteractionActorName, (app::KwolokNpcEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_CameraTargetActive, (app::KwolokNpcEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x012FBBD0, CharacterInteractableActivationMode__Enum, get_ActivationMode, (app::KwolokNpcEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012FBCB0, KwolokNpcEntity_State__Enum, get_CurrentState, (app::KwolokNpcEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012FBD10, KwolokNpcEntity_CleanseWellspringState__Enum, get_CleanseWellspringCurrentState, (app::KwolokNpcEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012FC7D0, IUberState__Array *, get_AffectingUberStates, (app::KwolokNpcEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x012FC860, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::KwolokNpcEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x012FCA20, bool, CanInteractWithCharacter, (app::KwolokNpcEntity * this_ptr, app::ICharacter * character));
IL2CPP_REGISTER_METHOD(0x012FCBB0, void, __ctor, (app::KwolokNpcEntity * this_ptr));
}
