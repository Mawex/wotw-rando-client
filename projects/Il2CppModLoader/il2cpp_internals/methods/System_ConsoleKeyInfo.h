...
IL2CPP_REGISTER_METHOD(0x001DBE50, void, __ctor, (app::ConsoleKeyInfo__Boxed * this_ptr, uint16_t key_char, app::ConsoleKey__Enum key, bool shift, bool alt, bool control));
...
IL2CPP_REGISTER_METHOD(0x00113CE0, ConsoleKey__Enum, get_Key, (app::ConsoleKeyInfo__Boxed * this_ptr));
