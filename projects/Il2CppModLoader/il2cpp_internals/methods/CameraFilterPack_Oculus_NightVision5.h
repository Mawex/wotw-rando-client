...
IL2CPP_REGISTER_METHOD(0x02486030, Material *, get_material, (app::CameraFilterPack_Oculus_NightVision5 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02486D90, void, __ctor, (app::CameraFilterPack_Oculus_NightVision5 * this_ptr));
}
