...
IL2CPP_REGISTER_METHOD(0x013F74A0, UberExplosionActor *, get_Actor, (app::UberInteractionExplosionAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00990E80, void, __ctor, (app::UberInteractionExplosionAnimator * this_ptr));
}
