...
namespace app::methods::SaveSlotUI {
    ...
    IL2CPP_REGISTER_METHOD(0x00923B20, Rect, get_Bounds, (app::SaveSlotUI * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::SaveSlotUI * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x009253B0, SaveSlotInfo*, get_SaveSlot, (app::SaveSlotUI * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00925620, MessageDescriptor, DifficultyModeToMessage, (app::SaveSlotUI * this_ptr, app::DifficultyMode__Enum difficulty));
    ...
    IL2CPP_REGISTER_METHOD(0x0068A510, SuspendableMask__Enum, get_Mask, (app::SaveSlotUI * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00926CB0, void, __ctor, (app::SaveSlotUI * this_ptr));
} // namespace app::methods::SaveSlotUI
