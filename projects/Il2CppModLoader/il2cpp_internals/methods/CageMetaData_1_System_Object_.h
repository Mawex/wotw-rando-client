...
IL2CPP_REGISTER_METHOD(0x019DD7B0, Object *, FindByID, (app::CageMetaData_1_System_Object_ * this_ptr, int32_t id));
IL2CPP_REGISTER_METHOD(0x019DD8C0, void, __ctor, (app::CageMetaData_1_System_Object_ * this_ptr));
}
