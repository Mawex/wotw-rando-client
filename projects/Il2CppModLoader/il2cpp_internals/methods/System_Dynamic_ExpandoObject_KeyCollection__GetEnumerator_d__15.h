...
namespace app::methods::System_Dynamic::ExpandoObject_KeyCollection__GetEnumerator_d__15 {
IL2CPP_REGISTER_METHOD(0x002FC6E0, void, __ctor, (app::ExpandoObject_KeyCollection_GetEnumerator_d_15 * this_ptr, int32_t __1__state));
...
IL2CPP_REGISTER_METHOD(0x002FB930, String *, IEnumerator_string__get_Current, (app::ExpandoObject_KeyCollection_GetEnumerator_d_15 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB930, Object *, IEnumerator_get_Current, (app::ExpandoObject_KeyCollection_GetEnumerator_d_15 * this_ptr));
}
