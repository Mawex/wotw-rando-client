...
namespace app::methods::System_Collections_Generic::Dictionary_2_TKey_TValue__Enumerator_System_ByteEnum_System_Boolean_ {
    IL2CPP_REGISTER_METHOD(0x001358A0, void, __ctor, (app::Dictionary_2_TKey_TValue_Enumerator_System_ByteEnum_System_Boolean___Boxed * this_ptr, app::Dictionary_2_System_ByteEnum_System_Boolean_ * dictionary, int32_t get_enumerator_ret_type));
