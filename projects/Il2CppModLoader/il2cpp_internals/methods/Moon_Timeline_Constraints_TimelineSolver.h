...
namespace app::methods::Moon_Timeline_Constraints::TimelineSolver {
IL2CPP_REGISTER_METHOD(0x01BB66B0, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x01BB6AE0, IDisposable *, OpenScope, (bool allow_evaluate, bool detect_infinite_loops, bool allow_cache));
...
IL2CPP_REGISTER_METHOD(0x01BB7080, bool, EvaluateEvent, (app::ITimelineEntityParent * scope, app::EntityId id, int32_t event_id, app::float * time));
...
IL2CPP_REGISTER_METHOD(0x01BB8220, bool, ApproximateCustomEvent_2, (app::ITimelineEventProvider * provider, int32_t event_id, float min, float max, app::float * time));
}
