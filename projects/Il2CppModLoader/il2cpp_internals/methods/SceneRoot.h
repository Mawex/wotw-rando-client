...
namespace app::methods::SceneRoot {
    ...
    IL2CPP_REGISTER_METHOD(0x008519C0, SceneState__Enum, get_State, (app::SceneRoot * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00BB2710, SceneSettingsComponent*, get_SceneSettings, (app::SceneRoot * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00BB2820, SceneRoot*, FindFromTransform, (app::Transform * transform));
    IL2CPP_REGISTER_METHOD(0x00BB2900, SceneRoot*, FindFromPosition, (app::Vector3 position, app::SceneRoot__Array* scene_roots));
    ...
    IL2CPP_REGISTER_METHOD(0x00BB4910, IEnumerator*, UnloadSceneCoroutine, (app::SceneRoot * this_ptr, app::Scene scene));
    ...
    IL2CPP_REGISTER_METHOD(0x00BB80A0, void, __ctor, (app::SceneRoot * this_ptr));
