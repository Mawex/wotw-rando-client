...
namespace app::methods::Moon_Wwise::WwiseSyncProcessor {
...
IL2CPP_REGISTER_METHOD(0x002FBB00, IListenerSyncProcessor *, get_ListenerSyncProcessor, (app::WwiseSyncProcessor * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02718AF0, void, DefragmentPositionTasks, (app::WwiseSyncProcessor * this_ptr, app::PositionSyncTask__Array * arg_tasks, app::int32_t * valid_size));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::WwiseSyncProcessor * this_ptr));
