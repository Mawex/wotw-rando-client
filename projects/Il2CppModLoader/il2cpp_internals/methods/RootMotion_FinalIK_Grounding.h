...
namespace app::methods::RootMotion_FinalIK::Grounding {
IL2CPP_REGISTER_METHOD(0x002FBB40, Grounding_Leg__Array *, get_legs, (app::Grounding * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB50, void, set_legs, (app::Grounding * this_ptr, app::Grounding_Leg__Array * value));
IL2CPP_REGISTER_METHOD(0x002FBB60, Grounding_Pelvis *, get_pelvis, (app::Grounding * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBA0, Transform *, get_root, (app::Grounding * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBB0, void, set_root, (app::Grounding * this_ptr, app::Transform * value));
IL2CPP_REGISTER_METHOD(0x02070160, RaycastHit, get_rootHit, (app::Grounding * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020701E0, RaycastHit, GetRootHit, (app::Grounding * this_ptr, float max_distance_mlp));
...
IL2CPP_REGISTER_METHOD(0x020712E0, Vector3, GetLegsPlaneNormal, (app::Grounding * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020716E0, Vector3, get_up, (app::Grounding * this_ptr));
IL2CPP_REGISTER_METHOD(0x020717D0, float, GetVerticalOffset, (app::Grounding * this_ptr, app::Vector3 p1, app::Vector3 p2));
IL2CPP_REGISTER_METHOD(0x020719D0, Vector3, Flatten, (app::Grounding * this_ptr, app::Vector3 v));
IL2CPP_REGISTER_METHOD(0x02071B60, bool, get_useRootRotation, (app::Grounding * this_ptr));
IL2CPP_REGISTER_METHOD(0x02071C80, void, __ctor, (app::Grounding * this_ptr));
}
