...
namespace app::methods::System_Net::FtpWebRequest {
IL2CPP_REGISTER_METHOD(0x01D2EF90, void, __ctor_1, (app::FtpWebRequest * this_ptr, app::Uri * uri));
IL2CPP_REGISTER_METHOD(0x01D2F150, Exception *, GetMustImplement, ());
IL2CPP_REGISTER_METHOD(0x01D2F290, X509CertificateCollection_1 *, get_ClientCertificates, (app::FtpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D2F3D0, String *, get_ConnectionGroupName, (app::FtpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D2F510, String *, get_ContentType, (app::FtpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBC0, ICredentials *, get_Credentials, (app::FtpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D2F800, WebHeaderCollection *, get_Headers, (app::FtpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBCC0, String *, get_Method, (app::FtpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC40, IWebProxy *, get_Proxy, (app::FtpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBCE0, String *, get_RenameTo, (app::FtpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, Uri *, get_RequestUri, (app::FtpWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x01D2FDF0, ServicePoint *, get_ServicePoint, (app::FtpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D30070, String *, get_DataType, (app::FtpWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x01D30100, FtpWebRequest_RequestState__Enum, get_State, (app::FtpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D30670, IAsyncResult *, BeginGetResponse, (app::FtpWebRequest * this_ptr, app::AsyncCallback * callback, app::Object * state));
IL2CPP_REGISTER_METHODINFO(0x0470AF08, FtpWebRequest_BeginGetResponse__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01D30B60, WebResponse *, EndGetResponse, (app::FtpWebRequest * this_ptr, app::IAsyncResult * async_result));
IL2CPP_REGISTER_METHODINFO(0x0473E3E0, FtpWebRequest_EndGetResponse__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01D30D50, WebResponse *, GetResponse, (app::FtpWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x01D30D90, IAsyncResult *, BeginGetRequestStream, (app::FtpWebRequest * this_ptr, app::AsyncCallback * callback, app::Object * state));
IL2CPP_REGISTER_METHODINFO(0x04773BE0, FtpWebRequest_BeginGetRequestStream__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01D312C0, Stream *, EndGetRequestStream, (app::FtpWebRequest * this_ptr, app::IAsyncResult * async_result));
IL2CPP_REGISTER_METHODINFO(0x0473F3A8, FtpWebRequest_EndGetRequestStream__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01D31520, Stream *, GetRequestStream, (app::FtpWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x01D31560, ServicePoint *, GetServicePoint, (app::FtpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D31D30, String *, GetRemoteFolderPath, (app::FtpWebRequest * this_ptr, app::Uri * uri));
...
IL2CPP_REGISTER_METHOD(0x01D34140, String *, GetInitialPath, (app::FtpStatus * status));
IL2CPP_REGISTER_METHODINFO(0x047012D8, FtpWebRequest_GetInitialPath__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01D34390, Socket *, SetupPassiveConnection, (app::FtpWebRequest * this_ptr, app::String * status_description, bool ipv6));
...
IL2CPP_REGISTER_METHOD(0x01D34CD0, String *, FormatAddress, (app::FtpWebRequest * this_ptr, app::IPAddress * address, int32_t port));
IL2CPP_REGISTER_METHOD(0x01D35170, String *, FormatAddressV6, (app::FtpWebRequest * this_ptr, app::IPAddress * address, int32_t port));
IL2CPP_REGISTER_METHOD(0x01D35380, Exception *, CreateExceptionFromResponse, (app::FtpWebRequest * this_ptr, app::FtpStatus * status));
...
IL2CPP_REGISTER_METHOD(0x01D35700, Socket *, InitDataConnection, (app::FtpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D369A0, FtpStatus *, SendCommand_1, (app::FtpWebRequest * this_ptr, app::String * command, app::String__Array * parameters));
IL2CPP_REGISTER_METHOD(0x01D369C0, FtpStatus *, SendCommand_2, (app::FtpWebRequest * this_ptr, bool wait_response, app::String * command, app::String__Array * parameters));
IL2CPP_REGISTER_METHOD(0x01D36C50, FtpStatus *, ServiceNotAvailable, ());
IL2CPP_REGISTER_METHOD(0x01D36DA0, FtpStatus *, GetResponseStatus, (app::FtpWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D37BB0, void, __ctor_2, (app::FtpWebRequest * this_ptr));
