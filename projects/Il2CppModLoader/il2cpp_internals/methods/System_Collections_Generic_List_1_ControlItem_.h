...
namespace app::methods::System_Collections_Generic::List_1_ControlItem_ {
IL2CPP_REGISTER_METHOD(0x025EFC50, ControlItem *, get_Item, (app::List_1_ControlItem_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_ControlItem_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0471C578, List_1_ControlItem___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_ControlItem_, GetEnumerator, (app::List_1_ControlItem_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025F05A0, ControlItem *, Find, (app::List_1_ControlItem_ * this_ptr, app::Predicate_1_ControlItem_ * match));
