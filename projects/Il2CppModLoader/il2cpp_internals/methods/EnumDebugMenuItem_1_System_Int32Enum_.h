...
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_Path, (app::EnumDebugMenuItem_1_System_Int32Enum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_Path, (app::EnumDebugMenuItem_1_System_Int32Enum_ * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Text, (app::EnumDebugMenuItem_1_System_Int32Enum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_Text, (app::EnumDebugMenuItem_1_System_Int32Enum_ * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_HelpText, (app::EnumDebugMenuItem_1_System_Int32Enum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB960, void, set_HelpText, (app::EnumDebugMenuItem_1_System_Int32Enum_ * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor_1, (app::EnumDebugMenuItem_1_System_Int32Enum_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x019E1D40, void, __ctor_2, (app::EnumDebugMenuItem_1_System_Int32Enum_ * this_ptr, app::String * path, app::String * text, app::Func_1_Int32Enum_ * getter, app::Action_1_Int32Enum_ * setter, app::String * help, bool should_show_only_selected));
...
IL2CPP_REGISTER_METHOD(0x002FB9D0, Func_1_String_ *, get_DynamicText, (app::EnumDebugMenuItem_1_System_Int32Enum_ * this_ptr));
