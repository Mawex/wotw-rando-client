...
IL2CPP_REGISTER_METHOD(0x0176F500, void, __ctor, (app::PetrifiedOwlBossFinalComboBehaviour_DiveLaserState * this_ptr, app::PetrifiedOwlBossFinalComboBehaviour * behaviour));
