...
IL2CPP_REGISTER_METHOD(0x02552F70, Vector3, get_insideUnitSphere, ());
IL2CPP_REGISTER_METHOD(0x0296D170, void, GetRandomUnitCircle, (Vector2 * output));
IL2CPP_REGISTER_METHOD(0x0296D1C0, Vector2, get_insideUnitCircle, ());
IL2CPP_REGISTER_METHOD(0x0296D220, Quaternion, get_rotationUniform, ());
