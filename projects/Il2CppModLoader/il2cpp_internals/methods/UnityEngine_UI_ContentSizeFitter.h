...
namespace app::methods::UnityEngine_UI::ContentSizeFitter {
IL2CPP_REGISTER_METHOD(0x01F30480, void, __ctor, (app::ContentSizeFitter * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F2AB70, ContentSizeFitter_FitMode__Enum, get_horizontalFit, (app::ContentSizeFitter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F30530, ContentSizeFitter_FitMode__Enum, get_verticalFit, (app::ContentSizeFitter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F305E0, RectTransform *, get_rectTransform, (app::ContentSizeFitter * this_ptr));
