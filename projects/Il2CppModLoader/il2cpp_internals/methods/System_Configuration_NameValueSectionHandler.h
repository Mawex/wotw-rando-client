...
IL2CPP_REGISTER_METHOD(0x02961F30, void, __ctor, (NameValueSectionHandler * __this));
IL2CPP_REGISTER_METHODINFO(0x04716278, NameValueSectionHandler__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02961F60, String *, get_KeyAttributeName, (NameValueSectionHandler * __this));
IL2CPP_REGISTER_METHODINFO(0x04729320, NameValueSectionHandler_get_KeyAttributeName__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02961F90, String *, get_ValueAttributeName, (NameValueSectionHandler * __this));
IL2CPP_REGISTER_METHODINFO(0x0474EA18, NameValueSectionHandler_get_ValueAttributeName__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02961FC0, Object *, Create, (NameValueSectionHandler * __this, Object * parent, Object * context, XmlNode * section));
