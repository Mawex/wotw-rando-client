...
IL2CPP_REGISTER_METHOD(0x022D2780, String *, get_InstructionName, (app::AddOvfInstruction * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::AddOvfInstruction * this_ptr));
IL2CPP_REGISTER_METHOD(0x022D2800, Instruction *, Create, (app::Type * type));
}
