...
IL2CPP_REGISTER_METHOD(0x013EE640, Renderer *, get_TargetRenderer, (app::UberGhostTrail * this_ptr));
IL2CPP_REGISTER_METHOD(0x013EE750, void, Reset, (app::UberGhostTrail * this_ptr));
IL2CPP_REGISTER_METHOD(0x013EE830, Renderer *, get_Renderer, (app::UberGhostTrail * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x013F0540, UberScreenMode__Enum, GetExternalUberScreenMode, (app::UberGhostTrail * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CBCEC0, SuspendableMask__Enum, get_Mask, (app::UberGhostTrail * this_ptr));
IL2CPP_REGISTER_METHOD(0x013F1110, void, set_Mask, (app::UberGhostTrail * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x013F11D0, void, __ctor, (app::UberGhostTrail * this_ptr));
}
