...
IL2CPP_REGISTER_METHOD(0x002FA280, Object_1 *, get_TargetObject, (app::RuntimeDynamicDataLink_1_System_Int64_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, MemberInfo_1 *, get_TargetMemberInfo, (app::RuntimeDynamicDataLink_1_System_Int64_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB40, Type *, get_ReturnedValueType, (app::RuntimeDynamicDataLink_1_System_Int64_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01CE2FF0, DynamicDataLinkSerializedData, GetSerializedData, (app::RuntimeDynamicDataLink_1_System_Int64_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0290EE20, String *, ToString, (app::RuntimeDynamicDataLink_1_System_Int64_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::RuntimeDynamicDataLink_1_System_Int64_ * this_ptr));
}
