...
namespace app::methods::PlayFab_Logger::DebugLogger {
IL2CPP_REGISTER_METHOD(0x002FC6E0, void, __ctor, (app::DebugLogger * this_ptr, app::LogLevel__Enum_1 min_log_level));
