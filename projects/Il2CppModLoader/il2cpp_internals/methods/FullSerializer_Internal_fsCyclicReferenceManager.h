...
namespace app::methods::FullSerializer_Internal::fsCyclicReferenceManager {
...
IL2CPP_REGISTER_METHOD(0x01651A00, Object *, GetReferenceObject, (app::fsCyclicReferenceManager * this_ptr, int32_t id));
...
IL2CPP_REGISTER_METHOD(0x01651F70, void, __ctor, (app::fsCyclicReferenceManager * this_ptr));
}
