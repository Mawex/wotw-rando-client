...
IL2CPP_REGISTER_METHOD(0x013AE4A0, PlayerUberStateShards_Shard *, get_ShardState, (app::UpgradableShardItem * this_ptr));
IL2CPP_REGISTER_METHOD(0x013AE670, MessageProvider *, get_ItemName, (app::UpgradableShardItem * this_ptr));
IL2CPP_REGISTER_METHOD(0x013AE750, MessageProvider *, get_ItemDescription, (app::UpgradableShardItem * this_ptr));
IL2CPP_REGISTER_METHOD(0x013AE890, MessageProvider *, get_ItemNextLevelDescription, (app::UpgradableShardItem * this_ptr));
IL2CPP_REGISTER_METHOD(0x013AEA20, Texture2D *, get_ItemIcon, (app::UpgradableShardItem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::UpgradableShardItem * this_ptr));
