...
namespace app::methods::Moon_Extensions::AnimationCurveExtensions {
...
IL2CPP_REGISTER_METHOD(0x031B3A10, ParticleSystem_MinMaxCurve, AsMinMaxCurve, (app::AnimationCurve * animation_curve));
...
IL2CPP_REGISTER_METHOD(0x031B4800, Keyframe, CopyKeyframeWithTime, (app::Keyframe frame_to_copy, float time));
IL2CPP_REGISTER_METHOD(0x031B4830, Keyframe, KeyframeWithValue, (app::AnimationCurve * curve, int32_t index, float value));
...
IL2CPP_REGISTER_METHOD(0x031B5430, Single__Array *, GetUniqueKeyframeTimes, (app::AnimationCurve__Array * curves));
