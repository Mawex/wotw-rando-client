...
IL2CPP_REGISTER_METHOD(0x020E4CC0, Material *, get_material, (app::CameraFilterPack_TV_ARCADE_Fast * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E5670, void, __ctor, (app::CameraFilterPack_TV_ARCADE_Fast * this_ptr));
}
