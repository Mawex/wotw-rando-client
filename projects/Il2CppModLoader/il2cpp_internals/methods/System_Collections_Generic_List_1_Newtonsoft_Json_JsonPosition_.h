...
namespace app::methods::System_Collections_Generic::List_1_Newtonsoft_Json_JsonPosition_ {
IL2CPP_REGISTER_METHOD(0x025EC760, JsonPosition, get_Item, (app::List_1_Newtonsoft_Json_JsonPosition_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025ED850, List_1_T_Enumerator_Newtonsoft_Json_JsonPosition_, GetEnumerator, (app::List_1_Newtonsoft_Json_JsonPosition_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0476B0B0, List_1_Newtonsoft_Json_JsonPosition__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_Newtonsoft_Json_JsonPosition_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_Newtonsoft_Json_JsonPosition_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHOD(0x02E4BBD0, void, __ctor_3, (app::List_1_Newtonsoft_Json_JsonPosition_ * this_ptr, app::IEnumerable_1_Newtonsoft_Json_JsonPosition_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02E4C060, Object *, ICollection_get_SyncRoot, (app::List_1_Newtonsoft_Json_JsonPosition_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EC910, Object *, IList_get_Item, (app::List_1_Newtonsoft_Json_JsonPosition_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_Newtonsoft_Json_JsonPosition_ *, AsReadOnly, (app::List_1_Newtonsoft_Json_JsonPosition_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025ED1F0, JsonPosition, Find, (app::List_1_Newtonsoft_Json_JsonPosition_ * this_ptr, app::Predicate_1_Newtonsoft_Json_JsonPosition_ * match));
IL2CPP_REGISTER_METHOD(0x025ED330, List_1_Newtonsoft_Json_JsonPosition_ *, FindAll, (app::List_1_Newtonsoft_Json_JsonPosition_ * this_ptr, app::Predicate_1_Newtonsoft_Json_JsonPosition_ * match));
...
IL2CPP_REGISTER_METHOD(0x025ED8A0, IEnumerator_1_Newtonsoft_Json_JsonPosition_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_Newtonsoft_Json_JsonPosition_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025ED8A0, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_Newtonsoft_Json_JsonPosition_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_Newtonsoft_Json_JsonPosition_ *, GetRange, (app::List_1_Newtonsoft_Json_JsonPosition_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, JsonPosition__Array *, ToArray, (app::List_1_Newtonsoft_Json_JsonPosition_ * this_ptr));
