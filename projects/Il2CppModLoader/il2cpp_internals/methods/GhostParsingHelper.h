...
IL2CPP_REGISTER_METHOD(0x007DB4E0, GameObject *, CreatePlaybackInstance, (app::GameObject * prefab, app::Vector3 position, app::Quaternion rotation, app::Transform * parent));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::GhostParsingHelper * this_ptr));
IL2CPP_REGISTER_METHOD(0x007DBDE0, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x015E9D90, Object *, CreateAnimator, (app::Transform * parent, app::String * name));
IL2CPP_REGISTER_METHOD(0x015E9FA0, Object *, GetOrCreateAnimator, (app::Transform * parent, app::String * name, int32_t i_d, app::Dictionary_2_System_Int32_UnityEngine_Component_ * parsing_groups_cache));
IL2CPP_REGISTER_METHOD(0x015E9C30, Object *, AddTimelineChildren, (app::MoonTimeline * parent, float start_time, float duration));
}
