...
IL2CPP_REGISTER_METHOD(0x030528B0, String *, GetShaderName, (app::ShadowsMidtonesHighlights * this_ptr));
IL2CPP_REGISTER_METHOD(0x03052930, void, __ctor, (app::ShadowsMidtonesHighlights * this_ptr));
}
