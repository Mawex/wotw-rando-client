...
IL2CPP_REGISTER_METHOD(0x009553C0, BehaviourStatus__Enum, OnExecute, (app::SpiderBatClimbBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x009559A0, void, __ctor, (app::SpiderBatClimbBehaviour * this_ptr));
}
