...
IL2CPP_REGISTER_METHOD(0x017644B0, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossTakeOffBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x01765790, void, OnExit, (app::PetrifiedOwlBossTakeOffBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x017657C0, void, __ctor, (app::PetrifiedOwlBossTakeOffBehaviour * this_ptr));
}
