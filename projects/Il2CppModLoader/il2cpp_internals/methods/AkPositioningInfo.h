...
IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkPositioningInfo * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x0188FBD0, void *, getCPtr, (app::AkPositioningInfo * obj));
IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkPositioningInfo * this_ptr, app::void * c_ptr));
...
IL2CPP_REGISTER_METHOD(0x01890270, AkSpeakerPanningType__Enum, get_pannerType, (app::AkPositioningInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x018904C0, Ak3DPositionType__Enum, get_e3dPositioningType, (app::AkPositioningInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01890970, Ak3DSpatializationMode__Enum, get_e3DSpatializationMode, (app::AkPositioningInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x018928C0, void, __ctor_2, (app::AkPositioningInfo * this_ptr));
}
