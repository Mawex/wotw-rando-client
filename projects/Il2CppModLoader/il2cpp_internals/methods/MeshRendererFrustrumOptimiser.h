...
IL2CPP_REGISTER_METHOD(0x009EB2E0, void, __ctor, (app::MeshRendererFrustrumOptimiser * this_ptr, app::GameObject * game_object));
...
IL2CPP_REGISTER_METHOD(0x009EB5D0, Bounds, get_Bounds, (app::MeshRendererFrustrumOptimiser * this_ptr));
