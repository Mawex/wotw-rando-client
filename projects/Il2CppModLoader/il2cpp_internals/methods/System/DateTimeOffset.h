...
namespace app::methods::System::DateTimeOffset {
    IL2CPP_REGISTER_METHOD(0x00214B90, void, __ctor_1, (app::DateTimeOffset__Boxed * this_ptr, int64_t ticks, app::TimeSpan offset));
    IL2CPP_REGISTER_METHOD(0x00214BA0, void, __ctor_2, (app::DateTimeOffset__Boxed * this_ptr, app::DateTime date_time));
    IL2CPP_REGISTER_METHOD(0x00214BB0, void, __ctor_3, (app::DateTimeOffset__Boxed * this_ptr, app::DateTime date_time, app::TimeSpan offset));
    IL2CPP_REGISTER_METHODINFO(0x04789730, DateTimeOffset__ctor_2__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x00214BC0, void, __ctor_4, (app::DateTimeOffset__Boxed * this_ptr, int32_t year, int32_t month, int32_t day, int32_t hour, int32_t minute, int32_t second, app::TimeSpan offset));
    IL2CPP_REGISTER_METHOD(0x00214CF0, void, __ctor_5, (app::DateTimeOffset__Boxed * this_ptr, int32_t year, int32_t month, int32_t day, int32_t hour, int32_t minute, int32_t second, int32_t millisecond, app::TimeSpan offset));
    IL2CPP_REGISTER_METHOD(0x00214E20, void, __ctor_6, (app::DateTimeOffset__Boxed * this_ptr, int32_t year, int32_t month, int32_t day, int32_t hour, int32_t minute, int32_t second, int32_t millisecond, app::Calendar * calendar, app::TimeSpan offset));
    ...
    IL2CPP_REGISTER_METHOD(0x00215710, void, __ctor_7, (app::DateTimeOffset__Boxed * this_ptr, app::SerializationInfo * info, app::StreamingContext context));
    ...
    operator == (app::DateTimeOffset left, app::DateTimeOffset right) {
