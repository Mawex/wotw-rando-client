...
IL2CPP_REGISTER_METHOD(0x00D5EAB0, Vector3, get_Position, (app::SpiritLeashHook * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0057AAC0, SpiritLeashMode__Enum, get_LeashInteractionMode, (app::SpiritLeashHook * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, Transform *, get_HookTargetTransform, (app::SpiritLeashHook * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, Transform *, get_HookTransform, (app::SpiritLeashHook * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D5EC40, Transform *, ISpiritLeashHook_get_HookTargetTransform, (app::SpiritLeashHook * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D5F620, Vector3, get_CameraTargetPosition, (app::SpiritLeashHook * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D5F780, Vector2, get_CameraTargetPadding, (app::SpiritLeashHook * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D5F830, Vector3, get_CameraInfluencePosition, (app::SpiritLeashHook * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A372E0, Vector2, get_CameraZoomFactor, (app::SpiritLeashHook * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417920, CameraTargetType__Enum, get_TargetType, (app::SpiritLeashHook * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D5F900, void, GetTargetData, (app::SpiritLeashHook * this_ptr, app::CameraTargetData * * data));
IL2CPP_REGISTER_METHOD(0x00A37560, void, AdjustCameraTargetWeight, (app::SpiritLeashHook * this_ptr, app::float * weight, app::CameraTargetData * data, app::Vector3 primary_target_position));
...
IL2CPP_REGISTER_METHOD(0x002FBC00, IDamageReciever__Array *, get_AffectedReceivers, (app::SpiritLeashHook * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D5FD60, void, __ctor, (app::SpiritLeashHook * this_ptr));
}
