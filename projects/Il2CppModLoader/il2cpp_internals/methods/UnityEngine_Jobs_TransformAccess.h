...
namespace app::methods::UnityEngine_Jobs::TransformAccess {
IL2CPP_REGISTER_METHOD(0x001F2360, Vector3, get_position, (app::TransformAccess__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001F23F0, void, set_position, (app::TransformAccess__Boxed * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x001F2460, Quaternion, get_rotation, (app::TransformAccess__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001F24E0, void, set_rotation, (app::TransformAccess__Boxed * this_ptr, app::Quaternion value));
IL2CPP_REGISTER_METHOD(0x001F2540, Vector3, get_localScale, (app::TransformAccess__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001F25D0, void, set_localScale, (app::TransformAccess__Boxed * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x001F2640, Vector3, get_up, (app::TransformAccess__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x001F2670, Vector3, TransformPoint, (app::TransformAccess__Boxed * this_ptr, app::Vector3 point));
