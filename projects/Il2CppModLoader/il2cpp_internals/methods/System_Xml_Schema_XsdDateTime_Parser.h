...
namespace app::methods::System_Xml_Schema::XsdDateTime_Parser {
...
IL2CPP_REGISTER_METHOD(0x001C6200, bool, ParseTime, (app::XsdDateTime_Parser__Boxed * this_ptr, app::int32_t * start));
IL2CPP_REGISTER_METHOD(0x001C6210, bool, ParseZoneAndWhitespace, (app::XsdDateTime_Parser__Boxed * this_ptr, int32_t start));
IL2CPP_REGISTER_METHOD(0x001C6220, bool, Parse4Dig, (app::XsdDateTime_Parser__Boxed * this_ptr, int32_t start, app::int32_t * num));
IL2CPP_REGISTER_METHOD(0x001C6230, bool, Parse2Dig, (app::XsdDateTime_Parser__Boxed * this_ptr, int32_t start, app::int32_t * num));
...
IL2CPP_REGISTER_METHOD(0x01C80CE0, void, __cctor, ());
}
