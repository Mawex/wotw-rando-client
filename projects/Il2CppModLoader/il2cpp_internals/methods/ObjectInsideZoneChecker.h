...
IL2CPP_REGISTER_METHOD(0x005C3FE0, Rect, get_Bounds, (app::ObjectInsideZoneChecker * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0060EB80, Vector3, GetSize, (app::ObjectInsideZoneChecker * this_ptr));
IL2CPP_REGISTER_METHOD(0x0060EEC0, bool, Validate, (app::ObjectInsideZoneChecker * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, get_VirtualTimelineTarget, (app::ObjectInsideZoneChecker * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417920, VirtualTimelineRepresentationGroup__Enum, get_VirtualTimelineGroup, (app::ObjectInsideZoneChecker * this_ptr));
IL2CPP_REGISTER_METHOD(0x004C65D0, String *, get_NameDisplayedOnClip, (app::ObjectInsideZoneChecker * this_ptr));
