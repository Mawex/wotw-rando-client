...
namespace app::methods::KuController {
    ...
    IL2CPP_REGISTER_METHOD(0x003FDCE0, SuspendableMask__Enum, get_Mask, (app::KuController * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0058EE40, void, __ctor, (app::KuController * this_ptr));
} // namespace app::methods::KuController
