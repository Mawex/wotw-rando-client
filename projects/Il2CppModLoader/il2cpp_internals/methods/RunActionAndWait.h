...
IL2CPP_REGISTER_METHOD(0x002FD490, SuspendableMask__Enum, get_Mask, (app::RunActionAndWait * this_ptr));
IL2CPP_REGISTER_METHOD(0x013729F0, void, set_Mask, (app::RunActionAndWait * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x01372AA0, void, __ctor, (app::RunActionAndWait * this_ptr));
}
