...
namespace app::methods::MessageBox {
    IL2CPP_REGISTER_METHOD(0x0158DA80, HashSet_1_Moon_ISuspendable_*, GetSuspendables, (app::MessageBox * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBC60, SoundHost*, get_SoundHost, (app::MessageBox * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0065FBC0, String*, get_CurrentMessage, (app::MessageBox * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01202580, EmotionType__Enum, get_CurrentEmotion, (app::MessageBox * this_ptr));
    IL2CPP_REGISTER_METHOD(0x005FDE00, Event_1*, get_CurrentMessageSound, (app::MessageBox * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01591E00, void, __ctor, (app::MessageBox * this_ptr));
} // namespace app::methods::MessageBox
