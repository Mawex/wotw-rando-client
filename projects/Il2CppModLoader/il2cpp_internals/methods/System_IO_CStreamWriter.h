...
namespace app::methods::System_IO::CStreamWriter {
    IL2CPP_REGISTER_METHOD(0x01E014A0, void, __ctor, (app::CStreamWriter * this_ptr, app::Stream * stream, app::Encoding * encoding, bool leave_open));
