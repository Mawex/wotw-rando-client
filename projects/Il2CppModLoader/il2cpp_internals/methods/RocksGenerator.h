...
IL2CPP_REGISTER_METHOD(0x003FC380, SuspendableMask__Enum, get_Mask, (app::RocksGenerator * this_ptr));
IL2CPP_REGISTER_METHOD(0x0135B330, void, set_Mask, (app::RocksGenerator * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x0135B3F0, void, __ctor, (app::RocksGenerator * this_ptr));
}
