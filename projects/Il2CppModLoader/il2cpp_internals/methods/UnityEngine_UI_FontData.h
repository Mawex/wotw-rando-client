...
namespace app::methods::UnityEngine_UI::FontData {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::FontData * this_ptr));
IL2CPP_REGISTER_METHOD(0x024AD000, FontData *, get_defaultFontData, ());
IL2CPP_REGISTER_METHOD(0x01F2AB40, Font *, get_font, (app::FontData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024AD180, FontStyle__Enum, get_fontStyle, (app::FontData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024AD1A0, TextAnchor__Enum, get_alignment, (app::FontData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F30530, HorizontalWrapMode__Enum, get_horizontalOverflow, (app::FontData * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E06D70, void, set_horizontalOverflow, (app::FontData * this_ptr, app::HorizontalWrapMode__Enum value));
IL2CPP_REGISTER_METHOD(0x01F22020, VerticalWrapMode__Enum, get_verticalOverflow, (app::FontData * this_ptr));
