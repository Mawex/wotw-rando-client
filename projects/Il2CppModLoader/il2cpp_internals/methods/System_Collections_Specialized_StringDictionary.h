...
namespace app::methods::System_Collections_Specialized::StringDictionary {
IL2CPP_REGISTER_METHOD(0x0249E610, void, __ctor, (app::StringDictionary * this_ptr));
IL2CPP_REGISTER_METHOD(0x0249E770, String *, get_Item, (app::StringDictionary * this_ptr, app::String * key));
...
IL2CPP_REGISTER_METHOD(0x01717450, IEnumerator *, GetEnumerator, (app::StringDictionary * this_ptr));
