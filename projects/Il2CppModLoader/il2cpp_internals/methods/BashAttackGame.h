...
IL2CPP_REGISTER_METHOD(0x00F8E4F0, void, UpdateDPadAngle, (bool smooth, app::float * angle_in_out, app::float * kbd_speed_in_out, app::float * kbd_angle_in_out, app::bool * kbd_clockwise_in_out));
...
IL2CPP_REGISTER_METHOD(0x00F8F5F0, void, __ctor, (app::BashAttackGame * this_ptr));
}
