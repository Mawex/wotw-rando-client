...
namespace app::methods::System_Runtime_CompilerServices::AsyncVoidMethodBuilder {
...
IL2CPP_REGISTER_METHOD(0x0018EE60, Task *, get_Task, (app::AsyncVoidMethodBuilder__Boxed * this_ptr));
