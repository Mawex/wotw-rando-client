...
IL2CPP_REGISTER_METHOD(0x007346F0, CharacterLeftRightMovement *, get_LeftRightMovement, (app::ReadyForAnimationTrigger * this_ptr));
IL2CPP_REGISTER_METHOD(0x00734820, bool, get_IsOri, (app::ReadyForAnimationTrigger * this_ptr));
IL2CPP_REGISTER_METHOD(0x007348D0, Vector3, GetDestination, (app::ReadyForAnimationTrigger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00735B10, void, __ctor, (app::ReadyForAnimationTrigger * this_ptr));
