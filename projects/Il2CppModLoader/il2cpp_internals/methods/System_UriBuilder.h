...
IL2CPP_REGISTER_METHOD(0x02A8E0F0, void, __ctor_1, (app::UriBuilder * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A8E220, void, __ctor_2, (app::UriBuilder * this_ptr, app::Uri * uri));
...
IL2CPP_REGISTER_METHOD(0x02A8EBE0, Uri *, get_Uri, (app::UriBuilder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A8EFC0, String *, ToString, (app::UriBuilder * this_ptr));
