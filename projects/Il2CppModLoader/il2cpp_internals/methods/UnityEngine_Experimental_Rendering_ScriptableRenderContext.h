...
namespace app::methods::UnityEngine_Experimental_Rendering::ScriptableRenderContext {
IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor, (app::ScriptableRenderContext__Boxed * this_ptr, app::void * ptr));
