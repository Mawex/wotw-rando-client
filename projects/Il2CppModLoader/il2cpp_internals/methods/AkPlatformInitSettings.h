...
IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkPlatformInitSettings * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x01888810, void *, getCPtr, (app::AkPlatformInitSettings * obj));
IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkPlatformInitSettings * this_ptr, app::void * c_ptr));
...
IL2CPP_REGISTER_METHOD(0x01888C70, AkThreadProperties *, get_threadLEngine, (app::AkPlatformInitSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01888FC0, AkThreadProperties *, get_threadOutputMgr, (app::AkPlatformInitSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01889310, AkThreadProperties *, get_threadBankManager, (app::AkPlatformInitSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01889660, AkThreadProperties *, get_threadMonitor, (app::AkPlatformInitSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0188A2E0, AkAudioAPI__Enum, get_eAudioAPI, (app::AkPlatformInitSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0188A660, void, __ctor_2, (app::AkPlatformInitSettings * this_ptr));
}
