...
namespace app::methods::Moon::Sensor {
    ...
    IL2CPP_REGISTER_METHOD(0x003FC830, SuspendableMask__Enum, get_Mask, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00ECCC30, void, set_Mask, (app::Sensor * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x00ECCCE0, GameObject*, get_TrackedCharacter, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00ECCE10, Vector3, get_CharacterPosition, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00ECCF20, Vector3, CharacterPositionEx, (app::Transform * fallback));
    ...
    IL2CPP_REGISTER_METHOD(0x00ECD6D0, Vector2, get_DirectionToCharacter, (app::Sensor * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00ECDDA0, Vector3, get_LastSeenPosition, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00ECDE80, Vector3, get_LostSightLocation, (app::Sensor * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00ECE8C0, Vector3, get_OriPredictedPosition, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00ECEAA0, Vector2, get_RayOriginPosition, (app::Sensor * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00ECF5F0, Sensor_CanSeeCharacterHelper, CanSeeCharacterHelperFullAccess, (app::Sensor * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00ED0C40, Vector3, ProjectTargetOnGround, (app::Sensor * this_ptr, float distance, int32_t ground_mask));
    ...
    IL2CPP_REGISTER_METHOD(0x00ED1060, void, __ctor, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00ED10E0, void, __cctor, ());
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_1, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_2, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_3, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_4, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_5, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_6, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_7, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_8, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_9, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_10, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_11, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_12, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_13, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_14, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_15, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_16, (app::Sensor * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_17, (app::Sensor * this_ptr));
} // namespace app::methods::Moon::Sensor
