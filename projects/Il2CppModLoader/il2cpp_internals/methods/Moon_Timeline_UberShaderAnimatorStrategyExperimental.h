...
namespace app::methods::Moon_Timeline::UberShaderAnimatorStrategyExperimental {
...
IL2CPP_REGISTER_METHOD(0x00D138F0, Vector4, GetStaticVector, (app::UberShaderAnimatorStrategyExperimental * this_ptr, app::Renderer * target_renderer, app::UberShaderProperty_Vector__Enum property));
...
IL2CPP_REGISTER_METHOD(0x00D14C30, UberShaderAnimatorStrategyExperimental_RendererState *, GetState, (app::UberShaderAnimatorStrategyExperimental * this_ptr, app::Renderer * target_renderer, bool create));
IL2CPP_REGISTER_METHOD(0x00D14DF0, UberShaderAnimatorStrategyExperimental_RendererState *, AllocateState, (app::UberShaderAnimatorStrategyExperimental * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D14F70, void, __ctor, (app::UberShaderAnimatorStrategyExperimental * this_ptr));
}
