...
namespace app::methods::Moon_Timeline::LegacyTimelineState {
...
IL2CPP_REGISTER_METHOD(0x00774B00, GameObject *, GetOrCreateEditorOri, ());
IL2CPP_REGISTER_METHOD(0x00774BA0, GameObject *, GetEditorOri, ());
IL2CPP_REGISTER_METHOD(0x00774C40, Animator *, GetOriAnimator, ());
...
IL2CPP_REGISTER_METHOD(0x00775490, GenericPuppet *, GetPuppet, (int32_t puppet_id, int32_t recording_id));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::LegacyTimelineState * this_ptr));
IL2CPP_REGISTER_METHOD(0x00775780, void, __cctor, ());
}
