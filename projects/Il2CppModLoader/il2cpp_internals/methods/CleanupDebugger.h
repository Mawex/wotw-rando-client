...
IL2CPP_REGISTER_METHOD(0x01324D40, GUIStyle *, get_LabelStyle, (app::CleanupDebugger * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01326720, void, __ctor, (app::CleanupDebugger * this_ptr));
}
