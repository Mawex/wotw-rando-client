...
IL2CPP_REGISTER_METHOD(0x00420EE0, GhostRecorder_GhostPluginRecordingType__Enum, GetRecordingType, (app::GhostUberStatePlugin * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x007E59B0, void, __ctor, (app::GhostUberStatePlugin * this_ptr));
}
