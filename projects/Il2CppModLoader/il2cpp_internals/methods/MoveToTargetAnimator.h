...
IL2CPP_REGISTER_METHOD(0x00868870, Vector3, get_OriginalPosition, (app::MoveToTargetAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00869350, void, __ctor, (app::MoveToTargetAnimator * this_ptr));
}
