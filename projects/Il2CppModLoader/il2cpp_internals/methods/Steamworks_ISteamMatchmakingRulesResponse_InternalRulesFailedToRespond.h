...
namespace app::methods::Steamworks::ISteamMatchmakingRulesResponse_InternalRulesFailedToRespond {
    IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::ISteamMatchmakingRulesResponse_InternalRulesFailedToRespond * this_ptr, app::Object * object, void * method_1));
