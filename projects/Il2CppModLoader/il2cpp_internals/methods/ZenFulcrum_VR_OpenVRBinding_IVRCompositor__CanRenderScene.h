...
namespace app::methods::ZenFulcrum_VR_OpenVRBinding::IVRCompositor__CanRenderScene {
    IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::IVRCompositor_CanRenderScene * this_ptr, app::Object * object, void * method_1));
