...
IL2CPP_REGISTER_METHOD(0x01834A60, IGenericUberState *, GetChangedState, (app::SwitchSeriesPuzzle * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9F0, IUberState__Array *, get_AffectingUberStates, (app::SwitchSeriesPuzzle * this_ptr));
IL2CPP_REGISTER_METHOD(0x01835080, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::SwitchSeriesPuzzle * this_ptr));
