...
IL2CPP_REGISTER_METHOD(0x00608710, SuspendableMask__Enum, get_Mask, (app::RigidbodySerialize * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01352610, void, __ctor, (app::RigidbodySerialize * this_ptr));
}
