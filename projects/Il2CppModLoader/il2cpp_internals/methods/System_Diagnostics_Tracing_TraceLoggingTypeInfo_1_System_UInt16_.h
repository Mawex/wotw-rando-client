...
namespace app::methods::System_Diagnostics_Tracing::TraceLoggingTypeInfo_1_System_UInt16_ {
...
IL2CPP_REGISTER_METHOD(0x02871710, TraceLoggingTypeInfo_1_System_UInt16_ *, get_Instance, ());
...
IL2CPP_REGISTER_METHOD(0x02877F30, TraceLoggingTypeInfo_1_System_UInt16_ *, GetInstance, (app::List_1_System_Type_ * recursion_check));
IL2CPP_REGISTER_METHOD(0x02878120, TraceLoggingTypeInfo_1_System_UInt16_ *, InitInstance, ());
}
