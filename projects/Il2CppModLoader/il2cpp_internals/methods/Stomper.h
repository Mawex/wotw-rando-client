...
namespace app::methods::Stomper {
    ...
    IL2CPP_REGISTER_METHOD(0x003FFA60, SuspendableMask__Enum, get_Mask, (app::Stomper * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00658AD0, void, set_Mask, (app::Stomper * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x00658B90, void, __ctor, (app::Stomper * this_ptr));
} // namespace app::methods::Stomper
