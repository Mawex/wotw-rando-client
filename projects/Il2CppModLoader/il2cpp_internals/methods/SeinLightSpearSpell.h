...
IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement *, get_PlatformMovement, (app::SeinLightSpearSpell * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x008925C0, void, __ctor, (app::SeinLightSpearSpell * this_ptr));
}
