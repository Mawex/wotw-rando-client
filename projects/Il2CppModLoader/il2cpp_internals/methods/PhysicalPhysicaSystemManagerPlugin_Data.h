...
IL2CPP_REGISTER_METHOD(0x014ED2B0, GhostFrame_FrameDataTypes__Enum, get_FrameType, (app::PhysicalPhysicaSystemManagerPlugin_Data * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014EE2A0, void, __ctor, (app::PhysicalPhysicaSystemManagerPlugin_Data * this_ptr));
}
