...
IL2CPP_REGISTER_METHOD(0x008D9640, WaterPoisonCloud_Blob, GetBlob, (app::WaterPoisonCloud * this_ptr, int32_t i));
...
IL2CPP_REGISTER_METHOD(0x008DA230, Damage *, GetDamageForPosition, (app::WaterPoisonCloud * this_ptr, app::Vector3 position));
...
IL2CPP_REGISTER_METHOD(0x008DCD60, void, __ctor, (app::WaterPoisonCloud * this_ptr));
}
