...
IL2CPP_REGISTER_METHOD(0x030434A0, String *, GetShaderName, (app::DynamicLookup * this_ptr));
IL2CPP_REGISTER_METHOD(0x03043520, void, __ctor, (app::DynamicLookup * this_ptr));
}
