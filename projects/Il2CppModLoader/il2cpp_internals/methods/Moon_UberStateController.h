...
IL2CPP_REGISTER_METHOD(0x01B69690, List_1_Moon_IUberStateApplier_ *, get_AppliersEditorCache, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x01B699A0, void, InvalidateAppliersCache, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x01B69AB0, void, ResetStatics, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x01B69CB0, UberStateController *, get_Instance, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x01B6A3B0, UberStateValueStore *, get_CurrentStateValueStore, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x01B6B390, void, ApplyPendingChanges, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x01B6C3D0, void, OnPostRestoreCheckpoint, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (UberStateController * __this));
IL2CPP_REGISTER_METHOD(0x002FA000, void, UpdateEditorAppliersCache, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x01B6C850, void, __cctor, (MethodInfo * method));
}
