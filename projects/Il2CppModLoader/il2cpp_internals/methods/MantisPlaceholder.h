...
IL2CPP_REGISTER_METHOD(0x006253D0, GameObject *, get_Prefab, (app::MantisPlaceholder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A09360, void, __ctor, (app::MantisPlaceholder * this_ptr));
}
