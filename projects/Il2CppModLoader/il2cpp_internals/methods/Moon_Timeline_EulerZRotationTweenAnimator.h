...
namespace app::methods::Moon_Timeline::EulerZRotationTweenAnimator {
IL2CPP_REGISTER_METHOD(0x002FBC20, Transform *, get_TransformTarget, (app::EulerZRotationTweenAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BBBA10, Transform *, get_EffectiveTransform, (app::EulerZRotationTweenAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BBC490, void, __ctor, (app::EulerZRotationTweenAnimator * this_ptr));
}
