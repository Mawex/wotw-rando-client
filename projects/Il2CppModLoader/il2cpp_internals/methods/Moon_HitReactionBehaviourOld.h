...
IL2CPP_REGISTER_METHOD(0x014ABDB0, StaggerSettings *, GetStaggerSetting, (app::HitReactionBehaviourOld * this_ptr, app::DamageResult damage_result));
IL2CPP_REGISTER_METHOD(0x002FA000, void, OnDrawGizmos, (app::HitReactionBehaviourOld * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::HitReactionBehaviourOld * this_ptr));
}
