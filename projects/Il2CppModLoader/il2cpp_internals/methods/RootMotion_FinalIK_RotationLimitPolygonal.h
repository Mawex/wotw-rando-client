...
namespace app::methods::RootMotion_FinalIK::RotationLimitPolygonal {
...
IL2CPP_REGISTER_METHOD(0x02A224B0, Quaternion, LimitRotation, (app::RotationLimitPolygonal * this_ptr, app::Quaternion rotation));
...
IL2CPP_REGISTER_METHOD(0x02A241B0, Vector3__Array *, SmoothPoints, (app::RotationLimitPolygonal * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A249C0, float, GetScalar, (app::RotationLimitPolygonal * this_ptr, int32_t k));
IL2CPP_REGISTER_METHOD(0x02A24A10, Vector3, PointToTangentPlane, (app::RotationLimitPolygonal * this_ptr, app::Vector3 p, float r));
IL2CPP_REGISTER_METHOD(0x02A24BC0, Vector3, TangentPointToSphere, (app::RotationLimitPolygonal * this_ptr, app::Vector3 q, float r));
IL2CPP_REGISTER_METHOD(0x02A24DB0, Quaternion, LimitSwing, (app::RotationLimitPolygonal * this_ptr, app::Quaternion rotation));
IL2CPP_REGISTER_METHOD(0x02A252C0, int32_t, GetReachCone, (app::RotationLimitPolygonal * this_ptr, app::Vector3 L));
IL2CPP_REGISTER_METHOD(0x02A255B0, void, __ctor, (app::RotationLimitPolygonal * this_ptr));
}
