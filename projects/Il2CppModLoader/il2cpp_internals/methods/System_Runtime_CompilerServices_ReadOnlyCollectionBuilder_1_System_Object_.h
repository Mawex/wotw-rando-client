...
namespace app::methods::System_Runtime_CompilerServices::ReadOnlyCollectionBuilder_1_System_Object_ {
...
IL2CPP_REGISTER_METHOD(0x02772110, Object *, get_Item, (app::ReadOnlyCollectionBuilder_1_System_Object_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02772BE0, Object *, IList_get_Item, (app::ReadOnlyCollectionBuilder_1_System_Object_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, Object *, ICollection_get_SyncRoot, (app::ReadOnlyCollectionBuilder_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0243CB70, void, __ctor_1, (app::ReadOnlyCollectionBuilder_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02771C10, void, __ctor_2, (app::ReadOnlyCollectionBuilder_1_System_Object_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x027724F0, IEnumerator_1_System_Object_ *, GetEnumerator, (app::ReadOnlyCollectionBuilder_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02772600, IEnumerator *, IEnumerable_GetEnumerator, (app::ReadOnlyCollectionBuilder_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, Object__Array *, ToArray, (app::ReadOnlyCollectionBuilder_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02772ED0, ReadOnlyCollection_1_System_Object_ *, ToReadOnlyCollection, (app::ReadOnlyCollectionBuilder_1_System_Object_ * this_ptr));
