...
IL2CPP_REGISTER_METHOD(0x00244720, void, __ctor, (app::SpherecastCommand__Boxed * this_ptr, app::Vector3 origin, float radius, app::Vector3 direction, float distance, int32_t layer_mask));
IL2CPP_REGISTER_METHOD(0x001EB5F0, Vector3, get_origin, (app::SpherecastCommand__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00244760, Vector3, get_direction, (app::SpherecastCommand__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030AF7D0, JobHandle, ScheduleBatch_1, (app::NativeArray_1_UnityEngine_SpherecastCommand_ commands, int32_t cmd_count, app::NativeArray_1_UnityEngine_RaycastHit_ results, int32_t result_count, int32_t min_commands_per_job, app::JobHandle depends_on));
IL2CPP_REGISTER_METHOD(0x030AF980, JobHandle, ScheduleBatch_2, (app::NativeArray_1_UnityEngine_SpherecastCommand_ commands, app::NativeArray_1_UnityEngine_RaycastHit_ results, int32_t min_commands_per_job, app::JobHandle depends_on));
IL2CPP_REGISTER_METHOD(0x030AFA00, JobHandle, ScheduleSpherecastBatch, (app::JobsUtility_JobScheduleParameters * parameters, app::Void * commands, int32_t command_len, app::Void * result, int32_t result_len, int32_t min_commands_per_job));
