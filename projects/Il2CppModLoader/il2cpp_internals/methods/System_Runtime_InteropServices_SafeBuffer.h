...
IL2CPP_REGISTER_METHOD(0x01A96CB0, void, AcquirePointer, (SafeBuffer * __this, uint8_t * * pointer));
IL2CPP_REGISTER_METHODINFO(0x04724368, SafeBuffer_AcquirePointer__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A96D90, void, ReleasePointer, (SafeBuffer * __this));
