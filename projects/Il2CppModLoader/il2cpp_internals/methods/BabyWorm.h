...
namespace app::methods::BabyWorm {
    ...
    IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::BabyWorm * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00F79010, Vector2, get_UpDirection, (app::BabyWorm * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00F79130, void, set_UpDirection, (app::BabyWorm * this_ptr, app::Vector2 value));
    IL2CPP_REGISTER_METHOD(0x00F79270, Vector2, get_WorldSpeed, (app::BabyWorm * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00F79440, BabyWorm_BabySandwormState__Enum, get_CurrentState, (app::BabyWorm * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00F79450, Vector2, get_TargetPosition, (app::BabyWorm * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00F79690, Vector2, get_DashDirection, (app::BabyWorm * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00F79790, SuspendableMask__Enum, get_Mask, (app::BabyWorm * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00F7CD50, Vector2, GetAvoidanceForces, (app::BabyWorm * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00813FA0, IDamageReciever__Array*, get_AffectedReceivers, (app::BabyWorm * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00F7F6D0, void, __ctor, (app::BabyWorm * this_ptr));
} // namespace app::methods::BabyWorm
