...
namespace app::methods::SeinPinned {
    ...
    IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement*, get_PlatformMovement, (app::SeinPinned * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x005C9550, void, __ctor, (app::SeinPinned * this_ptr));
} // namespace app::methods::SeinPinned
