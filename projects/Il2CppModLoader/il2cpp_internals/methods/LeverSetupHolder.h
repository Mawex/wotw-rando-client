...
IL2CPP_REGISTER_METHOD(0x01137C50, LeverSetupData *, get_LeftState, (app::LeverSetupHolder * this_ptr));
IL2CPP_REGISTER_METHOD(0x01137CF0, LeverSetupData *, get_RightState, (app::LeverSetupHolder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01138010, void, __ctor, (app::LeverSetupHolder * this_ptr));
}
