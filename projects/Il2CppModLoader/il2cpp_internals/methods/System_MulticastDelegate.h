...
IL2CPP_REGISTER_METHOD(0x0226E2A0, MethodInfo_1 *, GetMethodImpl, (app::MulticastDelegate * this_ptr));
IL2CPP_REGISTER_METHOD(0x0226E430, Delegate__Array *, GetInvocationList, (app::MulticastDelegate * this_ptr));
IL2CPP_REGISTER_METHOD(0x0226E5E0, Delegate *, CombineImpl, (app::MulticastDelegate * this_ptr, app::Delegate * follow));
...
IL2CPP_REGISTER_METHOD(0x0226EBE0, Delegate *, RemoveImpl, (app::MulticastDelegate * this_ptr, app::Delegate * value));
