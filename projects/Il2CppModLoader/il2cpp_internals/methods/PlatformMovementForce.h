...
IL2CPP_REGISTER_METHOD(0x0116F490, PlatformBehaviour *, get_PlatformBehaviour, (app::PlatformMovementForce * this_ptr));
IL2CPP_REGISTER_METHOD(0x0116F4B0, PlatformMovementListOfColliders *, get_ListOfColliders, (app::PlatformMovementForce * this_ptr));
IL2CPP_REGISTER_METHOD(0x0116F4E0, PlatformMovement *, get_PlatformMovement, (app::PlatformMovementForce * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::PlatformMovementForce * this_ptr));
}
