...
IL2CPP_REGISTER_METHOD(0x010B5B10, GameObject *, get_CreepPrefab, (app::TentacleSpitBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x010B5BC0, GameObject *, get_ProjectilePrefab, (app::TentacleSpitBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010B5FC0, BehaviourStatus__Enum, OnExecute, (app::TentacleSpitBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x010B7680, void, __ctor, (app::TentacleSpitBehaviour * this_ptr));
}
