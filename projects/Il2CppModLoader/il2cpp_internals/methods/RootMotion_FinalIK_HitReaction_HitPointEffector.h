...
namespace app::methods::RootMotion_FinalIK::HitReaction_HitPointEffector {
...
IL2CPP_REGISTER_METHOD(0x02076780, void, __ctor, (app::HitReaction_HitPointEffector * this_ptr));
}
