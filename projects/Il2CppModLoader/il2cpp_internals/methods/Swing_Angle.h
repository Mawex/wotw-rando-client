...
namespace app::methods::Swing::Angle {
    ...
    IL2CPP_REGISTER_METHOD(0x0182A090, app::Angle, operator___1, (app::Angle _a, app::Angle _b));
    IL2CPP_REGISTER_METHOD(0x0182A0B0, app::Angle, operator___2, (app::Angle _a, app::Angle _b));
    IL2CPP_REGISTER_METHOD(0x0182A0D0, app::Angle, operator___3, (app::Angle _a, float _b));
    IL2CPP_REGISTER_METHOD(0x0182A0E0, app::Angle, operator___4, (float _a, app::Angle _b));
    IL2CPP_REGISTER_METHOD(0x0182A0F0, app::Angle, operator___5, (app::Angle _a, float _b));
    IL2CPP_REGISTER_METHOD(0x0182A100, app::Angle, operator___6, (float _a, app::Angle _b));
    IL2CPP_REGISTER_METHOD(0x0182A110, app::Angle, operator___7, (app::Angle _a, app::Angle _b));
    IL2CPP_REGISTER_METHOD(0x0182A130, float, operator___8, (app::Angle _a, app::Angle _b));
    IL2CPP_REGISTER_METHOD(0x0182A140, app::Angle, operator___9, (app::Angle _a));
