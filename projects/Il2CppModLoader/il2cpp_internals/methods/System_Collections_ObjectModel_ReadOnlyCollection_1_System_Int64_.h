...
namespace app::methods::System_Collections_ObjectModel::ReadOnlyCollection_1_System_Int64_ {
IL2CPP_REGISTER_METHOD(0x02B7DCF0, void, __ctor, (app::ReadOnlyCollection_1_System_Int64_ * this_ptr, app::IList_1_System_Int64_ * list));
...
IL2CPP_REGISTER_METHOD(0x02B7DF30, IEnumerator_1_System_Int64__1 *, GetEnumerator, (app::ReadOnlyCollection_1_System_Int64_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02FDAA30, IEnumerator *, IEnumerable_GetEnumerator, (app::ReadOnlyCollection_1_System_Int64_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, ICollection_get_IsSynchronized, (app::ReadOnlyCollection_1_System_Int64_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02FDAAC0, Object *, ICollection_get_SyncRoot, (app::ReadOnlyCollection_1_System_Int64_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02FDB050, Object *, IList_get_Item, (app::ReadOnlyCollection_1_System_Int64_ * this_ptr, int32_t index));
