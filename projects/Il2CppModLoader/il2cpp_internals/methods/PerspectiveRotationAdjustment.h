...
IL2CPP_REGISTER_METHOD(0x00499420, Transform *, get_TargetTransform, (app::PerspectiveRotationAdjustment * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00499ED0, void, __ctor, (app::PerspectiveRotationAdjustment * this_ptr));
}
