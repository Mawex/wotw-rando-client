...
IL2CPP_REGISTER_METHOD(0x020EB3C0, Material *, get_material, (app::CameraFilterPack_TV_Old_Movie * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E8940, void, __ctor, (app::CameraFilterPack_TV_Old_Movie * this_ptr));
}
