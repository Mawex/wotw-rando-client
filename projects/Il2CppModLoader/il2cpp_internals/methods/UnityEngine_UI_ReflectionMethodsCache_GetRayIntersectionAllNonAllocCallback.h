...
namespace app::methods::UnityEngine_UI::ReflectionMethodsCache_GetRayIntersectionAllNonAllocCallback {
    IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::ReflectionMethodsCache_GetRayIntersectionAllNonAllocCallback * this_ptr, app::Object * object, void * method_1));
