...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::Comparison_1_Moon_Wwise_WwiseEventSystem_SoundHandleProtected_CallbackData_ * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02C7AF10, IAsyncResult *, BeginInvoke, (app::Comparison_1_Moon_Wwise_WwiseEventSystem_SoundHandleProtected_CallbackData_ * this_ptr, app::WwiseEventSystem_SoundHandleProtected_CallbackData x, app::WwiseEventSystem_SoundHandleProtected_CallbackData y, app::AsyncCallback * callback, app::Object * object));
