...
IL2CPP_REGISTER_METHOD(0x0088EB90, SeinLifeAbsorbSpell *, get_Spell, (app::SeinLifeAbsorbArm * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0088EF30, Vector3, Biezer, (app::SeinLifeAbsorbArm * this_ptr, app::Vector3 p1, app::Vector3 p2, app::Vector3 p3, app::Vector3 p4, float x));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::SeinLifeAbsorbArm * this_ptr));
}
