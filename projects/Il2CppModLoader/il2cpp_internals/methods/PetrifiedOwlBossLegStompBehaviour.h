...
IL2CPP_REGISTER_METHOD(0x017644B0, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossLegStompBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01777DF0, Enum__Array *, GetEntries, (app::PetrifiedOwlBossLegStompBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x01777E90, Enum, Evaluate, (app::PetrifiedOwlBossLegStompBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_ShouldSkip, (app::PetrifiedOwlBossLegStompBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x017657C0, void, __ctor, (app::PetrifiedOwlBossLegStompBehaviour * this_ptr));
}
