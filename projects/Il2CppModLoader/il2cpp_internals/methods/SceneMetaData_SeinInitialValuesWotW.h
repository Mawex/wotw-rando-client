...
IL2CPP_REGISTER_METHOD(0x00BB0450, PlayerUberStateInventory_InventoryItem *, RegisterEquipment, (app::SceneMetaData_SeinEquipmentWotW * equipment));
IL2CPP_REGISTER_METHOD(0x00BB0530, void, __ctor, (app::SceneMetaData_SeinInitialValuesWotW * this_ptr));
}
