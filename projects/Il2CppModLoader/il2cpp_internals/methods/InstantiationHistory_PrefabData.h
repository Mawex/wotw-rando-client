...
IL2CPP_REGISTER_METHOD(0x00635BE0, void, __ctor, (app::InstantiationHistory_PrefabData * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00635CE0, String *, ToCSV, (app::InstantiationHistory_PrefabData * this_ptr));
}
