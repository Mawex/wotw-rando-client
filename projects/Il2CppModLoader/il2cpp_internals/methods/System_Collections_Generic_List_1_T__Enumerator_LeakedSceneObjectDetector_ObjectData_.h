...
IL2CPP_REGISTER_METHOD(0x00107C20, LeakedSceneObjectDetector_ObjectData *, get_Current, (app::List_1_T_Enumerator_LeakedSceneObjectDetector_ObjectData___Boxed * this_ptr));
