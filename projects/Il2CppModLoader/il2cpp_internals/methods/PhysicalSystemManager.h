...
IL2CPP_REGISTER_METHOD(0x014EF6F0, Bounds, get_WorldSpaceBoundingBox, (app::PhysicalSystemManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x014EF920, void, set_WorldSpaceBoundingBox, (app::PhysicalSystemManager * this_ptr, app::Bounds value));
IL2CPP_REGISTER_METHOD(0x014EFB50, Bounds, get_LocalSpaceBoundingBox, (app::PhysicalSystemManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014F01E0, PhysicalSystemState *, GetSystemState_1, (app::PhysicalSystemManager * this_ptr, int32_t state_g_u_i_d));
IL2CPP_REGISTER_METHOD(0x014F0280, PhysicalSystemState *, GetSystemState_2, (app::PhysicalSystemManager * this_ptr, app::String * state_name));
...
IL2CPP_REGISTER_METHOD(0x014F3CC0, Bounds, get_Bounds, (app::PhysicalSystemManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014F3CF0, SuspendableMask__Enum, ISuspendable_get_Mask, (app::PhysicalSystemManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014F5370, RigidbodyState__Array *, GetRigidbodyStates, (app::PhysicalSystemManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD00, ApplyTurbulentForce__Array *, get_ApplyTurbulentForces, (app::PhysicalSystemManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x0065FBE0, RigidbodyState__Array *, get_CachedRigidbodyStates, (app::PhysicalSystemManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014F6610, PhysicalSystemState *, get_LastState, (app::PhysicalSystemManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014F7660, IEnumerator *, TimeSliceDisablePhysics, (app::PhysicalSystemManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014F7A90, IEnumerator *, TimeSliceActivatePhysics, (app::PhysicalSystemManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, RecordableParsingGroup__Enum, IRecordable_get_ParsingGroup, (app::PhysicalSystemManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014F8640, void, __ctor, (app::PhysicalSystemManager * this_ptr));
