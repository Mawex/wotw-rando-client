...
IL2CPP_REGISTER_METHOD(0x01683250, CameraChaseTargetSpeedRatioController *, get_SpeedRatioController, (app::CameraChaseTarget * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x016835E0, Vector3, UpdateChase, (app::CameraChaseTarget * this_ptr, float delta_time));
...
IL2CPP_REGISTER_METHOD(0x01684240, void, __ctor, (app::CameraChaseTarget * this_ptr));
}
