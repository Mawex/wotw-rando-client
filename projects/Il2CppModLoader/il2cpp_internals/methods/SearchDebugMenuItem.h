...
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_Path, (app::SearchDebugMenuItem * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_Path, (app::SearchDebugMenuItem * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Text, (app::SearchDebugMenuItem * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_Text, (app::SearchDebugMenuItem * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_HelpText, (app::SearchDebugMenuItem * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB960, void, set_HelpText, (app::SearchDebugMenuItem * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x0106A150, void, __ctor, (app::SearchDebugMenuItem * this_ptr, app::String * path));
...
IL2CPP_REGISTER_METHOD(0x002FB9F0, Func_1_String_ *, get_DynamicText, (app::SearchDebugMenuItem * this_ptr));
}
