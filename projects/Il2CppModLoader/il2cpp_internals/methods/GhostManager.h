...
namespace app::methods::GhostManager {
    ...
    IL2CPP_REGISTER_METHOD(0x00E223E0, String*, GetRaceDirectory, (app::String * race_i_d));
    IL2CPP_REGISTER_METHOD(0x00E22500, String*, GetOfflineRaceDirectory, (app::String * race_i_d));
    ...
    IL2CPP_REGISTER_METHOD(0x00E22670, Byte__Array*, ReadBytesFromFilePath, (app::String * file_path));
    IL2CPP_REGISTER_METHOD(0x00E22680, String*, GetGhostFile, (app::String * directory));
    IL2CPP_REGISTER_METHOD(0x00E22720, GhostPlayer*, createGhost_1, (app::GhostManager * this_ptr, app::String* ghost_input_file));
    IL2CPP_REGISTER_METHOD(0x00E229D0, GhostPlayer*, createGhost_2, (app::GhostManager * this_ptr, app::String* display_name, app::String* replay));
