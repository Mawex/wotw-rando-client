...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::JSONNode {
    ...
    IL2CPP_REGISTER_METHOD(0x01DE2930, app::String *, operator__1, (app::JSONNode * n));
    IL2CPP_REGISTER_METHOD(0x01DE2960, app::JSONNode *, operator__2, (app::String * v));
    IL2CPP_REGISTER_METHOD(0x01DE2AB0, int32_t, operator__3, (app::JSONNode * n));
    IL2CPP_REGISTER_METHOD(0x01DE2AE0, app::JSONNode *, operator__4, (int32_t v));
    IL2CPP_REGISTER_METHOD(0x01DE2C30, float, operator__5, (app::JSONNode * n));
    IL2CPP_REGISTER_METHOD(0x01DE2C60, app::JSONNode *, operator__6, (float v));
    IL2CPP_REGISTER_METHOD(0x01DE2DC0, double, operator__7, (app::JSONNode * n));
    IL2CPP_REGISTER_METHOD(0x01DE2DF0, app::JSONNode *, operator__8, (double v));
    ...
    IL2CPP_REGISTER_METHOD(0x01DE31A0, app::Dictionary_2_System_String_ZenFulcrum_EmbeddedBrowser_JSONNode_ *, operator__9, (app::JSONNode * n));
    ...
    IL2CPP_REGISTER_METHOD(0x01DE3490, app::List_1_ZenFulcrum_EmbeddedBrowser_JSONNode_ *, operator__10, (app::JSONNode * n));
    ...
    IL2CPP_REGISTER_METHOD(0x01DE3690, app::JSONNode *, operator__12, (bool v));
