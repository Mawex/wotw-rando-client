...
namespace app::methods::System_Diagnostics_Tracing::EnumSByteTypeInfo_1_EmptyStruct_ {
...
IL2CPP_REGISTER_METHOD(0x00502220, Object *, GetData, (app::EnumSByteTypeInfo_1_EmptyStruct_ * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x0298B8E0, void, __ctor, (app::EnumSByteTypeInfo_1_EmptyStruct_ * this_ptr));
}
