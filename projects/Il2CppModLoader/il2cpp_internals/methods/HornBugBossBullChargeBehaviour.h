...
IL2CPP_REGISTER_METHOD(0x00B60F60, BehaviourStatus__Enum, OnExecute, (app::HornBugBossBullChargeBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00B61A10, void, __ctor, (app::HornBugBossBullChargeBehaviour * this_ptr));
}
