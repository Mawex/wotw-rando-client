...
namespace app::methods::System_Collections_Generic::List_1_Game_Targets_ConsumerList_ {
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_Game_Targets_ConsumerList_, GetEnumerator, (app::List_1_Game_Targets_ConsumerList_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EFC50, Targets_ConsumerList *, get_Item, (app::List_1_Game_Targets_ConsumerList_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor, (app::List_1_Game_Targets_ConsumerList_ * this_ptr, int32_t capacity));
