...
IL2CPP_REGISTER_METHOD(0x006515B0, SuspendableMask__Enum, get_Mask, (app::DeadJumpingSootEnemy * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00DDC470, void, __ctor, (app::DeadJumpingSootEnemy * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::DeadJumpingSootEnemy * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::DeadJumpingSootEnemy * this_ptr));
}
