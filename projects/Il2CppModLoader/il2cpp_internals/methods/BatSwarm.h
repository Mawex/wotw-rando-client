...
namespace app::methods::BatSwarm {
    IL2CPP_REGISTER_METHOD(0x00F943E0, Vector2, get_MainPOI, (app::BatSwarm * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00F945A0, Vector2, get_Position, (app::BatSwarm * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00F94880, Vector2, get_PathPOI, (app::BatSwarm * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00F95570, Vector2, get_AvoidanceSpot, (app::BatSwarm * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00F96070, void, __ctor, (app::BatSwarm * this_ptr));
} // namespace app::methods::BatSwarm
