...
namespace app::methods::System_Data::XmlDataTreeWriter {
IL2CPP_REGISTER_METHOD(0x023EEEB0, void, __ctor_1, (app::XmlDataTreeWriter * this_ptr, app::DataSet * ds));
IL2CPP_REGISTER_METHOD(0x023EF200, void, __ctor_2, (app::XmlDataTreeWriter * this_ptr, app::DataTable * dt, bool write_hierarchy));
IL2CPP_REGISTER_METHOD(0x023EF4C0, DataTable__Array *, CreateToplevelTables, (app::XmlDataTreeWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x023F0C00, ArrayList *, GetNestedChildRelations, (app::XmlDataTreeWriter * this_ptr, app::DataRow * row));
