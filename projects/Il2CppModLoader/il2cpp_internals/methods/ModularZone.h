...
namespace app::methods::ModularZone {
    ...
    IL2CPP_REGISTER_METHOD(0x0132F760, IModularZoneModifier__Array*, get_Modifiers, (app::ModularZone * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBC10, void, set_Modifiers, (app::ModularZone * this_ptr, app::IModularZoneModifier__Array* value));
    IL2CPP_REGISTER_METHOD(0x0132F790, List_1_ICondition_*, get_ResolvedConditions, (app::ModularZone * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0132F9C0, Transform*, get_TargetTransform, (app::ModularZone * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01330B30, IModularZoneModifier*, AddModifier_1, (app::ModularZone * this_ptr, app::Type* type));
    ...
    IL2CPP_REGISTER_METHOD(0x01331230, void, __ctor, (app::ModularZone * this_ptr));
    IL2CPP_REGISTER_METHOD(0x015EB9B0, Object*, AddModifier_2, (app::ModularZone * this_ptr));
