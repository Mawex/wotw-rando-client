...
namespace app::methods::Newtonsoft_Json_Utilities::DateTimeUtils {
IL2CPP_REGISTER_METHOD(0x01C089A0, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x01C08AA0, TimeSpan, GetUtcOffset, (app::DateTime d));
IL2CPP_REGISTER_METHOD(0x01C08AE0, XmlDateTimeSerializationMode__Enum, ToSerializationMode, (app::DateTimeKind__Enum kind));
IL2CPP_REGISTER_METHODINFO(0x047122E8, DateTimeUtils_ToSerializationMode__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01C08BC0, DateTime, EnsureDateTime, (app::DateTime value, app::DateTimeZoneHandling__Enum time_zone));
...
IL2CPP_REGISTER_METHOD(0x01C093B0, DateTime, ConvertJavaScriptTicksToDateTime, (int64_t java_script_ticks));
...
IL2CPP_REGISTER_METHOD(0x01C09A70, DateTime, CreateDateTime, (app::DateTimeParser date_time_parser));
...
IL2CPP_REGISTER_METHOD(0x01C0ABB0, bool, TryParseMicrosoftDate, (app::StringReference text, app::int64_t * ticks, app::TimeSpan * offset, app::DateTimeKind__Enum * kind));
...
IL2CPP_REGISTER_METHOD(0x01C0C520, void, GetDateValues, (app::DateTime td, app::int32_t * year, app::int32_t * month, app::int32_t * day));
}
