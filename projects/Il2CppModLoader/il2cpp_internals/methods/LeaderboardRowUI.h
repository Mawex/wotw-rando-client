...
IL2CPP_REGISTER_METHOD(0x002FBBA0, String *, get_UserHandle, (app::LeaderboardRowUI * this_ptr));
IL2CPP_REGISTER_METHOD(0x015B8370, Rect, get_Bounds, (app::LeaderboardRowUI * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::LeaderboardRowUI * this_ptr));
}
