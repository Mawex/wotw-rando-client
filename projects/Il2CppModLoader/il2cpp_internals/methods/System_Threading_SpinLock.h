...
namespace app::methods::System_Threading::SpinLock {
IL2CPP_REGISTER_METHOD(0x001E6AC0, void, __ctor, (app::SpinLock__Boxed * this_ptr, bool enable_thread_owner_tracking));
IL2CPP_REGISTER_METHOD(0x001E6AF0, void, Enter, (app::SpinLock__Boxed * this_ptr, app::bool * lock_taken));
IL2CPP_REGISTER_METHOD(0x001E6B00, void, TryEnter, (app::SpinLock__Boxed * this_ptr, int32_t milliseconds_timeout, app::bool * lock_taken));
IL2CPP_REGISTER_METHOD(0x001E6B10, void, ContinueTryEnter, (app::SpinLock__Boxed * this_ptr, int32_t milliseconds_timeout, app::bool * lock_taken));
...
IL2CPP_REGISTER_METHOD(0x001E6B30, void, ContinueTryEnterWithThreadTracking, (app::SpinLock__Boxed * this_ptr, int32_t milliseconds_timeout, uint32_t start_time, app::bool * lock_taken));
