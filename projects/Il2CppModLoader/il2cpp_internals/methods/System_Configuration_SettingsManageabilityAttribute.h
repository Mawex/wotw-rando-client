...
namespace app::methods::System_Configuration::SettingsManageabilityAttribute {
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::SettingsManageabilityAttribute * this_ptr, app::SettingsManageability__Enum manageability));
