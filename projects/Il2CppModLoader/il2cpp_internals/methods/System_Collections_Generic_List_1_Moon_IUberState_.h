...
namespace app::methods::System_Collections_Generic::List_1_Moon_IUberState_ {
...
IL2CPP_REGISTER_METHOD(0x025EFC50, IUberState *, get_Item, (app::List_1_Moon_IUberState_ * this_ptr, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x0470EDD0, List_1_Moon_IUberState__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_1, (app::List_1_Moon_IUberState_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, IUberState__Array *, ToArray, (app::List_1_Moon_IUberState_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04773D68, List_1_Moon_IUberState__ToArray__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_2, (app::List_1_Moon_IUberState_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHODINFO(0x0478EC00, List_1_Moon_IUberState___ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_Moon_IUberState_, GetEnumerator, (app::List_1_Moon_IUberState_ * this_ptr));
