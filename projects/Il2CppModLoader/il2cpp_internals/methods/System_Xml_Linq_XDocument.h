...
namespace app::methods::System_Xml_Linq::XDocument {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_1, (app::XDocument * this_ptr));
IL2CPP_REGISTER_METHOD(0x03035470, void, __ctor_2, (app::XDocument * this_ptr, app::XDocument * other));
IL2CPP_REGISTER_METHOD(0x002FB990, XDeclaration *, get_Declaration, (app::XDocument * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9A0, void, set_Declaration, (app::XDocument * this_ptr, app::XDeclaration * value));
IL2CPP_REGISTER_METHOD(0x00AB4D20, XmlNodeType__Enum, get_NodeType, (app::XDocument * this_ptr));
IL2CPP_REGISTER_METHOD(0x03035690, XElement *, get_Root, (app::XDocument * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x03035A90, XNode *, CloneNode, (app::XDocument * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0157AB70, Object *, GetFirstNode_1, (app::XDocument * this_ptr));
IL2CPP_REGISTER_METHOD(0x0157AB70, XElement *, GetFirstNode_2, (app::XDocument * this_ptr));
