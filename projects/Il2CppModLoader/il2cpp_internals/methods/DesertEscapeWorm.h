...
IL2CPP_REGISTER_METHOD(0x00998570, SuspendableMask__Enum, get_Mask, (app::DesertEscapeWorm * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B84150, void, set_Mask, (app::DesertEscapeWorm * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x00B84200, DesertEscapeWorm_States__Enum, get_CurrentUberState, (app::DesertEscapeWorm * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B84370, SeinCharacter *, get_Sein, (app::DesertEscapeWorm * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B86C60, DesertEscapeWorm_AdditionalTimelineSet *, GetCurrentAdditionalTimelineSet, (app::DesertEscapeWorm * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B87AE0, IUberState__Array *, get_AffectingUberStates, (app::DesertEscapeWorm * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B87B70, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::DesertEscapeWorm * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B87D30, void, __ctor, (app::DesertEscapeWorm * this_ptr));
}
