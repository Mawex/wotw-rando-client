...
IL2CPP_REGISTER_METHOD(0x011A4510, SuspendableMask__Enum, get_Mask, (app::WaterFall * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011A6B10, ParticleSystem *, CreateImpactEffect, (app::WaterFall * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011A6EF0, Bounds, get_Bounds, (app::WaterFall * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417870, bool, get_AllowCacheBounds, (app::WaterFall * this_ptr));
IL2CPP_REGISTER_METHOD(0x011A7130, void, __ctor, (app::WaterFall * this_ptr));
}
