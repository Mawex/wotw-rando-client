...
IL2CPP_REGISTER_METHOD(0x0024A820, String *, ToString, (app::PhysicsScene2D__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0024AA00, RaycastHit2D, Raycast_1, (app::PhysicsScene2D__Boxed * this_ptr, app::Vector2 origin, app::Vector2 direction, float distance, int32_t layer_mask));
IL2CPP_REGISTER_METHOD(0x0024AA50, RaycastHit2D, Raycast_2, (app::PhysicsScene2D__Boxed * this_ptr, app::Vector2 origin, app::Vector2 direction, float distance, app::ContactFilter2D contact_filter));
IL2CPP_REGISTER_METHOD(0x03171D00, RaycastHit2D, Raycast_Internal, (app::PhysicsScene2D physics_scene, app::Vector2 origin, app::Vector2 direction, float distance, app::ContactFilter2D contact_filter));
