...
IL2CPP_REGISTER_METHOD(0x00F9AB50, BehaviourStatus__Enum, OnExecute, (app::BaurInteractionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0060C1C0, void, __ctor, (app::BaurInteractionBehaviour * this_ptr));
}
