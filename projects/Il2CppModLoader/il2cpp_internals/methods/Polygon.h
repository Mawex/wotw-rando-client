...
namespace app::methods::Polygon {
    ...
    IL2CPP_REGISTER_METHOD(0x00C5C100, Vector3, CalculateCenterOfMass, (app::Polygon_1 * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00C5C5C0, Vector3, ClosestPoint, (app::Polygon_1 * this_ptr, app::Vector3 reference_point));
    IL2CPP_REGISTER_METHOD(0x00C5C9F0, void, __ctor, (app::Polygon_1 * this_ptr));
} // namespace app::methods::Polygon
