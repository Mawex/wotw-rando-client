...
namespace app::methods::XGamingRuntime_Interop::AsyncHelpers {
IL2CPP_REGISTER_METHOD(0x030AFB50, XAsyncBlockPtr, WrapAsyncBlock, (app::XTaskQueueHandle queue, app::XAsyncCompletionRoutine * callback));
