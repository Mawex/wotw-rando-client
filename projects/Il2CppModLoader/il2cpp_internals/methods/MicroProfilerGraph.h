...
IL2CPP_REGISTER_METHOD(0x015A44D0, Color, GetColorForMetric, (app::Metric__Enum m));
...
IL2CPP_REGISTER_METHOD(0x015A5510, void, GetStartAndEndFrameForHighlightedTimeMarker, (app::MicroProfilerGraph * this_ptr, app::int32_t * start_index, app::int32_t * end_index));
...
IL2CPP_REGISTER_METHOD(0x015AC570, void, __ctor, (app::MicroProfilerGraph * this_ptr));
