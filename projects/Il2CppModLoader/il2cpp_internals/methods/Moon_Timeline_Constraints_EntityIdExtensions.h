...
namespace app::methods::Moon_Timeline_Constraints::EntityIdExtensions {
IL2CPP_REGISTER_METHOD(0x01BB62A0, bool, IsParentOrNothing, (app::EntityId id));
IL2CPP_REGISTER_METHOD(0x01BB62B0, IConstraint *, GetConstraint, (app::IConstrainedEntity * c_entity, app::Constraint__Enum constraint));
...
IL2CPP_REGISTER_METHOD(0x01BB6470, Constraint__Enum, GetTargetAction, (app::IConstraint * constraint));
