...
namespace app::methods::System_Collections_Generic::Dictionary_2_MoonGuid_RuntimeQuest_ {
IL2CPP_REGISTER_METHOD(0x0283B3E0, Dictionary_2_TKey_TValue_ValueCollection_MoonGuid_RuntimeQuest_ *, get_Values, (app::Dictionary_2_MoonGuid_RuntimeQuest_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BD24D0, RuntimeQuest *, get_Item, (app::Dictionary_2_MoonGuid_RuntimeQuest_ * this_ptr, app::MoonGuid * key));
...
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_MoonGuid_RuntimeQuest_ * this_ptr));
