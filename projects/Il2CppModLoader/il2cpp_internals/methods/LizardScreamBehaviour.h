...
IL2CPP_REGISTER_METHOD(0x00FB24D0, BehaviourStatus__Enum, OnExecute, (app::LizardScreamBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x00F155A0, void, __ctor, (app::LizardScreamBehaviour * this_ptr));
}
