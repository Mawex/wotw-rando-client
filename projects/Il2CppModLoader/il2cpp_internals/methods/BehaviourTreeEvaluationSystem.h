...
IL2CPP_REGISTER_METHOD(0x00998570, UpdateType__Enum, get_UpdateType, (app::BehaviourTreeEvaluationSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F9BDE0, BehaviourTreeEvaluationSystem_AllowedEvaluationSkips__Enum, CalculateAllowedSkips, (app::BehaviourTreeEvaluationSystem * this_ptr, app::Entity * entity));
...
IL2CPP_REGISTER_METHOD(0x00F9CA50, void, __ctor, (app::BehaviourTreeEvaluationSystem * this_ptr));
}
