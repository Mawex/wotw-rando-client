...
namespace app::methods::System_Net_Http_Headers::TransferCodingHeaderValue {
IL2CPP_REGISTER_METHOD(0x02D18450, void, __ctor_1, (app::TransferCodingHeaderValue * this_ptr, app::TransferCodingHeaderValue * source));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_2, (app::TransferCodingHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D18860, ICollection_1_System_Net_Http_Headers_NameValueHeaderValue_ *, get_Parameters, (app::TransferCodingHeaderValue * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D189C0, Object *, ICloneable_Clone, (app::TransferCodingHeaderValue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D18E20, String *, ToString, (app::TransferCodingHeaderValue * this_ptr));
