...
IL2CPP_REGISTER_METHOD(0x0010A980, StreamingContext, GetValueOrDefault_1, (app::Nullable_1_System_Runtime_Serialization_StreamingContext___Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00120520, void, __ctor, (app::Nullable_1_System_Runtime_Serialization_StreamingContext___Boxed * this_ptr, app::StreamingContext value));
IL2CPP_REGISTER_METHOD(0x0020F670, StreamingContext, get_Value, (app::Nullable_1_System_Runtime_Serialization_StreamingContext___Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x001F49C0, StreamingContext, GetValueOrDefault_2, (app::Nullable_1_System_Runtime_Serialization_StreamingContext___Boxed * this_ptr, app::StreamingContext default_value));
IL2CPP_REGISTER_METHOD(0x0020F8D0, String *, ToString, (app::Nullable_1_System_Runtime_Serialization_StreamingContext___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0254E8A0, Object *, Box, (app::Nullable_1_System_Runtime_Serialization_StreamingContext_ o));
IL2CPP_REGISTER_METHOD(0x0254E930, Nullable_1_System_Runtime_Serialization_StreamingContext_, Unbox, (app::Object * o));
}
