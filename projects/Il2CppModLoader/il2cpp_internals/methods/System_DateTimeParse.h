...
IL2CPP_REGISTER_METHOD(0x028ACE80, DateTime, ParseExact, (app::String * s, app::String * format, app::DateTimeFormatInfo * dtfi, app::DateTimeStyles__Enum style));
...
IL2CPP_REGISTER_METHOD(0x028AD490, DateTime, ParseExactMultiple_1, (app::String * s, app::String__Array * formats, app::DateTimeFormatInfo * dtfi, app::DateTimeStyles__Enum style));
IL2CPP_REGISTER_METHODINFO(0x04799130, DateTimeParse_ParseExactMultiple__MethodInfo);
IL2CPP_REGISTER_METHOD(0x028AD600, DateTime, ParseExactMultiple_2, (app::String * s, app::String__Array * formats, app::DateTimeFormatInfo * dtfi, app::DateTimeStyles__Enum style, app::TimeSpan * offset));
...
IL2CPP_REGISTER_METHOD(0x028AE010, bool, ParseFraction, (app::_DTString * str, app::double * result));
...
IL2CPP_REGISTER_METHOD(0x028AF840, bool, GetYearMonthDayOrder, (app::String * date_pattern, app::DateTimeFormatInfo * dtfi, app::int32_t * order));
IL2CPP_REGISTER_METHOD(0x028AFA70, bool, GetYearMonthOrder, (app::String * pattern, app::DateTimeFormatInfo * dtfi, app::int32_t * order));
IL2CPP_REGISTER_METHOD(0x028AFBC0, bool, GetMonthDayOrder, (app::String * pattern, app::DateTimeFormatInfo * dtfi, app::int32_t * order));
IL2CPP_REGISTER_METHOD(0x028AFD50, bool, TryAdjustYear, (app::DateTimeResult * result, int32_t year, app::int32_t * adjusted_year));
...
IL2CPP_REGISTER_METHOD(0x028B1BF0, bool, AdjustHour, (app::int32_t * hour, app::DateTimeParse_TM__Enum time_mark));
...
IL2CPP_REGISTER_METHOD(0x028B2F50, DateTime, Parse_1, (app::String * s, app::DateTimeFormatInfo * dtfi, app::DateTimeStyles__Enum styles));
IL2CPP_REGISTER_METHODINFO(0x0471F550, DateTimeParse_Parse__MethodInfo);
IL2CPP_REGISTER_METHOD(0x028B30A0, DateTime, Parse_2, (app::String * s, app::DateTimeFormatInfo * dtfi, app::DateTimeStyles__Enum styles, app::TimeSpan * offset));
...
IL2CPP_REGISTER_METHOD(0x028B4D70, bool, MatchHebrewDigits, (app::_DTString * str, int32_t digit_len, app::int32_t * number));
IL2CPP_REGISTER_METHODINFO(0x0473A4E8, DateTimeParse_MatchHebrewDigits__MethodInfo);
IL2CPP_REGISTER_METHOD(0x028B4EA0, bool, ParseDigits_1, (app::_DTString * str, int32_t digit_len, app::int32_t * result));
IL2CPP_REGISTER_METHOD(0x028B4F90, bool, ParseDigits_2, (app::_DTString * str, int32_t min_digit_len, int32_t max_digit_len, app::int32_t * result));
IL2CPP_REGISTER_METHOD(0x028B5040, bool, ParseFractionExact, (app::_DTString * str, int32_t max_digit_len, app::double * result));
IL2CPP_REGISTER_METHOD(0x028B51E0, bool, ParseSign, (app::_DTString * str, app::bool * result));
IL2CPP_REGISTER_METHOD(0x028B5270, bool, ParseTimeZoneOffset, (app::_DTString * str, int32_t len, app::TimeSpan * result));
IL2CPP_REGISTER_METHOD(0x028B56E0, bool, MatchAbbreviatedMonthName, (app::_DTString * str, app::DateTimeFormatInfo * dtfi, app::int32_t * result));
IL2CPP_REGISTER_METHOD(0x028B5950, bool, MatchMonthName, (app::_DTString * str, app::DateTimeFormatInfo * dtfi, app::int32_t * result));
IL2CPP_REGISTER_METHOD(0x028B5C60, bool, MatchAbbreviatedDayName, (app::_DTString * str, app::DateTimeFormatInfo * dtfi, app::int32_t * result));
IL2CPP_REGISTER_METHOD(0x028B5D60, bool, MatchDayName, (app::_DTString * str, app::DateTimeFormatInfo * dtfi, app::int32_t * result));
IL2CPP_REGISTER_METHOD(0x028B5E60, bool, MatchEraName, (app::_DTString * str, app::DateTimeFormatInfo * dtfi, app::int32_t * result));
...
IL2CPP_REGISTER_METHOD(0x028B62E0, bool, CheckNewValue, (app::int32_t * current_value, int32_t new_value, uint16_t pattern_char, app::DateTimeResult * result));
IL2CPP_REGISTER_METHOD(0x028B63C0, DateTime, GetDateTimeNow, (app::DateTimeResult * result, app::DateTimeStyles__Enum * styles));
...
IL2CPP_REGISTER_METHOD(0x028B6780, String *, ExpandPredefinedFormat, (app::String * format, app::DateTimeFormatInfo * * dtfi, app::ParsingInfo * parse_info, app::DateTimeResult * result));
...
IL2CPP_REGISTER_METHOD(0x028B7D10, bool, TryParseQuoteString, (app::String * format, int32_t pos, app::StringBuilder * result, app::int32_t * return_value));
...
IL2CPP_REGISTER_METHOD(0x028B8410, Exception *, GetDateTimeParseException, (app::DateTimeResult * result));
