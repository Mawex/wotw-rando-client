...
IL2CPP_REGISTER_METHOD(0x02405F90, String *, get_InstructionName, (app::NotInstruction * this_ptr));
IL2CPP_REGISTER_METHOD(0x02406010, Instruction *, Create, (app::Type * type));
