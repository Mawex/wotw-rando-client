...
namespace app::methods::Moon_Timeline::ColorAnimatorSystem {
...
IL2CPP_REGISTER_METHOD(0x00420EE0, UpdateType__Enum, get_UpdateType, (app::ColorAnimatorSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x00761650, void, OnUpdate, (app::ColorAnimatorSystem * this_ptr, float delta));
IL2CPP_REGISTER_METHOD(0x007618D0, ColorAnimatorSystem_RendererState *, GetStateFromPool, (app::ColorAnimatorSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00761CF0, void, __ctor, (app::ColorAnimatorSystem * this_ptr));
}
