...
namespace app::methods::Moon_uberSerializationWisp::PlayerUberStateShards_Shard {
IL2CPP_REGISTER_METHOD(0x00F41E60, void, __ctor, (app::PlayerUberStateShards_Shard * this_ptr, app::SpiritShardType__Enum type, app::Action * set_dirty_callback));
...
IL2CPP_REGISTER_METHOD(0x0052B590, SpiritShardType__Enum, get_Type, (app::PlayerUberStateShards_Shard * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00F42E50, State *, get_OnState, (app::PlayerUberStateShards_Shard * this_ptr));
IL2CPP_REGISTER_METHOD(0x00F430B0, State *, get_OffState, (app::PlayerUberStateShards_Shard * this_ptr));
