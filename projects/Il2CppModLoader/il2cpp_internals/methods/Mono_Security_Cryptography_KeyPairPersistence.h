...
namespace app::methods::Mono_Security_Cryptography::KeyPairPersistence {
IL2CPP_REGISTER_METHOD(0x025CC460, void, __ctor_1, (app::KeyPairPersistence * this_ptr, app::CspParameters * parameters));
IL2CPP_REGISTER_METHOD(0x025CC530, void, __ctor_2, (app::KeyPairPersistence * this_ptr, app::CspParameters * parameters, app::String * key_pair));
IL2CPP_REGISTER_METHODINFO(0x0471A2C8, KeyPairPersistence__ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025CC610, String *, get_Filename, (app::KeyPairPersistence * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_KeyValue, (app::KeyPairPersistence * this_ptr));
IL2CPP_REGISTER_METHOD(0x025CC7F0, void, set_KeyValue, (app::KeyPairPersistence * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x025CC800, CspParameters *, get_Parameters, (app::KeyPairPersistence * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x025CDC00, String *, get_ContainerName, (app::KeyPairPersistence * this_ptr));
IL2CPP_REGISTER_METHOD(0x025CDE30, CspParameters *, Copy, (app::KeyPairPersistence * this_ptr, app::CspParameters * p));
IL2CPP_REGISTER_METHOD(0x025CDFD0, void, FromXml, (app::KeyPairPersistence * this_ptr, app::String * xml));
IL2CPP_REGISTER_METHOD(0x025CE210, String *, ToXml, (app::KeyPairPersistence * this_ptr));
