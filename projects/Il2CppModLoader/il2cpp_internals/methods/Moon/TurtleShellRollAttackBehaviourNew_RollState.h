...
namespace app::methods::Moon::TurtleShellRollAttackBehaviourNew_RollState {
    IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::TurtleShellRollAttackBehaviourNew_RollState * this_ptr, app::TurtleShellRollAttackBehaviourNew * behaviour));
