...
namespace app::methods::System::Collections::Generic::GenericComparer_1_System_Double_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0225BDA0, void, __ctor, (app::GenericComparer_1_System_Double_ * this_ptr));
}
