...
namespace app::methods::ControlList {
    ...
    IL2CPP_REGISTER_METHOD(0x011EA780, List_1_ControlItem_*, CurrentKeyBindingsForCode, (app::ControlList * this_ptr, app::KeyCode__Enum incoming_key));
    ...
    IL2CPP_REGISTER_METHOD(0x011EC960, void, __ctor, (app::ControlList * this_ptr));
