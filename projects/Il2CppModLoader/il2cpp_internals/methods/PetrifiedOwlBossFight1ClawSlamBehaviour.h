...
IL2CPP_REGISTER_METHOD(0x017644B0, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossFight1ClawSlamBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x01765790, void, OnExit, (app::PetrifiedOwlBossFight1ClawSlamBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x017657C0, void, __ctor, (app::PetrifiedOwlBossFight1ClawSlamBehaviour * this_ptr));
}
