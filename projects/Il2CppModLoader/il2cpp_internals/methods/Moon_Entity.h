...
namespace app::methods::Moon::Entity {
    ...
    IL2CPP_REGISTER_METHOD(0x00949D10, SuspendableMask__Enum, get_Mask, (app::Entity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00A64220, EntityTask__Array*, get_Tasks, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00A64240, List_1_Moon_BehaviourSystem_ITask_*, get_ExecutingTasks, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01211660, Entity_EntityState__Enum, get_CurrentEntityState, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x006A63A0, INavigationAgent*, get_NavigationAgent, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01211670, NavigationType__Enum, get_CurrentAreaType, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x012117F0, Vector3, get_NavigationAgentPosition, (app::Entity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00A79470, SoundHost*, get_SoundHost, (app::Entity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01211A30, Vitals*, get_Vitals, (app::Entity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01211B70, Sensor*, get_Sensor, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00720040, ITask*, get_LastTask, (app::Entity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x005E0530, MoonAnimator*, get_Animator, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBD00, BehaviourTree*, get_BehaviourTree, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x006253D0, IEntityLocomotion*, get_Locomotion, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01211DC0, void, set_Locomotion, (app::Entity * this_ptr, app::IEntityLocomotion* value));
    IL2CPP_REGISTER_METHOD(0x006C8770, BaseNPC*, get_NPC, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01211DD0, void, set_NPC, (app::Entity * this_ptr, app::BaseNPC* value));
    IL2CPP_REGISTER_METHOD(0x002FBD40, DamageDealer__Array*, get_DamageDealers, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0071F210, EntityReactions*, get_Reactions, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01211DE0, bool, get_IsLimitedByArea, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::Entity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x012122E0, Vector3, get_GroundProjectedPatrolAreaPoint, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01212590, Vector3, get_GroundProjectedAllowedAreaPoint, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01212720, Vector3, get_SpawnPosition, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x004F4750, GameObject*, get_EntityGameObject, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_EntityRootPosition, (app::Entity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00A5BA50, String*, get_EntityPlaceholderPath, (app::Entity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01212D00, EntityTask*, GetTask_1, (app::Entity * this_ptr, app::Type* type));
    ...
    IL2CPP_REGISTER_METHOD(0x01213B10, Locomotion*, GetLocomotion_1, (app::Entity * this_ptr, app::Type* type));
    ...
    IL2CPP_REGISTER_METHOD(0x01214920, BehaviourTree*, GetBehaviourTree, (app::Entity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01216BC0, Locomotion*, GetActiveLocomotion, (app::Entity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FBD20, List_1_Moon_ISuspendable_*, GetHitStopAutoSuspendables, (app::Entity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00417920, RecordableParsingGroup__Enum, get_ParsingGroup, (app::Entity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0121A280, TrackingExclusions, get_TrackingExclusions, (app::Entity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0121A2E0, Vector3, get_CameraTargetPosition, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0121A610, Vector2, get_CameraTargetPadding, (app::Entity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0121A970, Vector3, get_CameraInfluencePosition, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0121A9B0, Vector2, get_CameraZoomFactor, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0043D9E0, CameraTargetType__Enum, get_TargetType, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0121A9D0, void, GetTargetData, (app::Entity * this_ptr, app::CameraTargetData** data));
    IL2CPP_REGISTER_METHOD(0x0121AAD0, void, AdjustCameraTargetWeight, (app::Entity * this_ptr, app::float* weight, app::CameraTargetData* data, app::Vector3 primary_target_position));
    IL2CPP_REGISTER_METHOD(0x0121AE50, bool, get_IsAggroed, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0121AF70, CharacterPlatformMovement*, get_PlatformMovement, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, IPortalVisitor_get_Position, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00736690, void, IPortalVisitor_set_Position, (app::Entity * this_ptr, app::Vector3 value));
    IL2CPP_REGISTER_METHOD(0x0121B050, Vector3, IPortalVisitor_get_Speed, (app::Entity * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0121BE60, void, __ctor, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x004F4750, GameObject*, IHitStopReceiver_get_gameObject, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_1, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x015F15D0, Object*, GetTask_2, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x015F1700, Object*, GetTreeBehaviour_1, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x015F1360, Object*, GetLocomotion_2, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x015F1530, Object*, GetNavigation, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x015F1360, AirEntityLocomotion*, GetLocomotion_3, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x047785E0, Entity_GetLocomotion_2__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x015F1360, GroundEntityLocomotion*, GetLocomotion_4, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x04782930, Entity_GetLocomotion_3__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x015F1360, SpikeSlugLocomotion*, GetLocomotion_5, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x0472BA60, Entity_GetLocomotion_4__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x015F1360, DropSlugLocomotion*, GetLocomotion_6, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x04782348, Entity_GetLocomotion_5__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x015F1360, Locomotion*, GetLocomotion_7, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x04789630, Entity_GetLocomotion_6__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x015F1360, FrogGroundLocomotion*, GetLocomotion_8, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x0477BCD8, Entity_GetLocomotion_7__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x015F1360, StaticEntityLocomotion*, GetLocomotion_9, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x047981F0, Entity_GetLocomotion_8__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x015F15D0, TurningBehaviour*, GetTask_3, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x047272C0, Entity_GetTask_2__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x015F1360, SandWormLocomotion*, GetLocomotion_10, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x0471D180, Entity_GetLocomotion_9__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x015F1360, VolumeEntityLocomotion*, GetLocomotion_11, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x04745D78, Entity_GetLocomotion_10__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x015F1360, SwimmingLocomotion*, GetLocomotion_12, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x0475D730, Entity_GetLocomotion_11__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x015F1360, SkeetoLocomotion*, GetLocomotion_13, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x0475DD70, Entity_GetLocomotion_12__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x015F1700, GroundPatrolBehaviourNew*, GetTreeBehaviour_2, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x0472D3F0, Entity_GetTreeBehaviour_1__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x015F1360, SpiderlingLocomotion*, GetLocomotion_14, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHODINFO(0x047648E8, Entity_GetLocomotion_13__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_2, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_3, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_4, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_5, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_6, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_7, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_8, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_9, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_10, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_11, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_12, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_13, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_14, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_15, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_16, (app::Entity * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB990, IMoonTypeResolver*, GetResolverForType_17, (app::Entity * this_ptr));
} // namespace app::methods::Moon::Entity
