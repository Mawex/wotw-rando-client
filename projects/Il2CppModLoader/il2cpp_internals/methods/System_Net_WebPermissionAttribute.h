...
namespace app::methods::System_Net::WebPermissionAttribute {
IL2CPP_REGISTER_METHOD(0x002FC6E0, void, __ctor, (app::WebPermissionAttribute * this_ptr, app::SecurityAction__Enum action));
IL2CPP_REGISTER_METHOD(0x01D7F640, String *, get_Connect, (app::WebPermissionAttribute * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D7F820, String *, get_Accept, (app::WebPermissionAttribute * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D7FA00, String *, get_ConnectPattern, (app::WebPermissionAttribute * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D7FDA0, String *, get_AcceptPattern, (app::WebPermissionAttribute * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D80140, IPermission *, CreatePermission, (app::WebPermissionAttribute * this_ptr));
}
