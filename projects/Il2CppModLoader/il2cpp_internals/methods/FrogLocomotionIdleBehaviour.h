...
IL2CPP_REGISTER_METHOD(0x00420EE0, BehaviourStatus__Enum, OnExecuteTask, (app::FrogLocomotionIdleBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0164A2A0, void, __ctor, (app::FrogLocomotionIdleBehaviour * this_ptr));
}
