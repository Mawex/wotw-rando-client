...
IL2CPP_REGISTER_METHOD(0x00611810, void, __ctor, (app::Comparison_1_SaveSlotBackupsManager_BackupParseQueue_ * this_ptr, app::Object * object, app::void * method_1));
...
IL2CPP_REGISTER_METHOD(0x02C7B830, IAsyncResult *, BeginInvoke, (app::Comparison_1_SaveSlotBackupsManager_BackupParseQueue_ * this_ptr, app::SaveSlotBackupsManager_BackupParseQueue x, app::SaveSlotBackupsManager_BackupParseQueue y, app::AsyncCallback * callback, app::Object * object));
