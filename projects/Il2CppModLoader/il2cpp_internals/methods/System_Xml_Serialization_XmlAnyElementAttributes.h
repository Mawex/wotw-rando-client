...
namespace app::methods::System_Xml_Serialization::XmlAnyElementAttributes {
IL2CPP_REGISTER_METHOD(0x01C99DB0, XmlAnyElementAttribute *, get_Item, (app::XmlAnyElementAttributes * this_ptr, int32_t index));
