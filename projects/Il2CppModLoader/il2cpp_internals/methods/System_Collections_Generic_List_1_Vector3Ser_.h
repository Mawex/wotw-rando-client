...
IL2CPP_REGISTER_METHOD(0x025EFC50, Vector3Ser *, get_Item, (List_1_Vector3Ser_ * __this, int32_t index));
IL2CPP_REGISTER_METHODINFO(0x04788C30, List_1_Vector3Ser__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (List_1_Vector3Ser_ * __this));
IL2CPP_REGISTER_METHODINFO(0x047797D8, List_1_Vector3Ser__get_Count__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (List_1_Vector3Ser_ * __this));
IL2CPP_REGISTER_METHODINFO(0x04740338, List_1_Vector3Ser___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (List_1_Vector3Ser_ * __this, Vector3Ser * item));
