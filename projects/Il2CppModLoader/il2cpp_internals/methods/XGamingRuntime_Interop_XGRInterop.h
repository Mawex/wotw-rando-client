...
namespace app::methods::XGamingRuntime_Interop::XGRInterop {
...
IL2CPP_REGISTER_METHOD(0x030B1C60, int32_t, XGameSaveEnumerateBlobInfo, (app::XGameSaveContainerHandle_1 container, app::void * context, app::XGameSaveBlobInfoCallback * callback));
IL2CPP_REGISTER_METHOD(0x030B1D20, int32_t, XGameSaveReadBlobDataAsync, (app::XGameSaveContainerHandle_1 container, app::void * blob_names, uint32_t count_of_blobs, app::XAsyncBlockPtr async_block));
IL2CPP_REGISTER_METHOD(0x030B1DE0, int32_t, XGameSaveReadBlobDataResult, (app::XAsyncBlockPtr async_block, app::SizeT blobs_size, app::void * allocated_blob_ptr, app::uint32_t * count_of_blobs));
...
IL2CPP_REGISTER_METHOD(0x030B24E0, int32_t, XUserGetId, (app::XUserHandle_1 user, app::uint64_t * user_id));
...
IL2CPP_REGISTER_METHOD(0x030B2D90, int32_t, XUserGetTokenAndSignatureUtf16Result, (app::XAsyncBlockPtr async_block, app::SizeT buffer_size, app::void * buffer, app::void * * ptr_to_buffer, app::SizeT * buffer_used));
...
IL2CPP_REGISTER_METHOD(0x030B2FC0, int32_t, XUserRegisterForChangeEvent, (app::XTaskQueueHandle queue, app::void * context, app::XUserChangeEventCallback_1 * callback, app::XTaskQueueRegistrationToken * token));
