...
IL2CPP_REGISTER_METHOD(0x00A35C40, Vector3, get_Position, (app::LegacySpiritLeashHook * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003FF3C0, SpiritLeashMode__Enum, get_LeashInteractionMode, (app::LegacySpiritLeashHook * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB40, Transform *, get_HookTargetTransform, (app::LegacySpiritLeashHook * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB40, Transform *, get_HookTransform, (app::LegacySpiritLeashHook * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A35F40, Transform *, ISpiritLeashHook_get_HookTargetTransform, (app::LegacySpiritLeashHook * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A36FB0, Vector3, get_CameraTargetPosition, (app::LegacySpiritLeashHook * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A37150, Vector2, get_CameraTargetPadding, (app::LegacySpiritLeashHook * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A37200, Vector3, get_CameraInfluencePosition, (app::LegacySpiritLeashHook * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A372E0, Vector2, get_CameraZoomFactor, (app::LegacySpiritLeashHook * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417920, CameraTargetType__Enum, get_TargetType, (app::LegacySpiritLeashHook * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A37300, void, GetTargetData, (app::LegacySpiritLeashHook * this_ptr, app::CameraTargetData * * data));
IL2CPP_REGISTER_METHOD(0x00A37560, void, AdjustCameraTargetWeight, (app::LegacySpiritLeashHook * this_ptr, app::float * weight, app::CameraTargetData * data, app::Vector3 primary_target_position));
...
IL2CPP_REGISTER_METHOD(0x002FBCE0, IDamageReciever__Array *, get_AffectedReceivers, (app::LegacySpiritLeashHook * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A37780, void, __ctor, (app::LegacySpiritLeashHook * this_ptr));
}
