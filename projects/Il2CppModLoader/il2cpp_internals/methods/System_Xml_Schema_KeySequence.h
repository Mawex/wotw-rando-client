...
namespace app::methods::System_Xml_Schema::KeySequence {
IL2CPP_REGISTER_METHOD(0x016CC620, void, __ctor, (app::KeySequence * this_ptr, int32_t dim, int32_t line, int32_t col));
...
IL2CPP_REGISTER_METHOD(0x016CC6E0, Object *, get_Item, (app::KeySequence * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x016CCF90, String *, ToString, (app::KeySequence * this_ptr));
}
