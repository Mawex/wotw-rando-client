...
namespace app::methods::SnakeSolver {
    ...
    IL2CPP_REGISTER_METHOD(0x002FBBC0, Vector2__Array*, get_Segments, (app::SnakeSolver * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x006D5D70, Vector2, RotateVector2, (app::SnakeSolver * this_ptr, app::Vector2 v, float degrees));
    IL2CPP_REGISTER_METHOD(0x006D5F60, float, Angle, (app::SnakeSolver * this_ptr, app::Vector2 v));
    IL2CPP_REGISTER_METHOD(0x006D6010, void, __ctor, (app::SnakeSolver * this_ptr));
} // namespace app::methods::SnakeSolver
