...
IL2CPP_REGISTER_METHOD(0x01825CB0, BehaviourStatus__Enum, OnExecute, (app::SwarmTargetingBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x01825F10, void, OnExit, (app::SwarmTargetingBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x01825FB0, Vector3, GetAtttackStartPositionSmart, (app::SwarmTargetingBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x018269C0, void, __ctor, (app::SwarmTargetingBehaviour * this_ptr));
}
