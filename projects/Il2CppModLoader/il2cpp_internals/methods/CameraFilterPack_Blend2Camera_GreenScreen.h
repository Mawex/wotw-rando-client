...
IL2CPP_REGISTER_METHOD(0x0274C840, Material *, get_material, (app::CameraFilterPack_Blend2Camera_GreenScreen * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0274D440, void, __ctor, (app::CameraFilterPack_Blend2Camera_GreenScreen * this_ptr));
}
