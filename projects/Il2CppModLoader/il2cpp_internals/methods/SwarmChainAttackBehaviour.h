...
IL2CPP_REGISTER_METHOD(0x01816FE0, BehaviourStatus__Enum, OnExecute, (app::SwarmChainAttackBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x018179B0, Vector3, GetAfterAttackPosition, (app::SwarmChainAttackBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01819130, void, __ctor, (app::SwarmChainAttackBehaviour * this_ptr));
}
