...
namespace app::methods::Moon_Timeline::GameplayToCinematicEntity___c {
    IL2CPP_REGISTER_METHOD(0x0076F470, void, __cctor, ());
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::GameplayToCinematicEntity_c * this_ptr));
