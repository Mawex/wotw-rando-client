...
namespace app::methods::System_Xml_Schema::SelectorActiveAxis {
IL2CPP_REGISTER_METHOD(0x01AB90E0, int32_t, get_lastDepth, (app::SelectorActiveAxis * this_ptr));
IL2CPP_REGISTER_METHOD(0x01AB9220, void, __ctor, (app::SelectorActiveAxis * this_ptr, app::Asttree * axis_tree, app::ConstraintStruct * cs));
...
IL2CPP_REGISTER_METHOD(0x01AB9B40, KeySequence *, PopKS, (app::SelectorActiveAxis * this_ptr));
}
