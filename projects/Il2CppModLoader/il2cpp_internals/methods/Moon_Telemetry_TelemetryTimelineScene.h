...
namespace app::methods::Moon_Telemetry::TelemetryTimelineScene {
IL2CPP_REGISTER_METHOD(0x010AA7F0, void, __ctor, (app::TelemetryTimelineScene * this_ptr, app::MoonTelemetrySceneEvent__Array * scene_events));
...
IL2CPP_REGISTER_METHOD(0x010AB440, Single__Array *, GetEventsLength, (app::TelemetryTimelineScene * this_ptr, app::MoonTelemetrySceneEvent__Array * scene_events));
