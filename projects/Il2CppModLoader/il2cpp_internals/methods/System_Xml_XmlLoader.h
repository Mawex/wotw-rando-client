...
IL2CPP_REGISTER_METHOD(0x01DB9E90, XmlNode *, ReadCurrentNode, (app::XmlLoader * this_ptr, app::XmlDocument * doc, app::XmlReader * reader));
IL2CPP_REGISTER_METHODINFO(0x0472B608, XmlLoader_ReadCurrentNode__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01DBA060, XmlNode *, LoadNode, (app::XmlLoader * this_ptr, bool skip_over_whitespace));
IL2CPP_REGISTER_METHODINFO(0x04726C88, XmlLoader_LoadNode__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01DBA7A0, XmlAttribute *, LoadAttributeNode, (app::XmlLoader * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04754C28, XmlLoader_LoadAttributeNode__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01DBAB60, XmlAttribute *, LoadDefaultAttribute, (app::XmlLoader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01DBB310, XmlEntityReference *, LoadEntityReferenceNode, (app::XmlLoader * this_ptr, bool direct));
IL2CPP_REGISTER_METHOD(0x01DBB660, XmlDeclaration *, LoadDeclarationNode, (app::XmlLoader * this_ptr));
IL2CPP_REGISTER_METHOD(0x01DBB980, XmlDocumentType *, LoadDocumentTypeNode, (app::XmlLoader * this_ptr));
IL2CPP_REGISTER_METHOD(0x01DBBCB0, XmlNode *, LoadNodeDirect, (app::XmlLoader * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0470C0B8, XmlLoader_LoadNodeDirect__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01DBC750, XmlAttribute *, LoadAttributeNodeDirect, (app::XmlLoader * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01DBE010, XmlParserContext *, GetContext, (app::XmlLoader * this_ptr, app::XmlNode * node));
IL2CPP_REGISTER_METHOD(0x01DBEB80, XmlNamespaceManager *, ParsePartialContent, (app::XmlLoader * this_ptr, app::XmlNode * parent_node, app::String * innerxmltext, app::XmlNodeType__Enum nt));
...
IL2CPP_REGISTER_METHOD(0x01DBF320, String *, EntitizeName, (app::XmlLoader * this_ptr, app::String * name));
...
IL2CPP_REGISTER_METHOD(0x01DBFBF0, XmlReader *, CreateInnerXmlReader, (app::XmlLoader * this_ptr, app::String * xml_fragment, app::XmlNodeType__Enum nt, app::XmlParserContext * context, app::XmlDocument * doc));
...
IL2CPP_REGISTER_METHOD(0x01DC0280, Exception *, UnexpectedNodeType, (app::XmlNodeType__Enum nodetype));
}
