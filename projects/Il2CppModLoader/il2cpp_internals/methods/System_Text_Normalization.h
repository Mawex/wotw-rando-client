...
namespace app::methods::System_Text::Normalization {
...
IL2CPP_REGISTER_METHOD(0x0245A900, String *, Compose, (app::String * source, int32_t check_type));
IL2CPP_REGISTER_METHOD(0x0245AA60, StringBuilder *, Combine_1, (app::String * source, int32_t start, int32_t check_type));
...
IL2CPP_REGISTER_METHOD(0x0245B640, String *, Decompose_1, (app::String * source, int32_t check_type));
...
IL2CPP_REGISTER_METHOD(0x0245BCA0, void, DecomposeChar, (app::StringBuilder * * sb, app::Int32__Array * * buf, app::String * s, int32_t i, int32_t check_type, app::int32_t * start));
...
IL2CPP_REGISTER_METHOD(0x0245C810, String *, Normalize_1, (app::String * source, app::NormalizationForm__Enum normalization_form));
IL2CPP_REGISTER_METHOD(0x0245C950, String *, Normalize_2, (app::String * source, int32_t type));
