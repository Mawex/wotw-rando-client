...
IL2CPP_REGISTER_METHOD(0x005D8D30, IEnumerator *, Perform_2, (app::SeinRunToTargetAction * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D8E80, void, Exit, (app::SeinRunToTargetAction * this_ptr));
IL2CPP_REGISTER_METHOD(0x005D8F90, void, __ctor, (app::SeinRunToTargetAction * this_ptr));
}
