...
IL2CPP_REGISTER_METHOD(0x00639D70, String *, get_InteractionName, (app::InteractionRotationModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x00639E10, UberInteractionManager_PropertyIDCache *, get_PropertyCache, (app::InteractionRotationModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x00639EF0, IEnumerable_1_System_String_ *, GetKeywordsForShader, (app::InteractionRotationModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0063A9F0, Vector2, Rotate, (app::Vector2 v, float degrees));
...
IL2CPP_REGISTER_METHOD(0x0063B010, void, __ctor, (app::InteractionRotationModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x0063B380, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x006389E0, IEnumerable_1_System_String_ *, __n__0, (app::InteractionRotationModifier * this_ptr));
}
