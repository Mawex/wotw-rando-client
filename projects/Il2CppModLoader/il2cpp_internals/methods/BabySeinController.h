...
IL2CPP_REGISTER_METHOD(0x00861930, Vector3, get_Position, (app::BabySeinController * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006410F0, SuspendableMask__Enum, get_Mask, (app::BabySeinController * this_ptr));
