...
IL2CPP_REGISTER_METHOD(0x00A0FE00, IEnumerable_1_System_String_ *, GetKeywordsForShader, (app::MaskDissolveModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A10250, void, __ctor, (app::MaskDissolveModifier * this_ptr));
}
