...
namespace app::methods::usedStandaloneScripts_DeltaTimeManagers::AverageBothDeltaTimeController {
...
IL2CPP_REGISTER_METHOD(0x00F76B50, void, __ctor, (app::AverageBothDeltaTimeController * this_ptr));
