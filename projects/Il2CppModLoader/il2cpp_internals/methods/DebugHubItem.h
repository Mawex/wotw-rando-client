...
namespace app::methods::DebugHubItem {
    IL2CPP_REGISTER_METHOD(0x002FA280, String*, get_Name, (app::DebugHubItem * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FA490, void, set_Name, (app::DebugHubItem * this_ptr, app::String* value));
    IL2CPP_REGISTER_METHOD(0x00529FF0, Input_Button__Enum, get_ButtonBinding, (app::DebugHubItem * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FB950, Action*, get_ToggleAction, (app::DebugHubItem * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FB960, void, set_ToggleAction, (app::DebugHubItem * this_ptr, app::Action* value));
    IL2CPP_REGISTER_METHOD(0x002FBB00, Func_1_Boolean_*, get_IsActiveFunc, (app::DebugHubItem * this_ptr));
    IL2CPP_REGISTER_METHOD(0x002FBB10, void, set_IsActiveFunc, (app::DebugHubItem * this_ptr, app::Func_1_Boolean_* value));
    IL2CPP_REGISTER_METHOD(0x00DED630, DebugHubItem_DebugHubItemLayout, get_Layout, (app::DebugHubItem * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::DebugHubItem * this_ptr));
} // namespace app::methods::DebugHubItem
