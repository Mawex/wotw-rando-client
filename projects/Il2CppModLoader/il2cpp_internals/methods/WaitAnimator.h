...
namespace app::methods::WaitAnimator {
    IL2CPP_REGISTER_METHOD(0x00420EE0, Func_2_IContext_Boolean_*, get_CodeCondition, (app::WaitAnimator * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x008C58F0, BaseAnimator*, GetRootAnimator, (app::WaitAnimator * this_ptr, app::BaseAnimator* base_animator));
    ...
    IL2CPP_REGISTER_METHOD(0x008C5A70, void, __ctor, (app::WaitAnimator * this_ptr));
} // namespace app::methods::WaitAnimator
