...
namespace app::methods::Moon_BehaviourSystem::ActionDecorator {
IL2CPP_REGISTER_METHOD(0x03002050, String *, get_Info, (app::ActionDecorator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBD00, List_1_Moon_BehaviourSystem_Action_ *, get_Actions, (app::ActionDecorator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x030027F0, BehaviourStatus__Enum, OnExecute, (app::ActionDecorator * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x03002A10, void, PerformSanityCheck, (app::ActionDecorator * this_ptr));
IL2CPP_REGISTER_METHOD(0x03002CD0, void, __ctor, (app::ActionDecorator * this_ptr));
}
