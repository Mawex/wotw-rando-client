...
namespace app::methods::System_ComponentModel::EnumConverter {
IL2CPP_REGISTER_METHOD(0x01FE8140, void, __ctor, (app::EnumConverter * this_ptr, app::Type * type));
IL2CPP_REGISTER_METHOD(0x002FB930, Type *, get_EnumType, (app::EnumConverter * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA280, TypeConverter_StandardValuesCollection *, get_Values, (app::EnumConverter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01FE8410, IComparer *, get_Comparer, (app::EnumConverter * this_ptr));
IL2CPP_REGISTER_METHOD(0x01FE84B0, Object *, ConvertFrom, (app::EnumConverter * this_ptr, app::ITypeDescriptorContext * context, app::CultureInfo * culture, app::Object * value));
IL2CPP_REGISTER_METHODINFO(0x04703288, EnumConverter_ConvertFrom__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01FE8930, Object *, ConvertTo, (app::EnumConverter * this_ptr, app::ITypeDescriptorContext * context, app::CultureInfo * culture, app::Object * value, app::Type * destination_type));
IL2CPP_REGISTER_METHODINFO(0x047159E0, EnumConverter_ConvertTo__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01FE9730, TypeConverter_StandardValuesCollection *, GetStandardValues, (app::EnumConverter * this_ptr, app::ITypeDescriptorContext * context));
