...
namespace app::methods::System_Net::CookieCollection_CookieCollectionEnumerator {
IL2CPP_REGISTER_METHOD(0x01EA2210, void, __ctor, (app::CookieCollection_CookieCollectionEnumerator * this_ptr, app::CookieCollection * cookies));
IL2CPP_REGISTER_METHOD(0x01EA2270, Object *, IEnumerator_get_Current, (app::CookieCollection_CookieCollectionEnumerator * this_ptr));
