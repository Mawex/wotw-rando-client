...
IL2CPP_REGISTER_METHOD(0x00C09AF0, BehaviourStatus__Enum, OnExecute, (app::SandWormChaseBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00C0A760, BehaviourStatus__Enum, OnSandChaseUpdate, (app::SandWormChaseBehaviour * this_ptr, float d_time));
...
IL2CPP_REGISTER_METHOD(0x00C0AFF0, BehaviourStatus__Enum, OnPreJumpUpdate, (app::SandWormChaseBehaviour * this_ptr, float d_time));
...
IL2CPP_REGISTER_METHOD(0x00C0AFF0, BehaviourStatus__Enum, OnJumpingUpdate, (app::SandWormChaseBehaviour * this_ptr, float d_time));
...
IL2CPP_REGISTER_METHOD(0x0043D9A0, SelectableCategory__Enum, get_Category, (app::SandWormChaseBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C0BB40, void, __ctor, (app::SandWormChaseBehaviour * this_ptr));
}
