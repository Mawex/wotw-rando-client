...
namespace app::methods::System_Collections_Generic::Queue_1_MoonTelemetry_MaelstromEvent_ {
...
IL2CPP_REGISTER_METHOD(0x02CA77B0, MoonTelemetry_MaelstromEvent *, Dequeue, (app::Queue_1_MoonTelemetry_MaelstromEvent_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CA7860, MoonTelemetry_MaelstromEvent *, Peek, (app::Queue_1_MoonTelemetry_MaelstromEvent_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0473CD80, Queue_1_MoonTelemetry_MaelstromEvent__Peek__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02CA7080, void, __ctor, (app::Queue_1_MoonTelemetry_MaelstromEvent_ * this_ptr, int32_t capacity));
