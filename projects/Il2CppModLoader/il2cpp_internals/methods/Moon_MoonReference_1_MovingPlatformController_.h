...
IL2CPP_REGISTER_METHOD(0x02720AC0, MovingPlatformController *, Resolve, (app::MoonReference_1_MovingPlatformController_ * this_ptr, app::IMoonResolverContext * context));
