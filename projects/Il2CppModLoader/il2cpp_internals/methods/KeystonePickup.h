...
IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_AreaCompletorPosition, (app::KeystonePickup * this_ptr));
IL2CPP_REGISTER_METHOD(0x005AC260, void, __ctor, (app::KeystonePickup * this_ptr));
