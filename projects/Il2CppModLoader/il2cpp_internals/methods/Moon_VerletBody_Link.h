...
IL2CPP_REGISTER_METHOD(0x002FA280, VerletBody_Point *, get_Point0, (app::VerletBody_Link * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, VerletBody_Point *, get_Point1, (app::VerletBody_Link * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x021267A0, Vector3, get_Direction, (app::VerletBody_Link * this_ptr));
IL2CPP_REGISTER_METHOD(0x02126940, void, __ctor, (app::VerletBody_Link * this_ptr, app::VerletBody_Point * p0, app::VerletBody_Point * p1, float rest_distance, float stiffness));
