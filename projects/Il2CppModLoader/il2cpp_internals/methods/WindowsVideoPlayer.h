...
IL2CPP_REGISTER_METHOD(0x002FBC00, OnDelegate *, get_OnPlaybackFinished, (app::WindowsVideoPlayer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0057BBE0, void, __ctor, (app::WindowsVideoPlayer * this_ptr));
}
