...
namespace app::methods::System_Net::UploadProgressChangedEventArgs {
    IL2CPP_REGISTER_METHOD(0x020ACF70, void, __ctor_1, (app::UploadProgressChangedEventArgs * this_ptr, int32_t progress_percentage, app::Object * user_token, int64_t bytes_sent, int64_t total_bytes_to_send, int64_t bytes_received, int64_t total_bytes_to_receive));
    ...
    IL2CPP_REGISTER_METHOD(0x020ACFC0, void, __ctor_2, (app::UploadProgressChangedEventArgs * this_ptr));
