...
namespace app::methods::System_Security_Cryptography::RC2CryptoServiceProvider {
IL2CPP_REGISTER_METHOD(0x028DE660, void, __ctor, (app::RC2CryptoServiceProvider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x028DE8F0, ICryptoTransform *, CreateEncryptor, (app::RC2CryptoServiceProvider * this_ptr, app::Byte__Array * rgb_key, app::Byte__Array * rgb_i_v));
IL2CPP_REGISTER_METHODINFO(0x04753578, RC2CryptoServiceProvider_CreateEncryptor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x028DEAA0, ICryptoTransform *, CreateDecryptor, (app::RC2CryptoServiceProvider * this_ptr, app::Byte__Array * rgb_key, app::Byte__Array * rgb_i_v));
