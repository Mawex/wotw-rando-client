...
IL2CPP_REGISTER_METHOD(0x011BB230, BehaviourStatus__Enum, OnExecute, (app::SpiderBossTimelineBehaviourBase * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x011BB390, void, OnExit, (app::SpiderBossTimelineBehaviourBase * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x011B1480, void, __ctor, (app::SpiderBossTimelineBehaviourBase * this_ptr));
}
