...
namespace app::methods::System_Collections_Generic::Stack_1_UnityEngine_Vector3_ {
IL2CPP_REGISTER_METHOD(0x0243CB70, void, __ctor_1, (app::Stack_1_UnityEngine_Vector3_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CFA230, Vector3__Array *, ToArray, (app::Stack_1_UnityEngine_Vector3_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04771F20, Stack_1_UnityEngine_Vector3__ToArray__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02CFA0C0, Vector3, Pop, (app::Stack_1_UnityEngine_Vector3_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047129F0, Stack_1_UnityEngine_Vector3__Pop__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02CF99E0, void, __ctor_2, (app::Stack_1_UnityEngine_Vector3_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x02CF9B10, Object *, ICollection_get_SyncRoot, (app::Stack_1_UnityEngine_Vector3_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02CF9F70, Stack_1_T_Enumerator_UnityEngine_Vector3_, GetEnumerator, (app::Stack_1_UnityEngine_Vector3_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CF9FB0, IEnumerator_1_UnityEngine_Vector3_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::Stack_1_UnityEngine_Vector3_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CF9FB0, IEnumerator *, IEnumerable_GetEnumerator, (app::Stack_1_UnityEngine_Vector3_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02CFA040, Vector3, Peek, (app::Stack_1_UnityEngine_Vector3_ * this_ptr));
