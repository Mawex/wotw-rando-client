...
IL2CPP_REGISTER_METHOD(0x01521270, Vector3, get_Position, (app::AttackableIteratorUnitTester_TestAttackable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB930, IDamageReciever__Array *, get_AffectedReceivers, (app::AttackableIteratorUnitTester_TestAttackable * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::AttackableIteratorUnitTester_TestAttackable * this_ptr));
}
