...
IL2CPP_REGISTER_METHOD(0x00417920, MenuTabBackground__Enum, get_BackgroundMode, (app::EquipmentWheel * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0097B040, PlayerUberStateInventory_InventoryItem *, get_SelectedSpell, (app::EquipmentWheel * this_ptr));
IL2CPP_REGISTER_METHOD(0x0097B110, SpellUIItem *, get_SelectedSpellUIItem, (app::EquipmentWheel * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0097F8D0, PlayerUberStateInventory_InventoryItem *, GetActualInventoryItem, (app::EquipmentType__Enum typ));
...
IL2CPP_REGISTER_METHOD(0x003FFB70, SuspendableMask__Enum, get_Mask, (app::EquipmentWheel * this_ptr));
IL2CPP_REGISTER_METHOD(0x00980130, void, set_Mask, (app::EquipmentWheel * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x009801F0, HashSet_1_Moon_ISuspendable_ *, get_CachedSuspendables, (app::EquipmentWheel * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00980950, void, __ctor, (app::EquipmentWheel * this_ptr));
