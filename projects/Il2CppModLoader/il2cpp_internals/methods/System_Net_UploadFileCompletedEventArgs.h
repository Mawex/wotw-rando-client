...
namespace app::methods::System_Net::UploadFileCompletedEventArgs {
...
IL2CPP_REGISTER_METHOD(0x01BCB280, Byte__Array *, get_Result, (app::UploadFileCompletedEventArgs * this_ptr));
