...
IL2CPP_REGISTER_METHOD(0x024E4580, Material *, get_material, (app::CameraFilterPack_Distortion_BigFace * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024E4E30, void, __ctor, (app::CameraFilterPack_Distortion_BigFace * this_ptr));
}
