...
namespace app::methods::System_Security_Cryptography::RSAPKCS1SignatureDeformatter {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_1, (app::RSAPKCS1SignatureDeformatter * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F76900, void, __ctor_2, (app::RSAPKCS1SignatureDeformatter * this_ptr, app::AsymmetricAlgorithm * key));
