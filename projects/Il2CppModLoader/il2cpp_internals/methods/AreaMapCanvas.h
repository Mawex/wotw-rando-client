...
namespace app::methods::AreaMapCanvas {
    ...
    IL2CPP_REGISTER_METHOD(0x00509DD0, Texture*, get_WorldMapTexture, (app::AreaMapCanvas * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00509DF0, Bounds, get_Bounds, (app::AreaMapCanvas * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00509E30, CageStructureTool*, get_CageStructureTool, (app::AreaMapCanvas * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00509E50, Vector2, get_WorldMapTextureSize, (app::AreaMapCanvas * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00509EE0, Color, GetColor, (app::AreaMapCanvas * this_ptr, app::WorldMapAreaState__Enum world_state));
    ...
    IL2CPP_REGISTER_METHOD(0x0050B260, void, __ctor, (app::AreaMapCanvas * this_ptr));
} // namespace app::methods::AreaMapCanvas
