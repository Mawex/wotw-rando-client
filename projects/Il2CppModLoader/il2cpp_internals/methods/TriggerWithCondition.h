...
IL2CPP_REGISTER_METHOD(0x0057AAC0, SuspendableMask__Enum, get_Mask, (app::TriggerWithCondition * this_ptr));
IL2CPP_REGISTER_METHOD(0x00B14570, void, set_Mask, (app::TriggerWithCondition * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x0057AB80, void, __ctor, (app::TriggerWithCondition * this_ptr));
}
