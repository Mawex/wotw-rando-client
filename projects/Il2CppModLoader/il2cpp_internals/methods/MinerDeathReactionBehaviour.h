...
IL2CPP_REGISTER_METHOD(0x01448030, BehaviourStatus__Enum, OnExecuteTask, (app::MinerDeathReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01448630, void, __ctor, (app::MinerDeathReactionBehaviour * this_ptr));
