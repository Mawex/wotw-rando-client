...
namespace app::methods::System_Diagnostics_Tracing::InvokeTypeInfo_1_System_Char_ {
...
IL2CPP_REGISTER_METHOD(0x02B98F50, void, WriteData, (app::InvokeTypeInfo_1_System_Char_ * this_ptr, app::TraceLoggingDataCollector * collector, app::uint16_t * value));
IL2CPP_REGISTER_METHOD(0x02B99AF0, Object *, GetData, (app::InvokeTypeInfo_1_System_Char_ * this_ptr, app::Object * value));
