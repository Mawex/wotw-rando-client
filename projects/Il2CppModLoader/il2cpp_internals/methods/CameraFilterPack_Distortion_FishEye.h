...
IL2CPP_REGISTER_METHOD(0x024E71F0, Material *, get_material, (app::CameraFilterPack_Distortion_FishEye * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024E7AE0, void, __ctor, (app::CameraFilterPack_Distortion_FishEye * this_ptr));
