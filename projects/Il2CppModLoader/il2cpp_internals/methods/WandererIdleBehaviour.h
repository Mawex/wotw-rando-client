...
IL2CPP_REGISTER_METHOD(0x008C8400, BehaviourStatus__Enum, OnExecuteTask, (app::WandererIdleBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x005B3EC0, void, __ctor, (app::WandererIdleBehaviour * this_ptr));
}
