...
namespace app::methods::UnityEngine_EventSystems::StandaloneInputModule {
IL2CPP_REGISTER_METHOD(0x01F26E70, void, __ctor, (app::StandaloneInputModule * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F1B660, StandaloneInputModule_InputMode__Enum, get_inputMode, (app::StandaloneInputModule * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BA66F0, String *, get_horizontalAxis, (app::StandaloneInputModule * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC90, void, set_horizontalAxis, (app::StandaloneInputModule * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x01F26F80, String *, get_verticalAxis, (app::StandaloneInputModule * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCB0, void, set_verticalAxis, (app::StandaloneInputModule * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x01F26F90, String *, get_submitButton, (app::StandaloneInputModule * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBCD0, void, set_submitButton, (app::StandaloneInputModule * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x01F26FA0, String *, get_cancelButton, (app::StandaloneInputModule * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F28350, Vector2, GetRawMoveVector, (app::StandaloneInputModule * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F294F0, GameObject *, GetCurrentFocusedGameObject, (app::StandaloneInputModule * this_ptr));
}
