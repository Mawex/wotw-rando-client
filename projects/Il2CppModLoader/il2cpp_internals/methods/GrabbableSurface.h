...
IL2CPP_REGISTER_METHOD(0x002FBBE0, Transform *, get_HookTargetTransform, (app::GrabbableSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x00623260, float, get_PositionOffset, (app::GrabbableSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x00417920, SpiritLeashMode__Enum, get_LeashInteractionMode, (app::GrabbableSurface * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0107BEA0, Vector3, get_FrontSegmentPoint, (app::GrabbableSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x0107BED0, Vector3, get_FrontSegmentNormal, (app::GrabbableSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x0107BF00, Vector3, get_FrontSegmentDirection, (app::GrabbableSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x0107BF30, Vector3, get_BackSegmentPoint, (app::GrabbableSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x0107BF60, Vector3, get_BackSegmentNormal, (app::GrabbableSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x0107BF90, Vector3, get_BackSegmentDirection, (app::GrabbableSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x0107BFC0, Vector3, get_CurrentSegmentPoint, (app::GrabbableSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x0107BFF0, Vector3, get_CurrentSegmentNormal, (app::GrabbableSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x0107C020, Vector3, get_CurrentSegmentNormalSmooth, (app::GrabbableSurface * this_ptr));
IL2CPP_REGISTER_METHOD(0x0107CFE0, Vector3, get_CurrentSegmentDirection, (app::GrabbableSurface * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0107D280, Vector2, GetVelocityAtPoint, (app::GrabbableSurface * this_ptr, app::Vector2 point));
...
IL2CPP_REGISTER_METHOD(0x0107FC60, Vector3, AdvancePosition_1, (app::GrabbableSurface * this_ptr, float move_distance));
IL2CPP_REGISTER_METHOD(0x0107FE60, Vector3, AdvancePosition_2, (app::GrabbableSurface * this_ptr, float move_distance, app::GrabbableSurface_PositionInfo * position_info));
...
IL2CPP_REGISTER_METHOD(0x010810E0, void, __ctor, (app::GrabbableSurface * this_ptr));
