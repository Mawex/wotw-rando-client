...
namespace app::methods::Moon_Driver::UpdateManager_ExplicitEntry {
IL2CPP_REGISTER_METHOD(0x002FBB80, IUpdateHandlerBase *, get_Handler, (app::UpdateManager_ExplicitEntry * this_ptr));
