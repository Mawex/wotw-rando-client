...
namespace app::methods::System_Collections_Generic::EqualityComparer_1_IntStateMap_Mapping_ {
IL2CPP_REGISTER_METHOD(0x02807CD0, EqualityComparer_1_IntStateMap_Mapping_ *, get_Default, ());
IL2CPP_REGISTER_METHOD(0x02CD3A80, EqualityComparer_1_IntStateMap_Mapping_ *, CreateComparer, ());
...
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::EqualityComparer_1_IntStateMap_Mapping_ * this_ptr));
}
