...
IL2CPP_REGISTER_METHOD(0x0013D2C0, void, __ctor, (app::Vector3Int__Boxed * this_ptr, int32_t x, int32_t y, int32_t z));
...
IL2CPP_REGISTER_METHOD(0x02C77F50, Vector3Int, operator__, (app::Vector3Int a, app::Vector3Int b));
IL2CPP_REGISTER_METHOD(0x02C77F90, bool, operator___, (app::Vector3Int lhs, app::Vector3Int rhs));
...
IL2CPP_REGISTER_METHOD(0x00229840, String *, ToString, (app::Vector3Int__Boxed * this_ptr));
