...
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Name, (app::ScalableAnimationPlayer_Event * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::ScalableAnimationPlayer_Event * this_ptr));
}
