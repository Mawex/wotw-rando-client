...
IL2CPP_REGISTER_METHOD(0x00D1F560, TurningAnimation *, get_CurrentTurningAnimation, (app::TurningBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D1FBD0, BehaviourStatus__Enum, OnExecuteTask, (app::TurningBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00D201A0, void, __ctor, (app::TurningBehaviour * this_ptr));
}
