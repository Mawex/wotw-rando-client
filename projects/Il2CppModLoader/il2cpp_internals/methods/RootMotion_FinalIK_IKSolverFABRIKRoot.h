...
namespace app::methods::RootMotion_FinalIK::IKSolverFABRIKRoot {
...
IL2CPP_REGISTER_METHOD(0x02BF1B30, IKSolver_Point__Array *, GetPoints, (app::IKSolverFABRIKRoot * this_ptr));
IL2CPP_REGISTER_METHOD(0x02BF1C30, IKSolver_Point *, GetPoint, (app::IKSolverFABRIKRoot * this_ptr, app::Transform * transform));
...
IL2CPP_REGISTER_METHOD(0x02BF1ED0, Vector3, GetCentroid, (app::IKSolverFABRIKRoot * this_ptr));
IL2CPP_REGISTER_METHOD(0x02BF24D0, void, __ctor, (app::IKSolverFABRIKRoot * this_ptr));
}
