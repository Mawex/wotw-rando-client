...
namespace app::methods::System_Net::WebProxy {
IL2CPP_REGISTER_METHOD(0x01D805A0, void, __ctor_1, (app::WebProxy * this_ptr));
IL2CPP_REGISTER_METHOD(0x01D80630, void, __ctor_2, (app::WebProxy * this_ptr, app::Uri * address));
IL2CPP_REGISTER_METHOD(0x01D806D0, void, __ctor_3, (app::WebProxy * this_ptr, app::Uri * address, bool bypass_on_local));
IL2CPP_REGISTER_METHOD(0x01D80780, void, __ctor_4, (app::WebProxy * this_ptr, app::Uri * address, bool bypass_on_local, app::String__Array * bypass_list));
IL2CPP_REGISTER_METHOD(0x01D807A0, void, __ctor_5, (app::WebProxy * this_ptr, app::Uri * address, bool bypass_on_local, app::String__Array * bypass_list, app::ICredentials * credentials));
IL2CPP_REGISTER_METHOD(0x01D80920, void, __ctor_6, (app::WebProxy * this_ptr, app::String * host, int32_t port));
IL2CPP_REGISTER_METHOD(0x01D80B40, void, __ctor_7, (app::WebProxy * this_ptr, app::String * address));
IL2CPP_REGISTER_METHOD(0x01D80BF0, void, __ctor_8, (app::WebProxy * this_ptr, app::String * address, bool bypass_on_local));
IL2CPP_REGISTER_METHOD(0x01D80CB0, void, __ctor_9, (app::WebProxy * this_ptr, app::String * address, bool bypass_on_local, app::String__Array * bypass_list));
IL2CPP_REGISTER_METHOD(0x01D80D10, void, __ctor_10, (app::WebProxy * this_ptr, app::String * address, bool bypass_on_local, app::String__Array * bypass_list, app::ICredentials * credentials));
IL2CPP_REGISTER_METHOD(0x002FB930, Uri *, get_Address, (app::WebProxy * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D81060, String__Array *, get_BypassList, (app::WebProxy * this_ptr));
IL2CPP_REGISTER_METHOD(0x01D81240, void, set_BypassList, (app::WebProxy * this_ptr, app::String__Array * value));
IL2CPP_REGISTER_METHOD(0x002FBB00, ICredentials *, get_Credentials, (app::WebProxy * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D814B0, ArrayList *, get_BypassArrayList, (app::WebProxy * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8E90, void, CheckForChanges, (app::WebProxy * this_ptr));
IL2CPP_REGISTER_METHOD(0x01D81610, Uri *, GetProxy, (app::WebProxy * this_ptr, app::Uri * destination));
IL2CPP_REGISTER_METHODINFO(0x04710730, WebProxy_GetProxy__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01D817D0, Uri *, CreateProxyUri, (app::String * address));
...
IL2CPP_REGISTER_METHOD(0x01D82880, void, __ctor_11, (app::WebProxy * this_ptr, app::SerializationInfo * serialization_info, app::StreamingContext streaming_context));
...
IL2CPP_REGISTER_METHOD(0x002FB9D0, AutoWebProxyScriptEngine *, get_ScriptEngine, (app::WebProxy * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D82DC0, void, __ctor_12, (app::WebProxy * this_ptr, bool enable_autoproxy));
...
IL2CPP_REGISTER_METHOD(0x01D82F30, ProxyChain *, IAutoWebProxy_GetProxies, (app::WebProxy * this_ptr, app::Uri * destination));
...
IL2CPP_REGISTER_METHOD(0x01D83170, bool, IsBypassedAuto, (app::WebProxy * this_ptr, app::Uri * destination, app::bool * is_bypassed));
IL2CPP_REGISTER_METHOD(0x01D831F0, Uri__Array *, GetProxiesAuto, (app::WebProxy * this_ptr, app::Uri * destination, app::int32_t * sync_status));
IL2CPP_REGISTER_METHOD(0x003F8E90, void, AbortGetProxiesAuto, (app::WebProxy * this_ptr, app::int32_t * sync_status));
IL2CPP_REGISTER_METHOD(0x01D83260, Uri *, GetProxyAutoFailover, (app::WebProxy * this_ptr, app::Uri * destination));
IL2CPP_REGISTER_METHOD(0x01D833A0, bool, AreAllBypassed, (app::IEnumerable_1_System_String_ * proxies, bool check_first_only));
IL2CPP_REGISTER_METHOD(0x01D83540, Uri *, ProxyUri, (app::String * proxy_name));
}
