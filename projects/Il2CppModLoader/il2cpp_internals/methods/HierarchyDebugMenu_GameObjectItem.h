...
IL2CPP_REGISTER_METHOD(0x00B52660, void, __ctor, (app::HierarchyDebugMenu_GameObjectItem * this_ptr, app::GameObject * go));
...
IL2CPP_REGISTER_METHOD(0x002FC6D0, HierarchyDebugMenu_CompareType__Enum, get_CurrentSortType, (app::HierarchyDebugMenu_GameObjectItem * this_ptr));
