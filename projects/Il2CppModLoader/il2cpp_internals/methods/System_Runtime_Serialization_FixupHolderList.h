...
namespace app::methods::System_Runtime_Serialization::FixupHolderList {
IL2CPP_REGISTER_METHOD(0x01D87CC0, void, __ctor_1, (app::FixupHolderList * this_ptr));
IL2CPP_REGISTER_METHOD(0x01D87D60, void, __ctor_2, (app::FixupHolderList * this_ptr, int32_t starting_size));
