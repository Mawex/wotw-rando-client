...
namespace app::methods::SaveSlotsUI {
    IL2CPP_REGISTER_METHOD(0x0092B260, SaveSlotUI*, get_CurrentSaveSlot, (app::SaveSlotsUI * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0092B330, List_1_SaveSlotUI_*, get_Items, (app::SaveSlotsUI * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0092BBB0, SaveSlotUI*, get_SaveSlotUnderCursor, (app::SaveSlotsUI * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0091D5A0, SuspendableMask__Enum, get_Mask, (app::SaveSlotsUI * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00720150, String__Array*, GetAllConditionNames, (app::SaveSlotsUI * this_ptr));
    IL2CPP_REGISTER_METHOD(0x006D64E0, Int32__Array*, GetAllConditionGuids, (app::SaveSlotsUI * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00931470, String*, GetConditionNameFromGuid, (app::SaveSlotsUI * this_ptr, int32_t guid));
    ...
    IL2CPP_REGISTER_METHOD(0x009314F0, void, __ctor, (app::SaveSlotsUI * this_ptr));
} // namespace app::methods::SaveSlotsUI
