...
namespace app::methods::Moon_HierarchyPerformanceTest::BaselinePerfAnalyzer {
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::BaselinePerfAnalyzer * this_ptr));
}
