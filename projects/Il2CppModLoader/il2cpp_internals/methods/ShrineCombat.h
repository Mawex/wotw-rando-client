...
namespace app::methods::ShrineCombat {
    ...
    IL2CPP_REGISTER_METHOD(0x005065F0, SuspendableMask__Enum, get_Mask, (app::ShrineCombat * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00739F30, Input_InputButtonProcessor*, get_Button, (app::ShrineCombat * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0073A220, Vector3, get_SeinPosition, (app::ShrineCombat * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0073A290, SeinCharacter*, get_Sein, (app::ShrineCombat * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0073BFA0, IUberState__Array*, get_AffectingUberStates, (app::ShrineCombat * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0073C040, List_1_UnityEngine_GameObject_*, get_AllTargets, (app::ShrineCombat * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0073C200, String__Array*, GetAllConditionNames, (app::ShrineCombat * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0073C2B0, void, EnsureMapExists, (app::ShrineCombat * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0073C460, Int32__Array*, GetAllConditionGuids, (app::ShrineCombat * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0073C510, String*, GetConditionNameFromGuid, (app::ShrineCombat * this_ptr, int32_t guid));
    ...
    IL2CPP_REGISTER_METHOD(0x0073C650, void, __ctor, (app::ShrineCombat * this_ptr));
