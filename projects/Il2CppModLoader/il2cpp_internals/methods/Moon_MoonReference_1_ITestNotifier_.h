...
IL2CPP_REGISTER_METHOD(0x02720AC0, ITestNotifier *, Resolve, (app::MoonReference_1_ITestNotifier_ * this_ptr, app::IMoonResolverContext * context));
IL2CPP_REGISTER_METHODINFO(0x04767548, MoonReference_1_ITestNotifier__Resolve__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027205B0, void, __ctor, (app::MoonReference_1_ITestNotifier_ * this_ptr, app::ITestNotifier * reference));
