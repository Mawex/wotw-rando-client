...
IL2CPP_REGISTER_METHOD(0x00C41600, Vector3, get_Position, (app::SpiritLeashInteractable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004E57A0, SpiritLeashMode__Enum, get_LeashInteractionMode, (app::SpiritLeashInteractable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9F0, Transform *, get_HookTargetTransform, (app::SpiritLeashInteractable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB60, IDamageReciever__Array *, get_AffectedReceivers, (app::SpiritLeashInteractable * this_ptr));
IL2CPP_REGISTER_METHOD(0x00D601F0, void, __ctor, (app::SpiritLeashInteractable * this_ptr));
}
