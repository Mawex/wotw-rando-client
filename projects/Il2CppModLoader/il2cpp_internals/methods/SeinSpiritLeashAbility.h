...
IL2CPP_REGISTER_METHOD(0x00420EE0, ButtonInputType__Enum, get_ButtonInputType, (app::SeinSpiritLeashAbility * this_ptr));
IL2CPP_REGISTER_METHOD(0x005E57B0, Transform *, get_LeashMarkPositionTransform, (app::SeinSpiritLeashAbility * this_ptr));
IL2CPP_REGISTER_METHOD(0x005E59C0, LayerMask, get_GroundMask, ());
IL2CPP_REGISTER_METHOD(0x005E5AD0, LayerMask, get_RaycastMask, (app::SeinSpiritLeashAbility * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005E5E10, Input_InputButtonProcessor *, get_ActivationButton, (app::SeinSpiritLeashAbility * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005E70B0, GrabbableSurface *, GetAndCacheObjectSurface, (app::SeinSpiritLeashAbility * this_ptr, app::GameObject * obj));
IL2CPP_REGISTER_METHOD(0x005E7370, void, PruneRecentHitSurfaces, (app::SeinSpiritLeashAbility * this_ptr));
IL2CPP_REGISTER_METHOD(0x005E7710, void, PreDash, (app::SeinSpiritLeashAbility * this_ptr, app::bool * allow));
...
IL2CPP_REGISTER_METHOD(0x00417920, ComboMoveType__Enum, get_ComboMoveType, (app::SeinSpiritLeashAbility * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005D06C0, PlatformMovement *, get_PlatformMovement, (app::SeinSpiritLeashAbility * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005F0FB0, CharacterApplyFrictionToSpeed *, get_ApplyFrictionToSpeed, (app::SeinSpiritLeashAbility * this_ptr));
IL2CPP_REGISTER_METHOD(0x005F0FF0, CharacterAirNoDeceleration *, get_AirNoDeceleration, (app::SeinSpiritLeashAbility * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005F3040, bool, IsVectorWithinAngle, (app::Vector3 target_dir, app::Vector3 ref_dir, float angle_threshold, app::float * angle_difference));
IL2CPP_REGISTER_METHOD(0x005F3140, bool, IsInputTowardsTarget, (app::SeinSpiritLeashAbility * this_ptr, app::Vector3 target_dir, app::Vector3 input_dir, bool is_current_target, app::float * angle_difference));
...
IL2CPP_REGISTER_METHOD(0x005F3780, Guid, get_AttackableConsumerID, (app::SeinSpiritLeashAbility * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005F7C20, Vector3, GetSlinshotTargetPosition, (app::Vector3 from, app::Vector3 to, bool is_player, float target_distance));
IL2CPP_REGISTER_METHOD(0x005F7EC0, ActiveAnimationHandle, PlayAnimation, (app::SeinSpiritLeashAbility * this_ptr, app::MoonAnimation * animation, int32_t layer, app::Action * on_stop_playing, app::Func_1_Boolean_ * condition, float speed, bool increase_priority));
...
IL2CPP_REGISTER_METHOD(0x005F7FD0, Vector3, CalculatePullVelocity, (app::Vector3 direction, float speed, float max_speed));
IL2CPP_REGISTER_METHOD(0x005F8160, void, OnDestroy, (app::SeinSpiritLeashAbility * this_ptr));
IL2CPP_REGISTER_METHOD(0x005F8690, IComboMove *, GetComboMove, (app::SeinSpiritLeashAbility * this_ptr, app::ComboInput * input));
IL2CPP_REGISTER_METHOD(0x005F86D0, bool, CanBeInterruptedBy, (app::SeinSpiritLeashAbility * this_ptr, app::IComboMove * move));
IL2CPP_REGISTER_METHOD(0x005F8A10, List_1_Moon_ComboSystem_IComboMove_ *, get_ComboMoves, (app::SeinSpiritLeashAbility * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005F8A30, AbilityType__Enum, get_ComboAbilityType, (app::SeinSpiritLeashAbility * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005F8A80, SeinLeashPuppet *, get_Puppet, (app::SeinSpiritLeashAbility * this_ptr));
IL2CPP_REGISTER_METHOD(0x005F8B40, String *, get_StressTestName, (app::SeinSpiritLeashAbility * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005F8D20, StressTestStatus__Enum, get_StressTestStatus, (app::SeinSpiritLeashAbility * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005F8DF0, void, __ctor, (app::SeinSpiritLeashAbility * this_ptr));
