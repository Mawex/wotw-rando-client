...
IL2CPP_REGISTER_METHOD(0x002FB990, AkCommonUserSettings *, GetUserSettings, (app::AkWwiseInitializationSettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9B0, AkCommonAdvancedSettings *, GetAdvancedSettings, (app::AkWwiseInitializationSettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9D0, AkCommonCommSettings *, GetCommsSettings, (app::AkWwiseInitializationSettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x027030A0, AkWwiseInitializationSettings *, get_Instance, ());
IL2CPP_REGISTER_METHOD(0x02703240, AkBasePlatformSettings *, GetPlatformSettings, (app::String * platform_name));
IL2CPP_REGISTER_METHOD(0x027035D0, AkBasePlatformSettings *, get_ActivePlatformSettings, ());
...
IL2CPP_REGISTER_METHOD(0x02705470, void, __ctor, (app::AkWwiseInitializationSettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x02705760, void, __cctor, ());
}
