...
IL2CPP_REGISTER_METHOD(0x005B0220, Transform *, get_FeetTransform, (app::KwolokBossLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x012E28E0, Vector3, get_FeetPosition, (app::KwolokBossLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00974AE0, EntityWeightData_EntityWeight__Enum, get_Weight, (app::KwolokBossLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0065FBA0, EntityLocomotionTask *, get_DefaultFSMState, (app::KwolokBossLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, ConfigureStateMachine, (app::KwolokBossLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, EntityLocomotionTask *, GetNextBehaviour, (app::KwolokBossLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012E33B0, Vector3, get_DirectionToTargetFromStinkSpirit, (app::KwolokBossLocomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x012E3570, Vector3, get_DirectionToTargetFromKwolok, (app::KwolokBossLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012E5050, Vector2, GetMovementLimits, (app::KwolokBossLocomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012E6A00, void, __ctor, (app::KwolokBossLocomotion * this_ptr));
}
