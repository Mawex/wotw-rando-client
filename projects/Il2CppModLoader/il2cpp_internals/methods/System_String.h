...
namespace app::methods::System::String {
    ...
    IL2CPP_REGISTER_METHOD(0x01E29A50, void, __ctor_1, (app::String * this_ptr, uint16_t * value));
    IL2CPP_REGISTER_METHOD(0x01E29A50, void, __ctor_2, (app::String * this_ptr, uint16_t * value, int32_t start_index, int32_t length));
    IL2CPP_REGISTER_METHOD(0x01E29A50, void, __ctor_3, (app::String * this_ptr, int8_t * value));
    IL2CPP_REGISTER_METHOD(0x01E29A50, void, __ctor_4, (app::String * this_ptr, int8_t * value, int32_t start_index, int32_t length));
    IL2CPP_REGISTER_METHOD(0x01E29A60, void, __ctor_5, (app::String * this_ptr, int8_t * value, int32_t start_index, int32_t length, app::Encoding * enc));
