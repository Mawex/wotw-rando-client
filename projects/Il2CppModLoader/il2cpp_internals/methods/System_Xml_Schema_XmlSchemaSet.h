...
namespace app::methods::System_Xml_Schema::XmlSchemaSet {
IL2CPP_REGISTER_METHOD(0x01CBA8C0, Object *, get_InternalSyncObject, (app::XmlSchemaSet * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBE0, XmlSchemaCompilationSettings *, get_CompilationSettings, (app::XmlSchemaSet * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01CBB650, XmlSchemaObjectTable *, get_GlobalElements, (app::XmlSchemaSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CBB7B0, XmlSchemaObjectTable *, get_GlobalAttributes, (app::XmlSchemaSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CBB910, XmlSchemaObjectTable *, get_GlobalTypes, (app::XmlSchemaSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CBBA70, XmlSchemaObjectTable *, get_SubstitutionGroups, (app::XmlSchemaSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9D0, Hashtable *, get_SchemaLocations, (app::XmlSchemaSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CBBBD0, XmlSchemaObjectTable *, get_TypeExtensions, (app::XmlSchemaSet * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01CBC3F0, XmlSchema *, Add_2, (app::XmlSchemaSet * this_ptr, app::XmlSchema * schema));
...
IL2CPP_REGISTER_METHOD(0x01CBDB30, XmlSchema *, Reprocess, (app::XmlSchemaSet * this_ptr, app::XmlSchema * schema));
...
IL2CPP_REGISTER_METHOD(0x01CBE340, ICollection *, Schemas_1, (app::XmlSchemaSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CBE370, ICollection *, Schemas_2, (app::XmlSchemaSet * this_ptr, app::String * target_namespace));
IL2CPP_REGISTER_METHOD(0x01CBE660, XmlSchema *, Add_3, (app::XmlSchemaSet * this_ptr, app::String * target_namespace, app::XmlSchema * schema));
...
IL2CPP_REGISTER_METHOD(0x01CBEC10, XmlSchema *, FindSchemaByNSAndUrl, (app::XmlSchemaSet * this_ptr, app::Uri * schema_uri, app::String * ns, app::DictionaryEntry__Array * locations_table));
...
IL2CPP_REGISTER_METHOD(0x01CBFB70, XmlSchema *, Remove, (app::XmlSchemaSet * this_ptr, app::XmlSchema * schema, bool force_compile));
...
IL2CPP_REGISTER_METHOD(0x01CC02D0, XmlSchema *, ParseSchema, (app::XmlSchemaSet * this_ptr, app::String * target_namespace, app::XmlReader * reader));
IL2CPP_REGISTER_METHOD(0x01CC0550, void, CopyFromCompiledSet, (app::XmlSchemaSet * this_ptr, app::XmlSchemaSet * other_set));
IL2CPP_REGISTER_METHOD(0x002FBB80, SchemaInfo *, get_CompiledInfo, (app::XmlSchemaSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBA0, XmlReaderSettings *, get_ReaderSettings, (app::XmlSchemaSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CC1A40, XmlResolver *, GetResolver, (app::XmlSchemaSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB990, ValidationEventHandler *, GetEventHandler, (app::XmlSchemaSet * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CC1A60, SchemaNames *, GetSchemaNames, (app::XmlSchemaSet * this_ptr, app::XmlNameTable * nt));
...
IL2CPP_REGISTER_METHOD(0x01CC22D0, String *, GetTargetNamespace, (app::XmlSchemaSet * this_ptr, app::XmlSchema * schema));
IL2CPP_REGISTER_METHOD(0x002FB950, SortedList *, get_SortedSchemas, (app::XmlSchemaSet * this_ptr));
