...
IL2CPP_REGISTER_METHOD(0x0176EF00, void, __ctor, (app::PetrifiedOwlBossFinalComboBehaviour_DiveHorizontalState * this_ptr, app::PetrifiedOwlBossFinalComboBehaviour * behaviour));
