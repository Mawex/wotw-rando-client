...
namespace app::methods::Mono_Security_Protocol_Tls::ClientSessionInfo {
IL2CPP_REGISTER_METHOD(0x01F68830, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x01F68910, void, __ctor, (app::ClientSessionInfo * this_ptr, app::String * hostname, app::Byte__Array * id));
IL2CPP_REGISTER_METHOD(0x01F68920, void, Finalize, (app::ClientSessionInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_HostName, (app::ClientSessionInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB00, Byte__Array *, get_Id, (app::ClientSessionInfo * this_ptr));
