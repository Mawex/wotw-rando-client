...
IL2CPP_REGISTER_METHOD(0x019E5330, SpellShardCompatibility *, GetValue, (app::EnumDictionary_2_EquipmentType_SpellShardCompatibility_ * this_ptr, app::EquipmentType__Enum key));
IL2CPP_REGISTER_METHODINFO(0x04709A18, EnumDictionary_2_EquipmentType_SpellShardCompatibility__GetValue__MethodInfo);
IL2CPP_REGISTER_METHOD(0x019E4530, void, __ctor, (app::EnumDictionary_2_EquipmentType_SpellShardCompatibility_ * this_ptr));
