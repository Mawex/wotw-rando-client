...
IL2CPP_REGISTER_METHOD(0x0115E2F0, BehaviourStatus__Enum, OnExecuteTask, (app::PiranhaDeathReactionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0115E5F0, void, __ctor, (app::PiranhaDeathReactionBehaviour * this_ptr));
}
