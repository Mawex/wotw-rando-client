...
namespace app::methods::System_Dynamic_Utils::CacheDict_2_System_Object_System_Object_ {
...
IL2CPP_REGISTER_METHOD(0x02879320, void, __ctor, (app::CacheDict_2_System_Object_System_Object_ * this_ptr, int32_t size));
