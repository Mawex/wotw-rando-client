...
namespace app::methods::Moon_Timeline::EntityPhysicsAnimator {
IL2CPP_REGISTER_METHOD(0x00766190, CharacterPlatformMovement *, get_Movement, (app::EntityPhysicsAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00766270, MovementProcessor *, get_MovementProcessor, (app::EntityPhysicsAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00767530, void, __ctor, (app::EntityPhysicsAnimator * this_ptr));
}
