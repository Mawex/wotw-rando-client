...
namespace app::methods::System_ComponentModel::ImmutableObjectAttribute {
    IL2CPP_REGISTER_METHOD(0x0052C650, void, __ctor, (app::ImmutableObjectAttribute * this_ptr, bool immutable));
    ...
    IL2CPP_REGISTER_METHOD(0x01FEE450, void, __cctor, ());
}
