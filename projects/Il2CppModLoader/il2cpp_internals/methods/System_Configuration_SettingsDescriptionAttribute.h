...
namespace app::methods::System_Configuration::SettingsDescriptionAttribute {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::SettingsDescriptionAttribute * this_ptr, app::String * description));
IL2CPP_REGISTER_METHOD(0x02962B90, String *, get_Description, (app::SettingsDescriptionAttribute * this_ptr));
