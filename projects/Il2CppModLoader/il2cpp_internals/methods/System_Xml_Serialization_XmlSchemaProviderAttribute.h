...
namespace app::methods::System_Xml_Serialization::XmlSchemaProviderAttribute {
    IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::XmlSchemaProviderAttribute * this_ptr, app::String * method_name));
