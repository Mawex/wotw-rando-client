...
namespace app::methods::System_Collections_Specialized::CaseSensitiveStringDictionary {
IL2CPP_REGISTER_METHOD(0x024928E0, void, __ctor, (app::CaseSensitiveStringDictionary * this_ptr));
IL2CPP_REGISTER_METHOD(0x024928F0, String *, get_Item, (app::CaseSensitiveStringDictionary * this_ptr, app::String * key));
