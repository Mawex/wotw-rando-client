...
IL2CPP_REGISTER_METHOD(0x00420EE0, BehaviourStatus__Enum, OnExecute, (app::LaserShooterIdleBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00F155A0, void, __ctor, (app::LaserShooterIdleBehaviour * this_ptr));
}
