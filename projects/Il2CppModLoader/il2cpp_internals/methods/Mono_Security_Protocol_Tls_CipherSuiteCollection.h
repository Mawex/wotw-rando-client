...
namespace app::methods::Mono_Security_Protocol_Tls::CipherSuiteCollection {
IL2CPP_REGISTER_METHOD(0x01F65030, CipherSuite *, get_Item_1, (app::CipherSuiteCollection * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x01F650F0, CipherSuite *, get_Item_2, (app::CipherSuiteCollection * this_ptr, int16_t code));
IL2CPP_REGISTER_METHOD(0x01F651B0, void, __ctor, (app::CipherSuiteCollection * this_ptr, app::SecurityProtocolType__Enum_1 protocol));
...
IL2CPP_REGISTER_METHOD(0x01F65990, IList_1_System_String_ *, GetNames, (app::CipherSuiteCollection * this_ptr));
}
