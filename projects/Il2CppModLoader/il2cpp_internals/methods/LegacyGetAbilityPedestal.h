...
IL2CPP_REGISTER_METHOD(0x003FC380, StressTestStatus__Enum, get_StressTestStatus, (app::LegacyGetAbilityPedestal * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00A26DF0, String *, get_StressTestName, (app::LegacyGetAbilityPedestal * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A26E70, void, __ctor, (app::LegacyGetAbilityPedestal * this_ptr));
