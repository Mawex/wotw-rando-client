...
namespace app::methods::System_Collections_Generic::Dictionary_2_TKey_TValue__Enumerator_SmartInput_IButtonInput_Core_Input_InputButtonProcessor_ {
IL2CPP_REGISTER_METHOD(0x00136440, KeyValuePair_2_SmartInput_IButtonInput_Core_Input_InputButtonProcessor_, get_Current, (app::Dictionary_2_TKey_TValue_Enumerator_SmartInput_IButtonInput_Core_Input_InputButtonProcessor___Boxed * this_ptr));
