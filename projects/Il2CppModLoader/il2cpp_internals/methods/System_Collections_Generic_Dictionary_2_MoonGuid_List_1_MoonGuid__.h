...
namespace app::methods::System_Collections_Generic::Dictionary_2_MoonGuid_List_1_MoonGuid__ {
...
IL2CPP_REGISTER_METHOD(0x02BD24D0, List_1_MoonGuid_ *, get_Item, (app::Dictionary_2_MoonGuid_List_1_MoonGuid_ * this_ptr, app::MoonGuid * key));
IL2CPP_REGISTER_METHODINFO(0x04705B40, Dictionary_2_MoonGuid_List_1_MoonGuid__get_Item__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02259DF0, void, __ctor, (app::Dictionary_2_MoonGuid_List_1_MoonGuid_ * this_ptr, int32_t capacity));
