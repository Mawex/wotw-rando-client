...
IL2CPP_REGISTER_METHOD(0x00AC4E70, LegacyDoor *, GetTargetDoor, (app::SeinDoorHandler * this_ptr, app::LegacyDoor * door));
...
IL2CPP_REGISTER_METHOD(0x00AC72B0, void, __ctor, (app::SeinDoorHandler * this_ptr));
}
