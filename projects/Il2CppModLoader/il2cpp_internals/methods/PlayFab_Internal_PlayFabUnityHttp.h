...
namespace app::methods::PlayFab_Internal::PlayFabUnityHttp {
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_AuthKey, (app::PlayFabUnityHttp * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_AuthKey, (app::PlayFabUnityHttp * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_EntityToken, (app::PlayFabUnityHttp * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0183DB70, IEnumerator *, SimpleCallCoroutine, (app::String * method_1, app::String * full_url, app::Byte__Array * payload, app::Action_1_Byte_ * success_callback, app::Action_1_String_ * error_callback));
IL2CPP_REGISTER_METHOD(0x0183DCF0, void, MakeApiCall, (app::PlayFabUnityHttp * this_ptr, app::Object * req_container_obj));
IL2CPP_REGISTER_METHOD(0x0183E460, IEnumerator *, Post, (app::PlayFabUnityHttp * this_ptr, app::CallRequestContainer * req_container));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::PlayFabUnityHttp * this_ptr));
}
