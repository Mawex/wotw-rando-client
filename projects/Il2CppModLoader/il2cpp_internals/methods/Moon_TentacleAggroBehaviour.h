...
IL2CPP_REGISTER_METHOD(0x010AB6A0, BehaviourStatus__Enum, OnExecute, (app::TentacleAggroBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x010AB9C0, void, __ctor, (app::TentacleAggroBehaviour * this_ptr));
}
