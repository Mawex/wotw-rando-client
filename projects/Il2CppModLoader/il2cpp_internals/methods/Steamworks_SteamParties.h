...
IL2CPP_REGISTER_METHOD(0x0278EE40, PartyBeaconID_t, GetBeaconByIndex, (uint32_t un_index));
...
IL2CPP_REGISTER_METHOD(0x0278F140, SteamAPICall_t, JoinParty, (app::PartyBeaconID_t ul_beacon_i_d));
IL2CPP_REGISTER_METHOD(0x0278F280, bool, GetNumAvailableBeaconLocations, (app::uint32_t * pu_num_locations));
...
IL2CPP_REGISTER_METHOD(0x0278F410, SteamAPICall_t, CreateBeacon, (uint32_t un_open_slots, app::SteamPartyBeaconLocation_t * p_beacon_location, app::String * pch_connect_string, app::String * pch_metadata));
...
IL2CPP_REGISTER_METHOD(0x0278FA40, SteamAPICall_t, ChangeNumOpenSlots, (app::PartyBeaconID_t ul_beacon, uint32_t un_open_slots));
