...
IL2CPP_REGISTER_METHOD(0x0086D320, Vector2, CalculateDelta, (app::MovingGroundHelper * this_ptr, app::Transform * target));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MovingGroundHelper * this_ptr));
}
