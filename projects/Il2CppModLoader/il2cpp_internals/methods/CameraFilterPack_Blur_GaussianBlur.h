...
IL2CPP_REGISTER_METHOD(0x024D1840, Material *, get_material, (app::CameraFilterPack_Blur_GaussianBlur * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024D2130, void, __ctor, (app::CameraFilterPack_Blur_GaussianBlur * this_ptr));
}
