...
namespace app::methods::BatEnemy {
    IL2CPP_REGISTER_METHOD(0x00F8F610, BatSwarm*, get_Swarm, (app::BatEnemy * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0043D9E0, BehaviourTreeStatus__Enum, OnIdleUpdate, (app::BatEnemy * this_ptr, app::TickData t));
    ...
    IL2CPP_REGISTER_METHOD(0x00F92F40, BehaviourTreeStatus__Enum, OnSeekUpdate, (app::BatEnemy * this_ptr, app::TickData t));
    ...
    IL2CPP_REGISTER_METHOD(0x00F930A0, BehaviourTreeStatus__Enum, OnAttackUpdate, (app::BatEnemy * this_ptr, app::TickData t));
    ...
    IL2CPP_REGISTER_METHOD(0x00F93760, BehaviourTreeStatus__Enum, OnFleeUpdate, (app::BatEnemy * this_ptr, app::TickData t));
    ...
    IL2CPP_REGISTER_METHOD(0x00F93A20, BehaviourTreeStatus__Enum, OnFrozenUpdate, (app::BatEnemy * this_ptr, app::TickData t));
    ...
    IL2CPP_REGISTER_METHOD(0x00F93CE0, BehaviourTreeStatus__Enum, OnFrozenShatter, (app::BatEnemy * this_ptr, app::TickData t));
    ...
    IL2CPP_REGISTER_METHOD(0x0043D9E0, BehaviourTreeStatus__Enum, OnCarryStickyMineUpdate, (app::BatEnemy * this_ptr, app::TickData t));
    IL2CPP_REGISTER_METHODINFO(0x04722138, BatEnemy_OnCarryStickyMineUpdate__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x00F94050, void, __ctor, (app::BatEnemy * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00F94200, BehaviourTreeStatus__Enum, _Awake_b__29_2, (app::BatEnemy * this_ptr, app::TickData t));
