...
namespace app::methods::System_Linq_Expressions_Interpreter::QuoteInstruction {
...
IL2CPP_REGISTER_METHOD(0x0240D360, String *, get_InstructionName, (app::QuoteInstruction * this_ptr));
