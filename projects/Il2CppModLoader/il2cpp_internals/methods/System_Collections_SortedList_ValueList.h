...
namespace app::methods::System_Collections::SortedList_ValueList {
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::SortedList_ValueList * this_ptr, app::SortedList * sorted_list));
...
IL2CPP_REGISTER_METHOD(0x017173F0, Object *, get_SyncRoot, (app::SortedList_ValueList * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02031830, Object *, get_Item, (app::SortedList_ValueList * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x020318D0, IEnumerator *, GetEnumerator, (app::SortedList_ValueList * this_ptr));
