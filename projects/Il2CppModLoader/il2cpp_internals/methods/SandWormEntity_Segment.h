...
IL2CPP_REGISTER_METHOD(0x002FB930, VerletBody_Point *, get_VerletPoint, (app::SandWormEntity_Segment * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_VerletPoint, (app::SandWormEntity_Segment * this_ptr, app::VerletBody_Point * value));
IL2CPP_REGISTER_METHOD(0x002FB950, VerletBody_Link *, get_VerletLink, (app::SandWormEntity_Segment * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB960, void, set_VerletLink, (app::SandWormEntity_Segment * this_ptr, app::VerletBody_Link * value));
IL2CPP_REGISTER_METHOD(0x00C1B1E0, Vector3, get_Velocity, (app::SandWormEntity_Segment * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C1B200, void, set_Velocity, (app::SandWormEntity_Segment * this_ptr, app::Vector3 value));
IL2CPP_REGISTER_METHOD(0x002FB9B0, Rigidbody *, get_Rigidbody, (app::SandWormEntity_Segment * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9C0, void, set_Rigidbody, (app::SandWormEntity_Segment * this_ptr, app::Rigidbody * value));
IL2CPP_REGISTER_METHOD(0x002FB9D0, CharacterJoint *, get_CharacterJoint, (app::SandWormEntity_Segment * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9E0, void, set_CharacterJoint, (app::SandWormEntity_Segment * this_ptr, app::CharacterJoint * value));
IL2CPP_REGISTER_METHOD(0x002FB9F0, Collider *, get_Collider, (app::SandWormEntity_Segment * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC00, EntityTargetting *, get_Targetting, (app::SandWormEntity_Segment * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBC10, void, set_Targetting, (app::SandWormEntity_Segment * this_ptr, app::EntityTargetting * value));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::SandWormEntity_Segment * this_ptr));
}
