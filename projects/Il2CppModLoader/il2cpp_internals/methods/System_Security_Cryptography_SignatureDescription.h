...
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_KeyAlgorithm, (app::SignatureDescription * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_KeyAlgorithm, (app::SignatureDescription * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_DigestAlgorithm, (app::SignatureDescription * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB940, void, set_DigestAlgorithm, (app::SignatureDescription * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_FormatterAlgorithm, (app::SignatureDescription * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB960, void, set_FormatterAlgorithm, (app::SignatureDescription * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, get_DeformatterAlgorithm, (app::SignatureDescription * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB10, void, set_DeformatterAlgorithm, (app::SignatureDescription * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x01E0FCA0, AsymmetricSignatureDeformatter *, CreateDeformatter, (app::SignatureDescription * this_ptr, app::AsymmetricAlgorithm * key));
IL2CPP_REGISTER_METHOD(0x01E0FDA0, AsymmetricSignatureFormatter *, CreateFormatter, (app::SignatureDescription * this_ptr, app::AsymmetricAlgorithm * key));
IL2CPP_REGISTER_METHOD(0x01E0FEA0, HashAlgorithm *, CreateDigest, (app::SignatureDescription * this_ptr));
}
