...
IL2CPP_REGISTER_METHOD(0x00CFBD00, String *, get_Name, (app::TentacleEnemy_StuckInGroundState * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00CFBF50, BehaviourTreeStatus__Enum, OnTentacleStateUpdate, (app::TentacleEnemy_StuckInGroundState * this_ptr, app::TickData tick));
...
IL2CPP_REGISTER_METHOD(0x00CFC570, void, __ctor, (app::TentacleEnemy_StuckInGroundState * this_ptr));
}
