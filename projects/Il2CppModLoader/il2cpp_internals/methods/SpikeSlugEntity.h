...
IL2CPP_REGISTER_METHOD(0x011C9260, GroundPatrolDirectionMode__Enum, get_MovementPattern, (app::SpikeSlugEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011C92D0, EnemyPlatformMovement *, get_PlatformMovement, (app::SpikeSlugEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011CA890, SpikeSlugEntity_SpikeSlugShellState__Enum, get_ShellState, (app::SpikeSlugEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011CC180, Vector3, ModifyKickbackForce, (app::SpikeSlugEntity * this_ptr, app::Vector3 force, app::Damage * damage, bool apply_death_modification));
...
IL2CPP_REGISTER_METHOD(0x011CC850, void, __ctor, (app::SpikeSlugEntity * this_ptr));
