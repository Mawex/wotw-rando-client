...
namespace app::methods::UberSwarmer {
    IL2CPP_REGISTER_METHOD(0x002FB930, UberSwarm*, get_Swarm, (app::UberSwarmer * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0128E2C0, Vector2, CalculateExtraVelocities, (app::UberSwarmer * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0128E350, void, CalculateVelocities, (app::UberSwarmer * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0128EAF0, Vector2, CheckObstacles, (app::UberSwarmer * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0128F0C0, Vector2, Steer, (app::UberSwarmer * this_ptr, app::Vector2 target, bool inverse));
    IL2CPP_REGISTER_METHOD(0x0128F2E0, Vector2, Limit, (app::UberSwarmer * this_ptr, app::Vector2 v, float max));
    ...
    IL2CPP_REGISTER_METHOD(0x003FF2B0, SuspendableMask__Enum, get_Mask, (app::UberSwarmer * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01290230, void, __ctor, (app::UberSwarmer * this_ptr));
} // namespace app::methods::UberSwarmer
