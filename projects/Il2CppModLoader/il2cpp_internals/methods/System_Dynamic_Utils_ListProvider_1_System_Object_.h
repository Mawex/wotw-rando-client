...
namespace app::methods::System_Dynamic_Utils::ListProvider_1_System_Object_ {
IL2CPP_REGISTER_METHOD(0x02879B70, Object *, get_Item, (app::ListProvider_1_System_Object_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02879EF0, IEnumerator_1_System_Object_ *, GetEnumerator, (app::ListProvider_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x019DF3A0, IEnumerator *, IEnumerable_GetEnumerator, (app::ListProvider_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::ListProvider_1_System_Object_ * this_ptr));
}
