...
IL2CPP_REGISTER_METHOD(0x002FA280, IUberState *, get_UberState, (app::DesiredUberStateBoolBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B57A40, String *, get_NiceName, (app::DesiredUberStateBoolBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x01B57D10, bool, IsFulfilled, (app::DesiredUberStateBoolBase * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::DesiredUberStateBoolBase * this_ptr));
}
