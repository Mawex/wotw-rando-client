...
namespace app::methods::Newtonsoft_Json_Linq::JArray {
IL2CPP_REGISTER_METHOD(0x002FBB60, IList_1_Newtonsoft_Json_Linq_JToken_ *, get_ChildrenTokens, (app::JArray * this_ptr));
IL2CPP_REGISTER_METHOD(0x0043D9E0, JTokenType__Enum, get_Type, (app::JArray * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F037F0, void, __ctor_1, (app::JArray * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F03950, void, __ctor_2, (app::JArray * this_ptr, app::JArray * other));
IL2CPP_REGISTER_METHOD(0x01F03AB0, void, __ctor_3, (app::JArray * this_ptr, app::Object * content));
IL2CPP_REGISTER_METHOD(0x01F03C20, JToken *, CloneToken, (app::JArray * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F03E90, JArray *, Load, (app::JsonReader * reader, app::JsonLoadSettings * settings));
...
IL2CPP_REGISTER_METHOD(0x01F042A0, JToken *, get_Item, (app::JArray * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x01F04440, IEnumerator_1_Newtonsoft_Json_Linq_JToken_ *, GetEnumerator, (app::JArray * this_ptr));
