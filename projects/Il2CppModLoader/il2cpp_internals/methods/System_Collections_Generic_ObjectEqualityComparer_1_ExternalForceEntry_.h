...
namespace app::methods::System_Collections_Generic::ObjectEqualityComparer_1_ExternalForceEntry_ {
    ...
    IL2CPP_REGISTER_METHOD(0x019F8810, void, __ctor, (app::ObjectEqualityComparer_1_ExternalForceEntry_ * this_ptr));
}
