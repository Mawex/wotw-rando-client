...
IL2CPP_REGISTER_METHOD(0x024E21F0, Material *, get_material, (app::CameraFilterPack_Colors_NewPosterize * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024E1140, void, __ctor, (app::CameraFilterPack_Colors_NewPosterize * this_ptr));
}
