...
namespace app::methods::ZenFulcrum_EmbeddedBrowser::Door {
...
IL2CPP_REGISTER_METHOD(0x003FF610, Door_OpenState__Enum, get_State, (app::Door_1 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01DD6A70, void, __ctor, (app::Door_1 * this_ptr));
}
