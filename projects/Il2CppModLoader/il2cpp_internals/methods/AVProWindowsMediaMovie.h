...
IL2CPP_REGISTER_METHOD(0x0312E3B0, Texture *, get_OutputTexture, (app::AVProWindowsMediaMovie * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB80, AVProWindowsMedia *, get_MovieInstance, (app::AVProWindowsMediaMovie * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0312E7A0, bool, LoadMovieFromMemory, (app::AVProWindowsMediaMovie * this_ptr, bool auto_play, app::String * name, app::void * movie_pointer, int64_t movie_length, app::FilterMode__Enum texture_filter_mode, app::TextureWrapMode__Enum texture_wrap_mode));
...
IL2CPP_REGISTER_METHOD(0x0312ED40, String *, GetClipName, (app::AVProWindowsMediaMovie * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x0312F0A0, String *, GetCurrentClipName, (app::AVProWindowsMediaMovie * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0312F560, String *, GetFilePath, (app::AVProWindowsMediaMovie * this_ptr));
IL2CPP_REGISTER_METHOD(0x0312F710, void, __ctor, (app::AVProWindowsMediaMovie * this_ptr));
}
