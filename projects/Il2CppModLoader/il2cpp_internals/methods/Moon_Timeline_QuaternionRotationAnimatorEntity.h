...
namespace app::methods::Moon_Timeline::QuaternionRotationAnimatorEntity {
IL2CPP_REGISTER_METHOD(0x01E7D4F0, Transform *, get_TransformTarget, (app::QuaternionRotationAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E7D590, GameObject *, get_ExternalTarget, (app::QuaternionRotationAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E7D640, Transform *, get_EffectiveTransform, (app::QuaternionRotationAnimatorEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E7DD60, Quaternion, GetRotationAtValue, (app::QuaternionRotationAnimatorEntity * this_ptr, float value));
IL2CPP_REGISTER_METHOD(0x002FBC20, MoonReference_1_UnityEngine_Transform_ *, GetTransformTarget, (app::QuaternionRotationAnimatorEntity * this_ptr));
IL2CPP_REGISTER_METHOD(0x01E7DE70, bool, GetCurrentValueAssociatedWithCurve, (app::QuaternionRotationAnimatorEntity * this_ptr, app::String * curve, app::float * value));
...
IL2CPP_REGISTER_METHOD(0x01E7E670, void, __ctor, (app::QuaternionRotationAnimatorEntity * this_ptr));
}
