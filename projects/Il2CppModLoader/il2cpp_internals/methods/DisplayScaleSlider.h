...
IL2CPP_REGISTER_METHOD(0x00B99740, String *, GetValueToDisplay, (app::DisplayScaleSlider * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B99C30, void, __ctor, (app::DisplayScaleSlider * this_ptr));
