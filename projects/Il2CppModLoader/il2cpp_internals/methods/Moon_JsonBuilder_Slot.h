...
IL2CPP_REGISTER_METHOD(0x0013C010, void, __ctor, (app::JsonBuilder_Slot__Boxed * this_ptr, int32_t ident, app::JsonBuilder * builder));
...
IL2CPP_REGISTER_METHOD(0x002457D0, JsonBuilder_Object, BuildObject, (app::JsonBuilder_Slot__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x00245830, JsonBuilder_Array, BuildArray, (app::JsonBuilder_Slot__Boxed * this_ptr));
}
