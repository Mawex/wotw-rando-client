...
namespace app::methods::Moon_Extensions::LinqExtensions {
IL2CPP_REGISTER_METHOD(0x00E7D170, IEnumerable_1_System_Object_ *, DistinctBy, (app::IEnumerable_1_System_Object_ * source, app::Func_2_Object_Object_ * key_selector));
