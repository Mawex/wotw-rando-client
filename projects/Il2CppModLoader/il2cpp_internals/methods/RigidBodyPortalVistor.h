...
IL2CPP_REGISTER_METHOD(0x00911E90, Vector3, get_Position, (app::RigidBodyPortalVistor * this_ptr));
IL2CPP_REGISTER_METHOD(0x00911F20, Vector3, get_Speed, (app::RigidBodyPortalVistor * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::RigidBodyPortalVistor * this_ptr));
}
