...
IL2CPP_REGISTER_METHOD(0x003FC830, SuspendableMask__Enum, get_Mask, (app::ActionWithDuration * this_ptr));
IL2CPP_REGISTER_METHOD(0x004C6EE0, void, set_Mask, (app::ActionWithDuration * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x0043BB90, void, __ctor, (app::ActionWithDuration * this_ptr));
}
