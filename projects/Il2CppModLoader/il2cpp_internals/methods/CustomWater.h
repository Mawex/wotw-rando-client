...
namespace app::methods::CustomWater {
    ...
    IL2CPP_REGISTER_METHOD(0x00DBC320, Matrix4x4, CalculateReflectionMatrix, (app::CustomWater * this_ptr, app::Vector4 plane));
    IL2CPP_REGISTER_METHOD(0x00DBCA30, Vector4, CameraSpacePlane, (app::CustomWater * this_ptr, app::Camera* cam, app::Vector3 pos, app::Vector3 normal, float side_sign));
    ...
    IL2CPP_REGISTER_METHOD(0x00DBD4A0, void, __ctor, (app::CustomWater * this_ptr));
} // namespace app::methods::CustomWater
