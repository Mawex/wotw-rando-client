...
namespace app::methods::System_Collections::SortedList_KeyList {
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::SortedList_KeyList * this_ptr, app::SortedList * sorted_list));
...
IL2CPP_REGISTER_METHOD(0x017173F0, Object *, get_SyncRoot, (app::SortedList_KeyList * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0202F200, Object *, get_Item, (app::SortedList_KeyList * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x0202F2A0, IEnumerator *, GetEnumerator, (app::SortedList_KeyList * this_ptr));
