...
IL2CPP_REGISTER_METHOD(0x017644B0, BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossLaserCenterBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x01765790, void, OnExit, (app::PetrifiedOwlBossLaserCenterBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x01776850, Enum__Array *, GetEntries, (app::PetrifiedOwlBossLaserCenterBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x017768F0, Enum, Evaluate, (app::PetrifiedOwlBossLaserCenterBehaviour * this_ptr));
