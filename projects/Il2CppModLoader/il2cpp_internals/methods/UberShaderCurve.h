...
IL2CPP_REGISTER_METHOD(0x002FB9B0, AnimationCurve *, get_Curve, (app::UberShaderCurve * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0190E7A0, void, __ctor_1, (app::UberShaderCurve * this_ptr));
IL2CPP_REGISTER_METHOD(0x0190E7E0, void, __ctor_2, (app::UberShaderCurve * this_ptr, float value));
IL2CPP_REGISTER_METHOD(0x0190E820, void, __ctor_3, (app::UberShaderCurve * this_ptr, app::AnimationCurve * curve));
...
IL2CPP_REGISTER_METHOD(0x0190EE60, Vector4, GetSettings, (app::UberShaderCurve * this_ptr));
