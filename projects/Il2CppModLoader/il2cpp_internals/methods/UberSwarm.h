...
namespace app::methods::UberSwarm {
    ...
    IL2CPP_REGISTER_METHOD(0x0057AAC0, SuspendableMask__Enum, get_Mask, (app::UberSwarm * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0128BD10, void, set_Mask, (app::UberSwarm * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x00866A10, void, __ctor, (app::UberSwarm * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0128BFA0, Vector2, SwarmCenter, (app::UberSwarm * this_ptr));
} // namespace app::methods::UberSwarm
