...
IL2CPP_REGISTER_METHOD(0x002FB9F0, GlobalRecordingTable *, get_GlobalRecordingTable, (app::PhysicalPhysicaSystemManagerPlugin * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, GhostRecorder_GhostPluginRecordingType__Enum, GetRecordingType, (app::PhysicalPhysicaSystemManagerPlugin * this_ptr));
IL2CPP_REGISTER_METHOD(0x007E59B0, void, __ctor, (app::PhysicalPhysicaSystemManagerPlugin * this_ptr));
}
