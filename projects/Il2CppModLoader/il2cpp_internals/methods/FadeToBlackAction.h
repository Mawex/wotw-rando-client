...
IL2CPP_REGISTER_METHOD(0x0098F7D0, String *, GetNiceName, (app::FadeToBlackAction * this_ptr));
IL2CPP_REGISTER_METHOD(0x0043BB90, void, __ctor, (app::FadeToBlackAction * this_ptr));
}
