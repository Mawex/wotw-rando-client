...
IL2CPP_REGISTER_METHOD(0x029E3A00, String *, TextField, (app::String * text, app::GUILayoutOption__Array * options));
IL2CPP_REGISTER_METHOD(0x029E3AE0, String *, TextArea, (app::String * text, app::GUILayoutOption__Array * options));
IL2CPP_REGISTER_METHOD(0x029E3BC0, String *, DoTextField, (app::String * text, int32_t max_length, bool multiline, app::GUIStyle * style, app::GUILayoutOption__Array * options));
...
IL2CPP_REGISTER_METHOD(0x029E5DA0, Vector2, BeginScrollView_1, (app::Vector2 scroll_position, app::GUILayoutOption__Array * options));
IL2CPP_REGISTER_METHOD(0x029E5ED0, Vector2, BeginScrollView_2, (app::Vector2 scroll_position, bool always_show_horizontal, bool always_show_vertical, app::GUILayoutOption__Array * options));
IL2CPP_REGISTER_METHOD(0x029E6010, Vector2, BeginScrollView_3, (app::Vector2 scroll_position, app::GUIStyle * horizontal_scrollbar, app::GUIStyle * vertical_scrollbar, app::GUILayoutOption__Array * options));
IL2CPP_REGISTER_METHOD(0x029E6110, Vector2, BeginScrollView_4, (app::Vector2 scroll_position, app::GUIStyle * style));
IL2CPP_REGISTER_METHOD(0x029E6130, Vector2, BeginScrollView_5, (app::Vector2 scroll_position, app::GUIStyle * style, app::GUILayoutOption__Array * options));
IL2CPP_REGISTER_METHOD(0x029E6380, Vector2, BeginScrollView_6, (app::Vector2 scroll_position, bool always_show_horizontal, bool always_show_vertical, app::GUIStyle * horizontal_scrollbar, app::GUIStyle * vertical_scrollbar, app::GUILayoutOption__Array * options));
IL2CPP_REGISTER_METHOD(0x029E6490, Vector2, BeginScrollView_7, (app::Vector2 scroll_position, bool always_show_horizontal, bool always_show_vertical, app::GUIStyle * horizontal_scrollbar, app::GUIStyle * vertical_scrollbar, app::GUIStyle * background, app::GUILayoutOption__Array * options));
...
IL2CPP_REGISTER_METHOD(0x029E6B00, GUILayoutOption *, MinHeight, (float min_height));
