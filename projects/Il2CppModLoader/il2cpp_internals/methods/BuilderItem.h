...
namespace app::methods::BuilderItem {
    IL2CPP_REGISTER_METHOD(0x004173F0, MessageProvider*, get_ItemName, (app::BuilderItem * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00818320, MessageProvider*, get_ItemDescription, (app::BuilderItem * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00818460, MessageProvider*, get_ItemNextLevelDescription, (app::BuilderItem * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00417880, Texture2D*, get_ItemIcon, (app::BuilderItem * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::BuilderItem * this_ptr));
} // namespace app::methods::BuilderItem
