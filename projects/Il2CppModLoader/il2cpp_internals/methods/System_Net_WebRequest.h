...
namespace app::methods::System_Net::WebRequest {
IL2CPP_REGISTER_METHOD(0x021B35D0, IWebRequestCreate *, get_CreatorInstance, (app::WebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x021B38F0, WebRequest *, Create_1, (app::Uri * request_uri, bool use_uri_base));
IL2CPP_REGISTER_METHODINFO(0x047703B0, WebRequest_Create__MethodInfo);
IL2CPP_REGISTER_METHOD(0x021B3C40, WebRequest *, Create_2, (app::String * request_uri_string));
IL2CPP_REGISTER_METHODINFO(0x04760D80, WebRequest_Create_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x021B3DF0, WebRequest *, Create_3, (app::Uri * request_uri));
IL2CPP_REGISTER_METHODINFO(0x0470DD00, WebRequest_Create_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x021B3EE0, WebRequest *, CreateDefault, (app::Uri * request_uri));
IL2CPP_REGISTER_METHODINFO(0x04785218, WebRequest_CreateDefault__MethodInfo);
IL2CPP_REGISTER_METHOD(0x021B3FD0, HttpWebRequest *, CreateHttp_1, (app::String * request_uri_string));
IL2CPP_REGISTER_METHODINFO(0x0478BA30, WebRequest_CreateHttp__MethodInfo);
IL2CPP_REGISTER_METHOD(0x021B4180, HttpWebRequest *, CreateHttp_2, (app::Uri * request_uri));
...
IL2CPP_REGISTER_METHOD(0x021B5580, void, __ctor_1, (app::WebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_2, (app::WebRequest * this_ptr, app::SerializationInfo * serialization_info, app::StreamingContext streaming_context));
...
IL2CPP_REGISTER_METHOD(0x002FB950, RequestCachePolicy *, get_CachePolicy, (app::WebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x021B5910, String *, get_Method, (app::WebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x021B5990, Uri *, get_RequestUri, (app::WebRequest * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0475B280, WebRequest_get_RequestUri__MethodInfo);
IL2CPP_REGISTER_METHOD(0x021B59D0, String *, get_ConnectionGroupName, (app::WebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x021B5A50, WebHeaderCollection *, get_Headers, (app::WebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x021B5B50, String *, get_ContentType, (app::WebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x021B5BD0, ICredentials *, get_Credentials, (app::WebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x021B5CD0, IWebProxy *, get_Proxy, (app::WebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x021B5E50, Stream *, GetRequestStream, (app::WebRequest * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0474D8D8, WebRequest_GetRequestStream__MethodInfo);
IL2CPP_REGISTER_METHOD(0x021B5E90, WebResponse *, GetResponse, (app::WebRequest * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04797678, WebRequest_GetResponse__MethodInfo);
IL2CPP_REGISTER_METHOD(0x021B5ED0, IAsyncResult *, BeginGetResponse, (app::WebRequest * this_ptr, app::AsyncCallback * callback, app::Object * state));
IL2CPP_REGISTER_METHODINFO(0x047328C0, WebRequest_BeginGetResponse__MethodInfo);
IL2CPP_REGISTER_METHOD(0x021B5F10, WebResponse *, EndGetResponse, (app::WebRequest * this_ptr, app::IAsyncResult * async_result));
IL2CPP_REGISTER_METHODINFO(0x0477C2D8, WebRequest_EndGetResponse__MethodInfo);
IL2CPP_REGISTER_METHOD(0x021B5F50, IAsyncResult *, BeginGetRequestStream, (app::WebRequest * this_ptr, app::AsyncCallback * callback, app::Object * state));
IL2CPP_REGISTER_METHODINFO(0x0477B810, WebRequest_BeginGetRequestStream__MethodInfo);
IL2CPP_REGISTER_METHOD(0x021B5F90, Stream *, EndGetRequestStream, (app::WebRequest * this_ptr, app::IAsyncResult * async_result));
IL2CPP_REGISTER_METHODINFO(0x04771640, WebRequest_EndGetRequestStream__MethodInfo);
IL2CPP_REGISTER_METHOD(0x021B5FD0, Task_1_System_IO_Stream_ *, GetRequestStreamAsync, (app::WebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x021B6400, Task_1_System_Net_WebResponse_ *, GetResponseAsync, (app::WebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x021B6830, WindowsIdentity *, SafeCaptureIdenity, (app::WebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB00, RequestCacheProtocol *, get_CacheProtocol, (app::WebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB10, void, set_CacheProtocol, (app::WebRequest * this_ptr, app::RequestCacheProtocol * value));
IL2CPP_REGISTER_METHOD(0x00529FF0, AuthenticationLevel__Enum, get_AuthenticationLevel, (app::WebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0052A010, TokenImpersonationLevel__Enum, get_ImpersonationLevel, (app::WebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x021B72F0, Task_1_System_IO_Stream_ *, _GetRequestStreamAsync_b__78_0, (app::WebRequest * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04782518, WebRequest__GetRequestStreamAsync_b__78_0__MethodInfo);
IL2CPP_REGISTER_METHOD(0x021B75A0, Task_1_System_Net_WebResponse_ *, _GetResponseAsync_b__79_0, (app::WebRequest * this_ptr));
