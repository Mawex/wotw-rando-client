...
IL2CPP_REGISTER_METHOD(0x0057A5A0, SuspendableMask__Enum, get_Mask, (app::SpiritCrescent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x011D4710, void, __ctor, (app::SpiritCrescent * this_ptr));
}
