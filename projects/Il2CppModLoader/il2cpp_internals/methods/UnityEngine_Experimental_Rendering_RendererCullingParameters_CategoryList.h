...
namespace app::methods::UnityEngine_Experimental_Rendering::RendererCullingParameters_CategoryList {
    ...
    IL2CPP_REGISTER_METHOD(0x025240C0, app::RendererCullingParameters_CategoryList, operator_, (app::RendererCullingCategoryParameters__Array * array));
