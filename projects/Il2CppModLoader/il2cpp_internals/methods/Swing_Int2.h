...
namespace app::methods::Swing::Int2 {
    ...
    IL2CPP_REGISTER_METHOD(0x0182B110, Int2, operator___1, (app::Int2 a, app::Int2 b));
    IL2CPP_REGISTER_METHOD(0x0182B130, Int2, operator___2, (app::Int2 a, app::Int2 b));
    IL2CPP_REGISTER_METHOD(0x0182B150, Int2, operator___3, (app::Int2 a));
    IL2CPP_REGISTER_METHOD(0x0182B170, Int2, operator___4, (app::Int2 a, int32_t d));
    IL2CPP_REGISTER_METHOD(0x0182B190, Int2, operator___5, (int32_t d, app::Int2 a));
    IL2CPP_REGISTER_METHOD(0x0182B1B0, Int2, operator___6, (app::Int2 a, app::Int2 b));
    IL2CPP_REGISTER_METHOD(0x0182B1D0, Vector2, operator___7, (app::Int2 a, float d));
    IL2CPP_REGISTER_METHOD(0x0182B200, Vector2, operator___8, (float d, app::Int2 a));
    IL2CPP_REGISTER_METHOD(0x0182B230, Vector2, operator___9, (app::Int2 a, float d));
    IL2CPP_REGISTER_METHOD(0x0182B260, Vector2, operator___10, (float f, app::Int2 d));
    IL2CPP_REGISTER_METHOD(0x0182B290, Vector2, operator___11, (app::Int2 a, app::Int2 b));
    IL2CPP_REGISTER_METHOD(0x0182B2D0, Int2, Round, (app::Vector2 v));
    IL2CPP_REGISTER_METHOD(0x0182B390, Int2, operator__1, (app::Vector2 v));
    IL2CPP_REGISTER_METHOD(0x0182B3B0, Vector2, operator__2, (app::Int2 v));
    IL2CPP_REGISTER_METHOD(0x0182B3D0, Int2, operator__3, (app::Vector3 v));
    IL2CPP_REGISTER_METHOD(0x0182B400, Vector3, operator__4, (app::Int2 v));
    ...
    IL2CPP_REGISTER_METHOD(0x0014B5D0, String*, ToString_1, (app::Int2__Boxed * this_ptr));
    IL2CPP_REGISTER_METHOD(0x0014B6E0, String*, ToString_2, (app::Int2__Boxed * this_ptr, app::String* format));
