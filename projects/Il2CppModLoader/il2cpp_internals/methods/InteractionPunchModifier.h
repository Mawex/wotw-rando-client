...
IL2CPP_REGISTER_METHOD(0x00638F70, String *, get_InteractionName, (app::InteractionPunchModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x00639010, UberInteractionManager_PropertyIDCache *, get_PropertyCache, (app::InteractionPunchModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x006390F0, IEnumerable_1_System_String_ *, GetKeywordsForShader, (app::InteractionPunchModifier * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006394D0, void, __ctor, (app::InteractionPunchModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x00639750, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x006389E0, IEnumerable_1_System_String_ *, __n__0, (app::InteractionPunchModifier * this_ptr));
}
