...
namespace app::methods::System_Xml::EmptyEnumerator {
...
IL2CPP_REGISTER_METHOD(0x021F8150, Object *, IEnumerator_get_Current, (app::EmptyEnumerator * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04768EC0, EmptyEnumerator_System_Collections_IEnumerator_get_Current__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::EmptyEnumerator * this_ptr));
}
