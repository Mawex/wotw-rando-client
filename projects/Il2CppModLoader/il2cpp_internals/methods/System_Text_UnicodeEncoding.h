...
namespace app::methods::System_Text::UnicodeEncoding {
...
IL2CPP_REGISTER_METHOD(0x027D34A0, int32_t, GetByteCount_3, (app::UnicodeEncoding * this_ptr, app::uint16_t * chars, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x027D3B10, int32_t, GetBytes_3, (app::UnicodeEncoding * this_ptr, app::uint16_t * chars, int32_t char_count, app::uint8_t * bytes, int32_t byte_count));
...
IL2CPP_REGISTER_METHOD(0x027D3E60, int32_t, GetCharCount_2, (app::UnicodeEncoding * this_ptr, app::uint8_t * bytes, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x027D4240, int32_t, GetChars_2, (app::UnicodeEncoding * this_ptr, app::uint8_t * bytes, int32_t byte_count, app::uint16_t * chars, int32_t char_count));
IL2CPP_REGISTER_METHODINFO(0x0477EC38, UnicodeEncoding_GetChars_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027D43C0, String *, GetString, (app::UnicodeEncoding * this_ptr, app::Byte__Array * bytes, int32_t index, int32_t count));
IL2CPP_REGISTER_METHODINFO(0x0472F2A8, UnicodeEncoding_GetString__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027D4590, int32_t, GetByteCount_4, (app::UnicodeEncoding * this_ptr, app::uint16_t * chars, int32_t count, app::EncoderNLS * encoder));
IL2CPP_REGISTER_METHODINFO(0x04742530, UnicodeEncoding_GetByteCount_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027D4E40, int32_t, GetBytes_4, (app::UnicodeEncoding * this_ptr, app::uint16_t * chars, int32_t char_count, app::uint8_t * bytes, int32_t byte_count, app::EncoderNLS * encoder));
IL2CPP_REGISTER_METHODINFO(0x0478AC68, UnicodeEncoding_GetBytes_3__MethodInfo);
IL2CPP_REGISTER_METHOD(0x027D5970, int32_t, GetCharCount_3, (app::UnicodeEncoding * this_ptr, app::uint8_t * bytes, int32_t count, app::DecoderNLS * base_decoder));
IL2CPP_REGISTER_METHOD(0x027D63A0, int32_t, GetChars_3, (app::UnicodeEncoding * this_ptr, app::uint8_t * bytes, int32_t byte_count, app::uint16_t * chars, int32_t char_count, app::DecoderNLS * base_decoder));
IL2CPP_REGISTER_METHOD(0x027D6F20, Encoder *, GetEncoder, (app::UnicodeEncoding * this_ptr));
IL2CPP_REGISTER_METHOD(0x027D7090, Decoder *, GetDecoder, (app::UnicodeEncoding * this_ptr));
IL2CPP_REGISTER_METHOD(0x027D7200, Byte__Array *, GetPreamble, (app::UnicodeEncoding * this_ptr));
