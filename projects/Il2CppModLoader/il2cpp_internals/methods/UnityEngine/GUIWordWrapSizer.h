...
namespace app::methods::UnityEngine::GUIWordWrapSizer {
    IL2CPP_REGISTER_METHOD(0x029F9700, void, __ctor, (app::GUIWordWrapSizer * this_ptr, app::GUIStyle * style, app::GUIContent * content, app::GUILayoutOption__Array * options));
