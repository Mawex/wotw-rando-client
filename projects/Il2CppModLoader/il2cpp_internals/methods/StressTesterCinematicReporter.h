...
IL2CPP_REGISTER_METHOD(0x0066EB20, CameraController_1 *, get_Controller, (app::StressTesterCinematicReporter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x006708E0, void, __ctor, (app::StressTesterCinematicReporter * this_ptr));
}
