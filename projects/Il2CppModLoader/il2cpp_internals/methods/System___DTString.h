...
IL2CPP_REGISTER_METHOD(0x00107C30, CompareInfo *, get_CompareInfo, (app::_DTString__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0024A090, void, GetRegularToken, (app::_DTString__Boxed * this_ptr, app::TokenType__Enum * token_type, app::int32_t * token_value, app::DateTimeFormatInfo * dtfi));
IL2CPP_REGISTER_METHOD(0x0024A0A0, TokenType__Enum, GetSeparatorToken, (app::_DTString__Boxed * this_ptr, app::DateTimeFormatInfo * dtfi, app::int32_t * index_before_separator, app::uint16_t * char_before_separator));
...
IL2CPP_REGISTER_METHOD(0x0024A0D0, bool, MatchSpecifiedWords, (app::_DTString__Boxed * this_ptr, app::String * target, bool check_word_boundary, app::int32_t * match_length));
...
IL2CPP_REGISTER_METHOD(0x0024A150, int32_t, MatchLongestWords, (app::_DTString__Boxed * this_ptr, app::String__Array * words, app::int32_t * max_match_str_len));
...
IL2CPP_REGISTER_METHOD(0x0024A230, DTSubString, GetSubString, (app::_DTString__Boxed * this_ptr));
