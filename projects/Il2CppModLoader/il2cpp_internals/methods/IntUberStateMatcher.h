...
IL2CPP_REGISTER_METHOD(0x01B5F170, void, __ctor, (app::IntUberStateMatcher * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01B5F6F0, IntUberStateMatcher_IntRangeUberStatePair *, GetStatePairAt, (app::IntUberStateMatcher * this_ptr, int32_t index));
