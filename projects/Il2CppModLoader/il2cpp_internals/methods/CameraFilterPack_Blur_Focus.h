...
IL2CPP_REGISTER_METHOD(0x024D0E20, Material *, get_material, (app::CameraFilterPack_Blur_Focus * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024D1820, void, __ctor, (app::CameraFilterPack_Blur_Focus * this_ptr));
}
