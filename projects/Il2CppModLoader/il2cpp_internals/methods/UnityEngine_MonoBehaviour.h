...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::MonoBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0253CA70, Coroutine *, StartCoroutine_1, (app::MonoBehaviour * this_ptr, app::String * method_name));
IL2CPP_REGISTER_METHOD(0x0253CC00, Coroutine *, StartCoroutine_2, (app::MonoBehaviour * this_ptr, app::String * method_name, app::Object * value));
IL2CPP_REGISTER_METHODINFO(0x047411D8, MonoBehaviour_StartCoroutine_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0253CD90, Coroutine *, StartCoroutine_3, (app::MonoBehaviour * this_ptr, app::IEnumerator * routine));
IL2CPP_REGISTER_METHODINFO(0x0476BFA0, MonoBehaviour_StartCoroutine_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0253CF10, Coroutine *, StartCoroutine_Auto, (app::MonoBehaviour * this_ptr, app::IEnumerator * routine));
...
IL2CPP_REGISTER_METHOD(0x0253D4F0, Coroutine *, StartCoroutineManaged, (app::MonoBehaviour * this_ptr, app::String * method_name, app::Object * value));
IL2CPP_REGISTER_METHOD(0x0253D560, Coroutine *, StartCoroutineManaged2, (app::MonoBehaviour * this_ptr, app::IEnumerator * enumerator));
...
IL2CPP_REGISTER_METHOD(0x0253D680, String *, GetScriptClassName, (app::MonoBehaviour * this_ptr));
}
