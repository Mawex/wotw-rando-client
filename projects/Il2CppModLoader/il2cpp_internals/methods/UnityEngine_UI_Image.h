...
namespace app::methods::UnityEngine_UI::Image {
IL2CPP_REGISTER_METHOD(0x024B7660, void, __ctor, (app::Image * this_ptr));
IL2CPP_REGISTER_METHOD(0x024B76C0, Sprite *, get_sprite, (app::Image * this_ptr));
IL2CPP_REGISTER_METHOD(0x024B76D0, void, set_sprite, (app::Image * this_ptr, app::Sprite * value));
IL2CPP_REGISTER_METHOD(0x024B77A0, Sprite *, get_overrideSprite, (app::Image * this_ptr));
IL2CPP_REGISTER_METHOD(0x024B77B0, void, set_overrideSprite, (app::Image * this_ptr, app::Sprite * value));
IL2CPP_REGISTER_METHOD(0x024B7880, Sprite *, get_activeSprite, (app::Image * this_ptr));
IL2CPP_REGISTER_METHOD(0x024B7950, Image_Type__Enum, get_type, (app::Image * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024B7BF0, Image_FillMethod__Enum, get_fillMethod, (app::Image * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024B8280, Texture *, get_mainTexture, (app::Image * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024B87E0, Material *, get_material, (app::Image * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x024B8D40, Vector4, GetDrawingDimensions, (app::Image * this_ptr, bool should_preserve_aspect));
...
IL2CPP_REGISTER_METHOD(0x024BD240, Vector4, GetAdjustedBorders, (app::Image * this_ptr, app::Vector4 border, app::Rect adjusted_rect));
...
IL2CPP_REGISTER_METHOD(0x024BFE40, Vector2, MapCoordinate, (app::Image * this_ptr, app::Vector2 local, app::Rect rect));
