...
IL2CPP_REGISTER_METHOD(0x0303DB90, Shader *, get_ShaderSafe, (app::BaseEffect * this_ptr));
IL2CPP_REGISTER_METHOD(0x0303DCA0, Material *, get_Material, (app::BaseEffect * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0303E3A0, String *, GetShaderName, (app::BaseEffect * this_ptr));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::BaseEffect * this_ptr));
}
