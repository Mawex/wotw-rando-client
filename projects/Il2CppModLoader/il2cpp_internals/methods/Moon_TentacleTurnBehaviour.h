...
IL2CPP_REGISTER_METHOD(0x010BB4A0, BehaviourStatus__Enum, OnExecuteTask, (app::TentacleTurnBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x010BB750, void, OnExitTask, (app::TentacleTurnBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x010BBAE0, void, __ctor, (app::TentacleTurnBehaviour * this_ptr));
}
