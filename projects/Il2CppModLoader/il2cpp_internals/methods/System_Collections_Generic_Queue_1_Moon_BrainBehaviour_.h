...
namespace app::methods::System_Collections_Generic::Queue_1_Moon_BrainBehaviour_ {
...
IL2CPP_REGISTER_METHOD(0x02CA77B0, BrainBehaviour *, Dequeue, (app::Queue_1_Moon_BrainBehaviour_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047382F8, Queue_1_Moon_BrainBehaviour__Dequeue__MethodInfo);
IL2CPP_REGISTER_METHOD(0x0243CB70, void, __ctor, (app::Queue_1_Moon_BrainBehaviour_ * this_ptr));
