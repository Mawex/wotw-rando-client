...
IL2CPP_REGISTER_METHOD(0x019F0B80, bool, PerformCastInternal, (app::RaycastCommand cmd, app::RaycastHit * hit, app::int32_t * request_i_d, bool guarantee_immediate_result));
IL2CPP_REGISTER_METHODINFO(0x04725880, GenericCastManager_1_UnityEngine_RaycastCommand__PerformCastInternal__MethodInfo);
IL2CPP_REGISTER_METHOD(0x019F1CA0, bool, PerformMultipleCastsInternal, (app::RaycastCommand__Array * cmds, app::RaycastHit__Array * hits, app::Boolean__Array * hit_results, int32_t cmd_count, app::int32_t * request_i_d, bool guarantee_immediate_result));
...
IL2CPP_REGISTER_METHOD(0x019EE1D0, void, __ctor, (app::GenericCastManager_1_UnityEngine_RaycastCommand_ * this_ptr));
