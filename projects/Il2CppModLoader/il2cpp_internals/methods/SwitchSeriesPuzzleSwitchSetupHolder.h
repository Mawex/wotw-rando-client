...
IL2CPP_REGISTER_METHOD(0x01835240, SwitchSeriesPuzzleSetupData *, get_DeactivatedState, (app::SwitchSeriesPuzzleSwitchSetupHolder * this_ptr));
IL2CPP_REGISTER_METHOD(0x018352E0, SwitchSeriesPuzzleSetupData *, get_ActivatedState, (app::SwitchSeriesPuzzleSwitchSetupHolder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01835790, void, __ctor, (app::SwitchSeriesPuzzleSwitchSetupHolder * this_ptr));
}
