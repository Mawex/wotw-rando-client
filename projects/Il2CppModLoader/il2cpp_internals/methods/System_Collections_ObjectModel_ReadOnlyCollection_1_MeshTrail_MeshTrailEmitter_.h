...
namespace app::methods::System_Collections_ObjectModel::ReadOnlyCollection_1_MeshTrail_MeshTrailEmitter_ {
IL2CPP_REGISTER_METHOD(0x02B7DCF0, void, __ctor, (app::ReadOnlyCollection_1_MeshTrail_MeshTrailEmitter_ * this_ptr, app::IList_1_MeshTrail_MeshTrailEmitter_ * list));
IL2CPP_REGISTER_METHOD(0x02B7DD20, int32_t, get_Count, (app::ReadOnlyCollection_1_MeshTrail_MeshTrailEmitter_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02B80970, MeshTrail_MeshTrailEmitter, get_Item, (app::ReadOnlyCollection_1_MeshTrail_MeshTrailEmitter_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02B7DF30, IEnumerator_1_MeshTrail_MeshTrailEmitter_ *, GetEnumerator, (app::ReadOnlyCollection_1_MeshTrail_MeshTrailEmitter_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B80970, MeshTrail_MeshTrailEmitter, System_Collections_Generic_IList_T__get_Item, (app::ReadOnlyCollection_1_MeshTrail_MeshTrailEmitter_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02F17CD0, IEnumerator *, IEnumerable_GetEnumerator, (app::ReadOnlyCollection_1_MeshTrail_MeshTrailEmitter_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02F17D60, Object *, ICollection_get_SyncRoot, (app::ReadOnlyCollection_1_MeshTrail_MeshTrailEmitter_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B811E0, Object *, IList_get_Item, (app::ReadOnlyCollection_1_MeshTrail_MeshTrailEmitter_ * this_ptr, int32_t index));
