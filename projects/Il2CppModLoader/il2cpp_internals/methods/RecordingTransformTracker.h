...
IL2CPP_REGISTER_METHOD(0x00420EE0, RecordableParsingGroup__Enum, get_ParsingGroup, (app::RecordingTransformTracker * this_ptr));
IL2CPP_REGISTER_METHOD(0x008FB230, TrackingExclusions, get_TrackingExclusions, (app::RecordingTransformTracker * this_ptr));
