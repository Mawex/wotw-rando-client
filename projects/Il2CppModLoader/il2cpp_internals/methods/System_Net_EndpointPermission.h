...
namespace app::methods::System_Net::EndpointPermission {
IL2CPP_REGISTER_METHOD(0x01D25D60, void, __ctor_1, (app::EndpointPermission * this_ptr, app::String * hostname, int32_t port, app::TransportType__Enum transport));
IL2CPP_REGISTER_METHODINFO(0x047498B0, EndpointPermission__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FA280, String *, get_Hostname, (app::EndpointPermission * this_ptr));
IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Port, (app::EndpointPermission * this_ptr));
IL2CPP_REGISTER_METHOD(0x0052A010, TransportType__Enum, get_Transport, (app::EndpointPermission * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D25F90, String *, ToString, (app::EndpointPermission * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D26570, EndpointPermission *, Intersect_1, (app::EndpointPermission * this_ptr, app::EndpointPermission * perm));
IL2CPP_REGISTER_METHOD(0x01D26750, String *, IntersectHostname, (app::EndpointPermission * this_ptr, app::EndpointPermission * perm));
IL2CPP_REGISTER_METHOD(0x01D26A00, String *, Intersect_2, (app::EndpointPermission * this_ptr, app::String * addr1, app::String * addr2));
...
IL2CPP_REGISTER_METHOD(0x01D27320, void, __ctor_2, (app::EndpointPermission * this_ptr));
