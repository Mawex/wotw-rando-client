...
IL2CPP_REGISTER_METHOD(0x030F0670, JsonToken__Enum, Next, (app::String * json, app::Substr span, app::Substr * remainder, app::StringBuilder * buffer, app::double * number));
