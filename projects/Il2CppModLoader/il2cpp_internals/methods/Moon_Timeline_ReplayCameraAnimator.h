...
IL2CPP_REGISTER_METHOD(0x0077FA40, bool, get_IsControllingCamera, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0077FAC0, void, set_IsControllingCamera, (bool value));
IL2CPP_REGISTER_METHOD(0x0077FB50, Vector3, get_CurrentCameraTargetPosition, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x0077FBF0, void, set_CurrentCameraTargetPosition, (Vector3 value));
IL2CPP_REGISTER_METHOD(0x0077FC80, Vector3, get_CurrentCameraTargetVelocity, (MethodInfo * method));
