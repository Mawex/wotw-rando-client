...
IL2CPP_REGISTER_METHOD(0x0072F730, GameObject *, GetGroupParent, (app::RandomObjectGenerator * this_ptr));
IL2CPP_REGISTER_METHOD(0x0072F9D0, void, __ctor, (app::RandomObjectGenerator * this_ptr));
}
