...
IL2CPP_REGISTER_METHOD(0x002FA280, EventProvider_SessionInfo, get_Item1, (app::Tuple_2_System_Diagnostics_Tracing_EventProvider_SessionInfo_Boolean_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A5F4B0, void, __ctor, (app::Tuple_2_System_Diagnostics_Tracing_EventProvider_SessionInfo_Boolean_ * this_ptr, app::EventProvider_SessionInfo item1, bool item2));
...
IL2CPP_REGISTER_METHOD(0x02A62A80, String *, ToString, (app::Tuple_2_System_Diagnostics_Tracing_EventProvider_SessionInfo_Boolean_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A62C00, String *, ITupleInternal_ToString, (app::Tuple_2_System_Diagnostics_Tracing_EventProvider_SessionInfo_Boolean_ * this_ptr, app::StringBuilder * sb));
}
