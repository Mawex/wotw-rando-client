...
namespace app::methods::PhysicsUtils {
    ...
    IL2CPP_REGISTER_METHOD(0x01156720, LayerMask, get_GroundMask, ());
    IL2CPP_REGISTER_METHOD(0x01156810, LayerMask, get_ObstaclesMask, ());
    IL2CPP_REGISTER_METHOD(0x01156900, LayerMask, get_KillCharacterMask, ());
    IL2CPP_REGISTER_METHOD(0x011569F0, LayerMask, get_CharacterMask, ());
    IL2CPP_REGISTER_METHOD(0x01156AE0, LayerMask, get_PlayerMask, ());
    IL2CPP_REGISTER_METHOD(0x01156BD0, Comparer_1_UnityEngine_RaycastHit_*, get_NearesHitComparer, ());
    IL2CPP_REGISTER_METHOD(0x01156C70, LayerMask, GetMask, (app::PhysicsUtils_Mask__Enum mask));
    ...
    IL2CPP_REGISTER_METHOD(0x011571F0, void, __cctor, ());
} // namespace app::methods::PhysicsUtils
