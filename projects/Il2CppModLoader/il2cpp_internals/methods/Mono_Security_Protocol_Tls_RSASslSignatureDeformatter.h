...
namespace app::methods::Mono_Security_Protocol_Tls::RSASslSignatureDeformatter {
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_1, (app::RSASslSignatureDeformatter * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01F76900, void, __ctor_2, (app::RSASslSignatureDeformatter * this_ptr, app::AsymmetricAlgorithm * key));
