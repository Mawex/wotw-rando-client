...
IL2CPP_REGISTER_METHOD(0x002FBB40, String *, get_CurrencyEnglishName, (app::RegionInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9D0, String *, get_CurrencySymbol, (app::RegionInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_DisplayName, (app::RegionInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB990, String *, get_EnglishName, (app::RegionInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB9F0, String *, get_ISOCurrencySymbol, (app::RegionInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9B0, String *, get_NativeName, (app::RegionInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB60, String *, get_CurrencyNativeName, (app::RegionInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Name, (app::RegionInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB950, String *, get_ThreeLetterISORegionName, (app::RegionInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB00, String *, get_ThreeLetterWindowsRegionName, (app::RegionInfo * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_TwoLetterISORegionName, (app::RegionInfo * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01DEBEA0, String *, ToString, (app::RegionInfo * this_ptr));
