...
namespace app::methods::Moon_HierarchyPerformanceTest::HierarchyTestOutput {
IL2CPP_REGISTER_METHOD(0x014A35B0, void, __ctor, (app::HierarchyTestOutput * this_ptr, app::SceneTestData * data));
...
IL2CPP_REGISTER_METHOD(0x014A38B0, String *, FormatResult, (app::HierarchyTestOutput * this_ptr, app::String * tag, app::HPerfTestResult * result));
