...
IL2CPP_REGISTER_METHOD(0x03131550, void, SetAudioChannelMatrix, (int32_t handle, Single__Array * values, int32_t numValues));
...
IL2CPP_REGISTER_METHOD(0x03131890, bool, UpdateTextureGL, (int32_t handle, int32_t textureID, int32_t * frameNumber));
IL2CPP_REGISTER_METHOD(0x03131950, bool, GetFramePixels, (int32_t handle, void * data, int32_t bufferWidth, int32_t bufferHeight, int32_t * frameNumber));
...
IL2CPP_REGISTER_METHOD(0x03131F60, void, GetFrameBufferTimes, (int32_t handle, void * dest, int32_t destSizeBytes));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (AVProWindowsMediaPlugin * __this));
}
