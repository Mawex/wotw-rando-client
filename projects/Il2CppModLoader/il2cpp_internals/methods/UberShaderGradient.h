...
IL2CPP_REGISTER_METHOD(0x002FB9B0, Gradient *, get_Gradient, (app::UberShaderGradient * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01912900, void, __ctor, (app::UberShaderGradient * this_ptr));
}
