...
namespace app::methods::Moon_uberSerializationWisp::PlayerUberStateHoldables {
    ...
    IL2CPP_REGISTER_METHOD(0x00F3A430, void, __ctor, (app::PlayerUberStateHoldables * this_ptr, app::Action * set_dirty_callback));
