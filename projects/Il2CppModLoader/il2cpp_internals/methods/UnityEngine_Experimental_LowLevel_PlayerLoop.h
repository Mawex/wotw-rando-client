...
IL2CPP_REGISTER_METHOD(0x02431FB0, PlayerLoopSystem, GetDefaultPlayerLoop, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x02432A20, PlayerLoopSystemInternal__Array *, GetDefaultPlayerLoopInternal, (MethodInfo * method));
