...
namespace app::methods::Moon_Timeline::PreLoadingEntity {
IL2CPP_REGISTER_METHOD(0x002FBBE0, SceneMetaData *, get_SceneMetaData, (app::PreLoadingEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0077C280, void, __ctor, (app::PreLoadingEntity * this_ptr));
}
