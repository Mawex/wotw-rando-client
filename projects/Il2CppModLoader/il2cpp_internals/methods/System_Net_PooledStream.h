...
namespace app::methods::System_Net::PooledStream {
IL2CPP_REGISTER_METHOD(0x01BCBCB0, void, __ctor_1, (app::PooledStream * this_ptr, app::Object * owner));
IL2CPP_REGISTER_METHOD(0x01BCBF20, void, __ctor_2, (app::PooledStream * this_ptr, app::ConnectionPool * connection_pool, app::TimeSpan lifetime, bool check_lifetime));
IL2CPP_REGISTER_METHOD(0x01BCC0D0, bool, get_JustConnected, (app::PooledStream * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB80, IPAddress *, get_ServerAddress, (app::PooledStream * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BCC1B0, Object *, get_Owner, (app::PooledStream * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BCC200, void, set_Owner, (app::PooledStream * this_ptr, app::Object * value));
IL2CPP_REGISTER_METHOD(0x002FB9F0, ConnectionPool *, get_Pool, (app::PooledStream * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BCC2F0, ServicePoint *, get_ServicePoint, (app::PooledStream * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBA0, NetworkStream *, get_NetworkStream, (app::PooledStream * this_ptr));
IL2CPP_REGISTER_METHOD(0x01BCCDE0, void, set_NetworkStream, (app::PooledStream * this_ptr, app::NetworkStream * value));
IL2CPP_REGISTER_METHOD(0x01BCCDF0, Socket *, get_Socket, (app::PooledStream * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BCD420, IAsyncResult *, BeginRead, (app::PooledStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t size, app::AsyncCallback * callback, app::Object * state));
IL2CPP_REGISTER_METHOD(0x01BCD450, IAsyncResult *, UnsafeBeginRead, (app::PooledStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t size, app::AsyncCallback * callback, app::Object * state));
IL2CPP_REGISTER_METHOD(0x01BCD480, int32_t, EndRead, (app::PooledStream * this_ptr, app::IAsyncResult * async_result));
IL2CPP_REGISTER_METHOD(0x01BCD4B0, IAsyncResult *, BeginWrite, (app::PooledStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t size, app::AsyncCallback * callback, app::Object * state));
IL2CPP_REGISTER_METHOD(0x01BCD4E0, IAsyncResult *, UnsafeBeginWrite, (app::PooledStream * this_ptr, app::Byte__Array * buffer, int32_t offset, int32_t size, app::AsyncCallback * callback, app::Object * state));
IL2CPP_REGISTER_METHOD(0x01BCD510, void, EndWrite, (app::PooledStream * this_ptr, app::IAsyncResult * async_result));
IL2CPP_REGISTER_METHOD(0x01BCD540, IAsyncResult *, BeginMultipleWrite, (app::PooledStream * this_ptr, app::BufferOffsetSize_1__Array * buffers, app::AsyncCallback * callback, app::Object * state));
...
IL2CPP_REGISTER_METHOD(0x01BCD5D0, Task *, FlushAsync, (app::PooledStream * this_ptr, app::CancellationToken cancellation_token));
