...
namespace app::methods::Moon_Telemetry_Performance::ProfilingSettings {
IL2CPP_REGISTER_METHOD(0x00E33C00, void, CacheDefaults, ());
IL2CPP_REGISTER_METHOD(0x00E33DF0, void, CreateSettings, ());
IL2CPP_REGISTER_METHOD(0x00E346B0, IProfilingSetting *, GetSettingForType, (app::ProfilingSettings_SettingType__Enum type));
...
IL2CPP_REGISTER_METHOD(0x00E38490, String *, ParseArgument, (app::String * flag));
...
IL2CPP_REGISTER_METHOD(0x00E389A0, ProfilingSettings_BulkSettings *, SetStateBulk_1, (app::ProfilingSettings_BulkSettings * settings));
IL2CPP_REGISTER_METHOD(0x00E38A60, ProfilingSettings_BulkSettings *, SetStateBulk_2, (app::ProfilingSettings_SettingType__Enum__Array * settings_to_disable, app::ProfilingSettings_SettingType__Enum__Array * settings_to_enable, app::ProfilingSettings_SettingType__Enum__Array * settings_to_restore));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::ProfilingSettings * this_ptr));
