...
namespace app::methods::System_Net_Configuration::WebRequestModulesSection {
IL2CPP_REGISTER_METHOD(0x01E999B0, void, __ctor, (app::WebRequestModulesSection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0472EAF8, WebRequestModulesSection__ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E999E0, ConfigurationPropertyCollection *, get_Properties, (app::WebRequestModulesSection * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0477A688, WebRequestModulesSection_get_Properties__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01E99A10, WebRequestModuleElementCollection *, get_WebRequestModules, (app::WebRequestModulesSection * this_ptr));
