...
IL2CPP_REGISTER_METHOD(0x00440A20, OriSpeechSounds_EmotionSounds *, GetSoundSetForEmotion, (app::OriSpeechSounds * this_ptr, app::EmotionType__Enum emotion));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::OriSpeechSounds * this_ptr));
}
