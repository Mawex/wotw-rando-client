...
IL2CPP_REGISTER_METHOD(0x002FB930, String *, get_Namespace, (app::XmlTypeAttribute * this_ptr));
IL2CPP_REGISTER_METHOD(0x0194CBD0, String *, get_TypeName, (app::XmlTypeAttribute * this_ptr));
