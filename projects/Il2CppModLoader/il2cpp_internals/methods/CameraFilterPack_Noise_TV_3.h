...
IL2CPP_REGISTER_METHOD(0x02483840, Material *, get_material, (app::CameraFilterPack_Noise_TV_3 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E9B00, void, __ctor, (app::CameraFilterPack_Noise_TV_3 * this_ptr));
}
