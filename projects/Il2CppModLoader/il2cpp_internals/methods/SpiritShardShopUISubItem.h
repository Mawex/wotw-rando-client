...
IL2CPP_REGISTER_METHOD(0x002FB9D0, PlayerUberStateShards_Shard *, get_SpiritShard, (app::SpiritShardShopUISubItem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::SpiritShardShopUISubItem * this_ptr));
}
