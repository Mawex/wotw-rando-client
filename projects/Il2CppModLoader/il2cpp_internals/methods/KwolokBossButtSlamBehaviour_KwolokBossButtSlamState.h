...
IL2CPP_REGISTER_METHOD(0x0124A6F0, void, __ctor, (app::KwolokBossButtSlamBehaviour_KwolokBossButtSlamState * this_ptr, app::KwolokBossButtSlamBehaviour * behaviour));
