...
IL2CPP_REGISTER_METHOD(0x02463C80, Material *, get_material, (app::CameraFilterPack_Edge_BlackLine * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0136E200, void, __ctor, (app::CameraFilterPack_Edge_BlackLine * this_ptr));
}
