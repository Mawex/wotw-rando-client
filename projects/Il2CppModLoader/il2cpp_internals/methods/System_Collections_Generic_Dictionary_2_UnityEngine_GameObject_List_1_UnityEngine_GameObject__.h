...
namespace app::methods::System_Collections_Generic::Dictionary_2_UnityEngine_GameObject_List_1_UnityEngine_GameObject__ {
    ...
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor, (app::Dictionary_2_UnityEngine_GameObject_List_1_UnityEngine_GameObject_ * this_ptr));
