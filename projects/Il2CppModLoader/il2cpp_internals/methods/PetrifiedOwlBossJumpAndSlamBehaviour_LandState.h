...
namespace app::methods::PetrifiedOwlBossJumpAndSlamBehaviour_LandState {
    IL2CPP_REGISTER_METHOD(0x017754C0, void, __ctor, (app::PetrifiedOwlBossJumpAndSlamBehaviour_LandState * this_ptr, app::PetrifiedOwlBossJumpAndSlamBehaviour * behaviour));
