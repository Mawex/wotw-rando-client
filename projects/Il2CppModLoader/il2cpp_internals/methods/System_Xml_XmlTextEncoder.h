...
namespace app::methods::System_Xml::XmlTextEncoder {
IL2CPP_REGISTER_METHOD(0x01714D10, void, __ctor, (app::XmlTextEncoder * this_ptr, app::TextWriter * text_writer));
...
IL2CPP_REGISTER_METHOD(0x01714F10, String *, get_AttributeValue, (app::XmlTextEncoder * this_ptr));
