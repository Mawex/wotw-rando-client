...
namespace app::methods::FixedRandom {
    ...
    IL2CPP_REGISTER_METHOD(0x02552EB0, Vector2, InsideUnitCircleValuesFromPosition, (app::Vector3 position, int32_t offset));
    IL2CPP_REGISTER_METHOD(0x02552F10, Vector2, InsideUnitCircleValueFromInt, (int32_t index));
    IL2CPP_REGISTER_METHOD(0x02552F70, Vector3, InsideUnitSphereValuesFromPosition, (app::Vector3 position, int32_t offset));
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::FixedRandom * this_ptr));
    IL2CPP_REGISTER_METHOD(0x02553110, void, __cctor, ());
    IL2CPP_REGISTER_METHOD(0x015E83F0, Object*, GetRandomListItem_1, (app::List_1_System_Object_ * list, int32_t values_index));
    IL2CPP_REGISTER_METHOD(0x015E83F0, Object*, GetRandomListItem_2, (app::List_1_System_Object_ * list, app::Vector3 position));
    IL2CPP_REGISTER_METHOD(0x015E8360, Object*, GetRandomArrayItem_1, (app::Object__Array * list, int32_t values_index));
    IL2CPP_REGISTER_METHOD(0x015E8360, Object*, GetRandomArrayItem_2, (app::Object__Array * list, app::Vector3 position));
    IL2CPP_REGISTER_METHOD(0x015E8360, TextureAnimationWithTransitions*, GetRandomArrayItem_3, (app::TextureAnimationWithTransitions__Array * list, int32_t values_index));
    IL2CPP_REGISTER_METHODINFO(0x0472FD00, FixedRandom_GetRandomArrayItem_2__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x015E83F0, GameObject*, GetRandomListItem_3, (app::List_1_UnityEngine_GameObject_ * list, app::Vector3 position));
    IL2CPP_REGISTER_METHODINFO(0x0477BA10, FixedRandom_GetRandomListItem_2__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x015E83F0, TargetSpheres_Sphere*, GetRandomListItem_4, (app::List_1_TargetSpheres_Sphere_ * list, int32_t values_index));
    IL2CPP_REGISTER_METHODINFO(0x047674A0, FixedRandom_GetRandomListItem_3__MethodInfo);
    IL2CPP_REGISTER_METHOD(0x015E8360, WormHole*, GetRandomArrayItem_4, (app::WormHole__Array * list, int32_t values_index));
