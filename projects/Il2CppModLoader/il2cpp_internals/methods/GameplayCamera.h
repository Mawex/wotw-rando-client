...
IL2CPP_REGISTER_METHOD(0x0040B220, Camera *, get_Camera, (app::GameplayCamera * this_ptr));
IL2CPP_REGISTER_METHOD(0x0040B240, Transform *, get_GameplayPuppet, (app::GameplayCamera * this_ptr));
IL2CPP_REGISTER_METHOD(0x0040B270, CameraPostProcessing *, get_CameraPostProcessing, (app::GameplayCamera * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0040CC90, Transform *, get_Target, (app::GameplayCamera * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0040D3B0, Bounds, get_CameraBoundingBox, (app::GameplayCamera * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0040D4D0, Vector3, get_CameraCenterInGameplayPlane, (app::GameplayCamera * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0040E9A0, Vector3, ProjectPointOnZ, (app::GameplayCamera * this_ptr, app::Vector3 point));
...
IL2CPP_REGISTER_METHOD(0x0040EF70, SuspendableMask__Enum, get_Mask, (app::GameplayCamera * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0040F110, void, __ctor, (app::GameplayCamera * this_ptr));
}
