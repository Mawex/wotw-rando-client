...
namespace app::methods::Newtonsoft_Json_Utilities::CollectionUtils {
IL2CPP_REGISTER_METHOD(0x01C00BD0, bool, IsDictionaryType, (app::Type * type));
IL2CPP_REGISTER_METHOD(0x01C00D90, ConstructorInfo *, ResolveEnumerableCollectionConstructor_1, (app::Type * collection_type, app::Type * collection_item_type));
IL2CPP_REGISTER_METHOD(0x01C00EF0, ConstructorInfo *, ResolveEnumerableCollectionConstructor_2, (app::Type * collection_type, app::Type * collection_item_type, app::Type * constructor_argument_type));
IL2CPP_REGISTER_METHOD(0x01C011C0, IList_1_System_Int32_ *, GetDimensions, (app::IList * values, int32_t dimensions_count));
...
IL2CPP_REGISTER_METHOD(0x01C01980, Object *, JaggedArrayGetValue, (app::IList * values, app::Int32__Array * indices));
IL2CPP_REGISTER_METHOD(0x01C01AB0, Array *, ToMultidimensionalArray, (app::IList * values, app::Type * type, int32_t rank));
...
IL2CPP_REGISTER_METHOD(0x01586730, Object__Array *, ArrayEmpty_1, ());
IL2CPP_REGISTER_METHODINFO(0x04769688, CollectionUtils_ArrayEmpty__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01586730, Byte__Array *, ArrayEmpty_2, ());
...
IL2CPP_REGISTER_METHOD(0x01586730, Int32__Array *, ArrayEmpty_3, ());
IL2CPP_REGISTER_METHODINFO(0x0475C328, CollectionUtils_ArrayEmpty_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01586730, DynamicMetaObject__Array *, ArrayEmpty_4, ());
...
IL2CPP_REGISTER_METHOD(0x01586730, Expression__Array *, ArrayEmpty_5, ());
...
IL2CPP_REGISTER_METHOD(0x01586730, String__Array *, ArrayEmpty_6, ());
