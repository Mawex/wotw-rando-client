...
IL2CPP_REGISTER_METHOD(0x0064D930, Vector3, get_Target, (app::HornBugGuardBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00615280, void, __ctor, (app::HornBugGuardBehaviour * this_ptr));
