...
namespace app::methods::EnemyZone {
    IL2CPP_REGISTER_METHOD(0x0043D9A0, SelectableCategory__Enum, get_Category, (app::EnemyZone * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::EnemyZone * this_ptr));
