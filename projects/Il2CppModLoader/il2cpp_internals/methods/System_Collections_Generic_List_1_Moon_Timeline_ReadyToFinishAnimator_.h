...
namespace app::methods::System_Collections_Generic::List_1_Moon_Timeline_ReadyToFinishAnimator_ {
...
IL2CPP_REGISTER_METHOD(0x025F0B10, List_1_T_Enumerator_Moon_Timeline_ReadyToFinishAnimator_, GetEnumerator, (app::List_1_Moon_Timeline_ReadyToFinishAnimator_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x047271B8, List_1_Moon_Timeline_ReadyToFinishAnimator__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_Moon_Timeline_ReadyToFinishAnimator_ * this_ptr));
