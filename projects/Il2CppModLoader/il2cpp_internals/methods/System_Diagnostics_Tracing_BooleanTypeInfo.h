...
namespace app::methods::System_Diagnostics_Tracing::BooleanTypeInfo {
...
IL2CPP_REGISTER_METHOD(0x017474A0, void, WriteData, (app::BooleanTypeInfo * this_ptr, app::TraceLoggingDataCollector * collector, app::bool * value));
