...
namespace app::methods::System_Text_RegularExpressions::Match {
IL2CPP_REGISTER_METHOD(0x025823A0, Match *, get_Empty, ());
IL2CPP_REGISTER_METHOD(0x02582440, void, __ctor_1, (app::Match * this_ptr, app::Regex * regex, int32_t capcount, app::String * text, int32_t begpos, int32_t len, int32_t startpos));
...
IL2CPP_REGISTER_METHOD(0x02582670, GroupCollection *, get_Groups, (app::Match * this_ptr));
IL2CPP_REGISTER_METHOD(0x025827D0, Match *, NextMatch, (app::Match * this_ptr));
IL2CPP_REGISTER_METHOD(0x02582820, String *, GroupToStringImpl, (app::Match * this_ptr, int32_t groupnum));
IL2CPP_REGISTER_METHOD(0x02582990, String *, LastGroupToStringImpl, (app::Match * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02583650, void, __ctor_2, (app::Match * this_ptr));
