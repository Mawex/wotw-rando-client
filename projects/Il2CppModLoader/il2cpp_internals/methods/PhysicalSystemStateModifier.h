...
IL2CPP_REGISTER_METHOD(0x014FBD90, void, __ctor, (app::PhysicalSystemStateModifier * this_ptr));
IL2CPP_REGISTER_METHOD(0x014FBDB0, Dictionary_2_System_Int32_System_Type_ *, GetIdToTypeMap, (app::PhysicalSystemStateModifier * this_ptr));
}
