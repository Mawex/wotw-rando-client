...
namespace app::methods::frameworks_loading_Prewarmers::ResourcesLoadPrewarmOperation {
IL2CPP_REGISTER_METHOD(0x00F61D00, void, __ctor, (app::ResourcesLoadPrewarmOperation * this_ptr));
