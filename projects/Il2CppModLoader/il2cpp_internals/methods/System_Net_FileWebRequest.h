...
namespace app::methods::System_Net::FileWebRequest {
...
IL2CPP_REGISTER_METHOD(0x002FB9B0, String *, get_ConnectionGroupName, (app::FileWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D28680, String *, get_ContentType, (app::FileWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x01D28720, void, set_ContentType, (app::FileWebRequest * this_ptr, app::String * value));
IL2CPP_REGISTER_METHOD(0x002FB9F0, ICredentials *, get_Credentials, (app::FileWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBA00, void, set_Credentials, (app::FileWebRequest * this_ptr, app::ICredentials * value));
IL2CPP_REGISTER_METHOD(0x002FBB60, WebHeaderCollection *, get_Headers, (app::FileWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBB80, String *, get_Method, (app::FileWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBC0, IWebProxy *, get_Proxy, (app::FileWebRequest * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBC80, Uri *, get_RequestUri, (app::FileWebRequest * this_ptr));
IL2CPP_REGISTER_METHOD(0x01D289A0, IAsyncResult *, BeginGetRequestStream, (app::FileWebRequest * this_ptr, app::AsyncCallback * callback, app::Object * state));
IL2CPP_REGISTER_METHODINFO(0x0478B620, FileWebRequest_BeginGetRequestStream__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01D28E20, IAsyncResult *, BeginGetResponse, (app::FileWebRequest * this_ptr, app::AsyncCallback * callback, app::Object * state));
...
IL2CPP_REGISTER_METHOD(0x01D29220, Stream *, EndGetRequestStream, (app::FileWebRequest * this_ptr, app::IAsyncResult * async_result));
IL2CPP_REGISTER_METHODINFO(0x0472A808, FileWebRequest_EndGetRequestStream__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01D294C0, WebResponse *, EndGetResponse, (app::FileWebRequest * this_ptr, app::IAsyncResult * async_result));
IL2CPP_REGISTER_METHODINFO(0x04757420, FileWebRequest_EndGetResponse__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01D29760, Stream *, GetRequestStream, (app::FileWebRequest * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0476E2B8, FileWebRequest_GetRequestStream__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01D299D0, WebResponse *, GetResponse, (app::FileWebRequest * this_ptr));
