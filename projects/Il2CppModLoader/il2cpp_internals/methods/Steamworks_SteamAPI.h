...
IL2CPP_REGISTER_METHOD(0x016016E0, HSteamUser, GetHSteamUserCurrent, ());
IL2CPP_REGISTER_METHOD(0x01601800, HSteamPipe, GetHSteamPipe, ());
IL2CPP_REGISTER_METHOD(0x01601930, HSteamUser, GetHSteamUser, ());
}
