...
IL2CPP_REGISTER_METHOD(0x00C73A70, String__Array *, GetDataHeaderNames, (app::ProfilingDataCaptureAgent * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C743B0, String__Array *, GetFrameData_1, (app::ProfilingDataCaptureAgent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::ProfilingDataCaptureAgent * this_ptr));
}
