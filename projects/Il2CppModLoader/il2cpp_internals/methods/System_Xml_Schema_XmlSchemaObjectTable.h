...
namespace app::methods::System_Xml_Schema::XmlSchemaObjectTable {
IL2CPP_REGISTER_METHOD(0x01CB7370, void, __ctor, (app::XmlSchemaObjectTable * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01CB8030, XmlSchemaObject *, get_Item, (app::XmlSchemaObjectTable * this_ptr, app::XmlQualifiedName * name));
IL2CPP_REGISTER_METHOD(0x01CB8130, ICollection *, get_Values, (app::XmlSchemaObjectTable * this_ptr));
IL2CPP_REGISTER_METHOD(0x01CB82A0, IDictionaryEnumerator *, GetEnumerator, (app::XmlSchemaObjectTable * this_ptr));
}
