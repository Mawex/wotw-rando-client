...
namespace app::methods::Moon_Timeline::PassiveStateVolitileOverrideAnimator {
IL2CPP_REGISTER_METHOD(0x01E78F40, IPassiveStateDescriptor *, get_ResolvedDescriptor, (app::PassiveStateVolitileOverrideAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01E79290, void, __ctor, (app::PassiveStateVolitileOverrideAnimator * this_ptr));
}
