...
IL2CPP_REGISTER_METHOD(0x00413180, SuspendableMask__Enum, get_Mask, (app::GameplaySoundManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00414040, void, __ctor, (app::GameplaySoundManager * this_ptr));
