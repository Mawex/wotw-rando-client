...
IL2CPP_REGISTER_METHOD(0x008519C0, BuilderNPC_State__Enum, get_DialogState, (app::MinerBuilderDialogBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00615280, void, __ctor, (app::MinerBuilderDialogBehaviour * this_ptr));
}
