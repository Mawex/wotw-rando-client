...
IL2CPP_REGISTER_METHOD(0x008C6BF0, BehaviourStatus__Enum, OnExecute, (app::WandererDesertQuestCompletedInteractionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x0060C1C0, void, __ctor, (app::WandererDesertQuestCompletedInteractionBehaviour * this_ptr));
}
