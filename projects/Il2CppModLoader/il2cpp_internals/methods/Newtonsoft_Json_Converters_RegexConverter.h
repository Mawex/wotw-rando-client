...
namespace app::methods::Newtonsoft_Json_Converters::RegexConverter {
...
IL2CPP_REGISTER_METHOD(0x01A553D0, Object *, ReadJson, (app::RegexConverter * this_ptr, app::JsonReader * reader, app::Type * object_type, app::Object * existing_value, app::JsonSerializer * serializer));
IL2CPP_REGISTER_METHODINFO(0x0470E5E8, RegexConverter_ReadJson__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A554E0, Object *, ReadRegexString, (app::RegexConverter * this_ptr, app::JsonReader * reader));
IL2CPP_REGISTER_METHODINFO(0x04739988, RegexConverter_ReadRegexString__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01A55790, Regex *, ReadRegexObject, (app::RegexConverter * this_ptr, app::JsonReader * reader, app::JsonSerializer * serializer));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::RegexConverter * this_ptr));
}
