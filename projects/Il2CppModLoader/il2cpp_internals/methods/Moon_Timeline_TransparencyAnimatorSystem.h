...
namespace app::methods::Moon_Timeline::TransparencyAnimatorSystem {
...
IL2CPP_REGISTER_METHOD(0x00597B10, UpdateType__Enum, get_UpdateType, (app::TransparencyAnimatorSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9D0, TransparencyAnimatorSystemStrategy *, get_Strategy, (app::TransparencyAnimatorSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D0DD70, bool, GetHandoverAlpha, (app::TransparencyAnimatorSystem * this_ptr, app::Renderer * renderer, app::UberShaderProperty_Color__Enum property, app::float * value));
...
IL2CPP_REGISTER_METHOD(0x00D0E3A0, void, ApplyTransparency, (app::Renderer * renderer, app::UberShaderProperty_Color__Enum property, float value, bool enable_disable, app::bool * got_hidden));
IL2CPP_REGISTER_METHOD(0x00D0E830, void, __ctor, (app::TransparencyAnimatorSystem * this_ptr));
