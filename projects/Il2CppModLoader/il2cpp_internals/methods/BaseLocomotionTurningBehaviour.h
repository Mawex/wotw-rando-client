...
IL2CPP_REGISTER_METHOD(0x00F863D0, BehaviourStatus__Enum, OnExecuteTask, (app::BaseLocomotionTurningBehaviour * this_ptr, app::IContext * context));
IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, ShouldPauseLocomotion, (app::BaseLocomotionTurningBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x005B3EC0, void, __ctor, (app::BaseLocomotionTurningBehaviour * this_ptr));
}
