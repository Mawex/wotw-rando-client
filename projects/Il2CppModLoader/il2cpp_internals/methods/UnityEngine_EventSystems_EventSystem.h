...
namespace app::methods::UnityEngine_EventSystems::EventSystem {
IL2CPP_REGISTER_METHOD(0x01F1BDD0, void, __ctor, (app::EventSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F1C1D0, BaseInputModule *, get_currentInputModule, (app::EventSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F1A590, GameObject *, get_firstSelectedGameObject, (app::EventSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9E0, void, set_firstSelectedGameObject, (app::EventSystem * this_ptr, app::GameObject * value));
IL2CPP_REGISTER_METHOD(0x01F1A580, GameObject *, get_currentSelectedGameObject, (app::EventSystem * this_ptr));
IL2CPP_REGISTER_METHOD(0x01F1B660, GameObject *, get_lastSelectedGameObject, (app::EventSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F1C630, BaseEventData *, get_baseEventDataCache, (app::EventSystem * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F1DAC0, String *, ToString, (app::EventSystem * this_ptr));
