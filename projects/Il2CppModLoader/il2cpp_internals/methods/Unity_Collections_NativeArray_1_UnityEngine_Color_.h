...
namespace app::methods::Unity_Collections::NativeArray_1_UnityEngine_Color_ {
IL2CPP_REGISTER_METHOD(0x001DF770, void, __ctor, (app::NativeArray_1_UnityEngine_Color___Boxed * this_ptr, int32_t length, app::Allocator__Enum allocator, app::NativeArrayOptions__Enum options));
...
IL2CPP_REGISTER_METHOD(0x001E01B0, Color, get_Item, (app::NativeArray_1_UnityEngine_Color___Boxed * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x001DFA50, Color__Array *, ToArray, (app::NativeArray_1_UnityEngine_Color___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001DFB30, NativeArray_1_T_Enumerator_UnityEngine_Color_, GetEnumerator, (app::NativeArray_1_UnityEngine_Color___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001DFB90, IEnumerator_1_UnityEngine_Color_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::NativeArray_1_UnityEngine_Color___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001DFC30, IEnumerator *, IEnumerable_GetEnumerator, (app::NativeArray_1_UnityEngine_Color___Boxed * this_ptr));
