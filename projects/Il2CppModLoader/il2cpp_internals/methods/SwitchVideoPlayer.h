...
IL2CPP_REGISTER_METHOD(0x002FB9F0, OnDelegate *, get_OnPlaybackFinished, (app::SwitchVideoPlayer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::SwitchVideoPlayer * this_ptr));
}
