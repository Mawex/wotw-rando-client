...
IL2CPP_REGISTER_METHOD(0x00F116C0, BehaviourStatus__Enum, OnExecute, (app::LaserShooterBeamAttackWithCycleRepetitionBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00F12970, void, __ctor, (app::LaserShooterBeamAttackWithCycleRepetitionBehaviour * this_ptr));
