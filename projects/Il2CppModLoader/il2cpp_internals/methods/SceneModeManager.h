...
IL2CPP_REGISTER_METHOD(0x00BB0B90, SceneModeManager_SceneModeOverride__Enum, get_Mode, (MethodInfo * method));
IL2CPP_REGISTER_METHOD(0x00BB0C30, void, set_Mode, (SceneModeManager_SceneModeOverride__Enum value));
IL2CPP_REGISTER_METHOD(0x00420EE0, SceneModeManager_SceneModeOverride__Enum, get_EditorPrefMode, (MethodInfo * method));
...
IL2CPP_REGISTER_METHOD(0x00BB1300, List_1_SceneManagerScene_ *, GetAllSceneRoots, (MethodInfo * method));
