...
namespace app::methods::System_Collections_Generic::List_1_DelayedAction_ {
IL2CPP_REGISTER_METHOD(0x025EFC50, DelayedAction *, get_Item, (app::List_1_DelayedAction_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor, (app::List_1_DelayedAction_ * this_ptr));
