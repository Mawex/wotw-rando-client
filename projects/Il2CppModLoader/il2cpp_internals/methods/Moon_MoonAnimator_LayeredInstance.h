...
IL2CPP_REGISTER_METHOD(0x002FB9F0, MoonAnimator_AnimationInstance__Array *, get_InputInstances, (app::MoonAnimator_LayeredInstance * this_ptr));
IL2CPP_REGISTER_METHOD(0x02119390, Playable, get_Playable, (app::MoonAnimator_LayeredInstance * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x005D89A0, MoonAnimator_AnimationInstanceType__Enum, get_Type, (app::MoonAnimator_LayeredInstance * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::MoonAnimator_LayeredInstance * this_ptr));
}
