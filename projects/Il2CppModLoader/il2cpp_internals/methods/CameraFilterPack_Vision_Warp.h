...
IL2CPP_REGISTER_METHOD(0x020FA9A0, Material *, get_material, (app::CameraFilterPack_Vision_Warp * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020FB2F0, void, __ctor, (app::CameraFilterPack_Vision_Warp * this_ptr));
}
