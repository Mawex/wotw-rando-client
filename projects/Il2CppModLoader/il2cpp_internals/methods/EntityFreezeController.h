...
IL2CPP_REGISTER_METHOD(0x00608710, SuspendableMask__Enum, get_Mask, (app::EntityFreezeController * this_ptr));
IL2CPP_REGISTER_METHOD(0x00C919E0, void, set_Mask, (app::EntityFreezeController * this_ptr, app::SuspendableMask__Enum value));
IL2CPP_REGISTER_METHOD(0x00C91A90, void, __ctor, (app::EntityFreezeController * this_ptr));
}
