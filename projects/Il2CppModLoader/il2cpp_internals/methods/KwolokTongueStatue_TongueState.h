...
IL2CPP_REGISTER_METHOD(0x00EFB0C0, void, __ctor, (app::KwolokTongueStatue_TongueState * this_ptr, app::KwolokTongueStatue * owner, app::KwolokTongueStatue_KwolowTongueStatueState__Enum desired_state, app::MoonTimeline * timeline));
IL2CPP_REGISTER_METHOD(0x00EFB0D0, bool, get_IsPerforming, (app::KwolokTongueStatue_TongueState * this_ptr));
IL2CPP_REGISTER_METHOD(0x00EFB0F0, DesiredUberStateByte *, get_DesiredState, (app::KwolokTongueStatue_TongueState * this_ptr));
IL2CPP_REGISTER_METHOD(0x00EFB150, DesiredUberStateByte *, CreateDesiredState, (app::KwolokTongueStatue_TongueState * this_ptr, uint8_t desired_value));
