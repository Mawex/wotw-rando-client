...
IL2CPP_REGISTER_METHOD(0x00DD3140, DashableSwitchSetupData *, get_DeactivatedState, (app::DashableSwitchSetupHolder * this_ptr));
IL2CPP_REGISTER_METHOD(0x00DD31E0, DashableSwitchSetupData *, get_ActivatedState, (app::DashableSwitchSetupHolder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00DD3830, void, __ctor, (app::DashableSwitchSetupHolder * this_ptr));
}
