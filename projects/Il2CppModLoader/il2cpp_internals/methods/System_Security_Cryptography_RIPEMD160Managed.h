...
namespace app::methods::System_Security_Cryptography::RIPEMD160Managed {
IL2CPP_REGISTER_METHOD(0x028E0A70, void, __ctor, (app::RIPEMD160Managed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x028E0B90, Byte__Array *, HashFinal, (app::RIPEMD160Managed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x028E0E40, Byte__Array *, _EndHash, (app::RIPEMD160Managed * this_ptr));
IL2CPP_REGISTER_METHOD(0x028E10E0, void, MDTransform, (app::uint32_t * block_d_words, app::uint32_t * state, app::uint8_t * block));
