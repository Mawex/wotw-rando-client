...
namespace app::methods::System_Security_Cryptography::AesTransform {
IL2CPP_REGISTER_METHOD(0x02FC9430, void, __ctor, (app::AesTransform * this_ptr, app::Aes * algo, bool encryption, app::Byte__Array * key, app::Byte__Array * iv));
