...
IL2CPP_REGISTER_METHOD(0x01251320, BehaviourStatus__Enum, OnExecute, (app::KwolokBossCleanWaterPhaseStartBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x01251800, void, ModifyDesiredLookAngle, (app::KwolokBossCleanWaterPhaseStartBehaviour * this_ptr, app::float * angle));
IL2CPP_REGISTER_METHODINFO(0x047206C0, KwolokBossCleanWaterPhaseStartBehaviour_ModifyDesiredLookAngle__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01251810, void, ModifyBodyHeight, (app::KwolokBossCleanWaterPhaseStartBehaviour * this_ptr, app::float * height));
IL2CPP_REGISTER_METHODINFO(0x0478E040, KwolokBossCleanWaterPhaseStartBehaviour_ModifyBodyHeight__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01251870, void, __ctor, (app::KwolokBossCleanWaterPhaseStartBehaviour * this_ptr));
}
