...
IL2CPP_REGISTER_METHOD(0x00C03C70, DebugPlayerTeleporter_DebugMarkerMode__Enum, get_Mode, (app::DebugPlayerTeleporter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00DFDA50, void, __ctor, (app::DebugPlayerTeleporter * this_ptr));
IL2CPP_REGISTER_METHOD(0x00DFDBB0, void, __cctor, ());
}
