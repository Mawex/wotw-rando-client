...
IL2CPP_REGISTER_METHOD(0x00956A60, ConfigurableJoint *, GetGeneratedConfigurableJoint, (app::SpiderBatEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00956AE0, Action_1_Damage_ *, get_ReceivedDamageEvent, (app::SpiderBatEntity * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0095B4F0, void, __ctor, (app::SpiderBatEntity * this_ptr));
}
