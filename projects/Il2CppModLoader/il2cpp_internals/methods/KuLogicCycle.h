...
namespace app::methods::KuLogicCycle {
    ...
    IL2CPP_REGISTER_METHOD(0x002FB9F0, List_1_KuState_*, GetStates, (app::KuLogicCycle * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0043D9E0, UpdateType__Enum, get_UpdateType, (app::KuLogicCycle * this_ptr));
    IL2CPP_REGISTER_METHOD(0x01240940, void, __ctor, (app::KuLogicCycle * this_ptr));
