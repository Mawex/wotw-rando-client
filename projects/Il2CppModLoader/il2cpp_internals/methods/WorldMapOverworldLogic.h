...
IL2CPP_REGISTER_METHOD(0x00584C50, Vector3, WorldToOverworld, (app::WorldMapOverworldLogic * this_ptr, app::Vector3 position));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::WorldMapOverworldLogic * this_ptr));
}
