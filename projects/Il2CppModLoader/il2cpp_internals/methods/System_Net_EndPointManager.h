...
namespace app::methods::System_Net::EndPointManager {
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::EndPointManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01EB74E0, EndPointListener *, GetEPListener, (app::String * host, int32_t port, app::HttpListener * listener, bool secure));
