...
namespace app::methods::System_Text::Encoding_EncodingByteBuffer {
IL2CPP_REGISTER_METHOD(0x02454840, void, __ctor, (app::Encoding_EncodingByteBuffer * this_ptr, app::Encoding * in_encoding, app::EncoderNLS * in_encoder, app::uint8_t * in_byte_start, int32_t in_byte_count, app::uint16_t * in_char_start, int32_t in_char_count));
