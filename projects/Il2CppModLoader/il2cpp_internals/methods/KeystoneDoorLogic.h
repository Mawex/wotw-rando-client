...
IL2CPP_REGISTER_METHOD(0x002FB9D0, IMoonSetupAnimator *, get_MoonSetupAnimator, (app::KeystoneDoorLogic * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E6C6C0, void, set_MoonSetupAnimator, (app::KeystoneDoorLogic * this_ptr, app::IMoonSetupAnimator * value));
IL2CPP_REGISTER_METHOD(0x00E6C790, MoonReference_1_IGenericUberState_ *, get_SharedState, (app::KeystoneDoorLogic * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, Object_1 *, get_ObjectReference, (app::KeystoneDoorLogic * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E6CA00, void, Awake, (app::KeystoneDoorLogic * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E6CE10, MoonTimeline *, get_OpenDoorTimeline, (app::KeystoneDoorLogic * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E6CE30, MoonTimeline *, get_OnFailTimeline, (app::KeystoneDoorLogic * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E6DF80, IUberState__Array *, get_AffectingUberStates, (app::KeystoneDoorLogic * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E6E020, List_1_UnityEngine_GameObject_ *, get_AllTargets, (app::KeystoneDoorLogic * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003FFBD0, StressTestStatus__Enum, get_StressTestStatus, (app::KeystoneDoorLogic * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00E6FFC0, String *, get_StressTestName, (app::KeystoneDoorLogic * this_ptr));
IL2CPP_REGISTER_METHOD(0x00E70040, IDesiredUberState *, GetRequirementsForTimeline, (app::KeystoneDoorLogic * this_ptr, app::MoonTimeline * timeline));
IL2CPP_REGISTER_METHOD(0x00E70120, void, __ctor, (app::KeystoneDoorLogic * this_ptr));
