...
IL2CPP_REGISTER_METHOD(0x002FA280, IState *, GetNextState, (app::DemoMainMenuState * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::DemoMainMenuState * this_ptr));
}
