...
IL2CPP_REGISTER_METHOD(0x02775660, ThreadPoolWorkQueue_WorkStealingQueue__Array *, get_Current, (app::ThreadPoolWorkQueue_SparseArray_1_ThreadPoolWorkQueue_WorkStealingQueue_ * this_ptr));
