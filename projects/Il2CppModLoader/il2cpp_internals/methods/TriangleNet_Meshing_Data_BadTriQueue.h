...
namespace app::methods::TriangleNet_Meshing_Data::BadTriQueue {
IL2CPP_REGISTER_METHOD(0x005C3FF0, int32_t, get_Count, (app::BadTriQueue * this_ptr));
IL2CPP_REGISTER_METHOD(0x02B0E8A0, void, __ctor, (app::BadTriQueue * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B0EE70, BadTriangle *, Dequeue, (app::BadTriQueue * this_ptr));
}
