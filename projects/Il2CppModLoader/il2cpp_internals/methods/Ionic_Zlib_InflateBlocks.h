...
namespace app::methods::Ionic_Zlib::InflateBlocks {
    IL2CPP_REGISTER_METHOD(0x0306FF50, void, __ctor, (app::InflateBlocks * this_ptr, app::ZlibCodec * codec, app::Object * checkfn, int32_t w));
    ...
    IL2CPP_REGISTER_METHOD(0x03072020, void, __cctor, ());
}
