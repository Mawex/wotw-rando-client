...
IL2CPP_REGISTER_METHOD(0x029DC630, String *, PasswordFieldGetStrToShow, (app::String * password, uint16_t mask_char));
IL2CPP_REGISTER_METHOD(0x029DC7C0, String *, TextArea_1, (app::Rect position, app::String * text));
IL2CPP_REGISTER_METHOD(0x029DC940, String *, TextArea_2, (app::Rect position, app::String * text, app::GUIStyle * style));
...
IL2CPP_REGISTER_METHOD(0x029E0860, Vector2, BeginScrollView, (app::Rect position, app::Vector2 scroll_position, app::Rect view_rect, bool always_show_horizontal, bool always_show_vertical, app::GUIStyle * horizontal_scrollbar, app::GUIStyle * vertical_scrollbar, app::GUIStyle * background));
