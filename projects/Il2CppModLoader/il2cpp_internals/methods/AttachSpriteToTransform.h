...
IL2CPP_REGISTER_METHOD(0x008468B0, SuspendableMask__Enum, get_Mask, (app::AttachSpriteToTransform * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, UpdateType__Enum, get_UpdateType, (app::AttachSpriteToTransform * this_ptr));
IL2CPP_REGISTER_METHOD(0x0084E2D0, void, OnUpdate, (app::AttachSpriteToTransform * this_ptr, float delta));
IL2CPP_REGISTER_METHOD(0x0084F180, void, __ctor, (app::AttachSpriteToTransform * this_ptr));
}
