...
namespace app::methods::Swing::RectExt {
    ...
    IL2CPP_REGISTER_METHOD(0x0014B910, void, __ctor_1, (app::RectExt__Boxed * this_ptr, app::Vector2 _top_left, app::Vector2 _size));
    IL2CPP_REGISTER_METHOD(0x0014B950, void, __ctor_2, (app::RectExt__Boxed * this_ptr, app::Vector2 _pos, app::Vector2 _size, bool _centered));
    ...
    IL2CPP_REGISTER_METHOD(0x00121740, void, __ctor_3, (app::RectExt__Boxed * this_ptr, float left, float top, float width, float height));
    IL2CPP_REGISTER_METHOD(0x0014C4D0, void, __ctor_4, (app::RectExt__Boxed * this_ptr, app::RectExt source));
    ...
    operator * (app::RectExt _rect, float _mult) {
        return op_Multiply(_rect, _mult);
    }
    operator * (app::RectExt _rect, app::Vector2 _mult) {
        return op_Multiply(_rect, _mult);
    }
    operator / (app::RectExt _rect, float _div) {
        return op_Division(_rect, _div);
    }
    operator / (app::RectExt _rect, app::Vector2 _div) {
        return op_Division(_rect, _div);
    }
    operator != (app::RectExt lhs, app::RectExt rhs) {
