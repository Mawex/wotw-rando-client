...
IL2CPP_REGISTER_METHOD(0x00BA9A60, void, __ctor_1, (app::SceneManagerScene * this_ptr, app::SceneRoot * scene_root, app::RuntimeSceneMetaData * scene_meta_data, app::SceneState__Enum inital_state));
IL2CPP_REGISTER_METHOD(0x00BA9BC0, void, __ctor_2, (app::SceneManagerScene * this_ptr, app::SceneRoot * scene_root, app::RuntimeSceneMetaData * scene_meta_data));
IL2CPP_REGISTER_METHOD(0x00BA9D10, void, __ctor_3, (app::SceneManagerScene * this_ptr, app::RuntimeSceneMetaData * meta_data));
IL2CPP_REGISTER_METHOD(0x00BA9E70, bool, get_IsLoadingComplete, (app::SceneManagerScene * this_ptr));
IL2CPP_REGISTER_METHOD(0x00BA9ED0, SceneState__Enum, get_CurrentState, (app::SceneManagerScene * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B1EA60, Vector3, get_CameraTargetOnLastEnabled, (app::SceneManagerScene * this_ptr));
