...
namespace app::methods::System_Collections::ArrayList_ReadOnlyList {
IL2CPP_REGISTER_METHOD(0x002FA490, void, __ctor, (app::ArrayList_ReadOnlyList * this_ptr, app::IList * l));
...
IL2CPP_REGISTER_METHOD(0x0201CF30, Object *, get_Item, (app::ArrayList_ReadOnlyList * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x0201D040, Object *, get_SyncRoot, (app::ArrayList_ReadOnlyList * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0201D310, IEnumerator *, GetEnumerator, (app::ArrayList_ReadOnlyList * this_ptr));
