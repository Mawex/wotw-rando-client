...
namespace app::methods::System_Net::SocketAddress {
IL2CPP_REGISTER_METHOD(0x01BDB850, AddressFamily__Enum, get_Family, (app::SocketAddress * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BDBAB0, void, __ctor_1, (app::SocketAddress * this_ptr, app::AddressFamily__Enum family));
IL2CPP_REGISTER_METHOD(0x01BDBAC0, void, __ctor_2, (app::SocketAddress * this_ptr, app::AddressFamily__Enum family, int32_t size));
IL2CPP_REGISTER_METHODINFO(0x047588E8, SocketAddress__ctor_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01BDBC00, void, __ctor_3, (app::SocketAddress * this_ptr, app::IPAddress * ip_address));
IL2CPP_REGISTER_METHOD(0x01BDBFF0, void, __ctor_4, (app::SocketAddress * this_ptr, app::IPAddress * ipaddress, int32_t port));
IL2CPP_REGISTER_METHOD(0x01BDC070, IPAddress *, GetIPAddress, (app::SocketAddress * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04755910, SocketAddress_GetIPAddress__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01BDC5D0, IPEndPoint *, GetIPEndPoint, (app::SocketAddress * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BDC8C0, void, SetSize, (app::SocketAddress * this_ptr, app::void * ptr));
...
IL2CPP_REGISTER_METHOD(0x01BDCBB0, String *, ToString, (app::SocketAddress * this_ptr));
}
