...
namespace app::methods::System_Security_Permissions::SecurityAttribute {
IL2CPP_REGISTER_METHOD(0x002FC6E0, void, __ctor, (app::SecurityAttribute * this_ptr, app::SecurityAction__Enum action));
