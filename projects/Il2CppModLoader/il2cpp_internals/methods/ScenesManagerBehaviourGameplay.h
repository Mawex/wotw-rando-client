...
IL2CPP_REGISTER_METHOD(0x01056D40, Vector2, get_CurrentCameraTargetPositionExtrapolated, (app::ScenesManagerBehaviourGameplay * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01056D80, Vector2, get_CurrentCameraTargetPositionExtrapolatedShort, (app::ScenesManagerBehaviourGameplay * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01056D40, Vector2, get_PredictedTargetPosition, (app::ScenesManagerBehaviourGameplay * this_ptr));
IL2CPP_REGISTER_METHOD(0x00597B10, ScenesManagerUpdateType__Enum, get_CurrentUpdateType, (app::ScenesManagerBehaviourGameplay * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01059610, void, __ctor, (app::ScenesManagerBehaviourGameplay * this_ptr));
}
