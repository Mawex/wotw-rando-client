...
IL2CPP_REGISTER_METHOD(0x02477B20, Material *, get_material, (app::CameraFilterPack_Glitch_Mozaic * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020F7040, void, __ctor, (app::CameraFilterPack_Glitch_Mozaic * this_ptr));
}
