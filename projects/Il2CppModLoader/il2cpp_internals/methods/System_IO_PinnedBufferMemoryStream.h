...
namespace app::methods::System_IO::PinnedBufferMemoryStream {
    IL2CPP_REGISTER_METHOD(0x0237B110, void, __ctor, (app::PinnedBufferMemoryStream * this_ptr, app::Byte__Array * array));
