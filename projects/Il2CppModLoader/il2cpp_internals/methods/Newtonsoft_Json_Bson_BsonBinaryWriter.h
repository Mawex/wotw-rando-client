...
namespace app::methods::Newtonsoft_Json_Bson::BsonBinaryWriter {
IL2CPP_REGISTER_METHOD(0x002FD1D0, DateTimeKind__Enum, get_DateTimeKindHandling, (app::BsonBinaryWriter * this_ptr));
