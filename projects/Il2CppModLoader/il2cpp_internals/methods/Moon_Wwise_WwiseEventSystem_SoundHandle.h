...
namespace app::methods::Moon_Wwise::WwiseEventSystem_SoundHandle {
IL2CPP_REGISTER_METHOD(0x001FEC90, void, __ctor, (app::WwiseEventSystem_SoundHandle__Boxed * this_ptr, app::WwiseEventSystem_SoundHandleProtected * snd_handle, int64_t handle_version));
...
IL2CPP_REGISTER_METHOD(0x001FEDC0, WwiseEventSystem_EventStatus__Enum, get_Status, (app::WwiseEventSystem_SoundHandle__Boxed * this_ptr));
