...
namespace app::methods::UnityEngine_UI::Navigation {
IL2CPP_REGISTER_METHOD(0x001EBC90, Navigation_Mode__Enum, get_mode, (app::Navigation__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0010DB80, void, set_mode, (app::Navigation__Boxed * this_ptr, app::Navigation_Mode__Enum value));
IL2CPP_REGISTER_METHOD(0x001FBB90, Selectable *, get_selectOnUp, (app::Navigation__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0010D3A0, void, set_selectOnUp, (app::Navigation__Boxed * this_ptr, app::Selectable * value));
IL2CPP_REGISTER_METHOD(0x001FBBA0, Selectable *, get_selectOnDown, (app::Navigation__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0010D3B0, void, set_selectOnDown, (app::Navigation__Boxed * this_ptr, app::Selectable * value));
IL2CPP_REGISTER_METHOD(0x001FBBB0, Selectable *, get_selectOnLeft, (app::Navigation__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x0010D3C0, void, set_selectOnLeft, (app::Navigation__Boxed * this_ptr, app::Selectable * value));
IL2CPP_REGISTER_METHOD(0x001FBBC0, Selectable *, get_selectOnRight, (app::Navigation__Boxed * this_ptr));
