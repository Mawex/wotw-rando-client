...
namespace app::methods::Moon_Timeline_Constraints::ConstraintEvaluator {
IL2CPP_REGISTER_METHOD(0x01BB1790, IDisposable *, OpenCache, (app::IConstraintEntityCache * cache));
...
IL2CPP_REGISTER_METHOD(0x01BB2A70, IConstrainedEntity *, GetConstrainedEntity, (app::IConstrainedEntityWithChildren * parent, app::EntityId id));
...
IL2CPP_REGISTER_METHOD(0x01BB4100, bool, GetCustomEventTime_2, (app::ITimelineEventProvider * provider, int32_t event_id, float min, float max, app::float * time));
...
IL2CPP_REGISTER_METHOD(0x01BB5F80, IConstraint *, GetConstraintFor, (app::IConstrainedEntity * constrained_entity, app::Constraint__Enum constraint));
