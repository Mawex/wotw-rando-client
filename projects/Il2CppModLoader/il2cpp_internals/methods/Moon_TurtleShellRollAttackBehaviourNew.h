...
IL2CPP_REGISTER_METHOD(0x00D216C0, BehaviourStatus__Enum, OnExecute, (app::TurtleShellRollAttackBehaviourNew * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00D217F0, void, __ctor, (app::TurtleShellRollAttackBehaviourNew * this_ptr));
}
