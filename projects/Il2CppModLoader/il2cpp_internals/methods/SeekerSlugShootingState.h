...
IL2CPP_REGISTER_METHOD(0x0106C6F0, void, __ctor, (app::SeekerSlugShootingState * this_ptr, app::SlugEnemy * slug, app::SlugDirectionalAnimation * animation, app::GameObject * spike_prefab, app::SoundSource * shooting_sound));
