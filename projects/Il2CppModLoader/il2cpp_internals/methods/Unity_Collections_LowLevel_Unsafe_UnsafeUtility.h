...
namespace app::methods::Unity_Collections_LowLevel_Unsafe::UnsafeUtility {
IL2CPP_REGISTER_METHOD(0x02418CB0, Void *, Malloc, (int64_t size, int32_t alignment, app::Allocator__Enum allocator));
...
IL2CPP_REGISTER_METHOD(0x02418FB0, String *, GetReasonForTypeNonBlittableImpl, (app::Type * t, app::String * name));
IL2CPP_REGISTER_METHOD(0x02419250, bool, IsArrayBlittable, (app::Array * arr));
IL2CPP_REGISTER_METHOD(0x024192A0, String *, GetReasonForArrayNonBlittable, (app::Array * arr));
IL2CPP_REGISTER_METHOD(0x0157BDF0, Object *, ReadArrayElement_1, (app::Void * source, int32_t index));
IL2CPP_REGISTER_METHOD(0x015E3900, void, WriteArrayElement_1, (app::Void * destination, int32_t index, app::Object * value));
IL2CPP_REGISTER_METHOD(0x004C50A0, Void *, AddressOf_1, (app::BatchQueryJob_2_UnityEngine_CapsulecastCommand_UnityEngine_RaycastHit_ * output));
IL2CPP_REGISTER_METHODINFO(0x0472F110, UnsafeUtility_AddressOf__MethodInfo);
IL2CPP_REGISTER_METHOD(0x004C50A0, Void *, AddressOf_2, (app::BatchQueryJob_2_UnityEngine_RaycastCommand_UnityEngine_RaycastHit_ * output));
IL2CPP_REGISTER_METHODINFO(0x0478ABB0, UnsafeUtility_AddressOf_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x004C50A0, Void *, AddressOf_3, (app::BatchQueryJob_2_UnityEngine_SpherecastCommand_UnityEngine_RaycastHit_ * output));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, Void *, AddressOf_4, (app::AttachSpriteToPhysicsSystem_JobWithMonoBehaviour * output));
IL2CPP_REGISTER_METHOD(0x004C50A0, Void *, AddressOf_5, (app::BlendGradientColorsJob * output));
IL2CPP_REGISTER_METHOD(0x004C50A0, Void *, AddressOf_6, (app::XboxControllerManager_VibrationJob * output));
IL2CPP_REGISTER_METHOD(0x004C50A0, Void *, AddressOf_7, (app::MoonTrailSystem_SimulateJob * output));
IL2CPP_REGISTER_METHOD(0x004C50A0, Void *, AddressOf_8, (app::SimpleSwayAnimPostprocess_Job * output));
IL2CPP_REGISTER_METHOD(0x004C50A0, Void *, AddressOf_9, (app::SimpleSwayBossAnimPostprocess_Job * output));
IL2CPP_REGISTER_METHOD(0x004C50A0, Void *, AddressOf_10, (app::VerletPhysicsAnimationPostprocess_Job * output));
IL2CPP_REGISTER_METHOD(0x004C50A0, Void *, AddressOf_11, (app::SoundZoneProcessor_Job * output));
IL2CPP_REGISTER_METHOD(0x004C50A0, Void *, AddressOf_12, (app::Int32Enum__Enum * output));
IL2CPP_REGISTER_METHOD(0x004C50A0, Void *, AddressOf_13, (app::VerletStructure_JobWithMonoBehaviour * output));
...
IL2CPP_REGISTER_METHOD(0x0157BE10, Bounds, ReadArrayElement_4, (app::Void * source, int32_t index));
IL2CPP_REGISTER_METHOD(0x0157BE40, CapsulecastCommand, ReadArrayElement_5, (app::Void * source, int32_t index));
IL2CPP_REGISTER_METHOD(0x0157BE70, Color, ReadArrayElement_6, (app::Void * source, int32_t index));
IL2CPP_REGISTER_METHOD(0x0157BE90, TransformStreamHandle, ReadArrayElement_7, (app::Void * source, int32_t index));
IL2CPP_REGISTER_METHOD(0x0157BE70, Quaternion, ReadArrayElement_8, (app::Void * source, int32_t index));
IL2CPP_REGISTER_METHOD(0x0157BEB0, RaycastCommand, ReadArrayElement_9, (app::Void * source, int32_t index));
IL2CPP_REGISTER_METHOD(0x0157BEE0, RaycastHit, ReadArrayElement_10, (app::Void * source, int32_t index));
IL2CPP_REGISTER_METHOD(0x0157BF20, SpherecastCommand, ReadArrayElement_11, (app::Void * source, int32_t index));
IL2CPP_REGISTER_METHOD(0x0157BE90, Vector3, ReadArrayElement_12, (app::Void * source, int32_t index));
}
