...
IL2CPP_REGISTER_METHOD(0x00E737B0, BehaviourStatus__Enum, OnExecuteTask, (app::KickupDeathBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x005B3EC0, void, __ctor, (app::KickupDeathBehaviour * this_ptr));
}
