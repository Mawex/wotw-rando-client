...
namespace app::methods::Unity_IO_Compression::DeflateInput {
IL2CPP_REGISTER_METHOD(0x002FA280, Byte__Array *, get_Buffer, (app::DeflateInput * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02B72120, DeflateInput_InputState, DumpState, (app::DeflateInput * this_ptr));
IL2CPP_REGISTER_METHOD(0x02B72140, void, RestoreState, (app::DeflateInput * this_ptr, app::DeflateInput_InputState state));
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::DeflateInput * this_ptr));
}
