...
namespace app::methods::Mono_Xml::SmallXmlParser {
IL2CPP_REGISTER_METHOD(0x02287290, void, __ctor, (app::SmallXmlParser * this_ptr));
IL2CPP_REGISTER_METHOD(0x02287650, Exception *, Error, (app::SmallXmlParser * this_ptr, app::String * msg));
IL2CPP_REGISTER_METHOD(0x022878A0, Exception *, UnexpectedEndError, (app::SmallXmlParser * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02288110, String *, ReadUntil, (app::SmallXmlParser * this_ptr, uint16_t until, bool handle_references));
IL2CPP_REGISTER_METHODINFO(0x0476F4A0, SmallXmlParser_ReadUntil__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02288410, String *, ReadName, (app::SmallXmlParser * this_ptr));
