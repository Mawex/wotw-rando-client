...
IL2CPP_REGISTER_METHOD(0x02764F40, Material *, get_material, (app::CameraFilterPack_Blur_Blurry * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x027659B0, void, __ctor, (app::CameraFilterPack_Blur_Blurry * this_ptr));
}
