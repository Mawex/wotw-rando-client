...
namespace app::methods::Moon_ArtOptimization::OptimizationCache___c {
IL2CPP_REGISTER_METHOD(0x0134F340, void, __cctor, ());
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::OptimizationCache_c * this_ptr));
