...
IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_Position, (app::AttackableSwitch * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00855600, SuspendableMask__Enum, get_Mask, (app::AttackableSwitch * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0058E140, Vector3, get_BowAutoTargetPosition, (app::AttackableSwitch * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00855740, IDesiredUberState *, GetRequirementsForTimeline, (app::AttackableSwitch * this_ptr, app::MoonTimeline * timeline));
IL2CPP_REGISTER_METHOD(0x002FBD00, Action_1_Damage_ *, get_DamageReceived, (app::AttackableSwitch * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBD10, void, set_DamageReceived, (app::AttackableSwitch * this_ptr, app::Action_1_Damage_ * value));
IL2CPP_REGISTER_METHOD(0x002FBD20, IDamageReciever__Array *, get_AffectedReceivers, (app::AttackableSwitch * this_ptr));
IL2CPP_REGISTER_METHOD(0x008559C0, void, __ctor, (app::AttackableSwitch * this_ptr));
IL2CPP_REGISTER_METHOD(0x004F4750, GameObject *, IDamageReciever_get_gameObject, (app::AttackableSwitch * this_ptr));
IL2CPP_REGISTER_METHOD(0x00506170, Transform *, IDamageReciever_get_transform, (app::AttackableSwitch * this_ptr));
}
