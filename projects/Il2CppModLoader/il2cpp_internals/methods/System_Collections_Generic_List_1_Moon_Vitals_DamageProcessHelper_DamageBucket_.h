...
namespace app::methods::System_Collections_Generic::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ {
...
IL2CPP_REGISTER_METHOD(0x02D49B80, Vitals_DamageProcessHelper_DamageBucket, get_Item, (app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x02D4AC20, List_1_T_Enumerator_Moon_Vitals_DamageProcessHelper_DamageBucket_, GetEnumerator, (app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x0478BC00, List_1_Moon_Vitals_DamageProcessHelper_DamageBucket__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_1, (app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHODINFO(0x0478D190, List_1_Moon_Vitals_DamageProcessHelper_DamageBucket___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_2, (app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02E092A0, void, __ctor_3, (app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ * this_ptr, app::IEnumerable_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02E09730, Object *, ICollection_get_SyncRoot, (app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D49C20, bool, IsCompatibleObject, (app::Object * value));
IL2CPP_REGISTER_METHOD(0x02D49D10, Object *, IList_get_Item, (app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ *, AsReadOnly, (app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D4A5E0, Vitals_DamageProcessHelper_DamageBucket, Find, (app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ * this_ptr, app::Predicate_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ * match));
IL2CPP_REGISTER_METHOD(0x02D4A710, List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ *, FindAll, (app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ * this_ptr, app::Predicate_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ * match));
...
IL2CPP_REGISTER_METHOD(0x02D4AC60, IEnumerator_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D4AC60, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ *, GetRange, (app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, Vitals_DamageProcessHelper_DamageBucket__Array *, ToArray, (app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ * this_ptr));
