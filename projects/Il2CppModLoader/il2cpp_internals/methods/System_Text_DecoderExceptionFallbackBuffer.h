...
namespace app::methods::System_Text::DecoderExceptionFallbackBuffer {
...
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::DecoderExceptionFallbackBuffer * this_ptr));
}
