...
IL2CPP_REGISTER_METHOD(0x01287A80, Renderer *, GetRenderer, (app::UberShaderRuntimeZShift * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::UberShaderRuntimeZShift * this_ptr));
}
