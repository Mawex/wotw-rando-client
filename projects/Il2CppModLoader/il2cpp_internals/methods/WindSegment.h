...
namespace app::methods::WindSegment {
    ...
    IL2CPP_REGISTER_METHOD(0x003FF7B0, SuspendableMask__Enum, get_Mask, (app::WindSegment * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00578C00, void, set_Mask, (app::WindSegment * this_ptr, app::SuspendableMask__Enum value));
    IL2CPP_REGISTER_METHOD(0x00578CB0, void, __ctor, (app::WindSegment * this_ptr));
} // namespace app::methods::WindSegment
