...
namespace app::methods::Moon_Timeline::RigidbodyParametersAnimator {
IL2CPP_REGISTER_METHOD(0x007808F0, GameObject *, get_ExternalTarget, (app::RigidbodyParametersAnimator * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBBC0, MoonReference_1_UnityEngine_Transform_ *, GetTransformTarget, (app::RigidbodyParametersAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA000, void, OnDrawGizmosSelected, (app::RigidbodyParametersAnimator * this_ptr));
IL2CPP_REGISTER_METHOD(0x00780D60, void, __ctor, (app::RigidbodyParametersAnimator * this_ptr));
}
