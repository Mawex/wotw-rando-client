...
namespace app::methods::System_Net::FtpAsyncResult {
IL2CPP_REGISTER_METHOD(0x01D2C460, void, __ctor, (app::FtpAsyncResult * this_ptr, app::AsyncCallback * callback, app::Object * state));
IL2CPP_REGISTER_METHOD(0x002FB9B0, Object *, get_AsyncState, (app::FtpAsyncResult * this_ptr));
IL2CPP_REGISTER_METHOD(0x01D2C5C0, WaitHandle *, get_AsyncWaitHandle, (app::FtpAsyncResult * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FB950, Exception *, get_Exception, (app::FtpAsyncResult * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA280, FtpWebResponse *, get_Response, (app::FtpAsyncResult * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_Response, (app::FtpAsyncResult * this_ptr, app::FtpWebResponse * value));
IL2CPP_REGISTER_METHOD(0x002FB990, Stream *, get_Stream, (app::FtpAsyncResult * this_ptr));
