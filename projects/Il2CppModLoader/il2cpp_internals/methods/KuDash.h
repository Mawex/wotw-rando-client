...
namespace app::methods::KuDash {
    IL2CPP_REGISTER_METHOD(0x00417920, ComboMoveType__Enum, get_ComboMoveType, (app::KuDash * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00420EE0, ButtonInputType__Enum, get_ButtonInputType, (app::KuDash * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x0065FBC0, KuDashPuppet*, get_Puppet, (app::KuDash * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x012328E0, void, ComputeDashDirectionAndType, (app::KuDash * this_ptr, app::int32_t* dash_direction, app::bool* is_forward_dash));
    ...
    IL2CPP_REGISTER_METHOD(0x00A64220, IComboMove__Array*, get_ComboMoves, (app::KuDash * this_ptr));
    IL2CPP_REGISTER_METHOD(0x00510100, void, set_ComboMoves, (app::KuDash * this_ptr, app::IComboMove__Array* value));
    IL2CPP_REGISTER_METHOD(0x006FB830, AbilityType__Enum, get_ComboAbilityType, (app::KuDash * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01234080, void, __ctor, (app::KuDash * this_ptr));
} // namespace app::methods::KuDash
