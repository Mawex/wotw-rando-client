...
IL2CPP_REGISTER_METHOD(0x002FB940, void, __ctor, (app::InverterNode * this_ptr, app::String * name));
IL2CPP_REGISTER_METHOD(0x013E24C0, BehaviourTreeStatus__Enum, Tick, (app::InverterNode * this_ptr, app::TickData tick));
