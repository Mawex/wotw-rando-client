...
namespace app::methods::System_Threading_Tasks::Task_ContingentProperties {
...
IL2CPP_REGISTER_METHOD(0x0233B220, void, __ctor, (app::Task_ContingentProperties * this_ptr));
}
