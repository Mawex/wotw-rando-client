...
IL2CPP_REGISTER_METHOD(0x004C1E90, void, __ctor, (app::RockyEnemyShootingState * this_ptr, app::RockyEnemy * enemy));
...
IL2CPP_REGISTER_METHOD(0x01363A90, Vector3, get_ProjectileSpawnerPositionToPlayerPosition, (app::RockyEnemyShootingState * this_ptr));
