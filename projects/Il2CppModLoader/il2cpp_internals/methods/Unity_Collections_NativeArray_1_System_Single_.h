...
IL2CPP_REGISTER_METHOD(0x001DFA50, Single__Array *, ToArray, (app::NativeArray_1_System_Single___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001DFB30, NativeArray_1_T_Enumerator_System_Single_, GetEnumerator, (app::NativeArray_1_System_Single___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001DFB90, IEnumerator_1_System_Single_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::NativeArray_1_System_Single___Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001DFC30, IEnumerator *, IEnumerable_GetEnumerator, (app::NativeArray_1_System_Single___Boxed * this_ptr));
