...
IL2CPP_REGISTER_METHOD(0x00654950, SuspendableMask__Enum, get_Mask, (app::DelayedActionManager * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00B808C0, DelayedActionManager *, get_Instance, ());
IL2CPP_REGISTER_METHOD(0x00B80B10, void, FixedUpdate, (app::DelayedActionManager * this_ptr));
IL2CPP_REGISTER_METHOD(0x00444DD0, void, __ctor, (app::DelayedActionManager * this_ptr));
}
