...
IL2CPP_REGISTER_METHOD(0x002FBBA0, MonoChunkStream *, get_MonoChunkStream, (app::WebConnection * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01D62D20, WebHeaderCollection *, ReadHeaders, (app::WebConnection * this_ptr, app::Stream * stream, app::Byte__Array * * ret_buffer, app::int32_t * status));
...
IL2CPP_REGISTER_METHOD(0x01D656D0, EventHandler *, SendRequest, (app::WebConnection * this_ptr, app::HttpWebRequest * request));
...
IL2CPP_REGISTER_METHOD(0x01D66040, bool, ReadLine, (app::Byte__Array * buffer, app::int32_t * start, int32_t max, app::String * * output));
IL2CPP_REGISTER_METHOD(0x01D66320, IAsyncResult *, BeginRead, (app::WebConnection * this_ptr, app::HttpWebRequest * request, app::Byte__Array * buffer, int32_t offset, int32_t size, app::AsyncCallback * cb, app::Object * state));
...
IL2CPP_REGISTER_METHOD(0x01D670F0, IAsyncResult *, BeginWrite, (app::WebConnection * this_ptr, app::HttpWebRequest * request, app::Byte__Array * buffer, int32_t offset, int32_t size, app::AsyncCallback * cb, app::Object * state));
...
IL2CPP_REGISTER_METHOD(0x002FBC20, NetworkCredential *, get_NtlmCredential, (app::WebConnection * this_ptr));
