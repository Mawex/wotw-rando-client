...
IL2CPP_REGISTER_METHOD(0x00CB5CD0, Nullable_1_UnityEngine_Vector3_, get_ReplacementRegisteredPoint, (app::Locomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x002FBB80, CharacterPlatformMovement *, get_PlatformMovement, (app::Locomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FB9F0, Entity *, get_Entity, (app::Locomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0110A940, Vector2, get_GravityDirection, (app::Locomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x0110AA80, bool, get_IsBlocking, (app::Locomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x0043D9E0, EntityOwnedInitOrder__Enum, get_InitOrder, (app::Locomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x0110AB60, Vector2, get_PreviusPositionForWaterfallInteraction, (app::Locomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x0110AC20, Vector2, get_PositionForWaterfallInteraction, (app::Locomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x0110AD00, Vector2, get_SpeedForWaterfallInteraction, (app::Locomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x0110AE90, void, set_SpeedForWaterfallInteraction, (app::Locomotion * this_ptr, app::Vector2 value));
IL2CPP_REGISTER_METHOD(0x0110AFF0, Rect, get_BoundsForWaterfallInteraction, (app::Locomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x00420EE0, WaterfallIntersectionMode__Enum, get_WaterfallIntersectionMode, (app::Locomotion * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FBBC0, Rigidbody *, get_RigidbodyForWaterfallInteraction, (app::Locomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0110C8C0, void, StopAllLocomotionBehaviours_1, (app::Locomotion * this_ptr, app::bool * all_interrupted, bool force_interrupt));
...
IL2CPP_REGISTER_METHOD(0x0110D410, RootMotionProcessor *, GetRootMotionProcessor, (app::Locomotion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0110D640, void, __ctor, (app::Locomotion * this_ptr));
}
