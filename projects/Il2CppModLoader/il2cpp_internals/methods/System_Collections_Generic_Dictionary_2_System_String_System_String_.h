...
namespace app::methods::System_Collections_Generic::Dictionary_2_System_String_System_String_ {
IL2CPP_REGISTER_METHOD(0x0283AC20, void, __ctor_1, (app::Dictionary_2_System_String_System_String_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BA5400, Dictionary_2_TKey_TValue_Enumerator_System_String_System_String_, GetEnumerator, (app::Dictionary_2_System_String_System_String_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04768720, Dictionary_2_System_String_System_String__GetEnumerator__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02259DF0, void, __ctor_2, (app::Dictionary_2_System_String_System_String_ * this_ptr, int32_t capacity));
...
IL2CPP_REGISTER_METHOD(0x0283B2B0, Dictionary_2_TKey_TValue_KeyCollection_System_String_System_String_ *, get_Keys, (app::Dictionary_2_System_String_System_String_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02BD24D0, String *, get_Item, (app::Dictionary_2_System_String_System_String_ * this_ptr, app::String * key));
