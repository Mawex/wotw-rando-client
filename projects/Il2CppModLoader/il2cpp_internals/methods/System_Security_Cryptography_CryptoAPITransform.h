...
namespace app::methods::System_Security_Cryptography::CryptoAPITransform {
IL2CPP_REGISTER_METHOD(0x00531660, void, __ctor, (app::CryptoAPITransform * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00420EE0, Byte__Array *, TransformFinalBlock, (app::CryptoAPITransform * this_ptr, app::Byte__Array * input_buffer, int32_t input_offset, int32_t input_count));
