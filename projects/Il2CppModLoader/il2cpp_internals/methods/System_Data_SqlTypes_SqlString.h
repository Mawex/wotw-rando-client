...
namespace app::methods::System_Data_SqlTypes::SqlString {
    ...
    IL2CPP_REGISTER_METHOD(0x022BA3B0, app::SqlString, operator_, (app::String * x));
    IL2CPP_REGISTER_METHOD(0x001E60F0, app::String *, ToString, (app::SqlString__Boxed * this_ptr));
    IL2CPP_REGISTER_METHOD(0x022BA3E0, app::SqlString, operator__, (app::SqlString x, app::SqlString y));
    ...
    IL2CPP_REGISTER_METHOD(0x022BABF0, app::SqlBoolean, operator___, (app::SqlString x, app::SqlString y));
