...
IL2CPP_REGISTER_METHOD(0x027F3810, HAuthTicket, GetAuthSessionTicket, (app::Byte__Array * p_ticket, int32_t cb_max_ticket, app::uint32_t * pcb_ticket));
IL2CPP_REGISTER_METHOD(0x027F3980, EBeginAuthSessionResult__Enum, BeginAuthSession, (app::Byte__Array * p_auth_ticket, int32_t cb_auth_ticket, app::CSteamID steam_i_d));
...
IL2CPP_REGISTER_METHOD(0x027F3BD0, EUserHasLicenseForAppResult__Enum, UserHasLicenseForApp, (app::CSteamID steam_i_d, app::AppId_t app_i_d));
...
IL2CPP_REGISTER_METHOD(0x027F4100, int32_t, GetNextOutgoingPacket, (app::Byte__Array * p_out, int32_t cb_max_out, app::uint32_t * p_net_adr, app::uint16_t * p_port));
...
IL2CPP_REGISTER_METHOD(0x027F4420, SteamAPICall_t, AssociateWithClan, (app::CSteamID steam_i_d_clan));
IL2CPP_REGISTER_METHOD(0x027F4560, SteamAPICall_t, ComputeNewPlayerCompatibility, (app::CSteamID steam_i_d_new_player));
}
