...
IL2CPP_REGISTER_METHOD(0x00BDB0E0, DoorSetupData *, get_ClosedState, (app::DoorSetupHolder * this_ptr));
IL2CPP_REGISTER_METHOD(0x00BDB180, DoorSetupData *, get_OpenedState, (app::DoorSetupHolder * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00BDB680, void, __ctor, (app::DoorSetupHolder * this_ptr));
}
