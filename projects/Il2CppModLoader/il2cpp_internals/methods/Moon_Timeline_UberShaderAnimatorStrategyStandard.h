...
namespace app::methods::Moon_Timeline::UberShaderAnimatorStrategyStandard {
...
IL2CPP_REGISTER_METHOD(0x00D16890, Vector4, GetStaticVector, (app::UberShaderAnimatorStrategyStandard * this_ptr, app::Renderer * target_renderer, app::UberShaderProperty_Vector__Enum property));
...
IL2CPP_REGISTER_METHOD(0x00D18020, UberShaderAnimatorStrategyStandard_RendererState *, GetRendererState, (app::UberShaderAnimatorStrategyStandard * this_ptr, app::Renderer * target_renderer, bool create));
IL2CPP_REGISTER_METHOD(0x00D181E0, UberShaderAnimatorStrategyStandard_RendererState *, GetStateFromPool, (app::UberShaderAnimatorStrategyStandard * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00D18640, void, __ctor, (app::UberShaderAnimatorStrategyStandard * this_ptr));
IL2CPP_REGISTER_METHOD(0x018F0340, UberShaderAnimatorStrategyStandard_UberShaderAnimation_1_System_Object_ *, GetUberShaderAnimationInstance_1, ());
IL2CPP_REGISTER_METHOD(0x018F0340, UberShaderAnimatorStrategyStandard_UberShaderAnimation_1_UnityEngine_Color_ *, GetUberShaderAnimationInstance_2, ());
IL2CPP_REGISTER_METHODINFO(0x0478CA80, UberShaderAnimatorStrategyStandard_GetUberShaderAnimationInstance_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x018F0340, UberShaderAnimatorStrategyStandard_UberShaderAnimation_1_UnityEngine_Vector4_ *, GetUberShaderAnimationInstance_3, ());
IL2CPP_REGISTER_METHODINFO(0x04776080, UberShaderAnimatorStrategyStandard_GetUberShaderAnimationInstance_2__MethodInfo);
IL2CPP_REGISTER_METHOD(0x018F0340, UberShaderAnimatorStrategyStandard_UberShaderAnimation_1_System_Single_ *, GetUberShaderAnimationInstance_4, ());
