...
IL2CPP_REGISTER_METHOD(0x012F0DF0, Transform *, get_TongueRoot, (app::KwolokBossTongueAttackBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x012F0EA0, Vector3, get_TongueRootPosition, (app::KwolokBossTongueAttackBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x012F0FD0, Transform *, get_TongueTip, (app::KwolokBossTongueAttackBehaviour * this_ptr));
IL2CPP_REGISTER_METHOD(0x012F1080, Vector3, get_TongueTipPosition, (app::KwolokBossTongueAttackBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x012F1720, BehaviourStatus__Enum, OnExecute, (app::KwolokBossTongueAttackBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x012F2340, void, ModifyAcceleration, (app::KwolokBossTongueAttackBehaviour * this_ptr, app::float * acceleration, app::float * deceleration));
...
IL2CPP_REGISTER_METHOD(0x012F3630, void, __ctor, (app::KwolokBossTongueAttackBehaviour * this_ptr));
}
