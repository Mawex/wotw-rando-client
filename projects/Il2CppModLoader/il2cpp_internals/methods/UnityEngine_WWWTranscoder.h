...
IL2CPP_REGISTER_METHOD(0x031814A0, Byte__Array *, URLDecode, (app::Byte__Array * to_encode));
IL2CPP_REGISTER_METHOD(0x03181560, bool, ByteSubArrayEquals, (app::Byte__Array * array, int32_t index, app::Byte__Array * comperand));
IL2CPP_REGISTER_METHOD(0x03181610, Byte__Array *, Decode, (app::Byte__Array * input, uint8_t escape_char, app::Byte__Array * space));
