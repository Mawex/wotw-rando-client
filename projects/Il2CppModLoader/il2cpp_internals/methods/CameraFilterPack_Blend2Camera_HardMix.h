...
IL2CPP_REGISTER_METHOD(0x0274E750, Material *, get_material, (app::CameraFilterPack_Blend2Camera_HardMix * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0274F920, void, __ctor, (app::CameraFilterPack_Blend2Camera_HardMix * this_ptr));
}
