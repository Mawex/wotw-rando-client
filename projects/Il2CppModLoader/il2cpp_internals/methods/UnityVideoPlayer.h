...
IL2CPP_REGISTER_METHOD(0x002FB990, OnDelegate *, get_OnPlaybackFinished, (app::UnityVideoPlayer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::UnityVideoPlayer * this_ptr));
}
