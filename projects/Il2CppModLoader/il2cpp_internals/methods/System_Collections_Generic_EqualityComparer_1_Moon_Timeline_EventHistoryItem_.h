...
namespace app::methods::System_Collections_Generic::EqualityComparer_1_Moon_Timeline_EventHistoryItem_ {
...
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::EqualityComparer_1_Moon_Timeline_EventHistoryItem_ * this_ptr));
}
