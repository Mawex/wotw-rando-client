...
IL2CPP_REGISTER_METHOD(0x02A5BCF0, String *, get_DebuggerDisplayResultDescription, (app::Task_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A5BDA0, String *, get_DebuggerDisplayMethodDescription, (app::Task_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02A5A760, Object *, get_Result, (app::Task_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHODINFO(0x04749FA8, Task_1_System_Object__get_Result__MethodInfo);
IL2CPP_REGISTER_METHOD(0x002FBB40, Object *, get_ResultOnSuccess, (app::Task_1_System_Object_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02A5B6D0, Task_1_System_Object_ *, StartNew_1, (app::Task * parent, app::Func_1_Object_ * function, app::CancellationToken cancellation_token, app::TaskCreationOptions__Enum creation_options, app::InternalTaskOptions__Enum internal_options, app::TaskScheduler * scheduler, app::StackCrawlMark__Enum * stack_mark));
IL2CPP_REGISTER_METHODINFO(0x0475FE08, Task_1_System_Object__StartNew__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02A5B9E0, Task_1_System_Object_ *, StartNew_2, (app::Task * parent, app::Func_2_Object_Object_ * function, app::Object * state, app::CancellationToken cancellation_token, app::TaskCreationOptions__Enum creation_options, app::InternalTaskOptions__Enum internal_options, app::TaskScheduler * scheduler, app::StackCrawlMark__Enum * stack_mark));
...
IL2CPP_REGISTER_METHOD(0x02A5A7B0, Object *, GetResultCore, (app::Task_1_System_Object_ * this_ptr, bool wait_completion_notification));
...
IL2CPP_REGISTER_METHOD(0x004C50A0, TaskAwaiter_1_System_Object_, GetAwaiter, (app::Task_1_System_Object_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x0277FBD0, ConfiguredTaskAwaitable_1_System_Object_, ConfigureAwait, (app::Task_1_System_Object_ * this_ptr, bool continue_on_captured_context));
IL2CPP_REGISTER_METHOD(0x02A5BF40, Task *, ContinueWith_1, (app::Task_1_System_Object_ * this_ptr, app::Action_1_System_Threading_Tasks_Task_1__2 * continuation_action));
IL2CPP_REGISTER_METHOD(0x02A5C040, Task *, ContinueWith_2, (app::Task_1_System_Object_ * this_ptr, app::Action_1_System_Threading_Tasks_Task_1__2 * continuation_action, app::TaskScheduler * scheduler, app::CancellationToken cancellation_token, app::TaskContinuationOptions__Enum continuation_options, app::StackCrawlMark__Enum * stack_mark));
IL2CPP_REGISTER_METHODINFO(0x04788B30, Task_1_System_Object__ContinueWith_1__MethodInfo);
IL2CPP_REGISTER_METHOD(0x01542810, Task_1_System_Object_ *, ContinueWith_3, (app::Task_1_System_Object_ * this_ptr, app::Func_2_System_Threading_Tasks_Task_1_Object_ * continuation_function));
IL2CPP_REGISTER_METHOD(0x01542910, Task_1_System_Object_ *, ContinueWith_4, (app::Task_1_System_Object_ * this_ptr, app::Func_2_System_Threading_Tasks_Task_1_Object_ * continuation_function, app::TaskScheduler * scheduler, app::CancellationToken cancellation_token, app::TaskContinuationOptions__Enum continuation_options, app::StackCrawlMark__Enum * stack_mark));
