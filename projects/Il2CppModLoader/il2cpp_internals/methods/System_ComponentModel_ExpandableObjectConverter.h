...
IL2CPP_REGISTER_METHOD(0x01FECAF0, PropertyDescriptorCollection *, GetProperties, (app::ExpandableObjectConverter * this_ptr, app::ITypeDescriptorContext * context, app::Object * value, app::Attribute__Array * attributes));
