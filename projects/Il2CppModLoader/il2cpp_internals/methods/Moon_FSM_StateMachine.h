...
namespace app::methods::Moon_FSM::StateMachine {
IL2CPP_REGISTER_METHOD(0x002FA280, IState *, get_CurrentState, (app::StateMachine * this_ptr));
IL2CPP_REGISTER_METHOD(0x002FA490, void, set_CurrentState, (app::StateMachine * this_ptr, app::IState * value));
IL2CPP_REGISTER_METHOD(0x002FB930, Stack_1_Moon_FSM_IInterruptState_ *, get_InterruptStates, (app::StateMachine * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02558770, void, __ctor, (app::StateMachine * this_ptr, app::IState * initial_state));
