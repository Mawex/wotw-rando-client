...
IL2CPP_REGISTER_METHOD(0x00A6ABB0, IEnumerator *, HandleSpawningSentries, (app::SeinSpiritSentrySpell * this_ptr));
IL2CPP_REGISTER_METHOD(0x00A6AD00, void, __ctor, (app::SeinSpiritSentrySpell * this_ptr));
}
