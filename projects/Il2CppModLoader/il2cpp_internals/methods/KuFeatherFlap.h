...
namespace app::methods::KuFeatherFlap {
    ...
    IL2CPP_REGISTER_METHOD(0x01236630, Input_InputButtonProcessor*, get_Button, (app::KuFeatherFlap * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x01238160, void, __ctor, (app::KuFeatherFlap * this_ptr));
