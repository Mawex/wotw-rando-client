...
IL2CPP_REGISTER_METHOD(0x00EC5790, BehaviourStatus__Enum, OnExecute, (app::SandWormStickOutBehaviourNew * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00EC6790, void, __ctor, (app::SandWormStickOutBehaviourNew * this_ptr));
}
