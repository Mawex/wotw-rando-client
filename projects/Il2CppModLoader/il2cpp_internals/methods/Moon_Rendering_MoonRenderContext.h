...
namespace app::methods::Moon_Rendering::MoonRenderContext {
...
IL2CPP_REGISTER_METHOD(0x002FBB00, CommandBuffer *, get_cmd, (app::MoonRenderContext * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00417870, MoonRenderContext_Sample, GetSample_1, (app::MoonRenderContext * this_ptr, app::SrpSampler sampler));
IL2CPP_REGISTER_METHOD(0x00417870, MoonRenderContext_Sample, GetSample_2, (app::MoonRenderContext * this_ptr, app::String * name, app::SrpSampler_Scope__Enum scope));
...
IL2CPP_REGISTER_METHOD(0x00790F60, ScriptableCullingParameters, GetCullingParameters, (app::MoonRenderContext * this_ptr, app::Camera * camera));
...
IL2CPP_REGISTER_METHOD(0x00791320, void, __ctor, (app::MoonRenderContext * this_ptr));
}
