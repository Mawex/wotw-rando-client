...
namespace app::methods::FullSerializer_Internal::fsSerializationCallbackProcessor {
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::fsSerializationCallbackProcessor * this_ptr));
}
