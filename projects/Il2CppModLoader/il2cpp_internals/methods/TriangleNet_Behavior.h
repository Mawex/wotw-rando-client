...
IL2CPP_REGISTER_METHOD(0x026198E0, void, __ctor, (app::Behavior * this_ptr, bool quality, double min_angle));
...
IL2CPP_REGISTER_METHOD(0x002FB930, Func_3_TriangleNet_Geometry_ITriangle_Double_Boolean_ *, get_UserTest, (app::Behavior * this_ptr));
