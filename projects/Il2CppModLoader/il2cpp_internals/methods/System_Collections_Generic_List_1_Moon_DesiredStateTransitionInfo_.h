...
namespace app::methods::System_Collections_Generic::List_1_Moon_DesiredStateTransitionInfo_ {
IL2CPP_REGISTER_METHOD(0x025E81E0, void, __ctor_1, (app::List_1_Moon_DesiredStateTransitionInfo_ * this_ptr, int32_t capacity));
IL2CPP_REGISTER_METHODINFO(0x04776858, List_1_Moon_DesiredStateTransitionInfo___ctor__MethodInfo);
IL2CPP_REGISTER_METHOD(0x02D24DA0, DesiredStateTransitionInfo, get_Item, (app::List_1_Moon_DesiredStateTransitionInfo_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E8100, void, __ctor_2, (app::List_1_Moon_DesiredStateTransitionInfo_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D4FCF0, void, __ctor_3, (app::List_1_Moon_DesiredStateTransitionInfo_ * this_ptr, app::IEnumerable_1_Moon_DesiredStateTransitionInfo_ * collection));
...
IL2CPP_REGISTER_METHOD(0x02D50190, Object *, ICollection_get_SyncRoot, (app::List_1_Moon_DesiredStateTransitionInfo_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D24F80, Object *, IList_get_Item, (app::List_1_Moon_DesiredStateTransitionInfo_ * this_ptr, int32_t index));
...
IL2CPP_REGISTER_METHOD(0x025E9050, ReadOnlyCollection_1_Moon_DesiredStateTransitionInfo_ *, AsReadOnly, (app::List_1_Moon_DesiredStateTransitionInfo_ * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x02D258D0, DesiredStateTransitionInfo, Find, (app::List_1_Moon_DesiredStateTransitionInfo_ * this_ptr, app::Predicate_1_Moon_DesiredStateTransitionInfo_ * match));
IL2CPP_REGISTER_METHOD(0x02D25A30, List_1_Moon_DesiredStateTransitionInfo_ *, FindAll, (app::List_1_Moon_DesiredStateTransitionInfo_ * this_ptr, app::Predicate_1_Moon_DesiredStateTransitionInfo_ * match));
...
IL2CPP_REGISTER_METHOD(0x02D25F90, List_1_T_Enumerator_Moon_DesiredStateTransitionInfo_, GetEnumerator, (app::List_1_Moon_DesiredStateTransitionInfo_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D25FF0, IEnumerator_1_Moon_DesiredStateTransitionInfo_ *, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_Moon_DesiredStateTransitionInfo_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x02D25FF0, IEnumerator *, IEnumerable_GetEnumerator, (app::List_1_Moon_DesiredStateTransitionInfo_ * this_ptr));
IL2CPP_REGISTER_METHOD(0x025E9DF0, List_1_Moon_DesiredStateTransitionInfo_ *, GetRange, (app::List_1_Moon_DesiredStateTransitionInfo_ * this_ptr, int32_t index, int32_t count));
...
IL2CPP_REGISTER_METHOD(0x025EAEF0, DesiredStateTransitionInfo__Array *, ToArray, (app::List_1_Moon_DesiredStateTransitionInfo_ * this_ptr));
