...
namespace app::methods::System_Diagnostics::Stopwatch {
IL2CPP_REGISTER_METHOD(0x02004240, int64_t, GetTimestamp, ());
IL2CPP_REGISTER_METHOD(0x02004250, Stopwatch *, StartNew, ());
IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor, (app::Stopwatch * this_ptr));
IL2CPP_REGISTER_METHOD(0x020043A0, TimeSpan, get_Elapsed, (app::Stopwatch * this_ptr));
