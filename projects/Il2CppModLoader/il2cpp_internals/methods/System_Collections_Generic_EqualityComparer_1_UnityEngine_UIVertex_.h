...
namespace app::methods::System_Collections_Generic::EqualityComparer_1_UnityEngine_UIVertex_ {
IL2CPP_REGISTER_METHOD(0x02807CD0, EqualityComparer_1_UnityEngine_UIVertex_ *, get_Default, ());
IL2CPP_REGISTER_METHOD(0x02B56F20, EqualityComparer_1_UnityEngine_UIVertex_ *, CreateComparer, ());
...
IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::EqualityComparer_1_UnityEngine_UIVertex_ * this_ptr));
}
