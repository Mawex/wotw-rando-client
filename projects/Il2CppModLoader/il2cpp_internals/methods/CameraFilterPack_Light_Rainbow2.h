...
IL2CPP_REGISTER_METHOD(0x0247EC90, Material *, get_material, (app::CameraFilterPack_Light_Rainbow2 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0247EC70, void, __ctor, (app::CameraFilterPack_Light_Rainbow2 * this_ptr));
}
