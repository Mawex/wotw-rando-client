...
IL2CPP_REGISTER_METHOD(0x024E8470, Material *, get_material, (app::CameraFilterPack_Distortion_Flush * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020EAC00, void, __ctor, (app::CameraFilterPack_Distortion_Flush * this_ptr));
}
