...
IL2CPP_REGISTER_METHOD(0x00A1FBC0, Vector3, get_TargetPosition, (app::LocomotionGroundMoveBehaviour * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x00FC5A70, Vector2, DeltaToPoint, (app::LocomotionGroundMoveBehaviour * this_ptr, app::Vector3 point));
...
IL2CPP_REGISTER_METHOD(0x00FC6000, BehaviourStatus__Enum, OnExecuteTask, (app::LocomotionGroundMoveBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00842340, void, __ctor, (app::LocomotionGroundMoveBehaviour * this_ptr));
}
