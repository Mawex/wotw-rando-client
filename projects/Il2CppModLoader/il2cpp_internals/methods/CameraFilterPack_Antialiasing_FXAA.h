...
IL2CPP_REGISTER_METHOD(0x0273F360, Material *, get_material, (app::CameraFilterPack_Antialiasing_FXAA * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0136E200, void, __ctor, (app::CameraFilterPack_Antialiasing_FXAA * this_ptr));
}
