...
IL2CPP_REGISTER_METHOD(0x01BAA850, ActiveAnimationHandle, get_ActiveAnimation, (app::MoonAnimationPlayer * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01BAAE80, void, __ctor, (app::MoonAnimationPlayer * this_ptr));
}
