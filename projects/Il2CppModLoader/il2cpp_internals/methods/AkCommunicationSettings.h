...
IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkCommunicationSettings * this_ptr, app::void * c_ptr, bool c_memory_own));
IL2CPP_REGISTER_METHOD(0x026DC0F0, void *, getCPtr, (app::AkCommunicationSettings * obj));
IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkCommunicationSettings * this_ptr, app::void * c_ptr));
...
IL2CPP_REGISTER_METHOD(0x026DC410, void, __ctor_2, (app::AkCommunicationSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x026DD2D0, String *, get_szAppNetworkName, (app::AkCommunicationSettings * this_ptr));
}
