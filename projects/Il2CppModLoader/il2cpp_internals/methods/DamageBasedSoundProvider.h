...
IL2CPP_REGISTER_METHOD(0x00DC2710, SoundDescriptor *, GetSoundForDamage, (app::DamageBasedSoundProvider * this_ptr, app::Damage * damage));
IL2CPP_REGISTER_METHOD(0x00DC28F0, Object *, GetGenericResource, (app::DamageBasedSoundProvider * this_ptr, int32_t id));
IL2CPP_REGISTER_METHOD(0x00DC2AE0, int32_t, GetGenericResourceId, (app::DamageBasedSoundProvider * this_ptr, app::Object * context));
IL2CPP_REGISTER_METHOD(0x003F8A60, void, __ctor, (app::DamageBasedSoundProvider * this_ptr));
