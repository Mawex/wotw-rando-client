...
namespace app::methods::Moon_Race_Networking::WebService {
IL2CPP_REGISTER_METHOD(0x00C454F0, ReplayData *, GetReplay, (app::String * race_name, app::String * player_id));
IL2CPP_REGISTER_METHOD(0x00C458D0, LeaderboadData *, GetLeaderboad, (app::String * race_name));
...
IL2CPP_REGISTER_METHOD(0x00C46600, Byte__Array *, Zip, (app::String * str));
IL2CPP_REGISTER_METHOD(0x00C46AE0, String *, Unzip, (app::Byte__Array * bytes));
}
