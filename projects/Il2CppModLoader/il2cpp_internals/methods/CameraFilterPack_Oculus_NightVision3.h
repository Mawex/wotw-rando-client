...
IL2CPP_REGISTER_METHOD(0x02485740, Material *, get_material, (app::CameraFilterPack_Oculus_NightVision3 * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020E70F0, void, __ctor, (app::CameraFilterPack_Oculus_NightVision3 * this_ptr));
}
