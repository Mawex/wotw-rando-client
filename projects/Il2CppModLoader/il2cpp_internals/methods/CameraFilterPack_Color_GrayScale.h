...
IL2CPP_REGISTER_METHOD(0x024D9A80, Material *, get_material, (app::CameraFilterPack_Color_GrayScale * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0136E200, void, __ctor, (app::CameraFilterPack_Color_GrayScale * this_ptr));
}
