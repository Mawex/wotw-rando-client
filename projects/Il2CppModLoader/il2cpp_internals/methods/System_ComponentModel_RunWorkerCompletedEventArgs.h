...
IL2CPP_REGISTER_METHOD(0x01BCB280, Object *, get_Result, (RunWorkerCompletedEventArgs * __this));
IL2CPP_REGISTER_METHOD(0x002FB950, Object *, get_UserState, (RunWorkerCompletedEventArgs * __this));
}
