...
IL2CPP_REGISTER_METHOD(0x00855600, SuspendableMask__Enum, get_Mask, (app::TextBoxMessage * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x010E5970, Byte__Array *, StringToByteArray, (app::String * hex));
...
IL2CPP_REGISTER_METHOD(0x010E7380, void, __ctor, (app::TextBoxMessage * this_ptr));
}
