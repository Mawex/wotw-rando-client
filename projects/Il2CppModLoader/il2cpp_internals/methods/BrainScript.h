...
namespace app::methods::BrainScript {
    ...
    IL2CPP_REGISTER_METHOD(0x00D48D80, LegacyTimelineSequence_SequenceEntry*, AddEntry, (app::BrainScript * this_ptr, app::BaseAnimator* animator));
    IL2CPP_REGISTER_METHOD(0x002FBD20, List_1_LegacyTimelineSequence_SequenceEntry_*, get_EditorEntries, (app::BrainScript * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x00D49A90, void, __ctor, (app::BrainScript * this_ptr));
} // namespace app::methods::BrainScript
