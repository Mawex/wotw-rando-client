...
IL2CPP_REGISTER_METHOD(0x014F9D90, GUIStyle *, get_LabelStyle, (app::PhysicalSystemProfiler * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014FB360, void, __ctor, (app::PhysicalSystemProfiler * this_ptr));
}
