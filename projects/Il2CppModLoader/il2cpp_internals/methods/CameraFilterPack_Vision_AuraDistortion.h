...
IL2CPP_REGISTER_METHOD(0x020F4CD0, Material *, get_material, (app::CameraFilterPack_Vision_AuraDistortion * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x020F4C90, void, __ctor, (app::CameraFilterPack_Vision_AuraDistortion * this_ptr));
}
