...
IL2CPP_REGISTER_METHOD(0x01288790, Vector2, get_Position, (app::MoonTelemetryCharacterBaseEvent * this_ptr));
IL2CPP_REGISTER_METHOD(0x01466B20, Vector2, get_LastScreenPosition, (app::MoonTelemetryCharacterBaseEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x014679F0, Dictionary_2_System_String_System_Reflection_FieldInfo_ *, GetFieldsCollection, (app::MoonTelemetryCharacterBaseEvent * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01469C80, void, __ctor, (app::MoonTelemetryCharacterBaseEvent * this_ptr));
