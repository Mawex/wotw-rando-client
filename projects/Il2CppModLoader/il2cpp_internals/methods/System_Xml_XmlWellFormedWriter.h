...
namespace app::methods::System_Xml::XmlWellFormedWriter {
...
IL2CPP_REGISTER_METHOD(0x01FCBAB0, WriteState__Enum, get_WriteState, (app::XmlWellFormedWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01FCF1D0, String *, LookupPrefix, (app::XmlWellFormedWriter * this_ptr, app::String * ns));
...
IL2CPP_REGISTER_METHOD(0x002FB950, XmlRawWriter *, get_RawWriter, (app::XmlWellFormedWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01FD0E60, XmlException *, DupAttrException, (app::String * prefix, app::String * local_name));
...
IL2CPP_REGISTER_METHOD(0x01FD1630, String *, GetStateName, (app::XmlWellFormedWriter_State__Enum state));
IL2CPP_REGISTER_METHOD(0x01FD1710, String *, LookupNamespace, (app::XmlWellFormedWriter * this_ptr, app::String * prefix));
IL2CPP_REGISTER_METHOD(0x01FD1880, String *, LookupLocalNamespace, (app::XmlWellFormedWriter * this_ptr, app::String * prefix));
IL2CPP_REGISTER_METHOD(0x01FD19A0, String *, GeneratePrefix, (app::XmlWellFormedWriter * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01FD1CE0, Exception *, InvalidCharsException, (app::String * name, int32_t bad_char_index));
