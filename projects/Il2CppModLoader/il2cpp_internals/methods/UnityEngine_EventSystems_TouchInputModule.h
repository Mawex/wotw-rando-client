...
namespace app::methods::UnityEngine_EventSystems::TouchInputModule {
IL2CPP_REGISTER_METHOD(0x01F29500, void, __ctor, (app::TouchInputModule * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01F2A510, String *, ToString, (app::TouchInputModule * this_ptr));
}
