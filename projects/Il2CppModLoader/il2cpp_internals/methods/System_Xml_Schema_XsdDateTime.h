...
namespace app::methods::System_Xml_Schema::XsdDateTime {
...
IL2CPP_REGISTER_METHOD(0x001C5DD0, XsdDateTime_DateTimeTypeCode__Enum, get_InternalTypeCode, (app::XsdDateTime__Boxed * this_ptr));
IL2CPP_REGISTER_METHOD(0x001C5DE0, XsdDateTime_XsdDateTimeKind__Enum, get_InternalKind, (app::XsdDateTime__Boxed * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x01C7D680, DateTime, operator__1, (app::XsdDateTime xdt));
IL2CPP_REGISTER_METHOD(0x01C7DB30, DateTimeOffset, operator__2, (app::XsdDateTime xdt));
IL2CPP_REGISTER_METHOD(0x001C5F20, String *, ToString, (app::XsdDateTime__Boxed * this_ptr));
