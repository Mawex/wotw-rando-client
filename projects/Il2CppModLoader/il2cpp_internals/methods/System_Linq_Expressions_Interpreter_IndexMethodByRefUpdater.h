...
namespace app::methods::System_Linq_Expressions_Interpreter::IndexMethodByRefUpdater {
IL2CPP_REGISTER_METHOD(0x01CD5D00, void, __ctor, (app::IndexMethodByRefUpdater * this_ptr, app::Nullable_1_System_Linq_Expressions_Interpreter_LocalDefinition_ obj, app::LocalDefinition__Array * args, app::MethodInfo_1 * indexer, int32_t argument_index));
