...
IL2CPP_REGISTER_METHOD(0x0043C220, Rect, get_Bounds, (app::OriInterestTriggerB * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0043D9A0, SelectableCategory__Enum, get_Category, (app::OriInterestTriggerB * this_ptr));
IL2CPP_REGISTER_METHOD(0x0043D9B0, void, Serialize, (app::OriInterestTriggerB * this_ptr, app::Archive * ar));
IL2CPP_REGISTER_METHOD(0x0043C130, void, __ctor, (app::OriInterestTriggerB * this_ptr));
}
