...
namespace app::methods::AkTransform {
    IL2CPP_REGISTER_METHOD(0x01880BB0, void, __ctor_1, (app::AkTransform * this_ptr, app::void* c_ptr, bool c_memory_own));
    IL2CPP_REGISTER_METHOD(0x026FDD00, void*, getCPtr, (app::AkTransform * obj));
    IL2CPP_REGISTER_METHOD(0x01880C50, void, setCPtr, (app::AkTransform * this_ptr, app::void* c_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x026FE020, AkVector*, Position, (app::AkTransform * this_ptr));
    IL2CPP_REGISTER_METHOD(0x026FE220, AkVector*, OrientationFront, (app::AkTransform * this_ptr));
    IL2CPP_REGISTER_METHOD(0x026FE420, AkVector*, OrientationTop, (app::AkTransform * this_ptr));
    ...
    IL2CPP_REGISTER_METHOD(0x026FEE60, void, __ctor_2, (app::AkTransform * this_ptr));
} // namespace app::methods::AkTransform
