...
namespace app::methods::PlayFab_Pipeline::PipelineStageBase_2_PlayFab_IPlayFabEmitEventRequest_TitleEventBatch_ {
    IL2CPP_REGISTER_METHOD(0x018E6D70, void, __ctor, (app::PipelineStageBase_2_PlayFab_IPlayFabEmitEventRequest_TitleEventBatch_ * this_ptr));
