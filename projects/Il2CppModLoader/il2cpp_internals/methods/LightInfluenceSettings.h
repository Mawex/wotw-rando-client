...
IL2CPP_REGISTER_METHOD(0x0114D360, Dictionary_2_LightPriority_Layer_LightInfluence_ *, get_InfluenceMap, (app::LightInfluenceSettings * this_ptr));
IL2CPP_REGISTER_METHOD(0x0114D390, void, __ctor, (app::LightInfluenceSettings * this_ptr));
...
IL2CPP_REGISTER_METHOD(0x0114DE40, LightInfluence *, GetInfluenceForLayer, (app::LightInfluenceSettings * this_ptr, app::LightPriority_Layer__Enum layer));
...
IL2CPP_REGISTER_METHOD(0x0114E310, LightInfluenceSettings *, Clone, (app::LightInfluenceSettings * this_ptr));
