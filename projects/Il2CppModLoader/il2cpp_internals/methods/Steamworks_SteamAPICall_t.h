...
namespace app::methods::Steamworks::SteamAPICall_t {
    IL2CPP_REGISTER_METHOD(0x0010FD20, void, __ctor, (app::SteamAPICall_t__Boxed * this_ptr, uint64_t value));
    ...
    IL2CPP_REGISTER_METHOD(0x015F8190, bool, operator____1, (app::SteamAPICall_t x, app::SteamAPICall_t y));
    IL2CPP_REGISTER_METHOD(0x027E1FA0, bool, operator____2, (app::SteamAPICall_t x, app::SteamAPICall_t y));
    IL2CPP_REGISTER_METHOD(0x004C50A0, app::SteamAPICall_t, operator__1, (uint64_t value));
    IL2CPP_REGISTER_METHOD(0x004C50A0, uint64_t, operator__2, (app::SteamAPICall_t that));
