...
IL2CPP_REGISTER_METHOD(0x00F1D2F0, BehaviourStatus__Enum, OnExecute, (app::LaserShooterMinibossProjectileAttackBehaviour * this_ptr, app::IContext * context));
...
IL2CPP_REGISTER_METHOD(0x00F1DBA0, void, __ctor, (app::LaserShooterMinibossProjectileAttackBehaviour * this_ptr));
}
